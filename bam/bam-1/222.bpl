...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,22704));
...
const encrypt: ref;
axiom (encrypt == $sub.ref(0,1032));
procedure {:inline 1} encrypt($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $M.0, $M.1, $exn;
{
  ...
  var $p38.shadow: ref;
$bb0:
  assume {:sourceloc "examples/tea/tea.c", 8, 15} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "examples/tea/tea.c", 8, 15} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p0,$mul.ref(0,4));
  $p2.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "examples/tea/tea.c", 8, 15} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $i3 := $load.i32($M.0,$p2);
  $i3.shadow := $load.i32($M.0.shadow,$p2.shadow);
  call {:cexpr "v0"} boogie_si_record_i32($i3);
  assume {:sourceloc "examples/tea/tea.c", 8, 24} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "v1"} boogie_si_record_i32($i5);
  assume {:sourceloc "examples/tea/tea.c", 10, 15} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "k0"} boogie_si_record_i32($i7);
  assume {:sourceloc "examples/tea/tea.c", 10, 24} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p1,$mul.ref(1,4));
  $p8.shadow := $add.ref($p1.shadow,$mul.ref(1,4));
  assume {:sourceloc "examples/tea/tea.c", 10, 24} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $i9 := $load.i32($M.3,$p8);
  $i9.shadow := $load.i32($M.3.shadow,$p8.shadow);
  call {:cexpr "k1"} boogie_si_record_i32($i9);
  assume {:sourceloc "examples/tea/tea.c", 10, 33} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($p1,$mul.ref(2,4));
  $p10.shadow := $add.ref($p1.shadow,$mul.ref(2,4));
  assume {:sourceloc "examples/tea/tea.c", 10, 33} true;
  assume {:verifier.code 0} true;
  assert ($p10 == $p10.shadow);
  $i11 := $load.i32($M.4,$p10);
  $i11.shadow := $load.i32($M.4.shadow,$p10.shadow);
  call {:cexpr "k2"} boogie_si_record_i32($i11);
  assume {:sourceloc "examples/tea/tea.c", 10, 42} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p1,$mul.ref(3,4));
  $p12.shadow := $add.ref($p1.shadow,$mul.ref(3,4));
  assume {:sourceloc "examples/tea/tea.c", 10, 42} true;
  assume {:verifier.code 0} true;
  assert ($p12 == $p12.shadow);
  $i13 := $load.i32($M.5,$p12);
  $i13.shadow := $load.i32($M.5.shadow,$p12.shadow);
  call {:cexpr "k3"} boogie_si_record_i32($i13);
  assume {:sourceloc "examples/tea/tea.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $i14 := $i5;
  $i14.shadow := $i5.shadow;
  $i15 := $i3;
  $i15.shadow := $i3.shadow;
  $i16 := 0;
  $i16.shadow := 0;
  $i17 := 0;
  $i17.shadow := 0;
...
$bb1:
  ...
  assume {:sourceloc "examples/tea/tea.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "examples/tea/tea.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "examples/tea/tea.c", 0, 0} true;
  ...
  assume {:sourceloc "examples/tea/tea.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "examples/tea/tea.c", 13, 15} true;
  assume {:verifier.code 0} true;
  $i18 := $ult.i32($i17,32);
  $i18.shadow := $ult.i32($i17.shadow,32);
  assume {:sourceloc "examples/tea/tea.c", 13, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i18} true;
  assert ($i18 == $i18.shadow);
  goto $bb2, $bb3;
$bb2:
  assume ($i18 == 1);
  assume {:sourceloc "examples/tea/tea.c", 14, 9} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i16,2654435769);
  $i19.shadow := $add.i32($i16.shadow,2654435769);
  call {:cexpr "sum"} boogie_si_record_i32($i19);
  assume {:sourceloc "examples/tea/tea.c", 15, 15} true;
  assume {:verifier.code 0} true;
  $i20 := $shl.i32($i14,4);
  $i20.shadow := $shl.i32($i14.shadow,4);
  assume {:sourceloc "examples/tea/tea.c", 15, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i32($i20,$i7);
  $i21.shadow := $add.i32($i20.shadow,$i7.shadow);
  assume {:sourceloc "examples/tea/tea.c", 15, 32} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i32($i14,$i19);
  $i22.shadow := $add.i32($i14.shadow,$i19.shadow);
  assume {:sourceloc "examples/tea/tea.c", 15, 26} true;
  assume {:verifier.code 0} true;
  $i23 := $xor.i32($i21,$i22);
  $i23.shadow := $xor.i32($i21.shadow,$i22.shadow);
  assume {:sourceloc "examples/tea/tea.c", 15, 45} true;
  assume {:verifier.code 0} true;
  $i24 := $lshr.i32($i14,5);
  $i24.shadow := $lshr.i32($i14.shadow,5);
  assume {:sourceloc "examples/tea/tea.c", 15, 50} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i24,$i9);
  $i25.shadow := $add.i32($i24.shadow,$i9.shadow);
  assume {:sourceloc "examples/tea/tea.c", 15, 39} true;
  assume {:verifier.code 0} true;
  $i26 := $xor.i32($i23,$i25);
  $i26.shadow := $xor.i32($i23.shadow,$i25.shadow);
  assume {:sourceloc "examples/tea/tea.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i15,$i26);
  $i27.shadow := $add.i32($i15.shadow,$i26.shadow);
  call {:cexpr "v0"} boogie_si_record_i32($i27);
  assume {:sourceloc "examples/tea/tea.c", 16, 15} true;
  assume {:verifier.code 0} true;
  $i28 := $shl.i32($i27,4);
  $i28.shadow := $shl.i32($i27.shadow,4);
  assume {:sourceloc "examples/tea/tea.c", 16, 20} true;
  assume {:verifier.code 0} true;
  $i29 := $add.i32($i28,$i11);
  $i29.shadow := $add.i32($i28.shadow,$i11.shadow);
  assume {:sourceloc "examples/tea/tea.c", 16, 32} true;
  assume {:verifier.code 0} true;
  $i30 := $add.i32($i27,$i19);
  $i30.shadow := $add.i32($i27.shadow,$i19.shadow);
  assume {:sourceloc "examples/tea/tea.c", 16, 26} true;
  assume {:verifier.code 0} true;
  $i31 := $xor.i32($i29,$i30);
  $i31.shadow := $xor.i32($i29.shadow,$i30.shadow);
  assume {:sourceloc "examples/tea/tea.c", 16, 45} true;
  assume {:verifier.code 0} true;
  $i32 := $lshr.i32($i27,5);
  $i32.shadow := $lshr.i32($i27.shadow,5);
  assume {:sourceloc "examples/tea/tea.c", 16, 50} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i32,$i13);
  $i33.shadow := $add.i32($i32.shadow,$i13.shadow);
  assume {:sourceloc "examples/tea/tea.c", 16, 39} true;
  assume {:verifier.code 0} true;
  $i34 := $xor.i32($i31,$i33);
  $i34.shadow := $xor.i32($i31.shadow,$i33.shadow);
  assume {:sourceloc "examples/tea/tea.c", 16, 8} true;
  assume {:verifier.code 0} true;
  $i35 := $add.i32($i14,$i34);
  $i35.shadow := $add.i32($i14.shadow,$i34.shadow);
  call {:cexpr "v1"} boogie_si_record_i32($i35);
  assume {:sourceloc "examples/tea/tea.c", 17, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i18 == 1);
  assume {:sourceloc "examples/tea/tea.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($p0,$mul.ref(0,4));
  $p37.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "examples/tea/tea.c", 18, 7} true;
  assume {:verifier.code 0} true;
  assert ($p37 == $p37.shadow);
  $M.0 := $store.i32($M.0,$p37,$i15);
  $M.0.shadow := $store.i32($M.0.shadow,$p37.shadow,$i15.shadow);
  assume {:sourceloc "examples/tea/tea.c", 18, 12} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p0,$mul.ref(1,4));
  $p38.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "examples/tea/tea.c", 18, 16} true;
  assume {:verifier.code 0} true;
  assert ($p38 == $p38.shadow);
  $M.1 := $store.i32($M.1,$p38,$i14);
  $M.1.shadow := $store.i32($M.1.shadow,$p38.shadow,$i14.shadow);
  assume {:sourceloc "examples/tea/tea.c", 19, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "examples/tea/tea.c", 13, 22} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i32($i17,1);
  $i36.shadow := $add.i32($i17.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i36);
  assume {:sourceloc "examples/tea/tea.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i14 := $i35;
  $i14.shadow := $i35.shadow;
  $i15 := $i27;
  $i15.shadow := $i27.shadow;
  $i16 := $i19;
  $i16.shadow := $i19.shadow;
  $i17 := $i36;
  $i17.shadow := $i36.shadow;
  goto $bb1;
}
const encrypt_wrapper: ref;
axiom (encrypt_wrapper == $sub.ref(0,2064));
procedure {:entrypoint} encrypt_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "examples/tea/tea.c", 37, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "examples/tea/tea.c", 37, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p2, $p2.shadow);
  assume {:sourceloc "examples/tea/tea.c", 38, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p3 := __SMACK_value.ref($p1);
  $p3.shadow := $p3;
  assume $isExternal($p3);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p3);
  assume {:sourceloc "examples/tea/tea.c", 38, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p3, $p3.shadow);
  assume {:sourceloc "examples/tea/tea.c", 43, 3} true;
  assume {:verifier.code 0} true;
  call encrypt($p0, $p0.shadow, $p1, $p1.shadow);
  assume {:sourceloc "examples/tea/tea.c", 44, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
