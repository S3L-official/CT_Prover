...
; Function Attrs: noinline nounwind uwtable
define dso_local void @decrypt_wrapper(i32 %0, i32* %1, i8* %2) #0 !dbg !814 {
  call void @llvm.dbg.value(metadata i32 %0, metadata !815, metadata !DIExpression()), !dbg !816
  call void @llvm.dbg.value(metadata i32* %1, metadata !817, metadata !DIExpression()), !dbg !816
  call void @llvm.dbg.value(metadata i8* %2, metadata !818, metadata !DIExpression()), !dbg !816
  %4 = call %struct.smack_value* (i32, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i32, ...)*)(i32 %0), !dbg !819
  call void @public_in(%struct.smack_value* %4), !dbg !820
  %5 = call %struct.smack_value* (i32*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i32*, ...)*)(i32* %1), !dbg !821
  call void @public_in(%struct.smack_value* %5), !dbg !822
  %6 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %2), !dbg !823
  call void @public_in(%struct.smack_value* %6), !dbg !824
  %7 = call %struct.smack_value* @__SMACK_values(i8* %2, i32 16), !dbg !825
  call void @public_in(%struct.smack_value* %7), !dbg !826
  call void @br_aes_big_decrypt(i32 %0, i32* %1, i8* %2), !dbg !827
  ret void, !dbg !828
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @decrypt_wrapper_t() #0 !dbg !829 {
  %1 = call i32 (...) @getuns(), !dbg !832
  call void @llvm.dbg.value(metadata i32 %1, metadata !833, metadata !DIExpression()), !dbg !834
  ...
  %5 = call i32 (...) @getpt2(), !dbg !837
  %6 = sext i32 %5 to i64, !dbg !837
  %7 = inttoptr i64 %6 to i8*, !dbg !837
  call void @llvm.dbg.value(metadata i8* %7, metadata !838, metadata !DIExpression()), !dbg !834
  call void @br_aes_big_decrypt(i32 %1, i32* %4, i8* %7), !dbg !839
  ret void, !dbg !840
}
...
!41 = !DIFile(filename: "decrypt.c", directory: "/home/luwei/bech-back/BearSSL/AES_big_cbc")
...
!814 = distinct !DISubprogram(name: "decrypt_wrapper", scope: !41, file: !41, line: 5, type: !182, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !40, retainedNodes: !4)
!815 = !DILocalVariable(name: "num_rounds", arg: 1, scope: !814, file: !41, line: 5, type: !11)
!816 = !DILocation(line: 0, scope: !814)
!817 = !DILocalVariable(name: "skey", arg: 2, scope: !814, file: !41, line: 5, type: !184)
!818 = !DILocalVariable(name: "data", arg: 3, scope: !814, file: !41, line: 5, type: !185)
!819 = !DILocation(line: 6, column: 12, scope: !814)
!820 = !DILocation(line: 6, column: 2, scope: !814)
!821 = !DILocation(line: 7, column: 12, scope: !814)
!822 = !DILocation(line: 7, column: 2, scope: !814)
!823 = !DILocation(line: 8, column: 12, scope: !814)
!824 = !DILocation(line: 8, column: 2, scope: !814)
!825 = !DILocation(line: 10, column: 12, scope: !814)
!826 = !DILocation(line: 10, column: 2, scope: !814)
!827 = !DILocation(line: 12, column: 2, scope: !814)
!828 = !DILocation(line: 13, column: 1, scope: !814)
!829 = distinct !DISubprogram(name: "decrypt_wrapper_t", scope: !41, file: !41, line: 16, type: !830, scopeLine: 16, spFlags: DISPFlagDefinition, unit: !40, retainedNodes: !4)
!830 = !DISubroutineType(types: !831)
!831 = !{null}
!832 = !DILocation(line: 17, column: 24, scope: !829)
!833 = !DILocalVariable(name: "num_rounds", scope: !829, file: !41, line: 17, type: !11)
...
!837 = !DILocation(line: 19, column: 15, scope: !829)
!838 = !DILocalVariable(name: "data", scope: !829, file: !41, line: 19, type: !185)
