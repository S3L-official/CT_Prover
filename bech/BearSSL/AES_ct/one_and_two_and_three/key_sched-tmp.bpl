...
modifies $M.1, $exn;
requires (Rcon == Rcon);
requires ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(1,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(1,1)));
requires ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(2,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(2,1)));
requires ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(3,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(3,1)));
requires ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(4,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(4,1)));
requires ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(5,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(5,1)));
requires ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(6,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(6,1)));
requires ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(7,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(7,1)));
requires ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(8,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(8,1)));
requires ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(9,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(9,1)));
{
$bb0:
