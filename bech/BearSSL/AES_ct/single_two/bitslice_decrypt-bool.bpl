...
procedure {:inline 1} br_aes_ct_bitslice_Sbox($p0: ref, $p0.dup: i1)
modifies $M.0, $exn;
{
  var $p1: ref;
  var $p1.dup: i1;
...
procedure {:inline 1} br_aes_ct_bitslice_invSbox($p0: ref, $p0.dup: i1)
modifies $M.0, $exn;
{
  var $p1: ref;
  var $p1.dup: i1;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_Sbox($p0, $p0.dup);
...
procedure {:inline 1} br_aes_ct_bitslice_decrypt($i0: i32, $i0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1)
modifies $exn;
modifies $M.0;
{
  var $i3: i32;
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_invSbox($p2, $p2.dup);
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i50, $i50.dup := rotr16($i49, $i49.dup);
  ...
  assume {:verifier.code 0} true;
  call $i64, $i64.dup := rotr16($i63, $i63.dup);
  ...
  assume {:verifier.code 0} true;
  call $i78, $i78.dup := rotr16($i77, $i77.dup);
  ...
  assume {:verifier.code 0} true;
  call $i98, $i98.dup := rotr16($i97, $i97.dup);
  ...
  assume {:verifier.code 0} true;
  call $i118, $i118.dup := rotr16($i117, $i117.dup);
  ...
  assume {:verifier.code 0} true;
  call $i136, $i136.dup := rotr16($i135, $i135.dup);
  ...
  assume {:verifier.code 0} true;
  call $i152, $i152.dup := rotr16($i151, $i151.dup);
  ...
  assume {:verifier.code 0} true;
  call $i164, $i164.dup := rotr16($i163, $i163.dup);
...
procedure {:inline 1} rotr16($i0: i32, $i0.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i1: i32;
  var $i1.dup: i1;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_decrypt($i0, $i0.dup, $p1, $p1.dup, $p7, $p7.dup);
