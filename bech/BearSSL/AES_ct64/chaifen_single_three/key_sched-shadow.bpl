...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,30962));
...
const {:allocSize 10} {:count 10} Rcon: ref;
axiom (Rcon == $sub.ref(0,1034));
const br_aes_ct64_bitslice_Sbox: ref;
axiom (br_aes_ct64_bitslice_Sbox == $sub.ref(0,2066));
...
axiom (llvm.dbg.value == $sub.ref(0,3098));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const br_aes_ct64_ortho: ref;
axiom (br_aes_ct64_ortho == $sub.ref(0,4130));
procedure {:inline 1} br_aes_ct64_ortho($p0: ref, $p0.shadow: ref)
modifies $M.0, $exn;
{
  var $p1: ref;
  var $p1.shadow: ref;
  ...
  var $p168.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  ...
  $i2 := $load.i64($M.0,$p1);
  $i2.shadow := $load.i64($M.0.shadow,$p1.shadow);
  call {:cexpr "a"} boogie_si_record_i64($i2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  ...
  $i4 := $load.i64($M.0,$p3);
  $i4.shadow := $load.i64($M.0.shadow,$p3.shadow);
  call {:cexpr "b"} boogie_si_record_i64($i4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i5 := $and.i64($i2,6148914691236517205);
  $i5.shadow := $and.i64($i2.shadow,6148914691236517205);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i6 := $and.i64($i4,6148914691236517205);
  $i6.shadow := $and.i64($i4.shadow,6148914691236517205);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $shl.i64($i6,1);
  $i7.shadow := $shl.i64($i6.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i8 := $or.i64($i5,$i7);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(0,8));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $M.0 := $store.i64($M.0,$p9,$i8);
  $M.0.shadow := $store.i64($M.0.shadow,$p9.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i10 := $and.i64($i2,12297829382473034410);
  $i10.shadow := $and.i64($i2.shadow,12297829382473034410);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $lshr.i64($i10,1);
  $i11.shadow := $lshr.i64($i10.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i12 := $and.i64($i4,12297829382473034410);
  $i12.shadow := $and.i64($i4.shadow,12297829382473034410);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i13 := $or.i64($i11,$i12);
  $i13.shadow := $or.i64($i11.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p0,$mul.ref(1,8));
  $p14.shadow := $add.ref($p0.shadow,$mul.ref(1,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 220, 2} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p0,$mul.ref(2,8));
  $p15.shadow := $add.ref($p0.shadow,$mul.ref(2,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  assert ($p15 == $p15.shadow);
  $i16 := $load.i64($M.0,$p15);
  $i16.shadow := $load.i64($M.0.shadow,$p15.shadow);
  call {:cexpr "a"} boogie_si_record_i64($i16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($p0,$mul.ref(3,8));
  $p17.shadow := $add.ref($p0.shadow,$mul.ref(3,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  assert ($p17 == $p17.shadow);
  $i18 := $load.i64($M.0,$p17);
  $i18.shadow := $load.i64($M.0.shadow,$p17.shadow);
  call {:cexpr "b"} boogie_si_record_i64($i18);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i19 := $and.i64($i16,6148914691236517205);
  $i19.shadow := $and.i64($i16.shadow,6148914691236517205);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i20 := $and.i64($i18,6148914691236517205);
  $i20.shadow := $and.i64($i18.shadow,6148914691236517205);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i21 := $shl.i64($i20,1);
  $i21.shadow := $shl.i64($i20.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i22 := $or.i64($i19,$i21);
  $i22.shadow := $or.i64($i19.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p0,$mul.ref(2,8));
  $p23.shadow := $add.ref($p0.shadow,$mul.ref(2,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i24 := $and.i64($i16,12297829382473034410);
  $i24.shadow := $and.i64($i16.shadow,12297829382473034410);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i25 := $lshr.i64($i24,1);
  $i25.shadow := $lshr.i64($i24.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i26 := $and.i64($i18,12297829382473034410);
  $i26.shadow := $and.i64($i18.shadow,12297829382473034410);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i27 := $or.i64($i25,$i26);
  $i27.shadow := $or.i64($i25.shadow,$i26.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($p0,$mul.ref(3,8));
  $p28.shadow := $add.ref($p0.shadow,$mul.ref(3,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  assert ($p28 == $p28.shadow);
  $M.0 := $store.i64($M.0,$p28,$i27);
  $M.0.shadow := $store.i64($M.0.shadow,$p28.shadow,$i27.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 221, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p0,$mul.ref(4,8));
  $p29.shadow := $add.ref($p0.shadow,$mul.ref(4,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $i30 := $load.i64($M.0,$p29);
  $i30.shadow := $load.i64($M.0.shadow,$p29.shadow);
  call {:cexpr "a"} boogie_si_record_i64($i30);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "b"} boogie_si_record_i64($i32);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i33 := $and.i64($i30,6148914691236517205);
  $i33.shadow := $and.i64($i30.shadow,6148914691236517205);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i34 := $and.i64($i32,6148914691236517205);
  $i34.shadow := $and.i64($i32.shadow,6148914691236517205);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i35 := $shl.i64($i34,1);
  $i35.shadow := $shl.i64($i34.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i36 := $or.i64($i33,$i35);
  $i36.shadow := $or.i64($i33.shadow,$i35.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($p0,$mul.ref(4,8));
  $p37.shadow := $add.ref($p0.shadow,$mul.ref(4,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  assert ($p37 == $p37.shadow);
  $M.0 := $store.i64($M.0,$p37,$i36);
  $M.0.shadow := $store.i64($M.0.shadow,$p37.shadow,$i36.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i38 := $and.i64($i30,12297829382473034410);
  $i38.shadow := $and.i64($i30.shadow,12297829382473034410);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i39 := $lshr.i64($i38,1);
  $i39.shadow := $lshr.i64($i38.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i40 := $and.i64($i32,12297829382473034410);
  $i40.shadow := $and.i64($i32.shadow,12297829382473034410);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i41 := $or.i64($i39,$i40);
  $i41.shadow := $or.i64($i39.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  ...
  $M.0.shadow := $store.i64($M.0.shadow,$p42.shadow,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 222, 2} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($p0,$mul.ref(6,8));
  $p43.shadow := $add.ref($p0.shadow,$mul.ref(6,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  assert ($p43 == $p43.shadow);
  $i44 := $load.i64($M.0,$p43);
  $i44.shadow := $load.i64($M.0.shadow,$p43.shadow);
  call {:cexpr "a"} boogie_si_record_i64($i44);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($p0,$mul.ref(7,8));
  $p45.shadow := $add.ref($p0.shadow,$mul.ref(7,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  assert ($p45 == $p45.shadow);
  $i46 := $load.i64($M.0,$p45);
  $i46.shadow := $load.i64($M.0.shadow,$p45.shadow);
  call {:cexpr "b"} boogie_si_record_i64($i46);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i47 := $and.i64($i44,6148914691236517205);
  $i47.shadow := $and.i64($i44.shadow,6148914691236517205);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i48 := $and.i64($i46,6148914691236517205);
  $i48.shadow := $and.i64($i46.shadow,6148914691236517205);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i49 := $shl.i64($i48,1);
  $i49.shadow := $shl.i64($i48.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i50 := $or.i64($i47,$i49);
  $i50.shadow := $or.i64($i47.shadow,$i49.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($p0,$mul.ref(6,8));
  $p51.shadow := $add.ref($p0.shadow,$mul.ref(6,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  assert ($p51 == $p51.shadow);
  $M.0 := $store.i64($M.0,$p51,$i50);
  $M.0.shadow := $store.i64($M.0.shadow,$p51.shadow,$i50.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i52 := $and.i64($i44,12297829382473034410);
  $i52.shadow := $and.i64($i44.shadow,12297829382473034410);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i53 := $lshr.i64($i52,1);
  $i53.shadow := $lshr.i64($i52.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i54 := $and.i64($i46,12297829382473034410);
  $i54.shadow := $and.i64($i46.shadow,12297829382473034410);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i55 := $or.i64($i53,$i54);
  $i55.shadow := $or.i64($i53.shadow,$i54.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $p56 := $add.ref($p0,$mul.ref(7,8));
  $p56.shadow := $add.ref($p0.shadow,$mul.ref(7,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  assert ($p56 == $p56.shadow);
  $M.0 := $store.i64($M.0,$p56,$i55);
  $M.0.shadow := $store.i64($M.0.shadow,$p56.shadow,$i55.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 223, 2} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  ...
  $p57.shadow := $add.ref($p0.shadow,$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  assert ($p57 == $p57.shadow);
  $i58 := $load.i64($M.0,$p57);
  $i58.shadow := $load.i64($M.0.shadow,$p57.shadow);
  call {:cexpr "a"} boogie_si_record_i64($i58);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($p0,$mul.ref(2,8));
  $p59.shadow := $add.ref($p0.shadow,$mul.ref(2,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  assert ($p59 == $p59.shadow);
  $i60 := $load.i64($M.0,$p59);
  $i60.shadow := $load.i64($M.0.shadow,$p59.shadow);
  call {:cexpr "b"} boogie_si_record_i64($i60);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i61 := $and.i64($i58,3689348814741910323);
  $i61.shadow := $and.i64($i58.shadow,3689348814741910323);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i62 := $and.i64($i60,3689348814741910323);
  $i62.shadow := $and.i64($i60.shadow,3689348814741910323);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i63 := $shl.i64($i62,2);
  $i63.shadow := $shl.i64($i62.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i64 := $or.i64($i61,$i63);
  $i64.shadow := $or.i64($i61.shadow,$i63.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $p65 := $add.ref($p0,$mul.ref(0,8));
  $p65.shadow := $add.ref($p0.shadow,$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  assert ($p65 == $p65.shadow);
  $M.0 := $store.i64($M.0,$p65,$i64);
  $M.0.shadow := $store.i64($M.0.shadow,$p65.shadow,$i64.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i66 := $and.i64($i58,14757395258967641292);
  $i66.shadow := $and.i64($i58.shadow,14757395258967641292);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i67 := $lshr.i64($i66,2);
  $i67.shadow := $lshr.i64($i66.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i68 := $and.i64($i60,14757395258967641292);
  $i68.shadow := $and.i64($i60.shadow,14757395258967641292);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i69 := $or.i64($i67,$i68);
  $i69.shadow := $or.i64($i67.shadow,$i68.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($p0,$mul.ref(2,8));
  $p70.shadow := $add.ref($p0.shadow,$mul.ref(2,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 225, 2} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $p71 := $add.ref($p0,$mul.ref(1,8));
  $p71.shadow := $add.ref($p0.shadow,$mul.ref(1,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  assert ($p71 == $p71.shadow);
  $i72 := $load.i64($M.0,$p71);
  $i72.shadow := $load.i64($M.0.shadow,$p71.shadow);
  call {:cexpr "a"} boogie_si_record_i64($i72);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($p0,$mul.ref(3,8));
  $p73.shadow := $add.ref($p0.shadow,$mul.ref(3,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  assert ($p73 == $p73.shadow);
  $i74 := $load.i64($M.0,$p73);
  $i74.shadow := $load.i64($M.0.shadow,$p73.shadow);
  call {:cexpr "b"} boogie_si_record_i64($i74);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i75 := $and.i64($i72,3689348814741910323);
  $i75.shadow := $and.i64($i72.shadow,3689348814741910323);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i76 := $and.i64($i74,3689348814741910323);
  $i76.shadow := $and.i64($i74.shadow,3689348814741910323);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i77 := $shl.i64($i76,2);
  $i77.shadow := $shl.i64($i76.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i78 := $or.i64($i75,$i77);
  $i78.shadow := $or.i64($i75.shadow,$i77.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $p79 := $add.ref($p0,$mul.ref(1,8));
  $p79.shadow := $add.ref($p0.shadow,$mul.ref(1,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i80 := $and.i64($i72,14757395258967641292);
  $i80.shadow := $and.i64($i72.shadow,14757395258967641292);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i81 := $lshr.i64($i80,2);
  $i81.shadow := $lshr.i64($i80.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i82 := $and.i64($i74,14757395258967641292);
  $i82.shadow := $and.i64($i74.shadow,14757395258967641292);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i83 := $or.i64($i81,$i82);
  $i83.shadow := $or.i64($i81.shadow,$i82.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  ...
  $M.0.shadow := $store.i64($M.0.shadow,$p84.shadow,$i83.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 226, 2} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb12:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb13:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $p85 := $add.ref($p0,$mul.ref(4,8));
  $p85.shadow := $add.ref($p0.shadow,$mul.ref(4,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  assert ($p85 == $p85.shadow);
  $i86 := $load.i64($M.0,$p85);
  $i86.shadow := $load.i64($M.0.shadow,$p85.shadow);
  call {:cexpr "a"} boogie_si_record_i64($i86);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $p87 := $add.ref($p0,$mul.ref(6,8));
  $p87.shadow := $add.ref($p0.shadow,$mul.ref(6,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  assert ($p87 == $p87.shadow);
  $i88 := $load.i64($M.0,$p87);
  $i88.shadow := $load.i64($M.0.shadow,$p87.shadow);
  call {:cexpr "b"} boogie_si_record_i64($i88);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i89 := $and.i64($i86,3689348814741910323);
  $i89.shadow := $and.i64($i86.shadow,3689348814741910323);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i90 := $and.i64($i88,3689348814741910323);
  $i90.shadow := $and.i64($i88.shadow,3689348814741910323);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i91 := $shl.i64($i90,2);
  $i91.shadow := $shl.i64($i90.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i92 := $or.i64($i89,$i91);
  $i92.shadow := $or.i64($i89.shadow,$i91.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $p93 := $add.ref($p0,$mul.ref(4,8));
  $p93.shadow := $add.ref($p0.shadow,$mul.ref(4,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i94 := $and.i64($i86,14757395258967641292);
  $i94.shadow := $and.i64($i86.shadow,14757395258967641292);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i95 := $lshr.i64($i94,2);
  $i95.shadow := $lshr.i64($i94.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i96 := $and.i64($i88,14757395258967641292);
  $i96.shadow := $and.i64($i88.shadow,14757395258967641292);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i97 := $or.i64($i95,$i96);
  $i97.shadow := $or.i64($i95.shadow,$i96.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $p98 := $add.ref($p0,$mul.ref(6,8));
  $p98.shadow := $add.ref($p0.shadow,$mul.ref(6,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  assert ($p98 == $p98.shadow);
  $M.0 := $store.i64($M.0,$p98,$i97);
  $M.0.shadow := $store.i64($M.0.shadow,$p98.shadow,$i97.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 227, 2} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb15:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $p99 := $add.ref($p0,$mul.ref(5,8));
  $p99.shadow := $add.ref($p0.shadow,$mul.ref(5,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  assert ($p99 == $p99.shadow);
  $i100 := $load.i64($M.0,$p99);
  $i100.shadow := $load.i64($M.0.shadow,$p99.shadow);
  call {:cexpr "a"} boogie_si_record_i64($i100);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $p101 := $add.ref($p0,$mul.ref(7,8));
  $p101.shadow := $add.ref($p0.shadow,$mul.ref(7,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  assert ($p101 == $p101.shadow);
  $i102 := $load.i64($M.0,$p101);
  $i102.shadow := $load.i64($M.0.shadow,$p101.shadow);
  call {:cexpr "b"} boogie_si_record_i64($i102);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i103 := $and.i64($i100,3689348814741910323);
  $i103.shadow := $and.i64($i100.shadow,3689348814741910323);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i104 := $and.i64($i102,3689348814741910323);
  $i104.shadow := $and.i64($i102.shadow,3689348814741910323);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i105 := $shl.i64($i104,2);
  $i105.shadow := $shl.i64($i104.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i106 := $or.i64($i103,$i105);
  $i106.shadow := $or.i64($i103.shadow,$i105.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $p107 := $add.ref($p0,$mul.ref(5,8));
  $p107.shadow := $add.ref($p0.shadow,$mul.ref(5,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  assert ($p107 == $p107.shadow);
  $M.0 := $store.i64($M.0,$p107,$i106);
  $M.0.shadow := $store.i64($M.0.shadow,$p107.shadow,$i106.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i108 := $and.i64($i100,14757395258967641292);
  $i108.shadow := $and.i64($i100.shadow,14757395258967641292);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i109 := $lshr.i64($i108,2);
  $i109.shadow := $lshr.i64($i108.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i110 := $and.i64($i102,14757395258967641292);
  $i110.shadow := $and.i64($i102.shadow,14757395258967641292);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i111 := $or.i64($i109,$i110);
  $i111.shadow := $or.i64($i109.shadow,$i110.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $p112 := $add.ref($p0,$mul.ref(7,8));
  $p112.shadow := $add.ref($p0.shadow,$mul.ref(7,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  assert ($p112 == $p112.shadow);
  $M.0 := $store.i64($M.0,$p112,$i111);
  $M.0.shadow := $store.i64($M.0.shadow,$p112.shadow,$i111.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 228, 2} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb17:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $p113 := $add.ref($p0,$mul.ref(0,8));
  $p113.shadow := $add.ref($p0.shadow,$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  assert ($p113 == $p113.shadow);
  $i114 := $load.i64($M.0,$p113);
  $i114.shadow := $load.i64($M.0.shadow,$p113.shadow);
  call {:cexpr "a"} boogie_si_record_i64($i114);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $p115 := $add.ref($p0,$mul.ref(4,8));
  $p115.shadow := $add.ref($p0.shadow,$mul.ref(4,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  assert ($p115 == $p115.shadow);
  $i116 := $load.i64($M.0,$p115);
  $i116.shadow := $load.i64($M.0.shadow,$p115.shadow);
  call {:cexpr "b"} boogie_si_record_i64($i116);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i117 := $and.i64($i114,1085102592571150095);
  $i117.shadow := $and.i64($i114.shadow,1085102592571150095);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i118 := $and.i64($i116,1085102592571150095);
  $i118.shadow := $and.i64($i116.shadow,1085102592571150095);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i119 := $shl.i64($i118,4);
  $i119.shadow := $shl.i64($i118.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i120 := $or.i64($i117,$i119);
  $i120.shadow := $or.i64($i117.shadow,$i119.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $p121 := $add.ref($p0,$mul.ref(0,8));
  $p121.shadow := $add.ref($p0.shadow,$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  assert ($p121 == $p121.shadow);
  $M.0 := $store.i64($M.0,$p121,$i120);
  $M.0.shadow := $store.i64($M.0.shadow,$p121.shadow,$i120.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i122 := $and.i64($i114,17361641481138401520);
  $i122.shadow := $and.i64($i114.shadow,17361641481138401520);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i123 := $lshr.i64($i122,4);
  $i123.shadow := $lshr.i64($i122.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i124 := $and.i64($i116,17361641481138401520);
  $i124.shadow := $and.i64($i116.shadow,17361641481138401520);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i125 := $or.i64($i123,$i124);
  $i125.shadow := $or.i64($i123.shadow,$i124.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $p126 := $add.ref($p0,$mul.ref(4,8));
  $p126.shadow := $add.ref($p0.shadow,$mul.ref(4,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  assert ($p126 == $p126.shadow);
  $M.0 := $store.i64($M.0,$p126,$i125);
  $M.0.shadow := $store.i64($M.0.shadow,$p126.shadow,$i125.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 230, 2} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb18:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb19:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $p127 := $add.ref($p0,$mul.ref(1,8));
  $p127.shadow := $add.ref($p0.shadow,$mul.ref(1,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  assert ($p127 == $p127.shadow);
  $i128 := $load.i64($M.0,$p127);
  $i128.shadow := $load.i64($M.0.shadow,$p127.shadow);
  call {:cexpr "a"} boogie_si_record_i64($i128);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $p129 := $add.ref($p0,$mul.ref(5,8));
  $p129.shadow := $add.ref($p0.shadow,$mul.ref(5,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  assert ($p129 == $p129.shadow);
  $i130 := $load.i64($M.0,$p129);
  $i130.shadow := $load.i64($M.0.shadow,$p129.shadow);
  call {:cexpr "b"} boogie_si_record_i64($i130);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i131 := $and.i64($i128,1085102592571150095);
  $i131.shadow := $and.i64($i128.shadow,1085102592571150095);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i132 := $and.i64($i130,1085102592571150095);
  $i132.shadow := $and.i64($i130.shadow,1085102592571150095);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i133 := $shl.i64($i132,4);
  $i133.shadow := $shl.i64($i132.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i134 := $or.i64($i131,$i133);
  $i134.shadow := $or.i64($i131.shadow,$i133.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $p135 := $add.ref($p0,$mul.ref(1,8));
  $p135.shadow := $add.ref($p0.shadow,$mul.ref(1,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  assert ($p135 == $p135.shadow);
  $M.0 := $store.i64($M.0,$p135,$i134);
  $M.0.shadow := $store.i64($M.0.shadow,$p135.shadow,$i134.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i136 := $and.i64($i128,17361641481138401520);
  $i136.shadow := $and.i64($i128.shadow,17361641481138401520);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i137 := $lshr.i64($i136,4);
  $i137.shadow := $lshr.i64($i136.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i138 := $and.i64($i130,17361641481138401520);
  $i138.shadow := $and.i64($i130.shadow,17361641481138401520);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i139 := $or.i64($i137,$i138);
  $i139.shadow := $or.i64($i137.shadow,$i138.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $p140 := $add.ref($p0,$mul.ref(5,8));
  $p140.shadow := $add.ref($p0.shadow,$mul.ref(5,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  assert ($p140 == $p140.shadow);
  $M.0 := $store.i64($M.0,$p140,$i139);
  $M.0.shadow := $store.i64($M.0.shadow,$p140.shadow,$i139.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 231, 2} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb20:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb21:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  ...
  $i142.shadow := $load.i64($M.0.shadow,$p141.shadow);
  call {:cexpr "a"} boogie_si_record_i64($i142);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $p143 := $add.ref($p0,$mul.ref(6,8));
  $p143.shadow := $add.ref($p0.shadow,$mul.ref(6,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  assert ($p143 == $p143.shadow);
  $i144 := $load.i64($M.0,$p143);
  $i144.shadow := $load.i64($M.0.shadow,$p143.shadow);
  call {:cexpr "b"} boogie_si_record_i64($i144);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i145 := $and.i64($i142,1085102592571150095);
  $i145.shadow := $and.i64($i142.shadow,1085102592571150095);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i146 := $and.i64($i144,1085102592571150095);
  $i146.shadow := $and.i64($i144.shadow,1085102592571150095);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i147 := $shl.i64($i146,4);
  $i147.shadow := $shl.i64($i146.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i148 := $or.i64($i145,$i147);
  $i148.shadow := $or.i64($i145.shadow,$i147.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $p149 := $add.ref($p0,$mul.ref(2,8));
  $p149.shadow := $add.ref($p0.shadow,$mul.ref(2,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  assert ($p149 == $p149.shadow);
  $M.0 := $store.i64($M.0,$p149,$i148);
  $M.0.shadow := $store.i64($M.0.shadow,$p149.shadow,$i148.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i150 := $and.i64($i142,17361641481138401520);
  $i150.shadow := $and.i64($i142.shadow,17361641481138401520);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i151 := $lshr.i64($i150,4);
  $i151.shadow := $lshr.i64($i150.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i152 := $and.i64($i144,17361641481138401520);
  $i152.shadow := $and.i64($i144.shadow,17361641481138401520);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i153 := $or.i64($i151,$i152);
  $i153.shadow := $or.i64($i151.shadow,$i152.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 232, 2} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb22;
$bb22:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb23:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $p155 := $add.ref($p0,$mul.ref(3,8));
  $p155.shadow := $add.ref($p0.shadow,$mul.ref(3,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  assert ($p155 == $p155.shadow);
  $i156 := $load.i64($M.0,$p155);
  $i156.shadow := $load.i64($M.0.shadow,$p155.shadow);
  call {:cexpr "a"} boogie_si_record_i64($i156);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $p157 := $add.ref($p0,$mul.ref(7,8));
  $p157.shadow := $add.ref($p0.shadow,$mul.ref(7,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  assert ($p157 == $p157.shadow);
  $i158 := $load.i64($M.0,$p157);
  $i158.shadow := $load.i64($M.0.shadow,$p157.shadow);
  call {:cexpr "b"} boogie_si_record_i64($i158);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i159 := $and.i64($i156,1085102592571150095);
  $i159.shadow := $and.i64($i156.shadow,1085102592571150095);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i160 := $and.i64($i158,1085102592571150095);
  $i160.shadow := $and.i64($i158.shadow,1085102592571150095);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i161 := $shl.i64($i160,4);
  $i161.shadow := $shl.i64($i160.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i162 := $or.i64($i159,$i161);
  $i162.shadow := $or.i64($i159.shadow,$i161.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $p163 := $add.ref($p0,$mul.ref(3,8));
  $p163.shadow := $add.ref($p0.shadow,$mul.ref(3,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  assert ($p163 == $p163.shadow);
  $M.0 := $store.i64($M.0,$p163,$i162);
  $M.0.shadow := $store.i64($M.0.shadow,$p163.shadow,$i162.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i164 := $and.i64($i156,17361641481138401520);
  $i164.shadow := $and.i64($i156.shadow,17361641481138401520);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i165 := $lshr.i64($i164,4);
  $i165.shadow := $lshr.i64($i164.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i166 := $and.i64($i158,17361641481138401520);
  $i166.shadow := $and.i64($i158.shadow,17361641481138401520);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i167 := $or.i64($i165,$i166);
  $i167.shadow := $or.i64($i165.shadow,$i166.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $p168 := $add.ref($p0,$mul.ref(7,8));
  $p168.shadow := $add.ref($p0.shadow,$mul.ref(7,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  assert ($p168 == $p168.shadow);
  $M.0 := $store.i64($M.0,$p168,$i167);
  $M.0.shadow := $store.i64($M.0.shadow,$p168.shadow,$i167.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 233, 2} true;
  assume {:verifier.code 0} true;
  goto $bb24;
$bb24:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 234, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const br_aes_ct64_interleave_in: ref;
axiom (br_aes_ct64_interleave_in == $sub.ref(0,5162));
procedure {:inline 1} br_aes_ct64_interleave_in($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.0, $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $i42.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 242, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 242, 7} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "x0"} boogie_si_record_i64($i5);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 243, 7} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p2,$mul.ref(1,4));
  $p6.shadow := $add.ref($p2.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 243, 7} true;
  assume {:verifier.code 0} true;
  assert ($p6 == $p6.shadow);
  $i7 := $load.i32($M.1,$p6);
  ...
  call {:cexpr "x1"} boogie_si_record_i64($i8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 244, 7} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p2,$mul.ref(2,4));
  $p9.shadow := $add.ref($p2.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 244, 7} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $i10 := $load.i32($M.1,$p9);
  ...
  call {:cexpr "x2"} boogie_si_record_i64($i11);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 245, 7} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p2,$mul.ref(3,4));
  $p12.shadow := $add.ref($p2.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 245, 7} true;
  assume {:verifier.code 0} true;
  assert ($p12 == $p12.shadow);
  $i13 := $load.i32($M.1,$p12);
  $i13.shadow := $load.i32($M.1.shadow,$p12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 245, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i32.i64($i13);
  $i14.shadow := $zext.i32.i64($i13.shadow);
  call {:cexpr "x3"} boogie_si_record_i64($i14);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 246, 12} true;
  assume {:verifier.code 0} true;
  $i15 := $shl.i64($i5,16);
  $i15.shadow := $shl.i64($i5.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 246, 5} true;
  assume {:verifier.code 0} true;
  $i16 := $or.i64($i5,$i15);
  $i16.shadow := $or.i64($i5.shadow,$i15.shadow);
  call {:cexpr "x0"} boogie_si_record_i64($i16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 247, 12} true;
  assume {:verifier.code 0} true;
  $i17 := $shl.i64($i8,16);
  $i17.shadow := $shl.i64($i8.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 247, 5} true;
  assume {:verifier.code 0} true;
  $i18 := $or.i64($i8,$i17);
  $i18.shadow := $or.i64($i8.shadow,$i17.shadow);
  call {:cexpr "x1"} boogie_si_record_i64($i18);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 248, 12} true;
  assume {:verifier.code 0} true;
  $i19 := $shl.i64($i11,16);
  $i19.shadow := $shl.i64($i11.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 248, 5} true;
  assume {:verifier.code 0} true;
  $i20 := $or.i64($i11,$i19);
  $i20.shadow := $or.i64($i11.shadow,$i19.shadow);
  call {:cexpr "x2"} boogie_si_record_i64($i20);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 249, 12} true;
  assume {:verifier.code 0} true;
  $i21 := $shl.i64($i14,16);
  $i21.shadow := $shl.i64($i14.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 249, 5} true;
  assume {:verifier.code 0} true;
  $i22 := $or.i64($i14,$i21);
  $i22.shadow := $or.i64($i14.shadow,$i21.shadow);
  call {:cexpr "x3"} boogie_si_record_i64($i22);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 250, 5} true;
  assume {:verifier.code 0} true;
  $i23 := $and.i64($i16,281470681808895);
  $i23.shadow := $and.i64($i16.shadow,281470681808895);
  call {:cexpr "x0"} boogie_si_record_i64($i23);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 251, 5} true;
  assume {:verifier.code 0} true;
  $i24 := $and.i64($i18,281470681808895);
  $i24.shadow := $and.i64($i18.shadow,281470681808895);
  call {:cexpr "x1"} boogie_si_record_i64($i24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 252, 5} true;
  assume {:verifier.code 0} true;
  $i25 := $and.i64($i20,281470681808895);
  $i25.shadow := $and.i64($i20.shadow,281470681808895);
  call {:cexpr "x2"} boogie_si_record_i64($i25);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 253, 5} true;
  assume {:verifier.code 0} true;
  $i26 := $and.i64($i22,281470681808895);
  $i26.shadow := $and.i64($i22.shadow,281470681808895);
  call {:cexpr "x3"} boogie_si_record_i64($i26);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 254, 12} true;
  assume {:verifier.code 0} true;
  $i27 := $shl.i64($i23,8);
  $i27.shadow := $shl.i64($i23.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 254, 5} true;
  assume {:verifier.code 0} true;
  $i28 := $or.i64($i23,$i27);
  $i28.shadow := $or.i64($i23.shadow,$i27.shadow);
  call {:cexpr "x0"} boogie_si_record_i64($i28);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 255, 12} true;
  assume {:verifier.code 0} true;
  $i29 := $shl.i64($i24,8);
  $i29.shadow := $shl.i64($i24.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 255, 5} true;
  assume {:verifier.code 0} true;
  $i30 := $or.i64($i24,$i29);
  $i30.shadow := $or.i64($i24.shadow,$i29.shadow);
  call {:cexpr "x1"} boogie_si_record_i64($i30);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 256, 12} true;
  assume {:verifier.code 0} true;
  $i31 := $shl.i64($i25,8);
  $i31.shadow := $shl.i64($i25.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 256, 5} true;
  assume {:verifier.code 0} true;
  $i32 := $or.i64($i25,$i31);
  $i32.shadow := $or.i64($i25.shadow,$i31.shadow);
  call {:cexpr "x2"} boogie_si_record_i64($i32);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 257, 12} true;
  assume {:verifier.code 0} true;
  $i33 := $shl.i64($i26,8);
  $i33.shadow := $shl.i64($i26.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 257, 5} true;
  assume {:verifier.code 0} true;
  $i34 := $or.i64($i26,$i33);
  $i34.shadow := $or.i64($i26.shadow,$i33.shadow);
  call {:cexpr "x3"} boogie_si_record_i64($i34);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 258, 5} true;
  assume {:verifier.code 0} true;
  $i35 := $and.i64($i28,71777214294589695);
  $i35.shadow := $and.i64($i28.shadow,71777214294589695);
  call {:cexpr "x0"} boogie_si_record_i64($i35);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 259, 5} true;
  assume {:verifier.code 0} true;
  $i36 := $and.i64($i30,71777214294589695);
  $i36.shadow := $and.i64($i30.shadow,71777214294589695);
  call {:cexpr "x1"} boogie_si_record_i64($i36);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 260, 5} true;
  assume {:verifier.code 0} true;
  $i37 := $and.i64($i32,71777214294589695);
  $i37.shadow := $and.i64($i32.shadow,71777214294589695);
  call {:cexpr "x2"} boogie_si_record_i64($i37);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 261, 5} true;
  assume {:verifier.code 0} true;
  $i38 := $and.i64($i34,71777214294589695);
  $i38.shadow := $and.i64($i34.shadow,71777214294589695);
  call {:cexpr "x3"} boogie_si_record_i64($i38);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 262, 17} true;
  assume {:verifier.code 0} true;
  $i39 := $shl.i64($i37,8);
  $i39.shadow := $shl.i64($i37.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 262, 11} true;
  assume {:verifier.code 0} true;
  $i40 := $or.i64($i35,$i39);
  $i40.shadow := $or.i64($i35.shadow,$i39.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 262, 6} true;
  assume {:verifier.code 0} true;
  assert ($p0 == $p0.shadow);
  $M.0 := $store.i64($M.0,$p0,$i40);
  $M.0.shadow := $store.i64($M.0.shadow,$p0.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 263, 17} true;
  assume {:verifier.code 0} true;
  $i41 := $shl.i64($i38,8);
  $i41.shadow := $shl.i64($i38.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 263, 11} true;
  assume {:verifier.code 0} true;
  $i42 := $or.i64($i36,$i41);
  $i42.shadow := $or.i64($i36.shadow,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 263, 6} true;
  assume {:verifier.code 0} true;
  assert ($p1 == $p1.shadow);
  $M.0 := $store.i64($M.0,$p1,$i42);
  $M.0.shadow := $store.i64($M.0.shadow,$p1.shadow,$i42.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 264, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const br_aes_ct64_keysched: ref;
axiom (br_aes_ct64_keysched == $sub.ref(0,6194));
procedure {:inline 1} br_aes_ct64_keysched($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $exn, $M.1, $M.0, $M.3;
modifies $CurrAddr;
{
  var $p3: ref;
  var $p3.shadow: ref;
...
$bb0:
  ...
  $p3.shadow := $p3;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(64,$zext.i32.i64(1)));
  $p4.shadow := $p4;
  call {:cexpr "br_aes_ct64_keysched:arg:key_len"} boogie_si_record_i64($i2);
  assume true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
  $i5 := $slt.i64($i2,24);
  $i5.shadow := $slt.i64($i2.shadow,24);
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  $i6 := $slt.i64($i2,32);
  $i6.shadow := $slt.i64($i2.shadow,32);
  assume {:verifier.code 0} true;
...
$bb6:
  assume ($i7 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 325, 3} true;
  assume {:verifier.code 0} true;
  $i10 := 14;
  $i10.shadow := 14;
  goto $bb13;
...
$bb9:
  assume ($i8 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 322, 3} true;
  assume {:verifier.code 0} true;
  $i10 := 12;
  $i10.shadow := 12;
  goto $bb13;
...
$bb11:
  assume ($i9 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 319, 3} true;
  assume {:verifier.code 0} true;
  $i10 := 10;
  $i10.shadow := 10;
  goto $bb13;
$bb12:
  ...
  goto $bb8;
$bb13:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 330, 21} true;
  assume {:verifier.code 0} true;
  $i12 := $lshr.i64($i2,2);
  $i12.shadow := $lshr.i64($i2.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 330, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i64.i32($i12);
  $i13.shadow := $trunc.i64.i32($i12.shadow);
  call {:cexpr "nk"} boogie_si_record_i32($i13);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 331, 26} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i10,1);
  $i14.shadow := $add.i32($i10.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 331, 31} true;
  assume {:verifier.code 0} true;
  $i15 := $shl.i32($i14,2);
  $i15.shadow := $shl.i32($i14.shadow,2);
  call {:cexpr "nkf"} boogie_si_record_i32($i15);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 332, 19} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p3,$mul.ref(0,240)),$mul.ref(0,4));
  $p16.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,240)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 332, 34} true;
  assume {:verifier.code 0} true;
  $i17 := $lshr.i64($i2,2);
  $i17.shadow := $lshr.i64($i2.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 332, 2} true;
  assume {:verifier.code 0} true;
  call br_range_dec32le($p16, $p16.shadow, $i17, $i17.shadow, $p1, $p1.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 333, 22} true;
  assume {:verifier.code 0} true;
  $i18 := $lshr.i64($i2,2);
  $i18.shadow := $lshr.i64($i2.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 333, 28} true;
  assume {:verifier.code 0} true;
  $i19 := $sub.i64($i18,1);
  $i19.shadow := $sub.i64($i18.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 333, 8} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p3,$mul.ref(0,240)),$mul.ref($i19,4));
  $p20.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,240)),$mul.ref($i19.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 333, 8} true;
  assume {:verifier.code 0} true;
  assert ($p20 == $p20.shadow);
  $i21 := $load.i32($M.1,$p20);
  $i21.shadow := $load.i32($M.1.shadow,$p20.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i21);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 334, 7} true;
  assume {:verifier.code 0} true;
  $i22 := $i13;
  $i22.shadow := $i13.shadow;
  $i23 := 0;
  $i23.shadow := 0;
  $i24 := 0;
  $i24.shadow := 0;
  ...
  goto $bb16;
$bb14:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 328, 3} true;
  assume {:verifier.code 0} true;
  $i11 := 0;
  $i11.shadow := 0;
  goto $bb15;
$bb15:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 372, 1} true;
  assume {:verifier.code 0} true;
  $r := $i11;
  $r.shadow := $i11.shadow;
  $exn := false;
...
$bb16:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 334, 31} true;
  assume {:verifier.code 0} true;
  $i26 := $slt.i32($i22,$i15);
  $i26.shadow := $slt.i32($i22.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 334, 2} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume ($i26 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 335, 9} true;
  assume {:verifier.code 0} true;
  $i27 := $eq.i32($i23,0);
  $i27.shadow := $eq.i32($i23.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 335, 7} true;
  assume {:verifier.code 0} true;
...
$bb18:
  assume !($i26 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 349, 7} true;
  assume {:verifier.code 0} true;
  $i55 := 0;
  $i55.shadow := 0;
  $i56 := 0;
...
$bb19:
  assume ($i27 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 336, 15} true;
  assume {:verifier.code 0} true;
  $i28 := $shl.i32($i25,24);
  $i28.shadow := $shl.i32($i25.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 336, 29} true;
  assume {:verifier.code 0} true;
  $i29 := $lshr.i32($i25,8);
  $i29.shadow := $lshr.i32($i25.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 336, 22} true;
  assume {:verifier.code 0} true;
  $i30 := $or.i32($i28,$i29);
  $i30.shadow := $or.i32($i28.shadow,$i29.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i30);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 337, 10} true;
  assume {:verifier.code 0} true;
  call $i31, $i31.shadow := sub_word($i30, $i30.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 337, 26} true;
  assume {:verifier.code 0} true;
  $i32 := $sext.i32.i64($i24);
  $i32.shadow := $sext.i32.i64($i24.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 337, 26} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref($i32,1));
  $p33.shadow := $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref($i32.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 337, 26} true;
  assume {:verifier.code 0} true;
  assert ($p33 == $p33.shadow);
  $i34 := $load.i8($M.2,$p33);
  $i34.shadow := $load.i8($M.2.shadow,$p33.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 337, 26} true;
  assume {:verifier.code 0} true;
  $i35 := $zext.i8.i32($i34);
  $i35.shadow := $zext.i8.i32($i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 337, 24} true;
  assume {:verifier.code 0} true;
  $i36 := $xor.i32($i31,$i35);
  $i36.shadow := $xor.i32($i31.shadow,$i35.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i36);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 338, 3} true;
  assume {:verifier.code 0} true;
  $i37 := $i36;
  $i37.shadow := $i36.shadow;
  goto $bb21;
$bb20:
  assume !($i27 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 338, 17} true;
  assume {:verifier.code 0} true;
  $i38 := $sgt.i32($i13,6);
  $i38.shadow := $sgt.i32($i13.shadow,6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 338, 21} true;
  assume {:verifier.code 0} true;
  $i39 := $i25;
  $i39.shadow := $i25.shadow;
  assume {:branchcond $i38} true;
  assert ($i38 == $i38.shadow);
  goto $bb22, $bb23;
$bb21:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 341, 17} true;
  assume {:verifier.code 0} true;
  $i42 := $sub.i32($i22,$i13);
  $i42.shadow := $sub.i32($i22.shadow,$i13.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 341, 10} true;
  assume {:verifier.code 0} true;
  $i43 := $sext.i32.i64($i42);
  $i43.shadow := $sext.i32.i64($i42.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 341, 10} true;
  assume {:verifier.code 0} true;
  $p44 := $add.ref($add.ref($p3,$mul.ref(0,240)),$mul.ref($i43,4));
  $p44.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,240)),$mul.ref($i43.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 341, 10} true;
  assume {:verifier.code 0} true;
  assert ($p44 == $p44.shadow);
  $i45 := $load.i32($M.1,$p44);
  $i45.shadow := $load.i32($M.1.shadow,$p44.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 341, 7} true;
  assume {:verifier.code 0} true;
  $i46 := $xor.i32($i37,$i45);
  $i46.shadow := $xor.i32($i37.shadow,$i45.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i46);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 342, 3} true;
  assume {:verifier.code 0} true;
  $i47 := $sext.i32.i64($i22);
  $i47.shadow := $sext.i32.i64($i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 342, 3} true;
  assume {:verifier.code 0} true;
  $p48 := $add.ref($add.ref($p3,$mul.ref(0,240)),$mul.ref($i47,4));
  $p48.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,240)),$mul.ref($i47.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 342, 11} true;
  assume {:verifier.code 0} true;
  assert ($p48 == $p48.shadow);
  $M.1 := $store.i32($M.1,$p48,$i46);
  $M.1.shadow := $store.i32($M.1.shadow,$p48.shadow,$i46.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 343, 7} true;
  assume {:verifier.code 0} true;
  $i49 := $add.i32($i23,1);
  $i49.shadow := $add.i32($i23.shadow,1);
  call {:cexpr "j"} boogie_si_record_i32($i49);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 343, 12} true;
  assume {:verifier.code 0} true;
  $i50 := $eq.i32($i49,$i13);
  $i50.shadow := $eq.i32($i49.shadow,$i13.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 343, 7} true;
  assume {:verifier.code 0} true;
  $i51 := $i49;
  $i51.shadow := $i49.shadow;
  $i52 := $i24;
  $i52.shadow := $i24.shadow;
  assume {:branchcond $i50} true;
  assert ($i50 == $i50.shadow);
  goto $bb27, $bb28;
$bb22:
  assume ($i38 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 338, 26} true;
  assume {:verifier.code 0} true;
  $i40 := $eq.i32($i23,4);
  $i40.shadow := $eq.i32($i23.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 338, 14} true;
  assume {:verifier.code 0} true;
  $i39 := $i25;
  $i39.shadow := $i25.shadow;
...
$bb25:
  assume ($i40 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 339, 10} true;
  assume {:verifier.code 0} true;
  call $i41, $i41.shadow := sub_word($i25, $i25.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i41);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 340, 3} true;
  assume {:verifier.code 0} true;
  $i39 := $i41;
  $i39.shadow := $i41.shadow;
  goto $bb24;
$bb26:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 338, 14} true;
  assume {:verifier.code 0} true;
...
$bb27:
  assume ($i50 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 345, 6} true;
  assume {:verifier.code 0} true;
  $i53 := $add.i32($i24,1);
  $i53.shadow := $add.i32($i24.shadow,1);
  call {:cexpr "k"} boogie_si_record_i32($i53);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 346, 3} true;
  assume {:verifier.code 0} true;
  $i51 := 0;
  $i51.shadow := 0;
  $i52 := $i53;
  $i52.shadow := $i53.shadow;
  goto $bb29;
$bb28:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 343, 7} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 347, 2} true;
  assume {:verifier.code 0} true;
  goto $bb30;
$bb30:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 334, 40} true;
  assume {:verifier.code 0} true;
  $i54 := $add.i32($i22,1);
  $i54.shadow := $add.i32($i22.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i54);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 334, 2} true;
  assume {:verifier.code 0} true;
  $i22 := $i54;
  $i22.shadow := $i54.shadow;
  $i23 := $i51;
  $i23.shadow := $i51.shadow;
  $i24 := $i52;
  $i24.shadow := $i52.shadow;
  $i25 := $i46;
  $i25.shadow := $i46.shadow;
  goto $bb16;
$bb31:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i56 == $i56.shadow);
  assert {:shadow_invariant} ($p4 == $p4.shadow);
  assert {:shadow_invariant} ($i55 == $i55.shadow);
  assert {:shadow_invariant} ($i10 == $i10.shadow);
  assert {:shadow_invariant} ($i15 == $i15.shadow);
  assert {:shadow_invariant} ($p3 == $p3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 0, 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 349, 23} true;
  assume {:verifier.code 0} true;
  $i57 := $slt.i32($i55,$i15);
  $i57.shadow := $slt.i32($i55.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 349, 2} true;
  assume {:verifier.code 0} true;
...
$bb32:
  assume ($i57 == 1);
  assume true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 352, 30} true;
  assume {:verifier.code 0} true;
  $p58 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(0,8));
  $p58.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 352, 37} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(4,8));
  $p59.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(4,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 352, 43} true;
  assume {:verifier.code 0} true;
  $p60 := $add.ref($add.ref($p3,$mul.ref(0,240)),$mul.ref(0,4));
  $p60.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,240)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 352, 48} true;
  assume {:verifier.code 0} true;
  $i61 := $sext.i32.i64($i55);
  $i61.shadow := $sext.i32.i64($i55.shadow);
  $p62 := $add.ref($add.ref($p3,$mul.ref(0,240)),$mul.ref($i61,4));
  $p62.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,240)),$mul.ref($i61.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 352, 3} true;
  assume {:verifier.code 0} true;
  call br_aes_ct64_interleave_in($p58, $p58.shadow, $p59, $p59.shadow, $p62, $p62.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 353, 10} true;
  assume {:verifier.code 0} true;
  $p63 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(0,8));
  $p63.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 353, 10} true;
  assume {:verifier.code 0} true;
  assert ($p63 == $p63.shadow);
  $i64 := $load.i64($M.0,$p63);
  $i64.shadow := $load.i64($M.0.shadow,$p63.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 353, 3} true;
  assume {:verifier.code 0} true;
  $p65 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(1,8));
  $p65.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(1,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 353, 8} true;
  assume {:verifier.code 0} true;
  assert ($p65 == $p65.shadow);
  $M.0 := $store.i64($M.0,$p65,$i64);
  $M.0.shadow := $store.i64($M.0.shadow,$p65.shadow,$i64.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 354, 10} true;
  assume {:verifier.code 0} true;
  $p66 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(0,8));
  $p66.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 354, 10} true;
  assume {:verifier.code 0} true;
  assert ($p66 == $p66.shadow);
  $i67 := $load.i64($M.0,$p66);
  $i67.shadow := $load.i64($M.0.shadow,$p66.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 354, 3} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(2,8));
  $p68.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(2,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 354, 8} true;
  assume {:verifier.code 0} true;
  assert ($p68 == $p68.shadow);
  $M.0 := $store.i64($M.0,$p68,$i67);
  $M.0.shadow := $store.i64($M.0.shadow,$p68.shadow,$i67.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 355, 10} true;
  assume {:verifier.code 0} true;
  $p69 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(0,8));
  $p69.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 355, 10} true;
  assume {:verifier.code 0} true;
  assert ($p69 == $p69.shadow);
  $i70 := $load.i64($M.0,$p69);
  $i70.shadow := $load.i64($M.0.shadow,$p69.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 355, 3} true;
  assume {:verifier.code 0} true;
  $p71 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(3,8));
  $p71.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(3,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 355, 8} true;
  assume {:verifier.code 0} true;
  assert ($p71 == $p71.shadow);
  $M.0 := $store.i64($M.0,$p71,$i70);
  $M.0.shadow := $store.i64($M.0.shadow,$p71.shadow,$i70.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 356, 10} true;
  assume {:verifier.code 0} true;
  $p72 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(4,8));
  $p72.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(4,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 356, 10} true;
  assume {:verifier.code 0} true;
  assert ($p72 == $p72.shadow);
  $i73 := $load.i64($M.0,$p72);
  $i73.shadow := $load.i64($M.0.shadow,$p72.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 356, 3} true;
  assume {:verifier.code 0} true;
  $p74 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(5,8));
  $p74.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(5,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 356, 8} true;
  assume {:verifier.code 0} true;
  assert ($p74 == $p74.shadow);
  $M.0 := $store.i64($M.0,$p74,$i73);
  $M.0.shadow := $store.i64($M.0.shadow,$p74.shadow,$i73.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 357, 10} true;
  assume {:verifier.code 0} true;
  $p75 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(4,8));
  $p75.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(4,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 357, 10} true;
  assume {:verifier.code 0} true;
  assert ($p75 == $p75.shadow);
  $i76 := $load.i64($M.0,$p75);
  $i76.shadow := $load.i64($M.0.shadow,$p75.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 357, 3} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(6,8));
  $p77.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(6,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 357, 8} true;
  assume {:verifier.code 0} true;
  assert ($p77 == $p77.shadow);
  $M.0 := $store.i64($M.0,$p77,$i76);
  $M.0.shadow := $store.i64($M.0.shadow,$p77.shadow,$i76.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 358, 10} true;
  assume {:verifier.code 0} true;
  $p78 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(4,8));
  $p78.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(4,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 358, 10} true;
  assume {:verifier.code 0} true;
  assert ($p78 == $p78.shadow);
  $i79 := $load.i64($M.0,$p78);
  $i79.shadow := $load.i64($M.0.shadow,$p78.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 358, 3} true;
  assume {:verifier.code 0} true;
  $p80 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(7,8));
  $p80.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(7,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 358, 8} true;
  assume {:verifier.code 0} true;
  assert ($p80 == $p80.shadow);
  $M.0 := $store.i64($M.0,$p80,$i79);
  $M.0.shadow := $store.i64($M.0.shadow,$p80.shadow,$i79.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 359, 21} true;
  assume {:verifier.code 0} true;
  $p81 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(0,8));
  $p81.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 359, 3} true;
  assume {:verifier.code 0} true;
  call br_aes_ct64_ortho($p81, $p81.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 361, 7} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(0,8));
  $p82.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 361, 7} true;
  assume {:verifier.code 0} true;
  assert ($p82 == $p82.shadow);
  $i83 := $load.i64($M.0,$p82);
  $i83.shadow := $load.i64($M.0.shadow,$p82.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 361, 12} true;
  assume {:verifier.code 0} true;
  $i84 := $and.i64($i83,1229782938247303441);
  $i84.shadow := $and.i64($i83.shadow,1229782938247303441);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 362, 7} true;
  assume {:verifier.code 0} true;
  $p85 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(1,8));
  $p85.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(1,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 362, 7} true;
  assume {:verifier.code 0} true;
  assert ($p85 == $p85.shadow);
  $i86 := $load.i64($M.0,$p85);
  $i86.shadow := $load.i64($M.0.shadow,$p85.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 362, 12} true;
  assume {:verifier.code 0} true;
  $i87 := $and.i64($i86,2459565876494606882);
  $i87.shadow := $and.i64($i86.shadow,2459565876494606882);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 362, 4} true;
  assume {:verifier.code 0} true;
  $i88 := $or.i64($i84,$i87);
  $i88.shadow := $or.i64($i84.shadow,$i87.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 363, 7} true;
  assume {:verifier.code 0} true;
  $p89 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(2,8));
  $p89.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(2,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 363, 7} true;
  assume {:verifier.code 0} true;
  assert ($p89 == $p89.shadow);
  $i90 := $load.i64($M.0,$p89);
  $i90.shadow := $load.i64($M.0.shadow,$p89.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 363, 12} true;
  assume {:verifier.code 0} true;
  $i91 := $and.i64($i90,4919131752989213764);
  $i91.shadow := $and.i64($i90.shadow,4919131752989213764);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 363, 4} true;
  assume {:verifier.code 0} true;
  $i92 := $or.i64($i88,$i91);
  $i92.shadow := $or.i64($i88.shadow,$i91.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 364, 7} true;
  assume {:verifier.code 0} true;
  $p93 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(3,8));
  $p93.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(3,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 364, 7} true;
  assume {:verifier.code 0} true;
  assert ($p93 == $p93.shadow);
  $i94 := $load.i64($M.0,$p93);
  $i94.shadow := $load.i64($M.0.shadow,$p93.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 364, 12} true;
  assume {:verifier.code 0} true;
  $i95 := $and.i64($i94,9838263505978427528);
  $i95.shadow := $and.i64($i94.shadow,9838263505978427528);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 364, 4} true;
  assume {:verifier.code 0} true;
  $i96 := $or.i64($i92,$i95);
  $i96.shadow := $or.i64($i92.shadow,$i95.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 360, 15} true;
  assume {:verifier.code 0} true;
  $i97 := $add.i32($i56,0);
  $i97.shadow := $add.i32($i56.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 360, 3} true;
  assume {:verifier.code 0} true;
  $i98 := $sext.i32.i64($i97);
  $i98.shadow := $sext.i32.i64($i97.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 360, 3} true;
  assume {:verifier.code 0} true;
  $p99 := $add.ref($p0,$mul.ref($i98,8));
  $p99.shadow := $add.ref($p0.shadow,$mul.ref($i98.shadow,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 360, 20} true;
  assume {:verifier.code 0} true;
  assert ($p99 == $p99.shadow);
  $M.3 := $store.i64($M.3,$p99,$i96);
  $M.3.shadow := $store.i64($M.3.shadow,$p99.shadow,$i96.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 366, 7} true;
  assume {:verifier.code 0} true;
  $p100 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(4,8));
  $p100.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(4,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 366, 7} true;
  assume {:verifier.code 0} true;
  assert ($p100 == $p100.shadow);
  $i101 := $load.i64($M.0,$p100);
  $i101.shadow := $load.i64($M.0.shadow,$p100.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 366, 12} true;
  assume {:verifier.code 0} true;
  $i102 := $and.i64($i101,1229782938247303441);
  $i102.shadow := $and.i64($i101.shadow,1229782938247303441);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 367, 7} true;
  assume {:verifier.code 0} true;
  $p103 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(5,8));
  $p103.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(5,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 367, 7} true;
  assume {:verifier.code 0} true;
  assert ($p103 == $p103.shadow);
  $i104 := $load.i64($M.0,$p103);
  $i104.shadow := $load.i64($M.0.shadow,$p103.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 367, 12} true;
  assume {:verifier.code 0} true;
  $i105 := $and.i64($i104,2459565876494606882);
  $i105.shadow := $and.i64($i104.shadow,2459565876494606882);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 367, 4} true;
  assume {:verifier.code 0} true;
  $i106 := $or.i64($i102,$i105);
  $i106.shadow := $or.i64($i102.shadow,$i105.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 368, 7} true;
  assume {:verifier.code 0} true;
  $p107 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(6,8));
  $p107.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(6,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 368, 7} true;
  assume {:verifier.code 0} true;
  assert ($p107 == $p107.shadow);
  $i108 := $load.i64($M.0,$p107);
  $i108.shadow := $load.i64($M.0.shadow,$p107.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 368, 12} true;
  assume {:verifier.code 0} true;
  $i109 := $and.i64($i108,4919131752989213764);
  $i109.shadow := $and.i64($i108.shadow,4919131752989213764);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 368, 4} true;
  assume {:verifier.code 0} true;
  $i110 := $or.i64($i106,$i109);
  $i110.shadow := $or.i64($i106.shadow,$i109.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 369, 7} true;
  assume {:verifier.code 0} true;
  $p111 := $add.ref($add.ref($p4,$mul.ref(0,64)),$mul.ref(7,8));
  $p111.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,64)),$mul.ref(7,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 369, 7} true;
  assume {:verifier.code 0} true;
  assert ($p111 == $p111.shadow);
  $i112 := $load.i64($M.0,$p111);
  $i112.shadow := $load.i64($M.0.shadow,$p111.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 369, 12} true;
  assume {:verifier.code 0} true;
  $i113 := $and.i64($i112,9838263505978427528);
  $i113.shadow := $and.i64($i112.shadow,9838263505978427528);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 369, 4} true;
  assume {:verifier.code 0} true;
  $i114 := $or.i64($i110,$i113);
  $i114.shadow := $or.i64($i110.shadow,$i113.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 365, 15} true;
  assume {:verifier.code 0} true;
  $i115 := $add.i32($i56,1);
  $i115.shadow := $add.i32($i56.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 365, 3} true;
  assume {:verifier.code 0} true;
  $i116 := $sext.i32.i64($i115);
  $i116.shadow := $sext.i32.i64($i115.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 365, 3} true;
  assume {:verifier.code 0} true;
  $p117 := $add.ref($p0,$mul.ref($i116,8));
  $p117.shadow := $add.ref($p0.shadow,$mul.ref($i116.shadow,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 365, 20} true;
  assume {:verifier.code 0} true;
  assert ($p117 == $p117.shadow);
  $M.3 := $store.i64($M.3,$p117,$i114);
  $M.3.shadow := $store.i64($M.3.shadow,$p117.shadow,$i114.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 370, 2} true;
  assume {:verifier.code 0} true;
  goto $bb34;
$bb33:
  assume !($i57 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 371, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i10;
  $i11.shadow := $i10.shadow;
  goto $bb15;
$bb34:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 349, 32} true;
  assume {:verifier.code 0} true;
  $i118 := $add.i32($i55,4);
  $i118.shadow := $add.i32($i55.shadow,4);
  call {:cexpr "i"} boogie_si_record_i32($i118);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 349, 40} true;
  assume {:verifier.code 0} true;
  $i119 := $add.i32($i56,2);
  $i119.shadow := $add.i32($i56.shadow,2);
  call {:cexpr "j"} boogie_si_record_i32($i119);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 349, 2} true;
  assume {:verifier.code 0} true;
  $i55 := $i118;
  $i55.shadow := $i118.shadow;
  $i56 := $i119;
  $i56.shadow := $i119.shadow;
  goto $bb31;
}
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0,7226));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const br_range_dec32le: ref;
axiom (br_range_dec32le == $sub.ref(0,8258));
procedure {:inline 1} br_range_dec32le($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64, $p2: ref, $p2.shadow: ref);
const sub_word: ref;
axiom (sub_word == $sub.ref(0,9290));
procedure {:inline 1} sub_word($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $M.0, $exn;
modifies $CurrAddr;
{
  var $p1: ref;
  ...
  var $i11.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 299, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p1 := $alloc($mul.ref(64,$zext.i32.i64(1)));
  $p1.shadow := $p1;
  call {:cexpr "sub_word:arg:x"} boogie_si_record_i32($i0);
  assume true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 299, 2} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref($p1,$mul.ref(0,64)),$mul.ref(0,8));
  $p2.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 299, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assert ($p3 == $p3.shadow);
  call $M.0, $M.0.shadow := $memset.i8($M.0, $M.0.shadow, $p3, $p3.shadow, 0, 0, 64, 64, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 300, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i32.i64($i0);
  $i4.shadow := $zext.i32.i64($i0.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 300, 2} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p1,$mul.ref(0,64)),$mul.ref(0,8));
  $p5.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 300, 7} true;
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $M.0 := $store.i64($M.0,$p5,$i4);
  $M.0.shadow := $store.i64($M.0.shadow,$p5.shadow,$i4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 301, 20} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p1,$mul.ref(0,64)),$mul.ref(0,8));
  $p6.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 301, 2} true;
  assume {:verifier.code 0} true;
  call br_aes_ct64_ortho($p6, $p6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 302, 28} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p1,$mul.ref(0,64)),$mul.ref(0,8));
  $p7.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 302, 2} true;
  assume {:verifier.code 0} true;
  call br_aes_ct64_bitslice_Sbox($p7, $p7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 303, 20} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p1,$mul.ref(0,64)),$mul.ref(0,8));
  $p8.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 303, 2} true;
  assume {:verifier.code 0} true;
  call br_aes_ct64_ortho($p8, $p8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 304, 19} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p1,$mul.ref(0,64)),$mul.ref(0,8));
  $p9.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 304, 19} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $i10 := $load.i64($M.0,$p9);
  $i10.shadow := $load.i64($M.0.shadow,$p9.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 304, 9} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i64.i32($i10);
  $i11.shadow := $trunc.i64.i32($i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64.c", 304, 2} true;
  assume {:verifier.code 0} true;
  $r := $i11;
  $r.shadow := $i11.shadow;
  $exn := false;
...
axiom (llvm.memset.p0i8.i64 == $sub.ref(0,10322));
procedure {:inline 1} llvm.memset.p0i8.i64($p0: ref, $p0.shadow: ref, $i1: i8, $i1.shadow: i8, $i2: i64, $i2.shadow: i64, $i3: i1, $i3.shadow: i1);
const key_sched_wrapper: ref;
axiom (key_sched_wrapper == $sub.ref(0,11354));
procedure {:entrypoint} key_sched_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64)
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "key_sched.c", 4, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:key_sched_wrapper"} boogie_si_record_ref(key_sched_wrapper);
  call {:cexpr "smack:arg:key_sched_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:key_sched_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:key_sched_wrapper:$i2"} boogie_si_record_i64($i2);
  call {:cexpr "key_sched_wrapper:arg:key_len"} boogie_si_record_i64($i2);
  assume {:sourceloc "key_sched.c", 4, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "key_sched.c", 4, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p3, $p3.shadow);
  assume {:sourceloc "key_sched.c", 5, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p4 := __SMACK_value.ref($p1);
  $p4.shadow := $p4;
  assume $isExternal($p4);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p4);
  assume {:sourceloc "key_sched.c", 5, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "key_sched.c", 6, 12} true;
  assume {:verifier.code 0} true;
  call {:name $i2} $p5 := __SMACK_value.i64($i2);
  $p5.shadow := $p5;
  assume $isExternal($p5);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p5);
  assume {:sourceloc "key_sched.c", 6, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "key_sched.c", 8, 23} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p0);
  $p6.shadow := $bitcast.ref.ref($p0.shadow);
  assume {:sourceloc "key_sched.c", 8, 2} true;
  assume {:verifier.code 0} true;
  call $i7, $i7.shadow := br_aes_ct64_keysched($p6, $p6.shadow, $p1, $p1.shadow, $i2, $i2.shadow);
  assume {:sourceloc "key_sched.c", 9, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
...
axiom (__SMACK_dummy == $sub.ref(0,16514));
...
axiom (__SMACK_and32 == $sub.ref(0,17546));
...
axiom (__SMACK_and64 == $sub.ref(0,18578));
...
axiom (__SMACK_and16 == $sub.ref(0,19610));
...
axiom (__SMACK_and8 == $sub.ref(0,20642));
...
axiom (__SMACK_or32 == $sub.ref(0,21674));
...
axiom (__SMACK_or64 == $sub.ref(0,22706));
...
axiom (__SMACK_or16 == $sub.ref(0,23738));
...
axiom (__SMACK_or8 == $sub.ref(0,24770));
...
axiom (__SMACK_check_overflow == $sub.ref(0,25802));
...
axiom (__SMACK_loop_exit == $sub.ref(0,26834));
...
axiom (__SMACK_decls == $sub.ref(0,27866));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,28898));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,29930));
...
axiom (__SMACK_static_init == $sub.ref(0,30962));
procedure {:inline 1} __SMACK_static_init()
modifies $M.2, $exn;
{
$bb0:
  assert (Rcon == Rcon);
  $M.2 := $store.i8($M.2,Rcon,1);
  $M.2.shadow := $store.i8($M.2.shadow,Rcon,1);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(1,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(1,1)));
  $M.2 := $store.i8($M.2,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(1,1)),2);
  $M.2.shadow := $store.i8($M.2.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(1,1)),2);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(2,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(2,1)));
  $M.2 := $store.i8($M.2,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(2,1)),4);
  $M.2.shadow := $store.i8($M.2.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(2,1)),4);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(3,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(3,1)));
  $M.2 := $store.i8($M.2,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(3,1)),8);
  $M.2.shadow := $store.i8($M.2.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(3,1)),8);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(4,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(4,1)));
  $M.2 := $store.i8($M.2,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(4,1)),16);
  $M.2.shadow := $store.i8($M.2.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(4,1)),16);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(5,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(5,1)));
  $M.2 := $store.i8($M.2,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(5,1)),32);
  $M.2.shadow := $store.i8($M.2.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(5,1)),32);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(6,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(6,1)));
  $M.2 := $store.i8($M.2,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(6,1)),64);
  $M.2.shadow := $store.i8($M.2.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(6,1)),64);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(7,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(7,1)));
  $M.2 := $store.i8($M.2,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(7,1)),$sub.i8(0,128));
  $M.2.shadow := $store.i8($M.2.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(7,1)),$sub.i8(0,128));
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(8,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(8,1)));
  $M.2 := $store.i8($M.2,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(8,1)),27);
  $M.2.shadow := $store.i8($M.2.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(8,1)),27);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(9,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(9,1)));
  $M.2 := $store.i8($M.2,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(9,1)),54);
  $M.2.shadow := $store.i8($M.2.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(9,1)),54);
  $exn := false;
  $exn.shadow := false;
  return;
}
