...
procedure {:inline 1} br_aes_ct64_bitslice_encrypt($i0: i32, $i0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1)
modifies $exn;
modifies $M.0;
{
  var $i3: i32;
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  call add_round_key($p2, $p2.dup, $p7, $p7.dup);
...
$bb0:
  ...
  $M.0.dup := $store.i1($M.0.dup,$p4,$i6.dup);
  ...
  $M.0.dup := $store.i1($M.0.dup,$p9,$i11.dup);
  ...
  assume {:verifier.code 0} true;
  $i16 := $xor.i64($i15,$i13);
  $i16.dup := $or.i1($i15.dup,$i13.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64_enc.c", 32, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p14.dup == 0));
  $M.0 := $store.i64($M.0,$p14,$i16);
  $M.0.dup := $store.i1($M.0.dup,$p14,$i16.dup);
  ...
  assume {:verifier.code 0} true;
  $i21 := $xor.i64($i20,$i18);
  $i21.dup := $or.i1($i20.dup,$i18.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64_enc.c", 33, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p19.dup == 0));
  $M.0 := $store.i64($M.0,$p19,$i21);
  $M.0.dup := $store.i1($M.0.dup,$p19,$i21.dup);
  ...
  assume {:verifier.code 0} true;
  $i26 := $xor.i64($i25,$i23);
  $i26.dup := $or.i1($i25.dup,$i23.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64_enc.c", 34, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p24.dup == 0));
  $M.0 := $store.i64($M.0,$p24,$i26);
  $M.0.dup := $store.i1($M.0.dup,$p24,$i26.dup);
  ...
  assume {:verifier.code 0} true;
  $i31 := $xor.i64($i30,$i28);
  $i31.dup := $or.i1($i30.dup,$i28.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct64_enc.c", 35, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p29.dup == 0));
  $M.0 := $store.i64($M.0,$p29,$i31);
  $M.0.dup := $store.i1($M.0.dup,$p29,$i31.dup);
  ...
  $M.0.dup := $store.i1($M.0.dup,$p34,$i36.dup);
...
procedure {:inline 1} shift_rows($p0: ref, $p0.dup: i1)
modifies $M.0, $exn;
{
  var $i1: i32;
  var $i1.dup: i1;
...
procedure {:inline 1} mix_columns($p0: ref, $p0.dup: i1)
modifies $M.0, $exn;
{
  var $p1: ref;
  var $p1.dup: i1;
...
procedure {:entrypoint} bitslice_encrypt_wrapper($i0: i32, $i0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1)
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_aes_ct64_bitslice_encrypt($i0, $i0.dup, $p7, $p7.dup, $p8, $p8.dup);
