...
const {:allocSize 0} br_aes_S: ref;
axiom (br_aes_S == $add.ref($GLOBALS_BOTTOM,$sub.ref(0,32776)));
...
const br_aes_small_encrypt: ref;
axiom (br_aes_small_encrypt == $sub.ref(0,3096));
procedure {:inline 1} br_aes_small_encrypt($i0: i32, $i0.shadow: i32, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
...
modifies $CurrAddr;
{
  ...
  var $i38.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 113, 7} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(64,$zext.i32.i64(1)));
  $p3.shadow := $p3;
  call {:cexpr "br_aes_small_encrypt:arg:num_rounds"} boogie_si_record_i32($i0);
  assume true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 113, 7} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 113, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i4,16);
  $i5.shadow := $ult.i32($i4.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 113, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 114, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i32.i64($i4);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 114, 3} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i32.i64($i4);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 114, 12} true;
  assume {:verifier.code 0} true;
  assert ($p11 == $p11.shadow);
  $M.1 := $store.i32($M.1,$p11,$i9);
  $M.1.shadow := $store.i32($M.1.shadow,$p11.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 115, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i5 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 116, 16} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p13.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 116, 2} true;
  assume {:verifier.code 0} true;
  call add_round_key.7($p13, $p13.shadow, $p1, $p1.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 117, 7} true;
  assume {:verifier.code 0} true;
  $i14 := 1;
  $i14.shadow := 1;
  goto $bb5;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 113, 24} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i4,1);
...
$bb5:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 117, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $ult.i32($i14,$i0);
  $i15.shadow := $ult.i32($i14.shadow,$i0.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 117, 2} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume ($i15 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 118, 13} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p16.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 118, 3} true;
  assume {:verifier.code 0} true;
  call sub_bytes($p16, $p16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 119, 14} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p17.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 119, 3} true;
  assume {:verifier.code 0} true;
  call shift_rows($p17, $p17.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 120, 15} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p18.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 120, 3} true;
  assume {:verifier.code 0} true;
  call mix_columns($p18, $p18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 121, 17} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p19.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 121, 34} true;
  assume {:verifier.code 0} true;
  $i20 := $shl.i32($i14,2);
  $i20.shadow := $shl.i32($i14.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 121, 29} true;
  assume {:verifier.code 0} true;
  ...
  $p22.shadow := $add.ref($p1.shadow,$mul.ref($i21.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 121, 3} true;
  assume {:verifier.code 0} true;
  call add_round_key.7($p19, $p19.shadow, $p22, $p22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 122, 2} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume !($i15 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 123, 12} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p24.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 123, 2} true;
  assume {:verifier.code 0} true;
  call sub_bytes($p24, $p24.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 124, 13} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p25.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 124, 2} true;
  assume {:verifier.code 0} true;
  call shift_rows($p25, $p25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 125, 16} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p26.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 125, 42} true;
  assume {:verifier.code 0} true;
  $i27 := $shl.i32($i0,2);
  $i27.shadow := $shl.i32($i0.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 125, 28} true;
  assume {:verifier.code 0} true;
  ...
  $p29.shadow := $add.ref($p1.shadow,$mul.ref($i28.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 125, 2} true;
  assume {:verifier.code 0} true;
  call add_round_key.7($p26, $p26.shadow, $p29, $p29.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 126, 7} true;
  assume {:verifier.code 0} true;
  $i30 := 0;
  $i30.shadow := 0;
  goto $bb9;
$bb8:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 117, 32} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i14,1);
  $i23.shadow := $add.i32($i14.shadow,1);
  call {:cexpr "u"} boogie_si_record_i32($i23);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 117, 2} true;
  assume {:verifier.code 0} true;
  $i14 := $i23;
  $i14.shadow := $i23.shadow;
  goto $bb5;
$bb9:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i30 == $i30.shadow);
  assert {:shadow_invariant} ($p3 == $p3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 126, 16} true;
  assume {:verifier.code 0} true;
  $i31 := $ult.i32($i30,16);
  $i31.shadow := $ult.i32($i30.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 126, 2} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i31 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 127, 12} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i32.i64($i30);
  $i32.shadow := $zext.i32.i64($i30.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 127, 12} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref($i32,4));
  $p33.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref($i32.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 127, 12} true;
  assume {:verifier.code 0} true;
  ...
  $i35.shadow := $trunc.i32.i8($i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 127, 3} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i32.i64($i30);
  $i36.shadow := $zext.i32.i64($i30.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 127, 3} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($p2,$mul.ref($i36,1));
  $p37.shadow := $add.ref($p2.shadow,$mul.ref($i36.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 127, 10} true;
  assume {:verifier.code 0} true;
  assert ($p37 == $p37.shadow);
  $M.0 := $store.i8($M.0,$p37,$i35);
  $M.0.shadow := $store.i8($M.0.shadow,$p37.shadow,$i35.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 128, 2} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume !($i31 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 129, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb12:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 126, 24} true;
  assume {:verifier.code 0} true;
  $i38 := $add.i32($i30,1);
  $i38.shadow := $add.i32($i30.shadow,1);
  call {:cexpr "u"} boogie_si_record_i32($i38);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 126, 2} true;
  assume {:verifier.code 0} true;
  $i30 := $i38;
  $i30.shadow := $i38.shadow;
  goto $bb9;
}
const add_round_key.7: ref;
axiom (add_round_key.7 == $sub.ref(0,4128));
procedure {:inline 1} add_round_key.7($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $M.1, $exn;
{
  var $p2: ref;
  var $p2.shadow: ref;
  ...
  var $i33.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 34, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 34, 7} true;
  assume {:verifier.code 0} true;
  $p2 := $p1;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 34, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i3,16);
  $i4.shadow := $slt.i32($i3.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 34, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 37, 14} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p2,$mul.ref(1,4));
  $p5.shadow := $add.ref($p2.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 37, 7} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $i6 := $load.i32($M.2,$p2);
  $i6.shadow := $load.i32($M.2.shadow,$p2.shadow);
  call {:cexpr "k"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 38, 32} true;
  assume {:verifier.code 0} true;
  $i7 := $lshr.i32($i6,24);
  $i7.shadow := $lshr.i32($i6.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 38, 11} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i3,0);
  $i8.shadow := $add.i32($i3.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 38, 3} true;
  assume {:verifier.code 0} true;
  $i9 := $sext.i32.i64($i8);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 38, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 39, 32} true;
  assume {:verifier.code 0} true;
  $i13 := $lshr.i32($i6,16);
  $i13.shadow := $lshr.i32($i6.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 39, 39} true;
  assume {:verifier.code 0} true;
  $i14 := $and.i32($i13,255);
  $i14.shadow := $and.i32($i13.shadow,255);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 39, 11} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i3,1);
  $i15.shadow := $add.i32($i3.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 39, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 39, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 40, 32} true;
  assume {:verifier.code 0} true;
  $i20 := $lshr.i32($i6,8);
  $i20.shadow := $lshr.i32($i6.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 40, 38} true;
  assume {:verifier.code 0} true;
  $i21 := $and.i32($i20,255);
  $i21.shadow := $and.i32($i20.shadow,255);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 40, 11} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i32($i3,2);
  $i22.shadow := $add.i32($i3.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 40, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 40, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 41, 31} true;
  assume {:verifier.code 0} true;
  $i27 := $and.i32($i6,255);
  $i27.shadow := $and.i32($i6.shadow,255);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 41, 11} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i32($i3,3);
  $i28.shadow := $add.i32($i3.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 41, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 41, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 42, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i4 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 43, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 34, 24} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i3,4);
...
const sub_bytes: ref;
axiom (sub_bytes == $sub.ref(0,5160));
procedure {:inline 1} sub_bytes($p0: ref, $p0.shadow: ref)
modifies $M.1, $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i12.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 50, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 50, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 50, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1,16);
  $i2.shadow := $slt.i32($i1.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 50, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 51, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 51, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i32.i64($i5);
  $i6.shadow := $zext.i32.i64($i5.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 51, 14} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(br_aes_S,$mul.ref(0,0)),$mul.ref($i6,1));
  $p7.shadow := $add.ref($add.ref(br_aes_S,$mul.ref(0,0)),$mul.ref($i6.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 51, 14} true;
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $i8 := $load.i8($M.3,$p7);
  ...
  $i9 := $zext.i8.i32($i8);
  $i9.shadow := $zext.i8.i32($i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 51, 3} true;
  assume {:verifier.code 0} true;
  $i10 := $sext.i32.i64($i1);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 51, 12} true;
  assume {:verifier.code 0} true;
  assert ($p11 == $p11.shadow);
  $M.1 := $store.i32($M.1,$p11,$i9);
  $M.1.shadow := $store.i32($M.1.shadow,$p11.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 52, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 53, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 50, 24} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i1,1);
...
axiom (shift_rows == $sub.ref(0,6192));
...
modifies $M.1, $exn;
{
  ...
  var $p36.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 60, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 60, 8} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($p0,$mul.ref(1,4));
  $p1.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 60, 8} true;
  assume {:verifier.code 0} true;
  assert ($p1 == $p1.shadow);
  $i2 := $load.i32($M.1,$p1);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 61, 13} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p0,$mul.ref(5,4));
  $p3.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 61, 13} true;
  assume {:verifier.code 0} true;
  assert ($p3 == $p3.shadow);
  $i4 := $load.i32($M.1,$p3);
  $i4.shadow := $load.i32($M.1.shadow,$p3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 61, 2} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0,$mul.ref(1,4));
  $p5.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 61, 11} true;
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $M.1 := $store.i32($M.1,$p5,$i4);
  $M.1.shadow := $store.i32($M.1.shadow,$p5.shadow,$i4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 62, 13} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p0,$mul.ref(9,4));
  $p6.shadow := $add.ref($p0.shadow,$mul.ref(9,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 62, 13} true;
  assume {:verifier.code 0} true;
  assert ($p6 == $p6.shadow);
  $i7 := $load.i32($M.1,$p6);
  $i7.shadow := $load.i32($M.1.shadow,$p6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 62, 2} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p0,$mul.ref(5,4));
  $p8.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 62, 11} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $M.1 := $store.i32($M.1,$p8,$i7);
  $M.1.shadow := $store.i32($M.1.shadow,$p8.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 63, 13} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(13,4));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(13,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 63, 13} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $i10 := $load.i32($M.1,$p9);
  $i10.shadow := $load.i32($M.1.shadow,$p9.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 63, 2} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p0,$mul.ref(9,4));
  $p11.shadow := $add.ref($p0.shadow,$mul.ref(9,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 63, 11} true;
  assume {:verifier.code 0} true;
  assert ($p11 == $p11.shadow);
  $M.1 := $store.i32($M.1,$p11,$i10);
  $M.1.shadow := $store.i32($M.1.shadow,$p11.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 64, 2} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p0,$mul.ref(13,4));
  $p12.shadow := $add.ref($p0.shadow,$mul.ref(13,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 64, 12} true;
  assume {:verifier.code 0} true;
  assert ($p12 == $p12.shadow);
  $M.1 := $store.i32($M.1,$p12,$i2);
  $M.1.shadow := $store.i32($M.1.shadow,$p12.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 66, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 67, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($p0,$mul.ref(2,4));
  $p17.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 67, 11} true;
  assume {:verifier.code 0} true;
  assert ($p17 == $p17.shadow);
  $M.1 := $store.i32($M.1,$p17,$i16);
  $M.1.shadow := $store.i32($M.1.shadow,$p17.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 68, 2} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p0,$mul.ref(10,4));
  $p18.shadow := $add.ref($p0.shadow,$mul.ref(10,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 68, 12} true;
  assume {:verifier.code 0} true;
  assert ($p18 == $p18.shadow);
  $M.1 := $store.i32($M.1,$p18,$i14);
  $M.1.shadow := $store.i32($M.1.shadow,$p18.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 69, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 70, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 70, 2} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p0,$mul.ref(6,4));
  $p23.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 70, 11} true;
  assume {:verifier.code 0} true;
  assert ($p23 == $p23.shadow);
  $M.1 := $store.i32($M.1,$p23,$i22);
  $M.1.shadow := $store.i32($M.1.shadow,$p23.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 71, 2} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p0,$mul.ref(14,4));
  $p24.shadow := $add.ref($p0.shadow,$mul.ref(14,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 71, 12} true;
  assume {:verifier.code 0} true;
  assert ($p24 == $p24.shadow);
  $M.1 := $store.i32($M.1,$p24,$i20);
  $M.1.shadow := $store.i32($M.1.shadow,$p24.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 73, 8} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($p0,$mul.ref(15,4));
  $p25.shadow := $add.ref($p0.shadow,$mul.ref(15,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 73, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 74, 14} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($p0,$mul.ref(11,4));
  $p27.shadow := $add.ref($p0.shadow,$mul.ref(11,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 74, 14} true;
  assume {:verifier.code 0} true;
  assert ($p27 == $p27.shadow);
  $i28 := $load.i32($M.1,$p27);
  $i28.shadow := $load.i32($M.1.shadow,$p27.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 74, 2} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p0,$mul.ref(15,4));
  $p29.shadow := $add.ref($p0.shadow,$mul.ref(15,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 74, 12} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $M.1 := $store.i32($M.1,$p29,$i28);
  $M.1.shadow := $store.i32($M.1.shadow,$p29.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 75, 14} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($p0,$mul.ref(7,4));
  $p30.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 75, 14} true;
  assume {:verifier.code 0} true;
  assert ($p30 == $p30.shadow);
  $i31 := $load.i32($M.1,$p30);
  $i31.shadow := $load.i32($M.1.shadow,$p30.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 75, 2} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($p0,$mul.ref(11,4));
  $p32.shadow := $add.ref($p0.shadow,$mul.ref(11,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 75, 12} true;
  assume {:verifier.code 0} true;
  assert ($p32 == $p32.shadow);
  $M.1 := $store.i32($M.1,$p32,$i31);
  $M.1.shadow := $store.i32($M.1.shadow,$p32.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 76, 13} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($p0,$mul.ref(3,4));
  $p33.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 76, 13} true;
  assume {:verifier.code 0} true;
  assert ($p33 == $p33.shadow);
  $i34 := $load.i32($M.1,$p33);
  $i34.shadow := $load.i32($M.1.shadow,$p33.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 76, 2} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($p0,$mul.ref(7,4));
  $p35.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 76, 11} true;
  assume {:verifier.code 0} true;
  assert ($p35 == $p35.shadow);
  $M.1 := $store.i32($M.1,$p35,$i34);
  $M.1.shadow := $store.i32($M.1.shadow,$p35.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 77, 2} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($p0,$mul.ref(3,4));
  $p36.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 77, 11} true;
  assume {:verifier.code 0} true;
  assert ($p36 == $p36.shadow);
  $M.1 := $store.i32($M.1,$p36,$i26);
  $M.1.shadow := $store.i32($M.1.shadow,$p36.shadow,$i26.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 78, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
axiom (mix_columns == $sub.ref(0,7224));
...
modifies $M.1, $exn;
{
  ...
  var $i71.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 85, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 85, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 85, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1,16);
  $i2.shadow := $slt.i32($i1.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 85, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  assert ($i2 == $i2.shadow);
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 89, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i1,0);
  $i3.shadow := $add.i32($i1.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 89, 8} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 90, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1,1);
  $i7.shadow := $add.i32($i1.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 90, 8} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i7);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 91, 16} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i1,2);
  $i11.shadow := $add.i32($i1.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 91, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 92, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i1,3);
  $i15.shadow := $add.i32($i1.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 92, 8} true;
  assume {:verifier.code 0} true;
  $i16 := $sext.i32.i64($i15);
  $i16.shadow := $sext.i32.i64($i15.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 92, 8} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 93, 12} true;
  assume {:verifier.code 0} true;
  $i19 := $shl.i32($i6,1);
  $i19.shadow := $shl.i32($i6.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 93, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $xor.i32($i19,$i10);
  $i20.shadow := $xor.i32($i19.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 93, 29} true;
  assume {:verifier.code 0} true;
  $i21 := $shl.i32($i10,1);
  $i21.shadow := $shl.i32($i10.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 93, 23} true;
  assume {:verifier.code 0} true;
  $i22 := $xor.i32($i20,$i21);
  $i22.shadow := $xor.i32($i20.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 93, 35} true;
  assume {:verifier.code 0} true;
  $i23 := $xor.i32($i22,$i14);
  $i23.shadow := $xor.i32($i22.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 93, 40} true;
  assume {:verifier.code 0} true;
  $i24 := $xor.i32($i23,$i18);
  $i24.shadow := $xor.i32($i23.shadow,$i18.shadow);
  call {:cexpr "t0"} boogie_si_record_i32($i24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 94, 17} true;
  assume {:verifier.code 0} true;
  $i25 := $shl.i32($i10,1);
  $i25.shadow := $shl.i32($i10.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 94, 11} true;
  assume {:verifier.code 0} true;
  $i26 := $xor.i32($i6,$i25);
  $i26.shadow := $xor.i32($i6.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 94, 23} true;
  assume {:verifier.code 0} true;
  $i27 := $xor.i32($i26,$i14);
  $i27.shadow := $xor.i32($i26.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 94, 34} true;
  assume {:verifier.code 0} true;
  $i28 := $shl.i32($i14,1);
  $i28.shadow := $shl.i32($i14.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 94, 28} true;
  assume {:verifier.code 0} true;
  $i29 := $xor.i32($i27,$i28);
  $i29.shadow := $xor.i32($i27.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 94, 40} true;
  assume {:verifier.code 0} true;
  $i30 := $xor.i32($i29,$i18);
  $i30.shadow := $xor.i32($i29.shadow,$i18.shadow);
  call {:cexpr "t1"} boogie_si_record_i32($i30);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 95, 11} true;
  assume {:verifier.code 0} true;
  $i31 := $xor.i32($i6,$i10);
  $i31.shadow := $xor.i32($i6.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 95, 22} true;
  assume {:verifier.code 0} true;
  $i32 := $shl.i32($i14,1);
  $i32.shadow := $shl.i32($i14.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 95, 16} true;
  assume {:verifier.code 0} true;
  $i33 := $xor.i32($i31,$i32);
  $i33.shadow := $xor.i32($i31.shadow,$i32.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 95, 28} true;
  assume {:verifier.code 0} true;
  $i34 := $xor.i32($i33,$i18);
  $i34.shadow := $xor.i32($i33.shadow,$i18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 95, 39} true;
  assume {:verifier.code 0} true;
  $i35 := $shl.i32($i18,1);
  $i35.shadow := $shl.i32($i18.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 95, 33} true;
  assume {:verifier.code 0} true;
  $i36 := $xor.i32($i34,$i35);
  $i36.shadow := $xor.i32($i34.shadow,$i35.shadow);
  call {:cexpr "t2"} boogie_si_record_i32($i36);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 96, 17} true;
  assume {:verifier.code 0} true;
  $i37 := $shl.i32($i6,1);
  $i37.shadow := $shl.i32($i6.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 96, 11} true;
  assume {:verifier.code 0} true;
  $i38 := $xor.i32($i6,$i37);
  $i38.shadow := $xor.i32($i6.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 96, 23} true;
  assume {:verifier.code 0} true;
  $i39 := $xor.i32($i38,$i10);
  $i39.shadow := $xor.i32($i38.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 96, 28} true;
  assume {:verifier.code 0} true;
  $i40 := $xor.i32($i39,$i14);
  $i40.shadow := $xor.i32($i39.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 96, 39} true;
  assume {:verifier.code 0} true;
  $i41 := $shl.i32($i18,1);
  $i41.shadow := $shl.i32($i18.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 96, 33} true;
  assume {:verifier.code 0} true;
  $i42 := $xor.i32($i40,$i41);
  $i42.shadow := $xor.i32($i40.shadow,$i41.shadow);
  call {:cexpr "t3"} boogie_si_record_i32($i42);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 97, 45} true;
  assume {:verifier.code 0} true;
  $i43 := $lshr.i32($i24,8);
  $i43.shadow := $lshr.i32($i24.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 97, 35} true;
  assume {:verifier.code 0} true;
  $i44 := $sub.i32(0,$i43);
  $i44.shadow := $sub.i32(0,$i43.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 97, 52} true;
  assume {:verifier.code 0} true;
  $i45 := $and.i32($i44,283);
  $i45.shadow := $and.i32($i44.shadow,283);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 97, 21} true;
  assume {:verifier.code 0} true;
  $i46 := $xor.i32($i24,$i45);
  $i46.shadow := $xor.i32($i24.shadow,$i45.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 97, 11} true;
  assume {:verifier.code 0} true;
  $i47 := $add.i32($i1,0);
  $i47.shadow := $add.i32($i1.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 97, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 97, 16} true;
  assume {:verifier.code 0} true;
  assert ($p49 == $p49.shadow);
  $M.1 := $store.i32($M.1,$p49,$i46);
  $M.1.shadow := $store.i32($M.1.shadow,$p49.shadow,$i46.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 98, 45} true;
  assume {:verifier.code 0} true;
  $i50 := $lshr.i32($i30,8);
  $i50.shadow := $lshr.i32($i30.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 98, 35} true;
  assume {:verifier.code 0} true;
  $i51 := $sub.i32(0,$i50);
  $i51.shadow := $sub.i32(0,$i50.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 98, 52} true;
  assume {:verifier.code 0} true;
  $i52 := $and.i32($i51,283);
  $i52.shadow := $and.i32($i51.shadow,283);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 98, 21} true;
  assume {:verifier.code 0} true;
  $i53 := $xor.i32($i30,$i52);
  $i53.shadow := $xor.i32($i30.shadow,$i52.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 98, 11} true;
  assume {:verifier.code 0} true;
  $i54 := $add.i32($i1,1);
  $i54.shadow := $add.i32($i1.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 98, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 98, 16} true;
  assume {:verifier.code 0} true;
  assert ($p56 == $p56.shadow);
  $M.1 := $store.i32($M.1,$p56,$i53);
  $M.1.shadow := $store.i32($M.1.shadow,$p56.shadow,$i53.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 99, 45} true;
  assume {:verifier.code 0} true;
  $i57 := $lshr.i32($i36,8);
  $i57.shadow := $lshr.i32($i36.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 99, 35} true;
  assume {:verifier.code 0} true;
  $i58 := $sub.i32(0,$i57);
  $i58.shadow := $sub.i32(0,$i57.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 99, 52} true;
  assume {:verifier.code 0} true;
  $i59 := $and.i32($i58,283);
  $i59.shadow := $and.i32($i58.shadow,283);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 99, 21} true;
  assume {:verifier.code 0} true;
  $i60 := $xor.i32($i36,$i59);
  $i60.shadow := $xor.i32($i36.shadow,$i59.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 99, 11} true;
  assume {:verifier.code 0} true;
  $i61 := $add.i32($i1,2);
  $i61.shadow := $add.i32($i1.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 99, 3} true;
  assume {:verifier.code 0} true;
  $i62 := $sext.i32.i64($i61);
  $i62.shadow := $sext.i32.i64($i61.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 99, 3} true;
  assume {:verifier.code 0} true;
  $p63 := $add.ref($p0,$mul.ref($i62,4));
  $p63.shadow := $add.ref($p0.shadow,$mul.ref($i62.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 99, 16} true;
  assume {:verifier.code 0} true;
  assert ($p63 == $p63.shadow);
  $M.1 := $store.i32($M.1,$p63,$i60);
  $M.1.shadow := $store.i32($M.1.shadow,$p63.shadow,$i60.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 100, 45} true;
  assume {:verifier.code 0} true;
  $i64 := $lshr.i32($i42,8);
  $i64.shadow := $lshr.i32($i42.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 100, 35} true;
  assume {:verifier.code 0} true;
  $i65 := $sub.i32(0,$i64);
  $i65.shadow := $sub.i32(0,$i64.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 100, 52} true;
  assume {:verifier.code 0} true;
  $i66 := $and.i32($i65,283);
  $i66.shadow := $and.i32($i65.shadow,283);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 100, 21} true;
  assume {:verifier.code 0} true;
  $i67 := $xor.i32($i42,$i66);
  $i67.shadow := $xor.i32($i42.shadow,$i66.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 100, 11} true;
  assume {:verifier.code 0} true;
  $i68 := $add.i32($i1,3);
  $i68.shadow := $add.i32($i1.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 100, 3} true;
  assume {:verifier.code 0} true;
  $i69 := $sext.i32.i64($i68);
  $i69.shadow := $sext.i32.i64($i68.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 100, 3} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($p0,$mul.ref($i69,4));
  $p70.shadow := $add.ref($p0.shadow,$mul.ref($i69.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 100, 16} true;
  assume {:verifier.code 0} true;
  assert ($p70 == $p70.shadow);
  $M.1 := $store.i32($M.1,$p70,$i67);
  $M.1.shadow := $store.i32($M.1.shadow,$p70.shadow,$i67.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 101, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 102, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 85, 24} true;
  assume {:verifier.code 0} true;
  $i71 := $add.i32($i1,4);
  $i71.shadow := $add.i32($i1.shadow,4);
  call {:cexpr "i"} boogie_si_record_i32($i71);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 85, 2} true;
  assume {:verifier.code 0} true;
  $i1 := $i71;
  $i1.shadow := $i71.shadow;
  goto $bb1;
}
const encrypt_wrapper: ref;
axiom (encrypt_wrapper == $sub.ref(0,8256));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_aes_small_encrypt($i0, $i0.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
