...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,31208));
...
axiom (iS == $sub.ref(0,1280));
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0,2312));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0,3344));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const br_aes_small_decrypt: ref;
axiom (br_aes_small_decrypt == $sub.ref(0,4376));
procedure {:inline 1} br_aes_small_decrypt($i0: i32, $i0.shadow: i32, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.1, $M.0, $exn;
modifies $CurrAddr;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $i39.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 160, 7} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(64,$zext.i32.i64(1)));
  $p3.shadow := $p3;
  call {:cexpr "br_aes_small_decrypt:arg:num_rounds"} boogie_si_record_i32($i0);
  assume true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 160, 7} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 160, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i4,16);
  $i5.shadow := $ult.i32($i4.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 160, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 161, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i32.i64($i4);
  $i6.shadow := $zext.i32.i64($i4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 161, 14} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p2,$mul.ref($i6,1));
  $p7.shadow := $add.ref($p2.shadow,$mul.ref($i6.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 161, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 161, 3} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i32.i64($i4);
  $i10.shadow := $zext.i32.i64($i4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 161, 3} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref($i10,4));
  $p11.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref($i10.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 161, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p11 == $p11.shadow));
  $M.1 := $store.i32($M.1,$p11,$i9);
  $M.1.shadow := $store.i32($M.1.shadow,$p11.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 162, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i5 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 163, 16} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p13.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 163, 42} true;
  assume {:verifier.code 0} true;
  $i14 := $shl.i32($i0,2);
  $i14.shadow := $shl.i32($i0.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 163, 28} true;
  assume {:verifier.code 0} true;
  ...
  $p16.shadow := $add.ref($p1.shadow,$mul.ref($i15.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 163, 2} true;
  assume {:verifier.code 0} true;
  call add_round_key($p13, $p13.shadow, $p16, $p16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 164, 22} true;
  assume {:verifier.code 0} true;
  $i17 := $sub.i32($i0,1);
  $i17.shadow := $sub.i32($i0.shadow,1);
  call {:cexpr "u"} boogie_si_record_i32($i17);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 164, 7} true;
  assume {:verifier.code 0} true;
  $i18 := $i17;
  $i18.shadow := $i17.shadow;
  goto $bb5;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 160, 24} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i4,1);
  $i12.shadow := $add.i32($i4.shadow,1);
  call {:cexpr "u"} boogie_si_record_i32($i12);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 160, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $i12;
  $i4.shadow := $i12.shadow;
  goto $bb1;
$bb5:
  assert {:shadow_invariant} $shadow_ok;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 164, 29} true;
  assume {:verifier.code 0} true;
  $i19 := $ugt.i32($i18,0);
  $i19.shadow := $ugt.i32($i18.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 164, 2} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume ($i19 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 165, 18} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p20.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 165, 3} true;
  assume {:verifier.code 0} true;
  call inv_shift_rows($p20, $p20.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 166, 17} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p21.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 166, 3} true;
  assume {:verifier.code 0} true;
  call inv_sub_bytes($p21, $p21.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 167, 17} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p22.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 167, 34} true;
  assume {:verifier.code 0} true;
  $i23 := $shl.i32($i18,2);
  $i23.shadow := $shl.i32($i18.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 167, 29} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 167, 3} true;
  assume {:verifier.code 0} true;
  call add_round_key($p22, $p22.shadow, $p25, $p25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 168, 19} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p26.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 168, 3} true;
  assume {:verifier.code 0} true;
  call inv_mix_columns($p26, $p26.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 169, 2} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume !($i19 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 170, 17} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p28.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 170, 2} true;
  assume {:verifier.code 0} true;
  call inv_shift_rows($p28, $p28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 171, 16} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p29.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 171, 2} true;
  assume {:verifier.code 0} true;
  call inv_sub_bytes($p29, $p29.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 172, 16} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,4));
  $p30.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 172, 2} true;
  assume {:verifier.code 0} true;
  call add_round_key($p30, $p30.shadow, $p1, $p1.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 173, 7} true;
  assume {:verifier.code 0} true;
  $i31 := 0;
  $i31.shadow := 0;
  goto $bb9;
$bb8:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 164, 36} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i18,$sub.i32(0,1));
  $i27.shadow := $add.i32($i18.shadow,$sub.i32(0,1));
  call {:cexpr "u"} boogie_si_record_i32($i27);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 164, 2} true;
  assume {:verifier.code 0} true;
  $i18 := $i27;
  $i18.shadow := $i27.shadow;
  goto $bb5;
$bb9:
  assert {:shadow_invariant} $shadow_ok;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 173, 16} true;
  assume {:verifier.code 0} true;
  $i32 := $ult.i32($i31,16);
  $i32.shadow := $ult.i32($i31.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 173, 2} true;
  assume {:verifier.code 0} true;
...
$bb10:
  assume ($i32 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 174, 12} true;
  assume {:verifier.code 0} true;
  $i33 := $zext.i32.i64($i31);
  $i33.shadow := $zext.i32.i64($i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 174, 12} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref($i33,4));
  $p34.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref($i33.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 174, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 174, 3} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i32.i64($i31);
  $i37.shadow := $zext.i32.i64($i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 174, 3} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p2,$mul.ref($i37,1));
  $p38.shadow := $add.ref($p2.shadow,$mul.ref($i37.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 174, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p38 == $p38.shadow));
  $M.0 := $store.i8($M.0,$p38,$i36);
  $M.0.shadow := $store.i8($M.0.shadow,$p38.shadow,$i36.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 175, 2} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume !($i32 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 176, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb12:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 173, 24} true;
  assume {:verifier.code 0} true;
  $i39 := $add.i32($i31,1);
  $i39.shadow := $add.i32($i31.shadow,1);
  call {:cexpr "u"} boogie_si_record_i32($i39);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 173, 2} true;
  assume {:verifier.code 0} true;
  $i31 := $i39;
  $i31.shadow := $i39.shadow;
  goto $bb9;
}
const add_round_key: ref;
axiom (add_round_key == $sub.ref(0,5408));
procedure {:inline 1} add_round_key($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $M.1, $exn;
{
  var $p2: ref;
  var $p2.shadow: ref;
  ...
  var $i33.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 60, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 60, 7} true;
  assume {:verifier.code 0} true;
  $p2 := $p1;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 60, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i3,16);
  $i4.shadow := $slt.i32($i3.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 60, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 63, 14} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p2,$mul.ref(1,4));
  $p5.shadow := $add.ref($p2.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 63, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p2 == $p2.shadow));
  $i6 := $load.i32($M.2,$p2);
  $i6.shadow := $load.i32($M.2.shadow,$p2.shadow);
  call {:cexpr "k"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 64, 32} true;
  assume {:verifier.code 0} true;
  $i7 := $lshr.i32($i6,24);
  $i7.shadow := $lshr.i32($i6.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 64, 11} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i3,0);
  $i8.shadow := $add.i32($i3.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 64, 3} true;
  assume {:verifier.code 0} true;
  $i9 := $sext.i32.i64($i8);
  ...
  $p10.shadow := $add.ref($p0.shadow,$mul.ref($i9.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 64, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i12 := $xor.i32($i11,$i7);
  $i12.shadow := $xor.i32($i11.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 64, 16} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p10 == $p10.shadow));
  $M.1 := $store.i32($M.1,$p10,$i12);
  $M.1.shadow := $store.i32($M.1.shadow,$p10.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 65, 32} true;
  assume {:verifier.code 0} true;
  $i13 := $lshr.i32($i6,16);
  $i13.shadow := $lshr.i32($i6.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 65, 39} true;
  assume {:verifier.code 0} true;
  $i14 := $and.i32($i13,255);
  $i14.shadow := $and.i32($i13.shadow,255);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 65, 11} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i3,1);
  $i15.shadow := $add.i32($i3.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 65, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 65, 16} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p17 == $p17.shadow));
  $i18 := $load.i32($M.1,$p17);
  $i18.shadow := $load.i32($M.1.shadow,$p17.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 65, 16} true;
  assume {:verifier.code 0} true;
  $i19 := $xor.i32($i18,$i14);
  $i19.shadow := $xor.i32($i18.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 65, 16} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p17 == $p17.shadow));
  $M.1 := $store.i32($M.1,$p17,$i19);
  $M.1.shadow := $store.i32($M.1.shadow,$p17.shadow,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 66, 32} true;
  assume {:verifier.code 0} true;
  $i20 := $lshr.i32($i6,8);
  $i20.shadow := $lshr.i32($i6.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 66, 38} true;
  assume {:verifier.code 0} true;
  $i21 := $and.i32($i20,255);
  $i21.shadow := $and.i32($i20.shadow,255);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 66, 11} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i32($i3,2);
  $i22.shadow := $add.i32($i3.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 66, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p24.shadow := $add.ref($p0.shadow,$mul.ref($i23.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 66, 16} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p24 == $p24.shadow));
  $i25 := $load.i32($M.1,$p24);
  $i25.shadow := $load.i32($M.1.shadow,$p24.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 66, 16} true;
  assume {:verifier.code 0} true;
  $i26 := $xor.i32($i25,$i21);
  $i26.shadow := $xor.i32($i25.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 66, 16} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p24 == $p24.shadow));
  $M.1 := $store.i32($M.1,$p24,$i26);
  $M.1.shadow := $store.i32($M.1.shadow,$p24.shadow,$i26.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 67, 31} true;
  assume {:verifier.code 0} true;
  $i27 := $and.i32($i6,255);
  $i27.shadow := $and.i32($i6.shadow,255);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 67, 11} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i32($i3,3);
  $i28.shadow := $add.i32($i3.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 67, 3} true;
  assume {:verifier.code 0} true;
  $i29 := $sext.i32.i64($i28);
  $i29.shadow := $sext.i32.i64($i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 67, 3} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($p0,$mul.ref($i29,4));
  $p30.shadow := $add.ref($p0.shadow,$mul.ref($i29.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 67, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i32 := $xor.i32($i31,$i27);
  $i32.shadow := $xor.i32($i31.shadow,$i27.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 67, 16} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p30 == $p30.shadow));
  $M.1 := $store.i32($M.1,$p30,$i32);
  $M.1.shadow := $store.i32($M.1.shadow,$p30.shadow,$i32.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 68, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i4 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 69, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 60, 24} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i3,4);
  $i33.shadow := $add.i32($i3.shadow,4);
  ...
  $p2.shadow := $p5.shadow;
  $i3 := $i33;
  $i3.shadow := $i33.shadow;
  goto $bb1;
}
const inv_shift_rows: ref;
axiom (inv_shift_rows == $sub.ref(0,6440));
procedure {:inline 1} inv_shift_rows($p0: ref, $p0.shadow: ref)
modifies $M.1, $exn;
{
  var $p1: ref;
  var $p1.shadow: ref;
  ...
  var $p36.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 86, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 86, 8} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($p0,$mul.ref(13,4));
  $p1.shadow := $add.ref($p0.shadow,$mul.ref(13,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 86, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 87, 14} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p0,$mul.ref(9,4));
  $p3.shadow := $add.ref($p0.shadow,$mul.ref(9,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 87, 14} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p3 == $p3.shadow));
  $i4 := $load.i32($M.1,$p3);
  $i4.shadow := $load.i32($M.1.shadow,$p3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 87, 2} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0,$mul.ref(13,4));
  $p5.shadow := $add.ref($p0.shadow,$mul.ref(13,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 87, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p5 == $p5.shadow));
  $M.1 := $store.i32($M.1,$p5,$i4);
  $M.1.shadow := $store.i32($M.1.shadow,$p5.shadow,$i4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 88, 13} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p0,$mul.ref(5,4));
  $p6.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 88, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p6 == $p6.shadow));
  $i7 := $load.i32($M.1,$p6);
  $i7.shadow := $load.i32($M.1.shadow,$p6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 88, 2} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p0,$mul.ref(9,4));
  $p8.shadow := $add.ref($p0.shadow,$mul.ref(9,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 88, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p8 == $p8.shadow));
  $M.1 := $store.i32($M.1,$p8,$i7);
  $M.1.shadow := $store.i32($M.1.shadow,$p8.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 89, 13} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(1,4));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 89, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p9 == $p9.shadow));
  $i10 := $load.i32($M.1,$p9);
  $i10.shadow := $load.i32($M.1.shadow,$p9.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 89, 2} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p0,$mul.ref(5,4));
  $p11.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 89, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p11 == $p11.shadow));
  $M.1 := $store.i32($M.1,$p11,$i10);
  $M.1.shadow := $store.i32($M.1.shadow,$p11.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 90, 2} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p0,$mul.ref(1,4));
  $p12.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 90, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p12 == $p12.shadow));
  $M.1 := $store.i32($M.1,$p12,$i2);
  $M.1.shadow := $store.i32($M.1.shadow,$p12.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 92, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p0,$mul.ref(2,4));
  $p13.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 92, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p13 == $p13.shadow));
  $i14 := $load.i32($M.1,$p13);
  $i14.shadow := $load.i32($M.1.shadow,$p13.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 93, 13} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p0,$mul.ref(10,4));
  $p15.shadow := $add.ref($p0.shadow,$mul.ref(10,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 93, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p15 == $p15.shadow));
  $i16 := $load.i32($M.1,$p15);
  $i16.shadow := $load.i32($M.1.shadow,$p15.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 93, 2} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($p0,$mul.ref(2,4));
  $p17.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 93, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p17 == $p17.shadow));
  $M.1 := $store.i32($M.1,$p17,$i16);
  $M.1.shadow := $store.i32($M.1.shadow,$p17.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 94, 2} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p0,$mul.ref(10,4));
  $p18.shadow := $add.ref($p0.shadow,$mul.ref(10,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 94, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p18 == $p18.shadow));
  $M.1 := $store.i32($M.1,$p18,$i14);
  $M.1.shadow := $store.i32($M.1.shadow,$p18.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 95, 8} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($p0,$mul.ref(6,4));
  $p19.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 95, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p19 == $p19.shadow));
  $i20 := $load.i32($M.1,$p19);
  $i20.shadow := $load.i32($M.1.shadow,$p19.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i20);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 96, 13} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p0,$mul.ref(14,4));
  $p21.shadow := $add.ref($p0.shadow,$mul.ref(14,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 96, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p21 == $p21.shadow));
  $i22 := $load.i32($M.1,$p21);
  $i22.shadow := $load.i32($M.1.shadow,$p21.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 96, 2} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p0,$mul.ref(6,4));
  $p23.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 96, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p23 == $p23.shadow));
  $M.1 := $store.i32($M.1,$p23,$i22);
  $M.1.shadow := $store.i32($M.1.shadow,$p23.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 97, 2} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p0,$mul.ref(14,4));
  $p24.shadow := $add.ref($p0.shadow,$mul.ref(14,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 97, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p24 == $p24.shadow));
  $M.1 := $store.i32($M.1,$p24,$i20);
  $M.1.shadow := $store.i32($M.1.shadow,$p24.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 99, 8} true;
  assume {:verifier.code 0} true;
  ...
  $i26.shadow := $load.i32($M.1.shadow,$p25.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i26);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 100, 13} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($p0,$mul.ref(7,4));
  $p27.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 100, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p27 == $p27.shadow));
  $i28 := $load.i32($M.1,$p27);
  $i28.shadow := $load.i32($M.1.shadow,$p27.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 100, 2} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p0,$mul.ref(3,4));
  $p29.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 100, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p29 == $p29.shadow));
  $M.1 := $store.i32($M.1,$p29,$i28);
  $M.1.shadow := $store.i32($M.1.shadow,$p29.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 101, 13} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($p0,$mul.ref(11,4));
  $p30.shadow := $add.ref($p0.shadow,$mul.ref(11,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 101, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p30 == $p30.shadow));
  $i31 := $load.i32($M.1,$p30);
  $i31.shadow := $load.i32($M.1.shadow,$p30.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 101, 2} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($p0,$mul.ref(7,4));
  $p32.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 101, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p32 == $p32.shadow));
  $M.1 := $store.i32($M.1,$p32,$i31);
  $M.1.shadow := $store.i32($M.1.shadow,$p32.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 102, 14} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($p0,$mul.ref(15,4));
  $p33.shadow := $add.ref($p0.shadow,$mul.ref(15,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 102, 14} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p33 == $p33.shadow));
  $i34 := $load.i32($M.1,$p33);
  $i34.shadow := $load.i32($M.1.shadow,$p33.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 102, 2} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($p0,$mul.ref(11,4));
  $p35.shadow := $add.ref($p0.shadow,$mul.ref(11,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 102, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p35 == $p35.shadow));
  $M.1 := $store.i32($M.1,$p35,$i34);
  $M.1.shadow := $store.i32($M.1.shadow,$p35.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 103, 2} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($p0,$mul.ref(15,4));
  $p36.shadow := $add.ref($p0.shadow,$mul.ref(15,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 103, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p36 == $p36.shadow));
  $M.1 := $store.i32($M.1,$p36,$i26);
  $M.1.shadow := $store.i32($M.1.shadow,$p36.shadow,$i26.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 104, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const inv_sub_bytes: ref;
axiom (inv_sub_bytes == $sub.ref(0,7472));
procedure {:inline 1} inv_sub_bytes($p0: ref, $p0.shadow: ref)
modifies $M.1, $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i12.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 76, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 76, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 76, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1,16);
  $i2.shadow := $slt.i32($i1.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 76, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 77, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  ...
  $p4.shadow := $add.ref($p0.shadow,$mul.ref($i3.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 77, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4 == $p4.shadow));
  $i5 := $load.i32($M.1,$p4);
  $i5.shadow := $load.i32($M.1.shadow,$p4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 77, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i32.i64($i5);
  $i6.shadow := $zext.i32.i64($i5.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 77, 14} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(iS,$mul.ref(0,256)),$mul.ref($i6,1));
  $p7.shadow := $add.ref($add.ref(iS,$mul.ref(0,256)),$mul.ref($i6.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 77, 14} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p7 == $p7.shadow));
  $i8 := $load.i8($M.3,$p7);
  $i8.shadow := $load.i8($M.3.shadow,$p7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 77, 14} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i8.i32($i8);
  $i9.shadow := $zext.i8.i32($i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 77, 3} true;
  assume {:verifier.code 0} true;
  $i10 := $sext.i32.i64($i1);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 77, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p11 == $p11.shadow));
  $M.1 := $store.i32($M.1,$p11,$i9);
  $M.1.shadow := $store.i32($M.1.shadow,$p11.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 78, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 79, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 76, 24} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i1,1);
  ...
  assume {:verifier.code 0} true;
  $i1 := $i12;
  $i1.shadow := $i12.shadow;
  goto $bb1;
}
const inv_mix_columns: ref;
axiom (inv_mix_columns == $sub.ref(0,8504));
procedure {:inline 1} inv_mix_columns($p0: ref, $p0.shadow: ref)
modifies $M.1, $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i107.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 120, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 120, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 120, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1,16);
  $i2.shadow := $slt.i32($i1.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 120, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  $shadow_ok := ($shadow_ok && ($i2 == $i2.shadow));
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 124, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i1,0);
  $i3.shadow := $add.i32($i1.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 124, 8} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i3);
  ...
  $p5.shadow := $add.ref($p0.shadow,$mul.ref($i4.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 124, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p5 == $p5.shadow));
  $i6 := $load.i32($M.1,$p5);
  $i6.shadow := $load.i32($M.1.shadow,$p5.shadow);
  call {:cexpr "s0"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 125, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i1,1);
  $i7.shadow := $add.i32($i1.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 125, 8} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i7);
  ...
  $p9.shadow := $add.ref($p0.shadow,$mul.ref($i8.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 125, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p9 == $p9.shadow));
  $i10 := $load.i32($M.1,$p9);
  $i10.shadow := $load.i32($M.1.shadow,$p9.shadow);
  call {:cexpr "s1"} boogie_si_record_i32($i10);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 126, 16} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i1,2);
  $i11.shadow := $add.i32($i1.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 126, 8} true;
  assume {:verifier.code 0} true;
  $i12 := $sext.i32.i64($i11);
  $i12.shadow := $sext.i32.i64($i11.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 126, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p0,$mul.ref($i12,4));
  $p13.shadow := $add.ref($p0.shadow,$mul.ref($i12.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 126, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p13 == $p13.shadow));
  $i14 := $load.i32($M.1,$p13);
  $i14.shadow := $load.i32($M.1.shadow,$p13.shadow);
  call {:cexpr "s2"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 127, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i1,3);
  $i15.shadow := $add.i32($i1.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 127, 8} true;
  assume {:verifier.code 0} true;
  $i16 := $sext.i32.i64($i15);
  $i16.shadow := $sext.i32.i64($i15.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 127, 8} true;
  ...
  $i18 := $load.i32($M.1,$p17);
  $i18.shadow := $load.i32($M.1.shadow,$p17.shadow);
  call {:cexpr "s3"} boogie_si_record_i32($i18);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 128, 12} true;
  assume {:verifier.code 0} true;
  $i19 := $shl.i32($i6,1);
  $i19.shadow := $shl.i32($i6.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 128, 24} true;
  assume {:verifier.code 0} true;
  $i20 := $shl.i32($i6,2);
  $i20.shadow := $shl.i32($i6.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 128, 18} true;
  assume {:verifier.code 0} true;
  $i21 := $xor.i32($i19,$i20);
  $i21.shadow := $xor.i32($i19.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 128, 36} true;
  assume {:verifier.code 0} true;
  $i22 := $shl.i32($i6,3);
  $i22.shadow := $shl.i32($i6.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 128, 30} true;
  assume {:verifier.code 0} true;
  $i23 := $xor.i32($i21,$i22);
  $i23.shadow := $xor.i32($i21.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 129, 4} true;
  assume {:verifier.code 0} true;
  $i24 := $xor.i32($i23,$i10);
  $i24.shadow := $xor.i32($i23.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 129, 15} true;
  assume {:verifier.code 0} true;
  $i25 := $shl.i32($i10,1);
  $i25.shadow := $shl.i32($i10.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 129, 9} true;
  assume {:verifier.code 0} true;
  $i26 := $xor.i32($i24,$i25);
  $i26.shadow := $xor.i32($i24.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 129, 27} true;
  assume {:verifier.code 0} true;
  $i27 := $shl.i32($i10,3);
  $i27.shadow := $shl.i32($i10.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 129, 21} true;
  assume {:verifier.code 0} true;
  $i28 := $xor.i32($i26,$i27);
  $i28.shadow := $xor.i32($i26.shadow,$i27.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 130, 4} true;
  assume {:verifier.code 0} true;
  $i29 := $xor.i32($i28,$i14);
  $i29.shadow := $xor.i32($i28.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 130, 15} true;
  assume {:verifier.code 0} true;
  $i30 := $shl.i32($i14,2);
  $i30.shadow := $shl.i32($i14.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 130, 9} true;
  assume {:verifier.code 0} true;
  $i31 := $xor.i32($i29,$i30);
  $i31.shadow := $xor.i32($i29.shadow,$i30.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 130, 27} true;
  assume {:verifier.code 0} true;
  $i32 := $shl.i32($i14,3);
  $i32.shadow := $shl.i32($i14.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 130, 21} true;
  assume {:verifier.code 0} true;
  $i33 := $xor.i32($i31,$i32);
  $i33.shadow := $xor.i32($i31.shadow,$i32.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 131, 4} true;
  assume {:verifier.code 0} true;
  $i34 := $xor.i32($i33,$i18);
  $i34.shadow := $xor.i32($i33.shadow,$i18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 131, 15} true;
  assume {:verifier.code 0} true;
  $i35 := $shl.i32($i18,3);
  $i35.shadow := $shl.i32($i18.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 131, 9} true;
  assume {:verifier.code 0} true;
  $i36 := $xor.i32($i34,$i35);
  $i36.shadow := $xor.i32($i34.shadow,$i35.shadow);
  call {:cexpr "t0"} boogie_si_record_i32($i36);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 132, 17} true;
  assume {:verifier.code 0} true;
  $i37 := $shl.i32($i6,3);
  $i37.shadow := $shl.i32($i6.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 132, 11} true;
  assume {:verifier.code 0} true;
  $i38 := $xor.i32($i6,$i37);
  $i38.shadow := $xor.i32($i6.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 133, 10} true;
  assume {:verifier.code 0} true;
  $i39 := $shl.i32($i10,1);
  $i39.shadow := $shl.i32($i10.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 133, 4} true;
  assume {:verifier.code 0} true;
  $i40 := $xor.i32($i38,$i39);
  $i40.shadow := $xor.i32($i38.shadow,$i39.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 133, 22} true;
  assume {:verifier.code 0} true;
  $i41 := $shl.i32($i10,2);
  $i41.shadow := $shl.i32($i10.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 133, 16} true;
  assume {:verifier.code 0} true;
  $i42 := $xor.i32($i40,$i41);
  $i42.shadow := $xor.i32($i40.shadow,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 133, 34} true;
  assume {:verifier.code 0} true;
  $i43 := $shl.i32($i10,3);
  $i43.shadow := $shl.i32($i10.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 133, 28} true;
  assume {:verifier.code 0} true;
  $i44 := $xor.i32($i42,$i43);
  $i44.shadow := $xor.i32($i42.shadow,$i43.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 134, 4} true;
  assume {:verifier.code 0} true;
  $i45 := $xor.i32($i44,$i14);
  $i45.shadow := $xor.i32($i44.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 134, 15} true;
  assume {:verifier.code 0} true;
  $i46 := $shl.i32($i14,1);
  $i46.shadow := $shl.i32($i14.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 134, 9} true;
  assume {:verifier.code 0} true;
  $i47 := $xor.i32($i45,$i46);
  $i47.shadow := $xor.i32($i45.shadow,$i46.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 134, 27} true;
  assume {:verifier.code 0} true;
  $i48 := $shl.i32($i14,3);
  $i48.shadow := $shl.i32($i14.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 134, 21} true;
  assume {:verifier.code 0} true;
  $i49 := $xor.i32($i47,$i48);
  $i49.shadow := $xor.i32($i47.shadow,$i48.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 135, 4} true;
  assume {:verifier.code 0} true;
  $i50 := $xor.i32($i49,$i18);
  $i50.shadow := $xor.i32($i49.shadow,$i18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 135, 15} true;
  assume {:verifier.code 0} true;
  $i51 := $shl.i32($i18,2);
  $i51.shadow := $shl.i32($i18.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 135, 9} true;
  assume {:verifier.code 0} true;
  $i52 := $xor.i32($i50,$i51);
  $i52.shadow := $xor.i32($i50.shadow,$i51.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 135, 27} true;
  assume {:verifier.code 0} true;
  $i53 := $shl.i32($i18,3);
  $i53.shadow := $shl.i32($i18.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 135, 21} true;
  assume {:verifier.code 0} true;
  $i54 := $xor.i32($i52,$i53);
  $i54.shadow := $xor.i32($i52.shadow,$i53.shadow);
  call {:cexpr "t1"} boogie_si_record_i32($i54);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 136, 17} true;
  assume {:verifier.code 0} true;
  $i55 := $shl.i32($i6,2);
  $i55.shadow := $shl.i32($i6.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 136, 11} true;
  assume {:verifier.code 0} true;
  $i56 := $xor.i32($i6,$i55);
  $i56.shadow := $xor.i32($i6.shadow,$i55.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 136, 29} true;
  assume {:verifier.code 0} true;
  $i57 := $shl.i32($i6,3);
  $i57.shadow := $shl.i32($i6.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 136, 23} true;
  assume {:verifier.code 0} true;
  $i58 := $xor.i32($i56,$i57);
  $i58.shadow := $xor.i32($i56.shadow,$i57.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 137, 4} true;
  assume {:verifier.code 0} true;
  $i59 := $xor.i32($i58,$i10);
  $i59.shadow := $xor.i32($i58.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 137, 15} true;
  assume {:verifier.code 0} true;
  $i60 := $shl.i32($i10,3);
  $i60.shadow := $shl.i32($i10.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 137, 9} true;
  assume {:verifier.code 0} true;
  $i61 := $xor.i32($i59,$i60);
  $i61.shadow := $xor.i32($i59.shadow,$i60.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 138, 10} true;
  assume {:verifier.code 0} true;
  $i62 := $shl.i32($i14,1);
  $i62.shadow := $shl.i32($i14.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 138, 4} true;
  assume {:verifier.code 0} true;
  $i63 := $xor.i32($i61,$i62);
  $i63.shadow := $xor.i32($i61.shadow,$i62.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 138, 22} true;
  assume {:verifier.code 0} true;
  $i64 := $shl.i32($i14,2);
  $i64.shadow := $shl.i32($i14.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 138, 16} true;
  assume {:verifier.code 0} true;
  $i65 := $xor.i32($i63,$i64);
  $i65.shadow := $xor.i32($i63.shadow,$i64.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 138, 34} true;
  assume {:verifier.code 0} true;
  $i66 := $shl.i32($i14,3);
  $i66.shadow := $shl.i32($i14.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 138, 28} true;
  assume {:verifier.code 0} true;
  $i67 := $xor.i32($i65,$i66);
  $i67.shadow := $xor.i32($i65.shadow,$i66.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 139, 4} true;
  assume {:verifier.code 0} true;
  $i68 := $xor.i32($i67,$i18);
  $i68.shadow := $xor.i32($i67.shadow,$i18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 139, 15} true;
  assume {:verifier.code 0} true;
  $i69 := $shl.i32($i18,1);
  $i69.shadow := $shl.i32($i18.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 139, 9} true;
  assume {:verifier.code 0} true;
  $i70 := $xor.i32($i68,$i69);
  $i70.shadow := $xor.i32($i68.shadow,$i69.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 139, 27} true;
  assume {:verifier.code 0} true;
  $i71 := $shl.i32($i18,3);
  $i71.shadow := $shl.i32($i18.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 139, 21} true;
  assume {:verifier.code 0} true;
  $i72 := $xor.i32($i70,$i71);
  $i72.shadow := $xor.i32($i70.shadow,$i71.shadow);
  call {:cexpr "t2"} boogie_si_record_i32($i72);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 140, 17} true;
  assume {:verifier.code 0} true;
  $i73 := $shl.i32($i6,1);
  $i73.shadow := $shl.i32($i6.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 140, 11} true;
  assume {:verifier.code 0} true;
  $i74 := $xor.i32($i6,$i73);
  $i74.shadow := $xor.i32($i6.shadow,$i73.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 140, 29} true;
  assume {:verifier.code 0} true;
  $i75 := $shl.i32($i6,3);
  $i75.shadow := $shl.i32($i6.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 140, 23} true;
  assume {:verifier.code 0} true;
  $i76 := $xor.i32($i74,$i75);
  $i76.shadow := $xor.i32($i74.shadow,$i75.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 141, 4} true;
  assume {:verifier.code 0} true;
  $i77 := $xor.i32($i76,$i10);
  $i77.shadow := $xor.i32($i76.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 141, 15} true;
  assume {:verifier.code 0} true;
  $i78 := $shl.i32($i10,2);
  $i78.shadow := $shl.i32($i10.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 141, 9} true;
  assume {:verifier.code 0} true;
  $i79 := $xor.i32($i77,$i78);
  $i79.shadow := $xor.i32($i77.shadow,$i78.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 141, 27} true;
  assume {:verifier.code 0} true;
  $i80 := $shl.i32($i10,3);
  $i80.shadow := $shl.i32($i10.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 141, 21} true;
  assume {:verifier.code 0} true;
  $i81 := $xor.i32($i79,$i80);
  $i81.shadow := $xor.i32($i79.shadow,$i80.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 142, 4} true;
  assume {:verifier.code 0} true;
  $i82 := $xor.i32($i81,$i14);
  $i82.shadow := $xor.i32($i81.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 142, 15} true;
  assume {:verifier.code 0} true;
  $i83 := $shl.i32($i14,3);
  $i83.shadow := $shl.i32($i14.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 142, 9} true;
  assume {:verifier.code 0} true;
  $i84 := $xor.i32($i82,$i83);
  $i84.shadow := $xor.i32($i82.shadow,$i83.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 143, 10} true;
  assume {:verifier.code 0} true;
  $i85 := $shl.i32($i18,1);
  $i85.shadow := $shl.i32($i18.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 143, 4} true;
  assume {:verifier.code 0} true;
  $i86 := $xor.i32($i84,$i85);
  $i86.shadow := $xor.i32($i84.shadow,$i85.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 143, 22} true;
  assume {:verifier.code 0} true;
  $i87 := $shl.i32($i18,2);
  $i87.shadow := $shl.i32($i18.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 143, 16} true;
  assume {:verifier.code 0} true;
  $i88 := $xor.i32($i86,$i87);
  $i88.shadow := $xor.i32($i86.shadow,$i87.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 143, 34} true;
  assume {:verifier.code 0} true;
  $i89 := $shl.i32($i18,3);
  $i89.shadow := $shl.i32($i18.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 143, 28} true;
  assume {:verifier.code 0} true;
  $i90 := $xor.i32($i88,$i89);
  $i90.shadow := $xor.i32($i88.shadow,$i89.shadow);
  call {:cexpr "t3"} boogie_si_record_i32($i90);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 144, 18} true;
  assume {:verifier.code 0} true;
  call $i91, $i91.shadow := gf256red($i36, $i36.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 144, 11} true;
  assume {:verifier.code 0} true;
  $i92 := $add.i32($i1,0);
  $i92.shadow := $add.i32($i1.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 144, 3} true;
  assume {:verifier.code 0} true;
  $i93 := $sext.i32.i64($i92);
  $i93.shadow := $sext.i32.i64($i92.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 144, 3} true;
  assume {:verifier.code 0} true;
  $p94 := $add.ref($p0,$mul.ref($i93,4));
  $p94.shadow := $add.ref($p0.shadow,$mul.ref($i93.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 144, 16} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p94 == $p94.shadow));
  $M.1 := $store.i32($M.1,$p94,$i91);
  $M.1.shadow := $store.i32($M.1.shadow,$p94.shadow,$i91.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 145, 18} true;
  assume {:verifier.code 0} true;
  call $i95, $i95.shadow := gf256red($i54, $i54.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 145, 11} true;
  assume {:verifier.code 0} true;
  $i96 := $add.i32($i1,1);
  $i96.shadow := $add.i32($i1.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 145, 3} true;
  assume {:verifier.code 0} true;
  $i97 := $sext.i32.i64($i96);
  $i97.shadow := $sext.i32.i64($i96.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 145, 3} true;
  assume {:verifier.code 0} true;
  $p98 := $add.ref($p0,$mul.ref($i97,4));
  $p98.shadow := $add.ref($p0.shadow,$mul.ref($i97.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 145, 16} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p98 == $p98.shadow));
  $M.1 := $store.i32($M.1,$p98,$i95);
  $M.1.shadow := $store.i32($M.1.shadow,$p98.shadow,$i95.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 146, 18} true;
  assume {:verifier.code 0} true;
  call $i99, $i99.shadow := gf256red($i72, $i72.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 146, 11} true;
  assume {:verifier.code 0} true;
  $i100 := $add.i32($i1,2);
  $i100.shadow := $add.i32($i1.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 146, 3} true;
  assume {:verifier.code 0} true;
  $i101 := $sext.i32.i64($i100);
  $i101.shadow := $sext.i32.i64($i100.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 146, 3} true;
  assume {:verifier.code 0} true;
  $p102 := $add.ref($p0,$mul.ref($i101,4));
  $p102.shadow := $add.ref($p0.shadow,$mul.ref($i101.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 146, 16} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p102 == $p102.shadow));
  $M.1 := $store.i32($M.1,$p102,$i99);
  $M.1.shadow := $store.i32($M.1.shadow,$p102.shadow,$i99.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 147, 18} true;
  assume {:verifier.code 0} true;
  call $i103, $i103.shadow := gf256red($i90, $i90.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 147, 11} true;
  assume {:verifier.code 0} true;
  $i104 := $add.i32($i1,3);
  $i104.shadow := $add.i32($i1.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 147, 3} true;
  assume {:verifier.code 0} true;
  $i105 := $sext.i32.i64($i104);
  $i105.shadow := $sext.i32.i64($i104.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 147, 3} true;
  assume {:verifier.code 0} true;
  $p106 := $add.ref($p0,$mul.ref($i105,4));
  $p106.shadow := $add.ref($p0.shadow,$mul.ref($i105.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 147, 16} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p106 == $p106.shadow));
  $M.1 := $store.i32($M.1,$p106,$i103);
  $M.1.shadow := $store.i32($M.1.shadow,$p106.shadow,$i103.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 148, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 149, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 120, 24} true;
  assume {:verifier.code 0} true;
  $i107 := $add.i32($i1,4);
  $i107.shadow := $add.i32($i1.shadow,4);
  call {:cexpr "i"} boogie_si_record_i32($i107);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 120, 2} true;
  assume {:verifier.code 0} true;
  $i1 := $i107;
  $i1.shadow := $i107.shadow;
  goto $bb1;
}
const gf256red: ref;
axiom (gf256red == $sub.ref(0,9536));
procedure {:inline 1} gf256red($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i9.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 111, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "gf256red:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 111, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $lshr.i32($i0,8);
  $i1.shadow := $lshr.i32($i0.shadow,8);
  call {:cexpr "y"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 112, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i32($i0,$i1);
  $i2.shadow := $xor.i32($i0.shadow,$i1.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 112, 21} true;
  assume {:verifier.code 0} true;
  $i3 := $shl.i32($i1,1);
  $i3.shadow := $shl.i32($i1.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 112, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $xor.i32($i2,$i3);
  $i4.shadow := $xor.i32($i2.shadow,$i3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 112, 32} true;
  assume {:verifier.code 0} true;
  $i5 := $shl.i32($i1,3);
  $i5.shadow := $shl.i32($i1.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 112, 27} true;
  assume {:verifier.code 0} true;
  $i6 := $xor.i32($i4,$i5);
  $i6.shadow := $xor.i32($i4.shadow,$i5.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 112, 43} true;
  assume {:verifier.code 0} true;
  $i7 := $shl.i32($i1,4);
  $i7.shadow := $shl.i32($i1.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 112, 38} true;
  assume {:verifier.code 0} true;
  $i8 := $xor.i32($i6,$i7);
  $i8.shadow := $xor.i32($i6.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 112, 50} true;
  assume {:verifier.code 0} true;
  $i9 := $and.i32($i8,255);
  $i9.shadow := $and.i32($i8.shadow,255);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_dec.c", 112, 2} true;
  assume {:verifier.code 0} true;
  $r := $i9;
  $r.shadow := $i9.shadow;
  $exn := false;
...
axiom (decrypt_wrapper == $sub.ref(0,10568));
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "decrypt.c", 27, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "decrypt.c", 27, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p3, $p3.shadow);
  assume {:sourceloc "decrypt.c", 28, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p4 := __SMACK_value.ref($p1);
  $p4.shadow := $p4;
  assume $isExternal($p4);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p4);
  assume {:sourceloc "decrypt.c", 28, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "decrypt.c", 29, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p2} $p5 := __SMACK_value.ref($p2);
  $p5.shadow := $p5;
  assume $isExternal($p5);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p5);
  assume {:sourceloc "decrypt.c", 29, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "decrypt.c", 31, 12} true;
  assume {:verifier.code 1} true;
  call {:name $p2} {:array "$load.i8", $M.0, $p2, 1, 16} $p6 := __SMACK_values($p2, 16);
  $p6.shadow := $p6;
  assume $isExternal($p6);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p6);
  assume {:sourceloc "decrypt.c", 31, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p6, $p6.shadow);
  assume {:sourceloc "decrypt.c", 33, 2} true;
  assume {:verifier.code 0} true;
  call br_aes_small_decrypt($i0, $i0.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "decrypt.c", 34, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
...
axiom (__SMACK_dummy == $sub.ref(0,16760));
...
axiom (__SMACK_and32 == $sub.ref(0,17792));
...
axiom (__SMACK_and64 == $sub.ref(0,18824));
...
axiom (__SMACK_and16 == $sub.ref(0,19856));
...
axiom (__SMACK_and8 == $sub.ref(0,20888));
...
axiom (__SMACK_or32 == $sub.ref(0,21920));
...
axiom (__SMACK_or64 == $sub.ref(0,22952));
...
axiom (__SMACK_or16 == $sub.ref(0,23984));
...
axiom (__SMACK_or8 == $sub.ref(0,25016));
...
axiom (__SMACK_check_overflow == $sub.ref(0,26048));
...
axiom (__SMACK_loop_exit == $sub.ref(0,27080));
...
axiom (__SMACK_decls == $sub.ref(0,28112));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(