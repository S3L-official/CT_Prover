...
procedure {:inline 1} br_aes_small_encrypt($i0: i32, $i0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1)
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  call add_round_key.7($p13, $p13.dup, $p1, $p1.dup);
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  call add_round_key.7($p19, $p19.dup, $p22, $p22.dup);
...
$bb7:
  ...
  $p29.dup := $or.i1($p1.dup,$or.i1($i28.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 125, 2} true;
  assume {:verifier.code 0} true;
  call add_round_key.7($p26, $p26.dup, $p29, $p29.dup);
...
$bb9:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i30.dup == 0);
  assert {:shadow_invariant} ($p3.dup == 0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_small_enc.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
$bb10:
  ...
  $M.0.dup := $store.i1($M.0.dup,$p37,$i35.dup);
...
procedure {:inline 1} add_round_key.7($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1)
modifies $M.1, $exn;
{
  var $p2: ref;
  var $p2.dup: i1;
...
procedure {:inline 1} sub_bytes($p0: ref, $p0.dup: i1)
modifies $M.1, $exn;
{
  var $i1: i32;
  var $i1.dup: i1;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_aes_small_encrypt($i0, $i0.dup, $p1, $p1.dup, $p2, $p2.dup);
