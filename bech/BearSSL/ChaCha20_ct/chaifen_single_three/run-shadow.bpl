...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,28904));
...
$bb5:
  ...
  assert {:shadow_invariant} ($p7 == $p7.shadow);
  assert {:shadow_invariant} ($p6 == $p6.shadow);
  assert {:shadow_invariant} ($i16 == $i16.shadow);
  assert {:shadow_invariant} ($p5 == $p5.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/chacha20_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($p24 == $p24.shadow);
  assert {:shadow_invariant} ($p8 == $p8.shadow);
  assert {:shadow_invariant} ($p7 == $p7.shadow);
...
$bb10:
  ...
  assert (br_chacha20_ct_run.CW == br_chacha20_ct_run.CW);
...
$bb32:
  ...
  assert {:shadow_invariant} ($p24 == $p24.shadow);
  assert {:shadow_invariant} ($p8 == $p8.shadow);
  assert {:shadow_invariant} ($i617 == $i617.shadow);
  assert {:shadow_invariant} ($p7 == $p7.shadow);
  assert {:shadow_invariant} ($i23 == $i23.shadow);
  assert {:shadow_invariant} ($p6 == $p6.shadow);
  assert {:shadow_invariant} ($p5 == $p5.shadow);
...
$bb36:
  ...
  assert {:shadow_invariant} ($p24 == $p24.shadow);
  assert {:shadow_invariant} ($p8 == $p8.shadow);
  assert {:shadow_invariant} ($i627 == $i627.shadow);
  assert {:shadow_invariant} ($p7 == $p7.shadow);
  assert {:shadow_invariant} ($i23 == $i23.shadow);
  assert {:shadow_invariant} ($p6 == $p6.shadow);
  assert {:shadow_invariant} ($p5 == $p5.shadow);
...
$bb40:
  ...
  assert {:shadow_invariant} ($p24 == $p24.shadow);
  assert {:shadow_invariant} ($p8 == $p8.shadow);
  assert {:shadow_invariant} ($i642 == $i642.shadow);
  assert {:shadow_invariant} ($p7 == $p7.shadow);
  assert {:shadow_invariant} ($i23 == $i23.shadow);
  assert {:shadow_invariant} ($p6 == $p6.shadow);
  assert {:shadow_invariant} ($p5 == $p5.shadow);
...
$bb47:
  ...
  assert {:shadow_invariant} ($p24 == $p24.shadow);
  assert {:shadow_invariant} ($p8 == $p8.shadow);
  assert {:shadow_invariant} ($i655 == $i655.shadow);
  assert {:shadow_invariant} ($p7 == $p7.shadow);
  assert {:shadow_invariant} ($i654 == $i654.shadow);
  assert {:shadow_invariant} ($i23 == $i23.shadow);
  assert {:shadow_invariant} ($p6 == $p6.shadow);
  assert {:shadow_invariant} ($p5 == $p5.shadow);
  assert {:unlikely_shadow_invariant ($i25 == $i25.shadow)} true;
...
axiom (run_wrapper == $sub.ref(0,8264));
procedure {:entrypoint} run_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32, $p3: ref, $p3.shadow: ref, $i4: i64, $i4.shadow: i64)
...
requires {:public_in $load.i8, $M.5, $p3, 1, 32} true;
...
requires ($load.i8($M.5,($p3 + 0)) == $load.i8($M.5.shadow,($p3.shadow + 0)));
requires ($load.i8($M.5,($p3 + 1)) == $load.i8($M.5.shadow,($p3.shadow + 1)));
requires ($load.i8($M.5,($p3 + 2)) == $load.i8($M.5.shadow,($p3.shadow + 2)));
requires ($load.i8($M.5,($p3 + 3)) == $load.i8($M.5.shadow,($p3.shadow + 3)));
requires ($load.i8($M.5,($p3 + 4)) == $load.i8($M.5.shadow,($p3.shadow + 4)));
requires ($load.i8($M.5,($p3 + 5)) == $load.i8($M.5.shadow,($p3.shadow + 5)));
requires ($load.i8($M.5,($p3 + 6)) == $load.i8($M.5.shadow,($p3.shadow + 6)));
requires ($load.i8($M.5,($p3 + 7)) == $load.i8($M.5.shadow,($p3.shadow + 7)));
requires ($load.i8($M.5,($p3 + 8)) == $load.i8($M.5.shadow,($p3.shadow + 8)));
requires ($load.i8($M.5,($p3 + 9)) == $load.i8($M.5.shadow,($p3.shadow + 9)));
requires ($load.i8($M.5,($p3 + 10)) == $load.i8($M.5.shadow,($p3.shadow + 10)));
requires ($load.i8($M.5,($p3 + 11)) == $load.i8($M.5.shadow,($p3.shadow + 11)));
requires ($load.i8($M.5,($p3 + 12)) == $load.i8($M.5.shadow,($p3.shadow + 12)));
requires ($load.i8($M.5,($p3 + 13)) == $load.i8($M.5.shadow,($p3.shadow + 13)));
requires ($load.i8($M.5,($p3 + 14)) == $load.i8($M.5.shadow,($p3.shadow + 14)));
requires ($load.i8($M.5,($p3 + 15)) == $load.i8($M.5.shadow,($p3.shadow + 15)));
requires ($load.i8($M.5,($p3 + 16)) == $load.i8($M.5.shadow,($p3.shadow + 16)));
requires ($load.i8($M.5,($p3 + 17)) == $load.i8($M.5.shadow,($p3.shadow + 17)));
requires ($load.i8($M.5,($p3 + 18)) == $load.i8($M.5.shadow,($p3.shadow + 18)));
requires ($load.i8($M.5,($p3 + 19)) == $load.i8($M.5.shadow,($p3.shadow + 19)));
requires ($load.i8($M.5,($p3 + 20)) == $load.i8($M.5.shadow,($p3.shadow + 20)));
requires ($load.i8($M.5,($p3 + 21)) == $load.i8($M.5.shadow,($p3.shadow + 21)));
requires ($load.i8($M.5,($p3 + 22)) == $load.i8($M.5.shadow,($p3.shadow + 22)));
requires ($load.i8($M.5,($p3 + 23)) == $load.i8($M.5.shadow,($p3.shadow + 23)));
requires ($load.i8($M.5,($p3 + 24)) == $load.i8($M.5.shadow,($p3.shadow + 24)));
requires ($load.i8($M.5,($p3 + 25)) == $load.i8($M.5.shadow,($p3.shadow + 25)));
requires ($load.i8($M.5,($p3 + 26)) == $load.i8($M.5.shadow,($p3.shadow + 26)));
requires ($load.i8($M.5,($p3 + 27)) == $load.i8($M.5.shadow,($p3.shadow + 27)));
requires ($load.i8($M.5,($p3 + 28)) == $load.i8($M.5.shadow,($p3.shadow + 28)));
requires ($load.i8($M.5,($p3 + 29)) == $load.i8($M.5.shadow,($p3.shadow + 29)));
requires ($load.i8($M.5,($p3 + 30)) == $load.i8($M.5.shadow,($p3.shadow + 30)));
requires ($load.i8($M.5,($p3 + 31)) == $load.i8($M.5.shadow,($p3.shadow + 31)));
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "run.c", 5, 12} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "smack:arg:run_wrapper:$i2"} boogie_si_record_i32($i2);
  call {:cexpr "smack:arg:run_wrapper:$p3"} boogie_si_record_ref($p3);
  call {:cexpr "smack:arg:run_wrapper:$i4"} boogie_si_record_i64($i4);
  call {:cexpr "run_wrapper:arg:cc"} boogie_si_record_i32($i2);
  call {:cexpr "run_wrapper:arg:len"} boogie_si_record_i64($i4);
  assume {:sourceloc "run.c", 5, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "run.c", 5, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "run.c", 6, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p6 := __SMACK_value.ref($p1);
  $p6.shadow := $p6;
  ...
  assume {:verifier.code 0} true;
  call {:name $i2} $p7 := __SMACK_value.i32($i2);
  $p7.shadow := $p7;
  ...
  assume {:verifier.code 0} true;
  call {:name $p3} $p8 := __SMACK_value.ref($p3);
  $p8.shadow := $p8;
  ...
  assume {:verifier.code 0} true;
  call {:name $i4} $p9 := __SMACK_value.i64($i4);
  $p9.shadow := $p9;
  ...
  call {:name $p3} {:array "$load.i8", $M.5, $p3, 1, 32} $p10 := __SMACK_values($p3, 32);
  $p10.shadow := $p10;
  ...
  assume {:verifier.code 1} true;
  call {:name $p1} {:array "$load.i8", $M.6, $p1, 1, 32} $p11 := __SMACK_values($p1, 32);
  $p11.shadow := $p11;
  ...
  assume {:sourceloc "run.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call $i12, $i12.shadow := br_chacha20_ct_run($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow, $p3, $p3.shadow, $i4, $i4.shadow);
  assume {:sourceloc "run.c", 15, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
...
axiom (__SMACK_value == $sub.ref(0,9296));
...
axiom (__SMACK_dummy == $sub.ref(0,14456));
...
axiom (__SMACK_and32 == $sub.ref(0,15488));
...
axiom (__SMACK_and64 == $sub.ref(0,16520));
...
axiom (__SMACK_and16 == $sub.ref(0,17552));
...
axiom (__SMACK_and8 == $sub.ref(0,18584));
...
axiom (__SMACK_or32 == $sub.ref(0,19616));
...
axiom (__SMACK_or64 == $sub.ref(0,20648));
...
axiom (__SMACK_or16 == $sub.ref(0,21680));
...
axiom (__SMACK_or8 == $sub.ref(0,22712));
...
axiom (__SMACK_check_overflow == $sub.ref(0,23744));
...
axiom (__SMACK_loop_exit == $sub.ref(0,24776));
...
axiom (__SMACK_decls == $sub.ref(0,25808));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,26840));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,27872));
...
axiom (__SMACK_static_init == $sub.ref(0,28904));
...
$bb0:
  ...
  assert ($add.ref($add.ref(br_chacha20_ct_run.CW,$mul.ref(0,16)),$mul.ref(1,4)) == $add.ref($add.ref(br_chacha20_ct_run.CW,$mul.ref(0,16)),$mul.ref(1,4)));
  ...
  assert ($add.ref($add.ref(br_chacha20_ct_run.CW,$mul.ref(0,16)),$mul.ref(2,4)) == $add.ref($add.ref(br_chacha20_ct_run.CW,$mul.ref(0,16)),$mul.ref(2,4)));
  ...
  assert ($add.ref($add.ref(br_chacha20_ct_run.CW,$mul.ref(0,16)),$mul.ref(3,4)) == $add.ref($add.ref(br_chacha20_ct_run.CW,$mul.ref(0,16)),$mul.ref(3,4)));
