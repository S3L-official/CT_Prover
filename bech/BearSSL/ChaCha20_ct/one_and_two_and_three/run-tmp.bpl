...
modifies $M.4;
modifies $CurrAddr;
requires (br_chacha20_ct_run.CW == br_chacha20_ct_run.CW);
{
  var $p5: ref;
  var $p5.shadow: ref;
  var $p6: ref;
...
modifies $M.2, $exn;
requires (br_chacha20_ct_run.CW == br_chacha20_ct_run.CW);
requires ($add.ref($add.ref(br_chacha20_ct_run.CW,$mul.ref(0,16)),$mul.ref(1,4)) == $add.ref($add.ref(br_chacha20_ct_run.CW,$mul.ref(0,16)),$mul.ref(1,4)));
requires ($add.ref($add.ref(br_chacha20_ct_run.CW,$mul.ref(0,16)),$mul.ref(2,4)) == $add.ref($add.ref(br_chacha20_ct_run.CW,$mul.ref(0,16)),$mul.ref(2,4)));
requires ($add.ref($add.ref(br_chacha20_ct_run.CW,$mul.ref(0,16)),$mul.ref(3,4)) == $add.ref($add.ref(br_chacha20_ct_run.CW,$mul.ref(0,16)),$mul.ref(3,4)));
{
$bb0:
