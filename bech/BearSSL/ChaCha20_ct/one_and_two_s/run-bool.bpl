...
$bb5:
  ...
  assert {:likely_shadow_invariant} ($p5.dup == 0);
  assert {:likely_shadow_invariant} ($p7.dup == 0);
  assert {:likely_shadow_invariant} ($i16.dup == 0);
  assume {:sourceloc "../BearSSL/src/symcipher/chacha20_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
$bb32:
  assert {:shadow_invariant} $shadow_ok;
  assert {:likely_shadow_invariant} ($i617.dup == 0);
  assert {:likely_shadow_invariant} ($p8.dup == 0);
  assert {:likely_shadow_invariant} ($p6.dup == 0);
  assert {:likely_shadow_invariant} ($p5.dup == 0);
  assert {:likely_shadow_invariant} ($p7.dup == 0);
...
$bb36:
  assert {:shadow_invariant} $shadow_ok;
  assert {:likely_shadow_invariant} ($i627.dup == 0);
  assert {:likely_shadow_invariant} ($p8.dup == 0);
  assert {:likely_shadow_invariant} ($p6.dup == 0);
  assert {:likely_shadow_invariant} ($p5.dup == 0);
  assert {:likely_shadow_invariant} ($p7.dup == 0);
...
$bb40:
  assert {:shadow_invariant} $shadow_ok;
  assert {:likely_shadow_invariant} ($i642.dup == 0);
  assert {:likely_shadow_invariant} ($p8.dup == 0);
  assert {:likely_shadow_invariant} ($p6.dup == 0);
  assert {:likely_shadow_invariant} ($p5.dup == 0);
  assert {:likely_shadow_invariant} ($p7.dup == 0);
