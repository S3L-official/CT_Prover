...
procedure {:inline 1} br_des_ct_cbcdec_run($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $i3: i64, $i3.shadow: i64)
...
$bb0:
  ...
  $p6.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,1152)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 60, 37} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(392,1));
  $p7.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(392,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 60, 37} true;
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $i8 := $load.i32($M.0,$p7);
  ...
  $p9.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(8,1));
  $p10 := $add.ref($add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(8,1)),$mul.ref(0,4));
  $p10.shadow := $add.ref($add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(8,1)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 60, 2} true;
  assume {:verifier.code 0} true;
  call br_des_ct_skey_expand($p6, $p6.shadow, $i8, $i8.shadow, $p10, $p10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 63, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i3;
  $i11.shadow := $i3.shadow;
  $p12 := $p2;
  $p12.shadow := $p2.shadow;
  goto $bb1;
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i13 := $ugt.i64($i11,0);
  $i13.shadow := $ugt.i64($i11.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 63, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  $p14.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 67, 3} true;
  assume {:verifier.code 0} true;
  assert ($p14 == $p14.shadow);
  assert ($p12 == $p12.shadow);
  call $M.2, $M.2.shadow := $memcpy.i8($M.2, $M.2.shadow, $M.1, $M.1.shadow, $p14, $p14.shadow, $p12, $p12.shadow, 8, 8, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 68, 32} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(392,1));
  $p15.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(392,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 68, 32} true;
  assume {:verifier.code 0} true;
  ...
  $p17.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,1152)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 68, 3} true;
  assume {:verifier.code 0} true;
  call br_des_ct_process_block($i16, $i16.shadow, $p17, $p17.shadow, $p12, $p12.shadow);
...
$bb4:
  ...
  assume {:verifier.code 0} true;
  $i19 := $slt.i32($i18,8);
  $i19.shadow := $slt.i32($i18.shadow,8);
...
$bb5:
  ...
  $i20.shadow := $sext.i32.i64($i18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 70, 14} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p1,$mul.ref($i20,1));
  $p21.shadow := $add.ref($p1.shadow,$mul.ref($i20.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 70, 14} true;
  assume {:verifier.code 0} true;
  assert ($p21 == $p21.shadow);
  $i22 := $load.i8($M.3,$p21);
  $i22.shadow := $load.i8($M.3.shadow,$p21.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 70, 14} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i8.i32($i22);
  ...
  $i24.shadow := $sext.i32.i64($i18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 70, 4} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($p12,$mul.ref($i24,1));
  $p25.shadow := $add.ref($p12.shadow,$mul.ref($i24.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 70, 11} true;
  assume {:verifier.code 0} true;
  assert ($p25 == $p25.shadow);
  $i26 := $load.i8($M.1,$p25);
  $i26.shadow := $load.i8($M.1.shadow,$p25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 70, 11} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i8.i32($i26);
  ...
  assume {:verifier.code 0} true;
  $i28 := $xor.i32($i27,$i23);
  $i28.shadow := $xor.i32($i27.shadow,$i23.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 70, 11} true;
  assume {:verifier.code 0} true;
  ...
  $M.1.shadow := $store.i8($M.1.shadow,$p25.shadow,$i29.shadow);
...
$bb6:
  ...
  $p31.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 72, 3} true;
  assume {:verifier.code 0} true;
  assert ($p1 == $p1.shadow);
  assert ($p31 == $p31.shadow);
  call $M.3, $M.3.shadow := $memcpy.i8($M.3, $M.3.shadow, $M.2, $M.2.shadow, $p1, $p1.shadow, $p31, $p31.shadow, 8, 8, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 73, 7} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($p12,$mul.ref(8,1));
  $p32.shadow := $add.ref($p12.shadow,$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 74, 7} true;
  assume {:verifier.code 0} true;
  $i33 := $sub.i64($i11,8);
  $i33.shadow := $sub.i64($i11.shadow,8);
  call {:cexpr "len"} boogie_si_record_i64($i33);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 63, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $i33;
  $i11.shadow := $i33.shadow;
  $p12 := $p32;
  $p12.shadow := $p32.shadow;
  goto $bb1;
$bb7:
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcdec.c", 69, 24} true;
  assume {:verifier.code 0} true;
  $i30 := $add.i32($i18,1);
  $i30.shadow := $add.i32($i18.shadow,1);
...
$bb2:
  ...
  $M.4.shadow := $store.i32($M.4.shadow,$p6.shadow,$i19.shadow);
  ...
  $M.4.shadow := $store.i32($M.4.shadow,$p20.shadow,$i22.shadow);
  ...
  $M.4.shadow := $store.i32($M.4.shadow,$p24.shadow,$i26.shadow);
  ...
  $M.4.shadow := $store.i32($M.4.shadow,$p28.shadow,$i30.shadow);
  $i33 := $add.i32(1,1);
  ...
  $M.4.shadow := $store.i32($M.4.shadow,$p32.shadow,$i40.shadow);
  ...
  $M.4.shadow := $store.i32($M.4.shadow,$p42.shadow,$i44.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 393, 2} true;
  assume {:verifier.code 0} true;
  $p4 := $p34;
...
$bb0:
  ...
  $M.5.shadow := $store.i32($M.5.shadow,$p3.shadow,$i5.shadow);
  ...
  $M.6.shadow := $store.i32($M.6.shadow,$p4.shadow,$i7.shadow);
...
$bb3:
  ...
  assert ($p3 == $p3.shadow);
  $i13 := $load.i32($M.5,$p3);
  $i13.shadow := $load.i32($M.5.shadow,$p3.shadow);
  ...
  assert ($p4 == $p4.shadow);
  $i15 := $load.i32($M.6,$p4);
  $i15.shadow := $load.i32($M.6.shadow,$p4.shadow);
...
$bb0:
  ...
  $M.5.shadow := $store.i32($M.5.shadow,$p0.shadow,$i33.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_support.c", 56, 6} true;
  assume {:verifier.code 0} true;
  assert ($p1 == $p1.shadow);
  $M.6 := $store.i32($M.6,$p1,$i31);
  $M.6.shadow := $store.i32($M.6.shadow,$p1.shadow,$i31.shadow);
...
$bb3:
  ...
  $M.5.shadow := $store.i32($M.5.shadow,$p0.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 363, 6} true;
  assume {:verifier.code 0} true;
  assert ($p1 == $p1.shadow);
  $M.6 := $store.i32($M.6,$p1,$i7);
  $M.6.shadow := $store.i32($M.6.shadow,$p1.shadow,$i7.shadow);
...
$bb0:
  ...
  $i24.shadow := $load.i32($M.4.shadow,$p23.shadow);
  ...
  $i27.shadow := $load.i32($M.4.shadow,$p26.shadow);
  ...
  $i33.shadow := $load.i32($M.4.shadow,$p32.shadow);
  ...
  $i36.shadow := $load.i32($M.4.shadow,$p35.shadow);
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_des_ct_cbcdec_run($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow, $i3, $i3.shadow);
