...
const br_des_ct_cbcenc_run: ref;
axiom (br_des_ct_cbcenc_run == $sub.ref(0,1032));
procedure {:inline 1} br_des_ct_cbcenc_run($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $i3: i64, $i3.shadow: i64)
modifies $exn, $M.2, $M.1;
modifies $M.3;
modifies $M.4, $M.5;
modifies $CurrAddr;
{
  ...
  var $i30.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 44, 24} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(1152,$zext.i32.i64(1)));
  $p4.shadow := $p4;
  call {:cexpr "br_des_ct_cbcenc_run:arg:len"} boogie_si_record_i64($i3);
  assume true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 44, 24} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p4,$mul.ref(0,1152)),$mul.ref(0,4));
  $p5.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,1152)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 44, 37} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(392,1));
  $p6.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(392,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 44, 37} true;
  assume {:verifier.code 0} true;
  assert ($p6 == $p6.shadow);
  $i7 := $load.i32($M.0,$p6);
  $i7.shadow := $load.i32($M.0.shadow,$p6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 44, 54} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(8,1));
  $p8.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(8,1));
  $p9 := $add.ref($add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(8,1)),$mul.ref(0,4));
  $p9.shadow := $add.ref($add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(8,1)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 44, 2} true;
  assume {:verifier.code 0} true;
  call br_des_ct_skey_expand($p5, $p5.shadow, $i7, $i7.shadow, $p9, $p9.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 47, 2} true;
  assume {:verifier.code 0} true;
  $i10 := $i3;
  $i10.shadow := $i3.shadow;
  $p11 := $p2;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 47, 13} true;
  assume {:verifier.code 0} true;
  $i12 := $ugt.i64($i10,0);
  $i12.shadow := $ugt.i64($i10.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 47, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i12 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 50, 8} true;
  assume {:verifier.code 0} true;
  $i13 := 0;
  $i13.shadow := 0;
  goto $bb4;
$bb3:
  assume !($i12 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 58, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 50, 17} true;
  assume {:verifier.code 0} true;
  $i14 := $slt.i32($i13,8);
  $i14.shadow := $slt.i32($i13.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 50, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i14 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 51, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 51, 4} true;
  assume {:verifier.code 0} true;
  $i19 := $sext.i32.i64($i13);
  $i19.shadow := $sext.i32.i64($i13.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 51, 4} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($p11,$mul.ref($i19,1));
  $p20.shadow := $add.ref($p11.shadow,$mul.ref($i19.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 51, 11} true;
  assume {:verifier.code 0} true;
  assert ($p20 == $p20.shadow);
  $i21 := $load.i8($M.2,$p20);
  $i21.shadow := $load.i8($M.2.shadow,$p20.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 51, 11} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i8.i32($i21);
  ...
  assume {:verifier.code 0} true;
  assert ($p20 == $p20.shadow);
  $M.2 := $store.i8($M.2,$p20,$i24);
  $M.2.shadow := $store.i8($M.2.shadow,$p20.shadow,$i24.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 52, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !($i14 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 53, 32} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(392,1));
  $p26.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(392,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 53, 32} true;
  assume {:verifier.code 0} true;
  assert ($p26 == $p26.shadow);
  $i27 := $load.i32($M.0,$p26);
  $i27.shadow := $load.i32($M.0.shadow,$p26.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 53, 44} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p4,$mul.ref(0,1152)),$mul.ref(0,4));
  $p28.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,1152)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 53, 3} true;
  assume {:verifier.code 0} true;
  call br_des_ct_process_block($i27, $i27.shadow, $p28, $p28.shadow, $p11, $p11.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 54, 3} true;
  assume {:verifier.code 0} true;
  assert ($p1 == $p1.shadow);
  assert ($p11 == $p11.shadow);
  call $M.1, $M.1.shadow := $memcpy.i8($M.1, $M.1.shadow, $M.2, $M.2.shadow, $p1, $p1.shadow, $p11, $p11.shadow, 8, 8, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 55, 7} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p11,$mul.ref(8,1));
  $p29.shadow := $add.ref($p11.shadow,$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 56, 7} true;
  assume {:verifier.code 0} true;
  $i30 := $sub.i64($i10,8);
  $i30.shadow := $sub.i64($i10.shadow,8);
  call {:cexpr "len"} boogie_si_record_i64($i30);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 47, 2} true;
  assume {:verifier.code 0} true;
  $i10 := $i30;
  $i10.shadow := $i30.shadow;
  $p11 := $p29;
  $p11.shadow := $p29.shadow;
  goto $bb1;
$bb7:
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 50, 24} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i13,1);
...
procedure {:inline 1} br_des_ct_skey_expand($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32, $p2: ref, $p2.shadow: ref)
modifies $M.3, $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
...
$bb1:
  ...
  $i7.shadow := $add.i32($i5.shadow,$sub.i32(0,1));
...
$bb2:
  ...
  $p9.shadow := $add.ref($p4.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 396, 7} true;
  assume {:verifier.code 0} true;
  assert ($p4 == $p4.shadow);
  $i10 := $load.i32($M.0,$p4);
  $i10.shadow := $load.i32($M.0.shadow,$p4.shadow);
  ...
  assume {:verifier.code 0} true;
  $p4 := $p34;
  $p4.shadow := $p34.shadow;
  $i5 := $i7;
  $i5.shadow := $i7.shadow;
  $p6 := $p46;
  $p6.shadow := $p46.shadow;
  goto $bb1;
$bb3:
  assume !($i8 == 1);
...
axiom (br_des_ct_process_block == $sub.ref(0,5160));
procedure {:inline 1} br_des_ct_process_block($i0: i32, $i0.shadow: i32, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
...
$bb0:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 375, 6} true;
  assume {:verifier.code 0} true;
  call $i5, $i5.shadow := br_dec32be($p2, $p2.shadow);
...
$bb2:
  ...
  $p12.shadow := $add.ref($p8.shadow,$mul.ref(96,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 378, 2} true;
  assume {:verifier.code 0} true;
  $p8 := $p12;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i9 := $slt.i32($i5,16);
  $i9.shadow := $slt.i32($i5.shadow,16);
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  call $i10, $i10.shadow := Fconf($i8, $i8.shadow, $p6, $p6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 357, 9} true;
  assume {:verifier.code 0} true;
  $i11 := $xor.i32($i7,$i10);
  $i11.shadow := $xor.i32($i7.shadow,$i10.shadow);
  ...
  $p12.shadow := $add.ref($p6.shadow,$mul.ref(6,4));
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assert ($p0 == $p0.shadow);
  $M.4 := $store.i32($M.4,$p0,$i8);
  $M.4.shadow := $store.i32($M.4.shadow,$p0.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 363, 6} true;
  assume {:verifier.code 0} true;
  assert ($p1 == $p1.shadow);
  $M.5 := $store.i32($M.5,$p1,$i7);
  $M.5.shadow := $store.i32($M.5.shadow,$p1.shadow,$i7.shadow);
...
$bb4:
  ...
  $p6 := $p12;
  $p6.shadow := $p12.shadow;
  $i7 := $i8;
  $i7.shadow := $i8.shadow;
  $i8 := $i11;
  $i8.shadow := $i11.shadow;
  goto $bb1;
}
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  assert ($p4 == $p4.shadow);
  $M.2 := $store.i8($M.2,$p4,$i3);
  $M.2.shadow := $store.i8($M.2.shadow,$p4.shadow,$i3.shadow);
  ...
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $M.2 := $store.i8($M.2,$p7,$i6);
  $M.2.shadow := $store.i8($M.2.shadow,$p7.shadow,$i6.shadow);
  ...
  assume {:verifier.code 0} true;
  assert ($p10 == $p10.shadow);
  $M.2 := $store.i8($M.2,$p10,$i9);
  $M.2.shadow := $store.i8($M.2.shadow,$p10.shadow,$i9.shadow);
  ...
  $M.2.shadow := $store.i8($M.2.shadow,$p12.shadow,$i11.shadow);
...
procedure {:inline 1} Fconf($i0: i32, $i0.shadow: i32, $p1: ref, $p1.shadow: ref) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i18 := $lshr.i32($i16,28);
  $i18.shadow := $lshr.i32($i16.shadow,28);
  ...
  assume {:verifier.code 0} true;
  $i20 := $lshr.i32($i10,4);
  $i20.shadow := $lshr.i32($i10.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 223, 23} true;
  assume {:verifier.code 0} true;
  $i21 := $shl.i32($i10,28);
  $i21.shadow := $shl.i32($i10.shadow,28);
  ...
  $p23.shadow := $add.ref($p1.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 228, 8} true;
  assume {:verifier.code 0} true;
  ...
  $p26.shadow := $add.ref($p1.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 229, 8} true;
  assume {:verifier.code 0} true;
  assert ($p26 == $p26.shadow);
  ...
  assume {:verifier.code 0} true;
  $i28 := $xor.i32($i10,$i27);
  $i28.shadow := $xor.i32($i10.shadow,$i27.shadow);
  ...
  $p29.shadow := $add.ref($p1.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 230, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i31 := $xor.i32($i12,$i30);
  $i31.shadow := $xor.i32($i12.shadow,$i30.shadow);
  ...
  $p32.shadow := $add.ref($p1.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 231, 8} true;
  assume {:verifier.code 0} true;
  assert ($p32 == $p32.shadow);
  $i33 := $load.i32($M.3,$p32);
  $i33.shadow := $load.i32($M.3.shadow,$p32.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 231, 5} true;
  assume {:verifier.code 0} true;
  $i34 := $xor.i32($i14,$i33);
  $i34.shadow := $xor.i32($i14.shadow,$i33.shadow);
  ...
  $p35.shadow := $add.ref($p1.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 232, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i37 := $xor.i32($i16,$i36);
  $i37.shadow := $xor.i32($i16.shadow,$i36.shadow);
  ...
  $p38.shadow := $add.ref($p1.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 233, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i40 := $xor.i32($i22,$i39);
  $i40.shadow := $xor.i32($i22.shadow,$i39.shadow);
  ...
  $i164.shadow := $and.i32($i158.shadow,302121248);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 322, 8} true;
  assume {:verifier.code 0} true;
  call $i165, $i165.shadow := rotl($i164, $i164.shadow, 5, 5);
  ...
  $i170.shadow := $and.i32($i158.shadow,32768);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 324, 36} true;
  assume {:verifier.code 0} true;
  $i171 := $shl.i32($i170,9);
  $i171.shadow := $shl.i32($i170.shadow,9);
  ...
  $i194.shadow := $and.i32($i158.shadow,1082136576);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 332, 8} true;
  assume {:verifier.code 0} true;
  call $i195, $i195.shadow := rotl($i194, $i194.shadow, 17, 17);
  ...
  $i206.shadow := $and.i32($i158.shadow,2281701384);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct.c", 336, 8} true;
  assume {:verifier.code 0} true;
  call $i207, $i207.shadow := rotl($i206, $i206.shadow, 24, 24);
...
procedure {:inline 1} rotl($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
axiom (cbc_encrypt_wrapper == $sub.ref(0,14448));
...
requires {:public_in $load.i8, $M.2, $p2, 1, 16} true;
requires {:public_in $load.i8, $M.1, $p1, 1, 16} true;
modifies $exn;
modifies $M.2, $M.1;
modifies $CurrAddr;
...
requires ($load.i32($M.0,$add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(392,1))) == $load.i32($M.0.shadow,$add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(392,1))));
...
requires ($load.i8($M.1,($p1 + 0)) == $load.i8($M.1.shadow,($p1.shadow + 0)));
requires ($load.i8($M.1,($p1 + 1)) == $load.i8($M.1.shadow,($p1.shadow + 1)));
requires ($load.i8($M.1,($p1 + 2)) == $load.i8($M.1.shadow,($p1.shadow + 2)));
requires ($load.i8($M.1,($p1 + 3)) == $load.i8($M.1.shadow,($p1.shadow + 3)));
requires ($load.i8($M.1,($p1 + 4)) == $load.i8($M.1.shadow,($p1.shadow + 4)));
requires ($load.i8($M.1,($p1 + 5)) == $load.i8($M.1.shadow,($p1.shadow + 5)));
requires ($load.i8($M.1,($p1 + 6)) == $load.i8($M.1.shadow,($p1.shadow + 6)));
requires ($load.i8($M.1,($p1 + 7)) == $load.i8($M.1.shadow,($p1.shadow + 7)));
requires ($load.i8($M.1,($p1 + 8)) == $load.i8($M.1.shadow,($p1.shadow + 8)));
requires ($load.i8($M.1,($p1 + 9)) == $load.i8($M.1.shadow,($p1.shadow + 9)));
requires ($load.i8($M.1,($p1 + 10)) == $load.i8($M.1.shadow,($p1.shadow + 10)));
requires ($load.i8($M.1,($p1 + 11)) == $load.i8($M.1.shadow,($p1.shadow + 11)));
requires ($load.i8($M.1,($p1 + 12)) == $load.i8($M.1.shadow,($p1.shadow + 12)));
requires ($load.i8($M.1,($p1 + 13)) == $load.i8($M.1.shadow,($p1.shadow + 13)));
requires ($load.i8($M.1,($p1 + 14)) == $load.i8($M.1.shadow,($p1.shadow + 14)));
requires ($load.i8($M.1,($p1 + 15)) == $load.i8($M.1.shadow,($p1.shadow + 15)));
{
  var $p4: ref;
  var $p4.shadow: ref;
  var $p5: ref;
...
$bb0:
  ...
  call {:name $p2} {:array "$load.i8", $M.2, $p2, 1, 16} $p11 := __SMACK_values($p2, 16);
  $p11.shadow := $p11;
  ...
  assume {:verifier.code 1} true;
  call {:name $p1} {:array "$load.i8", $M.1, $p1, 1, 16} $p12 := __SMACK_values($p1, 16);
  $p12.shadow := $p12;
  ...
  assume {:verifier.code 0} true;
  call br_des_ct_cbcenc_run($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow, $i3, $i3.shadow);
