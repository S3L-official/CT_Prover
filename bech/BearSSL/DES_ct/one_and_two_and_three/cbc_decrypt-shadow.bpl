...
modifies $M.2, $M.2.shadow, $exn, $exn.shadow, $M.1, $M.1.shadow, $M.3, $M.3.shadow;
...
modifies $M.2, $M.2.shadow, $M.1, $M.1.shadow, $M.3, $M.3.shadow;
modifies $CurrAddr;
modifies $M.4, $M.4.shadow, $M.5, $M.5.shadow, $M.6, $M.6.shadow;
{
  var $p4: ref;
  var $p4.shadow: ref;
  var $p5: ref;
