...
procedure {:inline 1} br_des_ct_cbcenc_run($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1, $i3: i64, $i3.dup: i1)
...
$bb0:
  ...
  $p9.dup := $or.i1($or.i1($or.i1($p0.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 44, 2} true;
  assume {:verifier.code 0} true;
  call br_des_ct_skey_expand($p5, $p5.dup, $i7, $i7.dup, $p9, $p9.dup);
...
$bb5:
  ...
  $p20.dup := $or.i1($p11.dup,$or.i1($i19.dup,0));
  ...
  $M.2.dup := $store.i1($M.2.dup,$p20,$i24.dup);
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  call br_des_ct_process_block($i27, $i27.dup, $p28, $p28.dup, $p11, $p11.dup);
  ...
  call $M.1, $M.1.dup := $memcpy.i8($M.1, $M.1.dup, $M.2, $M.2.dup, $p1, $p1.dup, $p11, $p11.dup, 8, 0, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/des_ct_cbcenc.c", 55, 7} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p11,$mul.ref(8,1));
  $p29.dup := $or.i1($p11.dup,$or.i1(0,0));
...
$bb2:
  ...
  $M.3.dup := $store.i1($M.3.dup,$p24,$i26.dup);
  ...
  $M.3.dup := $store.i1($M.3.dup,$p28,$i30.dup);
  $i33 := $add.i32(1,1);
  $i33.dup := $or.i1(0,0);
  ...
  $M.3.dup := $store.i1($M.3.dup,$p32,$i40.dup);
...
$bb0:
  ...
  $M.2.dup := $store.i1($M.2.dup,$p4,$i3.dup);
  ...
  $M.2.dup := $store.i1($M.2.dup,$p7,$i6.dup);
  ...
  $M.2.dup := $store.i1($M.2.dup,$p10,$i9.dup);
  ...
  $M.2.dup := $store.i1($M.2.dup,$p12,$i11.dup);
...
requires ($load.i8($M.1.dup,($p1 + 0)) == 0);
requires ($load.i8($M.1.dup,($p1 + 1)) == 0);
requires ($load.i8($M.1.dup,($p1 + 2)) == 0);
requires ($load.i8($M.1.dup,($p1 + 3)) == 0);
requires ($load.i8($M.1.dup,($p1 + 4)) == 0);
requires ($load.i8($M.1.dup,($p1 + 5)) == 0);
requires ($load.i8($M.1.dup,($p1 + 6)) == 0);
requires ($load.i8($M.1.dup,($p1 + 7)) == 0);
requires ($load.i8($M.1.dup,($p1 + 8)) == 0);
requires ($load.i8($M.1.dup,($p1 + 9)) == 0);
requires ($load.i8($M.1.dup,($p1 + 10)) == 0);
requires ($load.i8($M.1.dup,($p1 + 11)) == 0);
requires ($load.i8($M.1.dup,($p1 + 12)) == 0);
requires ($load.i8($M.1.dup,($p1 + 13)) == 0);
requires ($load.i8($M.1.dup,($p1 + 14)) == 0);
requires ($load.i8($M.1.dup,($p1 + 15)) == 0);
{
  var $p4: ref;
  var $p4.dup: i1;
  var $p5: ref;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_des_ct_cbcenc_run($p0, $p0.dup, $p1, $p1.dup, $p2, $p2.dup, $i3, $i3.dup);
