...
modifies $M.1, $M.1.shadow, $exn, $exn.shadow, $M.0, $M.0.shadow, $M.3, $M.3.shadow;
modifies $M.4, $M.4.shadow, $M.5, $M.5.shadow, $shadow_ok;
modifies $CurrAddr;
{
  var $p4: ref;
  var $p4.shadow: ref;
...
modifies $M.4, $M.4.shadow, $M.5, $M.5.shadow, $shadow_ok, $exn, $exn.shadow;
...
requires ($p0 == $p0.shadow);
requires ($p1 == $p1.shadow);
modifies $M.4, $M.4.shadow, $M.5, $M.5.shadow, $exn, $exn.shadow;
{
  var $i2: i32;
  var $i2.shadow: i32;
  var $i3: i32;
...
modifies $shadow_ok, $exn, $exn.shadow;
modifies $M.1, $M.1.shadow, $M.0, $M.0.shadow, $M.3, $M.3.shadow;
modifies $CurrAddr, $M.6, $M.6.shadow, $M.7, $M.7.shadow, $M.8, $M.8.shadow, $M.9, $M.9.shadow, $M.10, $M.10.shadow, $M.11, $M.11.shadow, $M.12, $M.12.shadow, $M.13, $M.13.shadow;
modifies $M.4, $M.4.shadow, $M.5, $M.5.shadow;
{
  var $p4: ref;
  var $p4.shadow: ref;
  var $p5: ref;
...
modifies $M.6, $M.6.shadow, $M.7, $M.7.shadow, $M.8, $M.8.shadow, $M.9, $M.9.shadow, $M.10, $M.10.shadow, $M.11, $M.11.shadow, $M.12, $M.12.shadow, $M.13, $M.13.shadow, $exn, $exn.shadow;
{
$bb0:
...
modifies $CurrAddr, $exn;
modifies $M.6, $M.6.shadow, $M.7, $M.7.shadow, $M.8, $M.8.shadow, $M.9, $M.9.shadow, $M.10, $M.10.shadow, $M.11, $M.11.shadow, $M.12, $M.12.shadow, $M.13, $M.13.shadow, $exn.shadow;
{
