...
const br_des_tab_cbcdec_run: ref;
axiom (br_des_tab_cbcdec_run == $sub.ref(0,11272));
procedure {:inline 1} br_des_tab_cbcdec_run($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $i3: i64, $i3.shadow: i64)
modifies $M.1, $exn, $M.0, $M.3;
modifies $M.4, $M.5;
modifies $CurrAddr;
{
  var $p4: ref;
  ...
  var $i28.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 61, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(8,$zext.i32.i64(1)));
  $p4.shadow := $p4;
  call {:cexpr "br_des_tab_cbcdec_run:arg:len"} boogie_si_record_i64($i3);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 61, 2} true;
  assume {:verifier.code 0} true;
  $i5 := $i3;
  $i5.shadow := $i3.shadow;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 61, 13} true;
  assume {:verifier.code 0} true;
  $i7 := $ugt.i64($i5,0);
  $i7.shadow := $ugt.i64($i5.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 61, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i7 == 1);
  assume true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 65, 3} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p4,$mul.ref(0,8)),$mul.ref(0,1));
  $p8.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 65, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p8 == $p8.shadow));
  $shadow_ok := ($shadow_ok && ($p6 == $p6.shadow));
  call $M.1, $M.1.shadow := $memcpy.i8($M.1, $M.1.shadow, $M.0, $M.0.shadow, $p8, $p8.shadow, $p6, $p6.shadow, 8, 8, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 66, 33} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(392,1));
  $p9.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(392,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 66, 33} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p9 == $p9.shadow));
  $i10 := $load.i32($M.2,$p9);
  $i10.shadow := $load.i32($M.2.shadow,$p9.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 66, 50} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(8,1));
  $p11.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(8,1));
  $p12 := $add.ref($add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(8,1)),$mul.ref(0,4));
  $p12.shadow := $add.ref($add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(8,1)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 66, 3} true;
  assume {:verifier.code 0} true;
  call br_des_tab_process_block($i10, $i10.shadow, $p12, $p12.shadow, $p6, $p6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 67, 8} true;
  assume {:verifier.code 0} true;
  $i13 := 0;
  $i13.shadow := 0;
  goto $bb4;
$bb3:
  assume !($i7 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 74, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i13 == $i13.shadow);
  assert {:shadow_invariant} ($p6 == $p6.shadow);
  assert {:shadow_invariant} ($p4 == $p4.shadow);
  assert {:shadow_invariant} ($i5 == $i5.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 67, 17} true;
  assume {:verifier.code 0} true;
  $i14 := $slt.i32($i13,8);
  $i14.shadow := $slt.i32($i13.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 67, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i14 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 68, 14} true;
  assume {:verifier.code 0} true;
  $i15 := $sext.i32.i64($i13);
  $i15.shadow := $sext.i32.i64($i13.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 68, 14} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p1,$mul.ref($i15,1));
  $p16.shadow := $add.ref($p1.shadow,$mul.ref($i15.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 68, 14} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p16 == $p16.shadow));
  $i17 := $load.i8($M.3,$p16);
  $i17.shadow := $load.i8($M.3.shadow,$p16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 68, 14} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i8.i32($i17);
  $i18.shadow := $zext.i8.i32($i17.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 68, 4} true;
  assume {:verifier.code 0} true;
  $i19 := $sext.i32.i64($i13);
  $i19.shadow := $sext.i32.i64($i13.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 68, 4} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($p6,$mul.ref($i19,1));
  $p20.shadow := $add.ref($p6.shadow,$mul.ref($i19.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 68, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p20 == $p20.shadow));
  $i21 := $load.i8($M.0,$p20);
  $i21.shadow := $load.i8($M.0.shadow,$p20.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 68, 11} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i8.i32($i21);
  $i22.shadow := $zext.i8.i32($i21.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 68, 11} true;
  assume {:verifier.code 0} true;
  $i23 := $xor.i32($i22,$i18);
  $i23.shadow := $xor.i32($i22.shadow,$i18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 68, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 69, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !($i14 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 70, 3} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p4,$mul.ref(0,8)),$mul.ref(0,1));
  $p26.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 70, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p1 == $p1.shadow));
  $shadow_ok := ($shadow_ok && ($p26 == $p26.shadow));
  call $M.3, $M.3.shadow := $memcpy.i8($M.3, $M.3.shadow, $M.1, $M.1.shadow, $p1, $p1.shadow, $p26, $p26.shadow, 8, 8, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 71, 7} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($p6,$mul.ref(8,1));
  $p27.shadow := $add.ref($p6.shadow,$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 72, 7} true;
  assume {:verifier.code 0} true;
  $i28 := $sub.i64($i5,8);
  $i28.shadow := $sub.i64($i5.shadow,8);
  call {:cexpr "len"} boogie_si_record_i64($i28);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 61, 2} true;
  assume {:verifier.code 0} true;
  $i5 := $i28;
  $i5.shadow := $i28.shadow;
  $p6 := $p27;
  $p6.shadow := $p27.shadow;
  goto $bb1;
$bb7:
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcdec.c", 67, 24} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i13,1);
  $i25.shadow := $add.i32($i13.shadow,1);
...
axiom (llvm.dbg.declare == $sub.ref(0,13336));
...
$bb0:
  ...
  $M.4 := $store.i32($M.4,$p3,$i5);
  $M.4.shadow := $store.i32($M.4.shadow,$p3.shadow,$i5.shadow);
  ...
  $M.5 := $store.i32($M.5,$p4,$i7);
  $M.5.shadow := $store.i32($M.5.shadow,$p4.shadow,$i7.shadow);
...
$bb3:
  ...
  $shadow_ok := ($shadow_ok && ($p3 == $p3.shadow));
  $i13 := $load.i32($M.4,$p3);
  $i13.shadow := $load.i32($M.4.shadow,$p3.shadow);
  ...
  $shadow_ok := ($shadow_ok && ($p4 == $p4.shadow));
  $i15 := $load.i32($M.5,$p4);
  $i15.shadow := $load.i32($M.5.shadow,$p4.shadow);
...
$bb0:
  ...
  $shadow_ok := ($shadow_ok && ($p1 == $p1.shadow));
  $i2 := $load.i8($M.0,$p1);
  $i2.shadow := $load.i8($M.0.shadow,$p1.shadow);
  ...
  $i16 := $load.i8($M.0,$p15);
  $i16.shadow := $load.i8($M.0.shadow,$p15.shadow);
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p0 == $p0.shadow));
  $M.4 := $store.i32($M.4,$p0,$i33);
  $M.4.shadow := $store.i32($M.4.shadow,$p0.shadow,$i33.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_support.c", 56, 6} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p1 == $p1.shadow));
  $M.5 := $store.i32($M.5,$p1,$i31);
  $M.5.shadow := $store.i32($M.5.shadow,$p1.shadow,$i31.shadow);
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p0 == $p0.shadow));
  $M.4 := $store.i32($M.4,$p0,$i7);
  $M.4.shadow := $store.i32($M.4.shadow,$p0.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 237, 6} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p1 == $p1.shadow));
  $M.5 := $store.i32($M.5,$p1,$i6);
  $M.5.shadow := $store.i32($M.5.shadow,$p1.shadow,$i6.shadow);
...
$bb0:
  ...
  $M.0.shadow := $store.i8($M.0.shadow,$p4.shadow,$i3.shadow);
  ...
  $M.0.shadow := $store.i8($M.0.shadow,$p7.shadow,$i6.shadow);
  ...
  $M.0.shadow := $store.i8($M.0.shadow,$p12.shadow,$i11.shadow);
...
$bb0:
  ...
  $i12.shadow := $load.i32($M.6.shadow,$p11.shadow);
  ...
  $i19.shadow := $load.i32($M.7.shadow,$p18.shadow);
  ...
  $i27.shadow := $load.i32($M.8.shadow,$p26.shadow);
  ...
  $i34.shadow := $load.i32($M.9.shadow,$p33.shadow);
  ...
  $i42 := $load.i32($M.10,$p41);
  $i42.shadow := $load.i32($M.10.shadow,$p41.shadow);
  ...
  $i50 := $load.i32($M.11,$p49);
  $i50.shadow := $load.i32($M.11.shadow,$p49.shadow);
  ...
  $i58.shadow := $load.i32($M.12.shadow,$p57.shadow);
  ...
  $i65 := $load.i32($M.13,$p64);
  $i65.shadow := $load.i32($M.13.shadow,$p64.shadow);
...
axiom (cbc_decrypt_wrapper == $sub.ref(0,22624));
procedure {:entrypoint} cbc_decrypt_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $i3: i64, $i3.shadow: i64)
...
requires {:public_in $load.i8, $M.0, $p2, 1, 16} true;
requires {:public_in $load.i8, $M.3, $p1, 1, 16} true;
modifies $exn;
modifies $M.1, $M.0, $M.3;
modifies $CurrAddr, $M.6, $M.7, $M.8, $M.9, $M.10, $M.11, $M.12, $M.13;
modifies $M.4, $M.5;
...
requires ($load.i8($M.0,($p2 + 0)) == $load.i8($M.0.shadow,($p2.shadow + 0)));
requires ($load.i8($M.0,($p2 + 1)) == $load.i8($M.0.shadow,($p2.shadow + 1)));
requires ($load.i8($M.0,($p2 + 2)) == $load.i8($M.0.shadow,($p2.shadow + 2)));
requires ($load.i8($M.0,($p2 + 3)) == $load.i8($M.0.shadow,($p2.shadow + 3)));
requires ($load.i8($M.0,($p2 + 4)) == $load.i8($M.0.shadow,($p2.shadow + 4)));
requires ($load.i8($M.0,($p2 + 5)) == $load.i8($M.0.shadow,($p2.shadow + 5)));
requires ($load.i8($M.0,($p2 + 6)) == $load.i8($M.0.shadow,($p2.shadow + 6)));
requires ($load.i8($M.0,($p2 + 7)) == $load.i8($M.0.shadow,($p2.shadow + 7)));
requires ($load.i8($M.0,($p2 + 8)) == $load.i8($M.0.shadow,($p2.shadow + 8)));
requires ($load.i8($M.0,($p2 + 9)) == $load.i8($M.0.shadow,($p2.shadow + 9)));
requires ($load.i8($M.0,($p2 + 10)) == $load.i8($M.0.shadow,($p2.shadow + 10)));
requires ($load.i8($M.0,($p2 + 11)) == $load.i8($M.0.shadow,($p2.shadow + 11)));
requires ($load.i8($M.0,($p2 + 12)) == $load.i8($M.0.shadow,($p2.shadow + 12)));
requires ($load.i8($M.0,($p2 + 13)) == $load.i8($M.0.shadow,($p2.shadow + 13)));
requires ($load.i8($M.0,($p2 + 14)) == $load.i8($M.0.shadow,($p2.shadow + 14)));
requires ($load.i8($M.0,($p2 + 15)) == $load.i8($M.0.shadow,($p2.shadow + 15)));
requires ($load.i8($M.3,($p1 + 0)) == $load.i8($M.3.shadow,($p1.shadow + 0)));
requires ($load.i8($M.3,($p1 + 1)) == $load.i8($M.3.shadow,($p1.shadow + 1)));
requires ($load.i8($M.3,($p1 + 2)) == $load.i8($M.3.shadow,($p1.shadow + 2)));
requires ($load.i8($M.3,($p1 + 3)) == $load.i8($M.3.shadow,($p1.shadow + 3)));
requires ($load.i8($M.3,($p1 + 4)) == $load.i8($M.3.shadow,($p1.shadow + 4)));
requires ($load.i8($M.3,($p1 + 5)) == $load.i8($M.3.shadow,($p1.shadow + 5)));
requires ($load.i8($M.3,($p1 + 6)) == $load.i8($M.3.shadow,($p1.shadow + 6)));
requires ($load.i8($M.3,($p1 + 7)) == $load.i8($M.3.shadow,($p1.shadow + 7)));
requires ($load.i8($M.3,($p1 + 8)) == $load.i8($M.3.shadow,($p1.shadow + 8)));
requires ($load.i8($M.3,($p1 + 9)) == $load.i8($M.3.shadow,($p1.shadow + 9)));
requires ($load.i8($M.3,($p1 + 10)) == $load.i8($M.3.shadow,($p1.shadow + 10)));
requires ($load.i8($M.3,($p1 + 11)) == $load.i8($M.3.shadow,($p1.shadow + 11)));
requires ($load.i8($M.3,($p1 + 12)) == $load.i8($M.3.shadow,($p1.shadow + 12)));
requires ($load.i8($M.3,($p1 + 13)) == $load.i8($M.3.shadow,($p1.shadow + 13)));
requires ($load.i8($M.3,($p1 + 14)) == $load.i8($M.3.shadow,($p1.shadow + 14)));
requires ($load.i8($M.3,($p1 + 15)) == $load.i8($M.3.shadow,($p1.shadow + 15)));
{
  var $p4: ref;
  var $p4.shadow: ref;
  var $p5: ref;
...
$bb0:
  ...
  call {:name $p2} {:array "$load.i8", $M.0, $p2, 1, 16} $p11 := __SMACK_values($p2, 16);
  $p11.shadow := $p11;
  ...
  assume {:verifier.code 0} true;
  call br_des_tab_cbcdec_run($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow, $i3, $i3.shadow);
...
modifies $M.6, $M.7, $M.8, $M.9, $M.10, $M.11, $M.12, $M.13, $exn;
{
$bb0:
  $shadow_ok := ($shadow_ok && (S1 == S1));
  $M.6 := $store.i32($M.6,S1,8421888);
  $M.6.shadow := $store.i32($M.6.shadow,S1,8421888);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(1,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(1,4))));
  $M.6 := $store.i32($M.6,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(1,4)),0);
  $M.6.shadow := $store.i32($M.6.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(1,4)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(2,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(2,4))));
  $M.6 := $store.i32($M.6,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(2,4)),32768);
  $M.6.shadow := $store.i32($M.6.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(2,4)),32768);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(3,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(3,4))));
  $M.6 := $store.i32($M.6,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(3,4)),8421890);
  $M.6.shadow := $store.i32($M.6.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(3,4)),8421890);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(4,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(4,4))));
  $M.6 := $store.i32($M.6,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(4,4)),8421378);
  $M.6.shadow := $store.i32($M.6.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(4,4)),8421378);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref