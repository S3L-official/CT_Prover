...
var $M.13: [ref] ref;
var $M.13.shadow: [ref] ref;
axiom ($GLOBALS_BOTTOM == $sub.ref(0,43264));
...
const {:allocSize 256} {:count 64} S1: ref;
axiom (S1 == $sub.ref(0,1280));
const {:allocSize 256} {:count 64} S2: ref;
axiom (S2 == $sub.ref(0,2560));
const {:allocSize 256} {:count 64} S3: ref;
axiom (S3 == $sub.ref(0,3840));
const {:allocSize 256} {:count 64} S4: ref;
axiom (S4 == $sub.ref(0,5120));
const {:allocSize 256} {:count 64} S5: ref;
axiom (S5 == $sub.ref(0,6400));
const {:allocSize 256} {:count 64} S6: ref;
axiom (S6 == $sub.ref(0,7680));
const {:allocSize 256} {:count 64} S7: ref;
axiom (S7 == $sub.ref(0,8960));
const {:allocSize 256} {:count 64} S8: ref;
axiom (S8 == $sub.ref(0,10240));
const br_des_tab_cbcenc_run: ref;
axiom (br_des_tab_cbcenc_run == $sub.ref(0,11272));
procedure {:inline 1} br_des_tab_cbcenc_run($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $i3: i64, $i3.shadow: i64)
modifies $exn, $M.1, $M.0;
modifies $M.3, $M.4;
modifies $CurrAddr;
{
  var $i4: i64;
  ...
  var $i25.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 45, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_des_tab_cbcenc_run:arg:len"} boogie_si_record_i64($i3);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 45, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $i3;
  $i4.shadow := $i3.shadow;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 45, 13} true;
  assume {:verifier.code 0} true;
  $i6 := $ugt.i64($i4,0);
  $i6.shadow := $ugt.i64($i4.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 45, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i6 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 48, 8} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
  $i7.shadow := 0;
  goto $bb4;
$bb3:
  assume !($i6 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 56, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($p5 == $p5.shadow);
  assert {:shadow_invariant} ($i7 == $i7.shadow);
  assert {:shadow_invariant} ($i4 == $i4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 48, 17} true;
  assume {:verifier.code 0} true;
  $i8 := $slt.i32($i7,8);
  $i8.shadow := $slt.i32($i7.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 48, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 49, 14} true;
  assume {:verifier.code 0} true;
  $i9 := $sext.i32.i64($i7);
  $i9.shadow := $sext.i32.i64($i7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 49, 14} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($p1,$mul.ref($i9,1));
  $p10.shadow := $add.ref($p1.shadow,$mul.ref($i9.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 49, 14} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p10 == $p10.shadow));
  $i11 := $load.i8($M.0,$p10);
  $i11.shadow := $load.i8($M.0.shadow,$p10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 49, 14} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i8.i32($i11);
  $i12.shadow := $zext.i8.i32($i11.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 49, 4} true;
  assume {:verifier.code 0} true;
  $i13 := $sext.i32.i64($i7);
  $i13.shadow := $sext.i32.i64($i7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 49, 4} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p5,$mul.ref($i13,1));
  $p14.shadow := $add.ref($p5.shadow,$mul.ref($i13.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 49, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p14 == $p14.shadow));
  $i15 := $load.i8($M.1,$p14);
  $i15.shadow := $load.i8($M.1.shadow,$p14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 49, 11} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i8.i32($i15);
  ...
  assume {:verifier.code 0} true;
  $i17 := $xor.i32($i16,$i12);
  $i17.shadow := $xor.i32($i16.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 49, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p14 == $p14.shadow));
  $M.1 := $store.i8($M.1,$p14,$i18);
  $M.1.shadow := $store.i8($M.1.shadow,$p14.shadow,$i18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 50, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !($i8 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 51, 33} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(392,1));
  $p20.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(392,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 51, 33} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p20 == $p20.shadow));
  $i21 := $load.i32($M.2,$p20);
  $i21.shadow := $load.i32($M.2.shadow,$p20.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 51, 50} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(8,1));
  $p22.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(8,1));
  $p23 := $add.ref($add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(8,1)),$mul.ref(0,4));
  $p23.shadow := $add.ref($add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(8,1)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 51, 3} true;
  assume {:verifier.code 0} true;
  call br_des_tab_process_block($i21, $i21.shadow, $p23, $p23.shadow, $p5, $p5.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 52, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p1 == $p1.shadow));
  $shadow_ok := ($shadow_ok && ($p5 == $p5.shadow));
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.1, $M.1.shadow, $p1, $p1.shadow, $p5, $p5.shadow, 8, 8, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 53, 7} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p5,$mul.ref(8,1));
  $p24.shadow := $add.ref($p5.shadow,$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 54, 7} true;
  assume {:verifier.code 0} true;
  $i25 := $sub.i64($i4,8);
  $i25.shadow := $sub.i64($i4.shadow,8);
  call {:cexpr "len"} boogie_si_record_i64($i25);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 45, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $i25;
  $i4.shadow := $i25.shadow;
  $p5 := $p24;
  $p5.shadow := $p24.shadow;
  goto $bb1;
$bb7:
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 48, 24} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i7,1);
  $i19.shadow := $add.i32($i7.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i19);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab_cbcenc.c", 48, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $i19;
  $i7.shadow := $i19.shadow;
  goto $bb4;
}
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0,12304));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const br_des_tab_process_block: ref;
axiom (br_des_tab_process_block == $sub.ref(0,13336));
procedure {:inline 1} br_des_tab_process_block($i0: i32, $i0.shadow: i32, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
...
modifies $CurrAddr;
{
  ...
  var $i15.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 248, 6} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  $p4.shadow := $p4;
  call {:cexpr "br_des_tab_process_block:arg:num_rounds"} boogie_si_record_i32($i0);
  assume true;
  assume true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 248, 6} true;
  assume {:verifier.code 0} true;
  call $i5, $i5.shadow := br_dec32be.1($p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 248, 4} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p3 == $p3.shadow));
  $M.3 := $store.i32($M.3,$p3,$i5);
  $M.3.shadow := $store.i32($M.3.shadow,$p3.shadow,$i5.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 249, 21} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p2,$mul.ref(4,1));
  $p6.shadow := $add.ref($p2.shadow,$mul.ref(4,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 249, 6} true;
  assume {:verifier.code 0} true;
  call $i7, $i7.shadow := br_dec32be.1($p6, $p6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 249, 4} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4 == $p4.shadow));
  $M.4 := $store.i32($M.4,$p4,$i7);
  $M.4.shadow := $store.i32($M.4.shadow,$p4.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 250, 2} true;
  assume {:verifier.code 0} true;
  call br_des_do_IP($p3, $p3.shadow, $p4, $p4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 251, 2} true;
  assume {:verifier.code 0} true;
  $p8 := $p1;
  $p8.shadow := $p1.shadow;
  $i9 := $i0;
...
$bb1:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i9 == $i9.shadow);
  assert {:shadow_invariant} ($p4 == $p4.shadow);
  assert {:shadow_invariant} ($p3 == $p3.shadow);
  assert {:likely_shadow_invariant} ($p8 == $p8.shadow);
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 251, 20} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i9,$sub.i32(0,1));
  $i10.shadow := $add.i32($i9.shadow,$sub.i32(0,1));
  call {:cexpr "num_rounds"} boogie_si_record_i32($i10);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 251, 23} true;
  assume {:verifier.code 0} true;
  $i11 := $ugt.i32($i9,0);
  $i11.shadow := $ugt.i32($i9.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 251, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i11 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 252, 3} true;
  assume {:verifier.code 0} true;
  call process_block_unit($p3, $p3.shadow, $p4, $p4.shadow, $p8, $p8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 253, 8} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p8,$mul.ref(32,4));
  $p12.shadow := $add.ref($p8.shadow,$mul.ref(32,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 251, 2} true;
  assume {:verifier.code 0} true;
  $p8 := $p12;
  $p8.shadow := $p12.shadow;
  $i9 := $i10;
  $i9.shadow := $i10.shadow;
  goto $bb1;
$bb3:
  assume !($i11 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 255, 2} true;
  assume {:verifier.code 0} true;
  call br_des_do_invIP($p3, $p3.shadow, $p4, $p4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 256, 18} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p3 == $p3.shadow));
  $i13 := $load.i32($M.3,$p3);
  $i13.shadow := $load.i32($M.3.shadow,$p3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 256, 2} true;
  assume {:verifier.code 0} true;
  call br_enc32be($p2, $p2.shadow, $i13, $i13.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 257, 17} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p2,$mul.ref(4,1));
  $p14.shadow := $add.ref($p2.shadow,$mul.ref(4,1));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 257, 22} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4 == $p4.shadow));
  $i15 := $load.i32($M.4,$p4);
  $i15.shadow := $load.i32($M.4.shadow,$p4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 257, 2} true;
  assume {:verifier.code 0} true;
  call br_enc32be($p14, $p14.shadow, $i15, $i15.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 258, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0,14368));
...
$bb0:
  ...
  $shadow_ok := ($shadow_ok && ($p1 == $p1.shadow));
  $i2 := $load.i8($M.1,$p1);
  $i2.shadow := $load.i8($M.1.shadow,$p1.shadow);
  ...
  $shadow_ok := ($shadow_ok && ($p5 == $p5.shadow));
  $i6 := $load.i8($M.1,$p5);
  $i6.shadow := $load.i8($M.1.shadow,$p5.shadow);
  ...
  $shadow_ok := ($shadow_ok && ($p10 == $p10.shadow));
  $i11 := $load.i8($M.1,$p10);
  $i11.shadow := $load.i8($M.1.shadow,$p10.shadow);
  ...
  $i16 := $load.i8($M.1,$p15);
  $i16.shadow := $load.i8($M.1.shadow,$p15.shadow);
...
axiom (br_des_do_IP == $sub.ref(0,17464));
procedure {:inline 1} br_des_do_IP($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $M.3, $M.4, $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
axiom (process_block_unit == $sub.ref(0,18496));
procedure {:inline 1} process_block_unit($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.3, $M.4, $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
  ...
  var $i21.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 227, 6} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 227, 6} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p0 == $p0.shadow));
  $i3 := $load.i32($M.3,$p0);
  $i3.shadow := $load.i32($M.3.shadow,$p0.shadow);
  call {:cexpr "l"} boogie_si_record_i32($i3);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 228, 6} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p1 == $p1.shadow));
  $i4 := $load.i32($M.4,$p1);
  $i4.shadow := $load.i32($M.4.shadow,$p1.shadow);
  call {:cexpr "r"} boogie_si_record_i32($i4);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 229, 7} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  $i5.shadow := 0;
  $i6 := $i3;
...
$bb1:
  ...
  assert {:unlikely_shadow_invariant ($i6 == $i6.shadow)} true;
  assert {:unlikely_shadow_invariant ($i7 == $i7.shadow)} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 229, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $slt.i32($i5,16);
  $i8.shadow := $slt.i32($i5.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 229, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  $shadow_ok := ($shadow_ok && ($i8 == $i8.shadow));
  goto $bb2, $bb3;
$bb2:
  assume ($i8 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 232, 28} true;
  assume {:verifier.code 0} true;
  $i9 := $shl.i32($i5,1);
  $i9.shadow := $shl.i32($i5.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 232, 34} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i9,0);
  $i10.shadow := $add.i32($i9.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 232, 20} true;
  assume {:verifier.code 0} true;
  $i11 := $sext.i32.i64($i10);
  $i11.shadow := $sext.i32.i64($i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 232, 20} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p2,$mul.ref($i11,4));
  $p12.shadow := $add.ref($p2.shadow,$mul.ref($i11.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 232, 20} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p12 == $p12.shadow));
  $i13 := $load.i32($M.2,$p12);
  $i13.shadow := $load.i32($M.2.shadow,$p12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 232, 48} true;
  assume {:verifier.code 0} true;
  $i14 := $shl.i32($i5,1);
  $i14.shadow := $shl.i32($i5.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 232, 54} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i14,1);
  $i15.shadow := $add.i32($i14.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 232, 40} true;
  assume {:verifier.code 0} true;
  $i16 := $sext.i32.i64($i15);
  $i16.shadow := $sext.i32.i64($i15.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 232, 40} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($p2,$mul.ref($i16,4));
  $p17.shadow := $add.ref($p2.shadow,$mul.ref($i16.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 232, 40} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p17 == $p17.shadow));
  $i18 := $load.i32($M.2,$p17);
  $i18.shadow := $load.i32($M.2.shadow,$p17.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 232, 11} true;
  assume {:verifier.code 0} true;
  call $i19, $i19.shadow := Fconf($i7, $i7.shadow, $i13, $i13.shadow, $i18, $i18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 232, 9} true;
  assume {:verifier.code 0} true;
  $i20 := $xor.i32($i6,$i19);
  $i20.shadow := $xor.i32($i6.shadow,$i19.shadow);
  call {:cexpr "t"} boogie_si_record_i32($i20);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 235, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i8 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 236, 6} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p0 == $p0.shadow));
  $M.3 := $store.i32($M.3,$p0,$i7);
  $M.3.shadow := $store.i32($M.3.shadow,$p0.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 237, 6} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p1 == $p1.shadow));
  $M.4 := $store.i32($M.4,$p1,$i6);
  $M.4.shadow := $store.i32($M.4.shadow,$p1.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 238, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 229, 24} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i32($i5,1);
  ...
  $i6.shadow := $i7.shadow;
  $i7 := $i20;
  $i7.shadow := $i20.shadow;
  goto $bb1;
}
const br_des_do_invIP: ref;
axiom (br_des_do_invIP == $sub.ref(0,19528));
procedure {:inline 1} br_des_do_invIP($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $M.3, $M.4, $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i4 := $lshr.i32($i2,1);
  $i4.shadow := $lshr.i32($i2.shadow,1);
  ...
  $i6.shadow := $and.i32($i5.shadow,1431655765);
  call {:cexpr "t"} boogie_si_record_i32($i6);
  ...
  assume {:verifier.code 0} true;
  $i19 := $xor.i32($i13,$i18);
  $i19.shadow := $xor.i32($i13.shadow,$i18.shadow);
  call {:cexpr "l"} boogie_si_record_i32($i19);
...
axiom (br_enc32be == $sub.ref(0,20560));
...
$bb0:
  ...
  $M.1.shadow := $store.i8($M.1.shadow,$p4.shadow,$i3.shadow);
  ...
  $M.1.shadow := $store.i8($M.1.shadow,$p7.shadow,$i6.shadow);
  ...
  $M.1.shadow := $store.i8($M.1.shadow,$p10.shadow,$i9.shadow);
  ...
  $M.1.shadow := $store.i8($M.1.shadow,$p12.shadow,$i11.shadow);
...
const Fconf: ref;
axiom (Fconf == $sub.ref(0,21592));
procedure {:inline 1} Fconf($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
  ...
  var $i66.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 209, 11} true;
  assume {:verifier.code 0} true;
  call {:cexpr "Fconf:arg:r0"} boogie_si_record_i32($i0);
  call {:cexpr "Fconf:arg:skl"} boogie_si_record_i32($i1);
  call {:cexpr "Fconf:arg:skr"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 209, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $shl.i32($i0,16);
  $i3.shadow := $shl.i32($i0.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 209, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $lshr.i32($i0,16);
  $i4.shadow := $lshr.i32($i0.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 209, 18} true;
  assume {:verifier.code 0} true;
  $i5 := $or.i32($i3,$i4);
  $i5.shadow := $or.i32($i3.shadow,$i4.shadow);
  call {:cexpr "r1"} boogie_si_record_i32($i5);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 211, 13} true;
  assume {:verifier.code 0} true;
  $i6 := $lshr.i32($i5,11);
  $i6.shadow := $lshr.i32($i5.shadow,11);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 211, 27} true;
  assume {:verifier.code 0} true;
  $i7 := $lshr.i32($i1,18);
  $i7.shadow := $lshr.i32($i1.shadow,18);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 211, 20} true;
  assume {:verifier.code 0} true;
  $i8 := $xor.i32($i6,$i7);
  $i8.shadow := $xor.i32($i6.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 211, 35} true;
  assume {:verifier.code 0} true;
  $i9 := $and.i32($i8,63);
  $i9.shadow := $and.i32($i8.shadow,63);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 211, 5} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i32.i64($i9);
  $i10.shadow := $zext.i32.i64($i9.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 211, 5} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref($i10,4));
  $p11.shadow := $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref($i10.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 211, 5} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p11 == $p11.shadow));
  $i12 := $load.i32($M.5,$p11);
  $i12.shadow := $load.i32($M.5.shadow,$p11.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 212, 13} true;
  assume {:verifier.code 0} true;
  $i13 := $lshr.i32($i0,23);
  $i13.shadow := $lshr.i32($i0.shadow,23);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 212, 27} true;
  assume {:verifier.code 0} true;
  $i14 := $lshr.i32($i1,12);
  $i14.shadow := $lshr.i32($i1.shadow,12);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 212, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $xor.i32($i13,$i14);
  $i15.shadow := $xor.i32($i13.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 212, 35} true;
  assume {:verifier.code 0} true;
  $i16 := $and.i32($i15,63);
  $i16.shadow := $and.i32($i15.shadow,63);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 212, 5} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i32.i64($i16);
  $i17.shadow := $zext.i32.i64($i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 212, 5} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref(S2,$mul.ref(0,256)),$mul.ref($i17,4));
  $p18.shadow := $add.ref($add.ref(S2,$mul.ref(0,256)),$mul.ref($i17.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 212, 5} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p18 == $p18.shadow));
  $i19 := $load.i32($M.6,$p18);
  $i19.shadow := $load.i32($M.6.shadow,$p18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 212, 3} true;
  assume {:verifier.code 0} true;
  $i20 := $or.i32($i12,$i19);
  $i20.shadow := $or.i32($i12.shadow,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 213, 13} true;
  assume {:verifier.code 0} true;
  $i21 := $lshr.i32($i0,19);
  $i21.shadow := $lshr.i32($i0.shadow,19);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 213, 27} true;
  assume {:verifier.code 0} true;
  $i22 := $lshr.i32($i1,6);
  $i22.shadow := $lshr.i32($i1.shadow,6);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 213, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $xor.i32($i21,$i22);
  $i23.shadow := $xor.i32($i21.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 213, 35} true;
  assume {:verifier.code 0} true;
  $i24 := $and.i32($i23,63);
  $i24.shadow := $and.i32($i23.shadow,63);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 213, 5} true;
  assume {:verifier.code 0} true;
  $i25 := $zext.i32.i64($i24);
  $i25.shadow := $zext.i32.i64($i24.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 213, 5} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref(S3,$mul.ref(0,256)),$mul.ref($i25,4));
  $p26.shadow := $add.ref($add.ref(S3,$mul.ref(0,256)),$mul.ref($i25.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 213, 5} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p26 == $p26.shadow));
  $i27 := $load.i32($M.7,$p26);
  $i27.shadow := $load.i32($M.7.shadow,$p26.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 213, 3} true;
  assume {:verifier.code 0} true;
  $i28 := $or.i32($i20,$i27);
  $i28.shadow := $or.i32($i20.shadow,$i27.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 214, 13} true;
  assume {:verifier.code 0} true;
  $i29 := $lshr.i32($i0,15);
  $i29.shadow := $lshr.i32($i0.shadow,15);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 214, 20} true;
  assume {:verifier.code 0} true;
  $i30 := $xor.i32($i29,$i1);
  $i30.shadow := $xor.i32($i29.shadow,$i1.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 214, 35} true;
  assume {:verifier.code 0} true;
  $i31 := $and.i32($i30,63);
  $i31.shadow := $and.i32($i30.shadow,63);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 214, 5} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i32.i64($i31);
  $i32.shadow := $zext.i32.i64($i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 214, 5} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref(S4,$mul.ref(0,256)),$mul.ref($i32,4));
  $p33.shadow := $add.ref($add.ref(S4,$mul.ref(0,256)),$mul.ref($i32.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 214, 5} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p33 == $p33.shadow));
  $i34 := $load.i32($M.8,$p33);
  $i34.shadow := $load.i32($M.8.shadow,$p33.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 214, 3} true;
  assume {:verifier.code 0} true;
  $i35 := $or.i32($i28,$i34);
  $i35.shadow := $or.i32($i28.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 215, 13} true;
  assume {:verifier.code 0} true;
  $i36 := $lshr.i32($i0,11);
  $i36.shadow := $lshr.i32($i0.shadow,11);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 215, 27} true;
  assume {:verifier.code 0} true;
  $i37 := $lshr.i32($i2,18);
  $i37.shadow := $lshr.i32($i2.shadow,18);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 215, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $xor.i32($i36,$i37);
  $i38.shadow := $xor.i32($i36.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 215, 35} true;
  assume {:verifier.code 0} true;
  $i39 := $and.i32($i38,63);
  $i39.shadow := $and.i32($i38.shadow,63);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 215, 5} true;
  assume {:verifier.code 0} true;
  $i40 := $zext.i32.i64($i39);
  $i40.shadow := $zext.i32.i64($i39.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 215, 5} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($add.ref(S5,$mul.ref(0,256)),$mul.ref($i40,4));
  $p41.shadow := $add.ref($add.ref(S5,$mul.ref(0,256)),$mul.ref($i40.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 215, 5} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p41 == $p41.shadow));
  $i42 := $load.i32($M.9,$p41);
  $i42.shadow := $load.i32($M.9.shadow,$p41.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 215, 3} true;
  assume {:verifier.code 0} true;
  $i43 := $or.i32($i35,$i42);
  $i43.shadow := $or.i32($i35.shadow,$i42.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 216, 13} true;
  assume {:verifier.code 0} true;
  $i44 := $lshr.i32($i0,7);
  $i44.shadow := $lshr.i32($i0.shadow,7);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 216, 27} true;
  assume {:verifier.code 0} true;
  $i45 := $lshr.i32($i2,12);
  $i45.shadow := $lshr.i32($i2.shadow,12);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 216, 20} true;
  assume {:verifier.code 0} true;
  $i46 := $xor.i32($i44,$i45);
  $i46.shadow := $xor.i32($i44.shadow,$i45.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 216, 35} true;
  assume {:verifier.code 0} true;
  $i47 := $and.i32($i46,63);
  $i47.shadow := $and.i32($i46.shadow,63);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 216, 5} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i32.i64($i47);
  $i48.shadow := $zext.i32.i64($i47.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 216, 5} true;
  assume {:verifier.code 0} true;
  $p49 := $add.ref($add.ref(S6,$mul.ref(0,256)),$mul.ref($i48,4));
  $p49.shadow := $add.ref($add.ref(S6,$mul.ref(0,256)),$mul.ref($i48.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 216, 5} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p49 == $p49.shadow));
  $i50 := $load.i32($M.10,$p49);
  $i50.shadow := $load.i32($M.10.shadow,$p49.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 216, 3} true;
  assume {:verifier.code 0} true;
  $i51 := $or.i32($i43,$i50);
  $i51.shadow := $or.i32($i43.shadow,$i50.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 217, 13} true;
  assume {:verifier.code 0} true;
  $i52 := $lshr.i32($i0,3);
  $i52.shadow := $lshr.i32($i0.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 217, 27} true;
  assume {:verifier.code 0} true;
  $i53 := $lshr.i32($i2,6);
  $i53.shadow := $lshr.i32($i2.shadow,6);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 217, 20} true;
  assume {:verifier.code 0} true;
  $i54 := $xor.i32($i52,$i53);
  $i54.shadow := $xor.i32($i52.shadow,$i53.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 217, 35} true;
  assume {:verifier.code 0} true;
  $i55 := $and.i32($i54,63);
  $i55.shadow := $and.i32($i54.shadow,63);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 217, 5} true;
  assume {:verifier.code 0} true;
  $i56 := $zext.i32.i64($i55);
  $i56.shadow := $zext.i32.i64($i55.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 217, 5} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($add.ref(S7,$mul.ref(0,256)),$mul.ref($i56,4));
  $p57.shadow := $add.ref($add.ref(S7,$mul.ref(0,256)),$mul.ref($i56.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 217, 5} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p57 == $p57.shadow));
  $i58 := $load.i32($M.11,$p57);
  $i58.shadow := $load.i32($M.11.shadow,$p57.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 217, 3} true;
  assume {:verifier.code 0} true;
  $i59 := $or.i32($i51,$i58);
  $i59.shadow := $or.i32($i51.shadow,$i58.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 218, 13} true;
  assume {:verifier.code 0} true;
  $i60 := $lshr.i32($i5,15);
  $i60.shadow := $lshr.i32($i5.shadow,15);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 218, 20} true;
  assume {:verifier.code 0} true;
  $i61 := $xor.i32($i60,$i2);
  $i61.shadow := $xor.i32($i60.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 218, 35} true;
  assume {:verifier.code 0} true;
  $i62 := $and.i32($i61,63);
  $i62.shadow := $and.i32($i61.shadow,63);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 218, 5} true;
  assume {:verifier.code 0} true;
  $i63 := $zext.i32.i64($i62);
  $i63.shadow := $zext.i32.i64($i62.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 218, 5} true;
  assume {:verifier.code 0} true;
  $p64 := $add.ref($add.ref(S8,$mul.ref(0,256)),$mul.ref($i63,4));
  $p64.shadow := $add.ref($add.ref(S8,$mul.ref(0,256)),$mul.ref($i63.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 218, 5} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p64 == $p64.shadow));
  $i65 := $load.i32($M.12,$p64);
  $i65.shadow := $load.i32($M.12.shadow,$p64.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 218, 3} true;
  assume {:verifier.code 0} true;
  $i66 := $or.i32($i59,$i65);
  $i66.shadow := $or.i32($i59.shadow,$i65.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/des_tab.c", 210, 2} true;
  assume {:verifier.code 0} true;
  $r := $i66;
  $r.shadow := $i66.shadow;
  $exn := false;
...
const cbc_encrypt_wrapper: ref;
axiom (cbc_encrypt_wrapper == $sub.ref(0,22624));
procedure {:entrypoint} cbc_encrypt_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $i3: i64, $i3.shadow: i64)
requires {:public_in $p0} true;
requires {:public_in $p1} true;
requires {:public_in $p2} true;
requires {:public_in $i3} true;
requires {:public_in $load.i32, $M.2, $add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(392,1)), 4} true;
requires {:public_in $load.i8, $M.1, $p2, 1, 16} true;
requires {:public_in $load.i8, $M.0, $p1, 1, 16} true;
modifies $exn;
modifies $M.1, $M.0;
modifies $CurrAddr, $M.5, $M.6, $M.7, $M.8, $M.9, $M.10, $M.11, $M.12;
modifies $M.3, $M.4;
requires ($p0 == $p0.shadow);
requires ($p1 == $p1.shadow);
requires ($p2 == $p2.shadow);
requires ($i3 == $i3.shadow);
requires ($load.i32($M.2,$add.ref($add.ref($p0,$mul.ref(0,400)),$mul.ref(392,1))) == $load.i32($M.2.shadow,$add.ref($add.ref($p0.shadow,$mul.ref(0,400)),$mul.ref(392,1))));
requires ($load.i8($M.1,($p2 + 0)) == $load.i8($M.1.shadow,($p2.shadow + 0)));
requires ($load.i8($M.1,($p2 + 1)) == $load.i8($M.1.shadow,($p2.shadow + 1)));
requires ($load.i8($M.1,($p2 + 2)) == $load.i8($M.1.shadow,($p2.shadow + 2)));
requires ($load.i8($M.1,($p2 + 3)) == $load.i8($M.1.shadow,($p2.shadow + 3)));
requires ($load.i8($M.1,($p2 + 4)) == $load.i8($M.1.shadow,($p2.shadow + 4)));
requires ($load.i8($M.1,($p2 + 5)) == $load.i8($M.1.shadow,($p2.shadow + 5)));
requires ($load.i8($M.1,($p2 + 6)) == $load.i8($M.1.shadow,($p2.shadow + 6)));
requires ($load.i8($M.1,($p2 + 7)) == $load.i8($M.1.shadow,($p2.shadow + 7)));
requires ($load.i8($M.1,($p2 + 8)) == $load.i8($M.1.shadow,($p2.shadow + 8)));
requires ($load.i8($M.1,($p2 + 9)) == $load.i8($M.1.shadow,($p2.shadow + 9)));
requires ($load.i8($M.1,($p2 + 10)) == $load.i8($M.1.shadow,($p2.shadow + 10)));
requires ($load.i8($M.1,($p2 + 11)) == $load.i8($M.1.shadow,($p2.shadow + 11)));
requires ($load.i8($M.1,($p2 + 12)) == $load.i8($M.1.shadow,($p2.shadow + 12)));
requires ($load.i8($M.1,($p2 + 13)) == $load.i8($M.1.shadow,($p2.shadow + 13)));
requires ($load.i8($M.1,($p2 + 14)) == $load.i8($M.1.shadow,($p2.shadow + 14)));
requires ($load.i8($M.1,($p2 + 15)) == $load.i8($M.1.shadow,($p2.shadow + 15)));
requires ($load.i8($M.0,($p1 + 0)) == $load.i8($M.0.shadow,($p1.shadow + 0)));
requires ($load.i8($M.0,($p1 + 1)) == $load.i8($M.0.shadow,($p1.shadow + 1)));
requires ($load.i8($M.0,($p1 + 2)) == $load.i8($M.0.shadow,($p1.shadow + 2)));
requires ($load.i8($M.0,($p1 + 3)) == $load.i8($M.0.shadow,($p1.shadow + 3)));
requires ($load.i8($M.0,($p1 + 4)) == $load.i8($M.0.shadow,($p1.shadow + 4)));
requires ($load.i8($M.0,($p1 + 5)) == $load.i8($M.0.shadow,($p1.shadow + 5)));
requires ($load.i8($M.0,($p1 + 6)) == $load.i8($M.0.shadow,($p1.shadow + 6)));
requires ($load.i8($M.0,($p1 + 7)) == $load.i8($M.0.shadow,($p1.shadow + 7)));
requires ($load.i8($M.0,($p1 + 8)) == $load.i8($M.0.shadow,($p1.shadow + 8)));
requires ($load.i8($M.0,($p1 + 9)) == $load.i8($M.0.shadow,($p1.shadow + 9)));
requires ($load.i8($M.0,($p1 + 10)) == $load.i8($M.0.shadow,($p1.shadow + 10)));
requires ($load.i8($M.0,($p1 + 11)) == $load.i8($M.0.shadow,($p1.shadow + 11)));
requires ($load.i8($M.0,($p1 + 12)) == $load.i8($M.0.shadow,($p1.shadow + 12)));
requires ($load.i8($M.0,($p1 + 13)) == $load.i8($M.0.shadow,($p1.shadow + 13)));
requires ($load.i8($M.0,($p1 + 14)) == $load.i8($M.0.shadow,($p1.shadow + 14)));
requires ($load.i8($M.0,($p1 + 15)) == $load.i8($M.0.shadow,($p1.shadow + 15)));
{
  var $p4: ref;
  var $p4.shadow: ref;
  var $p5: ref;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "cbc_encrypt.c", 5, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:cbc_encrypt_wrapper"} boogie_si_record_ref(cbc_encrypt_wrapper);
  call {:cexpr "smack:arg:cbc_encrypt_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:cbc_encrypt_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:cbc_encrypt_wrapper:$p2"} boogie_si_record_ref($p2);
  call {:cexpr "smack:arg:cbc_encrypt_wrapper:$i3"} boogie_si_record_i64($i3);
  call {:cexpr "cbc_encrypt_wrapper:arg:len"} boogie_si_record_i64($i3);
  assume {:sourceloc "cbc_encrypt.c", 5, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "cbc_encrypt.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p11, $p11.shadow);
  assume {:sourceloc "cbc_encrypt.c", 16, 12} true;
  assume {:verifier.code 1} true;
  call {:name $p1} {:array "$load.i8", $M.0, $p1, 1, 16} $p12 := __SMACK_values($p1, 16);
  $p12.shadow := $p12;
  assume $isExternal($p12);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p12);
  assume {:sourceloc "cbc_encrypt.c", 16, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p12, $p12.shadow);
  assume {:sourceloc "cbc_encrypt.c", 18, 2} true;
  assume {:verifier.code 0} true;
  call br_des_tab_cbcenc_run($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow, $i3, $i3.shadow);
  assume {:sourceloc "cbc_encrypt.c", 19, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
...
axiom (__SMACK_value == $sub.ref(0,23656));
...
axiom (__SMACK_dummy == $sub.ref(0,28816));
...
axiom (__SMACK_and32 == $sub.ref(0,29848));
...
axiom (__SMACK_and64 == $sub.ref(0,30880));
...
axiom (__SMACK_and16 == $sub.ref(0,31912));
...
axiom (__SMACK_and8 == $sub.ref(0,32944));
...
axiom (__SMACK_or32 == $sub.ref(0,33976));
...
axiom (__SMACK_or64 == $sub.ref(0,35008));
...
axiom (__SMACK_or16 == $sub.ref(0,36040));
...
axiom (__SMACK_or8 == $sub.ref(0,37072));
...
axiom (__SMACK_check_overflow == $sub.ref(0,38104));
...
axiom (__SMACK_loop_exit == $sub.ref(0,39136));
...
axiom (__SMACK_decls == $sub.ref(0,40168));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,41200));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,42232));
...
axiom (__SMACK_static_init == $sub.ref(0,43264));
procedure {:inline 1} __SMACK_static_init()
modifies $M.5, $M.6, $M.7, $M.8, $M.9, $M.10, $M.11, $M.12, $exn;
{
$bb0:
  $shadow_ok := ($shadow_ok && (S1 == S1));
  $M.5 := $store.i32($M.5,S1,8421888);
  $M.5.shadow := $store.i32($M.5.shadow,S1,8421888);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(1,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(1,4))));
  $M.5 := $store.i32($M.5,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(1,4)),0);
  $M.5.shadow := $store.i32($M.5.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(1,4)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(2,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(2,4))));
  $M.5 := $store.i32($M.5,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(2,4)),32768);
  $M.5.shadow := $store.i32($M.5.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(2,4)),32768);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(3,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(3,4))));
  $M.5 := $store.i32($M.5,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(3,4)),8421890);
  $M.5.shadow := $store.i32($M.5.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(3,4)),8421890);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(4,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(4,4))));
  $M.5 := $store.i32($M.5,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(4,4)),8421378);
  $M.5.shadow := $store.i32($M.5.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(4,4)),8421378);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(5,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(5,4))));
  $M.5 := $store.i32($M.5,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(5,4)),33282);
  $M.5.shadow := $store.i32($M.5.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(5,4)),33282);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(6,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(6,4))));
  $M.5 := $store.i32($M.5,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(6,4)),2);
  $M.5.shadow := $store.i32($M.5.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(6,4)),2);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(7,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(7,4))));
  $M.5 := $store.i32($M.5,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(7,4)),32768);
  $M.5.shadow := $store.i32($M.5.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(7,4)),32768);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(8,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(8,4))));
  $M.5 := $store.i32($M.5,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(8,4)),512);
  $M.5.shadow := $store.i32($M.5.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(8,4)),512);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(9,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(9,4))));
  $M.5 := $store.i32($M.5,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(9,4)),8421888);
  $M.5.shadow := $store.i32($M.5.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(9,4)),8421888);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(10,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(10,4))));
  $M.5 := $store.i32($M.5,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(10,4)),8421890);
  $M.5.shadow := $store.i32($M.5.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(10,4)),8421890);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(11,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(11,4))));
  $M.5 := $store.i32($M.5,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(11,4)),512);
  $M.5.shadow := $store.i32($M.5.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(11,4)),512);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(12,4)) == $add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(12,4))));
  $M.5 := $store.i32($M.5,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref(12,4)),8389122);
  $M.5.shadow := $store.i32($M.5.shadow,$add.ref($add.ref(S1,$mul.ref(0,256)),$mul.ref