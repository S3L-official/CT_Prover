...
var $M.15: ref;
var $M.15.shadow: ref;
axiom ($GLOBALS_BOTTOM == $sub.ref(0,62100));
...
const {:allocSize 56} br_ec_c25519_i15: ref;
axiom (br_ec_c25519_i15 == $sub.ref(0,1080));
const {:allocSize 36} {:count 18} C255_P: ref;
axiom (C255_P == $sub.ref(0,2140));
const {:allocSize 36} C255_R2: ref;
axiom (C255_R2 == $sub.ref(0,3200));
const {:allocSize 36} C255_A24: ref;
axiom (C255_A24 == $sub.ref(0,4260));
const {:allocSize 32} {:count 32} ORDER: ref;
axiom (ORDER == $sub.ref(0,5316));
const {:allocSize 32} GEN: ref;
axiom (GEN == $sub.ref(0,6372));
const api_generator: ref;
axiom (api_generator == $sub.ref(0,7404));
procedure {:inline 1} api_generator($i0: i32, $i0.shadow: i32, $p1: ref, $p1.shadow: ref) returns ($r: ref, $r.shadow: ref)
modifies $M.0, $exn;
{
$bb0:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 95, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "api_generator:arg:curve"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 95, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p1 == $p1.shadow));
  $M.0 := $store.i64($M.0,$p1,32);
  $M.0.shadow := $store.i64($M.0.shadow,$p1.shadow,32);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 96, 2} true;
  assume {:verifier.code 0} true;
  $r := GEN;
  $r.shadow := GEN;
  $exn := false;
...
$bb0:
  ...
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 104, 2} true;
  assume {:verifier.code 0} true;
  $r := ORDER;
  $r.shadow := ORDER;
  $exn := false;
...
$bb0:
  ...
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 112, 2} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $r.shadow := 0;
  $exn := false;
...
modifies $CurrAddr;
{
  ...
  var $i22.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 203, 11} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  $p8.shadow := $p8;
  assume {:verifier.code 0} true;
  call $p9 := $alloc($mul.ref(36,$zext.i32.i64(1)));
  $p9.shadow := $p9;
  assume {:verifier.code 0} true;
  call $p10 := $alloc($mul.ref(38,$zext.i32.i64(1)));
  $p10.shadow := $p10;
  assume {:verifier.code 0} true;
  call $p11 := $alloc($mul.ref(36,$zext.i32.i64(1)));
  $p11.shadow := $p11;
  assume {:verifier.code 0} true;
  call $p12 := $alloc($mul.ref(38,$zext.i32.i64(1)));
  $p12.shadow := $p12;
  assume {:verifier.code 0} true;
  call $p13 := $alloc($mul.ref(36,$zext.i32.i64(1)));
  $p13.shadow := $p13;
  assume {:verifier.code 0} true;
  call $p14 := $alloc($mul.ref(36,$zext.i32.i64(1)));
  $p14.shadow := $p14;
  assume {:verifier.code 0} true;
  call $p15 := $alloc($mul.ref(36,$zext.i32.i64(1)));
  $p15.shadow := $p15;
  assume {:verifier.code 0} true;
  call $p16 := $alloc($mul.ref(36,$zext.i32.i64(1)));
  $p16.shadow := $p16;
  assume {:verifier.code 0} true;
  call $p17 := $alloc($mul.ref(36,$zext.i32.i64(1)));
  $p17.shadow := $p17;
  assume {:verifier.code 0} true;
  call $p18 := $alloc($mul.ref(36,$zext.i32.i64(1)));
  $p18.shadow := $p18;
  assume {:verifier.code 0} true;
  call $p19 := $alloc($mul.ref(32,$zext.i32.i64(1)));
  $p19.shadow := $p19;
  call {:cexpr "api_mul:arg:Glen"} boogie_si_record_i64($i1);
  call {:cexpr "api_mul:arg:kblen"} boogie_si_record_i64($i3);
  ...
  assume {:verifier.code 0} true;
  $i20 := $ne.i64($i1,32);
  $i20.shadow := $ne.i64($i1.shadow,32);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 203, 17} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 204, 3} true;
  assume {:verifier.code 0} true;
  $i22 := 0;
  $i22.shadow := 0;
  goto $bb6;
$bb3:
  assume !($i20 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 203, 26} true;
  assume {:verifier.code 0} true;
  $i21 := $ugt.i64($i3,32);
  $i21.shadow := $ugt.i64($i3.shadow,32);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 203, 6} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !($i21 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 206, 2} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p0,$mul.ref(31,1));
  $p23.shadow := $add.ref($p0.shadow,$mul.ref(31,1));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 206, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p23 == $p23.shadow));
  $i24 := $load.i8($M.3,$p23);
  $i24.shadow := $load.i8($M.3.shadow,$p23.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 206, 8} true;
  assume {:verifier.code 0} true;
  $i25 := $zext.i8.i32($i24);
  ...
  assume {:verifier.code 0} true;
  $i26 := $and.i32($i25,127);
  $i26.shadow := $and.i32($i25.shadow,127);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 206, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p23 == $p23.shadow));
  $M.3 := $store.i8($M.3,$p23,$i27);
  $M.3.shadow := $store.i8($M.3.shadow,$p23.shadow,$i27.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 212, 2} true;
  assume {:verifier.code 0} true;
  call byteswap($p0, $p0.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 225, 14} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p28.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 225, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_zero($p28, $p28.shadow, 273, 273);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(18,2));
  $p29.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(18,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 226, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p29 == $p29.shadow));
  $M.4 := $store.i16($M.4,$p29,1);
  $M.4.shadow := $store.i16($M.4.shadow,$p29.shadow,1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 227, 20} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p30.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 227, 30} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p31.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 227, 2} true;
  assume {:verifier.code 0} true;
  call $i32, $i32.shadow := br_i15_decode_mod($p30, $p30.shadow, $p0, $p0.shadow, 32, 32, $p31, $p31.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p33.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 228, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p33 == $p33.shadow));
  $M.4 := $store.i16($M.4,$p33,272);
  $M.4.shadow := $store.i16($M.4.shadow,$p33.shadow,272);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 229, 13} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p34.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 229, 39} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p35.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 229, 28} true;
  assume {:verifier.code 0} true;
  call $i36, $i36.shadow := br_i15_sub($p35, $p35.shadow, C255_P, C255_P, 0, 0);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 229, 24} true;
  assume {:verifier.code 0} true;
  call $i37, $i37.shadow := NOT($i36, $i36.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 229, 2} true;
  assume {:verifier.code 0} true;
  call $i38, $i38.shadow := br_i15_sub($p34, $p34.shadow, C255_P, C255_P, $i37, $i37.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 235, 18} true;
  assume {:verifier.code 0} true;
  $p39 := $add.ref($add.ref($p5,$mul.ref(0,36)),$mul.ref(0,2));
  $p39.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 235, 22} true;
  assume {:verifier.code 0} true;
  $p40 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p40.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 235, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_montymul($p39, $p39.shadow, $p40, $p40.shadow, C255_R2, C255_R2, C255_P, C255_P, 18971, 18971);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 236, 2} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,2));
  $p41.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 236, 2} true;
  assume {:verifier.code 0} true;
  $p42 := $bitcast.ref.ref($p41);
  $p42.shadow := $bitcast.ref.ref($p41.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 236, 2} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($add.ref($p5,$mul.ref(0,36)),$mul.ref(0,2));
  $p43.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 236, 2} true;
  assume {:verifier.code 0} true;
  $p44 := $bitcast.ref.ref($p43);
  $p44.shadow := $bitcast.ref.ref($p43.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 236, 2} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p42 == $p42.shadow));
  $shadow_ok := ($shadow_ok && ($p44 == $p44.shadow));
  call $M.4, $M.4.shadow := $memcpy.i8($M.4, $M.4.shadow, $M.4, $M.4.shadow, $p42, $p42.shadow, $p44, $p44.shadow, 36, 36, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 237, 14} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p45.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 237, 18} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && (C255_P == C255_P));
  $i46 := $load.i16($M.4,C255_P);
  $i46.shadow := $load.i16($M.4.shadow,C255_P);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 237, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_zero($p45, $p45.shadow, $i46, $i46.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 238, 2} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($add.ref($p6,$mul.ref(0,36)),$mul.ref(0,2));
  $p47.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 238, 2} true;
  assume {:verifier.code 0} true;
  $p48 := $bitcast.ref.ref($p47);
  $p48.shadow := $bitcast.ref.ref($p47.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 238, 2} true;
  assume {:verifier.code 0} true;
  $p49 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p49.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 238, 2} true;
  assume {:verifier.code 0} true;
  $p50 := $bitcast.ref.ref($p49);
  $p50.shadow := $bitcast.ref.ref($p49.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 238, 2} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p48 == $p48.shadow));
  $shadow_ok := ($shadow_ok && ($p50 == $p50.shadow));
  call $M.4, $M.4.shadow := $memcpy.i8($M.4, $M.4.shadow, $M.4, $M.4.shadow, $p48, $p48.shadow, $p50, $p50.shadow, 36, 36, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 239, 2} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($add.ref($p6,$mul.ref(0,36)),$mul.ref(1,2));
  $p51.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,36)),$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 239, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p51 == $p51.shadow));
  $M.4 := $store.i16($M.4,$p51,19);
  $M.4.shadow := $store.i16($M.4.shadow,$p51.shadow,19);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 240, 2} true;
  assume {:verifier.code 0} true;
  $p52 := $add.ref($add.ref($p9,$mul.ref(0,36)),$mul.ref(0,2));
  $p52.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 240, 2} true;
  assume {:verifier.code 0} true;
  $p53 := $bitcast.ref.ref($p52);
  $p53.shadow := $bitcast.ref.ref($p52.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 240, 2} true;
  assume {:verifier.code 0} true;
  $p54 := $add.ref($add.ref($p6,$mul.ref(0,36)),$mul.ref(0,2));
  $p54.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 240, 2} true;
  assume {:verifier.code 0} true;
  $p55 := $bitcast.ref.ref($p54);
  $p55.shadow := $bitcast.ref.ref($p54.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 240, 2} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p53 == $p53.shadow));
  $shadow_ok := ($shadow_ok && ($p55 == $p55.shadow));
  call $M.4, $M.4.shadow := $memcpy.i8($M.4, $M.4.shadow, $M.4, $M.4.shadow, $p53, $p53.shadow, $p55, $p55.shadow, 36, 36, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 242, 2} true;
  assume {:verifier.code 0} true;
  $p56 := $add.ref($add.ref($p19,$mul.ref(0,32)),$mul.ref(0,1));
  $p56.shadow := $add.ref($add.ref($p19.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 242, 26} true;
  assume {:verifier.code 0} true;
  $i57 := $sub.i64(32,$i3);
  $i57.shadow := $sub.i64(32,$i3.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 242, 2} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p56 == $p56.shadow));
  $shadow_ok := ($shadow_ok && ($i57 == $i57.shadow));
  call $M.5, $M.5.shadow := $memset.i8($M.5, $M.5.shadow, $p56, $p56.shadow, 0, 0, $i57, $i57.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 243, 9} true;
  assume {:verifier.code 0} true;
  $p58 := $add.ref($add.ref($p19,$mul.ref(0,32)),$mul.ref(0,1));
  $p58.shadow := $add.ref($add.ref($p19.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  $p59 := $add.ref($add.ref($p19,$mul.ref(0,32)),$mul.ref(32,1));
  $p59.shadow := $add.ref($add.ref($p19.shadow,$mul.ref(0,32)),$mul.ref(32,1));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 243, 24} true;
  assume {:verifier.code 0} true;
  $i60 := $sub.i64(0,$i3);
  $i60.shadow := $sub.i64(0,$i3.shadow);
  $i61 := $add.i64(32,$i60);
  $i61.shadow := $add.i64(32,$i60.shadow);
  $p62 := $add.ref($add.ref($p19,$mul.ref(0,32)),$mul.ref($i61,1));
  $p62.shadow := $add.ref($add.ref($p19.shadow,$mul.ref(0,32)),$mul.ref($i61.shadow,1));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 243, 2} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p62 == $p62.shadow));
  $shadow_ok := ($shadow_ok && ($p2 == $p2.shadow));
  $shadow_ok := ($shadow_ok && ($i3 == $i3.shadow));
  call $M.5, $M.5.shadow := $memcpy.i8($M.5, $M.5.shadow, $M.6, $M.6.shadow, $p62, $p62.shadow, $p2, $p2.shadow, $i3, $i3.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 244, 2} true;
  assume {:verifier.code 0} true;
  $p63 := $add.ref($add.ref($p19,$mul.ref(0,32)),$mul.ref(31,1));
  $p63.shadow := $add.ref($add.ref($p19.shadow,$mul.ref(0,32)),$mul.ref(31,1));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 244, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p63 == $p63.shadow));
  $i64 := $load.i8($M.5,$p63);
  $i64.shadow := $load.i8($M.5.shadow,$p63.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 244, 8} true;
  assume {:verifier.code 0} true;
  $i65 := $zext.i8.i32($i64);
  $i65.shadow := $zext.i8.i32($i64.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 244, 8} true;
  assume {:verifier.code 0} true;
  $i66 := $and.i32($i65,248);
  $i66.shadow := $and.i32($i65.shadow,248);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 244, 8} true;
  assume {:verifier.code 0} true;
  $i67 := $trunc.i32.i8($i66);
  $i67.shadow := $trunc.i32.i8($i66.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 244, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p63 == $p63.shadow));
  $M.5 := $store.i8($M.5,$p63,$i67);
  $M.5.shadow := $store.i8($M.5.shadow,$p63.shadow,$i67.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 245, 2} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($add.ref($p19,$mul.ref(0,32)),$mul.ref(0,1));
  $p68.shadow := $add.ref($add.ref($p19.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 245, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p68 == $p68.shadow));
  $i69 := $load.i8($M.5,$p68);
  $i69.shadow := $load.i8($M.5.shadow,$p68.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 245, 7} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i8.i32($i69);
  $i70.shadow := $zext.i8.i32($i69.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 245, 7} true;
  assume {:verifier.code 0} true;
  $i71 := $and.i32($i70,127);
  $i71.shadow := $and.i32($i70.shadow,127);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 245, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p68 == $p68.shadow));
  $M.5 := $store.i8($M.5,$p68,$i72);
  $M.5.shadow := $store.i8($M.5.shadow,$p68.shadow,$i72.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 246, 2} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($add.ref($p19,$mul.ref(0,32)),$mul.ref(0,1));
  $p73.shadow := $add.ref($add.ref($p19.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 246, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p73 == $p73.shadow));
  $i74 := $load.i8($M.5,$p73);
  $i74.shadow := $load.i8($M.5.shadow,$p73.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 246, 7} true;
  assume {:verifier.code 0} true;
  $i75 := $zext.i8.i32($i74);
  $i75.shadow := $zext.i8.i32($i74.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 246, 7} true;
  assume {:verifier.code 0} true;
  $i76 := $or.i32($i75,64);
  $i76.shadow := $or.i32($i75.shadow,64);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 246, 7} true;
  assume {:verifier.code 0} true;
  $i77 := $trunc.i32.i8($i76);
  $i77.shadow := $trunc.i32.i8($i76.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 246, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p73 == $p73.shadow));
  $M.5 := $store.i8($M.5,$p73,$i77);
  $M.5.shadow := $store.i8($M.5.shadow,$p73.shadow,$i77.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 253, 7} true;
  assume {:verifier.code 0} true;
  $i78 := 0;
  $i78.shadow := 0;
  $i79 := 254;
  ...
  goto $bb7;
$bb6:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 353, 1} true;
  assume {:verifier.code 0} true;
  $r := $i22;
  $r.shadow := $i22.shadow;
  $exn := false;
...
$bb7:
  ...
  assert {:shadow_invariant} ($i79 == $i79.shadow);
  assert {:shadow_invariant} ($p19 == $p19.shadow);
  ...
  assert {:shadow_invariant} ($p10 == $p10.shadow);
  assert {:shadow_invariant} ($p12 == $p12.shadow);
  assert {:likely_shadow_invariant} ($p18 == $p18.shadow);
  assert {:likely_shadow_invariant} ($p17 == $p17.shadow);
  assert {:likely_shadow_invariant} ($p15 == $p15.shadow);
  assert {:likely_shadow_invariant} ($p14 == $p14.shadow);
  assert {:likely_shadow_invariant} ($p16 == $p16.shadow);
  assert {:likely_shadow_invariant} ($p13 == $p13.shadow);
  assert {:likely_shadow_invariant} ($p11 == $p11.shadow);
  assert {:unlikely_shadow_invariant ($i78 == $i78.shadow)} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 253, 18} true;
  assume {:verifier.code 0} true;
  $i80 := $sge.i32($i79,0);
  $i80.shadow := $sge.i32($i79.shadow,0);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 253, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i80} true;
  $shadow_ok := ($shadow_ok && ($i80 == $i80.shadow));
  goto $bb8, $bb9;
$bb8:
  assume ($i80 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 256, 19} true;
  assume {:verifier.code 0} true;
  $i81 := $ashr.i32($i79,3);
  $i81.shadow := $ashr.i32($i79.shadow,3);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 256, 14} true;
  assume {:verifier.code 0} true;
  $i82 := $sub.i32(31,$i81);
  $i82.shadow := $sub.i32(31,$i81.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 256, 9} true;
  assume {:verifier.code 0} true;
  $i83 := $sext.i32.i64($i82);
  $i83.shadow := $sext.i32.i64($i82.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 256, 9} true;
  assume {:verifier.code 0} true;
  $p84 := $add.ref($add.ref($p19,$mul.ref(0,32)),$mul.ref($i83,1));
  $p84.shadow := $add.ref($add.ref($p19.shadow,$mul.ref(0,32)),$mul.ref($i83.shadow,1));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 256, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p84 == $p84.shadow));
  $i85 := $load.i8($M.5,$p84);
  $i85.shadow := $load.i8($M.5.shadow,$p84.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 256, 9} true;
  assume {:verifier.code 0} true;
  $i86 := $zext.i8.i32($i85);
  $i86.shadow := $zext.i8.i32($i85.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 256, 32} true;
  assume {:verifier.code 0} true;
  $i87 := $and.i32($i79,7);
  $i87.shadow := $and.i32($i79.shadow,7);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 256, 26} true;
  assume {:verifier.code 0} true;
  $i88 := $ashr.i32($i86,$i87);
  $i88.shadow := $ashr.i32($i86.shadow,$i87.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 256, 38} true;
  assume {:verifier.code 0} true;
  $i89 := $and.i32($i88,1);
  $i89.shadow := $and.i32($i88.shadow,1);
  call {:cexpr "kt"} boogie_si_record_i32($i89);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 257, 8} true;
  assume {:verifier.code 0} true;
  $i90 := $xor.i32($i78,$i89);
  $i90.shadow := $xor.i32($i78.shadow,$i89.shadow);
  call {:cexpr "swap"} boogie_si_record_i32($i90);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 258, 9} true;
  assume {:verifier.code 0} true;
  $p91 := $add.ref($add.ref($p6,$mul.ref(0,36)),$mul.ref(0,2));
  $p91.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 258, 13} true;
  assume {:verifier.code 0} true;
  $p92 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,2));
  $p92.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 258, 3} true;
  assume {:verifier.code 0} true;
  call cswap($p91, $p91.shadow, $p92, $p92.shadow, $i90, $i90.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 259, 9} true;
  assume {:verifier.code 0} true;
  $p93 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p93.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 259, 13} true;
  assume {:verifier.code 0} true;
  $p94 := $add.ref($add.ref($p9,$mul.ref(0,36)),$mul.ref(0,2));
  $p94.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 259, 3} true;
  assume {:verifier.code 0} true;
  call cswap($p93, $p93.shadow, $p94, $p94.shadow, $i90, $i90.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 269, 12} true;
  assume {:verifier.code 0} true;
  $p95 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p95.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 269, 15} true;
  assume {:verifier.code 0} true;
  $p96 := $add.ref($add.ref($p6,$mul.ref(0,36)),$mul.ref(0,2));
  $p96.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 269, 19} true;
  assume {:verifier.code 0} true;
  $p97 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p97.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 269, 3} true;
  assume {:verifier.code 0} true;
  call c255_add($p95, $p95.shadow, $p96, $p96.shadow, $p97, $p97.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 270, 12} true;
  assume {:verifier.code 0} true;
  $p98 := $add.ref($add.ref($p11,$mul.ref(0,36)),$mul.ref(0,2));
  $p98.shadow := $add.ref($add.ref($p11.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 270, 16} true;
  assume {:verifier.code 0} true;
  $p99 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p99.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 270, 19} true;
  assume {:verifier.code 0} true;
  $p100 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p100.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 270, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p98, $p98.shadow, $p99, $p99.shadow, $p100, $p100.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 271, 12} true;
  assume {:verifier.code 0} true;
  $p101 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p101.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 271, 15} true;
  assume {:verifier.code 0} true;
  $p102 := $add.ref($add.ref($p6,$mul.ref(0,36)),$mul.ref(0,2));
  $p102.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 271, 19} true;
  assume {:verifier.code 0} true;
  $p103 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p103.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 271, 3} true;
  assume {:verifier.code 0} true;
  call c255_sub($p101, $p101.shadow, $p102, $p102.shadow, $p103, $p103.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 272, 12} true;
  assume {:verifier.code 0} true;
  $p104 := $add.ref($add.ref($p13,$mul.ref(0,36)),$mul.ref(0,2));
  $p104.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 272, 16} true;
  assume {:verifier.code 0} true;
  $p105 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p105.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 272, 19} true;
  assume {:verifier.code 0} true;
  $p106 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p106.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 272, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p104, $p104.shadow, $p105, $p105.shadow, $p106, $p106.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 273, 12} true;
  assume {:verifier.code 0} true;
  $p107 := $add.ref($add.ref($p16,$mul.ref(0,36)),$mul.ref(0,2));
  $p107.shadow := $add.ref($add.ref($p16.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 273, 15} true;
  assume {:verifier.code 0} true;
  $p108 := $add.ref($add.ref($p11,$mul.ref(0,36)),$mul.ref(0,2));
  $p108.shadow := $add.ref($add.ref($p11.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 273, 19} true;
  assume {:verifier.code 0} true;
  $p109 := $add.ref($add.ref($p13,$mul.ref(0,36)),$mul.ref(0,2));
  $p109.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 273, 3} true;
  assume {:verifier.code 0} true;
  call c255_sub($p107, $p107.shadow, $p108, $p108.shadow, $p109, $p109.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 274, 12} true;
  assume {:verifier.code 0} true;
  $p110 := $add.ref($add.ref($p14,$mul.ref(0,36)),$mul.ref(0,2));
  $p110.shadow := $add.ref($add.ref($p14.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 274, 15} true;
  assume {:verifier.code 0} true;
  $p111 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,2));
  $p111.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 274, 19} true;
  assume {:verifier.code 0} true;
  $p112 := $add.ref($add.ref($p9,$mul.ref(0,36)),$mul.ref(0,2));
  $p112.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 274, 3} true;
  assume {:verifier.code 0} true;
  call c255_add($p110, $p110.shadow, $p111, $p111.shadow, $p112, $p112.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 275, 12} true;
  assume {:verifier.code 0} true;
  $p113 := $add.ref($add.ref($p15,$mul.ref(0,36)),$mul.ref(0,2));
  $p113.shadow := $add.ref($add.ref($p15.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 275, 15} true;
  assume {:verifier.code 0} true;
  $p114 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,2));
  $p114.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 275, 19} true;
  assume {:verifier.code 0} true;
  $p115 := $add.ref($add.ref($p9,$mul.ref(0,36)),$mul.ref(0,2));
  $p115.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 275, 3} true;
  assume {:verifier.code 0} true;
  call c255_sub($p113, $p113.shadow, $p114, $p114.shadow, $p115, $p115.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 276, 12} true;
  assume {:verifier.code 0} true;
  $p116 := $add.ref($add.ref($p17,$mul.ref(0,36)),$mul.ref(0,2));
  $p116.shadow := $add.ref($add.ref($p17.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 276, 16} true;
  assume {:verifier.code 0} true;
  $p117 := $add.ref($add.ref($p15,$mul.ref(0,36)),$mul.ref(0,2));
  $p117.shadow := $add.ref($add.ref($p15.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 276, 19} true;
  assume {:verifier.code 0} true;
  $p118 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p118.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 276, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p116, $p116.shadow, $p117, $p117.shadow, $p118, $p118.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 277, 12} true;
  assume {:verifier.code 0} true;
  $p119 := $add.ref($add.ref($p18,$mul.ref(0,36)),$mul.ref(0,2));
  $p119.shadow := $add.ref($add.ref($p18.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 277, 16} true;
  assume {:verifier.code 0} true;
  $p120 := $add.ref($add.ref($p14,$mul.ref(0,36)),$mul.ref(0,2));
  $p120.shadow := $add.ref($add.ref($p14.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 277, 19} true;
  assume {:verifier.code 0} true;
  $p121 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p121.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 277, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p119, $p119.shadow, $p120, $p120.shadow, $p121, $p121.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 291, 12} true;
  assume {:verifier.code 0} true;
  $p122 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,2));
  $p122.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 291, 16} true;
  assume {:verifier.code 0} true;
  $p123 := $add.ref($add.ref($p17,$mul.ref(0,36)),$mul.ref(0,2));
  $p123.shadow := $add.ref($add.ref($p17.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 291, 20} true;
  assume {:verifier.code 0} true;
  $p124 := $add.ref($add.ref($p18,$mul.ref(0,36)),$mul.ref(0,2));
  $p124.shadow := $add.ref($add.ref($p18.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 291, 3} true;
  assume {:verifier.code 0} true;
  call c255_add($p122, $p122.shadow, $p123, $p123.shadow, $p124, $p124.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 292, 12} true;
  assume {:verifier.code 0} true;
  $p125 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,2));
  $p125.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 292, 16} true;
  assume {:verifier.code 0} true;
  $p126 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,2));
  $p126.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 292, 20} true;
  assume {:verifier.code 0} true;
  $p127 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,2));
  $p127.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 292, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p125, $p125.shadow, $p126, $p126.shadow, $p127, $p127.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 293, 12} true;
  assume {:verifier.code 0} true;
  $p128 := $add.ref($add.ref($p9,$mul.ref(0,36)),$mul.ref(0,2));
  $p128.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 293, 16} true;
  assume {:verifier.code 0} true;
  $p129 := $add.ref($add.ref($p17,$mul.ref(0,36)),$mul.ref(0,2));
  $p129.shadow := $add.ref($add.ref($p17.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 293, 20} true;
  assume {:verifier.code 0} true;
  $p130 := $add.ref($add.ref($p18,$mul.ref(0,36)),$mul.ref(0,2));
  $p130.shadow := $add.ref($add.ref($p18.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 293, 3} true;
  assume {:verifier.code 0} true;
  call c255_sub($p128, $p128.shadow, $p129, $p129.shadow, $p130, $p130.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 294, 12} true;
  assume {:verifier.code 0} true;
  $p131 := $add.ref($add.ref($p9,$mul.ref(0,36)),$mul.ref(0,2));
  $p131.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 294, 16} true;
  assume {:verifier.code 0} true;
  $p132 := $add.ref($add.ref($p9,$mul.ref(0,36)),$mul.ref(0,2));
  $p132.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 294, 20} true;
  assume {:verifier.code 0} true;
  $p133 := $add.ref($add.ref($p9,$mul.ref(0,36)),$mul.ref(0,2));
  $p133.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 294, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p131, $p131.shadow, $p132, $p132.shadow, $p133, $p133.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 295, 12} true;
  assume {:verifier.code 0} true;
  $p134 := $add.ref($add.ref($p9,$mul.ref(0,36)),$mul.ref(0,2));
  $p134.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 295, 16} true;
  assume {:verifier.code 0} true;
  $p135 := $add.ref($add.ref($p9,$mul.ref(0,36)),$mul.ref(0,2));
  $p135.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 295, 20} true;
  assume {:verifier.code 0} true;
  $p136 := $add.ref($add.ref($p5,$mul.ref(0,36)),$mul.ref(0,2));
  $p136.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 295, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p134, $p134.shadow, $p135, $p135.shadow, $p136, $p136.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 296, 12} true;
  assume {:verifier.code 0} true;
  $p137 := $add.ref($add.ref($p6,$mul.ref(0,36)),$mul.ref(0,2));
  $p137.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 296, 16} true;
  assume {:verifier.code 0} true;
  $p138 := $add.ref($add.ref($p11,$mul.ref(0,36)),$mul.ref(0,2));
  $p138.shadow := $add.ref($add.ref($p11.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 296, 20} true;
  assume {:verifier.code 0} true;
  $p139 := $add.ref($add.ref($p13,$mul.ref(0,36)),$mul.ref(0,2));
  $p139.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 296, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p137, $p137.shadow, $p138, $p138.shadow, $p139, $p139.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 297, 12} true;
  assume {:verifier.code 0} true;
  $p140 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p140.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 297, 26} true;
  assume {:verifier.code 0} true;
  $p141 := $add.ref($add.ref($p16,$mul.ref(0,36)),$mul.ref(0,2));
  $p141.shadow := $add.ref($add.ref($p16.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 297, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p140, $p140.shadow, C255_A24, C255_A24, $p141, $p141.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 298, 12} true;
  assume {:verifier.code 0} true;
  $p142 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p142.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 298, 16} true;
  assume {:verifier.code 0} true;
  $p143 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p143.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 298, 20} true;
  assume {:verifier.code 0} true;
  $p144 := $add.ref($add.ref($p11,$mul.ref(0,36)),$mul.ref(0,2));
  $p144.shadow := $add.ref($add.ref($p11.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 298, 3} true;
  assume {:verifier.code 0} true;
  call c255_add($p142, $p142.shadow, $p143, $p143.shadow, $p144, $p144.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 299, 12} true;
  assume {:verifier.code 0} true;
  $p145 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p145.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 299, 16} true;
  assume {:verifier.code 0} true;
  $p146 := $add.ref($add.ref($p16,$mul.ref(0,36)),$mul.ref(0,2));
  $p146.shadow := $add.ref($add.ref($p16.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 299, 19} true;
  assume {:verifier.code 0} true;
  $p147 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p147.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 299, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p145, $p145.shadow, $p146, $p146.shadow, $p147, $p147.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 307, 2} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !($i80 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 308, 8} true;
  assume {:verifier.code 0} true;
  $p149 := $add.ref($add.ref($p6,$mul.ref(0,36)),$mul.ref(0,2));
  $p149.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 308, 12} true;
  assume {:verifier.code 0} true;
  $p150 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,2));
  $p150.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 308, 2} true;
  assume {:verifier.code 0} true;
  call cswap($p149, $p149.shadow, $p150, $p150.shadow, $i78, $i78.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 309, 8} true;
  assume {:verifier.code 0} true;
  $p151 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p151.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 309, 12} true;
  assume {:verifier.code 0} true;
  $p152 := $add.ref($add.ref($p9,$mul.ref(0,36)),$mul.ref(0,2));
  $p152.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 309, 2} true;
  assume {:verifier.code 0} true;
  call cswap($p151, $p151.shadow, $p152, $p152.shadow, $i78, $i78.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 316, 2} true;
  assume {:verifier.code 0} true;
  $p153 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p153.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 316, 2} true;
  assume {:verifier.code 0} true;
  $p154 := $bitcast.ref.ref($p153);
  $p154.shadow := $bitcast.ref.ref($p153.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 316, 2} true;
  assume {:verifier.code 0} true;
  $p155 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p155.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 316, 2} true;
  assume {:verifier.code 0} true;
  $p156 := $bitcast.ref.ref($p155);
  $p156.shadow := $bitcast.ref.ref($p155.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 316, 2} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p154 == $p154.shadow));
  $shadow_ok := ($shadow_ok && ($p156 == $p156.shadow));
  call $M.4, $M.4.shadow := $memcpy.i8($M.4, $M.4.shadow, $M.4, $M.4.shadow, $p154, $p154.shadow, $p156, $p156.shadow, 36, 36, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 317, 7} true;
  assume {:verifier.code 0} true;
  $i157 := 0;
  $i157.shadow := 0;
  goto $bb11;
$bb10:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 253, 26} true;
  assume {:verifier.code 0} true;
  $i148 := $add.i32($i79,$sub.i32(0,1));
  $i148.shadow := $add.i32($i79.shadow,$sub.i32(0,1));
  call {:cexpr "i"} boogie_si_record_i32($i148);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 253, 2} true;
  assume {:verifier.code 0} true;
  $i78 := $i89;
  $i78.shadow := $i89.shadow;
  $i79 := $i148;
  $i79.shadow := $i148.shadow;
  goto $bb7;
$bb11:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i157 == $i157.shadow);
  assert {:shadow_invariant} ($p8 == $p8.shadow);
  assert {:shadow_invariant} ($p6 == $p6.shadow);
  assert {:shadow_invariant} ($p10 == $p10.shadow);
  assert {:shadow_invariant} ($p12 == $p12.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 317, 16} true;
  assume {:verifier.code 0} true;
  $i158 := $slt.i32($i157,15);
  $i158.shadow := $slt.i32($i157.shadow,15);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 317, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i158} true;
  $shadow_ok := ($shadow_ok && ($i158 == $i158.shadow));
  goto $bb12, $bb13;
$bb12:
  assume ($i158 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 318, 12} true;
  assume {:verifier.code 0} true;
  $p159 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p159.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 318, 15} true;
  assume {:verifier.code 0} true;
  $p160 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p160.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 318, 18} true;
  assume {:verifier.code 0} true;
  $p161 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p161.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 318, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p159, $p159.shadow, $p160, $p160.shadow, $p161, $p161.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 319, 12} true;
  assume {:verifier.code 0} true;
  $p162 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p162.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 319, 15} true;
  assume {:verifier.code 0} true;
  $p163 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p163.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 319, 18} true;
  assume {:verifier.code 0} true;
  $p164 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p164.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 319, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p162, $p162.shadow, $p163, $p163.shadow, $p164, $p164.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 320, 2} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb13:
  assume !($i158 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 321, 2} true;
  assume {:verifier.code 0} true;
  $p166 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p166.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 321, 2} true;
  assume {:verifier.code 0} true;
  $p167 := $bitcast.ref.ref($p166);
  $p167.shadow := $bitcast.ref.ref($p166.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 321, 2} true;
  assume {:verifier.code 0} true;
  $p168 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p168.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 321, 2} true;
  assume {:verifier.code 0} true;
  $p169 := $bitcast.ref.ref($p168);
  $p169.shadow := $bitcast.ref.ref($p168.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 321, 2} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p167 == $p167.shadow));
  $shadow_ok := ($shadow_ok && ($p169 == $p169.shadow));
  call $M.4, $M.4.shadow := $memcpy.i8($M.4, $M.4.shadow, $M.4, $M.4.shadow, $p167, $p167.shadow, $p169, $p169.shadow, 36, 36, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 322, 7} true;
  assume {:verifier.code 0} true;
  $i170 := 0;
  $i170.shadow := 0;
  goto $bb15;
$bb14:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 317, 24} true;
  assume {:verifier.code 0} true;
  $i165 := $add.i32($i157,1);
  $i165.shadow := $add.i32($i157.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i165);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 317, 2} true;
  assume {:verifier.code 0} true;
  $i157 := $i165;
  $i157.shadow := $i165.shadow;
  goto $bb11;
$bb15:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i170 == $i170.shadow);
  assert {:shadow_invariant} ($p8 == $p8.shadow);
  assert {:shadow_invariant} ($p6 == $p6.shadow);
  assert {:shadow_invariant} ($p10 == $p10.shadow);
  assert {:shadow_invariant} ($p12 == $p12.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 322, 16} true;
  assume {:verifier.code 0} true;
  $i171 := $slt.i32($i170,14);
  $i171.shadow := $slt.i32($i170.shadow,14);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 322, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i171} true;
  $shadow_ok := ($shadow_ok && ($i171 == $i171.shadow));
  goto $bb16, $bb17;
$bb16:
  assume ($i171 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 325, 8} true;
  assume {:verifier.code 0} true;
  $i172 := 0;
  $i172.shadow := 0;
  goto $bb18;
$bb17:
  assume !($i171 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 330, 7} true;
  assume {:verifier.code 0} true;
  $i182 := 14;
  $i182.shadow := 14;
  goto $bb23;
$bb18:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i172 == $i172.shadow);
  assert {:shadow_invariant} ($i170 == $i170.shadow);
  assert {:shadow_invariant} ($p8 == $p8.shadow);
  assert {:shadow_invariant} ($p6 == $p6.shadow);
  assert {:shadow_invariant} ($p10 == $p10.shadow);
  ...
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 325, 17} true;
  assume {:verifier.code 0} true;
  $i173 := $slt.i32($i172,16);
  $i173.shadow := $slt.i32($i172.shadow,16);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 325, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i173} true;
  $shadow_ok := ($shadow_ok && ($i173 == $i173.shadow));
  goto $bb19, $bb20;
$bb19:
  assume ($i173 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 326, 13} true;
  assume {:verifier.code 0} true;
  $p174 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p174.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 326, 16} true;
  assume {:verifier.code 0} true;
  $p175 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p175.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 326, 19} true;
  assume {:verifier.code 0} true;
  $p176 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p176.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 326, 4} true;
  assume {:verifier.code 0} true;
  call c255_mul($p174, $p174.shadow, $p175, $p175.shadow, $p176, $p176.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 327, 3} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb20:
  assume !($i173 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 328, 12} true;
  assume {:verifier.code 0} true;
  $p178 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p178.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 328, 15} true;
  assume {:verifier.code 0} true;
  $p179 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p179.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 328, 18} true;
  assume {:verifier.code 0} true;
  $p180 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p180.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 328, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p178, $p178.shadow, $p179, $p179.shadow, $p180, $p180.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 329, 2} true;
  assume {:verifier.code 0} true;
  goto $bb22;
$bb21:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 325, 25} true;
  assume {:verifier.code 0} true;
  $i177 := $add.i32($i172,1);
  $i177.shadow := $add.i32($i172.shadow,1);
  call {:cexpr "j"} boogie_si_record_i32($i177);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 325, 3} true;
  assume {:verifier.code 0} true;
  $i172 := $i177;
  $i172.shadow := $i177.shadow;
  goto $bb18;
$bb22:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 322, 24} true;
  assume {:verifier.code 0} true;
  $i181 := $add.i32($i170,1);
  $i181.shadow := $add.i32($i170.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i181);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 322, 2} true;
  assume {:verifier.code 0} true;
  $i170 := $i181;
  $i170.shadow := $i181.shadow;
  goto $bb15;
$bb23:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i182 == $i182.shadow);
  assert {:shadow_invariant} ($p8 == $p8.shadow);
  assert {:shadow_invariant} ($p6 == $p6.shadow);
  assert {:shadow_invariant} ($p10 == $p10.shadow);
  assert {:shadow_invariant} ($p12 == $p12.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 330, 17} true;
  assume {:verifier.code 0} true;
  $i183 := $sge.i32($i182,0);
  $i183.shadow := $sge.i32($i182.shadow,0);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 330, 2} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume ($i183 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 331, 12} true;
  assume {:verifier.code 0} true;
  $p184 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p184.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 331, 15} true;
  assume {:verifier.code 0} true;
  $p185 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p185.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 331, 18} true;
  assume {:verifier.code 0} true;
  $p186 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p186.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 331, 3} true;
  assume {:verifier.code 0} true;
  call c255_mul($p184, $p184.shadow, $p185, $p185.shadow, $p186, $p186.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 332, 15} true;
  assume {:verifier.code 0} true;
  $i187 := $ashr.i32(65515,$i182);
  $i187.shadow := $ashr.i32(65515,$i182.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 332, 21} true;
  assume {:verifier.code 0} true;
  $i188 := $and.i32($i187,1);
  $i188.shadow := $and.i32($i187.shadow,1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 332, 21} true;
  assume {:verifier.code 0} true;
  $i189 := $ne.i32($i188,0);
  $i189.shadow := $ne.i32($i188.shadow,0);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 332, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i189} true;
  $shadow_ok := ($shadow_ok && ($i189 == $i189.shadow));
  goto $bb26, $bb27;
$bb25:
  assume !($i183 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 336, 11} true;
  assume {:verifier.code 0} true;
  $p194 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p194.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 336, 14} true;
  assume {:verifier.code 0} true;
  $p195 := $add.ref($add.ref($p6,$mul.ref(0,36)),$mul.ref(0,2));
  $p195.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 336, 18} true;
  assume {:verifier.code 0} true;
  $p196 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p196.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 336, 2} true;
  assume {:verifier.code 0} true;
  call c255_mul($p194, $p194.shadow, $p195, $p195.shadow, $p196, $p196.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 344, 14} true;
  assume {:verifier.code 0} true;
  $p197 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p197.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 344, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && (C255_P == C255_P));
  $i198 := $load.i16($M.4,C255_P);
  $i198.shadow := $load.i16($M.4.shadow,C255_P);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 344, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_zero($p197, $p197.shadow, $i198, $i198.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 345, 2} true;
  assume {:verifier.code 0} true;
  $p199 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(1,2));
  $p199.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 345, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p199 == $p199.shadow));
  $M.4 := $store.i16($M.4,$p199,1);
  $M.4.shadow := $store.i16($M.4.shadow,$p199.shadow,1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 346, 18} true;
  assume {:verifier.code 0} true;
  $p200 := $add.ref($add.ref($p6,$mul.ref(0,36)),$mul.ref(0,2));
  $p200.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 346, 22} true;
  assume {:verifier.code 0} true;
  $p201 := $add.ref($add.ref($p10,$mul.ref(0,38)),$mul.ref(0,2));
  $p201.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 346, 25} true;
  assume {:verifier.code 0} true;
  $p202 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p202.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 346, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_montymul($p200, $p200.shadow, $p201, $p201.shadow, $p202, $p202.shadow, C255_P, C255_P, 18971, 18971);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 348, 23} true;
  assume {:verifier.code 0} true;
  $p203 := $add.ref($add.ref($p6,$mul.ref(0,36)),$mul.ref(0,2));
  $p203.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 348, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_encode($p0, $p0.shadow, 32, 32, $p203, $p203.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 349, 2} true;
  assume {:verifier.code 0} true;
  call byteswap($p0, $p0.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 350, 2} true;
  assume {:verifier.code 0} true;
  $i22 := 1;
  $i22.shadow := 1;
  goto $bb6;
$bb26:
  assume ($i189 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 333, 13} true;
  assume {:verifier.code 0} true;
  $p190 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p190.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 333, 16} true;
  assume {:verifier.code 0} true;
  $p191 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,2));
  $p191.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 333, 20} true;
  assume {:verifier.code 0} true;
  $p192 := $add.ref($add.ref($p12,$mul.ref(0,38)),$mul.ref(0,2));
  $p192.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,38)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 333, 4} true;
  assume {:verifier.code 0} true;
  call c255_mul($p190, $p190.shadow, $p191, $p191.shadow, $p192, $p192.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 334, 3} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb27:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 332, 7} true;
  ...
  goto $bb28;
$bb28:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 335, 2} true;
  assume {:verifier.code 0} true;
  goto $bb29;
$bb29:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 330, 25} true;
  assume {:verifier.code 0} true;
  $i193 := $add.i32($i182,$sub.i32(0,1));
  $i193.shadow := $add.i32($i182.shadow,$sub.i32(0,1));
  call {:cexpr "i"} boogie_si_record_i32($i193);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 330, 2} true;
  assume {:verifier.code 0} true;
  $i182 := $i193;
  $i182.shadow := $i193.shadow;
  goto $bb23;
}
const api_mulgen: ref;
axiom (api_mulgen == $sub.ref(0,11532));
...
modifies $CurrAddr;
{
  ...
  var $i9.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 362, 6} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 362, 6} true;
  assume {:verifier.code 0} true;
  call $p5, $p5.shadow := api_generator($i3, $i3.shadow, $p4, $p4.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 363, 15} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4 == $p4.shadow));
  $i6 := $load.i64($M.0,$p4);
  $i6.shadow := $load.i64($M.0.shadow,$p4.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 363, 2} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p0 == $p0.shadow));
  $shadow_ok := ($shadow_ok && ($p5 == $p5.shadow));
  $shadow_ok := ($shadow_ok && ($i6 == $i6.shadow));
  call $M.3, $M.3.shadow := $memcpy.i8($M.3, $M.3.shadow, $M.7, $M.7.shadow, $p0, $p0.shadow, $p5, $p5.shadow, $i6, $i6.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 364, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4 == $p4.shadow));
  $i7 := $load.i64($M.0,$p4);
  $i7.shadow := $load.i64($M.0.shadow,$p4.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 364, 2} true;
  assume {:verifier.code 0} true;
  call $i8, $i8.shadow := api_mul($p0, $p0.shadow, $i7, $i7.shadow, $p1, $p1.shadow, $i2, $i2.shadow, $i3, $i3.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 365, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4 == $p4.shadow));
  $i9 := $load.i64($M.0,$p4);
  $i9.shadow := $load.i64($M.0.shadow,$p4.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 365, 2} true;
  assume {:verifier.code 0} true;
  $r := $i9;
  $r.shadow := $i9.shadow;
  $exn := false;
...
axiom (api_muladd == $sub.ref(0,12564));
...
{
$bb0:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 386, 2} true;
  assume {:verifier.code 0} true;
...
const byteswap: ref;
axiom (byteswap == $sub.ref(0,16692));
procedure {:inline 1} byteswap($p0: ref, $p0.shadow: ref)
modifies $M.3, $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i15.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 169, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 169, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 169, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1,16);
  $i2.shadow := $slt.i32($i1.shadow,16);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 169, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 172, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  ...
  $p4.shadow := $add.ref($p0.shadow,$mul.ref($i3.shadow,1));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 172, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4 == $p4.shadow));
  $i5 := $load.i8($M.3,$p4);
  $i5.shadow := $load.i8($M.3.shadow,$p4.shadow);
  call {:cexpr "t"} boogie_si_record_i8($i5);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 173, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $sub.i32(31,$i1);
  $i6.shadow := $sub.i32(31,$i1.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 173, 10} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i6);
  $i7.shadow := $sext.i32.i64($i6.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 173, 10} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p0,$mul.ref($i7,1));
  $p8.shadow := $add.ref($p0.shadow,$mul.ref($i7.shadow,1));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 173, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p8 == $p8.shadow));
  $i9 := $load.i8($M.3,$p8);
  $i9.shadow := $load.i8($M.3.shadow,$p8.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 173, 3} true;
  assume {:verifier.code 0} true;
  $i10 := $sext.i32.i64($i1);
  $i10.shadow := $sext.i32.i64($i1.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 173, 3} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p0,$mul.ref($i10,1));
  $p11.shadow := $add.ref($p0.shadow,$mul.ref($i10.shadow,1));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 173, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p11 == $p11.shadow));
  $M.3 := $store.i8($M.3,$p11,$i9);
  $M.3.shadow := $store.i8($M.3.shadow,$p11.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 174, 8} true;
  assume {:verifier.code 0} true;
  $i12 := $sub.i32(31,$i1);
  $i12.shadow := $sub.i32(31,$i1.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 174, 3} true;
  assume {:verifier.code 0} true;
  $i13 := $sext.i32.i64($i12);
  $i13.shadow := $sext.i32.i64($i12.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 174, 3} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p0,$mul.ref($i13,1));
  $p14.shadow := $add.ref($p0.shadow,$mul.ref($i13.shadow,1));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 174, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p14 == $p14.shadow));
  $M.3 := $store.i8($M.3,$p14,$i5);
  $M.3.shadow := $store.i8($M.3.shadow,$p14.shadow,$i5.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 175, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i2 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 176, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 169, 24} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i1,1);
  $i15.shadow := $add.i32($i1.shadow,1);
...
const br_i15_zero: ref;
axiom (br_i15_zero == $sub.ref(0,17724));
procedure {:inline 1} br_i15_zero($p0: ref, $p0.shadow: ref, $i1: i16, $i1.shadow: i16)
modifies $M.4, $exn;
{
  var $p2: ref;
  var $p2.shadow: ref;
  ...
  var $i8.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 1539, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_zero:arg:bit_len"} boogie_si_record_i16($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1539, 5} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p0,$mul.ref(1,2));
  $p2.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/inner.h", 1539, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p0 == $p0.shadow));
  $M.4 := $store.i16($M.4,$p0,$i1);
  $M.4.shadow := $store.i16($M.4.shadow,$p0.shadow,$i1.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1540, 2} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  $p3.shadow := $bitcast.ref.ref($p2.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1540, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i16.i32($i1);
  $i4.shadow := $zext.i16.i32($i1.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1540, 25} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i4,15);
  $i5.shadow := $add.i32($i4.shadow,15);
  assume {:sourceloc "../BearSSL/src/inner.h", 1540, 31} true;
  assume {:verifier.code 0} true;
  $i6 := $ashr.i32($i5,4);
  $i6.shadow := $ashr.i32($i5.shadow,4);
  assume {:sourceloc "../BearSSL/src/inner.h", 1540, 15} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i6);
  $i7.shadow := $sext.i32.i64($i6.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1540, 37} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i64($i7,2);
  $i8.shadow := $mul.i64($i7.shadow,2);
  assume {:sourceloc "../BearSSL/src/inner.h", 1540, 2} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p3 == $p3.shadow));
  $shadow_ok := ($shadow_ok && ($i8 == $i8.shadow));
  call $M.4, $M.4.shadow := $memset.i8($M.4, $M.4.shadow, $p3, $p3.shadow, 0, 0, $i8, $i8.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/inner.h", 1541, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const br_i15_decode_mod: ref;
axiom (br_i15_decode_mod == $sub.ref(0,18756));
procedure {:inline 1} br_i15_decode_mod($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64, $p3: ref, $p3.shadow: ref) returns ($r: i32, $r.shadow: i32)
modifies $M.4, $exn;
{
  var $p4: ref;
  var $p4.shadow: ref;
  ...
  var $i68.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 60, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_decode_mod:arg:len"} boogie_si_record_i64($i2);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 60, 10} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p3,$mul.ref(0,2));
  $p4.shadow := $add.ref($p3.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 60, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4 == $p4.shadow));
  $i5 := $load.i16($M.4,$p4);
  $i5.shadow := $load.i16($M.4.shadow,$p4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 60, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i16.i32($i5);
  $i6.shadow := $zext.i16.i32($i5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 60, 15} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i6,15);
  $i7.shadow := $add.i32($i6.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 60, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $ashr.i32($i7,4);
  $i8.shadow := $ashr.i32($i7.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 60, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $sext.i32.i64($i8);
  $i9.shadow := $sext.i32.i64($i8.shadow);
  call {:cexpr "mlen"} boogie_si_record_i64($i9);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 61, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $shl.i64($i9,1);
  $i10.shadow := $shl.i64($i9.shadow,1);
  call {:cexpr "tlen"} boogie_si_record_i64($i10);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 62, 11} true;
  assume {:verifier.code 0} true;
  $i11 := $ult.i64($i10,$i2);
  $i11.shadow := $ult.i64($i10.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 62, 6} true;
  assume {:verifier.code 0} true;
  $i12 := $i10;
  $i12.shadow := $i10.shadow;
  assume {:branchcond $i11} true;
  $shadow_ok := ($shadow_ok && ($i11 == $i11.shadow));
  goto $bb1, $bb2;
$bb1:
  assume ($i11 == 1);
  call {:cexpr "br_i15_decode_mod:arg:tlen"} boogie_si_record_i64($i2);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 64, 2} true;
  assume {:verifier.code 0} true;
  $i12 := $i2;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 65, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i64($i12,4);
  $i13.shadow := $add.i64($i12.shadow,4);
  call {:cexpr "tlen"} boogie_si_record_i64($i13);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 67, 7} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
  $i14.shadow := 0;
  $i15 := 0;
...
$bb4:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 67, 22} true;
  assume {:verifier.code 0} true;
  $i16 := $slt.i32($i14,2);
  $i16.shadow := $slt.i32($i14.shadow,2);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 67, 2} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i16 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 75, 8} true;
  assume {:verifier.code 0} true;
  $i17 := $i15;
...
$bb6:
  assume !($i16 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 122, 9} true;
  assume {:verifier.code 0} true;
  $p65 := $add.ref($p3,$mul.ref(0,2));
  $p65.shadow := $add.ref($p3.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 122, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p65 == $p65.shadow));
  $i66 := $load.i16($M.4,$p65);
  $i66.shadow := $load.i16($M.4.shadow,$p65.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 122, 2} true;
  assume {:verifier.code 0} true;
  $p67 := $add.ref($p0,$mul.ref(0,2));
  $p67.shadow := $add.ref($p0.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 122, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p67 == $p67.shadow));
  $M.4 := $store.i16($M.4,$p67,$i66);
  $M.4.shadow := $store.i16($M.4.shadow,$p67.shadow,$i66.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 123, 11} true;
  assume {:verifier.code 0} true;
  $i68 := $and.i32($i15,1);
  $i68.shadow := $and.i32($i15.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 123, 2} true;
  assume {:verifier.code 0} true;
  $r := $i68;
  $r.shadow := $i68.shadow;
  $exn := false;
...
$bb7:
  ...
  assert {:shadow_invariant} ($i21 == $i21.shadow);
  assert {:shadow_invariant} ($i13 == $i13.shadow);
  assert {:shadow_invariant} ($i18 == $i18.shadow);
  assert {:shadow_invariant} ($i14 == $i14.shadow);
  assert {:shadow_invariant} ($i9 == $i9.shadow);
  assert {:unlikely_shadow_invariant ($i17 == $i17.shadow)} true;
  assert {:unlikely_shadow_invariant ($i20 == $i20.shadow)} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 66, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 0, 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 75, 17} true;
  assume {:verifier.code 0} true;
  $i22 := $ult.i64($i18,$i13);
  $i22.shadow := $ult.i64($i18.shadow,$i13.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 75, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume ($i22 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 78, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $ult.i64($i18,$i2);
  $i23.shadow := $ult.i64($i18.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 78, 8} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume !($i22 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 118, 5} true;
  assume {:verifier.code 0} true;
  $i61 := $lshr.i32($i17,1);
  $i61.shadow := $lshr.i32($i17.shadow,1);
  call {:cexpr "r"} boogie_si_record_i32($i61);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 119, 11} true;
  assume {:verifier.code 0} true;
  $i62 := $shl.i32($i61,1);
  $i62.shadow := $shl.i32($i61.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 119, 5} true;
  assume {:verifier.code 0} true;
  $i63 := $or.i32($i61,$i62);
  $i63.shadow := $or.i32($i61.shadow,$i62.shadow);
  call {:cexpr "r"} boogie_si_record_i32($i63);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 120, 2} true;
  assume {:verifier.code 0} true;
  goto $bb26;
$bb10:
  assume ($i23 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 79, 17} true;
  assume {:verifier.code 0} true;
  $i24 := $sub.i64($i2,1);
  $i24.shadow := $sub.i64($i2.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 79, 21} true;
  assume {:verifier.code 0} true;
  $i25 := $sub.i64($i24,$i18);
  $i25.shadow := $sub.i64($i24.shadow,$i18.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 79, 9} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p1,$mul.ref($i25,1));
  $p26.shadow := $add.ref($p1.shadow,$mul.ref($i25.shadow,1));
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 79, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p26 == $p26.shadow));
  $i27 := $load.i8($M.3,$p26);
  $i27.shadow := $load.i8($M.3.shadow,$p26.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 79, 9} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i8.i32($i27);
  $i28.shadow := $zext.i8.i32($i27.shadow);
  call {:cexpr "b"} boogie_si_record_i32($i28);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 80, 4} true;
  assume {:verifier.code 0} true;
  $i29 := $i28;
  $i29.shadow := $i28.shadow;
  goto $bb12;
$bb11:
  assume !($i23 == 1);
  assume {:verifier.code 0} true;
...
$bb12:
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 83, 14} true;
  assume {:verifier.code 0} true;
  $i30 := $shl.i32($i29,$i21);
  $i30.shadow := $shl.i32($i29.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 83, 8} true;
  assume {:verifier.code 0} true;
  $i31 := $or.i32($i20,$i30);
  $i31.shadow := $or.i32($i20.shadow,$i30.shadow);
  call {:cexpr "acc"} boogie_si_record_i32($i31);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 84, 12} true;
  assume {:verifier.code 0} true;
  $i32 := $add.i32($i21,8);
  $i32.shadow := $add.i32($i21.shadow,8);
  call {:cexpr "acc_len"} boogie_si_record_i32($i32);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 85, 16} true;
  assume {:verifier.code 0} true;
  $i33 := $sge.i32($i32,15);
  $i33.shadow := $sge.i32($i32.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 85, 8} true;
  assume {:verifier.code 0} true;
  $i34 := $i17;
  $i34.shadow := $i17.shadow;
  $i35 := $i19;
  $i35.shadow := $i19.shadow;
  $i36 := $i31;
  $i36.shadow := $i31.shadow;
  $i37 := $i32;
...
$bb13:
  assume ($i33 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 88, 14} true;
  assume {:verifier.code 0} true;
  $i38 := $and.i32($i31,32767);
  $i38.shadow := $and.i32($i31.shadow,32767);
  call {:cexpr "xw"} boogie_si_record_i32($i38);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 89, 13} true;
  assume {:verifier.code 0} true;
  $i39 := $sub.i32($i32,15);
  $i39.shadow := $sub.i32($i32.shadow,15);
  call {:cexpr "acc_len"} boogie_si_record_i32($i39);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 90, 19} true;
  assume {:verifier.code 0} true;
  $i40 := $sub.i32(8,$i39);
  $i40.shadow := $sub.i32(8,$i39.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 90, 13} true;
  assume {:verifier.code 0} true;
  $i41 := $lshr.i32($i29,$i40);
  $i41.shadow := $lshr.i32($i29.shadow,$i40.shadow);
  call {:cexpr "acc"} boogie_si_record_i32($i41);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 91, 11} true;
  assume {:verifier.code 0} true;
  $i42 := $ule.i64($i19,$i9);
  $i42.shadow := $ule.i64($i19.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 91, 9} true;
  assume {:verifier.code 0} true;
...
$bb15:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 107, 3} true;
  assume {:verifier.code 0} true;
  goto $bb25;
$bb16:
  assume ($i42 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 92, 10} true;
  assume {:verifier.code 0} true;
  $i43 := $ne.i32($i14,0);
  $i43.shadow := $ne.i32($i14.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 92, 10} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume !($i42 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 101, 11} true;
  assume {:verifier.code 0} true;
  $i55 := $ne.i32($i14,0);
  $i55.shadow := $ne.i32($i14.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 101, 10} true;
  assume {:verifier.code 0} true;
  $i56 := $i17;
  $i56.shadow := $i17.shadow;
  assume {:branchcond $i55} true;
  $shadow_ok := ($shadow_ok && ($i55 == $i55.shadow));
  goto $bb22, $bb24;
$bb18:
  assume ($i43 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 93, 16} true;
  assume {:verifier.code 0} true;
  $i44 := $and.i32($i17,$i38);
  $i44.shadow := $and.i32($i17.shadow,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 93, 14} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i32.i16($i44);
  $i45.shadow := $trunc.i32.i16($i44.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 93, 7} true;
  assume {:verifier.code 0} true;
  $p46 := $add.ref($p0,$mul.ref($i19,2));
  $p46.shadow := $add.ref($p0.shadow,$mul.ref($i19.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 93, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p46 == $p46.shadow));
  $M.4 := $store.i16($M.4,$p46,$i45);
  $M.4.shadow := $store.i16($M.4.shadow,$p46.shadow,$i45.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 94, 6} true;
  assume {:verifier.code 0} true;
  $i47 := $i17;
  $i47.shadow := $i17.shadow;
  goto $bb20;
$bb19:
  assume !($i43 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 97, 30} true;
  assume {:verifier.code 0} true;
  $p48 := $add.ref($p3,$mul.ref($i19,2));
  $p48.shadow := $add.ref($p3.shadow,$mul.ref($i19.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 97, 30} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p48 == $p48.shadow));
  $i49 := $load.i16($M.4,$p48);
  $i49.shadow := $load.i16($M.4.shadow,$p48.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 97, 30} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i16.i32($i49);
  $i50.shadow := $zext.i16.i32($i49.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 97, 22} true;
  assume {:verifier.code 0} true;
  call $i51, $i51.shadow := CMP($i38, $i38.shadow, $i50, $i50.shadow);
  call {:cexpr "cc"} boogie_si_record_i32($i51);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 98, 15} true;
  assume {:verifier.code 0} true;
  call $i52, $i52.shadow := EQ($i51, $i51.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 98, 11} true;
  assume {:verifier.code 0} true;
  call $i53, $i53.shadow := MUX.7($i52, $i52.shadow, $i17, $i17.shadow, $i51, $i51.shadow);
  call {:cexpr "r"} boogie_si_record_i32($i53);
  assume {:verifier.code 0} true;
  $i47 := $i53;
...
$bb20:
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 100, 5} true;
  assume {:verifier.code 0} true;
  $i54 := $i47;
  $i54.shadow := $i47.shadow;
  goto $bb21;
$bb21:
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 66, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 105, 7} true;
  assume {:verifier.code 0} true;
  $i59 := $add.i64($i19,1);
  $i59.shadow := $add.i64($i19.shadow,1);
  call {:cexpr "v"} boogie_si_record_i64($i59);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 106, 4} true;
  assume {:verifier.code 0} true;
  $i34 := $i54;
  $i34.shadow := $i54.shadow;
  $i35 := $i59;
  $i35.shadow := $i59.shadow;
  $i36 := $i41;
  $i36.shadow := $i41.shadow;
  $i37 := $i39;
  $i37.shadow := $i39.shadow;
  goto $bb15;
$bb22:
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 101, 10} true;
  assume {:verifier.code 0} true;
...
$bb23:
  ...
  assume {:verifier.code 0} true;
  $i54 := $i56;
  $i54.shadow := $i56.shadow;
  goto $bb21;
$bb24:
  assume !($i55 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 102, 15} true;
  assume {:verifier.code 0} true;
  call $i57, $i57.shadow := EQ($i38, $i38.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 102, 11} true;
  assume {:verifier.code 0} true;
  call $i58, $i58.shadow := MUX.7($i57, $i57.shadow, $i17, $i17.shadow, 1, 1);
  call {:cexpr "r"} boogie_si_record_i32($i58);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 103, 6} true;
  assume {:verifier.code 0} true;
  $i56 := $i58;
  $i56.shadow := $i58.shadow;
  goto $bb23;
$bb25:
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 75, 27} true;
  assume {:verifier.code 0} true;
  $i60 := $add.i64($i18,1);
  $i60.shadow := $add.i64($i18.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i60);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 75, 3} true;
  assume {:verifier.code 0} true;
  $i17 := $i34;
  $i17.shadow := $i34.shadow;
  $i18 := $i60;
  $i18.shadow := $i60.shadow;
  $i19 := $i35;
  $i19.shadow := $i35.shadow;
  $i20 := $i36;
  $i20.shadow := $i36.shadow;
  $i21 := $i37;
  $i21.shadow := $i37.shadow;
  goto $bb7;
$bb26:
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 67, 32} true;
  assume {:verifier.code 0} true;
  $i64 := $add.i32($i14,1);
  $i64.shadow := $add.i32($i14.shadow,1);
  call {:cexpr "pass"} boogie_si_record_i32($i64);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $i14 := $i64;
  $i14.shadow := $i64.shadow;
  $i15 := $i63;
  $i15.shadow := $i63.shadow;
  goto $bb4;
}
const br_i15_sub: ref;
axiom (br_i15_sub == $sub.ref(0,19788));
procedure {:inline 1} br_i15_sub($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $M.4, $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $i25.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 35, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_sub:arg:ctl"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 35, 7} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p0,$mul.ref(0,2));
  $p3.shadow := $add.ref($p0.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 35, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p3 == $p3.shadow));
  $i4 := $load.i16($M.4,$p3);
  $i4.shadow := $load.i16($M.4.shadow,$p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 35, 7} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i16.i32($i4);
  $i5.shadow := $zext.i16.i32($i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 35, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i5,31);
  $i6.shadow := $add.i32($i5.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 35, 18} true;
  assume {:verifier.code 0} true;
  $i7 := $ashr.i32($i6,4);
  $i7.shadow := $ashr.i32($i6.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 35, 6} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i7);
  $i8.shadow := $sext.i32.i64($i7.shadow);
  call {:cexpr "m"} boogie_si_record_i64($i8);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 36, 7} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  $i9.shadow := 0;
  $i10 := 1;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 36, 16} true;
  assume {:verifier.code 0} true;
  $i11 := $ult.i64($i10,$i8);
  $i11.shadow := $ult.i64($i10.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 36, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  $shadow_ok := ($shadow_ok && ($i11 == $i11.shadow));
  goto $bb2, $bb3;
$bb2:
  assume ($i11 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 39, 8} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p0,$mul.ref($i10,2));
  $p12.shadow := $add.ref($p0.shadow,$mul.ref($i10.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 39, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p12 == $p12.shadow));
  $i13 := $load.i16($M.4,$p12);
  $i13.shadow := $load.i16($M.4.shadow,$p12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 39, 8} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i16.i32($i13);
  $i14.shadow := $zext.i16.i32($i13.shadow);
  call {:cexpr "aw"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 40, 8} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p1,$mul.ref($i10,2));
  $p15.shadow := $add.ref($p1.shadow,$mul.ref($i10.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 40, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p15 == $p15.shadow));
  $i16 := $load.i16($M.4,$p15);
  $i16.shadow := $load.i16($M.4.shadow,$p15.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 40, 8} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i16.i32($i16);
  $i17.shadow := $zext.i16.i32($i16.shadow);
  call {:cexpr "bw"} boogie_si_record_i32($i17);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 41, 12} true;
  assume {:verifier.code 0} true;
  $i18 := $sub.i32($i14,$i17);
  $i18.shadow := $sub.i32($i14.shadow,$i17.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 41, 17} true;
  assume {:verifier.code 0} true;
  $i19 := $sub.i32($i18,$i9);
  $i19.shadow := $sub.i32($i18.shadow,$i9.shadow);
  call {:cexpr "naw"} boogie_si_record_i32($i19);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 42, 12} true;
  assume {:verifier.code 0} true;
  $i20 := $lshr.i32($i19,31);
  $i20.shadow := $lshr.i32($i19.shadow,31);
  call {:cexpr "cc"} boogie_si_record_i32($i20);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 43, 23} true;
  assume {:verifier.code 0} true;
  $i21 := $and.i32($i19,32767);
  $i21.shadow := $and.i32($i19.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 43, 10} true;
  assume {:verifier.code 0} true;
  call $i22, $i22.shadow := MUX.17($i2, $i2.shadow, $i21, $i21.shadow, $i14, $i14.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 43, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i32.i16($i22);
  $i23.shadow := $trunc.i32.i16($i22.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p0,$mul.ref($i10,2));
  $p24.shadow := $add.ref($p0.shadow,$mul.ref($i10.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 43, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p24 == $p24.shadow));
  $M.4 := $store.i16($M.4,$p24,$i23);
  $M.4.shadow := $store.i16($M.4.shadow,$p24.shadow,$i23.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 44, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i11 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 45, 2} true;
  assume {:verifier.code 0} true;
  $r := $i9;
  $r.shadow := $i9.shadow;
  $exn := false;
  ...
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 36, 23} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i64($i10,1);
  $i25.shadow := $add.i64($i10.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i25);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 36, 2} true;
  assume {:verifier.code 0} true;
  $i9 := $i20;
  $i9.shadow := $i20.shadow;
  $i10 := $i25;
  $i10.shadow := $i25.shadow;
  goto $bb1;
}
const NOT: ref;
axiom (NOT == $sub.ref(0,20820));
...
const br_i15_montymul: ref;
axiom (br_i15_montymul == $sub.ref(0,21852));
procedure {:inline 1} br_i15_montymul($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref, $i4: i16, $i4.shadow: i16)
modifies $M.4, $exn;
{
  var $p5: ref;
  var $p5.shadow: ref;
  ...
  var $i168.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 35, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_montymul:arg:m0i"} boogie_si_record_i16($i4);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p3,$mul.ref(0,2));
  $p5.shadow := $add.ref($p3.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p5 == $p5.shadow));
  $i6 := $load.i16($M.4,$p5);
  $i6.shadow := $load.i16($M.4.shadow,$p5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i16.i32($i6);
  $i7.shadow := $zext.i16.i32($i6.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 35, 14} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i7,15);
  $i8.shadow := $add.i32($i7.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 35, 20} true;
  assume {:verifier.code 0} true;
  $i9 := $ashr.i32($i8,4);
  $i9.shadow := $ashr.i32($i8.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 35, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $sext.i32.i64($i9);
  $i10.shadow := $sext.i32.i64($i9.shadow);
  call {:cexpr "len"} boogie_si_record_i64($i10);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 36, 13} true;
  assume {:verifier.code 0} true;
  $i11 := $and.i64($i10,18446744073709551612);
  $i11.shadow := $and.i64($i10.shadow,18446744073709551612);
  call {:cexpr "len4"} boogie_si_record_i64($i11);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 37, 17} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p3,$mul.ref(0,2));
  $p12.shadow := $add.ref($p3.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 37, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p12 == $p12.shadow));
  $i13 := $load.i16($M.4,$p12);
  $i13.shadow := $load.i16($M.4.shadow,$p12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 37, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_zero.13($p0, $p0.shadow, $i13, $i13.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 39, 7} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
  $i14.shadow := 0;
  $i15 := 0;
...
$bb1:
  ...
  assert {:shadow_invariant} ($i14 == $i14.shadow);
  assert {:unlikely_shadow_invariant ($i15 == $i15.shadow)} true;
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 39, 16} true;
  assume {:verifier.code 0} true;
  $i16 := $ult.i64($i14,$i10);
  $i16.shadow := $ult.i64($i14.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 39, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i16} true;
  $shadow_ok := ($shadow_ok && ($i16 == $i16.shadow));
  goto $bb2, $bb3;
$bb2:
  assume ($i16 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 42, 12} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i64($i14,1);
  $i17.shadow := $add.i64($i14.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 42, 8} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p1,$mul.ref($i17,2));
  $p18.shadow := $add.ref($p1.shadow,$mul.ref($i17.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 42, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p18 == $p18.shadow));
  $i19 := $load.i16($M.4,$p18);
  $i19.shadow := $load.i16($M.4.shadow,$p18.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 42, 8} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i16.i32($i19);
  $i20.shadow := $zext.i16.i32($i19.shadow);
  call {:cexpr "xu"} boogie_si_record_i32($i20);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p0,$mul.ref(1,2));
  $p21.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p21 == $p21.shadow));
  $i22 := $load.i16($M.4,$p21);
  $i22.shadow := $load.i16($M.4.shadow,$p21.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i16.i32($i22);
  $i23.shadow := $zext.i16.i32($i22.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i64($i14,1);
  $i24.shadow := $add.i64($i14.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($p1,$mul.ref($i24,2));
  $p25.shadow := $add.ref($p1.shadow,$mul.ref($i24.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p25 == $p25.shadow));
  $i26 := $load.i16($M.4,$p25);
  $i26.shadow := $load.i16($M.4.shadow,$p25.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i16.i32($i26);
  $i27.shadow := $zext.i16.i32($i26.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($p2,$mul.ref(1,2));
  $p28.shadow := $add.ref($p2.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p28 == $p28.shadow));
  $i29 := $load.i16($M.4,$p28);
  $i29.shadow := $load.i16($M.4.shadow,$p28.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $i30 := $zext.i16.i32($i29);
  $i30.shadow := $zext.i16.i32($i29.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $i31 := $mul.i32($i27,$i30);
  $i31.shadow := $mul.i32($i27.shadow,$i30.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $i32 := $add.i32($i23,$i31);
  $i32.shadow := $add.i32($i23.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $i33 := $and.i32($i32,32767);
  $i33.shadow := $and.i32($i32.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i16.i32($i4);
  $i34.shadow := $zext.i16.i32($i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $i35 := $mul.i32($i33,$i34);
  $i35.shadow := $mul.i32($i33.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 44, 4} true;
  assume {:verifier.code 0} true;
  $i36 := $and.i32($i35,32767);
  $i36.shadow := $and.i32($i35.shadow,32767);
  call {:cexpr "f"} boogie_si_record_i32($i36);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 139, 8} true;
  assume {:verifier.code 0} true;
  $i37 := 0;
  $i37.shadow := 0;
  $i38 := 0;
...
$bb3:
  assume !($i16 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 177, 9} true;
  assume {:verifier.code 0} true;
  $p161 := $add.ref($p3,$mul.ref(0,2));
  $p161.shadow := $add.ref($p3.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 177, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p161 == $p161.shadow));
  $i162 := $load.i16($M.4,$p161);
  $i162.shadow := $load.i16($M.4.shadow,$p161.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 177, 2} true;
  assume {:verifier.code 0} true;
  $p163 := $add.ref($p0,$mul.ref(0,2));
  $p163.shadow := $add.ref($p0.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 177, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p163 == $p163.shadow));
  $M.4 := $store.i16($M.4,$p163,$i162);
  $M.4.shadow := $store.i16($M.4.shadow,$p163.shadow,$i162.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 183, 19} true;
  assume {:verifier.code 0} true;
  call $i164, $i164.shadow := NEQ($i15, $i15.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 183, 36} true;
  assume {:verifier.code 0} true;
  call $i165, $i165.shadow := br_i15_sub($p0, $p0.shadow, $p3, $p3.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 183, 32} true;
  assume {:verifier.code 0} true;
  call $i166, $i166.shadow := NOT.14($i165, $i165.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 183, 30} true;
  assume {:verifier.code 0} true;
  $i167 := $or.i32($i164,$i166);
  $i167.shadow := $or.i32($i164.shadow,$i166.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 183, 2} true;
  assume {:verifier.code 0} true;
  call $i168, $i168.shadow := br_i15_sub($p0, $p0.shadow, $p3, $p3.shadow, $i167, $i167.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 184, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 139, 17} true;
  assume {:verifier.code 0} true;
  $i39 := $ult.i64($i37,$i11);
  $i39.shadow := $ult.i64($i37.shadow,$i11.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 139, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i39 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 12} true;
  assume {:verifier.code 0} true;
  $i40 := $add.i64($i37,1);
  $i40.shadow := $add.i64($i37.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 8} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($p0,$mul.ref($i40,2));
  $p41.shadow := $add.ref($p0.shadow,$mul.ref($i40.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p41 == $p41.shadow));
  $i42 := $load.i16($M.4,$p41);
  $i42.shadow := $load.i16($M.4.shadow,$p41.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 8} true;
  assume {:verifier.code 0} true;
  $i43 := $zext.i16.i32($i42);
  $i43.shadow := $zext.i16.i32($i42.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 19} true;
  assume {:verifier.code 0} true;
  $i44 := $add.i64($i37,1);
  $i44.shadow := $add.i64($i37.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 19} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($p2,$mul.ref($i44,2));
  $p45.shadow := $add.ref($p2.shadow,$mul.ref($i44.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p45 == $p45.shadow));
  $i46 := $load.i16($M.4,$p45);
  $i46.shadow := $load.i16($M.4.shadow,$p45.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 19} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i16.i32($i46);
  $i47.shadow := $zext.i16.i32($i46.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 19} true;
  assume {:verifier.code 0} true;
  $i48 := $mul.i32($i20,$i47);
  $i48.shadow := $mul.i32($i20.shadow,$i47.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 17} true;
  assume {:verifier.code 0} true;
  $i49 := $add.i32($i43,$i48);
  $i49.shadow := $add.i32($i43.shadow,$i48.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 143, 7} true;
  assume {:verifier.code 0} true;
  $i50 := $add.i64($i37,1);
  $i50.shadow := $add.i64($i37.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 143, 7} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($p3,$mul.ref($i50,2));
  $p51.shadow := $add.ref($p3.shadow,$mul.ref($i50.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 143, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p51 == $p51.shadow));
  $i52 := $load.i16($M.4,$p51);
  $i52.shadow := $load.i16($M.4.shadow,$p51.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 143, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i54 := $mul.i32($i36,$i53);
  $i54.shadow := $mul.i32($i36.shadow,$i53.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 143, 5} true;
  assume {:verifier.code 0} true;
  $i55 := $add.i32($i49,$i54);
  $i55.shadow := $add.i32($i49.shadow,$i54.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 143, 26} true;
  assume {:verifier.code 0} true;
  $i56 := $add.i32($i55,$i38);
  $i56.shadow := $add.i32($i55.shadow,$i38.shadow);
  call {:cexpr "z"} boogie_si_record_i32($i56);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 144, 10} true;
  assume {:verifier.code 0} true;
  $i57 := $lshr.i32($i56,15);
  $i57.shadow := $lshr.i32($i56.shadow,15);
  call {:cexpr "r"} boogie_si_record_i32($i57);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 145, 17} true;
  assume {:verifier.code 0} true;
  $i58 := $and.i32($i56,32767);
  $i58.shadow := $and.i32($i56.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 145, 15} true;
  assume {:verifier.code 0} true;
  $i59 := $trunc.i32.i16($i58);
  $i59.shadow := $trunc.i32.i16($i58.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 145, 8} true;
  assume {:verifier.code 0} true;
  $i60 := $add.i64($i37,0);
  $i60.shadow := $add.i64($i37.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 145, 4} true;
  assume {:verifier.code 0} true;
  $p61 := $add.ref($p0,$mul.ref($i60,2));
  $p61.shadow := $add.ref($p0.shadow,$mul.ref($i60.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 145, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p61 == $p61.shadow));
  $M.4 := $store.i16($M.4,$p61,$i59);
  $M.4.shadow := $store.i16($M.4.shadow,$p61.shadow,$i59.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 12} true;
  assume {:verifier.code 0} true;
  $i62 := $add.i64($i37,2);
  $i62.shadow := $add.i64($i37.shadow,2);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 8} true;
  assume {:verifier.code 0} true;
  $p63 := $add.ref($p0,$mul.ref($i62,2));
  $p63.shadow := $add.ref($p0.shadow,$mul.ref($i62.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p63 == $p63.shadow));
  $i64 := $load.i16($M.4,$p63);
  $i64.shadow := $load.i16($M.4.shadow,$p63.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 8} true;
  assume {:verifier.code 0} true;
  $i65 := $zext.i16.i32($i64);
  $i65.shadow := $zext.i16.i32($i64.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 19} true;
  assume {:verifier.code 0} true;
  $i66 := $add.i64($i37,2);
  $i66.shadow := $add.i64($i37.shadow,2);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 19} true;
  assume {:verifier.code 0} true;
  $p67 := $add.ref($p2,$mul.ref($i66,2));
  $p67.shadow := $add.ref($p2.shadow,$mul.ref($i66.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p67 == $p67.shadow));
  $i68 := $load.i16($M.4,$p67);
  $i68.shadow := $load.i16($M.4.shadow,$p67.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 19} true;
  assume {:verifier.code 0} true;
  $i69 := $zext.i16.i32($i68);
  $i69.shadow := $zext.i16.i32($i68.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 19} true;
  assume {:verifier.code 0} true;
  $i70 := $mul.i32($i20,$i69);
  $i70.shadow := $mul.i32($i20.shadow,$i69.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 17} true;
  assume {:verifier.code 0} true;
  $i71 := $add.i32($i65,$i70);
  $i71.shadow := $add.i32($i65.shadow,$i70.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 147, 7} true;
  assume {:verifier.code 0} true;
  $i72 := $add.i64($i37,2);
  $i72.shadow := $add.i64($i37.shadow,2);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 147, 7} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($p3,$mul.ref($i72,2));
  $p73.shadow := $add.ref($p3.shadow,$mul.ref($i72.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 147, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p73 == $p73.shadow));
  $i74 := $load.i16($M.4,$p73);
  $i74.shadow := $load.i16($M.4.shadow,$p73.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 147, 7} true;
  assume {:verifier.code 0} true;
  $i75 := $zext.i16.i32($i74);
  $i75.shadow := $zext.i16.i32($i74.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 147, 7} true;
  assume {:verifier.code 0} true;
  $i76 := $mul.i32($i36,$i75);
  $i76.shadow := $mul.i32($i36.shadow,$i75.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 147, 5} true;
  assume {:verifier.code 0} true;
  $i77 := $add.i32($i71,$i76);
  $i77.shadow := $add.i32($i71.shadow,$i76.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 147, 26} true;
  assume {:verifier.code 0} true;
  $i78 := $add.i32($i77,$i57);
  $i78.shadow := $add.i32($i77.shadow,$i57.shadow);
  call {:cexpr "z"} boogie_si_record_i32($i78);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 148, 10} true;
  assume {:verifier.code 0} true;
  $i79 := $lshr.i32($i78,15);
  $i79.shadow := $lshr.i32($i78.shadow,15);
  call {:cexpr "r"} boogie_si_record_i32($i79);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 149, 17} true;
  assume {:verifier.code 0} true;
  $i80 := $and.i32($i78,32767);
  $i80.shadow := $and.i32($i78.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 149, 15} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i32.i16($i80);
  $i81.shadow := $trunc.i32.i16($i80.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 149, 8} true;
  assume {:verifier.code 0} true;
  $i82 := $add.i64($i37,1);
  $i82.shadow := $add.i64($i37.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 149, 4} true;
  assume {:verifier.code 0} true;
  $p83 := $add.ref($p0,$mul.ref($i82,2));
  $p83.shadow := $add.ref($p0.shadow,$mul.ref($i82.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 149, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p83 == $p83.shadow));
  $M.4 := $store.i16($M.4,$p83,$i81);
  $M.4.shadow := $store.i16($M.4.shadow,$p83.shadow,$i81.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 12} true;
  assume {:verifier.code 0} true;
  $i84 := $add.i64($i37,3);
  $i84.shadow := $add.i64($i37.shadow,3);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 8} true;
  assume {:verifier.code 0} true;
  $p85 := $add.ref($p0,$mul.ref($i84,2));
  $p85.shadow := $add.ref($p0.shadow,$mul.ref($i84.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p85 == $p85.shadow));
  $i86 := $load.i16($M.4,$p85);
  $i86.shadow := $load.i16($M.4.shadow,$p85.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 8} true;
  assume {:verifier.code 0} true;
  $i87 := $zext.i16.i32($i86);
  $i87.shadow := $zext.i16.i32($i86.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 19} true;
  assume {:verifier.code 0} true;
  $i88 := $add.i64($i37,3);
  $i88.shadow := $add.i64($i37.shadow,3);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 19} true;
  assume {:verifier.code 0} true;
  $p89 := $add.ref($p2,$mul.ref($i88,2));
  $p89.shadow := $add.ref($p2.shadow,$mul.ref($i88.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p89 == $p89.shadow));
  $i90 := $load.i16($M.4,$p89);
  $i90.shadow := $load.i16($M.4.shadow,$p89.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 19} true;
  assume {:verifier.code 0} true;
  $i91 := $zext.i16.i32($i90);
  $i91.shadow := $zext.i16.i32($i90.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 19} true;
  assume {:verifier.code 0} true;
  $i92 := $mul.i32($i20,$i91);
  $i92.shadow := $mul.i32($i20.shadow,$i91.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 17} true;
  assume {:verifier.code 0} true;
  $i93 := $add.i32($i87,$i92);
  $i93.shadow := $add.i32($i87.shadow,$i92.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 151, 7} true;
  assume {:verifier.code 0} true;
  $i94 := $add.i64($i37,3);
  $i94.shadow := $add.i64($i37.shadow,3);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 151, 7} true;
  assume {:verifier.code 0} true;
  $p95 := $add.ref($p3,$mul.ref($i94,2));
  $p95.shadow := $add.ref($p3.shadow,$mul.ref($i94.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 151, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p95 == $p95.shadow));
  $i96 := $load.i16($M.4,$p95);
  $i96.shadow := $load.i16($M.4.shadow,$p95.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 151, 7} true;
  assume {:verifier.code 0} true;
  $i97 := $zext.i16.i32($i96);
  $i97.shadow := $zext.i16.i32($i96.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 151, 7} true;
  assume {:verifier.code 0} true;
  $i98 := $mul.i32($i36,$i97);
  $i98.shadow := $mul.i32($i36.shadow,$i97.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 151, 5} true;
  assume {:verifier.code 0} true;
  $i99 := $add.i32($i93,$i98);
  $i99.shadow := $add.i32($i93.shadow,$i98.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 151, 26} true;
  assume {:verifier.code 0} true;
  $i100 := $add.i32($i99,$i79);
  $i100.shadow := $add.i32($i99.shadow,$i79.shadow);
  call {:cexpr "z"} boogie_si_record_i32($i100);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 152, 10} true;
  assume {:verifier.code 0} true;
  $i101 := $lshr.i32($i100,15);
  $i101.shadow := $lshr.i32($i100.shadow,15);
  call {:cexpr "r"} boogie_si_record_i32($i101);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 153, 17} true;
  assume {:verifier.code 0} true;
  $i102 := $and.i32($i100,32767);
  $i102.shadow := $and.i32($i100.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 153, 15} true;
  assume {:verifier.code 0} true;
  $i103 := $trunc.i32.i16($i102);
  $i103.shadow := $trunc.i32.i16($i102.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 153, 8} true;
  assume {:verifier.code 0} true;
  $i104 := $add.i64($i37,2);
  $i104.shadow := $add.i64($i37.shadow,2);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 153, 4} true;
  assume {:verifier.code 0} true;
  $p105 := $add.ref($p0,$mul.ref($i104,2));
  $p105.shadow := $add.ref($p0.shadow,$mul.ref($i104.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 153, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p105 == $p105.shadow));
  $M.4 := $store.i16($M.4,$p105,$i103);
  $M.4.shadow := $store.i16($M.4.shadow,$p105.shadow,$i103.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 12} true;
  assume {:verifier.code 0} true;
  $i106 := $add.i64($i37,4);
  $i106.shadow := $add.i64($i37.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 8} true;
  assume {:verifier.code 0} true;
  $p107 := $add.ref($p0,$mul.ref($i106,2));
  $p107.shadow := $add.ref($p0.shadow,$mul.ref($i106.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p107 == $p107.shadow));
  $i108 := $load.i16($M.4,$p107);
  $i108.shadow := $load.i16($M.4.shadow,$p107.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 8} true;
  assume {:verifier.code 0} true;
  $i109 := $zext.i16.i32($i108);
  $i109.shadow := $zext.i16.i32($i108.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 19} true;
  assume {:verifier.code 0} true;
  $i110 := $add.i64($i37,4);
  $i110.shadow := $add.i64($i37.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 19} true;
  assume {:verifier.code 0} true;
  $p111 := $add.ref($p2,$mul.ref($i110,2));
  $p111.shadow := $add.ref($p2.shadow,$mul.ref($i110.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p111 == $p111.shadow));
  $i112 := $load.i16($M.4,$p111);
  $i112.shadow := $load.i16($M.4.shadow,$p111.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 19} true;
  assume {:verifier.code 0} true;
  $i113 := $zext.i16.i32($i112);
  $i113.shadow := $zext.i16.i32($i112.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 19} true;
  assume {:verifier.code 0} true;
  $i114 := $mul.i32($i20,$i113);
  $i114.shadow := $mul.i32($i20.shadow,$i113.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 17} true;
  assume {:verifier.code 0} true;
  $i115 := $add.i32($i109,$i114);
  $i115.shadow := $add.i32($i109.shadow,$i114.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 155, 7} true;
  assume {:verifier.code 0} true;
  $i116 := $add.i64($i37,4);
  $i116.shadow := $add.i64($i37.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 155, 7} true;
  assume {:verifier.code 0} true;
  $p117 := $add.ref($p3,$mul.ref($i116,2));
  $p117.shadow := $add.ref($p3.shadow,$mul.ref($i116.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 155, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p117 == $p117.shadow));
  $i118 := $load.i16($M.4,$p117);
  $i118.shadow := $load.i16($M.4.shadow,$p117.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 155, 7} true;
  assume {:verifier.code 0} true;
  $i119 := $zext.i16.i32($i118);
  $i119.shadow := $zext.i16.i32($i118.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 155, 7} true;
  assume {:verifier.code 0} true;
  $i120 := $mul.i32($i36,$i119);
  $i120.shadow := $mul.i32($i36.shadow,$i119.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 155, 5} true;
  assume {:verifier.code 0} true;
  $i121 := $add.i32($i115,$i120);
  $i121.shadow := $add.i32($i115.shadow,$i120.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 155, 26} true;
  assume {:verifier.code 0} true;
  $i122 := $add.i32($i121,$i101);
  $i122.shadow := $add.i32($i121.shadow,$i101.shadow);
  call {:cexpr "z"} boogie_si_record_i32($i122);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 156, 10} true;
  assume {:verifier.code 0} true;
  $i123 := $lshr.i32($i122,15);
  $i123.shadow := $lshr.i32($i122.shadow,15);
  call {:cexpr "r"} boogie_si_record_i32($i123);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 157, 17} true;
  assume {:verifier.code 0} true;
  $i124 := $and.i32($i122,32767);
  $i124.shadow := $and.i32($i122.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 157, 15} true;
  assume {:verifier.code 0} true;
  $i125 := $trunc.i32.i16($i124);
  $i125.shadow := $trunc.i32.i16($i124.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 157, 8} true;
  assume {:verifier.code 0} true;
  $i126 := $add.i64($i37,3);
  $i126.shadow := $add.i64($i37.shadow,3);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 157, 4} true;
  assume {:verifier.code 0} true;
  $p127 := $add.ref($p0,$mul.ref($i126,2));
  $p127.shadow := $add.ref($p0.shadow,$mul.ref($i126.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 157, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p127 == $p127.shadow));
  $M.4 := $store.i16($M.4,$p127,$i125);
  $M.4.shadow := $store.i16($M.4.shadow,$p127.shadow,$i125.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 158, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !($i39 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 160, 3} true;
  assume {:verifier.code 0} true;
  $i129 := $i37;
  $i129.shadow := $i37.shadow;
  $i130 := $i38;
  $i130.shadow := $i38.shadow;
  goto $bb8;
$bb7:
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 139, 27} true;
  assume {:verifier.code 0} true;
  $i128 := $add.i64($i37,4);
  $i128.shadow := $add.i64($i37.shadow,4);
  call {:cexpr "v"} boogie_si_record_i64($i128);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 139, 3} true;
  assume {:verifier.code 0} true;
  $i37 := $i128;
  $i37.shadow := $i128.shadow;
  $i38 := $i123;
  $i38.shadow := $i123.shadow;
  goto $bb4;
$bb8:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i129 == $i129.shadow);
  assert {:shadow_invariant} ($i11 == $i11.shadow);
  assert {:shadow_invariant} ($i10 == $i10.shadow);
  assert {:shadow_invariant} ($i14 == $i14.shadow);
  assert {:unlikely_shadow_invariant ($i20 == $i20.shadow)} true;
  assert {:unlikely_shadow_invariant ($i36 == $i36.shadow)} true;
  assert {:unlikely_shadow_invariant ($i130 == $i130.shadow)} true;
  assert {:unlikely_shadow_invariant ($i15 == $i15.shadow)} true;
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 160, 12} true;
  assume {:verifier.code 0} true;
  $i131 := $ult.i64($i129,$i10);
  $i131.shadow := $ult.i64($i129.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 160, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i131} true;
  $shadow_ok := ($shadow_ok && ($i131 == $i131.shadow));
  goto $bb9, $bb10;
$bb9:
  assume ($i131 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 12} true;
  assume {:verifier.code 0} true;
  $i132 := $add.i64($i129,1);
  $i132.shadow := $add.i64($i129.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 8} true;
  assume {:verifier.code 0} true;
  $p133 := $add.ref($p0,$mul.ref($i132,2));
  $p133.shadow := $add.ref($p0.shadow,$mul.ref($i132.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p133 == $p133.shadow));
  $i134 := $load.i16($M.4,$p133);
  $i134.shadow := $load.i16($M.4.shadow,$p133.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 8} true;
  assume {:verifier.code 0} true;
  $i135 := $zext.i16.i32($i134);
  $i135.shadow := $zext.i16.i32($i134.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 19} true;
  assume {:verifier.code 0} true;
  $i136 := $add.i64($i129,1);
  $i136.shadow := $add.i64($i129.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 19} true;
  assume {:verifier.code 0} true;
  $p137 := $add.ref($p2,$mul.ref($i136,2));
  $p137.shadow := $add.ref($p2.shadow,$mul.ref($i136.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p137 == $p137.shadow));
  $i138 := $load.i16($M.4,$p137);
  $i138.shadow := $load.i16($M.4.shadow,$p137.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 19} true;
  assume {:verifier.code 0} true;
  $i139 := $zext.i16.i32($i138);
  $i139.shadow := $zext.i16.i32($i138.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 19} true;
  assume {:verifier.code 0} true;
  $i140 := $mul.i32($i20,$i139);
  $i140.shadow := $mul.i32($i20.shadow,$i139.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 17} true;
  assume {:verifier.code 0} true;
  $i141 := $add.i32($i135,$i140);
  $i141.shadow := $add.i32($i135.shadow,$i140.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 164, 7} true;
  assume {:verifier.code 0} true;
  $i142 := $add.i64($i129,1);
  $i142.shadow := $add.i64($i129.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 164, 7} true;
  assume {:verifier.code 0} true;
  $p143 := $add.ref($p3,$mul.ref($i142,2));
  $p143.shadow := $add.ref($p3.shadow,$mul.ref($i142.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 164, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p143 == $p143.shadow));
  $i144 := $load.i16($M.4,$p143);
  $i144.shadow := $load.i16($M.4.shadow,$p143.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 164, 7} true;
  assume {:verifier.code 0} true;
  $i145 := $zext.i16.i32($i144);
  $i145.shadow := $zext.i16.i32($i144.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 164, 7} true;
  assume {:verifier.code 0} true;
  $i146 := $mul.i32($i36,$i145);
  $i146.shadow := $mul.i32($i36.shadow,$i145.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 164, 5} true;
  assume {:verifier.code 0} true;
  $i147 := $add.i32($i141,$i146);
  $i147.shadow := $add.i32($i141.shadow,$i146.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 164, 26} true;
  assume {:verifier.code 0} true;
  $i148 := $add.i32($i147,$i130);
  $i148.shadow := $add.i32($i147.shadow,$i130.shadow);
  call {:cexpr "z"} boogie_si_record_i32($i148);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 165, 10} true;
  assume {:verifier.code 0} true;
  $i149 := $lshr.i32($i148,15);
  $i149.shadow := $lshr.i32($i148.shadow,15);
  call {:cexpr "r"} boogie_si_record_i32($i149);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 166, 17} true;
  assume {:verifier.code 0} true;
  $i150 := $and.i32($i148,32767);
  $i150.shadow := $and.i32($i148.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 166, 15} true;
  assume {:verifier.code 0} true;
  $i151 := $trunc.i32.i16($i150);
  $i151.shadow := $trunc.i32.i16($i150.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 166, 8} true;
  assume {:verifier.code 0} true;
  $i152 := $add.i64($i129,0);
  $i152.shadow := $add.i64($i129.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 166, 4} true;
  assume {:verifier.code 0} true;
  $p153 := $add.ref($p0,$mul.ref($i152,2));
  $p153.shadow := $add.ref($p0.shadow,$mul.ref($i152.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 166, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p153 == $p153.shadow));
  $M.4 := $store.i16($M.4,$p153,$i151);
  $M.4.shadow := $store.i16($M.4.shadow,$p153.shadow,$i151.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 167, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb10:
  assume !($i131 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 169, 11} true;
  assume {:verifier.code 0} true;
  $i155 := $add.i32($i15,$i130);
  $i155.shadow := $add.i32($i15.shadow,$i130.shadow);
  call {:cexpr "zh"} boogie_si_record_i32($i155);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 170, 15} true;
  assume {:verifier.code 0} true;
  $i156 := $and.i32($i155,32767);
  $i156.shadow := $and.i32($i155.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 170, 12} true;
  assume {:verifier.code 0} true;
  $i157 := $trunc.i32.i16($i156);
  $i157.shadow := $trunc.i32.i16($i156.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 170, 3} true;
  assume {:verifier.code 0} true;
  $p158 := $add.ref($p0,$mul.ref($i10,2));
  $p158.shadow := $add.ref($p0.shadow,$mul.ref($i10.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 170, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p158 == $p158.shadow));
  $M.4 := $store.i16($M.4,$p158,$i157);
  $M.4.shadow := $store.i16($M.4.shadow,$p158.shadow,$i157.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 171, 11} true;
  assume {:verifier.code 0} true;
  $i159 := $lshr.i32($i155,15);
  $i159.shadow := $lshr.i32($i155.shadow,15);
  call {:cexpr "dh"} boogie_si_record_i32($i159);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 172, 2} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 160, 21} true;
  assume {:verifier.code 0} true;
  $i154 := $add.i64($i129,1);
  $i154.shadow := $add.i64($i129.shadow,1);
  call {:cexpr "v"} boogie_si_record_i64($i154);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 160, 3} true;
  assume {:verifier.code 0} true;
  $i129 := $i154;
  $i129.shadow := $i154.shadow;
  $i130 := $i149;
  $i130.shadow := $i149.shadow;
  goto $bb8;
$bb12:
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 39, 25} true;
  assume {:verifier.code 0} true;
  $i160 := $add.i64($i14,1);
  $i160.shadow := $add.i64($i14.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i160);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 39, 2} true;
  assume {:verifier.code 0} true;
  $i14 := $i160;
  $i14.shadow := $i160.shadow;
  $i15 := $i159;
  $i15.shadow := $i159.shadow;
  goto $bb1;
}
const llvm.memset.p0i8.i64: ref;
axiom (llvm.memset.p0i8.i64 == $sub.ref(0,22884));
procedure {:inline 1} llvm.memset.p0i8.i64($p0: ref, $p0.shadow: ref, $i1: i8, $i1.shadow: i8, $i2: i64, $i2.shadow: i64, $i3: i1, $i3.shadow: i1);
const cswap: ref;
axiom (cswap == $sub.ref(0,23916));
procedure {:inline 1} cswap($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32)
modifies $M.4, $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
  ...
  var $i24.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 120, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "cswap:arg:ctl"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 120, 8} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0,$i2);
  $i3.shadow := $sub.i32(0,$i2.shadow);
  call {:cexpr "ctl"} boogie_si_record_i32($i3);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 121, 7} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  $i4.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 121, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i4,18);
  $i5.shadow := $slt.i32($i4.shadow,18);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 121, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 124, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i4);
  $i6.shadow := $sext.i32.i64($i4.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 124, 8} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p0,$mul.ref($i6,2));
  $p7.shadow := $add.ref($p0.shadow,$mul.ref($i6.shadow,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 124, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p7 == $p7.shadow));
  $i8 := $load.i16($M.4,$p7);
  $i8.shadow := $load.i16($M.4.shadow,$p7.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 124, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i16.i32($i8);
  $i9.shadow := $zext.i16.i32($i8.shadow);
  call {:cexpr "aw"} boogie_si_record_i32($i9);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 125, 8} true;
  assume {:verifier.code 0} true;
  $i10 := $sext.i32.i64($i4);
  $i10.shadow := $sext.i32.i64($i4.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 125, 8} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p1,$mul.ref($i10,2));
  $p11.shadow := $add.ref($p1.shadow,$mul.ref($i10.shadow,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 125, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p11 == $p11.shadow));
  $i12 := $load.i16($M.4,$p11);
  $i12.shadow := $load.i16($M.4.shadow,$p11.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 125, 8} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i16.i32($i12);
  $i13.shadow := $zext.i16.i32($i12.shadow);
  call {:cexpr "bw"} boogie_si_record_i32($i13);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 126, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $xor.i32($i9,$i13);
  $i14.shadow := $xor.i32($i9.shadow,$i13.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 126, 12} true;
  assume {:verifier.code 0} true;
  $i15 := $and.i32($i3,$i14);
  $i15.shadow := $and.i32($i3.shadow,$i14.shadow);
  call {:cexpr "tw"} boogie_si_record_i32($i15);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 127, 13} true;
  assume {:verifier.code 0} true;
  $i16 := $xor.i32($i9,$i15);
  $i16.shadow := $xor.i32($i9.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 127, 10} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i32.i16($i16);
  $i17.shadow := $trunc.i32.i16($i16.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 127, 3} true;
  assume {:verifier.code 0} true;
  $i18 := $sext.i32.i64($i4);
  $i18.shadow := $sext.i32.i64($i4.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 127, 3} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($p0,$mul.ref($i18,2));
  $p19.shadow := $add.ref($p0.shadow,$mul.ref($i18.shadow,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 127, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p19 == $p19.shadow));
  $M.4 := $store.i16($M.4,$p19,$i17);
  $M.4.shadow := $store.i16($M.4.shadow,$p19.shadow,$i17.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 128, 13} true;
  assume {:verifier.code 0} true;
  $i20 := $xor.i32($i13,$i15);
  $i20.shadow := $xor.i32($i13.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 128, 10} true;
  assume {:verifier.code 0} true;
  $i21 := $trunc.i32.i16($i20);
  $i21.shadow := $trunc.i32.i16($i20.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 128, 3} true;
  assume {:verifier.code 0} true;
  $i22 := $sext.i32.i64($i4);
  $i22.shadow := $sext.i32.i64($i4.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 128, 3} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p1,$mul.ref($i22,2));
  $p23.shadow := $add.ref($p1.shadow,$mul.ref($i22.shadow,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 128, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p23 == $p23.shadow));
  $M.4 := $store.i16($M.4,$p23,$i21);
  $M.4.shadow := $store.i16($M.4.shadow,$p23.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 129, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i5 == 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 130, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 121, 24} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i4,1);
  $i24.shadow := $add.i32($i4.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i24);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 121, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $i24;
  $i4.shadow := $i24.shadow;
  goto $bb1;
}
const c255_add: ref;
axiom (c255_add == $sub.ref(0,24948));
procedure {:inline 1} c255_add($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.4, $exn;
modifies $CurrAddr;
{
  var $p3: ref;
  ...
  var $p17.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 138, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 138, 2} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p3,$mul.ref(0,36)),$mul.ref(0,2));
  $p4.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 138, 2} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p4);
  $p5.shadow := $bitcast.ref.ref($p4.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 138, 2} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p1);
  $p6.shadow := $bitcast.ref.ref($p1.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 138, 2} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p5 == $p5.shadow));
  $shadow_ok := ($shadow_ok && ($p6 == $p6.shadow));
  call $M.4, $M.4.shadow := $memcpy.i8($M.4, $M.4.shadow, $M.4, $M.4.shadow, $p5, $p5.shadow, $p6, $p6.shadow, 36, 36, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 139, 19} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p3,$mul.ref(0,36)),$mul.ref(0,2));
  $p7.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 139, 8} true;
  assume {:verifier.code 0} true;
  call $i8, $i8.shadow := br_i15_add($p7, $p7.shadow, $p2, $p2.shadow, 1, 1);
  call {:cexpr "ctl"} boogie_si_record_i32($i8);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 140, 24} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p3,$mul.ref(0,36)),$mul.ref(0,2));
  $p9.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 140, 13} true;
  assume {:verifier.code 0} true;
  call $i10, $i10.shadow := br_i15_sub($p9, $p9.shadow, C255_P, C255_P, 0, 0);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 140, 9} true;
  assume {:verifier.code 0} true;
  call $i11, $i11.shadow := NOT($i10, $i10.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 140, 6} true;
  assume {:verifier.code 0} true;
  $i12 := $or.i32($i8,$i11);
  $i12.shadow := $or.i32($i8.shadow,$i11.shadow);
  call {:cexpr "ctl"} boogie_si_record_i32($i12);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 141, 13} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p3,$mul.ref(0,36)),$mul.ref(0,2));
  $p13.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 141, 2} true;
  assume {:verifier.code 0} true;
  call $i14, $i14.shadow := br_i15_sub($p13, $p13.shadow, C255_P, C255_P, $i12, $i12.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 142, 2} true;
  assume {:verifier.code 0} true;
  $p15 := $bitcast.ref.ref($p0);
  $p15.shadow := $bitcast.ref.ref($p0.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 142, 2} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p3,$mul.ref(0,36)),$mul.ref(0,2));
  $p16.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 142, 2} true;
  assume {:verifier.code 0} true;
  ...
  call $M.4, $M.4.shadow := $memcpy.i8($M.4, $M.4.shadow, $M.4, $M.4.shadow, $p15, $p15.shadow, $p17, $p17.shadow, 36, 36, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 143, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const c255_mul: ref;
axiom (c255_mul == $sub.ref(0,25980));
procedure {:inline 1} c255_mul($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.4, $exn;
modifies $CurrAddr;
{
  var $p3: ref;
  ...
  var $p7.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 160, 18} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(36,$zext.i32.i64(1)));
  $p3.shadow := $p3;
  ...
  $p4 := $add.ref($add.ref($p3,$mul.ref(0,36)),$mul.ref(0,2));
  $p4.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 160, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_montymul($p4, $p4.shadow, $p1, $p1.shadow, $p2, $p2.shadow, C255_P, C255_P, 18971, 18971);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 161, 2} true;
  assume {:verifier.code 0} true;
  $p5 := $bitcast.ref.ref($p0);
  $p5.shadow := $bitcast.ref.ref($p0.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 161, 2} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p3,$mul.ref(0,36)),$mul.ref(0,2));
  $p6.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 161, 2} true;
  assume {:verifier.code 0} true;
  ...
  $shadow_ok := ($shadow_ok && ($p5 == $p5.shadow));
  $shadow_ok := ($shadow_ok && ($p7 == $p7.shadow));
  call $M.4, $M.4.shadow := $memcpy.i8($M.4, $M.4.shadow, $M.4, $M.4.shadow, $p5, $p5.shadow, $p7, $p7.shadow, 36, 36, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 162, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const c255_sub: ref;
axiom (c255_sub == $sub.ref(0,27012));
procedure {:inline 1} c255_sub($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.4, $exn;
modifies $CurrAddr;
{
  var $p3: ref;
  ...
  var $p13.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 150, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(36,$zext.i32.i64(1)));
  $p3.shadow := $p3;
  ...
  $shadow_ok := ($shadow_ok && ($p6 == $p6.shadow));
  call $M.4, $M.4.shadow := $memcpy.i8($M.4, $M.4.shadow, $M.4, $M.4.shadow, $p5, $p5.shadow, $p6, $p6.shadow, 36, 36, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 151, 13} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p3,$mul.ref(0,36)),$mul.ref(0,2));
  $p7.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 151, 35} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p3,$mul.ref(0,36)),$mul.ref(0,2));
  $p8.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 151, 24} true;
  assume {:verifier.code 0} true;
  call $i9, $i9.shadow := br_i15_sub($p8, $p8.shadow, $p2, $p2.shadow, 1, 1);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 151, 2} true;
  assume {:verifier.code 0} true;
  call $i10, $i10.shadow := br_i15_add($p7, $p7.shadow, C255_P, C255_P, $i9, $i9.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 152, 2} true;
  assume {:verifier.code 0} true;
  $p11 := $bitcast.ref.ref($p0);
  $p11.shadow := $bitcast.ref.ref($p0.shadow);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 152, 2} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p3,$mul.ref(0,36)),$mul.ref(0,2));
  $p12.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,36)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 152, 2} true;
  assume {:verifier.code 0} true;
  ...
  call $M.4, $M.4.shadow := $memcpy.i8($M.4, $M.4.shadow, $M.4, $M.4.shadow, $p11, $p11.shadow, $p13, $p13.shadow, 36, 36, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 153, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const br_i15_encode: ref;
axiom (br_i15_encode == $sub.ref(0,28044));
procedure {:inline 1} br_i15_encode($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64, $p2: ref, $p2.shadow: ref)
modifies $M.3, $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $i33.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 36, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_encode:arg:len"} boogie_si_record_i64($i1);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 36, 10} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p2,$mul.ref(0,2));
  $p3.shadow := $add.ref($p2.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 36, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p3 == $p3.shadow));
  $i4 := $load.i16($M.4,$p3);
  ...
  $i5 := $zext.i16.i32($i4);
  $i5.shadow := $zext.i16.i32($i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 36, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i5,15);
  $i6.shadow := $add.i32($i5.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 36, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $ashr.i32($i6,4);
  $i7.shadow := $ashr.i32($i6.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 36, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i7);
  $i8.shadow := $sext.i32.i64($i7.shadow);
  call {:cexpr "xlen"} boogie_si_record_i64($i8);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 37, 11} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i64($i8,0);
  $i9.shadow := $eq.i64($i8.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 37, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i9 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 38, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p0 == $p0.shadow));
  $shadow_ok := ($shadow_ok && ($i1 == $i1.shadow));
  call $M.3, $M.3.shadow := $memset.i8($M.3, $M.3.shadow, $p0, $p0.shadow, 0, 0, $i1, $i1.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 39, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !($i9 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 45, 2} true;
  assume {:verifier.code 0} true;
  $i10 := 1;
  $i10.shadow := 1;
  $i11 := 0;
  $i11.shadow := 0;
  $i12 := $i1;
  $i12.shadow := $i1.shadow;
  $i13 := 0;
  $i13.shadow := 0;
  goto $bb4;
$bb3:
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 56, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  ...
  assert {:shadow_invariant} ($i8 == $i8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 45, 13} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i64($i12,$sub.i64(0,1));
  $i14.shadow := $add.i64($i12.shadow,$sub.i64(0,1));
  call {:cexpr "len"} boogie_si_record_i64($i14);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 45, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $ugt.i64($i12,0);
  $i15.shadow := $ugt.i64($i12.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 45, 2} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i15 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 46, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $slt.i32($i13,8);
  $i16.shadow := $slt.i32($i13.shadow,8);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 46, 7} true;
  assume {:verifier.code 0} true;
  $i17 := $i10;
  $i17.shadow := $i10.shadow;
  $i18 := $i11;
  $i18.shadow := $i11.shadow;
  $i19 := $i13;
  $i19.shadow := $i13.shadow;
  assume {:branchcond $i16} true;
  $shadow_ok := ($shadow_ok && ($i16 == $i16.shadow));
  goto $bb7, $bb8;
$bb6:
...
$bb7:
  assume ($i16 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 47, 10} true;
  assume {:verifier.code 0} true;
  $i20 := $ule.i64($i10,$i8);
  $i20.shadow := $ule.i64($i10.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $i21 := $i10;
  $i21.shadow := $i10.shadow;
  $i22 := $i11;
  $i22.shadow := $i11.shadow;
  assume {:branchcond $i20} true;
  $shadow_ok := ($shadow_ok && ($i20 == $i20.shadow));
  goto $bb10, $bb11;
$bb8:
...
$bb9:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 52, 14} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i32.i8($i18);
  $i30.shadow := $trunc.i32.i8($i18.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 52, 3} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($p0,$mul.ref($i14,1));
  $p31.shadow := $add.ref($p0.shadow,$mul.ref($i14.shadow,1));
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 52, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p31 == $p31.shadow));
  $M.3 := $store.i8($M.3,$p31,$i30);
  $M.3.shadow := $store.i8($M.3.shadow,$p31.shadow,$i30.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 53, 7} true;
  assume {:verifier.code 0} true;
  $i32 := $lshr.i32($i18,8);
  $i32.shadow := $lshr.i32($i18.shadow,8);
  call {:cexpr "acc"} boogie_si_record_i32($i32);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 54, 11} true;
  assume {:verifier.code 0} true;
  $i33 := $sub.i32($i19,8);
  $i33.shadow := $sub.i32($i19.shadow,8);
  call {:cexpr "acc_len"} boogie_si_record_i32($i33);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 45, 2} true;
  assume {:verifier.code 0} true;
  $i10 := $i17;
  $i10.shadow := $i17.shadow;
  $i11 := $i32;
  $i11.shadow := $i32.shadow;
  $i12 := $i14;
  $i12.shadow := $i14.shadow;
  $i13 := $i33;
  $i13.shadow := $i33.shadow;
  goto $bb4;
$bb10:
  assume ($i20 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 48, 26} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i64($i10,1);
  $i23.shadow := $add.i64($i10.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i23);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 48, 22} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p2,$mul.ref($i10,2));
  $p24.shadow := $add.ref($p2.shadow,$mul.ref($i10.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 48, 22} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p24 == $p24.shadow));
  $i25 := $load.i16($M.4,$p24);
  $i25.shadow := $load.i16($M.4.shadow,$p24.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 48, 12} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i16.i32($i25);
  $i26.shadow := $zext.i16.i32($i25.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 48, 30} true;
  assume {:verifier.code 0} true;
  $i27 := $shl.i32($i26,$i13);
  $i27.shadow := $shl.i32($i26.shadow,$i13.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 48, 9} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i32($i11,$i27);
  $i28.shadow := $add.i32($i11.shadow,$i27.shadow);
  call {:cexpr "acc"} boogie_si_record_i32($i28);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 49, 4} true;
  assume {:verifier.code 0} true;
  $i21 := $i23;
  $i21.shadow := $i23.shadow;
  $i22 := $i28;
  $i22.shadow := $i28.shadow;
  goto $bb12;
$bb11:
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 47, 8} true;
  assume {:verifier.code 0} true;
...
$bb12:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 50, 12} true;
  assume {:verifier.code 0} true;
  $i29 := $add.i32($i13,15);
  $i29.shadow := $add.i32($i13.shadow,15);
  call {:cexpr "acc_len"} boogie_si_record_i32($i29);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 51, 3} true;
  assume {:verifier.code 0} true;
  $i17 := $i21;
  $i17.shadow := $i21.shadow;
  $i18 := $i22;
  $i18.shadow := $i22.shadow;
  $i19 := $i29;
  $i19.shadow := $i29.shadow;
  goto $bb9;
}
const br_i15_add: ref;
axiom (br_i15_add == $sub.ref(0,29076));
procedure {:inline 1} br_i15_add($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $M.4, $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $i25.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 35, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_add:arg:ctl"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 35, 7} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p0,$mul.ref(0,2));
  $p3.shadow := $add.ref($p0.shadow,$mul.ref(0,2));
  ...
  $i5 := $zext.i16.i32($i4);
  $i5.shadow := $zext.i16.i32($i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 35, 12} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i5,31);
  $i6.shadow := $add.i32($i5.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 35, 18} true;
  assume {:verifier.code 0} true;
  $i7 := $ashr.i32($i6,4);
  $i7.shadow := $ashr.i32($i6.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 35, 6} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i7);
  $i8.shadow := $sext.i32.i64($i7.shadow);
  call {:cexpr "m"} boogie_si_record_i64($i8);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 36, 7} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  $i9.shadow := 0;
  $i10 := 1;
...
$bb1:
  ...
  assert {:shadow_invariant} ($i10 == $i10.shadow);
  assert {:unlikely_shadow_invariant ($i9 == $i9.shadow)} true;
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 36, 16} true;
  assume {:verifier.code 0} true;
  $i11 := $ult.i64($i10,$i8);
  $i11.shadow := $ult.i64($i10.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 36, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i11} true;
  $shadow_ok := ($shadow_ok && ($i11 == $i11.shadow));
  goto $bb2, $bb3;
$bb2:
  assume ($i11 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 39, 8} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p0,$mul.ref($i10,2));
  $p12.shadow := $add.ref($p0.shadow,$mul.ref($i10.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 39, 8} true;
  ...
  $i14.shadow := $zext.i16.i32($i13.shadow);
  call {:cexpr "aw"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 40, 8} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p1,$mul.ref($i10,2));
  $p15.shadow := $add.ref($p1.shadow,$mul.ref($i10.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 40, 8} true;
  ...
  $i17.shadow := $zext.i16.i32($i16.shadow);
  call {:cexpr "bw"} boogie_si_record_i32($i17);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 41, 12} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i32($i14,$i17);
  $i18.shadow := $add.i32($i14.shadow,$i17.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 41, 17} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i18,$i9);
  $i19.shadow := $add.i32($i18.shadow,$i9.shadow);
  call {:cexpr "naw"} boogie_si_record_i32($i19);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 42, 12} true;
  assume {:verifier.code 0} true;
  $i20 := $lshr.i32($i19,15);
  $i20.shadow := $lshr.i32($i19.shadow,15);
  call {:cexpr "cc"} boogie_si_record_i32($i20);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 43, 23} true;
  assume {:verifier.code 0} true;
  $i21 := $and.i32($i19,32767);
  $i21.shadow := $and.i32($i19.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 43, 10} true;
  assume {:verifier.code 0} true;
  call $i22, $i22.shadow := MUX($i2, $i2.shadow, $i21, $i21.shadow, $i14, $i14.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 43, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i32.i16($i22);
  $i23.shadow := $trunc.i32.i16($i22.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p0,$mul.ref($i10,2));
  $p24.shadow := $add.ref($p0.shadow,$mul.ref($i10.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 43, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p24 == $p24.shadow));
  $M.4 := $store.i16($M.4,$p24,$i23);
  $M.4.shadow := $store.i16($M.4.shadow,$p24.shadow,$i23.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 44, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i11 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 45, 2} true;
  assume {:verifier.code 0} true;
  $r := $i9;
  $r.shadow := $i9.shadow;
  $exn := false;
  ...
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 36, 23} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i64($i10,1);
  $i25.shadow := $add.i64($i10.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i25);
...
const br_i15_zero.13: ref;
axiom (br_i15_zero.13 == $sub.ref(0,31140));
procedure {:inline 1} br_i15_zero.13($p0: ref, $p0.shadow: ref, $i1: i16, $i1.shadow: i16)
modifies $M.4, $exn;
{
  var $p2: ref;
  var $p2.shadow: ref;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 1539, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_zero.13:arg:bit_len"} boogie_si_record_i16($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1539, 5} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p0,$mul.ref(1,2));
  $p2.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
...
const NOT.14: ref;
axiom (NOT.14 == $sub.ref(0,33204));
procedure {:inline 1} NOT.14($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "NOT.14:arg:ctl"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $xor.i32($i0,1);
  $i1.shadow := $xor.i32($i0.shadow,1);
...
const MUX.17: ref;
axiom (MUX.17 == $sub.ref(0,34236));
procedure {:inline 1} MUX.17($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "MUX.17:arg:ctl"} boogie_si_record_i32($i0);
  call {:cexpr "MUX.17:arg:x"} boogie_si_record_i32($i1);
  call {:cexpr "MUX.17:arg:y"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0,$i0);
  $i3.shadow := $sub.i32(0,$i0.shadow);
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i6, $i6.shadow := NOT.8($i5, $i5.shadow);
...
const MUX.7: ref;
axiom (MUX.7 == $sub.ref(0,37332));
procedure {:inline 1} MUX.7($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "MUX.7:arg:ctl"} boogie_si_record_i32($i0);
  call {:cexpr "MUX.7:arg:x"} boogie_si_record_i32($i1);
  call {:cexpr "MUX.7:arg:y"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0,$i0);
  $i3.shadow := $sub.i32(0,$i0.shadow);
...
const NOT.8: ref;
axiom (NOT.8 == $sub.ref(0,38364));
procedure {:inline 1} NOT.8($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "NOT.8:arg:ctl"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $xor.i32($i0,1);
  $i1.shadow := $xor.i32($i0.shadow,1);
...
axiom (api_mul_wrapper == $sub.ref(0,40428));
...
requires {:public_in $load.i8, $M.3, $p0, 1, 64} true;
modifies $exn;
modifies $M.3, $M.4, $M.5;
modifies $CurrAddr, $M.10, $M.11, $M.12, $M.13, $M.9, $M.14, $M.15, $M.7;
requires ($p0 == $p0.shadow);
requires ($i1 == $i1.shadow);
requires ($p2 == $p2.shadow);
requires ($i3 == $i3.shadow);
requires ($i4 == $i4.shadow);
requires ($load.i8($M.3,($p0 + 0)) == $load.i8($M.3.shadow,($p0.shadow + 0)));
requires ($load.i8($M.3,($p0 + 1)) == $load.i8($M.3.shadow,($p0.shadow + 1)));
requires ($load.i8($M.3,($p0 + 2)) == $load.i8($M.3.shadow,($p0.shadow + 2)));
requires ($load.i8($M.3,($p0 + 3)) == $load.i8($M.3.shadow,($p0.shadow + 3)));
requires ($load.i8($M.3,($p0 + 4)) == $load.i8($M.3.shadow,($p0.shadow + 4)));
requires ($load.i8($M.3,($p0 + 5)) == $load.i8($M.3.shadow,($p0.shadow + 5)));
requires ($load.i8($M.3,($p0 + 6)) == $load.i8($M.3.shadow,($p0.shadow + 6)));
requires ($load.i8($M.3,($p0 + 7)) == $load.i8($M.3.shadow,($p0.shadow + 7)));
requires ($load.i8($M.3,($p0 + 8)) == $load.i8($M.3.shadow,($p0.shadow + 8)));
requires ($load.i8($M.3,($p0 + 9)) == $load.i8($M.3.shadow,($p0.shadow + 9)));
requires ($load.i8($M.3,($p0 + 10)) == $load.i8($M.3.shadow,($p0.shadow + 10)));
requires ($load.i8($M.3,($p0 + 11)) == $load.i8($M.3.shadow,($p0.shadow + 11)));
requires ($load.i8($M.3,($p0 + 12)) == $load.i8($M.3.shadow,($p0.shadow + 12)));
requires ($load.i8($M.3,($p0 + 13)) == $load.i8($M.3.shadow,($p0.shadow + 13)));
requires ($load.i8($M.3,($p0 + 14)) == $load.i8($M.3.shadow,($p0.shadow + 14)));
requires ($load.i8($M.3,($p0 + 15)) == $load.i8($M.3.shadow,($p0.shadow + 15)));
requires ($load.i8($M.3,($p0 + 16)) == $load.i8($M.3.shadow,($p0.shadow + 16)));
requires ($load.i8($M.3,($p0 + 17)) == $load.i8($M.3.shadow,($p0.shadow + 17)));
requires ($load.i8($M.3,($p0 + 18)) == $load.i8($M.3.shadow,($p0.shadow + 18)));
requires ($load.i8($M.3,($p0 + 19)) == $load.i8($M.3.shadow,($p0.shadow + 19)));
requires ($load.i8($M.3,($p0 + 20)) == $load.i8($M.3.shadow,($p0.shadow + 20)));
requires ($load.i8($M.3,($p0 + 21)) == $load.i8($M.3.shadow,($p0.shadow + 21)));
requires ($load.i8($M.3,($p0 + 22)) == $load.i8($M.3.shadow,($p0.shadow + 22)));
requires ($load.i8($M.3,($p0 + 23)) == $load.i8($M.3.shadow,($p0.shadow + 23)));
requires ($load.i8($M.3,($p0 + 24)) == $load.i8($M.3.shadow,($p0.shadow + 24)));
requires ($load.i8($M.3,($p0 + 25)) == $load.i8($M.3.shadow,($p0.shadow + 25)));
requires ($load.i8($M.3,($p0 + 26)) == $load.i8($M.3.shadow,($p0.shadow + 26)));
requires ($load.i8($M.3,($p0 + 27)) == $load.i8($M.3.shadow,($p0.shadow + 27)));
requires ($load.i8($M.3,($p0 + 28)) == $load.i8($M.3.shadow,($p0.shadow + 28)));
requires ($load.i8($M.3,($p0 + 29)) == $load.i8($M.3.shadow,($p0.shadow + 29)));
requires ($load.i8($M.3,($p0 + 30)) == $load.i8($M.3.shadow,($p0.shadow + 30)));
requires ($load.i8($M.3,($p0 + 31)) == $load.i8($M.3.shadow,($p0.shadow + 31)));
requires ($load.i8($M.3,($p0 + 32)) == $load.i8($M.3.shadow,($p0.shadow + 32)));
requires ($load.i8($M.3,($p0 + 33)) == $load.i8($M.3.shadow,($p0.shadow + 33)));
requires ($load.i8($M.3,($p0 + 34)) == $load.i8($M.3.shadow,($p0.shadow + 34)));
requires ($load.i8($M.3,($p0 + 35)) == $load.i8($M.3.shadow,($p0.shadow + 35)));
requires ($load.i8($M.3,($p0 + 36)) == $load.i8($M.3.shadow,($p0.shadow + 36)));
requires ($load.i8($M.3,($p0 + 37)) == $load.i8($M.3.shadow,($p0.shadow + 37)));
requires ($load.i8($M.3,($p0 + 38)) == $load.i8($M.3.shadow,($p0.shadow + 38)));
requires ($load.i8($M.3,($p0 + 39)) == $load.i8($M.3.shadow,($p0.shadow + 39)));
requires ($load.i8($M.3,($p0 + 40)) == $load.i8($M.3.shadow,($p0.shadow + 40)));
requires ($load.i8($M.3,($p0 + 41)) == $load.i8($M.3.shadow,($p0.shadow + 41)));
requires ($load.i8($M.3,($p0 + 42)) == $load.i8($M.3.shadow,($p0.shadow + 42)));
requires ($load.i8($M.3,($p0 + 43)) == $load.i8($M.3.shadow,($p0.shadow + 43)));
requires ($load.i8($M.3,($p0 + 44)) == $load.i8($M.3.shadow,($p0.shadow + 44)));
requires ($load.i8($M.3,($p0 + 45)) == $load.i8($M.3.shadow,($p0.shadow + 45)));
requires ($load.i8($M.3,($p0 + 46)) == $load.i8($M.3.shadow,($p0.shadow + 46)));
requires ($load.i8($M.3,($p0 + 47)) == $load.i8($M.3.shadow,($p0.shadow + 47)));
requires ($load.i8($M.3,($p0 + 48)) == $load.i8($M.3.shadow,($p0.shadow + 48)));
requires ($load.i8($M.3,($p0 + 49)) == $load.i8($M.3.shadow,($p0.shadow + 49)));
requires ($load.i8($M.3,($p0 + 50)) == $load.i8($M.3.shadow,($p0.shadow + 50)));
requires ($load.i8($M.3,($p0 + 51)) == $load.i8($M.3.shadow,($p0.shadow + 51)));
requires ($load.i8($M.3,($p0 + 52)) == $load.i8($M.3.shadow,($p0.shadow + 52)));
requires ($load.i8($M.3,($p0 + 53)) == $load.i8($M.3.shadow,($p0.shadow + 53)));
requires ($load.i8($M.3,($p0 + 54)) == $load.i8($M.3.shadow,($p0.shadow + 54)));
requires ($load.i8($M.3,($p0 + 55)) == $load.i8($M.3.shadow,($p0.shadow + 55)));
requires ($load.i8($M.3,($p0 + 56)) == $load.i8($M.3.shadow,($p0.shadow + 56)));
requires ($load.i8($M.3,($p0 + 57)) == $load.i8($M.3.shadow,($p0.shadow + 57)));
requires ($load.i8($M.3,($p0 + 58)) == $load.i8($M.3.shadow,($p0.shadow + 58)));
requires ($load.i8($M.3,($p0 + 59)) == $load.i8($M.3.shadow,($p0.shadow + 59)));
requires ($load.i8($M.3,($p0 + 60)) == $load.i8($M.3.shadow,($p0.shadow + 60)));
requires ($load.i8($M.3,($p0 + 61)) == $load.i8($M.3.shadow,($p0.shadow + 61)));
requires ($load.i8($M.3,($p0 + 62)) == $load.i8($M.3.shadow,($p0.shadow + 62)));
requires ($load.i8($M.3,($p0 + 63)) == $load.i8($M.3.shadow,($p0.shadow + 63)));
{
  var $p5: ref;
  var $p5.shadow: ref;
  var $p6: ref;
...
$bb0:
  ...
  call {:name $p0} {:array "$load.i8", $M.3, $p0, 1, 64} $p10 := __SMACK_values($p0, 64);
  $p10.shadow := $p10;
  ...
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref(br_ec_c25519_i15,$mul.ref(0,56)),$mul.ref(32,1));
  $p11.shadow := $add.ref($add.ref(br_ec_c25519_i15,$mul.ref(0,56)),$mul.ref(32,1));
  assume {:sourceloc "api_mul.c", 18, 7} true;
  assume {:verifier.code 0} true;
  $p12 := $M.9;
  $p12.shadow := $M.9.shadow;
  call $i13, $i13.shadow := devirtbounce($p12, $p12.shadow, $p0, $p0.shadow, $i1, $i1.shadow, $p2, $p2.shadow, $i3, $i3.shadow, 29, 29);
...
axiom (__SMACK_value == $sub.ref(0,41460));
...
axiom (__SMACK_dummy == $sub.ref(0,46620));
...
axiom (__SMACK_and32 == $sub.ref(0,47652));
...
axiom (__SMACK_and64 == $sub.ref(0,48684));
...
axiom (__SMACK_and16 == $sub.ref(0,49716));
...
axiom (__SMACK_and8 == $sub.ref(0,50748));
...
axiom (__SMACK_or32 == $sub.ref(0,51780));
...
axiom (__SMACK_or64 == $sub.ref(0,52812));
...
axiom (__SMACK_or16 == $sub.ref(0,53844));
...
axiom (__SMACK_or8 == $sub.ref(0,54876));
...
axiom (__SMACK_check_overflow == $sub.ref(0,55908));
...
axiom (__SMACK_loop_exit == $sub.ref(0,56940));
...
axiom (__SMACK_decls == $sub.ref(0,57972));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,59004));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,60036));
...
axiom (__SMACK_static_init == $sub.ref(0,61068));
procedure {:inline 1} __SMACK_static_init()
modifies $M.10, $M.11, $M.12, $M.13, $M.9, $M.14, $M.15, $M.4, $M.7, $exn;
{
$bb0:
  $M.10 := 536870912;
  $M.10.shadow := 536870912;
  $M.11 := api_generator;
  $M.11.shadow := api_generator;
  $M.12 := api_order;
  $M.12.shadow := api_order;
  $M.13 := api_xoff;
  $M.13.shadow := api_xoff;
  $M.9 := api_mul;
  $M.9.shadow := api_mul;
  $M.14 := api_mulgen;
  $M.14.shadow := api_mulgen;
  $M.15 := api_muladd;
  $M.15.shadow := api_muladd;
  $shadow_ok := ($shadow_ok && (C255_P == C255_P));
  $M.4 := $store.i16($M.4,C255_P,272);
  $M.4.shadow := $store.i16($M.4.shadow,C255_P,272);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(1,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(1,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(1,2)),32749);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(1,2)),32749);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(2,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(2,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(2,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(2,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(3,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(3,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(3,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(3,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(4,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(4,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(4,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(4,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(5,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(5,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(5,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(5,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(6,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(6,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(6,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(6,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(7,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(7,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(7,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(7,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(8,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(8,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(8,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(8,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(9,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(9,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(9,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(9,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(10,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(10,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(10,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(10,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(11,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(11,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(11,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(11,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(12,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(12,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(12,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(12,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(13,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(13,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(13,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(13,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(14,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(14,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(14,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(14,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(15,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(15,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(15,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(15,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(16,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(16,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(16,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(16,2)),32767);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(17,2)) == $add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(17,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(17,2)),32767);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(17,2)),32767);
  $shadow_ok := ($shadow_ok && (C255_R2 == C255_R2));
  $M.4 := $store.i16($M.4,C255_R2,272);
  $M.4.shadow := $store.i16($M.4.shadow,C255_R2,272);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(2,1)) == $add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(2,1))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(2,1)),361);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(2,1)),361);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(0,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(0,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(0,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(0,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(1,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(1,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(1,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(1,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(2,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(2,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(2,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(2,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(3,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(3,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(3,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(3,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(4,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(4,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(4,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(4,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(5,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(5,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(5,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(5,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(6,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(6,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(6,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(6,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(7,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(7,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(7,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(7,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(8,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(8,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(8,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(8,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(9,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(9,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(9,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(9,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(10,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(10,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(10,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(10,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(11,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(11,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(11,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(11,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(12,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(12,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(12,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(12,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(13,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(13,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(13,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(13,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(14,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(14,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(14,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(14,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(15,2)) == $add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(15,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(15,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(15,2)),0);
  $shadow_ok := ($shadow_ok && (C255_A24 == C255_A24));
  $M.4 := $store.i16($M.4,C255_A24,272);
  $M.4.shadow := $store.i16($M.4.shadow,C255_A24,272);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(2,1)) == $add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(2,1))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(2,1)),17875);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(2,1)),17875);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(4,1)) == $add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(4,1))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(4,1)),70);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(4,1)),70);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(0,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(0,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(0,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(0,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(1,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(1,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(1,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(1,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(2,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(2,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(2,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(2,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(3,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(3,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(3,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(3,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(4,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(4,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(4,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(4,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(5,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(5,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(5,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(5,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(6,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(6,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(6,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(6,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(7,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(7,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(7,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(7,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(8,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(8,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(8,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(8,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(9,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(9,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(9,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(9,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(10,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(10,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(10,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(10,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(11,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(11,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(11,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(11,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(12,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(12,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(12,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(12,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(13,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(13,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(13,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(13,2)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(14,2)) == $add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(14,2))));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(14,2)),0);
  $M.4.shadow := $store.i16($M.4.shadow,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(14,2)),0);
  $shadow_ok := ($shadow_ok && (GEN == GEN));
  $M.7 := $store.i8($M.7,GEN,9);
  $M.7.shadow := $store.i8($M.7.shadow,GEN,9);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(0,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(0,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(0,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(0,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(1,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(1,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(1,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(1,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(2,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(2,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(2,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(2,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(3,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(3,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(3,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(3,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(4,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(4,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(4,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(4,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(5,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(5,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(5,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(5,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(6,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(6,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(6,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(6,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(7,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(7,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(7,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(7,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(8,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(8,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(8,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(8,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(9,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(9,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(9,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(9,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(10,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(10,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(10,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(10,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(11,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(11,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(11,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(11,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(12,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(12,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(12,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(12,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(13,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(13,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(13,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(13,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(14,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(14,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(14,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(14,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(15,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(15,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(15,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(15,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(16,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(16,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(16,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(16,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(17,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(17,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(17,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(17,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(18,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(18,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(18,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(18,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(19,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(19,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(19,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(19,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(20,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(20,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(20,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(20,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(21,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(21,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(21,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(21,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(22,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(22,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(22,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(22,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(23,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(23,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(23,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(23,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(24,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(24,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(24,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(24,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(25,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(25,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(25,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(25,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(26,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(26,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(26,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(26,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(27,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(27,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(27,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(27,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(28,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(28,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(28,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(28,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(29,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(29,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(29,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(29,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(30,1)) == $add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(30,1))));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(30,1)),0);
  $M.7.shadow := $store.i8($M.7.shadow,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(30,1)),0);
  $exn := false;
  $exn.shadow := false;
  return;
}
const devirtbounce: ref;
axiom (devirtbounce == $sub.ref(0,62100));
...
modifies $CurrAddr, $exn;
modifies $M.10, $M.11, $M.12, $M.13, $M.9, $M.14, $M.15, $M.4, $M.7;
{
