...
$bb5:
  ...
  $p23.dup := $or.i1($p0.dup,$or.i1(0,0));
  ...
  assume {:verifier.code 0} true;
  call $i36, $i36.dup := br_i15_sub($p35, $p35.dup, C255_P, cons.dup, 0, 0);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 229, 24} true;
  assume {:verifier.code 0} true;
  call $i37, $i37.dup := NOT($i36, $i36.dup);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 229, 2} true;
  assume {:verifier.code 0} true;
  call $i38, $i38.dup := br_i15_sub($p34, $p34.dup, C255_P, cons.dup, $i37, $i37.dup);
  ...
  assume {:verifier.code 0} true;
  call br_i15_montymul($p39, $p39.dup, $p40, $p40.dup, C255_R2, cons.dup, C255_P, cons.dup, 18971, 0);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 236, 2} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,2));
  $p41.dup := $or.i1($or.i1($p7.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 236, 2} true;
  assume {:verifier.code 0} true;
  ...
  $p49.dup := $or.i1($or.i1($p8.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 238, 2} true;
  assume {:verifier.code 0} true;
  ...
  call $M.4, $M.4.dup := $memcpy.i8($M.4, $M.4.dup, $M.4, $M.4.dup, $p53, $p53.dup, $p55, $p55.dup, 36, 0, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 242, 2} true;
  assume {:verifier.code 0} true;
  $p56 := $add.ref($add.ref($p19,$mul.ref(0,32)),$mul.ref(0,1));
  $p56.dup := $or.i1($or.i1($p19.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 242, 26} true;
  assume {:verifier.code 0} true;
  $i57 := $sub.i64(32,$i3);
  $i57.dup := $or.i1(0,$i3.dup);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 242, 2} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p56.dup == 0));
  $shadow_ok := ($shadow_ok && ($i57.dup == 0));
  call $M.5, $M.5.dup := $memset.i8($M.5, $M.5.dup, $p56, $p56.dup, 0, 0, $i57, $i57.dup, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 243, 9} true;
  assume {:verifier.code 0} true;
  $p58 := $add.ref($add.ref($p19,$mul.ref(0,32)),$mul.ref(0,1));
  $p58.dup := $or.i1($or.i1($p19.dup,$or.i1(0,0)),$or.i1(0,0));
  $p59 := $add.ref($add.ref($p19,$mul.ref(0,32)),$mul.ref(32,1));
  $p59.dup := $or.i1($or.i1($p19.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 243, 24} true;
  assume {:verifier.code 0} true;
  $i60 := $sub.i64(0,$i3);
  $i60.dup := $or.i1(0,$i3.dup);
  $i61 := $add.i64(32,$i60);
  $i61.dup := $or.i1(0,$i60.dup);
  $p62 := $add.ref($add.ref($p19,$mul.ref(0,32)),$mul.ref($i61,1));
  $p62.dup := $or.i1($or.i1($p19.dup,$or.i1(0,0)),$or.i1($i61.dup,0));
  ...
  $M.5.dup := $store.i1($M.5.dup,$p73,$i77.dup);
...
$bb7:
  ...
  assert {:shadow_invariant} ($i79.dup == 0);
  assert {:shadow_invariant} ($p19.dup == 0);
  assert {:shadow_invariant} ($p9.dup == 0);
  assert {:shadow_invariant} ($p8.dup == 0);
  assert {:shadow_invariant} ($p6.dup == 0);
  assert {:shadow_invariant} ($p5.dup == 0);
  assert {:shadow_invariant} ($p7.dup == 0);
  assert {:shadow_invariant} ($p10.dup == 0);
  assert {:shadow_invariant} ($p12.dup == 0);
  assert {:likely_shadow_invariant} ($p18.dup == 0);
  assert {:likely_shadow_invariant} ($p17.dup == 0);
  assert {:likely_shadow_invariant} ($p15.dup == 0);
  assert {:likely_shadow_invariant} ($p14.dup == 0);
  assert {:likely_shadow_invariant} ($p16.dup == 0);
  assert {:likely_shadow_invariant} ($p13.dup == 0);
  assert {:likely_shadow_invariant} ($p11.dup == 0);
  assert {:unlikely_shadow_invariant ($i78.dup == 0)} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
$bb8:
  ...
  $p84.dup := $or.i1($or.i1($p19.dup,$or.i1(0,0)),$or.i1($i83.dup,0));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 256, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p84.dup == 0));
  $i85 := $load.i8($M.5,$p84);
  $i85.dup := $load.i1($M.5.dup,$p84);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 256, 9} true;
  assume {:verifier.code 0} true;
  $i86 := $zext.i8.i32($i85);
  $i86.dup := $i85.dup;
...
$bb9:
  ...
  $p155.dup := $or.i1($or.i1($p8.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 316, 2} true;
  assume {:verifier.code 0} true;
  ...
  $shadow_ok := ($shadow_ok && ($p156.dup == 0));
  call $M.4, $M.4.dup := $memcpy.i8($M.4, $M.4.dup, $M.4, $M.4.dup, $p154, $p154.dup, $p156, $p156.dup, 36, 0, false, false);
...
$bb10:
  ...
  $i148.dup := $or.i1($i79.dup,$or.i1(0,0));
...
$bb11:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i157.dup == 0);
  assert {:shadow_invariant} ($p8.dup == 0);
  assert {:shadow_invariant} ($p6.dup == 0);
  assert {:shadow_invariant} ($p10.dup == 0);
  assert {:shadow_invariant} ($p12.dup == 0);
  ...
  $shadow_ok := ($shadow_ok && ($i158.dup == 0));
  goto $bb12, $bb13;
$bb12:
  assume ($i158 == 1);
...
$bb13:
  ...
  $p166.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 321, 2} true;
  assume {:verifier.code 0} true;
  ...
  $p168.dup := $or.i1($or.i1($p10.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 321, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 321, 2} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p167.dup == 0));
  $shadow_ok := ($shadow_ok && ($p169.dup == 0));
  call $M.4, $M.4.dup := $memcpy.i8($M.4, $M.4.dup, $M.4, $M.4.dup, $p167, $p167.dup, $p169, $p169.dup, 36, 0, false, false);
...
$bb15:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i170.dup == 0);
  assert {:shadow_invariant} ($p8.dup == 0);
  assert {:shadow_invariant} ($p6.dup == 0);
  assert {:shadow_invariant} ($p10.dup == 0);
  assert {:shadow_invariant} ($p12.dup == 0);
  ...
  $shadow_ok := ($shadow_ok && ($i171.dup == 0));
  goto $bb16, $bb17;
$bb16:
  assume ($i171 == 1);
...
$bb18:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i172.dup == 0);
  assert {:shadow_invariant} ($i170.dup == 0);
  assert {:shadow_invariant} ($p8.dup == 0);
  assert {:shadow_invariant} ($p6.dup == 0);
  assert {:shadow_invariant} ($p10.dup == 0);
  ...
  $shadow_ok := ($shadow_ok && ($i173.dup == 0));
  goto $bb19, $bb20;
$bb19:
  assume ($i173 == 1);
...
$bb23:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i182.dup == 0);
  assert {:shadow_invariant} ($p8.dup == 0);
  assert {:shadow_invariant} ($p6.dup == 0);
  assert {:shadow_invariant} ($p10.dup == 0);
  assert {:shadow_invariant} ($p12.dup == 0);
  ...
  $shadow_ok := ($shadow_ok && ($i183.dup == 0));
  goto $bb24, $bb25;
$bb24:
  assume ($i183 == 1);
  ...
  $shadow_ok := ($shadow_ok && ($i189.dup == 0));
  goto $bb26, $bb27;
$bb25:
  assume !($i183 == 1);
...
$bb29:
  ...
  $i193.dup := $or.i1($i182.dup,$or.i1(0,0));
...
$bb0:
  ...
  call $M.3, $M.3.dup := $memcpy.i8($M.3, $M.3.dup, $M.7, $M.7.dup, $p0, $p0.dup, $p5, $p5.dup, $i6, $i6.dup, false, false);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 364, 13} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4.dup == 0));
  $i7 := $load.i64($M.0,$p4);
  $i7.dup := $load.i1($M.0.dup,$p4);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 364, 2} true;
  assume {:verifier.code 0} true;
  call $i8, $i8.dup := api_mul($p0, $p0.dup, $i7, $i7.dup, $p1, $p1.dup, $i2, $i2.dup, $i3, $i3.dup);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 365, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4.dup == 0));
  $i9 := $load.i64($M.0,$p4);
  $i9.dup := $load.i1($M.0.dup,$p4);
...
procedure {:inline 1} byteswap($p0: ref, $p0.dup: i1)
modifies $M.3, $exn;
{
  var $i1: i32;
  var $i1.dup: i1;
...
$bb1:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i1.dup == 0);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  $p4.dup := $or.i1($p0.dup,$or.i1($i3.dup,0));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 172, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4.dup == 0));
  $i5 := $load.i8($M.3,$p4);
...
procedure {:inline 1} br_i15_zero($p0: ref, $p0.dup: i1, $i1: i16, $i1.dup: i1)
modifies $M.4, $exn;
{
  var $p2: ref;
  var $p2.dup: i1;
...
$bb0:
  ...
  $M.4.dup := $store.i1($M.4.dup,$p0,$i1.dup);
  ...
  call $M.4, $M.4.dup := $memset.i8($M.4, $M.4.dup, $p3, $p3.dup, 0, 0, $i8, $i8.dup, false, false);
...
procedure {:inline 1} br_i15_decode_mod($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i64, $i2.dup: i1, $p3: ref, $p3.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $M.4, $exn;
{
  var $p4: ref;
  var $p4.dup: i1;
...
$bb0:
  ...
  $p4.dup := $or.i1($p3.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 60, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4.dup == 0));
  $i5 := $load.i16($M.4,$p4);
  $i5.dup := $load.i1($M.4.dup,$p4);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 60, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i16.i32($i5);
  $i6.dup := $i5.dup;
...
$bb4:
  ...
  assert {:unlikely_shadow_invariant ($i15.dup == 0)} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i19.dup == 0);
  assert {:shadow_invariant} ($i21.dup == 0);
  assert {:shadow_invariant} ($i13.dup == 0);
...
$bb16:
  ...
  assume {:verifier.code 0} true;
  $i43 := $ne.i32($i14,0);
  $i43.dup := $or.i1($i14.dup,0);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 92, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i43} true;
  $shadow_ok := ($shadow_ok && ($i43.dup == 0));
  goto $bb18, $bb19;
$bb17:
  assume !($i42 == 1);
...
$bb18:
  ...
  $p46.dup := $or.i1($p0.dup,$or.i1($i19.dup,0));
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 93, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p46.dup == 0));
  $M.4 := $store.i16($M.4,$p46,$i45);
  $M.4.dup := $store.i1($M.4.dup,$p46,$i45.dup);
...
$bb19:
  ...
  $p48.dup := $or.i1($p3.dup,$or.i1($i19.dup,0));
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 97, 30} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p48.dup == 0));
...
$bb24:
  ...
  assume {:verifier.code 0} true;
  call $i57, $i57.dup := EQ($i38, $i38.dup, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i15_decmod.c", 102, 11} true;
  assume {:verifier.code 0} true;
  call $i58, $i58.dup := MUX.7($i57, $i57.dup, $i17, $i17.dup, 1, 0);
...
procedure {:inline 1} br_i15_sub($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i32, $i2.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $M.4, $exn;
{
  var $p3: ref;
  var $p3.dup: i1;
...
$bb1:
  ...
  assert {:shadow_invariant} ($i10.dup == 0);
  assert {:unlikely_shadow_invariant ($i9.dup == 0)} true;
...
$bb2:
  ...
  $p12.dup := $or.i1($p0.dup,$or.i1($i10.dup,0));
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 39, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p12.dup == 0));
  $i13 := $load.i16($M.4,$p12);
  $i13.dup := $load.i1($M.4.dup,$p12);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 39, 8} true;
  assume {:verifier.code 0} true;
  ...
  $p15.dup := $or.i1($p1.dup,$or.i1($i10.dup,0));
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 40, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p15.dup == 0));
  $i16 := $load.i16($M.4,$p15);
  $i16.dup := $load.i1($M.4.dup,$p15);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 40, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call $i22, $i22.dup := MUX.17($i2, $i2.dup, $i21, $i21.dup, $i14, $i14.dup);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 43, 10} true;
  assume {:verifier.code 0} true;
...
procedure {:inline 1} br_i15_montymul($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1, $p3: ref, $p3.dup: i1, $i4: i16, $i4.dup: i1)
modifies $M.4, $exn;
{
  var $p5: ref;
  var $p5.dup: i1;
...
$bb0:
  ...
  $p5.dup := $or.i1($p3.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p5.dup == 0));
  $i6 := $load.i16($M.4,$p5);
  $i6.dup := $load.i1($M.4.dup,$p5);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i16.i32($i6);
  $i7.dup := $i6.dup;
  ...
  $p12.dup := $or.i1($p3.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 37, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p12.dup == 0));
  $i13 := $load.i16($M.4,$p12);
  ...
  assume {:verifier.code 0} true;
  call br_i15_zero.13($p0, $p0.dup, $i13, $i13.dup);
...
$bb2:
  ...
  $p28.dup := $or.i1($p2.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p28.dup == 0));
  $i29 := $load.i16($M.4,$p28);
  $i29.dup := $load.i1($M.4.dup,$p28);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  assert {:shadow_invariant} ($i14.dup == 0);
  assert {:unlikely_shadow_invariant ($i20.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i36.dup == 0)} true;
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  $i44 := $add.i64($i37,1);
  $i44.dup := $or.i1($i37.dup,0);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 19} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($p2,$mul.ref($i44,2));
  $p45.dup := $or.i1($p2.dup,$or.i1($i44.dup,0));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p45.dup == 0));
  $i46 := $load.i16($M.4,$p45);
  $i46.dup := $load.i1($M.4.dup,$p45);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i66 := $add.i64($i37,2);
  $i66.dup := $or.i1($i37.dup,0);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 19} true;
  assume {:verifier.code 0} true;
  $p67 := $add.ref($p2,$mul.ref($i66,2));
  $p67.dup := $or.i1($p2.dup,$or.i1($i66.dup,0));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p67.dup == 0));
  $i68 := $load.i16($M.4,$p67);
  $i68.dup := $load.i1($M.4.dup,$p67);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i72 := $add.i64($i37,2);
  $i72.dup := $or.i1($i37.dup,0);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 147, 7} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($p3,$mul.ref($i72,2));
  $p73.dup := $or.i1($p3.dup,$or.i1($i72.dup,0));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 147, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p73.dup == 0));
  $i74 := $load.i16($M.4,$p73);
  $i74.dup := $load.i1($M.4.dup,$p73);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 147, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i88 := $add.i64($i37,3);
  $i88.dup := $or.i1($i37.dup,0);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 19} true;
  assume {:verifier.code 0} true;
  $p89 := $add.ref($p2,$mul.ref($i88,2));
  $p89.dup := $or.i1($p2.dup,$or.i1($i88.dup,0));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p89.dup == 0));
  $i90 := $load.i16($M.4,$p89);
  $i90.dup := $load.i1($M.4.dup,$p89);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 19} true;
  assume {:verifier.code 0} true;
  ...
  $i100.dup := $or.i1($i99.dup,$i79.dup);
  ...
  assume {:verifier.code 0} true;
  $i110 := $add.i64($i37,4);
  $i110.dup := $or.i1($i37.dup,0);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 19} true;
  assume {:verifier.code 0} true;
  $p111 := $add.ref($p2,$mul.ref($i110,2));
  $p111.dup := $or.i1($p2.dup,$or.i1($i110.dup,0));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p111.dup == 0));
  $i112 := $load.i16($M.4,$p111);
  $i112.dup := $load.i1($M.4.dup,$p111);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 19} true;
  assume {:verifier.code 0} true;
  ...
  $i114.dup := $or.i1($i20.dup,$i113.dup);
  ...
  assume {:verifier.code 0} true;
  $i116 := $add.i64($i37,4);
  $i116.dup := $or.i1($i37.dup,0);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 155, 7} true;
  assume {:verifier.code 0} true;
  $p117 := $add.ref($p3,$mul.ref($i116,2));
  $p117.dup := $or.i1($p3.dup,$or.i1($i116.dup,0));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 155, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p117.dup == 0));
  $i118 := $load.i16($M.4,$p117);
  $i118.dup := $load.i1($M.4.dup,$p117);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 155, 7} true;
  assume {:verifier.code 0} true;
  ...
  $i120.dup := $or.i1($i36.dup,$i119.dup);
  ...
  $i122.dup := $or.i1($i121.dup,$i101.dup);
...
$bb8:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i129.dup == 0);
  assert {:shadow_invariant} ($i11.dup == 0);
  assert {:shadow_invariant} ($i10.dup == 0);
  assert {:shadow_invariant} ($i14.dup == 0);
  assert {:unlikely_shadow_invariant ($i20.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i36.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i130.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i15.dup == 0)} true;
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 0, 0} true;
  ...
  $i131.dup := $or.i1($i129.dup,$i10.dup);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 160, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i131} true;
  $shadow_ok := ($shadow_ok && ($i131.dup == 0));
  goto $bb9, $bb10;
$bb9:
  assume ($i131 == 1);
  ...
  assume {:verifier.code 0} true;
  $i136 := $add.i64($i129,1);
  $i136.dup := $or.i1($i129.dup,0);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 19} true;
  assume {:verifier.code 0} true;
  $p137 := $add.ref($p2,$mul.ref($i136,2));
  $p137.dup := $or.i1($p2.dup,$or.i1($i136.dup,0));
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p137.dup == 0));
  $i138 := $load.i16($M.4,$p137);
  $i138.dup := $load.i1($M.4.dup,$p137);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 19} true;
  assume {:verifier.code 0} true;
...
$bb10:
  ...
  $i155.dup := $or.i1($i15.dup,$i130.dup);
...
procedure {:inline 1} cswap($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i32, $i2.dup: i1)
modifies $M.4, $exn;
{
  var $i3: i32;
  var $i3.dup: i1;
...
$bb2:
  ...
  $p7.dup := $or.i1($p0.dup,$or.i1($i6.dup,0));
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 124, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p7.dup == 0));
  $i8 := $load.i16($M.4,$p7);
  $i8.dup := $load.i1($M.4.dup,$p7);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 124, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i16.i32($i8);
  $i9.dup := $i8.dup;
  ...
  $M.4.dup := $store.i1($M.4.dup,$p23,$i21.dup);
...
procedure {:inline 1} c255_add($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1)
modifies $M.4, $exn;
modifies $CurrAddr;
{
  var $p3: ref;
...
$bb0:
  ...
  call $M.4, $M.4.dup := $memcpy.i8($M.4, $M.4.dup, $M.4, $M.4.dup, $p5, $p5.dup, $p6, $p6.dup, 36, 0, false, false);
  ...
  assume {:verifier.code 0} true;
  call $i8, $i8.dup := br_i15_add($p7, $p7.dup, $p2, $p2.dup, 1, 0);
  ...
  assume {:verifier.code 0} true;
  call $i10, $i10.dup := br_i15_sub($p9, $p9.dup, C255_P, cons.dup, 0, 0);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 140, 9} true;
  assume {:verifier.code 0} true;
  call $i11, $i11.dup := NOT($i10, $i10.dup);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 140, 6} true;
  assume {:verifier.code 0} true;
  $i12 := $or.i32($i8,$i11);
  $i12.dup := $or.i1($i8.dup,$i11.dup);
  ...
  assume {:verifier.code 0} true;
  call $i14, $i14.dup := br_i15_sub($p13, $p13.dup, C255_P, cons.dup, $i12, $i12.dup);
  ...
  call $M.4, $M.4.dup := $memcpy.i8($M.4, $M.4.dup, $M.4, $M.4.dup, $p15, $p15.dup, $p17, $p17.dup, 36, 0, false, false);
...
procedure {:inline 1} c255_mul($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1)
modifies $M.4, $exn;
modifies $CurrAddr;
{
  var $p3: ref;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_i15_montymul($p4, $p4.dup, $p1, $p1.dup, $p2, $p2.dup, C255_P, cons.dup, 18971, 0);
  ...
  $shadow_ok := ($shadow_ok && ($p5.dup == 0));
  $shadow_ok := ($shadow_ok && ($p7.dup == 0));
  call $M.4, $M.4.dup := $memcpy.i8($M.4, $M.4.dup, $M.4, $M.4.dup, $p5, $p5.dup, $p7, $p7.dup, 36, 0, false, false);
...
procedure {:inline 1} c255_sub($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1)
modifies $M.4, $exn;
modifies $CurrAddr;
{
  var $p3: ref;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i9, $i9.dup := br_i15_sub($p8, $p8.dup, $p2, $p2.dup, 1, 0);
  assume {:sourceloc "../BearSSL/src/ec/ec_c25519_i15.c", 151, 2} true;
  assume {:verifier.code 0} true;
  call $i10, $i10.dup := br_i15_add($p7, $p7.dup, C255_P, cons.dup, $i9, $i9.dup);
  ...
  call $M.4, $M.4.dup := $memcpy.i8($M.4, $M.4.dup, $M.4, $M.4.dup, $p11, $p11.dup, $p13, $p13.dup, 36, 0, false, false);
...
procedure {:inline 1} br_i15_encode($p0: ref, $p0.dup: i1, $i1: i64, $i1.dup: i1, $p2: ref, $p2.dup: i1)
modifies $M.3, $exn;
{
  var $p3: ref;
  var $p3.dup: i1;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p0.dup == 0));
  $shadow_ok := ($shadow_ok && ($i1.dup == 0));
  call $M.3, $M.3.dup := $memset.i8($M.3, $M.3.dup, $p0, $p0.dup, 0, 0, $i1, $i1.dup, false, false);
...
$bb10:
  ...
  $p24.dup := $or.i1($p2.dup,$or.i1($i10.dup,0));
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 48, 22} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p24.dup == 0));
  $i25 := $load.i16($M.4,$p24);
  $i25.dup := $load.i1($M.4.dup,$p24);
  ...
  assume {:verifier.code 0} true;
  $i27 := $shl.i32($i26,$i13);
  $i27.dup := $or.i1($i26.dup,$i13.dup);
  assume {:sourceloc "../BearSSL/src/int/i15_encode.c", 48, 9} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i32($i11,$i27);
  $i28.dup := $or.i1($i11.dup,$i27.dup);
...
procedure {:inline 1} br_i15_add($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i32, $i2.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $M.4, $exn;
{
  var $p3: ref;
  var $p3.dup: i1;
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  call $i22, $i22.dup := MUX($i2, $i2.dup, $i21, $i21.dup, $i14, $i14.dup);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 43, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i32.i16($i22);
  $i23.dup := $i22.dup;
...
procedure {:inline 1} br_i15_zero.13($p0: ref, $p0.dup: i1, $i1: i16, $i1.dup: i1)
modifies $M.4, $exn;
{
  var $p2: ref;
  var $p2.dup: i1;
...
procedure {:inline 1} NOT.14($i0: i32, $i0.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i1: i32;
  var $i1.dup: i1;
...
procedure {:inline 1} MUX.17($i0: i32, $i0.dup: i1, $i1: i32, $i1.dup: i1, $i2: i32, $i2.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i3: i32;
  var $i3.dup: i1;
...
procedure {:inline 1} CMP($i0: i32, $i0.dup: i1, $i1: i32, $i1.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i2: i32;
  var $i2.dup: i1;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i6, $i6.dup := NOT.8($i5, $i5.dup);
...
procedure {:inline 1} MUX.7($i0: i32, $i0.dup: i1, $i1: i32, $i1.dup: i1, $i2: i32, $i2.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i3: i32;
  var $i3.dup: i1;
...
procedure {:inline 1} NOT.8($i0: i32, $i0.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i1: i32;
  var $i1.dup: i1;
...
procedure {:inline 1} GT($i0: i32, $i0.dup: i1, $i1: i32, $i1.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i2: i32;
  var $i2.dup: i1;
...
requires ($i3.dup == 0);
requires ($i4.dup == 0);
requires ($load.i8($M.3.dup,($p0 + 0)) == 0);
requires ($load.i8($M.3.dup,($p0 + 1)) == 0);
requires ($load.i8($M.3.dup,($p0 + 2)) == 0);
requires ($load.i8($M.3.dup,($p0 + 3)) == 0);
requires ($load.i8($M.3.dup,($p0 + 4)) == 0);
requires ($load.i8($M.3.dup,($p0 + 5)) == 0);
requires ($load.i8($M.3.dup,($p0 + 6)) == 0);
requires ($load.i8($M.3.dup,($p0 + 7)) == 0);
requires ($load.i8($M.3.dup,($p0 + 8)) == 0);
requires ($load.i8($M.3.dup,($p0 + 9)) == 0);
requires ($load.i8($M.3.dup,($p0 + 10)) == 0);
requires ($load.i8($M.3.dup,($p0 + 11)) == 0);
requires ($load.i8($M.3.dup,($p0 + 12)) == 0);
requires ($load.i8($M.3.dup,($p0 + 13)) == 0);
requires ($load.i8($M.3.dup,($p0 + 14)) == 0);
requires ($load.i8($M.3.dup,($p0 + 15)) == 0);
requires ($load.i8($M.3.dup,($p0 + 16)) == 0);
requires ($load.i8($M.3.dup,($p0 + 17)) == 0);
requires ($load.i8($M.3.dup,($p0 + 18)) == 0);
requires ($load.i8($M.3.dup,($p0 + 19)) == 0);
requires ($load.i8($M.3.dup,($p0 + 20)) == 0);
requires ($load.i8($M.3.dup,($p0 + 21)) == 0);
requires ($load.i8($M.3.dup,($p0 + 22)) == 0);
requires ($load.i8($M.3.dup,($p0 + 23)) == 0);
requires ($load.i8($M.3.dup,($p0 + 24)) == 0);
requires ($load.i8($M.3.dup,($p0 + 25)) == 0);
requires ($load.i8($M.3.dup,($p0 + 26)) == 0);
requires ($load.i8($M.3.dup,($p0 + 27)) == 0);
requires ($load.i8($M.3.dup,($p0 + 28)) == 0);
requires ($load.i8($M.3.dup,($p0 + 29)) == 0);
requires ($load.i8($M.3.dup,($p0 + 30)) == 0);
requires ($load.i8($M.3.dup,($p0 + 31)) == 0);
requires ($load.i8($M.3.dup,($p0 + 32)) == 0);
requires ($load.i8($M.3.dup,($p0 + 33)) == 0);
requires ($load.i8($M.3.dup,($p0 + 34)) == 0);
requires ($load.i8($M.3.dup,($p0 + 35)) == 0);
requires ($load.i8($M.3.dup,($p0 + 36)) == 0);
requires ($load.i8($M.3.dup,($p0 + 37)) == 0);
requires ($load.i8($M.3.dup,($p0 + 38)) == 0);
requires ($load.i8($M.3.dup,($p0 + 39)) == 0);
requires ($load.i8($M.3.dup,($p0 + 40)) == 0);
requires ($load.i8($M.3.dup,($p0 + 41)) == 0);
requires ($load.i8($M.3.dup,($p0 + 42)) == 0);
requires ($load.i8($M.3.dup,($p0 + 43)) == 0);
requires ($load.i8($M.3.dup,($p0 + 44)) == 0);
requires ($load.i8($M.3.dup,($p0 + 45)) == 0);
requires ($load.i8($M.3.dup,($p0 + 46)) == 0);
requires ($load.i8($M.3.dup,($p0 + 47)) == 0);
requires ($load.i8($M.3.dup,($p0 + 48)) == 0);
requires ($load.i8($M.3.dup,($p0 + 49)) == 0);
requires ($load.i8($M.3.dup,($p0 + 50)) == 0);
requires ($load.i8($M.3.dup,($p0 + 51)) == 0);
requires ($load.i8($M.3.dup,($p0 + 52)) == 0);
requires ($load.i8($M.3.dup,($p0 + 53)) == 0);
requires ($load.i8($M.3.dup,($p0 + 54)) == 0);
requires ($load.i8($M.3.dup,($p0 + 55)) == 0);
requires ($load.i8($M.3.dup,($p0 + 56)) == 0);
requires ($load.i8($M.3.dup,($p0 + 57)) == 0);
requires ($load.i8($M.3.dup,($p0 + 58)) == 0);
requires ($load.i8($M.3.dup,($p0 + 59)) == 0);
requires ($load.i8($M.3.dup,($p0 + 60)) == 0);
requires ($load.i8($M.3.dup,($p0 + 61)) == 0);
requires ($load.i8($M.3.dup,($p0 + 62)) == 0);
requires ($load.i8($M.3.dup,($p0 + 63)) == 0);
{
  var $p5: ref;
  var $p5.dup: i1;
  var $p6: ref;
...
$bb0:
  ...
  $p12 := $M.9;
  $p12.dup := $M.9.dup;
  call $i13, $i13.dup := devirtbounce($p12, $p12.dup, $p0, $p0.dup, $i1, $i1.dup, $p2, $p2.dup, $i3, $i3.dup, 29, 0);
...
$bb0:
  ...
  $M.4.dup := $store.i1($M.4.dup,C255_P,0);
  ...
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(1,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(2,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(2,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(3,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(3,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(4,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(4,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(5,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(5,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(6,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(6,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(7,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(7,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(8,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(8,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(9,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(9,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(10,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(10,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(11,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(11,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(12,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(12,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(13,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(13,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(14,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(14,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(15,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(15,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(16,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(16,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(17,2)),32767);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_P,$mul.ref(0,36)),$mul.ref(17,2)),0);
  $shadow_ok := ($shadow_ok && (cons.dup == 0));
  $M.4 := $store.i16($M.4,C255_R2,272);
  $M.4.dup := $store.i1($M.4.dup,C255_R2,0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(2,1)),361);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(2,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(0,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(0,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(1,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(1,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(2,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(2,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(3,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(3,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(4,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(4,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(5,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(5,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(6,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(6,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(7,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(7,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(8,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(8,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(9,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(9,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(10,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(10,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(11,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(11,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(12,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(12,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(13,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(13,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(14,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(14,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(15,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_R2,$mul.ref(0,36)),$mul.ref(4,1)),$mul.ref(15,2)),0);
  $shadow_ok := ($shadow_ok && (cons.dup == 0));
  $M.4 := $store.i16($M.4,C255_A24,272);
  $M.4.dup := $store.i1($M.4.dup,C255_A24,0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(2,1)),17875);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(2,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(4,1)),70);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(4,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(0,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(0,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(1,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(1,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(2,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(2,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(3,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(3,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(4,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(4,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(5,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(5,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(6,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(6,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(7,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(7,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(8,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(8,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(9,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(9,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(10,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(10,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(11,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(11,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(12,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(12,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(13,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(13,2)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.4 := $store.i16($M.4,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(14,2)),0);
  $M.4.dup := $store.i1($M.4.dup,$add.ref($add.ref($add.ref(C255_A24,$mul.ref(0,36)),$mul.ref(6,1)),$mul.ref(14,2)),0);
  $shadow_ok := ($shadow_ok && (cons.dup == 0));
  $M.7 := $store.i8($M.7,GEN,9);
  $M.7.dup := $store.i1($M.7.dup,GEN,0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(0,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(0,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(1,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(1,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(2,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(2,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(3,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(3,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(4,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(4,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(5,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(5,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(6,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(6,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(7,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(7,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(8,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(8,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(9,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(9,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(10,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(10,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(11,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(11,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(12,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(12,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(13,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(13,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(14,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(14,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(15,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(15,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(16,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(16,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(17,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(17,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(18,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(18,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(19,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(19,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(20,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(20,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(21,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(21,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(22,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(22,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(23,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(23,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(24,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(24,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(25,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(25,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(26,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(26,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(27,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(27,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(28,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(28,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(29,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(29,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.7 := $store.i8($M.7,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(30,1)),0);
  $M.7.dup := $store.i1($M.7.dup,$add.ref($add.ref($add.ref(GEN,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(30,1)),0);
  $exn := false;
  $exn.dup := false;
  return;
}
