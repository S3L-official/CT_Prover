...
10:                                               ; preds = %3
  ...
  %47 = getelementptr inbounds [9 x i32], [9 x i32]* @P256_B, i64 0, i64 0
  call void @add_f256(i32* %45, i32* %46, i32* %47), !dbg !378
  %48 = getelementptr inbounds [9 x i32], [9 x i32]* %6, i64 0, i64 0, !dbg !379
  %49 = getelementptr inbounds [9 x i32], [9 x i32]* %6, i64 0, i64 0, !dbg !380
  %50 = getelementptr inbounds [9 x i32], [9 x i32]* %7, i64 0, i64 0, !dbg !381
  call void @sub_f256(i32* %48, i32* %49, i32* %50), !dbg !382
  %51 = getelementptr inbounds [9 x i32], [9 x i32]* %6, i64 0, i64 0, !dbg !383
  %52 = call i32 @reduce_final_f256(i32* %51), !dbg !384
  call void @llvm.dbg.value(metadata i32 0, metadata !385, metadata !DIExpression()), !dbg !318
  br label %53, !dbg !386

53:                                               ; preds = %60, %10
  %.02 = phi i32 [ %28, %10 ], [ %59, %60 ], !dbg !318
  %.01 = phi i32 [ 0, %10 ], [ %61, %60 ], !dbg !388
  ...
  %54 = icmp slt i32 %.01, 9, !dbg !389
  br i1 %54, label %55, label %62, !dbg !391

55:                                               ; preds = %53
  %56 = sext i32 %.01 to i64, !dbg !392
  %57 = getelementptr inbounds [9 x i32], [9 x i32]* %6, i64 0, i64 %56, !dbg !392
  %58 = load i32, i32* %57, align 4, !dbg !392
  %59 = or i32 %.02, %58, !dbg !394
  call void @llvm.dbg.value(metadata i32 %59, metadata !337, metadata !DIExpression()), !dbg !318
  br label %60, !dbg !395

60:                                               ; preds = %55
  %61 = add nsw i32 %.01, 1, !dbg !396
  call void @llvm.dbg.value(metadata i32 %61, metadata !385, metadata !DIExpression()), !dbg !318
  br label %53, !dbg !397, !llvm.loop !398

62:                                               ; preds = %53
  %63 = getelementptr inbounds %struct.p256_jacobian, %struct.p256_jacobian* %0, i32 0, i32 0, !dbg !400
  %64 = getelementptr inbounds [9 x i32], [9 x i32]* %63, i64 0, i64 0, !dbg !401
  %65 = bitcast i32* %64 to i8*, !dbg !401
  %66 = getelementptr inbounds [9 x i32], [9 x i32]* %4, i64 0, i64 0, !dbg !401
  %67 = bitcast i32* %66 to i8*, !dbg !401
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %65, i8* align 16 %67, i64 36, i1 false), !dbg !401
  %68 = getelementptr inbounds %struct.p256_jacobian, %struct.p256_jacobian* %0, i32 0, i32 1, !dbg !402
  %69 = getelementptr inbounds [9 x i32], [9 x i32]* %68, i64 0, i64 0, !dbg !403
  %70 = bitcast i32* %69 to i8*, !dbg !403
  %71 = getelementptr inbounds [9 x i32], [9 x i32]* %5, i64 0, i64 0, !dbg !403
  %72 = bitcast i32* %71 to i8*, !dbg !403
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %70, i8* align 16 %72, i64 36, i1 false), !dbg !403
  %73 = getelementptr inbounds %struct.p256_jacobian, %struct.p256_jacobian* %0, i32 0, i32 2, !dbg !404
  %74 = getelementptr inbounds [9 x i32], [9 x i32]* %73, i64 0, i64 0, !dbg !405
  %75 = bitcast i32* %74 to i8*, !dbg !405
  call void @llvm.memset.p0i8.i64(i8* align 4 %75, i8 0, i64 36, i1 false), !dbg !405
  %76 = getelementptr inbounds %struct.p256_jacobian, %struct.p256_jacobian* %0, i32 0, i32 2, !dbg !406
  %77 = getelementptr inbounds [9 x i32], [9 x i32]* %76, i64 0, i64 0, !dbg !407
  store i32 1, i32* %77, align 4, !dbg !408
  %78 = call i32 @EQ(i32 %.02, i32 0), !dbg !409
  br label %79, !dbg !410

79:                                               ; preds = %62, %9
  %.0 = phi i32 [ 0, %9 ], [ %78, %62 ], !dbg !318
  ret i32 %.0, !dbg !411
}
