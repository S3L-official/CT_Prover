...
define internal i32 @point_decode(%struct.p256_jacobian* %0, i8* %1) #0 !dbg !326 {
  ...
  %40 = getelementptr inbounds [5 x i64], [5 x i64]* @P256_B_MONTY, i64 0, i64 0
  call void @f256_sub(i64* %38, i64* %39, i64* %40), !dbg !384
  %41 = getelementptr inbounds [5 x i64], [5 x i64]* %5, i64 0, i64 0, !dbg !385
  call void @f256_final_reduce(i64* %41), !dbg !386
  %42 = getelementptr inbounds [5 x i64], [5 x i64]* %5, i64 0, i64 0, !dbg !387
  %43 = load i64, i64* %42, align 16, !dbg !387
  %44 = getelementptr inbounds [5 x i64], [5 x i64]* %5, i64 0, i64 1, !dbg !388
  %45 = load i64, i64* %44, align 8, !dbg !388
  %46 = or i64 %43, %45, !dbg !389
  %47 = getelementptr inbounds [5 x i64], [5 x i64]* %5, i64 0, i64 2, !dbg !390
  %48 = load i64, i64* %47, align 16, !dbg !390
  %49 = or i64 %46, %48, !dbg !391
  %50 = getelementptr inbounds [5 x i64], [5 x i64]* %5, i64 0, i64 3, !dbg !392
  %51 = load i64, i64* %50, align 8, !dbg !392
  %52 = or i64 %49, %51, !dbg !393
  %53 = getelementptr inbounds [5 x i64], [5 x i64]* %5, i64 0, i64 4, !dbg !394
  %54 = load i64, i64* %53, align 16, !dbg !394
  %55 = or i64 %52, %54, !dbg !395
  call void @llvm.dbg.value(metadata i64 %55, metadata !396, metadata !DIExpression()), !dbg !331
  %56 = lshr i64 %55, 32, !dbg !397
  %57 = or i64 %55, %56, !dbg !398
  %58 = trunc i64 %57 to i32, !dbg !399
  %59 = call i32 @EQ(i32 %58, i32 0), !dbg !400
  %60 = and i32 %10, %59, !dbg !401
  call void @llvm.dbg.value(metadata i32 %60, metadata !343, metadata !DIExpression()), !dbg !331
  %61 = getelementptr inbounds %struct.p256_jacobian, %struct.p256_jacobian* %0, i32 0, i32 0, !dbg !402
  %62 = getelementptr inbounds [5 x i64], [5 x i64]* %61, i64 0, i64 0, !dbg !403
  %63 = bitcast i64* %62 to i8*, !dbg !403
  %64 = getelementptr inbounds [5 x i64], [5 x i64]* %3, i64 0, i64 0, !dbg !403
  %65 = bitcast i64* %64 to i8*, !dbg !403
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %63, i8* align 16 %65, i64 40, i1 false), !dbg !403
  %66 = getelementptr inbounds %struct.p256_jacobian, %struct.p256_jacobian* %0, i32 0, i32 1, !dbg !404
  %67 = getelementptr inbounds [5 x i64], [5 x i64]* %66, i64 0, i64 0, !dbg !405
  %68 = bitcast i64* %67 to i8*, !dbg !405
  %69 = getelementptr inbounds [5 x i64], [5 x i64]* %4, i64 0, i64 0, !dbg !405
  %70 = bitcast i64* %69 to i8*, !dbg !405
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %68, i8* align 16 %70, i64 40, i1 false), !dbg !405
  %71 = getelementptr inbounds %struct.p256_jacobian, %struct.p256_jacobian* %0, i32 0, i32 2, !dbg !406
  %72 = getelementptr inbounds [5 x i64], [5 x i64]* %71, i64 0, i64 0, !dbg !407
  %73 = bitcast i64* %72 to i8*, !dbg !407
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %73, i8* align 16 bitcast ([5 x i64]* @F256_R to i8*), i64 40, i1 false), !dbg !407
  ret i32 %60, !dbg !408
}
...
define internal void @p256_mulgen(%struct.p256_jacobian* %0, i8* %1, i64 %2) #0 !dbg !474 {
  ...
  %4 = getelementptr inbounds [15 x %struct.p256_affine], [15 x %struct.p256_affine]* @P256_Gwin, i64 0, i64 0
  call void @point_mul_inner(%struct.p256_jacobian* %0, %struct.p256_affine* %4, i8* %1, i64 %2), !dbg !479
  ret void, !dbg !480
}
...
define internal void @f256_frommonty(i64* %0, i64* %1) #0 !dbg !50 {
  ...
  %3 = getelementptr inbounds [5 x i64], [5 x i64]* @f256_frommonty.one, i64 0, i64 0
  call void @f256_montymul(i64* %0, i64* %1, i64* %3), !dbg !1172
  ret void, !dbg !1173
}
...
define internal void @f256_tomonty(i64* %0, i64* %1) #0 !dbg !35 {
  ...
  %3 = getelementptr inbounds [5 x i64], [5 x i64]* @f256_tomonty.R2, i64 0, i64 0
  call void @f256_montymul(i64* %0, i64* %1, i64* %3), !dbg !2001
  ret void, !dbg !2002
}
