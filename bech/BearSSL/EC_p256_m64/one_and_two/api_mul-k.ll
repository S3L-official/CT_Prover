...
define internal i32 @point_decode(%struct.p256_jacobian* %0, i8* %1) #0 !dbg !323 {
  ...
  %60 = getelementptr inbounds [4 x i64], [4 x i64]* @P256_B_MONTY, i64 0, i64 0
  call void @f256_sub(i64* %58, i64* %59, i64* %60), !dbg !407
  %61 = getelementptr inbounds [4 x i64], [4 x i64]* %5, i64 0, i64 0, !dbg !408
  call void @f256_final_reduce(i64* %61), !dbg !409
  %62 = getelementptr inbounds [4 x i64], [4 x i64]* %5, i64 0, i64 0, !dbg !410
  %63 = load i64, i64* %62, align 16, !dbg !410
  %64 = getelementptr inbounds [4 x i64], [4 x i64]* %5, i64 0, i64 1, !dbg !411
  %65 = load i64, i64* %64, align 8, !dbg !411
  %66 = or i64 %63, %65, !dbg !412
  %67 = getelementptr inbounds [4 x i64], [4 x i64]* %5, i64 0, i64 2, !dbg !413
  %68 = load i64, i64* %67, align 16, !dbg !413
  %69 = or i64 %66, %68, !dbg !414
  %70 = getelementptr inbounds [4 x i64], [4 x i64]* %5, i64 0, i64 3, !dbg !415
  %71 = load i64, i64* %70, align 8, !dbg !415
  %72 = or i64 %69, %71, !dbg !416
  call void @llvm.dbg.value(metadata i64 %72, metadata !417, metadata !DIExpression()), !dbg !328
  %73 = lshr i64 %72, 32, !dbg !418
  %74 = or i64 %72, %73, !dbg !419
  %75 = trunc i64 %74 to i32, !dbg !420
  %76 = call i32 @EQ(i32 %75, i32 0), !dbg !421
  %77 = and i32 %10, %76, !dbg !422
  call void @llvm.dbg.value(metadata i32 %77, metadata !340, metadata !DIExpression()), !dbg !328
  %78 = getelementptr inbounds %struct.p256_jacobian, %struct.p256_jacobian* %0, i32 0, i32 0, !dbg !423
  %79 = getelementptr inbounds [4 x i64], [4 x i64]* %78, i64 0, i64 0, !dbg !424
  %80 = bitcast i64* %79 to i8*, !dbg !424
  %81 = getelementptr inbounds [4 x i64], [4 x i64]* %3, i64 0, i64 0, !dbg !424
  %82 = bitcast i64* %81 to i8*, !dbg !424
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %80, i8* align 16 %82, i64 32, i1 false), !dbg !424
  %83 = getelementptr inbounds %struct.p256_jacobian, %struct.p256_jacobian* %0, i32 0, i32 1, !dbg !425
  %84 = getelementptr inbounds [4 x i64], [4 x i64]* %83, i64 0, i64 0, !dbg !426
  %85 = bitcast i64* %84 to i8*, !dbg !426
  %86 = getelementptr inbounds [4 x i64], [4 x i64]* %4, i64 0, i64 0, !dbg !426
  %87 = bitcast i64* %86 to i8*, !dbg !426
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %85, i8* align 16 %87, i64 32, i1 false), !dbg !426
  %88 = getelementptr inbounds %struct.p256_jacobian, %struct.p256_jacobian* %0, i32 0, i32 2, !dbg !427
  %89 = getelementptr inbounds [4 x i64], [4 x i64]* %88, i64 0, i64 0, !dbg !428
  %90 = bitcast i64* %89 to i8*, !dbg !428
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %90, i8* align 16 bitcast ([4 x i64]* @F256_R to i8*), i64 32, i1 false), !dbg !428
  ret i32 %77, !dbg !429
}
...
define internal void @p256_mulgen(%struct.p256_jacobian* %0, i8* %1, i64 %2) #0 !dbg !495 {
  ...
  call void @point_mul_inner(%struct.p256_jacobian* %0, %struct.p256_affine* %4, i8* %1, i64 %2), !dbg !500
  ret void, !dbg !501
}
...
define internal void @f256_frommonty(i64* %0, i64* %1) #0 !dbg !50 {
  ...
  %3 = getelementptr inbounds [4 x i64], [4 x i64]* @f256_frommonty.one, i64 0, i64 0
  call void @f256_montymul(i64* %0, i64* %1, i64* %3), !dbg !1166
  ret void, !dbg !1167
}
...
define internal void @f256_tomonty(i64* %0, i64* %1) #0 !dbg !35 {
  ...
  %3 = getelementptr inbounds [4 x i64], [4 x i64]* @f256_tomonty.R2, i64 0, i64 0
  call void @f256_montymul(i64* %0, i64* %1, i64* %3), !dbg !1943
  ret void, !dbg !1944
}
