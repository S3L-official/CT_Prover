...
modifies $exn;
modifies $M.2, $M.3, $M.4, $M.5, $M.6, $M.1, $M.7, $M.8, $M.9;
modifies $CurrAddr;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_ghash_ctmul($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow, $i3, $i3.shadow);
...
const br_ghash_ctmul: ref;
axiom (br_ghash_ctmul == $sub.ref(0,6192));
procedure {:inline 1} br_ghash_ctmul($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $i3: i64, $i3.shadow: i64)
modifies $M.2, $M.3, $M.4, $M.5, $M.6, $exn, $M.1, $M.7, $M.8, $M.9;
modifies $CurrAddr;
{
  var $p4: ref;
  var $p4.shadow: ref;
  ...
  var $i324.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 211, 10} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  $p9.shadow := $p9;
  call {:cexpr "br_ghash_ctmul:arg:len"} boogie_si_record_i64($i3);
  assume true;
  assume true;
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 211, 10} true;
  assume {:verifier.code 0} true;
  call $i10, $i10.shadow := br_dec32be($p0, $p0.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 211, 2} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(3,4));
  $p11.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 211, 8} true;
  assume {:verifier.code 0} true;
  assert ($p11 == $p11.shadow);
  $M.2 := $store.i32($M.2,$p11,$i10);
  $M.2.shadow := $store.i32($M.2.shadow,$p11.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 212, 24} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p0,$mul.ref(4,1));
  $p12.shadow := $add.ref($p0.shadow,$mul.ref(4,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 212, 10} true;
  assume {:verifier.code 0} true;
  call $i13, $i13.shadow := br_dec32be($p12, $p12.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 212, 2} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(2,4));
  $p14.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 212, 8} true;
  assume {:verifier.code 0} true;
  assert ($p14 == $p14.shadow);
  $M.2 := $store.i32($M.2,$p14,$i13);
  $M.2.shadow := $store.i32($M.2.shadow,$p14.shadow,$i13.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 213, 24} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p0,$mul.ref(8,1));
  $p15.shadow := $add.ref($p0.shadow,$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 213, 10} true;
  assume {:verifier.code 0} true;
  call $i16, $i16.shadow := br_dec32be($p15, $p15.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 213, 2} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(1,4));
  $p17.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 213, 8} true;
  assume {:verifier.code 0} true;
  assert ($p17 == $p17.shadow);
  $M.2 := $store.i32($M.2,$p17,$i16);
  $M.2.shadow := $store.i32($M.2.shadow,$p17.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 214, 24} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p0,$mul.ref(12,1));
  $p18.shadow := $add.ref($p0.shadow,$mul.ref(12,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 214, 10} true;
  assume {:verifier.code 0} true;
  call $i19, $i19.shadow := br_dec32be($p18, $p18.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 214, 2} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(0,4));
  $p20.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 214, 8} true;
  assume {:verifier.code 0} true;
  assert ($p20 == $p20.shadow);
  $M.2 := $store.i32($M.2,$p20,$i19);
  $M.2.shadow := $store.i32($M.2.shadow,$p20.shadow,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 215, 10} true;
  assume {:verifier.code 0} true;
  call $i21, $i21.shadow := br_dec32be($p1, $p1.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 215, 2} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(3,4));
  $p22.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 215, 8} true;
  assume {:verifier.code 0} true;
  assert ($p22 == $p22.shadow);
  $M.3 := $store.i32($M.3,$p22,$i21);
  $M.3.shadow := $store.i32($M.3.shadow,$p22.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 216, 24} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p1,$mul.ref(4,1));
  $p23.shadow := $add.ref($p1.shadow,$mul.ref(4,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 216, 10} true;
  assume {:verifier.code 0} true;
  call $i24, $i24.shadow := br_dec32be($p23, $p23.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 216, 2} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(2,4));
  $p25.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 216, 8} true;
  assume {:verifier.code 0} true;
  assert ($p25 == $p25.shadow);
  $M.4 := $store.i32($M.4,$p25,$i24);
  $M.4.shadow := $store.i32($M.4.shadow,$p25.shadow,$i24.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 217, 24} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p1,$mul.ref(8,1));
  $p26.shadow := $add.ref($p1.shadow,$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 217, 10} true;
  assume {:verifier.code 0} true;
  call $i27, $i27.shadow := br_dec32be($p26, $p26.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 217, 2} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(1,4));
  $p28.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 217, 8} true;
  assume {:verifier.code 0} true;
  assert ($p28 == $p28.shadow);
  $M.5 := $store.i32($M.5,$p28,$i27);
  $M.5.shadow := $store.i32($M.5.shadow,$p28.shadow,$i27.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 218, 24} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p1,$mul.ref(12,1));
  $p29.shadow := $add.ref($p1.shadow,$mul.ref(12,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 218, 10} true;
  assume {:verifier.code 0} true;
  call $i30, $i30.shadow := br_dec32be($p29, $p29.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 218, 2} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(0,4));
  $p31.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 218, 8} true;
  assume {:verifier.code 0} true;
  assert ($p31 == $p31.shadow);
  $M.6 := $store.i32($M.6,$p31,$i30);
  $M.6.shadow := $store.i32($M.6.shadow,$p31.shadow,$i30.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 219, 2} true;
  assume {:verifier.code 0} true;
  $i32 := $i3;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 219, 13} true;
  assume {:verifier.code 0} true;
  $i34 := $ugt.i64($i32,0);
  $i34.shadow := $ugt.i64($i32.shadow,0);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 219, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  assume true;
  assume true;
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 230, 11} true;
  assume {:verifier.code 0} true;
  $i35 := $uge.i64($i32,16);
  $i35.shadow := $uge.i64($i32.shadow,16);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 230, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !($i34 == 1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 341, 17} true;
  assume {:verifier.code 0} true;
  $p314 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(3,4));
  $p314.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 341, 17} true;
  assume {:verifier.code 0} true;
  assert ($p314 == $p314.shadow);
  $i315 := $load.i32($M.2,$p314);
  $i315.shadow := $load.i32($M.2.shadow,$p314.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 341, 2} true;
  assume {:verifier.code 0} true;
  call br_enc32be($p0, $p0.shadow, $i315, $i315.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 342, 16} true;
  assume {:verifier.code 0} true;
  $p316 := $add.ref($p0,$mul.ref(4,1));
  $p316.shadow := $add.ref($p0.shadow,$mul.ref(4,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 342, 21} true;
  assume {:verifier.code 0} true;
  $p317 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(2,4));
  $p317.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 342, 21} true;
  assume {:verifier.code 0} true;
  assert ($p317 == $p317.shadow);
  $i318 := $load.i32($M.2,$p317);
  $i318.shadow := $load.i32($M.2.shadow,$p317.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 342, 2} true;
  assume {:verifier.code 0} true;
  call br_enc32be($p316, $p316.shadow, $i318, $i318.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 343, 16} true;
  assume {:verifier.code 0} true;
  $p319 := $add.ref($p0,$mul.ref(8,1));
  $p319.shadow := $add.ref($p0.shadow,$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 343, 21} true;
  assume {:verifier.code 0} true;
  $p320 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(1,4));
  $p320.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 343, 21} true;
  assume {:verifier.code 0} true;
  assert ($p320 == $p320.shadow);
  $i321 := $load.i32($M.2,$p320);
  $i321.shadow := $load.i32($M.2.shadow,$p320.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 343, 2} true;
  assume {:verifier.code 0} true;
  call br_enc32be($p319, $p319.shadow, $i321, $i321.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 344, 16} true;
  assume {:verifier.code 0} true;
  $p322 := $add.ref($p0,$mul.ref(12,1));
  $p322.shadow := $add.ref($p0.shadow,$mul.ref(12,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 344, 22} true;
  assume {:verifier.code 0} true;
  $p323 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(0,4));
  $p323.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 344, 22} true;
  assume {:verifier.code 0} true;
  assert ($p323 == $p323.shadow);
  $i324 := $load.i32($M.2,$p323);
  $i324.shadow := $load.i32($M.2.shadow,$p323.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 344, 2} true;
  assume {:verifier.code 0} true;
  call br_enc32be($p322, $p322.shadow, $i324, $i324.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 345, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume ($i35 == 1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 232, 8} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($p33,$mul.ref(16,1));
  $p36.shadow := $add.ref($p33.shadow,$mul.ref(16,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 233, 8} true;
  assume {:verifier.code 0} true;
  $i37 := $sub.i64($i32,16);
  $i37.shadow := $sub.i64($i32.shadow,16);
  call {:cexpr "len"} boogie_si_record_i64($i37);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 234, 3} true;
  assume {:verifier.code 0} true;
  $i38 := $i37;
  $i38.shadow := $i37.shadow;
  $p39 := $p36;
  $p39.shadow := $p36.shadow;
  $p40 := $p33;
  $p40.shadow := $p33.shadow;
  goto $bb6;
$bb5:
  assume !($i35 == 1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 235, 4} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($add.ref($p6,$mul.ref(0,16)),$mul.ref(0,1));
  $p41.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 235, 4} true;
  assume {:verifier.code 0} true;
  assert ($p41 == $p41.shadow);
  assert ($p33 == $p33.shadow);
  assert ($i32 == $i32.shadow);
  call $M.1, $M.1.shadow := $memcpy.i8($M.1, $M.1.shadow, $M.1, $M.1.shadow, $p41, $p41.shadow, $p33, $p33.shadow, $i32, $i32.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 236, 11} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($add.ref($p6,$mul.ref(0,16)),$mul.ref(0,1));
  $p42.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  $p43 := $add.ref($add.ref($p6,$mul.ref(0,16)),$mul.ref($i32,1));
  $p43.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,16)),$mul.ref($i32.shadow,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 236, 38} true;
  assume {:verifier.code 0} true;
  $i44 := $sub.i64(16,$i32);
  $i44.shadow := $sub.i64(16,$i32.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 236, 4} true;
  assume {:verifier.code 0} true;
  assert ($p43 == $p43.shadow);
  assert ($i44 == $i44.shadow);
  call $M.1, $M.1.shadow := $memset.i8($M.1, $M.1.shadow, $p43, $p43.shadow, 0, 0, $i44, $i44.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 237, 10} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($add.ref($p6,$mul.ref(0,16)),$mul.ref(0,1));
  $p45.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:verifier.code 0} true;
  $i38 := 0;
  $i38.shadow := 0;
  $p39 := $p33;
  $p39.shadow := $p33.shadow;
  $p40 := $p6;
  $p40.shadow := $p6.shadow;
  goto $bb6;
$bb6:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 245, 12} true;
  assume {:verifier.code 0} true;
  call $i46, $i46.shadow := br_dec32be($p40, $p40.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 245, 3} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(3,4));
  $p47.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 245, 9} true;
  assume {:verifier.code 0} true;
  assert ($p47 == $p47.shadow);
  $i48 := $load.i32($M.2,$p47);
  $i48.shadow := $load.i32($M.2.shadow,$p47.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 245, 9} true;
  assume {:verifier.code 0} true;
  $i49 := $xor.i32($i48,$i46);
  ...
  assume {:verifier.code 0} true;
  assert ($p47 == $p47.shadow);
  $M.2 := $store.i32($M.2,$p47,$i49);
  $M.2.shadow := $store.i32($M.2.shadow,$p47.shadow,$i49.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 246, 27} true;
  assume {:verifier.code 0} true;
  $p50 := $add.ref($p40,$mul.ref(4,1));
  $p50.shadow := $add.ref($p40.shadow,$mul.ref(4,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 246, 12} true;
  assume {:verifier.code 0} true;
  call $i51, $i51.shadow := br_dec32be($p50, $p50.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 246, 3} true;
  assume {:verifier.code 0} true;
  $p52 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(2,4));
  $p52.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 246, 9} true;
  assume {:verifier.code 0} true;
  assert ($p52 == $p52.shadow);
  $i53 := $load.i32($M.2,$p52);
  $i53.shadow := $load.i32($M.2.shadow,$p52.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 246, 9} true;
  assume {:verifier.code 0} true;
  $i54 := $xor.i32($i53,$i51);
  $i54.shadow := $xor.i32($i53.shadow,$i51.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 246, 9} true;
  assume {:verifier.code 0} true;
  assert ($p52 == $p52.shadow);
  $M.2 := $store.i32($M.2,$p52,$i54);
  $M.2.shadow := $store.i32($M.2.shadow,$p52.shadow,$i54.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 247, 27} true;
  assume {:verifier.code 0} true;
  $p55 := $add.ref($p40,$mul.ref(8,1));
  $p55.shadow := $add.ref($p40.shadow,$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 247, 12} true;
  assume {:verifier.code 0} true;
  call $i56, $i56.shadow := br_dec32be($p55, $p55.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 247, 3} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(1,4));
  $p57.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 247, 9} true;
  assume {:verifier.code 0} true;
  assert ($p57 == $p57.shadow);
  $i58 := $load.i32($M.2,$p57);
  $i58.shadow := $load.i32($M.2.shadow,$p57.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 247, 9} true;
  assume {:verifier.code 0} true;
  $i59 := $xor.i32($i58,$i56);
  $i59.shadow := $xor.i32($i58.shadow,$i56.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 247, 9} true;
  assume {:verifier.code 0} true;
  assert ($p57 == $p57.shadow);
  $M.2 := $store.i32($M.2,$p57,$i59);
  $M.2.shadow := $store.i32($M.2.shadow,$p57.shadow,$i59.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 248, 27} true;
  assume {:verifier.code 0} true;
  $p60 := $add.ref($p40,$mul.ref(12,1));
  $p60.shadow := $add.ref($p40.shadow,$mul.ref(12,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 248, 12} true;
  assume {:verifier.code 0} true;
  call $i61, $i61.shadow := br_dec32be($p60, $p60.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 248, 3} true;
  assume {:verifier.code 0} true;
  $p62 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(0,4));
  $p62.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 248, 9} true;
  assume {:verifier.code 0} true;
  assert ($p62 == $p62.shadow);
  $i63 := $load.i32($M.2,$p62);
  $i63.shadow := $load.i32($M.2.shadow,$p62.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 248, 9} true;
  assume {:verifier.code 0} true;
  $i64 := $xor.i32($i63,$i61);
  $i64.shadow := $xor.i32($i63.shadow,$i61.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 248, 9} true;
  assume {:verifier.code 0} true;
  assert ($p62 == $p62.shadow);
  $M.2 := $store.i32($M.2,$p62,$i64);
  $M.2.shadow := $store.i32($M.2.shadow,$p62.shadow,$i64.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 262, 10} true;
  assume {:verifier.code 0} true;
  $p65 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(0,4));
  $p65.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 262, 10} true;
  assume {:verifier.code 0} true;
  assert ($p65 == $p65.shadow);
  $i66 := $load.i32($M.2,$p65);
  $i66.shadow := $load.i32($M.2.shadow,$p65.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 262, 3} true;
  assume {:verifier.code 0} true;
  $p67 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,4));
  $p67.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 262, 8} true;
  assume {:verifier.code 0} true;
  assert ($p67 == $p67.shadow);
  $M.7 := $store.i32($M.7,$p67,$i66);
  $M.7.shadow := $store.i32($M.7.shadow,$p67.shadow,$i66.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 263, 10} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(0,4));
  $p68.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 263, 10} true;
  assume {:verifier.code 0} true;
  assert ($p68 == $p68.shadow);
  $i69 := $load.i32($M.6,$p68);
  $i69.shadow := $load.i32($M.6.shadow,$p68.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 263, 3} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,4));
  $p70.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 263, 8} true;
  assume {:verifier.code 0} true;
  assert ($p70 == $p70.shadow);
  $M.8 := $store.i32($M.8,$p70,$i69);
  $M.8.shadow := $store.i32($M.8.shadow,$p70.shadow,$i69.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 264, 10} true;
  assume {:verifier.code 0} true;
  $p71 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(1,4));
  $p71.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 264, 10} true;
  assume {:verifier.code 0} true;
  assert ($p71 == $p71.shadow);
  $i72 := $load.i32($M.2,$p71);
  $i72.shadow := $load.i32($M.2.shadow,$p71.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 264, 3} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(1,4));
  $p73.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 264, 8} true;
  assume {:verifier.code 0} true;
  assert ($p73 == $p73.shadow);
  $M.7 := $store.i32($M.7,$p73,$i72);
  $M.7.shadow := $store.i32($M.7.shadow,$p73.shadow,$i72.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 265, 10} true;
  assume {:verifier.code 0} true;
  $p74 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(1,4));
  $p74.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 265, 10} true;
  assume {:verifier.code 0} true;
  assert ($p74 == $p74.shadow);
  $i75 := $load.i32($M.5,$p74);
  $i75.shadow := $load.i32($M.5.shadow,$p74.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 265, 3} true;
  assume {:verifier.code 0} true;
  $p76 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(1,4));
  $p76.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 265, 8} true;
  assume {:verifier.code 0} true;
  assert ($p76 == $p76.shadow);
  $M.8 := $store.i32($M.8,$p76,$i75);
  $M.8.shadow := $store.i32($M.8.shadow,$p76.shadow,$i75.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 266, 10} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,4));
  $p77.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 266, 10} true;
  assume {:verifier.code 0} true;
  assert ($p77 == $p77.shadow);
  $i78 := $load.i32($M.7,$p77);
  $i78.shadow := $load.i32($M.7.shadow,$p77.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 266, 17} true;
  assume {:verifier.code 0} true;
  $p79 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(1,4));
  $p79.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 266, 17} true;
  assume {:verifier.code 0} true;
  assert ($p79 == $p79.shadow);
  $i80 := $load.i32($M.7,$p79);
  $i80.shadow := $load.i32($M.7.shadow,$p79.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 266, 15} true;
  assume {:verifier.code 0} true;
  $i81 := $xor.i32($i78,$i80);
  $i81.shadow := $xor.i32($i78.shadow,$i80.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 266, 3} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(2,4));
  $p82.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 266, 8} true;
  assume {:verifier.code 0} true;
  assert ($p82 == $p82.shadow);
  $M.7 := $store.i32($M.7,$p82,$i81);
  $M.7.shadow := $store.i32($M.7.shadow,$p82.shadow,$i81.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 267, 10} true;
  assume {:verifier.code 0} true;
  $p83 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,4));
  $p83.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 267, 10} true;
  assume {:verifier.code 0} true;
  assert ($p83 == $p83.shadow);
  $i84 := $load.i32($M.8,$p83);
  $i84.shadow := $load.i32($M.8.shadow,$p83.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 267, 17} true;
  assume {:verifier.code 0} true;
  $p85 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(1,4));
  $p85.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 267, 17} true;
  assume {:verifier.code 0} true;
  assert ($p85 == $p85.shadow);
  $i86 := $load.i32($M.8,$p85);
  $i86.shadow := $load.i32($M.8.shadow,$p85.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 267, 15} true;
  assume {:verifier.code 0} true;
  $i87 := $xor.i32($i84,$i86);
  $i87.shadow := $xor.i32($i84.shadow,$i86.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 267, 3} true;
  assume {:verifier.code 0} true;
  $p88 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(2,4));
  $p88.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 267, 8} true;
  assume {:verifier.code 0} true;
  assert ($p88 == $p88.shadow);
  $M.8 := $store.i32($M.8,$p88,$i87);
  $M.8.shadow := $store.i32($M.8.shadow,$p88.shadow,$i87.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 269, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 269, 3} true;
  assume {:verifier.code 0} true;
  $p91 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(3,4));
  $p91.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 269, 8} true;
  assume {:verifier.code 0} true;
  assert ($p91 == $p91.shadow);
  $M.7 := $store.i32($M.7,$p91,$i90);
  $M.7.shadow := $store.i32($M.7.shadow,$p91.shadow,$i90.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 270, 10} true;
  assume {:verifier.code 0} true;
  $p92 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(2,4));
  $p92.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 270, 10} true;
  assume {:verifier.code 0} true;
  assert ($p92 == $p92.shadow);
  $i93 := $load.i32($M.4,$p92);
  $i93.shadow := $load.i32($M.4.shadow,$p92.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 270, 3} true;
  assume {:verifier.code 0} true;
  $p94 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(3,4));
  $p94.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 270, 8} true;
  assume {:verifier.code 0} true;
  assert ($p94 == $p94.shadow);
  $M.8 := $store.i32($M.8,$p94,$i93);
  $M.8.shadow := $store.i32($M.8.shadow,$p94.shadow,$i93.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 271, 10} true;
  assume {:verifier.code 0} true;
  $p95 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(3,4));
  $p95.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 271, 10} true;
  assume {:verifier.code 0} true;
  assert ($p95 == $p95.shadow);
  $i96 := $load.i32($M.2,$p95);
  $i96.shadow := $load.i32($M.2.shadow,$p95.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 271, 3} true;
  assume {:verifier.code 0} true;
  $p97 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(4,4));
  $p97.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 271, 8} true;
  assume {:verifier.code 0} true;
  assert ($p97 == $p97.shadow);
  $M.7 := $store.i32($M.7,$p97,$i96);
  $M.7.shadow := $store.i32($M.7.shadow,$p97.shadow,$i96.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 272, 10} true;
  assume {:verifier.code 0} true;
  $p98 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(3,4));
  $p98.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 272, 10} true;
  assume {:verifier.code 0} true;
  assert ($p98 == $p98.shadow);
  $i99 := $load.i32($M.3,$p98);
  $i99.shadow := $load.i32($M.3.shadow,$p98.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 272, 3} true;
  assume {:verifier.code 0} true;
  $p100 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(4,4));
  $p100.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 272, 8} true;
  assume {:verifier.code 0} true;
  assert ($p100 == $p100.shadow);
  $M.8 := $store.i32($M.8,$p100,$i99);
  $M.8.shadow := $store.i32($M.8.shadow,$p100.shadow,$i99.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 273, 10} true;
  assume {:verifier.code 0} true;
  $p101 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(3,4));
  $p101.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 273, 10} true;
  assume {:verifier.code 0} true;
  assert ($p101 == $p101.shadow);
  $i102 := $load.i32($M.7,$p101);
  $i102.shadow := $load.i32($M.7.shadow,$p101.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 273, 17} true;
  assume {:verifier.code 0} true;
  $p103 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(4,4));
  $p103.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 273, 17} true;
  assume {:verifier.code 0} true;
  assert ($p103 == $p103.shadow);
  $i104 := $load.i32($M.7,$p103);
  $i104.shadow := $load.i32($M.7.shadow,$p103.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 273, 15} true;
  assume {:verifier.code 0} true;
  $i105 := $xor.i32($i102,$i104);
  $i105.shadow := $xor.i32($i102.shadow,$i104.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 273, 3} true;
  assume {:verifier.code 0} true;
  $p106 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(5,4));
  $p106.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 273, 8} true;
  assume {:verifier.code 0} true;
  assert ($p106 == $p106.shadow);
  $M.7 := $store.i32($M.7,$p106,$i105);
  $M.7.shadow := $store.i32($M.7.shadow,$p106.shadow,$i105.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 274, 10} true;
  assume {:verifier.code 0} true;
  $p107 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(3,4));
  $p107.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 274, 10} true;
  assume {:verifier.code 0} true;
  assert ($p107 == $p107.shadow);
  $i108 := $load.i32($M.8,$p107);
  $i108.shadow := $load.i32($M.8.shadow,$p107.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 274, 17} true;
  assume {:verifier.code 0} true;
  $p109 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(4,4));
  $p109.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 274, 17} true;
  assume {:verifier.code 0} true;
  assert ($p109 == $p109.shadow);
  $i110 := $load.i32($M.8,$p109);
  $i110.shadow := $load.i32($M.8.shadow,$p109.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 274, 15} true;
  assume {:verifier.code 0} true;
  $i111 := $xor.i32($i108,$i110);
  $i111.shadow := $xor.i32($i108.shadow,$i110.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 274, 3} true;
  assume {:verifier.code 0} true;
  $p112 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(5,4));
  $p112.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 274, 8} true;
  assume {:verifier.code 0} true;
  assert ($p112 == $p112.shadow);
  $M.8 := $store.i32($M.8,$p112,$i111);
  $M.8.shadow := $store.i32($M.8.shadow,$p112.shadow,$i111.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 276, 10} true;
  assume {:verifier.code 0} true;
  $p113 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,4));
  $p113.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 276, 10} true;
  assume {:verifier.code 0} true;
  assert ($p113 == $p113.shadow);
  $i114 := $load.i32($M.7,$p113);
  $i114.shadow := $load.i32($M.7.shadow,$p113.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 276, 17} true;
  assume {:verifier.code 0} true;
  $p115 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(3,4));
  $p115.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 276, 17} true;
  assume {:verifier.code 0} true;
  assert ($p115 == $p115.shadow);
  $i116 := $load.i32($M.7,$p115);
  $i116.shadow := $load.i32($M.7.shadow,$p115.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 276, 15} true;
  assume {:verifier.code 0} true;
  $i117 := $xor.i32($i114,$i116);
  $i117.shadow := $xor.i32($i114.shadow,$i116.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 276, 3} true;
  assume {:verifier.code 0} true;
  $p118 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(6,4));
  $p118.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 276, 8} true;
  assume {:verifier.code 0} true;
  assert ($p118 == $p118.shadow);
  $M.7 := $store.i32($M.7,$p118,$i117);
  $M.7.shadow := $store.i32($M.7.shadow,$p118.shadow,$i117.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 277, 10} true;
  assume {:verifier.code 0} true;
  $p119 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,4));
  $p119.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 277, 10} true;
  assume {:verifier.code 0} true;
  assert ($p119 == $p119.shadow);
  $i120 := $load.i32($M.8,$p119);
  $i120.shadow := $load.i32($M.8.shadow,$p119.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 277, 17} true;
  assume {:verifier.code 0} true;
  $p121 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(3,4));
  $p121.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 277, 17} true;
  assume {:verifier.code 0} true;
  assert ($p121 == $p121.shadow);
  $i122 := $load.i32($M.8,$p121);
  $i122.shadow := $load.i32($M.8.shadow,$p121.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 277, 15} true;
  assume {:verifier.code 0} true;
  $i123 := $xor.i32($i120,$i122);
  $i123.shadow := $xor.i32($i120.shadow,$i122.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 277, 3} true;
  assume {:verifier.code 0} true;
  $p124 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(6,4));
  $p124.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 277, 8} true;
  assume {:verifier.code 0} true;
  assert ($p124 == $p124.shadow);
  $M.8 := $store.i32($M.8,$p124,$i123);
  $M.8.shadow := $store.i32($M.8.shadow,$p124.shadow,$i123.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 278, 10} true;
  assume {:verifier.code 0} true;
  $p125 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(1,4));
  $p125.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 278, 10} true;
  assume {:verifier.code 0} true;
  assert ($p125 == $p125.shadow);
  $i126 := $load.i32($M.7,$p125);
  $i126.shadow := $load.i32($M.7.shadow,$p125.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 278, 17} true;
  assume {:verifier.code 0} true;
  $p127 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(4,4));
  $p127.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 278, 17} true;
  assume {:verifier.code 0} true;
  assert ($p127 == $p127.shadow);
  $i128 := $load.i32($M.7,$p127);
  $i128.shadow := $load.i32($M.7.shadow,$p127.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 278, 15} true;
  assume {:verifier.code 0} true;
  $i129 := $xor.i32($i126,$i128);
  $i129.shadow := $xor.i32($i126.shadow,$i128.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 278, 3} true;
  assume {:verifier.code 0} true;
  $p130 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(7,4));
  $p130.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 278, 8} true;
  assume {:verifier.code 0} true;
  assert ($p130 == $p130.shadow);
  $M.7 := $store.i32($M.7,$p130,$i129);
  $M.7.shadow := $store.i32($M.7.shadow,$p130.shadow,$i129.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 279, 10} true;
  assume {:verifier.code 0} true;
  $p131 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(1,4));
  $p131.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 279, 10} true;
  assume {:verifier.code 0} true;
  assert ($p131 == $p131.shadow);
  $i132 := $load.i32($M.8,$p131);
  $i132.shadow := $load.i32($M.8.shadow,$p131.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 279, 17} true;
  assume {:verifier.code 0} true;
  $p133 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(4,4));
  $p133.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 279, 17} true;
  assume {:verifier.code 0} true;
  assert ($p133 == $p133.shadow);
  $i134 := $load.i32($M.8,$p133);
  $i134.shadow := $load.i32($M.8.shadow,$p133.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 279, 15} true;
  assume {:verifier.code 0} true;
  $i135 := $xor.i32($i132,$i134);
  $i135.shadow := $xor.i32($i132.shadow,$i134.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 279, 3} true;
  assume {:verifier.code 0} true;
  $p136 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(7,4));
  $p136.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 279, 8} true;
  assume {:verifier.code 0} true;
  assert ($p136 == $p136.shadow);
  $M.8 := $store.i32($M.8,$p136,$i135);
  $M.8.shadow := $store.i32($M.8.shadow,$p136.shadow,$i135.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 280, 10} true;
  assume {:verifier.code 0} true;
  $p137 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(6,4));
  $p137.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 280, 10} true;
  assume {:verifier.code 0} true;
  assert ($p137 == $p137.shadow);
  $i138 := $load.i32($M.7,$p137);
  $i138.shadow := $load.i32($M.7.shadow,$p137.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 280, 17} true;
  assume {:verifier.code 0} true;
  $p139 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(7,4));
  $p139.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 280, 17} true;
  assume {:verifier.code 0} true;
  assert ($p139 == $p139.shadow);
  $i140 := $load.i32($M.7,$p139);
  $i140.shadow := $load.i32($M.7.shadow,$p139.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 280, 15} true;
  assume {:verifier.code 0} true;
  $i141 := $xor.i32($i138,$i140);
  $i141.shadow := $xor.i32($i138.shadow,$i140.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 280, 3} true;
  assume {:verifier.code 0} true;
  $p142 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(8,4));
  $p142.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(8,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 280, 8} true;
  assume {:verifier.code 0} true;
  assert ($p142 == $p142.shadow);
  $M.7 := $store.i32($M.7,$p142,$i141);
  $M.7.shadow := $store.i32($M.7.shadow,$p142.shadow,$i141.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 281, 10} true;
  assume {:verifier.code 0} true;
  $p143 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(6,4));
  $p143.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 281, 10} true;
  assume {:verifier.code 0} true;
  assert ($p143 == $p143.shadow);
  $i144 := $load.i32($M.8,$p143);
  $i144.shadow := $load.i32($M.8.shadow,$p143.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 281, 17} true;
  assume {:verifier.code 0} true;
  $p145 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(7,4));
  $p145.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 281, 17} true;
  assume {:verifier.code 0} true;
  assert ($p145 == $p145.shadow);
  $i146 := $load.i32($M.8,$p145);
  $i146.shadow := $load.i32($M.8.shadow,$p145.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 281, 15} true;
  assume {:verifier.code 0} true;
  $i147 := $xor.i32($i144,$i146);
  $i147.shadow := $xor.i32($i144.shadow,$i146.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 281, 3} true;
  assume {:verifier.code 0} true;
  $p148 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(8,4));
  $p148.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(8,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 281, 8} true;
  assume {:verifier.code 0} true;
  assert ($p148 == $p148.shadow);
  $M.8 := $store.i32($M.8,$p148,$i147);
  $M.8.shadow := $store.i32($M.8.shadow,$p148.shadow,$i147.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 283, 8} true;
  assume {:verifier.code 0} true;
  $i149 := 0;
  $i149.shadow := 0;
  goto $bb7;
$bb7:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($p9 == $p9.shadow);
  assert {:shadow_invariant} ($i149 == $i149.shadow);
  assert {:shadow_invariant} ($p8 == $p8.shadow);
  assert {:shadow_invariant} ($p7 == $p7.shadow);
  ...
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 283, 17} true;
  assume {:verifier.code 0} true;
  $i150 := $slt.i32($i149,9);
  $i150.shadow := $slt.i32($i149.shadow,9);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 283, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i150} true;
  assert ($i150 == $i150.shadow);
  goto $bb8, $bb9;
$bb8:
  assume ($i150 == 1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 10} true;
  assume {:verifier.code 0} true;
  $i151 := $sext.i32.i64($i149);
  $i151.shadow := $sext.i32.i64($i149.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 10} true;
  assume {:verifier.code 0} true;
  $p152 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref($i151,4));
  $p152.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref($i151.shadow,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 17} true;
  assume {:verifier.code 0} true;
  $i153 := $sext.i32.i64($i149);
  $i153.shadow := $sext.i32.i64($i149.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 17} true;
  assume {:verifier.code 0} true;
  $p154 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref($i153,4));
  $p154.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref($i153.shadow,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 23} true;
  assume {:verifier.code 0} true;
  $i155 := $sext.i32.i64($i149);
  $i155.shadow := $sext.i32.i64($i149.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 23} true;
  assume {:verifier.code 0} true;
  $p156 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref($i155,4));
  $p156.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref($i155.shadow,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 23} true;
  assume {:verifier.code 0} true;
  assert ($p156 == $p156.shadow);
  $i157 := $load.i32($M.8,$p156);
  $i157.shadow := $load.i32($M.8.shadow,$p156.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 29} true;
  assume {:verifier.code 0} true;
  $i158 := $sext.i32.i64($i149);
  $i158.shadow := $sext.i32.i64($i149.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 29} true;
  assume {:verifier.code 0} true;
  $p159 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref($i158,4));
  $p159.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref($i158.shadow,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 29} true;
  assume {:verifier.code 0} true;
  assert ($p159 == $p159.shadow);
  $i160 := $load.i32($M.7,$p159);
  $i160.shadow := $load.i32($M.7.shadow,$p159.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 4} true;
  assume {:verifier.code 0} true;
  call bmul($p152, $p152.shadow, $p154, $p154.shadow, $i157, $i157.shadow, $i160, $i160.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 285, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !($i150 == 1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 287, 8} true;
  assume {:verifier.code 0} true;
  $p162 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,4));
  $p162.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 287, 8} true;
  assume {:verifier.code 0} true;
  assert ($p162 == $p162.shadow);
  $i163 := $load.i32($M.7,$p162);
  $i163.shadow := $load.i32($M.7.shadow,$p162.shadow);
  call {:cexpr "c0"} boogie_si_record_i32($i163);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 288, 8} true;
  assume {:verifier.code 0} true;
  $p164 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,4));
  $p164.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 288, 8} true;
  assume {:verifier.code 0} true;
  assert ($p164 == $p164.shadow);
  $i165 := $load.i32($M.8,$p164);
  $i165.shadow := $load.i32($M.8.shadow,$p164.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 288, 15} true;
  assume {:verifier.code 0} true;
  $p166 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(2,4));
  $p166.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 288, 15} true;
  assume {:verifier.code 0} true;
  assert ($p166 == $p166.shadow);
  $i167 := $load.i32($M.7,$p166);
  $i167.shadow := $load.i32($M.7.shadow,$p166.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 288, 13} true;
  assume {:verifier.code 0} true;
  $i168 := $xor.i32($i165,$i167);
  $i168.shadow := $xor.i32($i165.shadow,$i167.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 288, 22} true;
  assume {:verifier.code 0} true;
  $p169 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(0,4));
  $p169.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 288, 22} true;
  assume {:verifier.code 0} true;
  assert ($p169 == $p169.shadow);
  $i170 := $load.i32($M.7,$p169);
  $i170.shadow := $load.i32($M.7.shadow,$p169.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 288, 20} true;
  assume {:verifier.code 0} true;
  $i171 := $xor.i32($i168,$i170);
  $i171.shadow := $xor.i32($i168.shadow,$i170.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 288, 29} true;
  assume {:verifier.code 0} true;
  $p172 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(1,4));
  $p172.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 288, 29} true;
  assume {:verifier.code 0} true;
  assert ($p172 == $p172.shadow);
  $i173 := $load.i32($M.7,$p172);
  $i173.shadow := $load.i32($M.7.shadow,$p172.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 288, 27} true;
  assume {:verifier.code 0} true;
  $i174 := $xor.i32($i171,$i173);
  $i174.shadow := $xor.i32($i171.shadow,$i173.shadow);
  call {:cexpr "c1"} boogie_si_record_i32($i174);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 289, 8} true;
  assume {:verifier.code 0} true;
  $p175 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(1,4));
  $p175.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 289, 8} true;
  assume {:verifier.code 0} true;
  assert ($p175 == $p175.shadow);
  $i176 := $load.i32($M.7,$p175);
  $i176.shadow := $load.i32($M.7.shadow,$p175.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 289, 15} true;
  assume {:verifier.code 0} true;
  $p177 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(2,4));
  $p177.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 289, 15} true;
  assume {:verifier.code 0} true;
  assert ($p177 == $p177.shadow);
  $i178 := $load.i32($M.8,$p177);
  $i178.shadow := $load.i32($M.8.shadow,$p177.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 289, 13} true;
  assume {:verifier.code 0} true;
  $i179 := $xor.i32($i176,$i178);
  $i179.shadow := $xor.i32($i176.shadow,$i178.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 289, 22} true;
  assume {:verifier.code 0} true;
  $p180 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(0,4));
  $p180.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 289, 22} true;
  assume {:verifier.code 0} true;
  assert ($p180 == $p180.shadow);
  $i181 := $load.i32($M.8,$p180);
  $i181.shadow := $load.i32($M.8.shadow,$p180.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 289, 20} true;
  assume {:verifier.code 0} true;
  $i182 := $xor.i32($i179,$i181);
  $i182.shadow := $xor.i32($i179.shadow,$i181.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 289, 29} true;
  assume {:verifier.code 0} true;
  $p183 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(1,4));
  $p183.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 289, 29} true;
  assume {:verifier.code 0} true;
  assert ($p183 == $p183.shadow);
  $i184 := $load.i32($M.8,$p183);
  $i184.shadow := $load.i32($M.8.shadow,$p183.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 289, 27} true;
  assume {:verifier.code 0} true;
  $i185 := $xor.i32($i182,$i184);
  $i185.shadow := $xor.i32($i182.shadow,$i184.shadow);
  call {:cexpr "c2"} boogie_si_record_i32($i185);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 290, 8} true;
  assume {:verifier.code 0} true;
  $p186 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(1,4));
  $p186.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 290, 8} true;
  assume {:verifier.code 0} true;
  assert ($p186 == $p186.shadow);
  $i187 := $load.i32($M.8,$p186);
  $i187.shadow := $load.i32($M.8.shadow,$p186.shadow);
  call {:cexpr "c3"} boogie_si_record_i32($i187);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 291, 8} true;
  assume {:verifier.code 0} true;
  $p188 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(3,4));
  $p188.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 291, 8} true;
  assume {:verifier.code 0} true;
  assert ($p188 == $p188.shadow);
  $i189 := $load.i32($M.7,$p188);
  $i189.shadow := $load.i32($M.7.shadow,$p188.shadow);
  call {:cexpr "d0"} boogie_si_record_i32($i189);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 292, 8} true;
  assume {:verifier.code 0} true;
  $p190 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(3,4));
  $p190.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 292, 8} true;
  assume {:verifier.code 0} true;
  assert ($p190 == $p190.shadow);
  $i191 := $load.i32($M.8,$p190);
  $i191.shadow := $load.i32($M.8.shadow,$p190.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 292, 15} true;
  assume {:verifier.code 0} true;
  $p192 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(5,4));
  $p192.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 292, 15} true;
  assume {:verifier.code 0} true;
  assert ($p192 == $p192.shadow);
  $i193 := $load.i32($M.7,$p192);
  $i193.shadow := $load.i32($M.7.shadow,$p192.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 292, 13} true;
  assume {:verifier.code 0} true;
  $i194 := $xor.i32($i191,$i193);
  $i194.shadow := $xor.i32($i191.shadow,$i193.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 292, 22} true;
  assume {:verifier.code 0} true;
  $p195 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(3,4));
  $p195.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 292, 22} true;
  assume {:verifier.code 0} true;
  assert ($p195 == $p195.shadow);
  $i196 := $load.i32($M.7,$p195);
  $i196.shadow := $load.i32($M.7.shadow,$p195.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 292, 20} true;
  assume {:verifier.code 0} true;
  $i197 := $xor.i32($i194,$i196);
  $i197.shadow := $xor.i32($i194.shadow,$i196.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 292, 29} true;
  assume {:verifier.code 0} true;
  $p198 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(4,4));
  $p198.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 292, 29} true;
  assume {:verifier.code 0} true;
  assert ($p198 == $p198.shadow);
  $i199 := $load.i32($M.7,$p198);
  $i199.shadow := $load.i32($M.7.shadow,$p198.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 292, 27} true;
  assume {:verifier.code 0} true;
  $i200 := $xor.i32($i197,$i199);
  $i200.shadow := $xor.i32($i197.shadow,$i199.shadow);
  call {:cexpr "d1"} boogie_si_record_i32($i200);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 8} true;
  assume {:verifier.code 0} true;
  $p201 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(4,4));
  $p201.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 8} true;
  assume {:verifier.code 0} true;
  assert ($p201 == $p201.shadow);
  $i202 := $load.i32($M.7,$p201);
  $i202.shadow := $load.i32($M.7.shadow,$p201.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 15} true;
  assume {:verifier.code 0} true;
  $p203 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(5,4));
  $p203.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 15} true;
  assume {:verifier.code 0} true;
  assert ($p203 == $p203.shadow);
  $i204 := $load.i32($M.8,$p203);
  $i204.shadow := $load.i32($M.8.shadow,$p203.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 13} true;
  assume {:verifier.code 0} true;
  $i205 := $xor.i32($i202,$i204);
  $i205.shadow := $xor.i32($i202.shadow,$i204.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 22} true;
  assume {:verifier.code 0} true;
  $p206 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(3,4));
  $p206.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 22} true;
  assume {:verifier.code 0} true;
  assert ($p206 == $p206.shadow);
  $i207 := $load.i32($M.8,$p206);
  $i207.shadow := $load.i32($M.8.shadow,$p206.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 20} true;
  assume {:verifier.code 0} true;
  $i208 := $xor.i32($i205,$i207);
  $i208.shadow := $xor.i32($i205.shadow,$i207.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 29} true;
  assume {:verifier.code 0} true;
  $p209 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(4,4));
  $p209.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 29} true;
  assume {:verifier.code 0} true;
  assert ($p209 == $p209.shadow);
  $i210 := $load.i32($M.8,$p209);
  $i210.shadow := $load.i32($M.8.shadow,$p209.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 27} true;
  assume {:verifier.code 0} true;
  $i211 := $xor.i32($i208,$i210);
  $i211.shadow := $xor.i32($i208.shadow,$i210.shadow);
  call {:cexpr "d2"} boogie_si_record_i32($i211);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 294, 8} true;
  assume {:verifier.code 0} true;
  $p212 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(4,4));
  $p212.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 294, 8} true;
  assume {:verifier.code 0} true;
  assert ($p212 == $p212.shadow);
  $i213 := $load.i32($M.8,$p212);
  $i213.shadow := $load.i32($M.8.shadow,$p212.shadow);
  call {:cexpr "d3"} boogie_si_record_i32($i213);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 295, 8} true;
  assume {:verifier.code 0} true;
  $p214 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(6,4));
  $p214.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 295, 8} true;
  assume {:verifier.code 0} true;
  assert ($p214 == $p214.shadow);
  $i215 := $load.i32($M.7,$p214);
  $i215.shadow := $load.i32($M.7.shadow,$p214.shadow);
  call {:cexpr "e0"} boogie_si_record_i32($i215);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 296, 8} true;
  assume {:verifier.code 0} true;
  $p216 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(6,4));
  $p216.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 296, 8} true;
  assume {:verifier.code 0} true;
  assert ($p216 == $p216.shadow);
  $i217 := $load.i32($M.8,$p216);
  $i217.shadow := $load.i32($M.8.shadow,$p216.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 296, 15} true;
  assume {:verifier.code 0} true;
  $p218 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(8,4));
  $p218.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(8,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 296, 15} true;
  assume {:verifier.code 0} true;
  assert ($p218 == $p218.shadow);
  $i219 := $load.i32($M.7,$p218);
  $i219.shadow := $load.i32($M.7.shadow,$p218.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 296, 13} true;
  assume {:verifier.code 0} true;
  $i220 := $xor.i32($i217,$i219);
  $i220.shadow := $xor.i32($i217.shadow,$i219.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 296, 22} true;
  assume {:verifier.code 0} true;
  $p221 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(6,4));
  $p221.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 296, 22} true;
  assume {:verifier.code 0} true;
  assert ($p221 == $p221.shadow);
  $i222 := $load.i32($M.7,$p221);
  $i222.shadow := $load.i32($M.7.shadow,$p221.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 296, 20} true;
  assume {:verifier.code 0} true;
  $i223 := $xor.i32($i220,$i222);
  $i223.shadow := $xor.i32($i220.shadow,$i222.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 296, 29} true;
  assume {:verifier.code 0} true;
  $p224 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(7,4));
  $p224.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 296, 29} true;
  assume {:verifier.code 0} true;
  assert ($p224 == $p224.shadow);
  $i225 := $load.i32($M.7,$p224);
  $i225.shadow := $load.i32($M.7.shadow,$p224.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 296, 27} true;
  assume {:verifier.code 0} true;
  $i226 := $xor.i32($i223,$i225);
  $i226.shadow := $xor.i32($i223.shadow,$i225.shadow);
  call {:cexpr "e1"} boogie_si_record_i32($i226);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 297, 8} true;
  assume {:verifier.code 0} true;
  $p227 := $add.ref($add.ref($p7,$mul.ref(0,36)),$mul.ref(7,4));
  $p227.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,36)),$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 297, 8} true;
  assume {:verifier.code 0} true;
  assert ($p227 == $p227.shadow);
  $i228 := $load.i32($M.7,$p227);
  $i228.shadow := $load.i32($M.7.shadow,$p227.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 297, 15} true;
  assume {:verifier.code 0} true;
  $p229 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(8,4));
  $p229.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(8,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 297, 15} true;
  assume {:verifier.code 0} true;
  assert ($p229 == $p229.shadow);
  $i230 := $load.i32($M.8,$p229);
  $i230.shadow := $load.i32($M.8.shadow,$p229.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 297, 13} true;
  assume {:verifier.code 0} true;
  $i231 := $xor.i32($i228,$i230);
  $i231.shadow := $xor.i32($i228.shadow,$i230.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 297, 22} true;
  assume {:verifier.code 0} true;
  $p232 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(6,4));
  $p232.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 297, 22} true;
  assume {:verifier.code 0} true;
  assert ($p232 == $p232.shadow);
  $i233 := $load.i32($M.8,$p232);
  $i233.shadow := $load.i32($M.8.shadow,$p232.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 297, 20} true;
  assume {:verifier.code 0} true;
  $i234 := $xor.i32($i231,$i233);
  $i234.shadow := $xor.i32($i231.shadow,$i233.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 297, 29} true;
  assume {:verifier.code 0} true;
  $p235 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(7,4));
  $p235.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 297, 29} true;
  assume {:verifier.code 0} true;
  assert ($p235 == $p235.shadow);
  $i236 := $load.i32($M.8,$p235);
  $i236.shadow := $load.i32($M.8.shadow,$p235.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 297, 27} true;
  assume {:verifier.code 0} true;
  $i237 := $xor.i32($i234,$i236);
  $i237.shadow := $xor.i32($i234.shadow,$i236.shadow);
  call {:cexpr "e2"} boogie_si_record_i32($i237);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 298, 8} true;
  assume {:verifier.code 0} true;
  $p238 := $add.ref($add.ref($p8,$mul.ref(0,36)),$mul.ref(7,4));
  $p238.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,36)),$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 298, 8} true;
  assume {:verifier.code 0} true;
  assert ($p238 == $p238.shadow);
  $i239 := $load.i32($M.8,$p238);
  $i239.shadow := $load.i32($M.8.shadow,$p238.shadow);
  call {:cexpr "e3"} boogie_si_record_i32($i239);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 300, 12} true;
  assume {:verifier.code 0} true;
  $i240 := $xor.i32($i163,$i189);
  $i240.shadow := $xor.i32($i163.shadow,$i189.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 300, 6} true;
  assume {:verifier.code 0} true;
  $i241 := $xor.i32($i215,$i240);
  $i241.shadow := $xor.i32($i215.shadow,$i240.shadow);
  call {:cexpr "e0"} boogie_si_record_i32($i241);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 301, 12} true;
  assume {:verifier.code 0} true;
  $i242 := $xor.i32($i174,$i200);
  $i242.shadow := $xor.i32($i174.shadow,$i200.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 301, 6} true;
  assume {:verifier.code 0} true;
  $i243 := $xor.i32($i226,$i242);
  $i243.shadow := $xor.i32($i226.shadow,$i242.shadow);
  call {:cexpr "e1"} boogie_si_record_i32($i243);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 302, 12} true;
  assume {:verifier.code 0} true;
  $i244 := $xor.i32($i185,$i211);
  $i244.shadow := $xor.i32($i185.shadow,$i211.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 302, 6} true;
  assume {:verifier.code 0} true;
  $i245 := $xor.i32($i237,$i244);
  $i245.shadow := $xor.i32($i237.shadow,$i244.shadow);
  call {:cexpr "e2"} boogie_si_record_i32($i245);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 303, 12} true;
  assume {:verifier.code 0} true;
  $i246 := $xor.i32($i187,$i213);
  $i246.shadow := $xor.i32($i187.shadow,$i213.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 303, 6} true;
  assume {:verifier.code 0} true;
  $i247 := $xor.i32($i239,$i246);
  $i247.shadow := $xor.i32($i239.shadow,$i246.shadow);
  call {:cexpr "e3"} boogie_si_record_i32($i247);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 304, 6} true;
  assume {:verifier.code 0} true;
  $i248 := $xor.i32($i185,$i241);
  $i248.shadow := $xor.i32($i185.shadow,$i241.shadow);
  call {:cexpr "c2"} boogie_si_record_i32($i248);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 305, 6} true;
  assume {:verifier.code 0} true;
  $i249 := $xor.i32($i187,$i243);
  $i249.shadow := $xor.i32($i187.shadow,$i243.shadow);
  call {:cexpr "c3"} boogie_si_record_i32($i249);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 306, 6} true;
  assume {:verifier.code 0} true;
  $i250 := $xor.i32($i189,$i245);
  $i250.shadow := $xor.i32($i189.shadow,$i245.shadow);
  call {:cexpr "d0"} boogie_si_record_i32($i250);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 307, 6} true;
  assume {:verifier.code 0} true;
  $i251 := $xor.i32($i200,$i247);
  $i251.shadow := $xor.i32($i200.shadow,$i247.shadow);
  call {:cexpr "d1"} boogie_si_record_i32($i251);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 315, 14} true;
  assume {:verifier.code 0} true;
  $i252 := $shl.i32($i163,1);
  $i252.shadow := $shl.i32($i163.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 315, 3} true;
  assume {:verifier.code 0} true;
  $p253 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,4));
  $p253.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 315, 9} true;
  assume {:verifier.code 0} true;
  assert ($p253 == $p253.shadow);
  $M.9 := $store.i32($M.9,$p253,$i252);
  $M.9.shadow := $store.i32($M.9.shadow,$p253.shadow,$i252.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 316, 15} true;
  assume {:verifier.code 0} true;
  $i254 := $shl.i32($i174,1);
  $i254.shadow := $shl.i32($i174.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 316, 27} true;
  assume {:verifier.code 0} true;
  $i255 := $lshr.i32($i163,31);
  $i255.shadow := $lshr.i32($i163.shadow,31);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 316, 21} true;
  assume {:verifier.code 0} true;
  $i256 := $or.i32($i254,$i255);
  $i256.shadow := $or.i32($i254.shadow,$i255.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 316, 3} true;
  assume {:verifier.code 0} true;
  $p257 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(1,4));
  $p257.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 316, 9} true;
  assume {:verifier.code 0} true;
  assert ($p257 == $p257.shadow);
  $M.9 := $store.i32($M.9,$p257,$i256);
  $M.9.shadow := $store.i32($M.9.shadow,$p257.shadow,$i256.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 317, 15} true;
  assume {:verifier.code 0} true;
  $i258 := $shl.i32($i248,1);
  $i258.shadow := $shl.i32($i248.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 317, 27} true;
  assume {:verifier.code 0} true;
  $i259 := $lshr.i32($i174,31);
  $i259.shadow := $lshr.i32($i174.shadow,31);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 317, 21} true;
  assume {:verifier.code 0} true;
  $i260 := $or.i32($i258,$i259);
  $i260.shadow := $or.i32($i258.shadow,$i259.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 317, 3} true;
  assume {:verifier.code 0} true;
  $p261 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(2,4));
  $p261.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 317, 9} true;
  assume {:verifier.code 0} true;
  assert ($p261 == $p261.shadow);
  $M.9 := $store.i32($M.9,$p261,$i260);
  $M.9.shadow := $store.i32($M.9.shadow,$p261.shadow,$i260.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 318, 15} true;
  assume {:verifier.code 0} true;
  $i262 := $shl.i32($i249,1);
  $i262.shadow := $shl.i32($i249.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 318, 27} true;
  assume {:verifier.code 0} true;
  $i263 := $lshr.i32($i248,31);
  $i263.shadow := $lshr.i32($i248.shadow,31);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 318, 21} true;
  assume {:verifier.code 0} true;
  $i264 := $or.i32($i262,$i263);
  $i264.shadow := $or.i32($i262.shadow,$i263.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 318, 3} true;
  assume {:verifier.code 0} true;
  $p265 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(3,4));
  $p265.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 318, 9} true;
  assume {:verifier.code 0} true;
  assert ($p265 == $p265.shadow);
  $M.9 := $store.i32($M.9,$p265,$i264);
  $M.9.shadow := $store.i32($M.9.shadow,$p265.shadow,$i264.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 319, 15} true;
  assume {:verifier.code 0} true;
  $i266 := $shl.i32($i250,1);
  $i266.shadow := $shl.i32($i250.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 319, 27} true;
  assume {:verifier.code 0} true;
  $i267 := $lshr.i32($i249,31);
  $i267.shadow := $lshr.i32($i249.shadow,31);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 319, 21} true;
  assume {:verifier.code 0} true;
  $i268 := $or.i32($i266,$i267);
  $i268.shadow := $or.i32($i266.shadow,$i267.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 319, 3} true;
  assume {:verifier.code 0} true;
  $p269 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(4,4));
  $p269.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 319, 9} true;
  assume {:verifier.code 0} true;
  assert ($p269 == $p269.shadow);
  $M.9 := $store.i32($M.9,$p269,$i268);
  $M.9.shadow := $store.i32($M.9.shadow,$p269.shadow,$i268.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 320, 15} true;
  assume {:verifier.code 0} true;
  $i270 := $shl.i32($i251,1);
  $i270.shadow := $shl.i32($i251.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 320, 27} true;
  assume {:verifier.code 0} true;
  $i271 := $lshr.i32($i250,31);
  $i271.shadow := $lshr.i32($i250.shadow,31);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 320, 21} true;
  assume {:verifier.code 0} true;
  $i272 := $or.i32($i270,$i271);
  $i272.shadow := $or.i32($i270.shadow,$i271.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 320, 3} true;
  assume {:verifier.code 0} true;
  $p273 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(5,4));
  $p273.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 320, 9} true;
  assume {:verifier.code 0} true;
  assert ($p273 == $p273.shadow);
  $M.9 := $store.i32($M.9,$p273,$i272);
  $M.9.shadow := $store.i32($M.9.shadow,$p273.shadow,$i272.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 321, 15} true;
  assume {:verifier.code 0} true;
  $i274 := $shl.i32($i211,1);
  $i274.shadow := $shl.i32($i211.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 321, 27} true;
  assume {:verifier.code 0} true;
  $i275 := $lshr.i32($i251,31);
  $i275.shadow := $lshr.i32($i251.shadow,31);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 321, 21} true;
  assume {:verifier.code 0} true;
  $i276 := $or.i32($i274,$i275);
  $i276.shadow := $or.i32($i274.shadow,$i275.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 321, 3} true;
  assume {:verifier.code 0} true;
  $p277 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(6,4));
  $p277.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 321, 9} true;
  assume {:verifier.code 0} true;
  assert ($p277 == $p277.shadow);
  $M.9 := $store.i32($M.9,$p277,$i276);
  $M.9.shadow := $store.i32($M.9.shadow,$p277.shadow,$i276.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 322, 15} true;
  assume {:verifier.code 0} true;
  $i278 := $shl.i32($i213,1);
  $i278.shadow := $shl.i32($i213.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 322, 27} true;
  assume {:verifier.code 0} true;
  $i279 := $lshr.i32($i211,31);
  $i279.shadow := $lshr.i32($i211.shadow,31);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 322, 21} true;
  assume {:verifier.code 0} true;
  $i280 := $or.i32($i278,$i279);
  $i280.shadow := $or.i32($i278.shadow,$i279.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 322, 3} true;
  assume {:verifier.code 0} true;
  $p281 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(7,4));
  $p281.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 322, 9} true;
  assume {:verifier.code 0} true;
  assert ($p281 == $p281.shadow);
  $M.9 := $store.i32($M.9,$p281,$i280);
  $M.9.shadow := $store.i32($M.9.shadow,$p281.shadow,$i280.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 328, 8} true;
  assume {:verifier.code 0} true;
  $i282 := 0;
  $i282.shadow := 0;
  goto $bb11;
$bb10:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 283, 24} true;
  assume {:verifier.code 0} true;
  $i161 := $add.i32($i149,1);
  $i161.shadow := $add.i32($i149.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i161);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 283, 3} true;
  assume {:verifier.code 0} true;
  $i149 := $i161;
  $i149.shadow := $i161.shadow;
  goto $bb7;
$bb11:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i282 == $i282.shadow);
  assert {:shadow_invariant} ($p9 == $p9.shadow);
  assert {:shadow_invariant} ($p8 == $p8.shadow);
  assert {:shadow_invariant} ($p7 == $p7.shadow);
  assert {:shadow_invariant} ($p39 == $p39.shadow);
  ...
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 328, 17} true;
  assume {:verifier.code 0} true;
  $i283 := $slt.i32($i282,4);
  $i283.shadow := $slt.i32($i282.shadow,4);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 328, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i283} true;
  assert ($i283 == $i283.shadow);
  goto $bb12, $bb13;
$bb12:
  assume ($i283 == 1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 331, 9} true;
  assume {:verifier.code 0} true;
  $i284 := $sext.i32.i64($i282);
  $i284.shadow := $sext.i32.i64($i282.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 331, 9} true;
  assume {:verifier.code 0} true;
  $p285 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref($i284,4));
  $p285.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref($i284.shadow,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 331, 9} true;
  assume {:verifier.code 0} true;
  assert ($p285 == $p285.shadow);
  $i286 := $load.i32($M.9,$p285);
  $i286.shadow := $load.i32($M.9.shadow,$p285.shadow);
  call {:cexpr "lw"} boogie_si_record_i32($i286);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 332, 26} true;
  assume {:verifier.code 0} true;
  $i287 := $lshr.i32($i286,1);
  $i287.shadow := $lshr.i32($i286.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 332, 20} true;
  assume {:verifier.code 0} true;
  $i288 := $xor.i32($i286,$i287);
  $i288.shadow := $xor.i32($i286.shadow,$i287.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 332, 38} true;
  assume {:verifier.code 0} true;
  $i289 := $lshr.i32($i286,2);
  $i289.shadow := $lshr.i32($i286.shadow,2);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 332, 32} true;
  assume {:verifier.code 0} true;
  $i290 := $xor.i32($i288,$i289);
  $i290.shadow := $xor.i32($i288.shadow,$i289.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 332, 50} true;
  assume {:verifier.code 0} true;
  $i291 := $lshr.i32($i286,7);
  $i291.shadow := $lshr.i32($i286.shadow,7);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 332, 44} true;
  assume {:verifier.code 0} true;
  $i292 := $xor.i32($i290,$i291);
  $i292.shadow := $xor.i32($i290.shadow,$i291.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 332, 9} true;
  assume {:verifier.code 0} true;
  $i293 := $add.i32($i282,4);
  $i293.shadow := $add.i32($i282.shadow,4);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 332, 4} true;
  assume {:verifier.code 0} true;
  $i294 := $sext.i32.i64($i293);
  $i294.shadow := $sext.i32.i64($i293.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 332, 4} true;
  assume {:verifier.code 0} true;
  $p295 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref($i294,4));
  $p295.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref($i294.shadow,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 332, 14} true;
  assume {:verifier.code 0} true;
  assert ($p295 == $p295.shadow);
  $i296 := $load.i32($M.9,$p295);
  $i296.shadow := $load.i32($M.9.shadow,$p295.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 332, 14} true;
  assume {:verifier.code 0} true;
  $i297 := $xor.i32($i296,$i292);
  $i297.shadow := $xor.i32($i296.shadow,$i292.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 332, 14} true;
  assume {:verifier.code 0} true;
  assert ($p295 == $p295.shadow);
  $M.9 := $store.i32($M.9,$p295,$i297);
  $M.9.shadow := $store.i32($M.9.shadow,$p295.shadow,$i297.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 333, 21} true;
  assume {:verifier.code 0} true;
  $i298 := $shl.i32($i286,31);
  $i298.shadow := $shl.i32($i286.shadow,31);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 333, 34} true;
  assume {:verifier.code 0} true;
  $i299 := $shl.i32($i286,30);
  $i299.shadow := $shl.i32($i286.shadow,30);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 333, 28} true;
  assume {:verifier.code 0} true;
  $i300 := $xor.i32($i298,$i299);
  $i300.shadow := $xor.i32($i298.shadow,$i299.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 333, 47} true;
  assume {:verifier.code 0} true;
  $i301 := $shl.i32($i286,25);
  $i301.shadow := $shl.i32($i286.shadow,25);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 333, 41} true;
  assume {:verifier.code 0} true;
  $i302 := $xor.i32($i300,$i301);
  $i302.shadow := $xor.i32($i300.shadow,$i301.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 333, 9} true;
  assume {:verifier.code 0} true;
  $i303 := $add.i32($i282,3);
  $i303.shadow := $add.i32($i282.shadow,3);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 333, 4} true;
  assume {:verifier.code 0} true;
  $i304 := $sext.i32.i64($i303);
  $i304.shadow := $sext.i32.i64($i303.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 333, 4} true;
  assume {:verifier.code 0} true;
  $p305 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref($i304,4));
  $p305.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref($i304.shadow,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 333, 14} true;
  assume {:verifier.code 0} true;
  assert ($p305 == $p305.shadow);
  $i306 := $load.i32($M.9,$p305);
  $i306.shadow := $load.i32($M.9.shadow,$p305.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 333, 14} true;
  assume {:verifier.code 0} true;
  $i307 := $xor.i32($i306,$i302);
  $i307.shadow := $xor.i32($i306.shadow,$i302.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 333, 14} true;
  assume {:verifier.code 0} true;
  assert ($p305 == $p305.shadow);
  $M.9 := $store.i32($M.9,$p305,$i307);
  $M.9.shadow := $store.i32($M.9.shadow,$p305.shadow,$i307.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 334, 3} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb13:
  assume !($i283 == 1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 335, 3} true;
  assume {:verifier.code 0} true;
  $p309 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(0,4));
  $p309.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 335, 3} true;
  assume {:verifier.code 0} true;
  $p310 := $bitcast.ref.ref($p309);
  $p310.shadow := $bitcast.ref.ref($p309.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 335, 14} true;
  assume {:verifier.code 0} true;
  $p311 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,4));
  $p311.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(0,4));
  $p312 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(4,4));
  $p312.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 335, 3} true;
  assume {:verifier.code 0} true;
  $p313 := $bitcast.ref.ref($p312);
  $p313.shadow := $bitcast.ref.ref($p312.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 335, 3} true;
  assume {:verifier.code 0} true;
  assert ($p310 == $p310.shadow);
  assert ($p313 == $p313.shadow);
  call $M.2, $M.2.shadow := $memcpy.i8($M.2, $M.2.shadow, $M.9, $M.9.shadow, $p310, $p310.shadow, $p313, $p313.shadow, 16, 16, false, false);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 219, 2} true;
  assume {:verifier.code 0} true;
  $i32 := $i38;
  $i32.shadow := $i38.shadow;
  $p33 := $p39;
  $p33.shadow := $p39.shadow;
  goto $bb1;
$bb14:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 328, 24} true;
  assume {:verifier.code 0} true;
  $i308 := $add.i32($i282,1);
  $i308.shadow := $add.i32($i282.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i308);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 328, 3} true;
  assume {:verifier.code 0} true;
  $i282 := $i308;
  $i282.shadow := $i308.shadow;
  goto $bb11;
}
...
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0,9288));
...
axiom (llvm.memset.p0i8.i64 == $sub.ref(0,10320));
procedure {:inline 1} llvm.memset.p0i8.i64($p0: ref, $p0.shadow: ref, $i1: i8, $i1.shadow: i8, $i2: i64, $i2.shadow: i64, $i3: i1, $i3.shadow: i1);
const bmul: ref;
axiom (bmul == $sub.ref(0,11352));
procedure {:inline 1} bmul($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32, $i3: i32, $i3.shadow: i32)
modifies $M.7, $M.8, $exn;
{
  ...
  var $i81.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 172, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "bmul:arg:x"} boogie_si_record_i32($i2);
  call {:cexpr "bmul:arg:y"} boogie_si_record_i32($i3);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 172, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $and.i32($i2,286331153);
  $i4.shadow := $and.i32($i2.shadow,286331153);
  call {:cexpr "x0"} boogie_si_record_i32($i4);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 173, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $and.i32($i2,572662306);
  $i5.shadow := $and.i32($i2.shadow,572662306);
  call {:cexpr "x1"} boogie_si_record_i32($i5);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 174, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $and.i32($i2,1145324612);
  $i6.shadow := $and.i32($i2.shadow,1145324612);
  call {:cexpr "x2"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 175, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $and.i32($i2,2290649224);
  $i7.shadow := $and.i32($i2.shadow,2290649224);
  call {:cexpr "x3"} boogie_si_record_i32($i7);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 176, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $and.i32($i3,286331153);
  $i8.shadow := $and.i32($i3.shadow,286331153);
  call {:cexpr "y0"} boogie_si_record_i32($i8);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 177, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $and.i32($i3,572662306);
  $i9.shadow := $and.i32($i3.shadow,572662306);
  call {:cexpr "y1"} boogie_si_record_i32($i9);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 178, 9} true;
  assume {:verifier.code 0} true;
  $i10 := $and.i32($i3,1145324612);
  $i10.shadow := $and.i32($i3.shadow,1145324612);
  call {:cexpr "y2"} boogie_si_record_i32($i10);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 179, 9} true;
  assume {:verifier.code 0} true;
  $i11 := $and.i32($i3,2290649224);
  $i11.shadow := $and.i32($i3.shadow,2290649224);
  call {:cexpr "y3"} boogie_si_record_i32($i11);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i32.i64($i4);
  $i12.shadow := $zext.i32.i64($i4.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i32.i64($i8);
  $i13.shadow := $zext.i32.i64($i8.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 7} true;
  assume {:verifier.code 0} true;
  $i14 := $mul.i64($i12,$i13);
  $i14.shadow := $mul.i64($i12.shadow,$i13.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 21} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i32.i64($i5);
  $i15.shadow := $zext.i32.i64($i5.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 21} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i32.i64($i11);
  $i16.shadow := $zext.i32.i64($i11.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 21} true;
  assume {:verifier.code 0} true;
  $i17 := $mul.i64($i15,$i16);
  $i17.shadow := $mul.i64($i15.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 19} true;
  assume {:verifier.code 0} true;
  $i18 := $xor.i64($i14,$i17);
  $i18.shadow := $xor.i64($i14.shadow,$i17.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 35} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i32.i64($i6);
  $i19.shadow := $zext.i32.i64($i6.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 35} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i32.i64($i10);
  $i20.shadow := $zext.i32.i64($i10.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 35} true;
  assume {:verifier.code 0} true;
  $i21 := $mul.i64($i19,$i20);
  $i21.shadow := $mul.i64($i19.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 33} true;
  assume {:verifier.code 0} true;
  $i22 := $xor.i64($i18,$i21);
  $i22.shadow := $xor.i64($i18.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 49} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i32.i64($i7);
  $i23.shadow := $zext.i32.i64($i7.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 49} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i32.i64($i9);
  $i24.shadow := $zext.i32.i64($i9.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 49} true;
  assume {:verifier.code 0} true;
  $i25 := $mul.i64($i23,$i24);
  $i25.shadow := $mul.i64($i23.shadow,$i24.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 180, 47} true;
  assume {:verifier.code 0} true;
  $i26 := $xor.i64($i22,$i25);
  $i26.shadow := $xor.i64($i22.shadow,$i25.shadow);
  call {:cexpr "z0"} boogie_si_record_i64($i26);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 7} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i32.i64($i4);
  $i27.shadow := $zext.i32.i64($i4.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 7} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i32.i64($i9);
  $i28.shadow := $zext.i32.i64($i9.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 7} true;
  assume {:verifier.code 0} true;
  $i29 := $mul.i64($i27,$i28);
  $i29.shadow := $mul.i64($i27.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 21} true;
  assume {:verifier.code 0} true;
  $i30 := $zext.i32.i64($i5);
  $i30.shadow := $zext.i32.i64($i5.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 21} true;
  assume {:verifier.code 0} true;
  $i31 := $zext.i32.i64($i8);
  $i31.shadow := $zext.i32.i64($i8.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 21} true;
  assume {:verifier.code 0} true;
  $i32 := $mul.i64($i30,$i31);
  $i32.shadow := $mul.i64($i30.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 19} true;
  assume {:verifier.code 0} true;
  $i33 := $xor.i64($i29,$i32);
  $i33.shadow := $xor.i64($i29.shadow,$i32.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 35} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i32.i64($i6);
  $i34.shadow := $zext.i32.i64($i6.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 35} true;
  assume {:verifier.code 0} true;
  $i35 := $zext.i32.i64($i11);
  $i35.shadow := $zext.i32.i64($i11.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 35} true;
  assume {:verifier.code 0} true;
  $i36 := $mul.i64($i34,$i35);
  $i36.shadow := $mul.i64($i34.shadow,$i35.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 33} true;
  assume {:verifier.code 0} true;
  $i37 := $xor.i64($i33,$i36);
  $i37.shadow := $xor.i64($i33.shadow,$i36.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 49} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i32.i64($i7);
  $i38.shadow := $zext.i32.i64($i7.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 49} true;
  assume {:verifier.code 0} true;
  $i39 := $zext.i32.i64($i10);
  $i39.shadow := $zext.i32.i64($i10.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 49} true;
  assume {:verifier.code 0} true;
  $i40 := $mul.i64($i38,$i39);
  $i40.shadow := $mul.i64($i38.shadow,$i39.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 181, 47} true;
  assume {:verifier.code 0} true;
  $i41 := $xor.i64($i37,$i40);
  $i41.shadow := $xor.i64($i37.shadow,$i40.shadow);
  call {:cexpr "z1"} boogie_si_record_i64($i41);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 7} true;
  assume {:verifier.code 0} true;
  $i42 := $zext.i32.i64($i4);
  $i42.shadow := $zext.i32.i64($i4.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 7} true;
  assume {:verifier.code 0} true;
  $i43 := $zext.i32.i64($i10);
  $i43.shadow := $zext.i32.i64($i10.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 7} true;
  assume {:verifier.code 0} true;
  $i44 := $mul.i64($i42,$i43);
  $i44.shadow := $mul.i64($i42.shadow,$i43.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 21} true;
  assume {:verifier.code 0} true;
  $i45 := $zext.i32.i64($i5);
  $i45.shadow := $zext.i32.i64($i5.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 21} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i32.i64($i9);
  $i46.shadow := $zext.i32.i64($i9.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 21} true;
  assume {:verifier.code 0} true;
  $i47 := $mul.i64($i45,$i46);
  $i47.shadow := $mul.i64($i45.shadow,$i46.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 19} true;
  assume {:verifier.code 0} true;
  $i48 := $xor.i64($i44,$i47);
  $i48.shadow := $xor.i64($i44.shadow,$i47.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 35} true;
  assume {:verifier.code 0} true;
  $i49 := $zext.i32.i64($i6);
  $i49.shadow := $zext.i32.i64($i6.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 35} true;
  assume {:verifier.code 0} true;
  $i50 := $zext.i32.i64($i8);
  $i50.shadow := $zext.i32.i64($i8.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 35} true;
  assume {:verifier.code 0} true;
  $i51 := $mul.i64($i49,$i50);
  $i51.shadow := $mul.i64($i49.shadow,$i50.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 33} true;
  assume {:verifier.code 0} true;
  $i52 := $xor.i64($i48,$i51);
  $i52.shadow := $xor.i64($i48.shadow,$i51.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 49} true;
  assume {:verifier.code 0} true;
  $i53 := $zext.i32.i64($i7);
  $i53.shadow := $zext.i32.i64($i7.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 49} true;
  assume {:verifier.code 0} true;
  $i54 := $zext.i32.i64($i11);
  $i54.shadow := $zext.i32.i64($i11.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 49} true;
  assume {:verifier.code 0} true;
  $i55 := $mul.i64($i53,$i54);
  $i55.shadow := $mul.i64($i53.shadow,$i54.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 182, 47} true;
  assume {:verifier.code 0} true;
  $i56 := $xor.i64($i52,$i55);
  $i56.shadow := $xor.i64($i52.shadow,$i55.shadow);
  call {:cexpr "z2"} boogie_si_record_i64($i56);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 7} true;
  assume {:verifier.code 0} true;
  $i57 := $zext.i32.i64($i4);
  $i57.shadow := $zext.i32.i64($i4.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 7} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i32.i64($i11);
  $i58.shadow := $zext.i32.i64($i11.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 7} true;
  assume {:verifier.code 0} true;
  $i59 := $mul.i64($i57,$i58);
  $i59.shadow := $mul.i64($i57.shadow,$i58.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 21} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i32.i64($i5);
  $i60.shadow := $zext.i32.i64($i5.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 21} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i32.i64($i10);
  $i61.shadow := $zext.i32.i64($i10.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 21} true;
  assume {:verifier.code 0} true;
  $i62 := $mul.i64($i60,$i61);
  $i62.shadow := $mul.i64($i60.shadow,$i61.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 19} true;
  assume {:verifier.code 0} true;
  $i63 := $xor.i64($i59,$i62);
  $i63.shadow := $xor.i64($i59.shadow,$i62.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 35} true;
  assume {:verifier.code 0} true;
  $i64 := $zext.i32.i64($i6);
  $i64.shadow := $zext.i32.i64($i6.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 35} true;
  assume {:verifier.code 0} true;
  $i65 := $zext.i32.i64($i9);
  $i65.shadow := $zext.i32.i64($i9.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 35} true;
  assume {:verifier.code 0} true;
  $i66 := $mul.i64($i64,$i65);
  $i66.shadow := $mul.i64($i64.shadow,$i65.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 33} true;
  assume {:verifier.code 0} true;
  $i67 := $xor.i64($i63,$i66);
  $i67.shadow := $xor.i64($i63.shadow,$i66.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 49} true;
  assume {:verifier.code 0} true;
  $i68 := $zext.i32.i64($i7);
  $i68.shadow := $zext.i32.i64($i7.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 49} true;
  assume {:verifier.code 0} true;
  $i69 := $zext.i32.i64($i8);
  $i69.shadow := $zext.i32.i64($i8.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 49} true;
  assume {:verifier.code 0} true;
  $i70 := $mul.i64($i68,$i69);
  $i70.shadow := $mul.i64($i68.shadow,$i69.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 183, 47} true;
  assume {:verifier.code 0} true;
  $i71 := $xor.i64($i67,$i70);
  $i71.shadow := $xor.i64($i67.shadow,$i70.shadow);
  call {:cexpr "z3"} boogie_si_record_i64($i71);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 184, 5} true;
  assume {:verifier.code 0} true;
  $i72 := $and.i64($i26,1229782938247303441);
  $i72.shadow := $and.i64($i26.shadow,1229782938247303441);
  call {:cexpr "z0"} boogie_si_record_i64($i72);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 185, 5} true;
  assume {:verifier.code 0} true;
  $i73 := $and.i64($i41,2459565876494606882);
  $i73.shadow := $and.i64($i41.shadow,2459565876494606882);
  call {:cexpr "z1"} boogie_si_record_i64($i73);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 186, 5} true;
  assume {:verifier.code 0} true;
  $i74 := $and.i64($i56,4919131752989213764);
  $i74.shadow := $and.i64($i56.shadow,4919131752989213764);
  call {:cexpr "z2"} boogie_si_record_i64($i74);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 187, 5} true;
  assume {:verifier.code 0} true;
  $i75 := $and.i64($i71,9838263505978427528);
  $i75.shadow := $and.i64($i71.shadow,9838263505978427528);
  call {:cexpr "z3"} boogie_si_record_i64($i75);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 188, 9} true;
  assume {:verifier.code 0} true;
  $i76 := $or.i64($i72,$i73);
  $i76.shadow := $or.i64($i72.shadow,$i73.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 188, 14} true;
  assume {:verifier.code 0} true;
  $i77 := $or.i64($i76,$i74);
  $i77.shadow := $or.i64($i76.shadow,$i74.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 188, 19} true;
  assume {:verifier.code 0} true;
  $i78 := $or.i64($i77,$i75);
  $i78.shadow := $or.i64($i77.shadow,$i75.shadow);
  call {:cexpr "z"} boogie_si_record_i64($i78);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 189, 8} true;
  assume {:verifier.code 0} true;
  $i79 := $trunc.i64.i32($i78);
  $i79.shadow := $trunc.i64.i32($i78.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 189, 6} true;
  assume {:verifier.code 0} true;
  assert ($p1 == $p1.shadow);
  $M.7 := $store.i32($M.7,$p1,$i79);
  $M.7.shadow := $store.i32($M.7.shadow,$p1.shadow,$i79.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 190, 21} true;
  assume {:verifier.code 0} true;
  $i80 := $lshr.i64($i78,32);
  $i80.shadow := $lshr.i64($i78.shadow,32);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 190, 8} true;
  assume {:verifier.code 0} true;
  $i81 := $trunc.i64.i32($i80);
  $i81.shadow := $trunc.i64.i32($i80.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 190, 6} true;
  assume {:verifier.code 0} true;
  assert ($p0 == $p0.shadow);
  $M.8 := $store.i32($M.8,$p0,$i81);
  $M.8.shadow := $store.i32($M.8.shadow,$p0.shadow,$i81.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 191, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
axiom (br_enc32be == $sub.ref(0,12384));
