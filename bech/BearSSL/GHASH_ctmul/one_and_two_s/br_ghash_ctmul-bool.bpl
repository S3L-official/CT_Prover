...
$bb1:
  ...
  assert {:likely_shadow_invariant} ($i32.dup == 0);
  assert {:likely_shadow_invariant} ($p33.dup == 0);
...
$bb7:
  ...
  assert {:likely_shadow_invariant} ($p4.dup == 0);
  assert {:likely_shadow_invariant} ($p7.dup == 0);
  assert {:likely_shadow_invariant} ($i149.dup == 0);
  assert {:likely_shadow_invariant} ($p8.dup == 0);
  assert {:likely_shadow_invariant} ($i38.dup == 0);
