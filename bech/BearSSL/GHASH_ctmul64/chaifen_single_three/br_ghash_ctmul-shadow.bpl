...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,33024));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_ghash_ctmul64($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow, $i3, $i3.shadow);
...
const br_ghash_ctmul64: ref;
axiom (br_ghash_ctmul64 == $sub.ref(0,6192));
procedure {:inline 1} br_ghash_ctmul64($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $i3: i64, $i3.shadow: i64)
modifies $exn, $M.1;
modifies $CurrAddr;
{
  var $p4: ref;
  ...
  var $p94.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 88, 7} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(16,$zext.i32.i64(1)));
  $p4.shadow := $p4;
  call {:cexpr "br_ghash_ctmul64:arg:len"} boogie_si_record_i64($i3);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 88, 7} true;
  assume {:verifier.code 0} true;
  call $i5, $i5.shadow := br_dec64be($p0, $p0.shadow);
  call {:cexpr "y1"} boogie_si_record_i64($i5);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 89, 21} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p0,$mul.ref(8,1));
  $p6.shadow := $add.ref($p0.shadow,$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 89, 7} true;
  assume {:verifier.code 0} true;
  call $i7, $i7.shadow := br_dec64be($p6, $p6.shadow);
  call {:cexpr "y0"} boogie_si_record_i64($i7);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 90, 7} true;
  assume {:verifier.code 0} true;
  call $i8, $i8.shadow := br_dec64be($p1, $p1.shadow);
  call {:cexpr "h1"} boogie_si_record_i64($i8);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 91, 21} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p1,$mul.ref(8,1));
  $p9.shadow := $add.ref($p1.shadow,$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 91, 7} true;
  assume {:verifier.code 0} true;
  call $i10, $i10.shadow := br_dec64be($p9, $p9.shadow);
  call {:cexpr "h0"} boogie_si_record_i64($i10);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 92, 8} true;
  assume {:verifier.code 0} true;
  call $i11, $i11.shadow := rev64($i10, $i10.shadow);
  call {:cexpr "h0r"} boogie_si_record_i64($i11);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 93, 8} true;
  assume {:verifier.code 0} true;
  call $i12, $i12.shadow := rev64($i8, $i8.shadow);
  call {:cexpr "h1r"} boogie_si_record_i64($i12);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 94, 10} true;
  assume {:verifier.code 0} true;
  $i13 := $xor.i64($i10,$i8);
  $i13.shadow := $xor.i64($i10.shadow,$i8.shadow);
  call {:cexpr "h2"} boogie_si_record_i64($i13);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 95, 12} true;
  assume {:verifier.code 0} true;
  $i14 := $xor.i64($i11,$i12);
  $i14.shadow := $xor.i64($i11.shadow,$i12.shadow);
  call {:cexpr "h2r"} boogie_si_record_i64($i14);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 96, 2} true;
  assume {:verifier.code 0} true;
  $p15 := $p2;
  $p15.shadow := $p2.shadow;
  $i16 := $i3;
  $i16.shadow := $i3.shadow;
  $i17 := $i7;
  $i17.shadow := $i7.shadow;
  $i18 := $i5;
  $i18.shadow := $i5.shadow;
  goto $bb1;
$bb1:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($p15 == $p15.shadow);
  ...
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 96, 13} true;
  assume {:verifier.code 0} true;
  $i19 := $ugt.i64($i16,0);
  $i19.shadow := $ugt.i64($i16.shadow,0);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 96, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i19 == 1);
  assume true;
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 103, 11} true;
  assume {:verifier.code 0} true;
  $i20 := $uge.i64($i16,16);
  $i20.shadow := $uge.i64($i16.shadow,16);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 103, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !($i19 == 1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 152, 2} true;
  assume {:verifier.code 0} true;
  call br_enc64be($p0, $p0.shadow, $i18, $i18.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 153, 16} true;
  assume {:verifier.code 0} true;
  $p94 := $add.ref($p0,$mul.ref(8,1));
  $p94.shadow := $add.ref($p0.shadow,$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 153, 2} true;
  assume {:verifier.code 0} true;
  call br_enc64be($p94, $p94.shadow, $i17, $i17.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 154, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume ($i20 == 1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 105, 8} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p15,$mul.ref(16,1));
  $p21.shadow := $add.ref($p15.shadow,$mul.ref(16,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 106, 8} true;
  assume {:verifier.code 0} true;
  $i22 := $sub.i64($i16,16);
  $i22.shadow := $sub.i64($i16.shadow,16);
  call {:cexpr "len"} boogie_si_record_i64($i22);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 107, 3} true;
  assume {:verifier.code 0} true;
  $p23 := $p21;
  $p23.shadow := $p21.shadow;
  $i24 := $i22;
  $i24.shadow := $i22.shadow;
  $p25 := $p15;
  $p25.shadow := $p15.shadow;
  goto $bb6;
$bb5:
  assume !($i20 == 1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 108, 4} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(0,1));
  $p26.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 108, 4} true;
  assume {:verifier.code 0} true;
  assert ($p26 == $p26.shadow);
  assert ($p15 == $p15.shadow);
  assert ($i16 == $i16.shadow);
  call $M.1, $M.1.shadow := $memcpy.i8($M.1, $M.1.shadow, $M.1, $M.1.shadow, $p26, $p26.shadow, $p15, $p15.shadow, $i16, $i16.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 109, 11} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(0,1));
  $p27.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  $p28 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref($i16,1));
  $p28.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref($i16.shadow,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 109, 38} true;
  assume {:verifier.code 0} true;
  $i29 := $sub.i64(16,$i16);
  $i29.shadow := $sub.i64(16,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 109, 4} true;
  assume {:verifier.code 0} true;
  assert ($p28 == $p28.shadow);
  assert ($i29 == $i29.shadow);
  call $M.1, $M.1.shadow := $memset.i8($M.1, $M.1.shadow, $p28, $p28.shadow, 0, 0, $i29, $i29.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 110, 10} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(0,1));
  $p30.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:verifier.code 0} true;
  $p23 := $p15;
  $p23.shadow := $p15.shadow;
  $i24 := 0;
  $i24.shadow := 0;
  $p25 := $p4;
  $p25.shadow := $p4.shadow;
  goto $bb6;
$bb6:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 113, 9} true;
  assume {:verifier.code 0} true;
  call $i31, $i31.shadow := br_dec64be($p25, $p25.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 113, 6} true;
  assume {:verifier.code 0} true;
  $i32 := $xor.i64($i18,$i31);
  $i32.shadow := $xor.i64($i18.shadow,$i31.shadow);
  call {:cexpr "y1"} boogie_si_record_i64($i32);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 114, 24} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($p25,$mul.ref(8,1));
  $p33.shadow := $add.ref($p25.shadow,$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 114, 9} true;
  assume {:verifier.code 0} true;
  call $i34, $i34.shadow := br_dec64be($p33, $p33.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 114, 6} true;
  assume {:verifier.code 0} true;
  $i35 := $xor.i64($i17,$i34);
  $i35.shadow := $xor.i64($i17.shadow,$i34.shadow);
  call {:cexpr "y0"} boogie_si_record_i64($i35);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 116, 9} true;
  assume {:verifier.code 0} true;
  call $i36, $i36.shadow := rev64($i35, $i35.shadow);
  call {:cexpr "y0r"} boogie_si_record_i64($i36);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 117, 9} true;
  assume {:verifier.code 0} true;
  call $i37, $i37.shadow := rev64($i32, $i32.shadow);
  call {:cexpr "y1r"} boogie_si_record_i64($i37);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 118, 11} true;
  assume {:verifier.code 0} true;
  $i38 := $xor.i64($i35,$i32);
  $i38.shadow := $xor.i64($i35.shadow,$i32.shadow);
  call {:cexpr "y2"} boogie_si_record_i64($i38);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 119, 13} true;
  assume {:verifier.code 0} true;
  $i39 := $xor.i64($i36,$i37);
  $i39.shadow := $xor.i64($i36.shadow,$i37.shadow);
  call {:cexpr "y2r"} boogie_si_record_i64($i39);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 121, 8} true;
  assume {:verifier.code 0} true;
  call $i40, $i40.shadow := bmul64($i35, $i35.shadow, $i10, $i10.shadow);
  call {:cexpr "z0"} boogie_si_record_i64($i40);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 122, 8} true;
  assume {:verifier.code 0} true;
  call $i41, $i41.shadow := bmul64($i32, $i32.shadow, $i8, $i8.shadow);
  call {:cexpr "z1"} boogie_si_record_i64($i41);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 123, 8} true;
  assume {:verifier.code 0} true;
  call $i42, $i42.shadow := bmul64($i38, $i38.shadow, $i13, $i13.shadow);
  call {:cexpr "z2"} boogie_si_record_i64($i42);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 124, 9} true;
  assume {:verifier.code 0} true;
  call $i43, $i43.shadow := bmul64($i36, $i36.shadow, $i11, $i11.shadow);
  call {:cexpr "z0h"} boogie_si_record_i64($i43);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 125, 9} true;
  assume {:verifier.code 0} true;
  call $i44, $i44.shadow := bmul64($i37, $i37.shadow, $i12, $i12.shadow);
  call {:cexpr "z1h"} boogie_si_record_i64($i44);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 126, 9} true;
  assume {:verifier.code 0} true;
  call $i45, $i45.shadow := bmul64($i39, $i39.shadow, $i14, $i14.shadow);
  call {:cexpr "z2h"} boogie_si_record_i64($i45);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 127, 12} true;
  assume {:verifier.code 0} true;
  $i46 := $xor.i64($i40,$i41);
  $i46.shadow := $xor.i64($i40.shadow,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 127, 6} true;
  assume {:verifier.code 0} true;
  $i47 := $xor.i64($i42,$i46);
  $i47.shadow := $xor.i64($i42.shadow,$i46.shadow);
  call {:cexpr "z2"} boogie_si_record_i64($i47);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 128, 14} true;
  assume {:verifier.code 0} true;
  $i48 := $xor.i64($i43,$i44);
  $i48.shadow := $xor.i64($i43.shadow,$i44.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 128, 7} true;
  assume {:verifier.code 0} true;
  $i49 := $xor.i64($i45,$i48);
  $i49.shadow := $xor.i64($i45.shadow,$i48.shadow);
  call {:cexpr "z2h"} boogie_si_record_i64($i49);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 129, 9} true;
  assume {:verifier.code 0} true;
  call $i50, $i50.shadow := rev64($i43, $i43.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 129, 20} true;
  assume {:verifier.code 0} true;
  $i51 := $lshr.i64($i50,1);
  $i51.shadow := $lshr.i64($i50.shadow,1);
  call {:cexpr "z0h"} boogie_si_record_i64($i51);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 130, 9} true;
  assume {:verifier.code 0} true;
  call $i52, $i52.shadow := rev64($i44, $i44.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 130, 20} true;
  assume {:verifier.code 0} true;
  $i53 := $lshr.i64($i52,1);
  $i53.shadow := $lshr.i64($i52.shadow,1);
  call {:cexpr "z1h"} boogie_si_record_i64($i53);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 131, 9} true;
  assume {:verifier.code 0} true;
  call $i54, $i54.shadow := rev64($i49, $i49.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 131, 20} true;
  assume {:verifier.code 0} true;
  $i55 := $lshr.i64($i54,1);
  $i55.shadow := $lshr.i64($i54.shadow,1);
  call {:cexpr "z2h"} boogie_si_record_i64($i55);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 134, 12} true;
  assume {:verifier.code 0} true;
  $i56 := $xor.i64($i51,$i47);
  $i56.shadow := $xor.i64($i51.shadow,$i47.shadow);
  call {:cexpr "v1"} boogie_si_record_i64($i56);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 135, 11} true;
  assume {:verifier.code 0} true;
  $i57 := $xor.i64($i41,$i55);
  $i57.shadow := $xor.i64($i41.shadow,$i55.shadow);
  call {:cexpr "v2"} boogie_si_record_i64($i57);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 138, 12} true;
  assume {:verifier.code 0} true;
  $i58 := $shl.i64($i53,1);
  $i58.shadow := $shl.i64($i53.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 138, 24} true;
  assume {:verifier.code 0} true;
  $i59 := $lshr.i64($i57,63);
  $i59.shadow := $lshr.i64($i57.shadow,63);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 138, 18} true;
  assume {:verifier.code 0} true;
  $i60 := $or.i64($i58,$i59);
  $i60.shadow := $or.i64($i58.shadow,$i59.shadow);
  call {:cexpr "v3"} boogie_si_record_i64($i60);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 139, 12} true;
  assume {:verifier.code 0} true;
  $i61 := $shl.i64($i57,1);
  $i61.shadow := $shl.i64($i57.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 139, 24} true;
  assume {:verifier.code 0} true;
  $i62 := $lshr.i64($i56,63);
  $i62.shadow := $lshr.i64($i56.shadow,63);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 139, 18} true;
  assume {:verifier.code 0} true;
  $i63 := $or.i64($i61,$i62);
  $i63.shadow := $or.i64($i61.shadow,$i62.shadow);
  call {:cexpr "v2"} boogie_si_record_i64($i63);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 140, 12} true;
  assume {:verifier.code 0} true;
  $i64 := $shl.i64($i56,1);
  $i64.shadow := $shl.i64($i56.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 140, 24} true;
  assume {:verifier.code 0} true;
  $i65 := $lshr.i64($i40,63);
  $i65.shadow := $lshr.i64($i40.shadow,63);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 140, 18} true;
  assume {:verifier.code 0} true;
  $i66 := $or.i64($i64,$i65);
  $i66.shadow := $or.i64($i64.shadow,$i65.shadow);
  call {:cexpr "v1"} boogie_si_record_i64($i66);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 141, 12} true;
  assume {:verifier.code 0} true;
  $i67 := $shl.i64($i40,1);
  $i67.shadow := $shl.i64($i40.shadow,1);
  call {:cexpr "v0"} boogie_si_record_i64($i67);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 143, 18} true;
  assume {:verifier.code 0} true;
  $i68 := $lshr.i64($i67,1);
  $i68.shadow := $lshr.i64($i67.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 143, 12} true;
  assume {:verifier.code 0} true;
  $i69 := $xor.i64($i67,$i68);
  $i69.shadow := $xor.i64($i67.shadow,$i68.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 143, 30} true;
  assume {:verifier.code 0} true;
  $i70 := $lshr.i64($i67,2);
  $i70.shadow := $lshr.i64($i67.shadow,2);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 143, 24} true;
  assume {:verifier.code 0} true;
  $i71 := $xor.i64($i69,$i70);
  $i71.shadow := $xor.i64($i69.shadow,$i70.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 143, 42} true;
  assume {:verifier.code 0} true;
  $i72 := $lshr.i64($i67,7);
  $i72.shadow := $lshr.i64($i67.shadow,7);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 143, 36} true;
  assume {:verifier.code 0} true;
  $i73 := $xor.i64($i71,$i72);
  $i73.shadow := $xor.i64($i71.shadow,$i72.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 143, 6} true;
  assume {:verifier.code 0} true;
  $i74 := $xor.i64($i63,$i73);
  $i74.shadow := $xor.i64($i63.shadow,$i73.shadow);
  call {:cexpr "v2"} boogie_si_record_i64($i74);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 144, 13} true;
  assume {:verifier.code 0} true;
  $i75 := $shl.i64($i67,63);
  $i75.shadow := $shl.i64($i67.shadow,63);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 144, 26} true;
  assume {:verifier.code 0} true;
  $i76 := $shl.i64($i67,62);
  $i76.shadow := $shl.i64($i67.shadow,62);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 144, 20} true;
  assume {:verifier.code 0} true;
  $i77 := $xor.i64($i75,$i76);
  $i77.shadow := $xor.i64($i75.shadow,$i76.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 144, 39} true;
  assume {:verifier.code 0} true;
  $i78 := $shl.i64($i67,57);
  $i78.shadow := $shl.i64($i67.shadow,57);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 144, 33} true;
  assume {:verifier.code 0} true;
  $i79 := $xor.i64($i77,$i78);
  $i79.shadow := $xor.i64($i77.shadow,$i78.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 144, 6} true;
  assume {:verifier.code 0} true;
  $i80 := $xor.i64($i66,$i79);
  $i80.shadow := $xor.i64($i66.shadow,$i79.shadow);
  call {:cexpr "v1"} boogie_si_record_i64($i80);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 145, 18} true;
  assume {:verifier.code 0} true;
  $i81 := $lshr.i64($i80,1);
  $i81.shadow := $lshr.i64($i80.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 145, 12} true;
  assume {:verifier.code 0} true;
  $i82 := $xor.i64($i80,$i81);
  $i82.shadow := $xor.i64($i80.shadow,$i81.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 145, 30} true;
  assume {:verifier.code 0} true;
  $i83 := $lshr.i64($i80,2);
  $i83.shadow := $lshr.i64($i80.shadow,2);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 145, 24} true;
  assume {:verifier.code 0} true;
  $i84 := $xor.i64($i82,$i83);
  $i84.shadow := $xor.i64($i82.shadow,$i83.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 145, 42} true;
  assume {:verifier.code 0} true;
  $i85 := $lshr.i64($i80,7);
  $i85.shadow := $lshr.i64($i80.shadow,7);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 145, 36} true;
  assume {:verifier.code 0} true;
  $i86 := $xor.i64($i84,$i85);
  $i86.shadow := $xor.i64($i84.shadow,$i85.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 145, 6} true;
  assume {:verifier.code 0} true;
  $i87 := $xor.i64($i60,$i86);
  $i87.shadow := $xor.i64($i60.shadow,$i86.shadow);
  call {:cexpr "v3"} boogie_si_record_i64($i87);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 146, 13} true;
  assume {:verifier.code 0} true;
  $i88 := $shl.i64($i80,63);
  $i88.shadow := $shl.i64($i80.shadow,63);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 146, 26} true;
  assume {:verifier.code 0} true;
  $i89 := $shl.i64($i80,62);
  $i89.shadow := $shl.i64($i80.shadow,62);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 146, 20} true;
  assume {:verifier.code 0} true;
  $i90 := $xor.i64($i88,$i89);
  $i90.shadow := $xor.i64($i88.shadow,$i89.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 146, 39} true;
  assume {:verifier.code 0} true;
  $i91 := $shl.i64($i80,57);
  $i91.shadow := $shl.i64($i80.shadow,57);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 146, 33} true;
  assume {:verifier.code 0} true;
  $i92 := $xor.i64($i90,$i91);
  $i92.shadow := $xor.i64($i90.shadow,$i91.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 146, 6} true;
  assume {:verifier.code 0} true;
  $i93 := $xor.i64($i74,$i92);
  $i93.shadow := $xor.i64($i74.shadow,$i92.shadow);
  call {:cexpr "v2"} boogie_si_record_i64($i93);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 96, 2} true;
  assume {:verifier.code 0} true;
  $p15 := $p23;
  $p15.shadow := $p23.shadow;
  $i16 := $i24;
  $i16.shadow := $i24.shadow;
  $i17 := $i93;
  $i17.shadow := $i93.shadow;
  $i18 := $i87;
  $i18.shadow := $i87.shadow;
  goto $bb1;
}
const br_dec64be: ref;
axiom (br_dec64be == $sub.ref(0,7224));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i7 := $or.i64($i3,$i6);
  $i7.shadow := $or.i64($i3.shadow,$i6.shadow);
...
const rev64: ref;
axiom (rev64 == $sub.ref(0,8256));
procedure {:inline 1} rev64($i0: i64, $i0.shadow: i64) returns ($r: i64, $r.shadow: i64)
modifies $exn;
{
  var $i1: i64;
  var $i1.shadow: i64;
  ...
  var $i28.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 66, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "rev64:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 66, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 66, 2} true;
  assume {:verifier.code 0} true;
  $i1 := $and.i64($i0,6148914691236517205);
  $i1.shadow := $and.i64($i0.shadow,6148914691236517205);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 66, 2} true;
  assume {:verifier.code 0} true;
  $i2 := $shl.i64($i1,1);
  $i2.shadow := $shl.i64($i1.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 66, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $lshr.i64($i0,1);
  $i3.shadow := $lshr.i64($i0.shadow,1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 66, 2} true;
  assume {:verifier.code 0} true;
  $i4 := $and.i64($i3,6148914691236517205);
  $i4.shadow := $and.i64($i3.shadow,6148914691236517205);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 66, 2} true;
  assume {:verifier.code 0} true;
  $i5 := $or.i64($i2,$i4);
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 67, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $i6 := $and.i64($i5,3689348814741910323);
  $i6.shadow := $and.i64($i5.shadow,3689348814741910323);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $shl.i64($i6,2);
  $i7.shadow := $shl.i64($i6.shadow,2);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $i8 := $lshr.i64($i5,2);
  $i8.shadow := $lshr.i64($i5.shadow,2);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $i9 := $and.i64($i8,3689348814741910323);
  $i9.shadow := $and.i64($i8.shadow,3689348814741910323);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $i10 := $or.i64($i7,$i9);
  $i10.shadow := $or.i64($i7.shadow,$i9.shadow);
  call {:cexpr "x"} boogie_si_record_i64($i10);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 67, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 68, 2} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 68, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $and.i64($i10,1085102592571150095);
  $i11.shadow := $and.i64($i10.shadow,1085102592571150095);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 68, 2} true;
  assume {:verifier.code 0} true;
  $i12 := $shl.i64($i11,4);
  $i12.shadow := $shl.i64($i11.shadow,4);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 68, 2} true;
  assume {:verifier.code 0} true;
  $i13 := $lshr.i64($i10,4);
  $i13.shadow := $lshr.i64($i10.shadow,4);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 68, 2} true;
  assume {:verifier.code 0} true;
  $i14 := $and.i64($i13,1085102592571150095);
  $i14.shadow := $and.i64($i13.shadow,1085102592571150095);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 68, 2} true;
  assume {:verifier.code 0} true;
  $i15 := $or.i64($i12,$i14);
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 69, 2} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 69, 2} true;
  assume {:verifier.code 0} true;
  $i16 := $and.i64($i15,71777214294589695);
  $i16.shadow := $and.i64($i15.shadow,71777214294589695);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 69, 2} true;
  assume {:verifier.code 0} true;
  $i17 := $shl.i64($i16,8);
  ...
  assume {:verifier.code 0} true;
  $i18 := $lshr.i64($i15,8);
  $i18.shadow := $lshr.i64($i15.shadow,8);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 69, 2} true;
  assume {:verifier.code 0} true;
  $i19 := $and.i64($i18,71777214294589695);
  $i19.shadow := $and.i64($i18.shadow,71777214294589695);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 69, 2} true;
  assume {:verifier.code 0} true;
  $i20 := $or.i64($i17,$i19);
  $i20.shadow := $or.i64($i17.shadow,$i19.shadow);
  call {:cexpr "x"} boogie_si_record_i64($i20);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 69, 2} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb8:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 70, 2} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 70, 2} true;
  assume {:verifier.code 0} true;
  $i21 := $and.i64($i20,281470681808895);
  $i21.shadow := $and.i64($i20.shadow,281470681808895);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 70, 2} true;
  assume {:verifier.code 0} true;
  $i22 := $shl.i64($i21,16);
  $i22.shadow := $shl.i64($i21.shadow,16);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 70, 2} true;
  assume {:verifier.code 0} true;
  $i23 := $lshr.i64($i20,16);
  $i23.shadow := $lshr.i64($i20.shadow,16);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 70, 2} true;
  assume {:verifier.code 0} true;
  $i24 := $and.i64($i23,281470681808895);
  $i24.shadow := $and.i64($i23.shadow,281470681808895);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 70, 2} true;
  assume {:verifier.code 0} true;
  $i25 := $or.i64($i22,$i24);
  $i25.shadow := $or.i64($i22.shadow,$i24.shadow);
  call {:cexpr "x"} boogie_si_record_i64($i25);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 70, 2} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 71, 12} true;
  assume {:verifier.code 0} true;
  $i26 := $shl.i64($i25,32);
  $i26.shadow := $shl.i64($i25.shadow,32);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 71, 24} true;
  assume {:verifier.code 0} true;
  $i27 := $lshr.i64($i25,32);
  $i27.shadow := $lshr.i64($i25.shadow,32);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 71, 19} true;
  assume {:verifier.code 0} true;
  $i28 := $or.i64($i26,$i27);
  $i28.shadow := $or.i64($i26.shadow,$i27.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 71, 2} true;
  assume {:verifier.code 0} true;
  $r := $i28;
  $r.shadow := $i28.shadow;
  $exn := false;
...
axiom (llvm.dbg.declare == $sub.ref(0,9288));
...
const bmul64: ref;
axiom (bmul64 == $sub.ref(0,12384));
procedure {:inline 1} bmul64($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i64, $r.shadow: i64)
modifies $exn;
{
  var $i2: i64;
  var $i2.shadow: i64;
  ...
  var $i44.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 39, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "bmul64:arg:x"} boogie_si_record_i64($i0);
  call {:cexpr "bmul64:arg:y"} boogie_si_record_i64($i1);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 39, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $and.i64($i0,1229782938247303441);
  $i2.shadow := $and.i64($i0.shadow,1229782938247303441);
  call {:cexpr "x0"} boogie_si_record_i64($i2);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 40, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $and.i64($i0,2459565876494606882);
  $i3.shadow := $and.i64($i0.shadow,2459565876494606882);
  call {:cexpr "x1"} boogie_si_record_i64($i3);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 41, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $and.i64($i0,4919131752989213764);
  $i4.shadow := $and.i64($i0.shadow,4919131752989213764);
  call {:cexpr "x2"} boogie_si_record_i64($i4);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 42, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $and.i64($i0,9838263505978427528);
  $i5.shadow := $and.i64($i0.shadow,9838263505978427528);
  call {:cexpr "x3"} boogie_si_record_i64($i5);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 43, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $and.i64($i1,1229782938247303441);
  $i6.shadow := $and.i64($i1.shadow,1229782938247303441);
  call {:cexpr "y0"} boogie_si_record_i64($i6);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 44, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $and.i64($i1,2459565876494606882);
  $i7.shadow := $and.i64($i1.shadow,2459565876494606882);
  call {:cexpr "y1"} boogie_si_record_i64($i7);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 45, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $and.i64($i1,4919131752989213764);
  $i8.shadow := $and.i64($i1.shadow,4919131752989213764);
  call {:cexpr "y2"} boogie_si_record_i64($i8);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 46, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $and.i64($i1,9838263505978427528);
  $i9.shadow := $and.i64($i1.shadow,9838263505978427528);
  call {:cexpr "y3"} boogie_si_record_i64($i9);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 47, 11} true;
  assume {:verifier.code 0} true;
  $i10 := $mul.i64($i2,$i6);
  $i10.shadow := $mul.i64($i2.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 47, 23} true;
  assume {:verifier.code 0} true;
  $i11 := $mul.i64($i3,$i9);
  $i11.shadow := $mul.i64($i3.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 47, 17} true;
  assume {:verifier.code 0} true;
  $i12 := $xor.i64($i10,$i11);
  $i12.shadow := $xor.i64($i10.shadow,$i11.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 47, 35} true;
  assume {:verifier.code 0} true;
  $i13 := $mul.i64($i4,$i8);
  $i13.shadow := $mul.i64($i4.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 47, 29} true;
  assume {:verifier.code 0} true;
  $i14 := $xor.i64($i12,$i13);
  $i14.shadow := $xor.i64($i12.shadow,$i13.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 47, 47} true;
  assume {:verifier.code 0} true;
  $i15 := $mul.i64($i5,$i7);
  $i15.shadow := $mul.i64($i5.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 47, 41} true;
  assume {:verifier.code 0} true;
  $i16 := $xor.i64($i14,$i15);
  $i16.shadow := $xor.i64($i14.shadow,$i15.shadow);
  call {:cexpr "z0"} boogie_si_record_i64($i16);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 48, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $mul.i64($i2,$i7);
  $i17.shadow := $mul.i64($i2.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 48, 23} true;
  assume {:verifier.code 0} true;
  $i18 := $mul.i64($i3,$i6);
  $i18.shadow := $mul.i64($i3.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 48, 17} true;
  assume {:verifier.code 0} true;
  $i19 := $xor.i64($i17,$i18);
  $i19.shadow := $xor.i64($i17.shadow,$i18.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 48, 35} true;
  assume {:verifier.code 0} true;
  $i20 := $mul.i64($i4,$i9);
  $i20.shadow := $mul.i64($i4.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 48, 29} true;
  assume {:verifier.code 0} true;
  $i21 := $xor.i64($i19,$i20);
  $i21.shadow := $xor.i64($i19.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 48, 47} true;
  assume {:verifier.code 0} true;
  $i22 := $mul.i64($i5,$i8);
  $i22.shadow := $mul.i64($i5.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 48, 41} true;
  assume {:verifier.code 0} true;
  $i23 := $xor.i64($i21,$i22);
  $i23.shadow := $xor.i64($i21.shadow,$i22.shadow);
  call {:cexpr "z1"} boogie_si_record_i64($i23);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 49, 11} true;
  assume {:verifier.code 0} true;
  $i24 := $mul.i64($i2,$i8);
  $i24.shadow := $mul.i64($i2.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 49, 23} true;
  assume {:verifier.code 0} true;
  $i25 := $mul.i64($i3,$i7);
  $i25.shadow := $mul.i64($i3.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 49, 17} true;
  assume {:verifier.code 0} true;
  $i26 := $xor.i64($i24,$i25);
  $i26.shadow := $xor.i64($i24.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 49, 35} true;
  assume {:verifier.code 0} true;
  $i27 := $mul.i64($i4,$i6);
  $i27.shadow := $mul.i64($i4.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 49, 29} true;
  assume {:verifier.code 0} true;
  $i28 := $xor.i64($i26,$i27);
  $i28.shadow := $xor.i64($i26.shadow,$i27.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 49, 47} true;
  assume {:verifier.code 0} true;
  $i29 := $mul.i64($i5,$i9);
  $i29.shadow := $mul.i64($i5.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 49, 41} true;
  assume {:verifier.code 0} true;
  $i30 := $xor.i64($i28,$i29);
  $i30.shadow := $xor.i64($i28.shadow,$i29.shadow);
  call {:cexpr "z2"} boogie_si_record_i64($i30);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 50, 11} true;
  assume {:verifier.code 0} true;
  $i31 := $mul.i64($i2,$i9);
  $i31.shadow := $mul.i64($i2.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 50, 23} true;
  assume {:verifier.code 0} true;
  $i32 := $mul.i64($i3,$i8);
  $i32.shadow := $mul.i64($i3.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 50, 17} true;
  assume {:verifier.code 0} true;
  $i33 := $xor.i64($i31,$i32);
  $i33.shadow := $xor.i64($i31.shadow,$i32.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 50, 35} true;
  assume {:verifier.code 0} true;
  $i34 := $mul.i64($i4,$i7);
  $i34.shadow := $mul.i64($i4.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 50, 29} true;
  assume {:verifier.code 0} true;
  $i35 := $xor.i64($i33,$i34);
  $i35.shadow := $xor.i64($i33.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 50, 47} true;
  assume {:verifier.code 0} true;
  $i36 := $mul.i64($i5,$i6);
  $i36.shadow := $mul.i64($i5.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 50, 41} true;
  assume {:verifier.code 0} true;
  $i37 := $xor.i64($i35,$i36);
  $i37.shadow := $xor.i64($i35.shadow,$i36.shadow);
  call {:cexpr "z3"} boogie_si_record_i64($i37);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 51, 5} true;
  assume {:verifier.code 0} true;
  $i38 := $and.i64($i16,1229782938247303441);
  $i38.shadow := $and.i64($i16.shadow,1229782938247303441);
  call {:cexpr "z0"} boogie_si_record_i64($i38);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 52, 5} true;
  assume {:verifier.code 0} true;
  $i39 := $and.i64($i23,2459565876494606882);
  $i39.shadow := $and.i64($i23.shadow,2459565876494606882);
  call {:cexpr "z1"} boogie_si_record_i64($i39);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 53, 5} true;
  assume {:verifier.code 0} true;
  $i40 := $and.i64($i30,4919131752989213764);
  $i40.shadow := $and.i64($i30.shadow,4919131752989213764);
  call {:cexpr "z2"} boogie_si_record_i64($i40);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 54, 5} true;
  assume {:verifier.code 0} true;
  $i41 := $and.i64($i37,9838263505978427528);
  $i41.shadow := $and.i64($i37.shadow,9838263505978427528);
  call {:cexpr "z3"} boogie_si_record_i64($i41);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 55, 12} true;
  assume {:verifier.code 0} true;
  $i42 := $or.i64($i38,$i39);
  $i42.shadow := $or.i64($i38.shadow,$i39.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 55, 17} true;
  assume {:verifier.code 0} true;
  $i43 := $or.i64($i42,$i40);
  $i43.shadow := $or.i64($i42.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 55, 22} true;
  assume {:verifier.code 0} true;
  $i44 := $or.i64($i43,$i41);
  $i44.shadow := $or.i64($i43.shadow,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 55, 2} true;
  assume {:verifier.code 0} true;
  $r := $i44;
  $r.shadow := $i44.shadow;
  $exn := false;
...
axiom (br_enc64be == $sub.ref(0,13416));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i2 := $lshr.i64($i1,32);
  $i2.shadow := $lshr.i64($i1.shadow,32);
  assume {:sourceloc "../BearSSL/src/inner.h", 628, 18} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i64.i32($i2);
  $i3.shadow := $trunc.i64.i32($i2.shadow);
  ...
  assume {:verifier.code 0} true;
  $i5 := $trunc.i64.i32($i1);
  $i5.shadow := $trunc.i64.i32($i1.shadow);
...
axiom (br_enc32be == $sub.ref(0,14448));
...
axiom (br_dec32be == $sub.ref(0,15480));
...
axiom (__SMACK_dummy == $sub.ref(0,18576));
...
axiom (__SMACK_and32 == $sub.ref(0,19608));
...
axiom (__SMACK_and64 == $sub.ref(0,20640));
...
axiom (__SMACK_and16 == $sub.ref(0,21672));
...
axiom (__SMACK_and8 == $sub.ref(0,22704));
...
axiom (__SMACK_or32 == $sub.ref(0,23736));
...
axiom (__SMACK_or64 == $sub.ref(0,24768));
...
axiom (__SMACK_or16 == $sub.ref(0,25800));
...
axiom (__SMACK_or8 == $sub.ref(0,26832));
...
axiom (__SMACK_check_overflow == $sub.ref(0,27864));
...
axiom (__SMACK_loop_exit == $sub.ref(0,28896));
...
axiom (__SMACK_decls == $sub.ref(0,29928));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,30960));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,31992));
...
axiom (__SMACK_static_init == $sub.ref(0,33024));
