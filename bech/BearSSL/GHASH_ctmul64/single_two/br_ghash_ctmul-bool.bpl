...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_ghash_ctmul64($p0, $p0.dup, $p1, $p1.dup, $p2, $p2.dup, $i3, $i3.dup);
...
procedure {:inline 1} br_ghash_ctmul64($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1, $i3: i64, $i3.dup: i1)
modifies $exn, $M.1;
modifies $CurrAddr;
{
  var $p4: ref;
...
$bb0:
  ...
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 88, 7} true;
  assume {:verifier.code 0} true;
  call $i5, $i5.dup := br_dec64be($p0, $p0.dup);
...
$bb1:
  ...
  assert {:shadow_invariant} ($p15.dup == 0);
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  call br_enc64be($p0, $p0.dup, $i18, $i18.dup);
  ...
  assume {:verifier.code 0} true;
  call br_enc64be($p94, $p94.dup, $i17, $i17.dup);
...
$bb4:
  ...
  $p21.dup := $or.i1($p15.dup,$or.i1(0,0));
...
$bb5:
  ...
  call $M.1, $M.1.dup := $memcpy.i8($M.1, $M.1.dup, $M.1, $M.1.dup, $p26, $p26.dup, $p15, $p15.dup, $i16, $i16.dup, false, false);
  ...
  $p28.dup := $or.i1($or.i1($p4.dup,$or.i1(0,0)),$or.i1($i16.dup,0));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 109, 38} true;
  assume {:verifier.code 0} true;
  $i29 := $sub.i64(16,$i16);
  $i29.dup := $or.i1(0,$i16.dup);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 109, 4} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p28.dup == 0));
  $shadow_ok := ($shadow_ok && ($i29.dup == 0));
  call $M.1, $M.1.dup := $memset.i8($M.1, $M.1.dup, $p28, $p28.dup, 0, 0, $i29, $i29.dup, false, false);
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  call $i31, $i31.dup := br_dec64be($p25, $p25.dup);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul64.c", 113, 6} true;
  assume {:verifier.code 0} true;
  $i32 := $xor.i64($i18,$i31);
  $i32.dup := $or.i1($i18.dup,$i31.dup);
  ...
  assume {:verifier.code 0} true;
  call $i50, $i50.dup := rev64($i43, $i43.dup);
  ...
  assume {:verifier.code 0} true;
  call $i52, $i52.dup := rev64($i44, $i44.dup);
  ...
  assume {:verifier.code 0} true;
  call $i54, $i54.dup := rev64($i49, $i49.dup);
...
procedure {:inline 1} br_dec64be($p0: ref, $p0.dup: i1) returns ($r: i64, $r.dup: i1)
modifies $exn;
{
  var $i1: i32;
  var $i1.dup: i1;
...
$bb0:
  ...
  assume {:sourceloc "../BearSSL/src/inner.h", 656, 20} true;
  assume {:verifier.code 0} true;
  call $i1, $i1.dup := br_dec32be($p0, $p0.dup);
...
procedure {:inline 1} rev64($i0: i64, $i0.dup: i1) returns ($r: i64, $r.dup: i1)
modifies $exn;
{
  var $i1: i64;
  var $i1.dup: i1;
...
procedure {:inline 1} bmul64($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1) returns ($r: i64, $r.dup: i1)
modifies $exn;
{
  var $i2: i64;
  var $i2.dup: i1;
...
procedure {:inline 1} br_enc64be($p0: ref, $p0.dup: i1, $i1: i64, $i1.dup: i1)
modifies $exn;
modifies $M.1;
{
  var $i2: i64;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_enc32be($p0, $p0.dup, $i3, $i3.dup);
  ...
  assume {:verifier.code 0} true;
  call br_enc32be($p4, $p4.dup, $i5, $i5.dup);
