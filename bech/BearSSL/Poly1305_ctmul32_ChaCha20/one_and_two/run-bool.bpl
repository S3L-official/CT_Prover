...
var $M.11: [ref] ref;
var $M.11.dup: [ref] i1;
axiom ($GLOBALS_BOTTOM == $sub.ref(0,41288));
...
const br_poly1305_ctmul32_run: ref;
axiom (br_poly1305_ctmul32_run == $sub.ref(0,8264));
procedure {:inline 1} br_poly1305_ctmul32_run($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1, $i3: i64, $i3.dup: i1, $p4: ref, $p4.dup: i1, $i5: i64, $i5.dup: i1, $p6: ref, $p6.dup: i1, $p7: ref, $p7.dup: i1, $i8: i32, $i8.dup: i1)
modifies $M.5, $M.7, $M.8, $exn;
modifies $M.9;
modifies $M.10;
...
modifies $M.4;
{
  ...
  var $i227.dup: i1;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 178, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  $p10.dup := 0;
  assume {:verifier.code 0} true;
  call $p11 := $alloc($mul.ref(76,$zext.i32.i64(1)));
  $p11.dup := 0;
  assume {:verifier.code 0} true;
  call $p12 := $alloc($mul.ref(40,$zext.i32.i64(1)));
  $p12.dup := 0;
  call {:cexpr "br_poly1305_ctmul32_run:arg:len"} boogie_si_record_i64($i3);
  call {:cexpr "br_poly1305_ctmul32_run:arg:aad_len"} boogie_si_record_i64($i5);
  call {:cexpr "br_poly1305_ctmul32_run:arg:encrypt"} boogie_si_record_i32($i8);
  assume true;
  assume true;
  assume true;
  assume true;
  ...
  $p13.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 178, 2} true;
  assume {:verifier.code 0} true;
  $p13.dup := 0;
  call $M.5, $M.5.dup := $memset.i8($M.5, $M.5.dup, $p13, $p13.dup, 0, 0, 32, 0, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 179, 22} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p14.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  call $i15, $i15.dup := devirtbounce($p7, $p7.dup, $p0, $p0.dup, $p1, $p1.dup, 0, 0, $p14, $p14.dup, 32, 0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 185, 6} true;
  assume {:verifier.code 0} true;
  $i16 := $ne.i32($i8,0);
...
$bb1:
  assume ($i16 == 1);
  call $i17, $i17.dup := devirtbounce($p7, $p7.dup, $p0, $p0.dup, $p1, $p1.dup, 1, 0, $p2, $p2.dup, $i3, $i3.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 187, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 185, 6} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 200, 17} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p18.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 200, 6} true;
  assume {:verifier.code 0} true;
  call $i19, $i19.dup := br_dec32le.1($p18, $p18.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 200, 23} true;
  assume {:verifier.code 0} true;
  $i20 := $and.i32($i19,67108863);
  $i20.dup := $or.i1($i19.dup,0);
  call {:cexpr "z"} boogie_si_record_i32($i20);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 201, 11} true;
  assume {:verifier.code 0} true;
  $i21 := $and.i32($i20,8191);
  $i21.dup := $or.i1($i20.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 201, 2} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(9,4));
  $p22.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 201, 7} true;
  assume {:verifier.code 0} true;
  $p22.dup := 0;
  $M.7 := $store.i32($M.7,$p22,$i21);
  $M.7.dup := $store.i1($M.7.dup,$p22,$i21.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 202, 12} true;
  assume {:verifier.code 0} true;
  $i23 := $lshr.i32($i20,13);
  $i23.dup := $or.i1($i20.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 202, 2} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(10,4));
  $p24.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 202, 8} true;
  assume {:verifier.code 0} true;
  $p24.dup := 0;
  $M.7 := $store.i32($M.7,$p24,$i23);
  $M.7.dup := $store.i1($M.7.dup,$p24,$i23.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 203, 18} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p25.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p26 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(3,1));
  $p26.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 203, 7} true;
  assume {:verifier.code 0} true;
  call $i27, $i27.dup := br_dec32le.1($p26, $p26.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 203, 29} true;
  assume {:verifier.code 0} true;
  $i28 := $lshr.i32($i27,2);
  $i28.dup := $or.i1($i27.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 203, 35} true;
  assume {:verifier.code 0} true;
  $i29 := $and.i32($i28,67108611);
  $i29.dup := $or.i1($i28.dup,0);
  call {:cexpr "z"} boogie_si_record_i32($i29);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 204, 12} true;
  assume {:verifier.code 0} true;
  $i30 := $and.i32($i29,8191);
  $i30.dup := $or.i1($i29.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 204, 2} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(11,4));
  $p31.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 204, 8} true;
  assume {:verifier.code 0} true;
  $p31.dup := 0;
  $M.7 := $store.i32($M.7,$p31,$i30);
  $M.7.dup := $store.i1($M.7.dup,$p31,$i30.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 205, 12} true;
  assume {:verifier.code 0} true;
  $i32 := $lshr.i32($i29,13);
  $i32.dup := $or.i1($i29.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 205, 2} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(12,4));
  $p33.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 205, 8} true;
  assume {:verifier.code 0} true;
  $p33.dup := 0;
  $M.7 := $store.i32($M.7,$p33,$i32);
  $M.7.dup := $store.i1($M.7.dup,$p33,$i32.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 206, 18} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p34.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p35 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(6,1));
  $p35.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 206, 7} true;
  assume {:verifier.code 0} true;
  call $i36, $i36.dup := br_dec32le.1($p35, $p35.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 206, 29} true;
  assume {:verifier.code 0} true;
  $i37 := $lshr.i32($i36,4);
  $i37.dup := $or.i1($i36.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 206, 35} true;
  assume {:verifier.code 0} true;
  $i38 := $and.i32($i37,67092735);
  $i38.dup := $or.i1($i37.dup,0);
  call {:cexpr "z"} boogie_si_record_i32($i38);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 207, 12} true;
  assume {:verifier.code 0} true;
  $i39 := $and.i32($i38,8191);
  $i39.dup := $or.i1($i38.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 207, 2} true;
  assume {:verifier.code 0} true;
  $p40 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(13,4));
  $p40.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 207, 8} true;
  assume {:verifier.code 0} true;
  $p40.dup := 0;
  $M.7 := $store.i32($M.7,$p40,$i39);
  $M.7.dup := $store.i1($M.7.dup,$p40,$i39.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 208, 12} true;
  assume {:verifier.code 0} true;
  $i41 := $lshr.i32($i38,13);
  $i41.dup := $or.i1($i38.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 208, 2} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(14,4));
  $p42.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 208, 8} true;
  assume {:verifier.code 0} true;
  $p42.dup := 0;
  $M.7 := $store.i32($M.7,$p42,$i41);
  $M.7.dup := $store.i1($M.7.dup,$p42,$i41.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 209, 18} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p43.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p44 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(9,1));
  $p44.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 209, 7} true;
  assume {:verifier.code 0} true;
  call $i45, $i45.dup := br_dec32le.1($p44, $p44.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 209, 29} true;
  assume {:verifier.code 0} true;
  $i46 := $lshr.i32($i45,6);
  $i46.dup := $or.i1($i45.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 209, 35} true;
  assume {:verifier.code 0} true;
  $i47 := $and.i32($i46,66076671);
  $i47.dup := $or.i1($i46.dup,0);
  call {:cexpr "z"} boogie_si_record_i32($i47);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 210, 12} true;
  assume {:verifier.code 0} true;
  $i48 := $and.i32($i47,8191);
  $i48.dup := $or.i1($i47.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 210, 2} true;
  assume {:verifier.code 0} true;
  $p49 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(15,4));
  $p49.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 210, 8} true;
  assume {:verifier.code 0} true;
  $p49.dup := 0;
  $M.7 := $store.i32($M.7,$p49,$i48);
  $M.7.dup := $store.i1($M.7.dup,$p49,$i48.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 211, 12} true;
  assume {:verifier.code 0} true;
  $i50 := $lshr.i32($i47,13);
  $i50.dup := $or.i1($i47.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 211, 2} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(16,4));
  $p51.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 211, 8} true;
  assume {:verifier.code 0} true;
  $p51.dup := 0;
  $M.7 := $store.i32($M.7,$p51,$i50);
  $M.7.dup := $store.i1($M.7.dup,$p51,$i50.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 212, 18} true;
  assume {:verifier.code 0} true;
  $p52 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p52.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p53 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(12,1));
  $p53.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 212, 7} true;
  assume {:verifier.code 0} true;
  call $i54, $i54.dup := br_dec32le.1($p53, $p53.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 212, 29} true;
  assume {:verifier.code 0} true;
  $i55 := $lshr.i32($i54,8);
  $i55.dup := $or.i1($i54.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 212, 35} true;
  assume {:verifier.code 0} true;
  $i56 := $and.i32($i55,1048575);
  $i56.dup := $or.i1($i55.dup,0);
  call {:cexpr "z"} boogie_si_record_i32($i56);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 213, 12} true;
  assume {:verifier.code 0} true;
  $i57 := $and.i32($i56,8191);
  $i57.dup := $or.i1($i56.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 213, 2} true;
  assume {:verifier.code 0} true;
  $p58 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(17,4));
  $p58.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 213, 8} true;
  assume {:verifier.code 0} true;
  $p58.dup := 0;
  $M.7 := $store.i32($M.7,$p58,$i57);
  $M.7.dup := $store.i1($M.7.dup,$p58,$i57.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 214, 12} true;
  assume {:verifier.code 0} true;
  $i59 := $lshr.i32($i56,13);
  $i59.dup := $or.i1($i56.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 214, 2} true;
  assume {:verifier.code 0} true;
  $p60 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(18,4));
  $p60.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 214, 8} true;
  assume {:verifier.code 0} true;
  $p60.dup := 0;
  $M.7 := $store.i32($M.7,$p60,$i59);
  $M.7.dup := $store.i1($M.7.dup,$p60,$i59.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 219, 7} true;
  assume {:verifier.code 0} true;
  $i61 := 0;
  $i61.dup := 0;
  goto $bb4;
$bb4:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 219, 16} true;
  assume {:verifier.code 0} true;
  $i62 := $slt.i32($i61,9);
  $i62.dup := $or.i1($i61.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 219, 2} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i62 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 220, 10} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i61,10);
  $i63.dup := $or.i1($i61.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 220, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 220, 10} true;
  assume {:verifier.code 0} true;
  $p65 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref($i64,4));
  $p65.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1($i64.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 220, 10} true;
  assume {:verifier.code 0} true;
  $p65.dup := 0;
  $i66 := $load.i32($M.7,$p65);
  $i66.dup := $load.i1($M.7.dup,$p65);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 220, 10} true;
  assume {:verifier.code 0} true;
  $i67 := $mul.i32(5,$i66);
  $i67.dup := $or.i1(0,$i66.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 220, 3} true;
  assume {:verifier.code 0} true;
  $i68 := $sext.i32.i64($i61);
  $i68.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 220, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p69 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref($i68,4));
  $p69.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1($i68.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 220, 8} true;
  assume {:verifier.code 0} true;
  $p69.dup := 0;
  $M.7 := $store.i32($M.7,$p69,$i67);
  $M.7.dup := $store.i1($M.7.dup,$p69,$i67.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 221, 2} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !($i62 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $p71 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(0,4));
  $p71.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 226, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p72.dup := 0;
  call $M.8, $M.8.dup := $memset.i8($M.8, $M.8.dup, $p72, $p72.dup, 0, 0, 40, 0, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 232, 13} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($add.ref($p10,$mul.ref(0,16)),$mul.ref(0,1));
  $p73.dup := $or.i1($or.i1($p10.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 232, 2} true;
  assume {:verifier.code 0} true;
  call br_enc64le($p73, $p73.dup, $i5, $i5.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 233, 13} true;
  assume {:verifier.code 0} true;
  $p74 := $add.ref($add.ref($p10,$mul.ref(0,16)),$mul.ref(0,1));
  $p74.dup := $or.i1($or.i1($p10.dup,$or.i1(0,0)),$or.i1(0,0));
  $p75 := $add.ref($add.ref($p10,$mul.ref(0,16)),$mul.ref(8,1));
  $p75.dup := $or.i1($or.i1($p10.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 233, 2} true;
  assume {:verifier.code 0} true;
  call br_enc64le($p75, $p75.dup, $i3, $i3.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 234, 17} true;
  assume {:verifier.code 0} true;
  $p76 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(0,4));
  $p76.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 234, 22} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(0,4));
  $p77.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 234, 2} true;
  assume {:verifier.code 0} true;
  call poly1305_inner($p76, $p76.dup, $p77, $p77.dup, $p4, $p4.dup, $i5, $i5.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 235, 17} true;
  assume {:verifier.code 0} true;
  $p78 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(0,4));
  $p78.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 235, 22} true;
  assume {:verifier.code 0} true;
  $p79 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(0,4));
  $p79.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 235, 2} true;
  assume {:verifier.code 0} true;
  call poly1305_inner($p78, $p78.dup, $p79, $p79.dup, $p2, $p2.dup, $i3, $i3.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 236, 17} true;
  assume {:verifier.code 0} true;
  $p80 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(0,4));
  $p80.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 236, 22} true;
  assume {:verifier.code 0} true;
  $p81 := $add.ref($add.ref($p11,$mul.ref(0,76)),$mul.ref(0,4));
  $p81.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 236, 25} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($add.ref($p10,$mul.ref(0,16)),$mul.ref(0,1));
  $p82.dup := $or.i1($or.i1($p10.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 236, 2} true;
  assume {:verifier.code 0} true;
  call poly1305_inner($p80, $p80.dup, $p81, $p81.dup, $p82, $p82.dup, 16, 0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 246, 7} true;
  assume {:verifier.code 0} true;
  $i83 := 0;
  $i83.dup := 0;
  $i84 := 1;
  ...
  goto $bb8;
$bb7:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 219, 23} true;
  assume {:verifier.code 0} true;
  $i70 := $add.i32($i61,1);
  $i70.dup := $or.i1($i61.dup,0);
...
$bb8:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 246, 16} true;
  assume {:verifier.code 0} true;
  $i85 := $slt.i32($i84,10);
  $i85.dup := $or.i1($i84.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 246, 2} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume ($i85 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 247, 7} true;
  assume {:verifier.code 0} true;
  $i86 := $sext.i32.i64($i84);
  $i86.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 247, 7} true;
  assume {:verifier.code 0} true;
  $p87 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref($i86,4));
  $p87.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1($i86.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 247, 7} true;
  assume {:verifier.code 0} true;
  $p87.dup := 0;
  $i88 := $load.i32($M.8,$p87);
  $i88.dup := $load.i1($M.8.dup,$p87);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 247, 14} true;
  assume {:verifier.code 0} true;
  $i89 := $add.i32($i88,$i83);
  $i89.dup := $or.i1($i88.dup,$i83.dup);
  call {:cexpr "z"} boogie_si_record_i32($i89);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 248, 14} true;
  assume {:verifier.code 0} true;
  $i90 := $and.i32($i89,8191);
  $i90.dup := $or.i1($i89.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 248, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p92 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref($i91,4));
  $p92.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1($i91.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 248, 10} true;
  assume {:verifier.code 0} true;
  $p92.dup := 0;
  $M.8 := $store.i32($M.8,$p92,$i90);
  $M.8.dup := $store.i1($M.8.dup,$p92,$i90.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 249, 10} true;
  assume {:verifier.code 0} true;
  $i93 := $lshr.i32($i89,13);
  $i93.dup := $or.i1($i89.dup,0);
  call {:cexpr "cc"} boogie_si_record_i32($i93);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 250, 2} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb10:
  assume !($i85 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 251, 6} true;
  assume {:verifier.code 0} true;
  $p95 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(0,4));
  $p95.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 251, 6} true;
  assume {:verifier.code 0} true;
  $p95.dup := 0;
  $i96 := $load.i32($M.8,$p95);
  $i96.dup := $load.i1($M.8.dup,$p95);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 251, 13} true;
  assume {:verifier.code 0} true;
  $i97 := $add.i32($i96,$i83);
  $i97.dup := $or.i1($i96.dup,$i83.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 251, 24} true;
  assume {:verifier.code 0} true;
  $i98 := $shl.i32($i83,2);
  $i98.dup := $or.i1($i83.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 251, 18} true;
  assume {:verifier.code 0} true;
  $i99 := $add.i32($i97,$i98);
  $i99.dup := $or.i1($i97.dup,$i98.dup);
  call {:cexpr "z"} boogie_si_record_i32($i99);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 252, 13} true;
  assume {:verifier.code 0} true;
  $i100 := $and.i32($i99,8191);
  $i100.dup := $or.i1($i99.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 252, 2} true;
  assume {:verifier.code 0} true;
  $p101 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(0,4));
  $p101.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 252, 9} true;
  assume {:verifier.code 0} true;
  $p101.dup := 0;
  $M.8 := $store.i32($M.8,$p101,$i100);
  $M.8.dup := $store.i1($M.8.dup,$p101,$i100.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 253, 14} true;
  assume {:verifier.code 0} true;
  $i102 := $lshr.i32($i99,13);
  $i102.dup := $or.i1($i99.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 253, 2} true;
  assume {:verifier.code 0} true;
  $p103 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(1,4));
  $p103.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 253, 9} true;
  assume {:verifier.code 0} true;
  $p103.dup := 0;
  $i104 := $load.i32($M.8,$p103);
  $i104.dup := $load.i1($M.8.dup,$p103);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 253, 9} true;
  assume {:verifier.code 0} true;
  $i105 := $add.i32($i104,$i102);
  $i105.dup := $or.i1($i104.dup,$i102.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 253, 9} true;
  assume {:verifier.code 0} true;
  $p103.dup := 0;
  $M.8 := $store.i32($M.8,$p103,$i105);
  $M.8.dup := $store.i1($M.8.dup,$p103,$i105.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 260, 11} true;
  assume {:verifier.code 0} true;
  $p106 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(0,4));
  $p106.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 260, 11} true;
  assume {:verifier.code 0} true;
  $p106.dup := 0;
  $i107 := $load.i32($M.8,$p106);
  $i107.dup := $load.i1($M.8.dup,$p106);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 260, 8} true;
  assume {:verifier.code 0} true;
  call $i108, $i108.dup := GT($i107, $i107.dup, 8186, 0);
  call {:cexpr "ctl"} boogie_si_record_i32($i108);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 261, 7} true;
  assume {:verifier.code 0} true;
  $i109 := $i108;
  $i109.dup := $i108.dup;
  $i110 := 1;
  ...
  goto $bb12;
$bb11:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 246, 24} true;
  assume {:verifier.code 0} true;
  $i94 := $add.i32($i84,1);
  $i94.dup := $or.i1($i84.dup,0);
...
$bb12:
  ...
  assert {:likely_shadow_invariant} ($p12.dup == 0);
  assert {:likely_shadow_invariant} ($p9.dup == 0);
  assert {:unlikely_shadow_invariant ($i109.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i110.dup == 0)} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 261, 16} true;
  assume {:verifier.code 0} true;
  $i111 := $slt.i32($i110,10);
  $i111.dup := $or.i1($i110.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 261, 2} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i111 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 262, 13} true;
  assume {:verifier.code 0} true;
  $i112 := $sext.i32.i64($i110);
  $i112.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 262, 13} true;
  assume {:verifier.code 0} true;
  $p113 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref($i112,4));
  $p113.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1($i112.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 262, 13} true;
  assume {:verifier.code 0} true;
  $p113.dup := 0;
  $i114 := $load.i32($M.8,$p113);
  $i114.dup := $load.i1($M.8.dup,$p113);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 262, 10} true;
  assume {:verifier.code 0} true;
  call $i115, $i115.dup := EQ($i114, $i114.dup, 8191, 0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 262, 7} true;
  assume {:verifier.code 0} true;
  $i116 := $and.i32($i109,$i115);
  $i116.dup := $or.i1($i109.dup,$i115.dup);
  call {:cexpr "ctl"} boogie_si_record_i32($i116);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 263, 2} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb14:
  assume !($i111 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 264, 20} true;
  assume {:verifier.code 0} true;
  $p118 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(0,4));
  $p118.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 264, 20} true;
  assume {:verifier.code 0} true;
  $p118.dup := 0;
  $i119 := $load.i32($M.8,$p118);
  $i119.dup := $load.i1($M.8.dup,$p118);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 264, 27} true;
  assume {:verifier.code 0} true;
  $i120 := $sub.i32($i119,8187);
  $i120.dup := $or.i1($i119.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 264, 37} true;
  assume {:verifier.code 0} true;
  $p121 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(0,4));
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 264, 11} true;
  assume {:verifier.code 0} true;
  call $i123, $i123.dup := MUX($i109, $i109.dup, $i120, $i120.dup, $i122, $i122.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 264, 2} true;
  assume {:verifier.code 0} true;
  $p124 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(0,4));
  $p124.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 264, 9} true;
  assume {:verifier.code 0} true;
  $p124.dup := 0;
  $M.8 := $store.i32($M.8,$p124,$i123);
  $M.8.dup := $store.i1($M.8.dup,$p124,$i123.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 265, 7} true;
  assume {:verifier.code 0} true;
  $i125 := 1;
  $i125.dup := 0;
  goto $bb16;
$bb15:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 261, 24} true;
  assume {:verifier.code 0} true;
  $i117 := $add.i32($i110,1);
  $i117.dup := $or.i1($i110.dup,0);
...
$bb16:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 265, 16} true;
  assume {:verifier.code 0} true;
  $i126 := $slt.i32($i125,10);
  $i126.dup := $or.i1($i125.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 265, 2} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume ($i126 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 266, 15} true;
  assume {:verifier.code 0} true;
  $i127 := $sub.i32(0,$i109);
  $i127.dup := $or.i1(0,$i109.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 266, 13} true;
  assume {:verifier.code 0} true;
  $i128 := $xor.i32($i127,$sub.i32(0,1));
  $i128.dup := $or.i1($i127.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 266, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p130 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref($i129,4));
  $p130.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1($i129.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 266, 10} true;
  assume {:verifier.code 0} true;
  $p130.dup := 0;
  $i131 := $load.i32($M.8,$p130);
  $i131.dup := $load.i1($M.8.dup,$p130);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 266, 10} true;
  assume {:verifier.code 0} true;
  $i132 := $and.i32($i131,$i128);
  $i132.dup := $or.i1($i131.dup,$i128.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 266, 10} true;
  assume {:verifier.code 0} true;
  $p130.dup := 0;
  $M.8 := $store.i32($M.8,$p130,$i132);
  $M.8.dup := $store.i1($M.8.dup,$p130,$i132.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 267, 2} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb18:
  assume !($i126 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 274, 6} true;
  assume {:verifier.code 0} true;
  $p134 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(0,4));
  $p134.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 274, 6} true;
  assume {:verifier.code 0} true;
  $p134.dup := 0;
  $i135 := $load.i32($M.8,$p134);
  $i135.dup := $load.i1($M.8.dup,$p134);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 274, 16} true;
  assume {:verifier.code 0} true;
  $p136 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(1,4));
  $p136.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 274, 16} true;
  assume {:verifier.code 0} true;
  $p136.dup := 0;
  $i137 := $load.i32($M.8,$p136);
  $i137.dup := $load.i1($M.8.dup,$p136);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 274, 23} true;
  assume {:verifier.code 0} true;
  $i138 := $shl.i32($i137,13);
  $i138.dup := $or.i1($i137.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 274, 13} true;
  assume {:verifier.code 0} true;
  $i139 := $add.i32($i135,$i138);
  $i139.dup := $or.i1($i135.dup,$i138.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 274, 43} true;
  assume {:verifier.code 0} true;
  $p140 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p140.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p141 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(16,1));
  $p141.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 274, 32} true;
  assume {:verifier.code 0} true;
  call $i142, $i142.dup := br_dec16le($p141, $p141.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 274, 30} true;
  assume {:verifier.code 0} true;
  $i143 := $add.i32($i139,$i142);
  $i143.dup := $or.i1($i139.dup,$i142.dup);
  call {:cexpr "z"} boogie_si_record_i32($i143);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 275, 37} true;
  assume {:verifier.code 0} true;
  $i144 := $and.i32($i143,65535);
  $i144.dup := $or.i1($i143.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 275, 2} true;
  assume {:verifier.code 0} true;
  call br_enc16le($p6, $p6.dup, $i144, $i144.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 276, 9} true;
  assume {:verifier.code 0} true;
  $i145 := $lshr.i32($i143,16);
  $i145.dup := $or.i1($i143.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 276, 19} true;
  assume {:verifier.code 0} true;
  $p146 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(2,4));
  $p146.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 276, 19} true;
  assume {:verifier.code 0} true;
  $p146.dup := 0;
  $i147 := $load.i32($M.8,$p146);
  $i147.dup := $load.i1($M.8.dup,$p146);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 276, 26} true;
  assume {:verifier.code 0} true;
  $i148 := $shl.i32($i147,10);
  $i148.dup := $or.i1($i147.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 276, 16} true;
  assume {:verifier.code 0} true;
  $i149 := $add.i32($i145,$i148);
  $i149.dup := $or.i1($i145.dup,$i148.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 276, 46} true;
  assume {:verifier.code 0} true;
  $p150 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p150.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p151 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(18,1));
  $p151.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 276, 35} true;
  assume {:verifier.code 0} true;
  call $i152, $i152.dup := br_dec16le($p151, $p151.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 276, 33} true;
  assume {:verifier.code 0} true;
  $i153 := $add.i32($i149,$i152);
  $i153.dup := $or.i1($i149.dup,$i152.dup);
  call {:cexpr "z"} boogie_si_record_i32($i153);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 277, 34} true;
  assume {:verifier.code 0} true;
  $p154 := $add.ref($p6,$mul.ref(2,1));
  $p154.dup := $or.i1($p6.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 277, 41} true;
  assume {:verifier.code 0} true;
  $i155 := $and.i32($i153,65535);
  $i155.dup := $or.i1($i153.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 277, 2} true;
  assume {:verifier.code 0} true;
  call br_enc16le($p154, $p154.dup, $i155, $i155.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 278, 9} true;
  assume {:verifier.code 0} true;
  $i156 := $lshr.i32($i153,16);
  $i156.dup := $or.i1($i153.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 278, 19} true;
  assume {:verifier.code 0} true;
  $p157 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(3,4));
  $p157.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 278, 19} true;
  assume {:verifier.code 0} true;
  $p157.dup := 0;
  $i158 := $load.i32($M.8,$p157);
  $i158.dup := $load.i1($M.8.dup,$p157);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 278, 26} true;
  assume {:verifier.code 0} true;
  $i159 := $shl.i32($i158,7);
  $i159.dup := $or.i1($i158.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 278, 16} true;
  assume {:verifier.code 0} true;
  $i160 := $add.i32($i156,$i159);
  $i160.dup := $or.i1($i156.dup,$i159.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 278, 45} true;
  assume {:verifier.code 0} true;
  $p161 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p161.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p162 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(20,1));
  $p162.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 278, 34} true;
  assume {:verifier.code 0} true;
  call $i163, $i163.dup := br_dec16le($p162, $p162.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 278, 32} true;
  assume {:verifier.code 0} true;
  $i164 := $add.i32($i160,$i163);
  $i164.dup := $or.i1($i160.dup,$i163.dup);
  call {:cexpr "z"} boogie_si_record_i32($i164);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 279, 34} true;
  assume {:verifier.code 0} true;
  $p165 := $add.ref($p6,$mul.ref(4,1));
  $p165.dup := $or.i1($p6.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 279, 41} true;
  assume {:verifier.code 0} true;
  $i166 := $and.i32($i164,65535);
  $i166.dup := $or.i1($i164.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 279, 2} true;
  assume {:verifier.code 0} true;
  call br_enc16le($p165, $p165.dup, $i166, $i166.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 280, 9} true;
  assume {:verifier.code 0} true;
  $i167 := $lshr.i32($i164,16);
  $i167.dup := $or.i1($i164.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 280, 19} true;
  assume {:verifier.code 0} true;
  $p168 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(4,4));
  $p168.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 280, 19} true;
  assume {:verifier.code 0} true;
  $p168.dup := 0;
  $i169 := $load.i32($M.8,$p168);
  $i169.dup := $load.i1($M.8.dup,$p168);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 280, 26} true;
  assume {:verifier.code 0} true;
  $i170 := $shl.i32($i169,4);
  $i170.dup := $or.i1($i169.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 280, 16} true;
  assume {:verifier.code 0} true;
  $i171 := $add.i32($i167,$i170);
  $i171.dup := $or.i1($i167.dup,$i170.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 280, 45} true;
  assume {:verifier.code 0} true;
  $p172 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p172.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p173 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(22,1));
  $p173.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 280, 34} true;
  assume {:verifier.code 0} true;
  call $i174, $i174.dup := br_dec16le($p173, $p173.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 280, 32} true;
  assume {:verifier.code 0} true;
  $i175 := $add.i32($i171,$i174);
  $i175.dup := $or.i1($i171.dup,$i174.dup);
  call {:cexpr "z"} boogie_si_record_i32($i175);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 281, 34} true;
  assume {:verifier.code 0} true;
  $p176 := $add.ref($p6,$mul.ref(6,1));
  $p176.dup := $or.i1($p6.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 281, 41} true;
  assume {:verifier.code 0} true;
  $i177 := $and.i32($i175,65535);
  $i177.dup := $or.i1($i175.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 281, 2} true;
  assume {:verifier.code 0} true;
  call br_enc16le($p176, $p176.dup, $i177, $i177.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 282, 9} true;
  assume {:verifier.code 0} true;
  $i178 := $lshr.i32($i175,16);
  $i178.dup := $or.i1($i175.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 282, 19} true;
  assume {:verifier.code 0} true;
  $p179 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(5,4));
  $p179.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 282, 19} true;
  assume {:verifier.code 0} true;
  $p179.dup := 0;
  $i180 := $load.i32($M.8,$p179);
  $i180.dup := $load.i1($M.8.dup,$p179);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 282, 26} true;
  assume {:verifier.code 0} true;
  $i181 := $shl.i32($i180,1);
  $i181.dup := $or.i1($i180.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 282, 16} true;
  assume {:verifier.code 0} true;
  $i182 := $add.i32($i178,$i181);
  $i182.dup := $or.i1($i178.dup,$i181.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 282, 35} true;
  assume {:verifier.code 0} true;
  $p183 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(6,4));
  $p183.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 282, 35} true;
  assume {:verifier.code 0} true;
  $p183.dup := 0;
  $i184 := $load.i32($M.8,$p183);
  $i184.dup := $load.i1($M.8.dup,$p183);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 282, 42} true;
  assume {:verifier.code 0} true;
  $i185 := $shl.i32($i184,14);
  $i185.dup := $or.i1($i184.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 282, 32} true;
  assume {:verifier.code 0} true;
  $i186 := $add.i32($i182,$i185);
  $i186.dup := $or.i1($i182.dup,$i185.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 282, 62} true;
  assume {:verifier.code 0} true;
  $p187 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p187.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p188 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(24,1));
  $p188.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 282, 51} true;
  assume {:verifier.code 0} true;
  call $i189, $i189.dup := br_dec16le($p188, $p188.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 282, 49} true;
  assume {:verifier.code 0} true;
  $i190 := $add.i32($i186,$i189);
  $i190.dup := $or.i1($i186.dup,$i189.dup);
  call {:cexpr "z"} boogie_si_record_i32($i190);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 283, 34} true;
  assume {:verifier.code 0} true;
  $p191 := $add.ref($p6,$mul.ref(8,1));
  $p191.dup := $or.i1($p6.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 283, 41} true;
  assume {:verifier.code 0} true;
  $i192 := $and.i32($i190,65535);
  $i192.dup := $or.i1($i190.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 283, 2} true;
  assume {:verifier.code 0} true;
  call br_enc16le($p191, $p191.dup, $i192, $i192.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 284, 9} true;
  assume {:verifier.code 0} true;
  $i193 := $lshr.i32($i190,16);
  $i193.dup := $or.i1($i190.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 284, 19} true;
  assume {:verifier.code 0} true;
  $p194 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(7,4));
  $p194.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 284, 19} true;
  assume {:verifier.code 0} true;
  $p194.dup := 0;
  $i195 := $load.i32($M.8,$p194);
  $i195.dup := $load.i1($M.8.dup,$p194);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 284, 26} true;
  assume {:verifier.code 0} true;
  $i196 := $shl.i32($i195,11);
  $i196.dup := $or.i1($i195.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 284, 16} true;
  assume {:verifier.code 0} true;
  $i197 := $add.i32($i193,$i196);
  $i197.dup := $or.i1($i193.dup,$i196.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 284, 46} true;
  assume {:verifier.code 0} true;
  $p198 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p198.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p199 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(26,1));
  $p199.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 284, 35} true;
  assume {:verifier.code 0} true;
  call $i200, $i200.dup := br_dec16le($p199, $p199.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 284, 33} true;
  assume {:verifier.code 0} true;
  $i201 := $add.i32($i197,$i200);
  $i201.dup := $or.i1($i197.dup,$i200.dup);
  call {:cexpr "z"} boogie_si_record_i32($i201);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 285, 34} true;
  assume {:verifier.code 0} true;
  $p202 := $add.ref($p6,$mul.ref(10,1));
  $p202.dup := $or.i1($p6.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 285, 42} true;
  assume {:verifier.code 0} true;
  $i203 := $and.i32($i201,65535);
  $i203.dup := $or.i1($i201.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 285, 2} true;
  assume {:verifier.code 0} true;
  call br_enc16le($p202, $p202.dup, $i203, $i203.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 286, 9} true;
  assume {:verifier.code 0} true;
  $i204 := $lshr.i32($i201,16);
  $i204.dup := $or.i1($i201.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 286, 19} true;
  assume {:verifier.code 0} true;
  $p205 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(8,4));
  $p205.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 286, 19} true;
  assume {:verifier.code 0} true;
  $p205.dup := 0;
  $i206 := $load.i32($M.8,$p205);
  $i206.dup := $load.i1($M.8.dup,$p205);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 286, 26} true;
  assume {:verifier.code 0} true;
  $i207 := $shl.i32($i206,8);
  $i207.dup := $or.i1($i206.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 286, 16} true;
  assume {:verifier.code 0} true;
  $i208 := $add.i32($i204,$i207);
  $i208.dup := $or.i1($i204.dup,$i207.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 286, 45} true;
  assume {:verifier.code 0} true;
  $p209 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p209.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p210 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(28,1));
  $p210.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 286, 34} true;
  assume {:verifier.code 0} true;
  call $i211, $i211.dup := br_dec16le($p210, $p210.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 286, 32} true;
  assume {:verifier.code 0} true;
  $i212 := $add.i32($i208,$i211);
  $i212.dup := $or.i1($i208.dup,$i211.dup);
  call {:cexpr "z"} boogie_si_record_i32($i212);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 287, 34} true;
  assume {:verifier.code 0} true;
  $p213 := $add.ref($p6,$mul.ref(12,1));
  $p213.dup := $or.i1($p6.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 287, 42} true;
  assume {:verifier.code 0} true;
  $i214 := $and.i32($i212,65535);
  $i214.dup := $or.i1($i212.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 287, 2} true;
  assume {:verifier.code 0} true;
  call br_enc16le($p213, $p213.dup, $i214, $i214.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 288, 9} true;
  assume {:verifier.code 0} true;
  $i215 := $lshr.i32($i212,16);
  $i215.dup := $or.i1($i212.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 288, 19} true;
  assume {:verifier.code 0} true;
  $p216 := $add.ref($add.ref($p12,$mul.ref(0,40)),$mul.ref(9,4));
  $p216.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 288, 19} true;
  assume {:verifier.code 0} true;
  $p216.dup := 0;
  $i217 := $load.i32($M.8,$p216);
  $i217.dup := $load.i1($M.8.dup,$p216);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 288, 26} true;
  assume {:verifier.code 0} true;
  $i218 := $shl.i32($i217,5);
  $i218.dup := $or.i1($i217.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 288, 16} true;
  assume {:verifier.code 0} true;
  $i219 := $add.i32($i215,$i218);
  $i219.dup := $or.i1($i215.dup,$i218.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 288, 45} true;
  assume {:verifier.code 0} true;
  $p220 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p220.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p221 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(30,1));
  $p221.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 288, 34} true;
  assume {:verifier.code 0} true;
  call $i222, $i222.dup := br_dec16le($p221, $p221.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 288, 32} true;
  assume {:verifier.code 0} true;
  $i223 := $add.i32($i219,$i222);
  $i223.dup := $or.i1($i219.dup,$i222.dup);
  call {:cexpr "z"} boogie_si_record_i32($i223);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 289, 34} true;
  assume {:verifier.code 0} true;
  $p224 := $add.ref($p6,$mul.ref(14,1));
  $p224.dup := $or.i1($p6.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 289, 42} true;
  assume {:verifier.code 0} true;
  $i225 := $and.i32($i223,65535);
  $i225.dup := $or.i1($i223.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 289, 2} true;
  assume {:verifier.code 0} true;
  call br_enc16le($p224, $p224.dup, $i225, $i225.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 294, 7} true;
  assume {:verifier.code 0} true;
  $i226 := $ne.i32($i8,0);
  $i226.dup := $or.i1($i8.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 294, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i226} true;
  $i226.dup := 0;
  goto $bb20, $bb22;
$bb19:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 265, 24} true;
  assume {:verifier.code 0} true;
  $i133 := $add.i32($i125,1);
  $i133.dup := $or.i1($i125.dup,0);
  call {:cexpr "i"} boogie_si_record_i32($i133);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 265, 2} true;
  assume {:verifier.code 0} true;
  $i125 := $i133;
  $i125.dup := 0;
...
$bb20:
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 297, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.dup := false;
  return;
$bb22:
  assume !($i226 == 1);
  call $i227, $i227.dup := devirtbounce($p7, $p7.dup, $p0, $p0.dup, $p1, $p1.dup, 1, 0, $p2, $p2.dup, $i3, $i3.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 296, 2} true;
  assume {:verifier.code 0} true;
  goto $bb21;
}
...
procedure {:inline 1} br_dec32le.1($p0: ref, $p0.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $p1: ref;
  var $p1.dup: i1;
...
procedure {:inline 1} br_enc64le($p0: ref, $p0.dup: i1, $i1: i64, $i1.dup: i1)
modifies $M.5, $exn;
{
  var $p2: ref;
  var $p2.dup: i1;
...
$bb0:
  ...
  $M.5.dup := $store.i1($M.5.dup,$p3,$i1.dup);
...
procedure {:inline 1} poly1305_inner($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1, $i3: i64, $i3.dup: i1)
modifies $exn, $M.5, $M.8, $M.9;
modifies $CurrAddr;
{
  var $p4: ref;
  var $p4.dup: i1;
  ...
  var $i252.dup: i1;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 51, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 51, 13} true;
  assume {:verifier.code 0} true;
  $i8 := $ugt.i64($i7,0);
...
$bb2:
  ...
  assume true;
  assume true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 60, 11} true;
  assume {:verifier.code 0} true;
  $i9 := $ult.i64($i7,16);
  $i9.dup := $or.i1($i7.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 60, 7} true;
  assume {:verifier.code 0} true;
  $p10 := $p6;
  $p10.dup := 0;
  $i11 := $i7;
...
$bb3:
  assume !($i8 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 162, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.dup := false;
  return;
$bb4:
  assume ($i9 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 61, 4} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p12.dup := 0;
  call $M.5, $M.5.dup := $memset.i8($M.5, $M.5.dup, $p12, $p12.dup, 0, 0, 16, 0, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 62, 4} true;
  assume {:verifier.code 0} true;
  ...
  $p6.dup := 0;
  $i7.dup := 0;
  call $M.5, $M.5.dup := $memcpy.i8($M.5, $M.5.dup, $M.5, $M.5.dup, $p13, $p13.dup, $p6, $p6.dup, $i7, $i7.dup, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 63, 10} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(0,1));
  $p14.dup := $or.i1($or.i1($p4.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 65, 3} true;
  assume {:verifier.code 0} true;
  $p10 := $p4;
  $p10.dup := 0;
  $i11 := 16;
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 71, 7} true;
  assume {:verifier.code 0} true;
  call $i15, $i15.dup := br_dec16le($p10, $p10.dup);
  call {:cexpr "v"} boogie_si_record_i32($i15);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 72, 13} true;
  assume {:verifier.code 0} true;
  $i16 := $and.i32($i15,8191);
  $i16.dup := $or.i1($i15.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 72, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p17 := $add.ref($p0,$mul.ref(0,4));
  $p17.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 72, 8} true;
  assume {:verifier.code 0} true;
  $p17.dup := 0;
  $i18 := $load.i32($M.8,$p17);
  $i18.dup := $load.i1($M.8.dup,$p17);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 72, 8} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i18,$i16);
  $i19.dup := $or.i1($i18.dup,$i16.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 72, 8} true;
  assume {:verifier.code 0} true;
  $p17.dup := 0;
  $M.8 := $store.i32($M.8,$p17,$i19);
  $M.8.dup := $store.i1($M.8.dup,$p17,$i19.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 73, 5} true;
  assume {:verifier.code 0} true;
  $i20 := $lshr.i32($i15,13);
  $i20.dup := $or.i1($i15.dup,0);
  call {:cexpr "v"} boogie_si_record_i32($i20);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 74, 8} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p10,$mul.ref(2,1));
  $p21.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 74, 8} true;
  assume {:verifier.code 0} true;
  $p21.dup := 0;
  $i22 := $load.i8($M.5,$p21);
  ...
  $i23 := $zext.i8.i32($i22);
  $i23.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 74, 15} true;
  assume {:verifier.code 0} true;
  $i24 := $shl.i32($i23,3);
  $i24.dup := $or.i1($i23.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 74, 5} true;
  assume {:verifier.code 0} true;
  $i25 := $or.i32($i20,$i24);
  $i25.dup := 0;
  call {:cexpr "v"} boogie_si_record_i32($i25);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 75, 8} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p10,$mul.ref(3,1));
  $p26.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 75, 8} true;
  assume {:verifier.code 0} true;
  $p26.dup := 0;
  $i27 := $load.i8($M.5,$p26);
  ...
  $i28 := $zext.i8.i32($i27);
  $i28.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 75, 15} true;
  assume {:verifier.code 0} true;
  $i29 := $shl.i32($i28,11);
  $i29.dup := $or.i1($i28.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 75, 5} true;
  assume {:verifier.code 0} true;
  $i30 := $or.i32($i25,$i29);
  $i30.dup := 0;
  call {:cexpr "v"} boogie_si_record_i32($i30);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 76, 13} true;
  assume {:verifier.code 0} true;
  $i31 := $and.i32($i30,8191);
  $i31.dup := $or.i1($i30.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 76, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p32 := $add.ref($p0,$mul.ref(1,4));
  $p32.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 76, 8} true;
  assume {:verifier.code 0} true;
  $p32.dup := 0;
  ...
  assume {:verifier.code 0} true;
  $p32.dup := 0;
  $M.8 := $store.i32($M.8,$p32,$i34);
  $M.8.dup := $store.i1($M.8.dup,$p32,$i34.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 77, 5} true;
  assume {:verifier.code 0} true;
  $i35 := $lshr.i32($i30,13);
  $i35.dup := $or.i1($i30.dup,0);
  call {:cexpr "v"} boogie_si_record_i32($i35);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 78, 8} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($p10,$mul.ref(4,1));
  $p36.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 78, 8} true;
  assume {:verifier.code 0} true;
  $p36.dup := 0;
  $i37 := $load.i8($M.5,$p36);
  ...
  $i38 := $zext.i8.i32($i37);
  $i38.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 78, 15} true;
  assume {:verifier.code 0} true;
  $i39 := $shl.i32($i38,6);
  $i39.dup := $or.i1($i38.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 78, 5} true;
  assume {:verifier.code 0} true;
  $i40 := $or.i32($i35,$i39);
  $i40.dup := 0;
  call {:cexpr "v"} boogie_si_record_i32($i40);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 79, 13} true;
  assume {:verifier.code 0} true;
  $i41 := $and.i32($i40,8191);
  $i41.dup := $or.i1($i40.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 79, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p42 := $add.ref($p0,$mul.ref(2,4));
  $p42.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 79, 8} true;
  assume {:verifier.code 0} true;
  $p42.dup := 0;
  $i43 := $load.i32($M.8,$p42);
  $i43.dup := $load.i1($M.8.dup,$p42);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 79, 8} true;
  assume {:verifier.code 0} true;
  $i44 := $add.i32($i43,$i41);
  ...
  assume {:verifier.code 0} true;
  $p42.dup := 0;
  $M.8 := $store.i32($M.8,$p42,$i44);
  $M.8.dup := $store.i1($M.8.dup,$p42,$i44.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 80, 5} true;
  assume {:verifier.code 0} true;
  $i45 := $lshr.i32($i40,13);
  $i45.dup := $or.i1($i40.dup,0);
  call {:cexpr "v"} boogie_si_record_i32($i45);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 81, 8} true;
  assume {:verifier.code 0} true;
  $p46 := $add.ref($p10,$mul.ref(5,1));
  $p46.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 81, 8} true;
  assume {:verifier.code 0} true;
  $p46.dup := 0;
  $i47 := $load.i8($M.5,$p46);
  ...
  $i48 := $zext.i8.i32($i47);
  $i48.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 81, 15} true;
  assume {:verifier.code 0} true;
  $i49 := $shl.i32($i48,1);
  $i49.dup := $or.i1($i48.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 81, 5} true;
  assume {:verifier.code 0} true;
  $i50 := $or.i32($i45,$i49);
  $i50.dup := 0;
  call {:cexpr "v"} boogie_si_record_i32($i50);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 82, 8} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($p10,$mul.ref(6,1));
  $p51.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 82, 8} true;
  assume {:verifier.code 0} true;
  $p51.dup := 0;
  $i52 := $load.i8($M.5,$p51);
  ...
  $i53 := $zext.i8.i32($i52);
  $i53.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 82, 15} true;
  assume {:verifier.code 0} true;
  $i54 := $shl.i32($i53,9);
  $i54.dup := $or.i1($i53.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 82, 5} true;
  assume {:verifier.code 0} true;
  $i55 := $or.i32($i50,$i54);
  $i55.dup := 0;
  call {:cexpr "v"} boogie_si_record_i32($i55);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 83, 13} true;
  assume {:verifier.code 0} true;
  $i56 := $and.i32($i55,8191);
  $i56.dup := $or.i1($i55.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 83, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p57 := $add.ref($p0,$mul.ref(3,4));
  $p57.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 83, 8} true;
  assume {:verifier.code 0} true;
  $p57.dup := 0;
  $i58 := $load.i32($M.8,$p57);
  $i58.dup := $load.i1($M.8.dup,$p57);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 83, 8} true;
  assume {:verifier.code 0} true;
  $i59 := $add.i32($i58,$i56);
  ...
  assume {:verifier.code 0} true;
  $p57.dup := 0;
  $M.8 := $store.i32($M.8,$p57,$i59);
  $M.8.dup := $store.i1($M.8.dup,$p57,$i59.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 84, 5} true;
  assume {:verifier.code 0} true;
  $i60 := $lshr.i32($i55,13);
  $i60.dup := $or.i1($i55.dup,0);
  call {:cexpr "v"} boogie_si_record_i32($i60);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 85, 8} true;
  assume {:verifier.code 0} true;
  $p61 := $add.ref($p10,$mul.ref(7,1));
  $p61.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 85, 8} true;
  assume {:verifier.code 0} true;
  $p61.dup := 0;
  $i62 := $load.i8($M.5,$p61);
  ...
  $i63 := $zext.i8.i32($i62);
  $i63.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 85, 15} true;
  assume {:verifier.code 0} true;
  $i64 := $shl.i32($i63,4);
  $i64.dup := $or.i1($i63.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 85, 5} true;
  assume {:verifier.code 0} true;
  $i65 := $or.i32($i60,$i64);
  $i65.dup := 0;
  call {:cexpr "v"} boogie_si_record_i32($i65);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 86, 8} true;
  assume {:verifier.code 0} true;
  $p66 := $add.ref($p10,$mul.ref(8,1));
  $p66.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 86, 8} true;
  assume {:verifier.code 0} true;
  $p66.dup := 0;
  $i67 := $load.i8($M.5,$p66);
  ...
  $i68 := $zext.i8.i32($i67);
  $i68.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 86, 15} true;
  assume {:verifier.code 0} true;
  $i69 := $shl.i32($i68,12);
  $i69.dup := $or.i1($i68.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 86, 5} true;
  assume {:verifier.code 0} true;
  $i70 := $or.i32($i65,$i69);
  $i70.dup := 0;
  call {:cexpr "v"} boogie_si_record_i32($i70);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 87, 13} true;
  assume {:verifier.code 0} true;
  $i71 := $and.i32($i70,8191);
  $i71.dup := $or.i1($i70.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 87, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p72 := $add.ref($p0,$mul.ref(4,4));
  $p72.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 87, 8} true;
  assume {:verifier.code 0} true;
  $p72.dup := 0;
  $i73 := $load.i32($M.8,$p72);
  $i73.dup := $load.i1($M.8.dup,$p72);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 87, 8} true;
  assume {:verifier.code 0} true;
  $i74 := $add.i32($i73,$i71);
  ...
  assume {:verifier.code 0} true;
  $p72.dup := 0;
  $M.8 := $store.i32($M.8,$p72,$i74);
  $M.8.dup := $store.i1($M.8.dup,$p72,$i74.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 88, 5} true;
  assume {:verifier.code 0} true;
  $i75 := $lshr.i32($i70,13);
  $i75.dup := $or.i1($i70.dup,0);
  call {:cexpr "v"} boogie_si_record_i32($i75);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 89, 8} true;
  assume {:verifier.code 0} true;
  $p76 := $add.ref($p10,$mul.ref(9,1));
  $p76.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 89, 8} true;
  assume {:verifier.code 0} true;
  $p76.dup := 0;
  $i77 := $load.i8($M.5,$p76);
  ...
  $i78 := $zext.i8.i32($i77);
  $i78.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 89, 15} true;
  assume {:verifier.code 0} true;
  $i79 := $shl.i32($i78,7);
  $i79.dup := $or.i1($i78.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 89, 5} true;
  assume {:verifier.code 0} true;
  $i80 := $or.i32($i75,$i79);
  $i80.dup := 0;
  call {:cexpr "v"} boogie_si_record_i32($i80);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 90, 13} true;
  assume {:verifier.code 0} true;
  $i81 := $and.i32($i80,8191);
  $i81.dup := $or.i1($i80.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 90, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p82 := $add.ref($p0,$mul.ref(5,4));
  $p82.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 90, 8} true;
  assume {:verifier.code 0} true;
  $p82.dup := 0;
  $i83 := $load.i32($M.8,$p82);
  $i83.dup := $load.i1($M.8.dup,$p82);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 90, 8} true;
  assume {:verifier.code 0} true;
  $i84 := $add.i32($i83,$i81);
  ...
  assume {:verifier.code 0} true;
  $p82.dup := 0;
  $M.8 := $store.i32($M.8,$p82,$i84);
  $M.8.dup := $store.i1($M.8.dup,$p82,$i84.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 91, 5} true;
  assume {:verifier.code 0} true;
  $i85 := $lshr.i32($i80,13);
  $i85.dup := $or.i1($i80.dup,0);
  call {:cexpr "v"} boogie_si_record_i32($i85);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 92, 8} true;
  assume {:verifier.code 0} true;
  $p86 := $add.ref($p10,$mul.ref(10,1));
  $p86.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 92, 8} true;
  assume {:verifier.code 0} true;
  $p86.dup := 0;
  $i87 := $load.i8($M.5,$p86);
  ...
  $i88 := $zext.i8.i32($i87);
  $i88.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 92, 16} true;
  assume {:verifier.code 0} true;
  $i89 := $shl.i32($i88,2);
  $i89.dup := $or.i1($i88.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 92, 5} true;
  assume {:verifier.code 0} true;
  $i90 := $or.i32($i85,$i89);
  $i90.dup := 0;
  call {:cexpr "v"} boogie_si_record_i32($i90);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 93, 8} true;
  assume {:verifier.code 0} true;
  $p91 := $add.ref($p10,$mul.ref(11,1));
  $p91.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 93, 8} true;
  assume {:verifier.code 0} true;
  $p91.dup := 0;
  $i92 := $load.i8($M.5,$p91);
  ...
  $i93 := $zext.i8.i32($i92);
  $i93.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 93, 16} true;
  assume {:verifier.code 0} true;
  $i94 := $shl.i32($i93,10);
  $i94.dup := $or.i1($i93.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 93, 5} true;
  assume {:verifier.code 0} true;
  $i95 := $or.i32($i90,$i94);
  $i95.dup := 0;
  call {:cexpr "v"} boogie_si_record_i32($i95);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 94, 13} true;
  assume {:verifier.code 0} true;
  $i96 := $and.i32($i95,8191);
  $i96.dup := $or.i1($i95.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 94, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p97 := $add.ref($p0,$mul.ref(6,4));
  $p97.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 94, 8} true;
  assume {:verifier.code 0} true;
  $p97.dup := 0;
  $i98 := $load.i32($M.8,$p97);
  $i98.dup := $load.i1($M.8.dup,$p97);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 94, 8} true;
  assume {:verifier.code 0} true;
  $i99 := $add.i32($i98,$i96);
  ...
  assume {:verifier.code 0} true;
  $p97.dup := 0;
  $M.8 := $store.i32($M.8,$p97,$i99);
  $M.8.dup := $store.i1($M.8.dup,$p97,$i99.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 95, 5} true;
  assume {:verifier.code 0} true;
  $i100 := $lshr.i32($i95,13);
  $i100.dup := $or.i1($i95.dup,0);
  call {:cexpr "v"} boogie_si_record_i32($i100);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 96, 8} true;
  assume {:verifier.code 0} true;
  $p101 := $add.ref($p10,$mul.ref(12,1));
  $p101.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 96, 8} true;
  assume {:verifier.code 0} true;
  $p101.dup := 0;
  $i102 := $load.i8($M.5,$p101);
  $i102.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 96, 8} true;
  assume {:verifier.code 0} true;
  $i103 := $zext.i8.i32($i102);
  $i103.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 96, 16} true;
  assume {:verifier.code 0} true;
  $i104 := $shl.i32($i103,5);
  $i104.dup := $or.i1($i103.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 96, 5} true;
  assume {:verifier.code 0} true;
  $i105 := $or.i32($i100,$i104);
  $i105.dup := 0;
  call {:cexpr "v"} boogie_si_record_i32($i105);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 97, 13} true;
  assume {:verifier.code 0} true;
  $i106 := $and.i32($i105,8191);
  $i106.dup := $or.i1($i105.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 97, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p107 := $add.ref($p0,$mul.ref(7,4));
  $p107.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 97, 8} true;
  assume {:verifier.code 0} true;
  $p107.dup := 0;
  ...
  $i109.dup := $or.i1($i108.dup,$i106.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 97, 8} true;
  assume {:verifier.code 0} true;
  $p107.dup := 0;
  $M.8 := $store.i32($M.8,$p107,$i109);
  $M.8.dup := $store.i1($M.8.dup,$p107,$i109.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 98, 22} true;
  assume {:verifier.code 0} true;
  $p110 := $add.ref($p10,$mul.ref(13,1));
  $p110.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 98, 7} true;
  assume {:verifier.code 0} true;
  call $i111, $i111.dup := br_dec16le($p110, $p110.dup);
  call {:cexpr "v"} boogie_si_record_i32($i111);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 99, 13} true;
  assume {:verifier.code 0} true;
  $i112 := $and.i32($i111,8191);
  $i112.dup := $or.i1($i111.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 99, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p113 := $add.ref($p0,$mul.ref(8,4));
  $p113.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 99, 8} true;
  assume {:verifier.code 0} true;
  $p113.dup := 0;
  $i114 := $load.i32($M.8,$p113);
  $i114.dup := $load.i1($M.8.dup,$p113);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 99, 8} true;
  assume {:verifier.code 0} true;
  $i115 := $add.i32($i114,$i112);
  $i115.dup := $or.i1($i114.dup,$i112.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 99, 8} true;
  assume {:verifier.code 0} true;
  $p113.dup := 0;
  $M.8 := $store.i32($M.8,$p113,$i115);
  $M.8.dup := $store.i1($M.8.dup,$p113,$i115.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 100, 5} true;
  assume {:verifier.code 0} true;
  $i116 := $lshr.i32($i111,13);
  $i116.dup := $or.i1($i111.dup,0);
  call {:cexpr "v"} boogie_si_record_i32($i116);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 101, 8} true;
  assume {:verifier.code 0} true;
  $p117 := $add.ref($p10,$mul.ref(15,1));
  $p117.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 101, 8} true;
  assume {:verifier.code 0} true;
  $p117.dup := 0;
  $i118 := $load.i8($M.5,$p117);
  $i118.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 101, 8} true;
  assume {:verifier.code 0} true;
  $i119 := $zext.i8.i32($i118);
  $i119.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 101, 16} true;
  assume {:verifier.code 0} true;
  $i120 := $shl.i32($i119,3);
  $i120.dup := $or.i1($i119.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 101, 5} true;
  assume {:verifier.code 0} true;
  $i121 := $or.i32($i116,$i120);
  $i121.dup := 0;
  call {:cexpr "v"} boogie_si_record_i32($i121);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 102, 13} true;
  assume {:verifier.code 0} true;
  $i122 := $or.i32($i121,2048);
  $i122.dup := $or.i1($i121.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 102, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p123 := $add.ref($p0,$mul.ref(9,4));
  $p123.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 102, 8} true;
  assume {:verifier.code 0} true;
  $p123.dup := 0;
  $i124 := $load.i32($M.8,$p123);
  $i124.dup := $load.i1($M.8.dup,$p123);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 102, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p123.dup := 0;
  $M.8 := $store.i32($M.8,$p123,$i125);
  $M.8.dup := $store.i1($M.8.dup,$p123,$i125.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 123, 8} true;
  assume {:verifier.code 0} true;
  $i126 := 0;
  $i126.dup := 0;
  $i127 := 0;
...
$bb7:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 123, 17} true;
  assume {:verifier.code 0} true;
  $i128 := $ult.i32($i126,10);
  $i128.dup := $or.i1($i126.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 123, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume ($i128 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 127, 7} true;
  assume {:verifier.code 0} true;
  $p129 := $add.ref($p0,$mul.ref(0,4));
  $p129.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 127, 7} true;
  assume {:verifier.code 0} true;
  $p129.dup := 0;
  $i130 := $load.i32($M.8,$p129);
  $i130.dup := $load.i1($M.8.dup,$p129);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 127, 7} true;
  assume {:verifier.code 0} true;
  $i131 := $add.i32($i126,9);
  $i131.dup := $or.i1($i126.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 127, 7} true;
  assume {:verifier.code 0} true;
  $i132 := $sub.i32($i131,0);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 127, 7} true;
  assume {:verifier.code 0} true;
  $p134 := $add.ref($p1,$mul.ref($i133,4));
  $p134.dup := $or.i1($p1.dup,$or.i1($i133.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 127, 7} true;
  assume {:verifier.code 0} true;
  $p134.dup := 0;
  $i135 := $load.i32($M.7,$p134);
  $i135.dup := $load.i1($M.7.dup,$p134);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 127, 7} true;
  assume {:verifier.code 0} true;
  $i136 := $mul.i32($i130,$i135);
  $i136.dup := $or.i1($i130.dup,$i135.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 127, 5} true;
  assume {:verifier.code 0} true;
  $i137 := $add.i32($i127,$i136);
  $i137.dup := $or.i1($i127.dup,$i136.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 128, 7} true;
  assume {:verifier.code 0} true;
  $p138 := $add.ref($p0,$mul.ref(1,4));
  $p138.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 128, 7} true;
  assume {:verifier.code 0} true;
  $p138.dup := 0;
  $i139 := $load.i32($M.8,$p138);
  $i139.dup := $load.i1($M.8.dup,$p138);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 128, 7} true;
  assume {:verifier.code 0} true;
  $i140 := $add.i32($i126,9);
  $i140.dup := $or.i1($i126.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 128, 7} true;
  assume {:verifier.code 0} true;
  $i141 := $sub.i32($i140,1);
  $i141.dup := $or.i1($i140.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 128, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 128, 7} true;
  assume {:verifier.code 0} true;
  $p143 := $add.ref($p1,$mul.ref($i142,4));
  $p143.dup := $or.i1($p1.dup,$or.i1($i142.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 128, 7} true;
  assume {:verifier.code 0} true;
  $p143.dup := 0;
  $i144 := $load.i32($M.7,$p143);
  $i144.dup := $load.i1($M.7.dup,$p143);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 128, 7} true;
  assume {:verifier.code 0} true;
  $i145 := $mul.i32($i139,$i144);
  $i145.dup := $or.i1($i139.dup,$i144.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 128, 5} true;
  assume {:verifier.code 0} true;
  $i146 := $add.i32($i137,$i145);
  $i146.dup := $or.i1($i137.dup,$i145.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 129, 7} true;
  assume {:verifier.code 0} true;
  $p147 := $add.ref($p0,$mul.ref(2,4));
  $p147.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 129, 7} true;
  assume {:verifier.code 0} true;
  $p147.dup := 0;
  $i148 := $load.i32($M.8,$p147);
  $i148.dup := $load.i1($M.8.dup,$p147);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 129, 7} true;
  assume {:verifier.code 0} true;
  $i149 := $add.i32($i126,9);
  $i149.dup := $or.i1($i126.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 129, 7} true;
  assume {:verifier.code 0} true;
  $i150 := $sub.i32($i149,2);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 129, 7} true;
  assume {:verifier.code 0} true;
  $p152 := $add.ref($p1,$mul.ref($i151,4));
  $p152.dup := $or.i1($p1.dup,$or.i1($i151.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 129, 7} true;
  assume {:verifier.code 0} true;
  $p152.dup := 0;
  $i153 := $load.i32($M.7,$p152);
  $i153.dup := $load.i1($M.7.dup,$p152);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 129, 7} true;
  assume {:verifier.code 0} true;
  $i154 := $mul.i32($i148,$i153);
  $i154.dup := $or.i1($i148.dup,$i153.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 129, 5} true;
  assume {:verifier.code 0} true;
  $i155 := $add.i32($i146,$i154);
  $i155.dup := $or.i1($i146.dup,$i154.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 130, 7} true;
  assume {:verifier.code 0} true;
  $p156 := $add.ref($p0,$mul.ref(3,4));
  $p156.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 130, 7} true;
  assume {:verifier.code 0} true;
  $p156.dup := 0;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 130, 7} true;
  assume {:verifier.code 0} true;
  $p161 := $add.ref($p1,$mul.ref($i160,4));
  $p161.dup := $or.i1($p1.dup,$or.i1($i160.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 130, 7} true;
  assume {:verifier.code 0} true;
  $p161.dup := 0;
  $i162 := $load.i32($M.7,$p161);
  $i162.dup := $load.i1($M.7.dup,$p161);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 130, 7} true;
  assume {:verifier.code 0} true;
  $i163 := $mul.i32($i157,$i162);
  $i163.dup := $or.i1($i157.dup,$i162.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 130, 5} true;
  assume {:verifier.code 0} true;
  $i164 := $add.i32($i155,$i163);
  $i164.dup := $or.i1($i155.dup,$i163.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 131, 7} true;
  assume {:verifier.code 0} true;
  $p165 := $add.ref($p0,$mul.ref(4,4));
  $p165.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 131, 7} true;
  assume {:verifier.code 0} true;
  $p165.dup := 0;
  $i166 := $load.i32($M.8,$p165);
  $i166.dup := $load.i1($M.8.dup,$p165);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 131, 7} true;
  assume {:verifier.code 0} true;
  $i167 := $add.i32($i126,9);
  $i167.dup := $or.i1($i126.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 131, 7} true;
  assume {:verifier.code 0} true;
  $i168 := $sub.i32($i167,4);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 131, 7} true;
  assume {:verifier.code 0} true;
  $p170 := $add.ref($p1,$mul.ref($i169,4));
  $p170.dup := $or.i1($p1.dup,$or.i1($i169.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 131, 7} true;
  assume {:verifier.code 0} true;
  $p170.dup := 0;
  $i171 := $load.i32($M.7,$p170);
  $i171.dup := $load.i1($M.7.dup,$p170);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 131, 7} true;
  assume {:verifier.code 0} true;
  $i172 := $mul.i32($i166,$i171);
  $i172.dup := $or.i1($i166.dup,$i171.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 131, 5} true;
  assume {:verifier.code 0} true;
  $i173 := $add.i32($i164,$i172);
  $i173.dup := $or.i1($i164.dup,$i172.dup);
  call {:cexpr "s"} boogie_si_record_i32($i173);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 132, 13} true;
  assume {:verifier.code 0} true;
  $i174 := $and.i32($i173,8191);
  $i174.dup := $or.i1($i173.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 132, 4} true;
  assume {:verifier.code 0} true;
  $i175 := $zext.i32.i64($i126);
  $i175.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 132, 4} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p176 := $add.ref($add.ref($p5,$mul.ref(0,40)),$mul.ref($i175,4));
  $p176.dup := $or.i1($or.i1($p5.dup,$or.i1(0,0)),$or.i1($i175.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 132, 9} true;
  assume {:verifier.code 0} true;
  $p176.dup := 0;
  $M.9 := $store.i32($M.9,$p176,$i174);
  $M.9.dup := $store.i1($M.9.dup,$p176,$i174.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 133, 12} true;
  assume {:verifier.code 0} true;
  $i177 := $lshr.i32($i173,13);
  $i177.dup := $or.i1($i173.dup,0);
  call {:cexpr "cc1"} boogie_si_record_i32($i177);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 134, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !($i128 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 136, 8} true;
  assume {:verifier.code 0} true;
  $i179 := 0;
  $i179.dup := 0;
  $i180 := 0;
  ...
  goto $bb11;
$bb10:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 123, 25} true;
  assume {:verifier.code 0} true;
  $i178 := $add.i32($i126,1);
  $i178.dup := $or.i1($i126.dup,0);
  call {:cexpr "u"} boogie_si_record_i32($i178);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 123, 3} true;
  assume {:verifier.code 0} true;
  $i126 := $i178;
  $i126.dup := 0;
...
$bb11:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 136, 17} true;
  assume {:verifier.code 0} true;
  $i181 := $ult.i32($i179,10);
  $i181.dup := $or.i1($i179.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 136, 3} true;
  assume {:verifier.code 0} true;
...
$bb12:
  assume ($i181 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 139, 8} true;
  assume {:verifier.code 0} true;
  $i182 := $zext.i32.i64($i179);
  $i182.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 139, 8} true;
  assume {:verifier.code 0} true;
  $p183 := $add.ref($add.ref($p5,$mul.ref(0,40)),$mul.ref($i182,4));
  $p183.dup := $or.i1($or.i1($p5.dup,$or.i1(0,0)),$or.i1($i182.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 139, 8} true;
  assume {:verifier.code 0} true;
  $p183.dup := 0;
  $i184 := $load.i32($M.9,$p183);
  $i184.dup := $load.i1($M.9.dup,$p183);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 139, 13} true;
  assume {:verifier.code 0} true;
  $i185 := $add.i32($i184,$i180);
  $i185.dup := $or.i1($i184.dup,$i180.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 140, 7} true;
  assume {:verifier.code 0} true;
  $p186 := $add.ref($p0,$mul.ref(5,4));
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 140, 7} true;
  assume {:verifier.code 0} true;
  $p191 := $add.ref($p1,$mul.ref($i190,4));
  $p191.dup := $or.i1($p1.dup,$or.i1($i190.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 140, 7} true;
  assume {:verifier.code 0} true;
  $p191.dup := 0;
  $i192 := $load.i32($M.7,$p191);
  $i192.dup := $load.i1($M.7.dup,$p191);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 140, 7} true;
  assume {:verifier.code 0} true;
  $i193 := $mul.i32($i187,$i192);
  $i193.dup := $or.i1($i187.dup,$i192.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 140, 5} true;
  assume {:verifier.code 0} true;
  $i194 := $add.i32($i185,$i193);
  $i194.dup := $or.i1($i185.dup,$i193.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 141, 7} true;
  assume {:verifier.code 0} true;
  $p195 := $add.ref($p0,$mul.ref(6,4));
  $p195.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 141, 7} true;
  assume {:verifier.code 0} true;
  $p195.dup := 0;
  $i196 := $load.i32($M.8,$p195);
  $i196.dup := $load.i1($M.8.dup,$p195);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 141, 7} true;
  assume {:verifier.code 0} true;
  $i197 := $add.i32($i179,9);
  $i197.dup := $or.i1($i179.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 141, 7} true;
  assume {:verifier.code 0} true;
  $i198 := $sub.i32($i197,6);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 141, 7} true;
  assume {:verifier.code 0} true;
  $p200 := $add.ref($p1,$mul.ref($i199,4));
  $p200.dup := $or.i1($p1.dup,$or.i1($i199.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 141, 7} true;
  assume {:verifier.code 0} true;
  $p200.dup := 0;
  $i201 := $load.i32($M.7,$p200);
  $i201.dup := $load.i1($M.7.dup,$p200);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 141, 7} true;
  assume {:verifier.code 0} true;
  $i202 := $mul.i32($i196,$i201);
  $i202.dup := $or.i1($i196.dup,$i201.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 141, 5} true;
  assume {:verifier.code 0} true;
  $i203 := $add.i32($i194,$i202);
  $i203.dup := $or.i1($i194.dup,$i202.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 142, 7} true;
  assume {:verifier.code 0} true;
  $p204 := $add.ref($p0,$mul.ref(7,4));
  $p204.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 142, 7} true;
  assume {:verifier.code 0} true;
  $p204.dup := 0;
  $i205 := $load.i32($M.8,$p204);
  $i205.dup := $load.i1($M.8.dup,$p204);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 142, 7} true;
  assume {:verifier.code 0} true;
  $i206 := $add.i32($i179,9);
  $i206.dup := $or.i1($i179.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 142, 7} true;
  assume {:verifier.code 0} true;
  $i207 := $sub.i32($i206,7);
  $i207.dup := $or.i1($i206.dup,0);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 142, 7} true;
  assume {:verifier.code 0} true;
  $p209 := $add.ref($p1,$mul.ref($i208,4));
  $p209.dup := $or.i1($p1.dup,$or.i1($i208.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 142, 7} true;
  assume {:verifier.code 0} true;
  $p209.dup := 0;
  $i210 := $load.i32($M.7,$p209);
  $i210.dup := $load.i1($M.7.dup,$p209);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 142, 7} true;
  assume {:verifier.code 0} true;
  $i211 := $mul.i32($i205,$i210);
  $i211.dup := $or.i1($i205.dup,$i210.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 142, 5} true;
  assume {:verifier.code 0} true;
  $i212 := $add.i32($i203,$i211);
  $i212.dup := $or.i1($i203.dup,$i211.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 143, 7} true;
  assume {:verifier.code 0} true;
  $p213 := $add.ref($p0,$mul.ref(8,4));
  $p213.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 143, 7} true;
  assume {:verifier.code 0} true;
  $p213.dup := 0;
  $i214 := $load.i32($M.8,$p213);
  $i214.dup := $load.i1($M.8.dup,$p213);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 143, 7} true;
  assume {:verifier.code 0} true;
  $i215 := $add.i32($i179,9);
  $i215.dup := $or.i1($i179.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 143, 7} true;
  assume {:verifier.code 0} true;
  $i216 := $sub.i32($i215,8);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 143, 7} true;
  assume {:verifier.code 0} true;
  $p218 := $add.ref($p1,$mul.ref($i217,4));
  $p218.dup := $or.i1($p1.dup,$or.i1($i217.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 143, 7} true;
  assume {:verifier.code 0} true;
  $p218.dup := 0;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 143, 7} true;
  assume {:verifier.code 0} true;
  $i220 := $mul.i32($i214,$i219);
  $i220.dup := $or.i1($i214.dup,$i219.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 143, 5} true;
  assume {:verifier.code 0} true;
  $i221 := $add.i32($i212,$i220);
  $i221.dup := $or.i1($i212.dup,$i220.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 144, 7} true;
  assume {:verifier.code 0} true;
  $p222 := $add.ref($p0,$mul.ref(9,4));
  $p222.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 144, 7} true;
  assume {:verifier.code 0} true;
  $p222.dup := 0;
  $i223 := $load.i32($M.8,$p222);
  $i223.dup := $load.i1($M.8.dup,$p222);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 144, 7} true;
  assume {:verifier.code 0} true;
  $i224 := $add.i32($i179,9);
  $i224.dup := $or.i1($i179.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 144, 7} true;
  assume {:verifier.code 0} true;
  $i225 := $sub.i32($i224,9);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 144, 7} true;
  assume {:verifier.code 0} true;
  $p227 := $add.ref($p1,$mul.ref($i226,4));
  $p227.dup := $or.i1($p1.dup,$or.i1($i226.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 144, 7} true;
  assume {:verifier.code 0} true;
  $p227.dup := 0;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 144, 7} true;
  assume {:verifier.code 0} true;
  $i229 := $mul.i32($i223,$i228);
  $i229.dup := $or.i1($i223.dup,$i228.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 144, 5} true;
  assume {:verifier.code 0} true;
  $i230 := $add.i32($i221,$i229);
  $i230.dup := $or.i1($i221.dup,$i229.dup);
  call {:cexpr "s"} boogie_si_record_i32($i230);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 145, 13} true;
  assume {:verifier.code 0} true;
  $i231 := $and.i32($i230,8191);
  $i231.dup := $or.i1($i230.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 145, 4} true;
  assume {:verifier.code 0} true;
  $i232 := $zext.i32.i64($i179);
  $i232.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 145, 4} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p233 := $add.ref($add.ref($p5,$mul.ref(0,40)),$mul.ref($i232,4));
  $p233.dup := $or.i1($or.i1($p5.dup,$or.i1(0,0)),$or.i1($i232.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 145, 9} true;
  assume {:verifier.code 0} true;
  $p233.dup := 0;
  $M.9 := $store.i32($M.9,$p233,$i231);
  $M.9.dup := $store.i1($M.9.dup,$p233,$i231.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 146, 12} true;
  assume {:verifier.code 0} true;
  $i234 := $lshr.i32($i230,13);
  $i234.dup := $or.i1($i230.dup,0);
  call {:cexpr "cc2"} boogie_si_record_i32($i234);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 147, 3} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb13:
  assume !($i181 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 148, 3} true;
  assume {:verifier.code 0} true;
  $p236 := $bitcast.ref.ref($p0);
  $p236.dup := 0;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 148, 3} true;
  assume {:verifier.code 0} true;
  $p237 := $add.ref($add.ref($p5,$mul.ref(0,40)),$mul.ref(0,4));
  $p237.dup := $or.i1($or.i1($p5.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 148, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p236.dup := 0;
  $p238.dup := 0;
  call $M.8, $M.8.dup := $memcpy.i8($M.8, $M.8.dup, $M.9, $M.9.dup, $p236, $p236.dup, $p238, $p238.dup, 40, 0, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 154, 11} true;
  assume {:verifier.code 0} true;
  $i239 := $add.i32($i127,$i180);
  $i239.dup := $or.i1($i127.dup,$i180.dup);
  call {:cexpr "z"} boogie_si_record_i32($i239);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 155, 11} true;
  assume {:verifier.code 0} true;
  $i240 := $shl.i32($i239,2);
  $i240.dup := $or.i1($i239.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 155, 19} true;
  assume {:verifier.code 0} true;
  $p241 := $add.ref($p0,$mul.ref(0,4));
  $p241.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 155, 19} true;
  assume {:verifier.code 0} true;
  $p241.dup := 0;
  $i242 := $load.i32($M.8,$p241);
  $i242.dup := $load.i1($M.8.dup,$p241);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 155, 17} true;
  assume {:verifier.code 0} true;
  $i243 := $add.i32($i240,$i242);
  $i243.dup := $or.i1($i240.dup,$i242.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 155, 5} true;
  assume {:verifier.code 0} true;
  $i244 := $add.i32($i239,$i243);
  $i244.dup := $or.i1($i239.dup,$i243.dup);
  call {:cexpr "z"} boogie_si_record_i32($i244);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 156, 12} true;
  assume {:verifier.code 0} true;
  $i245 := $and.i32($i244,8191);
  $i245.dup := $or.i1($i244.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 156, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p246 := $add.ref($p0,$mul.ref(0,4));
  $p246.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 156, 8} true;
  assume {:verifier.code 0} true;
  $p246.dup := 0;
  $M.8 := $store.i32($M.8,$p246,$i245);
  $M.8.dup := $store.i1($M.8.dup,$p246,$i245.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 157, 13} true;
  assume {:verifier.code 0} true;
  $i247 := $lshr.i32($i244,13);
  $i247.dup := $or.i1($i244.dup,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 157, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p248 := $add.ref($p0,$mul.ref(1,4));
  $p248.dup := $or.i1($p0.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 157, 8} true;
  assume {:verifier.code 0} true;
  $p248.dup := 0;
  $i249 := $load.i32($M.8,$p248);
  $i249.dup := $load.i1($M.8.dup,$p248);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 157, 8} true;
  assume {:verifier.code 0} true;
  $i250 := $add.i32($i249,$i247);
  $i250.dup := $or.i1($i249.dup,$i247.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 157, 8} true;
  assume {:verifier.code 0} true;
  $p248.dup := 0;
  $M.8 := $store.i32($M.8,$p248,$i250);
  $M.8.dup := $store.i1($M.8.dup,$p248,$i250.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 159, 7} true;
  assume {:verifier.code 0} true;
  $p251 := $add.ref($p10,$mul.ref(16,1));
  $p251.dup := $or.i1($p10.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 160, 7} true;
  assume {:verifier.code 0} true;
  $i252 := $sub.i64($i11,16);
  $i252.dup := $or.i1($i11.dup,0);
  call {:cexpr "len"} boogie_si_record_i64($i252);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 51, 2} true;
  assume {:verifier.code 0} true;
  $p6 := $p251;
  $p6.dup := 0;
  ...
  goto $bb1;
$bb14:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 136, 25} true;
  assume {:verifier.code 0} true;
  $i235 := $add.i32($i179,1);
  $i235.dup := $or.i1($i179.dup,0);
  call {:cexpr "u"} boogie_si_record_i32($i235);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_ctmul32.c", 136, 3} true;
  assume {:verifier.code 0} true;
  $i179 := $i235;
  $i179.dup := 0;
...
const br_dec16le: ref;
axiom (br_dec16le == $sub.ref(0,16520));
procedure {:inline 1} br_dec16le($p0: ref, $p0.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $p1: ref;
  var $p1.dup: i1;
  ...
  var $i4.dup: i1;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 519, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/inner.h", 519, 10} true;
  assume {:verifier.code 0} true;
  $p1 := $bitcast.ref.ref($p0);
  $p1.dup := 0;
  assume {:sourceloc "../BearSSL/src/inner.h", 519, 38} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p1);
  $p2.dup := 0;
  assume {:sourceloc "../BearSSL/src/inner.h", 519, 38} true;
  ...
  $i3 := $load.i16($M.5,$p2);
  $i3.dup := $load.i1($M.5.dup,$p2);
  assume {:sourceloc "../BearSSL/src/inner.h", 519, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i16.i32($i3);
  $i4.dup := $i3.dup;
  assume {:sourceloc "../BearSSL/src/inner.h", 519, 2} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $r.dup := 0;
  $exn := false;
...
const br_enc16le: ref;
axiom (br_enc16le == $sub.ref(0,17552));
procedure {:inline 1} br_enc16le($p0: ref, $p0.dup: i1, $i1: i32, $i1.dup: i1)
modifies $M.10, $exn;
{
  var $i2: i16;
  var $i2.dup: i1;
  ...
  var $p4.dup: i1;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 491, 29} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_enc16le:arg:x"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 491, 29} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i32.i16($i1);
  $i2.dup := $i1.dup;
  assume {:sourceloc "../BearSSL/src/inner.h", 491, 3} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p0);
  $p3.dup := 0;
  assume {:sourceloc "../BearSSL/src/inner.h", 491, 25} true;
  assume {:verifier.code 0} true;
  $p4 := $bitcast.ref.ref($p3);
  $p4.dup := 0;
  assume {:sourceloc "../BearSSL/src/inner.h", 491, 27} true;
  assume {:verifier.code 0} true;
  $p4.dup := 0;
  $M.10 := $store.i16($M.10,$p4,$i2);
  $M.10.dup := $store.i1($M.10.dup,$p4,$i2.dup);
  assume {:sourceloc "../BearSSL/src/inner.h", 499, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.dup := false;
  return;
...
axiom (run_wrapper == $sub.ref(0,19616));
procedure {:entrypoint} run_wrapper($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1, $i3: i64, $i3.dup: i1, $p4: ref, $p4.dup: i1, $i5: i64, $i5.dup: i1, $p6: ref, $p6.dup: i1, $p7: ref, $p7.dup: i1, $i8: i32, $i8.dup: i1)
...
modifies $exn;
modifies $M.5, $M.7, $M.8;
modifies $CurrAddr, $M.2;
modifies $M.9, $M.10, $M.0, $M.1, $M.3;
modifies $M.4;
requires ($p0.dup == 0);
requires ($p1.dup == 0);
requires ($p2.dup == 0);
...
requires ($p6.dup == 0);
requires ($i8.dup == 0);
requires ($load.i8($M.5.dup,($p2 + 0)) == 0);
requires ($load.i8($M.5.dup,($p2 + 1)) == 0);
requires ($load.i8($M.5.dup,($p2 + 2)) == 0);
requires ($load.i8($M.5.dup,($p2 + 3)) == 0);
requires ($load.i8($M.5.dup,($p2 + 4)) == 0);
requires ($load.i8($M.5.dup,($p2 + 5)) == 0);
requires ($load.i8($M.5.dup,($p2 + 6)) == 0);
requires ($load.i8($M.5.dup,($p2 + 7)) == 0);
requires ($load.i8($M.5.dup,($p2 + 8)) == 0);
requires ($load.i8($M.5.dup,($p2 + 9)) == 0);
requires ($load.i8($M.5.dup,($p2 + 10)) == 0);
requires ($load.i8($M.5.dup,($p2 + 11)) == 0);
requires ($load.i8($M.5.dup,($p2 + 12)) == 0);
requires ($load.i8($M.5.dup,($p2 + 13)) == 0);
requires ($load.i8($M.5.dup,($p2 + 14)) == 0);
requires ($load.i8($M.5.dup,($p2 + 15)) == 0);
requires ($load.i8($M.5.dup,($p2 + 16)) == 0);
requires ($load.i8($M.5.dup,($p2 + 17)) == 0);
requires ($load.i8($M.5.dup,($p2 + 18)) == 0);
requires ($load.i8($M.5.dup,($p2 + 19)) == 0);
requires ($load.i8($M.5.dup,($p2 + 20)) == 0);
requires ($load.i8($M.5.dup,($p2 + 21)) == 0);
requires ($load.i8($M.5.dup,($p2 + 22)) == 0);
requires ($load.i8($M.5.dup,($p2 + 23)) == 0);
requires ($load.i8($M.5.dup,($p2 + 24)) == 0);
requires ($load.i8($M.5.dup,($p2 + 25)) == 0);
requires ($load.i8($M.5.dup,($p2 + 26)) == 0);
requires ($load.i8($M.5.dup,($p2 + 27)) == 0);
requires ($load.i8($M.5.dup,($p2 + 28)) == 0);
requires ($load.i8($M.5.dup,($p2 + 29)) == 0);
requires ($load.i8($M.5.dup,($p2 + 30)) == 0);
requires ($load.i8($M.5.dup,($p2 + 31)) == 0);
...
requires ($load.i8($M.5.dup,($p4 + 0)) == 0);
requires ($load.i8($M.5.dup,($p4 + 1)) == 0);
requires ($load.i8($M.5.dup,($p4 + 2)) == 0);
requires ($load.i8($M.5.dup,($p4 + 3)) == 0);
requires ($load.i8($M.5.dup,($p4 + 4)) == 0);
requires ($load.i8($M.5.dup,($p4 + 5)) == 0);
requires ($load.i8($M.5.dup,($p4 + 6)) == 0);
requires ($load.i8($M.5.dup,($p4 + 7)) == 0);
requires ($load.i8($M.5.dup,($p4 + 8)) == 0);
requires ($load.i8($M.5.dup,($p4 + 9)) == 0);
requires ($load.i8($M.5.dup,($p4 + 10)) == 0);
requires ($load.i8($M.5.dup,($p4 + 11)) == 0);
requires ($load.i8($M.5.dup,($p4 + 12)) == 0);
requires ($load.i8($M.5.dup,($p4 + 13)) == 0);
requires ($load.i8($M.5.dup,($p4 + 14)) == 0);
requires ($load.i8($M.5.dup,($p4 + 15)) == 0);
requires ($load.i8($M.5.dup,($p4 + 16)) == 0);
requires ($load.i8($M.5.dup,($p4 + 17)) == 0);
requires ($load.i8($M.5.dup,($p4 + 18)) == 0);
requires ($load.i8($M.5.dup,($p4 + 19)) == 0);
requires ($load.i8($M.5.dup,($p4 + 20)) == 0);
requires ($load.i8($M.5.dup,($p4 + 21)) == 0);
requires ($load.i8($M.5.dup,($p4 + 22)) == 0);
requires ($load.i8($M.5.dup,($p4 + 23)) == 0);
requires ($load.i8($M.5.dup,($p4 + 24)) == 0);
requires ($load.i8($M.5.dup,($p4 + 25)) == 0);
requires ($load.i8($M.5.dup,($p4 + 26)) == 0);
requires ($load.i8($M.5.dup,($p4 + 27)) == 0);
requires ($load.i8($M.5.dup,($p4 + 28)) == 0);
requires ($load.i8($M.5.dup,($p4 + 29)) == 0);
requires ($load.i8($M.5.dup,($p4 + 30)) == 0);
requires ($load.i8($M.5.dup,($p4 + 31)) == 0);
{
  var $p9: ref;
  var $p9.dup: i1;
  var $p10: ref;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_poly1305_ctmul32_run($p0, $p0.dup, $p1, $p1.dup, $p2, $p2.dup, $i3, $i3.dup, $p4, $p4.dup, $i5, $i5.dup, $p6, $p6.dup, br_chacha20_ct_run, cons.dup, $i8, $i8.dup);
...
axiom (__SMACK_value == $sub.ref(0,20648));
...
axiom (__SMACK_dummy == $sub.ref(0,25808));
...
axiom (__SMACK_and32 == $sub.ref(0,26840));
...
axiom (__SMACK_and64 == $sub.ref(0,27872));
...
axiom (__SMACK_and16 == $sub.ref(0,28904));
...
axiom (__SMACK_and8 == $sub.ref(0,29936));
...
axiom (__SMACK_or32 == $sub.ref(0,30968));
...
axiom (__SMACK_or64 == $sub.ref(0,32000));
...
axiom (__SMACK_or16 == $sub.ref(0,33032));
...
axiom (__SMACK_or8 == $sub.ref(0,34064));
...
axiom (__SMACK_check_overflow == $sub.ref(0,35096));
...
axiom (__SMACK_loop_exit == $sub.ref(0,36128));
...
axiom (__SMACK_decls == $sub.ref(0,37160));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,38192));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,39224));
...
axiom (__SMACK_static_init == $sub.ref(0,40256));
...
axiom (devirtbounce == $sub.ref(0,41288));
procedure {:inline 1} devirtbounce(funcPtr: ref, funcPtr.dup: i1, arg: ref, arg.dup: i1, arg1: ref, arg1.dup: i1, arg2: i32, arg2.dup: i1, arg3: ref, arg3.dup: i1, arg4: i64, arg4.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
...
$bb2:
  assume ($i2 == 1);
  call $i1, $i1.dup := br_chacha20_ct_run(arg, arg.dup, arg1, arg1.dup, arg2, arg2.dup, arg3, arg3.dup, arg4, arg4.dup);
  $r := $i1;
  $r.dup := 0;
  $exn := false;
  $exn.dup := false;
