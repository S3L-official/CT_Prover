...
$bb4:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i59 == $i59.shadow);
...
$bb15:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i90 == $i90.shadow);
  assert {:shadow_invariant} ($p12 == $p12.shadow);
  assert {:shadow_invariant} ($p9 == $p9.shadow);
...
$bb1:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($p31 == $p31.shadow);
