...
var $M.7: [ref] i16;
var $M.7.shadow: [ref] i16;
var $M.8: [ref] i16;
var $M.8.shadow: [ref] i16;
var $M.9: [ref] i8;
var $M.9.shadow: [ref] i8;
var $M.10: [ref] i16;
var $M.10.shadow: [ref] i16;
var $M.11: [ref] ref;
var $M.11.shadow: [ref] ref;
var $M.12: [ref] i8;
var $M.12.shadow: [ref] i8;
axiom ($GLOBALS_BOTTOM == $sub.ref(0,44408));
...
const {:allocSize 20} {:count 10} P1305: ref;
axiom (P1305 == $sub.ref(0,2084));
const {:allocSize 20} R2: ref;
axiom (R2 == $sub.ref(0,3128));
const br_chacha20_ct_run: ref;
axiom (br_chacha20_ct_run == $sub.ref(0,4160));
...
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0,8288));
...
axiom (br_enc32le == $sub.ref(0,9320));
...
const br_poly1305_i15_run: ref;
axiom (br_poly1305_i15_run == $sub.ref(0,10352));
procedure {:inline 1} br_poly1305_i15_run($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $i3: i64, $i3.shadow: i64, $p4: ref, $p4.shadow: ref, $i5: i64, $i5.shadow: i64, $p6: ref, $p6.shadow: ref, $p7: ref, $p7.shadow: ref, $i8: i32, $i8.shadow: i32)
modifies $M.5, $exn;
modifies $M.7, $M.12;
modifies $M.9, $M.10;
...
modifies $M.4;
{
  ...
  var $i82.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 140, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  $p12.shadow := $p12;
  assume {:verifier.code 0} true;
  call $p13 := $alloc($mul.ref(20,$zext.i32.i64(1)));
  $p13.shadow := $p13;
  call {:cexpr "br_poly1305_i15_run:arg:len"} boogie_si_record_i64($i3);
  call {:cexpr "br_poly1305_i15_run:arg:aad_len"} boogie_si_record_i64($i5);
  call {:cexpr "br_poly1305_i15_run:arg:encrypt"} boogie_si_record_i32($i8);
  assume true;
  assume true;
  assume true;
  assume true;
  ...
  assume {:verifier.code 0} true;
  assert ($p14 == $p14.shadow);
  call $M.5, $M.5.shadow := $memset.i8($M.5, $M.5.shadow, $p14, $p14.shadow, 0, 0, 32, 32, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 141, 22} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p15.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  call $i16, $i16.shadow := devirtbounce($p7, $p7.shadow, $p0, $p0.shadow, $p1, $p1.shadow, 0, 0, $p15, $p15.shadow, 32, 32);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 147, 6} true;
  assume {:verifier.code 0} true;
  $i17 := $ne.i32($i8,0);
  $i17.shadow := $ne.i32($i8.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 147, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  assert ($i17 == $i17.shadow);
...
$bb1:
  assume ($i17 == 1);
  call $i18, $i18.shadow := devirtbounce($p7, $p7.shadow, $p0, $p0.shadow, $p1, $p1.shadow, 1, 1, $p2, $p2.shadow, $i3, $i3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 149, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 147, 6} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 161, 2} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(3,1));
  $p19.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(3,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 161, 11} true;
  assume {:verifier.code 0} true;
  assert ($p19 == $p19.shadow);
  $i20 := $load.i8($M.5,$p19);
  $i20.shadow := $load.i8($M.5.shadow,$p19.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 161, 11} true;
  assume {:verifier.code 0} true;
  $i21 := $zext.i8.i32($i20);
  ...
  assume {:verifier.code 0} true;
  assert ($p19 == $p19.shadow);
  $M.5 := $store.i8($M.5,$p19,$i23);
  $M.5.shadow := $store.i8($M.5.shadow,$p19.shadow,$i23.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 162, 2} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(7,1));
  $p24.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(7,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 162, 11} true;
  assume {:verifier.code 0} true;
  assert ($p24 == $p24.shadow);
  $i25 := $load.i8($M.5,$p24);
  $i25.shadow := $load.i8($M.5.shadow,$p24.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 162, 11} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i8.i32($i25);
  ...
  assume {:verifier.code 0} true;
  $i27 := $and.i32($i26,15);
  $i27.shadow := $and.i32($i26.shadow,15);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 162, 11} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i32.i8($i27);
  $i28.shadow := $trunc.i32.i8($i27.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 162, 11} true;
  assume {:verifier.code 0} true;
  assert ($p24 == $p24.shadow);
  $M.5 := $store.i8($M.5,$p24,$i28);
  $M.5.shadow := $store.i8($M.5.shadow,$p24.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 163, 2} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(11,1));
  $p29.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(11,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 163, 11} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $i30 := $load.i8($M.5,$p29);
  $i30.shadow := $load.i8($M.5.shadow,$p29.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 163, 11} true;
  assume {:verifier.code 0} true;
  $i31 := $zext.i8.i32($i30);
  ...
  assume {:verifier.code 0} true;
  $i32 := $and.i32($i31,15);
  $i32.shadow := $and.i32($i31.shadow,15);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 163, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $M.5 := $store.i8($M.5,$p29,$i33);
  $M.5.shadow := $store.i8($M.5.shadow,$p29.shadow,$i33.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 164, 2} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(15,1));
  $p34.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(15,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 164, 11} true;
  assume {:verifier.code 0} true;
  assert ($p34 == $p34.shadow);
  $i35 := $load.i8($M.5,$p34);
  $i35.shadow := $load.i8($M.5.shadow,$p34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 164, 11} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i8.i32($i35);
  ...
  assume {:verifier.code 0} true;
  $i37 := $and.i32($i36,15);
  $i37.shadow := $and.i32($i36.shadow,15);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 164, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assert ($p34 == $p34.shadow);
  $M.5 := $store.i8($M.5,$p34,$i38);
  $M.5.shadow := $store.i8($M.5.shadow,$p34.shadow,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 165, 2} true;
  assume {:verifier.code 0} true;
  $p39 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(4,1));
  $p39.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(4,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 165, 11} true;
  assume {:verifier.code 0} true;
  assert ($p39 == $p39.shadow);
  $i40 := $load.i8($M.5,$p39);
  $i40.shadow := $load.i8($M.5.shadow,$p39.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 165, 11} true;
  assume {:verifier.code 0} true;
  $i41 := $zext.i8.i32($i40);
  ...
  assume {:verifier.code 0} true;
  $i42 := $and.i32($i41,252);
  $i42.shadow := $and.i32($i41.shadow,252);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 165, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assert ($p39 == $p39.shadow);
  $M.5 := $store.i8($M.5,$p39,$i43);
  $M.5.shadow := $store.i8($M.5.shadow,$p39.shadow,$i43.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 166, 2} true;
  assume {:verifier.code 0} true;
  $p44 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(8,1));
  $p44.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 166, 11} true;
  assume {:verifier.code 0} true;
  assert ($p44 == $p44.shadow);
  $i45 := $load.i8($M.5,$p44);
  $i45.shadow := $load.i8($M.5.shadow,$p44.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 166, 11} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i8.i32($i45);
  ...
  assume {:verifier.code 0} true;
  $i47 := $and.i32($i46,252);
  $i47.shadow := $and.i32($i46.shadow,252);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 166, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assert ($p44 == $p44.shadow);
  $M.5 := $store.i8($M.5,$p44,$i48);
  $M.5.shadow := $store.i8($M.5.shadow,$p44.shadow,$i48.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 167, 2} true;
  assume {:verifier.code 0} true;
  $p49 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(12,1));
  $p49.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(12,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 167, 11} true;
  assume {:verifier.code 0} true;
  assert ($p49 == $p49.shadow);
  $i50 := $load.i8($M.5,$p49);
  $i50.shadow := $load.i8($M.5.shadow,$p49.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 167, 11} true;
  assume {:verifier.code 0} true;
  $i51 := $zext.i8.i32($i50);
  ...
  assume {:verifier.code 0} true;
  $i52 := $and.i32($i51,252);
  $i52.shadow := $and.i32($i51.shadow,252);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 167, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assert ($p49 == $p49.shadow);
  $M.5 := $store.i8($M.5,$p49,$i53);
  $M.5.shadow := $store.i8($M.5.shadow,$p49.shadow,$i53.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 173, 13} true;
  assume {:verifier.code 0} true;
  $p54 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p54.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 173, 2} true;
  assume {:verifier.code 0} true;
  call byteswap16($p54, $p54.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 174, 20} true;
  assume {:verifier.code 0} true;
  $p55 := $add.ref($add.ref($p11,$mul.ref(0,20)),$mul.ref(0,2));
  $p55.shadow := $add.ref($add.ref($p11.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 174, 23} true;
  assume {:verifier.code 0} true;
  $p56 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p56.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 174, 2} true;
  assume {:verifier.code 0} true;
  call $i57, $i57.shadow := br_i15_decode_mod($p55, $p55.shadow, $p56, $p56.shadow, 16, 16, P1305, P1305);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 179, 18} true;
  assume {:verifier.code 0} true;
  $p58 := $add.ref($add.ref($p12,$mul.ref(0,20)),$mul.ref(0,2));
  $p58.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 179, 21} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($add.ref($p11,$mul.ref(0,20)),$mul.ref(0,2));
  $p59.shadow := $add.ref($add.ref($p11.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 179, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_montymul($p58, $p58.shadow, $p59, $p59.shadow, R2, R2, P1305, P1305, 19661, 19661);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 184, 14} true;
  assume {:verifier.code 0} true;
  $p60 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p60.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 184, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_zero($p60, $p60.shadow, 138, 138);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 190, 13} true;
  assume {:verifier.code 0} true;
  $p61 := $add.ref($add.ref($p10,$mul.ref(0,16)),$mul.ref(0,1));
  $p61.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 190, 2} true;
  assume {:verifier.code 0} true;
  call br_enc64le($p61, $p61.shadow, $i5, $i5.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 191, 13} true;
  assume {:verifier.code 0} true;
  $p62 := $add.ref($add.ref($p10,$mul.ref(0,16)),$mul.ref(0,1));
  $p62.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  $p63 := $add.ref($add.ref($p10,$mul.ref(0,16)),$mul.ref(8,1));
  $p63.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,16)),$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 191, 2} true;
  assume {:verifier.code 0} true;
  call br_enc64le($p63, $p63.shadow, $i3, $i3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 192, 17} true;
  assume {:verifier.code 0} true;
  $p64 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p64.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 192, 22} true;
  assume {:verifier.code 0} true;
  $p65 := $add.ref($add.ref($p12,$mul.ref(0,20)),$mul.ref(0,2));
  $p65.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 192, 2} true;
  assume {:verifier.code 0} true;
  call poly1305_inner($p64, $p64.shadow, $p65, $p65.shadow, $p4, $p4.shadow, $i5, $i5.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 193, 17} true;
  assume {:verifier.code 0} true;
  $p66 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p66.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 193, 22} true;
  assume {:verifier.code 0} true;
  $p67 := $add.ref($add.ref($p12,$mul.ref(0,20)),$mul.ref(0,2));
  $p67.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 193, 2} true;
  assume {:verifier.code 0} true;
  call poly1305_inner($p66, $p66.shadow, $p67, $p67.shadow, $p2, $p2.shadow, $i3, $i3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 194, 17} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p68.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 194, 22} true;
  assume {:verifier.code 0} true;
  $p69 := $add.ref($add.ref($p12,$mul.ref(0,20)),$mul.ref(0,2));
  $p69.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 194, 25} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($add.ref($p10,$mul.ref(0,16)),$mul.ref(0,1));
  $p70.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 194, 2} true;
  assume {:verifier.code 0} true;
  call poly1305_inner($p68, $p68.shadow, $p69, $p69.shadow, $p70, $p70.shadow, 16, 16);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 199, 13} true;
  assume {:verifier.code 0} true;
  $p71 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p71.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  $p72 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(16,1));
  $p72.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(16,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 199, 2} true;
  assume {:verifier.code 0} true;
  call byteswap16($p72, $p72.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 200, 20} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($add.ref($p11,$mul.ref(0,20)),$mul.ref(0,2));
  $p73.shadow := $add.ref($add.ref($p11.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 200, 23} true;
  assume {:verifier.code 0} true;
  $p74 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p74.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  $p75 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(16,1));
  $p75.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,32)),$mul.ref(16,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 200, 2} true;
  assume {:verifier.code 0} true;
  call $i76, $i76.shadow := br_i15_decode_mod($p73, $p73.shadow, $p75, $p75.shadow, 16, 16, P1305, P1305);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 206, 13} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p77.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 206, 18} true;
  assume {:verifier.code 0} true;
  $p78 := $add.ref($add.ref($p11,$mul.ref(0,20)),$mul.ref(0,2));
  $p78.shadow := $add.ref($add.ref($p11.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 206, 2} true;
  assume {:verifier.code 0} true;
  call $i79, $i79.shadow := br_i15_add($p77, $p77.shadow, $p78, $p78.shadow, 1, 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 212, 25} true;
  assume {:verifier.code 0} true;
  $p80 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p80.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 212, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_encode($p6, $p6.shadow, 16, 16, $p80, $p80.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 213, 2} true;
  assume {:verifier.code 0} true;
  call byteswap16($p6, $p6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 218, 7} true;
  assume {:verifier.code 0} true;
  $i81 := $ne.i32($i8,0);
  $i81.shadow := $ne.i32($i8.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 218, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i81} true;
  assert ($i81 == $i81.shadow);
  goto $bb4, $bb6;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 218, 6} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 221, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb6:
  assume !($i81 == 1);
  call $i82, $i82.shadow := devirtbounce($p7, $p7.shadow, $p0, $p0.shadow, $p1, $p1.shadow, 1, 1, $p2, $p2.shadow, $i3, $i3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 220, 2} true;
  assume {:verifier.code 0} true;
  goto $bb5;
}
const llvm.memset.p0i8.i64: ref;
axiom (llvm.memset.p0i8.i64 == $sub.ref(0,11384));
procedure {:inline 1} llvm.memset.p0i8.i64($p0: ref, $p0.shadow: ref, $i1: i8, $i1.shadow: i8, $i2: i64, $i2.shadow: i64, $i3: i1, $i3.shadow: i1);
const byteswap16: ref;
axiom (byteswap16 == $sub.ref(0,12416));
procedure {:inline 1} byteswap16($p0: ref, $p0.shadow: ref)
modifies $M.5, $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i17.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 118, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 118, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 118, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1,8);
  $i2.shadow := $slt.i32($i1.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 118, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 121, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  ...
  assert ($p4 == $p4.shadow);
  $i5 := $load.i8($M.5,$p4);
  $i5.shadow := $load.i8($M.5.shadow,$p4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 121, 7} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i8.i32($i5);
  $i6.shadow := $zext.i8.i32($i5.shadow);
  call {:cexpr "x"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 122, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i32(15,$i1);
  $i7.shadow := $sub.i32(15,$i1.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 122, 12} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i7);
  ...
  assert ($p9 == $p9.shadow);
  $i10 := $load.i8($M.5,$p9);
  $i10.shadow := $load.i8($M.5.shadow,$p9.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 122, 3} true;
  assume {:verifier.code 0} true;
  $i11 := $sext.i32.i64($i1);
  $i11.shadow := $sext.i32.i64($i1.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 122, 3} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p0,$mul.ref($i11,1));
  $p12.shadow := $add.ref($p0.shadow,$mul.ref($i11.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 122, 10} true;
  assume {:verifier.code 0} true;
  assert ($p12 == $p12.shadow);
  $M.5 := $store.i8($M.5,$p12,$i10);
  $M.5.shadow := $store.i8($M.5.shadow,$p12.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 123, 17} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i32.i8($i6);
  $i13.shadow := $trunc.i32.i8($i6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 123, 10} true;
  assume {:verifier.code 0} true;
  $i14 := $sub.i32(15,$i1);
  $i14.shadow := $sub.i32(15,$i1.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 123, 3} true;
  assume {:verifier.code 0} true;
  $i15 := $sext.i32.i64($i14);
  $i15.shadow := $sext.i32.i64($i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 123, 3} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p0,$mul.ref($i15,1));
  $p16.shadow := $add.ref($p0.shadow,$mul.ref($i15.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 123, 15} true;
  assume {:verifier.code 0} true;
  assert ($p16 == $p16.shadow);
  $M.5 := $store.i8($M.5,$p16,$i13);
  $M.5.shadow := $store.i8($M.5.shadow,$p16.shadow,$i13.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 124, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 125, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 118, 23} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i32($i1,1);
  ...
  assume {:verifier.code 0} true;
  $i1 := $i17;
  $i1.shadow := $i17.shadow;
  goto $bb1;
}
const br_i15_decode_mod: ref;
axiom (br_i15_decode_mod == $sub.ref(0,13448));
...
axiom (br_i15_montymul == $sub.ref(0,14480));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  assert ($p0 == $p0.shadow);
  $M.7 := $store.i16($M.7,$p0,$i1);
  $M.7.shadow := $store.i16($M.7.shadow,$p0.shadow,$i1.shadow);
  ...
  assert ($p3 == $p3.shadow);
  assert ($i8 == $i8.shadow);
  call $M.12, $M.12.shadow := $memset.i8($M.12, $M.12.shadow, $p3, $p3.shadow, 0, 0, $i8, $i8.shadow, false, false);
...
axiom (br_enc64le == $sub.ref(0,16544));
...
modifies $CurrAddr;
{
  ...
  var $i43.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 66, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  $p5.shadow := $p5;
  assume {:verifier.code 0} true;
  call $p6 := $alloc($mul.ref(20,$zext.i32.i64(1)));
  $p6.shadow := $p6;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 66, 13} true;
  assume {:verifier.code 0} true;
  $i9 := $ugt.i64($i7,0);
...
$bb2:
  ...
  assume true;
  assume true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 75, 11} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i64($i7,16);
  $i10.shadow := $ult.i64($i7.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 75, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $i7;
  $i11.shadow := $i7.shadow;
  $p12 := $p8;
  $p12.shadow := $p8.shadow;
  assume {:branchcond $i10} true;
  assert ($i10 == $i10.shadow);
  goto $bb4, $bb5;
$bb3:
  assume !($i9 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 108, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume ($i10 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 76, 4} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(0,1));
  $p13.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 76, 4} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  call $M.5, $M.5.shadow := $memset.i8($M.5, $M.5.shadow, $p13, $p13.shadow, 0, 0, 16, 16, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 77, 4} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(0,1));
  $p14.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 77, 4} true;
  assume {:verifier.code 0} true;
  assert ($p14 == $p14.shadow);
  assert ($p8 == $p8.shadow);
  assert ($i7 == $i7.shadow);
  call $M.5, $M.5.shadow := $memcpy.i8($M.5, $M.5.shadow, $M.5, $M.5.shadow, $p14, $p14.shadow, $p8, $p8.shadow, $i7, $i7.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 78, 10} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p4,$mul.ref(0,16)),$mul.ref(0,1));
  $p15.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 80, 3} true;
  assume {:verifier.code 0} true;
  $i11 := 16;
  $i11.shadow := 16;
  $p12 := $p4;
  $p12.shadow := $p4.shadow;
  goto $bb6;
$bb5:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 75, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 86, 8} true;
  assume {:verifier.code 0} true;
  $i16 := 0;
  $i16.shadow := 0;
  goto $bb7;
$bb7:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 86, 17} true;
  assume {:verifier.code 0} true;
  $i17 := $slt.i32($i16,16);
  $i17.shadow := $slt.i32($i16.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 86, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  assert ($i17 == $i17.shadow);
  goto $bb8, $bb9;
$bb8:
  assume ($i17 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 87, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $sub.i32(15,$i16);
  $i18.shadow := $sub.i32(15,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 87, 13} true;
  assume {:verifier.code 0} true;
  ...
  $p20.shadow := $add.ref($p12.shadow,$mul.ref($i19.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 87, 13} true;
  assume {:verifier.code 0} true;
  assert ($p20 == $p20.shadow);
  $i21 := $load.i8($M.5,$p20);
  $i21.shadow := $load.i8($M.5.shadow,$p20.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 87, 4} true;
  assume {:verifier.code 0} true;
  $i22 := $sext.i32.i64($i16);
  $i22.shadow := $sext.i32.i64($i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 87, 4} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref($i22,1));
  $p23.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref($i22.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 87, 11} true;
  assume {:verifier.code 0} true;
  assert ($p23 == $p23.shadow);
  $M.9 := $store.i8($M.9,$p23,$i21);
  $M.9.shadow := $store.i8($M.9.shadow,$p23.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 88, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !($i17 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 89, 21} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p6,$mul.ref(0,20)),$mul.ref(0,2));
  $p25.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 89, 24} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(0,1));
  $p26.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 89, 3} true;
  assume {:verifier.code 0} true;
  call $i27, $i27.shadow := br_i15_decode_mod($p25, $p25.shadow, $p26, $p26.shadow, 16, 16, P1305, P1305);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 90, 3} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p6,$mul.ref(0,20)),$mul.ref(9,2));
  $p28.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,20)),$mul.ref(9,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 90, 8} true;
  assume {:verifier.code 0} true;
  assert ($p28 == $p28.shadow);
  $i29 := $load.i16($M.10,$p28);
  $i29.shadow := $load.i16($M.10.shadow,$p28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 90, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i31 := $or.i32($i30,256);
  $i31.shadow := $or.i32($i30.shadow,256);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 90, 8} true;
  assume {:verifier.code 0} true;
  $i32 := $trunc.i32.i16($i31);
  $i32.shadow := $trunc.i32.i16($i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 90, 8} true;
  assume {:verifier.code 0} true;
  assert ($p28 == $p28.shadow);
  $M.10 := $store.i16($M.10,$p28,$i32);
  $M.10.shadow := $store.i16($M.10.shadow,$p28.shadow,$i32.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 96, 20} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref($p6,$mul.ref(0,20)),$mul.ref(0,2));
  $p33.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 96, 9} true;
  assume {:verifier.code 0} true;
  call $i34, $i34.shadow := br_i15_add($p33, $p33.shadow, $p0, $p0.shadow, 1, 1);
  call {:cexpr "ctl"} boogie_si_record_i32($i34);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 97, 25} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($add.ref($p6,$mul.ref(0,20)),$mul.ref(0,2));
  $p35.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 97, 14} true;
  assume {:verifier.code 0} true;
  call $i36, $i36.shadow := br_i15_sub($p35, $p35.shadow, P1305, P1305, 0, 0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 97, 10} true;
  assume {:verifier.code 0} true;
  call $i37, $i37.shadow := NOT($i36, $i36.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 97, 7} true;
  assume {:verifier.code 0} true;
  $i38 := $or.i32($i34,$i37);
  $i38.shadow := $or.i32($i34.shadow,$i37.shadow);
  call {:cexpr "ctl"} boogie_si_record_i32($i38);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 98, 14} true;
  assume {:verifier.code 0} true;
  $p39 := $add.ref($add.ref($p6,$mul.ref(0,20)),$mul.ref(0,2));
  $p39.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 98, 3} true;
  assume {:verifier.code 0} true;
  call $i40, $i40.shadow := br_i15_sub($p39, $p39.shadow, P1305, P1305, $i38, $i38.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 103, 22} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($add.ref($p6,$mul.ref(0,20)),$mul.ref(0,2));
  $p41.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 103, 3} true;
  assume {:verifier.code 0} true;
  call br_i15_montymul($p0, $p0.shadow, $p41, $p41.shadow, $p1, $p1.shadow, P1305, P1305, 19661, 19661);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 105, 7} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($p12,$mul.ref(16,1));
  $p42.shadow := $add.ref($p12.shadow,$mul.ref(16,1));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 106, 7} true;
  assume {:verifier.code 0} true;
  $i43 := $sub.i64($i11,16);
  $i43.shadow := $sub.i64($i11.shadow,16);
  call {:cexpr "len"} boogie_si_record_i64($i43);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 66, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $i43;
  $i7.shadow := $i43.shadow;
  $p8 := $p42;
  $p8.shadow := $p42.shadow;
  goto $bb1;
$bb10:
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 86, 25} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i16,1);
  $i24.shadow := $add.i32($i16.shadow,1);
...
axiom (br_i15_add == $sub.ref(0,18608));
...
axiom (run_wrapper == $sub.ref(0,22736));
...
modifies $M.7, $M.12, $M.9, $M.10, $M.0, $M.1, $M.3;
modifies $M.4;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_poly1305_i15_run($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow, $i3, $i3.shadow, $p4, $p4.shadow, $i5, $i5.shadow, $p6, $p6.shadow, br_chacha20_ct_run, br_chacha20_ct_run, $i8, $i8.shadow);
...
axiom (__SMACK_value == $sub.ref(0,23768));
...
axiom (__SMACK_dummy == $sub.ref(0,28928));
...
axiom (__SMACK_and32 == $sub.ref(0,29960));
...
axiom (__SMACK_and64 == $sub.ref(0,30992));
...
axiom (__SMACK_and16 == $sub.ref(0,32024));
...
axiom (__SMACK_and8 == $sub.ref(0,33056));
...
axiom (__SMACK_or32 == $sub.ref(0,34088));
...
axiom (__SMACK_or64 == $sub.ref(0,35120));
...
axiom (__SMACK_or16 == $sub.ref(0,36152));
...
axiom (__SMACK_or8 == $sub.ref(0,37184));
...
axiom (__SMACK_check_overflow == $sub.ref(0,38216));
...
axiom (__SMACK_loop_exit == $sub.ref(0,39248));
...
axiom (__SMACK_decls == $sub.ref(0,40280));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,41312));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,42344));
...
axiom (__SMACK_static_init == $sub.ref(0,43376));
...
axiom (devirtbounce == $sub.ref(0,44408));
