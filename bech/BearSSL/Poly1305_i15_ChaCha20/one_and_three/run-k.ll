...
21:                                               ; preds = %19, %9
  ...
  %60 = getelementptr inbounds [10 x i16], [10 x i16]* @P1305, i64 0, i64 0
  %61 = call i32 @br_i15_decode_mod(i16* %58, i8* %59, i64 16, i16* %60), !dbg !342
  %62 = getelementptr inbounds [10 x i16], [10 x i16]* %13, i64 0, i64 0, !dbg !343
  %63 = getelementptr inbounds [10 x i16], [10 x i16]* %12, i64 0, i64 0, !dbg !344
  %64 = getelementptr inbounds [10 x i16], [10 x i16]* bitcast (<{ i16, i16, [8 x i16] }>* @R2 to [10 x i16]*), i64 0, i64 0
  %65 = getelementptr inbounds [10 x i16], [10 x i16]* @P1305, i64 0, i64 0
  call void @br_i15_montymul(i16* %62, i16* %63, i16* %64, i16* %65, i16 zeroext 19661), !dbg !345
  %66 = getelementptr inbounds [10 x i16], [10 x i16]* %14, i64 0, i64 0, !dbg !346
  call void @br_i15_zero(i16* %66, i16 zeroext 138), !dbg !347
  %67 = getelementptr inbounds [16 x i8], [16 x i8]* %11, i64 0, i64 0, !dbg !348
  call void @br_enc64le(i8* %67, i64 %5), !dbg !349
  %68 = getelementptr inbounds [16 x i8], [16 x i8]* %11, i64 0, i64 0, !dbg !350
  %69 = getelementptr inbounds i8, i8* %68, i64 8, !dbg !351
  call void @br_enc64le(i8* %69, i64 %3), !dbg !352
  %70 = getelementptr inbounds [10 x i16], [10 x i16]* %14, i64 0, i64 0, !dbg !353
  %71 = getelementptr inbounds [10 x i16], [10 x i16]* %13, i64 0, i64 0, !dbg !354
  call void @poly1305_inner(i16* %70, i16* %71, i8* %4, i64 %5), !dbg !355
  %72 = getelementptr inbounds [10 x i16], [10 x i16]* %14, i64 0, i64 0, !dbg !356
  %73 = getelementptr inbounds [10 x i16], [10 x i16]* %13, i64 0, i64 0, !dbg !357
  call void @poly1305_inner(i16* %72, i16* %73, i8* %2, i64 %3), !dbg !358
  %74 = getelementptr inbounds [10 x i16], [10 x i16]* %14, i64 0, i64 0, !dbg !359
  %75 = getelementptr inbounds [10 x i16], [10 x i16]* %13, i64 0, i64 0, !dbg !360
  %76 = getelementptr inbounds [16 x i8], [16 x i8]* %11, i64 0, i64 0, !dbg !361
  call void @poly1305_inner(i16* %74, i16* %75, i8* %76, i64 16), !dbg !362
  %77 = getelementptr inbounds [32 x i8], [32 x i8]* %10, i64 0, i64 0, !dbg !363
  %78 = getelementptr inbounds i8, i8* %77, i64 16, !dbg !364
  call void @byteswap16(i8* %78), !dbg !365
  %79 = getelementptr inbounds [10 x i16], [10 x i16]* %12, i64 0, i64 0, !dbg !366
  %80 = getelementptr inbounds [32 x i8], [32 x i8]* %10, i64 0, i64 0, !dbg !367
  %81 = getelementptr inbounds i8, i8* %80, i64 16, !dbg !368
  %82 = getelementptr inbounds [10 x i16], [10 x i16]* @P1305, i64 0, i64 0
  %83 = call i32 @br_i15_decode_mod(i16* %79, i8* %81, i64 16, i16* %82), !dbg !369
  %84 = getelementptr inbounds [10 x i16], [10 x i16]* %14, i64 0, i64 0, !dbg !370
  %85 = getelementptr inbounds [10 x i16], [10 x i16]* %12, i64 0, i64 0, !dbg !371
  %86 = call i32 @br_i15_add(i16* %84, i16* %85, i32 1), !dbg !372
  %87 = getelementptr inbounds [10 x i16], [10 x i16]* %14, i64 0, i64 0, !dbg !373
  call void @br_i15_encode(i8* %6, i64 16, i16* %87), !dbg !374
  call void @byteswap16(i8* %6), !dbg !375
  %88 = icmp ne i32 %8, 0, !dbg !376
  br i1 %88, label %91, label %89, !dbg !378

89:                                               ; preds = %21
  %90 = call i32 %7(i8* %0, i8* %1, i32 1, i8* %2, i64 %3), !dbg !379
  br label %91, !dbg !381
...
8:                                                ; preds = %28, %4
  %.02 = phi i64 [ %3, %4 ], [ %51, %28 ]
  %.01 = phi i8* [ %2, %4 ], [ %50, %28 ], !dbg !444
  ...
  br i1 %9, label %10, label %52, !dbg !449
...
28:                                               ; preds = %17
  ...
  %31 = getelementptr inbounds [10 x i16], [10 x i16]* @P1305, i64 0, i64 0
  %32 = call i32 @br_i15_decode_mod(i16* %29, i8* %30, i64 16, i16* %31), !dbg !486
  %33 = getelementptr inbounds [10 x i16], [10 x i16]* %7, i64 0, i64 9, !dbg !487
  %34 = load i16, i16* %33, align 2, !dbg !488
  %35 = zext i16 %34 to i32, !dbg !488
  %36 = or i32 %35, 256, !dbg !488
  %37 = trunc i32 %36 to i16, !dbg !488
  store i16 %37, i16* %33, align 2, !dbg !488
  %38 = getelementptr inbounds [10 x i16], [10 x i16]* %7, i64 0, i64 0, !dbg !489
  %39 = call i32 @br_i15_add(i16* %38, i16* %0, i32 1), !dbg !490
  call void @llvm.dbg.value(metadata i32 %39, metadata !491, metadata !DIExpression()), !dbg !467
  %40 = getelementptr inbounds [10 x i16], [10 x i16]* %7, i64 0, i64 0, !dbg !492
  %41 = getelementptr inbounds [10 x i16], [10 x i16]* @P1305, i64 0, i64 0
  %42 = call i32 @br_i15_sub(i16* %40, i16* %41, i32 0), !dbg !493
  %43 = call i32 @NOT(i32 %42), !dbg !494
  %44 = or i32 %39, %43, !dbg !495
  call void @llvm.dbg.value(metadata i32 %44, metadata !491, metadata !DIExpression()), !dbg !467
  %45 = getelementptr inbounds [10 x i16], [10 x i16]* %7, i64 0, i64 0, !dbg !496
  %46 = getelementptr inbounds [10 x i16], [10 x i16]* @P1305, i64 0, i64 0
  %47 = call i32 @br_i15_sub(i16* %45, i16* %46, i32 %44), !dbg !497
  %48 = getelementptr inbounds [10 x i16], [10 x i16]* %7, i64 0, i64 0, !dbg !498
  %49 = getelementptr inbounds [10 x i16], [10 x i16]* @P1305, i64 0, i64 0
  call void @br_i15_montymul(i16* %0, i16* %48, i16* %1, i16* %49, i16 zeroext 19661), !dbg !499
  %50 = getelementptr inbounds i8, i8* %.1, i64 16, !dbg !500
  call void @llvm.dbg.value(metadata i8* %50, metadata !448, metadata !DIExpression()), !dbg !444
  %51 = sub i64 %.13, 16, !dbg !501
  call void @llvm.dbg.value(metadata i64 %51, metadata !447, metadata !DIExpression()), !dbg !444
