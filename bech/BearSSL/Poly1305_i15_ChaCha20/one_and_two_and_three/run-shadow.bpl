...
modifies $M.7, $M.7.shadow, $M.12, $M.12.shadow;
modifies $M.9, $M.9.shadow, $M.10, $M.10.shadow;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i58, $i58.shadow := br_i15_decode_mod($p55, $p55.shadow, $p56, $p56.shadow, 16, 16, $p57, $p57.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 179, 18} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($add.ref($p12,$mul.ref(0,20)),$mul.ref(0,2));
  $p59.shadow := $add.ref($add.ref($p12.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  ...
  assume {:verifier.code 0} true;
  call br_i15_montymul($p59, $p59.shadow, $p60, $p60.shadow, $p61, $p61.shadow, $p62, $p62.shadow, 19661, 19661);
  ...
  assume {:verifier.code 0} true;
  call br_i15_zero($p63, $p63.shadow, 138, 138);
  ...
  assume {:verifier.code 0} true;
  call br_enc64le($p64, $p64.shadow, $i5, $i5.shadow);
  ...
  assume {:verifier.code 0} true;
  call br_enc64le($p66, $p66.shadow, $i3, $i3.shadow);
  ...
  assume {:verifier.code 0} true;
  call poly1305_inner($p67, $p67.shadow, $p68, $p68.shadow, $p4, $p4.shadow, $i5, $i5.shadow);
  ...
  assume {:verifier.code 0} true;
  call poly1305_inner($p69, $p69.shadow, $p70, $p70.shadow, $p2, $p2.shadow, $i3, $i3.shadow);
  ...
  assume {:verifier.code 0} true;
  call poly1305_inner($p71, $p71.shadow, $p72, $p72.shadow, $p73, $p73.shadow, 16, 16);
  ...
  assume {:verifier.code 0} true;
  call byteswap16($p75, $p75.shadow);
  ...
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i80, $i80.shadow := br_i15_decode_mod($p76, $p76.shadow, $p78, $p78.shadow, 16, 16, $p79, $p79.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 206, 13} true;
  assume {:verifier.code 0} true;
  $p81 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p81.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  ...
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i83, $i83.shadow := br_i15_add($p81, $p81.shadow, $p82, $p82.shadow, 1, 1);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 212, 25} true;
  assume {:verifier.code 0} true;
  $p84 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p84.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 212, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_encode($p6, $p6.shadow, 16, 16, $p84, $p84.shadow);
...
$bb6:
  assume !($i85 == 1);
  call $i86, $i86.shadow := devirtbounce($p7, $p7.shadow, $p0, $p0.shadow, $p1, $p1.shadow, 1, 1, $p2, $p2.shadow, $i3, $i3.shadow);
...
modifies $M.7, $M.7.shadow, $M.12, $M.12.shadow, $exn, $exn.shadow;
{
  var $p2: ref;
  var $p2.shadow: ref;
  var $p3: ref;
...
modifies $exn, $exn.shadow, $M.5, $M.5.shadow, $M.9, $M.9.shadow, $M.10, $M.10.shadow;
modifies $CurrAddr;
{
  var $p4: ref;
  var $p4.shadow: ref;
...
$bb9:
  ...
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i28, $i28.shadow := br_i15_decode_mod($p25, $p25.shadow, $p26, $p26.shadow, 16, 16, $p27, $p27.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 90, 3} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p6,$mul.ref(0,20)),$mul.ref(9,2));
  $p29.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,20)),$mul.ref(9,2));
  ...
  $M.10.shadow := $store.i16($M.10.shadow,$p29.shadow,$i33.shadow);
  ...
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i35, $i35.shadow := br_i15_add($p34, $p34.shadow, $p0, $p0.shadow, 1, 1);
  ...
  $p36.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,20)),$mul.ref(0,2));
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i38, $i38.shadow := br_i15_sub($p36, $p36.shadow, $p37, $p37.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 97, 10} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i39, $i39.shadow := NOT($i38, $i38.shadow);
...
modifies $M.5, $M.5.shadow;
modifies $CurrAddr, $M.2, $M.2.shadow;
modifies $M.7, $M.7.shadow, $M.12, $M.12.shadow, $M.9, $M.9.shadow, $M.10, $M.10.shadow, $M.0, $M.0.shadow, $M.1, $M.1.shadow, $M.3, $M.3.shadow;
modifies $M.4, $M.4.shadow;
{
  var $p9: ref;
  var $p9.shadow: ref;
