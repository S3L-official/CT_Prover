...
$bb3:
  ...
  assume {:verifier.code 0} true;
  $p57 := $add.ref($add.ref(P1305,$mul.ref(0,20)),$mul.ref(0,2));
  $p57.dup := $or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 174, 2} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i58, $i58.dup := br_i15_decode_mod($p55, $p55.dup, $p56, $p56.dup, 16, 0, $p57, $p57.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 179, 18} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($add.ref($p12,$mul.ref(0,20)),$mul.ref(0,2));
  $p59.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 179, 21} true;
  assume {:verifier.code 0} true;
  $p60 := $add.ref($add.ref($p11,$mul.ref(0,20)),$mul.ref(0,2));
  $p60.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:verifier.code 0} true;
  $p61 := $add.ref($add.ref(R2,$mul.ref(0,20)),$mul.ref(0,2));
  $p61.dup := $or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:verifier.code 0} true;
  $p62 := $add.ref($add.ref(P1305,$mul.ref(0,20)),$mul.ref(0,2));
  $p62.dup := $or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 179, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_montymul($p59, $p59.dup, $p60, $p60.dup, $p61, $p61.dup, $p62, $p62.dup, 19661, 0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 184, 14} true;
  assume {:verifier.code 0} true;
  $p63 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p63.dup := $or.i1($or.i1($p13.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 184, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_zero($p63, $p63.dup, 138, 0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 190, 13} true;
  assume {:verifier.code 0} true;
  $p64 := $add.ref($add.ref($p10,$mul.ref(0,16)),$mul.ref(0,1));
  $p64.dup := $or.i1($or.i1($p10.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 190, 2} true;
  assume {:verifier.code 0} true;
  call br_enc64le($p64, $p64.dup, $i5, $i5.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 191, 13} true;
  assume {:verifier.code 0} true;
  $p65 := $add.ref($add.ref($p10,$mul.ref(0,16)),$mul.ref(0,1));
  $p65.dup := $or.i1($or.i1($p10.dup,$or.i1(0,0)),$or.i1(0,0));
  $p66 := $add.ref($add.ref($p10,$mul.ref(0,16)),$mul.ref(8,1));
  $p66.dup := $or.i1($or.i1($p10.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 191, 2} true;
  assume {:verifier.code 0} true;
  call br_enc64le($p66, $p66.dup, $i3, $i3.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 192, 17} true;
  assume {:verifier.code 0} true;
  $p67 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p67.dup := $or.i1($or.i1($p13.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 192, 22} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($add.ref($p12,$mul.ref(0,20)),$mul.ref(0,2));
  $p68.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 192, 2} true;
  assume {:verifier.code 0} true;
  call poly1305_inner($p67, $p67.dup, $p68, $p68.dup, $p4, $p4.dup, $i5, $i5.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 193, 17} true;
  assume {:verifier.code 0} true;
  $p69 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p69.dup := $or.i1($or.i1($p13.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 193, 22} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($add.ref($p12,$mul.ref(0,20)),$mul.ref(0,2));
  $p70.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 193, 2} true;
  assume {:verifier.code 0} true;
  call poly1305_inner($p69, $p69.dup, $p70, $p70.dup, $p2, $p2.dup, $i3, $i3.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 194, 17} true;
  assume {:verifier.code 0} true;
  $p71 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p71.dup := $or.i1($or.i1($p13.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 194, 22} true;
  assume {:verifier.code 0} true;
  $p72 := $add.ref($add.ref($p12,$mul.ref(0,20)),$mul.ref(0,2));
  $p72.dup := $or.i1($or.i1($p12.dup,$or.i1(0,0)),$or.i1(0,0));
  ...
  assume {:verifier.code 0} true;
  call poly1305_inner($p71, $p71.dup, $p72, $p72.dup, $p73, $p73.dup, 16, 0);
  ...
  assume {:verifier.code 0} true;
  call byteswap16($p75, $p75.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 200, 20} true;
  assume {:verifier.code 0} true;
  $p76 := $add.ref($add.ref($p11,$mul.ref(0,20)),$mul.ref(0,2));
  $p76.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 200, 23} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(0,1));
  $p77.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p78 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(16,1));
  $p78.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:verifier.code 0} true;
  $p79 := $add.ref($add.ref(P1305,$mul.ref(0,20)),$mul.ref(0,2));
  $p79.dup := $or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 200, 2} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i80, $i80.dup := br_i15_decode_mod($p76, $p76.dup, $p78, $p78.dup, 16, 0, $p79, $p79.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 206, 13} true;
  assume {:verifier.code 0} true;
  $p81 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p81.dup := $or.i1($or.i1($p13.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 206, 18} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($add.ref($p11,$mul.ref(0,20)),$mul.ref(0,2));
  $p82.dup := $or.i1($or.i1($p11.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 206, 2} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i83, $i83.dup := br_i15_add($p81, $p81.dup, $p82, $p82.dup, 1, 0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 212, 25} true;
  assume {:verifier.code 0} true;
  $p84 := $add.ref($add.ref($p13,$mul.ref(0,20)),$mul.ref(0,2));
  $p84.dup := $or.i1($or.i1($p13.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 212, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_encode($p6, $p6.dup, 16, 0, $p84, $p84.dup);
...
$bb6:
  assume !($i85 == 1);
  call $i86, $i86.dup := devirtbounce($p7, $p7.dup, $p0, $p0.dup, $p1, $p1.dup, 1, 0, $p2, $p2.dup, $i3, $i3.dup);
...
$bb9:
  ...
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref(P1305,$mul.ref(0,20)),$mul.ref(0,2));
  $p27.dup := $or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 89, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i28, $i28.dup := br_i15_decode_mod($p25, $p25.dup, $p26, $p26.dup, 16, 0, $p27, $p27.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 90, 3} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p6,$mul.ref(0,20)),$mul.ref(9,2));
  $p29.dup := $or.i1($or.i1($p6.dup,$or.i1(0,0)),$or.i1(0,0));
  ...
  assume {:verifier.code 0} true;
  $p29.dup := 0;
  $M.10 := $store.i16($M.10,$p29,$i33);
  $M.10.dup := $store.i1($M.10.dup,$p29,$i33.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 96, 20} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p6,$mul.ref(0,20)),$mul.ref(0,2));
  $p34.dup := $or.i1($or.i1($p6.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 96, 9} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i35, $i35.dup := br_i15_add($p34, $p34.dup, $p0, $p0.dup, 1, 0);
  call {:cexpr "ctl"} boogie_si_record_i32($i35);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 97, 25} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($add.ref($p6,$mul.ref(0,20)),$mul.ref(0,2));
  $p36.dup := $or.i1($or.i1($p6.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:verifier.code 0} true;
  $p37 := $add.ref($add.ref(P1305,$mul.ref(0,20)),$mul.ref(0,2));
  $p37.dup := $or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 97, 14} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i38, $i38.dup := br_i15_sub($p36, $p36.dup, $p37, $p37.dup, 0, 0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 97, 10} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i39, $i39.dup := NOT($i38, $i38.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 97, 7} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $i40 := $or.i32($i35,$i39);
  $i40.dup := $or.i1($i35.dup,$i39.dup);
  call {:cexpr "ctl"} boogie_si_record_i32($i40);
  ...
  assume {:verifier.code 0} true;
  $p42 := $add.ref($add.ref(P1305,$mul.ref(0,20)),$mul.ref(0,2));
  $p42.dup := $or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 98, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i43, $i43.dup := br_i15_sub($p41, $p41.dup, $p42, $p42.dup, $i40, $i40.dup);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 103, 22} true;
  assume {:verifier.code 0} true;
  $p44 := $add.ref($add.ref($p6,$mul.ref(0,20)),$mul.ref(0,2));
  $p44.dup := $or.i1($or.i1($p6.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:verifier.code 0} true;
  $p45 := $add.ref($add.ref(P1305,$mul.ref(0,20)),$mul.ref(0,2));
  $p45.dup := $or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 103, 3} true;
  assume {:verifier.code 0} true;
  call br_i15_montymul($p0, $p0.dup, $p44, $p44.dup, $p1, $p1.dup, $p45, $p45.dup, 19661, 0);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 105, 7} true;
  assume {:verifier.code 0} true;
  $p46 := $add.ref($p12,$mul.ref(16,1));
  $p46.dup := $or.i1($p12.dup,$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 106, 7} true;
  assume {:verifier.code 0} true;
  $i47 := $sub.i64($i11,16);
  $i47.dup := $or.i1($i11.dup,0);
  call {:cexpr "len"} boogie_si_record_i64($i47);
  assume {:sourceloc "../BearSSL/src/symcipher/poly1305_i15.c", 66, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $i47;
  $i7.dup := 0;
