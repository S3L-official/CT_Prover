...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i37, $i37.shadow := br_rsa_i15_private($p0, $p0.shadow, $p1, $p1.shadow);
...
const br_rsa_i15_private: ref;
axiom (br_rsa_i15_private == $sub.ref(0,7224));
procedure {:inline 1} br_rsa_i15_private($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref) returns ($r: i32, $r.shadow: i32)
modifies $exn;
modifies $M.0;
modifies $CurrAddr;
modifies $M.13;
{
  ...
  var $i41.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 49, 10} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p2 := $alloc($mul.ref(2258,$zext.i32.i64(1)));
  $p2.shadow := $p2;
  assume true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 49, 10} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(8,1));
  $p3.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 49, 10} true;
  assume {:verifier.code 0} true;
  assert ($p3 == $p3.shadow);
  $p4 := $load.ref($M.1,$p3);
  $p4.shadow := $load.ref($M.1.shadow,$p3.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 50, 13} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(16,1));
  $p5.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(16,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 50, 13} true;
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $i6 := $load.i64($M.6,$p5);
  $i6.shadow := $load.i64($M.6.shadow,$p5.shadow);
  call {:cexpr "plen"} boogie_si_record_i64($i6);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 51, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $i6;
  $i7.shadow := $i6.shadow;
  $p8 := $p4;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 51, 14} true;
  assume {:verifier.code 0} true;
  $i9 := $ugt.i64($i7,0);
  $i9.shadow := $ugt.i64($i7.shadow,0);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 51, 18} true;
  assume {:verifier.code 0} true;
  $i10 := 0;
  $i10.shadow := 0;
...
$bb2:
  assume ($i9 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 51, 21} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $i11 := $load.i8($M.0,$p8);
  $i11.shadow := $load.i8($M.0.shadow,$p8.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 51, 21} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i8.i32($i11);
  $i12.shadow := $zext.i8.i32($i11.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 51, 24} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i32($i12,0);
  $i13.shadow := $eq.i32($i12.shadow,0);
  assume {:verifier.code 0} true;
  $i10 := $i13;
  $i10.shadow := $i13.shadow;
  goto $bb4;
$bb3:
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 51, 18} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i10 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 52, 5} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p8,$mul.ref(1,1));
  $p14.shadow := $add.ref($p8.shadow,$mul.ref(1,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 53, 8} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i64($i7,$sub.i64(0,1));
  $i15.shadow := $add.i64($i7.shadow,$sub.i64(0,1));
  call {:cexpr "plen"} boogie_si_record_i64($i15);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 51, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $i15;
  $i7.shadow := $i15.shadow;
  $p8 := $p14;
  $p8.shadow := $p14.shadow;
  goto $bb1;
$bb6:
  assume !($i10 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 55, 10} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(24,1));
  $p16.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(24,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 55, 10} true;
  assume {:verifier.code 0} true;
  assert ($p16 == $p16.shadow);
  $p17 := $load.ref($M.2,$p16);
  $p17.shadow := $load.ref($M.2.shadow,$p16.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 56, 13} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(32,1));
  $p18.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(32,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 56, 13} true;
  assume {:verifier.code 0} true;
  assert ($p18 == $p18.shadow);
  $i19 := $load.i64($M.7,$p18);
  $i19.shadow := $load.i64($M.7.shadow,$p18.shadow);
  call {:cexpr "qlen"} boogie_si_record_i64($i19);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 57, 2} true;
  assume {:verifier.code 0} true;
  $i20 := $i19;
  $i20.shadow := $i19.shadow;
  $p21 := $p17;
  $p21.shadow := $p17.shadow;
  goto $bb7;
$bb7:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($p2 == $p2.shadow);
  ...
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 57, 14} true;
  assume {:verifier.code 0} true;
  $i22 := $ugt.i64($i20,0);
  $i22.shadow := $ugt.i64($i20.shadow,0);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 57, 18} true;
  assume {:verifier.code 0} true;
  $i23 := 0;
  $i23.shadow := 0;
...
$bb8:
  assume ($i22 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 57, 21} true;
  assume {:verifier.code 0} true;
  assert ($p21 == $p21.shadow);
  $i24 := $load.i8($M.0,$p21);
  $i24.shadow := $load.i8($M.0.shadow,$p21.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 57, 21} true;
  assume {:verifier.code 0} true;
  $i25 := $zext.i8.i32($i24);
  $i25.shadow := $zext.i8.i32($i24.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 57, 24} true;
  assume {:verifier.code 0} true;
  $i26 := $eq.i32($i25,0);
  $i26.shadow := $eq.i32($i25.shadow,0);
  assume {:verifier.code 0} true;
  $i23 := $i26;
  $i23.shadow := $i26.shadow;
  goto $bb10;
$bb9:
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 57, 18} true;
  assume {:verifier.code 0} true;
...
$bb11:
  assume ($i23 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 58, 5} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($p21,$mul.ref(1,1));
  $p27.shadow := $add.ref($p21.shadow,$mul.ref(1,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 59, 8} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i64($i20,$sub.i64(0,1));
  $i28.shadow := $add.i64($i20.shadow,$sub.i64(0,1));
  call {:cexpr "qlen"} boogie_si_record_i64($i28);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 57, 2} true;
  assume {:verifier.code 0} true;
  $i20 := $i28;
  $i20.shadow := $i28.shadow;
  $p21 := $p27;
  $p21.shadow := $p27.shadow;
  goto $bb7;
$bb12:
  assume !($i23 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 65, 18} true;
  assume {:verifier.code 0} true;
  $i29 := $ugt.i64($i7,$i20);
  $i29.shadow := $ugt.i64($i7.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 65, 13} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 65, 13} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 65, 40} true;
  assume {:verifier.code 0} true;
  $i31 := $shl.i64($i30,3);
  $i31.shadow := $shl.i64($i30.shadow,3);
  call {:cexpr "z"} boogie_si_record_i64($i31);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $i32 := $i31;
  $i32.shadow := $i31.shadow;
  $i33 := 1;
  $i33.shadow := 1;
  goto $bb16;
$bb16:
  ...
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 67, 11} true;
  assume {:verifier.code 0} true;
  $i34 := $sgt.i64($i32,0);
  $i34.shadow := $sgt.i64($i32.shadow,0);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 67, 2} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume ($i34 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 68, 5} true;
  assume {:verifier.code 0} true;
  $i35 := $sub.i64($i32,15);
  $i35.shadow := $sub.i64($i32.shadow,15);
  call {:cexpr "z"} boogie_si_record_i64($i35);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 69, 9} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i64($i33,1);
  $i36.shadow := $add.i64($i33.shadow,1);
  call {:cexpr "fwlen"} boogie_si_record_i64($i36);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $i32 := $i35;
  $i32.shadow := $i35.shadow;
  $i33 := $i36;
  $i33.shadow := $i36.shadow;
  goto $bb16;
$bb18:
  assume !($i34 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 74, 18} true;
  assume {:verifier.code 0} true;
  $i37 := $and.i64($i33,1);
  $i37.shadow := $and.i64($i33.shadow,1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 74, 8} true;
  assume {:verifier.code 0} true;
  $i38 := $add.i64($i33,$i37);
  $i38.shadow := $add.i64($i33.shadow,$i37.shadow);
  call {:cexpr "fwlen"} boogie_si_record_i64($i38);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 79, 8} true;
  assume {:verifier.code 0} true;
  $i39 := $mul.i64(6,$i38);
  $i39.shadow := $mul.i64(6,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 79, 16} true;
  assume {:verifier.code 0} true;
  $i40 := $ugt.i64($i39,1128);
  $i40.shadow := $ugt.i64($i39.shadow,1128);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 79, 6} true;
  assume {:verifier.code 0} true;
...
$bb19:
  assume ($i40 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 80, 3} true;
  assume {:verifier.code 0} true;
  $i41 := 0;
  $i41.shadow := 0;
  goto $bb21;
$bb20:
  assume !($i40 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 86, 14} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(0,1));
  $p42.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 86, 14} true;
  assume {:verifier.code 0} true;
  assert ($p42 == $p42.shadow);
  $i43 := $load.i32($M.11,$p42);
  $i43.shadow := $load.i32($M.11.shadow,$p42.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 86, 23} true;
  assume {:verifier.code 0} true;
  $i44 := $add.i32($i43,7);
  $i44.shadow := $add.i32($i43.shadow,7);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 86, 28} true;
  assume {:verifier.code 0} true;
  $i45 := $lshr.i32($i44,3);
  $i45.shadow := $lshr.i32($i44.shadow,3);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 86, 9} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i32.i64($i45);
  $i46.shadow := $zext.i32.i64($i45.shadow);
  call {:cexpr "xlen"} boogie_si_record_i64($i46);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 91, 7} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($add.ref($p2,$mul.ref(0,2258)),$mul.ref(0,2));
  $p47.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,2258)),$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 92, 7} true;
  assume {:verifier.code 0} true;
  $i48 := $p2i.ref.i64($p47);
  $i48.shadow := $p2i.ref.i64($p47.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 92, 21} true;
  assume {:verifier.code 0} true;
  $i49 := $and.i64($i48,2);
  $i49.shadow := $and.i64($i48.shadow,2);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 92, 26} true;
  assume {:verifier.code 0} true;
  $i50 := $eq.i64($i49,0);
  $i50.shadow := $eq.i64($i49.shadow,0);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 92, 6} true;
  assume {:verifier.code 0} true;
  $p51 := $p2;
...
$bb21:
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 209, 1} true;
  assume {:verifier.code 0} true;
  $r := $i41;
  $r.shadow := $i41.shadow;
  $exn := false;
...
$bb22:
  assume ($i50 == 1);
  $p52 := $add.ref($add.ref($p2,$mul.ref(0,2258)),$mul.ref(1,2));
  $p52.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,2258)),$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 94, 2} true;
  assume {:verifier.code 0} true;
  $p51 := $p52;
  $p51.shadow := $p52.shadow;
  goto $bb24;
$bb23:
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 92, 6} true;
  assume {:verifier.code 0} true;
...
$bb24:
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 99, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_decode($p51, $p51.shadow, $p21, $p21.shadow, $i20, $i20.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 104, 10} true;
  assume {:verifier.code 0} true;
  $p53 := $add.ref($p51,$mul.ref($i38,2));
  $p53.shadow := $add.ref($p51.shadow,$mul.ref($i38.shadow,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 105, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_decode($p53, $p53.shadow, $p8, $p8.shadow, $i7, $i7.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 112, 14} true;
  assume {:verifier.code 0} true;
  $i54 := $mul.i64(2,$i38);
  $i54.shadow := $mul.i64(2,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 112, 10} true;
  assume {:verifier.code 0} true;
  $p55 := $add.ref($p51,$mul.ref($i54,2));
  $p55.shadow := $add.ref($p51.shadow,$mul.ref($i54.shadow,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 113, 18} true;
  assume {:verifier.code 0} true;
  $p56 := $add.ref($p51,$mul.ref(0,2));
  $p56.shadow := $add.ref($p51.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 113, 18} true;
  assume {:verifier.code 0} true;
  assert ($p56 == $p56.shadow);
  $i57 := $load.i16($M.0,$p56);
  $i57.shadow := $load.i16($M.0.shadow,$p56.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 113, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_zero.29($p55, $p55.shadow, $i57, $i57.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 114, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_mulacc($p55, $p55.shadow, $p51, $p51.shadow, $p53, $p53.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 125, 14} true;
  assume {:verifier.code 0} true;
  $i58 := $mul.i64(4,$i38);
  $i58.shadow := $mul.i64(4,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 125, 10} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($p51,$mul.ref($i58,2));
  $p59.shadow := $add.ref($p51.shadow,$mul.ref($i58.shadow,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 126, 16} true;
  assume {:verifier.code 0} true;
  $p60 := $bitcast.ref.ref($p59);
  $p60.shadow := $bitcast.ref.ref($p59.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 126, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_encode($p60, $p60.shadow, $i46, $i46.shadow, $p55, $p55.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 129, 2} true;
  assume {:verifier.code 0} true;
  $i61 := $i46;
  $i61.shadow := $i46.shadow;
  $i62 := 0;
  $i62.shadow := 0;
  goto $bb25;
$bb25:
  ...
  assert {:likely_shadow_invariant} ($p53 == $p53.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 129, 11} true;
  assume {:verifier.code 0} true;
  $i63 := $ugt.i64($i61,0);
  $i63.shadow := $ugt.i64($i61.shadow,0);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 129, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i63} true;
  assert ($i63 == $i63.shadow);
  goto $bb26, $bb27;
$bb26:
  assume ($i63 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 132, 5} true;
  assume {:verifier.code 0} true;
  $i64 := $add.i64($i61,$sub.i64(0,1));
  $i64.shadow := $add.i64($i61.shadow,$sub.i64(0,1));
  call {:cexpr "u"} boogie_si_record_i64($i64);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 133, 8} true;
  assume {:verifier.code 0} true;
  $p65 := $bitcast.ref.ref($p59);
  $p65.shadow := $bitcast.ref.ref($p59.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 133, 8} true;
  assume {:verifier.code 0} true;
  $p66 := $add.ref($p65,$mul.ref($i64,1));
  $p66.shadow := $add.ref($p65.shadow,$mul.ref($i64.shadow,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 133, 8} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "wn"} boogie_si_record_i32($i68);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 134, 8} true;
  assume {:verifier.code 0} true;
  $p69 := $add.ref($p0,$mul.ref($i64,1));
  $p69.shadow := $add.ref($p0.shadow,$mul.ref($i64.shadow,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 134, 8} true;
  assume {:verifier.code 0} true;
  assert ($p69 == $p69.shadow);
  $i70 := $load.i8($M.0,$p69);
  $i70.shadow := $load.i8($M.0.shadow,$p69.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 134, 8} true;
  assume {:verifier.code 0} true;
  $i71 := $zext.i8.i32($i70);
  $i71.shadow := $zext.i8.i32($i70.shadow);
  call {:cexpr "wx"} boogie_si_record_i32($i71);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 135, 18} true;
  assume {:verifier.code 0} true;
  $i72 := $add.i32($i68,$i62);
  $i72.shadow := $add.i32($i68.shadow,$i62.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 135, 12} true;
  assume {:verifier.code 0} true;
  $i73 := $sub.i32($i71,$i72);
  $i73.shadow := $sub.i32($i71.shadow,$i72.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 135, 24} true;
  assume {:verifier.code 0} true;
  $i74 := $lshr.i32($i73,8);
  $i74.shadow := $lshr.i32($i73.shadow,8);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 135, 30} true;
  assume {:verifier.code 0} true;
  $i75 := $and.i32($i74,1);
  $i75.shadow := $and.i32($i74.shadow,1);
  call {:cexpr "r"} boogie_si_record_i32($i75);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 129, 2} true;
  assume {:verifier.code 0} true;
  $i61 := $i64;
  $i61.shadow := $i64.shadow;
  $i62 := $i75;
  $i62.shadow := $i75.shadow;
  goto $bb25;
$bb27:
  assume !($i63 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 141, 14} true;
  assume {:verifier.code 0} true;
  $i76 := $mul.i64(2,$i38);
  $i76.shadow := $mul.i64(2,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 141, 10} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($p51,$mul.ref($i76,2));
  $p77.shadow := $add.ref($p51.shadow,$mul.ref($i76.shadow,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 142, 2} true;
  assume {:verifier.code 0} true;
  $p78 := $bitcast.ref.ref($p77);
  $p78.shadow := $bitcast.ref.ref($p77.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 142, 2} true;
  assume {:verifier.code 0} true;
  $p79 := $bitcast.ref.ref($p53);
  $p79.shadow := $bitcast.ref.ref($p53.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 142, 24} true;
  assume {:verifier.code 0} true;
  $i80 := $mul.i64($i38,2);
  $i80.shadow := $mul.i64($i38.shadow,2);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 142, 2} true;
  assume {:verifier.code 0} true;
  call llvm.memmove.p0i8.p0i8.i64($p78, $p78.shadow, $p79, $p79.shadow, $i80, $i80.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 147, 22} true;
  assume {:verifier.code 0} true;
  $p81 := $add.ref($p51,$mul.ref(1,2));
  $p81.shadow := $add.ref($p51.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 147, 22} true;
  assume {:verifier.code 0} true;
  assert ($p81 == $p81.shadow);
  $i82 := $load.i16($M.0,$p81);
  $i82.shadow := $load.i16($M.0.shadow,$p81.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 147, 8} true;
  assume {:verifier.code 0} true;
  call $i83, $i83.shadow := br_i15_ninv15($i82, $i82.shadow);
  call {:cexpr "q0i"} boogie_si_record_i16($i83);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 148, 10} true;
  assume {:verifier.code 0} true;
  $p84 := $add.ref($p51,$mul.ref($i38,2));
  $p84.shadow := $add.ref($p51.shadow,$mul.ref($i38.shadow,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 149, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_decode_reduce($p84, $p84.shadow, $p0, $p0.shadow, $i46, $i46.shadow, $p51, $p51.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 150, 33} true;
  assume {:verifier.code 0} true;
  $p85 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(56,1));
  $p85.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(56,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 150, 33} true;
  assume {:verifier.code 0} true;
  assert ($p85 == $p85.shadow);
  $p86 := $load.ref($M.4,$p85);
  $p86.shadow := $load.ref($M.4.shadow,$p85.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 150, 41} true;
  assume {:verifier.code 0} true;
  $p87 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(64,1));
  $p87.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(64,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 150, 41} true;
  assume {:verifier.code 0} true;
  assert ($p87 == $p87.shadow);
  $i88 := $load.i64($M.9,$p87);
  $i88.shadow := $load.i64($M.9.shadow,$p87.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 151, 10} true;
  assume {:verifier.code 0} true;
  $i89 := $mul.i64(3,$i38);
  $i89.shadow := $mul.i64(3,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 151, 6} true;
  assume {:verifier.code 0} true;
  $p90 := $add.ref($p51,$mul.ref($i89,2));
  $p90.shadow := $add.ref($p51.shadow,$mul.ref($i89.shadow,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 151, 28} true;
  assume {:verifier.code 0} true;
  $i91 := $mul.i64(3,$i38);
  $i91.shadow := $mul.i64(3,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 151, 24} true;
  assume {:verifier.code 0} true;
  $i92 := $sub.i64(1128,$i91);
  $i92.shadow := $sub.i64(1128,$i91.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 150, 7} true;
  assume {:verifier.code 0} true;
  call $i93, $i93.shadow := br_i15_modpow_opt($p84, $p84.shadow, $p86, $p86.shadow, $i88, $i88.shadow, $p51, $p51.shadow, $i83, $i83.shadow, $p90, $p90.shadow, $i92, $i92.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 150, 4} true;
  assume {:verifier.code 0} true;
  $i94 := $and.i32($i62,$i93);
  $i94.shadow := $and.i32($i62.shadow,$i93.shadow);
  call {:cexpr "r"} boogie_si_record_i32($i94);
  $i95 := $add.i64($i76,1);
  $i95.shadow := $add.i64($i76.shadow,1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 156, 22} true;
  assume {:verifier.code 0} true;
  $p96 := $add.ref($p51,$mul.ref($i95,2));
  $p96.shadow := $add.ref($p51.shadow,$mul.ref($i95.shadow,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 156, 22} true;
  assume {:verifier.code 0} true;
  assert ($p96 == $p96.shadow);
  $i97 := $load.i16($M.0,$p96);
  $i97.shadow := $load.i16($M.0.shadow,$p96.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 156, 8} true;
  assume {:verifier.code 0} true;
  call $i98, $i98.shadow := br_i15_ninv15($i97, $i97.shadow);
  call {:cexpr "p0i"} boogie_si_record_i16($i98);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 157, 14} true;
  assume {:verifier.code 0} true;
  $i99 := $mul.i64(3,$i38);
  $i99.shadow := $mul.i64(3,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 157, 10} true;
  assume {:verifier.code 0} true;
  $p100 := $add.ref($p51,$mul.ref($i99,2));
  $p100.shadow := $add.ref($p51.shadow,$mul.ref($i99.shadow,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 158, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_decode_reduce($p100, $p100.shadow, $p0, $p0.shadow, $i46, $i46.shadow, $p77, $p77.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 159, 33} true;
  assume {:verifier.code 0} true;
  $p101 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(40,1));
  $p101.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(40,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 159, 33} true;
  assume {:verifier.code 0} true;
  assert ($p101 == $p101.shadow);
  $p102 := $load.ref($M.3,$p101);
  $p102.shadow := $load.ref($M.3.shadow,$p101.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 159, 41} true;
  assume {:verifier.code 0} true;
  $p103 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(48,1));
  $p103.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(48,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 159, 41} true;
  assume {:verifier.code 0} true;
  assert ($p103 == $p103.shadow);
  $i104 := $load.i64($M.8,$p103);
  $i104.shadow := $load.i64($M.8.shadow,$p103.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 160, 10} true;
  assume {:verifier.code 0} true;
  $i105 := $mul.i64(4,$i38);
  $i105.shadow := $mul.i64(4,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 160, 6} true;
  assume {:verifier.code 0} true;
  $p106 := $add.ref($p51,$mul.ref($i105,2));
  $p106.shadow := $add.ref($p51.shadow,$mul.ref($i105.shadow,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 160, 28} true;
  assume {:verifier.code 0} true;
  $i107 := $mul.i64(4,$i38);
  $i107.shadow := $mul.i64(4,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 160, 24} true;
  assume {:verifier.code 0} true;
  $i108 := $sub.i64(1128,$i107);
  $i108.shadow := $sub.i64(1128,$i107.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 159, 7} true;
  assume {:verifier.code 0} true;
  call $i109, $i109.shadow := br_i15_modpow_opt($p100, $p100.shadow, $p102, $p102.shadow, $i104, $i104.shadow, $p77, $p77.shadow, $i98, $i98.shadow, $p106, $p106.shadow, $i108, $i108.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 159, 4} true;
  assume {:verifier.code 0} true;
  $i110 := $and.i32($i94,$i109);
  $i110.shadow := $and.i32($i94.shadow,$i109.shadow);
  call {:cexpr "r"} boogie_si_record_i32($i110);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 175, 14} true;
  assume {:verifier.code 0} true;
  $i111 := $mul.i64(4,$i38);
  $i111.shadow := $mul.i64(4,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 175, 10} true;
  assume {:verifier.code 0} true;
  $p112 := $add.ref($p51,$mul.ref($i111,2));
  $p112.shadow := $add.ref($p51.shadow,$mul.ref($i111.shadow,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 176, 14} true;
  assume {:verifier.code 0} true;
  $i113 := $mul.i64(5,$i38);
  $i113.shadow := $mul.i64(5,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 176, 10} true;
  assume {:verifier.code 0} true;
  $p114 := $add.ref($p51,$mul.ref($i113,2));
  $p114.shadow := $add.ref($p51.shadow,$mul.ref($i113.shadow,2));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 177, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_reduce($p114, $p114.shadow, $p84, $p84.shadow, $p77, $p77.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 178, 21} true;
  assume {:verifier.code 0} true;
  call $i115, $i115.shadow := br_i15_sub($p100, $p100.shadow, $p114, $p114.shadow, 1, 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 178, 2} true;
  assume {:verifier.code 0} true;
  call $i116, $i116.shadow := br_i15_add($p100, $p100.shadow, $p77, $p77.shadow, $i115, $i115.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 179, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_to_monty($p100, $p100.shadow, $p77, $p77.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 180, 31} true;
  assume {:verifier.code 0} true;
  $p117 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(72,1));
  $p117.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(72,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 180, 31} true;
  assume {:verifier.code 0} true;
  assert ($p117 == $p117.shadow);
  $p118 := $load.ref($M.5,$p117);
  $p118.shadow := $load.ref($M.5.shadow,$p117.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 180, 39} true;
  assume {:verifier.code 0} true;
  $p119 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(80,1));
  $p119.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(80,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 180, 39} true;
  assume {:verifier.code 0} true;
  assert ($p119 == $p119.shadow);
  $i120 := $load.i64($M.10,$p119);
  $i120.shadow := $load.i64($M.10.shadow,$p119.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 180, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_decode_reduce($p112, $p112.shadow, $p118, $p118.shadow, $i120, $i120.shadow, $p77, $p77.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 181, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_montymul($p114, $p114.shadow, $p100, $p100.shadow, $p112, $p112.shadow, $p77, $p77.shadow, $i98, $i98.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 196, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_mulacc($p84, $p84.shadow, $p51, $p51.shadow, $p114, $p114.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 202, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_encode($p0, $p0.shadow, $i46, $i46.shadow, $p84, $p84.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 208, 9} true;
  assume {:verifier.code 0} true;
  $i121 := $zext.i16.i32($i98);
  $i121.shadow := $zext.i16.i32($i98.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 208, 15} true;
  assume {:verifier.code 0} true;
  $i122 := $zext.i16.i32($i83);
  $i122.shadow := $zext.i16.i32($i83.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 208, 13} true;
  assume {:verifier.code 0} true;
  $i123 := $and.i32($i121,$i122);
  $i123.shadow := $and.i32($i121.shadow,$i122.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 208, 19} true;
  assume {:verifier.code 0} true;
  $i124 := $and.i32($i123,$i110);
  $i124.shadow := $and.i32($i123.shadow,$i110.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 208, 2} true;
  assume {:verifier.code 0} true;
  $i41 := $i124;
  $i41.shadow := $i124.shadow;
  goto $bb21;
}
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0,8256));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const br_i15_decode: ref;
axiom (br_i15_decode == $sub.ref(0,9288));
procedure {:inline 1} br_i15_decode($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64)
modifies $M.0, $exn;
{
  var $i3: i64;
  var $i3.shadow: i64;
  ...
  var $p34.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 40, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_decode:arg:len"} boogie_si_record_i64($i2);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 40, 2} true;
  assume {:verifier.code 0} true;
  $i3 := 1;
  $i3.shadow := 1;
...
$bb1:
  ...
  assert {:shadow_invariant} ($i4 == $i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 40, 13} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i64($i4,$sub.i64(0,1));
  $i7.shadow := $add.i64($i4.shadow,$sub.i64(0,1));
  call {:cexpr "len"} boogie_si_record_i64($i7);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 40, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $ugt.i64($i4,0);
  $i8.shadow := $ugt.i64($i4.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 40, 2} true;
...
$bb2:
  assume ($i8 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 43, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 44, 13} true;
  assume {:verifier.code 0} true;
  $i12 := $shl.i32($i11,$i6);
  $i12.shadow := $shl.i32($i11.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 44, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $or.i32($i5,$i12);
  $i13.shadow := $or.i32($i5.shadow,$i12.shadow);
  call {:cexpr "acc"} boogie_si_record_i32($i13);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 45, 11} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i6,8);
  $i14.shadow := $add.i32($i6.shadow,8);
  call {:cexpr "acc_len"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 46, 15} true;
  assume {:verifier.code 0} true;
  $i15 := $sge.i32($i14,15);
  $i15.shadow := $sge.i32($i14.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 46, 7} true;
  assume {:verifier.code 0} true;
  $i16 := $i3;
  $i16.shadow := $i3.shadow;
  $i17 := $i13;
  $i17.shadow := $i13.shadow;
  $i18 := $i14;
  $i18.shadow := $i14.shadow;
  assume {:branchcond $i15} true;
  assert ($i15 == $i15.shadow);
  goto $bb4, $bb5;
$bb3:
  assume !($i8 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 52, 14} true;
  assume {:verifier.code 0} true;
  $i25 := $ne.i32($i6,0);
  $i25.shadow := $ne.i32($i6.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 52, 6} true;
  assume {:verifier.code 0} true;
  $i26 := $i3;
  $i26.shadow := $i3.shadow;
  assume {:branchcond $i25} true;
  assert ($i25 == $i25.shadow);
  goto $bb7, $bb8;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 47, 18} true;
  assume {:verifier.code 0} true;
  $i19 := $and.i32($i13,32767);
  $i19.shadow := $and.i32($i13.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 47, 14} true;
  assume {:verifier.code 0} true;
  $i20 := $trunc.i32.i16($i19);
  $i20.shadow := $trunc.i32.i16($i19.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i64($i3,1);
  $i21.shadow := $add.i64($i3.shadow,1);
  call {:cexpr "v"} boogie_si_record_i64($i21);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 47, 4} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p0,$mul.ref($i3,2));
  $p22.shadow := $add.ref($p0.shadow,$mul.ref($i3.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 47, 12} true;
  assume {:verifier.code 0} true;
  assert ($p22 == $p22.shadow);
  $M.0 := $store.i16($M.0,$p22,$i20);
  $M.0.shadow := $store.i16($M.0.shadow,$p22.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 48, 12} true;
  assume {:verifier.code 0} true;
  $i23 := $sub.i32($i14,15);
  $i23.shadow := $sub.i32($i14.shadow,15);
  call {:cexpr "acc_len"} boogie_si_record_i32($i23);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 49, 8} true;
  assume {:verifier.code 0} true;
  $i24 := $lshr.i32($i13,15);
  $i24.shadow := $lshr.i32($i13.shadow,15);
  call {:cexpr "acc"} boogie_si_record_i32($i24);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 50, 3} true;
  assume {:verifier.code 0} true;
  $i16 := $i21;
  $i16.shadow := $i21.shadow;
  $i17 := $i24;
  $i17.shadow := $i24.shadow;
  $i18 := $i23;
  $i18.shadow := $i23.shadow;
  goto $bb6;
$bb5:
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 46, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  $i6 := $i18;
  $i6.shadow := $i18.shadow;
  goto $bb1;
$bb7:
  assume ($i25 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 53, 13} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i32.i16($i5);
  $i27.shadow := $trunc.i32.i16($i5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 53, 7} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i64($i3,1);
  $i28.shadow := $add.i64($i3.shadow,1);
  call {:cexpr "v"} boogie_si_record_i64($i28);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 53, 3} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p0,$mul.ref($i3,2));
  $p29.shadow := $add.ref($p0.shadow,$mul.ref($i3.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 53, 11} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $M.0 := $store.i16($M.0,$p29,$i27);
  $M.0.shadow := $store.i16($M.0.shadow,$p29.shadow,$i27.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 54, 2} true;
  assume {:verifier.code 0} true;
  $i26 := $i28;
  $i26.shadow := $i28.shadow;
  goto $bb9;
$bb8:
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 52, 6} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 55, 29} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($p0,$mul.ref(1,2));
  $p30.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 55, 36} true;
  assume {:verifier.code 0} true;
  $i31 := $sub.i64($i26,1);
  $i31.shadow := $sub.i64($i26.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 55, 9} true;
  assume {:verifier.code 0} true;
  call $i32, $i32.shadow := br_i15_bit_length($p30, $p30.shadow, $i31, $i31.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 55, 9} true;
  assume {:verifier.code 0} true;
  $i33 := $trunc.i32.i16($i32);
  $i33.shadow := $trunc.i32.i16($i32.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 55, 2} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($p0,$mul.ref(0,2));
  $p34.shadow := $add.ref($p0.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 55, 7} true;
  assume {:verifier.code 0} true;
  assert ($p34 == $p34.shadow);
  $M.0 := $store.i16($M.0,$p34,$i33);
  $M.0.shadow := $store.i16($M.0.shadow,$p34.shadow,$i33.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decode.c", 56, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const br_i15_zero.29: ref;
axiom (br_i15_zero.29 == $sub.ref(0,10320));
procedure {:inline 1} br_i15_zero.29($p0: ref, $p0.shadow: ref, $i1: i16, $i1.shadow: i16)
modifies $M.0, $exn;
{
  var $p2: ref;
  var $p2.shadow: ref;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_zero.29:arg:bit_len"} boogie_si_record_i16($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1539, 5} true;
  assume {:verifier.code 0} true;
  ...
  $M.0.shadow := $store.i16($M.0.shadow,$p0.shadow,$i1.shadow);
  ...
  assert ($p3 == $p3.shadow);
  assert ($i8 == $i8.shadow);
  call $M.0, $M.0.shadow := $memset.i8($M.0, $M.0.shadow, $p3, $p3.shadow, 0, 0, $i8, $i8.shadow, false, false);
...
const br_i15_mulacc: ref;
axiom (br_i15_mulacc == $sub.ref(0,11352));
procedure {:inline 1} br_i15_mulacc($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.0, $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $i73.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 34, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 34, 10} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p1,$mul.ref(0,2));
  $p3.shadow := $add.ref($p1.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 34, 10} true;
  assume {:verifier.code 0} true;
  assert ($p3 == $p3.shadow);
  $i4 := $load.i16($M.0,$p3);
  $i4.shadow := $load.i16($M.0.shadow,$p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 34, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i16.i32($i4);
  $i5.shadow := $zext.i16.i32($i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 34, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i5,15);
  $i6.shadow := $add.i32($i5.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 34, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $ashr.i32($i6,4);
  $i7.shadow := $ashr.i32($i6.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 34, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i7);
  $i8.shadow := $sext.i32.i64($i7.shadow);
  call {:cexpr "alen"} boogie_si_record_i64($i8);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 35, 10} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p2,$mul.ref(0,2));
  $p9.shadow := $add.ref($p2.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 35, 10} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $i10 := $load.i16($M.0,$p9);
  $i10.shadow := $load.i16($M.0.shadow,$p9.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 35, 10} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i16.i32($i10);
  $i11.shadow := $zext.i16.i32($i10.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 35, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i11,15);
  $i12.shadow := $add.i32($i11.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 35, 21} true;
  assume {:verifier.code 0} true;
  $i13 := $ashr.i32($i12,4);
  $i13.shadow := $ashr.i32($i12.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $i14 := $sext.i32.i64($i13);
  $i14.shadow := $sext.i32.i64($i13.shadow);
  call {:cexpr "blen"} boogie_si_record_i64($i14);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 41, 8} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p1,$mul.ref(0,2));
  $p15.shadow := $add.ref($p1.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 41, 8} true;
  assume {:verifier.code 0} true;
  assert ($p15 == $p15.shadow);
  $i16 := $load.i16($M.0,$p15);
  $i16.shadow := $load.i16($M.0.shadow,$p15.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 41, 8} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i16.i32($i16);
  $i17.shadow := $zext.i16.i32($i16.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 41, 13} true;
  assume {:verifier.code 0} true;
  $i18 := $and.i32($i17,15);
  $i18.shadow := $and.i32($i17.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 41, 22} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($p2,$mul.ref(0,2));
  $p19.shadow := $add.ref($p2.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 41, 22} true;
  assume {:verifier.code 0} true;
  assert ($p19 == $p19.shadow);
  $i20 := $load.i16($M.0,$p19);
  $i20.shadow := $load.i16($M.0.shadow,$p19.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 41, 22} true;
  assume {:verifier.code 0} true;
  $i21 := $zext.i16.i32($i20);
  $i21.shadow := $zext.i16.i32($i20.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 41, 27} true;
  assume {:verifier.code 0} true;
  $i22 := $and.i32($i21,15);
  $i22.shadow := $and.i32($i21.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 41, 19} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i18,$i22);
  $i23.shadow := $add.i32($i18.shadow,$i22.shadow);
  call {:cexpr "dl"} boogie_si_record_i32($i23);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 42, 8} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p1,$mul.ref(0,2));
  $p24.shadow := $add.ref($p1.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 42, 8} true;
  assume {:verifier.code 0} true;
  assert ($p24 == $p24.shadow);
  $i25 := $load.i16($M.0,$p24);
  $i25.shadow := $load.i16($M.0.shadow,$p24.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 42, 8} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i16.i32($i25);
  $i26.shadow := $zext.i16.i32($i25.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 42, 13} true;
  assume {:verifier.code 0} true;
  $i27 := $ashr.i32($i26,4);
  $i27.shadow := $ashr.i32($i26.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 42, 22} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($p2,$mul.ref(0,2));
  $p28.shadow := $add.ref($p2.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 42, 22} true;
  assume {:verifier.code 0} true;
  assert ($p28 == $p28.shadow);
  $i29 := $load.i16($M.0,$p28);
  $i29.shadow := $load.i16($M.0.shadow,$p28.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 42, 22} true;
  assume {:verifier.code 0} true;
  $i30 := $zext.i16.i32($i29);
  $i30.shadow := $zext.i16.i32($i29.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 42, 27} true;
  assume {:verifier.code 0} true;
  $i31 := $ashr.i32($i30,4);
  $i31.shadow := $ashr.i32($i30.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 42, 19} true;
  assume {:verifier.code 0} true;
  $i32 := $add.i32($i27,$i31);
  $i32.shadow := $add.i32($i27.shadow,$i31.shadow);
  call {:cexpr "dh"} boogie_si_record_i32($i32);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 43, 13} true;
  assume {:verifier.code 0} true;
  $i33 := $shl.i32($i32,4);
  $i33.shadow := $shl.i32($i32.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 43, 19} true;
  assume {:verifier.code 0} true;
  $i34 := $add.i32($i33,$i23);
  $i34.shadow := $add.i32($i33.shadow,$i23.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 43, 42} true;
  assume {:verifier.code 0} true;
  $i35 := $sub.i32($i23,15);
  $i35.shadow := $sub.i32($i23.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 43, 27} true;
  assume {:verifier.code 0} true;
  $i36 := $xor.i32($i35,$sub.i32(0,1));
  $i36.shadow := $xor.i32($i35.shadow,$sub.i32(0,1));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 43, 48} true;
  assume {:verifier.code 0} true;
  $i37 := $lshr.i32($i36,31);
  $i37.shadow := $lshr.i32($i36.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 43, 24} true;
  assume {:verifier.code 0} true;
  $i38 := $add.i32($i34,$i37);
  $i38.shadow := $add.i32($i34.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 43, 9} true;
  assume {:verifier.code 0} true;
  $i39 := $trunc.i32.i16($i38);
  $i39.shadow := $trunc.i32.i16($i38.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 43, 2} true;
  assume {:verifier.code 0} true;
  $p40 := $add.ref($p0,$mul.ref(0,2));
  $p40.shadow := $add.ref($p0.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 43, 7} true;
  assume {:verifier.code 0} true;
  assert ($p40 == $p40.shadow);
  $M.0 := $store.i16($M.0,$p40,$i39);
  $M.0.shadow := $store.i16($M.0.shadow,$p40.shadow,$i39.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 45, 7} true;
  assume {:verifier.code 0} true;
  $i41 := 0;
  $i41.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assert {:shadow_invariant} ($i41 == $i41.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 45, 16} true;
  assume {:verifier.code 0} true;
  $i42 := $ult.i64($i41,$i14);
  $i42.shadow := $ult.i64($i41.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 45, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i42 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 50, 11} true;
  assume {:verifier.code 0} true;
  $i43 := $add.i64(1,$i41);
  $i43.shadow := $add.i64(1,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 50, 7} true;
  assume {:verifier.code 0} true;
  $p44 := $add.ref($p2,$mul.ref($i43,2));
  $p44.shadow := $add.ref($p2.shadow,$mul.ref($i43.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 50, 7} true;
  assume {:verifier.code 0} true;
  assert ($p44 == $p44.shadow);
  $i45 := $load.i16($M.0,$p44);
  $i45.shadow := $load.i16($M.0.shadow,$p44.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 50, 7} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i16.i32($i45);
  $i46.shadow := $zext.i16.i32($i45.shadow);
  call {:cexpr "f"} boogie_si_record_i32($i46);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 52, 8} true;
  assume {:verifier.code 0} true;
  $i47 := 0;
  $i47.shadow := 0;
  $i48 := 0;
...
$bb3:
  assume !($i42 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 61, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 52, 17} true;
  assume {:verifier.code 0} true;
  $i49 := $ult.i64($i47,$i8);
  $i49.shadow := $ult.i64($i47.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 52, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i49 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 55, 22} true;
  assume {:verifier.code 0} true;
  $i50 := $add.i64(1,$i41);
  $i50.shadow := $add.i64(1,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 55, 26} true;
  assume {:verifier.code 0} true;
  $i51 := $add.i64($i50,$i47);
  $i51.shadow := $add.i64($i50.shadow,$i47.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 55, 18} true;
  assume {:verifier.code 0} true;
  $p52 := $add.ref($p0,$mul.ref($i51,2));
  $p52.shadow := $add.ref($p0.shadow,$mul.ref($i51.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 55, 18} true;
  assume {:verifier.code 0} true;
  assert ($p52 == $p52.shadow);
  $i53 := $load.i16($M.0,$p52);
  $i53.shadow := $load.i16($M.0.shadow,$p52.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 55, 8} true;
  assume {:verifier.code 0} true;
  $i54 := $zext.i16.i32($i53);
  $i54.shadow := $zext.i16.i32($i53.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 55, 33} true;
  assume {:verifier.code 0} true;
  $i55 := $add.i64(1,$i47);
  $i55.shadow := $add.i64(1,$i47.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 55, 33} true;
  assume {:verifier.code 0} true;
  $p56 := $add.ref($p1,$mul.ref($i55,2));
  $p56.shadow := $add.ref($p1.shadow,$mul.ref($i55.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 55, 33} true;
  assume {:verifier.code 0} true;
  assert ($p56 == $p56.shadow);
  $i57 := $load.i16($M.0,$p56);
  ...
  $i58.shadow := $zext.i16.i32($i57.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 55, 33} true;
  assume {:verifier.code 0} true;
  $i59 := $mul.i32($i46,$i58);
  $i59.shadow := $mul.i32($i46.shadow,$i58.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 55, 31} true;
  assume {:verifier.code 0} true;
  $i60 := $add.i32($i54,$i59);
  $i60.shadow := $add.i32($i54.shadow,$i59.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 55, 52} true;
  assume {:verifier.code 0} true;
  $i61 := $add.i32($i60,$i48);
  $i61.shadow := $add.i32($i60.shadow,$i48.shadow);
  call {:cexpr "z"} boogie_si_record_i32($i61);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 56, 11} true;
  assume {:verifier.code 0} true;
  $i62 := $lshr.i32($i61,15);
  $i62.shadow := $lshr.i32($i61.shadow,15);
  call {:cexpr "cc"} boogie_si_record_i32($i62);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 57, 21} true;
  assume {:verifier.code 0} true;
  $i63 := $and.i32($i61,32767);
  $i63.shadow := $and.i32($i61.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 57, 19} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i32.i16($i63);
  $i64.shadow := $trunc.i32.i16($i63.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 57, 8} true;
  assume {:verifier.code 0} true;
  $i65 := $add.i64(1,$i41);
  $i65.shadow := $add.i64(1,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 57, 12} true;
  assume {:verifier.code 0} true;
  $i66 := $add.i64($i65,$i47);
  $i66.shadow := $add.i64($i65.shadow,$i47.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 57, 4} true;
  assume {:verifier.code 0} true;
  $p67 := $add.ref($p0,$mul.ref($i66,2));
  $p67.shadow := $add.ref($p0.shadow,$mul.ref($i66.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 57, 17} true;
  assume {:verifier.code 0} true;
  assert ($p67 == $p67.shadow);
  $M.0 := $store.i16($M.0,$p67,$i64);
  $M.0.shadow := $store.i16($M.0.shadow,$p67.shadow,$i64.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 58, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !($i49 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 59, 21} true;
  assume {:verifier.code 0} true;
  $i69 := $trunc.i32.i16($i48);
  $i69.shadow := $trunc.i32.i16($i48.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 59, 7} true;
  assume {:verifier.code 0} true;
  $i70 := $add.i64(1,$i41);
  $i70.shadow := $add.i64(1,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 59, 11} true;
  assume {:verifier.code 0} true;
  $i71 := $add.i64($i70,$i8);
  $i71.shadow := $add.i64($i70.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 59, 3} true;
  assume {:verifier.code 0} true;
  $p72 := $add.ref($p0,$mul.ref($i71,2));
  $p72.shadow := $add.ref($p0.shadow,$mul.ref($i71.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 59, 19} true;
  assume {:verifier.code 0} true;
  assert ($p72 == $p72.shadow);
  $M.0 := $store.i16($M.0,$p72,$i69);
  $M.0.shadow := $store.i16($M.0.shadow,$p72.shadow,$i69.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 60, 2} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 52, 27} true;
  assume {:verifier.code 0} true;
  $i68 := $add.i64($i47,1);
  $i68.shadow := $add.i64($i47.shadow,1);
  call {:cexpr "v"} boogie_si_record_i64($i68);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 52, 3} true;
  assume {:verifier.code 0} true;
  $i47 := $i68;
  $i47.shadow := $i68.shadow;
  $i48 := $i62;
  $i48.shadow := $i62.shadow;
  goto $bb4;
$bb8:
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 45, 26} true;
  assume {:verifier.code 0} true;
  $i73 := $add.i64($i41,1);
  $i73.shadow := $add.i64($i41.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i73);
  assume {:sourceloc "../BearSSL/src/int/i15_mulacc.c", 45, 2} true;
  assume {:verifier.code 0} true;
  $i41 := $i73;
  $i41.shadow := $i73.shadow;
  goto $bb1;
}
const br_i15_encode: ref;
axiom (br_i15_encode == $sub.ref(0,12384));
...
$bb9:
  ...
  $M.0.shadow := $store.i8($M.0.shadow,$p31.shadow,$i30.shadow);
...
axiom (llvm.memmove.p0i8.p0i8.i64 == $sub.ref(0,13416));
...
const br_i15_ninv15: ref;
axiom (br_i15_ninv15 == $sub.ref(0,14448));
procedure {:inline 1} br_i15_ninv15($i0: i16, $i0.shadow: i16) returns ($r: i16, $r.shadow: i16)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i20.shadow: i16;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 33, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_ninv15:arg:x"} boogie_si_record_i16($i0);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 33, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i16.i32($i0);
  $i1.shadow := $zext.i16.i32($i0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 33, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(2,$i1);
  $i2.shadow := $sub.i32(2,$i1.shadow);
  call {:cexpr "y"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 34, 6} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i16.i32($i0);
  $i3.shadow := $zext.i16.i32($i0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 34, 6} true;
  assume {:verifier.code 0} true;
  $i4 := $mul.i32($i3,$i2);
  $i4.shadow := $mul.i32($i3.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 34, 6} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32(2,$i4);
  $i5.shadow := $sub.i32(2,$i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 34, 6} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i32($i2,$i5);
  $i6.shadow := $mul.i32($i2.shadow,$i5.shadow);
  call {:cexpr "y"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 35, 6} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i16.i32($i0);
  $i7.shadow := $zext.i16.i32($i0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 35, 6} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32($i7,$i6);
  $i8.shadow := $mul.i32($i7.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 35, 6} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.i32(2,$i8);
  ...
  assume {:verifier.code 0} true;
  $i10 := $mul.i32($i6,$i9);
  $i10.shadow := $mul.i32($i6.shadow,$i9.shadow);
  call {:cexpr "y"} boogie_si_record_i32($i10);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 36, 6} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i16.i32($i0);
  $i11.shadow := $zext.i16.i32($i0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 36, 6} true;
  assume {:verifier.code 0} true;
  $i12 := $mul.i32($i11,$i10);
  $i12.shadow := $mul.i32($i11.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 36, 6} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i32(2,$i12);
  $i13.shadow := $sub.i32(2,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 36, 6} true;
  assume {:verifier.code 0} true;
  $i14 := $mul.i32($i10,$i13);
  $i14.shadow := $mul.i32($i10.shadow,$i13.shadow);
  call {:cexpr "y"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 37, 13} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i16.i32($i0);
  $i15.shadow := $zext.i16.i32($i0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 37, 15} true;
  assume {:verifier.code 0} true;
  $i16 := $and.i32($i15,1);
  $i16.shadow := $and.i32($i15.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 37, 20} true;
  assume {:verifier.code 0} true;
  $i17 := $sub.i32(0,$i14);
  $i17.shadow := $sub.i32(0,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 37, 9} true;
  assume {:verifier.code 0} true;
  call $i18, $i18.shadow := MUX.19($i16, $i16.shadow, $i17, $i17.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 37, 27} true;
  assume {:verifier.code 0} true;
  $i19 := $and.i32($i18,32767);
  $i19.shadow := $and.i32($i18.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 37, 9} true;
  assume {:verifier.code 0} true;
  $i20 := $trunc.i32.i16($i19);
  $i20.shadow := $trunc.i32.i16($i19.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_ninv15.c", 37, 2} true;
  assume {:verifier.code 0} true;
  $r := $i20;
  $r.shadow := $i20.shadow;
  $exn := false;
...
const br_i15_decode_reduce: ref;
axiom (br_i15_decode_reduce == $sub.ref(0,15480));
procedure {:inline 1} br_i15_decode_reduce($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64, $p3: ref, $p3.shadow: ref)
modifies $M.0, $exn;
modifies $M.13;
modifies $CurrAddr;
{
  ...
  var $i53.shadow: i16;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 41, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_decode_reduce:arg:len"} boogie_si_record_i64($i2);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 41, 14} true;
  assume {:verifier.code 0} true;
  ...
  assert ($p4 == $p4.shadow);
  $i5 := $load.i16($M.0,$p4);
  $i5.shadow := $load.i16($M.0.shadow,$p4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 41, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i16.i32($i5);
  $i6.shadow := $zext.i16.i32($i5.shadow);
  call {:cexpr "m_ebitlen"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 46, 16} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6,0);
  $i7.shadow := $eq.i32($i6.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 46, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i7 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 47, 3} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p0,$mul.ref(0,2));
  $p8.shadow := $add.ref($p0.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 47, 8} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $M.0 := $store.i16($M.0,$p8,0);
  $M.0.shadow := $store.i16($M.0.shadow,$p8.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 48, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !($i7 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 54, 17} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i32.i16($i6);
  $i9.shadow := $trunc.i32.i16($i6.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 54, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_zero($p0, $p0.shadow, $i9, $i9.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 60, 24} true;
  assume {:verifier.code 0} true;
  $i10 := $lshr.i32($i6,4);
  $i10.shadow := $lshr.i32($i6.shadow,4);
  call {:cexpr "m_rbitlen"} boogie_si_record_i32($i10);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 61, 25} true;
  assume {:verifier.code 0} true;
  $i11 := $and.i32($i6,15);
  $i11.shadow := $and.i32($i6.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 61, 44} true;
  assume {:verifier.code 0} true;
  $i12 := $shl.i32($i10,4);
  $i12.shadow := $shl.i32($i10.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 61, 31} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i11,$i12);
  $i13.shadow := $add.i32($i11.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 61, 50} true;
  assume {:verifier.code 0} true;
  $i14 := $sub.i32($i13,$i10);
  $i14.shadow := $sub.i32($i13.shadow,$i10.shadow);
  call {:cexpr "m_rbitlen"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 62, 21} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i14,7);
  $i15.shadow := $add.i32($i14.shadow,7);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 62, 26} true;
  assume {:verifier.code 0} true;
  $i16 := $lshr.i32($i15,3);
  $i16.shadow := $lshr.i32($i15.shadow,3);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 62, 10} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i32.i64($i16);
  $i17.shadow := $zext.i32.i64($i16.shadow);
  call {:cexpr "mblen"} boogie_si_record_i64($i17);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 63, 12} true;
  assume {:verifier.code 0} true;
  $i18 := $sub.i64($i17,1);
  $i18.shadow := $sub.i64($i17.shadow,1);
  call {:cexpr "k"} boogie_si_record_i64($i18);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 64, 8} true;
  assume {:verifier.code 0} true;
  $i19 := $uge.i64($i18,$i2);
  $i19.shadow := $uge.i64($i18.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 64, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  assert ($i19 == $i19.shadow);
  goto $bb4, $bb5;
$bb3:
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 100, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume ($i19 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 65, 3} true;
  assume {:verifier.code 0} true;
  call br_i15_decode($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 66, 10} true;
  assume {:verifier.code 0} true;
  $i20 := $trunc.i32.i16($i6);
  $i20.shadow := $trunc.i32.i16($i6.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 66, 3} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p0,$mul.ref(0,2));
  $p21.shadow := $add.ref($p0.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 66, 8} true;
  assume {:verifier.code 0} true;
  assert ($p21 == $p21.shadow);
  $M.0 := $store.i16($M.0,$p21,$i20);
  $M.0.shadow := $store.i16($M.0.shadow,$p21.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 67, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb5:
  assume !($i19 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 70, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_decode($p0, $p0.shadow, $p1, $p1.shadow, $i18, $i18.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 71, 9} true;
  assume {:verifier.code 0} true;
  $i22 := $trunc.i32.i16($i6);
  $i22.shadow := $trunc.i32.i16($i6.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 71, 2} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p0,$mul.ref(0,2));
  $p23.shadow := $add.ref($p0.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 71, 7} true;
  assume {:verifier.code 0} true;
  assert ($p23 == $p23.shadow);
  $M.0 := $store.i16($M.0,$p23,$i22);
  $M.0.shadow := $store.i16($M.0.shadow,$p23.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 78, 2} true;
  assume {:verifier.code 0} true;
  $i24 := $i18;
...
$bb6:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 78, 11} true;
  assume {:verifier.code 0} true;
  $i27 := $ult.i64($i24,$i2);
  $i27.shadow := $ult.i64($i24.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 78, 2} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i27 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 81, 13} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i64($i24,1);
  $i28.shadow := $add.i64($i24.shadow,1);
  call {:cexpr "k"} boogie_si_record_i64($i28);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 81, 7} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p1,$mul.ref($i24,1));
  $p29.shadow := $add.ref($p1.shadow,$mul.ref($i24.shadow,1));
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 81, 7} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $i30 := $load.i8($M.0,$p29);
  ...
  call {:cexpr "v"} boogie_si_record_i32($i31);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 82, 14} true;
  assume {:verifier.code 0} true;
  $i32 := $shl.i32($i25,8);
  $i32.shadow := $shl.i32($i25.shadow,8);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 82, 20} true;
  assume {:verifier.code 0} true;
  $i33 := $or.i32($i32,$i31);
  $i33.shadow := $or.i32($i32.shadow,$i31.shadow);
  call {:cexpr "acc"} boogie_si_record_i32($i33);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 83, 11} true;
  assume {:verifier.code 0} true;
  $i34 := $add.i32($i26,8);
  $i34.shadow := $add.i32($i26.shadow,8);
  call {:cexpr "acc_len"} boogie_si_record_i32($i34);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 84, 15} true;
  assume {:verifier.code 0} true;
  $i35 := $sge.i32($i34,15);
  $i35.shadow := $sge.i32($i34.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 84, 7} true;
  assume {:verifier.code 0} true;
  $i36 := $i33;
  $i36.shadow := $i33.shadow;
  $i37 := $i34;
  $i37.shadow := $i34.shadow;
  assume {:branchcond $i35} true;
  assert ($i35 == $i35.shadow);
  goto $bb9, $bb10;
$bb8:
  assume !($i27 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 95, 14} true;
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i26,0);
  $i45.shadow := $ne.i32($i26.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 95, 6} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume ($i35 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 85, 43} true;
  assume {:verifier.code 0} true;
  $i38 := $sub.i32($i34,15);
  $i38.shadow := $sub.i32($i34.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 85, 31} true;
  assume {:verifier.code 0} true;
  $i39 := $lshr.i32($i33,$i38);
  $i39.shadow := $lshr.i32($i33.shadow,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 85, 27} true;
  assume {:verifier.code 0} true;
  $i40 := $trunc.i32.i16($i39);
  $i40.shadow := $trunc.i32.i16($i39.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 85, 4} true;
  assume {:verifier.code 0} true;
  call br_i15_muladd_small($p0, $p0.shadow, $i40, $i40.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 86, 12} true;
  assume {:verifier.code 0} true;
  $i41 := $sub.i32($i34,15);
  $i41.shadow := $sub.i32($i34.shadow,15);
  call {:cexpr "acc_len"} boogie_si_record_i32($i41);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 87, 26} true;
  assume {:verifier.code 0} true;
  $i42 := $shl.i32($sub.i32(0,1),$i41);
  $i42.shadow := $shl.i32($sub.i32(0,1),$i41.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 87, 11} true;
  assume {:verifier.code 0} true;
  $i43 := $xor.i32($i42,$sub.i32(0,1));
  $i43.shadow := $xor.i32($i42.shadow,$sub.i32(0,1));
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 87, 8} true;
  assume {:verifier.code 0} true;
  $i44 := $and.i32($i33,$i43);
  $i44.shadow := $and.i32($i33.shadow,$i43.shadow);
  call {:cexpr "acc"} boogie_si_record_i32($i44);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 88, 3} true;
  assume {:verifier.code 0} true;
  $i36 := $i44;
  $i36.shadow := $i44.shadow;
  $i37 := $i41;
...
$bb11:
  ...
  assume {:verifier.code 0} true;
  $i24 := $i28;
  $i24.shadow := $i28.shadow;
  $i25 := $i36;
  $i25.shadow := $i36.shadow;
  $i26 := $i37;
  $i26.shadow := $i37.shadow;
  goto $bb6;
$bb12:
  assume ($i45 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 96, 17} true;
  assume {:verifier.code 0} true;
  $p46 := $add.ref($p0,$mul.ref(1,2));
  $p46.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 96, 17} true;
  assume {:verifier.code 0} true;
  assert ($p46 == $p46.shadow);
  $i47 := $load.i16($M.0,$p46);
  $i47.shadow := $load.i16($M.0.shadow,$p46.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 96, 17} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i16.i32($i47);
  $i48.shadow := $zext.i16.i32($i47.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 96, 22} true;
  assume {:verifier.code 0} true;
  $i49 := $shl.i32($i48,$i26);
  $i49.shadow := $shl.i32($i48.shadow,$i26.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 96, 14} true;
  assume {:verifier.code 0} true;
  $i50 := $or.i32($i25,$i49);
  $i50.shadow := $or.i32($i25.shadow,$i49.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 96, 35} true;
  assume {:verifier.code 0} true;
  $i51 := $and.i32($i50,32767);
  $i51.shadow := $and.i32($i50.shadow,32767);
  call {:cexpr "acc"} boogie_si_record_i32($i51);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 97, 23} true;
  assume {:verifier.code 0} true;
  $i52 := $sub.i32(15,$i26);
  $i52.shadow := $sub.i32(15,$i26.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 97, 3} true;
  assume {:verifier.code 0} true;
  call br_i15_rshift($p0, $p0.shadow, $i52, $i52.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 98, 26} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i32.i16($i51);
  $i53.shadow := $trunc.i32.i16($i51.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 98, 3} true;
  assume {:verifier.code 0} true;
  call br_i15_muladd_small($p0, $p0.shadow, $i53, $i53.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 99, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb13:
  assume {:sourceloc "../BearSSL/src/int/i15_decred.c", 95, 6} true;
...
const br_i15_modpow_opt: ref;
axiom (br_i15_modpow_opt == $sub.ref(0,16512));
procedure {:inline 1} br_i15_modpow_opt($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64, $p3: ref, $p3.shadow: ref, $i4: i16, $i4.shadow: i16, $p5: ref, $p5.shadow: ref, $i6: i64, $i6.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $exn, $M.0;
modifies $M.13;
modifies $CurrAddr;
{
  ...
  var $i19.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 42, 11} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_modpow_opt:arg:elen"} boogie_si_record_i64($i2);
  call {:cexpr "br_i15_modpow_opt:arg:m0i"} boogie_si_record_i16($i4);
  call {:cexpr "br_i15_modpow_opt:arg:twlen"} boogie_si_record_i64($i6);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 42, 11} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p3,$mul.ref(0,2));
  $p7.shadow := $add.ref($p3.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 42, 11} true;
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $i8 := $load.i16($M.0,$p7);
  $i8.shadow := $load.i16($M.0.shadow,$p7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 42, 11} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i16.i32($i8);
  $i9.shadow := $zext.i16.i32($i8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 42, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i9,31);
  $i10.shadow := $add.i32($i9.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 42, 22} true;
  assume {:verifier.code 0} true;
  $i11 := $ashr.i32($i10,4);
  $i11.shadow := $ashr.i32($i10.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 42, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $sext.i32.i64($i11);
  $i12.shadow := $sext.i32.i64($i11.shadow);
  call {:cexpr "mwlen"} boogie_si_record_i64($i12);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 43, 15} true;
  assume {:verifier.code 0} true;
  $i13 := $mul.i64($i12,2);
  $i13.shadow := $mul.i64($i12.shadow,2);
  call {:cexpr "mlen"} boogie_si_record_i64($i13);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 44, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $and.i64($i12,1);
  $i14.shadow := $and.i64($i12.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 44, 8} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i64($i12,$i14);
  $i15.shadow := $add.i64($i12.shadow,$i14.shadow);
  call {:cexpr "mwlen"} boogie_si_record_i64($i15);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 46, 11} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p5,$mul.ref($i15,2));
  $p16.shadow := $add.ref($p5.shadow,$mul.ref($i15.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 54, 21} true;
  assume {:verifier.code 0} true;
  $i17 := $shl.i64($i15,1);
  $i17.shadow := $shl.i64($i15.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 54, 12} true;
  assume {:verifier.code 0} true;
  $i18 := $ult.i64($i6,$i17);
  $i18.shadow := $ult.i64($i6.shadow,$i17.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 54, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i18 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 55, 3} true;
  assume {:verifier.code 0} true;
  $i19 := 0;
  $i19.shadow := 0;
  goto $bb3;
$bb2:
  assume !($i18 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 57, 7} true;
  assume {:verifier.code 0} true;
  $i20 := 5;
  $i20.shadow := 5;
  goto $bb4;
$bb3:
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 160, 1} true;
  assume {:verifier.code 0} true;
  $r := $i19;
  $r.shadow := $i19.shadow;
  $exn := false;
...
$bb4:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 57, 28} true;
  assume {:verifier.code 0} true;
  $i21 := $sgt.i32($i20,1);
  $i21.shadow := $sgt.i32($i20.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 57, 2} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i21 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 58, 21} true;
  assume {:verifier.code 0} true;
  $i22 := $shl.i32(1,$i20);
  $i22.shadow := $shl.i32(1,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 58, 33} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i22,1);
  $i23.shadow := $add.i32($i22.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 58, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i32.i64($i23);
  $i24.shadow := $zext.i32.i64($i23.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 58, 38} true;
  assume {:verifier.code 0} true;
  $i25 := $mul.i64($i24,$i15);
  $i25.shadow := $mul.i64($i24.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 58, 46} true;
  assume {:verifier.code 0} true;
  $i26 := $ule.i64($i25,$i6);
  $i26.shadow := $ule.i64($i25.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 58, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 66, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_to_monty($p0, $p0.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 73, 14} true;
  assume {:verifier.code 0} true;
  $i28 := $eq.i32($i20,1);
  $i28.shadow := $eq.i32($i20.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 73, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i28} true;
  assert ($i28 == $i28.shadow);
  goto $bb11, $bb12;
$bb8:
  assume ($i26 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 59, 4} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb9:
  assume !($i26 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 61, 2} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 57, 41} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i20,$sub.i32(0,1));
  $i27.shadow := $add.i32($i20.shadow,$sub.i32(0,1));
  call {:cexpr "win_len"} boogie_si_record_i32($i27);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 57, 2} true;
  assume {:verifier.code 0} true;
  $i20 := $i27;
  $i20.shadow := $i27.shadow;
  goto $bb4;
$bb11:
  assume ($i28 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 74, 3} true;
  assume {:verifier.code 0} true;
  $p29 := $bitcast.ref.ref($p16);
  $p29.shadow := $bitcast.ref.ref($p16.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 74, 3} true;
  assume {:verifier.code 0} true;
  $p30 := $bitcast.ref.ref($p0);
  $p30.shadow := $bitcast.ref.ref($p0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 74, 3} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  assert ($p30 == $p30.shadow);
  assert ($i13 == $i13.shadow);
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.0, $M.0.shadow, $p29, $p29.shadow, $p30, $p30.shadow, $i13, $i13.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 75, 2} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume !($i28 == 1);
  $i31 := $add.i64($i15,$i15);
  $i31.shadow := $add.i64($i15.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 76, 13} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($p5,$mul.ref($i31,2));
  $p32.shadow := $add.ref($p5.shadow,$mul.ref($i31.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 76, 3} true;
  assume {:verifier.code 0} true;
  $p33 := $bitcast.ref.ref($p32);
  $p33.shadow := $bitcast.ref.ref($p32.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 76, 3} true;
  assume {:verifier.code 0} true;
  $p34 := $bitcast.ref.ref($p0);
  $p34.shadow := $bitcast.ref.ref($p0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 76, 3} true;
  assume {:verifier.code 0} true;
  assert ($p33 == $p33.shadow);
  assert ($p34 == $p34.shadow);
  assert ($i13 == $i13.shadow);
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.0, $M.0.shadow, $p33, $p33.shadow, $p34, $p34.shadow, $i13, $i13.shadow, false, false);
  $i35 := $add.i64($i15,$i15);
  $i35.shadow := $add.i64($i15.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 77, 13} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($p5,$mul.ref($i35,2));
  $p36.shadow := $add.ref($p5.shadow,$mul.ref($i35.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 78, 8} true;
  assume {:verifier.code 0} true;
  $p37 := $p36;
  $p37.shadow := $p36.shadow;
  $i38 := 2;
  $i38.shadow := 2;
  goto $bb14;
$bb13:
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 89, 17} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($p3,$mul.ref(0,2));
  $p45.shadow := $add.ref($p3.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 89, 17} true;
  assume {:verifier.code 0} true;
  assert ($p45 == $p45.shadow);
  $i46 := $load.i16($M.0,$p45);
  $i46.shadow := $load.i16($M.0.shadow,$p45.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 89, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_zero.4($p0, $p0.shadow, $i46, $i46.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 90, 5} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($p3,$mul.ref(0,2));
  $p47.shadow := $add.ref($p3.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 90, 5} true;
  assume {:verifier.code 0} true;
  assert ($p47 == $p47.shadow);
  $i48 := $load.i16($M.0,$p47);
  $i48.shadow := $load.i16($M.0.shadow,$p47.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 90, 5} true;
  assume {:verifier.code 0} true;
  $i49 := $zext.i16.i32($i48);
  $i49.shadow := $zext.i16.i32($i48.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 90, 10} true;
  assume {:verifier.code 0} true;
  $i50 := $add.i32($i49,15);
  $i50.shadow := $add.i32($i49.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 90, 16} true;
  assume {:verifier.code 0} true;
  $i51 := $ashr.i32($i50,4);
  $i51.shadow := $ashr.i32($i50.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 90, 2} true;
  assume {:verifier.code 0} true;
  $i52 := $sext.i32.i64($i51);
  $i52.shadow := $sext.i32.i64($i51.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 90, 2} true;
  assume {:verifier.code 0} true;
  $p53 := $add.ref($p0,$mul.ref($i52,2));
  $p53.shadow := $add.ref($p0.shadow,$mul.ref($i52.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 90, 22} true;
  assume {:verifier.code 0} true;
  assert ($p53 == $p53.shadow);
  $M.0 := $store.i16($M.0,$p53,1);
  $M.0.shadow := $store.i16($M.0.shadow,$p53.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 91, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_muladd_small($p0, $p0.shadow, 0, 0, $p3, $p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 99, 2} true;
  assume {:verifier.code 0} true;
  $i54 := 0;
  $i54.shadow := 0;
  $i55 := 0;
  $i55.shadow := 0;
  $i56 := $i2;
  $i56.shadow := $i2.shadow;
  $p57 := $p1;
  $p57.shadow := $p1.shadow;
  goto $bb18;
$bb14:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i38 == $i38.shadow);
  ...
  assert {:shadow_invariant} ($i20 == $i20.shadow);
  assert {:shadow_invariant} ($i15 == $i15.shadow);
  assert {:likely_shadow_invariant} ($p37 == $p37.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 78, 32} true;
  assume {:verifier.code 0} true;
  $i39 := $shl.i32(1,$i20);
  $i39.shadow := $shl.i32(1,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 78, 19} true;
  assume {:verifier.code 0} true;
  $i40 := $zext.i32.i64($i39);
  $i40.shadow := $zext.i32.i64($i39.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 78, 17} true;
  assume {:verifier.code 0} true;
  $i41 := $ult.i64($i38,$i40);
  $i41.shadow := $ult.i64($i38.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 78, 3} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume ($i41 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 79, 25} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($p37,$mul.ref($i15,2));
  $p42.shadow := $add.ref($p37.shadow,$mul.ref($i15.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 79, 4} true;
  assume {:verifier.code 0} true;
  call br_i15_montymul($p42, $p42.shadow, $p37, $p37.shadow, $p0, $p0.shadow, $p3, $p3.shadow, $i4, $i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 80, 9} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($p37,$mul.ref($i15,2));
  $p43.shadow := $add.ref($p37.shadow,$mul.ref($i15.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 81, 3} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb16:
  assume !($i41 == 1);
  ...
  goto $bb13;
$bb17:
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 78, 47} true;
  assume {:verifier.code 0} true;
  $i44 := $add.i64($i38,1);
  $i44.shadow := $add.i64($i38.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i44);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 78, 3} true;
  assume {:verifier.code 0} true;
  $p37 := $p43;
  $p37.shadow := $p43.shadow;
  $i38 := $i44;
  $i38.shadow := $i44.shadow;
  goto $bb14;
$bb18:
  assert {:shadow_invariant} $shadow_ok;
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 99, 17} true;
  assume {:verifier.code 0} true;
  $i58 := $sgt.i32($i55,0);
  $i58.shadow := $sgt.i32($i55.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 99, 21} true;
  assume {:verifier.code 0} true;
  $i59 := 1;
  $i59.shadow := 1;
...
$bb21:
  assume !($i58 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 99, 29} true;
  assume {:verifier.code 0} true;
  $i60 := $ugt.i64($i56,0);
  $i60.shadow := $ugt.i64($i56.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 99, 21} true;
  assume {:verifier.code 0} true;
  $i59 := $i60;
  $i59.shadow := $i60.shadow;
  goto $bb20;
$bb22:
  assume ($i59 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 107, 15} true;
  assume {:verifier.code 0} true;
  $i61 := $slt.i32($i55,$i20);
  $i61.shadow := $slt.i32($i55.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 107, 7} true;
  assume {:verifier.code 0} true;
  $i62 := $i54;
  $i62.shadow := $i54.shadow;
  $i63 := $i55;
  $i63.shadow := $i55.shadow;
  $i64 := $i56;
  $i64.shadow := $i56.shadow;
  $p65 := $p57;
  $p65.shadow := $p57.shadow;
  $i66 := $i20;
  $i66.shadow := $i20.shadow;
  assume {:branchcond $i61} true;
  assert ($i61 == $i61.shadow);
  goto $bb24, $bb25;
$bb23:
  assume !($i59 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 158, 2} true;
  assume {:verifier.code 0} true;
  call br_i15_from_monty($p0, $p0.shadow, $p3, $p3.shadow, $i4, $i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 159, 2} true;
  assume {:verifier.code 0} true;
  $i19 := 1;
  $i19.shadow := 1;
  goto $bb3;
$bb24:
  assume ($i61 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 108, 13} true;
  assume {:verifier.code 0} true;
  $i67 := $ugt.i64($i56,0);
  $i67.shadow := $ugt.i64($i56.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 108, 8} true;
  assume {:verifier.code 0} true;
...
$bb26:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 106, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 116, 27} true;
  assume {:verifier.code 0} true;
  $i80 := $sub.i32($i63,$i66);
  $i80.shadow := $sub.i32($i63.shadow,$i66.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 116, 15} true;
  assume {:verifier.code 0} true;
  $i81 := $lshr.i32($i62,$i80);
  $i81.shadow := $lshr.i32($i62.shadow,$i80.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 116, 49} true;
  assume {:verifier.code 0} true;
  $i82 := $shl.i32(1,$i66);
  $i82.shadow := $shl.i32(1,$i66.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 116, 55} true;
  assume {:verifier.code 0} true;
  $i83 := $sub.i32($i82,1);
  $i83.shadow := $sub.i32($i82.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 116, 33} true;
  assume {:verifier.code 0} true;
  $i84 := $and.i32($i81,$i83);
  $i84.shadow := $and.i32($i81.shadow,$i83.shadow);
  call {:cexpr "bits"} boogie_si_record_i32($i84);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 117, 11} true;
  assume {:verifier.code 0} true;
  $i85 := $sub.i32($i63,$i66);
  $i85.shadow := $sub.i32($i63.shadow,$i66.shadow);
  call {:cexpr "acc_len"} boogie_si_record_i32($i85);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 122, 8} true;
  assume {:verifier.code 0} true;
  $i86 := 0;
  $i86.shadow := 0;
  goto $bb30;
$bb27:
  assume ($i67 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 109, 16} true;
  assume {:verifier.code 0} true;
  $i68 := $shl.i32($i54,8);
  $i68.shadow := $shl.i32($i54.shadow,8);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 109, 27} true;
  assume {:verifier.code 0} true;
  $p69 := $add.ref($p57,$mul.ref(1,1));
  $p69.shadow := $add.ref($p57.shadow,$mul.ref(1,1));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 109, 24} true;
  assume {:verifier.code 0} true;
  assert ($p57 == $p57.shadow);
  $i70 := $load.i8($M.12,$p57);
  $i70.shadow := $load.i8($M.12.shadow,$p57.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 109, 24} true;
  assume {:verifier.code 0} true;
  $i71 := $zext.i8.i32($i70);
  $i71.shadow := $zext.i8.i32($i70.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 109, 22} true;
  assume {:verifier.code 0} true;
  $i72 := $or.i32($i68,$i71);
  $i72.shadow := $or.i32($i68.shadow,$i71.shadow);
  call {:cexpr "acc"} boogie_si_record_i32($i72);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 110, 10} true;
  assume {:verifier.code 0} true;
  $i73 := $add.i64($i56,$sub.i64(0,1));
  $i73.shadow := $add.i64($i56.shadow,$sub.i64(0,1));
  call {:cexpr "elen"} boogie_si_record_i64($i73);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 111, 13} true;
  assume {:verifier.code 0} true;
  $i74 := $add.i32($i55,8);
  $i74.shadow := $add.i32($i55.shadow,8);
  call {:cexpr "acc_len"} boogie_si_record_i32($i74);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 112, 4} true;
  assume {:verifier.code 0} true;
  $i75 := $i72;
  $i75.shadow := $i72.shadow;
  $i76 := $i74;
  $i76.shadow := $i74.shadow;
  $i77 := $i73;
  $i77.shadow := $i73.shadow;
  $p78 := $p69;
  $p78.shadow := $p69.shadow;
  $i79 := $i20;
  $i79.shadow := $i20.shadow;
  goto $bb29;
$bb28:
  assume !($i67 == 1);
  assume {:verifier.code 0} true;
  $i75 := $i54;
  $i75.shadow := $i54.shadow;
  $i76 := $i55;
  $i76.shadow := $i55.shadow;
  $i77 := $i56;
  $i77.shadow := $i56.shadow;
  $p78 := $p57;
  $p78.shadow := $p57.shadow;
  $i79 := $i55;
  $i79.shadow := $i55.shadow;
  goto $bb29;
$bb29:
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 115, 3} true;
  assume {:verifier.code 0} true;
  $i62 := $i75;
  $i62.shadow := $i75.shadow;
  $i63 := $i76;
  $i63.shadow := $i76.shadow;
  $i64 := $i77;
  $i64.shadow := $i77.shadow;
  $p65 := $p78;
  $p65.shadow := $p78.shadow;
  $i66 := $i79;
  $i66.shadow := $i79.shadow;
  goto $bb26;
$bb30:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i86 == $i86.shadow);
  assert {:shadow_invariant} ($p65 == $p65.shadow);
  assert {:shadow_invariant} ($i64 == $i64.shadow);
  assert {:shadow_invariant} ($i66 == $i66.shadow);
  assert {:shadow_invariant} ($i85 == $i85.shadow);
  assert {:shadow_invariant} ($i13 == $i13.shadow);
  assert {:shadow_invariant} ($p16 == $p16.shadow);
  assert {:shadow_invariant} ($i20 == $i20.shadow);
  assert {:shadow_invariant} ($i15 == $i15.shadow);
  assert {:unlikely_shadow_invariant ($i62 == $i62.shadow)} true;
  assert {:unlikely_shadow_invariant ($i84 == $i84.shadow)} true;
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 122, 17} true;
  assume {:verifier.code 0} true;
  $i87 := $slt.i32($i86,$i66);
  $i87.shadow := $slt.i32($i86.shadow,$i66.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 122, 3} true;
  assume {:verifier.code 0} true;
...
$bb31:
  assume ($i87 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 123, 4} true;
  assume {:verifier.code 0} true;
  call br_i15_montymul($p5, $p5.shadow, $p0, $p0.shadow, $p0, $p0.shadow, $p3, $p3.shadow, $i4, $i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 124, 4} true;
  assume {:verifier.code 0} true;
  $p88 := $bitcast.ref.ref($p0);
  $p88.shadow := $bitcast.ref.ref($p0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 124, 4} true;
  assume {:verifier.code 0} true;
  $p89 := $bitcast.ref.ref($p5);
  $p89.shadow := $bitcast.ref.ref($p5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 124, 4} true;
  assume {:verifier.code 0} true;
  assert ($p88 == $p88.shadow);
  assert ($p89 == $p89.shadow);
  assert ($i13 == $i13.shadow);
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.0, $M.0.shadow, $p88, $p88.shadow, $p89, $p89.shadow, $i13, $i13.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 125, 3} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb32:
  assume !($i87 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 133, 15} true;
  assume {:verifier.code 0} true;
  $i91 := $sgt.i32($i20,1);
  $i91.shadow := $sgt.i32($i20.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 133, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i91} true;
  assert ($i91 == $i91.shadow);
  goto $bb34, $bb35;
$bb33:
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 122, 24} true;
  assume {:verifier.code 0} true;
  $i90 := $add.i32($i86,1);
  $i90.shadow := $add.i32($i86.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i90);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 122, 3} true;
  assume {:verifier.code 0} true;
  $i86 := $i90;
  $i86.shadow := $i90.shadow;
  goto $bb30;
$bb34:
  assume ($i91 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 134, 20} true;
  assume {:verifier.code 0} true;
  $p92 := $add.ref($p3,$mul.ref(0,2));
  $p92.shadow := $add.ref($p3.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 134, 20} true;
  assume {:verifier.code 0} true;
  assert ($p92 == $p92.shadow);
  $i93 := $load.i16($M.0,$p92);
  $i93.shadow := $load.i16($M.0.shadow,$p92.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 134, 4} true;
  assume {:verifier.code 0} true;
  call br_i15_zero.4($p16, $p16.shadow, $i93, $i93.shadow);
  $i94 := $add.i64($i15,$i15);
  $i94.shadow := $add.i64($i15.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 135, 14} true;
  assume {:verifier.code 0} true;
  $p95 := $add.ref($p5,$mul.ref($i94,2));
  $p95.shadow := $add.ref($p5.shadow,$mul.ref($i94.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 136, 9} true;
  assume {:verifier.code 0} true;
  $p96 := $p95;
  $p96.shadow := $p95.shadow;
  $i97 := 1;
  $i97.shadow := 1;
  goto $bb37;
$bb35:
  ...
  goto $bb36;
$bb36:
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 151, 3} true;
  assume {:verifier.code 0} true;
  call br_i15_montymul($p5, $p5.shadow, $p0, $p0.shadow, $p16, $p16.shadow, $p3, $p3.shadow, $i4, $i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 152, 9} true;
  assume {:verifier.code 0} true;
  call $i119, $i119.shadow := NEQ.6($i84, $i84.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 152, 23} true;
  assume {:verifier.code 0} true;
  $p120 := $bitcast.ref.ref($p0);
  $p120.shadow := $bitcast.ref.ref($p0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 152, 26} true;
  assume {:verifier.code 0} true;
  $p121 := $bitcast.ref.ref($p5);
  $p121.shadow := $bitcast.ref.ref($p5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 152, 3} true;
  assume {:verifier.code 0} true;
  call br_ccopy($i119, $i119.shadow, $p120, $p120.shadow, $p121, $p121.shadow, $i13, $i13.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 99, 2} true;
  assume {:verifier.code 0} true;
  $i54 := $i62;
  $i54.shadow := $i62.shadow;
  $i55 := $i85;
  $i55.shadow := $i85.shadow;
  $i56 := $i64;
  $i56.shadow := $i64.shadow;
  $p57 := $p65;
  $p57.shadow := $p65.shadow;
  goto $bb18;
$bb37:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($p96 == $p96.shadow);
  assert {:shadow_invariant} ($i97 == $i97.shadow);
  assert {:shadow_invariant} ($p65 == $p65.shadow);
  assert {:shadow_invariant} ($i64 == $i64.shadow);
  assert {:shadow_invariant} ($i66 == $i66.shadow);
  assert {:shadow_invariant} ($i85 == $i85.shadow);
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 136, 33} true;
  assume {:verifier.code 0} true;
  $i98 := $shl.i32(1,$i66);
  $i98.shadow := $shl.i32(1,$i66.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 136, 20} true;
  assume {:verifier.code 0} true;
  $i99 := $zext.i32.i64($i98);
  $i99.shadow := $zext.i32.i64($i98.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 136, 18} true;
  assume {:verifier.code 0} true;
  $i100 := $ult.i64($i97,$i99);
  $i100.shadow := $ult.i64($i97.shadow,$i99.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 136, 4} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i100} true;
  assert ($i100 == $i100.shadow);
  goto $bb38, $bb39;
$bb38:
  assume ($i100 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 139, 16} true;
  assume {:verifier.code 0} true;
  $i101 := $trunc.i64.i32($i97);
  $i101.shadow := $trunc.i64.i32($i97.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 139, 13} true;
  assume {:verifier.code 0} true;
  call $i102, $i102.shadow := EQ.5($i101, $i101.shadow, $i84, $i84.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 139, 12} true;
  assume {:verifier.code 0} true;
  $i103 := $sub.i32(0,$i102);
  $i103.shadow := $sub.i32(0,$i102.shadow);
  call {:cexpr "mask"} boogie_si_record_i32($i103);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 140, 10} true;
  assume {:verifier.code 0} true;
  $i104 := 1;
  $i104.shadow := 1;
  goto $bb40;
$bb39:
  assume !($i100 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 145, 3} true;
  assume {:verifier.code 0} true;
  goto $bb36;
$bb40:
  assert {:shadow_invariant} $shadow_ok;
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 140, 19} true;
  assume {:verifier.code 0} true;
  $i105 := $ult.i64($i104,$i15);
  $i105.shadow := $ult.i64($i104.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 140, 5} true;
  assume {:verifier.code 0} true;
...
$bb41:
  assume ($i105 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 141, 22} true;
  assume {:verifier.code 0} true;
  $p106 := $add.ref($p96,$mul.ref($i104,2));
  $p106.shadow := $add.ref($p96.shadow,$mul.ref($i104.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 141, 22} true;
  assume {:verifier.code 0} true;
  assert ($p106 == $p106.shadow);
  $i107 := $load.i16($M.0,$p106);
  $i107.shadow := $load.i16($M.0.shadow,$p106.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 141, 22} true;
  assume {:verifier.code 0} true;
  $i108 := $zext.i16.i32($i107);
  $i108.shadow := $zext.i16.i32($i107.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 141, 20} true;
  assume {:verifier.code 0} true;
  $i109 := $and.i32($i103,$i108);
  $i109.shadow := $and.i32($i103.shadow,$i108.shadow);
  $i110 := $add.i64($i15,$i104);
  $i110.shadow := $add.i64($i15.shadow,$i104.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 141, 6} true;
  assume {:verifier.code 0} true;
  $p111 := $add.ref($p5,$mul.ref($i110,2));
  $p111.shadow := $add.ref($p5.shadow,$mul.ref($i110.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 141, 12} true;
  assume {:verifier.code 0} true;
  assert ($p111 == $p111.shadow);
  $i112 := $load.i16($M.0,$p111);
  $i112.shadow := $load.i16($M.0.shadow,$p111.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 141, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 141, 12} true;
  assume {:verifier.code 0} true;
  $i114 := $or.i32($i113,$i109);
  $i114.shadow := $or.i32($i113.shadow,$i109.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 141, 12} true;
  assume {:verifier.code 0} true;
  $i115 := $trunc.i32.i16($i114);
  $i115.shadow := $trunc.i32.i16($i114.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 141, 12} true;
  assume {:verifier.code 0} true;
  assert ($p111 == $p111.shadow);
  $M.0 := $store.i16($M.0,$p111,$i115);
  $M.0.shadow := $store.i16($M.0.shadow,$p111.shadow,$i115.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 142, 5} true;
  assume {:verifier.code 0} true;
  goto $bb43;
$bb42:
  assume !($i105 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 143, 10} true;
  assume {:verifier.code 0} true;
  $p117 := $add.ref($p96,$mul.ref($i15,2));
  $p117.shadow := $add.ref($p96.shadow,$mul.ref($i15.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 144, 4} true;
  assume {:verifier.code 0} true;
  goto $bb44;
$bb43:
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 140, 30} true;
  assume {:verifier.code 0} true;
  $i116 := $add.i64($i104,1);
  $i116.shadow := $add.i64($i104.shadow,1);
  call {:cexpr "v"} boogie_si_record_i64($i116);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 140, 5} true;
  assume {:verifier.code 0} true;
  $i104 := $i116;
  $i104.shadow := $i116.shadow;
  goto $bb40;
$bb44:
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 136, 42} true;
  assume {:verifier.code 0} true;
  $i118 := $add.i64($i97,1);
  $i118.shadow := $add.i64($i97.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i118);
  assume {:sourceloc "../BearSSL/src/int/i15_modpow2.c", 136, 4} true;
  assume {:verifier.code 0} true;
  $p96 := $p117;
  $p96.shadow := $p117.shadow;
  $i97 := $i118;
  $i97.shadow := $i118.shadow;
  goto $bb37;
}
const br_i15_reduce: ref;
axiom (br_i15_reduce == $sub.ref(0,17544));
procedure {:inline 1} br_i15_reduce($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.0, $exn;
modifies $M.13;
modifies $CurrAddr;
{
  ...
  var $i45.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 34, 13} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 34, 13} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p2,$mul.ref(0,2));
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 35, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i5,15);
  $i6.shadow := $add.i32($i5.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 35, 25} true;
  assume {:verifier.code 0} true;
  $i7 := $lshr.i32($i6,4);
  $i7.shadow := $lshr.i32($i6.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i32.i64($i7);
  $i8.shadow := $zext.i32.i64($i7.shadow);
  call {:cexpr "mlen"} boogie_si_record_i64($i8);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 37, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i32.i16($i5);
  $i9.shadow := $trunc.i32.i16($i5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 37, 2} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($p0,$mul.ref(0,2));
  $p10.shadow := $add.ref($p0.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 37, 7} true;
  assume {:verifier.code 0} true;
  assert ($p10 == $p10.shadow);
  $M.0 := $store.i16($M.0,$p10,$i9);
  $M.0.shadow := $store.i16($M.0.shadow,$p10.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 38, 15} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i5,0);
  $i11.shadow := $eq.i32($i5.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 38, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i11 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 39, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !($i11 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 46, 13} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p1,$mul.ref(0,2));
  $p12.shadow := $add.ref($p1.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 46, 13} true;
  assume {:verifier.code 0} true;
  assert ($p12 == $p12.shadow);
  $i13 := $load.i16($M.0,$p12);
  $i13.shadow := $load.i16($M.0.shadow,$p12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 46, 13} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i16.i32($i13);
  $i14.shadow := $zext.i16.i32($i13.shadow);
  call {:cexpr "a_bitlen"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 47, 19} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i14,15);
  $i15.shadow := $add.i32($i14.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 47, 25} true;
  assume {:verifier.code 0} true;
  $i16 := $lshr.i32($i15,4);
  $i16.shadow := $lshr.i32($i15.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 47, 9} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i32.i64($i16);
  $i17.shadow := $zext.i32.i64($i16.shadow);
  call {:cexpr "alen"} boogie_si_record_i64($i17);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 48, 15} true;
  assume {:verifier.code 0} true;
  $i18 := $ult.i32($i14,$i5);
  $i18.shadow := $ult.i32($i14.shadow,$i5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 48, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i18} true;
  assert ($i18 == $i18.shadow);
  goto $bb4, $bb5;
$bb3:
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 66, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume ($i18 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 49, 12} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($p0,$mul.ref(1,2));
  $p19.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 49, 3} true;
  assume {:verifier.code 0} true;
  $p20 := $bitcast.ref.ref($p19);
  $p20.shadow := $bitcast.ref.ref($p19.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 49, 19} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p1,$mul.ref(1,2));
  $p21.shadow := $add.ref($p1.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 49, 3} true;
  assume {:verifier.code 0} true;
  $p22 := $bitcast.ref.ref($p21);
  $p22.shadow := $bitcast.ref.ref($p21.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 49, 29} true;
  assume {:verifier.code 0} true;
  $i23 := $mul.i64($i17,2);
  $i23.shadow := $mul.i64($i17.shadow,2);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 49, 3} true;
  assume {:verifier.code 0} true;
  assert ($p20 == $p20.shadow);
  assert ($p22 == $p22.shadow);
  assert ($i23 == $i23.shadow);
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.0, $M.0.shadow, $p20, $p20.shadow, $p22, $p22.shadow, $i23, $i23.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 50, 8} true;
  assume {:verifier.code 0} true;
  $i24 := $i17;
  $i24.shadow := $i17.shadow;
  goto $bb6;
$bb5:
  assume !($i18 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 61, 11} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p0,$mul.ref(1,2));
  $p29.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 61, 2} true;
  assume {:verifier.code 0} true;
  $p30 := $bitcast.ref.ref($p29);
  $p30.shadow := $bitcast.ref.ref($p29.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 61, 18} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($p1,$mul.ref(2,2));
  $p31.shadow := $add.ref($p1.shadow,$mul.ref(2,2));
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 61, 30} true;
  assume {:verifier.code 0} true;
  $i32 := $sub.i64($i17,$i8);
  $i32.shadow := $sub.i64($i17.shadow,$i8.shadow);
  $i33 := $add.i64(2,$i32);
  $i33.shadow := $add.i64(2,$i32.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 61, 22} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($p1,$mul.ref($i33,2));
  $p34.shadow := $add.ref($p1.shadow,$mul.ref($i33.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 61, 2} true;
  assume {:verifier.code 0} true;
  $p35 := $bitcast.ref.ref($p34);
  $p35.shadow := $bitcast.ref.ref($p34.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 61, 45} true;
  assume {:verifier.code 0} true;
  $i36 := $sub.i64($i8,1);
  $i36.shadow := $sub.i64($i8.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 61, 50} true;
  assume {:verifier.code 0} true;
  $i37 := $mul.i64($i36,2);
  $i37.shadow := $mul.i64($i36.shadow,2);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 61, 2} true;
  assume {:verifier.code 0} true;
  assert ($p30 == $p30.shadow);
  assert ($p35 == $p35.shadow);
  assert ($i37 == $i37.shadow);
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.0, $M.0.shadow, $p30, $p30.shadow, $p35, $p35.shadow, $i37, $i37.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 62, 2} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p0,$mul.ref($i8,2));
  $p38.shadow := $add.ref($p0.shadow,$mul.ref($i8.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 62, 10} true;
  assume {:verifier.code 0} true;
  assert ($p38 == $p38.shadow);
  $M.0 := $store.i16($M.0,$p38,0);
  $M.0.shadow := $store.i16($M.0.shadow,$p38.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 63, 13} true;
  assume {:verifier.code 0} true;
  $i39 := $add.i64(1,$i17);
  $i39.shadow := $add.i64(1,$i17.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 63, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $sub.i64($i39,$i8);
  $i40.shadow := $sub.i64($i39.shadow,$i8.shadow);
  call {:cexpr "u"} boogie_si_record_i64($i40);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 63, 7} true;
  assume {:verifier.code 0} true;
  $i41 := $i40;
  $i41.shadow := $i40.shadow;
  goto $bb10;
$bb6:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i24 == $i24.shadow);
  assert {:shadow_invariant} ($i8 == $i8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 50, 20} true;
  assume {:verifier.code 0} true;
  $i25 := $ult.i64($i24,$i8);
  $i25.shadow := $ult.i64($i24.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 50, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i25} true;
  assert ($i25 == $i25.shadow);
  goto $bb7, $bb8;
$bb7:
  assume ($i25 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 51, 8} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i64($i24,1);
  $i26.shadow := $add.i64($i24.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 51, 4} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($p0,$mul.ref($i26,2));
  $p27.shadow := $add.ref($p0.shadow,$mul.ref($i26.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 51, 13} true;
  assume {:verifier.code 0} true;
  assert ($p27 == $p27.shadow);
  $M.0 := $store.i16($M.0,$p27,0);
  $M.0.shadow := $store.i16($M.0.shadow,$p27.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 52, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume !($i25 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 53, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb9:
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 50, 30} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i64($i24,1);
  $i28.shadow := $add.i64($i24.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i28);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 50, 3} true;
  assume {:verifier.code 0} true;
  $i24 := $i28;
  $i24.shadow := $i28.shadow;
...
$bb10:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 63, 30} true;
  assume {:verifier.code 0} true;
  $i42 := $ugt.i64($i41,0);
  $i42.shadow := $ugt.i64($i41.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 63, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i42} true;
  assert ($i42 == $i42.shadow);
  goto $bb11, $bb12;
$bb11:
  assume ($i42 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 64, 26} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($p1,$mul.ref($i41,2));
  $p43.shadow := $add.ref($p1.shadow,$mul.ref($i41.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 64, 26} true;
  assume {:verifier.code 0} true;
  assert ($p43 == $p43.shadow);
  $i44 := $load.i16($M.0,$p43);
  $i44.shadow := $load.i16($M.0.shadow,$p43.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 64, 3} true;
  assume {:verifier.code 0} true;
  call br_i15_muladd_small($p0, $p0.shadow, $i44, $i44.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 65, 2} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 63, 2} true;
  ...
  goto $bb3;
$bb13:
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 63, 37} true;
  assume {:verifier.code 0} true;
  $i45 := $add.i64($i41,$sub.i64(0,1));
  $i45.shadow := $add.i64($i41.shadow,$sub.i64(0,1));
  call {:cexpr "u"} boogie_si_record_i64($i45);
  assume {:sourceloc "../BearSSL/src/int/i15_reduce.c", 63, 2} true;
  assume {:verifier.code 0} true;
  $i41 := $i45;
  $i41.shadow := $i45.shadow;
  goto $bb10;
}
const br_i15_sub: ref;
axiom (br_i15_sub == $sub.ref(0,18576));
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  call $i22, $i22.shadow := MUX.24($i2, $i2.shadow, $i21, $i21.shadow, $i14, $i14.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_sub.c", 43, 10} true;
  assume {:verifier.code 0} true;
  ...
  $M.0.shadow := $store.i16($M.0.shadow,$p24.shadow,$i23.shadow);
...
axiom (br_i15_add == $sub.ref(0,19608));
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  call $i22, $i22.shadow := MUX.1($i2, $i2.shadow, $i21, $i21.shadow, $i14, $i14.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_add.c", 43, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i32.i16($i22);
  $i23.shadow := $trunc.i32.i16($i22.shadow);
...
const br_i15_to_monty: ref;
axiom (br_i15_to_monty == $sub.ref(0,20640));
procedure {:inline 1} br_i15_to_monty($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $exn;
modifies $M.0;
modifies $M.13;
modifies $CurrAddr;
{
  ...
  var $i9.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 33, 12} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 33, 12} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1,$mul.ref(0,2));
  $p2.shadow := $add.ref($p1.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 33, 12} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $i3 := $load.i16($M.0,$p2);
  $i3.shadow := $load.i16($M.0.shadow,$p2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 33, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i16.i32($i3);
  $i4.shadow := $zext.i16.i32($i3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 33, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i4,15);
  $i5.shadow := $add.i32($i4.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 33, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $ashr.i32($i5,4);
  $i6.shadow := $ashr.i32($i5.shadow,4);
  call {:cexpr "k"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 33, 7} true;
  assume {:verifier.code 0} true;
  $i7 := $i6;
  $i7.shadow := $i6.shadow;
  goto $bb1;
$bb1:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i7 == $i7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 33, 31} true;
  assume {:verifier.code 0} true;
  $i8 := $ugt.i32($i7,0);
  $i8.shadow := $ugt.i32($i7.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 33, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  assert ($i8 == $i8.shadow);
  goto $bb2, $bb3;
$bb2:
  assume ($i8 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 34, 3} true;
  assume {:verifier.code 0} true;
  call br_i15_muladd_small($p0, $p0.shadow, 0, 0, $p1, $p1.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 35, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i8 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 36, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 33, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i7,$sub.i32(0,1));
  $i9.shadow := $add.i32($i7.shadow,$sub.i32(0,1));
  call {:cexpr "k"} boogie_si_record_i32($i9);
  assume {:sourceloc "../BearSSL/src/int/i15_tmont.c", 33, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $i9;
  $i7.shadow := $i9.shadow;
...
axiom (br_i15_montymul == $sub.ref(0,21672));
...
$bb0:
  ...
  assert ($p5 == $p5.shadow);
  $i6 := $load.i16($M.0,$p5);
  $i6.shadow := $load.i16($M.0.shadow,$p5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i16.i32($i6);
  ...
  assume {:verifier.code 0} true;
  call br_i15_zero.10($p0, $p0.shadow, $i13, $i13.shadow);
...
$bb2:
  ...
  $i19.shadow := $load.i16($M.0.shadow,$p18.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 42, 8} true;
  assume {:verifier.code 0} true;
  ...
  $i22.shadow := $load.i16($M.0.shadow,$p21.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
  ...
  $i26.shadow := $load.i16($M.0.shadow,$p25.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 43, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  $i162.shadow := $load.i16($M.0.shadow,$p161.shadow);
  ...
  $M.0.shadow := $store.i16($M.0.shadow,$p163.shadow,$i162.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 183, 19} true;
  assume {:verifier.code 0} true;
  call $i164, $i164.shadow := NEQ.11($i15, $i15.shadow, 0, 0);
  ...
  assume {:verifier.code 0} true;
  call $i166, $i166.shadow := NOT.12($i165, $i165.shadow);
...
$bb5:
  ...
  $i42.shadow := $load.i16($M.0.shadow,$p41.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 142, 8} true;
  assume {:verifier.code 0} true;
  ...
  $i52.shadow := $load.i16($M.0.shadow,$p51.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 143, 7} true;
  assume {:verifier.code 0} true;
  ...
  $M.0.shadow := $store.i16($M.0.shadow,$p61.shadow,$i59.shadow);
  ...
  $i64.shadow := $load.i16($M.0.shadow,$p63.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 8} true;
  assume {:verifier.code 0} true;
  ...
  $i68.shadow := $load.i16($M.0.shadow,$p67.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 146, 19} true;
  assume {:verifier.code 0} true;
  ...
  $i74.shadow := $load.i16($M.0.shadow,$p73.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 147, 7} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $store.i16($M.0,$p83,$i81);
  $M.0.shadow := $store.i16($M.0.shadow,$p83.shadow,$i81.shadow);
  ...
  $i86.shadow := $load.i16($M.0.shadow,$p85.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 8} true;
  assume {:verifier.code 0} true;
  ...
  $i90.shadow := $load.i16($M.0.shadow,$p89.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 150, 19} true;
  assume {:verifier.code 0} true;
  ...
  $i96.shadow := $load.i16($M.0.shadow,$p95.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 151, 7} true;
  assume {:verifier.code 0} true;
  ...
  $M.0.shadow := $store.i16($M.0.shadow,$p105.shadow,$i103.shadow);
  ...
  $i108.shadow := $load.i16($M.0.shadow,$p107.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 154, 8} true;
  assume {:verifier.code 0} true;
  ...
  $i118.shadow := $load.i16($M.0.shadow,$p117.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 155, 7} true;
  assume {:verifier.code 0} true;
  ...
  $M.0.shadow := $store.i16($M.0.shadow,$p127.shadow,$i125.shadow);
...
$bb9:
  ...
  $i134.shadow := $load.i16($M.0.shadow,$p133.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 8} true;
  assume {:verifier.code 0} true;
  ...
  $i138.shadow := $load.i16($M.0.shadow,$p137.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 163, 19} true;
  assume {:verifier.code 0} true;
  ...
  $i144.shadow := $load.i16($M.0.shadow,$p143.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_montmul.c", 164, 7} true;
  assume {:verifier.code 0} true;
  ...
  $M.0 := $store.i16($M.0,$p153,$i151);
  $M.0.shadow := $store.i16($M.0.shadow,$p153.shadow,$i151.shadow);
...
$bb10:
  ...
  $M.0 := $store.i16($M.0,$p158,$i157);
  $M.0.shadow := $store.i16($M.0.shadow,$p158.shadow,$i157.shadow);
...
const br_i15_zero.10: ref;
axiom (br_i15_zero.10 == $sub.ref(0,22704));
procedure {:inline 1} br_i15_zero.10($p0: ref, $p0.shadow: ref, $i1: i16, $i1.shadow: i16)
modifies $M.0, $exn;
{
  var $p2: ref;
  var $p2.shadow: ref;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 1539, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_zero.10:arg:bit_len"} boogie_si_record_i16($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1539, 5} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p0,$mul.ref(1,2));
  $p2.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
...
const NEQ.11: ref;
axiom (NEQ.11 == $sub.ref(0,23736));
procedure {:inline 1} NEQ.11($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "NEQ.11:arg:x"} boogie_si_record_i32($i0);
  call {:cexpr "NEQ.11:arg:y"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 795, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i32($i0,$i1);
...
const NOT.12: ref;
axiom (NOT.12 == $sub.ref(0,24768));
procedure {:inline 1} NOT.12($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "NOT.12:arg:ctl"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $xor.i32($i0,1);
...
axiom (llvm.memset.p0i8.i64 == $sub.ref(0,25800));
procedure {:inline 1} llvm.memset.p0i8.i64($p0: ref, $p0.shadow: ref, $i1: i8, $i1.shadow: i8, $i2: i64, $i2.shadow: i64, $i3: i1, $i3.shadow: i1);
const br_i15_muladd_small: ref;
axiom (br_i15_muladd_small == $sub.ref(0,26832));
procedure {:inline 1} br_i15_muladd_small($p0: ref, $p0.shadow: ref, $i1: i16, $i1.shadow: i16, $p2: ref, $p2.shadow: ref)
modifies $exn, $M.0;
modifies $M.13;
modifies $CurrAddr;
{
  ...
  var $i131.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 69, 13} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(4,$zext.i32.i64(1)));
  $p3.shadow := $p3;
  call {:cexpr "br_i15_muladd_small:arg:z"} boogie_si_record_i16($i1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 69, 13} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p2,$mul.ref(0,2));
  $p4.shadow := $add.ref($p2.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 69, 13} true;
  assume {:verifier.code 0} true;
  assert ($p4 == $p4.shadow);
  $i5 := $load.i16($M.0,$p4);
  ...
  $i6 := $zext.i16.i32($i5);
  $i6.shadow := $zext.i16.i32($i5.shadow);
  call {:cexpr "m_bitlen"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 70, 15} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6,0);
  $i7.shadow := $eq.i32($i6.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 70, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  assert ($i7 == $i7.shadow);
  goto $bb1, $bb2;
$bb1:
  assume ($i7 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 71, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !($i7 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 73, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $ule.i32($i6,15);
  $i8.shadow := $ule.i32($i6.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 73, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  assert ($i8 == $i8.shadow);
  goto $bb4, $bb5;
$bb3:
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 173, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume ($i8 == 1);
  assume true;
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 76, 23} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(1,2));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 76, 23} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $i10 := $load.i16($M.0,$p9);
  $i10.shadow := $load.i16($M.0.shadow,$p9.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 76, 13} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i16.i32($i10);
  $i11.shadow := $zext.i16.i32($i10.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 76, 28} true;
  assume {:verifier.code 0} true;
  $i12 := $shl.i32($i11,15);
  $i12.shadow := $shl.i32($i11.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 76, 37} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i16.i32($i1);
  $i13.shadow := $zext.i16.i32($i1.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 76, 35} true;
  assume {:verifier.code 0} true;
  $i14 := $or.i32($i12,$i13);
  $i14.shadow := $or.i32($i12.shadow,$i13.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 76, 40} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p2,$mul.ref(1,2));
  $p15.shadow := $add.ref($p2.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 76, 40} true;
  assume {:verifier.code 0} true;
  assert ($p15 == $p15.shadow);
  $i16 := $load.i16($M.0,$p15);
  ...
  $i17 := $zext.i16.i32($i16);
  $i17.shadow := $zext.i16.i32($i16.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 76, 3} true;
  assume {:verifier.code 0} true;
  call $i18, $i18.shadow := divrem16($i14, $i14.shadow, $i17, $i17.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 77, 10} true;
  assume {:verifier.code 0} true;
  assert ($p3 == $p3.shadow);
  $i19 := $load.i32($M.13,$p3);
  $i19.shadow := $load.i32($M.13.shadow,$p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 77, 10} true;
  assume {:verifier.code 0} true;
  $i20 := $trunc.i32.i16($i19);
  $i20.shadow := $trunc.i32.i16($i19.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 77, 3} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p0,$mul.ref(1,2));
  $p21.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 77, 8} true;
  assume {:verifier.code 0} true;
  assert ($p21 == $p21.shadow);
  $M.0 := $store.i16($M.0,$p21,$i20);
  $M.0.shadow := $store.i16($M.0.shadow,$p21.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 78, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb5:
  assume !($i8 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 80, 19} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i32($i6,15);
  $i22.shadow := $add.i32($i6.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 80, 25} true;
  assume {:verifier.code 0} true;
  $i23 := $lshr.i32($i22,4);
  $i23.shadow := $lshr.i32($i22.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 80, 9} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i32.i64($i23);
  $i24.shadow := $zext.i32.i64($i23.shadow);
  call {:cexpr "mlen"} boogie_si_record_i64($i24);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 81, 18} true;
  assume {:verifier.code 0} true;
  $i25 := $and.i32($i6,15);
  $i25.shadow := $and.i32($i6.shadow,15);
  call {:cexpr "mblr"} boogie_si_record_i32($i25);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 109, 7} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p0,$mul.ref($i24,2));
  $p26.shadow := $add.ref($p0.shadow,$mul.ref($i24.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 109, 7} true;
  assume {:verifier.code 0} true;
  assert ($p26 == $p26.shadow);
  $i27 := $load.i16($M.0,$p26);
  $i27.shadow := $load.i16($M.0.shadow,$p26.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 109, 7} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i16.i32($i27);
  $i28.shadow := $zext.i16.i32($i27.shadow);
  call {:cexpr "hi"} boogie_si_record_i32($i28);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 110, 11} true;
  assume {:verifier.code 0} true;
  $i29 := $eq.i32($i25,0);
  $i29.shadow := $eq.i32($i25.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 110, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i29} true;
  assert ($i29 == $i29.shadow);
  goto $bb6, $bb7;
$bb6:
  assume ($i29 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 111, 8} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($p0,$mul.ref($i24,2));
  $p30.shadow := $add.ref($p0.shadow,$mul.ref($i24.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 111, 8} true;
  assume {:verifier.code 0} true;
  assert ($p30 == $p30.shadow);
  $i31 := $load.i16($M.0,$p30);
  $i31.shadow := $load.i16($M.0.shadow,$p30.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 111, 8} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i16.i32($i31);
  $i32.shadow := $zext.i16.i32($i31.shadow);
  call {:cexpr "a0"} boogie_si_record_i32($i32);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 112, 13} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($p0,$mul.ref(2,2));
  $p33.shadow := $add.ref($p0.shadow,$mul.ref(2,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 112, 3} true;
  assume {:verifier.code 0} true;
  $p34 := $bitcast.ref.ref($p33);
  $p34.shadow := $bitcast.ref.ref($p33.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 112, 20} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($p0,$mul.ref(1,2));
  $p35.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 112, 3} true;
  assume {:verifier.code 0} true;
  $p36 := $bitcast.ref.ref($p35);
  $p36.shadow := $bitcast.ref.ref($p35.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 112, 31} true;
  assume {:verifier.code 0} true;
  $i37 := $sub.i64($i24,1);
  $i37.shadow := $sub.i64($i24.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 112, 36} true;
  assume {:verifier.code 0} true;
  $i38 := $mul.i64($i37,2);
  $i38.shadow := $mul.i64($i37.shadow,2);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 112, 3} true;
  assume {:verifier.code 0} true;
  call llvm.memmove.p0i8.p0i8.i64($p34, $p34.shadow, $p36, $p36.shadow, $i38, $i38.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 113, 3} true;
  assume {:verifier.code 0} true;
  $p39 := $add.ref($p0,$mul.ref(1,2));
  $p39.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 113, 8} true;
  assume {:verifier.code 0} true;
  assert ($p39 == $p39.shadow);
  $M.0 := $store.i16($M.0,$p39,$i1);
  $M.0.shadow := $store.i16($M.0.shadow,$p39.shadow,$i1.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 114, 11} true;
  assume {:verifier.code 0} true;
  $i40 := $shl.i32($i32,15);
  $i40.shadow := $shl.i32($i32.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 114, 20} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($p0,$mul.ref($i24,2));
  $p41.shadow := $add.ref($p0.shadow,$mul.ref($i24.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 114, 20} true;
  assume {:verifier.code 0} true;
  assert ($p41 == $p41.shadow);
  $i42 := $load.i16($M.0,$p41);
  ...
  $i43 := $zext.i16.i32($i42);
  $i43.shadow := $zext.i16.i32($i42.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 114, 18} true;
  assume {:verifier.code 0} true;
  $i44 := $add.i32($i40,$i43);
  $i44.shadow := $add.i32($i40.shadow,$i43.shadow);
  call {:cexpr "a"} boogie_si_record_i32($i44);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 115, 7} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($p2,$mul.ref($i24,2));
  $p45.shadow := $add.ref($p2.shadow,$mul.ref($i24.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 115, 7} true;
  assume {:verifier.code 0} true;
  assert ($p45 == $p45.shadow);
  $i46 := $load.i16($M.0,$p45);
  ...
  $i47 := $zext.i16.i32($i46);
  $i47.shadow := $zext.i16.i32($i46.shadow);
  call {:cexpr "b"} boogie_si_record_i32($i47);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 116, 2} true;
  assume {:verifier.code 0} true;
  $i48 := $i32;
  $i48.shadow := $i32.shadow;
  $i49 := $i44;
  $i49.shadow := $i44.shadow;
  $i50 := $i47;
  $i50.shadow := $i47.shadow;
  goto $bb8;
$bb7:
  assume !($i29 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 117, 9} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($p0,$mul.ref($i24,2));
  $p51.shadow := $add.ref($p0.shadow,$mul.ref($i24.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 117, 9} true;
  assume {:verifier.code 0} true;
  assert ($p51 == $p51.shadow);
  $i52 := $load.i16($M.0,$p51);
  ...
  $i53 := $zext.i16.i32($i52);
  $i53.shadow := $zext.i16.i32($i52.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 117, 24} true;
  assume {:verifier.code 0} true;
  $i54 := $sub.i32(15,$i25);
  $i54.shadow := $sub.i32(15,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 117, 17} true;
  assume {:verifier.code 0} true;
  $i55 := $shl.i32($i53,$i54);
  $i55.shadow := $shl.i32($i53.shadow,$i54.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 117, 43} true;
  assume {:verifier.code 0} true;
  $i56 := $sub.i64($i24,1);
  $i56.shadow := $sub.i64($i24.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 117, 36} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($p0,$mul.ref($i56,2));
  $p57.shadow := $add.ref($p0.shadow,$mul.ref($i56.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 117, 36} true;
  assume {:verifier.code 0} true;
  assert ($p57 == $p57.shadow);
  $i58 := $load.i16($M.0,$p57);
  $i58.shadow := $load.i16($M.0.shadow,$p57.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 117, 36} true;
  assume {:verifier.code 0} true;
  $i59 := $zext.i16.i32($i58);
  $i59.shadow := $zext.i16.i32($i58.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 117, 48} true;
  assume {:verifier.code 0} true;
  $i60 := $ashr.i32($i59,$i25);
  $i60.shadow := $ashr.i32($i59.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 117, 33} true;
  assume {:verifier.code 0} true;
  $i61 := $or.i32($i55,$i60);
  $i61.shadow := $or.i32($i55.shadow,$i60.shadow);
  call {:cexpr "a0"} boogie_si_record_i32($i61);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 118, 13} true;
  assume {:verifier.code 0} true;
  $p62 := $add.ref($p0,$mul.ref(2,2));
  $p62.shadow := $add.ref($p0.shadow,$mul.ref(2,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 118, 3} true;
  assume {:verifier.code 0} true;
  $p63 := $bitcast.ref.ref($p62);
  $p63.shadow := $bitcast.ref.ref($p62.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 118, 20} true;
  assume {:verifier.code 0} true;
  $p64 := $add.ref($p0,$mul.ref(1,2));
  $p64.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 118, 3} true;
  assume {:verifier.code 0} true;
  $p65 := $bitcast.ref.ref($p64);
  $p65.shadow := $bitcast.ref.ref($p64.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 118, 31} true;
  assume {:verifier.code 0} true;
  $i66 := $sub.i64($i24,1);
  $i66.shadow := $sub.i64($i24.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 118, 36} true;
  assume {:verifier.code 0} true;
  $i67 := $mul.i64($i66,2);
  $i67.shadow := $mul.i64($i66.shadow,2);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 118, 3} true;
  assume {:verifier.code 0} true;
  call llvm.memmove.p0i8.p0i8.i64($p63, $p63.shadow, $p65, $p65.shadow, $i67, $i67.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 119, 3} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($p0,$mul.ref(1,2));
  $p68.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 119, 8} true;
  assume {:verifier.code 0} true;
  assert ($p68 == $p68.shadow);
  $M.0 := $store.i16($M.0,$p68,$i1);
  $M.0.shadow := $store.i16($M.0.shadow,$p68.shadow,$i1.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 120, 11} true;
  assume {:verifier.code 0} true;
  $i69 := $shl.i32($i61,15);
  $i69.shadow := $shl.i32($i61.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 120, 23} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($p0,$mul.ref($i24,2));
  $p70.shadow := $add.ref($p0.shadow,$mul.ref($i24.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 120, 23} true;
  assume {:verifier.code 0} true;
  assert ($p70 == $p70.shadow);
  $i71 := $load.i16($M.0,$p70);
  $i71.shadow := $load.i16($M.0.shadow,$p70.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 120, 23} true;
  assume {:verifier.code 0} true;
  $i72 := $zext.i16.i32($i71);
  $i72.shadow := $zext.i16.i32($i71.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 120, 38} true;
  assume {:verifier.code 0} true;
  $i73 := $sub.i32(15,$i25);
  $i73.shadow := $sub.i32(15,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 120, 31} true;
  assume {:verifier.code 0} true;
  $i74 := $shl.i32($i72,$i73);
  $i74.shadow := $shl.i32($i72.shadow,$i73.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 121, 14} true;
  assume {:verifier.code 0} true;
  $i75 := $sub.i64($i24,1);
  $i75.shadow := $sub.i64($i24.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 121, 7} true;
  assume {:verifier.code 0} true;
  $p76 := $add.ref($p0,$mul.ref($i75,2));
  $p76.shadow := $add.ref($p0.shadow,$mul.ref($i75.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 121, 7} true;
  assume {:verifier.code 0} true;
  assert ($p76 == $p76.shadow);
  $i77 := $load.i16($M.0,$p76);
  $i77.shadow := $load.i16($M.0.shadow,$p76.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 121, 7} true;
  assume {:verifier.code 0} true;
  $i78 := $zext.i16.i32($i77);
  $i78.shadow := $zext.i16.i32($i77.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 121, 19} true;
  assume {:verifier.code 0} true;
  $i79 := $ashr.i32($i78,$i25);
  $i79.shadow := $ashr.i32($i78.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 121, 4} true;
  assume {:verifier.code 0} true;
  $i80 := $or.i32($i74,$i79);
  $i80.shadow := $or.i32($i74.shadow,$i79.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 121, 29} true;
  assume {:verifier.code 0} true;
  $i81 := $and.i32($i80,32767);
  $i81.shadow := $and.i32($i80.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 120, 18} true;
  assume {:verifier.code 0} true;
  $i82 := $or.i32($i69,$i81);
  $i82.shadow := $or.i32($i69.shadow,$i81.shadow);
  call {:cexpr "a"} boogie_si_record_i32($i82);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 122, 8} true;
  assume {:verifier.code 0} true;
  $p83 := $add.ref($p2,$mul.ref($i24,2));
  $p83.shadow := $add.ref($p2.shadow,$mul.ref($i24.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 122, 8} true;
  assume {:verifier.code 0} true;
  assert ($p83 == $p83.shadow);
  $i84 := $load.i16($M.0,$p83);
  $i84.shadow := $load.i16($M.0.shadow,$p83.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 122, 8} true;
  assume {:verifier.code 0} true;
  $i85 := $zext.i16.i32($i84);
  $i85.shadow := $zext.i16.i32($i84.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 122, 23} true;
  assume {:verifier.code 0} true;
  $i86 := $sub.i32(15,$i25);
  $i86.shadow := $sub.i32(15,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 122, 16} true;
  assume {:verifier.code 0} true;
  $i87 := $shl.i32($i85,$i86);
  $i87.shadow := $shl.i32($i85.shadow,$i86.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 122, 42} true;
  assume {:verifier.code 0} true;
  $i88 := $sub.i64($i24,1);
  $i88.shadow := $sub.i64($i24.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 122, 35} true;
  assume {:verifier.code 0} true;
  $p89 := $add.ref($p2,$mul.ref($i88,2));
  $p89.shadow := $add.ref($p2.shadow,$mul.ref($i88.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 122, 35} true;
  ...
  $i91 := $zext.i16.i32($i90);
  $i91.shadow := $zext.i16.i32($i90.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 122, 47} true;
  assume {:verifier.code 0} true;
  $i92 := $ashr.i32($i91,$i25);
  $i92.shadow := $ashr.i32($i91.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 122, 32} true;
  assume {:verifier.code 0} true;
  $i93 := $or.i32($i87,$i92);
  $i93.shadow := $or.i32($i87.shadow,$i92.shadow);
  call {:cexpr "b"} boogie_si_record_i32($i93);
  assume {:verifier.code 0} true;
  $i48 := $i61;
  $i48.shadow := $i61.shadow;
  $i49 := $i82;
  $i49.shadow := $i82.shadow;
  $i50 := $i93;
  $i50.shadow := $i93.shadow;
  goto $bb8;
$bb8:
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 124, 6} true;
  assume {:verifier.code 0} true;
  call $i94, $i94.shadow := divrem16($i49, $i49.shadow, $i50, $i50.shadow, $0.ref, $0.ref);
  call {:cexpr "q"} boogie_si_record_i32($i94);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 134, 10} true;
  assume {:verifier.code 0} true;
  call $i95, $i95.shadow := EQ.15($i50, $i50.shadow, $i48, $i48.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 134, 31} true;
  assume {:verifier.code 0} true;
  $i96 := $sub.i32($i94,1);
  $i96.shadow := $sub.i32($i94.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 134, 41} true;
  assume {:verifier.code 0} true;
  $i97 := $sub.i32($i94,1);
  $i97.shadow := $sub.i32($i94.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 134, 46} true;
  assume {:verifier.code 0} true;
  $i98 := $lshr.i32($i97,31);
  $i98.shadow := $lshr.i32($i97.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 134, 35} true;
  assume {:verifier.code 0} true;
  $i99 := $add.i32($i96,$i98);
  $i99.shadow := $add.i32($i96.shadow,$i98.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 134, 6} true;
  assume {:verifier.code 0} true;
  call $i100, $i100.shadow := MUX.16($i95, $i95.shadow, 32767, 32767, $i99, $i99.shadow);
  call {:cexpr "q"} boogie_si_record_i32($i100);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 147, 7} true;
  assume {:verifier.code 0} true;
  $i101 := 1;
  $i101.shadow := 1;
  $i102 := 0;
...
$bb9:
  ...
  assert {:unlikely_shadow_invariant ($i103 == $i103.shadow)} true;
  assert {:unlikely_shadow_invariant ($i100 == $i100.shadow)} true;
  assert {:unlikely_shadow_invariant ($i102 == $i102.shadow)} true;
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 147, 16} true;
  assume {:verifier.code 0} true;
  $i104 := $ule.i64($i101,$i24);
  $i104.shadow := $ule.i64($i101.shadow,$i24.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 147, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i104} true;
  assert ($i104 == $i104.shadow);
  goto $bb10, $bb11;
$bb10:
  assume ($i104 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 150, 8} true;
  assume {:verifier.code 0} true;
  $p105 := $add.ref($p2,$mul.ref($i101,2));
  $p105.shadow := $add.ref($p2.shadow,$mul.ref($i101.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 150, 8} true;
  assume {:verifier.code 0} true;
  assert ($p105 == $p105.shadow);
  $i106 := $load.i16($M.0,$p105);
  $i106.shadow := $load.i16($M.0.shadow,$p105.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 150, 8} true;
  assume {:verifier.code 0} true;
  $i107 := $zext.i16.i32($i106);
  $i107.shadow := $zext.i16.i32($i106.shadow);
  call {:cexpr "mw"} boogie_si_record_i32($i107);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 151, 8} true;
  assume {:verifier.code 0} true;
  $i108 := $mul.i32($i107,$i100);
  $i108.shadow := $mul.i32($i107.shadow,$i100.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 151, 21} true;
  assume {:verifier.code 0} true;
  $i109 := $add.i32($i108,$i102);
  $i109.shadow := $add.i32($i108.shadow,$i102.shadow);
  call {:cexpr "zl"} boogie_si_record_i32($i109);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 152, 11} true;
  assume {:verifier.code 0} true;
  $i110 := $lshr.i32($i109,15);
  $i110.shadow := $lshr.i32($i109.shadow,15);
  call {:cexpr "cc"} boogie_si_record_i32($i110);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 153, 6} true;
  assume {:verifier.code 0} true;
  $i111 := $and.i32($i109,32767);
  $i111.shadow := $and.i32($i109.shadow,32767);
  call {:cexpr "zl"} boogie_si_record_i32($i111);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 154, 8} true;
  assume {:verifier.code 0} true;
  $p112 := $add.ref($p0,$mul.ref($i101,2));
  $p112.shadow := $add.ref($p0.shadow,$mul.ref($i101.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 154, 8} true;
  assume {:verifier.code 0} true;
  assert ($p112 == $p112.shadow);
  $i113 := $load.i16($M.0,$p112);
  $i113.shadow := $load.i16($M.0.shadow,$p112.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 154, 8} true;
  assume {:verifier.code 0} true;
  $i114 := $zext.i16.i32($i113);
  $i114.shadow := $zext.i16.i32($i113.shadow);
  call {:cexpr "xw"} boogie_si_record_i32($i114);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 155, 12} true;
  assume {:verifier.code 0} true;
  $i115 := $sub.i32($i114,$i111);
  $i115.shadow := $sub.i32($i114.shadow,$i111.shadow);
  call {:cexpr "nxw"} boogie_si_record_i32($i115);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 156, 13} true;
  assume {:verifier.code 0} true;
  $i116 := $lshr.i32($i115,31);
  $i116.shadow := $lshr.i32($i115.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 156, 6} true;
  assume {:verifier.code 0} true;
  $i117 := $add.i32($i110,$i116);
  $i117.shadow := $add.i32($i110.shadow,$i116.shadow);
  call {:cexpr "cc"} boogie_si_record_i32($i117);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 157, 7} true;
  assume {:verifier.code 0} true;
  $i118 := $and.i32($i115,32767);
  $i118.shadow := $and.i32($i115.shadow,32767);
  call {:cexpr "nxw"} boogie_si_record_i32($i118);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 158, 10} true;
  assume {:verifier.code 0} true;
  $i119 := $trunc.i32.i16($i118);
  $i119.shadow := $trunc.i32.i16($i118.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $p120 := $add.ref($p0,$mul.ref($i101,2));
  $p120.shadow := $add.ref($p0.shadow,$mul.ref($i101.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 158, 8} true;
  assume {:verifier.code 0} true;
  assert ($p120 == $p120.shadow);
  $M.0 := $store.i16($M.0,$p120,$i119);
  $M.0.shadow := $store.i16($M.0.shadow,$p120.shadow,$i119.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 159, 12} true;
  assume {:verifier.code 0} true;
  call $i121, $i121.shadow := EQ.15($i118, $i118.shadow, $i107, $i107.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 159, 29} true;
  assume {:verifier.code 0} true;
  call $i122, $i122.shadow := GT.17($i118, $i118.shadow, $i107, $i107.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 159, 8} true;
  assume {:verifier.code 0} true;
  call $i123, $i123.shadow := MUX.16($i121, $i121.shadow, $i103, $i103.shadow, $i122, $i122.shadow);
  call {:cexpr "tb"} boogie_si_record_i32($i123);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 160, 2} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb11:
  assume !($i104 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 169, 9} true;
  assume {:verifier.code 0} true;
  call $i125, $i125.shadow := GT.17($i102, $i102.shadow, $i28, $i28.shadow);
  call {:cexpr "over"} boogie_si_record_i32($i125);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 170, 10} true;
  assume {:verifier.code 0} true;
  $i126 := $xor.i32($i125,$sub.i32(0,1));
  $i126.shadow := $xor.i32($i125.shadow,$sub.i32(0,1));
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 170, 24} true;
  assume {:verifier.code 0} true;
  call $i127, $i127.shadow := GT.17($i28, $i28.shadow, $i102, $i102.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 170, 22} true;
  assume {:verifier.code 0} true;
  $i128 := $or.i32($i103,$i127);
  $i128.shadow := $or.i32($i103.shadow,$i127.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 170, 16} true;
  assume {:verifier.code 0} true;
  $i129 := $and.i32($i126,$i128);
  $i129.shadow := $and.i32($i126.shadow,$i128.shadow);
  call {:cexpr "under"} boogie_si_record_i32($i129);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 171, 2} true;
  assume {:verifier.code 0} true;
  call $i130, $i130.shadow := br_i15_add($p0, $p0.shadow, $p2, $p2.shadow, $i125, $i125.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 172, 2} true;
  assume {:verifier.code 0} true;
  call $i131, $i131.shadow := br_i15_sub($p0, $p0.shadow, $p2, $p2.shadow, $i129, $i129.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 173, 1} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb12:
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 147, 27} true;
  assume {:verifier.code 0} true;
  $i124 := $add.i64($i101,1);
  $i124.shadow := $add.i64($i101.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i124);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 147, 2} true;
  assume {:verifier.code 0} true;
  $i101 := $i124;
  $i101.shadow := $i124.shadow;
  $i102 := $i117;
  $i102.shadow := $i117.shadow;
  $i103 := $i123;
  $i103.shadow := $i123.shadow;
  goto $bb9;
}
const divrem16: ref;
axiom (divrem16 == $sub.ref(0,27864));
procedure {:inline 1} divrem16($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $p2: ref, $p2.shadow: ref) returns ($r: i32, $r.shadow: i32)
modifies $M.13, $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
  ...
  var $i18.shadow: i1;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 38, 4} true;
  assume {:verifier.code 0} true;
  call {:cexpr "divrem16:arg:x"} boogie_si_record_i32($i0);
  call {:cexpr "divrem16:arg:d"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 38, 4} true;
  assume {:verifier.code 0} true;
  $i3 := $shl.i32($i1,16);
  $i3.shadow := $shl.i32($i1.shadow,16);
  call {:cexpr "d"} boogie_si_record_i32($i3);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 39, 7} true;
  assume {:verifier.code 0} true;
  $i4 := 16;
  $i4.shadow := 16;
  $i5 := 0;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 39, 17} true;
  assume {:verifier.code 0} true;
  $i8 := $sge.i32($i4,0);
  $i8.shadow := $sge.i32($i4.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 39, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  assert ($i8 == $i8.shadow);
  goto $bb2, $bb3;
$bb2:
  assume ($i8 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 42, 9} true;
  assume {:verifier.code 0} true;
  call $i9, $i9.shadow := GT.17($i6, $i6.shadow, $i7, $i7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 42, 9} true;
  assume {:verifier.code 0} true;
  call $i10, $i10.shadow := NOT.18($i9, $i9.shadow);
  call {:cexpr "ctl"} boogie_si_record_i32($i10);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 43, 12} true;
  assume {:verifier.code 0} true;
  $i11 := $shl.i32($i10,$i4);
  $i11.shadow := $shl.i32($i10.shadow,$i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 43, 5} true;
  assume {:verifier.code 0} true;
  $i12 := $or.i32($i5,$i11);
  $i12.shadow := $or.i32($i5.shadow,$i11.shadow);
  call {:cexpr "q"} boogie_si_record_i32($i12);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 44, 9} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i32(0,$i10);
  $i13.shadow := $sub.i32(0,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 44, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $and.i32($i13,$i6);
  $i14.shadow := $and.i32($i13.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 44, 5} true;
  assume {:verifier.code 0} true;
  $i15 := $sub.i32($i7,$i14);
  $i15.shadow := $sub.i32($i7.shadow,$i14.shadow);
  call {:cexpr "x"} boogie_si_record_i32($i15);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 45, 5} true;
  assume {:verifier.code 0} true;
  $i16 := $lshr.i32($i6,1);
  $i16.shadow := $lshr.i32($i6.shadow,1);
  call {:cexpr "d"} boogie_si_record_i32($i16);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 46, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i8 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $i18 := $ne.ref($p2,$0.ref);
  $i18.shadow := $ne.ref($p2.shadow,$0.ref);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 47, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i18} true;
  assert ($i18 == $i18.shadow);
  goto $bb5, $bb6;
$bb4:
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 39, 25} true;
  assume {:verifier.code 0} true;
  ...
  $i6 := $i16;
  $i6.shadow := $i16.shadow;
  $i7 := $i15;
  $i7.shadow := $i15.shadow;
  goto $bb1;
$bb5:
  assume ($i18 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 48, 6} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $M.13 := $store.i32($M.13,$p2,$i7);
  $M.13.shadow := $store.i32($M.13.shadow,$p2.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 49, 2} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 47, 6} true;
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "../BearSSL/src/int/i15_muladd.c", 50, 2} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $r.shadow := $i5.shadow;
  $exn := false;
...
const EQ.15: ref;
axiom (EQ.15 == $sub.ref(0,28896));
procedure {:inline 1} EQ.15($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "EQ.15:arg:x"} boogie_si_record_i32($i0);
  call {:cexpr "EQ.15:arg:y"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 783, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i32($i0,$i1);
  $i2.shadow := $xor.i32($i0.shadow,$i1.shadow);
  ...
  assume {:verifier.code 0} true;
  call $i6, $i6.shadow := NOT.18($i5, $i5.shadow);
...
const MUX.16: ref;
axiom (MUX.16 == $sub.ref(0,29928));
procedure {:inline 1} MUX.16($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "MUX.16:arg:ctl"} boogie_si_record_i32($i0);
  call {:cexpr "MUX.16:arg:x"} boogie_si_record_i32($i1);
  call {:cexpr "MUX.16:arg:y"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0,$i0);
  $i3.shadow := $sub.i32(0,$i0.shadow);
...
const GT.17: ref;
axiom (GT.17 == $sub.ref(0,30960));
procedure {:inline 1} GT.17($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "GT.17:arg:x"} boogie_si_record_i32($i0);
  call {:cexpr "GT.17:arg:y"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 819, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32($i1,$i0);
...
const NOT.18: ref;
axiom (NOT.18 == $sub.ref(0,31992));
procedure {:inline 1} NOT.18($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "NOT.18:arg:ctl"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $xor.i32($i0,1);
  $i1.shadow := $xor.i32($i0.shadow,1);
...
const MUX.24: ref;
axiom (MUX.24 == $sub.ref(0,34056));
procedure {:inline 1} MUX.24($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "MUX.24:arg:ctl"} boogie_si_record_i32($i0);
  call {:cexpr "MUX.24:arg:x"} boogie_si_record_i32($i1);
  call {:cexpr "MUX.24:arg:y"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0,$i0);
  $i3.shadow := $sub.i32(0,$i0.shadow);
...
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0,35088));
...
const br_i15_zero.4: ref;
axiom (br_i15_zero.4 == $sub.ref(0,36120));
procedure {:inline 1} br_i15_zero.4($p0: ref, $p0.shadow: ref, $i1: i16, $i1.shadow: i16)
modifies $M.0, $exn;
{
  var $p2: ref;
  var $p2.shadow: ref;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 1539, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_zero.4:arg:bit_len"} boogie_si_record_i16($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1539, 5} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p0,$mul.ref(1,2));
  $p2.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
...
const EQ.5: ref;
axiom (EQ.5 == $sub.ref(0,37152));
procedure {:inline 1} EQ.5($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 783, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "EQ.5:arg:x"} boogie_si_record_i32($i0);
  call {:cexpr "EQ.5:arg:y"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 783, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i32($i0,$i1);
  $i2.shadow := $xor.i32($i0.shadow,$i1.shadow);
  ...
  assume {:sourceloc "../BearSSL/src/inner.h", 784, 9} true;
  assume {:verifier.code 0} true;
  call $i6, $i6.shadow := NOT.7($i5, $i5.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 784, 2} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $r.shadow := $i6.shadow;
...
const NEQ.6: ref;
axiom (NEQ.6 == $sub.ref(0,38184));
procedure {:inline 1} NEQ.6($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 795, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "NEQ.6:arg:x"} boogie_si_record_i32($i0);
  call {:cexpr "NEQ.6:arg:y"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 795, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i32($i0,$i1);
  $i2.shadow := $xor.i32($i0.shadow,$i1.shadow);
...
const br_i15_from_monty: ref;
axiom (br_i15_from_monty == $sub.ref(0,39216));
procedure {:inline 1} br_i15_from_monty($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i16, $i2.shadow: i16)
modifies $exn, $M.0;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $i42.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 33, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_from_monty:arg:m0i"} boogie_si_record_i16($i2);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 33, 9} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p1,$mul.ref(0,2));
  $p3.shadow := $add.ref($p1.shadow,$mul.ref(0,2));
  ...
  $i5 := $zext.i16.i32($i4);
  $i5.shadow := $zext.i16.i32($i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 33, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i5,15);
  $i6.shadow := $add.i32($i5.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 33, 20} true;
  assume {:verifier.code 0} true;
  $i7 := $ashr.i32($i6,4);
  $i7.shadow := $ashr.i32($i6.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 33, 8} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i7);
  $i8.shadow := $sext.i32.i64($i7.shadow);
  call {:cexpr "len"} boogie_si_record_i64($i8);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 34, 7} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  $i9.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 34, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i64($i9,$i8);
  $i10.shadow := $ult.i64($i9.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 34, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  assert ($i10 == $i10.shadow);
  goto $bb2, $bb3;
$bb2:
  assume ($i10 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 37, 7} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p0,$mul.ref(1,2));
  $p11.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 37, 7} true;
  assume {:verifier.code 0} true;
  assert ($p11 == $p11.shadow);
  $i12 := $load.i16($M.0,$p11);
  $i12.shadow := $load.i16($M.0.shadow,$p11.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 37, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i14 := $zext.i16.i32($i2);
  $i14.shadow := $zext.i16.i32($i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 37, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $mul.i32($i13,$i14);
  $i15.shadow := $mul.i32($i13.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 37, 24} true;
  assume {:verifier.code 0} true;
  $i16 := $and.i32($i15,32767);
  $i16.shadow := $and.i32($i15.shadow,32767);
  call {:cexpr "f"} boogie_si_record_i32($i16);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 39, 8} true;
  assume {:verifier.code 0} true;
  $i17 := 0;
  $i17.shadow := 0;
  $i18 := 0;
...
$bb3:
  assume !($i10 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 58, 23} true;
  assume {:verifier.code 0} true;
  call $i40, $i40.shadow := br_i15_sub($p0, $p0.shadow, $p1, $p1.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 58, 19} true;
  assume {:verifier.code 0} true;
  call $i41, $i41.shadow := NOT.3($i40, $i40.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 58, 2} true;
  assume {:verifier.code 0} true;
  call $i42, $i42.shadow := br_i15_sub($p0, $p0.shadow, $p1, $p1.shadow, $i41, $i41.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 59, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 39, 17} true;
  assume {:verifier.code 0} true;
  $i19 := $ult.i64($i17,$i8);
  $i19.shadow := $ult.i64($i17.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 39, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i19} true;
  assert ($i19 == $i19.shadow);
  goto $bb5, $bb6;
$bb5:
  assume ($i19 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 42, 22} true;
  assume {:verifier.code 0} true;
  $i20 := $add.i64($i17,1);
  $i20.shadow := $add.i64($i17.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 42, 18} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p0,$mul.ref($i20,2));
  $p21.shadow := $add.ref($p0.shadow,$mul.ref($i20.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 42, 18} true;
  assume {:verifier.code 0} true;
  assert ($p21 == $p21.shadow);
  $i22 := $load.i16($M.0,$p21);
  $i22.shadow := $load.i16($M.0.shadow,$p21.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 42, 8} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i16.i32($i22);
  $i23.shadow := $zext.i16.i32($i22.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 42, 29} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i64($i17,1);
  $i24.shadow := $add.i64($i17.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 42, 29} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($p1,$mul.ref($i24,2));
  $p25.shadow := $add.ref($p1.shadow,$mul.ref($i24.shadow,2));
  ...
  assume {:verifier.code 0} true;
  $i28 := $mul.i32($i16,$i27);
  $i28.shadow := $mul.i32($i16.shadow,$i27.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 42, 27} true;
  assume {:verifier.code 0} true;
  $i29 := $add.i32($i23,$i28);
  $i29.shadow := $add.i32($i23.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 42, 48} true;
  assume {:verifier.code 0} true;
  $i30 := $add.i32($i29,$i18);
  $i30.shadow := $add.i32($i29.shadow,$i18.shadow);
  call {:cexpr "z"} boogie_si_record_i32($i30);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 43, 11} true;
  assume {:verifier.code 0} true;
  $i31 := $lshr.i32($i30,15);
  $i31.shadow := $lshr.i32($i30.shadow,15);
  call {:cexpr "cc"} boogie_si_record_i32($i31);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 44, 10} true;
  assume {:verifier.code 0} true;
  $i32 := $ne.i64($i17,0);
  $i32.shadow := $ne.i64($i17.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 44, 8} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !($i19 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 48, 12} true;
  assume {:verifier.code 0} true;
  $i37 := $trunc.i32.i16($i18);
  $i37.shadow := $trunc.i32.i16($i18.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 48, 3} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p0,$mul.ref($i8,2));
  $p38.shadow := $add.ref($p0.shadow,$mul.ref($i8.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 48, 10} true;
  assume {:verifier.code 0} true;
  assert ($p38 == $p38.shadow);
  $M.0 := $store.i16($M.0,$p38,$i37);
  $M.0.shadow := $store.i16($M.0.shadow,$p38.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 49, 2} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb7:
  assume ($i32 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 45, 14} true;
  assume {:verifier.code 0} true;
  $i33 := $and.i32($i30,32767);
  $i33.shadow := $and.i32($i30.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 45, 12} true;
  assume {:verifier.code 0} true;
  $i34 := $trunc.i32.i16($i33);
  $i34.shadow := $trunc.i32.i16($i33.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 45, 5} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($p0,$mul.ref($i17,2));
  $p35.shadow := $add.ref($p0.shadow,$mul.ref($i17.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 45, 10} true;
  assume {:verifier.code 0} true;
  assert ($p35 == $p35.shadow);
  $M.0 := $store.i16($M.0,$p35,$i34);
  $M.0.shadow := $store.i16($M.0.shadow,$p35.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 46, 4} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 44, 8} true;
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 47, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 39, 26} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i64($i17,1);
  $i36.shadow := $add.i64($i17.shadow,1);
  call {:cexpr "v"} boogie_si_record_i64($i36);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 39, 3} true;
  assume {:verifier.code 0} true;
  $i17 := $i36;
  $i17.shadow := $i36.shadow;
  $i18 := $i31;
  $i18.shadow := $i31.shadow;
  goto $bb4;
$bb11:
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 34, 25} true;
  assume {:verifier.code 0} true;
  $i39 := $add.i64($i9,1);
  $i39.shadow := $add.i64($i9.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i39);
  assume {:sourceloc "../BearSSL/src/int/i15_fmont.c", 34, 2} true;
  assume {:verifier.code 0} true;
  $i9 := $i39;
  $i9.shadow := $i39.shadow;
  goto $bb1;
}
const NOT.3: ref;
axiom (NOT.3 == $sub.ref(0,40248));
procedure {:inline 1} NOT.3($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "NOT.3:arg:ctl"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $xor.i32($i0,1);
  $i1.shadow := $xor.i32($i0.shadow,1);
...
const NOT.7: ref;
axiom (NOT.7 == $sub.ref(0,41280));
procedure {:inline 1} NOT.7($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "NOT.7:arg:ctl"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $xor.i32($i0,1);
  $i1.shadow := $xor.i32($i0.shadow,1);
...
axiom (br_i15_zero == $sub.ref(0,42312));
...
const br_i15_rshift: ref;
axiom (br_i15_rshift == $sub.ref(0,43344));
procedure {:inline 1} br_i15_rshift($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32)
modifies $exn, $M.0;
{
  var $p2: ref;
  var $p2.shadow: ref;
  ...
  var $p29.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 34, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_rshift:arg:count"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 34, 9} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p0,$mul.ref(0,2));
  $p2.shadow := $add.ref($p0.shadow,$mul.ref(0,2));
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 34, 9} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $i3 := $load.i16($M.0,$p2);
  ...
  $i4 := $zext.i16.i32($i3);
  $i4.shadow := $zext.i16.i32($i3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 34, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i4,15);
  $i5.shadow := $add.i32($i4.shadow,15);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 34, 20} true;
  assume {:verifier.code 0} true;
  $i6 := $ashr.i32($i5,4);
  $i6.shadow := $ashr.i32($i5.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 34, 8} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i6);
  $i7.shadow := $sext.i32.i64($i6.shadow);
  call {:cexpr "len"} boogie_si_record_i64($i7);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 35, 10} true;
  assume {:verifier.code 0} true;
  $i8 := $eq.i64($i7,0);
  $i8.shadow := $eq.i64($i7.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 35, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  assert ($i8 == $i8.shadow);
  goto $bb1, $bb2;
$bb1:
  assume ($i8 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 36, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !($i8 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 38, 6} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(1,2));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(1,2));
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 38, 6} true;
  ...
  $i11 := $zext.i16.i32($i10);
  $i11.shadow := $zext.i16.i32($i10.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 38, 11} true;
  assume {:verifier.code 0} true;
  $i12 := $ashr.i32($i11,$i1);
  $i12.shadow := $ashr.i32($i11.shadow,$i1.shadow);
  call {:cexpr "r"} boogie_si_record_i32($i12);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 39, 7} true;
  assume {:verifier.code 0} true;
  $i13 := 2;
  $i13.shadow := 2;
  $i14 := $i12;
  ...
  goto $bb4;
$bb3:
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 47, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  ...
  assert {:shadow_invariant} ($i13 == $i13.shadow);
  assert {:shadow_invariant} ($i7 == $i7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 39, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $ule.i64($i13,$i7);
  $i15.shadow := $ule.i64($i13.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 39, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  assert ($i15 == $i15.shadow);
  goto $bb5, $bb6;
$bb5:
  assume ($i15 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 42, 7} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p0,$mul.ref($i13,2));
  $p16.shadow := $add.ref($p0.shadow,$mul.ref($i13.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 42, 7} true;
  assume {:verifier.code 0} true;
  assert ($p16 == $p16.shadow);
  $i17 := $load.i16($M.0,$p16);
  $i17.shadow := $load.i16($M.0.shadow,$p16.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 42, 7} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i16.i32($i17);
  $i18.shadow := $zext.i16.i32($i17.shadow);
  call {:cexpr "w"} boogie_si_record_i32($i18);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 43, 25} true;
  assume {:verifier.code 0} true;
  $i19 := $sub.i32(15,$i1);
  $i19.shadow := $sub.i32(15,$i1.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 43, 18} true;
  assume {:verifier.code 0} true;
  $i20 := $shl.i32($i18,$i19);
  $i20.shadow := $shl.i32($i18.shadow,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 43, 35} true;
  assume {:verifier.code 0} true;
  $i21 := $or.i32($i20,$i14);
  $i21.shadow := $or.i32($i20.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 43, 40} true;
  assume {:verifier.code 0} true;
  $i22 := $and.i32($i21,32767);
  $i22.shadow := $and.i32($i21.shadow,32767);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 43, 14} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i32.i16($i22);
  $i23.shadow := $trunc.i32.i16($i22.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $i24 := $sub.i64($i13,1);
  $i24.shadow := $sub.i64($i13.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($p0,$mul.ref($i24,2));
  $p25.shadow := $add.ref($p0.shadow,$mul.ref($i24.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 43, 12} true;
  assume {:verifier.code 0} true;
  assert ($p25 == $p25.shadow);
  $M.0 := $store.i16($M.0,$p25,$i23);
  $M.0.shadow := $store.i16($M.0.shadow,$p25.shadow,$i23.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 44, 9} true;
  assume {:verifier.code 0} true;
  $i26 := $lshr.i32($i18,$i1);
  $i26.shadow := $lshr.i32($i18.shadow,$i1.shadow);
  call {:cexpr "r"} boogie_si_record_i32($i26);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 45, 2} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !($i15 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 46, 11} true;
  assume {:verifier.code 0} true;
  $i28 := $trunc.i32.i16($i14);
  $i28.shadow := $trunc.i32.i16($i14.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 46, 2} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p0,$mul.ref($i7,2));
  $p29.shadow := $add.ref($p0.shadow,$mul.ref($i7.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 46, 9} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $M.0 := $store.i16($M.0,$p29,$i28);
  $M.0.shadow := $store.i16($M.0.shadow,$p29.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 47, 1} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 39, 26} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i64($i13,1);
  $i27.shadow := $add.i64($i13.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i27);
  assume {:sourceloc "../BearSSL/src/int/i15_rshift.c", 39, 2} true;
  assume {:verifier.code 0} true;
  $i13 := $i27;
  $i13.shadow := $i27.shadow;
  $i14 := $i26;
  $i14.shadow := $i26.shadow;
  goto $bb4;
}
const MUX.19: ref;
axiom (MUX.19 == $sub.ref(0,44376));
procedure {:inline 1} MUX.19($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "MUX.19:arg:ctl"} boogie_si_record_i32($i0);
  call {:cexpr "MUX.19:arg:x"} boogie_si_record_i32($i1);
  call {:cexpr "MUX.19:arg:y"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0,$i0);
  $i3.shadow := $sub.i32(0,$i0.shadow);
...
const br_i15_bit_length: ref;
axiom (br_i15_bit_length == $sub.ref(0,45408));
procedure {:inline 1} br_i15_bit_length($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
  ...
  var $i16.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 35, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i15_bit_length:arg:xlen"} boogie_si_record_i64($i1);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 35, 2} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  $i2.shadow := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 35, 14} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i64($i3,$sub.i64(0,1));
  $i5.shadow := $add.i64($i3.shadow,$sub.i64(0,1));
  call {:cexpr "xlen"} boogie_si_record_i64($i5);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 35, 17} true;
  assume {:verifier.code 0} true;
  $i6 := $ugt.i64($i3,0);
  $i6.shadow := $ugt.i64($i3.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 35, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i6 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 38, 7} true;
  assume {:verifier.code 0} true;
  call $i7, $i7.shadow := EQ($i2, $i2.shadow, 0, 0);
  call {:cexpr "c"} boogie_si_record_i32($i7);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 39, 7} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p0,$mul.ref($i5,2));
  $p8.shadow := $add.ref($p0.shadow,$mul.ref($i5.shadow,2));
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 39, 7} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $i9 := $load.i16($M.0,$p8);
  $i9.shadow := $load.i16($M.0.shadow,$p8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 39, 7} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i16.i32($i9);
  $i10.shadow := $zext.i16.i32($i9.shadow);
  call {:cexpr "w"} boogie_si_record_i32($i10);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 40, 8} true;
  assume {:verifier.code 0} true;
  call $i11, $i11.shadow := MUX.2($i7, $i7.shadow, $i10, $i10.shadow, $i2, $i2.shadow);
  call {:cexpr "tw"} boogie_si_record_i32($i11);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 41, 16} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i64.i32($i5);
  $i12.shadow := $trunc.i64.i32($i5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 41, 9} true;
  assume {:verifier.code 0} true;
  call $i13, $i13.shadow := MUX.2($i7, $i7.shadow, $i12, $i12.shadow, $i4, $i4.shadow);
  call {:cexpr "twk"} boogie_si_record_i32($i13);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 35, 2} true;
  assume {:verifier.code 0} true;
  $i2 := $i11;
...
$bb3:
  assume !($i6 == 1);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 43, 14} true;
  assume {:verifier.code 0} true;
  $i14 := $shl.i32($i4,4);
  $i14.shadow := $shl.i32($i4.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 43, 22} true;
  assume {:verifier.code 0} true;
  call $i15, $i15.shadow := BIT_LENGTH($i2, $i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 43, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i32($i14,$i15);
  $i16.shadow := $add.i32($i14.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/int/i15_bitlen.c", 43, 2} true;
  assume {:verifier.code 0} true;
  $r := $i16;
  $r.shadow := $i16.shadow;
  $exn := false;
...
const MUX.2: ref;
axiom (MUX.2 == $sub.ref(0,47472));
procedure {:inline 1} MUX.2($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "MUX.2:arg:ctl"} boogie_si_record_i32($i0);
  call {:cexpr "MUX.2:arg:x"} boogie_si_record_i32($i1);
  call {:cexpr "MUX.2:arg:y"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0,$i0);
  $i3.shadow := $sub.i32(0,$i0.shadow);
...
const BIT_LENGTH: ref;
axiom (BIT_LENGTH == $sub.ref(0,48504));
procedure {:inline 1} BIT_LENGTH($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i23.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 919, 6} true;
  assume {:verifier.code 0} true;
  call {:cexpr "BIT_LENGTH:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/inner.h", 919, 6} true;
  assume {:verifier.code 0} true;
  call $i1, $i1.shadow := NEQ($i0, $i0.shadow, 0, 0);
  call {:cexpr "k"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 920, 6} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.shadow := GT($i0, $i0.shadow, 65535, 65535);
  call {:cexpr "c"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/inner.h", 920, 34} true;
  assume {:verifier.code 0} true;
  $i3 := $lshr.i32($i0,16);
  $i3.shadow := $lshr.i32($i0.shadow,16);
  assume {:sourceloc "../BearSSL/src/inner.h", 920, 25} true;
  assume {:verifier.code 0} true;
  call $i4, $i4.shadow := MUX.2($i2, $i2.shadow, $i3, $i3.shadow, $i0, $i0.shadow);
  call {:cexpr "x"} boogie_si_record_i32($i4);
  assume {:sourceloc "../BearSSL/src/inner.h", 920, 52} true;
  assume {:verifier.code 0} true;
  $i5 := $shl.i32($i2,4);
  $i5.shadow := $shl.i32($i2.shadow,4);
  assume {:sourceloc "../BearSSL/src/inner.h", 920, 47} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1,$i5);
  $i6.shadow := $add.i32($i1.shadow,$i5.shadow);
  call {:cexpr "k"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/inner.h", 921, 6} true;
  assume {:verifier.code 0} true;
  call $i7, $i7.shadow := GT($i4, $i4.shadow, 255, 255);
  call {:cexpr "c"} boogie_si_record_i32($i7);
  assume {:sourceloc "../BearSSL/src/inner.h", 921, 34} true;
  assume {:verifier.code 0} true;
  $i8 := $lshr.i32($i4,8);
  $i8.shadow := $lshr.i32($i4.shadow,8);
  assume {:sourceloc "../BearSSL/src/inner.h", 921, 25} true;
  assume {:verifier.code 0} true;
  call $i9, $i9.shadow := MUX.2($i7, $i7.shadow, $i8, $i8.shadow, $i4, $i4.shadow);
  call {:cexpr "x"} boogie_si_record_i32($i9);
  assume {:sourceloc "../BearSSL/src/inner.h", 921, 52} true;
  assume {:verifier.code 0} true;
  $i10 := $shl.i32($i7,3);
  $i10.shadow := $shl.i32($i7.shadow,3);
  assume {:sourceloc "../BearSSL/src/inner.h", 921, 47} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i6,$i10);
  $i11.shadow := $add.i32($i6.shadow,$i10.shadow);
  call {:cexpr "k"} boogie_si_record_i32($i11);
  assume {:sourceloc "../BearSSL/src/inner.h", 922, 6} true;
  assume {:verifier.code 0} true;
  call $i12, $i12.shadow := GT($i9, $i9.shadow, 15, 15);
  call {:cexpr "c"} boogie_si_record_i32($i12);
  assume {:sourceloc "../BearSSL/src/inner.h", 922, 34} true;
  assume {:verifier.code 0} true;
  $i13 := $lshr.i32($i9,4);
  $i13.shadow := $lshr.i32($i9.shadow,4);
  assume {:sourceloc "../BearSSL/src/inner.h", 922, 25} true;
  assume {:verifier.code 0} true;
  call $i14, $i14.shadow := MUX.2($i12, $i12.shadow, $i13, $i13.shadow, $i9, $i9.shadow);
  call {:cexpr "x"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/inner.h", 922, 52} true;
  assume {:verifier.code 0} true;
  $i15 := $shl.i32($i12,2);
  $i15.shadow := $shl.i32($i12.shadow,2);
  assume {:sourceloc "../BearSSL/src/inner.h", 922, 47} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i32($i11,$i15);
  $i16.shadow := $add.i32($i11.shadow,$i15.shadow);
  call {:cexpr "k"} boogie_si_record_i32($i16);
  assume {:sourceloc "../BearSSL/src/inner.h", 923, 6} true;
  assume {:verifier.code 0} true;
  call $i17, $i17.shadow := GT($i14, $i14.shadow, 3, 3);
  call {:cexpr "c"} boogie_si_record_i32($i17);
  assume {:sourceloc "../BearSSL/src/inner.h", 923, 34} true;
  assume {:verifier.code 0} true;
  $i18 := $lshr.i32($i14,2);
  $i18.shadow := $lshr.i32($i14.shadow,2);
  assume {:sourceloc "../BearSSL/src/inner.h", 923, 25} true;
  assume {:verifier.code 0} true;
  call $i19, $i19.shadow := MUX.2($i17, $i17.shadow, $i18, $i18.shadow, $i14, $i14.shadow);
  call {:cexpr "x"} boogie_si_record_i32($i19);
  assume {:sourceloc "../BearSSL/src/inner.h", 923, 52} true;
  assume {:verifier.code 0} true;
  $i20 := $shl.i32($i17,1);
  $i20.shadow := $shl.i32($i17.shadow,1);
  assume {:sourceloc "../BearSSL/src/inner.h", 923, 47} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i32($i16,$i20);
  $i21.shadow := $add.i32($i16.shadow,$i20.shadow);
  call {:cexpr "k"} boogie_si_record_i32($i21);
  assume {:sourceloc "../BearSSL/src/inner.h", 924, 7} true;
  assume {:verifier.code 0} true;
  call $i22, $i22.shadow := GT($i19, $i19.shadow, 1, 1);
  assume {:sourceloc "../BearSSL/src/inner.h", 924, 4} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i21,$i22);
  $i23.shadow := $add.i32($i21.shadow,$i22.shadow);
  call {:cexpr "k"} boogie_si_record_i32($i23);
  assume {:sourceloc "../BearSSL/src/inner.h", 925, 2} true;
  assume {:verifier.code 0} true;
  $r := $i23;
  $r.shadow := $i23.shadow;
  $exn := false;
