...
$bb16:
  ...
  assert {:shadow_invariant} ($p21 == $p21.shadow);
  assert {:shadow_invariant} ($p8 == $p8.shadow);
  assert {:likely_shadow_invariant} ($i33 == $i33.shadow);
  assert {:likely_shadow_invariant} ($p2 == $p2.shadow);
  assert {:unlikely_shadow_invariant ($i7 == $i7.shadow)} true;
  assert {:unlikely_shadow_invariant ($i20 == $i20.shadow)} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 0, 0} true;
...
$bb25:
  assert {:shadow_invariant} $shadow_ok;
  assert {:likely_shadow_invariant} ($p59 == $p59.shadow);
...
$bb6:
  ...
  assert {:unlikely_shadow_invariant ($i26 == $i26.shadow)} true;
...
$bb18:
  ...
  assert {:shadow_invariant} ($i20 == $i20.shadow);
  assert {:shadow_invariant} ($i15 == $i15.shadow);
  assert {:unlikely_shadow_invariant ($p57 == $p57.shadow)} true;
  assert {:unlikely_shadow_invariant ($i55 == $i55.shadow)} true;
...
$bb30:
  ...
  assert {:shadow_invariant} ($i20 == $i20.shadow);
  assert {:shadow_invariant} ($i15 == $i15.shadow);
  assert {:unlikely_shadow_invariant ($p65 == $p65.shadow)} true;
  assert {:unlikely_shadow_invariant ($i85 == $i85.shadow)} true;
  assert {:unlikely_shadow_invariant ($i66 == $i66.shadow)} true;
...
$bb37:
  ...
  assert {:shadow_invariant} ($i20 == $i20.shadow);
  assert {:shadow_invariant} ($i15 == $i15.shadow);
  assert {:unlikely_shadow_invariant ($i97 == $i97.shadow)} true;
  assert {:unlikely_shadow_invariant ($p65 == $p65.shadow)} true;
  assert {:unlikely_shadow_invariant ($i85 == $i85.shadow)} true;
  assert {:unlikely_shadow_invariant ($i66 == $i66.shadow)} true;
  assert {:unlikely_shadow_invariant ($i62 == $i62.shadow)} true;
