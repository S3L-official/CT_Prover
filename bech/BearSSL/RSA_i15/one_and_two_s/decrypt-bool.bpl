...
$bb16:
  ...
  assert {:shadow_invariant} ($p21.dup == 0);
  assert {:shadow_invariant} ($p8.dup == 0);
  assert {:likely_shadow_invariant} ($i33.dup == 0);
  assert {:likely_shadow_invariant} ($p2.dup == 0);
  assert {:unlikely_shadow_invariant ($i7.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i20.dup == 0)} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i15_priv.c", 0, 0} true;
...
$bb25:
  assert {:shadow_invariant} $shadow_ok;
  assert {:likely_shadow_invariant} ($p59.dup == 0);
...
$bb18:
  ...
  assert {:shadow_invariant} ($i20.dup == 0);
  assert {:shadow_invariant} ($i15.dup == 0);
  assert {:unlikely_shadow_invariant ($p57.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i55.dup == 0)} true;
...
$bb30:
  ...
  assert {:shadow_invariant} ($i20.dup == 0);
  assert {:shadow_invariant} ($i15.dup == 0);
  assert {:unlikely_shadow_invariant ($p65.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i85.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i66.dup == 0)} true;
...
$bb37:
  ...
  assert {:shadow_invariant} ($i20.dup == 0);
  assert {:shadow_invariant} ($i15.dup == 0);
  assert {:unlikely_shadow_invariant ($i97.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($p65.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i85.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i66.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i62.dup == 0)} true;
