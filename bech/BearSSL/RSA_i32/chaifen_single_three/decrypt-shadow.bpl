...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,69144));
...
$bb2:
  ...
  assert ($p6 == $p6.shadow);
  $i10 := $load.i8($M.0,$p6);
  $i10.shadow := $load.i8($M.0.shadow,$p6.shadow);
  assume {:sourceloc "../BearSSL/src/codec/ccopy.c", 39, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i8.i32($i10);
  ...
  assert ($p5 == $p5.shadow);
  $i12 := $load.i8($M.0,$p5);
  $i12.shadow := $load.i8($M.0.shadow,$p5.shadow);
  assume {:sourceloc "../BearSSL/src/codec/ccopy.c", 40, 7} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i8.i32($i12);
  ...
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $M.0 := $store.i8($M.0,$p5,$i15);
  $M.0.shadow := $store.i8($M.0.shadow,$p5.shadow,$i15.shadow);
...
axiom (decrypt_wrapper == $sub.ref(0,4128));
procedure {:entrypoint} decrypt_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
requires {:public_in $p0} true;
requires {:public_in $p1} true;
requires {:public_in $load.i64, $M.1, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(8,1)), 8} true;
requires {:public_in $load.i64, $M.2, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(24,1)), 8} true;
requires {:public_in $load.i64, $M.3, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(40,1)), 8} true;
requires {:public_in $load.i64, $M.4, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(56,1)), 8} true;
requires {:public_in $load.i64, $M.5, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(72,1)), 8} true;
requires {:public_in $load.i64, $M.6, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(16,1)), 8} true;
requires {:public_in $load.i64, $M.7, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(32,1)), 8} true;
requires {:public_in $load.i64, $M.8, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(48,1)), 8} true;
requires {:public_in $load.i64, $M.9, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(64,1)), 8} true;
requires {:public_in $load.i64, $M.10, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(80,1)), 8} true;
requires {:public_in $load.i32, $M.11, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(0,1)), 4} true;
modifies $exn;
modifies $CurrAddr;
modifies $M.0;
requires ($p0 == $p0.shadow);
requires ($p1 == $p1.shadow);
requires ($load.i64($M.1,$add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(8,1))) == $load.i64($M.1.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(8,1))));
requires ($load.i64($M.2,$add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(24,1))) == $load.i64($M.2.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(24,1))));
requires ($load.i64($M.3,$add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(40,1))) == $load.i64($M.3.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(40,1))));
requires ($load.i64($M.4,$add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(56,1))) == $load.i64($M.4.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(56,1))));
requires ($load.i64($M.5,$add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(72,1))) == $load.i64($M.5.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(72,1))));
requires ($load.i64($M.6,$add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(16,1))) == $load.i64($M.6.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(16,1))));
requires ($load.i64($M.7,$add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(32,1))) == $load.i64($M.7.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(32,1))));
requires ($load.i64($M.8,$add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(48,1))) == $load.i64($M.8.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(48,1))));
requires ($load.i64($M.9,$add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(64,1))) == $load.i64($M.9.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(64,1))));
requires ($load.i64($M.10,$add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(80,1))) == $load.i64($M.10.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(80,1))));
requires ($load.i32($M.11,$add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(0,1))) == $load.i32($M.11.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(0,1))));
{
  var $p2: ref;
  var $p2.shadow: ref;
  var $p3: ref;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "decrypt.c", 4, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:decrypt_wrapper"} boogie_si_record_ref(decrypt_wrapper);
  call {:cexpr "smack:arg:decrypt_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:decrypt_wrapper:$p1"} boogie_si_record_ref($p1);
  assume {:sourceloc "decrypt.c", 4, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p0} $p2 := __SMACK_value.ref($p0);
  $p2.shadow := $p2;
  assume $isExternal($p2);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p2);
  assume {:sourceloc "decrypt.c", 4, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p2, $p2.shadow);
  assume {:sourceloc "decrypt.c", 5, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p3 := __SMACK_value.ref($p1);
  $p3.shadow := $p3;
  assume $isExternal($p3);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p3);
  assume {:sourceloc "decrypt.c", 5, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p3, $p3.shadow);
  assume {:sourceloc "decrypt.c", 6, 30} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(8,1));
  $p4.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(8,1));
  assume {:sourceloc "decrypt.c", 6, 30} true;
  assume {:verifier.code 0} true;
  assert ($p4 == $p4.shadow);
  $p5 := $load.ref($M.1,$p4);
  $p5.shadow := $load.ref($M.1.shadow,$p4.shadow);
  assume {:sourceloc "decrypt.c", 6, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.1, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(8,1)), 8} $p6 := __SMACK_value.ref($p5);
  $p6.shadow := $p6;
  ...
  assume {:sourceloc "decrypt.c", 7, 30} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(24,1));
  $p7.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(24,1));
  assume {:sourceloc "decrypt.c", 7, 30} true;
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $p8 := $load.ref($M.2,$p7);
  $p8.shadow := $load.ref($M.2.shadow,$p7.shadow);
  assume {:sourceloc "decrypt.c", 7, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.2, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(24,1)), 8} $p9 := __SMACK_value.ref($p8);
  $p9.shadow := $p9;
  ...
  assume {:sourceloc "decrypt.c", 8, 30} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(40,1));
  $p10.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(40,1));
  assume {:sourceloc "decrypt.c", 8, 30} true;
  assume {:verifier.code 0} true;
  assert ($p10 == $p10.shadow);
  $p11 := $load.ref($M.3,$p10);
  $p11.shadow := $load.ref($M.3.shadow,$p10.shadow);
  assume {:sourceloc "decrypt.c", 8, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.3, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(40,1)), 8} $p12 := __SMACK_value.ref($p11);
  $p12.shadow := $p12;
  ...
  assume {:sourceloc "decrypt.c", 9, 30} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(56,1));
  $p13.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(56,1));
  assume {:sourceloc "decrypt.c", 9, 30} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  $p14 := $load.ref($M.4,$p13);
  $p14.shadow := $load.ref($M.4.shadow,$p13.shadow);
  assume {:sourceloc "decrypt.c", 9, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.4, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(56,1)), 8} $p15 := __SMACK_value.ref($p14);
  $p15.shadow := $p15;
  assume $isExternal($p15);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p15);
  assume {:sourceloc "decrypt.c", 9, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p15, $p15.shadow);
  assume {:sourceloc "decrypt.c", 10, 30} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(72,1));
  $p16.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(72,1));
  assume {:sourceloc "decrypt.c", 10, 30} true;
  assume {:verifier.code 0} true;
  assert ($p16 == $p16.shadow);
  $p17 := $load.ref($M.5,$p16);
  $p17.shadow := $load.ref($M.5.shadow,$p16.shadow);
  assume {:sourceloc "decrypt.c", 10, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.5, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(72,1)), 8} $p18 := __SMACK_value.ref($p17);
  $p18.shadow := $p18;
  assume $isExternal($p18);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p18);
  assume {:sourceloc "decrypt.c", 10, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p18, $p18.shadow);
  assume {:sourceloc "decrypt.c", 12, 30} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(16,1));
  $p19.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(16,1));
  assume {:sourceloc "decrypt.c", 12, 30} true;
  assume {:verifier.code 0} true;
  assert ($p19 == $p19.shadow);
  $i20 := $load.i64($M.6,$p19);
  $i20.shadow := $load.i64($M.6.shadow,$p19.shadow);
  assume {:sourceloc "decrypt.c", 12, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.6, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(16,1)), 8} $p21 := __SMACK_value.i64($i20);
  $p21.shadow := $p21;
  assume $isExternal($p21);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p21);
  assume {:sourceloc "decrypt.c", 12, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p21, $p21.shadow);
  assume {:sourceloc "decrypt.c", 13, 30} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(32,1));
  $p22.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(32,1));
  assume {:sourceloc "decrypt.c", 13, 30} true;
  assume {:verifier.code 0} true;
  assert ($p22 == $p22.shadow);
  $i23 := $load.i64($M.7,$p22);
  $i23.shadow := $load.i64($M.7.shadow,$p22.shadow);
  assume {:sourceloc "decrypt.c", 13, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.7, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(32,1)), 8} $p24 := __SMACK_value.i64($i23);
  $p24.shadow := $p24;
  assume $isExternal($p24);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p24);
  assume {:sourceloc "decrypt.c", 13, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p24, $p24.shadow);
  assume {:sourceloc "decrypt.c", 14, 30} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(48,1));
  $p25.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(48,1));
  assume {:sourceloc "decrypt.c", 14, 30} true;
  assume {:verifier.code 0} true;
  assert ($p25 == $p25.shadow);
  $i26 := $load.i64($M.8,$p25);
  $i26.shadow := $load.i64($M.8.shadow,$p25.shadow);
  assume {:sourceloc "decrypt.c", 14, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.8, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(48,1)), 8} $p27 := __SMACK_value.i64($i26);
  $p27.shadow := $p27;
  assume $isExternal($p27);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p27);
  assume {:sourceloc "decrypt.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p27, $p27.shadow);
  assume {:sourceloc "decrypt.c", 15, 30} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(64,1));
  $p28.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(64,1));
  assume {:sourceloc "decrypt.c", 15, 30} true;
  assume {:verifier.code 0} true;
  assert ($p28 == $p28.shadow);
  $i29 := $load.i64($M.9,$p28);
  $i29.shadow := $load.i64($M.9.shadow,$p28.shadow);
  assume {:sourceloc "decrypt.c", 15, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.9, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(64,1)), 8} $p30 := __SMACK_value.i64($i29);
  $p30.shadow := $p30;
  assume $isExternal($p30);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p30);
  assume {:sourceloc "decrypt.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p30, $p30.shadow);
  assume {:sourceloc "decrypt.c", 16, 30} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(80,1));
  $p31.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(80,1));
  assume {:sourceloc "decrypt.c", 16, 30} true;
  assume {:verifier.code 0} true;
  assert ($p31 == $p31.shadow);
  $i32 := $load.i64($M.10,$p31);
  $i32.shadow := $load.i64($M.10.shadow,$p31.shadow);
  assume {:sourceloc "decrypt.c", 16, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.10, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(80,1)), 8} $p33 := __SMACK_value.i64($i32);
  $p33.shadow := $p33;
  assume $isExternal($p33);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p33);
  assume {:sourceloc "decrypt.c", 16, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p33, $p33.shadow);
  assume {:sourceloc "decrypt.c", 18, 30} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(0,1));
  $p34.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(0,1));
  assume {:sourceloc "decrypt.c", 18, 30} true;
  assume {:verifier.code 0} true;
  assert ($p34 == $p34.shadow);
  $i35 := $load.i32($M.11,$p34);
  $i35.shadow := $load.i32($M.11.shadow,$p34.shadow);
  assume {:sourceloc "decrypt.c", 18, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i32", $M.11, $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(0,1)), 4} $p36 := __SMACK_value.i32($i35);
  $p36.shadow := $p36;
  assume $isExternal($p36);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p36);
  assume {:sourceloc "decrypt.c", 18, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p36, $p36.shadow);
  assume {:sourceloc "decrypt.c", 21, 2} true;
  assume {:verifier.code 0} true;
  call $i37, $i37.shadow := br_rsa_i32_private($p0, $p0.shadow, $p1, $p1.shadow);
  assume {:sourceloc "decrypt.c", 22, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
...
axiom (__SMACK_value == $sub.ref(0,5160));
...
const public_in: ref;
axiom (public_in == $sub.ref(0,6192));
procedure {:inline 1} public_in($p0: ref, $p0.shadow: ref);
const br_rsa_i32_private: ref;
axiom (br_rsa_i32_private == $sub.ref(0,7224));
procedure {:inline 1} br_rsa_i32_private($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref) returns ($r: i32, $r.shadow: i32)
modifies $exn;
modifies $M.0;
modifies $CurrAddr;
{
  ...
  var $i42.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 49, 7} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p2 := $alloc($mul.ref(1584,$zext.i32.i64(1)));
  $p2.shadow := $p2;
  assume true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 49, 7} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(0,4));
  $p3.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 50, 7} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(0,4));
  $p4.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(0,4));
  $p5 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(66,4));
  $p5.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(66,4));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 51, 7} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(0,4));
  $p6.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(0,4));
  $p7 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(132,4));
  $p7.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(132,4));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 52, 7} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(0,4));
  $p8.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(0,4));
  $p9 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(198,4));
  $p9.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(198,4));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 53, 7} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(0,4));
  $p10.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(0,4));
  $p11 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(264,4));
  $p11.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(264,4));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 54, 7} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(0,4));
  $p12.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(0,4));
  $p13 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(330,4));
  $p13.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(330,4));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 61, 10} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(8,1));
  $p14.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(8,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 61, 10} true;
  assume {:verifier.code 0} true;
  assert ($p14 == $p14.shadow);
  $p15 := $load.ref($M.1,$p14);
  $p15.shadow := $load.ref($M.1.shadow,$p14.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 62, 13} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(16,1));
  $p16.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(16,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 62, 13} true;
  assume {:verifier.code 0} true;
  assert ($p16 == $p16.shadow);
  $i17 := $load.i64($M.6,$p16);
  $i17.shadow := $load.i64($M.6.shadow,$p16.shadow);
  call {:cexpr "plen"} boogie_si_record_i64($i17);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 63, 2} true;
  assume {:verifier.code 0} true;
  $i18 := $i17;
  $i18.shadow := $i17.shadow;
  $p19 := $p15;
  $p19.shadow := $p15.shadow;
  goto $bb1;
$bb1:
  assert {:shadow_invariant} $shadow_ok;
  ...
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 63, 14} true;
  assume {:verifier.code 0} true;
  $i20 := $ugt.i64($i18,0);
  $i20.shadow := $ugt.i64($i18.shadow,0);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 63, 18} true;
  assume {:verifier.code 0} true;
  $i21 := 0;
  $i21.shadow := 0;
...
$bb2:
  assume ($i20 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 63, 21} true;
  assume {:verifier.code 0} true;
  assert ($p19 == $p19.shadow);
  $i22 := $load.i8($M.0,$p19);
  $i22.shadow := $load.i8($M.0.shadow,$p19.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 63, 21} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i8.i32($i22);
  $i23.shadow := $zext.i8.i32($i22.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 63, 24} true;
  assume {:verifier.code 0} true;
  $i24 := $eq.i32($i23,0);
  $i24.shadow := $eq.i32($i23.shadow,0);
  assume {:verifier.code 0} true;
  $i21 := $i24;
...
$bb5:
  assume ($i21 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 64, 5} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($p19,$mul.ref(1,1));
  $p25.shadow := $add.ref($p19.shadow,$mul.ref(1,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 65, 8} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i64($i18,$sub.i64(0,1));
  $i26.shadow := $add.i64($i18.shadow,$sub.i64(0,1));
  call {:cexpr "plen"} boogie_si_record_i64($i26);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 63, 2} true;
  assume {:verifier.code 0} true;
  $i18 := $i26;
  $i18.shadow := $i26.shadow;
  $p19 := $p25;
  $p19.shadow := $p25.shadow;
  goto $bb1;
$bb6:
  assume !($i21 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 67, 10} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(24,1));
  $p27.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(24,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 67, 10} true;
  assume {:verifier.code 0} true;
  assert ($p27 == $p27.shadow);
  $p28 := $load.ref($M.2,$p27);
  $p28.shadow := $load.ref($M.2.shadow,$p27.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 68, 13} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(32,1));
  $p29.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(32,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 68, 13} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $i30 := $load.i64($M.7,$p29);
  $i30.shadow := $load.i64($M.7.shadow,$p29.shadow);
  call {:cexpr "qlen"} boogie_si_record_i64($i30);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 69, 2} true;
  assume {:verifier.code 0} true;
  $i31 := $i30;
  $i31.shadow := $i30.shadow;
  $p32 := $p28;
  $p32.shadow := $p28.shadow;
  goto $bb7;
$bb7:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($p2 == $p2.shadow);
  assert {:shadow_invariant} ($p32 == $p32.shadow);
  ...
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 69, 14} true;
  assume {:verifier.code 0} true;
  $i33 := $ugt.i64($i31,0);
  $i33.shadow := $ugt.i64($i31.shadow,0);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 69, 18} true;
  assume {:verifier.code 0} true;
  $i34 := 0;
  $i34.shadow := 0;
...
$bb8:
  assume ($i33 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 69, 21} true;
  assume {:verifier.code 0} true;
  assert ($p32 == $p32.shadow);
  $i35 := $load.i8($M.0,$p32);
  $i35.shadow := $load.i8($M.0.shadow,$p32.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 69, 21} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i8.i32($i35);
  $i36.shadow := $zext.i8.i32($i35.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 69, 24} true;
  assume {:verifier.code 0} true;
  $i37 := $eq.i32($i36,0);
  $i37.shadow := $eq.i32($i36.shadow,0);
  assume {:verifier.code 0} true;
  $i34 := $i37;
  $i34.shadow := $i37.shadow;
  goto $bb10;
$bb9:
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 69, 18} true;
  assume {:verifier.code 0} true;
...
$bb10:
  ...
  assert ($i34 == $i34.shadow);
  goto $bb11, $bb12;
$bb11:
  assume ($i34 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 70, 5} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p32,$mul.ref(1,1));
  $p38.shadow := $add.ref($p32.shadow,$mul.ref(1,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 71, 8} true;
  assume {:verifier.code 0} true;
  $i39 := $add.i64($i31,$sub.i64(0,1));
  $i39.shadow := $add.i64($i31.shadow,$sub.i64(0,1));
  call {:cexpr "qlen"} boogie_si_record_i64($i39);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 69, 2} true;
  assume {:verifier.code 0} true;
  $i31 := $i39;
  $i31.shadow := $i39.shadow;
  $p32 := $p38;
  $p32.shadow := $p38.shadow;
  goto $bb7;
$bb12:
  assume !($i34 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 73, 11} true;
  assume {:verifier.code 0} true;
  $i40 := $ugt.i64($i18,260);
  $i40.shadow := $ugt.i64($i18.shadow,260);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 74, 3} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  goto $bb14;
$bb14:
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 76, 3} true;
  assume {:verifier.code 0} true;
  $i42 := 0;
  $i42.shadow := 0;
  goto $bb18;
$bb15:
  assume !($i40 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 74, 11} true;
  assume {:verifier.code 0} true;
  $i41 := $ugt.i64($i31,260);
  $i41.shadow := $ugt.i64($i31.shadow,260);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 73, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i41} true;
  assert ($i41 == $i41.shadow);
  goto $bb16, $bb17;
$bb16:
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 73, 6} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume !($i41 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 82, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_decode($p5, $p5.shadow, $p19, $p19.shadow, $i18, $i18.shadow);
  $p43 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(66,4));
  $p43.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(66,4));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 83, 18} true;
  assume {:verifier.code 0} true;
  assert ($p43 == $p43.shadow);
  $i44 := $load.i32($M.0,$p43);
  $i44.shadow := $load.i32($M.0.shadow,$p43.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 83, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_zero.31($p7, $p7.shadow, $i44, $i44.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 84, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_decode($p3, $p3.shadow, $p32, $p32.shadow, $i31, $i31.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 90, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_mulacc($p7, $p7.shadow, $p5, $p5.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 91, 14} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(0,1));
  $p45.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 91, 14} true;
  assume {:verifier.code 0} true;
  assert ($p45 == $p45.shadow);
  $i46 := $load.i32($M.11,$p45);
  $i46.shadow := $load.i32($M.11.shadow,$p45.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 91, 23} true;
  assume {:verifier.code 0} true;
  $i47 := $add.i32($i46,7);
  $i47.shadow := $add.i32($i46.shadow,7);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 91, 28} true;
  assume {:verifier.code 0} true;
  $i48 := $lshr.i32($i47,3);
  $i48.shadow := $lshr.i32($i47.shadow,3);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 91, 9} true;
  assume {:verifier.code 0} true;
  $i49 := $zext.i32.i64($i48);
  $i49.shadow := $zext.i32.i64($i48.shadow);
  call {:cexpr "xlen"} boogie_si_record_i64($i49);
  $i50 := $add.i64(132,132);
  $i50.shadow := $add.i64(132,132);
  $p51 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref($i50,4));
  $p51.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref($i50.shadow,4));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 92, 16} true;
  assume {:verifier.code 0} true;
  $p52 := $bitcast.ref.ref($p51);
  $p52.shadow := $bitcast.ref.ref($p51.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 92, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_encode($p52, $p52.shadow, $i49, $i49.shadow, $p7, $p7.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 95, 2} true;
  assume {:verifier.code 0} true;
  $i53 := $i49;
  $i53.shadow := $i49.shadow;
  $i54 := 0;
  $i54.shadow := 0;
  goto $bb19;
$bb18:
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 161, 1} true;
  assume {:verifier.code 0} true;
  $r := $i42;
  $r.shadow := $i42.shadow;
  $exn := false;
...
$bb19:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i49 == $i49.shadow);
  ...
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 95, 11} true;
  assume {:verifier.code 0} true;
  $i55 := $ugt.i64($i53,0);
  $i55.shadow := $ugt.i64($i53.shadow,0);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 95, 2} true;
  assume {:verifier.code 0} true;
...
$bb20:
  assume ($i55 == 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 98, 5} true;
  assume {:verifier.code 0} true;
  $i56 := $add.i64($i53,$sub.i64(0,1));
  $i56.shadow := $add.i64($i53.shadow,$sub.i64(0,1));
  call {:cexpr "u"} boogie_si_record_i64($i56);
  $i57 := $add.i64(132,132);
  $i57.shadow := $add.i64(132,132);
  $p58 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref($i57,4));
  $p58.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref($i57.shadow,4));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 99, 8} true;
  assume {:verifier.code 0} true;
  $p59 := $bitcast.ref.ref($p58);
  $p59.shadow := $bitcast.ref.ref($p58.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 99, 8} true;
  assume {:verifier.code 0} true;
  $p60 := $add.ref($p59,$mul.ref($i56,1));
  $p60.shadow := $add.ref($p59.shadow,$mul.ref($i56.shadow,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 99, 8} true;
  assume {:verifier.code 0} true;
  assert ($p60 == $p60.shadow);
  $i61 := $load.i8($M.0,$p60);
  $i61.shadow := $load.i8($M.0.shadow,$p60.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 99, 8} true;
  assume {:verifier.code 0} true;
  $i62 := $zext.i8.i32($i61);
  $i62.shadow := $zext.i8.i32($i61.shadow);
  call {:cexpr "wn"} boogie_si_record_i32($i62);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 100, 8} true;
  assume {:verifier.code 0} true;
  $p63 := $add.ref($p0,$mul.ref($i56,1));
  $p63.shadow := $add.ref($p0.shadow,$mul.ref($i56.shadow,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 100, 8} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "wx"} boogie_si_record_i32($i65);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 101, 18} true;
  assume {:verifier.code 0} true;
  $i66 := $add.i32($i62,$i54);
  $i66.shadow := $add.i32($i62.shadow,$i54.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 101, 12} true;
  assume {:verifier.code 0} true;
  $i67 := $sub.i32($i65,$i66);
  $i67.shadow := $sub.i32($i65.shadow,$i66.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 101, 24} true;
  assume {:verifier.code 0} true;
  $i68 := $lshr.i32($i67,8);
  $i68.shadow := $lshr.i32($i67.shadow,8);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 101, 30} true;
  assume {:verifier.code 0} true;
  $i69 := $and.i32($i68,1);
  $i69.shadow := $and.i32($i68.shadow,1);
  call {:cexpr "r"} boogie_si_record_i32($i69);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 95, 2} true;
  assume {:verifier.code 0} true;
  $i53 := $i56;
  $i53.shadow := $i56.shadow;
  $i54 := $i69;
  $i54.shadow := $i69.shadow;
  goto $bb19;
$bb21:
  assume !($i55 == 1);
  $i70 := $add.i64(66,1);
  $i70.shadow := $add.i64(66,1);
  $p71 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref($i70,4));
  $p71.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref($i70.shadow,4));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 107, 22} true;
  assume {:verifier.code 0} true;
  assert ($p71 == $p71.shadow);
  $i72 := $load.i32($M.0,$p71);
  $i72.shadow := $load.i32($M.0.shadow,$p71.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 107, 8} true;
  assume {:verifier.code 0} true;
  call $i73, $i73.shadow := br_i32_ninv32($i72, $i72.shadow);
  call {:cexpr "p0i"} boogie_si_record_i32($i73);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 108, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_decode_reduce($p11, $p11.shadow, $p0, $p0.shadow, $i49, $i49.shadow, $p5, $p5.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 109, 24} true;
  assume {:verifier.code 0} true;
  $p74 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(40,1));
  $p74.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(40,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 109, 24} true;
  assume {:verifier.code 0} true;
  assert ($p74 == $p74.shadow);
  $p75 := $load.ref($M.3,$p74);
  $p75.shadow := $load.ref($M.3.shadow,$p74.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 109, 32} true;
  assume {:verifier.code 0} true;
  $p76 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(48,1));
  $p76.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(48,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 109, 32} true;
  assume {:verifier.code 0} true;
  assert ($p76 == $p76.shadow);
  $i77 := $load.i64($M.8,$p76);
  $i77.shadow := $load.i64($M.8.shadow,$p76.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 109, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_modpow($p11, $p11.shadow, $p75, $p75.shadow, $i77, $i77.shadow, $p5, $p5.shadow, $i73, $i73.shadow, $p13, $p13.shadow, $p7, $p7.shadow);
  $p78 := $add.ref($add.ref($p2,$mul.ref(0,1584)),$mul.ref(1,4));
  $p78.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,1584)),$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 114, 22} true;
  assume {:verifier.code 0} true;
  assert ($p78 == $p78.shadow);
  $i79 := $load.i32($M.0,$p78);
  $i79.shadow := $load.i32($M.0.shadow,$p78.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 114, 8} true;
  assume {:verifier.code 0} true;
  call $i80, $i80.shadow := br_i32_ninv32($i79, $i79.shadow);
  call {:cexpr "q0i"} boogie_si_record_i32($i80);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 115, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_decode_reduce($p9, $p9.shadow, $p0, $p0.shadow, $i49, $i49.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 116, 24} true;
  assume {:verifier.code 0} true;
  $p81 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(56,1));
  $p81.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(56,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 116, 24} true;
  assume {:verifier.code 0} true;
  assert ($p81 == $p81.shadow);
  $p82 := $load.ref($M.4,$p81);
  $p82.shadow := $load.ref($M.4.shadow,$p81.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 116, 32} true;
  assume {:verifier.code 0} true;
  $p83 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(64,1));
  $p83.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(64,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 116, 32} true;
  assume {:verifier.code 0} true;
  assert ($p83 == $p83.shadow);
  $i84 := $load.i64($M.9,$p83);
  $i84.shadow := $load.i64($M.9.shadow,$p83.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 116, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_modpow($p9, $p9.shadow, $p82, $p82.shadow, $i84, $i84.shadow, $p3, $p3.shadow, $i80, $i80.shadow, $p13, $p13.shadow, $p7, $p7.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 131, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_reduce($p7, $p7.shadow, $p9, $p9.shadow, $p5, $p5.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 132, 21} true;
  assume {:verifier.code 0} true;
  call $i85, $i85.shadow := br_i32_sub($p11, $p11.shadow, $p7, $p7.shadow, 1, 1);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 132, 2} true;
  assume {:verifier.code 0} true;
  call $i86, $i86.shadow := br_i32_add($p11, $p11.shadow, $p5, $p5.shadow, $i85, $i85.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 133, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_to_monty($p11, $p11.shadow, $p5, $p5.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 134, 31} true;
  assume {:verifier.code 0} true;
  $p87 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(72,1));
  $p87.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(72,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 134, 31} true;
  assume {:verifier.code 0} true;
  assert ($p87 == $p87.shadow);
  $p88 := $load.ref($M.5,$p87);
  $p88.shadow := $load.ref($M.5.shadow,$p87.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 134, 39} true;
  assume {:verifier.code 0} true;
  $p89 := $add.ref($add.ref($p1,$mul.ref(0,88)),$mul.ref(80,1));
  $p89.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,88)),$mul.ref(80,1));
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 134, 39} true;
  assume {:verifier.code 0} true;
  assert ($p89 == $p89.shadow);
  $i90 := $load.i64($M.10,$p89);
  $i90.shadow := $load.i64($M.10.shadow,$p89.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 134, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_decode_reduce($p13, $p13.shadow, $p88, $p88.shadow, $i90, $i90.shadow, $p5, $p5.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 135, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_montymul($p7, $p7.shadow, $p11, $p11.shadow, $p13, $p13.shadow, $p5, $p5.shadow, $i73, $i73.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 148, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_mulacc($p9, $p9.shadow, $p3, $p3.shadow, $p7, $p7.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 154, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_encode($p0, $p0.shadow, $i49, $i49.shadow, $p9, $p9.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 160, 13} true;
  assume {:verifier.code 0} true;
  $i91 := $and.i32($i73,$i80);
  $i91.shadow := $and.i32($i73.shadow,$i80.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 160, 19} true;
  assume {:verifier.code 0} true;
  $i92 := $and.i32($i91,$i54);
  $i92.shadow := $and.i32($i91.shadow,$i54.shadow);
  assume {:sourceloc "../BearSSL/src/rsa/rsa_i32_priv.c", 160, 2} true;
  assume {:verifier.code 0} true;
  $i42 := $i92;
  $i42.shadow := $i92.shadow;
  goto $bb18;
}
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0,8256));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const br_i32_decode: ref;
axiom (br_i32_decode == $sub.ref(0,9288));
procedure {:inline 1} br_i32_decode($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64)
modifies $M.0, $exn;
{
  var $i3: i64;
  var $i3.shadow: i64;
  ...
  var $p31.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 37, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_decode:arg:len"} boogie_si_record_i64($i2);
  call {:cexpr "br_i32_decode:arg:u"} boogie_si_record_i64($i2);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 37, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  $i3.shadow := $i2.shadow;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 38, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i64($i3,4);
  $i5.shadow := $ult.i64($i3.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 38, 7} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 41, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i64($i3,2);
  $i6.shadow := $ult.i64($i3.shadow,2);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 41, 8} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !($i5 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 58, 6} true;
  assume {:verifier.code 0} true;
  $i23 := $sub.i64($i3,4);
  $i23.shadow := $sub.i64($i3.shadow,4);
  call {:cexpr "u"} boogie_si_record_i64($i23);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 59, 29} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p1,$mul.ref($i23,1));
  $p24.shadow := $add.ref($p1.shadow,$mul.ref($i23.shadow,1));
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 59, 14} true;
  assume {:verifier.code 0} true;
  call $i25, $i25.shadow := br_dec32be($p24, $p24.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 59, 8} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i64($i4,1);
  $i26.shadow := $add.i64($i4.shadow,1);
  call {:cexpr "v"} boogie_si_record_i64($i26);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 59, 4} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($p0,$mul.ref($i4,4));
  $p27.shadow := $add.ref($p0.shadow,$mul.ref($i4.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 59, 12} true;
  assume {:verifier.code 0} true;
  assert ($p27 == $p27.shadow);
  $M.0 := $store.i32($M.0,$p27,$i25);
  $M.0.shadow := $store.i32($M.0.shadow,$p27.shadow,$i25.shadow);
  assume {:verifier.code 0} true;
  goto $bb14;
$bb4:
  assume ($i6 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 42, 11} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i64($i3,0);
  $i7.shadow := $eq.i64($i3.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 42, 9} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !($i6 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 48, 11} true;
  assume {:verifier.code 0} true;
  $i12 := $eq.i64($i3,2);
  $i12.shadow := $eq.i64($i3.shadow,2);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 48, 9} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume ($i7 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 43, 6} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume !($i7 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 45, 10} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p1,$mul.ref(0,1));
  $p8.shadow := $add.ref($p1.shadow,$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 45, 10} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $i9 := $load.i8($M.0,$p8);
  ...
  call {:cexpr "w"} boogie_si_record_i32($i10);
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 62, 14} true;
  assume {:verifier.code 0} true;
  $i28 := $udiv.i64($i2,4);
  $i28.shadow := $udiv.i64($i2.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 62, 19} true;
  assume {:verifier.code 0} true;
  $i29 := $shl.i64($i28,37);
  $i29.shadow := $shl.i64($i28.shadow,37);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 62, 9} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i64.i32($i29);
  $i30.shadow := $trunc.i64.i32($i29.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 62, 2} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($p0,$mul.ref(0,4));
  $p31.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 62, 7} true;
  assume {:verifier.code 0} true;
  assert ($p31 == $p31.shadow);
  $M.0 := $store.i32($M.0,$p31,$i30);
  $M.0.shadow := $store.i32($M.0.shadow,$p31.shadow,$i30.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 63, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb9:
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 47, 4} true;
  assume {:verifier.code 0} true;
  $i11 := $i10;
  $i11.shadow := $i10.shadow;
  goto $bb10;
$bb10:
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 55, 4} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p0,$mul.ref($i4,4));
  $p22.shadow := $add.ref($p0.shadow,$mul.ref($i4.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 55, 12} true;
  assume {:verifier.code 0} true;
  assert ($p22 == $p22.shadow);
  $M.0 := $store.i32($M.0,$p22,$i11);
  $M.0.shadow := $store.i32($M.0.shadow,$p22.shadow,$i11.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 56, 4} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb11:
  assume ($i12 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 49, 10} true;
  assume {:verifier.code 0} true;
  call $i13, $i13.shadow := br_dec16be($p1, $p1.shadow);
  call {:cexpr "w"} boogie_si_record_i32($i13);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 50, 5} true;
  assume {:verifier.code 0} true;
  $i14 := $i13;
  $i14.shadow := $i13.shadow;
  goto $bb13;
$bb12:
  assume !($i12 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 51, 21} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p1,$mul.ref(0,1));
  $p15.shadow := $add.ref($p1.shadow,$mul.ref(0,1));
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 51, 21} true;
  assume {:verifier.code 0} true;
  assert ($p15 == $p15.shadow);
  $i16 := $load.i8($M.0,$p15);
  $i16.shadow := $load.i8($M.0.shadow,$p15.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 51, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i8.i32($i16);
  $i17.shadow := $zext.i8.i32($i16.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 51, 28} true;
  assume {:verifier.code 0} true;
  $i18 := $shl.i32($i17,16);
  $i18.shadow := $shl.i32($i17.shadow,16);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 52, 24} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($p1,$mul.ref(1,1));
  $p19.shadow := $add.ref($p1.shadow,$mul.ref(1,1));
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 52, 9} true;
  assume {:verifier.code 0} true;
  call $i20, $i20.shadow := br_dec16be($p19, $p19.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 52, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $or.i32($i18,$i20);
  $i21.shadow := $or.i32($i18.shadow,$i20.shadow);
  call {:cexpr "w"} boogie_si_record_i32($i21);
  assume {:verifier.code 0} true;
  $i14 := $i21;
  $i14.shadow := $i21.shadow;
  goto $bb13;
$bb13:
  assume {:sourceloc "../BearSSL/src/int/i32_decode.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
$bb14:
  ...
  assume {:verifier.code 0} true;
  $i3 := $i23;
  $i3.shadow := $i23.shadow;
  $i4 := $i26;
  $i4.shadow := $i26.shadow;
  goto $bb1;
}
const br_i32_zero.31: ref;
axiom (br_i32_zero.31 == $sub.ref(0,10320));
procedure {:inline 1} br_i32_zero.31($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32)
modifies $M.0, $exn;
{
  var $p2: ref;
  var $p2.shadow: ref;
  ...
  var $i7.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 1237, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_zero.31:arg:bit_len"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1237, 5} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p0,$mul.ref(1,4));
  $p2.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/inner.h", 1237, 8} true;
  assume {:verifier.code 0} true;
  assert ($p0 == $p0.shadow);
  $M.0 := $store.i32($M.0,$p0,$i1);
  $M.0.shadow := $store.i32($M.0.shadow,$p0.shadow,$i1.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1238, 2} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  $p3.shadow := $bitcast.ref.ref($p2.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1238, 25} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i1,31);
  $i4.shadow := $add.i32($i1.shadow,31);
  assume {:sourceloc "../BearSSL/src/inner.h", 1238, 31} true;
  assume {:verifier.code 0} true;
  $i5 := $lshr.i32($i4,5);
  $i5.shadow := $lshr.i32($i4.shadow,5);
  assume {:sourceloc "../BearSSL/src/inner.h", 1238, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i32.i64($i5);
  $i6.shadow := $zext.i32.i64($i5.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1238, 37} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.i64($i6,4);
  $i7.shadow := $mul.i64($i6.shadow,4);
  assume {:sourceloc "../BearSSL/src/inner.h", 1238, 2} true;
  assume {:verifier.code 0} true;
  assert ($p3 == $p3.shadow);
  assert ($i7 == $i7.shadow);
  call $M.0, $M.0.shadow := $memset.i8($M.0, $M.0.shadow, $p3, $p3.shadow, 0, 0, $i7, $i7.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/inner.h", 1239, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const br_i32_mulacc: ref;
axiom (br_i32_mulacc == $sub.ref(0,11352));
procedure {:inline 1} br_i32_mulacc($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.0, $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $i50.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 33, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 33, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 33, 15} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i4,31);
  $i5.shadow := $add.i32($i4.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 33, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $lshr.i32($i5,5);
  $i6.shadow := $lshr.i32($i5.shadow,5);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 33, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i32.i64($i6);
  $i7.shadow := $zext.i32.i64($i6.shadow);
  call {:cexpr "alen"} boogie_si_record_i64($i7);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 34, 10} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p2,$mul.ref(0,4));
  $p8.shadow := $add.ref($p2.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 34, 10} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $i9 := $load.i32($M.0,$p8);
  $i9.shadow := $load.i32($M.0.shadow,$p8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 34, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i9,31);
  $i10.shadow := $add.i32($i9.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 34, 21} true;
  assume {:verifier.code 0} true;
  $i11 := $lshr.i32($i10,5);
  $i11.shadow := $lshr.i32($i10.shadow,5);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 34, 9} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i32.i64($i11);
  $i12.shadow := $zext.i32.i64($i11.shadow);
  call {:cexpr "blen"} boogie_si_record_i64($i12);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p1,$mul.ref(0,4));
  $p13.shadow := $add.ref($p1.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 35, 9} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  $i14 := $load.i32($M.0,$p13);
  $i14.shadow := $load.i32($M.0.shadow,$p13.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 35, 16} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p2,$mul.ref(0,4));
  $p15.shadow := $add.ref($p2.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 35, 16} true;
  assume {:verifier.code 0} true;
  assert ($p15 == $p15.shadow);
  $i16 := $load.i32($M.0,$p15);
  $i16.shadow := $load.i32($M.0.shadow,$p15.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 35, 14} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i32($i14,$i16);
  $i17.shadow := $add.i32($i14.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 35, 2} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p0,$mul.ref(0,4));
  $p18.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 35, 7} true;
  assume {:verifier.code 0} true;
  assert ($p18 == $p18.shadow);
  $M.0 := $store.i32($M.0,$p18,$i17);
  $M.0.shadow := $store.i32($M.0.shadow,$p18.shadow,$i17.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 36, 7} true;
  assume {:verifier.code 0} true;
  $i19 := 0;
  $i19.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 36, 16} true;
  assume {:verifier.code 0} true;
  $i20 := $ult.i64($i19,$i12);
  $i20.shadow := $ult.i64($i19.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 36, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i20} true;
  assert ($i20 == $i20.shadow);
  goto $bb2, $bb3;
$bb2:
  assume ($i20 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 45, 11} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i64(1,$i19);
  $i21.shadow := $add.i64(1,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 45, 7} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p2,$mul.ref($i21,4));
  $p22.shadow := $add.ref($p2.shadow,$mul.ref($i21.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 45, 7} true;
  assume {:verifier.code 0} true;
  assert ($p22 == $p22.shadow);
  $i23 := $load.i32($M.0,$p22);
  $i23.shadow := $load.i32($M.0.shadow,$p22.shadow);
  call {:cexpr "f"} boogie_si_record_i32($i23);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 47, 8} true;
  assume {:verifier.code 0} true;
  $i24 := 0;
  $i24.shadow := 0;
  $i25 := 0;
...
$bb3:
  assume !($i20 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 56, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 47, 17} true;
  assume {:verifier.code 0} true;
  $i26 := $ult.i64($i24,$i7);
  $i26.shadow := $ult.i64($i24.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 47, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i26} true;
  assert ($i26 == $i26.shadow);
  goto $bb5, $bb6;
$bb5:
  assume ($i26 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 22} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i64(1,$i19);
  $i27.shadow := $add.i64(1,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 26} true;
  assume {:verifier.code 0} true;
  $i28 := $add.i64($i27,$i24);
  $i28.shadow := $add.i64($i27.shadow,$i24.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 18} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p0,$mul.ref($i28,4));
  $p29.shadow := $add.ref($p0.shadow,$mul.ref($i28.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 18} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $i30 := $load.i32($M.0,$p29);
  $i30.shadow := $load.i32($M.0.shadow,$p29.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 8} true;
  assume {:verifier.code 0} true;
  $i31 := $zext.i32.i64($i30);
  $i31.shadow := $zext.i32.i64($i30.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 33} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i32.i64($i23);
  $i32.shadow := $zext.i32.i64($i23.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 33} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i64(1,$i24);
  $i33.shadow := $add.i64(1,$i24.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 33} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($p1,$mul.ref($i33,4));
  $p34.shadow := $add.ref($p1.shadow,$mul.ref($i33.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 33} true;
  assume {:verifier.code 0} true;
  assert ($p34 == $p34.shadow);
  $i35 := $load.i32($M.0,$p34);
  $i35.shadow := $load.i32($M.0.shadow,$p34.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 33} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i32.i64($i35);
  $i36.shadow := $zext.i32.i64($i35.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 33} true;
  assume {:verifier.code 0} true;
  $i37 := $mul.i64($i32,$i36);
  $i37.shadow := $mul.i64($i32.shadow,$i36.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 31} true;
  assume {:verifier.code 0} true;
  $i38 := $add.i64($i31,$i37);
  $i38.shadow := $add.i64($i31.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 50, 50} true;
  assume {:verifier.code 0} true;
  $i39 := $add.i64($i38,$i25);
  $i39.shadow := $add.i64($i38.shadow,$i25.shadow);
  call {:cexpr "z"} boogie_si_record_i64($i39);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 51, 11} true;
  assume {:verifier.code 0} true;
  $i40 := $lshr.i64($i39,32);
  $i40.shadow := $lshr.i64($i39.shadow,32);
  call {:cexpr "cc"} boogie_si_record_i64($i40);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 52, 19} true;
  assume {:verifier.code 0} true;
  $i41 := $trunc.i64.i32($i39);
  $i41.shadow := $trunc.i64.i32($i39.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 52, 8} true;
  assume {:verifier.code 0} true;
  $i42 := $add.i64(1,$i19);
  $i42.shadow := $add.i64(1,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 52, 12} true;
  assume {:verifier.code 0} true;
  $i43 := $add.i64($i42,$i24);
  $i43.shadow := $add.i64($i42.shadow,$i24.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 52, 4} true;
  assume {:verifier.code 0} true;
  $p44 := $add.ref($p0,$mul.ref($i43,4));
  $p44.shadow := $add.ref($p0.shadow,$mul.ref($i43.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 52, 17} true;
  assume {:verifier.code 0} true;
  assert ($p44 == $p44.shadow);
  $M.0 := $store.i32($M.0,$p44,$i41);
  $M.0.shadow := $store.i32($M.0.shadow,$p44.shadow,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 53, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !($i26 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 54, 21} true;
  assume {:verifier.code 0} true;
  $i46 := $trunc.i64.i32($i25);
  $i46.shadow := $trunc.i64.i32($i25.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 54, 7} true;
  assume {:verifier.code 0} true;
  $i47 := $add.i64(1,$i19);
  $i47.shadow := $add.i64(1,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 54, 11} true;
  assume {:verifier.code 0} true;
  $i48 := $add.i64($i47,$i7);
  $i48.shadow := $add.i64($i47.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 54, 3} true;
  assume {:verifier.code 0} true;
  $p49 := $add.ref($p0,$mul.ref($i48,4));
  $p49.shadow := $add.ref($p0.shadow,$mul.ref($i48.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 54, 19} true;
  assume {:verifier.code 0} true;
  assert ($p49 == $p49.shadow);
  $M.0 := $store.i32($M.0,$p49,$i46);
  $M.0.shadow := $store.i32($M.0.shadow,$p49.shadow,$i46.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 55, 2} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 47, 27} true;
  assume {:verifier.code 0} true;
  $i45 := $add.i64($i24,1);
  $i45.shadow := $add.i64($i24.shadow,1);
  call {:cexpr "v"} boogie_si_record_i64($i45);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 47, 3} true;
  assume {:verifier.code 0} true;
  $i24 := $i45;
  $i24.shadow := $i45.shadow;
  $i25 := $i40;
  $i25.shadow := $i40.shadow;
  goto $bb4;
$bb8:
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 36, 26} true;
  assume {:verifier.code 0} true;
  $i50 := $add.i64($i19,1);
  $i50.shadow := $add.i64($i19.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i50);
  assume {:sourceloc "../BearSSL/src/int/i32_mulacc.c", 36, 2} true;
  assume {:verifier.code 0} true;
  $i19 := $i50;
  $i19.shadow := $i50.shadow;
  goto $bb1;
}
const br_i32_encode: ref;
axiom (br_i32_encode == $sub.ref(0,12384));
procedure {:inline 1} br_i32_encode($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64, $p2: ref, $p2.shadow: ref)
modifies $M.0, $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $p44.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 40, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_encode:arg:len"} boogie_si_record_i64($i1);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 40, 7} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p2,$mul.ref(0,4));
  $p3.shadow := $add.ref($p2.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 40, 7} true;
  assume {:verifier.code 0} true;
  assert ($p3 == $p3.shadow);
  $i4 := $load.i32($M.0,$p3);
  $i4.shadow := $load.i32($M.0.shadow,$p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i4,7);
  $i5.shadow := $add.i32($i4.shadow,7);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 40, 17} true;
  assume {:verifier.code 0} true;
  $i6 := $lshr.i32($i5,3);
  $i6.shadow := $lshr.i32($i5.shadow,3);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 40, 6} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i32.i64($i6);
  $i7.shadow := $zext.i32.i64($i6.shadow);
  call {:cexpr "k"} boogie_si_record_i64($i7);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 41, 2} true;
  assume {:verifier.code 0} true;
  $p8 := $p0;
  $p8.shadow := $p0.shadow;
  $i9 := $i1;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 41, 13} true;
  assume {:verifier.code 0} true;
  $i10 := $ugt.i64($i9,$i7);
  $i10.shadow := $ugt.i64($i9.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 41, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i10 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 42, 8} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p8,$mul.ref(1,1));
  $p11.shadow := $add.ref($p8.shadow,$mul.ref(1,1));
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 42, 11} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $M.0 := $store.i8($M.0,$p8,0);
  $M.0.shadow := $store.i8($M.0.shadow,$p8.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 43, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i64($i9,$sub.i64(0,1));
  $i12.shadow := $add.i64($i9.shadow,$sub.i64(0,1));
  call {:cexpr "len"} boogie_si_record_i64($i12);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 41, 2} true;
  assume {:verifier.code 0} true;
  $p8 := $p11;
  $p8.shadow := $p11.shadow;
  $i9 := $i12;
  $i9.shadow := $i12.shadow;
  goto $bb1;
$bb3:
  assume !($i10 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 51, 11} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i64($i9,3);
  $i13.shadow := $add.i64($i9.shadow,3);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 51, 16} true;
  assume {:verifier.code 0} true;
  $i14 := $lshr.i64($i13,2);
  $i14.shadow := $lshr.i64($i13.shadow,2);
  call {:cexpr "k"} boogie_si_record_i64($i14);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 52, 14} true;
  assume {:verifier.code 0} true;
  $i15 := $and.i64($i9,3);
  $i15.shadow := $and.i64($i9.shadow,3);
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:verifier.code 0} true;
  $i16 := $slt.i64($i15,2);
  $i16.shadow := $slt.i64($i15.shadow,2);
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  $i19 := $eq.i64($i15,1);
  $i19.shadow := $eq.i64($i15.shadow,1);
  assume {:verifier.code 0} true;
  $p20 := $p8;
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  $i17 := $slt.i64($i15,3);
  $i17.shadow := $slt.i64($i15.shadow,3);
  assume {:verifier.code 0} true;
  $p18 := $p8;
  $p18.shadow := $p8.shadow;
  assume {:branchcond $i17} true;
  assert ($i17 == $i17.shadow);
  goto $bb7, $bb9;
$bb7:
  assume {:verifier.code 0} true;
  assume ($i17 == 1);
...
$bb8:
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 57, 13} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p2,$mul.ref($i14,4));
  $p26.shadow := $add.ref($p2.shadow,$mul.ref($i14.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 57, 13} true;
  assume {:verifier.code 0} true;
  assert ($p26 == $p26.shadow);
  $i27 := $load.i32($M.0,$p26);
  $i27.shadow := $load.i32($M.0.shadow,$p26.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 57, 18} true;
  assume {:verifier.code 0} true;
  $i28 := $lshr.i32($i27,8);
  $i28.shadow := $lshr.i32($i27.shadow,8);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 57, 13} true;
  assume {:verifier.code 0} true;
  $i29 := $trunc.i32.i8($i28);
  $i29.shadow := $trunc.i32.i8($i28.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 57, 8} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($p18,$mul.ref(1,1));
  $p30.shadow := $add.ref($p18.shadow,$mul.ref(1,1));
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 57, 11} true;
  assume {:verifier.code 0} true;
  assert ($p18 == $p18.shadow);
  $M.0 := $store.i8($M.0,$p18,$i29);
  $M.0.shadow := $store.i8($M.0.shadow,$p18.shadow,$i29.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 57, 3} true;
  assume {:verifier.code 0} true;
  $p20 := $p30;
  $p20.shadow := $p30.shadow;
  goto $bb11;
$bb9:
  assume !($i17 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 54, 13} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p2,$mul.ref($i14,4));
  $p21.shadow := $add.ref($p2.shadow,$mul.ref($i14.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 54, 13} true;
  assume {:verifier.code 0} true;
  assert ($p21 == $p21.shadow);
  $i22 := $load.i32($M.0,$p21);
  $i22.shadow := $load.i32($M.0.shadow,$p21.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 54, 18} true;
  assume {:verifier.code 0} true;
  $i23 := $lshr.i32($i22,16);
  $i23.shadow := $lshr.i32($i22.shadow,16);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 54, 13} true;
  assume {:verifier.code 0} true;
  $i24 := $trunc.i32.i8($i23);
  $i24.shadow := $trunc.i32.i8($i23.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 54, 8} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($p8,$mul.ref(1,1));
  $p25.shadow := $add.ref($p8.shadow,$mul.ref(1,1));
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 54, 11} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $M.0 := $store.i8($M.0,$p8,$i24);
  $M.0.shadow := $store.i8($M.0.shadow,$p8.shadow,$i24.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 54, 3} true;
  assume {:verifier.code 0} true;
  $p18 := $p25;
  $p18.shadow := $p25.shadow;
  goto $bb8;
$bb10:
  assume {:verifier.code 0} true;
  assume ($i19 == 1);
...
$bb11:
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 60, 13} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($p2,$mul.ref($i14,4));
  $p31.shadow := $add.ref($p2.shadow,$mul.ref($i14.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 60, 13} true;
  assume {:verifier.code 0} true;
  assert ($p31 == $p31.shadow);
  ...
  $i33.shadow := $trunc.i32.i8($i32.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 60, 8} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($p20,$mul.ref(1,1));
  $p34.shadow := $add.ref($p20.shadow,$mul.ref(1,1));
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 60, 11} true;
  assume {:verifier.code 0} true;
  assert ($p20 == $p20.shadow);
  $M.0 := $store.i8($M.0,$p20,$i33);
  $M.0.shadow := $store.i8($M.0.shadow,$p20.shadow,$i33.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 61, 5} true;
  assume {:verifier.code 0} true;
  $i35 := $add.i64($i14,$sub.i64(0,1));
  $i35.shadow := $add.i64($i14.shadow,$sub.i64(0,1));
  call {:cexpr "k"} boogie_si_record_i64($i35);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 62, 2} true;
  assume {:verifier.code 0} true;
  $p36 := $p34;
  $p36.shadow := $p34.shadow;
  $i37 := $i35;
  $i37.shadow := $i35.shadow;
  goto $bb13;
$bb12:
  assume !($i19 == 1);
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $p38 := $p36;
  $p38.shadow := $p36.shadow;
  $i39 := $i37;
  $i39.shadow := $i37.shadow;
  goto $bb14;
$bb14:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i39 == $i39.shadow);
  assert {:likely_shadow_invariant} ($p38 == $p38.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 67, 11} true;
  assume {:verifier.code 0} true;
  $i40 := $ugt.i64($i39,0);
  $i40.shadow := $ugt.i64($i39.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 67, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  assert ($i40 == $i40.shadow);
...
$bb15:
  assume ($i40 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 68, 19} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($p2,$mul.ref($i39,4));
  $p41.shadow := $add.ref($p2.shadow,$mul.ref($i39.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 68, 19} true;
  assume {:verifier.code 0} true;
  assert ($p41 == $p41.shadow);
  $i42 := $load.i32($M.0,$p41);
  $i42.shadow := $load.i32($M.0.shadow,$p41.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 68, 3} true;
  assume {:verifier.code 0} true;
  call br_enc32be($p38, $p38.shadow, $i42, $i42.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 69, 5} true;
  assume {:verifier.code 0} true;
  $i43 := $add.i64($i39,$sub.i64(0,1));
  $i43.shadow := $add.i64($i39.shadow,$sub.i64(0,1));
  call {:cexpr "k"} boogie_si_record_i64($i43);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 70, 7} true;
  assume {:verifier.code 0} true;
  $p44 := $add.ref($p38,$mul.ref(4,1));
  $p44.shadow := $add.ref($p38.shadow,$mul.ref(4,1));
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 67, 2} true;
  assume {:verifier.code 0} true;
  $p38 := $p44;
  $p38.shadow := $p44.shadow;
  $i39 := $i43;
  $i39.shadow := $i43.shadow;
  goto $bb14;
$bb16:
  assume !($i40 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_encode.c", 72, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const br_i32_ninv32: ref;
axiom (br_i32_ninv32 == $sub.ref(0,13416));
procedure {:inline 1} br_i32_ninv32($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i16.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 33, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_ninv32:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 33, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $sub.i32(2,$i0);
  $i1.shadow := $sub.i32(2,$i0.shadow);
  call {:cexpr "y"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 34, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $mul.i32($i1,$i0);
  $i2.shadow := $mul.i32($i1.shadow,$i0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 34, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(2,$i2);
  $i3.shadow := $sub.i32(2,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 34, 4} true;
  assume {:verifier.code 0} true;
  $i4 := $mul.i32($i1,$i3);
  $i4.shadow := $mul.i32($i1.shadow,$i3.shadow);
  call {:cexpr "y"} boogie_si_record_i32($i4);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 35, 13} true;
  assume {:verifier.code 0} true;
  $i5 := $mul.i32($i4,$i0);
  $i5.shadow := $mul.i32($i4.shadow,$i0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $i6 := $sub.i32(2,$i5);
  $i6.shadow := $sub.i32(2,$i5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 35, 4} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.i32($i4,$i6);
  $i7.shadow := $mul.i32($i4.shadow,$i6.shadow);
  call {:cexpr "y"} boogie_si_record_i32($i7);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 36, 13} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32($i7,$i0);
  $i8.shadow := $mul.i32($i7.shadow,$i0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 36, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.i32(2,$i8);
  $i9.shadow := $sub.i32(2,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 36, 4} true;
  assume {:verifier.code 0} true;
  $i10 := $mul.i32($i7,$i9);
  $i10.shadow := $mul.i32($i7.shadow,$i9.shadow);
  call {:cexpr "y"} boogie_si_record_i32($i10);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 37, 13} true;
  assume {:verifier.code 0} true;
  $i11 := $mul.i32($i10,$i0);
  $i11.shadow := $mul.i32($i10.shadow,$i0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 37, 9} true;
  assume {:verifier.code 0} true;
  $i12 := $sub.i32(2,$i11);
  $i12.shadow := $sub.i32(2,$i11.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 37, 4} true;
  assume {:verifier.code 0} true;
  $i13 := $mul.i32($i10,$i12);
  $i13.shadow := $mul.i32($i10.shadow,$i12.shadow);
  call {:cexpr "y"} boogie_si_record_i32($i13);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 38, 15} true;
  assume {:verifier.code 0} true;
  $i14 := $and.i32($i0,1);
  $i14.shadow := $and.i32($i0.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 38, 20} true;
  assume {:verifier.code 0} true;
  $i15 := $sub.i32(0,$i13);
  $i15.shadow := $sub.i32(0,$i13.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 38, 9} true;
  assume {:verifier.code 0} true;
  call $i16, $i16.shadow := MUX.20($i14, $i14.shadow, $i15, $i15.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i32_ninv32.c", 38, 2} true;
  assume {:verifier.code 0} true;
  $r := $i16;
  $r.shadow := $i16.shadow;
  $exn := false;
...
const br_i32_decode_reduce: ref;
axiom (br_i32_decode_reduce == $sub.ref(0,14448));
procedure {:inline 1} br_i32_decode_reduce($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64, $p3: ref, $p3.shadow: ref)
modifies $M.0, $exn;
modifies $CurrAddr;
{
  var $p4: ref;
  ...
  var $i40.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 36, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_decode_reduce:arg:len"} boogie_si_record_i64($i2);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 36, 13} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p3,$mul.ref(0,4));
  $p4.shadow := $add.ref($p3.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 36, 13} true;
  assume {:verifier.code 0} true;
  assert ($p4 == $p4.shadow);
  $i5 := $load.i32($M.0,$p4);
  $i5.shadow := $load.i32($M.0.shadow,$p4.shadow);
  call {:cexpr "m_bitlen"} boogie_si_record_i32($i5);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 41, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5,0);
  $i6.shadow := $eq.i32($i5.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 41, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  assert ($i6 == $i6.shadow);
  goto $bb1, $bb2;
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 42, 3} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p0,$mul.ref(0,4));
  $p7.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 42, 8} true;
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $M.0 := $store.i32($M.0,$p7,0);
  $M.0.shadow := $store.i32($M.0.shadow,$p7.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 43, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !($i6 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 49, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_zero($p0, $p0.shadow, $i5, $i5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 56, 20} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i5,7);
  $i8.shadow := $add.i32($i5.shadow,7);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 56, 25} true;
  assume {:verifier.code 0} true;
  $i9 := $lshr.i32($i8,3);
  $i9.shadow := $lshr.i32($i8.shadow,3);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 56, 10} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i32.i64($i9);
  $i10.shadow := $zext.i32.i64($i9.shadow);
  call {:cexpr "mblen"} boogie_si_record_i64($i10);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 57, 12} true;
  assume {:verifier.code 0} true;
  $i11 := $sub.i64($i10,1);
  $i11.shadow := $sub.i64($i10.shadow,1);
  call {:cexpr "k"} boogie_si_record_i64($i11);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 62, 8} true;
  assume {:verifier.code 0} true;
  $i12 := $uge.i64($i11,$i2);
  $i12.shadow := $uge.i64($i11.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 62, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i12} true;
  assert ($i12 == $i12.shadow);
  goto $bb4, $bb5;
$bb3:
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 107, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume ($i12 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 63, 3} true;
  assume {:verifier.code 0} true;
  call br_i32_decode($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 64, 3} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p0,$mul.ref(0,4));
  $p13.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 64, 8} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  $M.0 := $store.i32($M.0,$p13,$i5);
  $M.0.shadow := $store.i32($M.0.shadow,$p13.shadow,$i5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 65, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb5:
  assume !($i12 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 74, 11} true;
  assume {:verifier.code 0} true;
  $i14 := $sub.i64($i2,$i11);
  $i14.shadow := $sub.i64($i2.shadow,$i11.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 74, 15} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i64($i14,3);
  $i15.shadow := $add.i64($i14.shadow,3);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 74, 20} true;
  assume {:verifier.code 0} true;
  $i16 := $and.i64($i15,18446744073709551612);
  $i16.shadow := $and.i64($i15.shadow,18446744073709551612);
  call {:cexpr "q"} boogie_si_record_i64($i16);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 82, 8} true;
  assume {:verifier.code 0} true;
  $i17 := $ugt.i64($i16,$i2);
  $i17.shadow := $ugt.i64($i16.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 82, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  assert ($i17 == $i17.shadow);
  goto $bb6, $bb7;
$bb6:
  assume ($i17 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 87, 8} true;
  assume {:verifier.code 0} true;
  $i18 := $i16;
  $i18.shadow := $i16.shadow;
  $i19 := 0;
  $i19.shadow := 0;
  $i20 := 0;
  $i20.shadow := 0;
...
$bb7:
  assume !($i17 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 96, 29} true;
  assume {:verifier.code 0} true;
  $i33 := $sub.i64($i2,$i16);
  $i33.shadow := $sub.i64($i2.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 96, 3} true;
  assume {:verifier.code 0} true;
  call br_i32_decode($p0, $p0.shadow, $p1, $p1.shadow, $i33, $i33.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 97, 3} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($p0,$mul.ref(0,4));
  $p34.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 97, 8} true;
  assume {:verifier.code 0} true;
  assert ($p34 == $p34.shadow);
  $M.0 := $store.i32($M.0,$p34,$i5);
  $M.0.shadow := $store.i32($M.0.shadow,$p34.shadow,$i5.shadow);
  assume {:verifier.code 0} true;
  $i32 := $i16;
  $i32.shadow := $i16.shadow;
  goto $bb15;
$bb8:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i18 == $i18.shadow);
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 87, 17} true;
  assume {:verifier.code 0} true;
  $i21 := $slt.i32($i19,4);
  $i21.shadow := $slt.i32($i19.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 87, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  assert ($i21 == $i21.shadow);
  goto $bb9, $bb10;
$bb9:
  assume ($i21 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 88, 6} true;
  assume {:verifier.code 0} true;
  $i22 := $shl.i32($i20,8);
  $i22.shadow := $shl.i32($i20.shadow,8);
  call {:cexpr "w"} boogie_si_record_i32($i22);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 89, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $ule.i64($i18,$i2);
  $i23.shadow := $ule.i64($i18.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 89, 8} true;
  assume {:verifier.code 0} true;
  $i24 := $i22;
  $i24.shadow := $i22.shadow;
  assume {:branchcond $i23} true;
  assert ($i23 == $i23.shadow);
  goto $bb11, $bb12;
$bb10:
  assume !($i21 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 94, 3} true;
  assume {:verifier.code 0} true;
  call br_i32_muladd_small($p0, $p0.shadow, $i20, $i20.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 95, 2} true;
  assume {:verifier.code 0} true;
  $i32 := $i18;
  $i32.shadow := $i18.shadow;
  goto $bb15;
$bb11:
  assume ($i23 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 90, 18} true;
  assume {:verifier.code 0} true;
  $i25 := $sub.i64($i2,$i18);
  $i25.shadow := $sub.i64($i2.shadow,$i18.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 90, 10} true;
  assume {:verifier.code 0} true;
  ...
  assert ($p26 == $p26.shadow);
  $i27 := $load.i8($M.0,$p26);
  $i27.shadow := $load.i8($M.0.shadow,$p26.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 90, 10} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i8.i32($i27);
  $i28.shadow := $zext.i8.i32($i27.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 90, 7} true;
  assume {:verifier.code 0} true;
  $i29 := $or.i32($i22,$i28);
  $i29.shadow := $or.i32($i22.shadow,$i28.shadow);
  call {:cexpr "w"} boogie_si_record_i32($i29);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 91, 4} true;
  assume {:verifier.code 0} true;
  $i24 := $i29;
  $i24.shadow := $i29.shadow;
  goto $bb13;
$bb12:
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 89, 8} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 92, 6} true;
  assume {:verifier.code 0} true;
  $i30 := $add.i64($i18,$sub.i64(0,1));
  $i30.shadow := $add.i64($i18.shadow,$sub.i64(0,1));
  call {:cexpr "q"} boogie_si_record_i64($i30);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 93, 3} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 87, 24} true;
  assume {:verifier.code 0} true;
  $i31 := $add.i32($i19,1);
  $i31.shadow := $add.i32($i19.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i31);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 87, 3} true;
  assume {:verifier.code 0} true;
  $i18 := $i30;
  $i18.shadow := $i30.shadow;
  $i19 := $i31;
  $i19.shadow := $i31.shadow;
  $i20 := $i24;
  $i20.shadow := $i24.shadow;
  goto $bb8;
$bb15:
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 74, 4} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 104, 15} true;
  assume {:verifier.code 0} true;
  $i35 := $sub.i64($i2,$i32);
  $i35.shadow := $sub.i64($i2.shadow,$i32.shadow);
  call {:cexpr "k"} boogie_si_record_i64($i35);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 104, 7} true;
  assume {:verifier.code 0} true;
  $i36 := $i35;
  $i36.shadow := $i35.shadow;
  goto $bb16;
$bb16:
  assert {:shadow_invariant} $shadow_ok;
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 104, 22} true;
  assume {:verifier.code 0} true;
  $i37 := $ult.i64($i36,$i2);
  $i37.shadow := $ult.i64($i36.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 104, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i37} true;
  assert ($i37 == $i37.shadow);
  goto $bb17, $bb18;
$bb17:
  assume ($i37 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 105, 41} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p1,$mul.ref($i36,1));
  $p38.shadow := $add.ref($p1.shadow,$mul.ref($i36.shadow,1));
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 105, 26} true;
  assume {:verifier.code 0} true;
  call $i39, $i39.shadow := br_dec32be.6($p38, $p38.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 105, 3} true;
  assume {:verifier.code 0} true;
  call br_i32_muladd_small($p0, $p0.shadow, $i39, $i39.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 106, 2} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb18:
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 104, 2} true;
  ...
  goto $bb3;
$bb19:
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 104, 31} true;
  assume {:verifier.code 0} true;
  $i40 := $add.i64($i36,4);
  $i40.shadow := $add.i64($i36.shadow,4);
  call {:cexpr "k"} boogie_si_record_i64($i40);
  assume {:sourceloc "../BearSSL/src/int/i32_decred.c", 104, 2} true;
  assume {:verifier.code 0} true;
  $i36 := $i40;
  $i36.shadow := $i40.shadow;
  goto $bb16;
}
const br_i32_modpow: ref;
axiom (br_i32_modpow == $sub.ref(0,15480));
procedure {:inline 1} br_i32_modpow($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64, $p3: ref, $p3.shadow: ref, $i4: i32, $i4.shadow: i32, $p5: ref, $p5.shadow: ref, $p6: ref, $p6.shadow: ref)
modifies $M.0, $exn;
modifies $CurrAddr;
{
  var $p7: ref;
  ...
  var $i36.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 40, 11} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_modpow:arg:elen"} boogie_si_record_i64($i2);
  call {:cexpr "br_i32_modpow:arg:m0i"} boogie_si_record_i32($i4);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 40, 11} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p3,$mul.ref(0,4));
  $p7.shadow := $add.ref($p3.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 40, 11} true;
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $i8 := $load.i32($M.0,$p7);
  $i8.shadow := $load.i32($M.0.shadow,$p7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 40, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i8,63);
  $i9.shadow := $add.i32($i8.shadow,63);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 40, 22} true;
  assume {:verifier.code 0} true;
  $i10 := $lshr.i32($i9,5);
  $i10.shadow := $lshr.i32($i9.shadow,5);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 40, 9} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i32.i64($i10);
  $i11.shadow := $zext.i32.i64($i10.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 40, 28} true;
  assume {:verifier.code 0} true;
  $i12 := $mul.i64($i11,4);
  $i12.shadow := $mul.i64($i11.shadow,4);
  call {:cexpr "mlen"} boogie_si_record_i64($i12);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 52, 2} true;
  assume {:verifier.code 0} true;
  ...
  $p14.shadow := $bitcast.ref.ref($p0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 52, 2} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  assert ($p14 == $p14.shadow);
  assert ($i12 == $i12.shadow);
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.0, $M.0.shadow, $p13, $p13.shadow, $p14, $p14.shadow, $i12, $i12.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 53, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_to_monty($p5, $p5.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 54, 17} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p3,$mul.ref(0,4));
  $p15.shadow := $add.ref($p3.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 54, 17} true;
  assume {:verifier.code 0} true;
  assert ($p15 == $p15.shadow);
  $i16 := $load.i32($M.0,$p15);
  $i16.shadow := $load.i32($M.0.shadow,$p15.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 54, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_zero.8($p0, $p0.shadow, $i16, $i16.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 55, 2} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($p0,$mul.ref(1,4));
  $p17.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 55, 7} true;
  assume {:verifier.code 0} true;
  assert ($p17 == $p17.shadow);
  $M.0 := $store.i32($M.0,$p17,1);
  $M.0.shadow := $store.i32($M.0.shadow,$p17.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 56, 7} true;
  assume {:verifier.code 0} true;
  $i18 := 0;
  $i18.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assert {:shadow_invariant} ($i18 == $i18.shadow);
  assert {:shadow_invariant} ($i12 == $i12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 56, 19} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i64.i32($i2);
  $i19.shadow := $trunc.i64.i32($i2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 56, 34} true;
  assume {:verifier.code 0} true;
  $i20 := $shl.i32($i19,3);
  $i20.shadow := $shl.i32($i19.shadow,3);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 56, 16} true;
  assume {:verifier.code 0} true;
  $i21 := $ult.i32($i18,$i20);
  $i21.shadow := $ult.i32($i18.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 56, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  assert ($i21 == $i21.shadow);
  goto $bb2, $bb3;
$bb2:
  assume ($i21 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 59, 17} true;
  assume {:verifier.code 0} true;
  $i22 := $sub.i64($i2,1);
  $i22.shadow := $sub.i64($i2.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 59, 26} true;
  assume {:verifier.code 0} true;
  $i23 := $lshr.i32($i18,3);
  $i23.shadow := $lshr.i32($i18.shadow,3);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 59, 23} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i32.i64($i23);
  $i24.shadow := $zext.i32.i64($i23.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 59, 21} true;
  assume {:verifier.code 0} true;
  $i25 := $sub.i64($i22,$i24);
  $i25.shadow := $sub.i64($i22.shadow,$i24.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 59, 10} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p1,$mul.ref($i25,1));
  $p26.shadow := $add.ref($p1.shadow,$mul.ref($i25.shadow,1));
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 59, 10} true;
  assume {:verifier.code 0} true;
  assert ($p26 == $p26.shadow);
  $i27 := $load.i8($M.12,$p26);
  $i27.shadow := $load.i8($M.12.shadow,$p26.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 59, 10} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i8.i32($i27);
  $i28.shadow := $zext.i8.i32($i27.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 59, 39} true;
  assume {:verifier.code 0} true;
  $i29 := $and.i32($i18,7);
  $i29.shadow := $and.i32($i18.shadow,7);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 59, 33} true;
  assume {:verifier.code 0} true;
  $i30 := $ashr.i32($i28,$i29);
  $i30.shadow := $ashr.i32($i28.shadow,$i29.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 59, 45} true;
  assume {:verifier.code 0} true;
  $i31 := $and.i32($i30,1);
  $i31.shadow := $and.i32($i30.shadow,1);
  call {:cexpr "ctl"} boogie_si_record_i32($i31);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 60, 3} true;
  assume {:verifier.code 0} true;
  call br_i32_montymul($p6, $p6.shadow, $p0, $p0.shadow, $p5, $p5.shadow, $p3, $p3.shadow, $i4, $i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 61, 14} true;
  assume {:verifier.code 0} true;
  $p32 := $bitcast.ref.ref($p0);
  $p32.shadow := $bitcast.ref.ref($p0.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 61, 17} true;
  assume {:verifier.code 0} true;
  $p33 := $bitcast.ref.ref($p6);
  $p33.shadow := $bitcast.ref.ref($p6.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 61, 3} true;
  assume {:verifier.code 0} true;
  call br_ccopy($i31, $i31.shadow, $p32, $p32.shadow, $p33, $p33.shadow, $i12, $i12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 62, 3} true;
  assume {:verifier.code 0} true;
  call br_i32_montymul($p6, $p6.shadow, $p5, $p5.shadow, $p5, $p5.shadow, $p3, $p3.shadow, $i4, $i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 63, 3} true;
  assume {:verifier.code 0} true;
  $p34 := $bitcast.ref.ref($p5);
  $p34.shadow := $bitcast.ref.ref($p5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 63, 3} true;
  assume {:verifier.code 0} true;
  ...
  assert ($i12 == $i12.shadow);
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.0, $M.0.shadow, $p34, $p34.shadow, $p35, $p35.shadow, $i12, $i12.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 64, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i21 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 65, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 56, 43} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i32($i18,1);
  $i36.shadow := $add.i32($i18.shadow,1);
  call {:cexpr "k"} boogie_si_record_i32($i36);
  assume {:sourceloc "../BearSSL/src/int/i32_modpow.c", 56, 2} true;
  assume {:verifier.code 0} true;
  $i18 := $i36;
  $i18.shadow := $i36.shadow;
  goto $bb1;
}
const br_i32_reduce: ref;
axiom (br_i32_reduce == $sub.ref(0,16512));
procedure {:inline 1} br_i32_reduce($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.0, $exn;
modifies $CurrAddr;
{
  var $p3: ref;
  ...
  var $i42.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 34, 13} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 34, 13} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p2,$mul.ref(0,4));
  ...
  $i4 := $load.i32($M.0,$p3);
  $i4.shadow := $load.i32($M.0.shadow,$p3.shadow);
  call {:cexpr "m_bitlen"} boogie_si_record_i32($i4);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 35, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i4,31);
  $i5.shadow := $add.i32($i4.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 35, 25} true;
  assume {:verifier.code 0} true;
  $i6 := $lshr.i32($i5,5);
  $i6.shadow := $lshr.i32($i5.shadow,5);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i32.i64($i6);
  $i7.shadow := $zext.i32.i64($i6.shadow);
  call {:cexpr "mlen"} boogie_si_record_i64($i7);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 37, 2} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p0,$mul.ref(0,4));
  $p8.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 37, 7} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $M.0 := $store.i32($M.0,$p8,$i4);
  $M.0.shadow := $store.i32($M.0.shadow,$p8.shadow,$i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 38, 15} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i4,0);
  $i9.shadow := $eq.i32($i4.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 38, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i9 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 39, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !($i9 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 46, 13} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "a_bitlen"} boogie_si_record_i32($i11);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 47, 19} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i11,31);
  $i12.shadow := $add.i32($i11.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 47, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $lshr.i32($i12,5);
  $i13.shadow := $lshr.i32($i12.shadow,5);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 47, 9} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i32.i64($i13);
  $i14.shadow := $zext.i32.i64($i13.shadow);
  call {:cexpr "alen"} boogie_si_record_i64($i14);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 48, 15} true;
  assume {:verifier.code 0} true;
  $i15 := $ult.i32($i11,$i4);
  $i15.shadow := $ult.i32($i11.shadow,$i4.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 48, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  assert ($i15 == $i15.shadow);
  goto $bb4, $bb5;
$bb3:
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 66, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume ($i15 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 49, 12} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p0,$mul.ref(1,4));
  $p16.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 49, 3} true;
  assume {:verifier.code 0} true;
  $p17 := $bitcast.ref.ref($p16);
  $p17.shadow := $bitcast.ref.ref($p16.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 49, 19} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p1,$mul.ref(1,4));
  $p18.shadow := $add.ref($p1.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 49, 3} true;
  assume {:verifier.code 0} true;
  $p19 := $bitcast.ref.ref($p18);
  $p19.shadow := $bitcast.ref.ref($p18.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 49, 29} true;
  assume {:verifier.code 0} true;
  $i20 := $mul.i64($i14,4);
  $i20.shadow := $mul.i64($i14.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 49, 3} true;
  assume {:verifier.code 0} true;
  assert ($p17 == $p17.shadow);
  assert ($p19 == $p19.shadow);
  assert ($i20 == $i20.shadow);
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.0, $M.0.shadow, $p17, $p17.shadow, $p19, $p19.shadow, $i20, $i20.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 50, 8} true;
  assume {:verifier.code 0} true;
  $i21 := $i14;
  $i21.shadow := $i14.shadow;
  goto $bb6;
$bb5:
  assume !($i15 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 61, 11} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p0,$mul.ref(1,4));
  $p26.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 61, 2} true;
  assume {:verifier.code 0} true;
  $p27 := $bitcast.ref.ref($p26);
  $p27.shadow := $bitcast.ref.ref($p26.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 61, 18} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($p1,$mul.ref(2,4));
  $p28.shadow := $add.ref($p1.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 61, 30} true;
  assume {:verifier.code 0} true;
  $i29 := $sub.i64($i14,$i7);
  $i29.shadow := $sub.i64($i14.shadow,$i7.shadow);
  $i30 := $add.i64(2,$i29);
  $i30.shadow := $add.i64(2,$i29.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 61, 22} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 61, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $sub.i64($i7,1);
  $i33.shadow := $sub.i64($i7.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 61, 50} true;
  assume {:verifier.code 0} true;
  $i34 := $mul.i64($i33,4);
  $i34.shadow := $mul.i64($i33.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 61, 2} true;
  assume {:verifier.code 0} true;
  assert ($p27 == $p27.shadow);
  assert ($p32 == $p32.shadow);
  assert ($i34 == $i34.shadow);
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.0, $M.0.shadow, $p27, $p27.shadow, $p32, $p32.shadow, $i34, $i34.shadow, false, false);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 62, 2} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($p0,$mul.ref($i7,4));
  $p35.shadow := $add.ref($p0.shadow,$mul.ref($i7.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 62, 10} true;
  assume {:verifier.code 0} true;
  assert ($p35 == $p35.shadow);
  $M.0 := $store.i32($M.0,$p35,0);
  $M.0.shadow := $store.i32($M.0.shadow,$p35.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 63, 13} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i64(1,$i14);
  $i36.shadow := $add.i64(1,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 63, 20} true;
  assume {:verifier.code 0} true;
  $i37 := $sub.i64($i36,$i7);
  $i37.shadow := $sub.i64($i36.shadow,$i7.shadow);
  call {:cexpr "u"} boogie_si_record_i64($i37);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 63, 7} true;
  assume {:verifier.code 0} true;
  $i38 := $i37;
  $i38.shadow := $i37.shadow;
  goto $bb10;
$bb6:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i21 == $i21.shadow);
  assert {:shadow_invariant} ($i7 == $i7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 50, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $ult.i64($i21,$i7);
  $i22.shadow := $ult.i64($i21.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 50, 3} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i22 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 51, 8} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i64($i21,1);
  $i23.shadow := $add.i64($i21.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 51, 4} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p0,$mul.ref($i23,4));
  $p24.shadow := $add.ref($p0.shadow,$mul.ref($i23.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 51, 13} true;
  assume {:verifier.code 0} true;
  assert ($p24 == $p24.shadow);
  $M.0 := $store.i32($M.0,$p24,0);
  $M.0.shadow := $store.i32($M.0.shadow,$p24.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 52, 3} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume !($i22 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 53, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb9:
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 50, 30} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i64($i21,1);
  $i25.shadow := $add.i64($i21.shadow,1);
...
$bb10:
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 63, 30} true;
  assume {:verifier.code 0} true;
  $i39 := $ugt.i64($i38,0);
  $i39.shadow := $ugt.i64($i38.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 63, 2} true;
  assume {:verifier.code 0} true;
...
$bb11:
  assume ($i39 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 64, 26} true;
  assume {:verifier.code 0} true;
  $p40 := $add.ref($p1,$mul.ref($i38,4));
  $p40.shadow := $add.ref($p1.shadow,$mul.ref($i38.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 64, 26} true;
  assume {:verifier.code 0} true;
  assert ($p40 == $p40.shadow);
  $i41 := $load.i32($M.0,$p40);
  $i41.shadow := $load.i32($M.0.shadow,$p40.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 64, 3} true;
  assume {:verifier.code 0} true;
  call br_i32_muladd_small($p0, $p0.shadow, $i41, $i41.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 65, 2} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 63, 2} true;
  ...
  goto $bb3;
$bb13:
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 63, 37} true;
  assume {:verifier.code 0} true;
  $i42 := $add.i64($i38,$sub.i64(0,1));
  $i42.shadow := $add.i64($i38.shadow,$sub.i64(0,1));
  call {:cexpr "u"} boogie_si_record_i64($i42);
  assume {:sourceloc "../BearSSL/src/int/i32_reduce.c", 63, 2} true;
  assume {:verifier.code 0} true;
  $i38 := $i42;
  $i38.shadow := $i42.shadow;
  goto $bb10;
}
const br_i32_sub: ref;
axiom (br_i32_sub == $sub.ref(0,17544));
procedure {:inline 1} br_i32_sub($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $M.0, $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $i23.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 35, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_sub:arg:ctl"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 35, 7} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p0,$mul.ref(0,4));
  $p3.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 35, 7} true;
  assume {:verifier.code 0} true;
  assert ($p3 == $p3.shadow);
  $i4 := $load.i32($M.0,$p3);
  $i4.shadow := $load.i32($M.0.shadow,$p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 35, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i4,63);
  $i5.shadow := $add.i32($i4.shadow,63);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 35, 18} true;
  assume {:verifier.code 0} true;
  $i6 := $lshr.i32($i5,5);
  $i6.shadow := $lshr.i32($i5.shadow,5);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 35, 6} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i32.i64($i6);
  $i7.shadow := $zext.i32.i64($i6.shadow);
  call {:cexpr "m"} boogie_si_record_i64($i7);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 36, 7} true;
  assume {:verifier.code 0} true;
  $i8 := 0;
  $i8.shadow := 0;
  $i9 := 1;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 36, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i64($i9,$i7);
  $i10.shadow := $ult.i64($i9.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 36, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  assert ($i10 == $i10.shadow);
  goto $bb2, $bb3;
$bb2:
  assume ($i10 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 39, 8} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p0,$mul.ref($i9,4));
  $p11.shadow := $add.ref($p0.shadow,$mul.ref($i9.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 39, 8} true;
  assume {:verifier.code 0} true;
  assert ($p11 == $p11.shadow);
  $i12 := $load.i32($M.0,$p11);
  $i12.shadow := $load.i32($M.0.shadow,$p11.shadow);
  call {:cexpr "aw"} boogie_si_record_i32($i12);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 40, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p1,$mul.ref($i9,4));
  $p13.shadow := $add.ref($p1.shadow,$mul.ref($i9.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 40, 8} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  $i14 := $load.i32($M.0,$p13);
  $i14.shadow := $load.i32($M.0.shadow,$p13.shadow);
  call {:cexpr "bw"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 41, 12} true;
  assume {:verifier.code 0} true;
  $i15 := $sub.i32($i12,$i14);
  $i15.shadow := $sub.i32($i12.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 41, 17} true;
  assume {:verifier.code 0} true;
  $i16 := $sub.i32($i15,$i8);
  $i16.shadow := $sub.i32($i15.shadow,$i8.shadow);
  call {:cexpr "naw"} boogie_si_record_i32($i16);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 47, 14} true;
  assume {:verifier.code 0} true;
  call $i17, $i17.shadow := EQ.23($i16, $i16.shadow, $i12, $i12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 47, 12} true;
  assume {:verifier.code 0} true;
  $i18 := $and.i32($i8,$i17);
  $i18.shadow := $and.i32($i8.shadow,$i17.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 47, 29} true;
  assume {:verifier.code 0} true;
  call $i19, $i19.shadow := GT.24($i16, $i16.shadow, $i12, $i12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 47, 27} true;
  assume {:verifier.code 0} true;
  $i20 := $or.i32($i18,$i19);
  $i20.shadow := $or.i32($i18.shadow,$i19.shadow);
  call {:cexpr "cc"} boogie_si_record_i32($i20);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 48, 10} true;
  assume {:verifier.code 0} true;
  call $i21, $i21.shadow := MUX.25($i2, $i2.shadow, $i16, $i16.shadow, $i12, $i12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 48, 3} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p0,$mul.ref($i9,4));
  $p22.shadow := $add.ref($p0.shadow,$mul.ref($i9.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 48, 8} true;
  assume {:verifier.code 0} true;
  assert ($p22 == $p22.shadow);
  $M.0 := $store.i32($M.0,$p22,$i21);
  $M.0.shadow := $store.i32($M.0.shadow,$p22.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 49, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i10 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 50, 2} true;
  assume {:verifier.code 0} true;
  $r := $i8;
  $r.shadow := $i8.shadow;
  $exn := false;
  ...
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 36, 23} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i64($i9,1);
  $i23.shadow := $add.i64($i9.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i23);
  assume {:sourceloc "../BearSSL/src/int/i32_sub.c", 36, 2} true;
  assume {:verifier.code 0} true;
  $i8 := $i20;
  $i8.shadow := $i20.shadow;
  $i9 := $i23;
  $i9.shadow := $i23.shadow;
  goto $bb1;
}
const br_i32_add: ref;
axiom (br_i32_add == $sub.ref(0,18576));
procedure {:inline 1} br_i32_add($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $M.0, $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $i23.shadow: i64;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 35, 7} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_add:arg:ctl"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 35, 7} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p0,$mul.ref(0,4));
  $p3.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  ...
  $i4 := $load.i32($M.0,$p3);
  $i4.shadow := $load.i32($M.0.shadow,$p3.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 35, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i4,63);
  $i5.shadow := $add.i32($i4.shadow,63);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 35, 18} true;
  assume {:verifier.code 0} true;
  $i6 := $lshr.i32($i5,5);
  $i6.shadow := $lshr.i32($i5.shadow,5);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 35, 6} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i32.i64($i6);
  $i7.shadow := $zext.i32.i64($i6.shadow);
  call {:cexpr "m"} boogie_si_record_i64($i7);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 36, 7} true;
  assume {:verifier.code 0} true;
  $i8 := 0;
  $i8.shadow := 0;
  $i9 := 1;
...
$bb1:
  ...
  assert {:shadow_invariant} ($i9 == $i9.shadow);
  assert {:unlikely_shadow_invariant ($i8 == $i8.shadow)} true;
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 36, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i64($i9,$i7);
  $i10.shadow := $ult.i64($i9.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 36, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i10} true;
  assert ($i10 == $i10.shadow);
  goto $bb2, $bb3;
$bb2:
  assume ($i10 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 39, 8} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p0,$mul.ref($i9,4));
  $p11.shadow := $add.ref($p0.shadow,$mul.ref($i9.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 39, 8} true;
  ...
  $i12.shadow := $load.i32($M.0.shadow,$p11.shadow);
  call {:cexpr "aw"} boogie_si_record_i32($i12);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 40, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p1,$mul.ref($i9,4));
  $p13.shadow := $add.ref($p1.shadow,$mul.ref($i9.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 40, 8} true;
  ...
  $i14.shadow := $load.i32($M.0.shadow,$p13.shadow);
  call {:cexpr "bw"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 41, 12} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i12,$i14);
  $i15.shadow := $add.i32($i12.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 41, 17} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i32($i15,$i8);
  $i16.shadow := $add.i32($i15.shadow,$i8.shadow);
  call {:cexpr "naw"} boogie_si_record_i32($i16);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 47, 14} true;
  assume {:verifier.code 0} true;
  call $i17, $i17.shadow := EQ($i16, $i16.shadow, $i12, $i12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 47, 12} true;
  assume {:verifier.code 0} true;
  $i18 := $and.i32($i8,$i17);
  $i18.shadow := $and.i32($i8.shadow,$i17.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 47, 29} true;
  assume {:verifier.code 0} true;
  call $i19, $i19.shadow := GT($i12, $i12.shadow, $i16, $i16.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 47, 27} true;
  assume {:verifier.code 0} true;
  $i20 := $or.i32($i18,$i19);
  $i20.shadow := $or.i32($i18.shadow,$i19.shadow);
  call {:cexpr "cc"} boogie_si_record_i32($i20);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 48, 10} true;
  assume {:verifier.code 0} true;
  call $i21, $i21.shadow := MUX.1($i2, $i2.shadow, $i16, $i16.shadow, $i12, $i12.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 48, 3} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p0,$mul.ref($i9,4));
  $p22.shadow := $add.ref($p0.shadow,$mul.ref($i9.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 48, 8} true;
  assume {:verifier.code 0} true;
  assert ($p22 == $p22.shadow);
  $M.0 := $store.i32($M.0,$p22,$i21);
  $M.0.shadow := $store.i32($M.0.shadow,$p22.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 49, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i10 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 50, 2} true;
  assume {:verifier.code 0} true;
  $r := $i8;
  $r.shadow := $i8.shadow;
  $exn := false;
  ...
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/int/i32_add.c", 36, 23} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i64($i9,1);
  $i23.shadow := $add.i64($i9.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i23);
...
const br_i32_to_monty: ref;
axiom (br_i32_to_monty == $sub.ref(0,19608));
procedure {:inline 1} br_i32_to_monty($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $exn;
modifies $M.0;
modifies $CurrAddr;
{
  ...
  var $i8.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 33, 12} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 33, 12} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1,$mul.ref(0,4));
  $p2.shadow := $add.ref($p1.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 33, 12} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $i3 := $load.i32($M.0,$p2);
  $i3.shadow := $load.i32($M.0.shadow,$p2.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 33, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i3,31);
  $i4.shadow := $add.i32($i3.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 33, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $lshr.i32($i4,5);
  $i5.shadow := $lshr.i32($i4.shadow,5);
  call {:cexpr "k"} boogie_si_record_i32($i5);
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 33, 7} true;
  assume {:verifier.code 0} true;
  $i6 := $i5;
  $i6.shadow := $i5.shadow;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 33, 31} true;
  assume {:verifier.code 0} true;
  $i7 := $ugt.i32($i6,0);
  $i7.shadow := $ugt.i32($i6.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 33, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  assert ($i7 == $i7.shadow);
  goto $bb2, $bb3;
$bb2:
  assume ($i7 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 34, 3} true;
  assume {:verifier.code 0} true;
  call br_i32_muladd_small($p0, $p0.shadow, 0, 0, $p1, $p1.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 35, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i7 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 36, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 33, 38} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i6,$sub.i32(0,1));
  $i8.shadow := $add.i32($i6.shadow,$sub.i32(0,1));
  call {:cexpr "k"} boogie_si_record_i32($i8);
  assume {:sourceloc "../BearSSL/src/int/i32_tmont.c", 33, 2} true;
  assume {:verifier.code 0} true;
  $i6 := $i8;
  $i6.shadow := $i8.shadow;
...
const br_i32_montymul: ref;
axiom (br_i32_montymul == $sub.ref(0,20640));
procedure {:inline 1} br_i32_montymul($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref, $i4: i32, $i4.shadow: i32)
modifies $exn, $M.0;
{
  var $p5: ref;
  var $p5.shadow: ref;
  ...
  var $i71.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 35, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_montymul:arg:m0i"} boogie_si_record_i32($i4);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 35, 9} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p3,$mul.ref(0,4));
  $p5.shadow := $add.ref($p3.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 35, 9} true;
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $i6 := $load.i32($M.0,$p5);
  $i6.shadow := $load.i32($M.0.shadow,$p5.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 35, 14} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i6,31);
  $i7.shadow := $add.i32($i6.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 35, 20} true;
  assume {:verifier.code 0} true;
  $i8 := $lshr.i32($i7,5);
  $i8.shadow := $lshr.i32($i7.shadow,5);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 35, 8} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i32.i64($i8);
  $i9.shadow := $zext.i32.i64($i8.shadow);
  call {:cexpr "len"} boogie_si_record_i64($i9);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 36, 17} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($p3,$mul.ref(0,4));
  $p10.shadow := $add.ref($p3.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 36, 17} true;
  assume {:verifier.code 0} true;
  assert ($p10 == $p10.shadow);
  $i11 := $load.i32($M.0,$p10);
  $i11.shadow := $load.i32($M.0.shadow,$p10.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 36, 2} true;
  assume {:verifier.code 0} true;
  call br_i32_zero.11($p0, $p0.shadow, $i11, $i11.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 38, 7} true;
  assume {:verifier.code 0} true;
  $i12 := 0;
  $i12.shadow := 0;
  $i13 := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 38, 16} true;
  assume {:verifier.code 0} true;
  $i14 := $ult.i64($i12,$i9);
  $i14.shadow := $ult.i64($i12.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 38, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i14 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 42, 12} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i64($i12,1);
  $i15.shadow := $add.i64($i12.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 42, 8} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "xu"} boogie_si_record_i32($i17);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 43, 8} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p0,$mul.ref(1,4));
  $p18.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 43, 8} true;
  assume {:verifier.code 0} true;
  assert ($p18 == $p18.shadow);
  $i19 := $load.i32($M.0,$p18);
  $i19.shadow := $load.i32($M.0.shadow,$p18.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 43, 19} true;
  assume {:verifier.code 0} true;
  $i20 := $add.i64($i12,1);
  $i20.shadow := $add.i64($i12.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 43, 15} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p1,$mul.ref($i20,4));
  $p21.shadow := $add.ref($p1.shadow,$mul.ref($i20.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 43, 15} true;
  assume {:verifier.code 0} true;
  assert ($p21 == $p21.shadow);
  $i22 := $load.i32($M.0,$p21);
  $i22.shadow := $load.i32($M.0.shadow,$p21.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 43, 26} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p2,$mul.ref(1,4));
  $p23.shadow := $add.ref($p2.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 43, 26} true;
  assume {:verifier.code 0} true;
  assert ($p23 == $p23.shadow);
  $i24 := $load.i32($M.0,$p23);
  $i24.shadow := $load.i32($M.0.shadow,$p23.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 43, 24} true;
  assume {:verifier.code 0} true;
  $i25 := $mul.i32($i22,$i24);
  $i25.shadow := $mul.i32($i22.shadow,$i24.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 43, 13} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i32($i19,$i25);
  $i26.shadow := $add.i32($i19.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 43, 32} true;
  assume {:verifier.code 0} true;
  $i27 := $mul.i32($i26,$i4);
  $i27.shadow := $mul.i32($i26.shadow,$i4.shadow);
  call {:cexpr "f"} boogie_si_record_i32($i27);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 46, 8} true;
  assume {:verifier.code 0} true;
  $i28 := 0;
  $i28.shadow := 0;
  $i29 := 0;
...
$bb3:
  assume !($i14 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 68, 23} true;
  assume {:verifier.code 0} true;
  $i66 := $trunc.i64.i32($i13);
  $i66.shadow := $trunc.i64.i32($i13.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 68, 19} true;
  assume {:verifier.code 0} true;
  call $i67, $i67.shadow := NEQ.12($i66, $i66.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 68, 36} true;
  assume {:verifier.code 0} true;
  call $i68, $i68.shadow := br_i32_sub($p0, $p0.shadow, $p3, $p3.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 68, 32} true;
  assume {:verifier.code 0} true;
  call $i69, $i69.shadow := NOT.13($i68, $i68.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 68, 30} true;
  assume {:verifier.code 0} true;
  $i70 := $or.i32($i67,$i69);
  $i70.shadow := $or.i32($i67.shadow,$i69.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 68, 2} true;
  assume {:verifier.code 0} true;
  call $i71, $i71.shadow := br_i32_sub($p0, $p0.shadow, $p3, $p3.shadow, $i70, $i70.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 69, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i28 == $i28.shadow);
  assert {:shadow_invariant} ($i9 == $i9.shadow);
  assert {:shadow_invariant} ($i12 == $i12.shadow);
  ...
  assert {:unlikely_shadow_invariant ($i30 == $i30.shadow)} true;
  assert {:unlikely_shadow_invariant ($i13 == $i13.shadow)} true;
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 0, 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 46, 17} true;
  assume {:verifier.code 0} true;
  $i31 := $ult.i64($i28,$i9);
  $i31.shadow := $ult.i64($i28.shadow,$i9.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 46, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i31} true;
  assert ($i31 == $i31.shadow);
  goto $bb5, $bb6;
$bb5:
  assume ($i31 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 50, 22} true;
  assume {:verifier.code 0} true;
  $i32 := $add.i64($i28,1);
  $i32.shadow := $add.i64($i28.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 50, 18} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($p0,$mul.ref($i32,4));
  $p33.shadow := $add.ref($p0.shadow,$mul.ref($i32.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 50, 18} true;
  assume {:verifier.code 0} true;
  assert ($p33 == $p33.shadow);
  $i34 := $load.i32($M.0,$p33);
  $i34.shadow := $load.i32($M.0.shadow,$p33.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 50, 8} true;
  assume {:verifier.code 0} true;
  $i35 := $zext.i32.i64($i34);
  $i35.shadow := $zext.i32.i64($i34.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 50, 29} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i32.i64($i17);
  $i36.shadow := $zext.i32.i64($i17.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 50, 29} true;
  assume {:verifier.code 0} true;
  $i37 := $add.i64($i28,1);
  $i37.shadow := $add.i64($i28.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 50, 29} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p2,$mul.ref($i37,4));
  $p38.shadow := $add.ref($p2.shadow,$mul.ref($i37.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 50, 29} true;
  assume {:verifier.code 0} true;
  assert ($p38 == $p38.shadow);
  $i39 := $load.i32($M.0,$p38);
  $i39.shadow := $load.i32($M.0.shadow,$p38.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 50, 29} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i41 := $mul.i64($i36,$i40);
  $i41.shadow := $mul.i64($i36.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 50, 27} true;
  assume {:verifier.code 0} true;
  $i42 := $add.i64($i35,$i41);
  $i42.shadow := $add.i64($i35.shadow,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 50, 47} true;
  assume {:verifier.code 0} true;
  $i43 := $add.i64($i42,$i29);
  $i43.shadow := $add.i64($i42.shadow,$i29.shadow);
  call {:cexpr "z"} boogie_si_record_i64($i43);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 51, 11} true;
  assume {:verifier.code 0} true;
  $i44 := $lshr.i64($i43,32);
  $i44.shadow := $lshr.i64($i43.shadow,32);
  call {:cexpr "r1"} boogie_si_record_i64($i44);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 52, 8} true;
  assume {:verifier.code 0} true;
  $i45 := $trunc.i64.i32($i43);
  $i45.shadow := $trunc.i64.i32($i43.shadow);
  call {:cexpr "t"} boogie_si_record_i32($i45);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 53, 8} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i32.i64($i45);
  $i46.shadow := $zext.i32.i64($i45.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 53, 22} true;
  assume {:verifier.code 0} true;
  $i47 := $zext.i32.i64($i27);
  $i47.shadow := $zext.i32.i64($i27.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 53, 22} true;
  assume {:verifier.code 0} true;
  $i48 := $add.i64($i28,1);
  $i48.shadow := $add.i64($i28.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 53, 22} true;
  assume {:verifier.code 0} true;
  $p49 := $add.ref($p3,$mul.ref($i48,4));
  $p49.shadow := $add.ref($p3.shadow,$mul.ref($i48.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 53, 22} true;
  assume {:verifier.code 0} true;
  assert ($p49 == $p49.shadow);
  $i50 := $load.i32($M.0,$p49);
  $i50.shadow := $load.i32($M.0.shadow,$p49.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 53, 22} true;
  assume {:verifier.code 0} true;
  $i51 := $zext.i32.i64($i50);
  $i51.shadow := $zext.i32.i64($i50.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 53, 22} true;
  assume {:verifier.code 0} true;
  $i52 := $mul.i64($i47,$i51);
  $i52.shadow := $mul.i64($i47.shadow,$i51.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 53, 20} true;
  assume {:verifier.code 0} true;
  $i53 := $add.i64($i46,$i52);
  $i53.shadow := $add.i64($i46.shadow,$i52.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 53, 39} true;
  assume {:verifier.code 0} true;
  $i54 := $add.i64($i53,$i30);
  $i54.shadow := $add.i64($i53.shadow,$i30.shadow);
  call {:cexpr "z"} boogie_si_record_i64($i54);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 54, 11} true;
  assume {:verifier.code 0} true;
  $i55 := $lshr.i64($i54,32);
  $i55.shadow := $lshr.i64($i54.shadow,32);
  call {:cexpr "r2"} boogie_si_record_i64($i55);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 55, 10} true;
  assume {:verifier.code 0} true;
  $i56 := $ne.i64($i28,0);
  $i56.shadow := $ne.i64($i28.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 55, 8} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i56} true;
  assert ($i56 == $i56.shadow);
  goto $bb7, $bb8;
$bb6:
  assume !($i31 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 59, 11} true;
  assume {:verifier.code 0} true;
  $i60 := $add.i64($i13,$i29);
  $i60.shadow := $add.i64($i13.shadow,$i29.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 59, 16} true;
  assume {:verifier.code 0} true;
  $i61 := $add.i64($i60,$i30);
  $i61.shadow := $add.i64($i60.shadow,$i30.shadow);
  call {:cexpr "zh"} boogie_si_record_i64($i61);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 60, 12} true;
  assume {:verifier.code 0} true;
  $i62 := $trunc.i64.i32($i61);
  $i62.shadow := $trunc.i64.i32($i61.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 60, 3} true;
  assume {:verifier.code 0} true;
  $p63 := $add.ref($p0,$mul.ref($i9,4));
  $p63.shadow := $add.ref($p0.shadow,$mul.ref($i9.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 60, 10} true;
  assume {:verifier.code 0} true;
  assert ($p63 == $p63.shadow);
  $M.0 := $store.i32($M.0,$p63,$i62);
  $M.0.shadow := $store.i32($M.0.shadow,$p63.shadow,$i62.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 61, 11} true;
  assume {:verifier.code 0} true;
  $i64 := $lshr.i64($i61,32);
  $i64.shadow := $lshr.i64($i61.shadow,32);
  call {:cexpr "dh"} boogie_si_record_i64($i64);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 62, 2} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb7:
  assume ($i56 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 56, 12} true;
  assume {:verifier.code 0} true;
  $i57 := $trunc.i64.i32($i54);
  $i57.shadow := $trunc.i64.i32($i54.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 56, 5} true;
  assume {:verifier.code 0} true;
  $p58 := $add.ref($p0,$mul.ref($i28,4));
  $p58.shadow := $add.ref($p0.shadow,$mul.ref($i28.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 56, 10} true;
  assume {:verifier.code 0} true;
  assert ($p58 == $p58.shadow);
  $M.0 := $store.i32($M.0,$p58,$i57);
  $M.0.shadow := $store.i32($M.0.shadow,$p58.shadow,$i57.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 57, 4} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 55, 8} true;
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 58, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 46, 26} true;
  assume {:verifier.code 0} true;
  $i59 := $add.i64($i28,1);
  $i59.shadow := $add.i64($i28.shadow,1);
  call {:cexpr "v"} boogie_si_record_i64($i59);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 46, 3} true;
  assume {:verifier.code 0} true;
  $i28 := $i59;
  $i28.shadow := $i59.shadow;
  $i29 := $i44;
  $i29.shadow := $i44.shadow;
  $i30 := $i55;
  $i30.shadow := $i55.shadow;
  goto $bb4;
$bb11:
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 38, 25} true;
  assume {:verifier.code 0} true;
  $i65 := $add.i64($i12,1);
  $i65.shadow := $add.i64($i12.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i65);
  assume {:sourceloc "../BearSSL/src/int/i32_montmul.c", 38, 2} true;
  assume {:verifier.code 0} true;
  $i12 := $i65;
  $i12.shadow := $i65.shadow;
  $i13 := $i64;
  $i13.shadow := $i64.shadow;
  goto $bb1;
}
const br_i32_zero.11: ref;
axiom (br_i32_zero.11 == $sub.ref(0,21672));
procedure {:inline 1} br_i32_zero.11($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32)
modifies $M.0, $exn;
{
  var $p2: ref;
  var $p2.shadow: ref;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 1237, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_zero.11:arg:bit_len"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1237, 5} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p0,$mul.ref(1,4));
  $p2.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
...
const NEQ.12: ref;
axiom (NEQ.12 == $sub.ref(0,22704));
procedure {:inline 1} NEQ.12($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "NEQ.12:arg:x"} boogie_si_record_i32($i0);
  call {:cexpr "NEQ.12:arg:y"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 795, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i32($i0,$i1);
...
const NOT.13: ref;
axiom (NOT.13 == $sub.ref(0,23736));
procedure {:inline 1} NOT.13($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "NOT.13:arg:ctl"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $xor.i32($i0,1);
...
axiom (llvm.memset.p0i8.i64 == $sub.ref(0,24768));
procedure {:inline 1} llvm.memset.p0i8.i64($p0: ref, $p0.shadow: ref, $i1: i8, $i1.shadow: i8, $i2: i64, $i2.shadow: i64, $i3: i1, $i3.shadow: i1);
const br_i32_muladd_small: ref;
axiom (br_i32_muladd_small == $sub.ref(0,25800));
procedure {:inline 1} br_i32_muladd_small($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32, $p2: ref, $p2.shadow: ref)
modifies $exn, $M.0;
modifies $CurrAddr;
{
  var $p3: ref;
  ...
  var $i74.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 41, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_muladd_small:arg:z"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 41, 13} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p2,$mul.ref(0,4));
  $p3.shadow := $add.ref($p2.shadow,$mul.ref(0,4));
  ...
  $i4.shadow := $load.i32($M.0.shadow,$p3.shadow);
  call {:cexpr "m_bitlen"} boogie_si_record_i32($i4);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 42, 15} true;
  assume {:verifier.code 0} true;
  $i5 := $eq.i32($i4,0);
  $i5.shadow := $eq.i32($i4.shadow,0);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 42, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  assert ($i5 == $i5.shadow);
  goto $bb1, $bb2;
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 43, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !($i5 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 45, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $ule.i32($i4,32);
  $i6.shadow := $ule.i32($i4.shadow,32);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 45, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  assert ($i6 == $i6.shadow);
  goto $bb4, $bb5;
$bb3:
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 138, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume ($i6 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 46, 17} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p0,$mul.ref(1,4));
  $p7.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 46, 17} true;
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $i8 := $load.i32($M.0,$p7);
  $i8.shadow := $load.i32($M.0.shadow,$p7.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 46, 26} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p2,$mul.ref(1,4));
  $p9.shadow := $add.ref($p2.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 46, 26} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $i10 := $load.i32($M.0,$p9);
  $i10.shadow := $load.i32($M.0.shadow,$p9.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 46, 10} true;
  assume {:verifier.code 0} true;
  call $i11, $i11.shadow := br_rem($i8, $i8.shadow, $i1, $i1.shadow, $i10, $i10.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 46, 3} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p0,$mul.ref(1,4));
  $p12.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 46, 8} true;
  assume {:verifier.code 0} true;
  assert ($p12 == $p12.shadow);
  $M.0 := $store.i32($M.0,$p12,$i11);
  $M.0.shadow := $store.i32($M.0.shadow,$p12.shadow,$i11.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 47, 3} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb5:
  assume !($i6 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 49, 19} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i4,31);
  $i13.shadow := $add.i32($i4.shadow,31);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 49, 25} true;
  assume {:verifier.code 0} true;
  $i14 := $lshr.i32($i13,5);
  $i14.shadow := $lshr.i32($i13.shadow,5);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 49, 9} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i32.i64($i14);
  $i15.shadow := $zext.i32.i64($i14.shadow);
  call {:cexpr "mlen"} boogie_si_record_i64($i15);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 77, 31} true;
  assume {:verifier.code 0} true;
  $i16 := $sub.i32($i4,32);
  $i16.shadow := $sub.i32($i4.shadow,32);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 77, 7} true;
  assume {:verifier.code 0} true;
  call $i17, $i17.shadow := br_i32_word($p0, $p0.shadow, $i16, $i16.shadow);
  call {:cexpr "a0"} boogie_si_record_i32($i17);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 78, 7} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p0,$mul.ref($i15,4));
  $p18.shadow := $add.ref($p0.shadow,$mul.ref($i15.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 78, 7} true;
  assume {:verifier.code 0} true;
  assert ($p18 == $p18.shadow);
  $i19 := $load.i32($M.0,$p18);
  $i19.shadow := $load.i32($M.0.shadow,$p18.shadow);
  call {:cexpr "hi"} boogie_si_record_i32($i19);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 79, 12} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($p0,$mul.ref(2,4));
  $p20.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 79, 2} true;
  assume {:verifier.code 0} true;
  $p21 := $bitcast.ref.ref($p20);
  $p21.shadow := $bitcast.ref.ref($p20.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 79, 19} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p0,$mul.ref(1,4));
  $p22.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 79, 2} true;
  assume {:verifier.code 0} true;
  $p23 := $bitcast.ref.ref($p22);
  $p23.shadow := $bitcast.ref.ref($p22.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 79, 30} true;
  assume {:verifier.code 0} true;
  $i24 := $sub.i64($i15,1);
  $i24.shadow := $sub.i64($i15.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 79, 35} true;
  assume {:verifier.code 0} true;
  $i25 := $mul.i64($i24,4);
  $i25.shadow := $mul.i64($i24.shadow,4);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 79, 2} true;
  assume {:verifier.code 0} true;
  call llvm.memmove.p0i8.p0i8.i64($p21, $p21.shadow, $p23, $p23.shadow, $i25, $i25.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 80, 2} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p0,$mul.ref(1,4));
  $p26.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 80, 7} true;
  assume {:verifier.code 0} true;
  assert ($p26 == $p26.shadow);
  $M.0 := $store.i32($M.0,$p26,$i1);
  $M.0.shadow := $store.i32($M.0.shadow,$p26.shadow,$i1.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 81, 31} true;
  assume {:verifier.code 0} true;
  $i27 := $sub.i32($i4,32);
  $i27.shadow := $sub.i32($i4.shadow,32);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 81, 7} true;
  assume {:verifier.code 0} true;
  call $i28, $i28.shadow := br_i32_word($p0, $p0.shadow, $i27, $i27.shadow);
  call {:cexpr "a1"} boogie_si_record_i32($i28);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 82, 31} true;
  assume {:verifier.code 0} true;
  $i29 := $sub.i32($i4,32);
  $i29.shadow := $sub.i32($i4.shadow,32);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 82, 7} true;
  assume {:verifier.code 0} true;
  call $i30, $i30.shadow := br_i32_word($p2, $p2.shadow, $i29, $i29.shadow);
  call {:cexpr "b0"} boogie_si_record_i32($i30);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 94, 6} true;
  assume {:verifier.code 0} true;
  call $i31, $i31.shadow := br_div($i17, $i17.shadow, $i28, $i28.shadow, $i30, $i30.shadow);
  call {:cexpr "g"} boogie_si_record_i32($i31);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 95, 10} true;
  assume {:verifier.code 0} true;
  call $i32, $i32.shadow := EQ.16($i17, $i17.shadow, $i30, $i30.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 95, 38} true;
  assume {:verifier.code 0} true;
  call $i33, $i33.shadow := EQ.16($i31, $i31.shadow, 0, 0);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 95, 53} true;
  assume {:verifier.code 0} true;
  $i34 := $sub.i32($i31,1);
  $i34.shadow := $sub.i32($i31.shadow,1);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 95, 34} true;
  assume {:verifier.code 0} true;
  call $i35, $i35.shadow := MUX.17($i33, $i33.shadow, 0, 0, $i34, $i34.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 95, 6} true;
  assume {:verifier.code 0} true;
  call $i36, $i36.shadow := MUX.17($i32, $i32.shadow, $sub.i32(0,1), $sub.i32(0,1), $i35, $i35.shadow);
  call {:cexpr "q"} boogie_si_record_i32($i36);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 108, 7} true;
  assume {:verifier.code 0} true;
  $i37 := 1;
  $i37.shadow := 1;
  $i38 := 1;
...
$bb6:
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 108, 16} true;
  assume {:verifier.code 0} true;
  $i40 := $ule.i64($i37,$i15);
  $i40.shadow := $ule.i64($i37.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 108, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i40} true;
  assert ($i40 == $i40.shadow);
  goto $bb7, $bb8;
$bb7:
  assume ($i40 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 112, 8} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($p2,$mul.ref($i37,4));
  $p41.shadow := $add.ref($p2.shadow,$mul.ref($i37.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 112, 8} true;
  assume {:verifier.code 0} true;
  assert ($p41 == $p41.shadow);
  $i42 := $load.i32($M.0,$p41);
  $i42.shadow := $load.i32($M.0.shadow,$p41.shadow);
  call {:cexpr "mw"} boogie_si_record_i32($i42);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 113, 8} true;
  assume {:verifier.code 0} true;
  $i43 := $zext.i32.i64($i42);
  $i43.shadow := $zext.i32.i64($i42.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 113, 8} true;
  assume {:verifier.code 0} true;
  $i44 := $zext.i32.i64($i36);
  $i44.shadow := $zext.i32.i64($i36.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 113, 8} true;
  assume {:verifier.code 0} true;
  $i45 := $mul.i64($i43,$i44);
  $i45.shadow := $mul.i64($i43.shadow,$i44.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 113, 19} true;
  assume {:verifier.code 0} true;
  $i46 := $add.i64($i45,$i39);
  $i46.shadow := $add.i64($i45.shadow,$i39.shadow);
  call {:cexpr "zl"} boogie_si_record_i64($i46);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 114, 22} true;
  assume {:verifier.code 0} true;
  $i47 := $lshr.i64($i46,32);
  $i47.shadow := $lshr.i64($i46.shadow,32);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 114, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 115, 8} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i64.i32($i46);
  $i50.shadow := $trunc.i64.i32($i46.shadow);
  call {:cexpr "zw"} boogie_si_record_i32($i50);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 116, 8} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($p0,$mul.ref($i37,4));
  $p51.shadow := $add.ref($p0.shadow,$mul.ref($i37.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 116, 8} true;
  assume {:verifier.code 0} true;
  assert ($p51 == $p51.shadow);
  $i52 := $load.i32($M.0,$p51);
  $i52.shadow := $load.i32($M.0.shadow,$p51.shadow);
  call {:cexpr "xw"} boogie_si_record_i32($i52);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 117, 12} true;
  assume {:verifier.code 0} true;
  $i53 := $sub.i32($i52,$i50);
  $i53.shadow := $sub.i32($i52.shadow,$i50.shadow);
  call {:cexpr "nxw"} boogie_si_record_i32($i53);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 118, 19} true;
  assume {:verifier.code 0} true;
  call $i54, $i54.shadow := GT.18($i53, $i53.shadow, $i52, $i52.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 118, 9} true;
  assume {:verifier.code 0} true;
  $i55 := $zext.i32.i64($i54);
  $i55.shadow := $zext.i32.i64($i54.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 118, 6} true;
  assume {:verifier.code 0} true;
  $i56 := $add.i64($i49,$i55);
  $i56.shadow := $add.i64($i49.shadow,$i55.shadow);
  call {:cexpr "cc"} boogie_si_record_i64($i56);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 119, 3} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($p0,$mul.ref($i37,4));
  $p57.shadow := $add.ref($p0.shadow,$mul.ref($i37.shadow,4));
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 119, 8} true;
  assume {:verifier.code 0} true;
  assert ($p57 == $p57.shadow);
  $M.0 := $store.i32($M.0,$p57,$i53);
  $M.0.shadow := $store.i32($M.0.shadow,$p57.shadow,$i53.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 120, 12} true;
  assume {:verifier.code 0} true;
  call $i58, $i58.shadow := EQ.16($i53, $i53.shadow, $i42, $i42.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 120, 29} true;
  assume {:verifier.code 0} true;
  call $i59, $i59.shadow := GT.18($i53, $i53.shadow, $i42, $i42.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 120, 8} true;
  assume {:verifier.code 0} true;
  call $i60, $i60.shadow := MUX.17($i58, $i58.shadow, $i38, $i38.shadow, $i59, $i59.shadow);
  call {:cexpr "tb"} boogie_si_record_i32($i60);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 121, 2} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb8:
  assume !($i40 == 1);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 132, 22} true;
  assume {:verifier.code 0} true;
  $i62 := $lshr.i64($i39,32);
  $i62.shadow := $lshr.i64($i39.shadow,32);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 132, 8} true;
  assume {:verifier.code 0} true;
  $i63 := $trunc.i64.i32($i62);
  $i63.shadow := $trunc.i64.i32($i62.shadow);
  call {:cexpr "chf"} boogie_si_record_i32($i63);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 133, 9} true;
  assume {:verifier.code 0} true;
  $i64 := $trunc.i64.i32($i39);
  $i64.shadow := $trunc.i64.i32($i39.shadow);
  call {:cexpr "clow"} boogie_si_record_i32($i64);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 134, 15} true;
  assume {:verifier.code 0} true;
  call $i65, $i65.shadow := GT.18($i64, $i64.shadow, $i19, $i19.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 134, 13} true;
  assume {:verifier.code 0} true;
  $i66 := $or.i32($i63,$i65);
  $i66.shadow := $or.i32($i63.shadow,$i65.shadow);
  call {:cexpr "over"} boogie_si_record_i32($i66);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 135, 10} true;
  assume {:verifier.code 0} true;
  $i67 := $xor.i32($i66,$sub.i32(0,1));
  $i67.shadow := $xor.i32($i66.shadow,$sub.i32(0,1));
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 135, 25} true;
  assume {:verifier.code 0} true;
  $i68 := $xor.i32($i63,$sub.i32(0,1));
  $i68.shadow := $xor.i32($i63.shadow,$sub.i32(0,1));
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 135, 32} true;
  assume {:verifier.code 0} true;
  call $i69, $i69.shadow := GT.18($i19, $i19.shadow, $i64, $i64.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 135, 30} true;
  assume {:verifier.code 0} true;
  $i70 := $and.i32($i68,$i69);
  $i70.shadow := $and.i32($i68.shadow,$i69.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 135, 22} true;
  assume {:verifier.code 0} true;
  $i71 := $or.i32($i38,$i70);
  $i71.shadow := $or.i32($i38.shadow,$i70.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 135, 16} true;
  assume {:verifier.code 0} true;
  $i72 := $and.i32($i67,$i71);
  $i72.shadow := $and.i32($i67.shadow,$i71.shadow);
  call {:cexpr "under"} boogie_si_record_i32($i72);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 136, 2} true;
  assume {:verifier.code 0} true;
  call $i73, $i73.shadow := br_i32_add($p0, $p0.shadow, $p2, $p2.shadow, $i66, $i66.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 137, 2} true;
  assume {:verifier.code 0} true;
  call $i74, $i74.shadow := br_i32_sub($p0, $p0.shadow, $p2, $p2.shadow, $i72, $i72.shadow);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 138, 1} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb9:
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 108, 27} true;
  assume {:verifier.code 0} true;
  $i61 := $add.i64($i37,1);
  $i61.shadow := $add.i64($i37.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i61);
  assume {:sourceloc "../BearSSL/src/int/i32_muladd.c", 108, 2} true;
  assume {:verifier.code 0} true;
  $i37 := $i61;
  $i37.shadow := $i61.shadow;
  $i38 := $i60;
  $i38.shadow := $i60.shadow;
  $i39 := $i56;
  $i39.shadow := $i56.shadow;
  goto $bb6;
}
const br_rem: ref;
axiom (br_rem == $sub.ref(0,26832));
procedure {:inline 1} br_rem($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
modifies $CurrAddr;
{
  var $p3: ref;
  ...
  var $i5.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 1054, 2} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(4,$zext.i32.i64(1)));
  $p3.shadow := $p3;
  call {:cexpr "br_rem:arg:hi"} boogie_si_record_i32($i0);
  call {:cexpr "br_rem:arg:lo"} boogie_si_record_i32($i1);
  call {:cexpr "br_rem:arg:d"} boogie_si_record_i32($i2);
  assume true;
  assume {:sourceloc "../BearSSL/src/inner.h", 1054, 2} true;
  assume {:verifier.code 0} true;
  call $i4, $i4.shadow := br_divrem($i0, $i0.shadow, $i1, $i1.shadow, $i2, $i2.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1055, 9} true;
  assume {:verifier.code 0} true;
  assert ($p3 == $p3.shadow);
  $i5 := $load.i32($M.13,$p3);
  $i5.shadow := $load.i32($M.13.shadow,$p3.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1055, 2} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $r.shadow := $i5.shadow;
  $exn := false;
...
const br_i32_word: ref;
axiom (br_i32_word == $sub.ref(0,27864));
procedure {:inline 1} br_i32_word($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
  ...
  var $i9.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 1185, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_word:arg:off"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1185, 19} true;
  assume {:verifier.code 0} true;
  $i2 := $lshr.i32($i1,5);
  $i2.shadow := $lshr.i32($i1.shadow,5);
  assume {:sourceloc "../BearSSL/src/inner.h", 1185, 6} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i32.i64($i2);
  $i3.shadow := $zext.i32.i64($i2.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1185, 25} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i64($i3,1);
  $i4.shadow := $add.i64($i3.shadow,1);
  call {:cexpr "u"} boogie_si_record_i64($i4);
  assume {:sourceloc "../BearSSL/src/inner.h", 1186, 20} true;
  assume {:verifier.code 0} true;
  $i5 := $and.i32($i1,31);
  $i5.shadow := $and.i32($i1.shadow,31);
  call {:cexpr "j"} boogie_si_record_i32($i5);
  assume {:sourceloc "../BearSSL/src/inner.h", 1187, 8} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i5,0);
  $i6.shadow := $eq.i32($i5.shadow,0);
  assume {:sourceloc "../BearSSL/src/inner.h", 1187, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  assert ($i6 == $i6.shadow);
  goto $bb1, $bb2;
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1188, 10} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p0,$mul.ref($i4,4));
  $p7.shadow := $add.ref($p0.shadow,$mul.ref($i4.shadow,4));
  assume {:sourceloc "../BearSSL/src/inner.h", 1188, 10} true;
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $i8 := $load.i32($M.0,$p7);
  $i8.shadow := $load.i32($M.0.shadow,$p7.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1188, 3} true;
  assume {:verifier.code 0} true;
  $i9 := $i8;
  $i9.shadow := $i8.shadow;
  goto $bb3;
$bb2:
  assume !($i6 == 1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1190, 11} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($p0,$mul.ref($i4,4));
  $p10.shadow := $add.ref($p0.shadow,$mul.ref($i4.shadow,4));
  assume {:sourceloc "../BearSSL/src/inner.h", 1190, 11} true;
  assume {:verifier.code 0} true;
  assert ($p10 == $p10.shadow);
  $i11 := $load.i32($M.0,$p10);
  $i11.shadow := $load.i32($M.0.shadow,$p10.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1190, 16} true;
  assume {:verifier.code 0} true;
  $i12 := $lshr.i32($i11,$i5);
  $i12.shadow := $lshr.i32($i11.shadow,$i5.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1190, 29} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i64($i4,1);
  $i13.shadow := $add.i64($i4.shadow,1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1190, 25} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p0,$mul.ref($i13,4));
  $p14.shadow := $add.ref($p0.shadow,$mul.ref($i13.shadow,4));
  assume {:sourceloc "../BearSSL/src/inner.h", 1190, 25} true;
  assume {:verifier.code 0} true;
  assert ($p14 == $p14.shadow);
  $i15 := $load.i32($M.0,$p14);
  $i15.shadow := $load.i32($M.0.shadow,$p14.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1190, 41} true;
  assume {:verifier.code 0} true;
  $i16 := $sub.i32(32,$i5);
  $i16.shadow := $sub.i32(32,$i5.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1190, 34} true;
  assume {:verifier.code 0} true;
  $i17 := $shl.i32($i15,$i16);
  $i17.shadow := $shl.i32($i15.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1190, 22} true;
  assume {:verifier.code 0} true;
  $i18 := $or.i32($i12,$i17);
  $i18.shadow := $or.i32($i12.shadow,$i17.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1190, 3} true;
  assume {:verifier.code 0} true;
  $i9 := $i18;
  $i9.shadow := $i18.shadow;
  goto $bb3;
$bb3:
  assume {:sourceloc "../BearSSL/src/inner.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/inner.h", 1192, 1} true;
  assume {:verifier.code 0} true;
  $r := $i9;
  $r.shadow := $i9.shadow;
  $exn := false;
...
axiom (llvm.memmove.p0i8.p0i8.i64 == $sub.ref(0,28896));
...
const br_div: ref;
axiom (br_div == $sub.ref(0,29928));
procedure {:inline 1} br_div($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
modifies $CurrAddr;
{
  var $p3: ref;
  ...
  var $i4.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 1067, 9} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(4,$zext.i32.i64(1)));
  $p3.shadow := $p3;
  call {:cexpr "br_div:arg:hi"} boogie_si_record_i32($i0);
  call {:cexpr "br_div:arg:lo"} boogie_si_record_i32($i1);
  call {:cexpr "br_div:arg:d"} boogie_si_record_i32($i2);
  assume true;
  assume {:sourceloc "../BearSSL/src/inner.h", 1067, 9} true;
  assume {:verifier.code 0} true;
  call $i4, $i4.shadow := br_divrem($i0, $i0.shadow, $i1, $i1.shadow, $i2, $i2.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 1067, 2} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $r.shadow := $i4.shadow;
  $exn := false;
...
const EQ.16: ref;
axiom (EQ.16 == $sub.ref(0,30960));
procedure {:inline 1} EQ.16($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "EQ.16:arg:x"} boogie_si_record_i32($i0);
  call {:cexpr "EQ.16:arg:y"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 783, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i32($i0,$i1);
  $i2.shadow := $xor.i32($i0.shadow,$i1.shadow);
  ...
  assume {:verifier.code 0} true;
  call $i6, $i6.shadow := NOT.19($i5, $i5.shadow);
...
const GT.18: ref;
axiom (GT.18 == $sub.ref(0,33024));
procedure {:inline 1} GT.18($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "GT.18:arg:x"} boogie_si_record_i32($i0);
  call {:cexpr "GT.18:arg:y"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 819, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32($i1,$i0);
...
const NOT.19: ref;
axiom (NOT.19 == $sub.ref(0,34056));
procedure {:inline 1} NOT.19($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "NOT.19:arg:ctl"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $xor.i32($i0,1);
  $i1.shadow := $xor.i32($i0.shadow,1);
...
const br_divrem: ref;
axiom (br_divrem == $sub.ref(0,35088));
procedure {:inline 1} br_divrem($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32, $p3: ref, $p3.shadow: ref) returns ($r: i32, $r.shadow: i32);
const EQ: ref;
axiom (EQ == $sub.ref(0,36120));
...
const MUX.1: ref;
axiom (MUX.1 == $sub.ref(0,38184));
procedure {:inline 1} MUX.1($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "MUX.1:arg:ctl"} boogie_si_record_i32($i0);
  call {:cexpr "MUX.1:arg:x"} boogie_si_record_i32($i1);
  call {:cexpr "MUX.1:arg:y"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0,$i0);
  $i3.shadow := $sub.i32(0,$i0.shadow);
...
const EQ.23: ref;
axiom (EQ.23 == $sub.ref(0,40248));
procedure {:inline 1} EQ.23($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 783, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "EQ.23:arg:x"} boogie_si_record_i32($i0);
  call {:cexpr "EQ.23:arg:y"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 783, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i32($i0,$i1);
  $i2.shadow := $xor.i32($i0.shadow,$i1.shadow);
  ...
  assume {:sourceloc "../BearSSL/src/inner.h", 784, 9} true;
  assume {:verifier.code 0} true;
  call $i6, $i6.shadow := NOT.26($i5, $i5.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 784, 2} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $r.shadow := $i6.shadow;
...
const GT.24: ref;
axiom (GT.24 == $sub.ref(0,41280));
procedure {:inline 1} GT.24($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 819, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "GT.24:arg:x"} boogie_si_record_i32($i0);
  call {:cexpr "GT.24:arg:y"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 819, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32($i1,$i0);
  $i2.shadow := $sub.i32($i1.shadow,$i0.shadow);
...
const MUX.25: ref;
axiom (MUX.25 == $sub.ref(0,42312));
procedure {:inline 1} MUX.25($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "MUX.25:arg:ctl"} boogie_si_record_i32($i0);
  call {:cexpr "MUX.25:arg:x"} boogie_si_record_i32($i1);
  call {:cexpr "MUX.25:arg:y"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0,$i0);
  $i3.shadow := $sub.i32(0,$i0.shadow);
...
const NOT.26: ref;
axiom (NOT.26 == $sub.ref(0,43344));
procedure {:inline 1} NOT.26($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "NOT.26:arg:ctl"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/inner.h", 763, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $xor.i32($i0,1);
  $i1.shadow := $xor.i32($i0.shadow,1);
...
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0,44376));
...
const br_i32_zero.8: ref;
axiom (br_i32_zero.8 == $sub.ref(0,45408));
procedure {:inline 1} br_i32_zero.8($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32)
modifies $M.0, $exn;
{
  var $p2: ref;
  var $p2.shadow: ref;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 1237, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_zero.8:arg:bit_len"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1237, 5} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p0,$mul.ref(1,4));
  $p2.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
...
const br_i32_zero: ref;
axiom (br_i32_zero == $sub.ref(0,46440));
procedure {:inline 1} br_i32_zero($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32)
modifies $M.0, $exn;
{
  var $p2: ref;
  var $p2.shadow: ref;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 1237, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_i32_zero:arg:bit_len"} boogie_si_record_i32($i1);
  assume {:sourceloc "../BearSSL/src/inner.h", 1237, 5} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p0,$mul.ref(1,4));
  $p2.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
...
const br_dec32be.6: ref;
axiom (br_dec32be.6 == $sub.ref(0,47472));
procedure {:inline 1} br_dec32be.6($p0: ref, $p0.shadow: ref) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $p1: ref;
  var $p1.shadow: ref;
...
const MUX.20: ref;
axiom (MUX.20 == $sub.ref(0,48504));
procedure {:inline 1} MUX.20($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
...
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "MUX.20:arg:ctl"} boogie_si_record_i32($i0);
  call {:cexpr "MUX.20:arg:x"} boogie_si_record_i32($i1);
  call {:cexpr "MUX.20:arg:y"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/inner.h", 772, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0,$i0);
  $i3.shadow := $sub.i32(0,$i0.shadow);
...
axiom (br_enc32be == $sub.ref(0,49536));
...
const br_dec16be: ref;
axiom (br_dec16be == $sub.ref(0,50568));
procedure {:inline 1} br_dec16be($p0: ref, $p0.shadow: ref) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $p1: ref;
  var $p1.shadow: ref;
  ...
  var $i8.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/inner.h", 537, 20} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/inner.h", 537, 20} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($p0,$mul.ref(0,1));
  ...
  $i2 := $load.i8($M.0,$p1);
  $i2.shadow := $load.i8($M.0.shadow,$p1.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 537, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i8.i32($i2);
  $i3.shadow := $zext.i8.i32($i2.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 537, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $shl.i32($i3,8);
  $i4.shadow := $shl.i32($i3.shadow,8);
  assume {:sourceloc "../BearSSL/src/inner.h", 537, 45} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0,$mul.ref(1,1));
  $p5.shadow := $add.ref($p0.shadow,$mul.ref(1,1));
  assume {:sourceloc "../BearSSL/src/inner.h", 537, 45} true;
  ...
  $i6 := $load.i8($M.0,$p5);
  $i6.shadow := $load.i8($M.0.shadow,$p5.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 537, 35} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i8.i32($i6);
  $i7.shadow := $zext.i8.i32($i6.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 537, 33} true;
  assume {:verifier.code 0} true;
  $i8 := $or.i32($i4,$i7);
  $i8.shadow := $or.i32($i4.shadow,$i7.shadow);
  assume {:sourceloc "../BearSSL/src/inner.h", 537, 2} true;
  assume {:verifier.code 0} true;
  $r := $i8;
  $r.shadow := $i8.shadow;
  $exn := false;
...
axiom (br_dec32be == $sub.ref(0,51600));
...
axiom (__SMACK_dummy == $sub.ref(0,54696));
...
axiom (__SMACK_and32 == $sub.ref(0,55728));
...
axiom (__SMACK_and64 == $sub.ref(0,56760));
...
axiom (__SMACK_and16 == $sub.ref(0,57792));
...
axiom (__SMACK_and8 == $sub.ref(0,58824));
...
axiom (__SMACK_or32 == $sub.ref(0,59856));
...
axiom (__SMACK_or64 == $sub.ref(0,60888));
...
axiom (__SMACK_or16 == $sub.ref(0,61920));
...
axiom (__SMACK_or8 == $sub.ref(0,62952));
...
axiom (__SMACK_check_overflow == $sub.ref(0,63984));
...
axiom (__SMACK_loop_exit == $sub.ref(0,65016));
...
axiom (__SMACK_decls == $sub.ref(0,66048));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,67080));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,68112));
...
axiom (__SMACK_static_init == $sub.ref(0,69144));
