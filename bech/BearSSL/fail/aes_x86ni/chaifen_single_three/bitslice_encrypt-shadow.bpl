...
const br_aes_ct_bitslice_encrypt: ref;
axiom (br_aes_ct_bitslice_encrypt == $sub.ref(0,3096));
procedure {:inline 1} br_aes_ct_bitslice_encrypt($i0: i32, $i0.shadow: i32, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $exn;
modifies $M.0;
{
  var $i3: i32;
  ...
  var $p11.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 102, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_aes_ct_bitslice_encrypt:arg:num_rounds"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 102, 2} true;
  assume {:verifier.code 0} true;
  call add_round_key($p2, $p2.shadow, $p1, $p1.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 103, 7} true;
  assume {:verifier.code 0} true;
  $i3 := 1;
  $i3.shadow := 1;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 103, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.i32($i3,$i0);
  $i4.shadow := $ult.i32($i3.shadow,$i0.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 103, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 104, 3} true;
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_Sbox($p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 105, 3} true;
  assume {:verifier.code 0} true;
  call shift_rows($p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 106, 3} true;
  assume {:verifier.code 0} true;
  call mix_columns($p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 107, 30} true;
  assume {:verifier.code 0} true;
  $i5 := $shl.i32($i3,3);
  $i5.shadow := $shl.i32($i3.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 107, 25} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i32.i64($i5);
  ...
  $p7.shadow := $add.ref($p1.shadow,$mul.ref($i6.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 107, 3} true;
  assume {:verifier.code 0} true;
  call add_round_key($p2, $p2.shadow, $p7, $p7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 108, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i4 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 109, 2} true;
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_Sbox($p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 110, 2} true;
  assume {:verifier.code 0} true;
  call shift_rows($p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 111, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $shl.i32($i0,3);
  $i9.shadow := $shl.i32($i0.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 111, 24} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i32.i64($i9);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 111, 2} true;
  assume {:verifier.code 0} true;
  call add_round_key($p2, $p2.shadow, $p11, $p11.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 112, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 103, 32} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i3,1);
...
modifies $M.0, $exn;
{
  ...
  var $i41.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 30, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 30, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 30, 2} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p0,$mul.ref(0,4));
  $p4.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 30, 7} true;
  assume {:verifier.code 0} true;
  assert ($p4 == $p4.shadow);
  $i5 := $load.i32($M.0,$p4);
  ...
  assume {:verifier.code 0} true;
  $i6 := $xor.i32($i5,$i3);
  $i6.shadow := $xor.i32($i5.shadow,$i3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 30, 7} true;
  assume {:verifier.code 0} true;
  assert ($p4 == $p4.shadow);
  $M.0 := $store.i32($M.0,$p4,$i6);
  $M.0.shadow := $store.i32($M.0.shadow,$p4.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 31, 10} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 31, 2} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(1,4));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 31, 7} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $i10 := $load.i32($M.0,$p9);
  $i10.shadow := $load.i32($M.0.shadow,$p9.shadow);
  ...
  assume {:verifier.code 0} true;
  $i11 := $xor.i32($i10,$i8);
  $i11.shadow := $xor.i32($i10.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 31, 7} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $M.0 := $store.i32($M.0,$p9,$i11);
  $M.0.shadow := $store.i32($M.0.shadow,$p9.shadow,$i11.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 32, 10} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p1,$mul.ref(2,4));
  $p12.shadow := $add.ref($p1.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 32, 10} true;
  assume {:verifier.code 0} true;
  assert ($p12 == $p12.shadow);
  $i13 := $load.i32($M.1,$p12);
  $i13.shadow := $load.i32($M.1.shadow,$p12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 32, 2} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p0,$mul.ref(2,4));
  $p14.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 32, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i16 := $xor.i32($i15,$i13);
  $i16.shadow := $xor.i32($i15.shadow,$i13.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 32, 7} true;
  assume {:verifier.code 0} true;
  assert ($p14 == $p14.shadow);
  $M.0 := $store.i32($M.0,$p14,$i16);
  $M.0.shadow := $store.i32($M.0.shadow,$p14.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 33, 10} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($p1,$mul.ref(3,4));
  $p17.shadow := $add.ref($p1.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 33, 10} true;
  assume {:verifier.code 0} true;
  assert ($p17 == $p17.shadow);
  $i18 := $load.i32($M.1,$p17);
  $i18.shadow := $load.i32($M.1.shadow,$p17.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 33, 2} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($p0,$mul.ref(3,4));
  $p19.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 33, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i21 := $xor.i32($i20,$i18);
  $i21.shadow := $xor.i32($i20.shadow,$i18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 33, 7} true;
  assume {:verifier.code 0} true;
  assert ($p19 == $p19.shadow);
  $M.0 := $store.i32($M.0,$p19,$i21);
  $M.0.shadow := $store.i32($M.0.shadow,$p19.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 34, 10} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p1,$mul.ref(4,4));
  $p22.shadow := $add.ref($p1.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 34, 10} true;
  assume {:verifier.code 0} true;
  assert ($p22 == $p22.shadow);
  $i23 := $load.i32($M.1,$p22);
  $i23.shadow := $load.i32($M.1.shadow,$p22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 34, 2} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p0,$mul.ref(4,4));
  $p24.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 34, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i26 := $xor.i32($i25,$i23);
  $i26.shadow := $xor.i32($i25.shadow,$i23.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 34, 7} true;
  assume {:verifier.code 0} true;
  assert ($p24 == $p24.shadow);
  $M.0 := $store.i32($M.0,$p24,$i26);
  $M.0.shadow := $store.i32($M.0.shadow,$p24.shadow,$i26.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 35, 10} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($p1,$mul.ref(5,4));
  $p27.shadow := $add.ref($p1.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 35, 10} true;
  assume {:verifier.code 0} true;
  assert ($p27 == $p27.shadow);
  $i28 := $load.i32($M.1,$p27);
  $i28.shadow := $load.i32($M.1.shadow,$p27.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 35, 2} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p0,$mul.ref(5,4));
  $p29.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 35, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i31 := $xor.i32($i30,$i28);
  $i31.shadow := $xor.i32($i30.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 35, 7} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $M.0 := $store.i32($M.0,$p29,$i31);
  $M.0.shadow := $store.i32($M.0.shadow,$p29.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 36, 10} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($p1,$mul.ref(6,4));
  $p32.shadow := $add.ref($p1.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 36, 10} true;
  assume {:verifier.code 0} true;
  assert ($p32 == $p32.shadow);
  $i33 := $load.i32($M.1,$p32);
  $i33.shadow := $load.i32($M.1.shadow,$p32.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 36, 2} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($p0,$mul.ref(6,4));
  $p34.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 36, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assert ($p34 == $p34.shadow);
  $M.0 := $store.i32($M.0,$p34,$i36);
  $M.0.shadow := $store.i32($M.0.shadow,$p34.shadow,$i36.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 37, 10} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($p1,$mul.ref(7,4));
  $p37.shadow := $add.ref($p1.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 37, 10} true;
  assume {:verifier.code 0} true;
  assert ($p37 == $p37.shadow);
  $i38 := $load.i32($M.1,$p37);
  $i38.shadow := $load.i32($M.1.shadow,$p37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 37, 2} true;
  assume {:verifier.code 0} true;
  $p39 := $add.ref($p0,$mul.ref(7,4));
  $p39.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 37, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i41 := $xor.i32($i40,$i38);
  $i41.shadow := $xor.i32($i40.shadow,$i38.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 37, 7} true;
  assume {:verifier.code 0} true;
  assert ($p39 == $p39.shadow);
  $M.0 := $store.i32($M.0,$p39,$i41);
  $M.0.shadow := $store.i32($M.0.shadow,$p39.shadow,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 38, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
modifies $M.0, $exn;
{
  ...
  var $i27.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 45, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 45, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 45, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1,8);
  $i2.shadow := $slt.i32($i1.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 45, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 48, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 49, 13} true;
  assume {:verifier.code 0} true;
  $i6 := $and.i32($i5,255);
  $i6.shadow := $and.i32($i5.shadow,255);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 50, 10} true;
  assume {:verifier.code 0} true;
  $i7 := $and.i32($i5,64512);
  $i7.shadow := $and.i32($i5.shadow,64512);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 50, 24} true;
  assume {:verifier.code 0} true;
  $i8 := $lshr.i32($i7,2);
  $i8.shadow := $lshr.i32($i7.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 50, 4} true;
  assume {:verifier.code 0} true;
  $i9 := $or.i32($i6,$i8);
  $i9.shadow := $or.i32($i6.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 50, 36} true;
  assume {:verifier.code 0} true;
  $i10 := $and.i32($i5,768);
  $i10.shadow := $and.i32($i5.shadow,768);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 50, 50} true;
  assume {:verifier.code 0} true;
  $i11 := $shl.i32($i10,6);
  $i11.shadow := $shl.i32($i10.shadow,6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 50, 30} true;
  assume {:verifier.code 0} true;
  $i12 := $or.i32($i9,$i11);
  $i12.shadow := $or.i32($i9.shadow,$i11.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 51, 10} true;
  assume {:verifier.code 0} true;
  $i13 := $and.i32($i5,15728640);
  $i13.shadow := $and.i32($i5.shadow,15728640);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 51, 24} true;
  assume {:verifier.code 0} true;
  $i14 := $lshr.i32($i13,4);
  $i14.shadow := $lshr.i32($i13.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 51, 4} true;
  assume {:verifier.code 0} true;
  $i15 := $or.i32($i12,$i14);
  $i15.shadow := $or.i32($i12.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 51, 36} true;
  assume {:verifier.code 0} true;
  $i16 := $and.i32($i5,983040);
  $i16.shadow := $and.i32($i5.shadow,983040);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 51, 50} true;
  assume {:verifier.code 0} true;
  $i17 := $shl.i32($i16,4);
  $i17.shadow := $shl.i32($i16.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 51, 30} true;
  assume {:verifier.code 0} true;
  $i18 := $or.i32($i15,$i17);
  $i18.shadow := $or.i32($i15.shadow,$i17.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 52, 10} true;
  assume {:verifier.code 0} true;
  $i19 := $and.i32($i5,3221225472);
  $i19.shadow := $and.i32($i5.shadow,3221225472);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 52, 24} true;
  assume {:verifier.code 0} true;
  $i20 := $lshr.i32($i19,6);
  $i20.shadow := $lshr.i32($i19.shadow,6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 52, 4} true;
  assume {:verifier.code 0} true;
  $i21 := $or.i32($i18,$i20);
  $i21.shadow := $or.i32($i18.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 52, 36} true;
  assume {:verifier.code 0} true;
  $i22 := $and.i32($i5,1056964608);
  $i22.shadow := $and.i32($i5.shadow,1056964608);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 52, 50} true;
  assume {:verifier.code 0} true;
  $i23 := $shl.i32($i22,2);
  $i23.shadow := $shl.i32($i22.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 52, 30} true;
  assume {:verifier.code 0} true;
  $i24 := $or.i32($i21,$i23);
  $i24.shadow := $or.i32($i21.shadow,$i23.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 49, 3} true;
  assume {:verifier.code 0} true;
  $i25 := $sext.i32.i64($i1);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 49, 8} true;
  assume {:verifier.code 0} true;
  assert ($p26 == $p26.shadow);
  $M.0 := $store.i32($M.0,$p26,$i24);
  $M.0.shadow := $store.i32($M.0.shadow,$p26.shadow,$i24.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 53, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 54, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 45, 23} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i1,1);
...
modifies $M.0, $exn;
{
  ...
  var $p94.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 68, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 68, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 69, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 70, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 71, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 72, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 73, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 74, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 75, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 76, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $lshr.i32($i2,8);
  $i17.shadow := $lshr.i32($i2.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 76, 23} true;
  assume {:verifier.code 0} true;
  $i18 := $shl.i32($i2,24);
  $i18.shadow := $shl.i32($i2.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 76, 17} true;
  assume {:verifier.code 0} true;
  $i19 := $or.i32($i17,$i18);
  $i19.shadow := $or.i32($i17.shadow,$i18.shadow);
  call {:cexpr "r0"} boogie_si_record_i32($i19);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 77, 11} true;
  assume {:verifier.code 0} true;
  $i20 := $lshr.i32($i4,8);
  $i20.shadow := $lshr.i32($i4.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 77, 23} true;
  assume {:verifier.code 0} true;
  $i21 := $shl.i32($i4,24);
  $i21.shadow := $shl.i32($i4.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 77, 17} true;
  assume {:verifier.code 0} true;
  $i22 := $or.i32($i20,$i21);
  $i22.shadow := $or.i32($i20.shadow,$i21.shadow);
  call {:cexpr "r1"} boogie_si_record_i32($i22);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 78, 11} true;
  assume {:verifier.code 0} true;
  $i23 := $lshr.i32($i6,8);
  $i23.shadow := $lshr.i32($i6.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 78, 23} true;
  assume {:verifier.code 0} true;
  $i24 := $shl.i32($i6,24);
  $i24.shadow := $shl.i32($i6.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 78, 17} true;
  assume {:verifier.code 0} true;
  $i25 := $or.i32($i23,$i24);
  $i25.shadow := $or.i32($i23.shadow,$i24.shadow);
  call {:cexpr "r2"} boogie_si_record_i32($i25);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 79, 11} true;
  assume {:verifier.code 0} true;
  $i26 := $lshr.i32($i8,8);
  $i26.shadow := $lshr.i32($i8.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 79, 23} true;
  assume {:verifier.code 0} true;
  $i27 := $shl.i32($i8,24);
  $i27.shadow := $shl.i32($i8.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 79, 17} true;
  assume {:verifier.code 0} true;
  $i28 := $or.i32($i26,$i27);
  $i28.shadow := $or.i32($i26.shadow,$i27.shadow);
  call {:cexpr "r3"} boogie_si_record_i32($i28);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 80, 11} true;
  assume {:verifier.code 0} true;
  $i29 := $lshr.i32($i10,8);
  $i29.shadow := $lshr.i32($i10.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 80, 23} true;
  assume {:verifier.code 0} true;
  $i30 := $shl.i32($i10,24);
  $i30.shadow := $shl.i32($i10.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 80, 17} true;
  assume {:verifier.code 0} true;
  $i31 := $or.i32($i29,$i30);
  $i31.shadow := $or.i32($i29.shadow,$i30.shadow);
  call {:cexpr "r4"} boogie_si_record_i32($i31);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 81, 11} true;
  assume {:verifier.code 0} true;
  $i32 := $lshr.i32($i12,8);
  $i32.shadow := $lshr.i32($i12.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 81, 23} true;
  assume {:verifier.code 0} true;
  $i33 := $shl.i32($i12,24);
  $i33.shadow := $shl.i32($i12.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 81, 17} true;
  assume {:verifier.code 0} true;
  $i34 := $or.i32($i32,$i33);
  $i34.shadow := $or.i32($i32.shadow,$i33.shadow);
  call {:cexpr "r5"} boogie_si_record_i32($i34);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 82, 11} true;
  assume {:verifier.code 0} true;
  $i35 := $lshr.i32($i14,8);
  $i35.shadow := $lshr.i32($i14.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 82, 23} true;
  assume {:verifier.code 0} true;
  $i36 := $shl.i32($i14,24);
  $i36.shadow := $shl.i32($i14.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 82, 17} true;
  assume {:verifier.code 0} true;
  $i37 := $or.i32($i35,$i36);
  $i37.shadow := $or.i32($i35.shadow,$i36.shadow);
  call {:cexpr "r6"} boogie_si_record_i32($i37);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 83, 11} true;
  assume {:verifier.code 0} true;
  $i38 := $lshr.i32($i16,8);
  $i38.shadow := $lshr.i32($i16.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 83, 23} true;
  assume {:verifier.code 0} true;
  $i39 := $shl.i32($i16,24);
  $i39.shadow := $shl.i32($i16.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 83, 17} true;
  assume {:verifier.code 0} true;
  $i40 := $or.i32($i38,$i39);
  $i40.shadow := $or.i32($i38.shadow,$i39.shadow);
  call {:cexpr "r7"} boogie_si_record_i32($i40);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 85, 12} true;
  assume {:verifier.code 0} true;
  $i41 := $xor.i32($i16,$i40);
  $i41.shadow := $xor.i32($i16.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 85, 17} true;
  assume {:verifier.code 0} true;
  $i42 := $xor.i32($i41,$i19);
  $i42.shadow := $xor.i32($i41.shadow,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 85, 34} true;
  assume {:verifier.code 0} true;
  $i43 := $xor.i32($i2,$i19);
  $i43.shadow := $xor.i32($i2.shadow,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 85, 24} true;
  assume {:verifier.code 0} true;
  call $i44, $i44.shadow := rotr16($i43, $i43.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 85, 22} true;
  assume {:verifier.code 0} true;
  $i45 := $xor.i32($i42,$i44);
  $i45.shadow := $xor.i32($i42.shadow,$i44.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 85, 2} true;
  assume {:verifier.code 0} true;
  $p46 := $add.ref($p0,$mul.ref(0,4));
  $p46.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 85, 7} true;
  assume {:verifier.code 0} true;
  assert ($p46 == $p46.shadow);
  $M.0 := $store.i32($M.0,$p46,$i45);
  $M.0.shadow := $store.i32($M.0.shadow,$p46.shadow,$i45.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 86, 12} true;
  assume {:verifier.code 0} true;
  $i47 := $xor.i32($i2,$i19);
  $i47.shadow := $xor.i32($i2.shadow,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 86, 17} true;
  assume {:verifier.code 0} true;
  $i48 := $xor.i32($i47,$i16);
  $i48.shadow := $xor.i32($i47.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 86, 22} true;
  assume {:verifier.code 0} true;
  $i49 := $xor.i32($i48,$i40);
  $i49.shadow := $xor.i32($i48.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 86, 27} true;
  assume {:verifier.code 0} true;
  $i50 := $xor.i32($i49,$i22);
  $i50.shadow := $xor.i32($i49.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 86, 44} true;
  assume {:verifier.code 0} true;
  $i51 := $xor.i32($i4,$i22);
  $i51.shadow := $xor.i32($i4.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 86, 34} true;
  assume {:verifier.code 0} true;
  call $i52, $i52.shadow := rotr16($i51, $i51.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 86, 32} true;
  assume {:verifier.code 0} true;
  $i53 := $xor.i32($i50,$i52);
  $i53.shadow := $xor.i32($i50.shadow,$i52.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 86, 2} true;
  assume {:verifier.code 0} true;
  $p54 := $add.ref($p0,$mul.ref(1,4));
  $p54.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 86, 7} true;
  assume {:verifier.code 0} true;
  assert ($p54 == $p54.shadow);
  $M.0 := $store.i32($M.0,$p54,$i53);
  $M.0.shadow := $store.i32($M.0.shadow,$p54.shadow,$i53.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 87, 12} true;
  assume {:verifier.code 0} true;
  $i55 := $xor.i32($i4,$i22);
  $i55.shadow := $xor.i32($i4.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 87, 17} true;
  assume {:verifier.code 0} true;
  $i56 := $xor.i32($i55,$i25);
  $i56.shadow := $xor.i32($i55.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 87, 34} true;
  assume {:verifier.code 0} true;
  $i57 := $xor.i32($i6,$i25);
  $i57.shadow := $xor.i32($i6.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 87, 24} true;
  assume {:verifier.code 0} true;
  call $i58, $i58.shadow := rotr16($i57, $i57.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 87, 22} true;
  assume {:verifier.code 0} true;
  $i59 := $xor.i32($i56,$i58);
  $i59.shadow := $xor.i32($i56.shadow,$i58.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 87, 2} true;
  assume {:verifier.code 0} true;
  $p60 := $add.ref($p0,$mul.ref(2,4));
  $p60.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 87, 7} true;
  assume {:verifier.code 0} true;
  assert ($p60 == $p60.shadow);
  $M.0 := $store.i32($M.0,$p60,$i59);
  $M.0.shadow := $store.i32($M.0.shadow,$p60.shadow,$i59.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 88, 12} true;
  assume {:verifier.code 0} true;
  $i61 := $xor.i32($i6,$i25);
  $i61.shadow := $xor.i32($i6.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 88, 17} true;
  assume {:verifier.code 0} true;
  $i62 := $xor.i32($i61,$i16);
  $i62.shadow := $xor.i32($i61.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 88, 22} true;
  assume {:verifier.code 0} true;
  $i63 := $xor.i32($i62,$i40);
  $i63.shadow := $xor.i32($i62.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 88, 27} true;
  assume {:verifier.code 0} true;
  $i64 := $xor.i32($i63,$i28);
  $i64.shadow := $xor.i32($i63.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 88, 44} true;
  assume {:verifier.code 0} true;
  $i65 := $xor.i32($i8,$i28);
  $i65.shadow := $xor.i32($i8.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 88, 34} true;
  assume {:verifier.code 0} true;
  call $i66, $i66.shadow := rotr16($i65, $i65.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 88, 32} true;
  assume {:verifier.code 0} true;
  $i67 := $xor.i32($i64,$i66);
  $i67.shadow := $xor.i32($i64.shadow,$i66.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 88, 2} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($p0,$mul.ref(3,4));
  $p68.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 88, 7} true;
  assume {:verifier.code 0} true;
  assert ($p68 == $p68.shadow);
  $M.0 := $store.i32($M.0,$p68,$i67);
  $M.0.shadow := $store.i32($M.0.shadow,$p68.shadow,$i67.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 89, 12} true;
  assume {:verifier.code 0} true;
  $i69 := $xor.i32($i8,$i28);
  $i69.shadow := $xor.i32($i8.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 89, 17} true;
  assume {:verifier.code 0} true;
  $i70 := $xor.i32($i69,$i16);
  $i70.shadow := $xor.i32($i69.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 89, 22} true;
  assume {:verifier.code 0} true;
  $i71 := $xor.i32($i70,$i40);
  $i71.shadow := $xor.i32($i70.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 89, 27} true;
  assume {:verifier.code 0} true;
  $i72 := $xor.i32($i71,$i31);
  $i72.shadow := $xor.i32($i71.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 89, 44} true;
  assume {:verifier.code 0} true;
  $i73 := $xor.i32($i10,$i31);
  $i73.shadow := $xor.i32($i10.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 89, 34} true;
  assume {:verifier.code 0} true;
  call $i74, $i74.shadow := rotr16($i73, $i73.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 89, 32} true;
  assume {:verifier.code 0} true;
  $i75 := $xor.i32($i72,$i74);
  $i75.shadow := $xor.i32($i72.shadow,$i74.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 89, 2} true;
  assume {:verifier.code 0} true;
  $p76 := $add.ref($p0,$mul.ref(4,4));
  $p76.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 89, 7} true;
  assume {:verifier.code 0} true;
  assert ($p76 == $p76.shadow);
  $M.0 := $store.i32($M.0,$p76,$i75);
  $M.0.shadow := $store.i32($M.0.shadow,$p76.shadow,$i75.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 90, 12} true;
  assume {:verifier.code 0} true;
  $i77 := $xor.i32($i10,$i31);
  $i77.shadow := $xor.i32($i10.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 90, 17} true;
  assume {:verifier.code 0} true;
  $i78 := $xor.i32($i77,$i34);
  $i78.shadow := $xor.i32($i77.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 90, 34} true;
  assume {:verifier.code 0} true;
  $i79 := $xor.i32($i12,$i34);
  $i79.shadow := $xor.i32($i12.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 90, 24} true;
  assume {:verifier.code 0} true;
  call $i80, $i80.shadow := rotr16($i79, $i79.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 90, 22} true;
  assume {:verifier.code 0} true;
  $i81 := $xor.i32($i78,$i80);
  $i81.shadow := $xor.i32($i78.shadow,$i80.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 90, 2} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($p0,$mul.ref(5,4));
  $p82.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 90, 7} true;
  assume {:verifier.code 0} true;
  assert ($p82 == $p82.shadow);
  $M.0 := $store.i32($M.0,$p82,$i81);
  $M.0.shadow := $store.i32($M.0.shadow,$p82.shadow,$i81.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 91, 12} true;
  assume {:verifier.code 0} true;
  $i83 := $xor.i32($i12,$i34);
  $i83.shadow := $xor.i32($i12.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 91, 17} true;
  assume {:verifier.code 0} true;
  $i84 := $xor.i32($i83,$i37);
  $i84.shadow := $xor.i32($i83.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 91, 34} true;
  assume {:verifier.code 0} true;
  $i85 := $xor.i32($i14,$i37);
  $i85.shadow := $xor.i32($i14.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 91, 24} true;
  assume {:verifier.code 0} true;
  call $i86, $i86.shadow := rotr16($i85, $i85.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 91, 22} true;
  assume {:verifier.code 0} true;
  $i87 := $xor.i32($i84,$i86);
  $i87.shadow := $xor.i32($i84.shadow,$i86.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 91, 2} true;
  assume {:verifier.code 0} true;
  $p88 := $add.ref($p0,$mul.ref(6,4));
  $p88.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 91, 7} true;
  assume {:verifier.code 0} true;
  assert ($p88 == $p88.shadow);
  $M.0 := $store.i32($M.0,$p88,$i87);
  $M.0.shadow := $store.i32($M.0.shadow,$p88.shadow,$i87.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 92, 12} true;
  assume {:verifier.code 0} true;
  $i89 := $xor.i32($i14,$i37);
  $i89.shadow := $xor.i32($i14.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 92, 17} true;
  assume {:verifier.code 0} true;
  $i90 := $xor.i32($i89,$i40);
  $i90.shadow := $xor.i32($i89.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 92, 34} true;
  assume {:verifier.code 0} true;
  $i91 := $xor.i32($i16,$i40);
  $i91.shadow := $xor.i32($i16.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 92, 24} true;
  assume {:verifier.code 0} true;
  call $i92, $i92.shadow := rotr16($i91, $i91.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 92, 22} true;
  assume {:verifier.code 0} true;
  $i93 := $xor.i32($i90,$i92);
  $i93.shadow := $xor.i32($i90.shadow,$i92.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 92, 2} true;
  assume {:verifier.code 0} true;
  $p94 := $add.ref($p0,$mul.ref(7,4));
  $p94.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 92, 7} true;
  assume {:verifier.code 0} true;
  assert ($p94 == $p94.shadow);
  $M.0 := $store.i32($M.0,$p94,$i93);
  $M.0.shadow := $store.i32($M.0.shadow,$p94.shadow,$i93.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 93, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
modifies $exn;
{
  ...
  var $i3.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 59, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 59, 24} true;
  assume {:verifier.code 0} true;
  $i2 := $lshr.i32($i0,16);
  $i2.shadow := $lshr.i32($i0.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 59, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $or.i32($i1,$i2);
  $i3.shadow := $or.i32($i1.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_enc.c", 59, 2} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $r.shadow := $i3.shadow;
  $exn := false;
...
$bb0:
  ...
  assume {:sourceloc "bitslice_encrypt.c", 10, 47} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p2);
  $p7.shadow := $bitcast.ref.ref($p2.shadow);
  assume {:sourceloc "bitslice_encrypt.c", 10, 2} true;
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_encrypt($i0, $i0.shadow, $p1, $p1.shadow, $p7, $p7.shadow);
