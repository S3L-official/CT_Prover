...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,28898));
...
axiom (br_aes_ct_bitslice_Sbox == $sub.ref(0,2066));
...
const br_aes_ct_ortho: ref;
axiom (br_aes_ct_ortho == $sub.ref(0,4130));
procedure {:inline 1} br_aes_ct_ortho($p0: ref, $p0.shadow: ref)
modifies $M.0, $exn;
{
  var $p1: ref;
  var $p1.shadow: ref;
  ...
  var $p168.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i5 := $and.i32($i2,1431655765);
  $i5.shadow := $and.i32($i2.shadow,1431655765);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i6 := $and.i32($i4,1431655765);
  $i6.shadow := $and.i32($i4.shadow,1431655765);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i7 := $shl.i32($i6,1);
  $i7.shadow := $shl.i32($i6.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i8 := $or.i32($i5,$i7);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(0,4));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $M.0 := $store.i32($M.0,$p9,$i8);
  $M.0.shadow := $store.i32($M.0.shadow,$p9.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i10 := $and.i32($i2,2863311530);
  $i10.shadow := $and.i32($i2.shadow,2863311530);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i11 := $lshr.i32($i10,1);
  $i11.shadow := $lshr.i32($i10.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i12 := $and.i32($i4,2863311530);
  $i12.shadow := $and.i32($i4.shadow,2863311530);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $i13 := $or.i32($i11,$i12);
  $i13.shadow := $or.i32($i11.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p0,$mul.ref(1,4));
  $p14.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 220, 2} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  ...
  $p15.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  assert ($p15 == $p15.shadow);
  $i16 := $load.i32($M.0,$p15);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($p0,$mul.ref(3,4));
  $p17.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  assert ($p17 == $p17.shadow);
  $i18 := $load.i32($M.0,$p17);
  $i18.shadow := $load.i32($M.0.shadow,$p17.shadow);
  call {:cexpr "b"} boogie_si_record_i32($i18);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i19 := $and.i32($i16,1431655765);
  $i19.shadow := $and.i32($i16.shadow,1431655765);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i20 := $and.i32($i18,1431655765);
  $i20.shadow := $and.i32($i18.shadow,1431655765);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i21 := $shl.i32($i20,1);
  $i21.shadow := $shl.i32($i20.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i22 := $or.i32($i19,$i21);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i24 := $and.i32($i16,2863311530);
  $i24.shadow := $and.i32($i16.shadow,2863311530);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i25 := $lshr.i32($i24,1);
  $i25.shadow := $lshr.i32($i24.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i26 := $and.i32($i18,2863311530);
  $i26.shadow := $and.i32($i18.shadow,2863311530);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $i27 := $or.i32($i25,$i26);
  $i27.shadow := $or.i32($i25.shadow,$i26.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($p0,$mul.ref(3,4));
  $p28.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  assert ($p28 == $p28.shadow);
  $M.0 := $store.i32($M.0,$p28,$i27);
  $M.0.shadow := $store.i32($M.0.shadow,$p28.shadow,$i27.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 221, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p0,$mul.ref(4,4));
  $p29.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($p0,$mul.ref(5,4));
  $p31.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i33 := $and.i32($i30,1431655765);
  $i33.shadow := $and.i32($i30.shadow,1431655765);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i34 := $and.i32($i32,1431655765);
  $i34.shadow := $and.i32($i32.shadow,1431655765);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i35 := $shl.i32($i34,1);
  ...
  assume {:verifier.code 0} true;
  $i36 := $or.i32($i33,$i35);
  $i36.shadow := $or.i32($i33.shadow,$i35.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($p0,$mul.ref(4,4));
  $p37.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  assert ($p37 == $p37.shadow);
  $M.0 := $store.i32($M.0,$p37,$i36);
  $M.0.shadow := $store.i32($M.0.shadow,$p37.shadow,$i36.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i38 := $and.i32($i30,2863311530);
  $i38.shadow := $and.i32($i30.shadow,2863311530);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i39 := $lshr.i32($i38,1);
  $i39.shadow := $lshr.i32($i38.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i40 := $and.i32($i32,2863311530);
  $i40.shadow := $and.i32($i32.shadow,2863311530);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $i41 := $or.i32($i39,$i40);
  $i41.shadow := $or.i32($i39.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($p0,$mul.ref(5,4));
  $p42.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  assert ($p42 == $p42.shadow);
  $M.0 := $store.i32($M.0,$p42,$i41);
  $M.0.shadow := $store.i32($M.0.shadow,$p42.shadow,$i41.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 222, 2} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb6:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($p0,$mul.ref(6,4));
  $p43.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  assert ($p43 == $p43.shadow);
  $i44 := $load.i32($M.0,$p43);
  $i44.shadow := $load.i32($M.0.shadow,$p43.shadow);
  call {:cexpr "a"} boogie_si_record_i32($i44);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($p0,$mul.ref(7,4));
  $p45.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i47 := $and.i32($i44,1431655765);
  $i47.shadow := $and.i32($i44.shadow,1431655765);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i48 := $and.i32($i46,1431655765);
  $i48.shadow := $and.i32($i46.shadow,1431655765);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i49 := $shl.i32($i48,1);
  $i49.shadow := $shl.i32($i48.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i50 := $or.i32($i47,$i49);
  $i50.shadow := $or.i32($i47.shadow,$i49.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($p0,$mul.ref(6,4));
  $p51.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  assert ($p51 == $p51.shadow);
  $M.0 := $store.i32($M.0,$p51,$i50);
  $M.0.shadow := $store.i32($M.0.shadow,$p51.shadow,$i50.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i52 := $and.i32($i44,2863311530);
  $i52.shadow := $and.i32($i44.shadow,2863311530);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i53 := $lshr.i32($i52,1);
  $i53.shadow := $lshr.i32($i52.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i54 := $and.i32($i46,2863311530);
  $i54.shadow := $and.i32($i46.shadow,2863311530);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $i55 := $or.i32($i53,$i54);
  $i55.shadow := $or.i32($i53.shadow,$i54.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  $p56 := $add.ref($p0,$mul.ref(7,4));
  $p56.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 223, 2} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($p0,$mul.ref(0,4));
  $p57.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  assert ($p57 == $p57.shadow);
  $i58 := $load.i32($M.0,$p57);
  $i58.shadow := $load.i32($M.0.shadow,$p57.shadow);
  call {:cexpr "a"} boogie_si_record_i32($i58);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($p0,$mul.ref(2,4));
  $p59.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  assert ($p59 == $p59.shadow);
  $i60 := $load.i32($M.0,$p59);
  $i60.shadow := $load.i32($M.0.shadow,$p59.shadow);
  call {:cexpr "b"} boogie_si_record_i32($i60);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i61 := $and.i32($i58,858993459);
  $i61.shadow := $and.i32($i58.shadow,858993459);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i62 := $and.i32($i60,858993459);
  $i62.shadow := $and.i32($i60.shadow,858993459);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i63 := $shl.i32($i62,2);
  $i63.shadow := $shl.i32($i62.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i64 := $or.i32($i61,$i63);
  $i64.shadow := $or.i32($i61.shadow,$i63.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $p65 := $add.ref($p0,$mul.ref(0,4));
  $p65.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  assert ($p65 == $p65.shadow);
  $M.0 := $store.i32($M.0,$p65,$i64);
  $M.0.shadow := $store.i32($M.0.shadow,$p65.shadow,$i64.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i66 := $and.i32($i58,3435973836);
  $i66.shadow := $and.i32($i58.shadow,3435973836);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i67 := $lshr.i32($i66,2);
  $i67.shadow := $lshr.i32($i66.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i68 := $and.i32($i60,3435973836);
  $i68.shadow := $and.i32($i60.shadow,3435973836);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $i69 := $or.i32($i67,$i68);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($p0,$mul.ref(2,4));
  $p70.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 225, 2} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb10;
$bb10:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $p71 := $add.ref($p0,$mul.ref(1,4));
  $p71.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($p0,$mul.ref(3,4));
  $p73.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  assert ($p73 == $p73.shadow);
  $i74 := $load.i32($M.0,$p73);
  $i74.shadow := $load.i32($M.0.shadow,$p73.shadow);
  call {:cexpr "b"} boogie_si_record_i32($i74);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i75 := $and.i32($i72,858993459);
  $i75.shadow := $and.i32($i72.shadow,858993459);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i76 := $and.i32($i74,858993459);
  $i76.shadow := $and.i32($i74.shadow,858993459);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i77 := $shl.i32($i76,2);
  $i77.shadow := $shl.i32($i76.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i78 := $or.i32($i75,$i77);
  $i78.shadow := $or.i32($i75.shadow,$i77.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $p79 := $add.ref($p0,$mul.ref(1,4));
  $p79.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i80 := $and.i32($i72,3435973836);
  $i80.shadow := $and.i32($i72.shadow,3435973836);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i81 := $lshr.i32($i80,2);
  $i81.shadow := $lshr.i32($i80.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i82 := $and.i32($i74,3435973836);
  $i82.shadow := $and.i32($i74.shadow,3435973836);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $i83 := $or.i32($i81,$i82);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  $p84 := $add.ref($p0,$mul.ref(3,4));
  $p84.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  assert ($p84 == $p84.shadow);
  $M.0 := $store.i32($M.0,$p84,$i83);
  $M.0.shadow := $store.i32($M.0.shadow,$p84.shadow,$i83.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 226, 2} true;
  assume {:verifier.code 0} true;
  goto $bb12;
$bb12:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb13:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $p85 := $add.ref($p0,$mul.ref(4,4));
  $p85.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  assert ($p85 == $p85.shadow);
  $i86 := $load.i32($M.0,$p85);
  $i86.shadow := $load.i32($M.0.shadow,$p85.shadow);
  call {:cexpr "a"} boogie_si_record_i32($i86);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $p87 := $add.ref($p0,$mul.ref(6,4));
  $p87.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  assert ($p87 == $p87.shadow);
  $i88 := $load.i32($M.0,$p87);
  $i88.shadow := $load.i32($M.0.shadow,$p87.shadow);
  call {:cexpr "b"} boogie_si_record_i32($i88);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i89 := $and.i32($i86,858993459);
  $i89.shadow := $and.i32($i86.shadow,858993459);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i90 := $and.i32($i88,858993459);
  $i90.shadow := $and.i32($i88.shadow,858993459);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i91 := $shl.i32($i90,2);
  $i91.shadow := $shl.i32($i90.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i92 := $or.i32($i89,$i91);
  $i92.shadow := $or.i32($i89.shadow,$i91.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $p93 := $add.ref($p0,$mul.ref(4,4));
  $p93.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  assert ($p93 == $p93.shadow);
  $M.0 := $store.i32($M.0,$p93,$i92);
  $M.0.shadow := $store.i32($M.0.shadow,$p93.shadow,$i92.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i94 := $and.i32($i86,3435973836);
  $i94.shadow := $and.i32($i86.shadow,3435973836);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i95 := $lshr.i32($i94,2);
  $i95.shadow := $lshr.i32($i94.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i96 := $and.i32($i88,3435973836);
  $i96.shadow := $and.i32($i88.shadow,3435973836);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  $i97 := $or.i32($i95,$i96);
  $i97.shadow := $or.i32($i95.shadow,$i96.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  ...
  $M.0.shadow := $store.i32($M.0.shadow,$p98.shadow,$i97.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 227, 2} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb14:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  goto $bb15;
$bb15:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $p99 := $add.ref($p0,$mul.ref(5,4));
  $p99.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  assert ($p99 == $p99.shadow);
  $i100 := $load.i32($M.0,$p99);
  $i100.shadow := $load.i32($M.0.shadow,$p99.shadow);
  call {:cexpr "a"} boogie_si_record_i32($i100);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  ...
  $i102.shadow := $load.i32($M.0.shadow,$p101.shadow);
  call {:cexpr "b"} boogie_si_record_i32($i102);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i103 := $and.i32($i100,858993459);
  $i103.shadow := $and.i32($i100.shadow,858993459);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i104 := $and.i32($i102,858993459);
  $i104.shadow := $and.i32($i102.shadow,858993459);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i105 := $shl.i32($i104,2);
  $i105.shadow := $shl.i32($i104.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $p107 := $add.ref($p0,$mul.ref(5,4));
  $p107.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  assert ($p107 == $p107.shadow);
  $M.0 := $store.i32($M.0,$p107,$i106);
  $M.0.shadow := $store.i32($M.0.shadow,$p107.shadow,$i106.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i108 := $and.i32($i100,3435973836);
  $i108.shadow := $and.i32($i100.shadow,3435973836);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i109 := $lshr.i32($i108,2);
  $i109.shadow := $lshr.i32($i108.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i110 := $and.i32($i102,3435973836);
  $i110.shadow := $and.i32($i102.shadow,3435973836);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $i111 := $or.i32($i109,$i110);
  $i111.shadow := $or.i32($i109.shadow,$i110.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  $p112 := $add.ref($p0,$mul.ref(7,4));
  $p112.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  assert ($p112 == $p112.shadow);
  $M.0 := $store.i32($M.0,$p112,$i111);
  $M.0.shadow := $store.i32($M.0.shadow,$p112.shadow,$i111.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 228, 2} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb16:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  goto $bb17;
$bb17:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $p113 := $add.ref($p0,$mul.ref(0,4));
  $p113.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  assert ($p113 == $p113.shadow);
  $i114 := $load.i32($M.0,$p113);
  $i114.shadow := $load.i32($M.0.shadow,$p113.shadow);
  call {:cexpr "a"} boogie_si_record_i32($i114);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $p115 := $add.ref($p0,$mul.ref(4,4));
  $p115.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  assert ($p115 == $p115.shadow);
  $i116 := $load.i32($M.0,$p115);
  $i116.shadow := $load.i32($M.0.shadow,$p115.shadow);
  call {:cexpr "b"} boogie_si_record_i32($i116);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i117 := $and.i32($i114,252645135);
  $i117.shadow := $and.i32($i114.shadow,252645135);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i118 := $and.i32($i116,252645135);
  $i118.shadow := $and.i32($i116.shadow,252645135);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i119 := $shl.i32($i118,4);
  $i119.shadow := $shl.i32($i118.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i120 := $or.i32($i117,$i119);
  $i120.shadow := $or.i32($i117.shadow,$i119.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $p121 := $add.ref($p0,$mul.ref(0,4));
  $p121.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  assert ($p121 == $p121.shadow);
  $M.0 := $store.i32($M.0,$p121,$i120);
  $M.0.shadow := $store.i32($M.0.shadow,$p121.shadow,$i120.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i122 := $and.i32($i114,4042322160);
  $i122.shadow := $and.i32($i114.shadow,4042322160);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i123 := $lshr.i32($i122,4);
  $i123.shadow := $lshr.i32($i122.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i124 := $and.i32($i116,4042322160);
  $i124.shadow := $and.i32($i116.shadow,4042322160);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $i125 := $or.i32($i123,$i124);
  $i125.shadow := $or.i32($i123.shadow,$i124.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  $p126 := $add.ref($p0,$mul.ref(4,4));
  $p126.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  assert ($p126 == $p126.shadow);
  $M.0 := $store.i32($M.0,$p126,$i125);
  $M.0.shadow := $store.i32($M.0.shadow,$p126.shadow,$i125.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 230, 2} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb18:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb19:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $p127 := $add.ref($p0,$mul.ref(1,4));
  $p127.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  assert ($p127 == $p127.shadow);
  $i128 := $load.i32($M.0,$p127);
  $i128.shadow := $load.i32($M.0.shadow,$p127.shadow);
  call {:cexpr "a"} boogie_si_record_i32($i128);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $p129 := $add.ref($p0,$mul.ref(5,4));
  $p129.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  assert ($p129 == $p129.shadow);
  $i130 := $load.i32($M.0,$p129);
  $i130.shadow := $load.i32($M.0.shadow,$p129.shadow);
  call {:cexpr "b"} boogie_si_record_i32($i130);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i131 := $and.i32($i128,252645135);
  $i131.shadow := $and.i32($i128.shadow,252645135);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i132 := $and.i32($i130,252645135);
  $i132.shadow := $and.i32($i130.shadow,252645135);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i133 := $shl.i32($i132,4);
  $i133.shadow := $shl.i32($i132.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i134 := $or.i32($i131,$i133);
  $i134.shadow := $or.i32($i131.shadow,$i133.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $p135 := $add.ref($p0,$mul.ref(1,4));
  $p135.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  assert ($p135 == $p135.shadow);
  $M.0 := $store.i32($M.0,$p135,$i134);
  $M.0.shadow := $store.i32($M.0.shadow,$p135.shadow,$i134.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i136 := $and.i32($i128,4042322160);
  $i136.shadow := $and.i32($i128.shadow,4042322160);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i137 := $lshr.i32($i136,4);
  $i137.shadow := $lshr.i32($i136.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i138 := $and.i32($i130,4042322160);
  $i138.shadow := $and.i32($i130.shadow,4042322160);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $i139 := $or.i32($i137,$i138);
  $i139.shadow := $or.i32($i137.shadow,$i138.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  $p140 := $add.ref($p0,$mul.ref(5,4));
  $p140.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  assert ($p140 == $p140.shadow);
  $M.0 := $store.i32($M.0,$p140,$i139);
  $M.0.shadow := $store.i32($M.0.shadow,$p140.shadow,$i139.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 231, 2} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb20:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb21:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  ...
  call {:cexpr "a"} boogie_si_record_i32($i142);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $p143 := $add.ref($p0,$mul.ref(6,4));
  $p143.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  assert ($p143 == $p143.shadow);
  $i144 := $load.i32($M.0,$p143);
  $i144.shadow := $load.i32($M.0.shadow,$p143.shadow);
  call {:cexpr "b"} boogie_si_record_i32($i144);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i145 := $and.i32($i142,252645135);
  $i145.shadow := $and.i32($i142.shadow,252645135);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i146 := $and.i32($i144,252645135);
  $i146.shadow := $and.i32($i144.shadow,252645135);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i147 := $shl.i32($i146,4);
  $i147.shadow := $shl.i32($i146.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $p149 := $add.ref($p0,$mul.ref(2,4));
  $p149.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  assert ($p149 == $p149.shadow);
  $M.0 := $store.i32($M.0,$p149,$i148);
  $M.0.shadow := $store.i32($M.0.shadow,$p149.shadow,$i148.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i150 := $and.i32($i142,4042322160);
  $i150.shadow := $and.i32($i142.shadow,4042322160);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i151 := $lshr.i32($i150,4);
  $i151.shadow := $lshr.i32($i150.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i152 := $and.i32($i144,4042322160);
  $i152.shadow := $and.i32($i144.shadow,4042322160);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  $i153 := $or.i32($i151,$i152);
  $i153.shadow := $or.i32($i151.shadow,$i152.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 232, 2} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb22;
$bb22:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  goto $bb23;
$bb23:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $p155 := $add.ref($p0,$mul.ref(3,4));
  $p155.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  assert ($p155 == $p155.shadow);
  $i156 := $load.i32($M.0,$p155);
  $i156.shadow := $load.i32($M.0.shadow,$p155.shadow);
  call {:cexpr "a"} boogie_si_record_i32($i156);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $p157 := $add.ref($p0,$mul.ref(7,4));
  $p157.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  assert ($p157 == $p157.shadow);
  $i158 := $load.i32($M.0,$p157);
  $i158.shadow := $load.i32($M.0.shadow,$p157.shadow);
  call {:cexpr "b"} boogie_si_record_i32($i158);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i159 := $and.i32($i156,252645135);
  $i159.shadow := $and.i32($i156.shadow,252645135);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i160 := $and.i32($i158,252645135);
  $i160.shadow := $and.i32($i158.shadow,252645135);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i161 := $shl.i32($i160,4);
  $i161.shadow := $shl.i32($i160.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i162 := $or.i32($i159,$i161);
  $i162.shadow := $or.i32($i159.shadow,$i161.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $p163 := $add.ref($p0,$mul.ref(3,4));
  $p163.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  assert ($p163 == $p163.shadow);
  $M.0 := $store.i32($M.0,$p163,$i162);
  $M.0.shadow := $store.i32($M.0.shadow,$p163.shadow,$i162.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i164 := $and.i32($i156,4042322160);
  $i164.shadow := $and.i32($i156.shadow,4042322160);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i165 := $lshr.i32($i164,4);
  $i165.shadow := $lshr.i32($i164.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $i166 := $and.i32($i158,4042322160);
  $i166.shadow := $and.i32($i158.shadow,4042322160);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  $p168 := $add.ref($p0,$mul.ref(7,4));
  $p168.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  assert ($p168 == $p168.shadow);
  $M.0 := $store.i32($M.0,$p168,$i167);
  $M.0.shadow := $store.i32($M.0.shadow,$p168.shadow,$i167.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 233, 2} true;
  assume {:verifier.code 0} true;
  goto $bb24;
$bb24:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 234, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const br_aes_ct_keysched: ref;
axiom (br_aes_ct_keysched == $sub.ref(0,5162));
procedure {:inline 1} br_aes_ct_keysched($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $exn, $M.0, $M.2;
modifies $CurrAddr;
{
  var $p3: ref;
  var $p3.shadow: ref;
...
$bb0:
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(480,$zext.i32.i64(1)));
  $p3.shadow := $p3;
  call {:cexpr "br_aes_ct_keysched:arg:key_len"} boogie_si_record_i64($i2);
  assume true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
  $i4 := $slt.i64($i2,24);
  $i4.shadow := $slt.i64($i2.shadow,24);
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  $i5 := $slt.i64($i2,32);
  $i5.shadow := $slt.i64($i2.shadow,32);
  assume {:verifier.code 0} true;
...
$bb6:
  assume ($i6 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 273, 3} true;
  assume {:verifier.code 0} true;
  $i9 := 14;
  $i9.shadow := 14;
  goto $bb13;
...
$bb9:
  assume ($i7 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 270, 3} true;
  assume {:verifier.code 0} true;
  $i9 := 12;
  $i9.shadow := 12;
  goto $bb13;
...
$bb11:
  assume ($i8 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 267, 3} true;
  assume {:verifier.code 0} true;
  $i9 := 10;
  $i9.shadow := 10;
  goto $bb13;
$bb12:
  ...
  goto $bb8;
$bb13:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 278, 21} true;
  assume {:verifier.code 0} true;
  $i11 := $lshr.i64($i2,2);
  $i11.shadow := $lshr.i64($i2.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 278, 7} true;
  assume {:verifier.code 0} true;
  $i12 := $trunc.i64.i32($i11);
  $i12.shadow := $trunc.i64.i32($i11.shadow);
  call {:cexpr "nk"} boogie_si_record_i32($i12);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 279, 26} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i32($i9,1);
  $i13.shadow := $add.i32($i9.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 279, 31} true;
  assume {:verifier.code 0} true;
  $i14 := $shl.i32($i13,2);
  $i14.shadow := $shl.i32($i13.shadow,2);
  call {:cexpr "nkf"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 281, 7} true;
  assume {:verifier.code 0} true;
  $i15 := 0;
  $i15.shadow := 0;
  $i16 := 0;
  ...
  goto $bb16;
$bb14:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 276, 3} true;
  assume {:verifier.code 0} true;
  $i10 := 0;
  $i10.shadow := 0;
  goto $bb15;
$bb15:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 309, 1} true;
  assume {:verifier.code 0} true;
  $r := $i10;
  $r.shadow := $i10.shadow;
  $exn := false;
...
$bb16:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 281, 16} true;
  assume {:verifier.code 0} true;
  $i17 := $slt.i32($i15,$i12);
  $i17.shadow := $slt.i32($i15.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 281, 2} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume ($i17 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 282, 52} true;
  assume {:verifier.code 0} true;
  $i18 := $shl.i32($i15,2);
  $i18.shadow := $shl.i32($i15.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 282, 47} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 282, 9} true;
  assume {:verifier.code 0} true;
  call $i21, $i21.shadow := br_dec32le($p20, $p20.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i21);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 283, 11} true;
  assume {:verifier.code 0} true;
  $i22 := $shl.i32($i15,1);
  $i22.shadow := $shl.i32($i15.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 283, 17} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i22,0);
  $i23.shadow := $add.i32($i22.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 283, 3} true;
  assume {:verifier.code 0} true;
  $i24 := $sext.i32.i64($i23);
  $i24.shadow := $sext.i32.i64($i23.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 283, 3} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p3,$mul.ref(0,480)),$mul.ref($i24,4));
  $p25.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,480)),$mul.ref($i24.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 283, 22} true;
  assume {:verifier.code 0} true;
  assert ($p25 == $p25.shadow);
  $M.0 := $store.i32($M.0,$p25,$i21);
  $M.0.shadow := $store.i32($M.0.shadow,$p25.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 284, 11} true;
  assume {:verifier.code 0} true;
  $i26 := $shl.i32($i15,1);
  $i26.shadow := $shl.i32($i15.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 284, 17} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i26,1);
  $i27.shadow := $add.i32($i26.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 284, 3} true;
  assume {:verifier.code 0} true;
  $i28 := $sext.i32.i64($i27);
  $i28.shadow := $sext.i32.i64($i27.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 284, 3} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p3,$mul.ref(0,480)),$mul.ref($i28,4));
  $p29.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,480)),$mul.ref($i28.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 284, 22} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $M.0 := $store.i32($M.0,$p29,$i21);
  $M.0.shadow := $store.i32($M.0.shadow,$p29.shadow,$i21.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 285, 2} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb18:
  assume !($i17 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 286, 7} true;
  assume {:verifier.code 0} true;
  $i31 := $i12;
  $i31.shadow := $i12.shadow;
  $i32 := 0;
  $i32.shadow := 0;
  $i33 := 0;
  $i33.shadow := 0;
  $i34 := $i16;
  $i34.shadow := $i16.shadow;
  goto $bb20;
$bb19:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 281, 24} true;
  assume {:verifier.code 0} true;
  $i30 := $add.i32($i15,1);
  $i30.shadow := $add.i32($i15.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i30);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 281, 2} true;
  assume {:verifier.code 0} true;
  $i15 := $i30;
  $i15.shadow := $i30.shadow;
  $i16 := $i21;
  $i16.shadow := $i21.shadow;
  goto $bb16;
$bb20:
  assert {:shadow_invariant} $shadow_ok;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 286, 31} true;
  assume {:verifier.code 0} true;
  $i35 := $slt.i32($i31,$i14);
  $i35.shadow := $slt.i32($i31.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 286, 2} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume ($i35 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 287, 9} true;
  assume {:verifier.code 0} true;
  $i36 := $eq.i32($i32,0);
  $i36.shadow := $eq.i32($i32.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 287, 7} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume !($i35 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 301, 7} true;
  assume {:verifier.code 0} true;
  $i71 := 0;
  $i71.shadow := 0;
  goto $bb35;
$bb23:
  assume ($i36 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 288, 15} true;
  assume {:verifier.code 0} true;
  $i37 := $shl.i32($i34,24);
  $i37.shadow := $shl.i32($i34.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 288, 29} true;
  assume {:verifier.code 0} true;
  $i38 := $lshr.i32($i34,8);
  $i38.shadow := $lshr.i32($i34.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 288, 22} true;
  assume {:verifier.code 0} true;
  $i39 := $or.i32($i37,$i38);
  $i39.shadow := $or.i32($i37.shadow,$i38.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i39);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 289, 10} true;
  assume {:verifier.code 0} true;
  call $i40, $i40.shadow := sub_word($i39, $i39.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 289, 26} true;
  assume {:verifier.code 0} true;
  $i41 := $sext.i32.i64($i33);
  $i41.shadow := $sext.i32.i64($i33.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 289, 26} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref($i41,1));
  $p42.shadow := $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref($i41.shadow,1));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 289, 26} true;
  assume {:verifier.code 0} true;
  assert ($p42 == $p42.shadow);
  $i43 := $load.i8($M.1,$p42);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 289, 24} true;
  assume {:verifier.code 0} true;
  $i45 := $xor.i32($i40,$i44);
  $i45.shadow := $xor.i32($i40.shadow,$i44.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i45);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 290, 3} true;
  assume {:verifier.code 0} true;
  $i46 := $i45;
  $i46.shadow := $i45.shadow;
  goto $bb25;
$bb24:
  assume !($i36 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 290, 17} true;
  assume {:verifier.code 0} true;
  $i47 := $sgt.i32($i12,6);
  $i47.shadow := $sgt.i32($i12.shadow,6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 290, 21} true;
  assume {:verifier.code 0} true;
  $i48 := $i34;
  $i48.shadow := $i34.shadow;
...
$bb25:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 293, 18} true;
  assume {:verifier.code 0} true;
  $i51 := $sub.i32($i31,$i12);
  $i51.shadow := $sub.i32($i31.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 293, 24} true;
  assume {:verifier.code 0} true;
  $i52 := $shl.i32($i51,1);
  $i52.shadow := $shl.i32($i51.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 293, 10} true;
  assume {:verifier.code 0} true;
  $i53 := $sext.i32.i64($i52);
  $i53.shadow := $sext.i32.i64($i52.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 293, 10} true;
  assume {:verifier.code 0} true;
  $p54 := $add.ref($add.ref($p3,$mul.ref(0,480)),$mul.ref($i53,4));
  $p54.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,480)),$mul.ref($i53.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 293, 10} true;
  assume {:verifier.code 0} true;
  assert ($p54 == $p54.shadow);
  $i55 := $load.i32($M.0,$p54);
  $i55.shadow := $load.i32($M.0.shadow,$p54.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 293, 7} true;
  assume {:verifier.code 0} true;
  $i56 := $xor.i32($i46,$i55);
  $i56.shadow := $xor.i32($i46.shadow,$i55.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i56);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 294, 11} true;
  assume {:verifier.code 0} true;
  $i57 := $shl.i32($i31,1);
  $i57.shadow := $shl.i32($i31.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 294, 17} true;
  assume {:verifier.code 0} true;
  $i58 := $add.i32($i57,0);
  $i58.shadow := $add.i32($i57.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 294, 3} true;
  assume {:verifier.code 0} true;
  $i59 := $sext.i32.i64($i58);
  $i59.shadow := $sext.i32.i64($i58.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 294, 3} true;
  assume {:verifier.code 0} true;
  $p60 := $add.ref($add.ref($p3,$mul.ref(0,480)),$mul.ref($i59,4));
  $p60.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,480)),$mul.ref($i59.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 294, 22} true;
  assume {:verifier.code 0} true;
  assert ($p60 == $p60.shadow);
  $M.0 := $store.i32($M.0,$p60,$i56);
  $M.0.shadow := $store.i32($M.0.shadow,$p60.shadow,$i56.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 295, 11} true;
  assume {:verifier.code 0} true;
  $i61 := $shl.i32($i31,1);
  $i61.shadow := $shl.i32($i31.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 295, 17} true;
  assume {:verifier.code 0} true;
  $i62 := $add.i32($i61,1);
  $i62.shadow := $add.i32($i61.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 295, 3} true;
  assume {:verifier.code 0} true;
  $i63 := $sext.i32.i64($i62);
  $i63.shadow := $sext.i32.i64($i62.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 295, 3} true;
  assume {:verifier.code 0} true;
  $p64 := $add.ref($add.ref($p3,$mul.ref(0,480)),$mul.ref($i63,4));
  $p64.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,480)),$mul.ref($i63.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 295, 22} true;
  assume {:verifier.code 0} true;
  assert ($p64 == $p64.shadow);
  $M.0 := $store.i32($M.0,$p64,$i56);
  $M.0.shadow := $store.i32($M.0.shadow,$p64.shadow,$i56.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 296, 7} true;
  assume {:verifier.code 0} true;
  $i65 := $add.i32($i32,1);
  $i65.shadow := $add.i32($i32.shadow,1);
  call {:cexpr "j"} boogie_si_record_i32($i65);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 296, 12} true;
  assume {:verifier.code 0} true;
  $i66 := $eq.i32($i65,$i12);
  $i66.shadow := $eq.i32($i65.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 296, 7} true;
  assume {:verifier.code 0} true;
  $i67 := $i65;
  $i67.shadow := $i65.shadow;
  $i68 := $i33;
  $i68.shadow := $i33.shadow;
  assume {:branchcond $i66} true;
  assert ($i66 == $i66.shadow);
  goto $bb31, $bb32;
$bb26:
  assume ($i47 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 290, 26} true;
  assume {:verifier.code 0} true;
  $i49 := $eq.i32($i32,4);
  $i49.shadow := $eq.i32($i32.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 290, 14} true;
  assume {:verifier.code 0} true;
  $i48 := $i34;
  $i48.shadow := $i34.shadow;
...
$bb28:
  ...
  assume {:verifier.code 0} true;
  $i46 := $i48;
  $i46.shadow := $i48.shadow;
  goto $bb25;
$bb29:
  assume ($i49 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 291, 10} true;
  assume {:verifier.code 0} true;
  call $i50, $i50.shadow := sub_word($i34, $i34.shadow);
  call {:cexpr "tmp"} boogie_si_record_i32($i50);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 292, 3} true;
  assume {:verifier.code 0} true;
  $i48 := $i50;
  $i48.shadow := $i50.shadow;
  goto $bb28;
$bb30:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 290, 14} true;
  assume {:verifier.code 0} true;
...
$bb31:
  assume ($i66 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 298, 6} true;
  assume {:verifier.code 0} true;
  $i69 := $add.i32($i33,1);
  $i69.shadow := $add.i32($i33.shadow,1);
  call {:cexpr "k"} boogie_si_record_i32($i69);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 299, 3} true;
  assume {:verifier.code 0} true;
  $i67 := 0;
  $i67.shadow := 0;
  $i68 := $i69;
  $i68.shadow := $i69.shadow;
  goto $bb33;
$bb32:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 296, 7} true;
  assume {:verifier.code 0} true;
...
$bb33:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 300, 2} true;
  assume {:verifier.code 0} true;
  goto $bb34;
$bb34:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 286, 40} true;
  assume {:verifier.code 0} true;
  $i70 := $add.i32($i31,1);
  $i70.shadow := $add.i32($i31.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i70);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 286, 2} true;
  assume {:verifier.code 0} true;
  $i31 := $i70;
  $i31.shadow := $i70.shadow;
  $i32 := $i67;
  $i32.shadow := $i67.shadow;
  $i33 := $i68;
  $i33.shadow := $i68.shadow;
  $i34 := $i56;
  $i34.shadow := $i56.shadow;
  goto $bb20;
$bb35:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i71 == $i71.shadow);
  assert {:shadow_invariant} ($i9 == $i9.shadow);
  assert {:shadow_invariant} ($i14 == $i14.shadow);
  assert {:shadow_invariant} ($p3 == $p3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 301, 16} true;
  assume {:verifier.code 0} true;
  $i72 := $slt.i32($i71,$i14);
  $i72.shadow := $slt.i32($i71.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 301, 2} true;
  assume {:verifier.code 0} true;
...
$bb36:
  assume ($i72 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 302, 19} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($add.ref($p3,$mul.ref(0,480)),$mul.ref(0,4));
  $p73.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,480)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 302, 29} true;
  assume {:verifier.code 0} true;
  $i74 := $shl.i32($i71,1);
  $i74.shadow := $shl.i32($i71.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 302, 24} true;
  assume {:verifier.code 0} true;
  $i75 := $sext.i32.i64($i74);
  $i75.shadow := $sext.i32.i64($i74.shadow);
  $p76 := $add.ref($add.ref($p3,$mul.ref(0,480)),$mul.ref($i75,4));
  $p76.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,480)),$mul.ref($i75.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 302, 3} true;
  assume {:verifier.code 0} true;
  call br_aes_ct_ortho($p76, $p76.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 303, 2} true;
  assume {:verifier.code 0} true;
  goto $bb38;
$bb37:
  assume !($i72 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 304, 7} true;
  assume {:verifier.code 0} true;
  $i78 := 0;
  $i78.shadow := 0;
  $i79 := 0;
  ...
  goto $bb39;
$bb38:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 301, 25} true;
  assume {:verifier.code 0} true;
  $i77 := $add.i32($i71,4);
  $i77.shadow := $add.i32($i71.shadow,4);
  call {:cexpr "i"} boogie_si_record_i32($i77);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 301, 2} true;
  assume {:verifier.code 0} true;
  $i71 := $i77;
  $i71.shadow := $i77.shadow;
  goto $bb35;
$bb39:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i79 == $i79.shadow);
  assert {:shadow_invariant} ($i78 == $i78.shadow);
  assert {:shadow_invariant} ($i9 == $i9.shadow);
  assert {:shadow_invariant} ($i14 == $i14.shadow);
  assert {:shadow_invariant} ($p3 == $p3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 304, 23} true;
  assume {:verifier.code 0} true;
  $i80 := $slt.i32($i78,$i14);
  $i80.shadow := $slt.i32($i78.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 304, 2} true;
  assume {:verifier.code 0} true;
...
$bb40:
  assume ($i80 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 305, 26} true;
  assume {:verifier.code 0} true;
  $i81 := $add.i32($i79,0);
  $i81.shadow := $add.i32($i79.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 305, 19} true;
  assume {:verifier.code 0} true;
  $i82 := $sext.i32.i64($i81);
  $i82.shadow := $sext.i32.i64($i81.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 305, 19} true;
  assume {:verifier.code 0} true;
  $p83 := $add.ref($add.ref($p3,$mul.ref(0,480)),$mul.ref($i82,4));
  $p83.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,480)),$mul.ref($i82.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 305, 19} true;
  assume {:verifier.code 0} true;
  assert ($p83 == $p83.shadow);
  $i84 := $load.i32($M.0,$p83);
  $i84.shadow := $load.i32($M.0.shadow,$p83.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 305, 31} true;
  assume {:verifier.code 0} true;
  $i85 := $and.i32($i84,1431655765);
  $i85.shadow := $and.i32($i84.shadow,1431655765);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 306, 14} true;
  assume {:verifier.code 0} true;
  $i86 := $add.i32($i79,1);
  $i86.shadow := $add.i32($i79.shadow,1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 306, 7} true;
  assume {:verifier.code 0} true;
  $i87 := $sext.i32.i64($i86);
  $i87.shadow := $sext.i32.i64($i86.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 306, 7} true;
  assume {:verifier.code 0} true;
  $p88 := $add.ref($add.ref($p3,$mul.ref(0,480)),$mul.ref($i87,4));
  $p88.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,480)),$mul.ref($i87.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 306, 7} true;
  assume {:verifier.code 0} true;
  assert ($p88 == $p88.shadow);
  $i89 := $load.i32($M.0,$p88);
  $i89.shadow := $load.i32($M.0.shadow,$p88.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 306, 19} true;
  assume {:verifier.code 0} true;
  $i90 := $and.i32($i89,2863311530);
  $i90.shadow := $and.i32($i89.shadow,2863311530);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 306, 4} true;
  assume {:verifier.code 0} true;
  $i91 := $or.i32($i85,$i90);
  $i91.shadow := $or.i32($i85.shadow,$i90.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 305, 3} true;
  assume {:verifier.code 0} true;
  $i92 := $sext.i32.i64($i78);
  $i92.shadow := $sext.i32.i64($i78.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 305, 3} true;
  assume {:verifier.code 0} true;
  $p93 := $add.ref($p0,$mul.ref($i92,4));
  $p93.shadow := $add.ref($p0.shadow,$mul.ref($i92.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 305, 16} true;
  assume {:verifier.code 0} true;
  assert ($p93 == $p93.shadow);
  $M.2 := $store.i32($M.2,$p93,$i91);
  $M.2.shadow := $store.i32($M.2.shadow,$p93.shadow,$i91.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 307, 2} true;
  assume {:verifier.code 0} true;
  goto $bb42;
$bb41:
  assume !($i80 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 308, 2} true;
  assume {:verifier.code 0} true;
  $i10 := $i9;
  $i10.shadow := $i9.shadow;
  goto $bb15;
$bb42:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 304, 32} true;
  assume {:verifier.code 0} true;
  $i94 := $add.i32($i78,1);
  $i94.shadow := $add.i32($i78.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i94);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 304, 38} true;
  assume {:verifier.code 0} true;
  $i95 := $add.i32($i79,2);
  $i95.shadow := $add.i32($i79.shadow,2);
  call {:cexpr "j"} boogie_si_record_i32($i95);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 304, 2} true;
  assume {:verifier.code 0} true;
  $i78 := $i94;
  $i78.shadow := $i94.shadow;
  $i79 := $i95;
  $i79.shadow := $i95.shadow;
  goto $bb39;
}
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0,6194));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const br_dec32le: ref;
axiom (br_dec32le == $sub.ref(0,7226));
...
$bb0:
  ...
  assert ($p2 == $p2.shadow);
  $i3 := $load.i32($M.3,$p2);
  $i3.shadow := $load.i32($M.3.shadow,$p2.shadow);
...
modifies $CurrAddr;
{
  ...
  var $i11.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 246, 7} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 246, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i2,8);
  $i3.shadow := $slt.i32($i2.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 246, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 247, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i2);
  $i4.shadow := $sext.i32.i64($i2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 247, 3} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref($i4,4));
  $p5.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref($i4.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 247, 8} true;
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $M.0 := $store.i32($M.0,$p5,$i0);
  $M.0.shadow := $store.i32($M.0.shadow,$p5.shadow,$i0.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 248, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i3 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 249, 18} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,4));
  $p7.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 249, 2} true;
  assume {:verifier.code 0} true;
  call br_aes_ct_ortho($p7, $p7.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 250, 26} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,4));
  $p8.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 250, 2} true;
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_Sbox($p8, $p8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 251, 18} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,4));
  $p9.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 251, 2} true;
  assume {:verifier.code 0} true;
  call br_aes_ct_ortho($p9, $p9.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 252, 9} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,4));
  $p10.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 252, 9} true;
  assume {:verifier.code 0} true;
  assert ($p10 == $p10.shadow);
  $i11 := $load.i32($M.0,$p10);
  $i11.shadow := $load.i32($M.0.shadow,$p10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 252, 2} true;
  assume {:verifier.code 0} true;
  $r := $i11;
  $r.shadow := $i11.shadow;
  $exn := false;
  ...
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 246, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i2,1);
  $i6.shadow := $add.i32($i2.shadow,1);
...
axiom (key_sched_wrapper == $sub.ref(0,9290));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i6, $i6.shadow := br_aes_ct_keysched($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow);
...
axiom (__SMACK_dummy == $sub.ref(0,14450));
...
axiom (__SMACK_and32 == $sub.ref(0,15482));
...
axiom (__SMACK_and64 == $sub.ref(0,16514));
...
axiom (__SMACK_and16 == $sub.ref(0,17546));
...
axiom (__SMACK_and8 == $sub.ref(0,18578));
...
axiom (__SMACK_or32 == $sub.ref(0,19610));
...
axiom (__SMACK_or64 == $sub.ref(0,20642));
...
axiom (__SMACK_or16 == $sub.ref(0,21674));
...
axiom (__SMACK_or8 == $sub.ref(0,22706));
...
axiom (__SMACK_check_overflow == $sub.ref(0,23738));
...
axiom (__SMACK_loop_exit == $sub.ref(0,24770));
...
axiom (__SMACK_decls == $sub.ref(0,25802));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,26834));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,27866));
...
axiom (__SMACK_static_init == $sub.ref(0,28898));
procedure {:inline 1} __SMACK_static_init()
modifies $M.1, $exn;
{
$bb0:
  assert (Rcon == Rcon);
  $M.1 := $store.i8($M.1,Rcon,1);
  $M.1.shadow := $store.i8($M.1.shadow,Rcon,1);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(1,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(1,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(1,1)),2);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(1,1)),2);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(2,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(2,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(2,1)),4);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(2,1)),4);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(3,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(3,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(3,1)),8);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(3,1)),8);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(4,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(4,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(4,1)),16);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(4,1)),16);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(5,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(5,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(5,1)),32);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(5,1)),32);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(6,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(6,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(6,1)),64);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(6,1)),64);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(7,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(7,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(7,1)),$sub.i8(0,128));
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(7,1)),$sub.i8(0,128));
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(8,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(8,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(8,1)),27);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(8,1)),27);
  assert ($add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(9,1)) == $add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(9,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(9,1)),54);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(9,1)),54);
  $exn := false;
  $exn.shadow := false;
  return;
}
