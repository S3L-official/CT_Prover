...
modifies $shadow_ok, $exn, $exn.shadow, $M.0, $M.0.shadow, $M.2, $M.2.shadow;
modifies $CurrAddr;
{
  var $p3: ref;
  var $p3.shadow: ref;
...
modifies $shadow_ok, $exn, $exn.shadow;
modifies $M.0, $M.0.shadow, $M.2, $M.2.shadow;
modifies $CurrAddr, $M.1, $M.1.shadow;
{
  var $p3: ref;
  var $p3.shadow: ref;
  var $p4: ref;
...
modifies $CurrAddr, $exn;
modifies $shadow_ok, $M.1, $M.1.shadow, $exn.shadow;
{
