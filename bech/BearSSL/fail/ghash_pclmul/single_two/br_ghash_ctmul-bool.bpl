...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_ghash_ctmul($p0, $p0.dup, $p1, $p1.dup, $p2, $p2.dup, $i3, $i3.dup);
...
procedure {:inline 1} br_ghash_ctmul($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1, $i3: i64, $i3.dup: i1)
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i13, $i13.dup := br_dec32be($p12, $p12.dup);
  ...
  $M.2.dup := $store.i1($M.2.dup,$p14,$i13.dup);
  ...
  assume {:verifier.code 0} true;
  call $i16, $i16.dup := br_dec32be($p15, $p15.dup);
  ...
  $M.2.dup := $store.i1($M.2.dup,$p17,$i16.dup);
  ...
  assume {:verifier.code 0} true;
  call $i19, $i19.dup := br_dec32be($p18, $p18.dup);
  ...
  assume {:verifier.code 0} true;
  call $i24, $i24.dup := br_dec32be($p23, $p23.dup);
  ...
  $M.4.dup := $store.i1($M.4.dup,$p25,$i24.dup);
  ...
  assume {:verifier.code 0} true;
  call $i27, $i27.dup := br_dec32be($p26, $p26.dup);
  ...
  $M.5.dup := $store.i1($M.5.dup,$p28,$i27.dup);
  ...
  assume {:verifier.code 0} true;
  call $i30, $i30.dup := br_dec32be($p29, $p29.dup);
  ...
  $M.6.dup := $store.i1($M.6.dup,$p31,$i30.dup);
...
$bb1:
  ...
  assert {:shadow_invariant} ($p33.dup == 0);
  assert {:shadow_invariant} ($p6.dup == 0);
  assert {:shadow_invariant} ($i32.dup == 0);
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  call $i46, $i46.dup := br_dec32be($p40, $p40.dup);
  ...
  $i63.dup := $load.i1($M.2.dup,$p62);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 248, 9} true;
  assume {:verifier.code 0} true;
  $i64 := $xor.i32($i63,$i61);
  $i64.dup := $or.i1($i63.dup,$i61.dup);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 248, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p62.dup == 0));
  $M.2 := $store.i32($M.2,$p62,$i64);
  $M.2.dup := $store.i1($M.2.dup,$p62,$i64.dup);
  ...
  $M.7.dup := $store.i1($M.7.dup,$p67,$i66.dup);
  ...
  $M.7.dup := $store.i1($M.7.dup,$p82,$i81.dup);
  ...
  $M.8.dup := $store.i1($M.8.dup,$p88,$i87.dup);
  ...
  $M.7.dup := $store.i1($M.7.dup,$p97,$i96.dup);
  ...
  $M.8.dup := $store.i1($M.8.dup,$p100,$i99.dup);
  ...
  $M.8.dup := $store.i1($M.8.dup,$p124,$i123.dup);
  ...
  $M.8.dup := $store.i1($M.8.dup,$p136,$i135.dup);
  ...
  $M.7.dup := $store.i1($M.7.dup,$p142,$i141.dup);
  ...
  $M.8.dup := $store.i1($M.8.dup,$p148,$i147.dup);
...
$bb7:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($p9.dup == 0);
  assert {:shadow_invariant} ($i149.dup == 0);
  assert {:shadow_invariant} ($p8.dup == 0);
  assert {:shadow_invariant} ($p7.dup == 0);
  assert {:shadow_invariant} ($p39.dup == 0);
  assert {:shadow_invariant} ($p6.dup == 0);
...
$bb8:
  ...
  $p152.dup := $or.i1($or.i1($p8.dup,$or.i1(0,0)),$or.i1($i151.dup,0));
  ...
  $p154.dup := $or.i1($or.i1($p7.dup,$or.i1(0,0)),$or.i1($i153.dup,0));
  ...
  $p156.dup := $or.i1($or.i1($p8.dup,$or.i1(0,0)),$or.i1($i155.dup,0));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 23} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p156.dup == 0));
  $i157 := $load.i32($M.8,$p156);
  $i157.dup := $load.i1($M.8.dup,$p156);
  ...
  $p159.dup := $or.i1($or.i1($p7.dup,$or.i1(0,0)),$or.i1($i158.dup,0));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 29} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p159.dup == 0));
  $i160 := $load.i32($M.7,$p159);
  $i160.dup := $load.i1($M.7.dup,$p159);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 284, 4} true;
  assume {:verifier.code 0} true;
  call bmul($p152, $p152.dup, $p154, $p154.dup, $i157, $i157.dup, $i160, $i160.dup);
...
$bb9:
  ...
  $p162.dup := $or.i1($or.i1($p7.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 287, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p162.dup == 0));
  $i163 := $load.i32($M.7,$p162);
  $i163.dup := $load.i1($M.7.dup,$p162);
  ...
  $p186.dup := $or.i1($or.i1($p8.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 290, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p186.dup == 0));
  $i187 := $load.i32($M.8,$p186);
  $i187.dup := $load.i1($M.8.dup,$p186);
  ...
  $p188.dup := $or.i1($or.i1($p7.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 291, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p188.dup == 0));
  $i189 := $load.i32($M.7,$p188);
  $i189.dup := $load.i1($M.7.dup,$p188);
  ...
  $p206.dup := $or.i1($or.i1($p8.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 22} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p206.dup == 0));
  $i207 := $load.i32($M.8,$p206);
  $i207.dup := $load.i1($M.8.dup,$p206);
  ...
  $p209.dup := $or.i1($or.i1($p8.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 293, 29} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p209.dup == 0));
  $i210 := $load.i32($M.8,$p209);
  $i210.dup := $load.i1($M.8.dup,$p209);
  ...
  $p212.dup := $or.i1($or.i1($p8.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 294, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p212.dup == 0));
  $i213 := $load.i32($M.8,$p212);
  $i213.dup := $load.i1($M.8.dup,$p212);
  ...
  $p214.dup := $or.i1($or.i1($p7.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 295, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p214.dup == 0));
  $i215 := $load.i32($M.7,$p214);
  $i215.dup := $load.i1($M.7.dup,$p214);
...
$bb11:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i282.dup == 0);
  assert {:shadow_invariant} ($p9.dup == 0);
  assert {:shadow_invariant} ($p8.dup == 0);
  assert {:shadow_invariant} ($p7.dup == 0);
  assert {:shadow_invariant} ($p39.dup == 0);
  ...
  $shadow_ok := ($shadow_ok && ($i283.dup == 0));
  goto $bb12, $bb13;
$bb12:
  assume ($i283 == 1);
...
$bb13:
  ...
  $p309.dup := $or.i1($or.i1($p4.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 335, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p311.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  $p312 := $add.ref($add.ref($p9,$mul.ref(0,32)),$mul.ref(4,4));
  $p312.dup := $or.i1($or.i1($p9.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 335, 3} true;
  assume {:verifier.code 0} true;
  ...
  call $M.2, $M.2.dup := $memcpy.i8($M.2, $M.2.dup, $M.9, $M.9.dup, $p310, $p310.dup, $p313, $p313.dup, 16, 0, false, false);
  assume {:sourceloc "../BearSSL/src/hash/ghash_ctmul.c", 219, 2} true;
  assume {:verifier.code 0} true;
  $i32 := $i38;
  $i32.dup := $i38.dup;
...
procedure {:inline 1} bmul($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i32, $i2.dup: i1, $i3: i32, $i3.dup: i1)
...
$bb0:
  ...
  $M.7.dup := $store.i1($M.7.dup,$p1,$i79.dup);
  ...
  $M.8.dup := $store.i1($M.8.dup,$p0,$i81.dup);
