...
modifies $M.2, $M.2.shadow, $M.3, $M.3.shadow, $M.4, $M.4.shadow, $M.5, $M.5.shadow, $M.6, $M.6.shadow, $M.1, $M.1.shadow, $M.7, $M.7.shadow, $M.8, $M.8.shadow, $M.9, $M.9.shadow;
modifies $CurrAddr;
{
  var $p4: ref;
  var $p4.shadow: ref;
...
modifies $shadow_ok, $M.2, $M.2.shadow, $M.3, $M.3.shadow, $M.4, $M.4.shadow, $M.5, $M.5.shadow, $M.6, $M.6.shadow, $exn, $exn.shadow, $M.1, $M.1.shadow, $M.7, $M.7.shadow, $M.8, $M.8.shadow, $M.9, $M.9.shadow;
modifies $CurrAddr;
{
  var $p4: ref;
  var $p4.shadow: ref;
...
modifies $shadow_ok, $M.7, $M.7.shadow, $M.8, $M.8.shadow, $exn, $exn.shadow;
{
  var $i4: i32;
  var $i4.shadow: i32;
  var $i5: i32;
