...
const br_aes_ct_bitslice_Sbox: ref;
axiom (br_aes_ct_bitslice_Sbox == $sub.ref(0,1032));
procedure {:inline 1} br_aes_ct_bitslice_Sbox($p0: ref, $p0.shadow: ref)
modifies $M.0, $exn;
{
  var $p1: ref;
  var $p1.shadow: ref;
  ...
  var $p143.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 56, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 56, 7} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($p0,$mul.ref(7,4));
  $p1.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 56, 7} true;
  assume {:verifier.code 0} true;
  assert ($p1 == $p1.shadow);
  $i2 := $load.i32($M.0,$p1);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 57, 7} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p0,$mul.ref(6,4));
  $p3.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 57, 7} true;
  assume {:verifier.code 0} true;
  assert ($p3 == $p3.shadow);
  $i4 := $load.i32($M.0,$p3);
  $i4.shadow := $load.i32($M.0.shadow,$p3.shadow);
  call {:cexpr "x1"} boogie_si_record_i32($i4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 58, 7} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0,$mul.ref(5,4));
  $p5.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 58, 7} true;
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $i6 := $load.i32($M.0,$p5);
  $i6.shadow := $load.i32($M.0.shadow,$p5.shadow);
  call {:cexpr "x2"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 59, 7} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p0,$mul.ref(4,4));
  $p7.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 59, 7} true;
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $i8 := $load.i32($M.0,$p7);
  $i8.shadow := $load.i32($M.0.shadow,$p7.shadow);
  call {:cexpr "x3"} boogie_si_record_i32($i8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 60, 7} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "x4"} boogie_si_record_i32($i10);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 61, 7} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p0,$mul.ref(2,4));
  $p11.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 61, 7} true;
  assume {:verifier.code 0} true;
  assert ($p11 == $p11.shadow);
  $i12 := $load.i32($M.0,$p11);
  $i12.shadow := $load.i32($M.0.shadow,$p11.shadow);
  call {:cexpr "x5"} boogie_si_record_i32($i12);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 62, 7} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p0,$mul.ref(1,4));
  $p13.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 62, 7} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  $i14 := $load.i32($M.0,$p13);
  $i14.shadow := $load.i32($M.0.shadow,$p13.shadow);
  call {:cexpr "x6"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 63, 7} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p0,$mul.ref(0,4));
  $p15.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 63, 7} true;
  assume {:verifier.code 0} true;
  assert ($p15 == $p15.shadow);
  $i16 := $load.i32($M.0,$p15);
  $i16.shadow := $load.i32($M.0.shadow,$p15.shadow);
  call {:cexpr "x7"} boogie_si_record_i32($i16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 68, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $xor.i32($i8,$i12);
  $i17.shadow := $xor.i32($i8.shadow,$i12.shadow);
  call {:cexpr "y14"} boogie_si_record_i32($i17);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 69, 11} true;
  assume {:verifier.code 0} true;
  $i18 := $xor.i32($i2,$i14);
  $i18.shadow := $xor.i32($i2.shadow,$i14.shadow);
  call {:cexpr "y13"} boogie_si_record_i32($i18);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 70, 10} true;
  assume {:verifier.code 0} true;
  $i19 := $xor.i32($i2,$i8);
  $i19.shadow := $xor.i32($i2.shadow,$i8.shadow);
  call {:cexpr "y9"} boogie_si_record_i32($i19);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 71, 10} true;
  assume {:verifier.code 0} true;
  $i20 := $xor.i32($i2,$i12);
  $i20.shadow := $xor.i32($i2.shadow,$i12.shadow);
  call {:cexpr "y8"} boogie_si_record_i32($i20);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 72, 10} true;
  assume {:verifier.code 0} true;
  $i21 := $xor.i32($i4,$i6);
  $i21.shadow := $xor.i32($i4.shadow,$i6.shadow);
  call {:cexpr "t0"} boogie_si_record_i32($i21);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 73, 10} true;
  assume {:verifier.code 0} true;
  $i22 := $xor.i32($i21,$i16);
  $i22.shadow := $xor.i32($i21.shadow,$i16.shadow);
  call {:cexpr "y1"} boogie_si_record_i32($i22);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 74, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $xor.i32($i22,$i8);
  $i23.shadow := $xor.i32($i22.shadow,$i8.shadow);
  call {:cexpr "y4"} boogie_si_record_i32($i23);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 75, 12} true;
  assume {:verifier.code 0} true;
  $i24 := $xor.i32($i18,$i17);
  $i24.shadow := $xor.i32($i18.shadow,$i17.shadow);
  call {:cexpr "y12"} boogie_si_record_i32($i24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 76, 10} true;
  assume {:verifier.code 0} true;
  $i25 := $xor.i32($i22,$i2);
  $i25.shadow := $xor.i32($i22.shadow,$i2.shadow);
  call {:cexpr "y2"} boogie_si_record_i32($i25);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 77, 10} true;
  assume {:verifier.code 0} true;
  $i26 := $xor.i32($i22,$i14);
  $i26.shadow := $xor.i32($i22.shadow,$i14.shadow);
  call {:cexpr "y5"} boogie_si_record_i32($i26);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 78, 10} true;
  assume {:verifier.code 0} true;
  $i27 := $xor.i32($i26,$i20);
  $i27.shadow := $xor.i32($i26.shadow,$i20.shadow);
  call {:cexpr "y3"} boogie_si_record_i32($i27);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 79, 10} true;
  assume {:verifier.code 0} true;
  $i28 := $xor.i32($i10,$i24);
  $i28.shadow := $xor.i32($i10.shadow,$i24.shadow);
  call {:cexpr "t1"} boogie_si_record_i32($i28);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 80, 11} true;
  assume {:verifier.code 0} true;
  $i29 := $xor.i32($i28,$i12);
  $i29.shadow := $xor.i32($i28.shadow,$i12.shadow);
  call {:cexpr "y15"} boogie_si_record_i32($i29);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 81, 11} true;
  assume {:verifier.code 0} true;
  $i30 := $xor.i32($i28,$i4);
  $i30.shadow := $xor.i32($i28.shadow,$i4.shadow);
  call {:cexpr "y20"} boogie_si_record_i32($i30);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 82, 11} true;
  assume {:verifier.code 0} true;
  $i31 := $xor.i32($i29,$i16);
  $i31.shadow := $xor.i32($i29.shadow,$i16.shadow);
  call {:cexpr "y6"} boogie_si_record_i32($i31);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 83, 12} true;
  assume {:verifier.code 0} true;
  $i32 := $xor.i32($i29,$i21);
  $i32.shadow := $xor.i32($i29.shadow,$i21.shadow);
  call {:cexpr "y10"} boogie_si_record_i32($i32);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 84, 12} true;
  assume {:verifier.code 0} true;
  $i33 := $xor.i32($i30,$i19);
  $i33.shadow := $xor.i32($i30.shadow,$i19.shadow);
  call {:cexpr "y11"} boogie_si_record_i32($i33);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 85, 10} true;
  assume {:verifier.code 0} true;
  $i34 := $xor.i32($i16,$i33);
  $i34.shadow := $xor.i32($i16.shadow,$i33.shadow);
  call {:cexpr "y7"} boogie_si_record_i32($i34);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 86, 12} true;
  assume {:verifier.code 0} true;
  $i35 := $xor.i32($i32,$i33);
  $i35.shadow := $xor.i32($i32.shadow,$i33.shadow);
  call {:cexpr "y17"} boogie_si_record_i32($i35);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 87, 12} true;
  assume {:verifier.code 0} true;
  $i36 := $xor.i32($i32,$i20);
  $i36.shadow := $xor.i32($i32.shadow,$i20.shadow);
  call {:cexpr "y19"} boogie_si_record_i32($i36);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 88, 11} true;
  assume {:verifier.code 0} true;
  $i37 := $xor.i32($i21,$i33);
  $i37.shadow := $xor.i32($i21.shadow,$i33.shadow);
  call {:cexpr "y16"} boogie_si_record_i32($i37);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 89, 12} true;
  assume {:verifier.code 0} true;
  $i38 := $xor.i32($i18,$i37);
  $i38.shadow := $xor.i32($i18.shadow,$i37.shadow);
  call {:cexpr "y21"} boogie_si_record_i32($i38);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 90, 11} true;
  assume {:verifier.code 0} true;
  $i39 := $xor.i32($i2,$i37);
  $i39.shadow := $xor.i32($i2.shadow,$i37.shadow);
  call {:cexpr "y18"} boogie_si_record_i32($i39);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 95, 11} true;
  assume {:verifier.code 0} true;
  $i40 := $and.i32($i24,$i29);
  $i40.shadow := $and.i32($i24.shadow,$i29.shadow);
  call {:cexpr "t2"} boogie_si_record_i32($i40);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 96, 10} true;
  assume {:verifier.code 0} true;
  $i41 := $and.i32($i27,$i31);
  $i41.shadow := $and.i32($i27.shadow,$i31.shadow);
  call {:cexpr "t3"} boogie_si_record_i32($i41);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 97, 10} true;
  assume {:verifier.code 0} true;
  $i42 := $xor.i32($i41,$i40);
  $i42.shadow := $xor.i32($i41.shadow,$i40.shadow);
  call {:cexpr "t4"} boogie_si_record_i32($i42);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 98, 10} true;
  assume {:verifier.code 0} true;
  $i43 := $and.i32($i23,$i16);
  $i43.shadow := $and.i32($i23.shadow,$i16.shadow);
  call {:cexpr "t5"} boogie_si_record_i32($i43);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 99, 10} true;
  assume {:verifier.code 0} true;
  $i44 := $xor.i32($i43,$i40);
  $i44.shadow := $xor.i32($i43.shadow,$i40.shadow);
  call {:cexpr "t6"} boogie_si_record_i32($i44);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 100, 11} true;
  assume {:verifier.code 0} true;
  $i45 := $and.i32($i18,$i37);
  $i45.shadow := $and.i32($i18.shadow,$i37.shadow);
  call {:cexpr "t7"} boogie_si_record_i32($i45);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 101, 10} true;
  assume {:verifier.code 0} true;
  $i46 := $and.i32($i26,$i22);
  $i46.shadow := $and.i32($i26.shadow,$i22.shadow);
  call {:cexpr "t8"} boogie_si_record_i32($i46);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 102, 10} true;
  assume {:verifier.code 0} true;
  $i47 := $xor.i32($i46,$i45);
  $i47.shadow := $xor.i32($i46.shadow,$i45.shadow);
  call {:cexpr "t9"} boogie_si_record_i32($i47);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 103, 11} true;
  assume {:verifier.code 0} true;
  $i48 := $and.i32($i25,$i34);
  $i48.shadow := $and.i32($i25.shadow,$i34.shadow);
  call {:cexpr "t10"} boogie_si_record_i32($i48);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 104, 12} true;
  assume {:verifier.code 0} true;
  $i49 := $xor.i32($i48,$i45);
  $i49.shadow := $xor.i32($i48.shadow,$i45.shadow);
  call {:cexpr "t11"} boogie_si_record_i32($i49);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 105, 11} true;
  assume {:verifier.code 0} true;
  $i50 := $and.i32($i19,$i33);
  $i50.shadow := $and.i32($i19.shadow,$i33.shadow);
  call {:cexpr "t12"} boogie_si_record_i32($i50);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 106, 12} true;
  assume {:verifier.code 0} true;
  $i51 := $and.i32($i17,$i35);
  $i51.shadow := $and.i32($i17.shadow,$i35.shadow);
  call {:cexpr "t13"} boogie_si_record_i32($i51);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 107, 12} true;
  assume {:verifier.code 0} true;
  $i52 := $xor.i32($i51,$i50);
  $i52.shadow := $xor.i32($i51.shadow,$i50.shadow);
  call {:cexpr "t14"} boogie_si_record_i32($i52);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 108, 11} true;
  assume {:verifier.code 0} true;
  $i53 := $and.i32($i20,$i32);
  $i53.shadow := $and.i32($i20.shadow,$i32.shadow);
  call {:cexpr "t15"} boogie_si_record_i32($i53);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 109, 12} true;
  assume {:verifier.code 0} true;
  $i54 := $xor.i32($i53,$i50);
  $i54.shadow := $xor.i32($i53.shadow,$i50.shadow);
  call {:cexpr "t16"} boogie_si_record_i32($i54);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 110, 11} true;
  assume {:verifier.code 0} true;
  $i55 := $xor.i32($i42,$i52);
  $i55.shadow := $xor.i32($i42.shadow,$i52.shadow);
  call {:cexpr "t17"} boogie_si_record_i32($i55);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 111, 11} true;
  assume {:verifier.code 0} true;
  $i56 := $xor.i32($i44,$i54);
  $i56.shadow := $xor.i32($i44.shadow,$i54.shadow);
  call {:cexpr "t18"} boogie_si_record_i32($i56);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 112, 11} true;
  assume {:verifier.code 0} true;
  $i57 := $xor.i32($i47,$i52);
  $i57.shadow := $xor.i32($i47.shadow,$i52.shadow);
  call {:cexpr "t19"} boogie_si_record_i32($i57);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 113, 12} true;
  assume {:verifier.code 0} true;
  $i58 := $xor.i32($i49,$i54);
  $i58.shadow := $xor.i32($i49.shadow,$i54.shadow);
  call {:cexpr "t20"} boogie_si_record_i32($i58);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 114, 12} true;
  assume {:verifier.code 0} true;
  $i59 := $xor.i32($i55,$i30);
  $i59.shadow := $xor.i32($i55.shadow,$i30.shadow);
  call {:cexpr "t21"} boogie_si_record_i32($i59);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 115, 12} true;
  assume {:verifier.code 0} true;
  $i60 := $xor.i32($i56,$i36);
  $i60.shadow := $xor.i32($i56.shadow,$i36.shadow);
  call {:cexpr "t22"} boogie_si_record_i32($i60);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 116, 12} true;
  assume {:verifier.code 0} true;
  $i61 := $xor.i32($i57,$i38);
  $i61.shadow := $xor.i32($i57.shadow,$i38.shadow);
  call {:cexpr "t23"} boogie_si_record_i32($i61);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 117, 12} true;
  assume {:verifier.code 0} true;
  $i62 := $xor.i32($i58,$i39);
  $i62.shadow := $xor.i32($i58.shadow,$i39.shadow);
  call {:cexpr "t24"} boogie_si_record_i32($i62);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 119, 12} true;
  assume {:verifier.code 0} true;
  $i63 := $xor.i32($i59,$i60);
  $i63.shadow := $xor.i32($i59.shadow,$i60.shadow);
  call {:cexpr "t25"} boogie_si_record_i32($i63);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 120, 12} true;
  assume {:verifier.code 0} true;
  $i64 := $and.i32($i59,$i61);
  $i64.shadow := $and.i32($i59.shadow,$i61.shadow);
  call {:cexpr "t26"} boogie_si_record_i32($i64);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 121, 12} true;
  assume {:verifier.code 0} true;
  $i65 := $xor.i32($i62,$i64);
  $i65.shadow := $xor.i32($i62.shadow,$i64.shadow);
  call {:cexpr "t27"} boogie_si_record_i32($i65);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 122, 12} true;
  assume {:verifier.code 0} true;
  $i66 := $and.i32($i63,$i65);
  $i66.shadow := $and.i32($i63.shadow,$i65.shadow);
  call {:cexpr "t28"} boogie_si_record_i32($i66);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 123, 12} true;
  assume {:verifier.code 0} true;
  $i67 := $xor.i32($i66,$i60);
  $i67.shadow := $xor.i32($i66.shadow,$i60.shadow);
  call {:cexpr "t29"} boogie_si_record_i32($i67);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 124, 12} true;
  assume {:verifier.code 0} true;
  $i68 := $xor.i32($i61,$i62);
  $i68.shadow := $xor.i32($i61.shadow,$i62.shadow);
  call {:cexpr "t30"} boogie_si_record_i32($i68);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 125, 12} true;
  assume {:verifier.code 0} true;
  $i69 := $xor.i32($i60,$i64);
  $i69.shadow := $xor.i32($i60.shadow,$i64.shadow);
  call {:cexpr "t31"} boogie_si_record_i32($i69);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 126, 12} true;
  assume {:verifier.code 0} true;
  $i70 := $and.i32($i69,$i68);
  $i70.shadow := $and.i32($i69.shadow,$i68.shadow);
  call {:cexpr "t32"} boogie_si_record_i32($i70);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 127, 12} true;
  assume {:verifier.code 0} true;
  $i71 := $xor.i32($i70,$i62);
  $i71.shadow := $xor.i32($i70.shadow,$i62.shadow);
  call {:cexpr "t33"} boogie_si_record_i32($i71);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 128, 12} true;
  assume {:verifier.code 0} true;
  $i72 := $xor.i32($i61,$i71);
  $i72.shadow := $xor.i32($i61.shadow,$i71.shadow);
  call {:cexpr "t34"} boogie_si_record_i32($i72);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 129, 12} true;
  assume {:verifier.code 0} true;
  $i73 := $xor.i32($i65,$i71);
  $i73.shadow := $xor.i32($i65.shadow,$i71.shadow);
  call {:cexpr "t35"} boogie_si_record_i32($i73);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 130, 12} true;
  assume {:verifier.code 0} true;
  $i74 := $and.i32($i62,$i73);
  $i74.shadow := $and.i32($i62.shadow,$i73.shadow);
  call {:cexpr "t36"} boogie_si_record_i32($i74);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 131, 12} true;
  assume {:verifier.code 0} true;
  $i75 := $xor.i32($i74,$i72);
  $i75.shadow := $xor.i32($i74.shadow,$i72.shadow);
  call {:cexpr "t37"} boogie_si_record_i32($i75);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 132, 12} true;
  assume {:verifier.code 0} true;
  $i76 := $xor.i32($i65,$i74);
  $i76.shadow := $xor.i32($i65.shadow,$i74.shadow);
  call {:cexpr "t38"} boogie_si_record_i32($i76);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 133, 12} true;
  assume {:verifier.code 0} true;
  $i77 := $and.i32($i67,$i76);
  $i77.shadow := $and.i32($i67.shadow,$i76.shadow);
  call {:cexpr "t39"} boogie_si_record_i32($i77);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 134, 12} true;
  assume {:verifier.code 0} true;
  $i78 := $xor.i32($i63,$i77);
  $i78.shadow := $xor.i32($i63.shadow,$i77.shadow);
  call {:cexpr "t40"} boogie_si_record_i32($i78);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 136, 12} true;
  assume {:verifier.code 0} true;
  $i79 := $xor.i32($i78,$i75);
  $i79.shadow := $xor.i32($i78.shadow,$i75.shadow);
  call {:cexpr "t41"} boogie_si_record_i32($i79);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 137, 12} true;
  assume {:verifier.code 0} true;
  $i80 := $xor.i32($i67,$i71);
  $i80.shadow := $xor.i32($i67.shadow,$i71.shadow);
  call {:cexpr "t42"} boogie_si_record_i32($i80);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 138, 12} true;
  assume {:verifier.code 0} true;
  $i81 := $xor.i32($i67,$i78);
  $i81.shadow := $xor.i32($i67.shadow,$i78.shadow);
  call {:cexpr "t43"} boogie_si_record_i32($i81);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 139, 12} true;
  assume {:verifier.code 0} true;
  $i82 := $xor.i32($i71,$i75);
  $i82.shadow := $xor.i32($i71.shadow,$i75.shadow);
  call {:cexpr "t44"} boogie_si_record_i32($i82);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 140, 12} true;
  assume {:verifier.code 0} true;
  $i83 := $xor.i32($i80,$i79);
  $i83.shadow := $xor.i32($i80.shadow,$i79.shadow);
  call {:cexpr "t45"} boogie_si_record_i32($i83);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 141, 11} true;
  assume {:verifier.code 0} true;
  $i84 := $and.i32($i82,$i29);
  $i84.shadow := $and.i32($i82.shadow,$i29.shadow);
  call {:cexpr "z0"} boogie_si_record_i32($i84);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 142, 11} true;
  assume {:verifier.code 0} true;
  $i85 := $and.i32($i75,$i31);
  $i85.shadow := $and.i32($i75.shadow,$i31.shadow);
  call {:cexpr "z1"} boogie_si_record_i32($i85);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 143, 11} true;
  assume {:verifier.code 0} true;
  $i86 := $and.i32($i71,$i16);
  $i86.shadow := $and.i32($i71.shadow,$i16.shadow);
  call {:cexpr "z2"} boogie_si_record_i32($i86);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 144, 11} true;
  assume {:verifier.code 0} true;
  $i87 := $and.i32($i81,$i37);
  $i87.shadow := $and.i32($i81.shadow,$i37.shadow);
  call {:cexpr "z3"} boogie_si_record_i32($i87);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 145, 11} true;
  assume {:verifier.code 0} true;
  $i88 := $and.i32($i78,$i22);
  $i88.shadow := $and.i32($i78.shadow,$i22.shadow);
  call {:cexpr "z4"} boogie_si_record_i32($i88);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 146, 11} true;
  assume {:verifier.code 0} true;
  $i89 := $and.i32($i67,$i34);
  $i89.shadow := $and.i32($i67.shadow,$i34.shadow);
  call {:cexpr "z5"} boogie_si_record_i32($i89);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 147, 11} true;
  assume {:verifier.code 0} true;
  $i90 := $and.i32($i80,$i33);
  $i90.shadow := $and.i32($i80.shadow,$i33.shadow);
  call {:cexpr "z6"} boogie_si_record_i32($i90);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 148, 11} true;
  assume {:verifier.code 0} true;
  $i91 := $and.i32($i83,$i35);
  $i91.shadow := $and.i32($i83.shadow,$i35.shadow);
  call {:cexpr "z7"} boogie_si_record_i32($i91);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 149, 11} true;
  assume {:verifier.code 0} true;
  $i92 := $and.i32($i79,$i32);
  $i92.shadow := $and.i32($i79.shadow,$i32.shadow);
  call {:cexpr "z8"} boogie_si_record_i32($i92);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 150, 11} true;
  assume {:verifier.code 0} true;
  $i93 := $and.i32($i82,$i24);
  $i93.shadow := $and.i32($i82.shadow,$i24.shadow);
  call {:cexpr "z9"} boogie_si_record_i32($i93);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 151, 12} true;
  assume {:verifier.code 0} true;
  $i94 := $and.i32($i75,$i27);
  $i94.shadow := $and.i32($i75.shadow,$i27.shadow);
  call {:cexpr "z10"} boogie_si_record_i32($i94);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 152, 12} true;
  assume {:verifier.code 0} true;
  $i95 := $and.i32($i71,$i23);
  $i95.shadow := $and.i32($i71.shadow,$i23.shadow);
  call {:cexpr "z11"} boogie_si_record_i32($i95);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 153, 12} true;
  assume {:verifier.code 0} true;
  $i96 := $and.i32($i81,$i18);
  $i96.shadow := $and.i32($i81.shadow,$i18.shadow);
  call {:cexpr "z12"} boogie_si_record_i32($i96);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 154, 12} true;
  assume {:verifier.code 0} true;
  $i97 := $and.i32($i78,$i26);
  $i97.shadow := $and.i32($i78.shadow,$i26.shadow);
  call {:cexpr "z13"} boogie_si_record_i32($i97);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 155, 12} true;
  assume {:verifier.code 0} true;
  $i98 := $and.i32($i67,$i25);
  $i98.shadow := $and.i32($i67.shadow,$i25.shadow);
  call {:cexpr "z14"} boogie_si_record_i32($i98);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 156, 12} true;
  assume {:verifier.code 0} true;
  $i99 := $and.i32($i80,$i19);
  $i99.shadow := $and.i32($i80.shadow,$i19.shadow);
  call {:cexpr "z15"} boogie_si_record_i32($i99);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 157, 12} true;
  assume {:verifier.code 0} true;
  $i100 := $and.i32($i83,$i17);
  $i100.shadow := $and.i32($i83.shadow,$i17.shadow);
  call {:cexpr "z16"} boogie_si_record_i32($i100);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 158, 12} true;
  assume {:verifier.code 0} true;
  $i101 := $and.i32($i79,$i20);
  $i101.shadow := $and.i32($i79.shadow,$i20.shadow);
  call {:cexpr "z17"} boogie_si_record_i32($i101);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 163, 12} true;
  assume {:verifier.code 0} true;
  $i102 := $xor.i32($i99,$i100);
  $i102.shadow := $xor.i32($i99.shadow,$i100.shadow);
  call {:cexpr "t46"} boogie_si_record_i32($i102);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 164, 12} true;
  assume {:verifier.code 0} true;
  $i103 := $xor.i32($i94,$i95);
  $i103.shadow := $xor.i32($i94.shadow,$i95.shadow);
  call {:cexpr "t47"} boogie_si_record_i32($i103);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 165, 11} true;
  assume {:verifier.code 0} true;
  $i104 := $xor.i32($i89,$i97);
  $i104.shadow := $xor.i32($i89.shadow,$i97.shadow);
  call {:cexpr "t48"} boogie_si_record_i32($i104);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 166, 11} true;
  assume {:verifier.code 0} true;
  $i105 := $xor.i32($i93,$i94);
  $i105.shadow := $xor.i32($i93.shadow,$i94.shadow);
  call {:cexpr "t49"} boogie_si_record_i32($i105);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 167, 11} true;
  assume {:verifier.code 0} true;
  $i106 := $xor.i32($i86,$i96);
  $i106.shadow := $xor.i32($i86.shadow,$i96.shadow);
  call {:cexpr "t50"} boogie_si_record_i32($i106);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 168, 11} true;
  assume {:verifier.code 0} true;
  $i107 := $xor.i32($i86,$i89);
  $i107.shadow := $xor.i32($i86.shadow,$i89.shadow);
  call {:cexpr "t51"} boogie_si_record_i32($i107);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 169, 11} true;
  assume {:verifier.code 0} true;
  $i108 := $xor.i32($i91,$i92);
  $i108.shadow := $xor.i32($i91.shadow,$i92.shadow);
  call {:cexpr "t52"} boogie_si_record_i32($i108);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 170, 11} true;
  assume {:verifier.code 0} true;
  $i109 := $xor.i32($i84,$i87);
  $i109.shadow := $xor.i32($i84.shadow,$i87.shadow);
  call {:cexpr "t53"} boogie_si_record_i32($i109);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 171, 11} true;
  assume {:verifier.code 0} true;
  $i110 := $xor.i32($i90,$i91);
  $i110.shadow := $xor.i32($i90.shadow,$i91.shadow);
  call {:cexpr "t54"} boogie_si_record_i32($i110);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 172, 12} true;
  assume {:verifier.code 0} true;
  $i111 := $xor.i32($i100,$i101);
  $i111.shadow := $xor.i32($i100.shadow,$i101.shadow);
  call {:cexpr "t55"} boogie_si_record_i32($i111);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 173, 12} true;
  assume {:verifier.code 0} true;
  $i112 := $xor.i32($i96,$i104);
  $i112.shadow := $xor.i32($i96.shadow,$i104.shadow);
  call {:cexpr "t56"} boogie_si_record_i32($i112);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 174, 12} true;
  assume {:verifier.code 0} true;
  $i113 := $xor.i32($i106,$i109);
  $i113.shadow := $xor.i32($i106.shadow,$i109.shadow);
  call {:cexpr "t57"} boogie_si_record_i32($i113);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 175, 11} true;
  assume {:verifier.code 0} true;
  $i114 := $xor.i32($i88,$i102);
  $i114.shadow := $xor.i32($i88.shadow,$i102.shadow);
  call {:cexpr "t58"} boogie_si_record_i32($i114);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 176, 11} true;
  assume {:verifier.code 0} true;
  $i115 := $xor.i32($i87,$i110);
  $i115.shadow := $xor.i32($i87.shadow,$i110.shadow);
  call {:cexpr "t59"} boogie_si_record_i32($i115);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 177, 12} true;
  assume {:verifier.code 0} true;
  $i116 := $xor.i32($i102,$i113);
  $i116.shadow := $xor.i32($i102.shadow,$i113.shadow);
  call {:cexpr "t60"} boogie_si_record_i32($i116);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 178, 12} true;
  assume {:verifier.code 0} true;
  $i117 := $xor.i32($i98,$i113);
  $i117.shadow := $xor.i32($i98.shadow,$i113.shadow);
  call {:cexpr "t61"} boogie_si_record_i32($i117);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 179, 12} true;
  assume {:verifier.code 0} true;
  $i118 := $xor.i32($i108,$i114);
  $i118.shadow := $xor.i32($i108.shadow,$i114.shadow);
  call {:cexpr "t62"} boogie_si_record_i32($i118);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 180, 12} true;
  assume {:verifier.code 0} true;
  $i119 := $xor.i32($i105,$i114);
  $i119.shadow := $xor.i32($i105.shadow,$i114.shadow);
  call {:cexpr "t63"} boogie_si_record_i32($i119);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 181, 11} true;
  assume {:verifier.code 0} true;
  $i120 := $xor.i32($i88,$i115);
  $i120.shadow := $xor.i32($i88.shadow,$i115.shadow);
  call {:cexpr "t64"} boogie_si_record_i32($i120);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 182, 12} true;
  assume {:verifier.code 0} true;
  $i121 := $xor.i32($i117,$i118);
  $i121.shadow := $xor.i32($i117.shadow,$i118.shadow);
  call {:cexpr "t65"} boogie_si_record_i32($i121);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 183, 11} true;
  assume {:verifier.code 0} true;
  $i122 := $xor.i32($i85,$i119);
  $i122.shadow := $xor.i32($i85.shadow,$i119.shadow);
  call {:cexpr "t66"} boogie_si_record_i32($i122);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 184, 11} true;
  assume {:verifier.code 0} true;
  $i123 := $xor.i32($i115,$i119);
  $i123.shadow := $xor.i32($i115.shadow,$i119.shadow);
  call {:cexpr "s0"} boogie_si_record_i32($i123);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 185, 13} true;
  assume {:verifier.code 0} true;
  $i124 := $xor.i32($i118,$sub.i32(0,1));
  $i124.shadow := $xor.i32($i118.shadow,$sub.i32(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 185, 11} true;
  assume {:verifier.code 0} true;
  $i125 := $xor.i32($i112,$i124);
  $i125.shadow := $xor.i32($i112.shadow,$i124.shadow);
  call {:cexpr "s6"} boogie_si_record_i32($i125);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 186, 13} true;
  assume {:verifier.code 0} true;
  $i126 := $xor.i32($i116,$sub.i32(0,1));
  $i126.shadow := $xor.i32($i116.shadow,$sub.i32(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 186, 11} true;
  assume {:verifier.code 0} true;
  $i127 := $xor.i32($i104,$i126);
  $i127.shadow := $xor.i32($i104.shadow,$i126.shadow);
  call {:cexpr "s7"} boogie_si_record_i32($i127);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 187, 12} true;
  assume {:verifier.code 0} true;
  $i128 := $xor.i32($i120,$i121);
  $i128.shadow := $xor.i32($i120.shadow,$i121.shadow);
  call {:cexpr "t67"} boogie_si_record_i32($i128);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 188, 11} true;
  assume {:verifier.code 0} true;
  $i129 := $xor.i32($i109,$i122);
  $i129.shadow := $xor.i32($i109.shadow,$i122.shadow);
  call {:cexpr "s3"} boogie_si_record_i32($i129);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 189, 11} true;
  assume {:verifier.code 0} true;
  $i130 := $xor.i32($i107,$i122);
  $i130.shadow := $xor.i32($i107.shadow,$i122.shadow);
  call {:cexpr "s4"} boogie_si_record_i32($i130);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 190, 11} true;
  assume {:verifier.code 0} true;
  $i131 := $xor.i32($i103,$i121);
  $i131.shadow := $xor.i32($i103.shadow,$i121.shadow);
  call {:cexpr "s5"} boogie_si_record_i32($i131);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 191, 13} true;
  assume {:verifier.code 0} true;
  $i132 := $xor.i32($i129,$sub.i32(0,1));
  $i132.shadow := $xor.i32($i129.shadow,$sub.i32(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 191, 11} true;
  assume {:verifier.code 0} true;
  $i133 := $xor.i32($i120,$i132);
  $i133.shadow := $xor.i32($i120.shadow,$i132.shadow);
  call {:cexpr "s1"} boogie_si_record_i32($i133);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 192, 13} true;
  assume {:verifier.code 0} true;
  $i134 := $xor.i32($i128,$sub.i32(0,1));
  $i134.shadow := $xor.i32($i128.shadow,$sub.i32(0,1));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 192, 11} true;
  assume {:verifier.code 0} true;
  $i135 := $xor.i32($i111,$i134);
  $i135.shadow := $xor.i32($i111.shadow,$i134.shadow);
  call {:cexpr "s2"} boogie_si_record_i32($i135);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 194, 2} true;
  assume {:verifier.code 0} true;
  $p136 := $add.ref($p0,$mul.ref(7,4));
  $p136.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 194, 7} true;
  assume {:verifier.code 0} true;
  assert ($p136 == $p136.shadow);
  $M.0 := $store.i32($M.0,$p136,$i123);
  $M.0.shadow := $store.i32($M.0.shadow,$p136.shadow,$i123.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 195, 2} true;
  assume {:verifier.code 0} true;
  $p137 := $add.ref($p0,$mul.ref(6,4));
  $p137.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 195, 7} true;
  assume {:verifier.code 0} true;
  assert ($p137 == $p137.shadow);
  $M.0 := $store.i32($M.0,$p137,$i133);
  $M.0.shadow := $store.i32($M.0.shadow,$p137.shadow,$i133.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 196, 2} true;
  assume {:verifier.code 0} true;
  $p138 := $add.ref($p0,$mul.ref(5,4));
  $p138.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 196, 7} true;
  assume {:verifier.code 0} true;
  assert ($p138 == $p138.shadow);
  $M.0 := $store.i32($M.0,$p138,$i135);
  $M.0.shadow := $store.i32($M.0.shadow,$p138.shadow,$i135.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 197, 2} true;
  assume {:verifier.code 0} true;
  $p139 := $add.ref($p0,$mul.ref(4,4));
  $p139.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 197, 7} true;
  assume {:verifier.code 0} true;
  assert ($p139 == $p139.shadow);
  $M.0 := $store.i32($M.0,$p139,$i129);
  $M.0.shadow := $store.i32($M.0.shadow,$p139.shadow,$i129.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 198, 2} true;
  assume {:verifier.code 0} true;
  $p140 := $add.ref($p0,$mul.ref(3,4));
  $p140.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 198, 7} true;
  assume {:verifier.code 0} true;
  assert ($p140 == $p140.shadow);
  $M.0 := $store.i32($M.0,$p140,$i130);
  $M.0.shadow := $store.i32($M.0.shadow,$p140.shadow,$i130.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 199, 2} true;
  assume {:verifier.code 0} true;
  $p141 := $add.ref($p0,$mul.ref(2,4));
  $p141.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 199, 7} true;
  assume {:verifier.code 0} true;
  assert ($p141 == $p141.shadow);
  $M.0 := $store.i32($M.0,$p141,$i131);
  $M.0.shadow := $store.i32($M.0.shadow,$p141.shadow,$i131.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 200, 2} true;
  assume {:verifier.code 0} true;
  $p142 := $add.ref($p0,$mul.ref(1,4));
  $p142.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 200, 7} true;
  assume {:verifier.code 0} true;
  assert ($p142 == $p142.shadow);
  $M.0 := $store.i32($M.0,$p142,$i125);
  $M.0.shadow := $store.i32($M.0.shadow,$p142.shadow,$i125.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 201, 2} true;
  assume {:verifier.code 0} true;
  $p143 := $add.ref($p0,$mul.ref(0,4));
  $p143.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 201, 7} true;
  assume {:verifier.code 0} true;
  assert ($p143 == $p143.shadow);
  $M.0 := $store.i32($M.0,$p143,$i127);
  $M.0.shadow := $store.i32($M.0.shadow,$p143.shadow,$i127.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 202, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const br_aes_ct_bitslice_invSbox: ref;
axiom (br_aes_ct_bitslice_invSbox == $sub.ref(0,3096));
procedure {:inline 1} br_aes_ct_bitslice_invSbox($p0: ref, $p0.shadow: ref)
modifies $M.0, $exn;
{
  var $p1: ref;
  var $p1.shadow: ref;
  ...
  var $p88.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 51, 8} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 51, 8} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($p0,$mul.ref(0,4));
  $p1.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 51, 8} true;
  assume {:verifier.code 0} true;
  assert ($p1 == $p1.shadow);
  $i2 := $load.i32($M.0,$p1);
  $i2.shadow := $load.i32($M.0.shadow,$p1.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 51, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $xor.i32($i2,$sub.i32(0,1));
  $i3.shadow := $xor.i32($i2.shadow,$sub.i32(0,1));
  call {:cexpr "q0"} boogie_si_record_i32($i3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 52, 8} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p0,$mul.ref(1,4));
  $p4.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 52, 8} true;
  assume {:verifier.code 0} true;
  assert ($p4 == $p4.shadow);
  $i5 := $load.i32($M.0,$p4);
  $i5.shadow := $load.i32($M.0.shadow,$p4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 52, 7} true;
  assume {:verifier.code 0} true;
  $i6 := $xor.i32($i5,$sub.i32(0,1));
  $i6.shadow := $xor.i32($i5.shadow,$sub.i32(0,1));
  call {:cexpr "q1"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 53, 7} true;
  assume {:verifier.code 0} true;
  ...
  $i8 := $load.i32($M.0,$p7);
  $i8.shadow := $load.i32($M.0.shadow,$p7.shadow);
  call {:cexpr "q2"} boogie_si_record_i32($i8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 54, 7} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(3,4));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 54, 7} true;
  ...
  $i10 := $load.i32($M.0,$p9);
  $i10.shadow := $load.i32($M.0.shadow,$p9.shadow);
  call {:cexpr "q3"} boogie_si_record_i32($i10);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 55, 7} true;
  assume {:verifier.code 0} true;
  ...
  $i12 := $load.i32($M.0,$p11);
  $i12.shadow := $load.i32($M.0.shadow,$p11.shadow);
  call {:cexpr "q4"} boogie_si_record_i32($i12);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 56, 8} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p0,$mul.ref(5,4));
  $p13.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 56, 8} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  $i14 := $load.i32($M.0,$p13);
  $i14.shadow := $load.i32($M.0.shadow,$p13.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 56, 7} true;
  assume {:verifier.code 0} true;
  $i15 := $xor.i32($i14,$sub.i32(0,1));
  $i15.shadow := $xor.i32($i14.shadow,$sub.i32(0,1));
  call {:cexpr "q5"} boogie_si_record_i32($i15);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 57, 8} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p0,$mul.ref(6,4));
  $p16.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 57, 8} true;
  assume {:verifier.code 0} true;
  assert ($p16 == $p16.shadow);
  $i17 := $load.i32($M.0,$p16);
  $i17.shadow := $load.i32($M.0.shadow,$p16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 57, 7} true;
  assume {:verifier.code 0} true;
  $i18 := $xor.i32($i17,$sub.i32(0,1));
  $i18.shadow := $xor.i32($i17.shadow,$sub.i32(0,1));
  call {:cexpr "q6"} boogie_si_record_i32($i18);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 58, 7} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($p0,$mul.ref(7,4));
  $p19.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 58, 7} true;
  assume {:verifier.code 0} true;
  assert ($p19 == $p19.shadow);
  $i20 := $load.i32($M.0,$p19);
  $i20.shadow := $load.i32($M.0.shadow,$p19.shadow);
  call {:cexpr "q7"} boogie_si_record_i32($i20);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 59, 12} true;
  assume {:verifier.code 0} true;
  $i21 := $xor.i32($i6,$i12);
  $i21.shadow := $xor.i32($i6.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 59, 17} true;
  assume {:verifier.code 0} true;
  $i22 := $xor.i32($i21,$i18);
  $i22.shadow := $xor.i32($i21.shadow,$i18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 59, 2} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p0,$mul.ref(7,4));
  $p23.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 59, 7} true;
  assume {:verifier.code 0} true;
  assert ($p23 == $p23.shadow);
  $M.0 := $store.i32($M.0,$p23,$i22);
  $M.0.shadow := $store.i32($M.0.shadow,$p23.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 60, 12} true;
  assume {:verifier.code 0} true;
  $i24 := $xor.i32($i3,$i10);
  $i24.shadow := $xor.i32($i3.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 60, 17} true;
  assume {:verifier.code 0} true;
  $i25 := $xor.i32($i24,$i15);
  $i25.shadow := $xor.i32($i24.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 60, 2} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p0,$mul.ref(6,4));
  $p26.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 60, 7} true;
  assume {:verifier.code 0} true;
  assert ($p26 == $p26.shadow);
  $M.0 := $store.i32($M.0,$p26,$i25);
  $M.0.shadow := $store.i32($M.0.shadow,$p26.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 61, 12} true;
  assume {:verifier.code 0} true;
  $i27 := $xor.i32($i20,$i8);
  $i27.shadow := $xor.i32($i20.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 61, 17} true;
  assume {:verifier.code 0} true;
  $i28 := $xor.i32($i27,$i12);
  $i28.shadow := $xor.i32($i27.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 61, 2} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p0,$mul.ref(5,4));
  $p29.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 61, 7} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $M.0 := $store.i32($M.0,$p29,$i28);
  $M.0.shadow := $store.i32($M.0.shadow,$p29.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 62, 12} true;
  assume {:verifier.code 0} true;
  $i30 := $xor.i32($i18,$i6);
  $i30.shadow := $xor.i32($i18.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 62, 17} true;
  assume {:verifier.code 0} true;
  $i31 := $xor.i32($i30,$i10);
  $i31.shadow := $xor.i32($i30.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 62, 2} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($p0,$mul.ref(4,4));
  $p32.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 62, 7} true;
  assume {:verifier.code 0} true;
  assert ($p32 == $p32.shadow);
  $M.0 := $store.i32($M.0,$p32,$i31);
  $M.0.shadow := $store.i32($M.0.shadow,$p32.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 63, 12} true;
  assume {:verifier.code 0} true;
  $i33 := $xor.i32($i15,$i3);
  $i33.shadow := $xor.i32($i15.shadow,$i3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 63, 17} true;
  assume {:verifier.code 0} true;
  $i34 := $xor.i32($i33,$i8);
  $i34.shadow := $xor.i32($i33.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 63, 2} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($p0,$mul.ref(3,4));
  $p35.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 63, 7} true;
  assume {:verifier.code 0} true;
  assert ($p35 == $p35.shadow);
  $M.0 := $store.i32($M.0,$p35,$i34);
  $M.0.shadow := $store.i32($M.0.shadow,$p35.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 64, 12} true;
  assume {:verifier.code 0} true;
  $i36 := $xor.i32($i12,$i20);
  $i36.shadow := $xor.i32($i12.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 64, 17} true;
  assume {:verifier.code 0} true;
  $i37 := $xor.i32($i36,$i6);
  $i37.shadow := $xor.i32($i36.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 64, 2} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p0,$mul.ref(2,4));
  $p38.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 64, 7} true;
  assume {:verifier.code 0} true;
  assert ($p38 == $p38.shadow);
  $M.0 := $store.i32($M.0,$p38,$i37);
  $M.0.shadow := $store.i32($M.0.shadow,$p38.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 65, 12} true;
  assume {:verifier.code 0} true;
  $i39 := $xor.i32($i10,$i18);
  $i39.shadow := $xor.i32($i10.shadow,$i18.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 65, 17} true;
  assume {:verifier.code 0} true;
  $i40 := $xor.i32($i39,$i3);
  $i40.shadow := $xor.i32($i39.shadow,$i3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 65, 2} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($p0,$mul.ref(1,4));
  $p41.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 65, 7} true;
  assume {:verifier.code 0} true;
  assert ($p41 == $p41.shadow);
  $M.0 := $store.i32($M.0,$p41,$i40);
  $M.0.shadow := $store.i32($M.0.shadow,$p41.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 66, 12} true;
  assume {:verifier.code 0} true;
  $i42 := $xor.i32($i8,$i15);
  $i42.shadow := $xor.i32($i8.shadow,$i15.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 66, 17} true;
  assume {:verifier.code 0} true;
  $i43 := $xor.i32($i42,$i20);
  $i43.shadow := $xor.i32($i42.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 66, 2} true;
  assume {:verifier.code 0} true;
  $p44 := $add.ref($p0,$mul.ref(0,4));
  $p44.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 66, 7} true;
  assume {:verifier.code 0} true;
  assert ($p44 == $p44.shadow);
  $M.0 := $store.i32($M.0,$p44,$i43);
  $M.0.shadow := $store.i32($M.0.shadow,$p44.shadow,$i43.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 68, 2} true;
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_Sbox($p0, $p0.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 70, 8} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($p0,$mul.ref(0,4));
  $p45.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 70, 8} true;
  assume {:verifier.code 0} true;
  assert ($p45 == $p45.shadow);
  $i46 := $load.i32($M.0,$p45);
  $i46.shadow := $load.i32($M.0.shadow,$p45.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 70, 7} true;
  assume {:verifier.code 0} true;
  $i47 := $xor.i32($i46,$sub.i32(0,1));
  $i47.shadow := $xor.i32($i46.shadow,$sub.i32(0,1));
  call {:cexpr "q0"} boogie_si_record_i32($i47);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 71, 8} true;
  assume {:verifier.code 0} true;
  $p48 := $add.ref($p0,$mul.ref(1,4));
  $p48.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 71, 8} true;
  assume {:verifier.code 0} true;
  assert ($p48 == $p48.shadow);
  $i49 := $load.i32($M.0,$p48);
  $i49.shadow := $load.i32($M.0.shadow,$p48.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 71, 7} true;
  assume {:verifier.code 0} true;
  $i50 := $xor.i32($i49,$sub.i32(0,1));
  $i50.shadow := $xor.i32($i49.shadow,$sub.i32(0,1));
  call {:cexpr "q1"} boogie_si_record_i32($i50);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 72, 7} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($p0,$mul.ref(2,4));
  $p51.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 72, 7} true;
  assume {:verifier.code 0} true;
  assert ($p51 == $p51.shadow);
  $i52 := $load.i32($M.0,$p51);
  $i52.shadow := $load.i32($M.0.shadow,$p51.shadow);
  call {:cexpr "q2"} boogie_si_record_i32($i52);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 73, 7} true;
  assume {:verifier.code 0} true;
  ...
  $i54.shadow := $load.i32($M.0.shadow,$p53.shadow);
  call {:cexpr "q3"} boogie_si_record_i32($i54);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 74, 7} true;
  assume {:verifier.code 0} true;
  $p55 := $add.ref($p0,$mul.ref(4,4));
  $p55.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 74, 7} true;
  assume {:verifier.code 0} true;
  assert ($p55 == $p55.shadow);
  $i56 := $load.i32($M.0,$p55);
  $i56.shadow := $load.i32($M.0.shadow,$p55.shadow);
  call {:cexpr "q4"} boogie_si_record_i32($i56);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 75, 8} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($p0,$mul.ref(5,4));
  $p57.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 75, 8} true;
  assume {:verifier.code 0} true;
  assert ($p57 == $p57.shadow);
  $i58 := $load.i32($M.0,$p57);
  $i58.shadow := $load.i32($M.0.shadow,$p57.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 75, 7} true;
  assume {:verifier.code 0} true;
  $i59 := $xor.i32($i58,$sub.i32(0,1));
  $i59.shadow := $xor.i32($i58.shadow,$sub.i32(0,1));
  call {:cexpr "q5"} boogie_si_record_i32($i59);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 76, 8} true;
  assume {:verifier.code 0} true;
  $p60 := $add.ref($p0,$mul.ref(6,4));
  $p60.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 76, 8} true;
  assume {:verifier.code 0} true;
  assert ($p60 == $p60.shadow);
  $i61 := $load.i32($M.0,$p60);
  $i61.shadow := $load.i32($M.0.shadow,$p60.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 76, 7} true;
  assume {:verifier.code 0} true;
  $i62 := $xor.i32($i61,$sub.i32(0,1));
  $i62.shadow := $xor.i32($i61.shadow,$sub.i32(0,1));
  call {:cexpr "q6"} boogie_si_record_i32($i62);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 77, 7} true;
  assume {:verifier.code 0} true;
  $p63 := $add.ref($p0,$mul.ref(7,4));
  $p63.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 77, 7} true;
  assume {:verifier.code 0} true;
  assert ($p63 == $p63.shadow);
  $i64 := $load.i32($M.0,$p63);
  $i64.shadow := $load.i32($M.0.shadow,$p63.shadow);
  call {:cexpr "q7"} boogie_si_record_i32($i64);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 78, 12} true;
  assume {:verifier.code 0} true;
  $i65 := $xor.i32($i50,$i56);
  $i65.shadow := $xor.i32($i50.shadow,$i56.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 78, 17} true;
  assume {:verifier.code 0} true;
  $i66 := $xor.i32($i65,$i62);
  $i66.shadow := $xor.i32($i65.shadow,$i62.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 78, 2} true;
  assume {:verifier.code 0} true;
  $p67 := $add.ref($p0,$mul.ref(7,4));
  $p67.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 78, 7} true;
  assume {:verifier.code 0} true;
  assert ($p67 == $p67.shadow);
  $M.0 := $store.i32($M.0,$p67,$i66);
  $M.0.shadow := $store.i32($M.0.shadow,$p67.shadow,$i66.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 79, 12} true;
  assume {:verifier.code 0} true;
  $i68 := $xor.i32($i47,$i54);
  $i68.shadow := $xor.i32($i47.shadow,$i54.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 79, 17} true;
  assume {:verifier.code 0} true;
  $i69 := $xor.i32($i68,$i59);
  $i69.shadow := $xor.i32($i68.shadow,$i59.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 79, 2} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($p0,$mul.ref(6,4));
  $p70.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 79, 7} true;
  assume {:verifier.code 0} true;
  assert ($p70 == $p70.shadow);
  $M.0 := $store.i32($M.0,$p70,$i69);
  $M.0.shadow := $store.i32($M.0.shadow,$p70.shadow,$i69.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 80, 12} true;
  assume {:verifier.code 0} true;
  $i71 := $xor.i32($i64,$i52);
  $i71.shadow := $xor.i32($i64.shadow,$i52.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 80, 17} true;
  assume {:verifier.code 0} true;
  $i72 := $xor.i32($i71,$i56);
  $i72.shadow := $xor.i32($i71.shadow,$i56.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 80, 2} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($p0,$mul.ref(5,4));
  $p73.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 80, 7} true;
  assume {:verifier.code 0} true;
  assert ($p73 == $p73.shadow);
  $M.0 := $store.i32($M.0,$p73,$i72);
  $M.0.shadow := $store.i32($M.0.shadow,$p73.shadow,$i72.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 81, 12} true;
  assume {:verifier.code 0} true;
  $i74 := $xor.i32($i62,$i50);
  $i74.shadow := $xor.i32($i62.shadow,$i50.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 81, 17} true;
  assume {:verifier.code 0} true;
  $i75 := $xor.i32($i74,$i54);
  $i75.shadow := $xor.i32($i74.shadow,$i54.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 81, 2} true;
  assume {:verifier.code 0} true;
  $p76 := $add.ref($p0,$mul.ref(4,4));
  $p76.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 81, 7} true;
  assume {:verifier.code 0} true;
  assert ($p76 == $p76.shadow);
  $M.0 := $store.i32($M.0,$p76,$i75);
  $M.0.shadow := $store.i32($M.0.shadow,$p76.shadow,$i75.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 82, 12} true;
  assume {:verifier.code 0} true;
  $i77 := $xor.i32($i59,$i47);
  $i77.shadow := $xor.i32($i59.shadow,$i47.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 82, 17} true;
  assume {:verifier.code 0} true;
  $i78 := $xor.i32($i77,$i52);
  $i78.shadow := $xor.i32($i77.shadow,$i52.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 82, 2} true;
  assume {:verifier.code 0} true;
  $p79 := $add.ref($p0,$mul.ref(3,4));
  $p79.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 82, 7} true;
  assume {:verifier.code 0} true;
  assert ($p79 == $p79.shadow);
  $M.0 := $store.i32($M.0,$p79,$i78);
  $M.0.shadow := $store.i32($M.0.shadow,$p79.shadow,$i78.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 83, 12} true;
  assume {:verifier.code 0} true;
  $i80 := $xor.i32($i56,$i64);
  $i80.shadow := $xor.i32($i56.shadow,$i64.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 83, 17} true;
  assume {:verifier.code 0} true;
  $i81 := $xor.i32($i80,$i50);
  $i81.shadow := $xor.i32($i80.shadow,$i50.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 83, 2} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($p0,$mul.ref(2,4));
  $p82.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 83, 7} true;
  assume {:verifier.code 0} true;
  assert ($p82 == $p82.shadow);
  $M.0 := $store.i32($M.0,$p82,$i81);
  $M.0.shadow := $store.i32($M.0.shadow,$p82.shadow,$i81.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 84, 12} true;
  assume {:verifier.code 0} true;
  $i83 := $xor.i32($i54,$i62);
  $i83.shadow := $xor.i32($i54.shadow,$i62.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 84, 17} true;
  assume {:verifier.code 0} true;
  $i84 := $xor.i32($i83,$i47);
  $i84.shadow := $xor.i32($i83.shadow,$i47.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 84, 2} true;
  assume {:verifier.code 0} true;
  $p85 := $add.ref($p0,$mul.ref(1,4));
  $p85.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 84, 7} true;
  assume {:verifier.code 0} true;
  assert ($p85 == $p85.shadow);
  $M.0 := $store.i32($M.0,$p85,$i84);
  $M.0.shadow := $store.i32($M.0.shadow,$p85.shadow,$i84.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 85, 12} true;
  assume {:verifier.code 0} true;
  $i86 := $xor.i32($i52,$i59);
  $i86.shadow := $xor.i32($i52.shadow,$i59.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 85, 17} true;
  assume {:verifier.code 0} true;
  $i87 := $xor.i32($i86,$i64);
  $i87.shadow := $xor.i32($i86.shadow,$i64.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 85, 2} true;
  assume {:verifier.code 0} true;
  $p88 := $add.ref($p0,$mul.ref(0,4));
  $p88.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 85, 7} true;
  assume {:verifier.code 0} true;
  assert ($p88 == $p88.shadow);
  $M.0 := $store.i32($M.0,$p88,$i87);
  $M.0.shadow := $store.i32($M.0.shadow,$p88.shadow,$i87.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 86, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const br_aes_ct_bitslice_decrypt: ref;
axiom (br_aes_ct_bitslice_decrypt == $sub.ref(0,4128));
procedure {:inline 1} br_aes_ct_bitslice_decrypt($i0: i32, $i0.shadow: i32, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $exn;
modifies $M.0;
{
  var $i3: i32;
  ...
  var $i12.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 160, 38} true;
  assume {:verifier.code 0} true;
  call {:cexpr "br_aes_ct_bitslice_decrypt:arg:num_rounds"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 160, 38} true;
  assume {:verifier.code 0} true;
  $i3 := $shl.i32($i0,3);
  $i3.shadow := $shl.i32($i0.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 160, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i32.i64($i3);
  $i4.shadow := $zext.i32.i64($i3.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 160, 24} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p1,$mul.ref($i4,4));
  $p5.shadow := $add.ref($p1.shadow,$mul.ref($i4.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 160, 2} true;
  assume {:verifier.code 0} true;
  call add_round_key($p2, $p2.shadow, $p5, $p5.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 161, 22} true;
  assume {:verifier.code 0} true;
  $i6 := $sub.i32($i0,1);
  $i6.shadow := $sub.i32($i0.shadow,1);
  call {:cexpr "u"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 161, 7} true;
  assume {:verifier.code 0} true;
  $i7 := $i6;
  $i7.shadow := $i6.shadow;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 161, 29} true;
  assume {:verifier.code 0} true;
  $i8 := $ugt.i32($i7,0);
  $i8.shadow := $ugt.i32($i7.shadow,0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 161, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i8 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 162, 3} true;
  assume {:verifier.code 0} true;
  call inv_shift_rows($p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 163, 3} true;
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_invSbox($p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 164, 30} true;
  assume {:verifier.code 0} true;
  $i9 := $shl.i32($i7,3);
  $i9.shadow := $shl.i32($i7.shadow,3);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 164, 25} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i32.i64($i9);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 164, 3} true;
  assume {:verifier.code 0} true;
  call add_round_key($p2, $p2.shadow, $p11, $p11.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 165, 3} true;
  assume {:verifier.code 0} true;
  call inv_mix_columns($p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 166, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i8 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 167, 2} true;
  assume {:verifier.code 0} true;
  call inv_shift_rows($p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 168, 2} true;
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_invSbox($p2, $p2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 169, 2} true;
  assume {:verifier.code 0} true;
  call add_round_key($p2, $p2.shadow, $p1, $p1.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 170, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 161, 36} true;
  assume {:verifier.code 0} true;
...
modifies $M.0, $exn;
{
  ...
  var $i11.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 93, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 93, 7} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 93, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i2,8);
  $i3.shadow := $slt.i32($i2.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 93, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 94, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.i32.i64($i2);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 94, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i2);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 94, 8} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $i9 := $load.i32($M.0,$p8);
  ...
  assume {:verifier.code 0} true;
  $i10 := $xor.i32($i9,$i6);
  $i10.shadow := $xor.i32($i9.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 94, 8} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $M.0 := $store.i32($M.0,$p8,$i10);
  $M.0.shadow := $store.i32($M.0.shadow,$p8.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 95, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i3 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 96, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 93, 23} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i2,1);
...
modifies $M.0, $exn;
{
  ...
  var $i27.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 103, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 103, 7} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
...
$bb1:
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 103, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1,8);
  $i2.shadow := $slt.i32($i1.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 103, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 106, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  ...
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 107, 13} true;
  assume {:verifier.code 0} true;
  $i6 := $and.i32($i5,255);
  $i6.shadow := $and.i32($i5.shadow,255);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 108, 10} true;
  assume {:verifier.code 0} true;
  $i7 := $and.i32($i5,16128);
  $i7.shadow := $and.i32($i5.shadow,16128);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 108, 24} true;
  assume {:verifier.code 0} true;
  $i8 := $shl.i32($i7,2);
  $i8.shadow := $shl.i32($i7.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 108, 4} true;
  assume {:verifier.code 0} true;
  $i9 := $or.i32($i6,$i8);
  $i9.shadow := $or.i32($i6.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 108, 36} true;
  assume {:verifier.code 0} true;
  $i10 := $and.i32($i5,49152);
  $i10.shadow := $and.i32($i5.shadow,49152);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 108, 50} true;
  assume {:verifier.code 0} true;
  $i11 := $lshr.i32($i10,6);
  $i11.shadow := $lshr.i32($i10.shadow,6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 108, 30} true;
  assume {:verifier.code 0} true;
  $i12 := $or.i32($i9,$i11);
  $i12.shadow := $or.i32($i9.shadow,$i11.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 109, 10} true;
  assume {:verifier.code 0} true;
  $i13 := $and.i32($i5,983040);
  $i13.shadow := $and.i32($i5.shadow,983040);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 109, 24} true;
  assume {:verifier.code 0} true;
  $i14 := $shl.i32($i13,4);
  $i14.shadow := $shl.i32($i13.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 109, 4} true;
  assume {:verifier.code 0} true;
  $i15 := $or.i32($i12,$i14);
  $i15.shadow := $or.i32($i12.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 109, 36} true;
  assume {:verifier.code 0} true;
  $i16 := $and.i32($i5,15728640);
  $i16.shadow := $and.i32($i5.shadow,15728640);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 109, 50} true;
  assume {:verifier.code 0} true;
  $i17 := $lshr.i32($i16,4);
  $i17.shadow := $lshr.i32($i16.shadow,4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 109, 30} true;
  assume {:verifier.code 0} true;
  $i18 := $or.i32($i15,$i17);
  $i18.shadow := $or.i32($i15.shadow,$i17.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 110, 10} true;
  assume {:verifier.code 0} true;
  $i19 := $and.i32($i5,50331648);
  $i19.shadow := $and.i32($i5.shadow,50331648);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 110, 24} true;
  assume {:verifier.code 0} true;
  $i20 := $shl.i32($i19,6);
  $i20.shadow := $shl.i32($i19.shadow,6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 110, 4} true;
  assume {:verifier.code 0} true;
  $i21 := $or.i32($i18,$i20);
  $i21.shadow := $or.i32($i18.shadow,$i20.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 110, 36} true;
  assume {:verifier.code 0} true;
  $i22 := $and.i32($i5,4227858432);
  $i22.shadow := $and.i32($i5.shadow,4227858432);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 110, 50} true;
  assume {:verifier.code 0} true;
  $i23 := $lshr.i32($i22,2);
  $i23.shadow := $lshr.i32($i22.shadow,2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 110, 30} true;
  assume {:verifier.code 0} true;
  $i24 := $or.i32($i21,$i23);
  $i24.shadow := $or.i32($i21.shadow,$i23.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 107, 3} true;
  assume {:verifier.code 0} true;
  $i25 := $sext.i32.i64($i1);
  $i25.shadow := $sext.i32.i64($i1.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 107, 3} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p0,$mul.ref($i25,4));
  $p26.shadow := $add.ref($p0.shadow,$mul.ref($i25.shadow,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 107, 8} true;
  assume {:verifier.code 0} true;
  assert ($p26 == $p26.shadow);
  $M.0 := $store.i32($M.0,$p26,$i24);
  $M.0.shadow := $store.i32($M.0.shadow,$p26.shadow,$i24.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 111, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i2 == 1);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 112, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 103, 23} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i32($i1,1);
...
modifies $M.0, $exn;
{
  ...
  var $p166.shadow: ref;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 126, 7} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 126, 7} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($p0,$mul.ref(0,4));
  ...
  $i2 := $load.i32($M.0,$p1);
  $i2.shadow := $load.i32($M.0.shadow,$p1.shadow);
  call {:cexpr "q0"} boogie_si_record_i32($i2);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 127, 7} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p0,$mul.ref(1,4));
  $p3.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 127, 7} true;
  assume {:verifier.code 0} true;
  assert ($p3 == $p3.shadow);
  $i4 := $load.i32($M.0,$p3);
  $i4.shadow := $load.i32($M.0.shadow,$p3.shadow);
  call {:cexpr "q1"} boogie_si_record_i32($i4);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 128, 7} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0,$mul.ref(2,4));
  $p5.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 128, 7} true;
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $i6 := $load.i32($M.0,$p5);
  $i6.shadow := $load.i32($M.0.shadow,$p5.shadow);
  call {:cexpr "q2"} boogie_si_record_i32($i6);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 129, 7} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p0,$mul.ref(3,4));
  $p7.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 129, 7} true;
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $i8 := $load.i32($M.0,$p7);
  $i8.shadow := $load.i32($M.0.shadow,$p7.shadow);
  call {:cexpr "q3"} boogie_si_record_i32($i8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 130, 7} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(4,4));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 130, 7} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $i10 := $load.i32($M.0,$p9);
  $i10.shadow := $load.i32($M.0.shadow,$p9.shadow);
  call {:cexpr "q4"} boogie_si_record_i32($i10);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 131, 7} true;
  assume {:verifier.code 0} true;
  ...
  $i12 := $load.i32($M.0,$p11);
  $i12.shadow := $load.i32($M.0.shadow,$p11.shadow);
  call {:cexpr "q5"} boogie_si_record_i32($i12);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 132, 7} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p0,$mul.ref(6,4));
  $p13.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 132, 7} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  $i14 := $load.i32($M.0,$p13);
  $i14.shadow := $load.i32($M.0.shadow,$p13.shadow);
  call {:cexpr "q6"} boogie_si_record_i32($i14);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 133, 7} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p0,$mul.ref(7,4));
  $p15.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 133, 7} true;
  assume {:verifier.code 0} true;
  assert ($p15 == $p15.shadow);
  $i16 := $load.i32($M.0,$p15);
  $i16.shadow := $load.i32($M.0.shadow,$p15.shadow);
  call {:cexpr "q7"} boogie_si_record_i32($i16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 134, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $lshr.i32($i2,8);
  $i17.shadow := $lshr.i32($i2.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 134, 23} true;
  assume {:verifier.code 0} true;
  $i18 := $shl.i32($i2,24);
  $i18.shadow := $shl.i32($i2.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 134, 17} true;
  assume {:verifier.code 0} true;
  $i19 := $or.i32($i17,$i18);
  $i19.shadow := $or.i32($i17.shadow,$i18.shadow);
  call {:cexpr "r0"} boogie_si_record_i32($i19);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 135, 11} true;
  assume {:verifier.code 0} true;
  $i20 := $lshr.i32($i4,8);
  $i20.shadow := $lshr.i32($i4.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 135, 23} true;
  assume {:verifier.code 0} true;
  $i21 := $shl.i32($i4,24);
  $i21.shadow := $shl.i32($i4.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 135, 17} true;
  assume {:verifier.code 0} true;
  $i22 := $or.i32($i20,$i21);
  $i22.shadow := $or.i32($i20.shadow,$i21.shadow);
  call {:cexpr "r1"} boogie_si_record_i32($i22);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 136, 11} true;
  assume {:verifier.code 0} true;
  $i23 := $lshr.i32($i6,8);
  $i23.shadow := $lshr.i32($i6.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 136, 23} true;
  assume {:verifier.code 0} true;
  $i24 := $shl.i32($i6,24);
  $i24.shadow := $shl.i32($i6.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 136, 17} true;
  assume {:verifier.code 0} true;
  $i25 := $or.i32($i23,$i24);
  $i25.shadow := $or.i32($i23.shadow,$i24.shadow);
  call {:cexpr "r2"} boogie_si_record_i32($i25);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 137, 11} true;
  assume {:verifier.code 0} true;
  $i26 := $lshr.i32($i8,8);
  $i26.shadow := $lshr.i32($i8.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 137, 23} true;
  assume {:verifier.code 0} true;
  $i27 := $shl.i32($i8,24);
  $i27.shadow := $shl.i32($i8.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 137, 17} true;
  assume {:verifier.code 0} true;
  $i28 := $or.i32($i26,$i27);
  $i28.shadow := $or.i32($i26.shadow,$i27.shadow);
  call {:cexpr "r3"} boogie_si_record_i32($i28);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 138, 11} true;
  assume {:verifier.code 0} true;
  $i29 := $lshr.i32($i10,8);
  $i29.shadow := $lshr.i32($i10.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 138, 23} true;
  assume {:verifier.code 0} true;
  $i30 := $shl.i32($i10,24);
  $i30.shadow := $shl.i32($i10.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 138, 17} true;
  assume {:verifier.code 0} true;
  $i31 := $or.i32($i29,$i30);
  $i31.shadow := $or.i32($i29.shadow,$i30.shadow);
  call {:cexpr "r4"} boogie_si_record_i32($i31);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 139, 11} true;
  assume {:verifier.code 0} true;
  $i32 := $lshr.i32($i12,8);
  $i32.shadow := $lshr.i32($i12.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 139, 23} true;
  assume {:verifier.code 0} true;
  $i33 := $shl.i32($i12,24);
  $i33.shadow := $shl.i32($i12.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 139, 17} true;
  assume {:verifier.code 0} true;
  $i34 := $or.i32($i32,$i33);
  $i34.shadow := $or.i32($i32.shadow,$i33.shadow);
  call {:cexpr "r5"} boogie_si_record_i32($i34);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 140, 11} true;
  assume {:verifier.code 0} true;
  $i35 := $lshr.i32($i14,8);
  $i35.shadow := $lshr.i32($i14.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 140, 23} true;
  assume {:verifier.code 0} true;
  $i36 := $shl.i32($i14,24);
  $i36.shadow := $shl.i32($i14.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 140, 17} true;
  assume {:verifier.code 0} true;
  $i37 := $or.i32($i35,$i36);
  $i37.shadow := $or.i32($i35.shadow,$i36.shadow);
  call {:cexpr "r6"} boogie_si_record_i32($i37);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 141, 11} true;
  assume {:verifier.code 0} true;
  $i38 := $lshr.i32($i16,8);
  $i38.shadow := $lshr.i32($i16.shadow,8);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 141, 23} true;
  assume {:verifier.code 0} true;
  $i39 := $shl.i32($i16,24);
  $i39.shadow := $shl.i32($i16.shadow,24);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 141, 17} true;
  assume {:verifier.code 0} true;
  $i40 := $or.i32($i38,$i39);
  $i40.shadow := $or.i32($i38.shadow,$i39.shadow);
  call {:cexpr "r7"} boogie_si_record_i32($i40);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 12} true;
  assume {:verifier.code 0} true;
  $i41 := $xor.i32($i12,$i14);
  $i41.shadow := $xor.i32($i12.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 17} true;
  assume {:verifier.code 0} true;
  $i42 := $xor.i32($i41,$i16);
  $i42.shadow := $xor.i32($i41.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 22} true;
  assume {:verifier.code 0} true;
  $i43 := $xor.i32($i42,$i19);
  $i43.shadow := $xor.i32($i42.shadow,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 27} true;
  assume {:verifier.code 0} true;
  $i44 := $xor.i32($i43,$i34);
  $i44.shadow := $xor.i32($i43.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 32} true;
  assume {:verifier.code 0} true;
  $i45 := $xor.i32($i44,$i40);
  $i45.shadow := $xor.i32($i44.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 49} true;
  assume {:verifier.code 0} true;
  $i46 := $xor.i32($i2,$i12);
  $i46.shadow := $xor.i32($i2.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 54} true;
  assume {:verifier.code 0} true;
  $i47 := $xor.i32($i46,$i14);
  $i47.shadow := $xor.i32($i46.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 59} true;
  assume {:verifier.code 0} true;
  $i48 := $xor.i32($i47,$i19);
  $i48.shadow := $xor.i32($i47.shadow,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 64} true;
  assume {:verifier.code 0} true;
  $i49 := $xor.i32($i48,$i34);
  $i49.shadow := $xor.i32($i48.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 39} true;
  assume {:verifier.code 0} true;
  call $i50, $i50.shadow := rotr16($i49, $i49.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 37} true;
  assume {:verifier.code 0} true;
  $i51 := $xor.i32($i45,$i50);
  $i51.shadow := $xor.i32($i45.shadow,$i50.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 2} true;
  assume {:verifier.code 0} true;
  $p52 := $add.ref($p0,$mul.ref(0,4));
  $p52.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 143, 7} true;
  assume {:verifier.code 0} true;
  assert ($p52 == $p52.shadow);
  $M.0 := $store.i32($M.0,$p52,$i51);
  $M.0.shadow := $store.i32($M.0.shadow,$p52.shadow,$i51.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 12} true;
  assume {:verifier.code 0} true;
  $i53 := $xor.i32($i2,$i12);
  $i53.shadow := $xor.i32($i2.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 17} true;
  assume {:verifier.code 0} true;
  $i54 := $xor.i32($i53,$i19);
  $i54.shadow := $xor.i32($i53.shadow,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 22} true;
  assume {:verifier.code 0} true;
  $i55 := $xor.i32($i54,$i22);
  $i55.shadow := $xor.i32($i54.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 27} true;
  assume {:verifier.code 0} true;
  $i56 := $xor.i32($i55,$i34);
  $i56.shadow := $xor.i32($i55.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 32} true;
  assume {:verifier.code 0} true;
  $i57 := $xor.i32($i56,$i37);
  $i57.shadow := $xor.i32($i56.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 37} true;
  assume {:verifier.code 0} true;
  $i58 := $xor.i32($i57,$i40);
  $i58.shadow := $xor.i32($i57.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 54} true;
  assume {:verifier.code 0} true;
  $i59 := $xor.i32($i4,$i12);
  $i59.shadow := $xor.i32($i4.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 59} true;
  assume {:verifier.code 0} true;
  $i60 := $xor.i32($i59,$i16);
  $i60.shadow := $xor.i32($i59.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 64} true;
  assume {:verifier.code 0} true;
  $i61 := $xor.i32($i60,$i22);
  $i61.shadow := $xor.i32($i60.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 69} true;
  assume {:verifier.code 0} true;
  $i62 := $xor.i32($i61,$i34);
  $i62.shadow := $xor.i32($i61.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 74} true;
  assume {:verifier.code 0} true;
  $i63 := $xor.i32($i62,$i37);
  $i63.shadow := $xor.i32($i62.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 44} true;
  assume {:verifier.code 0} true;
  call $i64, $i64.shadow := rotr16($i63, $i63.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 42} true;
  assume {:verifier.code 0} true;
  $i65 := $xor.i32($i58,$i64);
  $i65.shadow := $xor.i32($i58.shadow,$i64.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 2} true;
  assume {:verifier.code 0} true;
  $p66 := $add.ref($p0,$mul.ref(1,4));
  $p66.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 144, 7} true;
  assume {:verifier.code 0} true;
  assert ($p66 == $p66.shadow);
  $M.0 := $store.i32($M.0,$p66,$i65);
  $M.0.shadow := $store.i32($M.0.shadow,$p66.shadow,$i65.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 12} true;
  assume {:verifier.code 0} true;
  $i67 := $xor.i32($i2,$i4);
  $i67.shadow := $xor.i32($i2.shadow,$i4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 17} true;
  assume {:verifier.code 0} true;
  $i68 := $xor.i32($i67,$i14);
  $i68.shadow := $xor.i32($i67.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 22} true;
  assume {:verifier.code 0} true;
  $i69 := $xor.i32($i68,$i22);
  $i69.shadow := $xor.i32($i68.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 27} true;
  assume {:verifier.code 0} true;
  $i70 := $xor.i32($i69,$i25);
  $i70.shadow := $xor.i32($i69.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 32} true;
  assume {:verifier.code 0} true;
  $i71 := $xor.i32($i70,$i37);
  $i71.shadow := $xor.i32($i70.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 37} true;
  assume {:verifier.code 0} true;
  $i72 := $xor.i32($i71,$i40);
  $i72.shadow := $xor.i32($i71.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 54} true;
  assume {:verifier.code 0} true;
  $i73 := $xor.i32($i2,$i6);
  $i73.shadow := $xor.i32($i2.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 59} true;
  assume {:verifier.code 0} true;
  $i74 := $xor.i32($i73,$i14);
  $i74.shadow := $xor.i32($i73.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 64} true;
  assume {:verifier.code 0} true;
  $i75 := $xor.i32($i74,$i25);
  $i75.shadow := $xor.i32($i74.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 69} true;
  assume {:verifier.code 0} true;
  $i76 := $xor.i32($i75,$i37);
  $i76.shadow := $xor.i32($i75.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 74} true;
  assume {:verifier.code 0} true;
  $i77 := $xor.i32($i76,$i40);
  $i77.shadow := $xor.i32($i76.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 44} true;
  assume {:verifier.code 0} true;
  call $i78, $i78.shadow := rotr16($i77, $i77.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 42} true;
  assume {:verifier.code 0} true;
  $i79 := $xor.i32($i72,$i78);
  $i79.shadow := $xor.i32($i72.shadow,$i78.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 2} true;
  assume {:verifier.code 0} true;
  $p80 := $add.ref($p0,$mul.ref(2,4));
  $p80.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 145, 7} true;
  assume {:verifier.code 0} true;
  assert ($p80 == $p80.shadow);
  $M.0 := $store.i32($M.0,$p80,$i79);
  $M.0.shadow := $store.i32($M.0.shadow,$p80.shadow,$i79.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 12} true;
  assume {:verifier.code 0} true;
  $i81 := $xor.i32($i2,$i4);
  $i81.shadow := $xor.i32($i2.shadow,$i4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 17} true;
  assume {:verifier.code 0} true;
  $i82 := $xor.i32($i81,$i6);
  $i82.shadow := $xor.i32($i81.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 22} true;
  assume {:verifier.code 0} true;
  $i83 := $xor.i32($i82,$i12);
  $i83.shadow := $xor.i32($i82.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 27} true;
  assume {:verifier.code 0} true;
  $i84 := $xor.i32($i83,$i14);
  $i84.shadow := $xor.i32($i83.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 32} true;
  assume {:verifier.code 0} true;
  $i85 := $xor.i32($i84,$i19);
  $i85.shadow := $xor.i32($i84.shadow,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 37} true;
  assume {:verifier.code 0} true;
  $i86 := $xor.i32($i85,$i25);
  $i86.shadow := $xor.i32($i85.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 42} true;
  assume {:verifier.code 0} true;
  $i87 := $xor.i32($i86,$i28);
  $i87.shadow := $xor.i32($i86.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 47} true;
  assume {:verifier.code 0} true;
  $i88 := $xor.i32($i87,$i34);
  $i88.shadow := $xor.i32($i87.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 64} true;
  assume {:verifier.code 0} true;
  $i89 := $xor.i32($i2,$i4);
  $i89.shadow := $xor.i32($i2.shadow,$i4.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 69} true;
  assume {:verifier.code 0} true;
  $i90 := $xor.i32($i89,$i8);
  $i90.shadow := $xor.i32($i89.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 74} true;
  assume {:verifier.code 0} true;
  $i91 := $xor.i32($i90,$i12);
  $i91.shadow := $xor.i32($i90.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 79} true;
  assume {:verifier.code 0} true;
  $i92 := $xor.i32($i91,$i14);
  $i92.shadow := $xor.i32($i91.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 84} true;
  assume {:verifier.code 0} true;
  $i93 := $xor.i32($i92,$i16);
  $i93.shadow := $xor.i32($i92.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 89} true;
  assume {:verifier.code 0} true;
  $i94 := $xor.i32($i93,$i19);
  $i94.shadow := $xor.i32($i93.shadow,$i19.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 94} true;
  assume {:verifier.code 0} true;
  $i95 := $xor.i32($i94,$i28);
  $i95.shadow := $xor.i32($i94.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 99} true;
  assume {:verifier.code 0} true;
  $i96 := $xor.i32($i95,$i34);
  $i96.shadow := $xor.i32($i95.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 104} true;
  assume {:verifier.code 0} true;
  $i97 := $xor.i32($i96,$i40);
  $i97.shadow := $xor.i32($i96.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 54} true;
  assume {:verifier.code 0} true;
  call $i98, $i98.shadow := rotr16($i97, $i97.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 52} true;
  assume {:verifier.code 0} true;
  $i99 := $xor.i32($i88,$i98);
  $i99.shadow := $xor.i32($i88.shadow,$i98.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 2} true;
  assume {:verifier.code 0} true;
  $p100 := $add.ref($p0,$mul.ref(3,4));
  $p100.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 146, 7} true;
  assume {:verifier.code 0} true;
  assert ($p100 == $p100.shadow);
  $M.0 := $store.i32($M.0,$p100,$i99);
  $M.0.shadow := $store.i32($M.0.shadow,$p100.shadow,$i99.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 12} true;
  assume {:verifier.code 0} true;
  $i101 := $xor.i32($i4,$i6);
  $i101.shadow := $xor.i32($i4.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 17} true;
  assume {:verifier.code 0} true;
  $i102 := $xor.i32($i101,$i8);
  $i102.shadow := $xor.i32($i101.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 22} true;
  assume {:verifier.code 0} true;
  $i103 := $xor.i32($i102,$i12);
  $i103.shadow := $xor.i32($i102.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 27} true;
  assume {:verifier.code 0} true;
  $i104 := $xor.i32($i103,$i22);
  $i104.shadow := $xor.i32($i103.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 32} true;
  assume {:verifier.code 0} true;
  $i105 := $xor.i32($i104,$i28);
  $i105.shadow := $xor.i32($i104.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 37} true;
  assume {:verifier.code 0} true;
  $i106 := $xor.i32($i105,$i31);
  $i106.shadow := $xor.i32($i105.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 42} true;
  assume {:verifier.code 0} true;
  $i107 := $xor.i32($i106,$i34);
  $i107.shadow := $xor.i32($i106.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 47} true;
  assume {:verifier.code 0} true;
  $i108 := $xor.i32($i107,$i37);
  $i108.shadow := $xor.i32($i107.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 52} true;
  assume {:verifier.code 0} true;
  $i109 := $xor.i32($i108,$i40);
  $i109.shadow := $xor.i32($i108.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 69} true;
  assume {:verifier.code 0} true;
  $i110 := $xor.i32($i4,$i6);
  $i110.shadow := $xor.i32($i4.shadow,$i6.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 74} true;
  assume {:verifier.code 0} true;
  $i111 := $xor.i32($i110,$i10);
  $i111.shadow := $xor.i32($i110.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 79} true;
  assume {:verifier.code 0} true;
  $i112 := $xor.i32($i111,$i12);
  $i112.shadow := $xor.i32($i111.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 84} true;
  assume {:verifier.code 0} true;
  $i113 := $xor.i32($i112,$i16);
  $i113.shadow := $xor.i32($i112.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 89} true;
  assume {:verifier.code 0} true;
  $i114 := $xor.i32($i113,$i22);
  $i114.shadow := $xor.i32($i113.shadow,$i22.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 94} true;
  assume {:verifier.code 0} true;
  $i115 := $xor.i32($i114,$i31);
  $i115.shadow := $xor.i32($i114.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 99} true;
  assume {:verifier.code 0} true;
  $i116 := $xor.i32($i115,$i34);
  $i116.shadow := $xor.i32($i115.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 104} true;
  assume {:verifier.code 0} true;
  $i117 := $xor.i32($i116,$i37);
  $i117.shadow := $xor.i32($i116.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 59} true;
  assume {:verifier.code 0} true;
  call $i118, $i118.shadow := rotr16($i117, $i117.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 57} true;
  assume {:verifier.code 0} true;
  $i119 := $xor.i32($i109,$i118);
  $i119.shadow := $xor.i32($i109.shadow,$i118.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 2} true;
  assume {:verifier.code 0} true;
  $p120 := $add.ref($p0,$mul.ref(4,4));
  $p120.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 147, 7} true;
  assume {:verifier.code 0} true;
  assert ($p120 == $p120.shadow);
  $M.0 := $store.i32($M.0,$p120,$i119);
  $M.0.shadow := $store.i32($M.0.shadow,$p120.shadow,$i119.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 12} true;
  assume {:verifier.code 0} true;
  $i121 := $xor.i32($i6,$i8);
  $i121.shadow := $xor.i32($i6.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 17} true;
  assume {:verifier.code 0} true;
  $i122 := $xor.i32($i121,$i10);
  $i122.shadow := $xor.i32($i121.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 22} true;
  assume {:verifier.code 0} true;
  $i123 := $xor.i32($i122,$i14);
  $i123.shadow := $xor.i32($i122.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 27} true;
  assume {:verifier.code 0} true;
  $i124 := $xor.i32($i123,$i25);
  $i124.shadow := $xor.i32($i123.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 32} true;
  assume {:verifier.code 0} true;
  $i125 := $xor.i32($i124,$i31);
  $i125.shadow := $xor.i32($i124.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 37} true;
  assume {:verifier.code 0} true;
  $i126 := $xor.i32($i125,$i34);
  $i126.shadow := $xor.i32($i125.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 42} true;
  assume {:verifier.code 0} true;
  $i127 := $xor.i32($i126,$i37);
  $i127.shadow := $xor.i32($i126.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 47} true;
  assume {:verifier.code 0} true;
  $i128 := $xor.i32($i127,$i40);
  $i128.shadow := $xor.i32($i127.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 64} true;
  assume {:verifier.code 0} true;
  $i129 := $xor.i32($i6,$i8);
  $i129.shadow := $xor.i32($i6.shadow,$i8.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 69} true;
  assume {:verifier.code 0} true;
  $i130 := $xor.i32($i129,$i12);
  $i130.shadow := $xor.i32($i129.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 74} true;
  assume {:verifier.code 0} true;
  $i131 := $xor.i32($i130,$i14);
  $i131.shadow := $xor.i32($i130.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 79} true;
  assume {:verifier.code 0} true;
  $i132 := $xor.i32($i131,$i25);
  $i132.shadow := $xor.i32($i131.shadow,$i25.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 84} true;
  assume {:verifier.code 0} true;
  $i133 := $xor.i32($i132,$i34);
  $i133.shadow := $xor.i32($i132.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 89} true;
  assume {:verifier.code 0} true;
  $i134 := $xor.i32($i133,$i37);
  $i134.shadow := $xor.i32($i133.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 94} true;
  assume {:verifier.code 0} true;
  $i135 := $xor.i32($i134,$i40);
  $i135.shadow := $xor.i32($i134.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 54} true;
  assume {:verifier.code 0} true;
  call $i136, $i136.shadow := rotr16($i135, $i135.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 52} true;
  assume {:verifier.code 0} true;
  $i137 := $xor.i32($i128,$i136);
  $i137.shadow := $xor.i32($i128.shadow,$i136.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 2} true;
  assume {:verifier.code 0} true;
  $p138 := $add.ref($p0,$mul.ref(5,4));
  $p138.shadow := $add.ref($p0.shadow,$mul.ref(5,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 148, 7} true;
  assume {:verifier.code 0} true;
  assert ($p138 == $p138.shadow);
  $M.0 := $store.i32($M.0,$p138,$i137);
  $M.0.shadow := $store.i32($M.0.shadow,$p138.shadow,$i137.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 12} true;
  assume {:verifier.code 0} true;
  $i139 := $xor.i32($i8,$i10);
  $i139.shadow := $xor.i32($i8.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 17} true;
  assume {:verifier.code 0} true;
  $i140 := $xor.i32($i139,$i12);
  $i140.shadow := $xor.i32($i139.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 22} true;
  assume {:verifier.code 0} true;
  $i141 := $xor.i32($i140,$i16);
  $i141.shadow := $xor.i32($i140.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 27} true;
  assume {:verifier.code 0} true;
  $i142 := $xor.i32($i141,$i28);
  $i142.shadow := $xor.i32($i141.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 32} true;
  assume {:verifier.code 0} true;
  $i143 := $xor.i32($i142,$i34);
  $i143.shadow := $xor.i32($i142.shadow,$i34.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 37} true;
  assume {:verifier.code 0} true;
  $i144 := $xor.i32($i143,$i37);
  $i144.shadow := $xor.i32($i143.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 42} true;
  assume {:verifier.code 0} true;
  $i145 := $xor.i32($i144,$i40);
  $i145.shadow := $xor.i32($i144.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 59} true;
  assume {:verifier.code 0} true;
  $i146 := $xor.i32($i8,$i10);
  $i146.shadow := $xor.i32($i8.shadow,$i10.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 64} true;
  assume {:verifier.code 0} true;
  $i147 := $xor.i32($i146,$i14);
  $i147.shadow := $xor.i32($i146.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 69} true;
  assume {:verifier.code 0} true;
  $i148 := $xor.i32($i147,$i16);
  $i148.shadow := $xor.i32($i147.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 74} true;
  assume {:verifier.code 0} true;
  $i149 := $xor.i32($i148,$i28);
  $i149.shadow := $xor.i32($i148.shadow,$i28.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 79} true;
  assume {:verifier.code 0} true;
  $i150 := $xor.i32($i149,$i37);
  $i150.shadow := $xor.i32($i149.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 84} true;
  assume {:verifier.code 0} true;
  $i151 := $xor.i32($i150,$i40);
  $i151.shadow := $xor.i32($i150.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 49} true;
  assume {:verifier.code 0} true;
  call $i152, $i152.shadow := rotr16($i151, $i151.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 47} true;
  assume {:verifier.code 0} true;
  $i153 := $xor.i32($i145,$i152);
  $i153.shadow := $xor.i32($i145.shadow,$i152.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 2} true;
  assume {:verifier.code 0} true;
  $p154 := $add.ref($p0,$mul.ref(6,4));
  $p154.shadow := $add.ref($p0.shadow,$mul.ref(6,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 149, 7} true;
  assume {:verifier.code 0} true;
  assert ($p154 == $p154.shadow);
  $M.0 := $store.i32($M.0,$p154,$i153);
  $M.0.shadow := $store.i32($M.0.shadow,$p154.shadow,$i153.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 12} true;
  assume {:verifier.code 0} true;
  $i155 := $xor.i32($i10,$i12);
  $i155.shadow := $xor.i32($i10.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 17} true;
  assume {:verifier.code 0} true;
  $i156 := $xor.i32($i155,$i14);
  $i156.shadow := $xor.i32($i155.shadow,$i14.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 22} true;
  assume {:verifier.code 0} true;
  $i157 := $xor.i32($i156,$i31);
  $i157.shadow := $xor.i32($i156.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 27} true;
  assume {:verifier.code 0} true;
  $i158 := $xor.i32($i157,$i37);
  $i158.shadow := $xor.i32($i157.shadow,$i37.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 32} true;
  assume {:verifier.code 0} true;
  $i159 := $xor.i32($i158,$i40);
  $i159.shadow := $xor.i32($i158.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 49} true;
  assume {:verifier.code 0} true;
  $i160 := $xor.i32($i10,$i12);
  $i160.shadow := $xor.i32($i10.shadow,$i12.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 54} true;
  assume {:verifier.code 0} true;
  $i161 := $xor.i32($i160,$i16);
  $i161.shadow := $xor.i32($i160.shadow,$i16.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 59} true;
  assume {:verifier.code 0} true;
  $i162 := $xor.i32($i161,$i31);
  $i162.shadow := $xor.i32($i161.shadow,$i31.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 64} true;
  assume {:verifier.code 0} true;
  $i163 := $xor.i32($i162,$i40);
  $i163.shadow := $xor.i32($i162.shadow,$i40.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 39} true;
  assume {:verifier.code 0} true;
  call $i164, $i164.shadow := rotr16($i163, $i163.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 37} true;
  assume {:verifier.code 0} true;
  $i165 := $xor.i32($i159,$i164);
  $i165.shadow := $xor.i32($i159.shadow,$i164.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 2} true;
  assume {:verifier.code 0} true;
  $p166 := $add.ref($p0,$mul.ref(7,4));
  $p166.shadow := $add.ref($p0.shadow,$mul.ref(7,4));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 150, 7} true;
  assume {:verifier.code 0} true;
  assert ($p166 == $p166.shadow);
  $M.0 := $store.i32($M.0,$p166,$i165);
  $M.0.shadow := $store.i32($M.0.shadow,$p166.shadow,$i165.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 151, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const rotr16: ref;
axiom (rotr16 == $sub.ref(0,8256));
procedure {:inline 1} rotr16($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i3.shadow: i32;
$bb0:
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 117, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "rotr16:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 117, 12} true;
  assume {:verifier.code 0} true;
  $i1 := $shl.i32($i0,16);
  $i1.shadow := $shl.i32($i0.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 117, 24} true;
  assume {:verifier.code 0} true;
  $i2 := $lshr.i32($i0,16);
  $i2.shadow := $lshr.i32($i0.shadow,16);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 117, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $or.i32($i1,$i2);
  $i3.shadow := $or.i32($i1.shadow,$i2.shadow);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct_dec.c", 117, 2} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $r.shadow := $i3.shadow;
  $exn := false;
...
$bb0:
  ...
  assume {:sourceloc "bitslice_decrypt.c", 10, 47} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p2);
  $p7.shadow := $bitcast.ref.ref($p2.shadow);
  assume {:sourceloc "bitslice_decrypt.c", 10, 2} true;
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_decrypt($i0, $i0.shadow, $p1, $p1.shadow, $p7, $p7.shadow);
