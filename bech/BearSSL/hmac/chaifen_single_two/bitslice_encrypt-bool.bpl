...
procedure {:inline 1} br_aes_ct_bitslice_encrypt($i0: i32, $i0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1)
modifies $exn;
modifies $M.0;
{
  var $i3: i32;
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_Sbox($p2, $p2.dup);
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i44, $i44.dup := rotr16($i43, $i43.dup);
  ...
  assume {:verifier.code 0} true;
  call $i52, $i52.dup := rotr16($i51, $i51.dup);
  ...
  assume {:verifier.code 0} true;
  call $i58, $i58.dup := rotr16($i57, $i57.dup);
  ...
  assume {:verifier.code 0} true;
  call $i66, $i66.dup := rotr16($i65, $i65.dup);
  ...
  assume {:verifier.code 0} true;
  call $i74, $i74.dup := rotr16($i73, $i73.dup);
  ...
  assume {:verifier.code 0} true;
  call $i80, $i80.dup := rotr16($i79, $i79.dup);
  ...
  assume {:verifier.code 0} true;
  call $i86, $i86.dup := rotr16($i85, $i85.dup);
  ...
  assume {:verifier.code 0} true;
  call $i92, $i92.dup := rotr16($i91, $i91.dup);
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_encrypt($i0, $i0.dup, $p1, $p1.dup, $p7, $p7.dup);
