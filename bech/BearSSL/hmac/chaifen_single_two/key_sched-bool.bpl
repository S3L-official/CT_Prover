...
procedure {:inline 1} br_aes_ct_ortho($p0: ref, $p0.dup: i1)
modifies $M.0, $exn;
{
  var $p1: ref;
  var $p1.dup: i1;
...
procedure {:inline 1} br_aes_ct_keysched($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i64, $i2.dup: i1) returns ($r: i32, $r.dup: i1)
...
$bb17:
  ...
  $p29.dup := $or.i1($or.i1($p3.dup,$or.i1(0,0)),$or.i1($i28.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 284, 22} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p29.dup == 0));
  $M.0 := $store.i32($M.0,$p29,$i21);
  $M.0.dup := $store.i1($M.0.dup,$p29,$i21.dup);
...
$bb20:
  ...
  assert {:shadow_invariant} ($p3.dup == 0);
  assert {:shadow_invariant} ($i12.dup == 0);
  assert {:unlikely_shadow_invariant ($i34.dup == 0)} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  $p54.dup := $or.i1($or.i1($p3.dup,$or.i1(0,0)),$or.i1($i53.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 293, 10} true;
  assume {:verifier.code 0} true;
...
$bb29:
  ...
  assume {:verifier.code 0} true;
  call $i50, $i50.dup := sub_word($i34, $i34.dup);
...
$bb35:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i71.dup == 0);
  assert {:shadow_invariant} ($i9.dup == 0);
  assert {:shadow_invariant} ($i14.dup == 0);
  assert {:shadow_invariant} ($p3.dup == 0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
...
$bb36:
  ...
  $p73.dup := $or.i1($or.i1($p3.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 302, 29} true;
  assume {:verifier.code 0} true;
  $i74 := $shl.i32($i71,1);
  $i74.dup := $or.i1($i71.dup,0);
  ...
  assume {:verifier.code 0} true;
  call br_aes_ct_ortho($p76, $p76.dup);
...
$bb39:
  ...
  assert {:shadow_invariant} ($i78.dup == 0);
  assert {:shadow_invariant} ($i9.dup == 0);
  assert {:shadow_invariant} ($i14.dup == 0);
  assert {:shadow_invariant} ($p3.dup == 0);
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 0, 0} true;
...
$bb40:
  ...
  $p83.dup := $or.i1($or.i1($p3.dup,$or.i1(0,0)),$or.i1($i82.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 305, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p83.dup == 0));
  $i84 := $load.i32($M.0,$p83);
  $i84.dup := $load.i1($M.0.dup,$p83);
  ...
  $p88.dup := $or.i1($or.i1($p3.dup,$or.i1(0,0)),$or.i1($i87.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 306, 7} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p88.dup == 0));
  $i89 := $load.i32($M.0,$p88);
  $i89.dup := $load.i1($M.0.dup,$p88);
...
$bb1:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($p1.dup == 0);
...
$bb2:
  ...
  $p5.dup := $or.i1($or.i1($p1.dup,$or.i1(0,0)),$or.i1($i4.dup,0));
  assume {:sourceloc "../BearSSL/src/symcipher/aes_ct.c", 247, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p5.dup == 0));
  $M.0 := $store.i32($M.0,$p5,$i0);
  $M.0.dup := $store.i1($M.0.dup,$p5,$i0.dup);
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  call br_aes_ct_ortho($p7, $p7.dup);
  ...
  assume {:verifier.code 0} true;
  call br_aes_ct_bitslice_Sbox($p8, $p8.dup);
  ...
  assume {:verifier.code 0} true;
  call br_aes_ct_ortho($p9, $p9.dup);
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i6, $i6.dup := br_aes_ct_keysched($p0, $p0.dup, $p1, $p1.dup, $i2, $i2.dup);
...
$bb0:
  ...
  $M.1.dup := $store.i1($M.1.dup,Rcon,0);
  ...
  $M.1.dup := $store.i1($M.1.dup,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(1,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(2,1)),4);
  $M.1.dup := $store.i1($M.1.dup,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(2,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(3,1)),8);
  $M.1.dup := $store.i1($M.1.dup,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(3,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(4,1)),16);
  $M.1.dup := $store.i1($M.1.dup,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(4,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(5,1)),32);
  $M.1.dup := $store.i1($M.1.dup,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(5,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(6,1)),64);
  $M.1.dup := $store.i1($M.1.dup,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(6,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(7,1)),$sub.i8(0,128));
  $M.1.dup := $store.i1($M.1.dup,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(7,1)),$or.i1(0,0));
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(8,1)),27);
  $M.1.dup := $store.i1($M.1.dup,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(8,1)),0);
  $shadow_ok := ($shadow_ok && ($or.i1($or.i1(cons.dup,$or.i1(0,0)),$or.i1(0,0)) == 0));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(9,1)),54);
  $M.1.dup := $store.i1($M.1.dup,$add.ref($add.ref(Rcon,$mul.ref(0,10)),$mul.ref(9,1)),0);
  $exn := false;
  $exn.dup := false;
  return;
}
