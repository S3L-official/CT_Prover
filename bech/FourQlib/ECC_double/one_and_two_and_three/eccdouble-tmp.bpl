...
const eccdouble: ref;
axiom (eccdouble == $sub.ref(0,2064));
procedure {:inline 1} eccdouble($p0: ref, $p0.shadow: ref);
const eccdouble_wrapper: ref;
axiom (eccdouble_wrapper == $sub.ref(0,3096));
procedure {:entrypoint} eccdouble_wrapper($p0: ref, $p0.shadow: ref)
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "eccdouble.c", 11, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:eccdouble_wrapper"} boogie_si_record_ref(eccdouble_wrapper);
  call {:cexpr "smack:arg:eccdouble_wrapper:$p0"} boogie_si_record_ref($p0);
  assume {:sourceloc "eccdouble.c", 11, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p0} $p1 := __SMACK_value.ref($p0);
  $p1.shadow := $p1;
  assume $isExternal($p1);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p1);
  assume {:sourceloc "eccdouble.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p1, $p1.shadow);
  assume {:sourceloc "eccdouble.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call eccdouble($p0, $p0.shadow);
  assume {:sourceloc "eccdouble.c", 14, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := $exn;
