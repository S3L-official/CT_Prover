...
; Function Attrs: noinline nounwind uwtable
define dso_local void @eccnorm_wrapper(%struct.point_extproj* %0, %struct.point_affine* %1) #0 !dbg !2595 {
  call void @llvm.dbg.value(metadata %struct.point_extproj* %0, metadata !2596, metadata !DIExpression()), !dbg !2597
  call void @llvm.dbg.value(metadata %struct.point_affine* %1, metadata !2598, metadata !DIExpression()), !dbg !2597
  %3 = call %struct.smack_value* (%struct.point_extproj*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (%struct.point_extproj*, ...)*)(%struct.point_extproj* %0), !dbg !2599
  call void @public_in(%struct.smack_value* %3), !dbg !2600
  %4 = call %struct.smack_value* (%struct.point_affine*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (%struct.point_affine*, ...)*)(%struct.point_affine* %1), !dbg !2601
  call void @public_in(%struct.smack_value* %4), !dbg !2602
  call void @eccnorm(%struct.point_extproj* %0, %struct.point_affine* %1), !dbg !2603
  ret void, !dbg !2604
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @eccnorm_wrapper_t() #0 !dbg !2605 {
  ...
  %6 = getelementptr inbounds [1 x %struct.point_affine], [1 x %struct.point_affine]* %2, i64 0, i64 0, !dbg !2617
  call void @eccnorm(%struct.point_extproj* %5, %struct.point_affine* %6), !dbg !2618
  ret void, !dbg !2619
}
...
!53 = !DIFile(filename: "./../fourq/fourqlib/generic/../table_lookup.h", directory: "/home/luwei/bech-back/FourQlib/ECC_norm")
...
!313 = !DIFile(filename: "./../fourq/fourqlib/eccp2_core.c", directory: "/home/luwei/bech-back/FourQlib/ECC_norm")
...
!2595 = distinct !DISubprogram(name: "eccnorm_wrapper", scope: !3, file: !3, line: 9, type: !1555, scopeLine: 10, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!2596 = !DILocalVariable(name: "P", arg: 1, scope: !2595, file: !3, line: 9, type: !1557)
!2597 = !DILocation(line: 0, scope: !2595)
!2598 = !DILocalVariable(name: "Q", arg: 2, scope: !2595, file: !3, line: 9, type: !1534)
...
!2605 = distinct !DISubprogram(name: "eccnorm_wrapper_t", scope: !3, file: !3, line: 20, type: !2606, scopeLine: 21, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
