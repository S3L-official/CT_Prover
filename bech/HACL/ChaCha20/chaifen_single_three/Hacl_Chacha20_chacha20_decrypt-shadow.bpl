...
const Hacl_Chacha20_chacha20_decrypt: ref;
axiom (Hacl_Chacha20_chacha20_decrypt == $sub.ref(0,17552));
procedure {:inline 1} Hacl_Chacha20_chacha20_decrypt($i0: i32, $i0.shadow: i32, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref, $p4: ref, $p4.shadow: ref, $i5: i32, $i5.shadow: i32)
modifies $M.1, $exn;
modifies $M.3;
...
modifies $M.6;
{
  ...
  var $p9.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Chacha20.c", 227, 12} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p6 := $alloc($mul.ref(64,$zext.i32.i64(1)));
  $p6.shadow := $p6;
  call {:cexpr "Hacl_Chacha20_chacha20_decrypt:arg:len"} boogie_si_record_i32($i0);
  call {:cexpr "Hacl_Chacha20_chacha20_decrypt:arg:ctr"} boogie_si_record_i32($i5);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Chacha20.c", 227, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Chacha20.c", 228, 36} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p6,$mul.ref(0,64)),$mul.ref(0,4));
  $p8.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Chacha20.c", 228, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Impl_Chacha20_chacha20_init($p8, $p8.shadow, $p3, $p3.shadow, $p4, $p4.shadow, $i5, $i5.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Chacha20.c", 229, 38} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p6,$mul.ref(0,64)),$mul.ref(0,4));
  $p9.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,64)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Chacha20.c", 229, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Impl_Chacha20_chacha20_update($p9, $p9.shadow, $i0, $i0.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Chacha20.c", 230, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const Hacl_Chacha20_chacha20_decrypt_wrapper: ref;
axiom (Hacl_Chacha20_chacha20_decrypt_wrapper == $sub.ref(0,18584));
procedure {:entrypoint} Hacl_Chacha20_chacha20_decrypt_wrapper($i0: i32, $i0.shadow: i32, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref, $p4: ref, $p4.shadow: ref, $i5: i32, $i5.shadow: i32)
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 10, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:Hacl_Chacha20_chacha20_decrypt_wrapper"} boogie_si_record_ref(Hacl_Chacha20_chacha20_decrypt_wrapper);
  call {:cexpr "smack:arg:Hacl_Chacha20_chacha20_decrypt_wrapper:$i0"} boogie_si_record_i32($i0);
  call {:cexpr "smack:arg:Hacl_Chacha20_chacha20_decrypt_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:Hacl_Chacha20_chacha20_decrypt_wrapper:$p2"} boogie_si_record_ref($p2);
  call {:cexpr "smack:arg:Hacl_Chacha20_chacha20_decrypt_wrapper:$p3"} boogie_si_record_ref($p3);
  call {:cexpr "smack:arg:Hacl_Chacha20_chacha20_decrypt_wrapper:$p4"} boogie_si_record_ref($p4);
  call {:cexpr "smack:arg:Hacl_Chacha20_chacha20_decrypt_wrapper:$i5"} boogie_si_record_i32($i5);
  call {:cexpr "Hacl_Chacha20_chacha20_decrypt_wrapper:arg:len"} boogie_si_record_i32($i0);
  call {:cexpr "Hacl_Chacha20_chacha20_decrypt_wrapper:arg:ctr"} boogie_si_record_i32($i5);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 10, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p6, $p6.shadow);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 11, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p7 := __SMACK_value.ref($p1);
  $p7.shadow := $p7;
  assume $isExternal($p7);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p7);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p7, $p7.shadow);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 12, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p2} $p8 := __SMACK_value.ref($p2);
  $p8.shadow := $p8;
  assume $isExternal($p8);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p8);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p8, $p8.shadow);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 13, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p3} $p9 := __SMACK_value.ref($p3);
  $p9.shadow := $p9;
  assume $isExternal($p9);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p9);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p9, $p9.shadow);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 14, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p4} $p10 := __SMACK_value.ref($p4);
  $p10.shadow := $p10;
  assume $isExternal($p10);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p10);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p10, $p10.shadow);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 15, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i5} $p11 := __SMACK_value.i32($i5);
  $p11.shadow := $p11;
  assume $isExternal($p11);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p11);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p11, $p11.shadow);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 17, 13} true;
  assume {:verifier.code 1} true;
  call {:name $p2} {:array "$load.i8", $M.2, $p2, 1, 64} $p12 := __SMACK_values($p2, 64);
  $p12.shadow := $p12;
  assume $isExternal($p12);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p12);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p12, $p12.shadow);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Chacha20_chacha20_decrypt($i0, $i0.shadow, $p1, $p1.shadow, $p2, $p2.shadow, $p3, $p3.shadow, $p4, $p4.shadow, $i5, $i5.shadow);
  assume {:sourceloc "Hacl_Chacha20_chacha20_decrypt.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
