; ModuleID = 'Hacl_Chacha20_chacha20_decrypt.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Chacha20_chacha20_decrypt_wrapper(i32 %0, i8* %1, i8* %2, i8* %3, i8* %4, i32 %5) #0 !dbg !777 {
  ...
  %13 = call %struct.smack_value* @__SMACK_values(i8* %2, i32 64), !dbg !797
  call void @public_in(%struct.smack_value* %13), !dbg !798
  call void @Hacl_Chacha20_chacha20_decrypt(i32 %0, i8* %1, i8* %2, i8* %3, i8* %4, i32 %5), !dbg !799
  ret void, !dbg !800
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Chacha20_chacha20_decrypt_wrapper_t() #0 !dbg !801 {
  ...
  call void @Hacl_Chacha20_chacha20_decrypt(i32 %5, i8* %1, i8* %2, i8* %3, i8* %4, i32 %6), !dbg !817
  ret void, !dbg !818
}
...
!19 = !DIFile(filename: "Hacl_Chacha20_chacha20_decrypt.c", directory: "/home/luwei/bech-back/HACL/ChaCha20")
...
!777 = distinct !DISubprogram(name: "Hacl_Chacha20_chacha20_decrypt_wrapper", scope: !19, file: !19, line: 3, type: !746, scopeLine: 9, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !18, retainedNodes: !4)
...
!801 = distinct !DISubprogram(name: "Hacl_Chacha20_chacha20_decrypt_wrapper_t", scope: !19, file: !19, line: 27, type: !802, scopeLine: 27, spFlags: DISPFlagDefinition, unit: !18, retainedNodes: !4)
