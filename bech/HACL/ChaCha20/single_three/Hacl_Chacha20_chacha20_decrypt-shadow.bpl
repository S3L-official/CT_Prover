...
$bb3:
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Chacha20.c", 163, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p264 == $p264.shadow));
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Chacha20.c", 163, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p289 == $p289.shadow));
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Chacha20.c", 163, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p308 == $p308.shadow));
...
{
$bb0:
  $shadow_ok := ($shadow_ok && (chacha20_constants == chacha20_constants));
  $M.0 := $store.i32($M.0,chacha20_constants,1634760805);
  $M.0.shadow := $store.i32($M.0.shadow,chacha20_constants,1634760805);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(chacha20_constants,$mul.ref(0,16)),$mul.ref(1,4)) == $add.ref($add.ref(chacha20_constants,$mul.ref(0,16)),$mul.ref(1,4))));
  ...
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(chacha20_constants,$mul.ref(0,16)),$mul.ref(2,4)) == $add.ref($add.ref(chacha20_constants,$mul.ref(0,16)),$mul.ref(2,4))));
  ...
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(chacha20_constants,$mul.ref(0,16)),$mul.ref(3,4)) == $add.ref($add.ref(chacha20_constants,$mul.ref(0,16)),$mul.ref(3,4))));
