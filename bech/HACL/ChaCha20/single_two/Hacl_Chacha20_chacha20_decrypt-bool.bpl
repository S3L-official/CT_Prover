...
procedure {:inline 1} Hacl_Chacha20_chacha20_decrypt($i0: i32, $i0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1, $p3: ref, $p3.dup: i1, $p4: ref, $p4.dup: i1, $i5: i32, $i5.dup: i1)
modifies $M.1, $exn;
modifies $M.3;
...
procedure {:entrypoint} Hacl_Chacha20_chacha20_decrypt_wrapper($i0: i32, $i0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1, $p3: ref, $p3.dup: i1, $p4: ref, $p4.dup: i1, $i5: i32, $i5.dup: i1)
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call Hacl_Chacha20_chacha20_decrypt($i0, $i0.dup, $p1, $p1.dup, $p2, $p2.dup, $p3, $p3.dup, $p4, $p4.dup, $i5, $i5.dup);
