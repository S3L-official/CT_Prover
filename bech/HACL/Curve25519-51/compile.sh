...
# 四个需要指定的选项
deps=( ../hacl-star/dist/gcc-compatible/Hacl_Curve25519_51.c)

source=Hacl_Curve25519_51_secret_to_public.c
...
source=Hacl_Curve25519_51_scalarmult.c
...
source=Hacl_Curve25519_51_ecdh.c
