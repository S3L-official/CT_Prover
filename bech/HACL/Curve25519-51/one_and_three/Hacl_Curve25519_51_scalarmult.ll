; ModuleID = 'Hacl_Curve25519_51_scalarmult.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Curve25519_51_scalarmult_wrapper(i8* %0, i8* %1, i8* %2) #0 !dbg !2047 {
  ...
  call void @llvm.dbg.value(metadata i8* %2, metadata !2051, metadata !DIExpression()), !dbg !2049
  %4 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %0), !dbg !2052
  call void @public_in(%struct.smack_value* %4), !dbg !2053
  %5 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %1), !dbg !2054
  call void @public_in(%struct.smack_value* %5), !dbg !2055
  %6 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %2), !dbg !2056
  call void @public_in(%struct.smack_value* %6), !dbg !2057
  %7 = call %struct.smack_value* @__SMACK_values(i8* %2, i32 32), !dbg !2058
  call void @public_in(%struct.smack_value* %7), !dbg !2059
  %8 = call %struct.smack_value* @__SMACK_values(i8* %0, i32 32), !dbg !2060
  call void @public_in(%struct.smack_value* %8), !dbg !2061
  call void @Hacl_Curve25519_51_scalarmult(i8* %0, i8* %1, i8* %2), !dbg !2062
  ret void, !dbg !2063
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Curve25519_51_scalarmult_wrapper_t() #0 !dbg !2064 {
  %1 = call i8* (...) @getpt1(), !dbg !2067
  call void @llvm.dbg.value(metadata i8* %1, metadata !2068, metadata !DIExpression()), !dbg !2069
  %2 = call i8* (...) @getpt2(), !dbg !2070
  call void @llvm.dbg.value(metadata i8* %2, metadata !2071, metadata !DIExpression()), !dbg !2069
  %3 = call i8* (...) @getpt3(), !dbg !2072
  call void @llvm.dbg.value(metadata i8* %3, metadata !2073, metadata !DIExpression()), !dbg !2069
  call void @Hacl_Curve25519_51_scalarmult(i8* %1, i8* %2, i8* %3), !dbg !2074
  ret void, !dbg !2075
}
...
!27 = !DIFile(filename: "Hacl_Curve25519_51_scalarmult.c", directory: "/home/luwei/bech-back/hacl/curve25519-51")
...
!2047 = distinct !DISubprogram(name: "Hacl_Curve25519_51_scalarmult_wrapper", scope: !27, file: !27, line: 3, type: !483, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !26, retainedNodes: !4)
!2048 = !DILocalVariable(name: "shared", arg: 1, scope: !2047, file: !27, line: 3, type: !485)
!2049 = !DILocation(line: 0, scope: !2047)
!2050 = !DILocalVariable(name: "my_priv", arg: 2, scope: !2047, file: !27, line: 3, type: !485)
!2051 = !DILocalVariable(name: "their_pub", arg: 3, scope: !2047, file: !27, line: 3, type: !485)
!2052 = !DILocation(line: 5, column: 13, scope: !2047)
!2053 = !DILocation(line: 5, column: 3, scope: !2047)
!2054 = !DILocation(line: 6, column: 13, scope: !2047)
!2055 = !DILocation(line: 6, column: 3, scope: !2047)
!2056 = !DILocation(line: 7, column: 13, scope: !2047)
!2057 = !DILocation(line: 7, column: 3, scope: !2047)
!2058 = !DILocation(line: 8, column: 13, scope: !2047)
!2059 = !DILocation(line: 8, column: 3, scope: !2047)
!2060 = !DILocation(line: 9, column: 13, scope: !2047)
!2061 = !DILocation(line: 9, column: 3, scope: !2047)
!2062 = !DILocation(line: 10, column: 3, scope: !2047)
!2063 = !DILocation(line: 11, column: 1, scope: !2047)
!2064 = distinct !DISubprogram(name: "Hacl_Curve25519_51_scalarmult_wrapper_t", scope: !27, file: !27, line: 17, type: !2065, scopeLine: 17, spFlags: DISPFlagDefinition, unit: !26, retainedNodes: !4)
!2065 = !DISubroutineType(types: !2066)
!2066 = !{null}
!2067 = !DILocation(line: 18, column: 20, scope: !2064)
!2068 = !DILocalVariable(name: "shared", scope: !2064, file: !27, line: 18, type: !485)
!2069 = !DILocation(line: 0, scope: !2064)
!2070 = !DILocation(line: 19, column: 21, scope: !2064)
!2071 = !DILocalVariable(name: "my_priv", scope: !2064, file: !27, line: 19, type: !485)
!2072 = !DILocation(line: 20, column: 24, scope: !2064)
!2073 = !DILocalVariable(name: "their_pub", scope: !2064, file: !27, line: 20, type: !485)
!2074 = !DILocation(line: 21, column: 2, scope: !2064)
!2075 = !DILocation(line: 22, column: 1, scope: !2064)
