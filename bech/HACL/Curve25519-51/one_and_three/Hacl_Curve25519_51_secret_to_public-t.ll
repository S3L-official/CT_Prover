; ModuleID = 'Hacl_Curve25519_51_secret_to_public-k.ll'
...
32:                                               ; preds = %24
  ...
  %35 = getelementptr inbounds i8, i8* %0, i64 %34, !dbg !3287, !psr.id !3291
  ...
  %43 = getelementptr inbounds i8, i8* %0, i64 %42, !dbg !3299, !psr.id !3303
  ...
  %51 = getelementptr inbounds i8, i8* %0, i64 %50, !dbg !3311, !psr.id !3315
  ...
  %59 = getelementptr inbounds i8, i8* %0, i64 %58, !dbg !3323, !psr.id !3327
...
6:                                                ; preds = %20, %3
  %.01 = phi i8 [ -1, %3 ], [ %19, %20 ], !dbg !9629, !psr.id !9650
...
8:                                                ; preds = %6
  ...
  %10 = getelementptr inbounds i8, i8* %0, i64 %9, !dbg !9659, !psr.id !9662
  %11 = load i8, i8* %10, align 1, !dbg !9659, !psr.id !9663
  ...
  %15 = call zeroext i8 @FStar_UInt8_eq_mask(i8 zeroext %11, i8 zeroext %14), !dbg !9668, !psr.id !9669
  call void @llvm.dbg.value(metadata i8 %15, metadata !9670, metadata !DIExpression()), !dbg !9671, !psr.id !9672
  %16 = zext i8 %15 to i32, !dbg !9673, !psr.id !9674
  %17 = zext i8 %.01 to i32, !dbg !9675, !psr.id !9676
  %18 = and i32 %16, %17, !dbg !9677, !psr.id !9678
  %19 = trunc i32 %18 to i8, !dbg !9673, !psr.id !9679
...
22:                                               ; preds = %6
  ...
  %23 = zext i8 %.01 to i32, !dbg !9692, !psr.id !9693
  %24 = icmp eq i32 %23, 255, !dbg !9694, !psr.id !9695
  %25 = zext i1 %24 to i8, !dbg !9696, !psr.id !9697
  call void @llvm.dbg.value(metadata i8 %25, metadata !9698, metadata !DIExpression()), !dbg !9629, !psr.id !9699
  %26 = trunc i8 %25 to i1, !dbg !9700, !psr.id !9701
  %27 = xor i1 %26, true, !dbg !9702, !psr.id !9703
...
define internal zeroext i8 @FStar_UInt8_eq_mask(i8 zeroext %0, i8 zeroext %1) #0 !dbg !9706 {
  ...
  %3 = zext i8 %0 to i32, !dbg !9714, !psr.id !9715
  %4 = zext i8 %1 to i32, !dbg !9716, !psr.id !9717
  %5 = xor i32 %3, %4, !dbg !9718, !psr.id !9719
  %6 = trunc i32 %5 to i8, !dbg !9714, !psr.id !9720
  call void @llvm.dbg.value(metadata i8 %6, metadata !9721, metadata !DIExpression()), !dbg !9710, !psr.id !9722
  %7 = zext i8 %6 to i32, !dbg !9723, !psr.id !9724
  %8 = xor i32 %7, -1, !dbg !9725, !psr.id !9726
  %9 = add nsw i32 %8, 1, !dbg !9727, !psr.id !9728
  %10 = trunc i32 %9 to i8, !dbg !9725, !psr.id !9729
  call void @llvm.dbg.value(metadata i8 %10, metadata !9730, metadata !DIExpression()), !dbg !9710, !psr.id !9731
  %11 = zext i8 %6 to i32, !dbg !9732, !psr.id !9733
  %12 = zext i8 %10 to i32, !dbg !9734, !psr.id !9735
  %13 = or i32 %11, %12, !dbg !9736, !psr.id !9737
  %14 = trunc i32 %13 to i8, !dbg !9732, !psr.id !9738
  call void @llvm.dbg.value(metadata i8 %14, metadata !9739, metadata !DIExpression()), !dbg !9710, !psr.id !9740
  %15 = zext i8 %14 to i32, !dbg !9741, !psr.id !9742
  %16 = ashr i32 %15, 7, !dbg !9743, !psr.id !9744
  %17 = trunc i32 %16 to i8, !dbg !9741, !psr.id !9745
  call void @llvm.dbg.value(metadata i8 %17, metadata !9746, metadata !DIExpression()), !dbg !9710, !psr.id !9747
  %18 = zext i8 %17 to i32, !dbg !9748, !psr.id !9749
  %19 = sub nsw i32 %18, 1, !dbg !9750, !psr.id !9751
  %20 = trunc i32 %19 to i8, !dbg !9748, !psr.id !9752
  ret i8 %20, !dbg !9753, !psr.id !9754
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Curve25519_51_secret_to_public_wrapper(i8* %0, i8* %1) #0 !dbg !9755 {
  ...
  %3 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %0), !dbg !9761, !psr.id !9762
  call void @public_in(%struct.smack_value* %3), !dbg !9763, !psr.id !9764
  %4 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %1), !dbg !9765, !psr.id !9766
  call void @public_in(%struct.smack_value* %4), !dbg !9767, !psr.id !9768
  %5 = call %struct.smack_value* @__SMACK_values(i8* %0, i32 32), !dbg !9769, !psr.id !9770
  call void @public_in(%struct.smack_value* %5), !dbg !9771, !psr.id !9772
  call void @Hacl_Curve25519_51_secret_to_public(i8* %0, i8* %1), !dbg !9773, !psr.id !9774
  ret void, !dbg !9775, !psr.id !9776
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Curve25519_51_secret_to_public_wrapper_t() #0 !dbg !9777 {
  %1 = call i8* (...) @getpt1(), !dbg !9780, !psr.id !9781
  call void @llvm.dbg.value(metadata i8* %1, metadata !9782, metadata !DIExpression()), !dbg !9783, !psr.id !9784
  %2 = call i8* (...) @getpt2(), !dbg !9785, !psr.id !9786
  call void @llvm.dbg.value(metadata i8* %2, metadata !9787, metadata !DIExpression()), !dbg !9783, !psr.id !9788
  call void @Hacl_Curve25519_51_secret_to_public(i8* %1, i8* %2), !dbg !9789, !psr.id !9790
  ret void, !dbg !9791, !psr.id !9792
}
...
entry:
  call void @Hacl_Curve25519_51_secret_to_public_wrapper_t()
  ret void
}
...
!28 = !DIFile(filename: "Hacl_Curve25519_51_secret_to_public.c", directory: "/home/luwei/bech-back/hacl/curve25519-51")
...
!9754 = !{!"7705"}
!9755 = distinct !DISubprogram(name: "Hacl_Curve25519_51_secret_to_public_wrapper", scope: !28, file: !28, line: 3, type: !9564, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !27, retainedNodes: !4)
!9756 = !DILocalVariable(name: "pub", arg: 1, scope: !9755, file: !28, line: 3, type: !2625)
!9757 = !DILocation(line: 0, scope: !9755)
!9758 = !{!"7706"}
!9759 = !DILocalVariable(name: "priv", arg: 2, scope: !9755, file: !28, line: 3, type: !2625)
!9760 = !{!"7707"}
!9761 = !DILocation(line: 5, column: 13, scope: !9755)
!9762 = !{!"7708"}
!9763 = !DILocation(line: 5, column: 3, scope: !9755)
!9764 = !{!"7709"}
!9765 = !DILocation(line: 6, column: 13, scope: !9755)
!9766 = !{!"7710"}
!9767 = !DILocation(line: 6, column: 3, scope: !9755)
!9768 = !{!"7711"}
!9769 = !DILocation(line: 7, column: 13, scope: !9755)
!9770 = !{!"7712"}
!9771 = !DILocation(line: 7, column: 3, scope: !9755)
!9772 = !{!"7713"}
!9773 = !DILocation(line: 8, column: 3, scope: !9755)
!9774 = !{!"7714"}
!9775 = !DILocation(line: 9, column: 1, scope: !9755)
!9776 = !{!"7715"}
!9777 = distinct !DISubprogram(name: "Hacl_Curve25519_51_secret_to_public_wrapper_t", scope: !28, file: !28, line: 14, type: !9778, scopeLine: 14, spFlags: DISPFlagDefinition, unit: !27, retainedNodes: !4)
!9778 = !DISubroutineType(types: !9779)
!9779 = !{null}
!9780 = !DILocation(line: 15, column: 17, scope: !9777)
!9781 = !{!"7716"}
!9782 = !DILocalVariable(name: "pub", scope: !9777, file: !28, line: 15, type: !2625)
!9783 = !DILocation(line: 0, scope: !9777)
!9784 = !{!"7717"}
!9785 = !DILocation(line: 16, column: 18, scope: !9777)
!9786 = !{!"7718"}
!9787 = !DILocalVariable(name: "priv", scope: !9777, file: !28, line: 16, type: !2625)
!9788 = !{!"7719"}
!9789 = !DILocation(line: 17, column: 2, scope: !9777)
!9790 = !{!"7720"}
!9791 = !DILocation(line: 18, column: 1, scope: !9777)
!9792 = !{!"7721"}
