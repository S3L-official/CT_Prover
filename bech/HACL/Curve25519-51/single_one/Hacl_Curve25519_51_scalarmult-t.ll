; ModuleID = 'Hacl_Curve25519_51_scalarmult-k.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Curve25519_51_scalarmult_wrapper(i8* %0, i8* %1, i8* %2) #0 !dbg !9755 {
  ...
  %8 = call %struct.smack_value* @__SMACK_values(i8* %0, i32 32), !dbg !9779, !psr.id !9780
  call void @public_in(%struct.smack_value* %8), !dbg !9781, !psr.id !9782
  call void @Hacl_Curve25519_51_scalarmult(i8* %0, i8* %1, i8* %2), !dbg !9783, !psr.id !9784
  ret void, !dbg !9785, !psr.id !9786
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Curve25519_51_scalarmult_wrapper_t() #0 !dbg !9787 {
  %1 = call i8* (...) @getpt1(), !dbg !9790, !psr.id !9791
  call void @llvm.dbg.value(metadata i8* %1, metadata !9792, metadata !DIExpression()), !dbg !9793, !psr.id !9794
  %2 = call i8* (...) @getpt2(), !dbg !9795, !psr.id !9796
  call void @llvm.dbg.value(metadata i8* %2, metadata !9797, metadata !DIExpression()), !dbg !9793, !psr.id !9798
  %3 = call i8* (...) @getpt3(), !dbg !9799, !psr.id !9800
  call void @llvm.dbg.value(metadata i8* %3, metadata !9801, metadata !DIExpression()), !dbg !9793, !psr.id !9802
  call void @Hacl_Curve25519_51_scalarmult(i8* %1, i8* %2, i8* %3), !dbg !9803, !psr.id !9804
  ret void, !dbg !9805, !psr.id !9806
}
...
entry:
  call void @Hacl_Curve25519_51_scalarmult_wrapper_t()
  ret void
}
...
!28 = !DIFile(filename: "Hacl_Curve25519_51_scalarmult.c", directory: "/home/luwei/bech-back/hacl/curve25519-51")
...
!9754 = !{!"7705"}
!9755 = distinct !DISubprogram(name: "Hacl_Curve25519_51_scalarmult_wrapper", scope: !28, file: !28, line: 3, type: !2623, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !27, retainedNodes: !4)
!9756 = !DILocalVariable(name: "shared", arg: 1, scope: !9755, file: !28, line: 3, type: !2625)
!9757 = !DILocation(line: 0, scope: !9755)
!9758 = !{!"7706"}
!9759 = !DILocalVariable(name: "my_priv", arg: 2, scope: !9755, file: !28, line: 3, type: !2625)
!9760 = !{!"7707"}
!9761 = !DILocalVariable(name: "their_pub", arg: 3, scope: !9755, file: !28, line: 3, type: !2625)
!9762 = !{!"7708"}
...
!9778 = !{!"7716"}
!9779 = !DILocation(line: 9, column: 13, scope: !9755)
!9780 = !{!"7717"}
!9781 = !DILocation(line: 9, column: 3, scope: !9755)
!9782 = !{!"7718"}
!9783 = !DILocation(line: 10, column: 3, scope: !9755)
!9784 = !{!"7719"}
!9785 = !DILocation(line: 11, column: 1, scope: !9755)
!9786 = !{!"7720"}
!9787 = distinct !DISubprogram(name: "Hacl_Curve25519_51_scalarmult_wrapper_t", scope: !28, file: !28, line: 17, type: !9788, scopeLine: 17, spFlags: DISPFlagDefinition, unit: !27, retainedNodes: !4)
!9788 = !DISubroutineType(types: !9789)
!9789 = !{null}
!9790 = !DILocation(line: 18, column: 20, scope: !9787)
!9791 = !{!"7721"}
!9792 = !DILocalVariable(name: "shared", scope: !9787, file: !28, line: 18, type: !2625)
!9793 = !DILocation(line: 0, scope: !9787)
!9794 = !{!"7722"}
!9795 = !DILocation(line: 19, column: 21, scope: !9787)
!9796 = !{!"7723"}
!9797 = !DILocalVariable(name: "my_priv", scope: !9787, file: !28, line: 19, type: !2625)
!9798 = !{!"7724"}
!9799 = !DILocation(line: 20, column: 24, scope: !9787)
!9800 = !{!"7725"}
!9801 = !DILocalVariable(name: "their_pub", scope: !9787, file: !28, line: 20, type: !2625)
!9802 = !{!"7726"}
!9803 = !DILocation(line: 21, column: 2, scope: !9787)
!9804 = !{!"7727"}
!9805 = !DILocation(line: 22, column: 1, scope: !9787)
!9806 = !{!"7728"}
