...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,57792));
...
const Hacl_Curve25519_64_scalarmult_wrapper: ref;
axiom (Hacl_Curve25519_64_scalarmult_wrapper == $sub.ref(0,37152));
procedure {:entrypoint} Hacl_Curve25519_64_scalarmult_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 5, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:Hacl_Curve25519_64_scalarmult_wrapper"} boogie_si_record_ref(Hacl_Curve25519_64_scalarmult_wrapper);
  call {:cexpr "smack:arg:Hacl_Curve25519_64_scalarmult_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:Hacl_Curve25519_64_scalarmult_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:Hacl_Curve25519_64_scalarmult_wrapper:$p2"} boogie_si_record_ref($p2);
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 5, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 5, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p3, $p3.shadow);
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p4 := __SMACK_value.ref($p1);
  $p4.shadow := $p4;
  assume $isExternal($p4);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p4);
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 6, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 7, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p2} $p5 := __SMACK_value.ref($p2);
  $p5.shadow := $p5;
  assume $isExternal($p5);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p5);
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 7, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 8, 13} true;
  ...
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p6, $p6.shadow);
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 9, 13} true;
  assume {:verifier.code 1} true;
  call {:name $p0} {:array "$load.i8", $M.8, $p0, 1, 32} $p7 := __SMACK_values($p0, 32);
  $p7.shadow := $p7;
  assume $isExternal($p7);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p7);
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 9, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p7, $p7.shadow);
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Curve25519_64_scalarmult($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "Hacl_Curve25519_64_scalarmult.c", 11, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
...
axiom (__SMACK_dummy == $sub.ref(0,43344));
...
axiom (__SMACK_and32 == $sub.ref(0,44376));
...
axiom (__SMACK_and64 == $sub.ref(0,45408));
...
axiom (__SMACK_and16 == $sub.ref(0,46440));
...
axiom (__SMACK_and8 == $sub.ref(0,47472));
...
axiom (__SMACK_or32 == $sub.ref(0,48504));
...
axiom (__SMACK_or64 == $sub.ref(0,49536));
...
axiom (__SMACK_or16 == $sub.ref(0,50568));
...
axiom (__SMACK_or8 == $sub.ref(0,51600));
...
axiom (__SMACK_check_overflow == $sub.ref(0,52632));
...
axiom (__SMACK_loop_exit == $sub.ref(0,53664));
...
axiom (__SMACK_decls == $sub.ref(0,54696));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,55728));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,56760));
...
axiom (__SMACK_static_init == $sub.ref(0,57792));
