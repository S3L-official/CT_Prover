...
# 四个需要指定的选项
deps=( ../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c)

source=Hacl_Curve25519_64_secret_to_public.c
...
source=Hacl_Curve25519_64_scalarmult.c
...
source=Hacl_Curve25519_64_ecdh.c
