; ModuleID = 'Hacl_Curve25519_64_secret_to_public.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Curve25519_64_secret_to_public_wrapper(i8* %0, i8* %1) #0 !dbg !844 {
  ...
  %3 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %0), !dbg !848
  call void @public_in(%struct.smack_value* %3), !dbg !849
  %4 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %1), !dbg !850
  call void @public_in(%struct.smack_value* %4), !dbg !851
  %5 = call %struct.smack_value* @__SMACK_values(i8* %0, i32 32), !dbg !852
  call void @public_in(%struct.smack_value* %5), !dbg !853
  call void @Hacl_Curve25519_64_secret_to_public(i8* %0, i8* %1), !dbg !854
  ret void, !dbg !855
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Curve25519_64_secret_to_public_wrapper_t() #0 !dbg !856 {
  %1 = call i8* (...) @getpt1(), !dbg !859
  call void @llvm.dbg.value(metadata i8* %1, metadata !860, metadata !DIExpression()), !dbg !861
  %2 = call i8* (...) @getpt2(), !dbg !862
  call void @llvm.dbg.value(metadata i8* %2, metadata !863, metadata !DIExpression()), !dbg !861
  call void @Hacl_Curve25519_64_secret_to_public(i8* %1, i8* %2), !dbg !864
  ret void, !dbg !865
}
...
!23 = !DIFile(filename: "Hacl_Curve25519_64_secret_to_public.c", directory: "/home/luwei/bech-back/HACL/Curve25519-64")
...
!844 = distinct !DISubprogram(name: "Hacl_Curve25519_64_secret_to_public_wrapper", scope: !23, file: !23, line: 3, type: !748, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !22, retainedNodes: !4)
!845 = !DILocalVariable(name: "pub", arg: 1, scope: !844, file: !23, line: 3, type: !31)
!846 = !DILocation(line: 0, scope: !844)
!847 = !DILocalVariable(name: "priv", arg: 2, scope: !844, file: !23, line: 3, type: !31)
!848 = !DILocation(line: 5, column: 13, scope: !844)
!849 = !DILocation(line: 5, column: 3, scope: !844)
!850 = !DILocation(line: 6, column: 13, scope: !844)
!851 = !DILocation(line: 6, column: 3, scope: !844)
!852 = !DILocation(line: 7, column: 13, scope: !844)
!853 = !DILocation(line: 7, column: 3, scope: !844)
!854 = !DILocation(line: 8, column: 3, scope: !844)
!855 = !DILocation(line: 9, column: 1, scope: !844)
!856 = distinct !DISubprogram(name: "Hacl_Curve25519_64_secret_to_public_wrapper_t", scope: !23, file: !23, line: 14, type: !857, scopeLine: 14, spFlags: DISPFlagDefinition, unit: !22, retainedNodes: !4)
!857 = !DISubroutineType(types: !858)
!858 = !{null}
!859 = !DILocation(line: 15, column: 17, scope: !856)
!860 = !DILocalVariable(name: "pub", scope: !856, file: !23, line: 15, type: !31)
!861 = !DILocation(line: 0, scope: !856)
!862 = !DILocation(line: 16, column: 18, scope: !856)
!863 = !DILocalVariable(name: "priv", scope: !856, file: !23, line: 16, type: !31)
!864 = !DILocation(line: 17, column: 2, scope: !856)
!865 = !DILocation(line: 18, column: 1, scope: !856)
