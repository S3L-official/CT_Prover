; ModuleID = 'Hacl_Curve25519_64_scalarmult.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Curve25519_64_scalarmult_wrapper(i8* %0, i8* %1, i8* %2) #0 !dbg !844 {
  ...
  %8 = call %struct.smack_value* @__SMACK_values(i8* %0, i32 32), !dbg !857
  call void @public_in(%struct.smack_value* %8), !dbg !858
  call void @Hacl_Curve25519_64_scalarmult(i8* %0, i8* %1, i8* %2), !dbg !859
  ret void, !dbg !860
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Curve25519_64_scalarmult_wrapper_t() #0 !dbg !861 {
  %1 = call i8* (...) @getpt1(), !dbg !864
  call void @llvm.dbg.value(metadata i8* %1, metadata !865, metadata !DIExpression()), !dbg !866
  %2 = call i8* (...) @getpt2(), !dbg !867
  call void @llvm.dbg.value(metadata i8* %2, metadata !868, metadata !DIExpression()), !dbg !866
  %3 = call i8* (...) @getpt3(), !dbg !869
  call void @llvm.dbg.value(metadata i8* %3, metadata !870, metadata !DIExpression()), !dbg !866
  call void @Hacl_Curve25519_64_scalarmult(i8* %1, i8* %2, i8* %3), !dbg !871
  ret void, !dbg !872
}
...
!23 = !DIFile(filename: "Hacl_Curve25519_64_scalarmult.c", directory: "/home/luwei/bech-back/HACL/Curve25519-64")
...
!844 = distinct !DISubprogram(name: "Hacl_Curve25519_64_scalarmult_wrapper", scope: !23, file: !23, line: 3, type: !29, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !22, retainedNodes: !4)
!845 = !DILocalVariable(name: "shared", arg: 1, scope: !844, file: !23, line: 3, type: !31)
!846 = !DILocation(line: 0, scope: !844)
!847 = !DILocalVariable(name: "my_priv", arg: 2, scope: !844, file: !23, line: 3, type: !31)
!848 = !DILocalVariable(name: "their_pub", arg: 3, scope: !844, file: !23, line: 3, type: !31)
...
!857 = !DILocation(line: 9, column: 13, scope: !844)
!858 = !DILocation(line: 9, column: 3, scope: !844)
!859 = !DILocation(line: 10, column: 3, scope: !844)
!860 = !DILocation(line: 11, column: 1, scope: !844)
!861 = distinct !DISubprogram(name: "Hacl_Curve25519_64_scalarmult_wrapper_t", scope: !23, file: !23, line: 17, type: !862, scopeLine: 17, spFlags: DISPFlagDefinition, unit: !22, retainedNodes: !4)
!862 = !DISubroutineType(types: !863)
!863 = !{null}
!864 = !DILocation(line: 18, column: 20, scope: !861)
!865 = !DILocalVariable(name: "shared", scope: !861, file: !23, line: 18, type: !31)
!866 = !DILocation(line: 0, scope: !861)
!867 = !DILocation(line: 19, column: 21, scope: !861)
!868 = !DILocalVariable(name: "my_priv", scope: !861, file: !23, line: 19, type: !31)
!869 = !DILocation(line: 20, column: 24, scope: !861)
!870 = !DILocalVariable(name: "their_pub", scope: !861, file: !23, line: 20, type: !31)
!871 = !DILocation(line: 21, column: 2, scope: !861)
!872 = !DILocation(line: 22, column: 1, scope: !861)
