; ModuleID = 'Hacl_Curve25519_64_scalarmult-k.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Curve25519_64_scalarmult_wrapper(i8* %0, i8* %1, i8* %2) #0 !dbg !1669 {
  ...
  %8 = call %struct.smack_value* @__SMACK_values(i8* %0, i32 32), !dbg !1693, !psr.id !1694
  call void @public_in(%struct.smack_value* %8), !dbg !1695, !psr.id !1696
  call void @Hacl_Curve25519_64_scalarmult(i8* %0, i8* %1, i8* %2), !dbg !1697, !psr.id !1698
  ret void, !dbg !1699, !psr.id !1700
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Curve25519_64_scalarmult_wrapper_t() #0 !dbg !1701 {
  %1 = call i8* (...) @getpt1(), !dbg !1704, !psr.id !1705
  call void @llvm.dbg.value(metadata i8* %1, metadata !1706, metadata !DIExpression()), !dbg !1707, !psr.id !1708
  %2 = call i8* (...) @getpt2(), !dbg !1709, !psr.id !1710
  call void @llvm.dbg.value(metadata i8* %2, metadata !1711, metadata !DIExpression()), !dbg !1707, !psr.id !1712
  %3 = call i8* (...) @getpt3(), !dbg !1713, !psr.id !1714
  call void @llvm.dbg.value(metadata i8* %3, metadata !1715, metadata !DIExpression()), !dbg !1707, !psr.id !1716
  call void @Hacl_Curve25519_64_scalarmult(i8* %1, i8* %2, i8* %3), !dbg !1717, !psr.id !1718
  ret void, !dbg !1719, !psr.id !1720
}
...
entry:
  call void @Hacl_Curve25519_64_scalarmult_wrapper_t()
  ret void
}
...
!24 = !DIFile(filename: "Hacl_Curve25519_64_scalarmult.c", directory: "/home/luwei/bech-back/HACL/Curve25519-64")
...
!1668 = !{!"822"}
!1669 = distinct !DISubprogram(name: "Hacl_Curve25519_64_scalarmult_wrapper", scope: !24, file: !24, line: 3, type: !30, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !23, retainedNodes: !4)
!1670 = !DILocalVariable(name: "shared", arg: 1, scope: !1669, file: !24, line: 3, type: !32)
!1671 = !DILocation(line: 0, scope: !1669)
!1672 = !{!"823"}
!1673 = !DILocalVariable(name: "my_priv", arg: 2, scope: !1669, file: !24, line: 3, type: !32)
!1674 = !{!"824"}
!1675 = !DILocalVariable(name: "their_pub", arg: 3, scope: !1669, file: !24, line: 3, type: !32)
!1676 = !{!"825"}
...
!1692 = !{!"833"}
!1693 = !DILocation(line: 9, column: 13, scope: !1669)
!1694 = !{!"834"}
!1695 = !DILocation(line: 9, column: 3, scope: !1669)
!1696 = !{!"835"}
!1697 = !DILocation(line: 10, column: 3, scope: !1669)
!1698 = !{!"836"}
!1699 = !DILocation(line: 11, column: 1, scope: !1669)
!1700 = !{!"837"}
!1701 = distinct !DISubprogram(name: "Hacl_Curve25519_64_scalarmult_wrapper_t", scope: !24, file: !24, line: 17, type: !1702, scopeLine: 17, spFlags: DISPFlagDefinition, unit: !23, retainedNodes: !4)
!1702 = !DISubroutineType(types: !1703)
!1703 = !{null}
!1704 = !DILocation(line: 18, column: 20, scope: !1701)
!1705 = !{!"838"}
!1706 = !DILocalVariable(name: "shared", scope: !1701, file: !24, line: 18, type: !32)
!1707 = !DILocation(line: 0, scope: !1701)
!1708 = !{!"839"}
!1709 = !DILocation(line: 19, column: 21, scope: !1701)
!1710 = !{!"840"}
!1711 = !DILocalVariable(name: "my_priv", scope: !1701, file: !24, line: 19, type: !32)
!1712 = !{!"841"}
!1713 = !DILocation(line: 20, column: 24, scope: !1701)
!1714 = !{!"842"}
!1715 = !DILocalVariable(name: "their_pub", scope: !1701, file: !24, line: 20, type: !32)
!1716 = !{!"843"}
!1717 = !DILocation(line: 21, column: 2, scope: !1701)
!1718 = !{!"844"}
!1719 = !DILocation(line: 22, column: 1, scope: !1701)
!1720 = !{!"845"}
