...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,59880));
...
const {:allocSize 32} g25519: ref;
axiom (g25519 == $sub.ref(0,1056));
const Hacl_Curve25519_64_scalarmult: ref;
axiom (Hacl_Curve25519_64_scalarmult == $sub.ref(0,2088));
procedure {:inline 1} Hacl_Curve25519_64_scalarmult($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
...
modifies $CurrAddr;
{
  ...
  var $p70.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 345, 12} true;
  ...
  $p5.shadow := $bitcast.ref.ref($p3.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 345, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p5 == $p5.shadow));
  call $M.0, $M.0.shadow := $memset.i8($M.0, $M.0.shadow, $p5, $p5.shadow, 0, 0, 64, 64, false, false);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 346, 12} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p4);
  $p6.shadow := $bitcast.ref.ref($p4.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 346, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p6 == $p6.shadow));
  call $M.1, $M.1.shadow := $memset.i8($M.1, $M.1.shadow, $p6, $p6.shadow, 0, 0, 32, 32, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  ...
  $p7.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32(0,8);
  $i8.shadow := $mul.i32(0,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.i32.i64($i8);
  ...
  $p10.shadow := $add.ref($p2.shadow,$mul.ref($i9.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $zext.i32.i64(0);
  $i13.shadow := $zext.i32.i64(0);
  $p14 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref($i13,8));
  $p14.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref($i13.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p14 == $p14.shadow));
  $M.1 := $store.i64($M.1,$p14,$i12);
  $M.1.shadow := $store.i64($M.1.shadow,$p14.shadow,$i12.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32(0,1);
  $i15.shadow := $add.i32(0,1);
  call {:cexpr "i"} boogie_si_record_i32($i15);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref(0,8));
  $p16.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $i17 := $mul.i32($i15,8);
  $i17.shadow := $mul.i32($i15.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p19.shadow := $add.ref($p2.shadow,$mul.ref($i18.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  call $i20, $i20.shadow := load64($p19, $p19.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  call $i21, $i21.shadow := __uint64_identity($i20, $i20.shadow);
  call {:cexpr "u"} boogie_si_record_i64($i21);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i32.i64($i15);
  $i22.shadow := $zext.i32.i64($i15.shadow);
  $p23 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref($i22,8));
  $p23.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref($i22.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p23 == $p23.shadow));
  $M.1 := $store.i64($M.1,$p23,$i21);
  $M.1.shadow := $store.i64($M.1.shadow,$p23.shadow,$i21.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i15,1);
  $i24.shadow := $add.i32($i15.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i24);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref(0,8));
  $p25.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $i26 := $mul.i32($i24,8);
  $i26.shadow := $mul.i32($i24.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p28.shadow := $add.ref($p2.shadow,$mul.ref($i27.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  call $i29, $i29.shadow := load64($p28, $p28.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  call $i30, $i30.shadow := __uint64_identity($i29, $i29.shadow);
  call {:cexpr "u"} boogie_si_record_i64($i30);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $i31 := $zext.i32.i64($i24);
  $i31.shadow := $zext.i32.i64($i24.shadow);
  $p32 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref($i31,8));
  $p32.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref($i31.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p32 == $p32.shadow));
  $M.1 := $store.i64($M.1,$p32,$i30);
  $M.1.shadow := $store.i64($M.1.shadow,$p32.shadow,$i30.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i24,1);
  $i33.shadow := $add.i32($i24.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i33);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref(0,8));
  $p34.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $i35 := $mul.i32($i33,8);
  $i35.shadow := $mul.i32($i33.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p37.shadow := $add.ref($p2.shadow,$mul.ref($i36.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  call $i38, $i38.shadow := load64($p37, $p37.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  call $i39, $i39.shadow := __uint64_identity($i38, $i38.shadow);
  call {:cexpr "u"} boogie_si_record_i64($i39);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $i40 := $zext.i32.i64($i33);
  $i40.shadow := $zext.i32.i64($i33.shadow);
  $p41 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref($i40,8));
  $p41.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref($i40.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p41 == $p41.shadow));
  $M.1 := $store.i64($M.1,$p41,$i39);
  $M.1.shadow := $store.i64($M.1.shadow,$p41.shadow,$i39.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 347, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 357, 19} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref(3,8));
  $p42.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 357, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p42 == $p42.shadow));
  $i43 := $load.i64($M.1,$p42);
  $i43.shadow := $load.i64($M.1.shadow,$p42.shadow);
  call {:cexpr "tmp3"} boogie_si_record_i64($i43);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 358, 18} true;
  assume {:verifier.code 0} true;
  $i44 := $and.i64($i43,9223372036854775807);
  $i44.shadow := $and.i64($i43.shadow,9223372036854775807);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 358, 3} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref(3,8));
  $p45.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 358, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p45 == $p45.shadow));
  $M.1 := $store.i64($M.1,$p45,$i44);
  $M.1.shadow := $store.i64($M.1.shadow,$p45.shadow,$i44.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 359, 17} true;
  assume {:verifier.code 0} true;
  $p46 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,8));
  $p46.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 360, 17} true;
  assume {:verifier.code 0} true;
  $p47 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,8));
  $p47.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  $p48 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(4,8));
  $p48.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(4,8));
  $p49 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(4,8));
  $p49.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 361, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p49 == $p49.shadow));
  $M.0 := $store.i64($M.0,$p49,1);
  $M.0.shadow := $store.i64($M.0.shadow,$p49.shadow,1);
  $i50 := $add.i64(4,1);
  $i50.shadow := $add.i64(4,1);
  $p51 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref($i50,8));
  $p51.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref($i50.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 362, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p51 == $p51.shadow));
  $M.0 := $store.i64($M.0,$p51,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p51.shadow,0);
  $i52 := $add.i64(4,2);
  $i52.shadow := $add.i64(4,2);
  $p53 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref($i52,8));
  $p53.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref($i52.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 363, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p53 == $p53.shadow));
  $M.0 := $store.i64($M.0,$p53,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p53.shadow,0);
  $i54 := $add.i64(4,3);
  $i54.shadow := $add.i64(4,3);
  $p55 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref($i54,8));
  $p55.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref($i54.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 364, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p55 == $p55.shadow));
  $M.0 := $store.i64($M.0,$p55,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p55.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 365, 11} true;
  assume {:verifier.code 0} true;
  $p56 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref(0,8));
  $p56.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 365, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p56 == $p56.shadow));
  $i57 := $load.i64($M.1,$p56);
  $i57.shadow := $load.i64($M.1.shadow,$p56.shadow);
  $p58 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,8));
  $p58.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 365, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p58 == $p58.shadow));
  $M.0 := $store.i64($M.0,$p58,$i57);
  $M.0.shadow := $store.i64($M.0.shadow,$p58.shadow,$i57.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 366, 11} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref(1,8));
  $p59.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 366, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p59 == $p59.shadow));
  $i60 := $load.i64($M.1,$p59);
  $i60.shadow := $load.i64($M.1.shadow,$p59.shadow);
  $p61 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(1,8));
  $p61.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 366, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p61 == $p61.shadow));
  $M.0 := $store.i64($M.0,$p61,$i60);
  $M.0.shadow := $store.i64($M.0.shadow,$p61.shadow,$i60.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 367, 11} true;
  assume {:verifier.code 0} true;
  $p62 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref(2,8));
  $p62.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 367, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p62 == $p62.shadow));
  $i63 := $load.i64($M.1,$p62);
  $i63.shadow := $load.i64($M.1.shadow,$p62.shadow);
  $p64 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(2,8));
  $p64.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 367, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p64 == $p64.shadow));
  $M.0 := $store.i64($M.0,$p64,$i63);
  $M.0.shadow := $store.i64($M.0.shadow,$p64.shadow,$i63.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 368, 11} true;
  assume {:verifier.code 0} true;
  $p65 := $add.ref($add.ref($p4,$mul.ref(0,32)),$mul.ref(3,8));
  $p65.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,32)),$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 368, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p65 == $p65.shadow));
  $i66 := $load.i64($M.1,$p65);
  $i66.shadow := $load.i64($M.1.shadow,$p65.shadow);
  $p67 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(3,8));
  $p67.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 368, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p67 == $p67.shadow));
  $M.0 := $store.i64($M.0,$p67,$i66);
  $M.0.shadow := $store.i64($M.0.shadow,$p67.shadow,$i66.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 369, 21} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,8));
  $p68.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 369, 33} true;
  assume {:verifier.code 0} true;
  $p69 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,8));
  $p69.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 369, 3} true;
  assume {:verifier.code 0} true;
  call montgomery_ladder($p68, $p68.shadow, $p1, $p1.shadow, $p69, $p69.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 370, 21} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($add.ref($p3,$mul.ref(0,64)),$mul.ref(0,8));
  $p70.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,64)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 370, 3} true;
  assume {:verifier.code 0} true;
  call encode_point($p0, $p0.shadow, $p70, $p70.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 371, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
$bb0:
  ...
  call $M.3, $M.3.shadow := $memcpy.i8($M.3, $M.3.shadow, $M.2, $M.2.shadow, $p2, $p2.shadow, $p0, $p0.shadow, 8, 8, false, false);
  assume {:sourceloc "../hacl-star/dist/karamel/include/krml/lowstar_endianness.h", 175, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p1 == $p1.shadow));
  $i3 := $load.i64($M.3,$p1);
  $i3.shadow := $load.i64($M.3.shadow,$p1.shadow);
...
axiom (__uint64_identity == $sub.ref(0,7248));
...
axiom (montgomery_ladder == $sub.ref(0,8280));
procedure {:inline 1} montgomery_ladder($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.4, $M.0, $exn;
modifies $CurrAddr;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $p63.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 184, 12} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(128,$zext.i32.i64(1)));
  $p3.shadow := $p3;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(264,$zext.i32.i64(1)));
  $p4.shadow := $p4;
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 184, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p5 == $p5.shadow));
  call $M.4, $M.4.shadow := $memset.i8($M.4, $M.4.shadow, $p5, $p5.shadow, 0, 0, 128, 128, false, false);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 185, 12} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p4);
  $p6.shadow := $bitcast.ref.ref($p4.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 185, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p6 == $p6.shadow));
  call $M.0, $M.0.shadow := $memset.i8($M.0, $M.0.shadow, $p6, $p6.shadow, 0, 0, 264, 264, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 186, 18} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(0,8));
  $p7.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 187, 19} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(0,8));
  $p8.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(0,8));
  $p9 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(8,8));
  $p9.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(8,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 190, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p11.shadow := $bitcast.ref.ref($p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 190, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p10 == $p10.shadow));
  $shadow_ok := ($shadow_ok && ($p11 == $p11.shadow));
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.0, $M.0.shadow, $p10, $p10.shadow, $p11, $p11.shadow, 64, 64, false, false);
  $p12 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(4,8));
  $p12.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(4,8));
  $p13 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(0,8));
  $p13.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 193, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p13 == $p13.shadow));
  $M.0 := $store.i64($M.0,$p13,1);
  $M.0.shadow := $store.i64($M.0.shadow,$p13.shadow,1);
  $p14 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(1,8));
  $p14.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 194, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p14 == $p14.shadow));
  $M.0 := $store.i64($M.0,$p14,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p14.shadow,0);
  $p15 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(2,8));
  $p15.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 195, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p15 == $p15.shadow));
  $M.0 := $store.i64($M.0,$p15,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p15.shadow,0);
  $p16 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(3,8));
  $p16.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 196, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p16 == $p16.shadow));
  $M.0 := $store.i64($M.0,$p16,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p16.shadow,0);
  $p17 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(4,8));
  $p17.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 197, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p17 == $p17.shadow));
  $M.0 := $store.i64($M.0,$p17,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p17.shadow,0);
  $i18 := $add.i64(4,1);
  $i18.shadow := $add.i64(4,1);
  $p19 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref($i18,8));
  $p19.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref($i18.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 198, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p19 == $p19.shadow));
  $M.0 := $store.i64($M.0,$p19,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p19.shadow,0);
  $i20 := $add.i64(4,2);
  $i20.shadow := $add.i64(4,2);
  $p21 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref($i20,8));
  $p21.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref($i20.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 199, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p21 == $p21.shadow));
  $M.0 := $store.i64($M.0,$p21,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p21.shadow,0);
  $i22 := $add.i64(4,3);
  $i22.shadow := $add.i64(4,3);
  $p23 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref($i22,8));
  $p23.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref($i22.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 200, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p23 == $p23.shadow));
  $M.0 := $store.i64($M.0,$p23,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p23.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 201, 24} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(0,8));
  $p24.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 202, 25} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(0,8));
  $p25.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 203, 19} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(0,8));
  $p26.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 204, 22} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(0,8));
  $p27.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(0,8));
  $p28 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(8,8));
  $p28.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(8,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 205, 20} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(0,8));
  $p29.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(0,8));
  $p30 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(32,8));
  $p30.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(32,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 206, 3} true;
  assume {:verifier.code 0} true;
  call cswap20(1, 1, $p26, $p26.shadow, $p28, $p28.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 207, 41} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p31.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 207, 3} true;
  assume {:verifier.code 0} true;
  call point_add_and_double($p2, $p2.shadow, $p25, $p25.shadow, $p31, $p31.shadow);
  $p32 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(32,8));
  $p32.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(32,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 208, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p32 == $p32.shadow));
  $M.0 := $store.i64($M.0,$p32,1);
  $M.0.shadow := $store.i64($M.0.shadow,$p32.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 209, 8} true;
  assume {:verifier.code 0} true;
  $i33 := 0;
  $i33.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assert {:likely_shadow_invariant} ($p24 == $p24.shadow);
  assert {:likely_shadow_invariant} ($p28 == $p28.shadow);
  assert {:likely_shadow_invariant} ($p26 == $p26.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 209, 37} true;
  assume {:verifier.code 0} true;
  $i34 := $ult.i32($i33,251);
  $i34.shadow := $ult.i32($i33.shadow,251);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 209, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i34 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 211, 27} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(0,8));
  $p35.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 212, 23} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(0,8));
  $p36.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(0,8));
  $p37 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(32,8));
  $p37.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(32,8));
  $p38 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(8,8));
  $p38.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(8,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 217, 38} true;
  assume {:verifier.code 0} true;
  $i39 := $sub.i32(253,$i33);
  $i39.shadow := $sub.i32(253,$i33.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 218, 7} true;
  assume {:verifier.code 0} true;
  $i40 := $udiv.i32($i39,8);
  $i40.shadow := $udiv.i32($i39.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 217, 18} true;
  assume {:verifier.code 0} true;
  ...
  $p42.shadow := $add.ref($p1.shadow,$mul.ref($i41.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 217, 18} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p42 == $p42.shadow));
  $i43 := $load.i8($M.5,$p42);
  $i43.shadow := $load.i8($M.5.shadow,$p42.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 217, 18} true;
  assume {:verifier.code 0} true;
  $i44 := $zext.i8.i32($i43);
  $i44.shadow := $zext.i8.i32($i43.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 219, 26} true;
  assume {:verifier.code 0} true;
  $i45 := $sub.i32(253,$i33);
  $i45.shadow := $sub.i32(253,$i33.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 219, 31} true;
  assume {:verifier.code 0} true;
  $i46 := $urem.i32($i45,8);
  $i46.shadow := $urem.i32($i45.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 219, 7} true;
  assume {:verifier.code 0} true;
  $i47 := $ashr.i32($i44,$i46);
  $i47.shadow := $ashr.i32($i44.shadow,$i46.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 220, 7} true;
  assume {:verifier.code 0} true;
  $i48 := $and.i32($i47,1);
  $i48.shadow := $and.i32($i47.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 217, 7} true;
  assume {:verifier.code 0} true;
  $i49 := $sext.i32.i64($i48);
  $i49.shadow := $sext.i32.i64($i48.shadow);
  call {:cexpr "bit"} boogie_si_record_i64($i49);
  $p50 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(32,8));
  $p50.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(32,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 221, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p50 == $p50.shadow));
  $i51 := $load.i64($M.0,$p50);
  $i51.shadow := $load.i64($M.0.shadow,$p50.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 221, 29} true;
  assume {:verifier.code 0} true;
  $i52 := $xor.i64($i51,$i49);
  $i52.shadow := $xor.i64($i51.shadow,$i49.shadow);
  call {:cexpr "sw"} boogie_si_record_i64($i52);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 222, 5} true;
  assume {:verifier.code 0} true;
  call cswap20($i52, $i52.shadow, $p35, $p35.shadow, $p38, $p38.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 223, 43} true;
  assume {:verifier.code 0} true;
  $p53 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p53.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 223, 5} true;
  assume {:verifier.code 0} true;
  call point_add_and_double($p2, $p2.shadow, $p35, $p35.shadow, $p53, $p53.shadow);
  $p54 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(32,8));
  $p54.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(32,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 224, 15} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p54 == $p54.shadow));
  $M.0 := $store.i64($M.0,$p54,$i49);
  $M.0.shadow := $store.i64($M.0.shadow,$p54.shadow,$i49.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 225, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i34 == 1);
  $p56 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(32,8));
  $p56.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(32,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 226, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p56 == $p56.shadow));
  $i57 := $load.i64($M.0,$p56);
  $i57.shadow := $load.i64($M.0.shadow,$p56.shadow);
  call {:cexpr "sw"} boogie_si_record_i64($i57);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 227, 3} true;
  assume {:verifier.code 0} true;
  call cswap20($i57, $i57.shadow, $p26, $p26.shadow, $p28, $p28.shadow);
  $p58 := $add.ref($add.ref($p4,$mul.ref(0,264)),$mul.ref(16,8));
  $p58.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,264)),$mul.ref(16,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 230, 28} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p59.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 230, 3} true;
  assume {:verifier.code 0} true;
  call point_double($p24, $p24.shadow, $p58, $p58.shadow, $p59, $p59.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 231, 28} true;
  assume {:verifier.code 0} true;
  $p60 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p60.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 231, 3} true;
  assume {:verifier.code 0} true;
  call point_double($p24, $p24.shadow, $p58, $p58.shadow, $p60, $p60.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 232, 28} true;
  assume {:verifier.code 0} true;
  $p61 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p61.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 232, 3} true;
  assume {:verifier.code 0} true;
  call point_double($p24, $p24.shadow, $p58, $p58.shadow, $p61, $p61.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 233, 3} true;
  assume {:verifier.code 0} true;
  $p62 := $bitcast.ref.ref($p0);
  $p62.shadow := $bitcast.ref.ref($p0.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 233, 3} true;
  assume {:verifier.code 0} true;
  $p63 := $bitcast.ref.ref($p7);
  $p63.shadow := $bitcast.ref.ref($p7.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 233, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p62 == $p62.shadow));
  $shadow_ok := ($shadow_ok && ($p63 == $p63.shadow));
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.0, $M.0.shadow, $p62, $p62.shadow, $p63, $p63.shadow, 64, 64, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 234, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 209, 56} true;
  assume {:verifier.code 0} true;
  $i55 := $add.i32($i33,1);
  $i55.shadow := $add.i32($i33.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i55);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 209, 3} true;
  assume {:verifier.code 0} true;
  $i33 := $i55;
  $i33.shadow := $i55.shadow;
  goto $bb1;
}
const encode_point: ref;
axiom (encode_point == $sub.ref(0,9312));
procedure {:inline 1} encode_point($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $M.0, $M.6, $M.4, $exn;
modifies $M.7, $M.8;
modifies $CurrAddr;
{
  var $p2: ref;
  ...
  var $i46.shadow: i64;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 322, 19} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  $p3.shadow := $p3;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(128,$zext.i32.i64(1)));
  $p4.shadow := $p4;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 322, 19} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p1,$mul.ref(4,8));
  $p5.shadow := $add.ref($p1.shadow,$mul.ref(4,8));
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 323, 12} true;
  assume {:verifier.code 0} true;
  $p6 := $bitcast.ref.ref($p2);
  $p6.shadow := $bitcast.ref.ref($p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 323, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p6 == $p6.shadow));
  call $M.0, $M.0.shadow := $memset.i8($M.0, $M.0.shadow, $p6, $p6.shadow, 0, 0, 32, 32, false, false);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 324, 12} true;
  assume {:verifier.code 0} true;
  $p7 := $bitcast.ref.ref($p3);
  $p7.shadow := $bitcast.ref.ref($p3.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 324, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p7 == $p7.shadow));
  call $M.6, $M.6.shadow := $memset.i8($M.6, $M.6.shadow, $p7, $p7.shadow, 0, 0, 32, 32, false, false);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 325, 12} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p4);
  $p8.shadow := $bitcast.ref.ref($p4.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 325, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p8 == $p8.shadow));
  call $M.4, $M.4.shadow := $memset.i8($M.4, $M.4.shadow, $p8, $p8.shadow, 0, 0, 128, 128, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 326, 8} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p2,$mul.ref(0,32)),$mul.ref(0,8));
  $p9.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,32)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 326, 16} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p4,$mul.ref(0,128)),$mul.ref(0,8));
  $p10.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 326, 3} true;
  assume {:verifier.code 0} true;
  call finv($p9, $p9.shadow, $p5, $p5.shadow, $p10, $p10.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 327, 9} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p2,$mul.ref(0,32)),$mul.ref(0,8));
  $p11.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,32)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 327, 14} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p2,$mul.ref(0,32)),$mul.ref(0,8));
  $p12.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,32)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 327, 22} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p4,$mul.ref(0,128)),$mul.ref(0,8));
  $p13.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 327, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p11, $p11.shadow, $p12, $p12.shadow, $p1, $p1.shadow, $p13, $p13.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 328, 15} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p3,$mul.ref(0,32)),$mul.ref(0,8));
  $p14.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,32)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 328, 21} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p2,$mul.ref(0,32)),$mul.ref(0,8));
  $p15.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,32)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 328, 3} true;
  assume {:verifier.code 0} true;
  call store_felem($p14, $p14.shadow, $p15, $p15.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  ...
  $p18.shadow := $add.ref($p0.shadow,$mul.ref($i17.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i32.i64(0);
  $i19.shadow := $zext.i32.i64(0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p3,$mul.ref(0,32)),$mul.ref($i19,8));
  $p20.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,32)),$mul.ref($i19.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p20 == $p20.shadow));
  $i21 := $load.i64($M.6,$p20);
  $i21.shadow := $load.i64($M.6.shadow,$p20.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  call $i22, $i22.shadow := __uint64_identity($i21, $i21.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  call store64($p18, $p18.shadow, $i22, $i22.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32(0,1);
  $i23.shadow := $add.i32(0,1);
  call {:cexpr "i0"} boogie_si_record_i32($i23);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $i24 := $mul.i32($i23,8);
  $i24.shadow := $mul.i32($i23.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p26.shadow := $add.ref($p0.shadow,$mul.ref($i25.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i32.i64($i23);
  $i27.shadow := $zext.i32.i64($i23.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p3,$mul.ref(0,32)),$mul.ref($i27,8));
  $p28.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,32)),$mul.ref($i27.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p28 == $p28.shadow));
  $i29 := $load.i64($M.6,$p28);
  $i29.shadow := $load.i64($M.6.shadow,$p28.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  call $i30, $i30.shadow := __uint64_identity($i29, $i29.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  call store64($p26, $p26.shadow, $i30, $i30.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $i31 := $add.i32($i23,1);
  $i31.shadow := $add.i32($i23.shadow,1);
  call {:cexpr "i0"} boogie_si_record_i32($i31);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $i32 := $mul.i32($i31,8);
  $i32.shadow := $mul.i32($i31.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p34.shadow := $add.ref($p0.shadow,$mul.ref($i33.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $i35 := $zext.i32.i64($i31);
  $i35.shadow := $zext.i32.i64($i31.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($add.ref($p3,$mul.ref(0,32)),$mul.ref($i35,8));
  $p36.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,32)),$mul.ref($i35.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p36 == $p36.shadow));
  $i37 := $load.i64($M.6,$p36);
  $i37.shadow := $load.i64($M.6.shadow,$p36.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  call $i38, $i38.shadow := __uint64_identity($i37, $i37.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  call store64($p34, $p34.shadow, $i38, $i38.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $i39 := $add.i32($i31,1);
  $i39.shadow := $add.i32($i31.shadow,1);
  call {:cexpr "i0"} boogie_si_record_i32($i39);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $i40 := $mul.i32($i39,8);
  $i40.shadow := $mul.i32($i39.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $i41 := $zext.i32.i64($i40);
  $i41.shadow := $zext.i32.i64($i40.shadow);
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $i43 := $zext.i32.i64($i39);
  $i43.shadow := $zext.i32.i64($i39.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $p44 := $add.ref($add.ref($p3,$mul.ref(0,32)),$mul.ref($i43,8));
  $p44.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,32)),$mul.ref($i43.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p44 == $p44.shadow));
  $i45 := $load.i64($M.6,$p44);
  $i45.shadow := $load.i64($M.6.shadow,$p44.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  call $i46, $i46.shadow := __uint64_identity($i45, $i45.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  call store64($p42, $p42.shadow, $i46, $i46.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 329, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 334, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const finv: ref;
axiom (finv == $sub.ref(0,10344));
procedure {:inline 1} finv($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.0, $exn;
modifies $CurrAddr;
{
  var $p3: ref;
  ...
  var $p24.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 247, 12} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(128,$zext.i32.i64(1)));
  $p3.shadow := $p3;
  ...
  call $M.0, $M.0.shadow := $memset.i8($M.0, $M.0.shadow, $p4, $p4.shadow, 0, 0, 128, 128, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 248, 18} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p5.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 249, 18} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p6.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  $p7 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(4,8));
  $p7.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 250, 20} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p8.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  $p9 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(12,8));
  $p9.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(12,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 252, 3} true;
  assume {:verifier.code 0} true;
  call fsquare_times($p5, $p5.shadow, $p1, $p1.shadow, $p2, $p2.shadow, 1, 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 253, 3} true;
  assume {:verifier.code 0} true;
  call fsquare_times($p9, $p9.shadow, $p5, $p5.shadow, $p2, $p2.shadow, 2, 2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 254, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p7, $p7.shadow, $p9, $p9.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 255, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p5, $p5.shadow, $p7, $p7.shadow, $p5, $p5.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 256, 3} true;
  assume {:verifier.code 0} true;
  call fsquare_times($p9, $p9.shadow, $p5, $p5.shadow, $p2, $p2.shadow, 1, 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 257, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p7, $p7.shadow, $p9, $p9.shadow, $p7, $p7.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 258, 3} true;
  assume {:verifier.code 0} true;
  call fsquare_times($p9, $p9.shadow, $p7, $p7.shadow, $p2, $p2.shadow, 5, 5);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 259, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p7, $p7.shadow, $p9, $p9.shadow, $p7, $p7.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 260, 19} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p10.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  $p11 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(4,8));
  $p11.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 261, 19} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p12.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  $p13 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(8,8));
  $p13.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(8,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 262, 20} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p14.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  $p15 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(12,8));
  $p15.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(12,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 264, 3} true;
  assume {:verifier.code 0} true;
  call fsquare_times($p15, $p15.shadow, $p11, $p11.shadow, $p2, $p2.shadow, 10, 10);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 265, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p13, $p13.shadow, $p15, $p15.shadow, $p11, $p11.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 266, 3} true;
  assume {:verifier.code 0} true;
  call fsquare_times($p15, $p15.shadow, $p13, $p13.shadow, $p2, $p2.shadow, 20, 20);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 267, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p15, $p15.shadow, $p15, $p15.shadow, $p13, $p13.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 268, 3} true;
  assume {:verifier.code 0} true;
  call fsquare_times($p15, $p15.shadow, $p15, $p15.shadow, $p2, $p2.shadow, 10, 10);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 269, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p11, $p11.shadow, $p15, $p15.shadow, $p11, $p11.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 270, 3} true;
  assume {:verifier.code 0} true;
  call fsquare_times($p15, $p15.shadow, $p11, $p11.shadow, $p2, $p2.shadow, 50, 50);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 271, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p13, $p13.shadow, $p15, $p15.shadow, $p11, $p11.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 272, 19} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p16.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  $p17 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(4,8));
  $p17.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 273, 18} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p18.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  $p19 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(8,8));
  $p19.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(8,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 274, 19} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p20.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  $p21 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(12,8));
  $p21.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(12,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 276, 3} true;
  assume {:verifier.code 0} true;
  call fsquare_times($p21, $p21.shadow, $p19, $p19.shadow, $p2, $p2.shadow, 100, 100);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 277, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p21, $p21.shadow, $p21, $p21.shadow, $p19, $p19.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 278, 3} true;
  assume {:verifier.code 0} true;
  call fsquare_times($p21, $p21.shadow, $p21, $p21.shadow, $p2, $p2.shadow, 50, 50);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 279, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p21, $p21.shadow, $p21, $p21.shadow, $p17, $p17.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 280, 3} true;
  assume {:verifier.code 0} true;
  call fsquare_times($p21, $p21.shadow, $p21, $p21.shadow, $p2, $p2.shadow, 5, 5);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 281, 17} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p22.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 282, 18} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(0,8));
  $p23.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(0,8));
  $p24 := $add.ref($add.ref($p3,$mul.ref(0,128)),$mul.ref(12,8));
  $p24.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,128)),$mul.ref(12,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 283, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p0, $p0.shadow, $p24, $p24.shadow, $p22, $p22.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 284, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const fmul0: ref;
axiom (fmul0 == $sub.ref(0,11376));
procedure {:inline 1} fmul0($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref)
modifies $exn;
{
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 63, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 63, 3} true;
  assume {:verifier.code 0} true;
  call fmul($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 67, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const store_felem: ref;
axiom (store_felem == $sub.ref(0,12408));
procedure {:inline 1} store_felem($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $M.0, $M.6, $exn;
{
  var $p2: ref;
  var $p2.shadow: ref;
  var $i3: i64;
  ...
  var $p38.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 288, 18} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 288, 18} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1,$mul.ref(3,8));
  $p2.shadow := $add.ref($p1.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 288, 18} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p2 == $p2.shadow));
  $i3 := $load.i64($M.0,$p2);
  $i3.shadow := $load.i64($M.0.shadow,$p2.shadow);
  call {:cexpr "f30"} boogie_si_record_i64($i3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 289, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $lshr.i64($i3,63);
  $i4.shadow := $lshr.i64($i3.shadow,63);
  call {:cexpr "top_bit0"} boogie_si_record_i64($i4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 290, 15} true;
  assume {:verifier.code 0} true;
  $i5 := $and.i64($i3,9223372036854775807);
  $i5.shadow := $and.i64($i3.shadow,9223372036854775807);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 290, 3} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p1,$mul.ref(3,8));
  $p6.shadow := $add.ref($p1.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 290, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p6 == $p6.shadow));
  $M.0 := $store.i64($M.0,$p6,$i5);
  $M.0.shadow := $store.i64($M.0.shadow,$p6.shadow,$i5.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 291, 35} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.i64(19,$i4);
  $i7.shadow := $mul.i64(19,$i4.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 291, 3} true;
  assume {:verifier.code 0} true;
  call add_scalar0($p1, $p1.shadow, $p1, $p1.shadow, $i7, $i7.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 292, 18} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p1,$mul.ref(3,8));
  $p8.shadow := $add.ref($p1.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 292, 18} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p8 == $p8.shadow));
  $i9 := $load.i64($M.0,$p8);
  $i9.shadow := $load.i64($M.0.shadow,$p8.shadow);
  call {:cexpr "f31"} boogie_si_record_i64($i9);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 293, 26} true;
  assume {:verifier.code 0} true;
  $i10 := $lshr.i64($i9,63);
  $i10.shadow := $lshr.i64($i9.shadow,63);
  call {:cexpr "top_bit"} boogie_si_record_i64($i10);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 294, 15} true;
  assume {:verifier.code 0} true;
  $i11 := $and.i64($i9,9223372036854775807);
  $i11.shadow := $and.i64($i9.shadow,9223372036854775807);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 294, 3} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p1,$mul.ref(3,8));
  $p12.shadow := $add.ref($p1.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 294, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p12 == $p12.shadow));
  $M.0 := $store.i64($M.0,$p12,$i11);
  $M.0.shadow := $store.i64($M.0.shadow,$p12.shadow,$i11.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 295, 35} true;
  assume {:verifier.code 0} true;
  $i13 := $mul.i64(19,$i10);
  $i13.shadow := $mul.i64(19,$i10.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 295, 3} true;
  assume {:verifier.code 0} true;
  call add_scalar0($p1, $p1.shadow, $p1, $p1.shadow, $i13, $i13.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 296, 17} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p1,$mul.ref(0,8));
  $p14.shadow := $add.ref($p1.shadow,$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 296, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p14 == $p14.shadow));
  $i15 := $load.i64($M.0,$p14);
  $i15.shadow := $load.i64($M.0.shadow,$p14.shadow);
  call {:cexpr "f0"} boogie_si_record_i64($i15);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 297, 17} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p1,$mul.ref(1,8));
  $p16.shadow := $add.ref($p1.shadow,$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 297, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p16 == $p16.shadow));
  $i17 := $load.i64($M.0,$p16);
  $i17.shadow := $load.i64($M.0.shadow,$p16.shadow);
  call {:cexpr "f1"} boogie_si_record_i64($i17);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 298, 17} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p1,$mul.ref(2,8));
  $p18.shadow := $add.ref($p1.shadow,$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 298, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p18 == $p18.shadow));
  $i19 := $load.i64($M.0,$p18);
  $i19.shadow := $load.i64($M.0.shadow,$p18.shadow);
  call {:cexpr "f2"} boogie_si_record_i64($i19);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 299, 17} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($p1,$mul.ref(3,8));
  $p20.shadow := $add.ref($p1.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 299, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p20 == $p20.shadow));
  $i21 := $load.i64($M.0,$p20);
  $i21.shadow := $load.i64($M.0.shadow,$p20.shadow);
  call {:cexpr "f3"} boogie_si_record_i64($i21);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 300, 17} true;
  assume {:verifier.code 0} true;
  call $i22, $i22.shadow := FStar_UInt64_gte_mask($i15, $i15.shadow, $sub.i64(0,19), $sub.i64(0,19));
  call {:cexpr "m0"} boogie_si_record_i64($i22);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 301, 17} true;
  assume {:verifier.code 0} true;
  call $i23, $i23.shadow := FStar_UInt64_eq_mask($i17, $i17.shadow, $sub.i64(0,1), $sub.i64(0,1));
  call {:cexpr "m1"} boogie_si_record_i64($i23);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 302, 17} true;
  assume {:verifier.code 0} true;
  call $i24, $i24.shadow := FStar_UInt64_eq_mask($i19, $i19.shadow, $sub.i64(0,1), $sub.i64(0,1));
  call {:cexpr "m2"} boogie_si_record_i64($i24);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 303, 17} true;
  assume {:verifier.code 0} true;
  call $i25, $i25.shadow := FStar_UInt64_eq_mask($i21, $i21.shadow, 9223372036854775807, 9223372036854775807);
  call {:cexpr "m3"} boogie_si_record_i64($i25);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 304, 24} true;
  assume {:verifier.code 0} true;
  $i26 := $and.i64($i22,$i23);
  $i26.shadow := $and.i64($i22.shadow,$i23.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 304, 30} true;
  assume {:verifier.code 0} true;
  $i27 := $and.i64($i26,$i24);
  $i27.shadow := $and.i64($i26.shadow,$i24.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 304, 36} true;
  assume {:verifier.code 0} true;
  $i28 := $and.i64($i27,$i25);
  $i28.shadow := $and.i64($i27.shadow,$i25.shadow);
  call {:cexpr "mask"} boogie_si_record_i64($i28);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 305, 29} true;
  assume {:verifier.code 0} true;
  $i29 := $and.i64($i28,18446744073709551597);
  $i29.shadow := $and.i64($i28.shadow,18446744073709551597);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 305, 21} true;
  assume {:verifier.code 0} true;
  $i30 := $sub.i64($i15,$i29);
  $i30.shadow := $sub.i64($i15.shadow,$i29.shadow);
  call {:cexpr "f0_"} boogie_si_record_i64($i30);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 306, 21} true;
  assume {:verifier.code 0} true;
  $i31 := $sub.i64($i17,$i28);
  $i31.shadow := $sub.i64($i17.shadow,$i28.shadow);
  call {:cexpr "f1_"} boogie_si_record_i64($i31);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 307, 21} true;
  assume {:verifier.code 0} true;
  $i32 := $sub.i64($i19,$i28);
  $i32.shadow := $sub.i64($i19.shadow,$i28.shadow);
  call {:cexpr "f2_"} boogie_si_record_i64($i32);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 308, 29} true;
  assume {:verifier.code 0} true;
  $i33 := $and.i64($i28,9223372036854775807);
  $i33.shadow := $and.i64($i28.shadow,9223372036854775807);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 308, 21} true;
  assume {:verifier.code 0} true;
  $i34 := $sub.i64($i21,$i33);
  $i34.shadow := $sub.i64($i21.shadow,$i33.shadow);
  call {:cexpr "f3_"} boogie_si_record_i64($i34);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 313, 3} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($p0,$mul.ref(0,8));
  $p35.shadow := $add.ref($p0.shadow,$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 313, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p35 == $p35.shadow));
  $M.6 := $store.i64($M.6,$p35,$i30);
  $M.6.shadow := $store.i64($M.6.shadow,$p35.shadow,$i30.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 314, 3} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($p0,$mul.ref(1,8));
  $p36.shadow := $add.ref($p0.shadow,$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 314, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p36 == $p36.shadow));
  $M.6 := $store.i64($M.6,$p36,$i31);
  $M.6.shadow := $store.i64($M.6.shadow,$p36.shadow,$i31.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 315, 3} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($p0,$mul.ref(2,8));
  $p37.shadow := $add.ref($p0.shadow,$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 315, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p37 == $p37.shadow));
  $M.6 := $store.i64($M.6,$p37,$i32);
  $M.6.shadow := $store.i64($M.6.shadow,$p37.shadow,$i32.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 316, 3} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p0,$mul.ref(3,8));
  $p38.shadow := $add.ref($p0.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 316, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p38 == $p38.shadow));
  $M.6 := $store.i64($M.6,$p38,$i34);
  $M.6.shadow := $store.i64($M.6.shadow,$p38.shadow,$i34.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 317, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p2 == $p2.shadow));
  $M.7 := $store.i64($M.7,$p2,$i1);
  $M.7.shadow := $store.i64($M.7.shadow,$p2.shadow,$i1.shadow);
  assume true;
  assume {:sourceloc "../hacl-star/dist/karamel/include/krml/lowstar_endianness.h", 187, 3} true;
  assume {:verifier.code 0} true;
  ...
  call $M.8, $M.8.shadow := $memcpy.i8($M.8, $M.8.shadow, $M.7, $M.7.shadow, $p0, $p0.shadow, $p3, $p3.shadow, 8, 8, false, false);
...
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0,14472));
...
const add_scalar0: ref;
axiom (add_scalar0 == $sub.ref(0,15504));
procedure {:inline 1} add_scalar0($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64)
modifies $exn;
{
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "add_scalar0:arg:f2"} boogie_si_record_i64($i2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 36, 3} true;
  assume {:verifier.code 0} true;
  call add_scalar($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 40, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
axiom (FStar_UInt64_gte_mask == $sub.ref(0,16536));
...
axiom (FStar_UInt64_eq_mask == $sub.ref(0,17568));
...
const add_scalar: ref;
axiom (add_scalar == $sub.ref(0,18600));
procedure {:inline 1} add_scalar($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64)
modifies $exn;
{
  var $i3: i64;
  var $i3.shadow: i64;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 10, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "add_scalar:arg:f2"} boogie_si_record_i64($i2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 10, 3} true;
  assume {:verifier.code 0} true;
  assume true;
  call {:cexpr "f2"} boogie_si_record_i64($i3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 34, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const fmul: ref;
axiom (fmul == $sub.ref(0,19632));
procedure {:inline 1} fmul($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref)
modifies $exn;
{
  var $p4: ref;
  var $p4.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 125, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 125, 3} true;
  assume {:verifier.code 0} true;
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 205, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const fsquare_times: ref;
axiom (fsquare_times == $sub.ref(0,20664));
procedure {:inline 1} fsquare_times($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $i3: i32, $i3.shadow: i32)
modifies $exn;
{
  var $i4: i32;
  var $i4.shadow: i32;
  ...
  var $i7.shadow: i32;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 238, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "fsquare_times:arg:n"} boogie_si_record_i32($i3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 238, 3} true;
  assume {:verifier.code 0} true;
  call fsqr0($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 239, 8} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  $i4.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 239, 41} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32($i3,1);
  $i5.shadow := $sub.i32($i3.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 239, 37} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i32($i4,$i5);
  $i6.shadow := $ult.i32($i4.shadow,$i5.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 239, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i6 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 241, 5} true;
  assume {:verifier.code 0} true;
  call fsqr0($p0, $p0.shadow, $p0, $p0.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 242, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i6 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 243, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 239, 58} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i4,1);
  $i7.shadow := $add.i32($i4.shadow,1);
...
const fsqr0: ref;
axiom (fsqr0 == $sub.ref(0,21696));
procedure {:inline 1} fsqr0($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $exn;
{
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 90, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 90, 3} true;
  assume {:verifier.code 0} true;
  call fsqr($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 94, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const fsqr: ref;
axiom (fsqr == $sub.ref(0,22728));
procedure {:inline 1} fsqr($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 496, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 496, 3} true;
  assume {:verifier.code 0} true;
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 582, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const cswap20: ref;
axiom (cswap20 == $sub.ref(0,23760));
procedure {:inline 1} cswap20($i0: i64, $i0.shadow: i64, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $exn;
{
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 108, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "cswap20:arg:bit"} boogie_si_record_i64($i0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 108, 3} true;
  assume {:verifier.code 0} true;
  call cswap2($i0, $i0.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 112, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
axiom (point_add_and_double == $sub.ref(0,24792));
procedure {:inline 1} point_add_and_double($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.0, $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $p41.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 119, 30} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 119, 30} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p1,$mul.ref(8,8));
  $p3.shadow := $add.ref($p1.shadow,$mul.ref(8,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 120, 29} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p1,$mul.ref(16,8));
  $p4.shadow := $add.ref($p1.shadow,$mul.ref(16,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 123, 21} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p1,$mul.ref(4,8));
  $p5.shadow := $add.ref($p1.shadow,$mul.ref(4,8));
  $i6 := $add.i64(8,4);
  $i6.shadow := $add.i64(8,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 124, 24} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p1,$mul.ref($i6,8));
  $p7.shadow := $add.ref($p1.shadow,$mul.ref($i6.shadow,8));
  $i8 := $add.i64(16,4);
  $i8.shadow := $add.i64(16,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 126, 22} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p1,$mul.ref($i8,8));
  $p9.shadow := $add.ref($p1.shadow,$mul.ref($i8.shadow,8));
  $i10 := $add.i64(16,8);
  $i10.shadow := $add.i64(16,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 128, 23} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p1,$mul.ref($i10,8));
  $p11.shadow := $add.ref($p1.shadow,$mul.ref($i10.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 129, 3} true;
  assume {:verifier.code 0} true;
  call fadd0($p4, $p4.shadow, $p1, $p1.shadow, $p5, $p5.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 130, 3} true;
  assume {:verifier.code 0} true;
  call fsub0($p9, $p9.shadow, $p1, $p1.shadow, $p5, $p5.shadow);
  $i12 := $add.i64(8,4);
  $i12.shadow := $add.i64(8,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 132, 25} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p1,$mul.ref($i12,8));
  $p13.shadow := $add.ref($p1.shadow,$mul.ref($i12.shadow,8));
  $i14 := $add.i64($i10,4);
  $i14.shadow := $add.i64($i10.shadow,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 134, 21} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p1,$mul.ref($i14,8));
  $p15.shadow := $add.ref($p1.shadow,$mul.ref($i14.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 135, 3} true;
  assume {:verifier.code 0} true;
  call fadd0($p15, $p15.shadow, $p3, $p3.shadow, $p13, $p13.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 136, 3} true;
  assume {:verifier.code 0} true;
  call fsub0($p11, $p11.shadow, $p3, $p3.shadow, $p13, $p13.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 137, 3} true;
  assume {:verifier.code 0} true;
  call fmul20($p11, $p11.shadow, $p11, $p11.shadow, $p4, $p4.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 138, 3} true;
  assume {:verifier.code 0} true;
  call fadd0($p3, $p3.shadow, $p11, $p11.shadow, $p15, $p15.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 139, 3} true;
  assume {:verifier.code 0} true;
  call fsub0($p13, $p13.shadow, $p11, $p11.shadow, $p15, $p15.shadow);
  $i16 := $add.i64(16,4);
  $i16.shadow := $add.i64(16,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 141, 23} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($p1,$mul.ref($i16,8));
  $p17.shadow := $add.ref($p1.shadow,$mul.ref($i16.shadow,8));
  $i18 := $add.i64(16,8);
  $i18.shadow := $add.i64(16,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 142, 22} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($p1,$mul.ref($i18,8));
  $p19.shadow := $add.ref($p1.shadow,$mul.ref($i18.shadow,8));
  $i20 := $add.i64(16,12);
  $i20.shadow := $add.i64(16,12);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 143, 22} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($p1,$mul.ref($i20,8));
  $p21.shadow := $add.ref($p1.shadow,$mul.ref($i20.shadow,8));
  $i22 := $add.i64(16,8);
  $i22.shadow := $add.i64(16,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 145, 24} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p1,$mul.ref($i22,8));
  $p23.shadow := $add.ref($p1.shadow,$mul.ref($i22.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 146, 3} true;
  assume {:verifier.code 0} true;
  call fsqr20($p23, $p23.shadow, $p4, $p4.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 147, 3} true;
  assume {:verifier.code 0} true;
  call fsqr20($p3, $p3.shadow, $p3, $p3.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 148, 12} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p1,$mul.ref($i20,8));
  $p24.shadow := $add.ref($p1.shadow,$mul.ref($i20.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 148, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p24 == $p24.shadow));
  $i25 := $load.i64($M.0,$p24);
  $i25.shadow := $load.i64($M.0.shadow,$p24.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 148, 3} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p1,$mul.ref(16,8));
  $p26.shadow := $add.ref($p1.shadow,$mul.ref(16,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 148, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p26 == $p26.shadow));
  $M.0 := $store.i64($M.0,$p26,$i25);
  $M.0.shadow := $store.i64($M.0.shadow,$p26.shadow,$i25.shadow);
  $i27 := $add.i64($i20,1);
  $i27.shadow := $add.i64($i20.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 149, 12} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($p1,$mul.ref($i27,8));
  $p28.shadow := $add.ref($p1.shadow,$mul.ref($i27.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 149, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p28 == $p28.shadow));
  ...
  $i30 := $add.i64(16,1);
  $i30.shadow := $add.i64(16,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 149, 3} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($p1,$mul.ref($i30,8));
  $p31.shadow := $add.ref($p1.shadow,$mul.ref($i30.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 149, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p31 == $p31.shadow));
  $M.0 := $store.i64($M.0,$p31,$i29);
  $M.0.shadow := $store.i64($M.0.shadow,$p31.shadow,$i29.shadow);
  $i32 := $add.i64($i20,2);
  $i32.shadow := $add.i64($i20.shadow,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 150, 12} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($p1,$mul.ref($i32,8));
  $p33.shadow := $add.ref($p1.shadow,$mul.ref($i32.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 150, 12} true;
  assume {:verifier.code 0} true;
  ...
  $i35 := $add.i64(16,2);
  $i35.shadow := $add.i64(16,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 150, 3} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($p1,$mul.ref($i35,8));
  $p36.shadow := $add.ref($p1.shadow,$mul.ref($i35.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 150, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p36 == $p36.shadow));
  $M.0 := $store.i64($M.0,$p36,$i34);
  $M.0.shadow := $store.i64($M.0.shadow,$p36.shadow,$i34.shadow);
  $i37 := $add.i64($i20,3);
  $i37.shadow := $add.i64($i20.shadow,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 151, 12} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p1,$mul.ref($i37,8));
  $p38.shadow := $add.ref($p1.shadow,$mul.ref($i37.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 151, 12} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p38 == $p38.shadow));
  ...
  $i40 := $add.i64(16,3);
  $i40.shadow := $add.i64(16,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 151, 3} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($p1,$mul.ref($i40,8));
  $p41.shadow := $add.ref($p1.shadow,$mul.ref($i40.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 151, 10} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p41 == $p41.shadow));
  $M.0 := $store.i64($M.0,$p41,$i39);
  $M.0.shadow := $store.i64($M.0.shadow,$p41.shadow,$i39.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 152, 3} true;
  assume {:verifier.code 0} true;
  call fsub0($p21, $p21.shadow, $p19, $p19.shadow, $p21, $p21.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 153, 3} true;
  assume {:verifier.code 0} true;
  call fmul_scalar0($p17, $p17.shadow, $p21, $p21.shadow, 121665, 121665);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 154, 3} true;
  assume {:verifier.code 0} true;
  call fadd0($p17, $p17.shadow, $p17, $p17.shadow, $p19, $p19.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 155, 3} true;
  assume {:verifier.code 0} true;
  call fmul20($p1, $p1.shadow, $p23, $p23.shadow, $p4, $p4.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 156, 3} true;
  assume {:verifier.code 0} true;
  call fmul0($p7, $p7.shadow, $p7, $p7.shadow, $p0, $p0.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 157, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
axiom (point_double == $sub.ref(0,25824));
procedure {:inline 1} point_double($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.0, $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $p22.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 162, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 162, 21} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p0,$mul.ref(4,8));
  $p3.shadow := $add.ref($p0.shadow,$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 164, 22} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p1,$mul.ref(4,8));
  $p4.shadow := $add.ref($p1.shadow,$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 165, 22} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p1,$mul.ref(8,8));
  $p5.shadow := $add.ref($p1.shadow,$mul.ref(8,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 166, 22} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p1,$mul.ref(12,8));
  $p6.shadow := $add.ref($p1.shadow,$mul.ref(12,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 168, 23} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p1,$mul.ref(8,8));
  $p7.shadow := $add.ref($p1.shadow,$mul.ref(8,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 169, 3} true;
  assume {:verifier.code 0} true;
  call fadd0($p1, $p1.shadow, $p0, $p0.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 170, 3} true;
  assume {:verifier.code 0} true;
  call fsub0($p4, $p4.shadow, $p0, $p0.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 171, 3} true;
  assume {:verifier.code 0} true;
  call fsqr20($p7, $p7.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 172, 11} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p1,$mul.ref(12,8));
  $p8.shadow := $add.ref($p1.shadow,$mul.ref(12,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 172, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p8 == $p8.shadow));
  $i9 := $load.i64($M.0,$p8);
  $i9.shadow := $load.i64($M.0.shadow,$p8.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 172, 3} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($p1,$mul.ref(0,8));
  $p10.shadow := $add.ref($p1.shadow,$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 172, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p10 == $p10.shadow));
  $M.0 := $store.i64($M.0,$p10,$i9);
  $M.0.shadow := $store.i64($M.0.shadow,$p10.shadow,$i9.shadow);
  $i11 := $add.i64(12,1);
  $i11.shadow := $add.i64(12,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 173, 11} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p1,$mul.ref($i11,8));
  $p12.shadow := $add.ref($p1.shadow,$mul.ref($i11.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 173, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p12 == $p12.shadow));
  $i13 := $load.i64($M.0,$p12);
  $i13.shadow := $load.i64($M.0.shadow,$p12.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 173, 3} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p1,$mul.ref(1,8));
  $p14.shadow := $add.ref($p1.shadow,$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 173, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p14 == $p14.shadow));
  $M.0 := $store.i64($M.0,$p14,$i13);
  $M.0.shadow := $store.i64($M.0.shadow,$p14.shadow,$i13.shadow);
  $i15 := $add.i64(12,2);
  $i15.shadow := $add.i64(12,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 174, 11} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p1,$mul.ref($i15,8));
  $p16.shadow := $add.ref($p1.shadow,$mul.ref($i15.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 174, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p16 == $p16.shadow));
  $i17 := $load.i64($M.0,$p16);
  $i17.shadow := $load.i64($M.0.shadow,$p16.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 174, 3} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p1,$mul.ref(2,8));
  $p18.shadow := $add.ref($p1.shadow,$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 174, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p18 == $p18.shadow));
  $M.0 := $store.i64($M.0,$p18,$i17);
  $M.0.shadow := $store.i64($M.0.shadow,$p18.shadow,$i17.shadow);
  $i19 := $add.i64(12,3);
  $i19.shadow := $add.i64(12,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 175, 11} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($p1,$mul.ref($i19,8));
  $p20.shadow := $add.ref($p1.shadow,$mul.ref($i19.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 175, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p20 == $p20.shadow));
  $i21 := $load.i64($M.0,$p20);
  $i21.shadow := $load.i64($M.0.shadow,$p20.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 175, 3} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p1,$mul.ref(3,8));
  $p22.shadow := $add.ref($p1.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 175, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p22 == $p22.shadow));
  $M.0 := $store.i64($M.0,$p22,$i21);
  $M.0.shadow := $store.i64($M.0.shadow,$p22.shadow,$i21.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 176, 3} true;
  assume {:verifier.code 0} true;
  call fsub0($p6, $p6.shadow, $p5, $p5.shadow, $p6, $p6.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 177, 3} true;
  assume {:verifier.code 0} true;
  call fmul_scalar0($p4, $p4.shadow, $p6, $p6.shadow, 121665, 121665);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 178, 3} true;
  assume {:verifier.code 0} true;
  call fadd0($p4, $p4.shadow, $p4, $p4.shadow, $p5, $p5.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 179, 3} true;
  assume {:verifier.code 0} true;
  call fmul20($p0, $p0.shadow, $p7, $p7.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 180, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const fadd0: ref;
axiom (fadd0 == $sub.ref(0,26856));
procedure {:inline 1} fadd0($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $exn;
{
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 45, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 45, 3} true;
  assume {:verifier.code 0} true;
  call fadd($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 49, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const fsub0: ref;
axiom (fsub0 == $sub.ref(0,27888));
procedure {:inline 1} fsub0($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $exn;
{
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 54, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 54, 3} true;
  assume {:verifier.code 0} true;
  call fsub($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 58, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const fsqr20: ref;
axiom (fsqr20 == $sub.ref(0,28920));
procedure {:inline 1} fsqr20($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $exn;
{
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 99, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 99, 3} true;
  assume {:verifier.code 0} true;
  call fsqr2($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 103, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const fmul_scalar0: ref;
axiom (fmul_scalar0 == $sub.ref(0,29952));
procedure {:inline 1} fmul_scalar0($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64)
modifies $exn;
{
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 81, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "fmul_scalar0:arg:f2"} boogie_si_record_i64($i2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 81, 3} true;
  assume {:verifier.code 0} true;
  call fmul_scalar($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 85, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const fmul20: ref;
axiom (fmul20 == $sub.ref(0,30984));
procedure {:inline 1} fmul20($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref)
modifies $exn;
{
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 72, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 72, 3} true;
  assume {:verifier.code 0} true;
  call fmul2($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 76, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const fmul2: ref;
axiom (fmul2 == $sub.ref(0,32016));
procedure {:inline 1} fmul2($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref)
modifies $exn;
{
  var $p4: ref;
  var $p4.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 213, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 213, 3} true;
  assume {:verifier.code 0} true;
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 362, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const fmul_scalar: ref;
axiom (fmul_scalar == $sub.ref(0,33048));
procedure {:inline 1} fmul_scalar($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64)
modifies $exn;
{
  var $i3: i64;
  var $i3.shadow: i64;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 370, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "fmul_scalar:arg:f2"} boogie_si_record_i64($i2);
  call {:cexpr "fmul_scalar:arg:f2_r"} boogie_si_record_i64($i2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 370, 3} true;
  assume {:verifier.code 0} true;
  assume true;
  call {:cexpr "f2_r"} boogie_si_record_i64($i3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 406, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const fsqr2: ref;
axiom (fsqr2 == $sub.ref(0,34080));
procedure {:inline 1} fsqr2($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 590, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 590, 3} true;
  assume {:verifier.code 0} true;
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 744, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const fsub: ref;
axiom (fsub == $sub.ref(0,35112));
procedure {:inline 1} fsub($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $exn;
{
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 81, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 81, 3} true;
  assume {:verifier.code 0} true;
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 119, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const fadd: ref;
axiom (fadd == $sub.ref(0,36144));
procedure {:inline 1} fadd($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 39, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 39, 3} true;
  assume {:verifier.code 0} true;
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 76, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const cswap2: ref;
axiom (cswap2 == $sub.ref(0,37176));
procedure {:inline 1} cswap2($i0: i64, $i0.shadow: i64, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $exn;
{
  var $i3: i64;
  var $i3.shadow: i64;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 411, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "cswap2:arg:bit"} boogie_si_record_i64($i0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 411, 3} true;
  assume {:verifier.code 0} true;
  assume true;
  call {:cexpr "bit"} boogie_si_record_i64($i3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/curve25519-inline.h", 490, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const Hacl_Curve25519_64_secret_to_public: ref;
axiom (Hacl_Curve25519_64_secret_to_public == $sub.ref(0,38208));
procedure {:inline 1} Hacl_Curve25519_64_secret_to_public($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $M.2, $exn;
modifies $M.0, $M.1;
modifies $M.3, $M.4, $M.6;
modifies $CurrAddr;
modifies $M.7, $M.8;
{
  var $p2: ref;
  ...
  var $p13.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 383, 11} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p2 := $alloc($mul.ref(32,$zext.i32.i64(1)));
  $p2.shadow := $p2;
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p3 == $p3.shadow));
  call $M.2, $M.2.shadow := $memset.i8($M.2, $M.2.shadow, $p3, $p3.shadow, 0, 0, 32, 32, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 384, 8} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  $i4.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 384, 37} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i32($i4,32);
  $i5.shadow := $ult.i32($i4.shadow,32);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 384, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 386, 19} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p2,$mul.ref(0,32)),$mul.ref(0,1));
  $p6.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 387, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i32.i64($i4);
  $i7.shadow := $zext.i32.i64($i4.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 387, 17} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref($i7,1));
  $p8.shadow := $add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref($i7.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 387, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p8 == $p8.shadow));
  $i9 := $load.i8($M.9,$p8);
  $i9.shadow := $load.i8($M.9.shadow,$p8.shadow);
  call {:cexpr "x"} boogie_si_record_i8($i9);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 388, 5} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i32.i64($i4);
  $i10.shadow := $zext.i32.i64($i4.shadow);
  $p11 := $add.ref($add.ref($p2,$mul.ref(0,32)),$mul.ref($i10,1));
  $p11.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,32)),$mul.ref($i10.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 388, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p11 == $p11.shadow));
  $M.2 := $store.i8($M.2,$p11,$i9);
  $M.2.shadow := $store.i8($M.2.shadow,$p11.shadow,$i9.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 389, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i5 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 390, 44} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p2,$mul.ref(0,32)),$mul.ref(0,1));
  $p13.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 390, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Curve25519_64_scalarmult($p0, $p0.shadow, $p1, $p1.shadow, $p13, $p13.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 391, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 384, 55} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i4,1);
...
const Hacl_Curve25519_64_secret_to_public_wrapper: ref;
axiom (Hacl_Curve25519_64_secret_to_public_wrapper == $sub.ref(0,39240));
procedure {:entrypoint} Hacl_Curve25519_64_secret_to_public_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
requires {:public_in $p0} true;
requires {:public_in $p1} true;
requires {:public_in $load.i8, $M.8, $p0, 1, 32} true;
modifies $exn;
modifies $M.2, $M.0, $M.1;
modifies $CurrAddr, $M.9;
modifies $M.3, $M.4, $M.6;
modifies $M.7, $M.8;
requires ($p0 == $p0.shadow);
requires ($p1 == $p1.shadow);
requires ($load.i8($M.8,($p0 + 0)) == $load.i8($M.8.shadow,($p0.shadow + 0)));
requires ($load.i8($M.8,($p0 + 1)) == $load.i8($M.8.shadow,($p0.shadow + 1)));
requires ($load.i8($M.8,($p0 + 2)) == $load.i8($M.8.shadow,($p0.shadow + 2)));
requires ($load.i8($M.8,($p0 + 3)) == $load.i8($M.8.shadow,($p0.shadow + 3)));
requires ($load.i8($M.8,($p0 + 4)) == $load.i8($M.8.shadow,($p0.shadow + 4)));
requires ($load.i8($M.8,($p0 + 5)) == $load.i8($M.8.shadow,($p0.shadow + 5)));
requires ($load.i8($M.8,($p0 + 6)) == $load.i8($M.8.shadow,($p0.shadow + 6)));
requires ($load.i8($M.8,($p0 + 7)) == $load.i8($M.8.shadow,($p0.shadow + 7)));
requires ($load.i8($M.8,($p0 + 8)) == $load.i8($M.8.shadow,($p0.shadow + 8)));
requires ($load.i8($M.8,($p0 + 9)) == $load.i8($M.8.shadow,($p0.shadow + 9)));
requires ($load.i8($M.8,($p0 + 10)) == $load.i8($M.8.shadow,($p0.shadow + 10)));
requires ($load.i8($M.8,($p0 + 11)) == $load.i8($M.8.shadow,($p0.shadow + 11)));
requires ($load.i8($M.8,($p0 + 12)) == $load.i8($M.8.shadow,($p0.shadow + 12)));
requires ($load.i8($M.8,($p0 + 13)) == $load.i8($M.8.shadow,($p0.shadow + 13)));
requires ($load.i8($M.8,($p0 + 14)) == $load.i8($M.8.shadow,($p0.shadow + 14)));
requires ($load.i8($M.8,($p0 + 15)) == $load.i8($M.8.shadow,($p0.shadow + 15)));
requires ($load.i8($M.8,($p0 + 16)) == $load.i8($M.8.shadow,($p0.shadow + 16)));
requires ($load.i8($M.8,($p0 + 17)) == $load.i8($M.8.shadow,($p0.shadow + 17)));
requires ($load.i8($M.8,($p0 + 18)) == $load.i8($M.8.shadow,($p0.shadow + 18)));
requires ($load.i8($M.8,($p0 + 19)) == $load.i8($M.8.shadow,($p0.shadow + 19)));
requires ($load.i8($M.8,($p0 + 20)) == $load.i8($M.8.shadow,($p0.shadow + 20)));
requires ($load.i8($M.8,($p0 + 21)) == $load.i8($M.8.shadow,($p0.shadow + 21)));
requires ($load.i8($M.8,($p0 + 22)) == $load.i8($M.8.shadow,($p0.shadow + 22)));
requires ($load.i8($M.8,($p0 + 23)) == $load.i8($M.8.shadow,($p0.shadow + 23)));
requires ($load.i8($M.8,($p0 + 24)) == $load.i8($M.8.shadow,($p0.shadow + 24)));
requires ($load.i8($M.8,($p0 + 25)) == $load.i8($M.8.shadow,($p0.shadow + 25)));
requires ($load.i8($M.8,($p0 + 26)) == $load.i8($M.8.shadow,($p0.shadow + 26)));
requires ($load.i8($M.8,($p0 + 27)) == $load.i8($M.8.shadow,($p0.shadow + 27)));
requires ($load.i8($M.8,($p0 + 28)) == $load.i8($M.8.shadow,($p0.shadow + 28)));
requires ($load.i8($M.8,($p0 + 29)) == $load.i8($M.8.shadow,($p0.shadow + 29)));
requires ($load.i8($M.8,($p0 + 30)) == $load.i8($M.8.shadow,($p0.shadow + 30)));
requires ($load.i8($M.8,($p0 + 31)) == $load.i8($M.8.shadow,($p0.shadow + 31)));
{
  var $p2: ref;
  var $p2.shadow: ref;
  var $p3: ref;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "Hacl_Curve25519_64_secret_to_public.c", 5, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:Hacl_Curve25519_64_secret_to_public_wrapper"} boogie_si_record_ref(Hacl_Curve25519_64_secret_to_public_wrapper);
  call {:cexpr "smack:arg:Hacl_Curve25519_64_secret_to_public_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:Hacl_Curve25519_64_secret_to_public_wrapper:$p1"} boogie_si_record_ref($p1);
  assume {:sourceloc "Hacl_Curve25519_64_secret_to_public.c", 5, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "Hacl_Curve25519_64_secret_to_public.c", 5, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p2, $p2.shadow);
  assume {:sourceloc "Hacl_Curve25519_64_secret_to_public.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p3 := __SMACK_value.ref($p1);
  $p3.shadow := $p3;
  assume $isExternal($p3);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p3);
  assume {:sourceloc "Hacl_Curve25519_64_secret_to_public.c", 6, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p3, $p3.shadow);
  assume {:sourceloc "Hacl_Curve25519_64_secret_to_public.c", 7, 13} true;
  assume {:verifier.code 1} true;
  call {:name $p0} {:array "$load.i8", $M.8, $p0, 1, 32} $p4 := __SMACK_values($p0, 32);
  $p4.shadow := $p4;
  assume $isExternal($p4);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p4);
  assume {:sourceloc "Hacl_Curve25519_64_secret_to_public.c", 7, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "Hacl_Curve25519_64_secret_to_public.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Curve25519_64_secret_to_public($p0, $p0.shadow, $p1, $p1.shadow);
  assume {:sourceloc "Hacl_Curve25519_64_secret_to_public.c", 9, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
...
axiom (__SMACK_dummy == $sub.ref(0,45432));
...
axiom (__SMACK_and32 == $sub.ref(0,46464));
...
axiom (__SMACK_and64 == $sub.ref(0,47496));
...
axiom (__SMACK_and16 == $sub.ref(0,48528));
...
axiom (__SMACK_and8 == $sub.ref(0,49560));
...
axiom (__SMACK_or32 == $sub.ref(0,50592));
...
axiom (__SMACK_or64 == $sub.ref(0,51624));
...
axiom (__SMACK_or16 == $sub.ref(0,52656));
...
axiom (__SMACK_or8 == $sub.ref(0,53688));
...
axiom (__SMACK_check_overflow == $sub.ref(0,54720));
...
axiom (__SMACK_loop_exit == $sub.ref(0,55752));
...
axiom (__SMACK_decls == $sub.ref(0,56784));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,57816));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,58848));
...
axiom (__SMACK_static_init == $sub.ref(0,59880));
procedure {:inline 1} __SMACK_static_init()
modifies $M.9, $exn;
{
$bb0:
  $shadow_ok := ($shadow_ok && (g25519 == g25519));
  $M.9 := $store.i8($M.9,g25519,9);
  $M.9.shadow := $store.i8($M.9.shadow,g25519,9);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(0,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(0,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(0,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(0,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(1,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(1,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(1,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(1,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(2,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(2,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(2,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(2,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(3,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(3,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(3,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(3,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(4,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(4,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(4,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(4,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(5,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(5,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(5,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(5,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(6,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(6,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(6,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(6,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(7,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(7,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(7,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(7,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(8,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(8,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(8,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(8,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(9,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(9,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(9,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(9,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(10,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(10,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(10,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(10,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(11,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(11,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(11,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(11,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(12,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(12,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(12,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(12,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(13,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(13,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(13,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(13,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(14,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(14,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(14,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(14,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(15,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(15,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(15,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(15,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(16,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(16,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(16,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(16,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(17,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(17,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(17,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(17,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(18,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(18,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(18,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(18,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(19,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(19,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(19,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(19,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(20,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(20,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(20,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(20,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(21,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(21,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(21,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(21,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(22,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(22,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(22,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(22,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(23,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(23,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(23,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(23,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(24,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(24,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(24,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(24,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(25,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(25,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(25,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(25,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(26,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(26,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(26,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(26,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(27,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(27,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(27,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(27,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(28,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(28,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(28,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(28,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(29,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(29,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(29,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(29,1)),0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(30,1)) == $add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(30,1))));
  $M.9 := $store.i8($M.9,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(30,1)),0);
  $M.9.shadow := $store.i8($M.9.shadow,$add.ref($add.ref($add.ref(g25519,$mul.ref(0,32)),$mul.ref(1,1)),$mul.ref(30,1)),0);
  $exn := false;
  $exn.shadow := false;
  return;
}
