...
procedure {:inline 1} Hacl_Curve25519_64_ecdh($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1) returns ($r: i1, $r.dup: i1)
modifies $M.9, $exn;
modifies $M.0, $M.1;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4.dup == 0));
  call $M.9, $M.9.dup := $memset.i8($M.9, $M.9.dup, $p4, $p4.dup, 0, 0, 32, 0, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Curve25519_64.c", 403, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Curve25519_64_scalarmult($p0, $p0.dup, $p1, $p1.dup, $p2, $p2.dup);
...
procedure {:entrypoint} Hacl_Curve25519_64_ecdh_wrapper($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1)
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i7, $i7.dup := Hacl_Curve25519_64_ecdh($p0, $p0.dup, $p1, $p1.dup, $p2, $p2.dup);
