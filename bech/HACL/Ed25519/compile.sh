...
# 四个需要指定的选项
deps=( ../hacl-star/dist/gcc-compatible/Hacl_Ed25519.c ../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA2.c ../hacl-star/dist/gcc-compatible/Hacl_Curve25519_51.c)

source=Hacl_Ed25519_expand_keys.c
...
source=Hacl_Ed25519_secret_to_public.c
...
source=Hacl_Ed25519_sign_expanded.c
