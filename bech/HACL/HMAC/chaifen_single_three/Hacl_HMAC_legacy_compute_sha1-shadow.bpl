...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,48639));
...
const {:allocSize 20} {:count 5} _h0: ref;
axiom (_h0 == $sub.ref(0,1044));
const {:allocSize 20} {:count 5} __const.Hacl_Hash_SHA1_legacy_hash.s: ref;
axiom (__const.Hacl_Hash_SHA1_legacy_hash.s == $sub.ref(0,2088));
const {:allocSize 70} .str: ref;
axiom (.str == $sub.ref(0,3182));
const {:allocSize 45} {:count 45} .str.1: ref;
axiom (.str.1 == $sub.ref(0,4251));
const {:allocSize 20} {:count 5} __const.Hacl_HMAC_legacy_compute_sha1.s: ref;
axiom (__const.Hacl_HMAC_legacy_compute_sha1.s == $sub.ref(0,5295));
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0,6327));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0,7359));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const llvm.memset.p0i8.i64: ref;
axiom (llvm.memset.p0i8.i64 == $sub.ref(0,8391));
...
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0,9423));
...
const Hacl_Hash_Core_SHA1_legacy_init: ref;
axiom (Hacl_Hash_Core_SHA1_legacy_init == $sub.ref(0,10455));
procedure {:inline 1} Hacl_Hash_Core_SHA1_legacy_init($p0: ref, $p0.shadow: ref)
modifies $M.1, $exn;
{
  var $i1: i64;
  var $i1.shadow: i64;
  ...
  var $p29.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i1 := $zext.i32.i64(0);
  $i1.shadow := $zext.i32.i64(0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref($i1,4));
  $p2.shadow := $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref($i1.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $i3 := $load.i32($M.0,$p2);
  ...
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $M.1 := $store.i32($M.1,$p5,$i3);
  $M.1.shadow := $store.i32($M.1.shadow,$p5.shadow,$i3.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32(0,1);
  $i6.shadow := $add.i32(0,1);
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref($i7,4));
  $p8.shadow := $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref($i7.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $i9 := $load.i32($M.0,$p8);
  ...
  assume {:verifier.code 0} true;
  $i10 := $zext.i32.i64($i6);
  $i10.shadow := $zext.i32.i64($i6.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i12 := $add.i32($i6,1);
  $i12.shadow := $add.i32($i6.shadow,1);
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref($i13,4));
  $p14.shadow := $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref($i13.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  ...
  $i16.shadow := $zext.i32.i64($i12.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  ...
  $M.1 := $store.i32($M.1,$p17,$i15);
  $M.1.shadow := $store.i32($M.1.shadow,$p17.shadow,$i15.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i32($i12,1);
  $i18.shadow := $add.i32($i12.shadow,1);
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref($i19,4));
  $p20.shadow := $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref($i19.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  assert ($p20 == $p20.shadow);
  $i21 := $load.i32($M.0,$p20);
  $i21.shadow := $load.i32($M.0.shadow,$p20.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i32.i64($i18);
  $i22.shadow := $zext.i32.i64($i18.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p0,$mul.ref($i22,4));
  $p23.shadow := $add.ref($p0.shadow,$mul.ref($i22.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  assert ($p23 == $p23.shadow);
  $M.1 := $store.i32($M.1,$p23,$i21);
  $M.1.shadow := $store.i32($M.1.shadow,$p23.shadow,$i21.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i32($i18,1);
  $i24.shadow := $add.i32($i18.shadow,1);
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref($i25,4));
  $p26.shadow := $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref($i25.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  ...
  $i28.shadow := $zext.i32.i64($i24.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  ...
  $M.1.shadow := $store.i32($M.1.shadow,$p29.shadow,$i27.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 37, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 38, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const Hacl_Hash_Core_SHA1_legacy_finish: ref;
axiom (Hacl_Hash_Core_SHA1_legacy_finish == $sub.ref(0,11487));
procedure {:inline 1} Hacl_Hash_Core_SHA1_legacy_finish($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $exn;
modifies $M.2, $M.3;
modifies $CurrAddr;
{
  ...
  var $i40.shadow: i32;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  ...
  $p4.shadow := $add.ref($p1.shadow,$mul.ref($i3.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i32.i64(0);
  $i5.shadow := $zext.i32.i64(0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  call $i8, $i8.shadow := __bswap_32($i7, $i7.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  call store32.1($p4, $p4.shadow, $i8, $i8.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32(0,1);
  $i9.shadow := $add.i32(0,1);
  call {:cexpr "i"} boogie_si_record_i32($i9);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i10 := $mul.i32($i9,4);
  $i10.shadow := $mul.i32($i9.shadow,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p12.shadow := $add.ref($p1.shadow,$mul.ref($i11.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i32.i64($i9);
  $i13.shadow := $zext.i32.i64($i9.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  call $i16, $i16.shadow := __bswap_32($i15, $i15.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  call store32.1($p12, $p12.shadow, $i16, $i16.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i32($i9,1);
  $i17.shadow := $add.i32($i9.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i17);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i18 := $mul.i32($i17,4);
  $i18.shadow := $mul.i32($i17.shadow,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i32.i64($i18);
  $i19.shadow := $zext.i32.i64($i18.shadow);
  ...
  $p20.shadow := $add.ref($p1.shadow,$mul.ref($i19.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i21 := $zext.i32.i64($i17);
  $i21.shadow := $zext.i32.i64($i17.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p0,$mul.ref($i21,4));
  $p22.shadow := $add.ref($p0.shadow,$mul.ref($i21.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  assert ($p22 == $p22.shadow);
  $i23 := $load.i32($M.1,$p22);
  $i23.shadow := $load.i32($M.1.shadow,$p22.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  call $i24, $i24.shadow := __bswap_32($i23, $i23.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  call store32.1($p20, $p20.shadow, $i24, $i24.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i17,1);
  $i25.shadow := $add.i32($i17.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i25);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i26 := $mul.i32($i25,4);
  $i26.shadow := $mul.i32($i25.shadow,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p28.shadow := $add.ref($p1.shadow,$mul.ref($i27.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i29 := $zext.i32.i64($i25);
  $i29.shadow := $zext.i32.i64($i25.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  call $i32, $i32.shadow := __bswap_32($i31, $i31.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  call store32.1($p28, $p28.shadow, $i32, $i32.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i32($i25,1);
  $i33.shadow := $add.i32($i25.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i33);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i34 := $mul.i32($i33,4);
  $i34.shadow := $mul.i32($i33.shadow,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  ...
  $p36.shadow := $add.ref($p1.shadow,$mul.ref($i35.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i32.i64($i33);
  $i37.shadow := $zext.i32.i64($i33.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  $p38 := $add.ref($p0,$mul.ref($i37,4));
  $p38.shadow := $add.ref($p0.shadow,$mul.ref($i37.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  assert ($p38 == $p38.shadow);
  $i39 := $load.i32($M.1,$p38);
  $i39.shadow := $load.i32($M.1.shadow,$p38.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  call $i40, $i40.shadow := __bswap_32($i39, $i39.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  call store32.1($p36, $p36.shadow, $i40, $i40.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 158, 3} true;
  assume {:verifier.code 0} true;
  goto $bb2;
$bb2:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 163, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const __bswap_32: ref;
axiom (__bswap_32 == $sub.ref(0,12519));
procedure {:inline 1} __bswap_32($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i11.shadow: i32;
$bb0:
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 54, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__bswap_32:arg:__bsx"} boogie_si_record_i32($i0);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 54, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $and.i32($i0,4278190080);
  $i1.shadow := $and.i32($i0.shadow,4278190080);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 54, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $lshr.i32($i1,24);
  ...
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 54, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $and.i32($i0,16711680);
  $i3.shadow := $and.i32($i0.shadow,16711680);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 54, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $lshr.i32($i3,8);
  $i4.shadow := $lshr.i32($i3.shadow,8);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 54, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $or.i32($i2,$i4);
  ...
  assume {:verifier.code 0} true;
  $i6 := $and.i32($i0,65280);
  $i6.shadow := $and.i32($i0.shadow,65280);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 54, 10} true;
  assume {:verifier.code 0} true;
  $i7 := $shl.i32($i6,8);
  $i7.shadow := $shl.i32($i6.shadow,8);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 54, 10} true;
  assume {:verifier.code 0} true;
  $i8 := $or.i32($i5,$i7);
  $i8.shadow := $or.i32($i5.shadow,$i7.shadow);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 54, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $and.i32($i0,255);
  $i9.shadow := $and.i32($i0.shadow,255);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 54, 10} true;
  assume {:verifier.code 0} true;
  $i10 := $shl.i32($i9,24);
  $i10.shadow := $shl.i32($i9.shadow,24);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 54, 10} true;
  assume {:verifier.code 0} true;
  $i11 := $or.i32($i8,$i10);
  $i11.shadow := $or.i32($i8.shadow,$i10.shadow);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 54, 3} true;
  assume {:verifier.code 0} true;
  $r := $i11;
  $r.shadow := $i11.shadow;
  $exn := false;
...
const store32.1: ref;
axiom (store32.1 == $sub.ref(0,13551));
procedure {:inline 1} store32.1($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32)
...
modifies $CurrAddr;
{
  ...
  var $p3.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/karamel/include/krml/lowstar_endianness.h", 183, 3} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  $M.2.shadow := $store.i32($M.2.shadow,$p2.shadow,$i1.shadow);
  assume true;
  assume {:sourceloc "../hacl-star/dist/karamel/include/krml/lowstar_endianness.h", 183, 3} true;
  assume {:verifier.code 0} true;
  ...
  assert ($p0 == $p0.shadow);
  assert ($p3 == $p3.shadow);
  call $M.3, $M.3.shadow := $memcpy.i8($M.3, $M.3.shadow, $M.2, $M.2.shadow, $p0, $p0.shadow, $p3, $p3.shadow, 4, 4, false, false);
  assume {:sourceloc "../hacl-star/dist/karamel/include/krml/lowstar_endianness.h", 184, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const Hacl_Hash_SHA1_legacy_update_multi: ref;
axiom (Hacl_Hash_SHA1_legacy_update_multi == $sub.ref(0,14583));
procedure {:inline 1} Hacl_Hash_SHA1_legacy_update_multi($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32)
modifies $exn;
modifies $M.4, $M.1;
modifies $M.5;
modifies $CurrAddr;
{
  ...
  var $i8.shadow: i32;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 167, 8} true;
  assume {:verifier.code 0} true;
  call {:cexpr "Hacl_Hash_SHA1_legacy_update_multi:arg:n_blocks"} boogie_si_record_i32($i2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 167, 8} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  $i3.shadow := 0;
...
$bb1:
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 167, 37} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.i32($i3,$i2);
  $i4.shadow := $ult.i32($i3.shadow,$i2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 167, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 170, 34} true;
  assume {:verifier.code 0} true;
  $i5 := $mul.i32(64,$i3);
  $i5.shadow := $mul.i32(64,$i3.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 170, 29} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i32.i64($i5);
  ...
  $p7.shadow := $add.ref($p1.shadow,$mul.ref($i6.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 171, 5} true;
  assume {:verifier.code 0} true;
  call legacy_update($p0, $p0.shadow, $p7, $p7.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 172, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i4 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 173, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 167, 50} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i3,1);
  $i8.shadow := $add.i32($i3.shadow,1);
...
const legacy_update: ref;
axiom (legacy_update == $sub.ref(0,15615));
procedure {:inline 1} legacy_update($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $M.4, $M.1, $exn;
modifies $M.5;
modifies $CurrAddr;
{
  var $p2: ref;
  ...
  var $p128.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 42, 17} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p2 := $alloc($mul.ref(320,$zext.i32.i64(1)));
  $p2.shadow := $p2;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 42, 17} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "ha"} boogie_si_record_i32($i4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 43, 17} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0,$mul.ref(1,4));
  $p5.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 43, 17} true;
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $i6 := $load.i32($M.1,$p5);
  $i6.shadow := $load.i32($M.1.shadow,$p5.shadow);
  call {:cexpr "hb"} boogie_si_record_i32($i6);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 44, 17} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p0,$mul.ref(2,4));
  $p7.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 44, 17} true;
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $i8 := $load.i32($M.1,$p7);
  $i8.shadow := $load.i32($M.1.shadow,$p7.shadow);
  call {:cexpr "hc"} boogie_si_record_i32($i8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 45, 17} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(3,4));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 45, 17} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $i10 := $load.i32($M.1,$p9);
  $i10.shadow := $load.i32($M.1.shadow,$p9.shadow);
  call {:cexpr "hd"} boogie_si_record_i32($i10);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 46, 17} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p0,$mul.ref(4,4));
  $p11.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 46, 17} true;
  assume {:verifier.code 0} true;
  assert ($p11 == $p11.shadow);
  $i12 := $load.i32($M.1,$p11);
  $i12.shadow := $load.i32($M.1.shadow,$p11.shadow);
  call {:cexpr "he"} boogie_si_record_i32($i12);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 47, 12} true;
  assume {:verifier.code 0} true;
  $p13 := $bitcast.ref.ref($p2);
  $p13.shadow := $bitcast.ref.ref($p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 47, 12} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  call $M.4, $M.4.shadow := $memset.i8($M.4, $M.4.shadow, $p13, $p13.shadow, 0, 0, 320, 320, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 48, 8} true;
  assume {:verifier.code 0} true;
  $i14 := 0;
  $i14.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 48, 37} true;
  assume {:verifier.code 0} true;
  $i15 := $ult.i32($i14,80);
  $i15.shadow := $ult.i32($i14.shadow,80);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 48, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i15 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 51, 11} true;
  assume {:verifier.code 0} true;
  $i16 := $ult.i32($i14,16);
  $i16.shadow := $ult.i32($i14.shadow,16);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 51, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !($i15 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 70, 8} true;
  assume {:verifier.code 0} true;
  $i51 := 0;
  $i51.shadow := 0;
  goto $bb8;
$bb4:
  assume ($i16 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 53, 26} true;
  assume {:verifier.code 0} true;
  $i17 := $mul.i32($i14,4);
  $i17.shadow := $mul.i32($i14.shadow,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 53, 22} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 54, 20} true;
  assume {:verifier.code 0} true;
  call $i20, $i20.shadow := load32.2($p19, $p19.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 54, 20} true;
  assume {:verifier.code 0} true;
  call $i21, $i21.shadow := __bswap_32($i20, $i20.shadow);
  call {:cexpr "u"} boogie_si_record_i32($i21);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 56, 5} true;
  assume {:verifier.code 0} true;
  $i22 := $i21;
  $i22.shadow := $i21.shadow;
  goto $bb6;
$bb5:
  assume !($i16 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 59, 29} true;
  assume {:verifier.code 0} true;
  $i23 := $sub.i32($i14,3);
  $i23.shadow := $sub.i32($i14.shadow,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 59, 24} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i32.i64($i23);
  $i24.shadow := $zext.i32.i64($i23.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 59, 24} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p2,$mul.ref(0,320)),$mul.ref($i24,4));
  $p25.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,320)),$mul.ref($i24.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 59, 24} true;
  assume {:verifier.code 0} true;
  assert ($p25 == $p25.shadow);
  $i26 := $load.i32($M.4,$p25);
  $i26.shadow := $load.i32($M.4.shadow,$p25.shadow);
  call {:cexpr "wmit3"} boogie_si_record_i32($i26);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 60, 29} true;
  assume {:verifier.code 0} true;
  $i27 := $sub.i32($i14,8);
  $i27.shadow := $sub.i32($i14.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 60, 24} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i32.i64($i27);
  $i28.shadow := $zext.i32.i64($i27.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 60, 24} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p2,$mul.ref(0,320)),$mul.ref($i28,4));
  $p29.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,320)),$mul.ref($i28.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 60, 24} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $i30 := $load.i32($M.4,$p29);
  $i30.shadow := $load.i32($M.4.shadow,$p29.shadow);
  call {:cexpr "wmit8"} boogie_si_record_i32($i30);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 61, 30} true;
  assume {:verifier.code 0} true;
  $i31 := $sub.i32($i14,14);
  $i31.shadow := $sub.i32($i14.shadow,14);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 61, 25} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i32.i64($i31);
  $i32.shadow := $zext.i32.i64($i31.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 61, 25} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref($p2,$mul.ref(0,320)),$mul.ref($i32,4));
  $p33.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,320)),$mul.ref($i32.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 61, 25} true;
  assume {:verifier.code 0} true;
  assert ($p33 == $p33.shadow);
  $i34 := $load.i32($M.4,$p33);
  $i34.shadow := $load.i32($M.4.shadow,$p33.shadow);
  call {:cexpr "wmit14"} boogie_si_record_i32($i34);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 62, 30} true;
  assume {:verifier.code 0} true;
  $i35 := $sub.i32($i14,16);
  $i35.shadow := $sub.i32($i14.shadow,16);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 62, 25} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i32.i64($i35);
  $i36.shadow := $zext.i32.i64($i35.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 62, 25} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($add.ref($p2,$mul.ref(0,320)),$mul.ref($i36,4));
  $p37.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,320)),$mul.ref($i36.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 62, 25} true;
  assume {:verifier.code 0} true;
  assert ($p37 == $p37.shadow);
  $i38 := $load.i32($M.4,$p37);
  $i38.shadow := $load.i32($M.4.shadow,$p37.shadow);
  call {:cexpr "wmit16"} boogie_si_record_i32($i38);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 64, 35} true;
  assume {:verifier.code 0} true;
  $i39 := $xor.i32($i34,$i38);
  $i39.shadow := $xor.i32($i34.shadow,$i38.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 64, 25} true;
  assume {:verifier.code 0} true;
  $i40 := $xor.i32($i30,$i39);
  $i40.shadow := $xor.i32($i30.shadow,$i39.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 64, 16} true;
  assume {:verifier.code 0} true;
  $i41 := $xor.i32($i26,$i40);
  $i41.shadow := $xor.i32($i26.shadow,$i40.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 65, 9} true;
  assume {:verifier.code 0} true;
  $i42 := $shl.i32($i41,1);
  $i42.shadow := $shl.i32($i41.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 66, 37} true;
  assume {:verifier.code 0} true;
  $i43 := $xor.i32($i34,$i38);
  $i43.shadow := $xor.i32($i34.shadow,$i38.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 66, 27} true;
  assume {:verifier.code 0} true;
  $i44 := $xor.i32($i30,$i43);
  $i44.shadow := $xor.i32($i30.shadow,$i43.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 66, 18} true;
  assume {:verifier.code 0} true;
  $i45 := $xor.i32($i26,$i44);
  $i45.shadow := $xor.i32($i26.shadow,$i44.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 66, 49} true;
  assume {:verifier.code 0} true;
  $i46 := $lshr.i32($i45,31);
  $i46.shadow := $lshr.i32($i45.shadow,31);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 66, 9} true;
  assume {:verifier.code 0} true;
  $i47 := $or.i32($i42,$i46);
  $i47.shadow := $or.i32($i42.shadow,$i46.shadow);
  call {:cexpr "v"} boogie_si_record_i32($i47);
  assume {:verifier.code 0} true;
  $i22 := $i47;
  $i22.shadow := $i47.shadow;
  goto $bb6;
$bb6:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 68, 5} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i32.i64($i14);
  $i48.shadow := $zext.i32.i64($i14.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 68, 5} true;
  assume {:verifier.code 0} true;
  $p49 := $add.ref($add.ref($p2,$mul.ref(0,320)),$mul.ref($i48,4));
  $p49.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,320)),$mul.ref($i48.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 68, 11} true;
  assume {:verifier.code 0} true;
  assert ($p49 == $p49.shadow);
  $M.4 := $store.i32($M.4,$p49,$i22);
  $M.4.shadow := $store.i32($M.4.shadow,$p49.shadow,$i22.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 69, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 48, 55} true;
  assume {:verifier.code 0} true;
  $i50 := $add.i32($i14,1);
  $i50.shadow := $add.i32($i14.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i50);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 48, 3} true;
  assume {:verifier.code 0} true;
  $i14 := $i50;
  $i14.shadow := $i50.shadow;
  goto $bb1;
$bb8:
  assert {:shadow_invariant} $shadow_ok;
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 70, 37} true;
  assume {:verifier.code 0} true;
  $i52 := $ult.i32($i51,80);
  $i52.shadow := $ult.i32($i51.shadow,80);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 70, 3} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume ($i52 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 72, 19} true;
  assume {:verifier.code 0} true;
  $p53 := $add.ref($p0,$mul.ref(0,4));
  $p53.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 72, 19} true;
  assume {:verifier.code 0} true;
  assert ($p53 == $p53.shadow);
  $i54 := $load.i32($M.1,$p53);
  $i54.shadow := $load.i32($M.1.shadow,$p53.shadow);
  call {:cexpr "_a"} boogie_si_record_i32($i54);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 73, 19} true;
  assume {:verifier.code 0} true;
  $p55 := $add.ref($p0,$mul.ref(1,4));
  $p55.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 73, 19} true;
  assume {:verifier.code 0} true;
  assert ($p55 == $p55.shadow);
  $i56 := $load.i32($M.1,$p55);
  $i56.shadow := $load.i32($M.1.shadow,$p55.shadow);
  call {:cexpr "_b"} boogie_si_record_i32($i56);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 74, 19} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($p0,$mul.ref(2,4));
  $p57.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 74, 19} true;
  assume {:verifier.code 0} true;
  assert ($p57 == $p57.shadow);
  $i58 := $load.i32($M.1,$p57);
  $i58.shadow := $load.i32($M.1.shadow,$p57.shadow);
  call {:cexpr "_c"} boogie_si_record_i32($i58);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 75, 19} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($p0,$mul.ref(3,4));
  $p59.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 75, 19} true;
  assume {:verifier.code 0} true;
  assert ($p59 == $p59.shadow);
  $i60 := $load.i32($M.1,$p59);
  $i60.shadow := $load.i32($M.1.shadow,$p59.shadow);
  call {:cexpr "_d"} boogie_si_record_i32($i60);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 76, 19} true;
  assume {:verifier.code 0} true;
  $p61 := $add.ref($p0,$mul.ref(4,4));
  $p61.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 76, 19} true;
  assume {:verifier.code 0} true;
  assert ($p61 == $p61.shadow);
  $i62 := $load.i32($M.1,$p61);
  $i62.shadow := $load.i32($M.1.shadow,$p61.shadow);
  call {:cexpr "_e"} boogie_si_record_i32($i62);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 77, 21} true;
  assume {:verifier.code 0} true;
  $i63 := $zext.i32.i64($i51);
  $i63.shadow := $zext.i32.i64($i51.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 77, 21} true;
  assume {:verifier.code 0} true;
  $p64 := $add.ref($add.ref($p2,$mul.ref(0,320)),$mul.ref($i63,4));
  $p64.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,320)),$mul.ref($i63.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 77, 21} true;
  assume {:verifier.code 0} true;
  assert ($p64 == $p64.shadow);
  $i65 := $load.i32($M.4,$p64);
  $i65.shadow := $load.i32($M.4.shadow,$p64.shadow);
  call {:cexpr "wmit"} boogie_si_record_i32($i65);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 79, 11} true;
  assume {:verifier.code 0} true;
  $i66 := $ult.i32($i51,20);
  $i66.shadow := $ult.i32($i51.shadow,20);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 79, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i66} true;
  assert ($i66 == $i66.shadow);
  goto $bb11, $bb12;
$bb10:
  assume !($i52 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 115, 8} true;
  assume {:verifier.code 0} true;
  $i104 := 0;
  $i104.shadow := 0;
  goto $bb30;
$bb11:
  assume ($i66 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 81, 18} true;
  assume {:verifier.code 0} true;
  $i67 := $and.i32($i56,$i58);
  $i67.shadow := $and.i32($i56.shadow,$i58.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 81, 27} true;
  assume {:verifier.code 0} true;
  $i68 := $xor.i32($i56,$sub.i32(0,1));
  $i68.shadow := $xor.i32($i56.shadow,$sub.i32(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 81, 31} true;
  assume {:verifier.code 0} true;
  $i69 := $and.i32($i68,$i60);
  $i69.shadow := $and.i32($i68.shadow,$i60.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 81, 24} true;
  assume {:verifier.code 0} true;
  $i70 := $xor.i32($i67,$i69);
  $i70.shadow := $xor.i32($i67.shadow,$i69.shadow);
  call {:cexpr "ite0"} boogie_si_record_i32($i70);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 82, 5} true;
  assume {:verifier.code 0} true;
  $i71 := $i70;
  $i71.shadow := $i70.shadow;
  goto $bb13;
$bb12:
  assume !($i66 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 83, 28} true;
  assume {:verifier.code 0} true;
  $i72 := $ult.i32(39,$i51);
  $i72.shadow := $ult.i32(39,$i51.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 83, 32} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i72} true;
  assert ($i72 == $i72.shadow);
  goto $bb14, $bb15;
$bb13:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 92, 11} true;
  assume {:verifier.code 0} true;
  $i82 := $ult.i32($i51,20);
  $i82.shadow := $ult.i32($i51.shadow,20);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 92, 9} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume ($i72 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 83, 37} true;
  assume {:verifier.code 0} true;
  $i73 := $ult.i32($i51,60);
  $i73.shadow := $ult.i32($i51.shadow,60);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 83, 14} true;
  assume {:verifier.code 0} true;
...
$bb15:
  ...
  goto $bb16;
$bb16:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 89, 23} true;
  assume {:verifier.code 0} true;
  $i80 := $xor.i32($i58,$i60);
  $i80.shadow := $xor.i32($i58.shadow,$i60.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 89, 17} true;
  assume {:verifier.code 0} true;
  $i81 := $xor.i32($i56,$i80);
  $i81.shadow := $xor.i32($i56.shadow,$i80.shadow);
  call {:cexpr "ite0"} boogie_si_record_i32($i81);
  assume {:verifier.code 0} true;
  $i79 := $i81;
  $i79.shadow := $i81.shadow;
  goto $bb19;
$bb17:
  assume ($i73 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 85, 18} true;
  assume {:verifier.code 0} true;
  $i74 := $and.i32($i56,$i58);
  $i74.shadow := $and.i32($i56.shadow,$i58.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 85, 31} true;
  assume {:verifier.code 0} true;
  $i75 := $and.i32($i56,$i60);
  $i75.shadow := $and.i32($i56.shadow,$i60.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 85, 43} true;
  assume {:verifier.code 0} true;
  $i76 := $and.i32($i58,$i60);
  $i76.shadow := $and.i32($i58.shadow,$i60.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 85, 37} true;
  assume {:verifier.code 0} true;
  $i77 := $xor.i32($i75,$i76);
  $i77.shadow := $xor.i32($i75.shadow,$i76.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 85, 24} true;
  assume {:verifier.code 0} true;
  $i78 := $xor.i32($i74,$i77);
  $i78.shadow := $xor.i32($i74.shadow,$i77.shadow);
  call {:cexpr "ite0"} boogie_si_record_i32($i78);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 86, 5} true;
  assume {:verifier.code 0} true;
  $i79 := $i78;
  $i79.shadow := $i78.shadow;
  goto $bb19;
$bb18:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 83, 14} true;
  assume {:verifier.code 0} true;
...
$bb19:
  ...
  assume {:verifier.code 0} true;
  $i71 := $i79;
  $i71.shadow := $i79.shadow;
  goto $bb13;
$bb20:
  assume ($i82 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 95, 5} true;
  assume {:verifier.code 0} true;
  $i83 := 1518500249;
  $i83.shadow := 1518500249;
  goto $bb22;
$bb21:
  assume !($i82 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 96, 16} true;
  assume {:verifier.code 0} true;
  $i84 := $ult.i32($i51,40);
  $i84.shadow := $ult.i32($i51.shadow,40);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 96, 14} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i84} true;
  assert ($i84 == $i84.shadow);
  goto $bb23, $bb24;
$bb22:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 108, 23} true;
  assume {:verifier.code 0} true;
  $i88 := $shl.i32($i54,5);
  $i88.shadow := $shl.i32($i54.shadow,5);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 108, 44} true;
  assume {:verifier.code 0} true;
  $i89 := $lshr.i32($i54,27);
  $i89.shadow := $lshr.i32($i54.shadow,27);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 108, 39} true;
  assume {:verifier.code 0} true;
  $i90 := $or.i32($i88,$i89);
  $i90.shadow := $or.i32($i88.shadow,$i89.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 108, 62} true;
  assume {:verifier.code 0} true;
  $i91 := $add.i32($i90,$i71);
  $i91.shadow := $add.i32($i90.shadow,$i71.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 108, 69} true;
  assume {:verifier.code 0} true;
  $i92 := $add.i32($i91,$i62);
  $i92.shadow := $add.i32($i91.shadow,$i62.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 108, 74} true;
  assume {:verifier.code 0} true;
  $i93 := $add.i32($i92,$i83);
  $i93.shadow := $add.i32($i92.shadow,$i83.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 108, 80} true;
  assume {:verifier.code 0} true;
  $i94 := $add.i32($i93,$i65);
  $i94.shadow := $add.i32($i93.shadow,$i65.shadow);
  call {:cexpr "_T"} boogie_si_record_i32($i94);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 109, 5} true;
  assume {:verifier.code 0} true;
  $p95 := $add.ref($p0,$mul.ref(0,4));
  $p95.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 109, 11} true;
  assume {:verifier.code 0} true;
  assert ($p95 == $p95.shadow);
  $M.1 := $store.i32($M.1,$p95,$i94);
  $M.1.shadow := $store.i32($M.1.shadow,$p95.shadow,$i94.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 110, 5} true;
  assume {:verifier.code 0} true;
  $p96 := $add.ref($p0,$mul.ref(1,4));
  $p96.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 110, 11} true;
  assume {:verifier.code 0} true;
  assert ($p96 == $p96.shadow);
  $M.1 := $store.i32($M.1,$p96,$i54);
  $M.1.shadow := $store.i32($M.1.shadow,$p96.shadow,$i54.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 111, 16} true;
  assume {:verifier.code 0} true;
  $i97 := $shl.i32($i56,30);
  $i97.shadow := $shl.i32($i56.shadow,30);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 111, 38} true;
  assume {:verifier.code 0} true;
  $i98 := $lshr.i32($i56,2);
  $i98.shadow := $lshr.i32($i56.shadow,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 111, 33} true;
  assume {:verifier.code 0} true;
  $i99 := $or.i32($i97,$i98);
  $i99.shadow := $or.i32($i97.shadow,$i98.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 111, 5} true;
  assume {:verifier.code 0} true;
  $p100 := $add.ref($p0,$mul.ref(2,4));
  $p100.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 111, 11} true;
  assume {:verifier.code 0} true;
  assert ($p100 == $p100.shadow);
  $M.1 := $store.i32($M.1,$p100,$i99);
  $M.1.shadow := $store.i32($M.1.shadow,$p100.shadow,$i99.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 112, 5} true;
  assume {:verifier.code 0} true;
  $p101 := $add.ref($p0,$mul.ref(3,4));
  $p101.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 112, 11} true;
  assume {:verifier.code 0} true;
  assert ($p101 == $p101.shadow);
  $M.1 := $store.i32($M.1,$p101,$i58);
  $M.1.shadow := $store.i32($M.1.shadow,$p101.shadow,$i58.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 113, 5} true;
  assume {:verifier.code 0} true;
  $p102 := $add.ref($p0,$mul.ref(4,4));
  $p102.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 113, 11} true;
  assume {:verifier.code 0} true;
  assert ($p102 == $p102.shadow);
  $M.1 := $store.i32($M.1,$p102,$i60);
  $M.1.shadow := $store.i32($M.1.shadow,$p102.shadow,$i60.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 114, 3} true;
  assume {:verifier.code 0} true;
  goto $bb29;
$bb23:
  assume ($i84 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 99, 5} true;
  assume {:verifier.code 0} true;
  $i85 := 1859775393;
  $i85.shadow := 1859775393;
  goto $bb25;
$bb24:
  assume !($i84 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 100, 16} true;
  assume {:verifier.code 0} true;
  $i86 := $ult.i32($i51,60);
  $i86.shadow := $ult.i32($i51.shadow,60);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 100, 14} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i86} true;
  assert ($i86 == $i86.shadow);
  goto $bb26, $bb27;
$bb25:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i83 := $i85;
  $i83.shadow := $i85.shadow;
  goto $bb22;
$bb26:
  assume ($i86 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 103, 5} true;
  assume {:verifier.code 0} true;
  $i87 := $sub.i32(0,1894007588);
  $i87.shadow := $sub.i32(0,1894007588);
  goto $bb28;
$bb27:
  assume !($i86 == 1);
  assume {:verifier.code 0} true;
  $i87 := $sub.i32(0,899497514);
  $i87.shadow := $sub.i32(0,899497514);
  goto $bb28;
$bb28:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  $i85 := $i87;
  $i85.shadow := $i87.shadow;
  goto $bb25;
$bb29:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 70, 55} true;
  assume {:verifier.code 0} true;
  $i103 := $add.i32($i51,1);
  $i103.shadow := $add.i32($i51.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i103);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 70, 3} true;
  assume {:verifier.code 0} true;
  $i51 := $i103;
  $i51.shadow := $i103.shadow;
  goto $bb8;
$bb30:
  assert {:shadow_invariant} $shadow_ok;
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 115, 37} true;
  assume {:verifier.code 0} true;
  $i105 := $ult.i32($i104,80);
  $i105.shadow := $ult.i32($i104.shadow,80);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 115, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i105} true;
  assert ($i105 == $i105.shadow);
  goto $bb31, $bb32;
$bb31:
  assume ($i105 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 117, 5} true;
  assume {:verifier.code 0} true;
  $i106 := $zext.i32.i64($i104);
  $i106.shadow := $zext.i32.i64($i104.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 117, 5} true;
  assume {:verifier.code 0} true;
  $p107 := $add.ref($add.ref($p2,$mul.ref(0,320)),$mul.ref($i106,4));
  $p107.shadow := $add.ref($add.ref($p2.shadow,$mul.ref(0,320)),$mul.ref($i106.shadow,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 117, 11} true;
  assume {:verifier.code 0} true;
  assert ($p107 == $p107.shadow);
  $M.4 := $store.i32($M.4,$p107,0);
  $M.4.shadow := $store.i32($M.4.shadow,$p107.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 118, 3} true;
  assume {:verifier.code 0} true;
  goto $bb33;
$bb32:
  assume !($i105 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 119, 18} true;
  assume {:verifier.code 0} true;
  $p109 := $add.ref($p0,$mul.ref(0,4));
  $p109.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 119, 18} true;
  assume {:verifier.code 0} true;
  assert ($p109 == $p109.shadow);
  $i110 := $load.i32($M.1,$p109);
  $i110.shadow := $load.i32($M.1.shadow,$p109.shadow);
  call {:cexpr "sta"} boogie_si_record_i32($i110);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 120, 18} true;
  assume {:verifier.code 0} true;
  $p111 := $add.ref($p0,$mul.ref(1,4));
  $p111.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 120, 18} true;
  assume {:verifier.code 0} true;
  assert ($p111 == $p111.shadow);
  $i112 := $load.i32($M.1,$p111);
  $i112.shadow := $load.i32($M.1.shadow,$p111.shadow);
  call {:cexpr "stb"} boogie_si_record_i32($i112);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 121, 18} true;
  assume {:verifier.code 0} true;
  $p113 := $add.ref($p0,$mul.ref(2,4));
  $p113.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 121, 18} true;
  assume {:verifier.code 0} true;
  assert ($p113 == $p113.shadow);
  $i114 := $load.i32($M.1,$p113);
  $i114.shadow := $load.i32($M.1.shadow,$p113.shadow);
  call {:cexpr "stc"} boogie_si_record_i32($i114);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 122, 18} true;
  assume {:verifier.code 0} true;
  $p115 := $add.ref($p0,$mul.ref(3,4));
  $p115.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 122, 18} true;
  assume {:verifier.code 0} true;
  assert ($p115 == $p115.shadow);
  $i116 := $load.i32($M.1,$p115);
  $i116.shadow := $load.i32($M.1.shadow,$p115.shadow);
  call {:cexpr "std"} boogie_si_record_i32($i116);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 123, 18} true;
  assume {:verifier.code 0} true;
  $p117 := $add.ref($p0,$mul.ref(4,4));
  $p117.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 123, 18} true;
  assume {:verifier.code 0} true;
  assert ($p117 == $p117.shadow);
  $i118 := $load.i32($M.1,$p117);
  $i118.shadow := $load.i32($M.1.shadow,$p117.shadow);
  call {:cexpr "ste"} boogie_si_record_i32($i118);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 124, 15} true;
  assume {:verifier.code 0} true;
  $i119 := $add.i32($i110,$i4);
  $i119.shadow := $add.i32($i110.shadow,$i4.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 124, 3} true;
  assume {:verifier.code 0} true;
  $p120 := $add.ref($p0,$mul.ref(0,4));
  $p120.shadow := $add.ref($p0.shadow,$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 124, 9} true;
  assume {:verifier.code 0} true;
  assert ($p120 == $p120.shadow);
  $M.1 := $store.i32($M.1,$p120,$i119);
  $M.1.shadow := $store.i32($M.1.shadow,$p120.shadow,$i119.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 125, 15} true;
  assume {:verifier.code 0} true;
  $i121 := $add.i32($i112,$i6);
  $i121.shadow := $add.i32($i112.shadow,$i6.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 125, 3} true;
  assume {:verifier.code 0} true;
  $p122 := $add.ref($p0,$mul.ref(1,4));
  $p122.shadow := $add.ref($p0.shadow,$mul.ref(1,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 125, 9} true;
  assume {:verifier.code 0} true;
  assert ($p122 == $p122.shadow);
  $M.1 := $store.i32($M.1,$p122,$i121);
  $M.1.shadow := $store.i32($M.1.shadow,$p122.shadow,$i121.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 126, 15} true;
  assume {:verifier.code 0} true;
  $i123 := $add.i32($i114,$i8);
  $i123.shadow := $add.i32($i114.shadow,$i8.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 126, 3} true;
  assume {:verifier.code 0} true;
  $p124 := $add.ref($p0,$mul.ref(2,4));
  $p124.shadow := $add.ref($p0.shadow,$mul.ref(2,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 126, 9} true;
  assume {:verifier.code 0} true;
  assert ($p124 == $p124.shadow);
  $M.1 := $store.i32($M.1,$p124,$i123);
  $M.1.shadow := $store.i32($M.1.shadow,$p124.shadow,$i123.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 127, 15} true;
  assume {:verifier.code 0} true;
  $i125 := $add.i32($i116,$i10);
  $i125.shadow := $add.i32($i116.shadow,$i10.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 127, 3} true;
  assume {:verifier.code 0} true;
  $p126 := $add.ref($p0,$mul.ref(3,4));
  $p126.shadow := $add.ref($p0.shadow,$mul.ref(3,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 127, 9} true;
  assume {:verifier.code 0} true;
  assert ($p126 == $p126.shadow);
  $M.1 := $store.i32($M.1,$p126,$i125);
  $M.1.shadow := $store.i32($M.1.shadow,$p126.shadow,$i125.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 128, 15} true;
  assume {:verifier.code 0} true;
  $i127 := $add.i32($i118,$i12);
  $i127.shadow := $add.i32($i118.shadow,$i12.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 128, 3} true;
  assume {:verifier.code 0} true;
  $p128 := $add.ref($p0,$mul.ref(4,4));
  $p128.shadow := $add.ref($p0.shadow,$mul.ref(4,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 128, 9} true;
  assume {:verifier.code 0} true;
  assert ($p128 == $p128.shadow);
  $M.1 := $store.i32($M.1,$p128,$i127);
  $M.1.shadow := $store.i32($M.1.shadow,$p128.shadow,$i127.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 129, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb33:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 115, 55} true;
  assume {:verifier.code 0} true;
  $i108 := $add.i32($i104,1);
  $i108.shadow := $add.i32($i104.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i108);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 115, 3} true;
  assume {:verifier.code 0} true;
  $i104 := $i108;
  $i104.shadow := $i108.shadow;
  goto $bb30;
}
const load32.2: ref;
axiom (load32.2 == $sub.ref(0,16647));
procedure {:inline 1} load32.2($p0: ref, $p0.shadow: ref) returns ($r: i32, $r.shadow: i32)
modifies $M.5, $exn;
modifies $CurrAddr;
{
  var $p1: ref;
  ...
  var $i3.shadow: i32;
$bb0:
  assume {:sourceloc "../hacl-star/dist/karamel/include/krml/lowstar_endianness.h", 168, 3} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assert ($p2 == $p2.shadow);
  assert ($p0 == $p0.shadow);
  call $M.5, $M.5.shadow := $memcpy.i8($M.5, $M.5.shadow, $M.3, $M.3.shadow, $p2, $p2.shadow, $p0, $p0.shadow, 4, 4, false, false);
  assume {:sourceloc "../hacl-star/dist/karamel/include/krml/lowstar_endianness.h", 169, 10} true;
  assume {:verifier.code 0} true;
  assert ($p1 == $p1.shadow);
  $i3 := $load.i32($M.5,$p1);
  $i3.shadow := $load.i32($M.5.shadow,$p1.shadow);
  assume {:sourceloc "../hacl-star/dist/karamel/include/krml/lowstar_endianness.h", 169, 3} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $r.shadow := $i3.shadow;
  $exn := false;
...
const Hacl_Hash_SHA1_legacy_update_last: ref;
axiom (Hacl_Hash_SHA1_legacy_update_last == $sub.ref(0,17679));
procedure {:inline 1} Hacl_Hash_SHA1_legacy_update_last($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64, $p2: ref, $p2.shadow: ref, $i3: i32, $i3.shadow: i32)
modifies $M.3, $exn;
modifies $M.4, $M.1;
modifies $M.6;
modifies $CurrAddr;
modifies $M.5;
{
  ...
  var $i26.shadow: i32;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 183, 33} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(128,$zext.i32.i64(1)));
  $p4.shadow := $p4;
  call {:cexpr "Hacl_Hash_SHA1_legacy_update_last:arg:prev_len"} boogie_si_record_i64($i1);
  call {:cexpr "Hacl_Hash_SHA1_legacy_update_last:arg:input_len"} boogie_si_record_i32($i3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 183, 33} true;
  assume {:verifier.code 0} true;
  $i5 := $udiv.i32($i3,64);
  $i5.shadow := $udiv.i32($i3.shadow,64);
  call {:cexpr "blocks_n"} boogie_si_record_i32($i5);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 184, 34} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i32($i5,64);
  $i6.shadow := $mul.i32($i5.shadow,64);
  call {:cexpr "blocks_len"} boogie_si_record_i32($i6);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 186, 33} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i32($i3,$i6);
  $i7.shadow := $sub.i32($i3.shadow,$i6.shadow);
  call {:cexpr "rest_len"} boogie_si_record_i32($i7);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 187, 25} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i32.i64($i6);
  $i8.shadow := $zext.i32.i64($i6.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 187, 25} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p2,$mul.ref($i8,1));
  $p9.shadow := $add.ref($p2.shadow,$mul.ref($i8.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 188, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_update_multi($p0, $p0.shadow, $p2, $p2.shadow, $i5, $i5.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 189, 41} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i32.i64($i3);
  $i10.shadow := $zext.i32.i64($i3.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 189, 39} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i64($i1,$i10);
  $i11.shadow := $add.i64($i1.shadow,$i10.shadow);
  call {:cexpr "total_input_len"} boogie_si_record_i64($i11);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 194, 68} true;
  assume {:verifier.code 0} true;
  $i12 := $urem.i64($i11,64);
  $i12.shadow := $urem.i64($i11.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 194, 41} true;
  assume {:verifier.code 0} true;
  $i13 := $trunc.i64.i32($i12);
  $i13.shadow := $trunc.i64.i32($i12.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 194, 39} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32(9,$i13);
  $i14.shadow := $add.i32(9,$i13.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 194, 23} true;
  assume {:verifier.code 0} true;
  $i15 := $sub.i32(128,$i14);
  $i15.shadow := $sub.i32(128,$i14.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 195, 7} true;
  assume {:verifier.code 0} true;
  $i16 := $urem.i32($i15,64);
  $i16.shadow := $urem.i32($i15.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 193, 5} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i32(1,$i16);
  $i17.shadow := $add.i32(1,$i16.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 196, 5} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i32($i17,8);
  $i18.shadow := $add.i32($i17.shadow,8);
  call {:cexpr "pad_len"} boogie_si_record_i32($i18);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 197, 31} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i7,$i18);
  $i19.shadow := $add.i32($i7.shadow,$i18.shadow);
  call {:cexpr "tmp_len"} boogie_si_record_i32($i19);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 198, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assert ($p20 == $p20.shadow);
  call $M.3, $M.3.shadow := $memset.i8($M.3, $M.3.shadow, $p20, $p20.shadow, 0, 0, 128, 128, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 199, 18} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p4,$mul.ref(0,128)),$mul.ref(0,1));
  $p21.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,128)),$mul.ref(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 201, 26} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i32.i64($i7);
  $i22.shadow := $zext.i32.i64($i7.shadow);
  $p23 := $add.ref($add.ref($p4,$mul.ref(0,128)),$mul.ref($i22,1));
  $p23.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,128)),$mul.ref($i22.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 202, 26} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i32.i64($i7);
  $i24.shadow := $zext.i32.i64($i7.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 202, 35} true;
  assume {:verifier.code 0} true;
  $i25 := $mul.i64($i24,1);
  $i25.shadow := $mul.i64($i24.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 202, 3} true;
  assume {:verifier.code 0} true;
  assert ($p21 == $p21.shadow);
  assert ($p9 == $p9.shadow);
  assert ($i25 == $i25.shadow);
  call $M.3, $M.3.shadow := $memcpy.i8($M.3, $M.3.shadow, $M.3, $M.3.shadow, $p21, $p21.shadow, $p9, $p9.shadow, $i25, $i25.shadow, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 203, 3} true;
  assume {:verifier.code 0} true;
  call legacy_pad($i11, $i11.shadow, $p23, $p23.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 204, 54} true;
  assume {:verifier.code 0} true;
  $i26 := $udiv.i32($i19,64);
  $i26.shadow := $udiv.i32($i19.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 204, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_update_multi($p0, $p0.shadow, $p21, $p21.shadow, $i26, $i26.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 205, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const legacy_pad: ref;
axiom (legacy_pad == $sub.ref(0,18711));
procedure {:inline 1} legacy_pad($i0: i64, $i0.shadow: i64, $p1: ref, $p1.shadow: ref)
modifies $M.3, $exn;
modifies $M.6;
modifies $CurrAddr;
{
  ...
  var $i25.shadow: i64;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 134, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "legacy_pad:arg:len"} boogie_si_record_i64($i0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 134, 3} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p1,$mul.ref(0,1));
  $p2.shadow := $add.ref($p1.shadow,$mul.ref(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 134, 12} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $M.3 := $store.i8($M.3,$p2,$sub.i8(0,128));
  $M.3.shadow := $store.i8($M.3.shadow,$p2.shadow,$sub.i8(0,128));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 135, 23} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p1,$mul.ref(1,1));
  $p3.shadow := $add.ref($p1.shadow,$mul.ref(1,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 137, 4} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  $i4.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 140, 56} true;
  assume {:verifier.code 0} true;
  $i5 := $urem.i64($i0,64);
  $i5.shadow := $urem.i64($i0.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 140, 41} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i64.i32($i5);
  $i6.shadow := $trunc.i64.i32($i5.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 140, 39} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32(9,$i6);
  $i7.shadow := $add.i32(9,$i6.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 140, 23} true;
  assume {:verifier.code 0} true;
  $i8 := $sub.i32(128,$i7);
  $i8.shadow := $sub.i32(128,$i7.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 140, 85} true;
  assume {:verifier.code 0} true;
  $i9 := $urem.i32($i8,64);
  $i9.shadow := $urem.i32($i8.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 140, 5} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i32($i4,$i9);
  $i10.shadow := $ult.i32($i4.shadow,$i9.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 136, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i10 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 143, 5} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i32.i64($i4);
  $i11.shadow := $zext.i32.i64($i4.shadow);
  $i12 := $add.i64(1,$i11);
  $i12.shadow := $add.i64(1,$i11.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 143, 5} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p1,$mul.ref($i12,1));
  $p13.shadow := $add.ref($p1.shadow,$mul.ref($i12.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 143, 13} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  $M.3 := $store.i8($M.3,$p13,0);
  $M.3.shadow := $store.i8($M.3.shadow,$p13.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 144, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i10 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 148, 5} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p1,$mul.ref(1,1));
  $p15.shadow := $add.ref($p1.shadow,$mul.ref(1,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 151, 58} true;
  assume {:verifier.code 0} true;
  $i16 := $urem.i64($i0,64);
  $i16.shadow := $urem.i64($i0.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 151, 43} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i64.i32($i16);
  $i17.shadow := $trunc.i64.i32($i16.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 151, 41} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i32(9,$i17);
  $i18.shadow := $add.i32(9,$i17.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 151, 25} true;
  assume {:verifier.code 0} true;
  $i19 := $sub.i32(128,$i18);
  $i19.shadow := $sub.i32(128,$i18.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 152, 9} true;
  assume {:verifier.code 0} true;
  $i20 := $urem.i32($i19,64);
  $i20.shadow := $urem.i32($i19.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 150, 7} true;
  assume {:verifier.code 0} true;
  $i21 := $zext.i32.i64($i20);
  $i21.shadow := $zext.i32.i64($i20.shadow);
  $i22 := $add.i64(1,$i21);
  $i22.shadow := $add.i64(1,$i21.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 150, 7} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p1,$mul.ref($i22,1));
  $p23.shadow := $add.ref($p1.shadow,$mul.ref($i22.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 153, 3} true;
  assume {:verifier.code 0} true;
  $i24 := $shl.i64($i0,3);
  $i24.shadow := $shl.i64($i0.shadow,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 153, 3} true;
  assume {:verifier.code 0} true;
  call $i25, $i25.shadow := __bswap_64($i24, $i24.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 153, 3} true;
  assume {:verifier.code 0} true;
  call store64.3($p23, $p23.shadow, $i25, $i25.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 154, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 141, 6} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i4,1);
  $i14.shadow := $add.i32($i4.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i14);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 136, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $i14;
  $i4.shadow := $i14.shadow;
  goto $bb1;
}
const __bswap_64: ref;
axiom (__bswap_64 == $sub.ref(0,19743));
procedure {:inline 1} __bswap_64($i0: i64, $i0.shadow: i64) returns ($r: i64, $r.shadow: i64)
modifies $exn;
{
  var $i1: i64;
  var $i1.shadow: i64;
  ...
  var $i23.shadow: i64;
$bb0:
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "__bswap_64:arg:__bsx"} boogie_si_record_i64($i0);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $and.i64($i0,18374686479671623680);
  $i1.shadow := $and.i64($i0.shadow,18374686479671623680);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $lshr.i64($i1,56);
  $i2.shadow := $lshr.i64($i1.shadow,56);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $and.i64($i0,71776119061217280);
  $i3.shadow := $and.i64($i0.shadow,71776119061217280);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $lshr.i64($i3,40);
  $i4.shadow := $lshr.i64($i3.shadow,40);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $or.i64($i2,$i4);
  ...
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $and.i64($i0,280375465082880);
  $i6.shadow := $and.i64($i0.shadow,280375465082880);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i7 := $lshr.i64($i6,24);
  $i7.shadow := $lshr.i64($i6.shadow,24);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i8 := $or.i64($i5,$i7);
  $i8.shadow := $or.i64($i5.shadow,$i7.shadow);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $and.i64($i0,1095216660480);
  $i9.shadow := $and.i64($i0.shadow,1095216660480);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i10 := $lshr.i64($i9,8);
  $i10.shadow := $lshr.i64($i9.shadow,8);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i11 := $or.i64($i8,$i10);
  $i11.shadow := $or.i64($i8.shadow,$i10.shadow);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $and.i64($i0,4278190080);
  $i12.shadow := $and.i64($i0.shadow,4278190080);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i13 := $shl.i64($i12,8);
  $i13.shadow := $shl.i64($i12.shadow,8);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i14 := $or.i64($i11,$i13);
  $i14.shadow := $or.i64($i11.shadow,$i13.shadow);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i15 := $and.i64($i0,16711680);
  $i15.shadow := $and.i64($i0.shadow,16711680);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i16 := $shl.i64($i15,24);
  ...
  assume {:verifier.code 0} true;
  $i17 := $or.i64($i14,$i16);
  $i17.shadow := $or.i64($i14.shadow,$i16.shadow);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i18 := $and.i64($i0,65280);
  $i18.shadow := $and.i64($i0.shadow,65280);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i19 := $shl.i64($i18,40);
  $i19.shadow := $shl.i64($i18.shadow,40);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i20 := $or.i64($i17,$i19);
  $i20.shadow := $or.i64($i17.shadow,$i19.shadow);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i21 := $and.i64($i0,255);
  $i21.shadow := $and.i64($i0.shadow,255);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i22 := $shl.i64($i21,56);
  $i22.shadow := $shl.i64($i21.shadow,56);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $or.i64($i20,$i22);
  $i23.shadow := $or.i64($i20.shadow,$i22.shadow);
  assume {:sourceloc "/usr/include/x86_64-linux-gnu/bits/byteswap.h", 75, 3} true;
  assume {:verifier.code 0} true;
  $r := $i23;
  $r.shadow := $i23.shadow;
  $exn := false;
...
const store64.3: ref;
axiom (store64.3 == $sub.ref(0,20775));
procedure {:inline 1} store64.3($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64)
modifies $M.6, $M.3, $exn;
modifies $CurrAddr;
{
  var $p2: ref;
  var $p2.shadow: ref;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $M.6 := $store.i64($M.6,$p2,$i1);
  $M.6.shadow := $store.i64($M.6.shadow,$p2.shadow,$i1.shadow);
  assume true;
  assume {:sourceloc "../hacl-star/dist/karamel/include/krml/lowstar_endianness.h", 187, 3} true;
  assume {:verifier.code 0} true;
  $p3 := $bitcast.ref.ref($p2);
  ...
  assert ($p0 == $p0.shadow);
  assert ($p3 == $p3.shadow);
  call $M.3, $M.3.shadow := $memcpy.i8($M.3, $M.3.shadow, $M.6, $M.6.shadow, $p0, $p0.shadow, $p3, $p3.shadow, 8, 8, false, false);
...
const Hacl_Hash_SHA1_legacy_hash: ref;
axiom (Hacl_Hash_SHA1_legacy_hash == $sub.ref(0,21807));
procedure {:inline 1} Hacl_Hash_SHA1_legacy_hash($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32, $p2: ref, $p2.shadow: ref)
modifies $M.1, $exn;
modifies $M.3;
modifies $M.2;
modifies $M.4;
...
modifies $M.5;
{
  ...
  var $p18.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 210, 3} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(20,$zext.i32.i64(1)));
  $p3.shadow := $p3;
  call {:cexpr "Hacl_Hash_SHA1_legacy_hash:arg:input_len"} boogie_si_record_i32($i1);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 210, 3} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assert ($p4 == $p4.shadow);
  assert (__const.Hacl_Hash_SHA1_legacy_hash.s == __const.Hacl_Hash_SHA1_legacy_hash.s);
  call $M.1, $M.1.shadow := $memcpy.i8($M.1, $M.1.shadow, $M.7, $M.7.shadow, $p4, $p4.shadow, __const.Hacl_Hash_SHA1_legacy_hash.s, __const.Hacl_Hash_SHA1_legacy_hash.s, 20, 20, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 215, 34} true;
  assume {:verifier.code 0} true;
  $i5 := $udiv.i32($i1,64);
  $i5.shadow := $udiv.i32($i1.shadow,64);
  call {:cexpr "blocks_n0"} boogie_si_record_i32($i5);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 217, 17} true;
  assume {:verifier.code 0} true;
  $i6 := $urem.i32($i1,64);
  $i6.shadow := $urem.i32($i1.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 217, 33} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6,0);
  $i7.shadow := $eq.i32($i6.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 217, 49} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i7 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 217, 62} true;
  assume {:verifier.code 0} true;
  $i8 := $ugt.i32($i5,0);
  $i8.shadow := $ugt.i32($i5.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 217, 7} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:verifier.code 0} true;
  $i10 := $i5;
  $i10.shadow := $i5.shadow;
  goto $bb6;
$bb4:
  assume ($i8 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 219, 27} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.i32($i5,1);
  $i9.shadow := $sub.i32($i5.shadow,1);
  call {:cexpr "blocks_n1"} boogie_si_record_i32($i9);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 220, 3} true;
  assume {:verifier.code 0} true;
  $i10 := $i9;
  $i10.shadow := $i9.shadow;
  goto $bb6;
$bb5:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 217, 7} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 225, 36} true;
  assume {:verifier.code 0} true;
  $i11 := $mul.i32($i10,64);
  $i11.shadow := $mul.i32($i10.shadow,64);
  call {:cexpr "blocks_len0"} boogie_si_record_i32($i11);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 227, 34} true;
  assume {:verifier.code 0} true;
  $i12 := $sub.i32($i1,$i11);
  $i12.shadow := $sub.i32($i1.shadow,$i11.shadow);
  call {:cexpr "rest_len0"} boogie_si_record_i32($i12);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 228, 26} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i32.i64($i11);
  $i13.shadow := $zext.i32.i64($i11.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 228, 26} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p0,$mul.ref($i13,1));
  $p14.shadow := $add.ref($p0.shadow,$mul.ref($i13.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 234, 38} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p3,$mul.ref(0,20)),$mul.ref(0,4));
  $p15.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 234, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_update_multi($p15, $p15.shadow, $p0, $p0.shadow, $i10, $i10.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 235, 37} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p3,$mul.ref(0,20)),$mul.ref(0,4));
  $p16.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 235, 40} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i32.i64($i11);
  $i17.shadow := $zext.i32.i64($i11.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 235, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_update_last($p16, $p16.shadow, $i17, $i17.shadow, $p14, $p14.shadow, $i12, $i12.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 236, 37} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p3,$mul.ref(0,20)),$mul.ref(0,4));
  $p18.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 236, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_Core_SHA1_legacy_finish($p18, $p18.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Hash_SHA1.c", 237, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const Hacl_HMAC_legacy_compute_sha1: ref;
axiom (Hacl_HMAC_legacy_compute_sha1 == $sub.ref(0,22839));
procedure {:inline 1} Hacl_HMAC_legacy_compute_sha1($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32, $p3: ref, $p3.shadow: ref, $i4: i32, $i4.shadow: i32)
modifies $M.3, $M.1, $M.12, $M.11, $M.10, $M.15, $M.14, $M.13, $exn;
modifies $M.2;
modifies $M.4;
modifies $CurrAddr;
modifies $M.6;
modifies $M.5;
{
  ...
  var $p127.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 49, 3} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p5 := $alloc($mul.ref(20,$zext.i32.i64(1)));
  $p5.shadow := $p5;
  assume {:verifier.code 0} true;
  ...
  $p10.shadow := $p10;
  assume {:verifier.code 0} true;
  call $p11 := $alloc($mul.ref(8,$zext.i32.i64(1)));
  $p11.shadow := $p11;
  call {:cexpr "Hacl_HMAC_legacy_compute_sha1:arg:key_len"} boogie_si_record_i32($i2);
  call {:cexpr "Hacl_HMAC_legacy_compute_sha1:arg:data_len"} boogie_si_record_i32($i4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 49, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i12 := $zext.i32.i64(64);
  $i12.shadow := $zext.i32.i64(64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 49, 3} true;
  assume {:verifier.code 0} true;
  $i13 := $ugt.i64($i12,18446744073709551615);
  $i13.shadow := $ugt.i64($i12.shadow,18446744073709551615);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 49, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 49, 3} true;
  assume {:verifier.code 0} true;
  call $i14, $i14.shadow := printf.ref.ref.i32(.str, .str, .str.1, .str.1, 49, 49);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 49, 3} true;
  assume {:verifier.code 0} true;
  call exit(253, 253);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 49, 3} true;
...
$bb3:
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 50, 3} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i32.i64(64);
  $i15.shadow := $zext.i32.i64(64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 50, 3} true;
  assume {:verifier.code 0} true;
  call $p16 := llvm.stacksave();
  $p16.shadow := $p16;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 50, 3} true;
  assume {:verifier.code 0} true;
  assert ($mul.ref(1,$i15) == $mul.ref(1,$i15.shadow));
  call $p17 := $alloc($mul.ref(1,$i15));
  $p17.shadow := $p17;
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 51, 25} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i32.i64(64);
  $i18.shadow := $zext.i32.i64(64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 51, 27} true;
  assume {:verifier.code 0} true;
  $i19 := $mul.i64($i18,1);
  $i19.shadow := $mul.i64($i18.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 51, 3} true;
  assume {:verifier.code 0} true;
  assert ($p17 == $p17.shadow);
  assert ($i19 == $i19.shadow);
  call $M.3, $M.3.shadow := $memset.i8($M.3, $M.3.shadow, $p17, $p17.shadow, 0, 0, $i19, $i19.shadow, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 53, 15} true;
  assume {:verifier.code 0} true;
  $i20 := $ule.i32($i2,64);
  $i20.shadow := $ule.i32($i2.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 53, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i20 == 1);
  call {:cexpr "Hacl_HMAC_legacy_compute_sha1:arg:i0"} boogie_si_record_i32($i2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 56, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !($i20 == 1);
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 62, 15} true;
  assume {:verifier.code 0} true;
  $i21 := $ule.i32($i2,64);
  $i21.shadow := $ule.i32($i2.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 62, 7} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume ($i21 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 64, 23} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i32.i64($i2);
  $i22.shadow := $zext.i32.i64($i2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 64, 31} true;
  assume {:verifier.code 0} true;
  $i23 := $mul.i64($i22,1);
  $i23.shadow := $mul.i64($i22.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 64, 5} true;
  assume {:verifier.code 0} true;
  assert ($p17 == $p17.shadow);
  assert ($p1 == $p1.shadow);
  assert ($i23 == $i23.shadow);
  call $M.3, $M.3.shadow := $memcpy.i8($M.3, $M.3.shadow, $M.3, $M.3.shadow, $p17, $p17.shadow, $p1, $p1.shadow, $i23, $i23.shadow, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 65, 3} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !($i21 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 68, 5} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_hash($p1, $p1.shadow, $i2, $i2.shadow, $p17, $p17.shadow);
  assume {:verifier.code 0} true;
  goto $bb10;
$bb10:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 70, 3} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 70, 3} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i32.i64(64);
  $i24.shadow := $zext.i32.i64(64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 70, 3} true;
  assume {:verifier.code 0} true;
  $i25 := $ugt.i64($i24,18446744073709551615);
  $i25.shadow := $ugt.i64($i24.shadow,18446744073709551615);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 70, 3} true;
  assume {:verifier.code 0} true;
...
$bb12:
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 70, 3} true;
  assume {:verifier.code 0} true;
  call $i26, $i26.shadow := printf.ref.ref.i32(.str, .str, .str.1, .str.1, 70, 70);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 70, 3} true;
  assume {:verifier.code 0} true;
  call exit(253, 253);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 70, 3} true;
...
$bb14:
  ...
  goto $bb15;
$bb15:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 71, 3} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i32.i64(64);
  $i27.shadow := $zext.i32.i64(64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 71, 3} true;
  assume {:verifier.code 0} true;
  assert ($mul.ref(1,$i27) == $mul.ref(1,$i27.shadow));
  call $p28 := $alloc($mul.ref(1,$i27));
  $p28.shadow := $p28;
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 72, 32} true;
  assume {:verifier.code 0} true;
  $i29 := $zext.i32.i64(64);
  $i29.shadow := $zext.i32.i64(64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 72, 34} true;
  assume {:verifier.code 0} true;
  $i30 := $mul.i64($i29,1);
  $i30.shadow := $mul.i64($i29.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 72, 3} true;
  assume {:verifier.code 0} true;
  assert ($p28 == $p28.shadow);
  assert ($i30 == $i30.shadow);
  call $M.3, $M.3.shadow := $memset.i8($M.3, $M.3.shadow, $p28, $p28.shadow, 54, 54, $i30, $i30.shadow, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 73, 8} true;
  assume {:verifier.code 0} true;
  $i31 := 0;
  $i31.shadow := 0;
  goto $bb16;
$bb16:
  ...
  assert {:shadow_invariant} ($p28 == $p28.shadow);
  assert {:shadow_invariant} ($p17 == $p17.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 73, 37} true;
  assume {:verifier.code 0} true;
  $i32 := $ult.i32($i31,64);
  $i32.shadow := $ult.i32($i31.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 73, 3} true;
  assume {:verifier.code 0} true;
...
$bb17:
  assume ($i32 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 75, 18} true;
  assume {:verifier.code 0} true;
  ...
  $p34.shadow := $add.ref($p28.shadow,$mul.ref($i33.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 75, 18} true;
  assume {:verifier.code 0} true;
  assert ($p34 == $p34.shadow);
  $i35 := $load.i8($M.3,$p34);
  $i35.shadow := $load.i8($M.3.shadow,$p34.shadow);
  call {:cexpr "xi"} boogie_si_record_i8($i35);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 76, 18} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i32.i64($i31);
  $i36.shadow := $zext.i32.i64($i31.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 76, 18} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($p17,$mul.ref($i36,1));
  $p37.shadow := $add.ref($p17.shadow,$mul.ref($i36.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 76, 18} true;
  assume {:verifier.code 0} true;
  assert ($p37 == $p37.shadow);
  $i38 := $load.i8($M.3,$p37);
  $i38.shadow := $load.i8($M.3.shadow,$p37.shadow);
  call {:cexpr "yi"} boogie_si_record_i8($i38);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 77, 15} true;
  assume {:verifier.code 0} true;
  $i39 := $zext.i8.i32($i35);
  $i39.shadow := $zext.i8.i32($i35.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 77, 20} true;
  assume {:verifier.code 0} true;
  $i40 := $zext.i8.i32($i38);
  $i40.shadow := $zext.i8.i32($i38.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 77, 18} true;
  assume {:verifier.code 0} true;
  $i41 := $xor.i32($i39,$i40);
  $i41.shadow := $xor.i32($i39.shadow,$i40.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 77, 15} true;
  assume {:verifier.code 0} true;
  $i42 := $trunc.i32.i8($i41);
  $i42.shadow := $trunc.i32.i8($i41.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 77, 5} true;
  assume {:verifier.code 0} true;
  $i43 := $zext.i32.i64($i31);
  $i43.shadow := $zext.i32.i64($i31.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 77, 5} true;
  assume {:verifier.code 0} true;
  $p44 := $add.ref($p28,$mul.ref($i43,1));
  $p44.shadow := $add.ref($p28.shadow,$mul.ref($i43.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 77, 13} true;
  assume {:verifier.code 0} true;
  assert ($p44 == $p44.shadow);
  $M.3 := $store.i8($M.3,$p44,$i42);
  $M.3.shadow := $store.i8($M.3.shadow,$p44.shadow,$i42.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 78, 3} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb18:
  assume !($i32 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 79, 3} true;
  assume {:verifier.code 0} true;
  goto $bb20;
$bb19:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 73, 43} true;
  assume {:verifier.code 0} true;
  $i45 := $add.i32($i31,1);
  $i45.shadow := $add.i32($i31.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i45);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 73, 3} true;
  assume {:verifier.code 0} true;
  $i31 := $i45;
  $i31.shadow := $i45.shadow;
  goto $bb16;
$bb20:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 79, 3} true;
  assume {:verifier.code 0} true;
  $i46 := $zext.i32.i64(64);
  $i46.shadow := $zext.i32.i64(64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 79, 3} true;
  assume {:verifier.code 0} true;
  $i47 := $ugt.i64($i46,18446744073709551615);
  $i47.shadow := $ugt.i64($i46.shadow,18446744073709551615);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 79, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i47} true;
  assert ($i47 == $i47.shadow);
  goto $bb21, $bb22;
$bb21:
  assume ($i47 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 79, 3} true;
  assume {:verifier.code 0} true;
  call $i48, $i48.shadow := printf.ref.ref.i32(.str, .str, .str.1, .str.1, 79, 79);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 79, 3} true;
  assume {:verifier.code 0} true;
  call exit(253, 253);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 79, 3} true;
...
$bb23:
  ...
  goto $bb24;
$bb24:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 80, 3} true;
  assume {:verifier.code 0} true;
  $i49 := $zext.i32.i64(64);
  $i49.shadow := $zext.i32.i64(64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 80, 3} true;
  assume {:verifier.code 0} true;
  assert ($mul.ref(1,$i49) == $mul.ref(1,$i49.shadow));
  call $p50 := $alloc($mul.ref(1,$i49));
  $p50.shadow := $p50;
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 81, 32} true;
  assume {:verifier.code 0} true;
  $i51 := $zext.i32.i64(64);
  $i51.shadow := $zext.i32.i64(64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 81, 34} true;
  assume {:verifier.code 0} true;
  $i52 := $mul.i64($i51,1);
  $i52.shadow := $mul.i64($i51.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 81, 3} true;
  assume {:verifier.code 0} true;
  assert ($p50 == $p50.shadow);
  assert ($i52 == $i52.shadow);
  call $M.3, $M.3.shadow := $memset.i8($M.3, $M.3.shadow, $p50, $p50.shadow, 92, 92, $i52, $i52.shadow, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 82, 8} true;
  assume {:verifier.code 0} true;
  $i53 := 0;
  $i53.shadow := 0;
  goto $bb25;
$bb25:
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 82, 37} true;
  assume {:verifier.code 0} true;
  $i54 := $ult.i32($i53,64);
  $i54.shadow := $ult.i32($i53.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 82, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i54} true;
  assert ($i54 == $i54.shadow);
  goto $bb26, $bb27;
$bb26:
  assume ($i54 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 84, 18} true;
  assume {:verifier.code 0} true;
  $i55 := $zext.i32.i64($i53);
  $i55.shadow := $zext.i32.i64($i53.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 84, 18} true;
  assume {:verifier.code 0} true;
  $p56 := $add.ref($p50,$mul.ref($i55,1));
  $p56.shadow := $add.ref($p50.shadow,$mul.ref($i55.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 84, 18} true;
  assume {:verifier.code 0} true;
  assert ($p56 == $p56.shadow);
  $i57 := $load.i8($M.3,$p56);
  $i57.shadow := $load.i8($M.3.shadow,$p56.shadow);
  call {:cexpr "xi"} boogie_si_record_i8($i57);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 85, 18} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i32.i64($i53);
  $i58.shadow := $zext.i32.i64($i53.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 85, 18} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($p17,$mul.ref($i58,1));
  $p59.shadow := $add.ref($p17.shadow,$mul.ref($i58.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 85, 18} true;
  assume {:verifier.code 0} true;
  assert ($p59 == $p59.shadow);
  $i60 := $load.i8($M.3,$p59);
  $i60.shadow := $load.i8($M.3.shadow,$p59.shadow);
  call {:cexpr "yi"} boogie_si_record_i8($i60);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 86, 15} true;
  assume {:verifier.code 0} true;
  $i61 := $zext.i8.i32($i57);
  $i61.shadow := $zext.i8.i32($i57.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 86, 20} true;
  assume {:verifier.code 0} true;
  $i62 := $zext.i8.i32($i60);
  $i62.shadow := $zext.i8.i32($i60.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 86, 18} true;
  assume {:verifier.code 0} true;
  $i63 := $xor.i32($i61,$i62);
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 86, 5} true;
  assume {:verifier.code 0} true;
  $i65 := $zext.i32.i64($i53);
  $i65.shadow := $zext.i32.i64($i53.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 86, 5} true;
  assume {:verifier.code 0} true;
  $p66 := $add.ref($p50,$mul.ref($i65,1));
  $p66.shadow := $add.ref($p50.shadow,$mul.ref($i65.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 86, 13} true;
  assume {:verifier.code 0} true;
  assert ($p66 == $p66.shadow);
  $M.3 := $store.i8($M.3,$p66,$i64);
  $M.3.shadow := $store.i8($M.3.shadow,$p66.shadow,$i64.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 87, 3} true;
  assume {:verifier.code 0} true;
  goto $bb28;
$bb27:
  assume !($i54 == 1);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 89, 3} true;
  assume {:verifier.code 0} true;
  $p68 := $bitcast.ref.ref($p5);
  $p68.shadow := $bitcast.ref.ref($p5.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 89, 3} true;
  assume {:verifier.code 0} true;
  assert ($p68 == $p68.shadow);
  assert (__const.Hacl_HMAC_legacy_compute_sha1.s == __const.Hacl_HMAC_legacy_compute_sha1.s);
  call $M.1, $M.1.shadow := $memcpy.i8($M.1, $M.1.shadow, $M.9, $M.9.shadow, $p68, $p68.shadow, __const.Hacl_HMAC_legacy_compute_sha1.s, __const.Hacl_HMAC_legacy_compute_sha1.s, 20, 20, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 95, 16} true;
  assume {:verifier.code 0} true;
  $i69 := $eq.i32($i4,0);
  $i69.shadow := $eq.i32($i4.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 95, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i69} true;
  assert ($i69 == $i69.shadow);
  goto $bb29, $bb30;
$bb28:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 82, 43} true;
  assume {:verifier.code 0} true;
  $i67 := $add.i32($i53,1);
  $i67.shadow := $add.i32($i53.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i67);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 82, 3} true;
  assume {:verifier.code 0} true;
  $i53 := $i67;
  $i53.shadow := $i67.shadow;
  goto $bb25;
$bb29:
  assume ($i69 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 97, 39} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($add.ref($p5,$mul.ref(0,20)),$mul.ref(0,4));
  $p70.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 97, 5} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_update_last($p70, $p70.shadow, 0, 0, $p28, $p28.shadow, 64, 64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 98, 3} true;
  assume {:verifier.code 0} true;
  goto $bb31;
$bb30:
  assume !($i69 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 102, 35} true;
  assume {:verifier.code 0} true;
  $i71 := $udiv.i32($i4,64);
  $i71.shadow := $udiv.i32($i4.shadow,64);
  call {:cexpr "n_blocks0"} boogie_si_record_i32($i71);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 103, 30} true;
  assume {:verifier.code 0} true;
  $i72 := $urem.i32($i4,64);
  $i72.shadow := $urem.i32($i4.shadow,64);
  call {:cexpr "rem0"} boogie_si_record_i32($i72);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 105, 19} true;
  assume {:verifier.code 0} true;
  $i73 := $ugt.i32($i71,0);
  $i73.shadow := $ugt.i32($i71.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 105, 34} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i73} true;
  assert ($i73 == $i73.shadow);
  goto $bb32, $bb33;
$bb31:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 126, 37} true;
  assume {:verifier.code 0} true;
  $p98 := $add.ref($add.ref($p5,$mul.ref(0,20)),$mul.ref(0,4));
  $p98.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 126, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_Core_SHA1_legacy_finish($p98, $p98.shadow, $p28, $p28.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 128, 35} true;
  assume {:verifier.code 0} true;
  $p99 := $add.ref($add.ref($p5,$mul.ref(0,20)),$mul.ref(0,4));
  $p99.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 128, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_Core_SHA1_legacy_init($p99, $p99.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 130, 38} true;
  assume {:verifier.code 0} true;
  $i100 := $udiv.i32(20,64);
  $i100.shadow := $udiv.i32(20,64);
  call {:cexpr "n_blocks0"} boogie_si_record_i32($i100);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 131, 33} true;
  assume {:verifier.code 0} true;
  $i101 := $urem.i32(20,64);
  $i101.shadow := $urem.i32(20,64);
  call {:cexpr "rem0"} boogie_si_record_i32($i101);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 133, 17} true;
  assume {:verifier.code 0} true;
  $i102 := $ugt.i32($i100,0);
  $i102.shadow := $ugt.i32($i100.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 133, 32} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i102} true;
  assert ($i102 == $i102.shadow);
  goto $bb38, $bb39;
$bb32:
  assume ($i73 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 105, 42} true;
  assume {:verifier.code 0} true;
  $i74 := $eq.i32($i72,0);
  $i74.shadow := $eq.i32($i72.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 105, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i74} true;
  assert ($i74 == $i74.shadow);
  goto $bb35, $bb36;
$bb33:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 105, 34} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb34;
$bb34:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 112, 39} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($add.ref($p8,$mul.ref(0,8)),$mul.ref(0,1));
  $p82.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 112, 39} true;
  assume {:verifier.code 0} true;
  assert ($p82 == $p82.shadow);
  $M.12 := $store.i32($M.12,$p82,$i71);
  $M.12.shadow := $store.i32($M.12.shadow,$p82.shadow,$i71.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 112, 39} true;
  assume {:verifier.code 0} true;
  $p83 := $add.ref($add.ref($p8,$mul.ref(0,8)),$mul.ref(4,1));
  $p83.shadow := $add.ref($add.ref($p8.shadow,$mul.ref(0,8)),$mul.ref(4,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 112, 39} true;
  assume {:verifier.code 0} true;
  assert ($p83 == $p83.shadow);
  $M.12 := $store.i32($M.12,$p83,$i72);
  $M.12.shadow := $store.i32($M.12.shadow,$p83.shadow,$i72.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 112, 16} true;
  assume {:verifier.code 0} true;
  $p84 := $bitcast.ref.ref($p6);
  $p84.shadow := $bitcast.ref.ref($p6.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 112, 16} true;
  assume {:verifier.code 0} true;
  $p85 := $bitcast.ref.ref($p8);
  $p85.shadow := $bitcast.ref.ref($p8.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 112, 16} true;
  assume {:verifier.code 0} true;
  assert ($p84 == $p84.shadow);
  assert ($p85 == $p85.shadow);
  call $M.11, $M.11.shadow := $memcpy.i8($M.11, $M.11.shadow, $M.12, $M.12.shadow, $p84, $p84.shadow, $p85, $p85.shadow, 8, 8, false, false);
  assume {:verifier.code 0} true;
  goto $bb37;
$bb35:
  assume ($i74 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 107, 38} true;
  assume {:verifier.code 0} true;
  $i75 := $sub.i32($i71,1);
  $i75.shadow := $sub.i32($i71.shadow,1);
  call {:cexpr "n_blocks_"} boogie_si_record_i32($i75);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 108, 39} true;
  assume {:verifier.code 0} true;
  $p76 := $add.ref($add.ref($p7,$mul.ref(0,8)),$mul.ref(0,1));
  $p76.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 108, 39} true;
  assume {:verifier.code 0} true;
  assert ($p76 == $p76.shadow);
  $M.10 := $store.i32($M.10,$p76,$i75);
  $M.10.shadow := $store.i32($M.10.shadow,$p76.shadow,$i75.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 108, 39} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($add.ref($p7,$mul.ref(0,8)),$mul.ref(4,1));
  $p77.shadow := $add.ref($add.ref($p7.shadow,$mul.ref(0,8)),$mul.ref(4,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 108, 87} true;
  assume {:verifier.code 0} true;
  $i78 := $mul.i32($i75,64);
  $i78.shadow := $mul.i32($i75.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 108, 75} true;
  assume {:verifier.code 0} true;
  $i79 := $sub.i32($i4,$i78);
  $i79.shadow := $sub.i32($i4.shadow,$i78.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 108, 39} true;
  assume {:verifier.code 0} true;
  assert ($p77 == $p77.shadow);
  $M.10 := $store.i32($M.10,$p77,$i79);
  $M.10.shadow := $store.i32($M.10.shadow,$p77.shadow,$i79.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 108, 16} true;
  assume {:verifier.code 0} true;
  $p80 := $bitcast.ref.ref($p6);
  $p80.shadow := $bitcast.ref.ref($p6.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 108, 16} true;
  assume {:verifier.code 0} true;
  $p81 := $bitcast.ref.ref($p7);
  $p81.shadow := $bitcast.ref.ref($p7.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 108, 16} true;
  assume {:verifier.code 0} true;
  assert ($p80 == $p80.shadow);
  assert ($p81 == $p81.shadow);
  call $M.11, $M.11.shadow := $memcpy.i8($M.11, $M.11.shadow, $M.10, $M.10.shadow, $p80, $p80.shadow, $p81, $p81.shadow, 8, 8, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 109, 5} true;
  assume {:verifier.code 0} true;
  goto $bb37;
$bb36:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 105, 9} true;
  ...
  goto $bb34;
$bb37:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 114, 31} true;
  assume {:verifier.code 0} true;
  $p86 := $add.ref($add.ref($p6,$mul.ref(0,8)),$mul.ref(0,1));
  $p86.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 114, 31} true;
  assume {:verifier.code 0} true;
  assert ($p86 == $p86.shadow);
  $i87 := $load.i32($M.11,$p86);
  $i87.shadow := $load.i32($M.11.shadow,$p86.shadow);
  call {:cexpr "n_blocks"} boogie_si_record_i32($i87);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 115, 30} true;
  assume {:verifier.code 0} true;
  $p88 := $add.ref($add.ref($p6,$mul.ref(0,8)),$mul.ref(4,1));
  $p88.shadow := $add.ref($add.ref($p6.shadow,$mul.ref(0,8)),$mul.ref(4,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 115, 30} true;
  assume {:verifier.code 0} true;
  assert ($p88 == $p88.shadow);
  $i89 := $load.i32($M.11,$p88);
  $i89.shadow := $load.i32($M.11.shadow,$p88.shadow);
  call {:cexpr "rem_len"} boogie_si_record_i32($i89);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 116, 41} true;
  assume {:verifier.code 0} true;
  $i90 := $mul.i32($i87,64);
  $i90.shadow := $mul.i32($i87.shadow,64);
  call {:cexpr "full_blocks_len"} boogie_si_record_i32($i90);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 118, 25} true;
  assume {:verifier.code 0} true;
  ...
  $p92.shadow := $add.ref($p3.shadow,$mul.ref($i91.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 119, 40} true;
  assume {:verifier.code 0} true;
  $p93 := $add.ref($add.ref($p5,$mul.ref(0,20)),$mul.ref(0,4));
  $p93.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 119, 5} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_update_multi($p93, $p93.shadow, $p28, $p28.shadow, 1, 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 120, 40} true;
  assume {:verifier.code 0} true;
  $p94 := $add.ref($add.ref($p5,$mul.ref(0,20)),$mul.ref(0,4));
  $p94.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 120, 5} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_update_multi($p94, $p94.shadow, $p3, $p3.shadow, $i87, $i87.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 121, 39} true;
  assume {:verifier.code 0} true;
  $p95 := $add.ref($add.ref($p5,$mul.ref(0,20)),$mul.ref(0,4));
  $p95.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 122, 33} true;
  assume {:verifier.code 0} true;
  $i96 := $zext.i32.i64($i90);
  $i96.shadow := $zext.i32.i64($i90.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 122, 31} true;
  assume {:verifier.code 0} true;
  $i97 := $add.i64(64,$i96);
  $i97.shadow := $add.i64(64,$i96.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 121, 5} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_update_last($p95, $p95.shadow, $i97, $i97.shadow, $p92, $p92.shadow, $i89, $i89.shadow);
  assume {:verifier.code 0} true;
  goto $bb31;
$bb38:
  assume ($i102 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 133, 40} true;
  assume {:verifier.code 0} true;
  $i103 := $eq.i32($i101,0);
  $i103.shadow := $eq.i32($i101.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 133, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i103} true;
  assert ($i103 == $i103.shadow);
  goto $bb41, $bb42;
$bb39:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 133, 32} true;
  assume {:verifier.code 0} true;
  ...
  goto $bb40;
$bb40:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 141, 37} true;
  assume {:verifier.code 0} true;
  $p111 := $add.ref($add.ref($p11,$mul.ref(0,8)),$mul.ref(0,1));
  $p111.shadow := $add.ref($add.ref($p11.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 141, 37} true;
  assume {:verifier.code 0} true;
  assert ($p111 == $p111.shadow);
  $M.15 := $store.i32($M.15,$p111,$i100);
  $M.15.shadow := $store.i32($M.15.shadow,$p111.shadow,$i100.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 141, 37} true;
  assume {:verifier.code 0} true;
  $p112 := $add.ref($add.ref($p11,$mul.ref(0,8)),$mul.ref(4,1));
  $p112.shadow := $add.ref($add.ref($p11.shadow,$mul.ref(0,8)),$mul.ref(4,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 141, 37} true;
  assume {:verifier.code 0} true;
  assert ($p112 == $p112.shadow);
  $M.15 := $store.i32($M.15,$p112,$i101);
  $M.15.shadow := $store.i32($M.15.shadow,$p112.shadow,$i101.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 141, 14} true;
  assume {:verifier.code 0} true;
  $p113 := $bitcast.ref.ref($p9);
  $p113.shadow := $bitcast.ref.ref($p9.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 141, 14} true;
  assume {:verifier.code 0} true;
  $p114 := $bitcast.ref.ref($p11);
  $p114.shadow := $bitcast.ref.ref($p11.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 141, 14} true;
  assume {:verifier.code 0} true;
  assert ($p113 == $p113.shadow);
  assert ($p114 == $p114.shadow);
  call $M.14, $M.14.shadow := $memcpy.i8($M.14, $M.14.shadow, $M.15, $M.15.shadow, $p113, $p113.shadow, $p114, $p114.shadow, 8, 8, false, false);
  assume {:verifier.code 0} true;
  goto $bb43;
$bb41:
  assume ($i103 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 135, 36} true;
  assume {:verifier.code 0} true;
  $i104 := $sub.i32($i100,1);
  $i104.shadow := $sub.i32($i100.shadow,1);
  call {:cexpr "n_blocks_"} boogie_si_record_i32($i104);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 31} true;
  assume {:verifier.code 0} true;
  $p105 := $add.ref($add.ref($p10,$mul.ref(0,8)),$mul.ref(0,1));
  $p105.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 31} true;
  assume {:verifier.code 0} true;
  assert ($p105 == $p105.shadow);
  $M.13 := $store.i32($M.13,$p105,$i104);
  $M.13.shadow := $store.i32($M.13.shadow,$p105.shadow,$i104.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 31} true;
  assume {:verifier.code 0} true;
  $p106 := $add.ref($add.ref($p10,$mul.ref(0,8)),$mul.ref(4,1));
  $p106.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,8)),$mul.ref(4,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 84} true;
  assume {:verifier.code 0} true;
  $i107 := $mul.i32($i104,64);
  $i107.shadow := $mul.i32($i104.shadow,64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 72} true;
  assume {:verifier.code 0} true;
  $i108 := $sub.i32(20,$i107);
  $i108.shadow := $sub.i32(20,$i107.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 31} true;
  assume {:verifier.code 0} true;
  assert ($p106 == $p106.shadow);
  $M.13 := $store.i32($M.13,$p106,$i108);
  $M.13.shadow := $store.i32($M.13.shadow,$p106.shadow,$i108.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 8} true;
  assume {:verifier.code 0} true;
  $p109 := $bitcast.ref.ref($p9);
  $p109.shadow := $bitcast.ref.ref($p9.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 8} true;
  assume {:verifier.code 0} true;
  $p110 := $bitcast.ref.ref($p10);
  $p110.shadow := $bitcast.ref.ref($p10.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 8} true;
  assume {:verifier.code 0} true;
  assert ($p109 == $p109.shadow);
  assert ($p110 == $p110.shadow);
  call $M.14, $M.14.shadow := $memcpy.i8($M.14, $M.14.shadow, $M.13, $M.13.shadow, $p109, $p109.shadow, $p110, $p110.shadow, 8, 8, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 138, 3} true;
  assume {:verifier.code 0} true;
  goto $bb43;
$bb42:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 133, 7} true;
  ...
  goto $bb40;
$bb43:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 143, 29} true;
  assume {:verifier.code 0} true;
  $p115 := $add.ref($add.ref($p9,$mul.ref(0,8)),$mul.ref(0,1));
  $p115.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 143, 29} true;
  assume {:verifier.code 0} true;
  assert ($p115 == $p115.shadow);
  $i116 := $load.i32($M.14,$p115);
  $i116.shadow := $load.i32($M.14.shadow,$p115.shadow);
  call {:cexpr "n_blocks"} boogie_si_record_i32($i116);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 144, 28} true;
  assume {:verifier.code 0} true;
  $p117 := $add.ref($add.ref($p9,$mul.ref(0,8)),$mul.ref(4,1));
  $p117.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,8)),$mul.ref(4,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 144, 28} true;
  assume {:verifier.code 0} true;
  assert ($p117 == $p117.shadow);
  $i118 := $load.i32($M.14,$p117);
  $i118.shadow := $load.i32($M.14.shadow,$p117.shadow);
  call {:cexpr "rem_len"} boogie_si_record_i32($i118);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 145, 39} true;
  assume {:verifier.code 0} true;
  $i119 := $mul.i32($i116,64);
  $i119.shadow := $mul.i32($i116.shadow,64);
  call {:cexpr "full_blocks_len"} boogie_si_record_i32($i119);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 147, 24} true;
  assume {:verifier.code 0} true;
  $i120 := $zext.i32.i64($i119);
  $i120.shadow := $zext.i32.i64($i119.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 147, 24} true;
  assume {:verifier.code 0} true;
  $p121 := $add.ref($p28,$mul.ref($i120,1));
  $p121.shadow := $add.ref($p28.shadow,$mul.ref($i120.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 148, 38} true;
  assume {:verifier.code 0} true;
  $p122 := $add.ref($add.ref($p5,$mul.ref(0,20)),$mul.ref(0,4));
  $p122.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 148, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_update_multi($p122, $p122.shadow, $p50, $p50.shadow, 1, 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 149, 38} true;
  assume {:verifier.code 0} true;
  $p123 := $add.ref($add.ref($p5,$mul.ref(0,20)),$mul.ref(0,4));
  $p123.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 149, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_update_multi($p123, $p123.shadow, $p28, $p28.shadow, $i116, $i116.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 150, 37} true;
  assume {:verifier.code 0} true;
  $p124 := $add.ref($add.ref($p5,$mul.ref(0,20)),$mul.ref(0,4));
  $p124.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 151, 31} true;
  assume {:verifier.code 0} true;
  $i125 := $zext.i32.i64($i119);
  $i125.shadow := $zext.i32.i64($i119.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 151, 29} true;
  assume {:verifier.code 0} true;
  $i126 := $add.i64(64,$i125);
  $i126.shadow := $add.i64(64,$i125.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 150, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_update_last($p124, $p124.shadow, $i126, $i126.shadow, $p121, $p121.shadow, $i118, $i118.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 154, 37} true;
  assume {:verifier.code 0} true;
  $p127 := $add.ref($add.ref($p5,$mul.ref(0,20)),$mul.ref(0,4));
  $p127.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,20)),$mul.ref(0,4));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 154, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_Core_SHA1_legacy_finish($p127, $p127.shadow, $p0, $p0.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 155, 1} true;
  assume {:verifier.code 0} true;
  call llvm.stackrestore($p16);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 155, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
...
const printf: ref;
axiom (printf == $sub.ref(0,23871));
procedure {:inline 1} printf.ref.ref.i32($p0: ref, $p0.shadow: ref, p.1: ref, p.1.shadow: ref, p.2: i32, p.2.shadow: i32) returns ($r: i32, $r.shadow: i32);
const llvm.stacksave: ref;
axiom (llvm.stacksave == $sub.ref(0,24903));
procedure {:inline 1} llvm.stacksave() returns ($r: ref);
const llvm.stackrestore: ref;
axiom (llvm.stackrestore == $sub.ref(0,25935));
procedure {:inline 1} llvm.stackrestore($p0: ref);
const Hacl_HMAC_legacy_compute_sha1_wrapper: ref;
axiom (Hacl_HMAC_legacy_compute_sha1_wrapper == $sub.ref(0,26967));
procedure {:entrypoint} Hacl_HMAC_legacy_compute_sha1_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32, $p3: ref, $p3.shadow: ref, $i4: i32, $i4.shadow: i32)
...
modifies $exn;
modifies $M.3, $M.1, $M.12, $M.11, $M.10, $M.15, $M.14, $M.13;
modifies $CurrAddr, $M.0, $M.7, $M.9;
modifies $M.2, $M.4;
modifies $M.6, $M.5;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "Hacl_HMAC_legacy_compute_sha1.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:Hacl_HMAC_legacy_compute_sha1_wrapper"} boogie_si_record_ref(Hacl_HMAC_legacy_compute_sha1_wrapper);
  call {:cexpr "smack:arg:Hacl_HMAC_legacy_compute_sha1_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:Hacl_HMAC_legacy_compute_sha1_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:Hacl_HMAC_legacy_compute_sha1_wrapper:$i2"} boogie_si_record_i32($i2);
  call {:cexpr "smack:arg:Hacl_HMAC_legacy_compute_sha1_wrapper:$p3"} boogie_si_record_ref($p3);
  call {:cexpr "smack:arg:Hacl_HMAC_legacy_compute_sha1_wrapper:$i4"} boogie_si_record_i32($i4);
  call {:cexpr "Hacl_HMAC_legacy_compute_sha1_wrapper:arg:key_len"} boogie_si_record_i32($i2);
  call {:cexpr "Hacl_HMAC_legacy_compute_sha1_wrapper:arg:data_len"} boogie_si_record_i32($i4);
  assume {:sourceloc "Hacl_HMAC_legacy_compute_sha1.c", 9, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "Hacl_HMAC_legacy_compute_sha1.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p10, $p10.shadow);
  assume {:sourceloc "Hacl_HMAC_legacy_compute_sha1.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_HMAC_legacy_compute_sha1($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow, $p3, $p3.shadow, $i4, $i4.shadow);
  assume {:sourceloc "Hacl_HMAC_legacy_compute_sha1.c", 18, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
...
axiom (__SMACK_dummy == $sub.ref(0,33159));
...
axiom (__SMACK_and32 == $sub.ref(0,34191));
...
axiom (__SMACK_and64 == $sub.ref(0,35223));
...
axiom (__SMACK_and16 == $sub.ref(0,36255));
...
axiom (__SMACK_and8 == $sub.ref(0,37287));
...
axiom (__SMACK_or32 == $sub.ref(0,38319));
...
axiom (__SMACK_or64 == $sub.ref(0,39351));
...
axiom (__SMACK_or16 == $sub.ref(0,40383));
...
axiom (__SMACK_or8 == $sub.ref(0,41415));
...
axiom (__SMACK_check_overflow == $sub.ref(0,42447));
...
axiom (__SMACK_loop_exit == $sub.ref(0,43479));
...
axiom (__SMACK_decls == $sub.ref(0,44511));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,45543));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,46575));
...
const exit: ref;
axiom (exit == $sub.ref(0,47607));
procedure {:inline 1} exit($i0: i32, $i0.shadow: i32)
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 12, 3} true;
  assume {:verifier.code 1} true;
  call {:cexpr "exit:arg:x"} boogie_si_record_i32($i0);
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 12, 3} true;
  assume {:verifier.code 1} true;
  assume false;
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 13, 3} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  assert {:shadow_invariant} $shadow_ok;
...
axiom (__SMACK_static_init == $sub.ref(0,48639));
procedure {:inline 1} __SMACK_static_init()
modifies $M.0, $M.7, $M.9, $exn;
{
$bb0:
  assert (_h0 == _h0);
  $M.0 := $store.i32($M.0,_h0,1732584193);
  $M.0.shadow := $store.i32($M.0.shadow,_h0,1732584193);
  assert ($add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(1,4)) == $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(1,4)));
  $M.0 := $store.i32($M.0,$add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(1,4)),$sub.i32(0,271733879));
  $M.0.shadow := $store.i32($M.0.shadow,$add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(1,4)),$sub.i32(0,271733879));
  assert ($add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(2,4)) == $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(2,4)));
  $M.0 := $store.i32($M.0,$add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(2,4)),$sub.i32(0,1732584194));
  $M.0.shadow := $store.i32($M.0.shadow,$add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(2,4)),$sub.i32(0,1732584194));
  assert ($add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(3,4)) == $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(3,4)));
  $M.0 := $store.i32($M.0,$add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(3,4)),271733878);
  $M.0.shadow := $store.i32($M.0.shadow,$add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(3,4)),271733878);
  assert ($add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(4,4)) == $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(4,4)));
  $M.0 := $store.i32($M.0,$add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(4,4)),$sub.i32(0,1009589776));
  $M.0.shadow := $store.i32($M.0.shadow,$add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(4,4)),$sub.i32(0,1009589776));
  assert (__const.Hacl_Hash_SHA1_legacy_hash.s == __const.Hacl_Hash_SHA1_legacy_hash.s);
  $M.7 := $store.i32($M.7,__const.Hacl_Hash_SHA1_legacy_hash.s,1732584193);
  $M.7.shadow := $store.i32($M.7.shadow,__const.Hacl_Hash_SHA1_legacy_hash.s,1732584193);
  assert ($add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(1,4)) == $add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(1,4)));
  $M.7 := $store.i32($M.7,$add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(1,4)),$sub.i32(0,271733879));
  $M.7.shadow := $store.i32($M.7.shadow,$add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(1,4)),$sub.i32(0,271733879));
  assert ($add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(2,4)) == $add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(2,4)));
  $M.7 := $store.i32($M.7,$add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(2,4)),$sub.i32(0,1732584194));
  $M.7.shadow := $store.i32($M.7.shadow,$add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(2,4)),$sub.i32(0,1732584194));
  assert ($add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(3,4)) == $add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(3,4)));
  $M.7 := $store.i32($M.7,$add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(3,4)),271733878);
  $M.7.shadow := $store.i32($M.7.shadow,$add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(3,4)),271733878);
  assert ($add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(4,4)) == $add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(4,4)));
  $M.7 := $store.i32($M.7,$add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(4,4)),$sub.i32(0,1009589776));
  $M.7.shadow := $store.i32($M.7.shadow,$add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(4,4)),$sub.i32(0,1009589776));
  assert (__const.Hacl_HMAC_legacy_compute_sha1.s == __const.Hacl_HMAC_legacy_compute_sha1.s);
  $M.9 := $store.i32($M.9,__const.Hacl_HMAC_legacy_compute_sha1.s,1732584193);
  $M.9.shadow := $store.i32($M.9.shadow,__const.Hacl_HMAC_legacy_compute_sha1.s,1732584193);
  assert ($add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(1,4)) == $add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(1,4)));
  $M.9 := $store.i32($M.9,$add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(1,4)),$sub.i32(0,271733879));
  $M.9.shadow := $store.i32($M.9.shadow,$add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(1,4)),$sub.i32(0,271733879));
  assert ($add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(2,4)) == $add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(2,4)));
  $M.9 := $store.i32($M.9,$add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(2,4)),$sub.i32(0,1732584194));
  $M.9.shadow := $store.i32($M.9.shadow,$add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(2,4)),$sub.i32(0,1732584194));
  assert ($add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(3,4)) == $add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(3,4)));
  $M.9 := $store.i32($M.9,$add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(3,4)),271733878);
  $M.9.shadow := $store.i32($M.9.shadow,$add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(3,4)),271733878);
  assert ($add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(4,4)) == $add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(4,4)));
  $M.9 := $store.i32($M.9,$add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(4,4)),$sub.i32(0,1009589776));
  $M.9.shadow := $store.i32($M.9.shadow,$add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(4,4)),$sub.i32(0,1009589776));
  $exn := false;
  $exn.shadow := false;
  return;
}
