...
$bb1:
  ...
  assert {:likely_shadow_invariant} ($i3 == $i3.shadow);
...
modifies $M.6;
modifies $M.5;
requires (__const.Hacl_Hash_SHA1_legacy_hash.s == __const.Hacl_Hash_SHA1_legacy_hash.s);
{
  var $p3: ref;
  var $p3.shadow: ref;
  var $p4: ref;
...
modifies $M.6;
modifies $M.5;
requires ($mul.ref(1,$i17) == $mul.ref(1,$i17.shadow));
requires ($p1 == $p1.shadow);
requires ($mul.ref(1,$i31) == $mul.ref(1,$i31.shadow));
requires ($mul.ref(1,$i55) == $mul.ref(1,$i55.shadow));
requires (__const.Hacl_HMAC_legacy_compute_sha1.s == __const.Hacl_HMAC_legacy_compute_sha1.s);
{
  var $p5: ref;
  var $p5.shadow: ref;
  var $p6: ref;
...
$bb2:
  assume ($i13 == 1);
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref(.str,$mul.ref(0,70)),$mul.ref(0,1));
  $p14.shadow := $p14;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref(.str.1,$mul.ref(0,45)),$mul.ref(0,1));
  $p15.shadow := $p15;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 49, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i16, $i16.shadow := printf.ref.ref.i32($p14, $p14.shadow, $p15, $p15.shadow, 49, 49);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 49, 3} true;
  assume {:verifier.code 0} true;
  call exit(253, 253);
  assume {:verifier.code 0} true;
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  $i17 := $zext.i32.i64(64);
  $i17.shadow := $zext.i32.i64(64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 50, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $p18 := llvm.stacksave();
  $p18.shadow := $p18;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 50, 3} true;
  assume {:verifier.code 0} true;
  call $p19 := $alloc($mul.ref(1,$i17));
  $p19.shadow := $p19;
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 51, 25} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i32.i64(64);
  $i20.shadow := $zext.i32.i64(64);
  ...
  $p19 := $p19.shadow;
  $i21 := $i21.shadow;
  call $M.3, $M.3.shadow := $memset.i8($M.3, $M.3.shadow, $p19, $p19.shadow, 0, 0, $i21, $i21.shadow, false, false);
...
$bb9:
  ...
  $p19 := $p19.shadow;
  $i25 := $i25.shadow;
  call $M.3, $M.3.shadow := $memcpy.i8($M.3, $M.3.shadow, $M.3, $M.3.shadow, $p19, $p19.shadow, $p1, $p1.shadow, $i25, $i25.shadow, false, false);
...
$bb10:
  ...
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_hash($p1, $p1.shadow, $i2, $i2.shadow, $p19, $p19.shadow);
  assume {:verifier.code 0} true;
  goto $bb11;
$bb11:
...
$bb12:
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 70, 3} true;
  assume {:verifier.code 0} true;
  $i27 := $ugt.i64($i26,18446744073709551615);
  $i27.shadow := $i27;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 70, 3} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume ($i27 == 1);
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref(.str,$mul.ref(0,70)),$mul.ref(0,1));
  $p28.shadow := $p28;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref(.str.1,$mul.ref(0,45)),$mul.ref(0,1));
  $p29.shadow := $p29;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 70, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i30, $i30.shadow := printf.ref.ref.i32($p28, $p28.shadow, $p29, $p29.shadow, 70, 70);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 70, 3} true;
  assume {:verifier.code 0} true;
  call exit(253, 253);
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  assume {:verifier.code 0} true;
  $i31 := $zext.i32.i64(64);
  $i31.shadow := $zext.i32.i64(64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 71, 3} true;
  assume {:verifier.code 0} true;
  call $p32 := $alloc($mul.ref(1,$i31));
  $p32.shadow := $p32;
  assume true;
  ...
  $p32 := $p32.shadow;
  $i34 := $i34.shadow;
  call $M.3, $M.3.shadow := $memset.i8($M.3, $M.3.shadow, $p32, $p32.shadow, 54, 54, $i34, $i34.shadow, false, false);
...
$bb17:
  ...
  assert {:likely_shadow_invariant} ($p32 == $p32.shadow);
...
$bb18:
  ...
  $i39 := $load.i8($M.3,$p38);
  $i39.shadow := $i39;
  call {:cexpr "xi"} boogie_si_record_i8($i39);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 76, 18} true;
  assume {:verifier.code 0} true;
  $i40 := $zext.i32.i64($i35);
  $i40.shadow := $i40;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 76, 18} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($p19,$mul.ref($i40,1));
  $p41.shadow := $p41;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 76, 18} true;
  assume {:verifier.code 0} true;
  $p41 := $p41.shadow;
  $i42 := $load.i8($M.3,$p41);
  $i42.shadow := $i42;
  call {:cexpr "yi"} boogie_si_record_i8($i42);
  ...
  assume {:verifier.code 0} true;
  $i47 := $zext.i32.i64($i35);
  $i47.shadow := $i47;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 77, 5} true;
  assume {:verifier.code 0} true;
  $p48 := $add.ref($p32,$mul.ref($i47,1));
  $p48.shadow := $p48;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 77, 13} true;
  assume {:verifier.code 0} true;
  $p48 := $p48.shadow;
  $M.3 := $store.i8($M.3,$p48,$i46);
  $M.3.shadow := $store.i8($M.3.shadow,$p48.shadow,$i46.shadow);
...
$bb21:
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 79, 3} true;
  assume {:verifier.code 0} true;
  $i51 := $ugt.i64($i50,18446744073709551615);
  $i51.shadow := $i51;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 79, 3} true;
  assume {:verifier.code 0} true;
...
$bb22:
  assume ($i51 == 1);
  assume {:verifier.code 0} true;
  $p52 := $add.ref($add.ref(.str,$mul.ref(0,70)),$mul.ref(0,1));
  $p52.shadow := $p52;
  assume {:verifier.code 0} true;
  $p53 := $add.ref($add.ref(.str.1,$mul.ref(0,45)),$mul.ref(0,1));
  $p53.shadow := $p53;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 79, 3} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  call $i54, $i54.shadow := printf.ref.ref.i32($p52, $p52.shadow, $p53, $p53.shadow, 79, 79);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 79, 3} true;
  assume {:verifier.code 0} true;
  call exit(253, 253);
  assume {:verifier.code 0} true;
...
$bb25:
  ...
  $p56 := $p56.shadow;
  $i58 := $i58.shadow;
  call $M.3, $M.3.shadow := $memset.i8($M.3, $M.3.shadow, $p56, $p56.shadow, 92, 92, $i58, $i58.shadow, false, false);
...
$bb26:
  ...
  assert {:likely_shadow_invariant} ($p6 == $p6.shadow);
  assert {:likely_shadow_invariant} ($p5 == $p5.shadow);
  assert {:likely_shadow_invariant} ($p56 == $p56.shadow);
  assert {:likely_shadow_invariant} ($p32 == $p32.shadow);
  assert {:likely_shadow_invariant} ($p19 == $p19.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
$bb27:
  ...
  $i66 := $load.i8($M.3,$p65);
  $i66.shadow := $i66;
  call {:cexpr "yi"} boogie_si_record_i8($i66);
  ...
  assume {:verifier.code 0} true;
  $i71 := $zext.i32.i64($i59);
  $i71.shadow := $i71;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 86, 5} true;
  assume {:verifier.code 0} true;
  $p72 := $add.ref($p56,$mul.ref($i71,1));
  $p72.shadow := $p72;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 86, 13} true;
  assume {:verifier.code 0} true;
  $p72 := $p72.shadow;
  $M.3 := $store.i8($M.3,$p72,$i70);
  $M.3.shadow := $store.i8($M.3.shadow,$p72.shadow,$i70.shadow);
...
$bb28:
  ...
  assume {:verifier.code 0} true;
  $p74 := $bitcast.ref.ref($p5);
  $p74.shadow := $p74;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 89, 3} true;
  assume {:verifier.code 0} true;
  $p74 := $p74.shadow;
  call $M.1, $M.1.shadow := $memcpy.i8($M.1, $M.1.shadow, $M.9, $M.9.shadow, $p74, $p74.shadow, __const.Hacl_HMAC_legacy_compute_sha1.s, __const.Hacl_HMAC_legacy_compute_sha1.s, 20, 20, false, false);
...
$bb30:
  ...
  assume {:verifier.code 0} true;
  $p76 := $add.ref($add.ref($p5,$mul.ref(0,20)),$mul.ref(0,4));
  $p76.shadow := $p76;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 97, 5} true;
  assume {:verifier.code 0} true;
  call Hacl_Hash_SHA1_legacy_update_last($p76, $p76.shadow, 0, 0, $p32, $p32.shadow, 64, 64);
...
$bb31:
  ...
  $i77 := $udiv.i32($i4,64);
  $i77.shadow := $i77;
  call {:cexpr "n_blocks0"} boogie_si_record_i32($i77);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 103, 30} true;
  assume {:verifier.code 0} true;
  $i78 := $urem.i32($i4,64);
  $i78.shadow := $i78;
  call {:cexpr "rem0"} boogie_si_record_i32($i78);
  assume true;
...
$bb35:
  ...
  assume {:verifier.code 0} true;
  $p88 := $add.ref($add.ref($p8,$mul.ref(0,8)),$mul.ref(0,1));
  $p88.shadow := $p88;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 112, 39} true;
  assume {:verifier.code 0} true;
  $p88 := $p88.shadow;
  $M.12 := $store.i32($M.12,$p88,$i77);
  $M.12.shadow := $store.i32($M.12.shadow,$p88.shadow,$i77.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 112, 39} true;
  assume {:verifier.code 0} true;
  $p89 := $add.ref($add.ref($p8,$mul.ref(0,8)),$mul.ref(4,1));
  $p89.shadow := $p89;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 112, 39} true;
  assume {:verifier.code 0} true;
  $p89 := $p89.shadow;
  $M.12 := $store.i32($M.12,$p89,$i78);
  $M.12.shadow := $store.i32($M.12.shadow,$p89.shadow,$i78.shadow);
  ...
  $p90 := $p90.shadow;
  $p91 := $p91.shadow;
  call $M.11, $M.11.shadow := $memcpy.i8($M.11, $M.11.shadow, $M.12, $M.12.shadow, $p90, $p90.shadow, $p91, $p91.shadow, 8, 8, false, false);
  assume {:verifier.code 0} true;
  goto $bb38;
$bb36:
  assume ($i80 == 1);
  ...
  $i81 := $sub.i32($i77,1);
  $i81.shadow := $i81;
  call {:cexpr "n_blocks_"} boogie_si_record_i32($i81);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 108, 39} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($add.ref($p7,$mul.ref(0,8)),$mul.ref(0,1));
  $p82.shadow := $p82;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 108, 39} true;
  assume {:verifier.code 0} true;
  $p82 := $p82.shadow;
  $M.10 := $store.i32($M.10,$p82,$i81);
  $M.10.shadow := $store.i32($M.10.shadow,$p82.shadow,$i81.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 108, 39} true;
  assume {:verifier.code 0} true;
  $p83 := $add.ref($add.ref($p7,$mul.ref(0,8)),$mul.ref(4,1));
  $p83.shadow := $p83;
  ...
  assume {:verifier.code 0} true;
  $p83 := $p83.shadow;
  $M.10 := $store.i32($M.10,$p83,$i85);
  $M.10.shadow := $store.i32($M.10.shadow,$p83.shadow,$i85.shadow);
  ...
  $p86 := $p86.shadow;
  $p87 := $p87.shadow;
  call $M.11, $M.11.shadow := $memcpy.i8($M.11, $M.11.shadow, $M.10, $M.10.shadow, $p86, $p86.shadow, $p87, $p87.shadow, 8, 8, false, false);
...
$bb38:
  ...
  assume {:verifier.code 0} true;
  $p92 := $add.ref($add.ref($p6,$mul.ref(0,8)),$mul.ref(0,1));
  $p92.shadow := $p92;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 114, 31} true;
  assume {:verifier.code 0} true;
  $p92 := $p92.shadow;
  $i93 := $load.i32($M.11,$p92);
  $i93.shadow := $i93;
  call {:cexpr "n_blocks"} boogie_si_record_i32($i93);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 115, 30} true;
  assume {:verifier.code 0} true;
  $p94 := $add.ref($add.ref($p6,$mul.ref(0,8)),$mul.ref(4,1));
  $p94.shadow := $p94;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 115, 30} true;
  assume {:verifier.code 0} true;
  $p94 := $p94.shadow;
  $i95 := $load.i32($M.11,$p94);
  $i95.shadow := $i95;
  call {:cexpr "rem_len"} boogie_si_record_i32($i95);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 116, 41} true;
  assume {:verifier.code 0} true;
  $i96 := $mul.i32($i93,64);
  $i96.shadow := $i96;
  call {:cexpr "full_blocks_len"} boogie_si_record_i32($i96);
...
$bb41:
  ...
  assume {:verifier.code 0} true;
  $p117 := $add.ref($add.ref($p11,$mul.ref(0,8)),$mul.ref(0,1));
  $p117.shadow := $p117;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 141, 37} true;
  assume {:verifier.code 0} true;
  $p117 := $p117.shadow;
  $M.15 := $store.i32($M.15,$p117,$i106);
  $M.15.shadow := $store.i32($M.15.shadow,$p117.shadow,$i106.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 141, 37} true;
  assume {:verifier.code 0} true;
  $p118 := $add.ref($add.ref($p11,$mul.ref(0,8)),$mul.ref(4,1));
  $p118.shadow := $p118;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 141, 37} true;
  assume {:verifier.code 0} true;
  $p118 := $p118.shadow;
  $M.15 := $store.i32($M.15,$p118,$i107);
  $M.15.shadow := $store.i32($M.15.shadow,$p118.shadow,$i107.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 141, 14} true;
  assume {:verifier.code 0} true;
  $p119 := $bitcast.ref.ref($p9);
  $p119.shadow := $p119;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 141, 14} true;
  assume {:verifier.code 0} true;
  ...
  $p119 := $p119.shadow;
  $p120 := $p120.shadow;
  call $M.14, $M.14.shadow := $memcpy.i8($M.14, $M.14.shadow, $M.15, $M.15.shadow, $p119, $p119.shadow, $p120, $p120.shadow, 8, 8, false, false);
  assume {:verifier.code 0} true;
  goto $bb44;
$bb42:
  assume ($i109 == 1);
  ...
  $i110 := $sub.i32($i106,1);
  $i110.shadow := $i110;
  call {:cexpr "n_blocks_"} boogie_si_record_i32($i110);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 31} true;
  assume {:verifier.code 0} true;
  $p111 := $add.ref($add.ref($p10,$mul.ref(0,8)),$mul.ref(0,1));
  $p111.shadow := $p111;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 31} true;
  assume {:verifier.code 0} true;
  $p111 := $p111.shadow;
  $M.13 := $store.i32($M.13,$p111,$i110);
  $M.13.shadow := $store.i32($M.13.shadow,$p111.shadow,$i110.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 31} true;
  assume {:verifier.code 0} true;
  $p112 := $add.ref($add.ref($p10,$mul.ref(0,8)),$mul.ref(4,1));
  $p112.shadow := $p112;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 84} true;
  assume {:verifier.code 0} true;
  $i113 := $mul.i32($i110,64);
  $i113.shadow := $i113;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 72} true;
  assume {:verifier.code 0} true;
  $i114 := $sub.i32(20,$i113);
  $i114.shadow := $i114;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 31} true;
  assume {:verifier.code 0} true;
  $p112 := $p112.shadow;
  $M.13 := $store.i32($M.13,$p112,$i114);
  $M.13.shadow := $store.i32($M.13.shadow,$p112.shadow,$i114.shadow);
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 8} true;
  assume {:verifier.code 0} true;
  $p116 := $bitcast.ref.ref($p10);
  $p116.shadow := $p116;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 137, 8} true;
  assume {:verifier.code 0} true;
  $p115 := $p115.shadow;
  $p116 := $p116.shadow;
  call $M.14, $M.14.shadow := $memcpy.i8($M.14, $M.14.shadow, $M.13, $M.13.shadow, $p115, $p115.shadow, $p116, $p116.shadow, 8, 8, false, false);
...
$bb44:
  ...
  assume {:verifier.code 0} true;
  $p121 := $add.ref($add.ref($p9,$mul.ref(0,8)),$mul.ref(0,1));
  $p121.shadow := $p121;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 143, 29} true;
  assume {:verifier.code 0} true;
  $p121 := $p121.shadow;
  $i122 := $load.i32($M.14,$p121);
  $i122.shadow := $i122;
  call {:cexpr "n_blocks"} boogie_si_record_i32($i122);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 144, 28} true;
  assume {:verifier.code 0} true;
  $p123 := $add.ref($add.ref($p9,$mul.ref(0,8)),$mul.ref(4,1));
  $p123.shadow := $p123;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 144, 28} true;
  assume {:verifier.code 0} true;
  $p123 := $p123.shadow;
  $i124 := $load.i32($M.14,$p123);
  $i124.shadow := $i124;
  call {:cexpr "rem_len"} boogie_si_record_i32($i124);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_HMAC.c", 145, 39} true;
  assume {:verifier.code 0} true;
  $i125 := $mul.i32($i122,64);
  $i125.shadow := $i125;
  call {:cexpr "full_blocks_len"} boogie_si_record_i32($i125);
...
requires (_h0 == _h0);
requires ($add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(1,4)) == $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(1,4)));
requires ($add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(2,4)) == $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(2,4)));
requires ($add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(3,4)) == $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(3,4)));
requires ($add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(4,4)) == $add.ref($add.ref(_h0,$mul.ref(0,20)),$mul.ref(4,4)));
requires (__const.Hacl_Hash_SHA1_legacy_hash.s == __const.Hacl_Hash_SHA1_legacy_hash.s);
requires ($add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(1,4)) == $add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(1,4)));
requires ($add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(2,4)) == $add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(2,4)));
requires ($add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(3,4)) == $add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(3,4)));
requires ($add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(4,4)) == $add.ref($add.ref(__const.Hacl_Hash_SHA1_legacy_hash.s,$mul.ref(0,20)),$mul.ref(4,4)));
requires (__const.Hacl_HMAC_legacy_compute_sha1.s == __const.Hacl_HMAC_legacy_compute_sha1.s);
requires ($add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(1,4)) == $add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(1,4)));
requires ($add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(2,4)) == $add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(2,4)));
requires ($add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(3,4)) == $add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(3,4)));
requires ($add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(4,4)) == $add.ref($add.ref(__const.Hacl_HMAC_legacy_compute_sha1.s,$mul.ref(0,20)),$mul.ref(4,4)));
{
$bb0:
