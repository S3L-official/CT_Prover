...
const Hacl_Poly1305_32_poly1305_init: ref;
axiom (Hacl_Poly1305_32_poly1305_init == $sub.ref(0,1032));
procedure {:inline 1} Hacl_Poly1305_32_poly1305_init($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref)
modifies $M.0, $exn;
modifies $M.2;
modifies $CurrAddr;
{
  ...
  var $p113.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 31, 23} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 31, 23} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($p0,$mul.ref(5,8));
  $p2.shadow := $add.ref($p0.shadow,$mul.ref(5,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p0,$mul.ref(0,8));
  $p3.shadow := $add.ref($p0.shadow,$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 33, 11} true;
  assume {:verifier.code 0} true;
  assert ($p3 == $p3.shadow);
  $M.0 := $store.i64($M.0,$p3,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p3.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 34, 3} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p0,$mul.ref(1,8));
  $p4.shadow := $add.ref($p0.shadow,$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 34, 11} true;
  assume {:verifier.code 0} true;
  assert ($p4 == $p4.shadow);
  $M.0 := $store.i64($M.0,$p4,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p4.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 35, 3} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($p0,$mul.ref(2,8));
  $p5.shadow := $add.ref($p0.shadow,$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 35, 11} true;
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $M.0 := $store.i64($M.0,$p5,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p5.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 36, 3} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p0,$mul.ref(3,8));
  $p6.shadow := $add.ref($p0.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 36, 11} true;
  assume {:verifier.code 0} true;
  assert ($p6 == $p6.shadow);
  $M.0 := $store.i64($M.0,$p6,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p6.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 37, 3} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($p0,$mul.ref(4,8));
  $p7.shadow := $add.ref($p0.shadow,$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 37, 11} true;
  assume {:verifier.code 0} true;
  assert ($p7 == $p7.shadow);
  $M.0 := $store.i64($M.0,$p7,0);
  $M.0.shadow := $store.i64($M.0.shadow,$p7.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 38, 17} true;
  assume {:verifier.code 0} true;
  call $i8, $i8.shadow := load64($p1, $p1.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 38, 17} true;
  assume {:verifier.code 0} true;
  call $i9, $i9.shadow := __uint64_identity($i8, $i8.shadow);
  call {:cexpr "u0"} boogie_si_record_i64($i9);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 40, 16} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($p1,$mul.ref(8,1));
  $p10.shadow := $add.ref($p1.shadow,$mul.ref(8,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 40, 16} true;
  assume {:verifier.code 0} true;
  call $i11, $i11.shadow := load64($p10, $p10.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 40, 16} true;
  assume {:verifier.code 0} true;
  call $i12, $i12.shadow := __uint64_identity($i11, $i11.shadow);
  call {:cexpr "u"} boogie_si_record_i64($i12);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 44, 21} true;
  assume {:verifier.code 0} true;
  $i13 := $and.i64($i9,1152921487695413247);
  $i13.shadow := $and.i64($i9.shadow,1152921487695413247);
  call {:cexpr "lo1"} boogie_si_record_i64($i13);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 45, 21} true;
  assume {:verifier.code 0} true;
  $i14 := $and.i64($i12,1152921487695413244);
  $i14.shadow := $and.i64($i12.shadow,1152921487695413244);
  call {:cexpr "hi1"} boogie_si_record_i64($i14);
  $i15 := $add.i64(5,5);
  $i15.shadow := $add.i64(5,5);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 47, 22} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p0,$mul.ref($i15,8));
  $p16.shadow := $add.ref($p0.shadow,$mul.ref($i15.shadow,8));
  $i17 := $add.i64(5,10);
  $i17.shadow := $add.i64(5,10);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 48, 22} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p0,$mul.ref($i17,8));
  $p18.shadow := $add.ref($p0.shadow,$mul.ref($i17.shadow,8));
  $i19 := $add.i64(5,15);
  $i19.shadow := $add.i64(5,15);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 49, 24} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($p0,$mul.ref($i19,8));
  $p20.shadow := $add.ref($p0.shadow,$mul.ref($i19.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 52, 25} true;
  assume {:verifier.code 0} true;
  $i21 := $and.i64($i13,67108863);
  $i21.shadow := $and.i64($i13.shadow,67108863);
  call {:cexpr "f00"} boogie_si_record_i64($i21);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 53, 25} true;
  assume {:verifier.code 0} true;
  $i22 := $lshr.i64($i13,26);
  $i22.shadow := $lshr.i64($i13.shadow,26);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 53, 42} true;
  assume {:verifier.code 0} true;
  $i23 := $and.i64($i22,67108863);
  $i23.shadow := $and.i64($i22.shadow,67108863);
  call {:cexpr "f10"} boogie_si_record_i64($i23);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 54, 25} true;
  assume {:verifier.code 0} true;
  $i24 := $lshr.i64($i13,52);
  $i24.shadow := $lshr.i64($i13.shadow,52);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 54, 52} true;
  assume {:verifier.code 0} true;
  $i25 := $and.i64($i14,16383);
  $i25.shadow := $and.i64($i14.shadow,16383);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 54, 73} true;
  assume {:verifier.code 0} true;
  $i26 := $shl.i64($i25,12);
  $i26.shadow := $shl.i64($i25.shadow,12);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 54, 42} true;
  assume {:verifier.code 0} true;
  $i27 := $or.i64($i24,$i26);
  $i27.shadow := $or.i64($i24.shadow,$i26.shadow);
  call {:cexpr "f20"} boogie_si_record_i64($i27);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 55, 25} true;
  assume {:verifier.code 0} true;
  $i28 := $lshr.i64($i14,14);
  $i28.shadow := $lshr.i64($i14.shadow,14);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 55, 42} true;
  assume {:verifier.code 0} true;
  $i29 := $and.i64($i28,67108863);
  $i29.shadow := $and.i64($i28.shadow,67108863);
  call {:cexpr "f30"} boogie_si_record_i64($i29);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 56, 25} true;
  assume {:verifier.code 0} true;
  $i30 := $lshr.i64($i14,40);
  $i30.shadow := $lshr.i64($i14.shadow,40);
  call {:cexpr "f40"} boogie_si_record_i64($i30);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 62, 3} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($p0,$mul.ref(5,8));
  $p31.shadow := $add.ref($p0.shadow,$mul.ref(5,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 62, 9} true;
  assume {:verifier.code 0} true;
  assert ($p31 == $p31.shadow);
  $M.0 := $store.i64($M.0,$p31,$i21);
  $M.0.shadow := $store.i64($M.0.shadow,$p31.shadow,$i21.shadow);
  $i32 := $add.i64(5,1);
  $i32.shadow := $add.i64(5,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 63, 3} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($p0,$mul.ref($i32,8));
  $p33.shadow := $add.ref($p0.shadow,$mul.ref($i32.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 63, 9} true;
  assume {:verifier.code 0} true;
  assert ($p33 == $p33.shadow);
  $M.0 := $store.i64($M.0,$p33,$i23);
  $M.0.shadow := $store.i64($M.0.shadow,$p33.shadow,$i23.shadow);
  $i34 := $add.i64(5,2);
  $i34.shadow := $add.i64(5,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 64, 3} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($p0,$mul.ref($i34,8));
  $p35.shadow := $add.ref($p0.shadow,$mul.ref($i34.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 64, 9} true;
  assume {:verifier.code 0} true;
  assert ($p35 == $p35.shadow);
  $M.0 := $store.i64($M.0,$p35,$i27);
  $M.0.shadow := $store.i64($M.0.shadow,$p35.shadow,$i27.shadow);
  $i36 := $add.i64(5,3);
  $i36.shadow := $add.i64(5,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 65, 3} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($p0,$mul.ref($i36,8));
  $p37.shadow := $add.ref($p0.shadow,$mul.ref($i36.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 65, 9} true;
  assume {:verifier.code 0} true;
  assert ($p37 == $p37.shadow);
  $M.0 := $store.i64($M.0,$p37,$i29);
  $M.0.shadow := $store.i64($M.0.shadow,$p37.shadow,$i29.shadow);
  $i38 := $add.i64(5,4);
  $i38.shadow := $add.i64(5,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 66, 3} true;
  assume {:verifier.code 0} true;
  $p39 := $add.ref($p0,$mul.ref($i38,8));
  $p39.shadow := $add.ref($p0.shadow,$mul.ref($i38.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 66, 9} true;
  assume {:verifier.code 0} true;
  assert ($p39 == $p39.shadow);
  $M.0 := $store.i64($M.0,$p39,$i30);
  $M.0.shadow := $store.i64($M.0.shadow,$p39.shadow,$i30.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 67, 19} true;
  assume {:verifier.code 0} true;
  $p40 := $add.ref($p0,$mul.ref(5,8));
  $p40.shadow := $add.ref($p0.shadow,$mul.ref(5,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 67, 19} true;
  assume {:verifier.code 0} true;
  assert ($p40 == $p40.shadow);
  $i41 := $load.i64($M.0,$p40);
  $i41.shadow := $load.i64($M.0.shadow,$p40.shadow);
  call {:cexpr "f200"} boogie_si_record_i64($i41);
  $i42 := $add.i64(5,1);
  $i42.shadow := $add.i64(5,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 68, 18} true;
  assume {:verifier.code 0} true;
  $p43 := $add.ref($p0,$mul.ref($i42,8));
  $p43.shadow := $add.ref($p0.shadow,$mul.ref($i42.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 68, 18} true;
  assume {:verifier.code 0} true;
  assert ($p43 == $p43.shadow);
  $i44 := $load.i64($M.0,$p43);
  $i44.shadow := $load.i64($M.0.shadow,$p43.shadow);
  call {:cexpr "f21"} boogie_si_record_i64($i44);
  $i45 := $add.i64(5,2);
  $i45.shadow := $add.i64(5,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 69, 18} true;
  assume {:verifier.code 0} true;
  $p46 := $add.ref($p0,$mul.ref($i45,8));
  $p46.shadow := $add.ref($p0.shadow,$mul.ref($i45.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 69, 18} true;
  assume {:verifier.code 0} true;
  assert ($p46 == $p46.shadow);
  $i47 := $load.i64($M.0,$p46);
  $i47.shadow := $load.i64($M.0.shadow,$p46.shadow);
  call {:cexpr "f22"} boogie_si_record_i64($i47);
  $i48 := $add.i64(5,3);
  $i48.shadow := $add.i64(5,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 70, 18} true;
  assume {:verifier.code 0} true;
  $p49 := $add.ref($p0,$mul.ref($i48,8));
  $p49.shadow := $add.ref($p0.shadow,$mul.ref($i48.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 70, 18} true;
  assume {:verifier.code 0} true;
  assert ($p49 == $p49.shadow);
  $i50 := $load.i64($M.0,$p49);
  $i50.shadow := $load.i64($M.0.shadow,$p49.shadow);
  call {:cexpr "f23"} boogie_si_record_i64($i50);
  $i51 := $add.i64(5,4);
  $i51.shadow := $add.i64(5,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 71, 18} true;
  assume {:verifier.code 0} true;
  $p52 := $add.ref($p0,$mul.ref($i51,8));
  $p52.shadow := $add.ref($p0.shadow,$mul.ref($i51.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 71, 18} true;
  assume {:verifier.code 0} true;
  assert ($p52 == $p52.shadow);
  $i53 := $load.i64($M.0,$p52);
  $i53.shadow := $load.i64($M.0.shadow,$p52.shadow);
  call {:cexpr "f24"} boogie_si_record_i64($i53);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 72, 17} true;
  assume {:verifier.code 0} true;
  $i54 := $mul.i64($i41,5);
  $i54.shadow := $mul.i64($i41.shadow,5);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 72, 3} true;
  assume {:verifier.code 0} true;
  $p55 := $add.ref($p0,$mul.ref($i15,8));
  $p55.shadow := $add.ref($p0.shadow,$mul.ref($i15.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 72, 10} true;
  assume {:verifier.code 0} true;
  assert ($p55 == $p55.shadow);
  $M.0 := $store.i64($M.0,$p55,$i54);
  $M.0.shadow := $store.i64($M.0.shadow,$p55.shadow,$i54.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 73, 16} true;
  assume {:verifier.code 0} true;
  $i56 := $mul.i64($i44,5);
  $i56.shadow := $mul.i64($i44.shadow,5);
  $i57 := $add.i64($i15,1);
  $i57.shadow := $add.i64($i15.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 73, 3} true;
  assume {:verifier.code 0} true;
  $p58 := $add.ref($p0,$mul.ref($i57,8));
  $p58.shadow := $add.ref($p0.shadow,$mul.ref($i57.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 73, 10} true;
  assume {:verifier.code 0} true;
  assert ($p58 == $p58.shadow);
  $M.0 := $store.i64($M.0,$p58,$i56);
  $M.0.shadow := $store.i64($M.0.shadow,$p58.shadow,$i56.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 74, 16} true;
  assume {:verifier.code 0} true;
  $i59 := $mul.i64($i47,5);
  $i59.shadow := $mul.i64($i47.shadow,5);
  $i60 := $add.i64($i15,2);
  $i60.shadow := $add.i64($i15.shadow,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 74, 3} true;
  assume {:verifier.code 0} true;
  $p61 := $add.ref($p0,$mul.ref($i60,8));
  $p61.shadow := $add.ref($p0.shadow,$mul.ref($i60.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 74, 10} true;
  assume {:verifier.code 0} true;
  assert ($p61 == $p61.shadow);
  $M.0 := $store.i64($M.0,$p61,$i59);
  $M.0.shadow := $store.i64($M.0.shadow,$p61.shadow,$i59.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 75, 16} true;
  assume {:verifier.code 0} true;
  $i62 := $mul.i64($i50,5);
  $i62.shadow := $mul.i64($i50.shadow,5);
  $i63 := $add.i64($i15,3);
  $i63.shadow := $add.i64($i15.shadow,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 75, 3} true;
  assume {:verifier.code 0} true;
  $p64 := $add.ref($p0,$mul.ref($i63,8));
  $p64.shadow := $add.ref($p0.shadow,$mul.ref($i63.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 75, 10} true;
  assume {:verifier.code 0} true;
  assert ($p64 == $p64.shadow);
  $M.0 := $store.i64($M.0,$p64,$i62);
  $M.0.shadow := $store.i64($M.0.shadow,$p64.shadow,$i62.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 76, 16} true;
  assume {:verifier.code 0} true;
  $i65 := $mul.i64($i53,5);
  $i65.shadow := $mul.i64($i53.shadow,5);
  $i66 := $add.i64($i15,4);
  $i66.shadow := $add.i64($i15.shadow,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 76, 3} true;
  assume {:verifier.code 0} true;
  $p67 := $add.ref($p0,$mul.ref($i66,8));
  $p67.shadow := $add.ref($p0.shadow,$mul.ref($i66.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 76, 10} true;
  assume {:verifier.code 0} true;
  assert ($p67 == $p67.shadow);
  $M.0 := $store.i64($M.0,$p67,$i65);
  $M.0.shadow := $store.i64($M.0.shadow,$p67.shadow,$i65.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 77, 12} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($p0,$mul.ref(5,8));
  $p68.shadow := $add.ref($p0.shadow,$mul.ref(5,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 77, 12} true;
  assume {:verifier.code 0} true;
  assert ($p68 == $p68.shadow);
  $i69 := $load.i64($M.0,$p68);
  $i69.shadow := $load.i64($M.0.shadow,$p68.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 77, 3} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($p0,$mul.ref($i17,8));
  $p70.shadow := $add.ref($p0.shadow,$mul.ref($i17.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 77, 10} true;
  assume {:verifier.code 0} true;
  assert ($p70 == $p70.shadow);
  $M.0 := $store.i64($M.0,$p70,$i69);
  $M.0.shadow := $store.i64($M.0.shadow,$p70.shadow,$i69.shadow);
  $i71 := $add.i64(5,1);
  $i71.shadow := $add.i64(5,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 78, 12} true;
  assume {:verifier.code 0} true;
  $p72 := $add.ref($p0,$mul.ref($i71,8));
  $p72.shadow := $add.ref($p0.shadow,$mul.ref($i71.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 78, 12} true;
  assume {:verifier.code 0} true;
  assert ($p72 == $p72.shadow);
  $i73 := $load.i64($M.0,$p72);
  $i73.shadow := $load.i64($M.0.shadow,$p72.shadow);
  $i74 := $add.i64($i17,1);
  $i74.shadow := $add.i64($i17.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 78, 3} true;
  assume {:verifier.code 0} true;
  $p75 := $add.ref($p0,$mul.ref($i74,8));
  $p75.shadow := $add.ref($p0.shadow,$mul.ref($i74.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 78, 10} true;
  assume {:verifier.code 0} true;
  assert ($p75 == $p75.shadow);
  $M.0 := $store.i64($M.0,$p75,$i73);
  $M.0.shadow := $store.i64($M.0.shadow,$p75.shadow,$i73.shadow);
  $i76 := $add.i64(5,2);
  $i76.shadow := $add.i64(5,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 79, 12} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($p0,$mul.ref($i76,8));
  $p77.shadow := $add.ref($p0.shadow,$mul.ref($i76.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 79, 12} true;
  assume {:verifier.code 0} true;
  assert ($p77 == $p77.shadow);
  $i78 := $load.i64($M.0,$p77);
  $i78.shadow := $load.i64($M.0.shadow,$p77.shadow);
  $i79 := $add.i64($i17,2);
  $i79.shadow := $add.i64($i17.shadow,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 79, 3} true;
  assume {:verifier.code 0} true;
  $p80 := $add.ref($p0,$mul.ref($i79,8));
  $p80.shadow := $add.ref($p0.shadow,$mul.ref($i79.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 79, 10} true;
  assume {:verifier.code 0} true;
  assert ($p80 == $p80.shadow);
  $M.0 := $store.i64($M.0,$p80,$i78);
  $M.0.shadow := $store.i64($M.0.shadow,$p80.shadow,$i78.shadow);
  $i81 := $add.i64(5,3);
  $i81.shadow := $add.i64(5,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 80, 12} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($p0,$mul.ref($i81,8));
  $p82.shadow := $add.ref($p0.shadow,$mul.ref($i81.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 80, 12} true;
  assume {:verifier.code 0} true;
  assert ($p82 == $p82.shadow);
  $i83 := $load.i64($M.0,$p82);
  $i83.shadow := $load.i64($M.0.shadow,$p82.shadow);
  $i84 := $add.i64($i17,3);
  $i84.shadow := $add.i64($i17.shadow,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 80, 3} true;
  assume {:verifier.code 0} true;
  $p85 := $add.ref($p0,$mul.ref($i84,8));
  $p85.shadow := $add.ref($p0.shadow,$mul.ref($i84.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 80, 10} true;
  assume {:verifier.code 0} true;
  assert ($p85 == $p85.shadow);
  $M.0 := $store.i64($M.0,$p85,$i83);
  $M.0.shadow := $store.i64($M.0.shadow,$p85.shadow,$i83.shadow);
  $i86 := $add.i64(5,4);
  $i86.shadow := $add.i64(5,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 81, 12} true;
  assume {:verifier.code 0} true;
  $p87 := $add.ref($p0,$mul.ref($i86,8));
  $p87.shadow := $add.ref($p0.shadow,$mul.ref($i86.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 81, 12} true;
  assume {:verifier.code 0} true;
  assert ($p87 == $p87.shadow);
  $i88 := $load.i64($M.0,$p87);
  $i88.shadow := $load.i64($M.0.shadow,$p87.shadow);
  $i89 := $add.i64($i17,4);
  $i89.shadow := $add.i64($i17.shadow,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 81, 3} true;
  assume {:verifier.code 0} true;
  $p90 := $add.ref($p0,$mul.ref($i89,8));
  $p90.shadow := $add.ref($p0.shadow,$mul.ref($i89.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 81, 10} true;
  assume {:verifier.code 0} true;
  assert ($p90 == $p90.shadow);
  $M.0 := $store.i64($M.0,$p90,$i88);
  $M.0.shadow := $store.i64($M.0.shadow,$p90.shadow,$i88.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 82, 14} true;
  assume {:verifier.code 0} true;
  $p91 := $add.ref($p0,$mul.ref($i15,8));
  $p91.shadow := $add.ref($p0.shadow,$mul.ref($i15.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 82, 14} true;
  assume {:verifier.code 0} true;
  assert ($p91 == $p91.shadow);
  $i92 := $load.i64($M.0,$p91);
  $i92.shadow := $load.i64($M.0.shadow,$p91.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 82, 3} true;
  assume {:verifier.code 0} true;
  $p93 := $add.ref($p0,$mul.ref($i19,8));
  $p93.shadow := $add.ref($p0.shadow,$mul.ref($i19.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 82, 12} true;
  assume {:verifier.code 0} true;
  assert ($p93 == $p93.shadow);
  $M.0 := $store.i64($M.0,$p93,$i92);
  $M.0.shadow := $store.i64($M.0.shadow,$p93.shadow,$i92.shadow);
  $i94 := $add.i64($i15,1);
  $i94.shadow := $add.i64($i15.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 83, 14} true;
  assume {:verifier.code 0} true;
  $p95 := $add.ref($p0,$mul.ref($i94,8));
  $p95.shadow := $add.ref($p0.shadow,$mul.ref($i94.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 83, 14} true;
  assume {:verifier.code 0} true;
  assert ($p95 == $p95.shadow);
  $i96 := $load.i64($M.0,$p95);
  $i96.shadow := $load.i64($M.0.shadow,$p95.shadow);
  $i97 := $add.i64($i19,1);
  $i97.shadow := $add.i64($i19.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 83, 3} true;
  assume {:verifier.code 0} true;
  $p98 := $add.ref($p0,$mul.ref($i97,8));
  $p98.shadow := $add.ref($p0.shadow,$mul.ref($i97.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 83, 12} true;
  assume {:verifier.code 0} true;
  assert ($p98 == $p98.shadow);
  $M.0 := $store.i64($M.0,$p98,$i96);
  $M.0.shadow := $store.i64($M.0.shadow,$p98.shadow,$i96.shadow);
  $i99 := $add.i64($i15,2);
  $i99.shadow := $add.i64($i15.shadow,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 84, 14} true;
  assume {:verifier.code 0} true;
  $p100 := $add.ref($p0,$mul.ref($i99,8));
  $p100.shadow := $add.ref($p0.shadow,$mul.ref($i99.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 84, 14} true;
  assume {:verifier.code 0} true;
  assert ($p100 == $p100.shadow);
  $i101 := $load.i64($M.0,$p100);
  $i101.shadow := $load.i64($M.0.shadow,$p100.shadow);
  $i102 := $add.i64($i19,2);
  $i102.shadow := $add.i64($i19.shadow,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 84, 3} true;
  assume {:verifier.code 0} true;
  $p103 := $add.ref($p0,$mul.ref($i102,8));
  $p103.shadow := $add.ref($p0.shadow,$mul.ref($i102.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 84, 12} true;
  assume {:verifier.code 0} true;
  assert ($p103 == $p103.shadow);
  $M.0 := $store.i64($M.0,$p103,$i101);
  $M.0.shadow := $store.i64($M.0.shadow,$p103.shadow,$i101.shadow);
  $i104 := $add.i64($i15,3);
  $i104.shadow := $add.i64($i15.shadow,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 85, 14} true;
  assume {:verifier.code 0} true;
  $p105 := $add.ref($p0,$mul.ref($i104,8));
  $p105.shadow := $add.ref($p0.shadow,$mul.ref($i104.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 85, 14} true;
  assume {:verifier.code 0} true;
  assert ($p105 == $p105.shadow);
  $i106 := $load.i64($M.0,$p105);
  $i106.shadow := $load.i64($M.0.shadow,$p105.shadow);
  $i107 := $add.i64($i19,3);
  $i107.shadow := $add.i64($i19.shadow,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 85, 3} true;
  assume {:verifier.code 0} true;
  $p108 := $add.ref($p0,$mul.ref($i107,8));
  $p108.shadow := $add.ref($p0.shadow,$mul.ref($i107.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 85, 12} true;
  assume {:verifier.code 0} true;
  assert ($p108 == $p108.shadow);
  $M.0 := $store.i64($M.0,$p108,$i106);
  $M.0.shadow := $store.i64($M.0.shadow,$p108.shadow,$i106.shadow);
  $i109 := $add.i64($i15,4);
  $i109.shadow := $add.i64($i15.shadow,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 86, 14} true;
  assume {:verifier.code 0} true;
  $p110 := $add.ref($p0,$mul.ref($i109,8));
  $p110.shadow := $add.ref($p0.shadow,$mul.ref($i109.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 86, 14} true;
  assume {:verifier.code 0} true;
  assert ($p110 == $p110.shadow);
  $i111 := $load.i64($M.0,$p110);
  $i111.shadow := $load.i64($M.0.shadow,$p110.shadow);
  $i112 := $add.i64($i19,4);
  $i112.shadow := $add.i64($i19.shadow,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 86, 3} true;
  assume {:verifier.code 0} true;
  $p113 := $add.ref($p0,$mul.ref($i112,8));
  $p113.shadow := $add.ref($p0.shadow,$mul.ref($i112.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 86, 12} true;
  assume {:verifier.code 0} true;
  assert ($p113 == $p113.shadow);
  $M.0 := $store.i64($M.0,$p113,$i111);
  $M.0.shadow := $store.i64($M.0.shadow,$p113.shadow,$i111.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 87, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const load64: ref;
axiom (load64 == $sub.ref(0,3096));
procedure {:inline 1} load64($p0: ref, $p0.shadow: ref) returns ($r: i64, $r.shadow: i64)
modifies $M.2, $exn;
modifies $CurrAddr;
{
  var $p1: ref;
...
$bb0:
  ...
  assert ($p2 == $p2.shadow);
  assert ($p0 == $p0.shadow);
  call $M.2, $M.2.shadow := $memcpy.i8($M.2, $M.2.shadow, $M.1, $M.1.shadow, $p2, $p2.shadow, $p0, $p0.shadow, 8, 8, false, false);
  assume {:sourceloc "../hacl-star/dist/karamel/include/krml/lowstar_endianness.h", 175, 10} true;
  assume {:verifier.code 0} true;
  assert ($p1 == $p1.shadow);
  $i3 := $load.i64($M.2,$p1);
  $i3.shadow := $load.i64($M.2.shadow,$p1.shadow);
...
axiom (__uint64_identity == $sub.ref(0,4128));
procedure {:inline 1} __uint64_identity($i0: i64, $i0.shadow: i64) returns ($r: i64, $r.shadow: i64)
modifies $exn;
{
$bb0:
...
axiom (llvm.dbg.declare == $sub.ref(0,5160));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const llvm.memcpy.p0i8.p0i8.i64: ref;
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0,6192));
...
axiom (llvm.memset.p0i8.i64 == $sub.ref(0,7224));
procedure {:inline 1} llvm.memset.p0i8.i64($p0: ref, $p0.shadow: ref, $i1: i8, $i1.shadow: i8, $i2: i64, $i2.shadow: i64, $i3: i1, $i3.shadow: i1);
const Hacl_Poly1305_32_poly1305_update: ref;
axiom (Hacl_Poly1305_32_poly1305_update == $sub.ref(0,8256));
procedure {:inline 1} Hacl_Poly1305_32_poly1305_update($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32, $p2: ref, $p2.shadow: ref)
modifies $M.3, $M.0, $M.4, $M.1, $exn;
modifies $M.2;
modifies $CurrAddr;
{
  var $p3: ref;
  ...
  var $p337.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 213, 23} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  $p5.shadow := $p5;
  call {:cexpr "Hacl_Poly1305_32_poly1305_update:arg:len"} boogie_si_record_i32($i1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 213, 23} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p0,$mul.ref(5,8));
  $p6.shadow := $add.ref($p0.shadow,$mul.ref(5,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 215, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $udiv.i32($i1,16);
  $i7.shadow := $udiv.i32($i1.shadow,16);
  call {:cexpr "nb"} boogie_si_record_i32($i7);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 216, 22} true;
  assume {:verifier.code 0} true;
  $i8 := $urem.i32($i1,16);
  $i8.shadow := $urem.i32($i1.shadow,16);
  call {:cexpr "rem"} boogie_si_record_i32($i8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 217, 8} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  $i9.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 217, 37} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i32($i9,$i7);
  $i10.shadow := $ult.i32($i9.shadow,$i7.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 217, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i10 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 219, 31} true;
  assume {:verifier.code 0} true;
  $i11 := $mul.i32($i9,16);
  $i11.shadow := $mul.i32($i9.shadow,16);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 219, 27} true;
  assume {:verifier.code 0} true;
  ...
  $p13.shadow := $add.ref($p2.shadow,$mul.ref($i12.shadow,1));
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 220, 14} true;
  assume {:verifier.code 0} true;
  $p14 := $bitcast.ref.ref($p3);
  $p14.shadow := $bitcast.ref.ref($p3.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 220, 14} true;
  assume {:verifier.code 0} true;
  assert ($p14 == $p14.shadow);
  call $M.3, $M.3.shadow := $memset.i8($M.3, $M.3.shadow, $p14, $p14.shadow, 0, 0, 40, 40, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 221, 19} true;
  assume {:verifier.code 0} true;
  call $i15, $i15.shadow := load64($p13, $p13.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 221, 19} true;
  assume {:verifier.code 0} true;
  call $i16, $i16.shadow := __uint64_identity($i15, $i15.shadow);
  call {:cexpr "u0"} boogie_si_record_i64($i16);
  $i17 := $add.i64($i12,8);
  $i17.shadow := $add.i64($i12.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 223, 18} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p2,$mul.ref($i17,1));
  $p18.shadow := $add.ref($p2.shadow,$mul.ref($i17.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 223, 18} true;
  assume {:verifier.code 0} true;
  call $i19, $i19.shadow := load64($p18, $p18.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 223, 18} true;
  assume {:verifier.code 0} true;
  call $i20, $i20.shadow := __uint64_identity($i19, $i19.shadow);
  call {:cexpr "u"} boogie_si_record_i64($i20);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 227, 24} true;
  assume {:verifier.code 0} true;
  $i21 := $and.i64($i16,67108863);
  $i21.shadow := $and.i64($i16.shadow,67108863);
  call {:cexpr "f010"} boogie_si_record_i64($i21);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 228, 24} true;
  assume {:verifier.code 0} true;
  $i22 := $lshr.i64($i16,26);
  $i22.shadow := $lshr.i64($i16.shadow,26);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 228, 41} true;
  assume {:verifier.code 0} true;
  $i23 := $and.i64($i22,67108863);
  $i23.shadow := $and.i64($i22.shadow,67108863);
  call {:cexpr "f110"} boogie_si_record_i64($i23);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 229, 23} true;
  assume {:verifier.code 0} true;
  $i24 := $lshr.i64($i16,52);
  $i24.shadow := $lshr.i64($i16.shadow,52);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 229, 46} true;
  assume {:verifier.code 0} true;
  $i25 := $and.i64($i20,16383);
  $i25.shadow := $and.i64($i20.shadow,16383);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 229, 67} true;
  assume {:verifier.code 0} true;
  $i26 := $shl.i64($i25,12);
  $i26.shadow := $shl.i64($i25.shadow,12);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 229, 40} true;
  assume {:verifier.code 0} true;
  $i27 := $or.i64($i24,$i26);
  $i27.shadow := $or.i64($i24.shadow,$i26.shadow);
  call {:cexpr "f20"} boogie_si_record_i64($i27);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 230, 23} true;
  assume {:verifier.code 0} true;
  $i28 := $lshr.i64($i20,14);
  $i28.shadow := $lshr.i64($i20.shadow,14);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 230, 40} true;
  assume {:verifier.code 0} true;
  $i29 := $and.i64($i28,67108863);
  $i29.shadow := $and.i64($i28.shadow,67108863);
  call {:cexpr "f30"} boogie_si_record_i64($i29);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 231, 23} true;
  assume {:verifier.code 0} true;
  $i30 := $lshr.i64($i20,40);
  $i30.shadow := $lshr.i64($i20.shadow,40);
  call {:cexpr "f40"} boogie_si_record_i64($i30);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 237, 5} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($add.ref($p3,$mul.ref(0,40)),$mul.ref(0,8));
  $p31.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,40)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 237, 11} true;
  assume {:verifier.code 0} true;
  assert ($p31 == $p31.shadow);
  $M.3 := $store.i64($M.3,$p31,$i21);
  $M.3.shadow := $store.i64($M.3.shadow,$p31.shadow,$i21.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 238, 5} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($add.ref($p3,$mul.ref(0,40)),$mul.ref(1,8));
  $p32.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,40)),$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 238, 11} true;
  assume {:verifier.code 0} true;
  assert ($p32 == $p32.shadow);
  $M.3 := $store.i64($M.3,$p32,$i23);
  $M.3.shadow := $store.i64($M.3.shadow,$p32.shadow,$i23.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 239, 5} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref($p3,$mul.ref(0,40)),$mul.ref(2,8));
  $p33.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,40)),$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 239, 11} true;
  assume {:verifier.code 0} true;
  assert ($p33 == $p33.shadow);
  $M.3 := $store.i64($M.3,$p33,$i27);
  $M.3.shadow := $store.i64($M.3.shadow,$p33.shadow,$i27.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 240, 5} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p3,$mul.ref(0,40)),$mul.ref(3,8));
  $p34.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,40)),$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 240, 11} true;
  assume {:verifier.code 0} true;
  assert ($p34 == $p34.shadow);
  $M.3 := $store.i64($M.3,$p34,$i29);
  $M.3.shadow := $store.i64($M.3.shadow,$p34.shadow,$i29.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 241, 5} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($add.ref($p3,$mul.ref(0,40)),$mul.ref(4,8));
  $p35.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,40)),$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 241, 11} true;
  assume {:verifier.code 0} true;
  assert ($p35 == $p35.shadow);
  $M.3 := $store.i64($M.3,$p35,$i30);
  $M.3.shadow := $store.i64($M.3.shadow,$p35.shadow,$i30.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 244, 19} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($add.ref($p3,$mul.ref(0,40)),$mul.ref(4,8));
  $p36.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,40)),$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 244, 19} true;
  assume {:verifier.code 0} true;
  assert ($p36 == $p36.shadow);
  $i37 := $load.i64($M.3,$p36);
  $i37.shadow := $load.i64($M.3.shadow,$p36.shadow);
  call {:cexpr "f4"} boogie_si_record_i64($i37);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 245, 16} true;
  assume {:verifier.code 0} true;
  $i38 := $or.i64($i37,16777216);
  $i38.shadow := $or.i64($i37.shadow,16777216);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 245, 5} true;
  assume {:verifier.code 0} true;
  $p39 := $add.ref($add.ref($p3,$mul.ref(0,40)),$mul.ref(4,8));
  $p39.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,40)),$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 245, 11} true;
  assume {:verifier.code 0} true;
  assert ($p39 == $p39.shadow);
  $M.3 := $store.i64($M.3,$p39,$i38);
  $M.3.shadow := $store.i64($M.3.shadow,$p39.shadow,$i38.shadow);
  $i40 := $add.i64(5,5);
  $i40.shadow := $add.i64(5,5);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 247, 24} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($p0,$mul.ref($i40,8));
  $p41.shadow := $add.ref($p0.shadow,$mul.ref($i40.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 248, 19} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($p0,$mul.ref(5,8));
  $p42.shadow := $add.ref($p0.shadow,$mul.ref(5,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 248, 19} true;
  assume {:verifier.code 0} true;
  assert ($p42 == $p42.shadow);
  $i43 := $load.i64($M.0,$p42);
  $i43.shadow := $load.i64($M.0.shadow,$p42.shadow);
  call {:cexpr "r0"} boogie_si_record_i64($i43);
  $i44 := $add.i64(5,1);
  $i44.shadow := $add.i64(5,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 249, 19} true;
  assume {:verifier.code 0} true;
  $p45 := $add.ref($p0,$mul.ref($i44,8));
  $p45.shadow := $add.ref($p0.shadow,$mul.ref($i44.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 249, 19} true;
  assume {:verifier.code 0} true;
  assert ($p45 == $p45.shadow);
  $i46 := $load.i64($M.0,$p45);
  $i46.shadow := $load.i64($M.0.shadow,$p45.shadow);
  call {:cexpr "r1"} boogie_si_record_i64($i46);
  $i47 := $add.i64(5,2);
  $i47.shadow := $add.i64(5,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 250, 19} true;
  assume {:verifier.code 0} true;
  $p48 := $add.ref($p0,$mul.ref($i47,8));
  $p48.shadow := $add.ref($p0.shadow,$mul.ref($i47.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 250, 19} true;
  assume {:verifier.code 0} true;
  assert ($p48 == $p48.shadow);
  $i49 := $load.i64($M.0,$p48);
  $i49.shadow := $load.i64($M.0.shadow,$p48.shadow);
  call {:cexpr "r2"} boogie_si_record_i64($i49);
  $i50 := $add.i64(5,3);
  $i50.shadow := $add.i64(5,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 251, 19} true;
  assume {:verifier.code 0} true;
  $p51 := $add.ref($p0,$mul.ref($i50,8));
  $p51.shadow := $add.ref($p0.shadow,$mul.ref($i50.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 251, 19} true;
  assume {:verifier.code 0} true;
  assert ($p51 == $p51.shadow);
  $i52 := $load.i64($M.0,$p51);
  $i52.shadow := $load.i64($M.0.shadow,$p51.shadow);
  call {:cexpr "r3"} boogie_si_record_i64($i52);
  $i53 := $add.i64(5,4);
  $i53.shadow := $add.i64(5,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 252, 19} true;
  assume {:verifier.code 0} true;
  $p54 := $add.ref($p0,$mul.ref($i53,8));
  $p54.shadow := $add.ref($p0.shadow,$mul.ref($i53.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 252, 19} true;
  assume {:verifier.code 0} true;
  assert ($p54 == $p54.shadow);
  $i55 := $load.i64($M.0,$p54);
  $i55.shadow := $load.i64($M.0.shadow,$p54.shadow);
  call {:cexpr "r4"} boogie_si_record_i64($i55);
  $i56 := $add.i64($i40,1);
  $i56.shadow := $add.i64($i40.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 253, 20} true;
  assume {:verifier.code 0} true;
  $p57 := $add.ref($p0,$mul.ref($i56,8));
  $p57.shadow := $add.ref($p0.shadow,$mul.ref($i56.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 253, 20} true;
  assume {:verifier.code 0} true;
  assert ($p57 == $p57.shadow);
  $i58 := $load.i64($M.0,$p57);
  $i58.shadow := $load.i64($M.0.shadow,$p57.shadow);
  call {:cexpr "r51"} boogie_si_record_i64($i58);
  $i59 := $add.i64($i40,2);
  $i59.shadow := $add.i64($i40.shadow,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 254, 20} true;
  assume {:verifier.code 0} true;
  $p60 := $add.ref($p0,$mul.ref($i59,8));
  $p60.shadow := $add.ref($p0.shadow,$mul.ref($i59.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 254, 20} true;
  assume {:verifier.code 0} true;
  assert ($p60 == $p60.shadow);
  $i61 := $load.i64($M.0,$p60);
  $i61.shadow := $load.i64($M.0.shadow,$p60.shadow);
  call {:cexpr "r52"} boogie_si_record_i64($i61);
  $i62 := $add.i64($i40,3);
  $i62.shadow := $add.i64($i40.shadow,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 255, 20} true;
  assume {:verifier.code 0} true;
  $p63 := $add.ref($p0,$mul.ref($i62,8));
  $p63.shadow := $add.ref($p0.shadow,$mul.ref($i62.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 255, 20} true;
  assume {:verifier.code 0} true;
  assert ($p63 == $p63.shadow);
  $i64 := $load.i64($M.0,$p63);
  $i64.shadow := $load.i64($M.0.shadow,$p63.shadow);
  call {:cexpr "r53"} boogie_si_record_i64($i64);
  $i65 := $add.i64($i40,4);
  $i65.shadow := $add.i64($i40.shadow,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 256, 20} true;
  assume {:verifier.code 0} true;
  $p66 := $add.ref($p0,$mul.ref($i65,8));
  $p66.shadow := $add.ref($p0.shadow,$mul.ref($i65.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 256, 20} true;
  assume {:verifier.code 0} true;
  assert ($p66 == $p66.shadow);
  $i67 := $load.i64($M.0,$p66);
  $i67.shadow := $load.i64($M.0.shadow,$p66.shadow);
  call {:cexpr "r54"} boogie_si_record_i64($i67);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 257, 20} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($add.ref($p3,$mul.ref(0,40)),$mul.ref(0,8));
  $p68.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,40)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 257, 20} true;
  assume {:verifier.code 0} true;
  assert ($p68 == $p68.shadow);
  $i69 := $load.i64($M.3,$p68);
  $i69.shadow := $load.i64($M.3.shadow,$p68.shadow);
  call {:cexpr "f10"} boogie_si_record_i64($i69);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 258, 20} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($add.ref($p3,$mul.ref(0,40)),$mul.ref(1,8));
  $p70.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,40)),$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 258, 20} true;
  assume {:verifier.code 0} true;
  assert ($p70 == $p70.shadow);
  $i71 := $load.i64($M.3,$p70);
  $i71.shadow := $load.i64($M.3.shadow,$p70.shadow);
  call {:cexpr "f11"} boogie_si_record_i64($i71);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 259, 20} true;
  assume {:verifier.code 0} true;
  $p72 := $add.ref($add.ref($p3,$mul.ref(0,40)),$mul.ref(2,8));
  $p72.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,40)),$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 259, 20} true;
  assume {:verifier.code 0} true;
  assert ($p72 == $p72.shadow);
  $i73 := $load.i64($M.3,$p72);
  $i73.shadow := $load.i64($M.3.shadow,$p72.shadow);
  call {:cexpr "f12"} boogie_si_record_i64($i73);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 260, 20} true;
  assume {:verifier.code 0} true;
  $p74 := $add.ref($add.ref($p3,$mul.ref(0,40)),$mul.ref(3,8));
  $p74.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,40)),$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 260, 20} true;
  assume {:verifier.code 0} true;
  assert ($p74 == $p74.shadow);
  $i75 := $load.i64($M.3,$p74);
  $i75.shadow := $load.i64($M.3.shadow,$p74.shadow);
  call {:cexpr "f13"} boogie_si_record_i64($i75);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 261, 20} true;
  assume {:verifier.code 0} true;
  $p76 := $add.ref($add.ref($p3,$mul.ref(0,40)),$mul.ref(4,8));
  $p76.shadow := $add.ref($add.ref($p3.shadow,$mul.ref(0,40)),$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 261, 20} true;
  assume {:verifier.code 0} true;
  assert ($p76 == $p76.shadow);
  $i77 := $load.i64($M.3,$p76);
  $i77.shadow := $load.i64($M.3.shadow,$p76.shadow);
  call {:cexpr "f14"} boogie_si_record_i64($i77);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 262, 19} true;
  assume {:verifier.code 0} true;
  $p78 := $add.ref($p0,$mul.ref(0,8));
  $p78.shadow := $add.ref($p0.shadow,$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 262, 19} true;
  assume {:verifier.code 0} true;
  assert ($p78 == $p78.shadow);
  $i79 := $load.i64($M.0,$p78);
  $i79.shadow := $load.i64($M.0.shadow,$p78.shadow);
  call {:cexpr "a0"} boogie_si_record_i64($i79);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 263, 19} true;
  assume {:verifier.code 0} true;
  $p80 := $add.ref($p0,$mul.ref(1,8));
  $p80.shadow := $add.ref($p0.shadow,$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 263, 19} true;
  assume {:verifier.code 0} true;
  assert ($p80 == $p80.shadow);
  $i81 := $load.i64($M.0,$p80);
  $i81.shadow := $load.i64($M.0.shadow,$p80.shadow);
  call {:cexpr "a1"} boogie_si_record_i64($i81);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 264, 19} true;
  assume {:verifier.code 0} true;
  $p82 := $add.ref($p0,$mul.ref(2,8));
  $p82.shadow := $add.ref($p0.shadow,$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 264, 19} true;
  assume {:verifier.code 0} true;
  assert ($p82 == $p82.shadow);
  $i83 := $load.i64($M.0,$p82);
  $i83.shadow := $load.i64($M.0.shadow,$p82.shadow);
  call {:cexpr "a2"} boogie_si_record_i64($i83);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 265, 19} true;
  assume {:verifier.code 0} true;
  $p84 := $add.ref($p0,$mul.ref(3,8));
  $p84.shadow := $add.ref($p0.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 265, 19} true;
  assume {:verifier.code 0} true;
  assert ($p84 == $p84.shadow);
  $i85 := $load.i64($M.0,$p84);
  $i85.shadow := $load.i64($M.0.shadow,$p84.shadow);
  call {:cexpr "a3"} boogie_si_record_i64($i85);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 266, 19} true;
  assume {:verifier.code 0} true;
  $p86 := $add.ref($p0,$mul.ref(4,8));
  $p86.shadow := $add.ref($p0.shadow,$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 266, 19} true;
  assume {:verifier.code 0} true;
  assert ($p86 == $p86.shadow);
  $i87 := $load.i64($M.0,$p86);
  $i87.shadow := $load.i64($M.0.shadow,$p86.shadow);
  call {:cexpr "a4"} boogie_si_record_i64($i87);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 267, 23} true;
  assume {:verifier.code 0} true;
  $i88 := $add.i64($i79,$i69);
  $i88.shadow := $add.i64($i79.shadow,$i69.shadow);
  call {:cexpr "a01"} boogie_si_record_i64($i88);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 268, 23} true;
  assume {:verifier.code 0} true;
  $i89 := $add.i64($i81,$i71);
  $i89.shadow := $add.i64($i81.shadow,$i71.shadow);
  call {:cexpr "a11"} boogie_si_record_i64($i89);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 269, 23} true;
  assume {:verifier.code 0} true;
  $i90 := $add.i64($i83,$i73);
  $i90.shadow := $add.i64($i83.shadow,$i73.shadow);
  call {:cexpr "a21"} boogie_si_record_i64($i90);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 270, 23} true;
  assume {:verifier.code 0} true;
  $i91 := $add.i64($i85,$i75);
  $i91.shadow := $add.i64($i85.shadow,$i75.shadow);
  call {:cexpr "a31"} boogie_si_record_i64($i91);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 271, 23} true;
  assume {:verifier.code 0} true;
  $i92 := $add.i64($i87,$i77);
  $i92.shadow := $add.i64($i87.shadow,$i77.shadow);
  call {:cexpr "a41"} boogie_si_record_i64($i92);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 272, 23} true;
  assume {:verifier.code 0} true;
  $i93 := $mul.i64($i43,$i88);
  $i93.shadow := $mul.i64($i43.shadow,$i88.shadow);
  call {:cexpr "a02"} boogie_si_record_i64($i93);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 273, 23} true;
  assume {:verifier.code 0} true;
  $i94 := $mul.i64($i46,$i88);
  $i94.shadow := $mul.i64($i46.shadow,$i88.shadow);
  call {:cexpr "a12"} boogie_si_record_i64($i94);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 274, 23} true;
  assume {:verifier.code 0} true;
  $i95 := $mul.i64($i49,$i88);
  $i95.shadow := $mul.i64($i49.shadow,$i88.shadow);
  call {:cexpr "a22"} boogie_si_record_i64($i95);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 275, 23} true;
  assume {:verifier.code 0} true;
  $i96 := $mul.i64($i52,$i88);
  $i96.shadow := $mul.i64($i52.shadow,$i88.shadow);
  call {:cexpr "a32"} boogie_si_record_i64($i96);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 276, 23} true;
  assume {:verifier.code 0} true;
  $i97 := $mul.i64($i55,$i88);
  $i97.shadow := $mul.i64($i55.shadow,$i88.shadow);
  call {:cexpr "a42"} boogie_si_record_i64($i97);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 277, 30} true;
  assume {:verifier.code 0} true;
  $i98 := $mul.i64($i67,$i89);
  $i98.shadow := $mul.i64($i67.shadow,$i89.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 277, 24} true;
  assume {:verifier.code 0} true;
  $i99 := $add.i64($i93,$i98);
  $i99.shadow := $add.i64($i93.shadow,$i98.shadow);
  call {:cexpr "a03"} boogie_si_record_i64($i99);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 278, 29} true;
  assume {:verifier.code 0} true;
  $i100 := $mul.i64($i43,$i89);
  $i100.shadow := $mul.i64($i43.shadow,$i89.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 278, 24} true;
  assume {:verifier.code 0} true;
  $i101 := $add.i64($i94,$i100);
  $i101.shadow := $add.i64($i94.shadow,$i100.shadow);
  call {:cexpr "a13"} boogie_si_record_i64($i101);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 279, 29} true;
  assume {:verifier.code 0} true;
  $i102 := $mul.i64($i46,$i89);
  $i102.shadow := $mul.i64($i46.shadow,$i89.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 279, 24} true;
  assume {:verifier.code 0} true;
  $i103 := $add.i64($i95,$i102);
  $i103.shadow := $add.i64($i95.shadow,$i102.shadow);
  call {:cexpr "a23"} boogie_si_record_i64($i103);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 280, 29} true;
  assume {:verifier.code 0} true;
  $i104 := $mul.i64($i49,$i89);
  $i104.shadow := $mul.i64($i49.shadow,$i89.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 280, 24} true;
  assume {:verifier.code 0} true;
  $i105 := $add.i64($i96,$i104);
  $i105.shadow := $add.i64($i96.shadow,$i104.shadow);
  call {:cexpr "a33"} boogie_si_record_i64($i105);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 281, 29} true;
  assume {:verifier.code 0} true;
  $i106 := $mul.i64($i52,$i89);
  $i106.shadow := $mul.i64($i52.shadow,$i89.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 281, 24} true;
  assume {:verifier.code 0} true;
  $i107 := $add.i64($i97,$i106);
  $i107.shadow := $add.i64($i97.shadow,$i106.shadow);
  call {:cexpr "a43"} boogie_si_record_i64($i107);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 282, 30} true;
  assume {:verifier.code 0} true;
  $i108 := $mul.i64($i64,$i90);
  $i108.shadow := $mul.i64($i64.shadow,$i90.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 282, 24} true;
  assume {:verifier.code 0} true;
  $i109 := $add.i64($i99,$i108);
  $i109.shadow := $add.i64($i99.shadow,$i108.shadow);
  call {:cexpr "a04"} boogie_si_record_i64($i109);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 283, 30} true;
  assume {:verifier.code 0} true;
  $i110 := $mul.i64($i67,$i90);
  $i110.shadow := $mul.i64($i67.shadow,$i90.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 283, 24} true;
  assume {:verifier.code 0} true;
  $i111 := $add.i64($i101,$i110);
  $i111.shadow := $add.i64($i101.shadow,$i110.shadow);
  call {:cexpr "a14"} boogie_si_record_i64($i111);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 284, 29} true;
  assume {:verifier.code 0} true;
  $i112 := $mul.i64($i43,$i90);
  $i112.shadow := $mul.i64($i43.shadow,$i90.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 284, 24} true;
  assume {:verifier.code 0} true;
  $i113 := $add.i64($i103,$i112);
  $i113.shadow := $add.i64($i103.shadow,$i112.shadow);
  call {:cexpr "a24"} boogie_si_record_i64($i113);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 285, 29} true;
  assume {:verifier.code 0} true;
  $i114 := $mul.i64($i46,$i90);
  $i114.shadow := $mul.i64($i46.shadow,$i90.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 285, 24} true;
  assume {:verifier.code 0} true;
  $i115 := $add.i64($i105,$i114);
  $i115.shadow := $add.i64($i105.shadow,$i114.shadow);
  call {:cexpr "a34"} boogie_si_record_i64($i115);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 286, 29} true;
  assume {:verifier.code 0} true;
  $i116 := $mul.i64($i49,$i90);
  $i116.shadow := $mul.i64($i49.shadow,$i90.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 286, 24} true;
  assume {:verifier.code 0} true;
  $i117 := $add.i64($i107,$i116);
  $i117.shadow := $add.i64($i107.shadow,$i116.shadow);
  call {:cexpr "a44"} boogie_si_record_i64($i117);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 287, 30} true;
  assume {:verifier.code 0} true;
  $i118 := $mul.i64($i61,$i91);
  $i118.shadow := $mul.i64($i61.shadow,$i91.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 287, 24} true;
  assume {:verifier.code 0} true;
  $i119 := $add.i64($i109,$i118);
  $i119.shadow := $add.i64($i109.shadow,$i118.shadow);
  call {:cexpr "a05"} boogie_si_record_i64($i119);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 288, 30} true;
  assume {:verifier.code 0} true;
  $i120 := $mul.i64($i64,$i91);
  $i120.shadow := $mul.i64($i64.shadow,$i91.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 288, 24} true;
  assume {:verifier.code 0} true;
  $i121 := $add.i64($i111,$i120);
  $i121.shadow := $add.i64($i111.shadow,$i120.shadow);
  call {:cexpr "a15"} boogie_si_record_i64($i121);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 289, 30} true;
  assume {:verifier.code 0} true;
  $i122 := $mul.i64($i67,$i91);
  $i122.shadow := $mul.i64($i67.shadow,$i91.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 289, 24} true;
  assume {:verifier.code 0} true;
  $i123 := $add.i64($i113,$i122);
  $i123.shadow := $add.i64($i113.shadow,$i122.shadow);
  call {:cexpr "a25"} boogie_si_record_i64($i123);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 290, 29} true;
  assume {:verifier.code 0} true;
  $i124 := $mul.i64($i43,$i91);
  $i124.shadow := $mul.i64($i43.shadow,$i91.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 290, 24} true;
  assume {:verifier.code 0} true;
  $i125 := $add.i64($i115,$i124);
  $i125.shadow := $add.i64($i115.shadow,$i124.shadow);
  call {:cexpr "a35"} boogie_si_record_i64($i125);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 291, 29} true;
  assume {:verifier.code 0} true;
  $i126 := $mul.i64($i46,$i91);
  $i126.shadow := $mul.i64($i46.shadow,$i91.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 291, 24} true;
  assume {:verifier.code 0} true;
  $i127 := $add.i64($i117,$i126);
  $i127.shadow := $add.i64($i117.shadow,$i126.shadow);
  call {:cexpr "a45"} boogie_si_record_i64($i127);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 292, 30} true;
  assume {:verifier.code 0} true;
  $i128 := $mul.i64($i58,$i92);
  $i128.shadow := $mul.i64($i58.shadow,$i92.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 292, 24} true;
  assume {:verifier.code 0} true;
  $i129 := $add.i64($i119,$i128);
  $i129.shadow := $add.i64($i119.shadow,$i128.shadow);
  call {:cexpr "a06"} boogie_si_record_i64($i129);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 293, 30} true;
  assume {:verifier.code 0} true;
  $i130 := $mul.i64($i61,$i92);
  $i130.shadow := $mul.i64($i61.shadow,$i92.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 293, 24} true;
  assume {:verifier.code 0} true;
  $i131 := $add.i64($i121,$i130);
  $i131.shadow := $add.i64($i121.shadow,$i130.shadow);
  call {:cexpr "a16"} boogie_si_record_i64($i131);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 294, 30} true;
  assume {:verifier.code 0} true;
  $i132 := $mul.i64($i64,$i92);
  $i132.shadow := $mul.i64($i64.shadow,$i92.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 294, 24} true;
  assume {:verifier.code 0} true;
  $i133 := $add.i64($i123,$i132);
  $i133.shadow := $add.i64($i123.shadow,$i132.shadow);
  call {:cexpr "a26"} boogie_si_record_i64($i133);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 295, 30} true;
  assume {:verifier.code 0} true;
  $i134 := $mul.i64($i67,$i92);
  $i134.shadow := $mul.i64($i67.shadow,$i92.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 295, 24} true;
  assume {:verifier.code 0} true;
  $i135 := $add.i64($i125,$i134);
  $i135.shadow := $add.i64($i125.shadow,$i134.shadow);
  call {:cexpr "a36"} boogie_si_record_i64($i135);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 296, 29} true;
  assume {:verifier.code 0} true;
  $i136 := $mul.i64($i43,$i92);
  $i136.shadow := $mul.i64($i43.shadow,$i92.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 296, 24} true;
  assume {:verifier.code 0} true;
  $i137 := $add.i64($i127,$i136);
  $i137.shadow := $add.i64($i127.shadow,$i136.shadow);
  call {:cexpr "a46"} boogie_si_record_i64($i137);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 303, 22} true;
  assume {:verifier.code 0} true;
  $i138 := $lshr.i64($i129,26);
  $i138.shadow := $lshr.i64($i129.shadow,26);
  call {:cexpr "z0"} boogie_si_record_i64($i138);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 304, 22} true;
  assume {:verifier.code 0} true;
  $i139 := $lshr.i64($i135,26);
  $i139.shadow := $lshr.i64($i135.shadow,26);
  call {:cexpr "z1"} boogie_si_record_i64($i139);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 305, 22} true;
  assume {:verifier.code 0} true;
  $i140 := $and.i64($i129,67108863);
  $i140.shadow := $and.i64($i129.shadow,67108863);
  call {:cexpr "x0"} boogie_si_record_i64($i140);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 306, 22} true;
  assume {:verifier.code 0} true;
  $i141 := $and.i64($i135,67108863);
  $i141.shadow := $and.i64($i135.shadow,67108863);
  call {:cexpr "x3"} boogie_si_record_i64($i141);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 307, 22} true;
  assume {:verifier.code 0} true;
  $i142 := $add.i64($i131,$i138);
  $i142.shadow := $add.i64($i131.shadow,$i138.shadow);
  call {:cexpr "x1"} boogie_si_record_i64($i142);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 308, 22} true;
  assume {:verifier.code 0} true;
  $i143 := $add.i64($i137,$i139);
  $i143.shadow := $add.i64($i137.shadow,$i139.shadow);
  call {:cexpr "x4"} boogie_si_record_i64($i143);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 309, 23} true;
  assume {:verifier.code 0} true;
  $i144 := $lshr.i64($i142,26);
  $i144.shadow := $lshr.i64($i142.shadow,26);
  call {:cexpr "z01"} boogie_si_record_i64($i144);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 310, 23} true;
  assume {:verifier.code 0} true;
  $i145 := $lshr.i64($i143,26);
  $i145.shadow := $lshr.i64($i143.shadow,26);
  call {:cexpr "z11"} boogie_si_record_i64($i145);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 311, 22} true;
  assume {:verifier.code 0} true;
  $i146 := $shl.i64($i145,2);
  $i146.shadow := $shl.i64($i145.shadow,2);
  call {:cexpr "t"} boogie_si_record_i64($i146);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 312, 24} true;
  assume {:verifier.code 0} true;
  $i147 := $add.i64($i145,$i146);
  $i147.shadow := $add.i64($i145.shadow,$i146.shadow);
  call {:cexpr "z12"} boogie_si_record_i64($i147);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 313, 23} true;
  assume {:verifier.code 0} true;
  $i148 := $and.i64($i142,67108863);
  $i148.shadow := $and.i64($i142.shadow,67108863);
  call {:cexpr "x11"} boogie_si_record_i64($i148);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 314, 23} true;
  assume {:verifier.code 0} true;
  $i149 := $and.i64($i143,67108863);
  $i149.shadow := $and.i64($i143.shadow,67108863);
  call {:cexpr "x41"} boogie_si_record_i64($i149);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 315, 22} true;
  assume {:verifier.code 0} true;
  $i150 := $add.i64($i133,$i144);
  $i150.shadow := $add.i64($i133.shadow,$i144.shadow);
  call {:cexpr "x2"} boogie_si_record_i64($i150);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 316, 23} true;
  assume {:verifier.code 0} true;
  $i151 := $add.i64($i140,$i147);
  $i151.shadow := $add.i64($i140.shadow,$i147.shadow);
  call {:cexpr "x01"} boogie_si_record_i64($i151);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 317, 23} true;
  assume {:verifier.code 0} true;
  $i152 := $lshr.i64($i150,26);
  $i152.shadow := $lshr.i64($i150.shadow,26);
  call {:cexpr "z02"} boogie_si_record_i64($i152);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 318, 24} true;
  assume {:verifier.code 0} true;
  $i153 := $lshr.i64($i151,26);
  $i153.shadow := $lshr.i64($i151.shadow,26);
  call {:cexpr "z13"} boogie_si_record_i64($i153);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 319, 23} true;
  assume {:verifier.code 0} true;
  $i154 := $and.i64($i150,67108863);
  $i154.shadow := $and.i64($i150.shadow,67108863);
  call {:cexpr "x21"} boogie_si_record_i64($i154);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 320, 24} true;
  assume {:verifier.code 0} true;
  $i155 := $and.i64($i151,67108863);
  $i155.shadow := $and.i64($i151.shadow,67108863);
  call {:cexpr "x02"} boogie_si_record_i64($i155);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 321, 23} true;
  assume {:verifier.code 0} true;
  $i156 := $add.i64($i141,$i152);
  $i156.shadow := $add.i64($i141.shadow,$i152.shadow);
  call {:cexpr "x31"} boogie_si_record_i64($i156);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 322, 24} true;
  assume {:verifier.code 0} true;
  $i157 := $add.i64($i148,$i153);
  $i157.shadow := $add.i64($i148.shadow,$i153.shadow);
  call {:cexpr "x12"} boogie_si_record_i64($i157);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 323, 24} true;
  assume {:verifier.code 0} true;
  $i158 := $lshr.i64($i156,26);
  $i158.shadow := $lshr.i64($i156.shadow,26);
  call {:cexpr "z03"} boogie_si_record_i64($i158);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 324, 24} true;
  assume {:verifier.code 0} true;
  $i159 := $and.i64($i156,67108863);
  $i159.shadow := $and.i64($i156.shadow,67108863);
  call {:cexpr "x32"} boogie_si_record_i64($i159);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 325, 24} true;
  assume {:verifier.code 0} true;
  $i160 := $add.i64($i149,$i158);
  $i160.shadow := $add.i64($i149.shadow,$i158.shadow);
  call {:cexpr "x42"} boogie_si_record_i64($i160);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 331, 5} true;
  assume {:verifier.code 0} true;
  $p161 := $add.ref($p0,$mul.ref(0,8));
  $p161.shadow := $add.ref($p0.shadow,$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 331, 13} true;
  assume {:verifier.code 0} true;
  assert ($p161 == $p161.shadow);
  $M.0 := $store.i64($M.0,$p161,$i155);
  $M.0.shadow := $store.i64($M.0.shadow,$p161.shadow,$i155.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 332, 5} true;
  assume {:verifier.code 0} true;
  $p162 := $add.ref($p0,$mul.ref(1,8));
  $p162.shadow := $add.ref($p0.shadow,$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 332, 13} true;
  assume {:verifier.code 0} true;
  assert ($p162 == $p162.shadow);
  $M.0 := $store.i64($M.0,$p162,$i157);
  $M.0.shadow := $store.i64($M.0.shadow,$p162.shadow,$i157.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 333, 5} true;
  assume {:verifier.code 0} true;
  $p163 := $add.ref($p0,$mul.ref(2,8));
  $p163.shadow := $add.ref($p0.shadow,$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 333, 13} true;
  assume {:verifier.code 0} true;
  assert ($p163 == $p163.shadow);
  $M.0 := $store.i64($M.0,$p163,$i154);
  $M.0.shadow := $store.i64($M.0.shadow,$p163.shadow,$i154.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 334, 5} true;
  assume {:verifier.code 0} true;
  $p164 := $add.ref($p0,$mul.ref(3,8));
  $p164.shadow := $add.ref($p0.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 334, 13} true;
  assume {:verifier.code 0} true;
  assert ($p164 == $p164.shadow);
  $M.0 := $store.i64($M.0,$p164,$i159);
  $M.0.shadow := $store.i64($M.0.shadow,$p164.shadow,$i159.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 335, 5} true;
  assume {:verifier.code 0} true;
  $p165 := $add.ref($p0,$mul.ref(4,8));
  $p165.shadow := $add.ref($p0.shadow,$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 335, 13} true;
  assume {:verifier.code 0} true;
  assert ($p165 == $p165.shadow);
  $M.0 := $store.i64($M.0,$p165,$i160);
  $M.0.shadow := $store.i64($M.0.shadow,$p165.shadow,$i160.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 336, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i10 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 337, 11} true;
  assume {:verifier.code 0} true;
  $i167 := $ugt.i32($i8,0);
  $i167.shadow := $ugt.i32($i8.shadow,0);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 337, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i167} true;
  assert ($i167 == $i167.shadow);
  goto $bb5, $bb6;
$bb4:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 217, 44} true;
  assume {:verifier.code 0} true;
  $i166 := $add.i32($i9,1);
  $i166.shadow := $add.i32($i9.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i166);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 217, 3} true;
  assume {:verifier.code 0} true;
  $i9 := $i166;
  $i9.shadow := $i166.shadow;
  goto $bb1;
$bb5:
  assume ($i167 == 1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 339, 31} true;
  assume {:verifier.code 0} true;
  $i168 := $mul.i32($i7,16);
  $i168.shadow := $mul.i32($i7.shadow,16);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 339, 26} true;
  assume {:verifier.code 0} true;
  $i169 := $zext.i32.i64($i168);
  $i169.shadow := $zext.i32.i64($i168.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 339, 26} true;
  assume {:verifier.code 0} true;
  $p170 := $add.ref($p2,$mul.ref($i169,1));
  $p170.shadow := $add.ref($p2.shadow,$mul.ref($i169.shadow,1));
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 340, 14} true;
  assume {:verifier.code 0} true;
  $p171 := $bitcast.ref.ref($p4);
  $p171.shadow := $bitcast.ref.ref($p4.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 340, 14} true;
  assume {:verifier.code 0} true;
  assert ($p171 == $p171.shadow);
  call $M.4, $M.4.shadow := $memset.i8($M.4, $M.4.shadow, $p171, $p171.shadow, 0, 0, 40, 40, false, false);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 341, 13} true;
  assume {:verifier.code 0} true;
  $p172 := $bitcast.ref.ref($p5);
  $p172.shadow := $bitcast.ref.ref($p5.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 341, 13} true;
  assume {:verifier.code 0} true;
  assert ($p172 == $p172.shadow);
  call $M.1, $M.1.shadow := $memset.i8($M.1, $M.1.shadow, $p172, $p172.shadow, 0, 0, 16, 16, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 342, 5} true;
  assume {:verifier.code 0} true;
  $p173 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(0,1));
  $p173.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 342, 23} true;
  assume {:verifier.code 0} true;
  $i174 := $zext.i32.i64($i8);
  $i174.shadow := $zext.i32.i64($i8.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 342, 27} true;
  assume {:verifier.code 0} true;
  $i175 := $mul.i64($i174,1);
  $i175.shadow := $mul.i64($i174.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 342, 5} true;
  assume {:verifier.code 0} true;
  assert ($p173 == $p173.shadow);
  assert ($p170 == $p170.shadow);
  assert ($i175 == $i175.shadow);
  call $M.1, $M.1.shadow := $memcpy.i8($M.1, $M.1.shadow, $M.1, $M.1.shadow, $p173, $p173.shadow, $p170, $p170.shadow, $i175, $i175.shadow, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 343, 19} true;
  assume {:verifier.code 0} true;
  $p176 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(0,1));
  $p176.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 343, 19} true;
  assume {:verifier.code 0} true;
  call $i177, $i177.shadow := load64($p176, $p176.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 343, 19} true;
  assume {:verifier.code 0} true;
  call $i178, $i178.shadow := __uint64_identity($i177, $i177.shadow);
  call {:cexpr "u0"} boogie_si_record_i64($i178);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 345, 18} true;
  assume {:verifier.code 0} true;
  $p179 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(0,1));
  $p179.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  $p180 := $add.ref($add.ref($p5,$mul.ref(0,16)),$mul.ref(8,1));
  $p180.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,16)),$mul.ref(8,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 345, 18} true;
  assume {:verifier.code 0} true;
  call $i181, $i181.shadow := load64($p180, $p180.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 345, 18} true;
  assume {:verifier.code 0} true;
  call $i182, $i182.shadow := __uint64_identity($i181, $i181.shadow);
  call {:cexpr "u"} boogie_si_record_i64($i182);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 349, 24} true;
  assume {:verifier.code 0} true;
  $i183 := $and.i64($i178,67108863);
  $i183.shadow := $and.i64($i178.shadow,67108863);
  call {:cexpr "f010"} boogie_si_record_i64($i183);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 350, 24} true;
  assume {:verifier.code 0} true;
  $i184 := $lshr.i64($i178,26);
  $i184.shadow := $lshr.i64($i178.shadow,26);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 350, 41} true;
  assume {:verifier.code 0} true;
  $i185 := $and.i64($i184,67108863);
  $i185.shadow := $and.i64($i184.shadow,67108863);
  call {:cexpr "f110"} boogie_si_record_i64($i185);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 351, 23} true;
  assume {:verifier.code 0} true;
  $i186 := $lshr.i64($i178,52);
  $i186.shadow := $lshr.i64($i178.shadow,52);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 351, 46} true;
  assume {:verifier.code 0} true;
  $i187 := $and.i64($i182,16383);
  $i187.shadow := $and.i64($i182.shadow,16383);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 351, 67} true;
  assume {:verifier.code 0} true;
  $i188 := $shl.i64($i187,12);
  $i188.shadow := $shl.i64($i187.shadow,12);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 351, 40} true;
  assume {:verifier.code 0} true;
  $i189 := $or.i64($i186,$i188);
  $i189.shadow := $or.i64($i186.shadow,$i188.shadow);
  call {:cexpr "f20"} boogie_si_record_i64($i189);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 352, 23} true;
  assume {:verifier.code 0} true;
  $i190 := $lshr.i64($i182,14);
  $i190.shadow := $lshr.i64($i182.shadow,14);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 352, 40} true;
  assume {:verifier.code 0} true;
  $i191 := $and.i64($i190,67108863);
  $i191.shadow := $and.i64($i190.shadow,67108863);
  call {:cexpr "f30"} boogie_si_record_i64($i191);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 353, 23} true;
  assume {:verifier.code 0} true;
  $i192 := $lshr.i64($i182,40);
  $i192.shadow := $lshr.i64($i182.shadow,40);
  call {:cexpr "f40"} boogie_si_record_i64($i192);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 359, 5} true;
  assume {:verifier.code 0} true;
  $p193 := $add.ref($add.ref($p4,$mul.ref(0,40)),$mul.ref(0,8));
  $p193.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,40)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 359, 11} true;
  assume {:verifier.code 0} true;
  assert ($p193 == $p193.shadow);
  $M.4 := $store.i64($M.4,$p193,$i183);
  $M.4.shadow := $store.i64($M.4.shadow,$p193.shadow,$i183.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 360, 5} true;
  assume {:verifier.code 0} true;
  $p194 := $add.ref($add.ref($p4,$mul.ref(0,40)),$mul.ref(1,8));
  $p194.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,40)),$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 360, 11} true;
  assume {:verifier.code 0} true;
  assert ($p194 == $p194.shadow);
  $M.4 := $store.i64($M.4,$p194,$i185);
  $M.4.shadow := $store.i64($M.4.shadow,$p194.shadow,$i185.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 361, 5} true;
  assume {:verifier.code 0} true;
  $p195 := $add.ref($add.ref($p4,$mul.ref(0,40)),$mul.ref(2,8));
  $p195.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,40)),$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 361, 11} true;
  assume {:verifier.code 0} true;
  assert ($p195 == $p195.shadow);
  $M.4 := $store.i64($M.4,$p195,$i189);
  $M.4.shadow := $store.i64($M.4.shadow,$p195.shadow,$i189.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 362, 5} true;
  assume {:verifier.code 0} true;
  $p196 := $add.ref($add.ref($p4,$mul.ref(0,40)),$mul.ref(3,8));
  $p196.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,40)),$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 362, 11} true;
  assume {:verifier.code 0} true;
  assert ($p196 == $p196.shadow);
  $M.4 := $store.i64($M.4,$p196,$i191);
  $M.4.shadow := $store.i64($M.4.shadow,$p196.shadow,$i191.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 363, 5} true;
  assume {:verifier.code 0} true;
  $p197 := $add.ref($add.ref($p4,$mul.ref(0,40)),$mul.ref(4,8));
  $p197.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,40)),$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 363, 11} true;
  assume {:verifier.code 0} true;
  assert ($p197 == $p197.shadow);
  $M.4 := $store.i64($M.4,$p197,$i192);
  $M.4.shadow := $store.i64($M.4.shadow,$p197.shadow,$i192.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 364, 38} true;
  assume {:verifier.code 0} true;
  $i198 := $mul.i32($i8,8);
  $i198.shadow := $mul.i32($i8.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 364, 53} true;
  assume {:verifier.code 0} true;
  $i199 := $urem.i32($i198,26);
  $i199.shadow := $urem.i32($i198.shadow,26);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 364, 31} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i201 := $shl.i64(1,$i200);
  $i201.shadow := $shl.i64(1,$i200.shadow);
  call {:cexpr "b"} boogie_si_record_i64($i201);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 366, 25} true;
  assume {:verifier.code 0} true;
  $i202 := $mul.i32($i8,8);
  $i202.shadow := $mul.i32($i8.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 366, 40} true;
  assume {:verifier.code 0} true;
  $i203 := $udiv.i32($i202,26);
  $i203.shadow := $udiv.i32($i202.shadow,26);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 366, 19} true;
  assume {:verifier.code 0} true;
  $i204 := $zext.i32.i64($i203);
  $i204.shadow := $zext.i32.i64($i203.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 366, 19} true;
  assume {:verifier.code 0} true;
  $p205 := $add.ref($add.ref($p4,$mul.ref(0,40)),$mul.ref($i204,8));
  $p205.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,40)),$mul.ref($i204.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 366, 19} true;
  assume {:verifier.code 0} true;
  assert ($p205 == $p205.shadow);
  $i206 := $load.i64($M.4,$p205);
  $i206.shadow := $load.i64($M.4.shadow,$p205.shadow);
  call {:cexpr "fi"} boogie_si_record_i64($i206);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 367, 48} true;
  assume {:verifier.code 0} true;
  $i207 := $or.i64($i206,$i201);
  $i207.shadow := $or.i64($i206.shadow,$i201.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 367, 11} true;
  assume {:verifier.code 0} true;
  $i208 := $mul.i32($i8,8);
  $i208.shadow := $mul.i32($i8.shadow,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 367, 26} true;
  assume {:verifier.code 0} true;
  $i209 := $udiv.i32($i208,26);
  $i209.shadow := $udiv.i32($i208.shadow,26);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 367, 5} true;
  assume {:verifier.code 0} true;
  $i210 := $zext.i32.i64($i209);
  $i210.shadow := $zext.i32.i64($i209.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 367, 5} true;
  assume {:verifier.code 0} true;
  $p211 := $add.ref($add.ref($p4,$mul.ref(0,40)),$mul.ref($i210,8));
  $p211.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,40)),$mul.ref($i210.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 367, 43} true;
  assume {:verifier.code 0} true;
  assert ($p211 == $p211.shadow);
  $M.4 := $store.i64($M.4,$p211,$i207);
  $M.4.shadow := $store.i64($M.4.shadow,$p211.shadow,$i207.shadow);
  $i212 := $add.i64(5,5);
  $i212.shadow := $add.i64(5,5);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 369, 24} true;
  assume {:verifier.code 0} true;
  $p213 := $add.ref($p0,$mul.ref($i212,8));
  $p213.shadow := $add.ref($p0.shadow,$mul.ref($i212.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 370, 19} true;
  assume {:verifier.code 0} true;
  $p214 := $add.ref($p0,$mul.ref(5,8));
  $p214.shadow := $add.ref($p0.shadow,$mul.ref(5,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 370, 19} true;
  assume {:verifier.code 0} true;
  assert ($p214 == $p214.shadow);
  $i215 := $load.i64($M.0,$p214);
  $i215.shadow := $load.i64($M.0.shadow,$p214.shadow);
  call {:cexpr "r0"} boogie_si_record_i64($i215);
  $i216 := $add.i64(5,1);
  $i216.shadow := $add.i64(5,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 371, 19} true;
  assume {:verifier.code 0} true;
  $p217 := $add.ref($p0,$mul.ref($i216,8));
  $p217.shadow := $add.ref($p0.shadow,$mul.ref($i216.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 371, 19} true;
  assume {:verifier.code 0} true;
  assert ($p217 == $p217.shadow);
  $i218 := $load.i64($M.0,$p217);
  $i218.shadow := $load.i64($M.0.shadow,$p217.shadow);
  call {:cexpr "r1"} boogie_si_record_i64($i218);
  $i219 := $add.i64(5,2);
  $i219.shadow := $add.i64(5,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 372, 19} true;
  assume {:verifier.code 0} true;
  $p220 := $add.ref($p0,$mul.ref($i219,8));
  $p220.shadow := $add.ref($p0.shadow,$mul.ref($i219.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 372, 19} true;
  assume {:verifier.code 0} true;
  assert ($p220 == $p220.shadow);
  $i221 := $load.i64($M.0,$p220);
  $i221.shadow := $load.i64($M.0.shadow,$p220.shadow);
  call {:cexpr "r2"} boogie_si_record_i64($i221);
  $i222 := $add.i64(5,3);
  $i222.shadow := $add.i64(5,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 373, 19} true;
  assume {:verifier.code 0} true;
  $p223 := $add.ref($p0,$mul.ref($i222,8));
  $p223.shadow := $add.ref($p0.shadow,$mul.ref($i222.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 373, 19} true;
  assume {:verifier.code 0} true;
  assert ($p223 == $p223.shadow);
  $i224 := $load.i64($M.0,$p223);
  $i224.shadow := $load.i64($M.0.shadow,$p223.shadow);
  call {:cexpr "r3"} boogie_si_record_i64($i224);
  $i225 := $add.i64(5,4);
  $i225.shadow := $add.i64(5,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 374, 19} true;
  assume {:verifier.code 0} true;
  $p226 := $add.ref($p0,$mul.ref($i225,8));
  $p226.shadow := $add.ref($p0.shadow,$mul.ref($i225.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 374, 19} true;
  assume {:verifier.code 0} true;
  assert ($p226 == $p226.shadow);
  $i227 := $load.i64($M.0,$p226);
  $i227.shadow := $load.i64($M.0.shadow,$p226.shadow);
  call {:cexpr "r4"} boogie_si_record_i64($i227);
  $i228 := $add.i64($i212,1);
  $i228.shadow := $add.i64($i212.shadow,1);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 375, 20} true;
  assume {:verifier.code 0} true;
  $p229 := $add.ref($p0,$mul.ref($i228,8));
  $p229.shadow := $add.ref($p0.shadow,$mul.ref($i228.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 375, 20} true;
  assume {:verifier.code 0} true;
  assert ($p229 == $p229.shadow);
  $i230 := $load.i64($M.0,$p229);
  $i230.shadow := $load.i64($M.0.shadow,$p229.shadow);
  call {:cexpr "r51"} boogie_si_record_i64($i230);
  $i231 := $add.i64($i212,2);
  $i231.shadow := $add.i64($i212.shadow,2);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 376, 20} true;
  assume {:verifier.code 0} true;
  $p232 := $add.ref($p0,$mul.ref($i231,8));
  $p232.shadow := $add.ref($p0.shadow,$mul.ref($i231.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 376, 20} true;
  assume {:verifier.code 0} true;
  assert ($p232 == $p232.shadow);
  $i233 := $load.i64($M.0,$p232);
  $i233.shadow := $load.i64($M.0.shadow,$p232.shadow);
  call {:cexpr "r52"} boogie_si_record_i64($i233);
  $i234 := $add.i64($i212,3);
  $i234.shadow := $add.i64($i212.shadow,3);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 377, 20} true;
  assume {:verifier.code 0} true;
  $p235 := $add.ref($p0,$mul.ref($i234,8));
  $p235.shadow := $add.ref($p0.shadow,$mul.ref($i234.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 377, 20} true;
  assume {:verifier.code 0} true;
  assert ($p235 == $p235.shadow);
  $i236 := $load.i64($M.0,$p235);
  $i236.shadow := $load.i64($M.0.shadow,$p235.shadow);
  call {:cexpr "r53"} boogie_si_record_i64($i236);
  $i237 := $add.i64($i212,4);
  $i237.shadow := $add.i64($i212.shadow,4);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 378, 20} true;
  assume {:verifier.code 0} true;
  $p238 := $add.ref($p0,$mul.ref($i237,8));
  $p238.shadow := $add.ref($p0.shadow,$mul.ref($i237.shadow,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 378, 20} true;
  assume {:verifier.code 0} true;
  assert ($p238 == $p238.shadow);
  $i239 := $load.i64($M.0,$p238);
  $i239.shadow := $load.i64($M.0.shadow,$p238.shadow);
  call {:cexpr "r54"} boogie_si_record_i64($i239);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 379, 20} true;
  assume {:verifier.code 0} true;
  $p240 := $add.ref($add.ref($p4,$mul.ref(0,40)),$mul.ref(0,8));
  $p240.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,40)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 379, 20} true;
  assume {:verifier.code 0} true;
  assert ($p240 == $p240.shadow);
  $i241 := $load.i64($M.4,$p240);
  $i241.shadow := $load.i64($M.4.shadow,$p240.shadow);
  call {:cexpr "f10"} boogie_si_record_i64($i241);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 380, 20} true;
  assume {:verifier.code 0} true;
  $p242 := $add.ref($add.ref($p4,$mul.ref(0,40)),$mul.ref(1,8));
  $p242.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,40)),$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 380, 20} true;
  assume {:verifier.code 0} true;
  assert ($p242 == $p242.shadow);
  $i243 := $load.i64($M.4,$p242);
  $i243.shadow := $load.i64($M.4.shadow,$p242.shadow);
  call {:cexpr "f11"} boogie_si_record_i64($i243);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 381, 20} true;
  assume {:verifier.code 0} true;
  $p244 := $add.ref($add.ref($p4,$mul.ref(0,40)),$mul.ref(2,8));
  $p244.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,40)),$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 381, 20} true;
  assume {:verifier.code 0} true;
  assert ($p244 == $p244.shadow);
  $i245 := $load.i64($M.4,$p244);
  $i245.shadow := $load.i64($M.4.shadow,$p244.shadow);
  call {:cexpr "f12"} boogie_si_record_i64($i245);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 382, 20} true;
  assume {:verifier.code 0} true;
  $p246 := $add.ref($add.ref($p4,$mul.ref(0,40)),$mul.ref(3,8));
  $p246.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,40)),$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 382, 20} true;
  assume {:verifier.code 0} true;
  assert ($p246 == $p246.shadow);
  $i247 := $load.i64($M.4,$p246);
  $i247.shadow := $load.i64($M.4.shadow,$p246.shadow);
  call {:cexpr "f13"} boogie_si_record_i64($i247);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 383, 20} true;
  assume {:verifier.code 0} true;
  $p248 := $add.ref($add.ref($p4,$mul.ref(0,40)),$mul.ref(4,8));
  $p248.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,40)),$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 383, 20} true;
  assume {:verifier.code 0} true;
  assert ($p248 == $p248.shadow);
  $i249 := $load.i64($M.4,$p248);
  $i249.shadow := $load.i64($M.4.shadow,$p248.shadow);
  call {:cexpr "f14"} boogie_si_record_i64($i249);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 384, 19} true;
  assume {:verifier.code 0} true;
  $p250 := $add.ref($p0,$mul.ref(0,8));
  $p250.shadow := $add.ref($p0.shadow,$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 384, 19} true;
  assume {:verifier.code 0} true;
  assert ($p250 == $p250.shadow);
  $i251 := $load.i64($M.0,$p250);
  $i251.shadow := $load.i64($M.0.shadow,$p250.shadow);
  call {:cexpr "a0"} boogie_si_record_i64($i251);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 385, 19} true;
  assume {:verifier.code 0} true;
  $p252 := $add.ref($p0,$mul.ref(1,8));
  $p252.shadow := $add.ref($p0.shadow,$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 385, 19} true;
  assume {:verifier.code 0} true;
  assert ($p252 == $p252.shadow);
  $i253 := $load.i64($M.0,$p252);
  $i253.shadow := $load.i64($M.0.shadow,$p252.shadow);
  call {:cexpr "a1"} boogie_si_record_i64($i253);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 386, 19} true;
  assume {:verifier.code 0} true;
  $p254 := $add.ref($p0,$mul.ref(2,8));
  $p254.shadow := $add.ref($p0.shadow,$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 386, 19} true;
  assume {:verifier.code 0} true;
  assert ($p254 == $p254.shadow);
  $i255 := $load.i64($M.0,$p254);
  $i255.shadow := $load.i64($M.0.shadow,$p254.shadow);
  call {:cexpr "a2"} boogie_si_record_i64($i255);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 387, 19} true;
  assume {:verifier.code 0} true;
  $p256 := $add.ref($p0,$mul.ref(3,8));
  $p256.shadow := $add.ref($p0.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 387, 19} true;
  assume {:verifier.code 0} true;
  assert ($p256 == $p256.shadow);
  $i257 := $load.i64($M.0,$p256);
  $i257.shadow := $load.i64($M.0.shadow,$p256.shadow);
  call {:cexpr "a3"} boogie_si_record_i64($i257);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 388, 19} true;
  assume {:verifier.code 0} true;
  $p258 := $add.ref($p0,$mul.ref(4,8));
  $p258.shadow := $add.ref($p0.shadow,$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 388, 19} true;
  assume {:verifier.code 0} true;
  assert ($p258 == $p258.shadow);
  $i259 := $load.i64($M.0,$p258);
  $i259.shadow := $load.i64($M.0.shadow,$p258.shadow);
  call {:cexpr "a4"} boogie_si_record_i64($i259);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 389, 23} true;
  assume {:verifier.code 0} true;
  $i260 := $add.i64($i251,$i241);
  $i260.shadow := $add.i64($i251.shadow,$i241.shadow);
  call {:cexpr "a01"} boogie_si_record_i64($i260);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 390, 23} true;
  assume {:verifier.code 0} true;
  $i261 := $add.i64($i253,$i243);
  $i261.shadow := $add.i64($i253.shadow,$i243.shadow);
  call {:cexpr "a11"} boogie_si_record_i64($i261);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 391, 23} true;
  assume {:verifier.code 0} true;
  $i262 := $add.i64($i255,$i245);
  $i262.shadow := $add.i64($i255.shadow,$i245.shadow);
  call {:cexpr "a21"} boogie_si_record_i64($i262);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 392, 23} true;
  assume {:verifier.code 0} true;
  $i263 := $add.i64($i257,$i247);
  $i263.shadow := $add.i64($i257.shadow,$i247.shadow);
  call {:cexpr "a31"} boogie_si_record_i64($i263);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 393, 23} true;
  assume {:verifier.code 0} true;
  $i264 := $add.i64($i259,$i249);
  $i264.shadow := $add.i64($i259.shadow,$i249.shadow);
  call {:cexpr "a41"} boogie_si_record_i64($i264);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 394, 23} true;
  assume {:verifier.code 0} true;
  $i265 := $mul.i64($i215,$i260);
  $i265.shadow := $mul.i64($i215.shadow,$i260.shadow);
  call {:cexpr "a02"} boogie_si_record_i64($i265);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 395, 23} true;
  assume {:verifier.code 0} true;
  $i266 := $mul.i64($i218,$i260);
  $i266.shadow := $mul.i64($i218.shadow,$i260.shadow);
  call {:cexpr "a12"} boogie_si_record_i64($i266);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 396, 23} true;
  assume {:verifier.code 0} true;
  $i267 := $mul.i64($i221,$i260);
  $i267.shadow := $mul.i64($i221.shadow,$i260.shadow);
  call {:cexpr "a22"} boogie_si_record_i64($i267);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 397, 23} true;
  assume {:verifier.code 0} true;
  $i268 := $mul.i64($i224,$i260);
  $i268.shadow := $mul.i64($i224.shadow,$i260.shadow);
  call {:cexpr "a32"} boogie_si_record_i64($i268);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 398, 23} true;
  assume {:verifier.code 0} true;
  $i269 := $mul.i64($i227,$i260);
  $i269.shadow := $mul.i64($i227.shadow,$i260.shadow);
  call {:cexpr "a42"} boogie_si_record_i64($i269);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 399, 30} true;
  assume {:verifier.code 0} true;
  $i270 := $mul.i64($i239,$i261);
  $i270.shadow := $mul.i64($i239.shadow,$i261.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 399, 24} true;
  assume {:verifier.code 0} true;
  $i271 := $add.i64($i265,$i270);
  $i271.shadow := $add.i64($i265.shadow,$i270.shadow);
  call {:cexpr "a03"} boogie_si_record_i64($i271);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 400, 29} true;
  assume {:verifier.code 0} true;
  $i272 := $mul.i64($i215,$i261);
  $i272.shadow := $mul.i64($i215.shadow,$i261.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 400, 24} true;
  assume {:verifier.code 0} true;
  $i273 := $add.i64($i266,$i272);
  $i273.shadow := $add.i64($i266.shadow,$i272.shadow);
  call {:cexpr "a13"} boogie_si_record_i64($i273);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 401, 29} true;
  assume {:verifier.code 0} true;
  $i274 := $mul.i64($i218,$i261);
  $i274.shadow := $mul.i64($i218.shadow,$i261.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 401, 24} true;
  assume {:verifier.code 0} true;
  $i275 := $add.i64($i267,$i274);
  $i275.shadow := $add.i64($i267.shadow,$i274.shadow);
  call {:cexpr "a23"} boogie_si_record_i64($i275);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 402, 29} true;
  assume {:verifier.code 0} true;
  $i276 := $mul.i64($i221,$i261);
  $i276.shadow := $mul.i64($i221.shadow,$i261.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 402, 24} true;
  assume {:verifier.code 0} true;
  $i277 := $add.i64($i268,$i276);
  $i277.shadow := $add.i64($i268.shadow,$i276.shadow);
  call {:cexpr "a33"} boogie_si_record_i64($i277);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 403, 29} true;
  assume {:verifier.code 0} true;
  $i278 := $mul.i64($i224,$i261);
  $i278.shadow := $mul.i64($i224.shadow,$i261.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 403, 24} true;
  assume {:verifier.code 0} true;
  $i279 := $add.i64($i269,$i278);
  $i279.shadow := $add.i64($i269.shadow,$i278.shadow);
  call {:cexpr "a43"} boogie_si_record_i64($i279);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 404, 30} true;
  assume {:verifier.code 0} true;
  $i280 := $mul.i64($i236,$i262);
  $i280.shadow := $mul.i64($i236.shadow,$i262.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 404, 24} true;
  assume {:verifier.code 0} true;
  $i281 := $add.i64($i271,$i280);
  $i281.shadow := $add.i64($i271.shadow,$i280.shadow);
  call {:cexpr "a04"} boogie_si_record_i64($i281);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 405, 30} true;
  assume {:verifier.code 0} true;
  $i282 := $mul.i64($i239,$i262);
  $i282.shadow := $mul.i64($i239.shadow,$i262.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 405, 24} true;
  assume {:verifier.code 0} true;
  $i283 := $add.i64($i273,$i282);
  $i283.shadow := $add.i64($i273.shadow,$i282.shadow);
  call {:cexpr "a14"} boogie_si_record_i64($i283);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 406, 29} true;
  assume {:verifier.code 0} true;
  $i284 := $mul.i64($i215,$i262);
  $i284.shadow := $mul.i64($i215.shadow,$i262.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 406, 24} true;
  assume {:verifier.code 0} true;
  $i285 := $add.i64($i275,$i284);
  $i285.shadow := $add.i64($i275.shadow,$i284.shadow);
  call {:cexpr "a24"} boogie_si_record_i64($i285);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 407, 29} true;
  assume {:verifier.code 0} true;
  $i286 := $mul.i64($i218,$i262);
  $i286.shadow := $mul.i64($i218.shadow,$i262.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 407, 24} true;
  assume {:verifier.code 0} true;
  $i287 := $add.i64($i277,$i286);
  $i287.shadow := $add.i64($i277.shadow,$i286.shadow);
  call {:cexpr "a34"} boogie_si_record_i64($i287);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 408, 29} true;
  assume {:verifier.code 0} true;
  $i288 := $mul.i64($i221,$i262);
  $i288.shadow := $mul.i64($i221.shadow,$i262.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 408, 24} true;
  assume {:verifier.code 0} true;
  $i289 := $add.i64($i279,$i288);
  $i289.shadow := $add.i64($i279.shadow,$i288.shadow);
  call {:cexpr "a44"} boogie_si_record_i64($i289);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 409, 30} true;
  assume {:verifier.code 0} true;
  $i290 := $mul.i64($i233,$i263);
  $i290.shadow := $mul.i64($i233.shadow,$i263.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 409, 24} true;
  assume {:verifier.code 0} true;
  $i291 := $add.i64($i281,$i290);
  $i291.shadow := $add.i64($i281.shadow,$i290.shadow);
  call {:cexpr "a05"} boogie_si_record_i64($i291);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 410, 30} true;
  assume {:verifier.code 0} true;
  $i292 := $mul.i64($i236,$i263);
  $i292.shadow := $mul.i64($i236.shadow,$i263.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 410, 24} true;
  assume {:verifier.code 0} true;
  $i293 := $add.i64($i283,$i292);
  $i293.shadow := $add.i64($i283.shadow,$i292.shadow);
  call {:cexpr "a15"} boogie_si_record_i64($i293);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 411, 30} true;
  assume {:verifier.code 0} true;
  $i294 := $mul.i64($i239,$i263);
  $i294.shadow := $mul.i64($i239.shadow,$i263.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 411, 24} true;
  assume {:verifier.code 0} true;
  $i295 := $add.i64($i285,$i294);
  $i295.shadow := $add.i64($i285.shadow,$i294.shadow);
  call {:cexpr "a25"} boogie_si_record_i64($i295);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 412, 29} true;
  assume {:verifier.code 0} true;
  $i296 := $mul.i64($i215,$i263);
  $i296.shadow := $mul.i64($i215.shadow,$i263.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 412, 24} true;
  assume {:verifier.code 0} true;
  $i297 := $add.i64($i287,$i296);
  $i297.shadow := $add.i64($i287.shadow,$i296.shadow);
  call {:cexpr "a35"} boogie_si_record_i64($i297);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 413, 29} true;
  assume {:verifier.code 0} true;
  $i298 := $mul.i64($i218,$i263);
  $i298.shadow := $mul.i64($i218.shadow,$i263.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 413, 24} true;
  assume {:verifier.code 0} true;
  $i299 := $add.i64($i289,$i298);
  $i299.shadow := $add.i64($i289.shadow,$i298.shadow);
  call {:cexpr "a45"} boogie_si_record_i64($i299);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 414, 30} true;
  assume {:verifier.code 0} true;
  $i300 := $mul.i64($i230,$i264);
  $i300.shadow := $mul.i64($i230.shadow,$i264.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 414, 24} true;
  assume {:verifier.code 0} true;
  $i301 := $add.i64($i291,$i300);
  $i301.shadow := $add.i64($i291.shadow,$i300.shadow);
  call {:cexpr "a06"} boogie_si_record_i64($i301);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 415, 30} true;
  assume {:verifier.code 0} true;
  $i302 := $mul.i64($i233,$i264);
  $i302.shadow := $mul.i64($i233.shadow,$i264.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 415, 24} true;
  assume {:verifier.code 0} true;
  $i303 := $add.i64($i293,$i302);
  $i303.shadow := $add.i64($i293.shadow,$i302.shadow);
  call {:cexpr "a16"} boogie_si_record_i64($i303);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 416, 30} true;
  assume {:verifier.code 0} true;
  $i304 := $mul.i64($i236,$i264);
  $i304.shadow := $mul.i64($i236.shadow,$i264.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 416, 24} true;
  assume {:verifier.code 0} true;
  $i305 := $add.i64($i295,$i304);
  $i305.shadow := $add.i64($i295.shadow,$i304.shadow);
  call {:cexpr "a26"} boogie_si_record_i64($i305);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 417, 30} true;
  assume {:verifier.code 0} true;
  $i306 := $mul.i64($i239,$i264);
  $i306.shadow := $mul.i64($i239.shadow,$i264.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 417, 24} true;
  assume {:verifier.code 0} true;
  $i307 := $add.i64($i297,$i306);
  $i307.shadow := $add.i64($i297.shadow,$i306.shadow);
  call {:cexpr "a36"} boogie_si_record_i64($i307);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 418, 29} true;
  assume {:verifier.code 0} true;
  $i308 := $mul.i64($i215,$i264);
  $i308.shadow := $mul.i64($i215.shadow,$i264.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 418, 24} true;
  assume {:verifier.code 0} true;
  $i309 := $add.i64($i299,$i308);
  $i309.shadow := $add.i64($i299.shadow,$i308.shadow);
  call {:cexpr "a46"} boogie_si_record_i64($i309);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 425, 22} true;
  assume {:verifier.code 0} true;
  $i310 := $lshr.i64($i301,26);
  $i310.shadow := $lshr.i64($i301.shadow,26);
  call {:cexpr "z0"} boogie_si_record_i64($i310);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 426, 22} true;
  assume {:verifier.code 0} true;
  $i311 := $lshr.i64($i307,26);
  $i311.shadow := $lshr.i64($i307.shadow,26);
  call {:cexpr "z1"} boogie_si_record_i64($i311);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 427, 22} true;
  assume {:verifier.code 0} true;
  $i312 := $and.i64($i301,67108863);
  $i312.shadow := $and.i64($i301.shadow,67108863);
  call {:cexpr "x0"} boogie_si_record_i64($i312);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 428, 22} true;
  assume {:verifier.code 0} true;
  $i313 := $and.i64($i307,67108863);
  $i313.shadow := $and.i64($i307.shadow,67108863);
  call {:cexpr "x3"} boogie_si_record_i64($i313);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 429, 22} true;
  assume {:verifier.code 0} true;
  $i314 := $add.i64($i303,$i310);
  $i314.shadow := $add.i64($i303.shadow,$i310.shadow);
  call {:cexpr "x1"} boogie_si_record_i64($i314);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 430, 22} true;
  assume {:verifier.code 0} true;
  $i315 := $add.i64($i309,$i311);
  $i315.shadow := $add.i64($i309.shadow,$i311.shadow);
  call {:cexpr "x4"} boogie_si_record_i64($i315);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 431, 23} true;
  assume {:verifier.code 0} true;
  $i316 := $lshr.i64($i314,26);
  $i316.shadow := $lshr.i64($i314.shadow,26);
  call {:cexpr "z01"} boogie_si_record_i64($i316);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 432, 23} true;
  assume {:verifier.code 0} true;
  $i317 := $lshr.i64($i315,26);
  $i317.shadow := $lshr.i64($i315.shadow,26);
  call {:cexpr "z11"} boogie_si_record_i64($i317);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 433, 22} true;
  assume {:verifier.code 0} true;
  $i318 := $shl.i64($i317,2);
  $i318.shadow := $shl.i64($i317.shadow,2);
  call {:cexpr "t"} boogie_si_record_i64($i318);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 434, 24} true;
  assume {:verifier.code 0} true;
  $i319 := $add.i64($i317,$i318);
  $i319.shadow := $add.i64($i317.shadow,$i318.shadow);
  call {:cexpr "z12"} boogie_si_record_i64($i319);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 435, 23} true;
  assume {:verifier.code 0} true;
  $i320 := $and.i64($i314,67108863);
  $i320.shadow := $and.i64($i314.shadow,67108863);
  call {:cexpr "x11"} boogie_si_record_i64($i320);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 436, 23} true;
  assume {:verifier.code 0} true;
  $i321 := $and.i64($i315,67108863);
  $i321.shadow := $and.i64($i315.shadow,67108863);
  call {:cexpr "x41"} boogie_si_record_i64($i321);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 437, 22} true;
  assume {:verifier.code 0} true;
  $i322 := $add.i64($i305,$i316);
  $i322.shadow := $add.i64($i305.shadow,$i316.shadow);
  call {:cexpr "x2"} boogie_si_record_i64($i322);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 438, 23} true;
  assume {:verifier.code 0} true;
  $i323 := $add.i64($i312,$i319);
  $i323.shadow := $add.i64($i312.shadow,$i319.shadow);
  call {:cexpr "x01"} boogie_si_record_i64($i323);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 439, 23} true;
  assume {:verifier.code 0} true;
  $i324 := $lshr.i64($i322,26);
  $i324.shadow := $lshr.i64($i322.shadow,26);
  call {:cexpr "z02"} boogie_si_record_i64($i324);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 440, 24} true;
  assume {:verifier.code 0} true;
  $i325 := $lshr.i64($i323,26);
  $i325.shadow := $lshr.i64($i323.shadow,26);
  call {:cexpr "z13"} boogie_si_record_i64($i325);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 441, 23} true;
  assume {:verifier.code 0} true;
  $i326 := $and.i64($i322,67108863);
  $i326.shadow := $and.i64($i322.shadow,67108863);
  call {:cexpr "x21"} boogie_si_record_i64($i326);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 442, 24} true;
  assume {:verifier.code 0} true;
  $i327 := $and.i64($i323,67108863);
  $i327.shadow := $and.i64($i323.shadow,67108863);
  call {:cexpr "x02"} boogie_si_record_i64($i327);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 443, 23} true;
  assume {:verifier.code 0} true;
  $i328 := $add.i64($i313,$i324);
  $i328.shadow := $add.i64($i313.shadow,$i324.shadow);
  call {:cexpr "x31"} boogie_si_record_i64($i328);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 444, 24} true;
  assume {:verifier.code 0} true;
  $i329 := $add.i64($i320,$i325);
  $i329.shadow := $add.i64($i320.shadow,$i325.shadow);
  call {:cexpr "x12"} boogie_si_record_i64($i329);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 445, 24} true;
  assume {:verifier.code 0} true;
  $i330 := $lshr.i64($i328,26);
  $i330.shadow := $lshr.i64($i328.shadow,26);
  call {:cexpr "z03"} boogie_si_record_i64($i330);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 446, 24} true;
  assume {:verifier.code 0} true;
  $i331 := $and.i64($i328,67108863);
  $i331.shadow := $and.i64($i328.shadow,67108863);
  call {:cexpr "x32"} boogie_si_record_i64($i331);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 447, 24} true;
  assume {:verifier.code 0} true;
  $i332 := $add.i64($i321,$i330);
  $i332.shadow := $add.i64($i321.shadow,$i330.shadow);
  call {:cexpr "x42"} boogie_si_record_i64($i332);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 453, 5} true;
  assume {:verifier.code 0} true;
  $p333 := $add.ref($p0,$mul.ref(0,8));
  $p333.shadow := $add.ref($p0.shadow,$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 453, 13} true;
  assume {:verifier.code 0} true;
  assert ($p333 == $p333.shadow);
  $M.0 := $store.i64($M.0,$p333,$i327);
  $M.0.shadow := $store.i64($M.0.shadow,$p333.shadow,$i327.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 454, 5} true;
  assume {:verifier.code 0} true;
  $p334 := $add.ref($p0,$mul.ref(1,8));
  $p334.shadow := $add.ref($p0.shadow,$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 454, 13} true;
  assume {:verifier.code 0} true;
  assert ($p334 == $p334.shadow);
  $M.0 := $store.i64($M.0,$p334,$i329);
  $M.0.shadow := $store.i64($M.0.shadow,$p334.shadow,$i329.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 455, 5} true;
  assume {:verifier.code 0} true;
  $p335 := $add.ref($p0,$mul.ref(2,8));
  $p335.shadow := $add.ref($p0.shadow,$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 455, 13} true;
  assume {:verifier.code 0} true;
  assert ($p335 == $p335.shadow);
  $M.0 := $store.i64($M.0,$p335,$i326);
  $M.0.shadow := $store.i64($M.0.shadow,$p335.shadow,$i326.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 456, 5} true;
  assume {:verifier.code 0} true;
  $p336 := $add.ref($p0,$mul.ref(3,8));
  $p336.shadow := $add.ref($p0.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 456, 13} true;
  assume {:verifier.code 0} true;
  assert ($p336 == $p336.shadow);
  $M.0 := $store.i64($M.0,$p336,$i331);
  $M.0.shadow := $store.i64($M.0.shadow,$p336.shadow,$i331.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 457, 5} true;
  assume {:verifier.code 0} true;
  $p337 := $add.ref($p0,$mul.ref(4,8));
  $p337.shadow := $add.ref($p0.shadow,$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 457, 13} true;
  assume {:verifier.code 0} true;
  assert ($p337 == $p337.shadow);
  $M.0 := $store.i64($M.0,$p337,$i332);
  $M.0.shadow := $store.i64($M.0.shadow,$p337.shadow,$i332.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 458, 5} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 337, 7} true;
  ...
  goto $bb7;
$bb7:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 460, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const Hacl_Poly1305_32_poly1305_finish: ref;
axiom (Hacl_Poly1305_32_poly1305_finish == $sub.ref(0,9288));
procedure {:inline 1} Hacl_Poly1305_32_poly1305_finish($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
modifies $M.0, $exn;
modifies $M.2;
modifies $M.5, $M.6;
modifies $CurrAddr;
{
  ...
  var $i107.shadow: i64;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 465, 21} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 465, 21} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p1,$mul.ref(16,1));
  $p3.shadow := $add.ref($p1.shadow,$mul.ref(16,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 466, 17} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p2,$mul.ref(0,8));
  $p4.shadow := $add.ref($p2.shadow,$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 466, 17} true;
  assume {:verifier.code 0} true;
  assert ($p4 == $p4.shadow);
  $i5 := $load.i64($M.0,$p4);
  $i5.shadow := $load.i64($M.0.shadow,$p4.shadow);
  call {:cexpr "f0"} boogie_si_record_i64($i5);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 467, 18} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p2,$mul.ref(1,8));
  $p6.shadow := $add.ref($p2.shadow,$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 467, 18} true;
  assume {:verifier.code 0} true;
  assert ($p6 == $p6.shadow);
  $i7 := $load.i64($M.0,$p6);
  $i7.shadow := $load.i64($M.0.shadow,$p6.shadow);
  call {:cexpr "f13"} boogie_si_record_i64($i7);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 468, 18} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p2,$mul.ref(2,8));
  $p8.shadow := $add.ref($p2.shadow,$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 468, 18} true;
  assume {:verifier.code 0} true;
  assert ($p8 == $p8.shadow);
  $i9 := $load.i64($M.0,$p8);
  $i9.shadow := $load.i64($M.0.shadow,$p8.shadow);
  call {:cexpr "f23"} boogie_si_record_i64($i9);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 469, 18} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($p2,$mul.ref(3,8));
  $p10.shadow := $add.ref($p2.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 469, 18} true;
  assume {:verifier.code 0} true;
  assert ($p10 == $p10.shadow);
  $i11 := $load.i64($M.0,$p10);
  $i11.shadow := $load.i64($M.0.shadow,$p10.shadow);
  call {:cexpr "f33"} boogie_si_record_i64($i11);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 470, 18} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p2,$mul.ref(4,8));
  $p12.shadow := $add.ref($p2.shadow,$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 470, 18} true;
  assume {:verifier.code 0} true;
  assert ($p12 == $p12.shadow);
  $i13 := $load.i64($M.0,$p12);
  $i13.shadow := $load.i64($M.0.shadow,$p12.shadow);
  call {:cexpr "f40"} boogie_si_record_i64($i13);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 471, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i64($i5,0);
  $i14.shadow := $add.i64($i5.shadow,0);
  call {:cexpr "l0"} boogie_si_record_i64($i14);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 472, 23} true;
  assume {:verifier.code 0} true;
  $i15 := $and.i64($i14,67108863);
  $i15.shadow := $and.i64($i14.shadow,67108863);
  call {:cexpr "tmp00"} boogie_si_record_i64($i15);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 473, 21} true;
  assume {:verifier.code 0} true;
  $i16 := $lshr.i64($i14,26);
  $i16.shadow := $lshr.i64($i14.shadow,26);
  call {:cexpr "c00"} boogie_si_record_i64($i16);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 474, 21} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i64($i7,$i16);
  $i17.shadow := $add.i64($i7.shadow,$i16.shadow);
  call {:cexpr "l1"} boogie_si_record_i64($i17);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 475, 23} true;
  assume {:verifier.code 0} true;
  $i18 := $and.i64($i17,67108863);
  $i18.shadow := $and.i64($i17.shadow,67108863);
  call {:cexpr "tmp10"} boogie_si_record_i64($i18);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 476, 21} true;
  assume {:verifier.code 0} true;
  $i19 := $lshr.i64($i17,26);
  $i19.shadow := $lshr.i64($i17.shadow,26);
  call {:cexpr "c10"} boogie_si_record_i64($i19);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 477, 21} true;
  assume {:verifier.code 0} true;
  $i20 := $add.i64($i9,$i19);
  $i20.shadow := $add.i64($i9.shadow,$i19.shadow);
  call {:cexpr "l2"} boogie_si_record_i64($i20);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 478, 23} true;
  assume {:verifier.code 0} true;
  $i21 := $and.i64($i20,67108863);
  $i21.shadow := $and.i64($i20.shadow,67108863);
  call {:cexpr "tmp20"} boogie_si_record_i64($i21);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 479, 21} true;
  assume {:verifier.code 0} true;
  $i22 := $lshr.i64($i20,26);
  $i22.shadow := $lshr.i64($i20.shadow,26);
  call {:cexpr "c20"} boogie_si_record_i64($i22);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 480, 21} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i64($i11,$i22);
  $i23.shadow := $add.i64($i11.shadow,$i22.shadow);
  call {:cexpr "l3"} boogie_si_record_i64($i23);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 481, 23} true;
  assume {:verifier.code 0} true;
  $i24 := $and.i64($i23,67108863);
  $i24.shadow := $and.i64($i23.shadow,67108863);
  call {:cexpr "tmp30"} boogie_si_record_i64($i24);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 482, 21} true;
  assume {:verifier.code 0} true;
  $i25 := $lshr.i64($i23,26);
  $i25.shadow := $lshr.i64($i23.shadow,26);
  call {:cexpr "c30"} boogie_si_record_i64($i25);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 483, 21} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i64($i13,$i25);
  $i26.shadow := $add.i64($i13.shadow,$i25.shadow);
  call {:cexpr "l4"} boogie_si_record_i64($i26);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 484, 23} true;
  assume {:verifier.code 0} true;
  $i27 := $and.i64($i26,67108863);
  $i27.shadow := $and.i64($i26.shadow,67108863);
  call {:cexpr "tmp40"} boogie_si_record_i64($i27);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 485, 21} true;
  assume {:verifier.code 0} true;
  $i28 := $lshr.i64($i26,26);
  $i28.shadow := $lshr.i64($i26.shadow,26);
  call {:cexpr "c40"} boogie_si_record_i64($i28);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 486, 31} true;
  assume {:verifier.code 0} true;
  $i29 := $mul.i64($i28,5);
  $i29.shadow := $mul.i64($i28.shadow,5);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 486, 25} true;
  assume {:verifier.code 0} true;
  $i30 := $add.i64($i15,$i29);
  $i30.shadow := $add.i64($i15.shadow,$i29.shadow);
  call {:cexpr "f010"} boogie_si_record_i64($i30);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 491, 21} true;
  assume {:verifier.code 0} true;
  $i31 := $add.i64($i30,0);
  $i31.shadow := $add.i64($i30.shadow,0);
  call {:cexpr "l"} boogie_si_record_i64($i31);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 492, 21} true;
  assume {:verifier.code 0} true;
  $i32 := $and.i64($i31,67108863);
  $i32.shadow := $and.i64($i31.shadow,67108863);
  call {:cexpr "tmp0"} boogie_si_record_i64($i32);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 493, 19} true;
  assume {:verifier.code 0} true;
  $i33 := $lshr.i64($i31,26);
  $i33.shadow := $lshr.i64($i31.shadow,26);
  call {:cexpr "c0"} boogie_si_record_i64($i33);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 494, 22} true;
  assume {:verifier.code 0} true;
  $i34 := $add.i64($i18,$i33);
  $i34.shadow := $add.i64($i18.shadow,$i33.shadow);
  call {:cexpr "l5"} boogie_si_record_i64($i34);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 495, 22} true;
  assume {:verifier.code 0} true;
  $i35 := $and.i64($i34,67108863);
  $i35.shadow := $and.i64($i34.shadow,67108863);
  call {:cexpr "tmp1"} boogie_si_record_i64($i35);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 496, 20} true;
  assume {:verifier.code 0} true;
  $i36 := $lshr.i64($i34,26);
  $i36.shadow := $lshr.i64($i34.shadow,26);
  call {:cexpr "c1"} boogie_si_record_i64($i36);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 497, 22} true;
  assume {:verifier.code 0} true;
  $i37 := $add.i64($i21,$i36);
  $i37.shadow := $add.i64($i21.shadow,$i36.shadow);
  call {:cexpr "l6"} boogie_si_record_i64($i37);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 498, 22} true;
  assume {:verifier.code 0} true;
  $i38 := $and.i64($i37,67108863);
  $i38.shadow := $and.i64($i37.shadow,67108863);
  call {:cexpr "tmp2"} boogie_si_record_i64($i38);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 499, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $lshr.i64($i37,26);
  $i39.shadow := $lshr.i64($i37.shadow,26);
  call {:cexpr "c2"} boogie_si_record_i64($i39);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 500, 22} true;
  assume {:verifier.code 0} true;
  $i40 := $add.i64($i24,$i39);
  $i40.shadow := $add.i64($i24.shadow,$i39.shadow);
  call {:cexpr "l7"} boogie_si_record_i64($i40);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 501, 22} true;
  assume {:verifier.code 0} true;
  $i41 := $and.i64($i40,67108863);
  $i41.shadow := $and.i64($i40.shadow,67108863);
  call {:cexpr "tmp3"} boogie_si_record_i64($i41);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 502, 20} true;
  assume {:verifier.code 0} true;
  $i42 := $lshr.i64($i40,26);
  $i42.shadow := $lshr.i64($i40.shadow,26);
  call {:cexpr "c3"} boogie_si_record_i64($i42);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 503, 22} true;
  assume {:verifier.code 0} true;
  $i43 := $add.i64($i27,$i42);
  $i43.shadow := $add.i64($i27.shadow,$i42.shadow);
  call {:cexpr "l8"} boogie_si_record_i64($i43);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 504, 22} true;
  assume {:verifier.code 0} true;
  $i44 := $and.i64($i43,67108863);
  $i44.shadow := $and.i64($i43.shadow,67108863);
  call {:cexpr "tmp4"} boogie_si_record_i64($i44);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 505, 20} true;
  assume {:verifier.code 0} true;
  $i45 := $lshr.i64($i43,26);
  $i45.shadow := $lshr.i64($i43.shadow,26);
  call {:cexpr "c4"} boogie_si_record_i64($i45);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 506, 28} true;
  assume {:verifier.code 0} true;
  $i46 := $mul.i64($i45,5);
  $i46.shadow := $mul.i64($i45.shadow,5);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 506, 23} true;
  assume {:verifier.code 0} true;
  $i47 := $add.i64($i32,$i46);
  $i47.shadow := $add.i64($i32.shadow,$i46.shadow);
  call {:cexpr "f02"} boogie_si_record_i64($i47);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 513, 19} true;
  assume {:verifier.code 0} true;
  call $i48, $i48.shadow := FStar_UInt64_eq_mask($i44, $i44.shadow, 67108863, 67108863);
  call {:cexpr "mask"} boogie_si_record_i64($i48);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 514, 27} true;
  assume {:verifier.code 0} true;
  call $i49, $i49.shadow := FStar_UInt64_eq_mask($i41, $i41.shadow, 67108863, 67108863);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 514, 25} true;
  assume {:verifier.code 0} true;
  $i50 := $and.i64($i48,$i49);
  $i50.shadow := $and.i64($i48.shadow,$i49.shadow);
  call {:cexpr "mask1"} boogie_si_record_i64($i50);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 515, 28} true;
  assume {:verifier.code 0} true;
  call $i51, $i51.shadow := FStar_UInt64_eq_mask($i38, $i38.shadow, 67108863, 67108863);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 515, 26} true;
  assume {:verifier.code 0} true;
  $i52 := $and.i64($i50,$i51);
  $i52.shadow := $and.i64($i50.shadow,$i51.shadow);
  call {:cexpr "mask2"} boogie_si_record_i64($i52);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 516, 28} true;
  assume {:verifier.code 0} true;
  call $i53, $i53.shadow := FStar_UInt64_eq_mask($i35, $i35.shadow, 67108863, 67108863);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 516, 26} true;
  assume {:verifier.code 0} true;
  $i54 := $and.i64($i52,$i53);
  $i54.shadow := $and.i64($i52.shadow,$i53.shadow);
  call {:cexpr "mask3"} boogie_si_record_i64($i54);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 517, 30} true;
  assume {:verifier.code 0} true;
  call $i55, $i55.shadow := FStar_UInt64_gte_mask($i47, $i47.shadow, 67108859, 67108859);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 517, 29} true;
  assume {:verifier.code 0} true;
  $i56 := $xor.i64($i55,$sub.i64(0,1));
  $i56.shadow := $xor.i64($i55.shadow,$sub.i64(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 517, 28} true;
  assume {:verifier.code 0} true;
  $i57 := $xor.i64($i56,$sub.i64(0,1));
  $i57.shadow := $xor.i64($i56.shadow,$sub.i64(0,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 517, 26} true;
  assume {:verifier.code 0} true;
  $i58 := $and.i64($i54,$i57);
  $i58.shadow := $and.i64($i54.shadow,$i57.shadow);
  call {:cexpr "mask4"} boogie_si_record_i64($i58);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 518, 23} true;
  assume {:verifier.code 0} true;
  $i59 := $and.i64($i58,67108863);
  $i59.shadow := $and.i64($i58.shadow,67108863);
  call {:cexpr "ph"} boogie_si_record_i64($i59);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 519, 23} true;
  assume {:verifier.code 0} true;
  $i60 := $and.i64($i58,67108859);
  $i60.shadow := $and.i64($i58.shadow,67108859);
  call {:cexpr "pl"} boogie_si_record_i64($i60);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 520, 21} true;
  assume {:verifier.code 0} true;
  $i61 := $sub.i64($i47,$i60);
  $i61.shadow := $sub.i64($i47.shadow,$i60.shadow);
  call {:cexpr "o0"} boogie_si_record_i64($i61);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 521, 21} true;
  assume {:verifier.code 0} true;
  $i62 := $sub.i64($i35,$i59);
  $i62.shadow := $sub.i64($i35.shadow,$i59.shadow);
  call {:cexpr "o1"} boogie_si_record_i64($i62);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 522, 21} true;
  assume {:verifier.code 0} true;
  $i63 := $sub.i64($i38,$i59);
  $i63.shadow := $sub.i64($i38.shadow,$i59.shadow);
  call {:cexpr "o2"} boogie_si_record_i64($i63);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 523, 21} true;
  assume {:verifier.code 0} true;
  $i64 := $sub.i64($i41,$i59);
  $i64.shadow := $sub.i64($i41.shadow,$i59.shadow);
  call {:cexpr "o3"} boogie_si_record_i64($i64);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 524, 21} true;
  assume {:verifier.code 0} true;
  $i65 := $sub.i64($i44,$i59);
  $i65.shadow := $sub.i64($i44.shadow,$i59.shadow);
  call {:cexpr "o4"} boogie_si_record_i64($i65);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 530, 3} true;
  assume {:verifier.code 0} true;
  $p66 := $add.ref($p2,$mul.ref(0,8));
  $p66.shadow := $add.ref($p2.shadow,$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 530, 11} true;
  assume {:verifier.code 0} true;
  assert ($p66 == $p66.shadow);
  $M.0 := $store.i64($M.0,$p66,$i61);
  $M.0.shadow := $store.i64($M.0.shadow,$p66.shadow,$i61.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 531, 3} true;
  assume {:verifier.code 0} true;
  $p67 := $add.ref($p2,$mul.ref(1,8));
  $p67.shadow := $add.ref($p2.shadow,$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 531, 11} true;
  assume {:verifier.code 0} true;
  assert ($p67 == $p67.shadow);
  $M.0 := $store.i64($M.0,$p67,$i62);
  $M.0.shadow := $store.i64($M.0.shadow,$p67.shadow,$i62.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 532, 3} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($p2,$mul.ref(2,8));
  $p68.shadow := $add.ref($p2.shadow,$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 532, 11} true;
  assume {:verifier.code 0} true;
  assert ($p68 == $p68.shadow);
  $M.0 := $store.i64($M.0,$p68,$i63);
  $M.0.shadow := $store.i64($M.0.shadow,$p68.shadow,$i63.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 533, 3} true;
  assume {:verifier.code 0} true;
  $p69 := $add.ref($p2,$mul.ref(3,8));
  $p69.shadow := $add.ref($p2.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 533, 11} true;
  assume {:verifier.code 0} true;
  assert ($p69 == $p69.shadow);
  $M.0 := $store.i64($M.0,$p69,$i64);
  $M.0.shadow := $store.i64($M.0.shadow,$p69.shadow,$i64.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 534, 3} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($p2,$mul.ref(4,8));
  $p70.shadow := $add.ref($p2.shadow,$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 534, 11} true;
  assume {:verifier.code 0} true;
  assert ($p70 == $p70.shadow);
  $M.0 := $store.i64($M.0,$p70,$i65);
  $M.0.shadow := $store.i64($M.0.shadow,$p70.shadow,$i65.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 535, 18} true;
  assume {:verifier.code 0} true;
  $p71 := $add.ref($p2,$mul.ref(0,8));
  $p71.shadow := $add.ref($p2.shadow,$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 535, 18} true;
  assume {:verifier.code 0} true;
  assert ($p71 == $p71.shadow);
  $i72 := $load.i64($M.0,$p71);
  $i72.shadow := $load.i64($M.0.shadow,$p71.shadow);
  call {:cexpr "f00"} boogie_si_record_i64($i72);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 536, 17} true;
  assume {:verifier.code 0} true;
  $p73 := $add.ref($p2,$mul.ref(1,8));
  $p73.shadow := $add.ref($p2.shadow,$mul.ref(1,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 536, 17} true;
  assume {:verifier.code 0} true;
  assert ($p73 == $p73.shadow);
  $i74 := $load.i64($M.0,$p73);
  $i74.shadow := $load.i64($M.0.shadow,$p73.shadow);
  call {:cexpr "f1"} boogie_si_record_i64($i74);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 537, 17} true;
  assume {:verifier.code 0} true;
  $p75 := $add.ref($p2,$mul.ref(2,8));
  $p75.shadow := $add.ref($p2.shadow,$mul.ref(2,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 537, 17} true;
  assume {:verifier.code 0} true;
  assert ($p75 == $p75.shadow);
  $i76 := $load.i64($M.0,$p75);
  $i76.shadow := $load.i64($M.0.shadow,$p75.shadow);
  call {:cexpr "f2"} boogie_si_record_i64($i76);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 538, 17} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($p2,$mul.ref(3,8));
  $p77.shadow := $add.ref($p2.shadow,$mul.ref(3,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 538, 17} true;
  assume {:verifier.code 0} true;
  assert ($p77 == $p77.shadow);
  $i78 := $load.i64($M.0,$p77);
  $i78.shadow := $load.i64($M.0.shadow,$p77.shadow);
  call {:cexpr "f3"} boogie_si_record_i64($i78);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 539, 17} true;
  assume {:verifier.code 0} true;
  $p79 := $add.ref($p2,$mul.ref(4,8));
  $p79.shadow := $add.ref($p2.shadow,$mul.ref(4,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 539, 17} true;
  assume {:verifier.code 0} true;
  assert ($p79 == $p79.shadow);
  $i80 := $load.i64($M.0,$p79);
  $i80.shadow := $load.i64($M.0.shadow,$p79.shadow);
  call {:cexpr "f4"} boogie_si_record_i64($i80);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 545, 29} true;
  assume {:verifier.code 0} true;
  $i81 := $shl.i64($i74,26);
  $i81.shadow := $shl.i64($i74.shadow,26);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 545, 22} true;
  assume {:verifier.code 0} true;
  $i82 := $or.i64($i72,$i81);
  $i82.shadow := $or.i64($i72.shadow,$i81.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 545, 54} true;
  assume {:verifier.code 0} true;
  $i83 := $shl.i64($i76,52);
  $i83.shadow := $shl.i64($i76.shadow,52);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 545, 47} true;
  assume {:verifier.code 0} true;
  $i84 := $or.i64($i82,$i83);
  $i84.shadow := $or.i64($i82.shadow,$i83.shadow);
  call {:cexpr "lo"} boogie_si_record_i64($i84);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 546, 23} true;
  assume {:verifier.code 0} true;
  $i85 := $lshr.i64($i76,12);
  $i85.shadow := $lshr.i64($i76.shadow,12);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 546, 47} true;
  assume {:verifier.code 0} true;
  $i86 := $shl.i64($i78,14);
  $i86.shadow := $shl.i64($i78.shadow,14);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 546, 40} true;
  assume {:verifier.code 0} true;
  $i87 := $or.i64($i85,$i86);
  $i87.shadow := $or.i64($i85.shadow,$i86.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 546, 71} true;
  assume {:verifier.code 0} true;
  $i88 := $shl.i64($i80,40);
  $i88.shadow := $shl.i64($i80.shadow,40);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 546, 65} true;
  assume {:verifier.code 0} true;
  $i89 := $or.i64($i87,$i88);
  $i89.shadow := $or.i64($i87.shadow,$i88.shadow);
  call {:cexpr "hi"} boogie_si_record_i64($i89);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 549, 17} true;
  assume {:verifier.code 0} true;
  call $i90, $i90.shadow := load64($p3, $p3.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 549, 17} true;
  assume {:verifier.code 0} true;
  call $i91, $i91.shadow := __uint64_identity($i90, $i90.shadow);
  call {:cexpr "u0"} boogie_si_record_i64($i91);
  $i92 := $add.i64(16,8);
  $i92.shadow := $add.i64(16,8);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 551, 16} true;
  assume {:verifier.code 0} true;
  $p93 := $add.ref($p1,$mul.ref($i92,1));
  $p93.shadow := $add.ref($p1.shadow,$mul.ref($i92.shadow,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 551, 16} true;
  assume {:verifier.code 0} true;
  call $i94, $i94.shadow := load64($p93, $p93.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 551, 16} true;
  assume {:verifier.code 0} true;
  call $i95, $i95.shadow := __uint64_identity($i94, $i94.shadow);
  call {:cexpr "u"} boogie_si_record_i64($i95);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 555, 21} true;
  assume {:verifier.code 0} true;
  $i96 := $add.i64($i84,$i91);
  $i96.shadow := $add.i64($i84.shadow,$i91.shadow);
  call {:cexpr "r0"} boogie_si_record_i64($i96);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 556, 21} true;
  assume {:verifier.code 0} true;
  $i97 := $add.i64($i89,$i95);
  $i97.shadow := $add.i64($i89.shadow,$i95.shadow);
  call {:cexpr "r1"} boogie_si_record_i64($i97);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 557, 27} true;
  assume {:verifier.code 0} true;
  $i98 := $xor.i64($i96,$i91);
  $i98.shadow := $xor.i64($i96.shadow,$i91.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 557, 41} true;
  assume {:verifier.code 0} true;
  $i99 := $sub.i64($i96,$i91);
  $i99.shadow := $sub.i64($i96.shadow,$i91.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 557, 48} true;
  assume {:verifier.code 0} true;
  $i100 := $xor.i64($i99,$i91);
  $i100.shadow := $xor.i64($i99.shadow,$i91.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 557, 34} true;
  assume {:verifier.code 0} true;
  $i101 := $or.i64($i98,$i100);
  $i101.shadow := $or.i64($i98.shadow,$i100.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 557, 20} true;
  assume {:verifier.code 0} true;
  $i102 := $xor.i64($i96,$i101);
  $i102.shadow := $xor.i64($i96.shadow,$i101.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 557, 57} true;
  assume {:verifier.code 0} true;
  $i103 := $lshr.i64($i102,63);
  $i103.shadow := $lshr.i64($i102.shadow,63);
  call {:cexpr "c"} boogie_si_record_i64($i103);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 558, 21} true;
  assume {:verifier.code 0} true;
  $i104 := $add.i64($i97,$i103);
  $i104.shadow := $add.i64($i97.shadow,$i103.shadow);
  call {:cexpr "r11"} boogie_si_record_i64($i104);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 561, 3} true;
  assume {:verifier.code 0} true;
  call $i105, $i105.shadow := __uint64_identity($i96, $i96.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 561, 3} true;
  assume {:verifier.code 0} true;
  call store64($p0, $p0.shadow, $i105, $i105.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 562, 3} true;
  assume {:verifier.code 0} true;
  $p106 := $add.ref($p0,$mul.ref(8,1));
  $p106.shadow := $add.ref($p0.shadow,$mul.ref(8,1));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 562, 3} true;
  assume {:verifier.code 0} true;
  call $i107, $i107.shadow := __uint64_identity($i104, $i104.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 562, 3} true;
  assume {:verifier.code 0} true;
  call store64($p106, $p106.shadow, $i107, $i107.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 563, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
axiom (FStar_UInt64_eq_mask == $sub.ref(0,10320));
procedure {:inline 1} FStar_UInt64_eq_mask($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i64, $r.shadow: i64)
modifies $exn;
{
  var $i2: i64;
  var $i2.shadow: i64;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i2 := $xor.i64($i0,$i1);
  $i2.shadow := $xor.i64($i0.shadow,$i1.shadow);
  ...
  assume {:verifier.code 0} true;
  $i5 := $or.i64($i2,$i4);
  $i5.shadow := $or.i64($i2.shadow,$i4.shadow);
  ...
  assume {:verifier.code 0} true;
  $i6 := $lshr.i64($i5,63);
  $i6.shadow := $lshr.i64($i5.shadow,63);
...
axiom (FStar_UInt64_gte_mask == $sub.ref(0,11352));
procedure {:inline 1} FStar_UInt64_gte_mask($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i64, $r.shadow: i64)
modifies $exn;
{
  var $i2: i64;
  var $i2.shadow: i64;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i3 := $sub.i64($i0,$i1);
  $i3.shadow := $sub.i64($i0.shadow,$i1.shadow);
  ...
  assume {:verifier.code 0} true;
  $i4 := $xor.i64($i3,$i1);
  $i4.shadow := $xor.i64($i3.shadow,$i1.shadow);
  ...
  assume {:verifier.code 0} true;
  $i6 := $xor.i64($i0,$i5);
  $i6.shadow := $xor.i64($i0.shadow,$i5.shadow);
  ...
  assume {:verifier.code 0} true;
  $i7 := $lshr.i64($i6,63);
  $i7.shadow := $lshr.i64($i6.shadow,63);
...
const store64: ref;
axiom (store64 == $sub.ref(0,12384));
procedure {:inline 1} store64($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64)
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $M.5 := $store.i64($M.5,$p2,$i1);
  $M.5.shadow := $store.i64($M.5.shadow,$p2.shadow,$i1.shadow);
  assume true;
  assume {:sourceloc "../hacl-star/dist/karamel/include/krml/lowstar_endianness.h", 187, 3} true;
  assume {:verifier.code 0} true;
  ...
  assert ($p0 == $p0.shadow);
  assert ($p3 == $p3.shadow);
  call $M.6, $M.6.shadow := $memcpy.i8($M.6, $M.6.shadow, $M.5, $M.5.shadow, $p0, $p0.shadow, $p3, $p3.shadow, 8, 8, false, false);
...
const Hacl_Poly1305_32_poly1305_mac: ref;
axiom (Hacl_Poly1305_32_poly1305_mac == $sub.ref(0,13416));
procedure {:inline 1} Hacl_Poly1305_32_poly1305_mac($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref)
modifies $M.0, $exn;
modifies $M.3, $M.4, $M.1, $M.2;
modifies $M.5, $M.6;
modifies $CurrAddr;
{
  var $p4: ref;
  ...
  var $p8.shadow: ref;
$bb0:
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 567, 12} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(200,$zext.i32.i64(1)));
  $p4.shadow := $p4;
  call {:cexpr "Hacl_Poly1305_32_poly1305_mac:arg:len"} boogie_si_record_i32($i1);
  assume true;
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 567, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  call $M.0, $M.0.shadow := $memset.i8($M.0, $M.0.shadow, $p5, $p5.shadow, 0, 0, 200, 200, false, false);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 568, 34} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p4,$mul.ref(0,200)),$mul.ref(0,8));
  $p6.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,200)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 568, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Poly1305_32_poly1305_init($p6, $p6.shadow, $p3, $p3.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 569, 36} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref($p4,$mul.ref(0,200)),$mul.ref(0,8));
  $p7.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,200)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 569, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Poly1305_32_poly1305_update($p7, $p7.shadow, $i1, $i1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 570, 46} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p4,$mul.ref(0,200)),$mul.ref(0,8));
  $p8.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,200)),$mul.ref(0,8));
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 570, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Poly1305_32_poly1305_finish($p0, $p0.shadow, $p3, $p3.shadow, $p8, $p8.shadow);
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 571, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
}
const Hacl_Poly1305_32_poly1305_mac_wrapper: ref;
axiom (Hacl_Poly1305_32_poly1305_mac_wrapper == $sub.ref(0,14448));
procedure {:entrypoint} Hacl_Poly1305_32_poly1305_mac_wrapper($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref)
requires {:public_in $p0} true;
requires {:public_in $i1} true;
requires {:public_in $p2} true;
requires {:public_in $p3} true;
requires {:public_in $load.i8, $M.6, $p0, 1, 16} true;
requires {:public_in $load.i8, $M.1, $p2, 1, 16} true;
modifies $exn;
modifies $M.0, $M.3, $M.4, $M.1, $M.2;
modifies $CurrAddr;
modifies $M.5, $M.6;
...
requires ($load.i8($M.6,($p0 + 0)) == $load.i8($M.6.shadow,($p0.shadow + 0)));
requires ($load.i8($M.6,($p0 + 1)) == $load.i8($M.6.shadow,($p0.shadow + 1)));
requires ($load.i8($M.6,($p0 + 2)) == $load.i8($M.6.shadow,($p0.shadow + 2)));
requires ($load.i8($M.6,($p0 + 3)) == $load.i8($M.6.shadow,($p0.shadow + 3)));
requires ($load.i8($M.6,($p0 + 4)) == $load.i8($M.6.shadow,($p0.shadow + 4)));
requires ($load.i8($M.6,($p0 + 5)) == $load.i8($M.6.shadow,($p0.shadow + 5)));
requires ($load.i8($M.6,($p0 + 6)) == $load.i8($M.6.shadow,($p0.shadow + 6)));
requires ($load.i8($M.6,($p0 + 7)) == $load.i8($M.6.shadow,($p0.shadow + 7)));
requires ($load.i8($M.6,($p0 + 8)) == $load.i8($M.6.shadow,($p0.shadow + 8)));
requires ($load.i8($M.6,($p0 + 9)) == $load.i8($M.6.shadow,($p0.shadow + 9)));
requires ($load.i8($M.6,($p0 + 10)) == $load.i8($M.6.shadow,($p0.shadow + 10)));
requires ($load.i8($M.6,($p0 + 11)) == $load.i8($M.6.shadow,($p0.shadow + 11)));
requires ($load.i8($M.6,($p0 + 12)) == $load.i8($M.6.shadow,($p0.shadow + 12)));
requires ($load.i8($M.6,($p0 + 13)) == $load.i8($M.6.shadow,($p0.shadow + 13)));
requires ($load.i8($M.6,($p0 + 14)) == $load.i8($M.6.shadow,($p0.shadow + 14)));
requires ($load.i8($M.6,($p0 + 15)) == $load.i8($M.6.shadow,($p0.shadow + 15)));
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 5, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:Hacl_Poly1305_32_poly1305_mac_wrapper"} boogie_si_record_ref(Hacl_Poly1305_32_poly1305_mac_wrapper);
  call {:cexpr "smack:arg:Hacl_Poly1305_32_poly1305_mac_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:Hacl_Poly1305_32_poly1305_mac_wrapper:$i1"} boogie_si_record_i32($i1);
  call {:cexpr "smack:arg:Hacl_Poly1305_32_poly1305_mac_wrapper:$p2"} boogie_si_record_ref($p2);
  call {:cexpr "smack:arg:Hacl_Poly1305_32_poly1305_mac_wrapper:$p3"} boogie_si_record_ref($p3);
  call {:cexpr "Hacl_Poly1305_32_poly1305_mac_wrapper:arg:len"} boogie_si_record_i32($i1);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 5, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 5, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i1} $p5 := __SMACK_value.i32($i1);
  $p5.shadow := $p5;
  assume $isExternal($p5);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p5);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 6, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 7, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p2} $p6 := __SMACK_value.ref($p2);
  $p6.shadow := $p6;
  assume $isExternal($p6);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p6);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 7, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p6, $p6.shadow);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 8, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p3} $p7 := __SMACK_value.ref($p3);
  $p7.shadow := $p7;
  assume $isExternal($p7);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p7);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p7, $p7.shadow);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 11, 13} true;
  assume {:verifier.code 1} true;
  call {:name $p0} {:array "$load.i8", $M.6, $p0, 1, 16} $p8 := __SMACK_values($p0, 16);
  $p8.shadow := $p8;
  assume $isExternal($p8);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p8);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p8, $p8.shadow);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 12, 13} true;
  assume {:verifier.code 1} true;
  call {:name $p2} {:array "$load.i8", $M.1, $p2, 1, 16} $p9 := __SMACK_values($p2, 16);
  $p9.shadow := $p9;
  assume $isExternal($p9);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p9);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p9, $p9.shadow);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Poly1305_32_poly1305_mac($p0, $p0.shadow, $i1, $i1.shadow, $p2, $p2.shadow, $p3, $p3.shadow);
  assume {:sourceloc "Hacl_Poly1305_32_poly1305_mac.c", 15, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
