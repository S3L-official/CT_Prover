...
procedure {:entrypoint} Hacl_Poly1305_128_poly1305_mac_wrapper($p0: ref, $p0.dup: i1, $i1: i32, $i1.dup: i1, $p2: ref, $p2.dup: i1, $p3: ref, $p3.dup: i1)
...
requires ($load.i8($M.1.dup,($p0 + 32)) == 0);
requires ($load.i8($M.1.dup,($p0 + 33)) == 0);
requires ($load.i8($M.1.dup,($p0 + 34)) == 0);
requires ($load.i8($M.1.dup,($p0 + 35)) == 0);
requires ($load.i8($M.1.dup,($p0 + 36)) == 0);
requires ($load.i8($M.1.dup,($p0 + 37)) == 0);
requires ($load.i8($M.1.dup,($p0 + 38)) == 0);
requires ($load.i8($M.1.dup,($p0 + 39)) == 0);
requires ($load.i8($M.1.dup,($p0 + 40)) == 0);
requires ($load.i8($M.1.dup,($p0 + 41)) == 0);
requires ($load.i8($M.1.dup,($p0 + 42)) == 0);
requires ($load.i8($M.1.dup,($p0 + 43)) == 0);
requires ($load.i8($M.1.dup,($p0 + 44)) == 0);
requires ($load.i8($M.1.dup,($p0 + 45)) == 0);
requires ($load.i8($M.1.dup,($p0 + 46)) == 0);
requires ($load.i8($M.1.dup,($p0 + 47)) == 0);
requires ($load.i8($M.1.dup,($p0 + 48)) == 0);
requires ($load.i8($M.1.dup,($p0 + 49)) == 0);
requires ($load.i8($M.1.dup,($p0 + 50)) == 0);
requires ($load.i8($M.1.dup,($p0 + 51)) == 0);
requires ($load.i8($M.1.dup,($p0 + 52)) == 0);
requires ($load.i8($M.1.dup,($p0 + 53)) == 0);
requires ($load.i8($M.1.dup,($p0 + 54)) == 0);
requires ($load.i8($M.1.dup,($p0 + 55)) == 0);
requires ($load.i8($M.1.dup,($p0 + 56)) == 0);
requires ($load.i8($M.1.dup,($p0 + 57)) == 0);
requires ($load.i8($M.1.dup,($p0 + 58)) == 0);
requires ($load.i8($M.1.dup,($p0 + 59)) == 0);
requires ($load.i8($M.1.dup,($p0 + 60)) == 0);
requires ($load.i8($M.1.dup,($p0 + 61)) == 0);
requires ($load.i8($M.1.dup,($p0 + 62)) == 0);
requires ($load.i8($M.1.dup,($p0 + 63)) == 0);
...
requires ($load.i8($M.2.dup,($p2 + 32)) == 0);
requires ($load.i8($M.2.dup,($p2 + 33)) == 0);
requires ($load.i8($M.2.dup,($p2 + 34)) == 0);
requires ($load.i8($M.2.dup,($p2 + 35)) == 0);
requires ($load.i8($M.2.dup,($p2 + 36)) == 0);
requires ($load.i8($M.2.dup,($p2 + 37)) == 0);
requires ($load.i8($M.2.dup,($p2 + 38)) == 0);
requires ($load.i8($M.2.dup,($p2 + 39)) == 0);
requires ($load.i8($M.2.dup,($p2 + 40)) == 0);
requires ($load.i8($M.2.dup,($p2 + 41)) == 0);
requires ($load.i8($M.2.dup,($p2 + 42)) == 0);
requires ($load.i8($M.2.dup,($p2 + 43)) == 0);
requires ($load.i8($M.2.dup,($p2 + 44)) == 0);
requires ($load.i8($M.2.dup,($p2 + 45)) == 0);
requires ($load.i8($M.2.dup,($p2 + 46)) == 0);
requires ($load.i8($M.2.dup,($p2 + 47)) == 0);
requires ($load.i8($M.2.dup,($p2 + 48)) == 0);
requires ($load.i8($M.2.dup,($p2 + 49)) == 0);
requires ($load.i8($M.2.dup,($p2 + 50)) == 0);
requires ($load.i8($M.2.dup,($p2 + 51)) == 0);
requires ($load.i8($M.2.dup,($p2 + 52)) == 0);
requires ($load.i8($M.2.dup,($p2 + 53)) == 0);
requires ($load.i8($M.2.dup,($p2 + 54)) == 0);
requires ($load.i8($M.2.dup,($p2 + 55)) == 0);
requires ($load.i8($M.2.dup,($p2 + 56)) == 0);
requires ($load.i8($M.2.dup,($p2 + 57)) == 0);
requires ($load.i8($M.2.dup,($p2 + 58)) == 0);
requires ($load.i8($M.2.dup,($p2 + 59)) == 0);
requires ($load.i8($M.2.dup,($p2 + 60)) == 0);
requires ($load.i8($M.2.dup,($p2 + 61)) == 0);
requires ($load.i8($M.2.dup,($p2 + 62)) == 0);
requires ($load.i8($M.2.dup,($p2 + 63)) == 0);
{
  var $p4: ref;
  var $p4.dup: i1;
  var $p5: ref;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call Hacl_Poly1305_128_poly1305_mac($p0, $p0.dup, $i1, $i1.dup, $p2, $p2.dup, $p3, $p3.dup);
...
procedure {:inline 1} Hacl_Poly1305_128_poly1305_mac($p0: ref, $p0.dup: i1, $i1: i32, $i1.dup: i1, $p2: ref, $p2.dup: i1, $p3: ref, $p3.dup: i1);
