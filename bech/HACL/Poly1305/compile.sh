...
# 四个需要指定的选项
deps=( ../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c)

source=Hacl_Poly1305_32_poly1305_mac.c
...
# 四个需要指定的选项
deps=( ../hacl-star/dist/gcc-compatible/Hacl_Poly1305_128.c)

source=Hacl_Poly1305_128_poly1305_mac.c
...
# 四个需要指定的选项
deps=( ../hacl-star/dist/gcc-compatible/Hacl_Poly1305_256.c)

source=Hacl_Poly1305_256_poly1305_mac.c
