; ModuleID = 'Hacl_Poly1305_256_poly1305_mac-k.ll'
...
define dso_local void @Hacl_Poly1305_256_poly1305_mac_wrapper(i8* %0, i32 %1, i8* %2, i8* %3) #0 !dbg !7 {
  ...
  %9 = call %struct.smack_value* @__SMACK_values(i8* %0, i32 16), !dbg !44, !psr.id !45
  call void @public_in(%struct.smack_value* %9), !dbg !46, !psr.id !47
  %10 = call %struct.smack_value* @__SMACK_values(i8* %2, i32 16), !dbg !48, !psr.id !49
  call void @public_in(%struct.smack_value* %10), !dbg !50, !psr.id !51
  call void @Hacl_Poly1305_256_poly1305_mac(i8* %0, i32 %1, i8* %2, i8* %3), !dbg !52, !psr.id !53
...
declare dso_local void @Hacl_Poly1305_256_poly1305_mac(i8*, i32, i8*, i8*) #2

; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Poly1305_256_poly1305_mac_wrapper_t() #0 !dbg !56 {
  ...
  call void @Hacl_Poly1305_256_poly1305_mac(i8* %1, i32 %5, i8* %2, i8* %3), !dbg !78, !psr.id !79
...
entry:
  call void @Hacl_Poly1305_256_poly1305_mac_wrapper_t()
  ret void
}
...
!1 = !DIFile(filename: "Hacl_Poly1305_256_poly1305_mac.c", directory: "/home/luwei/bech-back/HACL/Poly1305")
!2 = !{}
!3 = !{!"Ubuntu clang version 12.0.1-++20211029101322+fed41342a82f-1~exp1~20211029221816.4"}
!4 = !{i32 7, !"Dwarf Version", i32 4}
!5 = !{i32 2, !"Debug Info Version", i32 3}
!6 = !{i32 1, !"wchar_size", i32 4}
!7 = distinct !DISubprogram(name: "Hacl_Poly1305_256_poly1305_mac_wrapper", scope: !1, file: !1, line: 3, type: !8, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
...
!55 = !{!"17"}
!56 = distinct !DISubprogram(name: "Hacl_Poly1305_256_poly1305_mac_wrapper_t", scope: !1, file: !1, line: 25, type: !57, scopeLine: 25, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
