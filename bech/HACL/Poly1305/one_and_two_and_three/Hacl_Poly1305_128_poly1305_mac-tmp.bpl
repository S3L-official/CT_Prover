...
const Hacl_Poly1305_128_poly1305_mac_wrapper: ref;
axiom (Hacl_Poly1305_128_poly1305_mac_wrapper == $sub.ref(0,1032));
procedure {:entrypoint} Hacl_Poly1305_128_poly1305_mac_wrapper($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref)
requires {:public_in $p0} true;
requires {:public_in $i1} true;
requires {:public_in $p2} true;
requires {:public_in $p3} true;
requires {:public_in $load.i8, $M.1, $p0, 1, 64} true;
requires {:public_in $load.i8, $M.2, $p2, 1, 64} true;
modifies $exn;
modifies $CurrAddr;
...
requires ($load.i8($M.1,($p0 + 32)) == $load.i8($M.1.shadow,($p0.shadow + 32)));
requires ($load.i8($M.1,($p0 + 33)) == $load.i8($M.1.shadow,($p0.shadow + 33)));
requires ($load.i8($M.1,($p0 + 34)) == $load.i8($M.1.shadow,($p0.shadow + 34)));
requires ($load.i8($M.1,($p0 + 35)) == $load.i8($M.1.shadow,($p0.shadow + 35)));
requires ($load.i8($M.1,($p0 + 36)) == $load.i8($M.1.shadow,($p0.shadow + 36)));
requires ($load.i8($M.1,($p0 + 37)) == $load.i8($M.1.shadow,($p0.shadow + 37)));
requires ($load.i8($M.1,($p0 + 38)) == $load.i8($M.1.shadow,($p0.shadow + 38)));
requires ($load.i8($M.1,($p0 + 39)) == $load.i8($M.1.shadow,($p0.shadow + 39)));
requires ($load.i8($M.1,($p0 + 40)) == $load.i8($M.1.shadow,($p0.shadow + 40)));
requires ($load.i8($M.1,($p0 + 41)) == $load.i8($M.1.shadow,($p0.shadow + 41)));
requires ($load.i8($M.1,($p0 + 42)) == $load.i8($M.1.shadow,($p0.shadow + 42)));
requires ($load.i8($M.1,($p0 + 43)) == $load.i8($M.1.shadow,($p0.shadow + 43)));
requires ($load.i8($M.1,($p0 + 44)) == $load.i8($M.1.shadow,($p0.shadow + 44)));
requires ($load.i8($M.1,($p0 + 45)) == $load.i8($M.1.shadow,($p0.shadow + 45)));
requires ($load.i8($M.1,($p0 + 46)) == $load.i8($M.1.shadow,($p0.shadow + 46)));
requires ($load.i8($M.1,($p0 + 47)) == $load.i8($M.1.shadow,($p0.shadow + 47)));
requires ($load.i8($M.1,($p0 + 48)) == $load.i8($M.1.shadow,($p0.shadow + 48)));
requires ($load.i8($M.1,($p0 + 49)) == $load.i8($M.1.shadow,($p0.shadow + 49)));
requires ($load.i8($M.1,($p0 + 50)) == $load.i8($M.1.shadow,($p0.shadow + 50)));
requires ($load.i8($M.1,($p0 + 51)) == $load.i8($M.1.shadow,($p0.shadow + 51)));
requires ($load.i8($M.1,($p0 + 52)) == $load.i8($M.1.shadow,($p0.shadow + 52)));
requires ($load.i8($M.1,($p0 + 53)) == $load.i8($M.1.shadow,($p0.shadow + 53)));
requires ($load.i8($M.1,($p0 + 54)) == $load.i8($M.1.shadow,($p0.shadow + 54)));
requires ($load.i8($M.1,($p0 + 55)) == $load.i8($M.1.shadow,($p0.shadow + 55)));
requires ($load.i8($M.1,($p0 + 56)) == $load.i8($M.1.shadow,($p0.shadow + 56)));
requires ($load.i8($M.1,($p0 + 57)) == $load.i8($M.1.shadow,($p0.shadow + 57)));
requires ($load.i8($M.1,($p0 + 58)) == $load.i8($M.1.shadow,($p0.shadow + 58)));
requires ($load.i8($M.1,($p0 + 59)) == $load.i8($M.1.shadow,($p0.shadow + 59)));
requires ($load.i8($M.1,($p0 + 60)) == $load.i8($M.1.shadow,($p0.shadow + 60)));
requires ($load.i8($M.1,($p0 + 61)) == $load.i8($M.1.shadow,($p0.shadow + 61)));
requires ($load.i8($M.1,($p0 + 62)) == $load.i8($M.1.shadow,($p0.shadow + 62)));
requires ($load.i8($M.1,($p0 + 63)) == $load.i8($M.1.shadow,($p0.shadow + 63)));
...
requires ($load.i8($M.2,($p2 + 32)) == $load.i8($M.2.shadow,($p2.shadow + 32)));
requires ($load.i8($M.2,($p2 + 33)) == $load.i8($M.2.shadow,($p2.shadow + 33)));
requires ($load.i8($M.2,($p2 + 34)) == $load.i8($M.2.shadow,($p2.shadow + 34)));
requires ($load.i8($M.2,($p2 + 35)) == $load.i8($M.2.shadow,($p2.shadow + 35)));
requires ($load.i8($M.2,($p2 + 36)) == $load.i8($M.2.shadow,($p2.shadow + 36)));
requires ($load.i8($M.2,($p2 + 37)) == $load.i8($M.2.shadow,($p2.shadow + 37)));
requires ($load.i8($M.2,($p2 + 38)) == $load.i8($M.2.shadow,($p2.shadow + 38)));
requires ($load.i8($M.2,($p2 + 39)) == $load.i8($M.2.shadow,($p2.shadow + 39)));
requires ($load.i8($M.2,($p2 + 40)) == $load.i8($M.2.shadow,($p2.shadow + 40)));
requires ($load.i8($M.2,($p2 + 41)) == $load.i8($M.2.shadow,($p2.shadow + 41)));
requires ($load.i8($M.2,($p2 + 42)) == $load.i8($M.2.shadow,($p2.shadow + 42)));
requires ($load.i8($M.2,($p2 + 43)) == $load.i8($M.2.shadow,($p2.shadow + 43)));
requires ($load.i8($M.2,($p2 + 44)) == $load.i8($M.2.shadow,($p2.shadow + 44)));
requires ($load.i8($M.2,($p2 + 45)) == $load.i8($M.2.shadow,($p2.shadow + 45)));
requires ($load.i8($M.2,($p2 + 46)) == $load.i8($M.2.shadow,($p2.shadow + 46)));
requires ($load.i8($M.2,($p2 + 47)) == $load.i8($M.2.shadow,($p2.shadow + 47)));
requires ($load.i8($M.2,($p2 + 48)) == $load.i8($M.2.shadow,($p2.shadow + 48)));
requires ($load.i8($M.2,($p2 + 49)) == $load.i8($M.2.shadow,($p2.shadow + 49)));
requires ($load.i8($M.2,($p2 + 50)) == $load.i8($M.2.shadow,($p2.shadow + 50)));
requires ($load.i8($M.2,($p2 + 51)) == $load.i8($M.2.shadow,($p2.shadow + 51)));
requires ($load.i8($M.2,($p2 + 52)) == $load.i8($M.2.shadow,($p2.shadow + 52)));
requires ($load.i8($M.2,($p2 + 53)) == $load.i8($M.2.shadow,($p2.shadow + 53)));
requires ($load.i8($M.2,($p2 + 54)) == $load.i8($M.2.shadow,($p2.shadow + 54)));
requires ($load.i8($M.2,($p2 + 55)) == $load.i8($M.2.shadow,($p2.shadow + 55)));
requires ($load.i8($M.2,($p2 + 56)) == $load.i8($M.2.shadow,($p2.shadow + 56)));
requires ($load.i8($M.2,($p2 + 57)) == $load.i8($M.2.shadow,($p2.shadow + 57)));
requires ($load.i8($M.2,($p2 + 58)) == $load.i8($M.2.shadow,($p2.shadow + 58)));
requires ($load.i8($M.2,($p2 + 59)) == $load.i8($M.2.shadow,($p2.shadow + 59)));
requires ($load.i8($M.2,($p2 + 60)) == $load.i8($M.2.shadow,($p2.shadow + 60)));
requires ($load.i8($M.2,($p2 + 61)) == $load.i8($M.2.shadow,($p2.shadow + 61)));
requires ($load.i8($M.2,($p2 + 62)) == $load.i8($M.2.shadow,($p2.shadow + 62)));
requires ($load.i8($M.2,($p2 + 63)) == $load.i8($M.2.shadow,($p2.shadow + 63)));
{
  var $p4: ref;
  var $p4.shadow: ref;
  var $p5: ref;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 5, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:Hacl_Poly1305_128_poly1305_mac_wrapper"} boogie_si_record_ref(Hacl_Poly1305_128_poly1305_mac_wrapper);
  call {:cexpr "smack:arg:Hacl_Poly1305_128_poly1305_mac_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:Hacl_Poly1305_128_poly1305_mac_wrapper:$i1"} boogie_si_record_i32($i1);
  call {:cexpr "smack:arg:Hacl_Poly1305_128_poly1305_mac_wrapper:$p2"} boogie_si_record_ref($p2);
  call {:cexpr "smack:arg:Hacl_Poly1305_128_poly1305_mac_wrapper:$p3"} boogie_si_record_ref($p3);
  call {:cexpr "Hacl_Poly1305_128_poly1305_mac_wrapper:arg:len"} boogie_si_record_i32($i1);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 5, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 5, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i1} $p5 := __SMACK_value.i32($i1);
  $p5.shadow := $p5;
  assume $isExternal($p5);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p5);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 6, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 7, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p2} $p6 := __SMACK_value.ref($p2);
  $p6.shadow := $p6;
  assume $isExternal($p6);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p6);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 7, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p6, $p6.shadow);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 8, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p3} $p7 := __SMACK_value.ref($p3);
  $p7.shadow := $p7;
  assume $isExternal($p7);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p7);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p7, $p7.shadow);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 11, 13} true;
  assume {:verifier.code 1} true;
  call {:name $p0} {:array "$load.i8", $M.1, $p0, 1, 64} $p8 := __SMACK_values($p0, 64);
  $p8.shadow := $p8;
  assume $isExternal($p8);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p8);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p8, $p8.shadow);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 12, 13} true;
  assume {:verifier.code 1} true;
  call {:name $p2} {:array "$load.i8", $M.2, $p2, 1, 64} $p9 := __SMACK_values($p2, 64);
  $p9.shadow := $p9;
  assume $isExternal($p9);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p9);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p9, $p9.shadow);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Poly1305_128_poly1305_mac($p0, $p0.shadow, $i1, $i1.shadow, $p2, $p2.shadow, $p3, $p3.shadow);
  assume {:sourceloc "Hacl_Poly1305_128_poly1305_mac.c", 15, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := $exn;
...
const Hacl_Poly1305_128_poly1305_mac: ref;
axiom (Hacl_Poly1305_128_poly1305_mac == $sub.ref(0,6192));
procedure {:inline 1} Hacl_Poly1305_128_poly1305_mac($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref);
