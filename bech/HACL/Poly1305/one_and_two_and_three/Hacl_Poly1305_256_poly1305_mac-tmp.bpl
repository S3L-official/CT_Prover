...
const Hacl_Poly1305_256_poly1305_mac_wrapper: ref;
axiom (Hacl_Poly1305_256_poly1305_mac_wrapper == $sub.ref(0,1032));
procedure {:entrypoint} Hacl_Poly1305_256_poly1305_mac_wrapper($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref)
requires {:public_in $p0} true;
requires {:public_in $i1} true;
requires {:public_in $p2} true;
requires {:public_in $p3} true;
requires {:public_in $load.i8, $M.1, $p0, 1, 16} true;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 5, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:Hacl_Poly1305_256_poly1305_mac_wrapper"} boogie_si_record_ref(Hacl_Poly1305_256_poly1305_mac_wrapper);
  call {:cexpr "smack:arg:Hacl_Poly1305_256_poly1305_mac_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:Hacl_Poly1305_256_poly1305_mac_wrapper:$i1"} boogie_si_record_i32($i1);
  call {:cexpr "smack:arg:Hacl_Poly1305_256_poly1305_mac_wrapper:$p2"} boogie_si_record_ref($p2);
  call {:cexpr "smack:arg:Hacl_Poly1305_256_poly1305_mac_wrapper:$p3"} boogie_si_record_ref($p3);
  call {:cexpr "Hacl_Poly1305_256_poly1305_mac_wrapper:arg:len"} boogie_si_record_i32($i1);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 5, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 5, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 6, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i1} $p5 := __SMACK_value.i32($i1);
  $p5.shadow := $p5;
  assume $isExternal($p5);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p5);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 6, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 7, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p2} $p6 := __SMACK_value.ref($p2);
  $p6.shadow := $p6;
  assume $isExternal($p6);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p6);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 7, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p6, $p6.shadow);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 8, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p3} $p7 := __SMACK_value.ref($p3);
  $p7.shadow := $p7;
  assume $isExternal($p7);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p7);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p7, $p7.shadow);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 11, 13} true;
  assume {:verifier.code 1} true;
  call {:name $p0} {:array "$load.i8", $M.1, $p0, 1, 16} $p8 := __SMACK_values($p0, 16);
  $p8.shadow := $p8;
  assume $isExternal($p8);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p8);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p8, $p8.shadow);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 12, 13} true;
  assume {:verifier.code 1} true;
  call {:name $p2} {:array "$load.i8", $M.2, $p2, 1, 16} $p9 := __SMACK_values($p2, 16);
  $p9.shadow := $p9;
  assume $isExternal($p9);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p9);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p9, $p9.shadow);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call Hacl_Poly1305_256_poly1305_mac($p0, $p0.shadow, $i1, $i1.shadow, $p2, $p2.shadow, $p3, $p3.shadow);
  assume {:sourceloc "Hacl_Poly1305_256_poly1305_mac.c", 15, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := $exn;
...
const Hacl_Poly1305_256_poly1305_mac: ref;
axiom (Hacl_Poly1305_256_poly1305_mac == $sub.ref(0,6192));
procedure {:inline 1} Hacl_Poly1305_256_poly1305_mac($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref);
