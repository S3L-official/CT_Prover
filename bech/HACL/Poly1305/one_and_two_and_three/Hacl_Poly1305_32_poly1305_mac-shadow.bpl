...
modifies $M.3, $M.3.shadow, $M.0, $M.0.shadow, $M.4, $M.4.shadow, $M.1, $M.1.shadow, $exn, $exn.shadow;
modifies $M.2, $M.2.shadow;
modifies $CurrAddr;
{
  var $p3: ref;
...
modifies $M.0, $M.0.shadow, $exn, $exn.shadow;
modifies $M.2, $M.2.shadow;
modifies $M.5, $M.5.shadow, $M.6, $M.6.shadow;
modifies $CurrAddr;
{
  var $p3: ref;
  var $p3.shadow: ref;
...
requires ($p0 == $p0.shadow);
modifies $M.5, $M.5.shadow, $M.6, $M.6.shadow, $exn, $exn.shadow;
modifies $CurrAddr;
{
  var $p2: ref;
  var $p2.shadow: ref;
...
modifies $M.0, $M.0.shadow, $exn, $exn.shadow;
modifies $M.3, $M.3.shadow, $M.4, $M.4.shadow, $M.1, $M.1.shadow, $M.2, $M.2.shadow;
modifies $M.5, $M.5.shadow, $M.6, $M.6.shadow;
modifies $CurrAddr;
{
  var $p4: ref;
...
modifies $M.0, $M.0.shadow, $M.3, $M.3.shadow, $M.4, $M.4.shadow, $M.1, $M.1.shadow, $M.2, $M.2.shadow;
modifies $CurrAddr;
modifies $M.5, $M.5.shadow, $M.6, $M.6.shadow;
{
  var $p4: ref;
