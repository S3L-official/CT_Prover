; ModuleID = 'Hacl_Poly1305_256_poly1305_mac.ll'
...
define dso_local void @Hacl_Poly1305_256_poly1305_mac_wrapper(i8* %0, i32 %1, i8* %2, i8* %3) #0 !dbg !7 {
  ...
  %9 = call %struct.smack_value* @__SMACK_values(i8* %0, i32 16), !dbg !32
  call void @public_in(%struct.smack_value* %9), !dbg !33
  %10 = call %struct.smack_value* @__SMACK_values(i8* %2, i32 16), !dbg !34
  call void @public_in(%struct.smack_value* %10), !dbg !35
  call void @Hacl_Poly1305_256_poly1305_mac(i8* %0, i32 %1, i8* %2, i8* %3), !dbg !36
  ret void, !dbg !37
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Hacl_Poly1305_256_poly1305_mac_wrapper_t() #0 !dbg !38 {
  ...
  call void @Hacl_Poly1305_256_poly1305_mac(i8* %1, i32 %5, i8* %2, i8* %3), !dbg !51
  ret void, !dbg !52
}
...
!38 = distinct !DISubprogram(name: "Hacl_Poly1305_256_poly1305_mac_wrapper_t", scope: !1, file: !1, line: 25, type: !39, scopeLine: 25, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
