...
$bb2:
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p162 == $p162.shadow));
...
$bb5:
  ...
  $shadow_ok := ($shadow_ok && ($i175 == $i175.shadow));
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 371, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p217 == $p217.shadow));
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 372, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p220 == $p220.shadow));
  ...
  assume {:sourceloc "../hacl-star/dist/gcc-compatible/Hacl_Poly1305_32.c", 373, 19} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p223 == $p223.shadow));
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p333 == $p333.shadow));
