...
procedure {:entrypoint} Hacl_Poly1305_256_poly1305_mac_wrapper($p0: ref, $p0.dup: i1, $i1: i32, $i1.dup: i1, $p2: ref, $p2.dup: i1, $p3: ref, $p3.dup: i1)
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call Hacl_Poly1305_256_poly1305_mac($p0, $p0.dup, $i1, $i1.dup, $p2, $p2.dup, $p3, $p3.dup);
...
procedure {:inline 1} Hacl_Poly1305_256_poly1305_mac($p0: ref, $p0.dup: i1, $i1: i32, $i1.dup: i1, $p2: ref, $p2.dup: i1, $p3: ref, $p3.dup: i1);
