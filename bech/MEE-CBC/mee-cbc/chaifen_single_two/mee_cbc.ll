...
define dso_local i32 @mee_cbc_wrapper_t() #0 !dbg !2160 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %7, i8* align 16 getelementptr inbounds (<{ i8, [31 x i8] }>, <{ i8, [31 x i8] }>* @__const.mee_cbc_wrapper_t.tin, i32 0, i32 0), i64 32, i1 false), !dbg !2166
  call void @llvm.dbg.declare(metadata [32 x i8]* %3, metadata !2167, metadata !DIExpression()), !dbg !2168
  %8 = bitcast [32 x i8]* %3 to i8*, !dbg !2168
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %8, i8* align 16 getelementptr inbounds (<{ i8, [31 x i8] }>, <{ i8, [31 x i8] }>* @__const.mee_cbc_wrapper_t.tiv, i32 0, i32 0), i64 32, i1 false), !dbg !2168
  call void @llvm.dbg.declare(metadata [32 x i8]* %4, metadata !2169, metadata !DIExpression()), !dbg !2170
  %9 = bitcast [32 x i8]* %4 to i8*, !dbg !2170
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %9, i8* align 16 getelementptr inbounds (<{ i8, [31 x i8] }>, <{ i8, [31 x i8] }>* @__const.mee_cbc_wrapper_t.tenc_sk, i32 0, i32 0), i64 32, i1 false), !dbg !2170
  call void @llvm.dbg.declare(metadata [32 x i8]* %5, metadata !2171, metadata !DIExpression()), !dbg !2172
  %10 = bitcast [32 x i8]* %5 to i8*, !dbg !2172
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %10, i8* align 16 getelementptr inbounds (<{ i8, [31 x i8] }>, <{ i8, [31 x i8] }>* @__const.mee_cbc_wrapper_t.tmac_sk, i32 0, i32 0), i64 32, i1 false), !dbg !2172
  %11 = getelementptr inbounds [32 x i8], [32 x i8]* %1, i64 0, i64 0, !dbg !2173
  call void @llvm.dbg.value(metadata i8* %11, metadata !2174, metadata !DIExpression()), !dbg !2175
  %12 = call i64* (...) @getvalue(), !dbg !2176
  call void @llvm.dbg.value(metadata i64* %12, metadata !2177, metadata !DIExpression()), !dbg !2175
  %13 = getelementptr inbounds [32 x i8], [32 x i8]* %2, i64 0, i64 0, !dbg !2178
  call void @llvm.dbg.value(metadata i8* %13, metadata !2179, metadata !DIExpression()), !dbg !2175
  %14 = call i64* (...) @getvalue2(), !dbg !2180
  %15 = ptrtoint i64* %14 to i64, !dbg !2180
  call void @llvm.dbg.value(metadata i64 %15, metadata !2181, metadata !DIExpression()), !dbg !2175
  %16 = getelementptr inbounds [32 x i8], [32 x i8]* %3, i64 0, i64 0, !dbg !2182
  call void @llvm.dbg.value(metadata i8* %16, metadata !2183, metadata !DIExpression()), !dbg !2175
  %17 = getelementptr inbounds [32 x i8], [32 x i8]* %4, i64 0, i64 0, !dbg !2184
  call void @llvm.dbg.value(metadata i8* %17, metadata !2185, metadata !DIExpression()), !dbg !2175
  %18 = getelementptr inbounds [32 x i8], [32 x i8]* %5, i64 0, i64 0, !dbg !2186
  call void @llvm.dbg.value(metadata i8* %18, metadata !2187, metadata !DIExpression()), !dbg !2175
  %19 = call i32 @decrypt_then_verify(i8* %11, i64* %12, i8* %13, i64 %15, i8* %16, i8* %17, i8* %18), !dbg !2188
  ret i32 %19, !dbg !2189
}
