...
$bb6:
  ...
  assert {:likely_shadow_invariant} ($p13.dup == 0);
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assert {:shadow_invariant} $shadow_ok;
  assert {:likely_shadow_invariant} ($p23.dup == 0);
  assert {:likely_shadow_invariant} ($p21.dup == 0);
...
$bb1:
  assert {:shadow_invariant} $shadow_ok;
  assert {:likely_shadow_invariant} ($i4.dup == 0);
