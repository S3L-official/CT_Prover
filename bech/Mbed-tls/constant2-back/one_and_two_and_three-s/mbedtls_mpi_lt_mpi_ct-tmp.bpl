...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,23736));
...
const mbedtls_ct_mpi_uint_lt: ref;
axiom (mbedtls_ct_mpi_uint_lt == $sub.ref(0,2064));
procedure {:inline 1} mbedtls_ct_mpi_uint_lt($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i64;
  var $i2.shadow: i64;
  ...
  var $i9.shadow: i32;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 237, 16} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_mpi_uint_lt:arg:x"} boogie_si_record_i64($i0);
  call {:cexpr "mbedtls_ct_mpi_uint_lt:arg:y"} boogie_si_record_i64($i1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 237, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i64($i0,$i1);
  $i2.shadow := $xor.i64($i0.shadow,$i1.shadow);
  call {:cexpr "cond"} boogie_si_record_i64($i2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 242, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i64($i0,$i1);
  $i3.shadow := $sub.i64($i0.shadow,$i1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 242, 23} true;
  assume {:verifier.code 0} true;
  $i4 := $xor.i64($i2,$sub.i64(0,1));
  $i4.shadow := $xor.i64($i2.shadow,$sub.i64(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 242, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $and.i64($i3,$i4);
  $i5.shadow := $and.i64($i3.shadow,$i4.shadow);
  call {:cexpr "ret"} boogie_si_record_i64($i5);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 248, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $and.i64($i1,$i2);
  $i6.shadow := $and.i64($i1.shadow,$i2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 248, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $or.i64($i5,$i6);
  $i7.shadow := $or.i64($i5.shadow,$i6.shadow);
  call {:cexpr "ret"} boogie_si_record_i64($i7);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 251, 15} true;
  assume {:verifier.code 0} true;
  $i8 := $lshr.i64($i7,63);
  $i8.shadow := $lshr.i64($i7.shadow,63);
  call {:cexpr "ret"} boogie_si_record_i64($i8);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 253, 12} true;
  assume {:verifier.code 0} true;
  $i9 := $trunc.i64.i32($i8);
  $i9.shadow := $trunc.i64.i32($i8.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 253, 5} true;
  assume {:verifier.code 0} true;
  $r := $i9;
  $r.shadow := $i9.shadow;
  $exn := false;
...
const mbedtls_mpi_lt_mpi_ct: ref;
axiom (mbedtls_mpi_lt_mpi_ct == $sub.ref(0,3096));
procedure {:inline 1} mbedtls_mpi_lt_mpi_ct($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref) returns ($r: i32, $r.shadow: i32)
modifies $M.4, $exn;
{
  var $p3: ref;
  var $p3.shadow: ref;
  ...
  var $i8.shadow: i32;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 787, 5} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 787, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 788, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 788, 5} true;
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 789, 5} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 789, 5} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 791, 12} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1));
  $p3.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 791, 12} true;
  assume {:verifier.code 0} true;
  $p3 := $p3.shadow;
  $i4 := $load.i64($M.0,$p3);
  $i4.shadow := $load.i64($M.0.shadow,$p3.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 791, 20} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 791, 14} true;
  assume {:verifier.code 0} true;
  $i7 := $ne.i64($i4,$i6);
  $i7.shadow := $ne.i64($i4.shadow,$i6.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 791, 9} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i7 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 792, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $sub.i32(0,4);
  $i8.shadow := $sub.i32(0,4);
  goto $bb9;
$bb8:
  assume !($i7 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 798, 26} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1));
  $p9.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 798, 26} true;
  assume {:verifier.code 0} true;
  $p9 := $p9.shadow;
  $i10 := $load.i32($M.2,$p9);
  $i10.shadow := $load.i32($M.2.shadow,$p9.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 798, 28} true;
  assume {:verifier.code 0} true;
  $i11 := $and.i32($i10,2);
  $i11.shadow := $and.i32($i10.shadow,2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 798, 34} true;
  assume {:verifier.code 0} true;
  $i12 := $ashr.i32($i11,1);
  $i12.shadow := $ashr.i32($i11.shadow,1);
  call {:cexpr "X_is_negative"} boogie_si_record_i32($i12);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 799, 26} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1));
  $p13.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 799, 26} true;
  assume {:verifier.code 0} true;
  $p13 := $p13.shadow;
  $i14 := $load.i32($M.3,$p13);
  $i14.shadow := $load.i32($M.3.shadow,$p13.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 799, 28} true;
  assume {:verifier.code 0} true;
  $i15 := $and.i32($i14,2);
  $i15.shadow := $and.i32($i14.shadow,2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 799, 34} true;
  assume {:verifier.code 0} true;
  $i16 := $ashr.i32($i15,1);
  $i16.shadow := $ashr.i32($i15.shadow,1);
  call {:cexpr "Y_is_negative"} boogie_si_record_i32($i16);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 806, 28} true;
  assume {:verifier.code 0} true;
  $i17 := $xor.i32($i12,$i16);
  $i17.shadow := $xor.i32($i12.shadow,$i16.shadow);
  call {:cexpr "cond"} boogie_si_record_i32($i17);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 807, 17} true;
  assume {:verifier.code 0} true;
  $i18 := $and.i32($i17,$i12);
  $i18.shadow := $and.i32($i17.shadow,$i12.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 807, 10} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $M.4 := $store.i32($M.4,$p2,$i18);
  $M.4.shadow := $store.i32($M.4.shadow,$p2.shadow,$i18.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 815, 17} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1));
  $p19.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 815, 17} true;
  assume {:verifier.code 0} true;
  $p19 := $p19.shadow;
  $i20 := $load.i64($M.0,$p19);
  $i20.shadow := $load.i64($M.0.shadow,$p19.shadow);
  call {:cexpr "i"} boogie_si_record_i64($i20);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 815, 10} true;
  assume {:verifier.code 0} true;
  $i21 := $i20;
  $i21.shadow := $i20.shadow;
  $i22 := $i17;
  $i22.shadow := $i17.shadow;
  goto $bb10;
$bb9:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 841, 1} true;
  assume {:verifier.code 0} true;
  $r := $i8;
  $r.shadow := $i8.shadow;
  $exn := false;
...
$bb10:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 815, 22} true;
  assume {:verifier.code 0} true;
  $i23 := $ugt.i64($i21,0);
  $i23.shadow := $ugt.i64($i21.shadow,0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 815, 5} true;
  assume {:verifier.code 0} true;
...
$bb11:
  assume ($i23 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 824, 43} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1));
  $p24.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 824, 43} true;
  assume {:verifier.code 0} true;
  $p24 := $p24.shadow;
  $p25 := $load.ref($M.5,$p24);
  $p25.shadow := $load.ref($M.5.shadow,$p24.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 824, 47} true;
  assume {:verifier.code 0} true;
  $i26 := $sub.i64($i21,1);
  $i26.shadow := $sub.i64($i21.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 824, 40} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($p25,$mul.ref($i26,8));
  $p27.shadow := $add.ref($p25.shadow,$mul.ref($i26.shadow,8));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 824, 40} true;
  assume {:verifier.code 0} true;
  assert ($p27 == $p27.shadow);
  $i28 := $load.i64($M.6,$p27);
  $i28.shadow := $load.i64($M.6.shadow,$p27.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 824, 56} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1));
  $p29.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 824, 56} true;
  assume {:verifier.code 0} true;
  $p29 := $p29.shadow;
  $p30 := $load.ref($M.7,$p29);
  $p30.shadow := $load.ref($M.7.shadow,$p29.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 824, 60} true;
  assume {:verifier.code 0} true;
  $i31 := $sub.i64($i21,1);
  $i31.shadow := $sub.i64($i21.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 824, 53} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($p30,$mul.ref($i31,8));
  $p32.shadow := $add.ref($p30.shadow,$mul.ref($i31.shadow,8));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 824, 53} true;
  assume {:verifier.code 0} true;
  assert ($p32 == $p32.shadow);
  $i33 := $load.i64($M.8,$p32);
  $i33.shadow := $load.i64($M.8.shadow,$p32.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 824, 16} true;
  assume {:verifier.code 0} true;
  call $i34, $i34.shadow := mbedtls_ct_mpi_uint_lt($i28, $i28.shadow, $i33, $i33.shadow);
  call {:cexpr "cond"} boogie_si_record_i32($i34);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 825, 28} true;
  assume {:verifier.code 0} true;
  $i35 := $sub.i32(1,$i22);
  $i35.shadow := $sub.i32(1,$i22.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 825, 22} true;
  assume {:verifier.code 0} true;
  $i36 := $and.i32($i34,$i35);
  $i36.shadow := $and.i32($i34.shadow,$i35.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 825, 37} true;
  assume {:verifier.code 0} true;
  $i37 := $and.i32($i36,$i12);
  $i37.shadow := $and.i32($i36.shadow,$i12.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 825, 14} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $i38 := $load.i32($M.4,$p2);
  $i38.shadow := $load.i32($M.4.shadow,$p2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 825, 14} true;
  assume {:verifier.code 0} true;
  $i39 := $or.i32($i38,$i37);
  $i39.shadow := $or.i32($i38.shadow,$i37.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 825, 14} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $M.4 := $store.i32($M.4,$p2,$i39);
  $M.4.shadow := $store.i32($M.4.shadow,$p2.shadow,$i39.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 826, 14} true;
  assume {:verifier.code 0} true;
  $i40 := $or.i32($i22,$i34);
  $i40.shadow := $or.i32($i22.shadow,$i34.shadow);
  call {:cexpr "done"} boogie_si_record_i32($i40);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 835, 43} true;
  assume {:verifier.code 0} true;
  $p41 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1));
  $p41.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 835, 43} true;
  assume {:verifier.code 0} true;
  $p41 := $p41.shadow;
  $p42 := $load.ref($M.7,$p41);
  $p42.shadow := $load.ref($M.7.shadow,$p41.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 835, 47} true;
  assume {:verifier.code 0} true;
  $i43 := $sub.i64($i21,1);
  $i43.shadow := $sub.i64($i21.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 835, 40} true;
  assume {:verifier.code 0} true;
  $p44 := $add.ref($p42,$mul.ref($i43,8));
  $p44.shadow := $add.ref($p42.shadow,$mul.ref($i43.shadow,8));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 835, 40} true;
  assume {:verifier.code 0} true;
  assert ($p44 == $p44.shadow);
  $i45 := $load.i64($M.8,$p44);
  $i45.shadow := $load.i64($M.8.shadow,$p44.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 835, 56} true;
  assume {:verifier.code 0} true;
  $p46 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1));
  $p46.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 835, 56} true;
  assume {:verifier.code 0} true;
  $p46 := $p46.shadow;
  $p47 := $load.ref($M.5,$p46);
  $p47.shadow := $load.ref($M.5.shadow,$p46.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 835, 60} true;
  assume {:verifier.code 0} true;
  $i48 := $sub.i64($i21,1);
  $i48.shadow := $sub.i64($i21.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 835, 53} true;
  assume {:verifier.code 0} true;
  $p49 := $add.ref($p47,$mul.ref($i48,8));
  $p49.shadow := $add.ref($p47.shadow,$mul.ref($i48.shadow,8));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 835, 53} true;
  assume {:verifier.code 0} true;
  assert ($p49 == $p49.shadow);
  $i50 := $load.i64($M.6,$p49);
  $i50.shadow := $load.i64($M.6.shadow,$p49.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 835, 16} true;
  assume {:verifier.code 0} true;
  call $i51, $i51.shadow := mbedtls_ct_mpi_uint_lt($i45, $i45.shadow, $i50, $i50.shadow);
  call {:cexpr "cond"} boogie_si_record_i32($i51);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 836, 28} true;
  assume {:verifier.code 0} true;
  $i52 := $sub.i32(1,$i40);
  $i52.shadow := $sub.i32(1,$i40.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 836, 22} true;
  assume {:verifier.code 0} true;
  $i53 := $and.i32($i51,$i52);
  $i53.shadow := $and.i32($i51.shadow,$i52.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 836, 43} true;
  assume {:verifier.code 0} true;
  $i54 := $sub.i32(1,$i12);
  $i54.shadow := $sub.i32(1,$i12.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 836, 37} true;
  assume {:verifier.code 0} true;
  $i55 := $and.i32($i53,$i54);
  $i55.shadow := $and.i32($i53.shadow,$i54.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 836, 14} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $i56 := $load.i32($M.4,$p2);
  $i56.shadow := $load.i32($M.4.shadow,$p2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 836, 14} true;
  assume {:verifier.code 0} true;
  $i57 := $or.i32($i56,$i55);
  $i57.shadow := $or.i32($i56.shadow,$i55.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 836, 14} true;
  assume {:verifier.code 0} true;
  assert ($p2 == $p2.shadow);
  $M.4 := $store.i32($M.4,$p2,$i57);
  $M.4.shadow := $store.i32($M.4.shadow,$p2.shadow,$i57.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 837, 14} true;
  assume {:verifier.code 0} true;
  $i58 := $or.i32($i40,$i51);
  $i58.shadow := $or.i32($i40.shadow,$i51.shadow);
  call {:cexpr "done"} boogie_si_record_i32($i58);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 838, 5} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume !($i23 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 840, 5} true;
  assume {:verifier.code 0} true;
  $i8 := 0;
  $i8.shadow := 0;
  goto $bb9;
$bb13:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 815, 28} true;
  assume {:verifier.code 0} true;
  $i59 := $add.i64($i21,$sub.i64(0,1));
  $i59.shadow := $add.i64($i21.shadow,$sub.i64(0,1));
  call {:cexpr "i"} boogie_si_record_i64($i59);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 815, 5} true;
  assume {:verifier.code 0} true;
  $i21 := $i59;
  $i21.shadow := $i59.shadow;
  $i22 := $i58;
  $i22.shadow := $i58.shadow;
  goto $bb10;
}
const mbedtls_mpi_lt_mpi_ct_wrapper: ref;
axiom (mbedtls_mpi_lt_mpi_ct_wrapper == $sub.ref(0,4128));
procedure {:entrypoint} mbedtls_mpi_lt_mpi_ct_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref)
...
requires {:public_in $load.i64, $M.7, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1)), 8} true;
requires {:public_in $load.i32, $M.2, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1)), 4} true;
requires {:public_in $load.i64, $M.1, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1)), 8} true;
requires {:public_in $load.i64, $M.5, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1)), 8} true;
...
requires ($load.i64($M.7,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1))) == $load.i64($M.7.shadow,$add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1))));
requires ($load.i32($M.2,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1))) == $load.i32($M.2.shadow,$add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(0,1))));
...
requires ($load.i64($M.5,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1))) == $load.i64($M.5.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(16,1))));
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 10, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_mpi_lt_mpi_ct_wrapper"} boogie_si_record_ref(mbedtls_mpi_lt_mpi_ct_wrapper);
  call {:cexpr "smack:arg:mbedtls_mpi_lt_mpi_ct_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:mbedtls_mpi_lt_mpi_ct_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:mbedtls_mpi_lt_mpi_ct_wrapper:$p2"} boogie_si_record_ref($p2);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 10, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 10, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p3, $p3.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 11, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p4 := __SMACK_value.ref($p1);
  $p4.shadow := $p4;
  assume $isExternal($p4);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p4);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 11, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 12, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p2} $p5 := __SMACK_value.ref($p2);
  $p5.shadow := $p5;
  assume $isExternal($p5);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p5);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 12, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 14, 29} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1));
  $p6.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 14, 29} true;
  assume {:verifier.code 0} true;
  $p6 := $p6.shadow;
  $i7 := $load.i64($M.0,$p6);
  $i7.shadow := $load.i64($M.0.shadow,$p6.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 14, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p0} {:field "$load.i64", $M.0, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1)), 8} $p8 := __SMACK_value.i64($i7);
  $p8.shadow := $p8;
  assume $isExternal($p8);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p8);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p8, $p8.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 15, 29} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1));
  $p9.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 15, 29} true;
  assume {:verifier.code 0} true;
  $p9 := $p9.shadow;
  $p10 := $load.ref($M.7,$p9);
  $p10.shadow := $load.ref($M.7.shadow,$p9.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 15, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p0} {:field "$load.i64", $M.7, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1)), 8} $p11 := __SMACK_value.ref($p10);
  $p11.shadow := $p11;
  assume $isExternal($p11);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p11);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p11, $p11.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 16, 29} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1));
  $p12.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 16, 29} true;
  assume {:verifier.code 0} true;
  $p12 := $p12.shadow;
  $i13 := $load.i32($M.2,$p12);
  $i13.shadow := $load.i32($M.2.shadow,$p12.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 16, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p0} {:field "$load.i32", $M.2, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1)), 4} $p14 := __SMACK_value.i32($i13);
  $p14.shadow := $p14;
  assume $isExternal($p14);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p14);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 16, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p14, $p14.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 18, 29} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1));
  $p15.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 18, 29} true;
  assume {:verifier.code 0} true;
  $p15 := $p15.shadow;
  $i16 := $load.i64($M.1,$p15);
  $i16.shadow := $load.i64($M.1.shadow,$p15.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 18, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.1, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1)), 8} $p17 := __SMACK_value.i64($i16);
  $p17.shadow := $p17;
  assume $isExternal($p17);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p17);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 18, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p17, $p17.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 19, 29} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1));
  $p18.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 19, 29} true;
  assume {:verifier.code 0} true;
  $p18 := $p18.shadow;
  $p19 := $load.ref($M.5,$p18);
  $p19.shadow := $load.ref($M.5.shadow,$p18.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 19, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.5, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1)), 8} $p20 := __SMACK_value.ref($p19);
  $p20.shadow := $p20;
  assume $isExternal($p20);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p20);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 19, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p20, $p20.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 20, 29} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1));
  $p21.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 20, 29} true;
  assume {:verifier.code 0} true;
  $p21 := $p21.shadow;
  $i22 := $load.i32($M.3,$p21);
  $i22.shadow := $load.i32($M.3.shadow,$p21.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 20, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i32", $M.3, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1)), 4} $p23 := __SMACK_value.i32($i22);
  $p23.shadow := $p23;
  assume $isExternal($p23);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p23);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 20, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p23, $p23.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call $i24, $i24.shadow := mbedtls_mpi_lt_mpi_ct($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow);
  assume {:sourceloc "mbedtls_mpi_lt_mpi_ct.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assume {:VFCTMarked} true;
...
axiom (__SMACK_loop_exit == $sub.ref(0,19608));
...
axiom (__SMACK_decls == $sub.ref(0,20640));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,21672));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,22704));
...
axiom (__SMACK_static_init == $sub.ref(0,23736));
