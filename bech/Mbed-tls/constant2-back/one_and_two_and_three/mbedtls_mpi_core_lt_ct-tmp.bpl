...
const mbedtls_mpi_core_lt_ct: ref;
axiom (mbedtls_mpi_core_lt_ct == $sub.ref(0,2064));
procedure {:inline 1} mbedtls_mpi_core_lt_ct($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
  ...
  var $i26.shadow: i64;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 745, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_mpi_core_lt_ct:arg:limbs"} boogie_si_record_i64($i2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 745, 10} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  $i3.shadow := 0;
...
$bb1:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 745, 30} true;
  assume {:verifier.code 0} true;
  $i6 := $ugt.i64($i5,0);
  $i6.shadow := $ugt.i64($i5.shadow,0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 745, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i6 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 754, 44} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i64($i5,1);
  $i7.shadow := $sub.i64($i5.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 754, 40} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p1,$mul.ref($i7,8));
  $p8.shadow := $add.ref($p1.shadow,$mul.ref($i7.shadow,8));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 754, 40} true;
  assume {:verifier.code 0} true;
  $p8 := $p8.shadow;
  $i9 := $load.i64($M.0,$p8);
  $i9.shadow := $load.i64($M.0.shadow,$p8.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 754, 54} true;
  assume {:verifier.code 0} true;
  $i10 := $sub.i64($i5,1);
  $i10.shadow := $sub.i64($i5.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 754, 50} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p0,$mul.ref($i10,8));
  $p11.shadow := $add.ref($p0.shadow,$mul.ref($i10.shadow,8));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 754, 50} true;
  assume {:verifier.code 0} true;
  $p11 := $p11.shadow;
  $i12 := $load.i64($M.1,$p11);
  $i12.shadow := $load.i64($M.1.shadow,$p11.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 754, 16} true;
  assume {:verifier.code 0} true;
  call $i13, $i13.shadow := mbedtls_ct_mpi_uint_lt($i9, $i9.shadow, $i12, $i12.shadow);
  call {:cexpr "cond"} boogie_si_record_i32($i13);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 755, 14} true;
  assume {:verifier.code 0} true;
  $i14 := $or.i32($i4,$i13);
  $i14.shadow := $or.i32($i4.shadow,$i13.shadow);
  call {:cexpr "done"} boogie_si_record_i32($i14);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 763, 44} true;
  assume {:verifier.code 0} true;
  $i15 := $sub.i64($i5,1);
  $i15.shadow := $sub.i64($i5.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 763, 40} true;
  assume {:verifier.code 0} true;
  ...
  $i17.shadow := $load.i64($M.1.shadow,$p16.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 763, 54} true;
  assume {:verifier.code 0} true;
  $i18 := $sub.i64($i5,1);
  $i18.shadow := $sub.i64($i5.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 763, 50} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 763, 16} true;
  assume {:verifier.code 0} true;
  call $i21, $i21.shadow := mbedtls_ct_mpi_uint_lt($i17, $i17.shadow, $i20, $i20.shadow);
  call {:cexpr "cond"} boogie_si_record_i32($i21);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 764, 27} true;
  assume {:verifier.code 0} true;
  $i22 := $sub.i32(1,$i14);
  $i22.shadow := $sub.i32(1,$i14.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 764, 21} true;
  assume {:verifier.code 0} true;
  $i23 := $and.i32($i21,$i22);
  $i23.shadow := $and.i32($i21.shadow,$i22.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 764, 13} true;
  assume {:verifier.code 0} true;
  $i24 := $or.i32($i3,$i23);
  $i24.shadow := $or.i32($i3.shadow,$i23.shadow);
  call {:cexpr "ret"} boogie_si_record_i32($i24);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 765, 14} true;
  assume {:verifier.code 0} true;
  $i25 := $or.i32($i14,$i21);
  $i25.shadow := $or.i32($i14.shadow,$i21.shadow);
  call {:cexpr "done"} boogie_si_record_i32($i25);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 766, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i6 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 773, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $r.shadow := $i3.shadow;
  $exn := false;
  ...
  return;
$bb4:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 745, 36} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i64($i5,$sub.i64(0,1));
  $i26.shadow := $add.i64($i5.shadow,$sub.i64(0,1));
  call {:cexpr "i"} boogie_si_record_i64($i26);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 745, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i24;
  $i3.shadow := $i24.shadow;
  $i4 := $i25;
...
axiom (mbedtls_ct_mpi_uint_lt == $sub.ref(0,3096));
...
const mbedtls_mpi_core_lt_ct_wrapper: ref;
axiom (mbedtls_mpi_core_lt_ct_wrapper == $sub.ref(0,4128));
procedure {:entrypoint} mbedtls_mpi_core_lt_ct_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64)
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_mpi_core_lt_ct.c", 10, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_mpi_core_lt_ct_wrapper"} boogie_si_record_ref(mbedtls_mpi_core_lt_ct_wrapper);
  call {:cexpr "smack:arg:mbedtls_mpi_core_lt_ct_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:mbedtls_mpi_core_lt_ct_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:mbedtls_mpi_core_lt_ct_wrapper:$i2"} boogie_si_record_i64($i2);
  call {:cexpr "mbedtls_mpi_core_lt_ct_wrapper:arg:limbs"} boogie_si_record_i64($i2);
  assume {:sourceloc "mbedtls_mpi_core_lt_ct.c", 10, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_mpi_core_lt_ct.c", 10, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p3, $p3.shadow);
  assume {:sourceloc "mbedtls_mpi_core_lt_ct.c", 11, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p4 := __SMACK_value.ref($p1);
  $p4.shadow := $p4;
  assume $isExternal($p4);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p4);
  assume {:sourceloc "mbedtls_mpi_core_lt_ct.c", 11, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "mbedtls_mpi_core_lt_ct.c", 12, 12} true;
  assume {:verifier.code 0} true;
  call {:name $i2} $p5 := __SMACK_value.i64($i2);
  $p5.shadow := $p5;
  assume $isExternal($p5);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p5);
  assume {:sourceloc "mbedtls_mpi_core_lt_ct.c", 12, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "mbedtls_mpi_core_lt_ct.c", 17, 2} true;
  assume {:verifier.code 0} true;
  call $i6, $i6.shadow := mbedtls_mpi_core_lt_ct($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow);
  assume {:sourceloc "mbedtls_mpi_core_lt_ct.c", 19, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assume {:VFCTMarked} true;
