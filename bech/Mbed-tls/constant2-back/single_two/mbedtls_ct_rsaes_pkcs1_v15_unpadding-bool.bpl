...
procedure {:inline 1} mbedtls_ct_uint_mask($i0: i32, $i0.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i1: i32;
  var $i1.dup: i1;
...
procedure {:inline 1} mbedtls_ct_uint_if($i0: i32, $i0.dup: i1, $i1: i32, $i1.dup: i1, $i2: i32, $i2.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i3: i32;
  var $i3.dup: i1;
...
$bb0:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 262, 21} true;
  assume {:verifier.code 0} true;
  call $i3, $i3.dup := mbedtls_ct_uint_mask($i0, $i0.dup);
...
procedure {:inline 1} mbedtls_ct_rsaes_pkcs1_v15_unpadding($p0: ref, $p0.dup: i1, $i1: i64, $i1.dup: i1, $p2: ref, $p2.dup: i1, $i3: i64, $i3.dup: i1, $p4: ref, $p4.dup: i1) returns ($r: i32, $r.dup: i1)
...
$bb5:
  ...
  $p22.dup := $or.i1($p0.dup,$or.i1($i18.dup,0));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 24} true;
  assume {:verifier.code 0} true;
  ...
  $p25.dup := $or.i1($p0.dup,$or.i1($i18.dup,0));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 51} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  assume {:verifier.code 0} true;
  call $i57, $i57.dup := mbedtls_ct_uint_if($i52, $i52.dup, $i53, $i53.dup, $i56, $i56.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 906, 22} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call $i59, $i59.dup := mbedtls_ct_size_gt($i58, $i58.dup, $i8, $i8.dup);
  call {:cexpr "output_too_large"} boogie_si_record_i32($i59);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 922, 21} true;
  assume {:verifier.code 0} true;
  call $i60, $i60.dup := mbedtls_ct_uint_if($i59, $i59.dup, 17408, 0, 0, 0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 920, 19} true;
  assume {:verifier.code 0} true;
  call $i61, $i61.dup := mbedtls_ct_uint_if($i52, $i52.dup, 16640, 0, $i60, $i60.dup);
  ...
  assume {:verifier.code 0} true;
  $i63 := $or.i32($i52,$i59);
  $i63.dup := $or.i1($i52.dup,$i59.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 932, 11} true;
  assume {:verifier.code 0} true;
  call $i64, $i64.dup := mbedtls_ct_uint_mask($i63, $i63.dup);
...
$bb8:
  ...
  assert {:unlikely_shadow_invariant ($i59.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i58.dup == 0)} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 933, 20} true;
  assume {:verifier.code 0} true;
  $i66 := $ult.i64($i65,$i1);
  $i66.dup := $or.i1($i65.dup,$i1.dup);
...
$bb9:
  ...
  $M.0.dup := $store.i1($M.0.dup,$p68,$i72.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 934, 9} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb10:
  ...
  assume {:verifier.code 0} true;
  call $i76, $i76.dup := mbedtls_ct_uint_if($i59, $i59.dup, $i74, $i74.dup, $i75, $i75.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 940, 22} true;
  assume {:verifier.code 0} true;
...
$bb12:
  ...
  $p84.dup := $or.i1($p0.dup,$or.i1($i1.dup,0));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 962, 38} true;
  assume {:verifier.code 0} true;
  $i85 := $sub.i64(0,$i8);
  $i85.dup := $or.i1(0,$i8.dup);
  $i86 := $add.i64($i1,$i85);
  $i86.dup := $or.i1($i1.dup,$i85.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 962, 38} true;
  assume {:verifier.code 0} true;
  ...
  call $M.1, $M.1.dup := $memcpy.i8($M.1, $M.1.dup, $M.0, $M.0.dup, $p2, $p2.dup, $p87, $p87.dup, $i8, $i8.dup, false, false);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 962, 9} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb13:
...
$bb14:
  ...
  $M.2.dup := $store.i1($M.2.dup,$p4,$i77.dup);
...
procedure {:inline 1} mbedtls_ct_size_gt($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i2: i64;
  var $i2.dup: i1;
...
procedure {:inline 1} mbedtls_ct_mem_move_to_left($p0: ref, $p0.dup: i1, $i1: i64, $i1.dup: i1, $i2: i64, $i2.dup: i1)
modifies $exn, $M.0;
{
  var $i3: i1;
  var $i3.dup: i1;
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  $i6 := $sub.i64($i1,$i2);
  $i6.dup := $or.i1($i1.dup,$i2.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 392, 26} true;
  assume {:verifier.code 0} true;
  call $i7, $i7.dup := mbedtls_ct_size_gt($i6, $i6.dup, $i4, $i4.dup);
...
$bb8:
  ...
  $p11.dup := $or.i1($p0.dup,$or.i1($i8.dup,0));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 398, 37} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call $i18, $i18.dup := mbedtls_ct_uint_if($i7, $i7.dup, $i16, $i16.dup, $i17, $i17.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 400, 22} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  assume {:verifier.code 0} true;
  call $i26, $i26.dup := mbedtls_ct_uint_if($i7, $i7.dup, $i25, $i25.dup, 0, 0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 402, 24} true;
  assume {:verifier.code 0} true;
  ...
  $M.0.dup := $store.i1($M.0.dup,$p29,$i27.dup);
...
procedure {:entrypoint} mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper($p0: ref, $p0.dup: i1, $i1: i64, $i1.dup: i1, $p2: ref, $p2.dup: i1, $i3: i64, $i3.dup: i1, $p4: ref, $p4.dup: i1)
...
requires ($i3.dup == 0);
requires ($p4.dup == 0);
requires ($load.i64($M.4.dup,($p4 + 0)) == 0);
requires ($load.i64($M.4.dup,($p4 + 8)) == 0);
requires ($load.i64($M.4.dup,($p4 + 16)) == 0);
requires ($load.i64($M.4.dup,($p4 + 24)) == 0);
requires ($load.i64($M.4.dup,($p4 + 32)) == 0);
requires ($load.i64($M.4.dup,($p4 + 40)) == 0);
requires ($load.i64($M.4.dup,($p4 + 48)) == 0);
requires ($load.i64($M.4.dup,($p4 + 56)) == 0);
requires ($load.i64($M.4.dup,($p4 + 64)) == 0);
requires ($load.i64($M.4.dup,($p4 + 72)) == 0);
requires ($load.i64($M.4.dup,($p4 + 80)) == 0);
requires ($load.i64($M.4.dup,($p4 + 88)) == 0);
requires ($load.i64($M.4.dup,($p4 + 96)) == 0);
requires ($load.i64($M.4.dup,($p4 + 104)) == 0);
requires ($load.i64($M.4.dup,($p4 + 112)) == 0);
requires ($load.i64($M.4.dup,($p4 + 120)) == 0);
requires ($load.i64($M.4.dup,($p4 + 128)) == 0);
requires ($load.i64($M.4.dup,($p4 + 136)) == 0);
requires ($load.i64($M.4.dup,($p4 + 144)) == 0);
requires ($load.i64($M.4.dup,($p4 + 152)) == 0);
requires ($load.i64($M.4.dup,($p4 + 160)) == 0);
requires ($load.i64($M.4.dup,($p4 + 168)) == 0);
requires ($load.i64($M.4.dup,($p4 + 176)) == 0);
requires ($load.i64($M.4.dup,($p4 + 184)) == 0);
requires ($load.i64($M.4.dup,($p4 + 192)) == 0);
requires ($load.i64($M.4.dup,($p4 + 200)) == 0);
requires ($load.i64($M.4.dup,($p4 + 208)) == 0);
requires ($load.i64($M.4.dup,($p4 + 216)) == 0);
requires ($load.i64($M.4.dup,($p4 + 224)) == 0);
requires ($load.i64($M.4.dup,($p4 + 232)) == 0);
requires ($load.i64($M.4.dup,($p4 + 240)) == 0);
requires ($load.i64($M.4.dup,($p4 + 248)) == 0);
{
  var $p5: ref;
  var $p5.dup: i1;
  var $p6: ref;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i12, $i12.dup := mbedtls_ct_rsaes_pkcs1_v15_unpadding($p0, $p0.dup, $i1, $i1.dup, $p2, $p2.dup, $i3, $i3.dup, $p4, $p4.dup);
