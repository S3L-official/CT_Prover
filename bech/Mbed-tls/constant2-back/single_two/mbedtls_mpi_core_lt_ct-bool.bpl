...
procedure {:inline 1} mbedtls_mpi_core_lt_ct($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i64, $i2.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i3: i32;
  var $i3.dup: i1;
...
$bb2:
  ...
  $p8.dup := $or.i1($p1.dup,$or.i1($i7.dup,0));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 754, 40} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  $i26.dup := $or.i1($i5.dup,$or.i1(0,0));
...
procedure {:entrypoint} mbedtls_mpi_core_lt_ct_wrapper($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i64, $i2.dup: i1)
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i6, $i6.dup := mbedtls_mpi_core_lt_ct($p0, $p0.dup, $p1, $p1.dup, $i2, $i2.dup);
