...
procedure {:inline 1} mbedtls_ct_mpi_uint_lt($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i2: i64;
  var $i2.dup: i1;
...
procedure {:inline 1} mbedtls_mpi_lt_mpi_ct($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $M.4, $exn;
{
  var $p3: ref;
  var $p3.dup: i1;
...
$bb11:
  ...
  assume {:verifier.code 0} true;
  $i37 := $and.i32($i36,$i12);
  $i37.dup := $or.i1($i36.dup,$i12.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 825, 14} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p2.dup == 0));
  $i38 := $load.i32($M.4,$p2);
  $i38.dup := $load.i1($M.4.dup,$p2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 825, 14} true;
  assume {:verifier.code 0} true;
  $i39 := $or.i32($i38,$i37);
  $i39.dup := $or.i1($i38.dup,$i37.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 825, 14} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p2.dup == 0));
  $M.4 := $store.i32($M.4,$p2,$i39);
  $M.4.dup := $store.i1($M.4.dup,$p2,$i39.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 826, 14} true;
  assume {:verifier.code 0} true;
  $i40 := $or.i32($i22,$i34);
  $i40.dup := $or.i1($i22.dup,$i34.dup);
  ...
  $shadow_ok := ($shadow_ok && ($p2.dup == 0));
  $i56 := $load.i32($M.4,$p2);
  $i56.dup := $load.i1($M.4.dup,$p2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 836, 14} true;
  assume {:verifier.code 0} true;
  $i57 := $or.i32($i56,$i55);
  $i57.dup := $or.i1($i56.dup,$i55.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 836, 14} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p2.dup == 0));
  $M.4 := $store.i32($M.4,$p2,$i57);
  $M.4.dup := $store.i1($M.4.dup,$p2,$i57.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 837, 14} true;
  assume {:verifier.code 0} true;
  $i58 := $or.i32($i40,$i51);
  $i58.dup := $or.i1($i40.dup,$i51.dup);
...
$bb13:
  ...
  $i59.dup := $or.i1($i21.dup,$or.i1(0,0));
...
procedure {:entrypoint} mbedtls_mpi_lt_mpi_ct_wrapper($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1)
...
requires ($load.i64($M.7.dup,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1))) == 0);
requires ($load.i32($M.2.dup,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1))) == 0);
requires ($load.i64($M.1.dup,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1))) == 0);
requires ($load.i64($M.5.dup,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1))) == 0);
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i24, $i24.dup := mbedtls_mpi_lt_mpi_ct($p0, $p0.dup, $p1, $p1.dup, $p2, $p2.dup);
