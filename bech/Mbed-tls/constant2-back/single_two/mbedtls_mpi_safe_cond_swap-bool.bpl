...
$bb3:
  ...
  assume {:verifier.code 0} true;
  call $i3, $i3.dup := menset.ref.i32.i64($p0, $p0.dup, 0, 0, $i1, $i1.dup);
  assume {:sourceloc "../mbedtls/library/platform_util.c", 72, 9} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
...
procedure {:inline 1} menset.ref.i32.i64(p.0: ref, p.0.dup: i1, p.1: i32, p.1.dup: i1, p.2: i64, p.2.dup: i1) returns ($r: i32, $r.dup: i1);
...
$bb11:
  ...
  call $M.2, $M.2.dup := $memcpy.i8($M.2, $M.2.dup, $M.2, $M.2.dup, $p13, $p13.dup, $p16, $p16.dup, $i19, $i19.dup, false, false);
...
$bb13:
  ...
  $M.0.dup := $store.i1($M.0.dup,$p27,$i1.dup);
  ...
  $M.1.dup := $store.ref($M.1.dup,$p28,$p7.dup);
...
procedure {:inline 1} mbedtls_mpi_core_cond_swap($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i64, $i2.dup: i1, $i3: i8, $i3.dup: i1)
modifies $exn, $M.2;
{
  var $i4: i1;
  var $i4.dup: i1;
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  call $i6, $i6.dup := mbedtls_ct_mpi_uint_mask($i5, $i5.dup);
...
$bb5:
  ...
  $p9.dup := $or.i1($p0.dup,$or.i1($i7.dup,0));
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 182, 32} true;
  assume {:verifier.code 0} true;
  ...
  $p15.dup := $or.i1($p1.dup,$or.i1($i7.dup,0));
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 183, 42} true;
  assume {:verifier.code 0} true;
  ...
  $p20.dup := $or.i1($p1.dup,$or.i1($i7.dup,0));
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 184, 18} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p20.dup == 0));
  ...
  $i22.dup := $or.i1($i6.dup,$or.i1(0,0));
...
procedure {:inline 1} mbedtls_mpi_safe_cond_swap($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i8, $i2.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn, $M.3;
...
$bb13:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 720, 5} true;
  assume {:verifier.code 0} true;
  call $i12, $i12.dup := mbedtls_mpi_grow($p1, $p1.dup, $i11, $i11.dup);
...
$bb16:
  ...
  assume {:verifier.code 0} true;
  call $i20, $i20.dup := mbedtls_ct_cond_select_sign($i2, $i2.dup, $i17, $i17.dup, $i19, $i19.dup);
  ...
  assume {:verifier.code 0} true;
  call $i24, $i24.dup := mbedtls_ct_cond_select_sign($i2, $i2.dup, $i15, $i15.dup, $i23, $i23.dup);
  ...
  assume {:verifier.code 0} true;
  call mbedtls_mpi_core_cond_swap($p27, $p27.dup, $p29, $p29.dup, $i31, $i31.dup, $i2, $i2.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 726, 5} true;
  assume {:verifier.code 0} true;
  $i9 := $i12;
  $i9.dup := $i12.dup;
...
procedure {:entrypoint} mbedtls_mpi_safe_cond_swap_wrapper($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i8, $i2.dup: i1)
...
requires ($p0.dup == 0);
requires ($p1.dup == 0);
requires ($load.i64($M.0.dup,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1))) == 0);
requires ($load.i64($M.1.dup,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1))) == 0);
requires ($load.i32($M.3.dup,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1))) == 0);
requires ($load.i64($M.0.dup,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1))) == 0);
requires ($load.i64($M.1.dup,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1))) == 0);
requires ($load.i32($M.3.dup,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1))) == 0);
{
  var $p3: ref;
  var $p3.dup: i1;
  var $p4: ref;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i23, $i23.dup := mbedtls_mpi_safe_cond_swap($p0, $p0.dup, $p1, $p1.dup, $i2, $i2.dup);
...
$bb2:
  ...
  call $M.2, $M.2.dup := $memset.i8($M.2, $M.2.dup, $p6, $p6.dup, 0, 0, $i7, $i7.dup, false, false);
