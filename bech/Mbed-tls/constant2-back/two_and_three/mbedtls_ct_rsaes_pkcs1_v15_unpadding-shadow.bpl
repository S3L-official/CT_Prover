...
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0,2064));
...
const mbedtls_ct_uint_mask: ref;
axiom (mbedtls_ct_uint_mask == $sub.ref(0,3096));
procedure {:inline 1} mbedtls_ct_uint_mask($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn, $exn.shadow;
{
  ...
  var $i4.shadow: i32;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 79, 27} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_uint_mask:arg:value"} boogie_si_record_i32($i0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 79, 27} true;
  assume {:verifier.code 0} true;
  $i1 := $sub.i32(0,$i0);
  $i1.shadow := $sub.i32(0,$i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 79, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $or.i32($i0,$i1);
  $i2.shadow := $or.i32($i0.shadow,$i1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 79, 37} true;
  assume {:verifier.code 0} true;
  $i3 := $lshr.i32($i2,31);
  $i3.shadow := $lshr.i32($i2.shadow,31);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 79, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0,$i3);
  $i4.shadow := $sub.i32(0,$i3.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 79, 5} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $r.shadow := $i4.shadow;
  $exn := false;
...
const mbedtls_ct_uint_if: ref;
axiom (mbedtls_ct_uint_if == $sub.ref(0,4128));
procedure {:inline 1} mbedtls_ct_uint_if($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn, $exn.shadow;
{
  var $i3: i32;
  var $i3.shadow: i32;
  ...
  var $i7.shadow: i32;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 262, 21} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_uint_if:arg:condition"} boogie_si_record_i32($i0);
  call {:cexpr "mbedtls_ct_uint_if:arg:if1"} boogie_si_record_i32($i1);
  call {:cexpr "mbedtls_ct_uint_if:arg:if0"} boogie_si_record_i32($i2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 262, 21} true;
  assume {:verifier.code 0} true;
  call $i3, $i3.shadow := mbedtls_ct_uint_mask($i0, $i0.shadow);
  call {:cexpr "mask"} boogie_si_record_i32($i3);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 263, 20} true;
  assume {:verifier.code 0} true;
  $i4 := $and.i32($i3,$i1);
  $i4.shadow := $and.i32($i3.shadow,$i1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 263, 31} true;
  assume {:verifier.code 0} true;
  $i5 := $xor.i32($i3,$sub.i32(0,1));
  $i5.shadow := $xor.i32($i3.shadow,$sub.i32(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 263, 37} true;
  assume {:verifier.code 0} true;
  $i6 := $and.i32($i5,$i2);
  $i6.shadow := $and.i32($i5.shadow,$i2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 263, 28} true;
  assume {:verifier.code 0} true;
  $i7 := $or.i32($i4,$i6);
  $i7.shadow := $or.i32($i4.shadow,$i6.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 263, 5} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $r.shadow := $i7.shadow;
  $exn := false;
...
const mbedtls_ct_rsaes_pkcs1_v15_unpadding: ref;
axiom (mbedtls_ct_rsaes_pkcs1_v15_unpadding == $sub.ref(0,5160));
procedure {:inline 1} mbedtls_ct_rsaes_pkcs1_v15_unpadding($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64, $p2: ref, $p2.shadow: ref, $i3: i64, $i3.shadow: i64, $p4: ref, $p4.shadow: ref) returns ($r: i32, $r.shadow: i32)
modifies $shadow_ok, $M.0, $M.0.shadow, $M.1, $M.1.shadow, $M.2, $M.2.shadow, $exn, $exn.shadow;
{
  var $i5: i64;
  var $i5.shadow: i64;
  var $i6: i1;
  ...
  var $p87.shadow: ref;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 872, 50} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_rsaes_pkcs1_v15_unpadding:arg:ilen"} boogie_si_record_i64($i1);
  call {:cexpr "mbedtls_ct_rsaes_pkcs1_v15_unpadding:arg:output_max_len"} boogie_si_record_i64($i3);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 872, 50} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i64($i1,11);
  $i5.shadow := $sub.i64($i1.shadow,11);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 872, 43} true;
  assume {:verifier.code 0} true;
  $i6 := $ugt.i64($i3,$i5);
  $i6.shadow := $ugt.i64($i3.shadow,$i5.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 872, 26} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 872, 64} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i64($i1,11);
  $i7.shadow := $sub.i64($i1.shadow,11);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 872, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $i7;
  $i8.shadow := $i7.shadow;
...
$bb3:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 872, 26} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 877, 12} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(0,1));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 877, 12} true;
  assume {:verifier.code 0} true;
  $p9 := $p9.shadow;
  $i10 := $load.i8($M.0,$p9);
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 877, 9} true;
  assume {:verifier.code 0} true;
  $i12 := $or.i32(0,$i11);
  $i12.shadow := $or.i32(0,$i11.shadow);
  call {:cexpr "bad"} boogie_si_record_i32($i12);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 882, 12} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($p0,$mul.ref(1,1));
  $p13.shadow := $add.ref($p0.shadow,$mul.ref(1,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 882, 12} true;
  assume {:verifier.code 0} true;
  $p13 := $p13.shadow;
  $i14 := $load.i8($M.0,$p13);
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 882, 21} true;
  assume {:verifier.code 0} true;
  $i16 := $xor.i32($i15,2);
  $i16.shadow := $xor.i32($i15.shadow,2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 882, 9} true;
  assume {:verifier.code 0} true;
  $i17 := $or.i32($i12,$i16);
  $i17.shadow := $or.i32($i12.shadow,$i16.shadow);
  call {:cexpr "bad"} boogie_si_record_i32($i17);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 886, 10} true;
  assume {:verifier.code 0} true;
  $i18 := 2;
  $i18.shadow := 2;
  $i19 := 0;
...
$bb4:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 886, 19} true;
  assume {:verifier.code 0} true;
  $i21 := $ult.i64($i18,$i1);
  $i21.shadow := $ult.i64($i18.shadow,$i1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 886, 5} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i21 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 24} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p0,$mul.ref($i18,1));
  $p22.shadow := $add.ref($p0.shadow,$mul.ref($i18.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 24} true;
  assume {:verifier.code 0} true;
  $p22 := $p22.shadow;
  $i23 := $load.i8($M.0,$p22);
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 51} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($p0,$mul.ref($i18,1));
  $p25.shadow := $add.ref($p0.shadow,$mul.ref($i18.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 51} true;
  assume {:verifier.code 0} true;
  $p25 := $p25.shadow;
  $i26 := $load.i8($M.0,$p25);
  $i26.shadow := $load.i8($M.0.shadow,$p25.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 51} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i8.i32($i26);
  $i27.shadow := $zext.i8.i32($i26.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 50} true;
  assume {:verifier.code 0} true;
  $i28 := $sub.i32(0,$i27);
  $i28.shadow := $sub.i32(0,$i27.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 35} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i30 := $zext.i8.i32($i29);
  $i30.shadow := $zext.i8.i32($i29.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 33} true;
  assume {:verifier.code 0} true;
  $i31 := $or.i32($i24,$i30);
  $i31.shadow := $or.i32($i24.shadow,$i30.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 61} true;
  assume {:verifier.code 0} true;
  $i32 := $ashr.i32($i31,7);
  $i32.shadow := $ashr.i32($i31.shadow,7);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 67} true;
  assume {:verifier.code 0} true;
  $i33 := $xor.i32($i32,1);
  $i33.shadow := $xor.i32($i32.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 19} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i8.i32($i20);
  $i34.shadow := $zext.i8.i32($i20.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 19} true;
  assume {:verifier.code 0} true;
  $i35 := $or.i32($i34,$i33);
  $i35.shadow := $or.i32($i34.shadow,$i33.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 888, 19} true;
  assume {:verifier.code 0} true;
  $i36 := $trunc.i32.i8($i35);
  $i36.shadow := $trunc.i32.i8($i35.shadow);
  call {:cexpr "pad_done"} boogie_si_record_i8($i36);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 889, 24} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i8.i32($i36);
  $i37.shadow := $zext.i8.i32($i36.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 889, 51} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i8.i32($i36);
  $i38.shadow := $zext.i8.i32($i36.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 889, 50} true;
  assume {:verifier.code 0} true;
  $i39 := $sub.i32(0,$i38);
  $i39.shadow := $sub.i32(0,$i38.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 889, 35} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 889, 33} true;
  assume {:verifier.code 0} true;
  $i42 := $or.i32($i37,$i41);
  $i42.shadow := $or.i32($i37.shadow,$i41.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 889, 61} true;
  assume {:verifier.code 0} true;
  $i43 := $ashr.i32($i42,7);
  $i43.shadow := $ashr.i32($i42.shadow,7);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 889, 67} true;
  assume {:verifier.code 0} true;
  $i44 := $xor.i32($i43,1);
  $i44.shadow := $xor.i32($i43.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 889, 22} true;
  assume {:verifier.code 0} true;
  $i45 := $sext.i32.i64($i44);
  $i45.shadow := $sext.i32.i64($i44.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 889, 19} true;
  assume {:verifier.code 0} true;
  $i46 := $add.i64($i19,$i45);
  $i46.shadow := $add.i64($i19.shadow,$i45.shadow);
  call {:cexpr "pad_count"} boogie_si_record_i64($i46);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 890, 5} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !($i21 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 894, 32} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i8.i32($i20);
  $i48.shadow := $zext.i8.i32($i20.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 894, 12} true;
  assume {:verifier.code 0} true;
  call $i49, $i49.shadow := mbedtls_ct_uint_if($i48, $i48.shadow, 0, 0, 1, 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 894, 9} true;
  assume {:verifier.code 0} true;
  $i50 := $or.i32($i17,$i49);
  $i50.shadow := $or.i32($i17.shadow,$i49.shadow);
  call {:cexpr "bad"} boogie_si_record_i32($i50);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 897, 12} true;
  assume {:verifier.code 0} true;
  call $i51, $i51.shadow := mbedtls_ct_size_gt(8, 8, $i19, $i19.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 897, 9} true;
  assume {:verifier.code 0} true;
  $i52 := $or.i32($i50,$i51);
  $i52.shadow := $or.i32($i50.shadow,$i51.shadow);
  call {:cexpr "bad"} boogie_si_record_i32($i52);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 907, 30} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i64.i32($i8);
  $i53.shadow := $trunc.i64.i32($i8.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 908, 43} true;
  assume {:verifier.code 0} true;
  $i54 := $sub.i64($i1,$i19);
  $i54.shadow := $sub.i64($i1.shadow,$i19.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 908, 55} true;
  assume {:verifier.code 0} true;
  $i55 := $sub.i64($i54,3);
  $i55.shadow := $sub.i64($i54.shadow,3);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 908, 25} true;
  assume {:verifier.code 0} true;
  $i56 := $trunc.i64.i32($i55);
  $i56.shadow := $trunc.i64.i32($i55.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 906, 22} true;
  assume {:verifier.code 0} true;
  call $i57, $i57.shadow := mbedtls_ct_uint_if($i52, $i52.shadow, $i53, $i53.shadow, $i56, $i56.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 906, 22} true;
  assume {:verifier.code 0} true;
  $i58 := $zext.i32.i64($i57);
  $i58.shadow := $zext.i32.i64($i57.shadow);
  call {:cexpr "plaintext_size"} boogie_si_record_i64($i58);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 912, 24} true;
  assume {:verifier.code 0} true;
  call $i59, $i59.shadow := mbedtls_ct_size_gt($i58, $i58.shadow, $i8, $i8.shadow);
  call {:cexpr "output_too_large"} boogie_si_record_i32($i59);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 922, 21} true;
  assume {:verifier.code 0} true;
  call $i60, $i60.shadow := mbedtls_ct_uint_if($i59, $i59.shadow, 17408, 17408, 0, 0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 920, 19} true;
  assume {:verifier.code 0} true;
  call $i61, $i61.shadow := mbedtls_ct_uint_if($i52, $i52.shadow, 16640, 16640, $i60, $i60.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 920, 11} true;
  assume {:verifier.code 0} true;
  $i62 := $sub.i32(0,$i61);
  $i62.shadow := $sub.i32(0,$i61.shadow);
  call {:cexpr "ret"} boogie_si_record_i32($i62);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 932, 37} true;
  assume {:verifier.code 0} true;
  $i63 := $or.i32($i52,$i59);
  $i63.shadow := $or.i32($i52.shadow,$i59.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 932, 11} true;
  assume {:verifier.code 0} true;
  call $i64, $i64.shadow := mbedtls_ct_uint_mask($i63, $i63.shadow);
  call {:cexpr "bad"} boogie_si_record_i32($i64);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 933, 10} true;
  assume {:verifier.code 0} true;
  $i65 := 11;
  $i65.shadow := 11;
  goto $bb8;
$bb7:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 886, 28} true;
  assume {:verifier.code 0} true;
  $i47 := $add.i64($i18,1);
  $i47.shadow := $add.i64($i18.shadow,1);
  call {:cexpr "i"} boogie_si_record_i64($i47);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 886, 5} true;
  assume {:verifier.code 0} true;
  $i18 := $i47;
  $i18.shadow := $i47.shadow;
  $i19 := $i46;
...
$bb8:
  ...
  $i8 := $i8.shadow;
  $i65 := $i65.shadow;
  assert {:unlikely_shadow_invariant ($i59 == $i59.shadow)} true;
  assert {:unlikely_shadow_invariant ($i58 == $i58.shadow)} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 933, 20} true;
  assume {:verifier.code 0} true;
  $i66 := $ult.i64($i65,$i1);
  $i66.shadow := $ult.i64($i65.shadow,$i1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 933, 5} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume ($i66 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 934, 21} true;
  assume {:verifier.code 0} true;
  $i67 := $xor.i32($i64,$sub.i32(0,1));
  $i67.shadow := $xor.i32($i64.shadow,$sub.i32(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 934, 9} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($p0,$mul.ref($i65,1));
  $p68.shadow := $add.ref($p0.shadow,$mul.ref($i65.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 934, 18} true;
  assume {:verifier.code 0} true;
  $p68 := $p68.shadow;
  $i69 := $load.i8($M.0,$p68);
  $i69.shadow := $load.i8($M.0.shadow,$p68.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 934, 18} true;
  assume {:verifier.code 0} true;
  $i70 := $zext.i8.i32($i69);
  ...
  assume {:verifier.code 0} true;
  $i71 := $and.i32($i70,$i67);
  $i71.shadow := $and.i32($i70.shadow,$i67.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 934, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $p68 := $p68.shadow;
  $M.0 := $store.i8($M.0,$p68,$i72);
  $M.0.shadow := $store.i8($M.0.shadow,$p68.shadow,$i72.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 934, 9} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb10:
  assume !($i66 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 941, 42} true;
  assume {:verifier.code 0} true;
  $i74 := $trunc.i64.i32($i8);
  $i74.shadow := $trunc.i64.i32($i8.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 942, 42} true;
  assume {:verifier.code 0} true;
  $i75 := $trunc.i64.i32($i58);
  $i75.shadow := $trunc.i64.i32($i58.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 940, 22} true;
  assume {:verifier.code 0} true;
  call $i76, $i76.shadow := mbedtls_ct_uint_if($i59, $i59.shadow, $i74, $i74.shadow, $i75, $i75.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 940, 22} true;
  assume {:verifier.code 0} true;
  $i77 := $zext.i32.i64($i76);
  $i77.shadow := $zext.i32.i64($i76.shadow);
  call {:cexpr "plaintext_size"} boogie_si_record_i64($i77);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 950, 40} true;
  assume {:verifier.code 0} true;
  $p78 := $add.ref($p0,$mul.ref($i1,1));
  $p78.shadow := $add.ref($p0.shadow,$mul.ref($i1.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 950, 47} true;
  assume {:verifier.code 0} true;
  $i79 := $sub.i64(0,$i8);
  $i79.shadow := $sub.i64(0,$i8.shadow);
  $i80 := $add.i64($i1,$i79);
  $i80.shadow := $add.i64($i1.shadow,$i79.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 950, 47} true;
  assume {:verifier.code 0} true;
  $p81 := $add.ref($p0,$mul.ref($i80,1));
  $p81.shadow := $add.ref($p0.shadow,$mul.ref($i80.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 952, 53} true;
  assume {:verifier.code 0} true;
  $i82 := $sub.i64($i8,$i77);
  $i82.shadow := $sub.i64($i8.shadow,$i77.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 950, 5} true;
  assume {:verifier.code 0} true;
  call mbedtls_ct_mem_move_to_left($p81, $p81.shadow, $i8, $i8.shadow, $i82, $i82.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 961, 24} true;
  assume {:verifier.code 0} true;
  $i83 := $ne.i64($i3,0);
  $i83.shadow := $ne.i64($i3.shadow,0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 961, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i83} true;
  $i83 := $i83.shadow;
  goto $bb12, $bb13;
$bb11:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 933, 29} true;
  assume {:verifier.code 0} true;
  $i73 := $add.i64($i65,1);
  $i73.shadow := $add.i64($i65.shadow,1);
  call {:cexpr "i"} boogie_si_record_i64($i73);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 933, 5} true;
  assume {:verifier.code 0} true;
  $i65 := $i73;
  $i65.shadow := $i73.shadow;
  goto $bb8;
$bb12:
  assume ($i83 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 962, 31} true;
  assume {:verifier.code 0} true;
  $p84 := $add.ref($p0,$mul.ref($i1,1));
  $p84.shadow := $add.ref($p0.shadow,$mul.ref($i1.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 962, 38} true;
  assume {:verifier.code 0} true;
  $i85 := $sub.i64(0,$i8);
  $i85.shadow := $sub.i64(0,$i8.shadow);
  $i86 := $add.i64($i1,$i85);
  $i86.shadow := $add.i64($i1.shadow,$i85.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 962, 38} true;
  assume {:verifier.code 0} true;
  $p87 := $add.ref($p0,$mul.ref($i86,1));
  $p87.shadow := $add.ref($p0.shadow,$mul.ref($i86.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 962, 9} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p2 == $p2.shadow));
  $p87 := $p87.shadow;
  $i8 := $i8.shadow;
  call $M.1, $M.1.shadow := $memcpy.i8($M.1, $M.1.shadow, $M.0, $M.0.shadow, $p2, $p2.shadow, $p87, $p87.shadow, $i8, $i8.shadow, false, false);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 962, 9} true;
  assume {:verifier.code 0} true;
  goto $bb14;
$bb13:
  ...
  goto $bb14;
$bb14:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 968, 11} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4 == $p4.shadow));
  $M.2 := $store.i64($M.2,$p4,$i77);
  $M.2.shadow := $store.i64($M.2.shadow,$p4.shadow,$i77.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 970, 5} true;
  assume {:verifier.code 0} true;
  $r := $i62;
  $r.shadow := $i62.shadow;
  $exn := false;
...
const mbedtls_ct_size_gt: ref;
axiom (mbedtls_ct_size_gt == $sub.ref(0,6192));
procedure {:inline 1} mbedtls_ct_size_gt($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $exn, $exn.shadow;
{
  var $i2: i64;
  var $i2.shadow: i64;
  ...
  var $i4.shadow: i32;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 221, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_size_gt:arg:x"} boogie_si_record_i64($i0);
  call {:cexpr "mbedtls_ct_size_gt:arg:y"} boogie_si_record_i64($i1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 221, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i64($i1,$i0);
  $i2.shadow := $sub.i64($i1.shadow,$i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 221, 23} true;
  assume {:verifier.code 0} true;
  $i3 := $lshr.i64($i2,63);
  $i3.shadow := $lshr.i64($i2.shadow,63);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 221, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i64.i32($i3);
  $i4.shadow := $trunc.i64.i32($i3.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 221, 5} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $r.shadow := $i4.shadow;
  $exn := false;
...
const mbedtls_ct_mem_move_to_left: ref;
axiom (mbedtls_ct_mem_move_to_left == $sub.ref(0,7224));
procedure {:inline 1} mbedtls_ct_mem_move_to_left($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64, $i2: i64, $i2.shadow: i64)
modifies $shadow_ok, $exn, $exn.shadow, $M.0, $M.0.shadow;
{
  ...
  var $i30.shadow: i64;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 388, 15} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_mem_move_to_left:arg:total"} boogie_si_record_i64($i1);
  call {:cexpr "mbedtls_ct_mem_move_to_left:arg:offset"} boogie_si_record_i64($i2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 388, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i64($i1,0);
  $i3.shadow := $eq.i64($i1.shadow,0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 388, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 389, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !($i3 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 390, 10} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  $i4.shadow := 0;
  goto $bb4;
$bb3:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 404, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 390, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i64($i4,$i1);
  $i5.shadow := $ult.i64($i4.shadow,$i1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 390, 5} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 392, 52} true;
  assume {:verifier.code 0} true;
  $i6 := $sub.i64($i1,$i2);
  $i6.shadow := $sub.i64($i1.shadow,$i2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 392, 26} true;
  assume {:verifier.code 0} true;
  call $i7, $i7.shadow := mbedtls_ct_size_gt($i6, $i6.shadow, $i4, $i4.shadow);
  call {:cexpr "no_op"} boogie_si_record_i32($i7);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 396, 14} true;
  assume {:verifier.code 0} true;
  $i8 := 0;
  $i8.shadow := 0;
  goto $bb7;
...
$bb7:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 396, 31} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.i64($i1,1);
  $i9.shadow := $sub.i64($i1.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 396, 23} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i64($i8,$i9);
  $i10.shadow := $ult.i64($i8.shadow,$i9.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 396, 9} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume ($i10 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 398, 37} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p0,$mul.ref($i8,1));
  $p11.shadow := $add.ref($p0.shadow,$mul.ref($i8.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 398, 37} true;
  assume {:verifier.code 0} true;
  $p11 := $p11.shadow;
  $i12 := $load.i8($M.0,$p11);
  $i12.shadow := $load.i8($M.0.shadow,$p11.shadow);
  call {:cexpr "current"} boogie_si_record_i8($i12);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 399, 39} true;
  assume {:verifier.code 0} true;
  $i13 := $add.i64($i8,1);
  $i13.shadow := $add.i64($i8.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 399, 34} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "next"} boogie_si_record_i8($i15);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 400, 49} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i8.i32($i12);
  $i16.shadow := $zext.i8.i32($i12.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 400, 58} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i8.i32($i15);
  $i17.shadow := $zext.i8.i32($i15.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 400, 22} true;
  assume {:verifier.code 0} true;
  call $i18, $i18.shadow := mbedtls_ct_uint_if($i7, $i7.shadow, $i16, $i16.shadow, $i17, $i17.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 400, 22} true;
  assume {:verifier.code 0} true;
  $i19 := $trunc.i32.i8($i18);
  $i19.shadow := $trunc.i32.i8($i18.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 400, 13} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($p0,$mul.ref($i8,1));
  $p20.shadow := $add.ref($p0.shadow,$mul.ref($i8.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 400, 20} true;
  assume {:verifier.code 0} true;
  $p20 := $p20.shadow;
  $M.0 := $store.i8($M.0,$p20,$i19);
  $M.0.shadow := $store.i8($M.0.shadow,$p20.shadow,$i19.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 401, 9} true;
  assume {:verifier.code 0} true;
  goto $bb10;
$bb9:
  assume !($i10 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 402, 60} true;
  assume {:verifier.code 0} true;
  $i22 := $sub.i64($i1,1);
  $i22.shadow := $sub.i64($i1.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 402, 51} true;
  assume {:verifier.code 0} true;
  $p23 := $add.ref($p0,$mul.ref($i22,1));
  $p23.shadow := $add.ref($p0.shadow,$mul.ref($i22.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 402, 51} true;
  assume {:verifier.code 0} true;
  $p23 := $p23.shadow;
  $i24 := $load.i8($M.0,$p23);
  $i24.shadow := $load.i8($M.0.shadow,$p23.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 402, 51} true;
  assume {:verifier.code 0} true;
  $i25 := $zext.i8.i32($i24);
  $i25.shadow := $zext.i8.i32($i24.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 402, 24} true;
  assume {:verifier.code 0} true;
  call $i26, $i26.shadow := mbedtls_ct_uint_if($i7, $i7.shadow, $i25, $i25.shadow, 0, 0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 402, 24} true;
  assume {:verifier.code 0} true;
  $i27 := $trunc.i32.i8($i26);
  $i27.shadow := $trunc.i32.i8($i26.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 402, 18} true;
  assume {:verifier.code 0} true;
  $i28 := $sub.i64($i1,1);
  $i28.shadow := $sub.i64($i1.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 402, 9} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($p0,$mul.ref($i28,1));
  $p29.shadow := $add.ref($p0.shadow,$mul.ref($i28.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 402, 22} true;
  assume {:verifier.code 0} true;
  $p29 := $p29.shadow;
  $M.0 := $store.i8($M.0,$p29,$i27);
  $M.0.shadow := $store.i8($M.0.shadow,$p29.shadow,$i27.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 403, 5} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb10:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 396, 37} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i64($i8,1);
  $i21.shadow := $add.i64($i8.shadow,1);
  call {:cexpr "n"} boogie_si_record_i64($i21);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 396, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $i21;
  $i8.shadow := $i21.shadow;
  goto $bb7;
$bb11:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 390, 29} true;
  assume {:verifier.code 0} true;
  $i30 := $add.i64($i4,1);
  $i30.shadow := $add.i64($i4.shadow,1);
  call {:cexpr "i"} boogie_si_record_i64($i30);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 390, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i30;
  $i4.shadow := $i30.shadow;
  goto $bb4;
}
const mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper: ref;
axiom (mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper == $sub.ref(0,8256));
procedure {:entrypoint} mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64, $p2: ref, $p2.shadow: ref, $i3: i64, $i3.shadow: i64, $p4: ref, $p4.shadow: ref)
...
requires {:public_in $load.i64, $M.4, $p4, 8, 256} true;
requires ($p0 == $p0.shadow);
requires ($i1 == $i1.shadow);
requires ($p2 == $p2.shadow);
requires ($i3 == $i3.shadow);
requires ($p4 == $p4.shadow);
requires ($load.i64($M.4,($p4 + 0)) == $load.i64($M.4.shadow,($p4.shadow + 0)));
requires ($load.i64($M.4,($p4 + 8)) == $load.i64($M.4.shadow,($p4.shadow + 8)));
requires ($load.i64($M.4,($p4 + 16)) == $load.i64($M.4.shadow,($p4.shadow + 16)));
requires ($load.i64($M.4,($p4 + 24)) == $load.i64($M.4.shadow,($p4.shadow + 24)));
requires ($load.i64($M.4,($p4 + 32)) == $load.i64($M.4.shadow,($p4.shadow + 32)));
requires ($load.i64($M.4,($p4 + 40)) == $load.i64($M.4.shadow,($p4.shadow + 40)));
requires ($load.i64($M.4,($p4 + 48)) == $load.i64($M.4.shadow,($p4.shadow + 48)));
requires ($load.i64($M.4,($p4 + 56)) == $load.i64($M.4.shadow,($p4.shadow + 56)));
requires ($load.i64($M.4,($p4 + 64)) == $load.i64($M.4.shadow,($p4.shadow + 64)));
requires ($load.i64($M.4,($p4 + 72)) == $load.i64($M.4.shadow,($p4.shadow + 72)));
requires ($load.i64($M.4,($p4 + 80)) == $load.i64($M.4.shadow,($p4.shadow + 80)));
requires ($load.i64($M.4,($p4 + 88)) == $load.i64($M.4.shadow,($p4.shadow + 88)));
requires ($load.i64($M.4,($p4 + 96)) == $load.i64($M.4.shadow,($p4.shadow + 96)));
requires ($load.i64($M.4,($p4 + 104)) == $load.i64($M.4.shadow,($p4.shadow + 104)));
requires ($load.i64($M.4,($p4 + 112)) == $load.i64($M.4.shadow,($p4.shadow + 112)));
requires ($load.i64($M.4,($p4 + 120)) == $load.i64($M.4.shadow,($p4.shadow + 120)));
requires ($load.i64($M.4,($p4 + 128)) == $load.i64($M.4.shadow,($p4.shadow + 128)));
requires ($load.i64($M.4,($p4 + 136)) == $load.i64($M.4.shadow,($p4.shadow + 136)));
requires ($load.i64($M.4,($p4 + 144)) == $load.i64($M.4.shadow,($p4.shadow + 144)));
requires ($load.i64($M.4,($p4 + 152)) == $load.i64($M.4.shadow,($p4.shadow + 152)));
requires ($load.i64($M.4,($p4 + 160)) == $load.i64($M.4.shadow,($p4.shadow + 160)));
requires ($load.i64($M.4,($p4 + 168)) == $load.i64($M.4.shadow,($p4.shadow + 168)));
requires ($load.i64($M.4,($p4 + 176)) == $load.i64($M.4.shadow,($p4.shadow + 176)));
requires ($load.i64($M.4,($p4 + 184)) == $load.i64($M.4.shadow,($p4.shadow + 184)));
requires ($load.i64($M.4,($p4 + 192)) == $load.i64($M.4.shadow,($p4.shadow + 192)));
requires ($load.i64($M.4,($p4 + 200)) == $load.i64($M.4.shadow,($p4.shadow + 200)));
requires ($load.i64($M.4,($p4 + 208)) == $load.i64($M.4.shadow,($p4.shadow + 208)));
requires ($load.i64($M.4,($p4 + 216)) == $load.i64($M.4.shadow,($p4.shadow + 216)));
requires ($load.i64($M.4,($p4 + 224)) == $load.i64($M.4.shadow,($p4.shadow + 224)));
requires ($load.i64($M.4,($p4 + 232)) == $load.i64($M.4.shadow,($p4.shadow + 232)));
requires ($load.i64($M.4,($p4 + 240)) == $load.i64($M.4.shadow,($p4.shadow + 240)));
requires ($load.i64($M.4,($p4 + 248)) == $load.i64($M.4.shadow,($p4.shadow + 248)));
modifies $shadow_ok, $exn, $exn.shadow;
modifies $M.0, $M.0.shadow, $M.1, $M.1.shadow, $M.2, $M.2.shadow;
modifies $CurrAddr;
{
  var $p5: ref;
  var $p5.shadow: ref;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 12, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper"} boogie_si_record_ref(mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper);
  call {:cexpr "smack:arg:mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper:$i1"} boogie_si_record_i64($i1);
  call {:cexpr "smack:arg:mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper:$p2"} boogie_si_record_ref($p2);
  call {:cexpr "smack:arg:mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper:$i3"} boogie_si_record_i64($i3);
  call {:cexpr "smack:arg:mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper:$p4"} boogie_si_record_ref($p4);
  call {:cexpr "mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper:arg:ilen"} boogie_si_record_i64($i1);
  call {:cexpr "mbedtls_ct_rsaes_pkcs1_v15_unpadding_wrapper:arg:output_max_len"} boogie_si_record_i64($i3);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 12, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 12, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 13, 12} true;
  assume {:verifier.code 0} true;
  call {:name $i1} $p6 := __SMACK_value.i64($i1);
  $p6.shadow := $p6;
  assume $isExternal($p6);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p6);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 13, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p6, $p6.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 14, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p2} $p7 := __SMACK_value.ref($p2);
  $p7.shadow := $p7;
  assume $isExternal($p7);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p7);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p7, $p7.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 15, 12} true;
  assume {:verifier.code 0} true;
  call {:name $i3} $p8 := __SMACK_value.i64($i3);
  $p8.shadow := $p8;
  assume $isExternal($p8);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p8);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p8, $p8.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 16, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p4} $p9 := __SMACK_value.ref($p4);
  $p9.shadow := $p9;
  assume $isExternal($p9);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p9);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 16, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p9, $p9.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 18, 27} true;
  assume {:verifier.code 1} true;
  $p10 := $bitcast.ref.ref($p4);
  $p10.shadow := $bitcast.ref.ref($p4.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 18, 12} true;
  assume {:verifier.code 1} true;
  call {:name $p4} {:array "$load.i64", $M.4, $p4, 8, 256} $p11 := __SMACK_values($p10, 32);
  $p11.shadow := $p11;
  assume $isExternal($p11);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p11);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 18, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p11, $p11.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call $i12, $i12.shadow := mbedtls_ct_rsaes_pkcs1_v15_unpadding($p0, $p0.shadow, $i1, $i1.shadow, $p2, $p2.shadow, $i3, $i3.shadow, $p4, $p4.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
