...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,41280));
...
axiom (mbedtls_mpi_safe_cond_assign == $sub.ref(0,10320));
...
modifies $shadow_ok, $exn, $exn.shadow, $M.5, $M.5.shadow, $M.2, $M.2.shadow;
...
$bb9:
  ...
  $p16.shadow := $load.ref($M.1.shadow,$p15.shadow);
...
axiom (mbedtls_ct_mpi_uint_mask == $sub.ref(0,11352));
...
axiom (mbedtls_ct_cond_select_sign == $sub.ref(0,12384));
...
axiom (mbedtls_mpi_core_cond_assign == $sub.ref(0,13416));
...
axiom (mbedtls_ct_mpi_uint_cond_assign == $sub.ref(0,14448));
...
$bb2:
  ...
  $M.2.shadow := $store.i64($M.2.shadow,$p17.shadow,$i16.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 9} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
...
axiom (mbedtls_mpi_safe_cond_assign_wrapper == $sub.ref(0,15480));
...
modifies $shadow_ok, $exn, $exn.shadow;
modifies $M.5, $M.5.shadow, $M.2, $M.2.shadow, $M.0, $M.0.shadow, $M.1, $M.1.shadow;
modifies $CurrAddr;
{
  var $p3: ref;
  var $p3.shadow: ref;
...
axiom (__VERIFIER_nondet_int == $sub.ref(0,31992));
...
axiom (__SMACK_nondet_int == $sub.ref(0,33024));
...
axiom (__SMACK_top_decl == $sub.ref(0,35088));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,36120));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0,37152));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0,38184));
...
axiom (__SMACK_static_init == $sub.ref(0,41280));
