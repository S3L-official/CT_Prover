...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,40248));
...
const mbedtls_mpi_zeroize: ref;
axiom (mbedtls_mpi_zeroize == $sub.ref(0,2064));
procedure {:inline 1} mbedtls_mpi_zeroize($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64)
...
modifies $shadow_ok;
{
  ...
  var $i3.shadow: i64;
$bb0:
  assume {:sourceloc "../mbedtls/library/bignum.c", 62, 31} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_mpi_zeroize:arg:n"} boogie_si_record_i64($i1);
  assume {:sourceloc "../mbedtls/library/bignum.c", 62, 31} true;
  assume {:verifier.code 0} true;
  $p2 := $bitcast.ref.ref($p0);
  $p2.shadow := $bitcast.ref.ref($p0.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 62, 38} true;
  assume {:verifier.code 0} true;
  $i3 := $mul.i64(8,$i1);
  $i3.shadow := $mul.i64(8,$i1.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 62, 5} true;
  assume {:verifier.code 0} true;
  call mbedtls_platform_zeroize($p2, $p2.shadow, $i3, $i3.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 63, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const mbedtls_platform_zeroize: ref;
axiom (mbedtls_platform_zeroize == $sub.ref(0,4128));
procedure {:inline 1} mbedtls_platform_zeroize($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64)
modifies $shadow_ok, $exn, $exn.shadow;
{
  ...
  var $i3.shadow: i32;
$bb0:
  assume {:sourceloc "../mbedtls/library/platform_util.c", 69, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_platform_zeroize:arg:len"} boogie_si_record_i64($i1);
  assume {:sourceloc "../mbedtls/library/platform_util.c", 69, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "../mbedtls/library/platform_util.c", 71, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $ugt.i64($i1,0);
  $i2.shadow := $ugt.i64($i1.shadow,0);
  assume {:sourceloc "../mbedtls/library/platform_util.c", 71, 9} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume ($i2 == 1);
  assume {:sourceloc "../mbedtls/library/platform_util.c", 72, 9} true;
  assume {:verifier.code 0} true;
  call $i3, $i3.shadow := menset.ref.i32.i64($p0, $p0.shadow, 0, 0, $i1, $i1.shadow);
  assume {:sourceloc "../mbedtls/library/platform_util.c", 72, 9} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
  ...
  goto $bb5;
$bb5:
  assume {:sourceloc "../mbedtls/library/platform_util.c", 75, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
const menset: ref;
axiom (menset == $sub.ref(0,5160));
procedure {:inline 1} menset.ref.i32.i64(p.0: ref, p.0.shadow: ref, p.1: i32, p.1.shadow: i32, p.2: i64, p.2.shadow: i64) returns ($r: i32, $r.shadow: i32);
const mbedtls_mpi_grow: ref;
axiom (mbedtls_mpi_grow == $sub.ref(0,6192));
procedure {:inline 1} mbedtls_mpi_grow($p0: ref, $p0.shadow: ref, $i1: i64, $i1.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $shadow_ok, $exn, $exn.shadow, $M.2, $M.2.shadow, $M.0, $M.0.shadow, $M.1, $M.1.shadow;
modifies $CurrAddr;
{
  var $i2: i1;
  var $i2.shadow: i1;
  ...
  var $i3.shadow: i32;
$bb0:
  assume {:sourceloc "../mbedtls/library/bignum.c", 102, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_mpi_grow:arg:nblimbs"} boogie_si_record_i64($i1);
  assume {:sourceloc "../mbedtls/library/bignum.c", 102, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "../mbedtls/library/bignum.c", 104, 17} true;
  assume {:verifier.code 0} true;
  $i2 := $ugt.i64($i1,10000);
  $i2.shadow := $ugt.i64($i1.shadow,10000);
  assume {:sourceloc "../mbedtls/library/bignum.c", 104, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  $i2 := $i2.shadow;
  goto $bb3, $bb4;
$bb3:
  assume ($i2 == 1);
  assume {:sourceloc "../mbedtls/library/bignum.c", 105, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0,16);
  $i3.shadow := $sub.i32(0,16);
  goto $bb5;
$bb4:
  assume !($i2 == 1);
  assume {:sourceloc "../mbedtls/library/bignum.c", 107, 12} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1));
  $p4.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "../mbedtls/library/bignum.c", 107, 12} true;
  assume {:verifier.code 0} true;
  $p4 := $p4.shadow;
  $i5 := $load.i64($M.0,$p4);
  $i5.shadow := $load.i64($M.0.shadow,$p4.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 107, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i64($i5,$i1);
  $i6.shadow := $ult.i64($i5.shadow,$i1.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 107, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  $i6 := $i6.shadow;
  goto $bb6, $bb7;
$bb5:
  assume {:sourceloc "../mbedtls/library/bignum.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/bignum.c", 124, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $r.shadow := $i3.shadow;
  $exn := false;
...
$bb6:
  assume ($i6 == 1);
  assume {:sourceloc "../mbedtls/library/bignum.c", 109, 38} true;
  assume {:verifier.code 0} true;
  call $p7, $p7.shadow := calloc($i1, $i1.shadow, 8, 8);
  assume {:sourceloc "../mbedtls/library/bignum.c", 109, 19} true;
  assume {:verifier.code 0} true;
  $p8 := $bitcast.ref.ref($p7);
  $p8.shadow := $bitcast.ref.ref($p7.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 109, 71} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.ref($p8,$0.ref);
  $i9.shadow := $eq.ref($p8.shadow,$0.ref);
  assume {:sourceloc "../mbedtls/library/bignum.c", 109, 13} true;
  assume {:verifier.code 0} true;
...
$bb7:
  ...
  goto $bb8;
$bb8:
  assume {:sourceloc "../mbedtls/library/bignum.c", 123, 5} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  $i3.shadow := 0;
  goto $bb5;
$bb9:
  assume ($i9 == 1);
  assume {:sourceloc "../mbedtls/library/bignum.c", 110, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(0,16);
  $i3.shadow := $sub.i32(0,16);
  goto $bb5;
$bb10:
  assume !($i9 == 1);
  assume {:sourceloc "../mbedtls/library/bignum.c", 112, 16} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1));
  $p10.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/bignum.c", 112, 16} true;
  assume {:verifier.code 0} true;
  $p10 := $p10.shadow;
  $p11 := $load.ref($M.1,$p10);
  $p11.shadow := $load.ref($M.1.shadow,$p10.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 112, 18} true;
  assume {:verifier.code 0} true;
  $i12 := $ne.ref($p11,$0.ref);
  $i12.shadow := $ne.ref($p11.shadow,$0.ref);
  assume {:sourceloc "../mbedtls/library/bignum.c", 112, 13} true;
  assume {:verifier.code 0} true;
...
$bb11:
  assume ($i12 == 1);
  assume {:sourceloc "../mbedtls/library/bignum.c", 114, 13} true;
  assume {:verifier.code 0} true;
  $p13 := $bitcast.ref.ref($p8);
  $p13.shadow := $bitcast.ref.ref($p8.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 114, 27} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1));
  $p14.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/bignum.c", 114, 27} true;
  assume {:verifier.code 0} true;
  $p14 := $p14.shadow;
  ...
  $p16.shadow := $bitcast.ref.ref($p15.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 114, 33} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1));
  $p17.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "../mbedtls/library/bignum.c", 114, 33} true;
  assume {:verifier.code 0} true;
  $p17 := $p17.shadow;
  $i18 := $load.i64($M.0,$p17);
  $i18.shadow := $load.i64($M.0.shadow,$p17.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 114, 35} true;
  assume {:verifier.code 0} true;
  $i19 := $mul.i64($i18,8);
  $i19.shadow := $mul.i64($i18.shadow,8);
  assume {:sourceloc "../mbedtls/library/bignum.c", 114, 13} true;
  assume {:verifier.code 0} true;
  $p13 := $p13.shadow;
  $p16 := $p16.shadow;
  $i19 := $i19.shadow;
  call $M.2, $M.2.shadow := $memcpy.i8($M.2, $M.2.shadow, $M.2, $M.2.shadow, $p13, $p13.shadow, $p16, $p16.shadow, $i19, $i19.shadow, false, false);
  assume {:sourceloc "../mbedtls/library/bignum.c", 115, 37} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1));
  $p20.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/bignum.c", 115, 37} true;
  assume {:verifier.code 0} true;
  $p20 := $p20.shadow;
  $p21 := $load.ref($M.1,$p20);
  $p21.shadow := $load.ref($M.1.shadow,$p20.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 115, 43} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1));
  $p22.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "../mbedtls/library/bignum.c", 115, 43} true;
  assume {:verifier.code 0} true;
  $p22 := $p22.shadow;
  $i23 := $load.i64($M.0,$p22);
  $i23.shadow := $load.i64($M.0.shadow,$p22.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 115, 13} true;
  assume {:verifier.code 0} true;
  call mbedtls_mpi_zeroize($p21, $p21.shadow, $i23, $i23.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 116, 30} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1));
  $p24.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/bignum.c", 116, 30} true;
  assume {:verifier.code 0} true;
  $p24 := $p24.shadow;
  $p25 := $load.ref($M.1,$p24);
  $p25.shadow := $load.ref($M.1.shadow,$p24.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 116, 27} true;
  assume {:verifier.code 0} true;
  $p26 := $bitcast.ref.ref($p25);
  $p26.shadow := $bitcast.ref.ref($p25.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 116, 13} true;
  assume {:verifier.code 0} true;
  call free_($p26, $p26.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 117, 9} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume {:sourceloc "../mbedtls/library/bignum.c", 112, 13} true;
  ...
  goto $bb13;
$bb13:
  assume {:sourceloc "../mbedtls/library/bignum.c", 119, 12} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1));
  $p27.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "../mbedtls/library/bignum.c", 119, 14} true;
  assume {:verifier.code 0} true;
  $p27 := $p27.shadow;
  $M.0 := $store.i64($M.0,$p27,$i1);
  $M.0.shadow := $store.i64($M.0.shadow,$p27.shadow,$i1.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 120, 12} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1));
  $p28.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/bignum.c", 120, 14} true;
  assume {:verifier.code 0} true;
  $p28 := $p28.shadow;
  $M.1 := $store.ref($M.1,$p28,$p7);
  $M.1.shadow := $store.ref($M.1.shadow,$p28.shadow,$p7.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 121, 5} true;
  assume {:verifier.code 0} true;
  goto $bb8;
}
...
axiom (llvm.memset.p0i8.i64 == $sub.ref(0,8256));
...
axiom (llvm.dbg.label == $sub.ref(0,9288));
procedure {:inline 1} llvm.dbg.label($p0: ref);
const mbedtls_ct_mpi_uint_mask: ref;
axiom (mbedtls_ct_mpi_uint_mask == $sub.ref(0,10320));
procedure {:inline 1} mbedtls_ct_mpi_uint_mask($i0: i64, $i0.shadow: i64) returns ($r: i64, $r.shadow: i64)
modifies $exn, $exn.shadow;
{
  var $i1: i64;
  var $i1.shadow: i64;
  ...
  var $i4.shadow: i64;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 113, 27} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_mpi_uint_mask:arg:value"} boogie_si_record_i64($i0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 113, 27} true;
  assume {:verifier.code 0} true;
  $i1 := $sub.i64(0,$i0);
  $i1.shadow := $sub.i64(0,$i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 113, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $or.i64($i0,$i1);
  $i2.shadow := $or.i64($i0.shadow,$i1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 113, 37} true;
  assume {:verifier.code 0} true;
  $i3 := $lshr.i64($i2,63);
  $i3.shadow := $lshr.i64($i2.shadow,63);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 113, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i64(0,$i3);
  $i4.shadow := $sub.i64(0,$i3.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 113, 5} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $r.shadow := $i4.shadow;
  $exn := false;
...
const mbedtls_ct_cond_select_sign: ref;
axiom (mbedtls_ct_cond_select_sign == $sub.ref(0,11352));
procedure {:inline 1} mbedtls_ct_cond_select_sign($i0: i8, $i0.shadow: i8, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn, $exn.shadow;
{
  var $i3: i32;
  var $i3.shadow: i32;
  ...
  var $i11.shadow: i32;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 289, 25} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_cond_select_sign:arg:condition"} boogie_si_record_i8($i0);
  call {:cexpr "mbedtls_ct_cond_select_sign:arg:if1"} boogie_si_record_i32($i1);
  call {:cexpr "mbedtls_ct_cond_select_sign:arg:if0"} boogie_si_record_i32($i2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 289, 25} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i1,1);
  $i3.shadow := $add.i32($i1.shadow,1);
  call {:cexpr "uif1"} boogie_si_record_i32($i3);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 290, 25} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i2,1);
  $i4.shadow := $add.i32($i2.shadow,1);
  call {:cexpr "uif0"} boogie_si_record_i32($i4);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 293, 27} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i8.i32($i0);
  $i5.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 293, 37} true;
  assume {:verifier.code 0} true;
  $i6 := $shl.i32($i5,1);
  $i6.shadow := $shl.i32($i5.shadow,1);
  call {:cexpr "mask"} boogie_si_record_i32($i6);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 296, 28} true;
  assume {:verifier.code 0} true;
  $i7 := $xor.i32($i6,$sub.i32(0,1));
  $i7.shadow := $xor.i32($i6.shadow,$sub.i32(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 296, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $and.i32($i4,$i7);
  $i8.shadow := $and.i32($i4.shadow,$i7.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 296, 45} true;
  assume {:verifier.code 0} true;
  $i9 := $and.i32($i3,$i6);
  $i9.shadow := $and.i32($i3.shadow,$i6.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 296, 36} true;
  assume {:verifier.code 0} true;
  $i10 := $or.i32($i8,$i9);
  $i10.shadow := $or.i32($i8.shadow,$i9.shadow);
  call {:cexpr "ur"} boogie_si_record_i32($i10);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 299, 22} true;
  assume {:verifier.code 0} true;
  $i11 := $sub.i32($i10,1);
  $i11.shadow := $sub.i32($i10.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 299, 5} true;
  assume {:verifier.code 0} true;
  $r := $i11;
  $r.shadow := $i11.shadow;
  $exn := false;
...
const mbedtls_mpi_core_cond_swap: ref;
axiom (mbedtls_mpi_core_cond_swap == $sub.ref(0,12384));
procedure {:inline 1} mbedtls_mpi_core_cond_swap($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64, $i3: i8, $i3.shadow: i8)
modifies $shadow_ok, $exn, $exn.shadow, $M.2, $M.2.shadow;
{
  var $i4: i1;
  var $i4.shadow: i1;
  var $i5: i64;
  ...
  var $i27.shadow: i64;
$bb0:
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 174, 11} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_mpi_core_cond_swap:arg:limbs"} boogie_si_record_i64($i2);
  call {:cexpr "mbedtls_mpi_core_cond_swap:arg:swap"} boogie_si_record_i8($i3);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 174, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.ref($p0,$p1);
  $i4.shadow := $eq.ref($p0.shadow,$p1.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 174, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 175, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !($i4 == 1);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 178, 60} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i8.i64($i3);
  $i5.shadow := $zext.i8.i64($i3.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 178, 34} true;
  assume {:verifier.code 0} true;
  call $i6, $i6.shadow := mbedtls_ct_mpi_uint_mask($i5, $i5.shadow);
  call {:cexpr "limb_mask"} boogie_si_record_i64($i6);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 180, 10} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
  $i7.shadow := 0;
  goto $bb4;
$bb3:
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 186, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  ...
  $i7 := $i7.shadow;
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 180, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $ult.i64($i7,$i2);
  $i8.shadow := $ult.i64($i7.shadow,$i2.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 180, 5} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 182, 32} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref($i7,8));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref($i7.shadow,8));
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 182, 32} true;
  assume {:verifier.code 0} true;
  $p9 := $p9.shadow;
  $i10 := $load.i64($M.2,$p9);
  ...
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 183, 18} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($p0,$mul.ref($i7,8));
  $p11.shadow := $add.ref($p0.shadow,$mul.ref($i7.shadow,8));
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 183, 18} true;
  assume {:verifier.code 0} true;
  $p11 := $p11.shadow;
  $i12 := $load.i64($M.2,$p11);
  $i12.shadow := $load.i64($M.2.shadow,$p11.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 183, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $xor.i64($i6,$sub.i64(0,1));
  $i13.shadow := $xor.i64($i6.shadow,$sub.i64(0,1));
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 183, 23} true;
  assume {:verifier.code 0} true;
  $i14 := $and.i64($i12,$i13);
  $i14.shadow := $and.i64($i12.shadow,$i13.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 183, 42} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p1,$mul.ref($i7,8));
  $p15.shadow := $add.ref($p1.shadow,$mul.ref($i7.shadow,8));
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 183, 42} true;
  assume {:verifier.code 0} true;
  $p15 := $p15.shadow;
  $i16 := $load.i64($M.2,$p15);
  $i16.shadow := $load.i64($M.2.shadow,$p15.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 183, 47} true;
  assume {:verifier.code 0} true;
  $i17 := $and.i64($i16,$i6);
  $i17.shadow := $and.i64($i16.shadow,$i6.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 183, 38} true;
  assume {:verifier.code 0} true;
  $i18 := $or.i64($i14,$i17);
  $i18.shadow := $or.i64($i14.shadow,$i17.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 183, 9} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($p0,$mul.ref($i7,8));
  $p19.shadow := $add.ref($p0.shadow,$mul.ref($i7.shadow,8));
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 183, 14} true;
  assume {:verifier.code 0} true;
  $p19 := $p19.shadow;
  $M.2 := $store.i64($M.2,$p19,$i18);
  $M.2.shadow := $store.i64($M.2.shadow,$p19.shadow,$i18.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 184, 18} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($p1,$mul.ref($i7,8));
  $p20.shadow := $add.ref($p1.shadow,$mul.ref($i7.shadow,8));
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 184, 18} true;
  assume {:verifier.code 0} true;
  $p20 := $p20.shadow;
  $i21 := $load.i64($M.2,$p20);
  $i21.shadow := $load.i64($M.2.shadow,$p20.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 184, 25} true;
  assume {:verifier.code 0} true;
  $i22 := $xor.i64($i6,$sub.i64(0,1));
  $i22.shadow := $xor.i64($i6.shadow,$sub.i64(0,1));
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 184, 23} true;
  assume {:verifier.code 0} true;
  $i23 := $and.i64($i21,$i22);
  $i23.shadow := $and.i64($i21.shadow,$i22.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 184, 47} true;
  assume {:verifier.code 0} true;
  $i24 := $and.i64($i10,$i6);
  $i24.shadow := $and.i64($i10.shadow,$i6.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 184, 38} true;
  assume {:verifier.code 0} true;
  $i25 := $or.i64($i23,$i24);
  $i25.shadow := $or.i64($i23.shadow,$i24.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 184, 9} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p1,$mul.ref($i7,8));
  $p26.shadow := $add.ref($p1.shadow,$mul.ref($i7.shadow,8));
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 184, 14} true;
  assume {:verifier.code 0} true;
  $p26 := $p26.shadow;
  $M.2 := $store.i64($M.2,$p26,$i25);
  $M.2.shadow := $store.i64($M.2.shadow,$p26.shadow,$i25.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 185, 5} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 180, 5} true;
  ...
  goto $bb3;
$bb7:
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 180, 36} true;
  assume {:verifier.code 0} true;
  $i27 := $add.i64($i7,1);
  $i27.shadow := $add.i64($i7.shadow,1);
  call {:cexpr "i"} boogie_si_record_i64($i27);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 180, 5} true;
  assume {:verifier.code 0} true;
  $i7 := $i27;
  $i7.shadow := $i27.shadow;
  goto $bb4;
}
const mbedtls_mpi_safe_cond_swap: ref;
axiom (mbedtls_mpi_safe_cond_swap == $sub.ref(0,13416));
procedure {:inline 1} mbedtls_mpi_safe_cond_swap($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i8, $i2.shadow: i8) returns ($r: i32, $r.shadow: i32)
modifies $shadow_ok, $exn, $exn.shadow, $M.3, $M.3.shadow;
...
modifies $CurrAddr;
{
  ...
  var $i4.shadow: i32;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 713, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_mpi_safe_cond_swap:arg:swap"} boogie_si_record_i8($i2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 713, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 714, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 714, 5} true;
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 716, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.ref($p0,$p1);
  $i3.shadow := $eq.ref($p0.shadow,$p1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 716, 9} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i3 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 717, 9} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  $i4.shadow := 0;
  goto $bb7;
$bb6:
  assume !($i3 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 719, 5} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 730, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $r.shadow := $i4.shadow;
  $exn := false;
...
$bb8:
  ...
  $p5.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 719, 5} true;
  assume {:verifier.code 0} true;
  $p5 := $p5.shadow;
  $i6 := $load.i64($M.0,$p5);
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 719, 5} true;
  assume {:verifier.code 0} true;
  call $i7, $i7.shadow := mbedtls_mpi_grow($p0, $p0.shadow, $i6, $i6.shadow);
...
$bb11:
  ...
  assume {:verifier.code 0} true;
  assume true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 729, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i9;
  $i4.shadow := $i9.shadow;
  goto $bb7;
$bb12:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 720, 5} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb13:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 720, 5} true;
  ...
  $p10.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 720, 5} true;
  assume {:verifier.code 0} true;
  $p10 := $p10.shadow;
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 720, 5} true;
  assume {:verifier.code 0} true;
  call $i12, $i12.shadow := mbedtls_mpi_grow($p1, $p1.shadow, $i11, $i11.shadow);
  call {:cexpr "ret"} boogie_si_record_i32($i12);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 720, 5} true;
  assume {:verifier.code 0} true;
  $i13 := $ne.i32($i12,0);
  $i13.shadow := $ne.i32($i12.shadow,0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 720, 5} true;
  assume {:verifier.code 0} true;
...
$bb15:
  ...
  goto $bb16;
$bb16:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 722, 12} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1));
  $p14.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 722, 12} true;
  assume {:verifier.code 0} true;
  $p14 := $p14.shadow;
  $i15 := $load.i32($M.3,$p14);
  $i15.shadow := $load.i32($M.3.shadow,$p14.shadow);
  call {:cexpr "s"} boogie_si_record_i32($i15);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 723, 50} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1));
  $p16.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 723, 50} true;
  assume {:verifier.code 0} true;
  $p16 := $p16.shadow;
  $i17 := $load.i32($M.3,$p16);
  $i17.shadow := $load.i32($M.3.shadow,$p16.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 723, 56} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1));
  $p18.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 723, 56} true;
  assume {:verifier.code 0} true;
  $p18 := $p18.shadow;
  $i19 := $load.i32($M.3,$p18);
  $i19.shadow := $load.i32($M.3.shadow,$p18.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 723, 12} true;
  assume {:verifier.code 0} true;
  call $i20, $i20.shadow := mbedtls_ct_cond_select_sign($i2, $i2.shadow, $i17, $i17.shadow, $i19, $i19.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 723, 8} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1));
  $p21.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 723, 10} true;
  assume {:verifier.code 0} true;
  $p21 := $p21.shadow;
  $M.3 := $store.i32($M.3,$p21,$i20);
  $M.3.shadow := $store.i32($M.3.shadow,$p21.shadow,$i20.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 724, 53} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1));
  $p22.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 724, 53} true;
  assume {:verifier.code 0} true;
  $p22 := $p22.shadow;
  $i23 := $load.i32($M.3,$p22);
  $i23.shadow := $load.i32($M.3.shadow,$p22.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 724, 12} true;
  assume {:verifier.code 0} true;
  call $i24, $i24.shadow := mbedtls_ct_cond_select_sign($i2, $i2.shadow, $i15, $i15.shadow, $i23, $i23.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 724, 8} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1));
  $p25.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 724, 10} true;
  assume {:verifier.code 0} true;
  $p25 := $p25.shadow;
  $M.3 := $store.i32($M.3,$p25,$i24);
  $M.3.shadow := $store.i32($M.3.shadow,$p25.shadow,$i24.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 726, 36} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1));
  $p26.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 726, 36} true;
  assume {:verifier.code 0} true;
  $p26 := $p26.shadow;
  $p27 := $load.ref($M.1,$p26);
  $p27.shadow := $load.ref($M.1.shadow,$p26.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 726, 42} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1));
  $p28.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 726, 42} true;
  assume {:verifier.code 0} true;
  $p28 := $p28.shadow;
  $p29 := $load.ref($M.1,$p28);
  $p29.shadow := $load.ref($M.1.shadow,$p28.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 726, 48} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1));
  $p30.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 726, 48} true;
  assume {:verifier.code 0} true;
  $p30 := $p30.shadow;
  $i31 := $load.i64($M.0,$p30);
  $i31.shadow := $load.i64($M.0.shadow,$p30.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 726, 5} true;
  assume {:verifier.code 0} true;
  call mbedtls_mpi_core_cond_swap($p27, $p27.shadow, $p29, $p29.shadow, $i31, $i31.shadow, $i2, $i2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 726, 5} true;
  assume {:verifier.code 0} true;
  $i9 := $i12;
  $i9.shadow := $i12.shadow;
...
const mbedtls_mpi_safe_cond_swap_wrapper: ref;
axiom (mbedtls_mpi_safe_cond_swap_wrapper == $sub.ref(0,14448));
procedure {:entrypoint} mbedtls_mpi_safe_cond_swap_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i8, $i2.shadow: i8)
requires {:public_in $p0} true;
requires {:public_in $p1} true;
requires {:public_in $load.i64, $M.0, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1)), 8} true;
requires {:public_in $load.i64, $M.1, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1)), 8} true;
requires {:public_in $load.i32, $M.3, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1)), 4} true;
requires {:public_in $load.i64, $M.0, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1)), 8} true;
requires {:public_in $load.i64, $M.1, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1)), 8} true;
requires {:public_in $load.i32, $M.3, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1)), 4} true;
requires ($p0 == $p0.shadow);
requires ($p1 == $p1.shadow);
requires ($load.i64($M.0,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1))) == $load.i64($M.0.shadow,$add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1))));
requires ($load.i64($M.1,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1))) == $load.i64($M.1.shadow,$add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1))));
requires ($load.i32($M.3,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1))) == $load.i32($M.3.shadow,$add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(0,1))));
requires ($load.i64($M.0,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1))) == $load.i64($M.0.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(8,1))));
requires ($load.i64($M.1,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1))) == $load.i64($M.1.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(16,1))));
requires ($load.i32($M.3,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1))) == $load.i32($M.3.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(0,1))));
modifies $shadow_ok, $exn, $exn.shadow;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 10, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_mpi_safe_cond_swap_wrapper"} boogie_si_record_ref(mbedtls_mpi_safe_cond_swap_wrapper);
  call {:cexpr "smack:arg:mbedtls_mpi_safe_cond_swap_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:mbedtls_mpi_safe_cond_swap_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:mbedtls_mpi_safe_cond_swap_wrapper:$i2"} boogie_si_record_i8($i2);
  call {:cexpr "mbedtls_mpi_safe_cond_swap_wrapper:arg:assign"} boogie_si_record_i8($i2);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 10, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 10, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p3, $p3.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 11, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p4 := __SMACK_value.ref($p1);
  $p4.shadow := $p4;
  assume $isExternal($p4);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p4);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 11, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 14, 29} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1));
  $p5.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 14, 29} true;
  assume {:verifier.code 0} true;
  $p5 := $p5.shadow;
  $i6 := $load.i64($M.0,$p5);
  $i6.shadow := $load.i64($M.0.shadow,$p5.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 14, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p0} {:field "$load.i64", $M.0, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1)), 8} $p7 := __SMACK_value.i64($i6);
  $p7.shadow := $p7;
  assume $isExternal($p7);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p7);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p7, $p7.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 15, 29} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1));
  $p8.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 15, 29} true;
  assume {:verifier.code 0} true;
  $p8 := $p8.shadow;
  $p9 := $load.ref($M.1,$p8);
  $p9.shadow := $load.ref($M.1.shadow,$p8.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 15, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p0} {:field "$load.i64", $M.1, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1)), 8} $p10 := __SMACK_value.ref($p9);
  $p10.shadow := $p10;
  assume $isExternal($p10);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p10);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p10, $p10.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 16, 29} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1));
  $p11.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 16, 29} true;
  assume {:verifier.code 0} true;
  $p11 := $p11.shadow;
  $i12 := $load.i32($M.3,$p11);
  $i12.shadow := $load.i32($M.3.shadow,$p11.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 16, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p0} {:field "$load.i32", $M.3, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1)), 4} $p13 := __SMACK_value.i32($i12);
  $p13.shadow := $p13;
  assume $isExternal($p13);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p13);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 16, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p13, $p13.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 18, 29} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1));
  $p14.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 18, 29} true;
  assume {:verifier.code 0} true;
  $p14 := $p14.shadow;
  $i15 := $load.i64($M.0,$p14);
  $i15.shadow := $load.i64($M.0.shadow,$p14.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 18, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.0, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1)), 8} $p16 := __SMACK_value.i64($i15);
  $p16.shadow := $p16;
  assume $isExternal($p16);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p16);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 18, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p16, $p16.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 19, 29} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1));
  $p17.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 19, 29} true;
  assume {:verifier.code 0} true;
  $p17 := $p17.shadow;
  $p18 := $load.ref($M.1,$p17);
  $p18.shadow := $load.ref($M.1.shadow,$p17.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 19, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.1, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1)), 8} $p19 := __SMACK_value.ref($p18);
  $p19.shadow := $p19;
  assume $isExternal($p19);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p19);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 19, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p19, $p19.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 20, 29} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1));
  $p20.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 20, 29} true;
  assume {:verifier.code 0} true;
  $p20 := $p20.shadow;
  $i21 := $load.i32($M.3,$p20);
  $i21.shadow := $load.i32($M.3.shadow,$p20.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 20, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i32", $M.3, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1)), 4} $p22 := __SMACK_value.i32($i21);
  $p22.shadow := $p22;
  assume $isExternal($p22);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p22);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 20, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p22, $p22.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call $i23, $i23.shadow := mbedtls_mpi_safe_cond_swap($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
...
axiom (__SMACK_dummy == $sub.ref(0,19608));
...
axiom (__SMACK_and32 == $sub.ref(0,20640));
...
axiom (__SMACK_and64 == $sub.ref(0,21672));
...
axiom (__SMACK_and16 == $sub.ref(0,22704));
...
axiom (__SMACK_and8 == $sub.ref(0,23736));
...
axiom (__SMACK_or32 == $sub.ref(0,24768));
...
axiom (__SMACK_or64 == $sub.ref(0,25800));
...
axiom (__SMACK_or16 == $sub.ref(0,26832));
...
axiom (__SMACK_or8 == $sub.ref(0,27864));
...
axiom (__SMACK_check_overflow == $sub.ref(0,28896));
...
axiom (__SMACK_loop_exit == $sub.ref(0,29928));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0,30960));
...
modifies $exn;
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1463, 11} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1463, 11} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1464, 23} true;
  assume {:verifier.code 0} true;
  $i1 := $sge.i32($i0,$sub.i32(0,2147483648));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1464, 34} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1464, 39} true;
  assume {:verifier.code 1} true;
...
$bb3:
  ...
  assume {:verifier.code 1} true;
  $i4 := $zext.i1.i32($i2);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1464, 3} true;
  assume {:verifier.code 1} true;
  call __VERIFIER_assume($i4);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1465, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_nondet_int == $sub.ref(0,31992));
procedure {:inline 1} __SMACK_nondet_int() returns ($r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0,33024));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,34056));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,35088));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0,36120));
procedure {:inline 1} __VERIFIER_atomic_begin()
modifies $exn;
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1892, 34} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1892, 34} true;
  assume {:verifier.code 1} true;
  call corral_atomic_begin();
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1892, 79} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const __VERIFIER_atomic_end: ref;
axiom (__VERIFIER_atomic_end == $sub.ref(0,37152));
procedure {:inline 1} __VERIFIER_atomic_end()
modifies $exn;
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1894, 32} true;
  assume {:verifier.code 1} true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1894, 32} true;
  assume {:verifier.code 1} true;
  call corral_atomic_end();
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1894, 75} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const calloc: ref;
axiom (calloc == $sub.ref(0,38184));
procedure {:inline 1} calloc($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: ref, $r.shadow: ref)
modifies $shadow_ok, $M.2, $M.2.shadow, $exn, $exn.shadow;
modifies $CurrAddr;
{
  var $i2: i32;
  var $i2.shadow: i32;
  ...
  var $p4.shadow: ref;
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 28, 7} true;
  assume {:verifier.code 1} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $p4 := $0.ref;
  $p4.shadow := $0.ref;
  goto $bb3;
$bb2:
  assume !($i3 == 1);
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 31, 5} true;
  assume {:verifier.code 0} true;
  call __VERIFIER_atomic_begin();
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 32, 22} true;
  assume {:verifier.code 0} true;
  $i5 := $mul.i64($i0,$i1);
  $i5.shadow := $mul.i64($i0.shadow,$i1.shadow);
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 32, 11} true;
  assume {:verifier.code 0} true;
  call $p6, $p6.shadow := malloc($i5, $i5.shadow);
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 33, 24} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.i64($i0,$i1);
  $i7.shadow := $mul.i64($i0.shadow,$i1.shadow);
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 33, 5} true;
  assume {:verifier.code 0} true;
  $p6 := $p6.shadow;
  $i7 := $i7.shadow;
  call $M.2, $M.2.shadow := $memset.i8($M.2, $M.2.shadow, $p6, $p6.shadow, 0, 0, $i7, $i7.shadow, false, false);
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 34, 5} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "/usr/local/share/smack/lib/stdlib.c", 36, 3} true;
  assume {:verifier.code 0} true;
  $r := $p4;
  $r.shadow := $p4.shadow;
  $exn := false;
...
const malloc: ref;
axiom (malloc == $sub.ref(0,39216));
procedure {:inline 1} malloc($i0: i64, $i0.shadow: i64) returns ($r: ref, $r.shadow: ref)
modifies $shadow_ok;
modifies $CurrAddr;
{
  call $r, $r.shadow := $malloc($i0, $i0.shadow);
}
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0,40248));
