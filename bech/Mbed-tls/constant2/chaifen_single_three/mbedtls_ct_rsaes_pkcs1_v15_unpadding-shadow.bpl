...
axiom (mbedtls_ct_uint_mask == $sub.ref(0,2064));
...
axiom (mbedtls_ct_uint_if == $sub.ref(0,3096));
...
axiom (mbedtls_ct_rsaes_pkcs1_v15_unpadding == $sub.ref(0,4128));
...
axiom (mbedtls_ct_size_gt == $sub.ref(0,5160));
...
axiom (mbedtls_ct_mem_move_to_left == $sub.ref(0,6192));
...
requires {:public_in $load.i64, $M.2, $p4, 8, 256} true;
modifies $exn;
...
requires ($load.i64($M.2,($p4 + 0)) == $load.i64($M.2.shadow,($p4.shadow + 0)));
requires ($load.i64($M.2,($p4 + 8)) == $load.i64($M.2.shadow,($p4.shadow + 8)));
requires ($load.i64($M.2,($p4 + 16)) == $load.i64($M.2.shadow,($p4.shadow + 16)));
requires ($load.i64($M.2,($p4 + 24)) == $load.i64($M.2.shadow,($p4.shadow + 24)));
requires ($load.i64($M.2,($p4 + 32)) == $load.i64($M.2.shadow,($p4.shadow + 32)));
requires ($load.i64($M.2,($p4 + 40)) == $load.i64($M.2.shadow,($p4.shadow + 40)));
requires ($load.i64($M.2,($p4 + 48)) == $load.i64($M.2.shadow,($p4.shadow + 48)));
requires ($load.i64($M.2,($p4 + 56)) == $load.i64($M.2.shadow,($p4.shadow + 56)));
requires ($load.i64($M.2,($p4 + 64)) == $load.i64($M.2.shadow,($p4.shadow + 64)));
requires ($load.i64($M.2,($p4 + 72)) == $load.i64($M.2.shadow,($p4.shadow + 72)));
requires ($load.i64($M.2,($p4 + 80)) == $load.i64($M.2.shadow,($p4.shadow + 80)));
requires ($load.i64($M.2,($p4 + 88)) == $load.i64($M.2.shadow,($p4.shadow + 88)));
requires ($load.i64($M.2,($p4 + 96)) == $load.i64($M.2.shadow,($p4.shadow + 96)));
requires ($load.i64($M.2,($p4 + 104)) == $load.i64($M.2.shadow,($p4.shadow + 104)));
requires ($load.i64($M.2,($p4 + 112)) == $load.i64($M.2.shadow,($p4.shadow + 112)));
requires ($load.i64($M.2,($p4 + 120)) == $load.i64($M.2.shadow,($p4.shadow + 120)));
requires ($load.i64($M.2,($p4 + 128)) == $load.i64($M.2.shadow,($p4.shadow + 128)));
requires ($load.i64($M.2,($p4 + 136)) == $load.i64($M.2.shadow,($p4.shadow + 136)));
requires ($load.i64($M.2,($p4 + 144)) == $load.i64($M.2.shadow,($p4.shadow + 144)));
requires ($load.i64($M.2,($p4 + 152)) == $load.i64($M.2.shadow,($p4.shadow + 152)));
requires ($load.i64($M.2,($p4 + 160)) == $load.i64($M.2.shadow,($p4.shadow + 160)));
requires ($load.i64($M.2,($p4 + 168)) == $load.i64($M.2.shadow,($p4.shadow + 168)));
requires ($load.i64($M.2,($p4 + 176)) == $load.i64($M.2.shadow,($p4.shadow + 176)));
requires ($load.i64($M.2,($p4 + 184)) == $load.i64($M.2.shadow,($p4.shadow + 184)));
requires ($load.i64($M.2,($p4 + 192)) == $load.i64($M.2.shadow,($p4.shadow + 192)));
requires ($load.i64($M.2,($p4 + 200)) == $load.i64($M.2.shadow,($p4.shadow + 200)));
requires ($load.i64($M.2,($p4 + 208)) == $load.i64($M.2.shadow,($p4.shadow + 208)));
requires ($load.i64($M.2,($p4 + 216)) == $load.i64($M.2.shadow,($p4.shadow + 216)));
requires ($load.i64($M.2,($p4 + 224)) == $load.i64($M.2.shadow,($p4.shadow + 224)));
requires ($load.i64($M.2,($p4 + 232)) == $load.i64($M.2.shadow,($p4.shadow + 232)));
requires ($load.i64($M.2,($p4 + 240)) == $load.i64($M.2.shadow,($p4.shadow + 240)));
requires ($load.i64($M.2,($p4 + 248)) == $load.i64($M.2.shadow,($p4.shadow + 248)));
{
  var $p5: ref;
  var $p5.shadow: ref;
  var $p6: ref;
...
$bb0:
  ...
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 19, 12} true;
  assume {:verifier.code 0} true;
  call {:name $i1} $p6 := __SMACK_value.i64($i1);
  $p6.shadow := $p6;
  assume $isExternal($p6);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p6);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 19, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p6, $p6.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 20, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p2} $p7 := __SMACK_value.ref($p2);
  $p7.shadow := $p7;
  assume $isExternal($p7);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p7);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 20, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p7, $p7.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 21, 12} true;
  assume {:verifier.code 0} true;
  call {:name $i3} $p8 := __SMACK_value.i64($i3);
  $p8.shadow := $p8;
  assume $isExternal($p8);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p8);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 21, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p8, $p8.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 22, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p4} $p9 := __SMACK_value.ref($p4);
  $p9.shadow := $p9;
  assume $isExternal($p9);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p9);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 22, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p9, $p9.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 24, 27} true;
  assume {:verifier.code 1} true;
  $p10 := $bitcast.ref.ref($p4);
  $p10.shadow := $bitcast.ref.ref($p4.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 24, 12} true;
  assume {:verifier.code 1} true;
  call {:name $p4} {:array "$load.i64", $M.2, $p4, 8, 256} $p11 := __SMACK_values($p10, 32);
  $p11.shadow := $p11;
  assume $isExternal($p11);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p11);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 24, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p11, $p11.shadow);
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 29, 2} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_ct_rsaes_pkcs1_v15_unpadding.c", 31, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
