...
const mbedtls_mpi_safe_cond_assign: ref;
axiom (mbedtls_mpi_safe_cond_assign == $sub.ref(0,9288));
procedure {:inline 1} mbedtls_mpi_safe_cond_assign($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i8, $i2.shadow: i8) returns ($r: i32, $r.shadow: i32)
modifies $exn, $M.5, $M.0;
modifies $M.1, $M.2;
modifies $CurrAddr;
{
  var $i3: i64;
  ...
  var $i33.shadow: i64;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 682, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_mpi_safe_cond_assign:arg:assign"} boogie_si_record_i8($i2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 682, 5} true;
  assume {:verifier.code 0} true;
  goto $bb1;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 683, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 683, 5} true;
  ...
  goto $bb4;
$bb4:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 686, 60} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i8.i64($i2);
  $i3.shadow := $zext.i8.i64($i2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 686, 34} true;
  assume {:verifier.code 0} true;
  call $i4, $i4.shadow := mbedtls_ct_mpi_uint_mask($i3, $i3.shadow);
  call {:cexpr "limb_mask"} boogie_si_record_i64($i4);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 688, 5} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb5:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 688, 5} true;
  ...
  assert ($p5 == $p5.shadow);
  $i6 := $load.i64($M.3,$p5);
  $i6.shadow := $load.i64($M.3.shadow,$p5.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 688, 5} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 698, 5} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $r.shadow := $i7.shadow;
  $exn := false;
  ...
  return;
$bb9:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 690, 52} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1));
  $p9.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 690, 52} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $i10 := $load.i32($M.4,$p9);
  $i10.shadow := $load.i32($M.4.shadow,$p9.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 690, 58} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 690, 12} true;
  assume {:verifier.code 0} true;
  call $i13, $i13.shadow := mbedtls_ct_cond_select_sign($i2, $i2.shadow, $i10, $i10.shadow, $i12, $i12.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 690, 8} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1));
  $p14.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 690, 10} true;
  assume {:verifier.code 0} true;
  assert ($p14 == $p14.shadow);
  $M.5 := $store.i32($M.5,$p14,$i13);
  $M.5.shadow := $store.i32($M.5.shadow,$p14.shadow,$i13.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 692, 38} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1));
  $p15.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 692, 38} true;
  assume {:verifier.code 0} true;
  assert ($p15 == $p15.shadow);
  $p16 := $load.ref($M.2,$p15);
  $p16.shadow := $load.ref($M.2.shadow,$p15.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 692, 44} true;
  assume {:verifier.code 0} true;
  ...
  $p18.shadow := $load.ref($M.6.shadow,$p17.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 692, 50} true;
  assume {:verifier.code 0} true;
  $p19 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1));
  $p19.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 692, 50} true;
  assume {:verifier.code 0} true;
  assert ($p19 == $p19.shadow);
  $i20 := $load.i64($M.3,$p19);
  $i20.shadow := $load.i64($M.3.shadow,$p19.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 692, 5} true;
  assume {:verifier.code 0} true;
  call mbedtls_mpi_core_cond_assign($p16, $p16.shadow, $p18, $p18.shadow, $i20, $i20.shadow, $i2, $i2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 694, 24} true;
  assume {:verifier.code 0} true;
  $p21 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1));
  $p21.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 694, 24} true;
  assume {:verifier.code 0} true;
  assert ($p21 == $p21.shadow);
  $i22 := $load.i64($M.3,$p21);
  $i22.shadow := $load.i64($M.3.shadow,$p21.shadow);
  call {:cexpr "i"} boogie_si_record_i64($i22);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 694, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $i22;
  $i23.shadow := $i22.shadow;
  goto $bb10;
$bb10:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 694, 34} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1));
  $p24.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 694, 34} true;
  assume {:verifier.code 0} true;
  assert ($p24 == $p24.shadow);
  $i25 := $load.i64($M.1,$p24);
  $i25.shadow := $load.i64($M.1.shadow,$p24.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 694, 29} true;
  assume {:verifier.code 0} true;
  $i26 := $ult.i64($i23,$i25);
  $i26.shadow := $ult.i64($i23.shadow,$i25.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 694, 5} true;
  assume {:verifier.code 0} true;
...
$bb11:
  assume ($i26 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 695, 20} true;
  assume {:verifier.code 0} true;
  $i27 := $xor.i64($i4,$sub.i64(0,1));
  $i27.shadow := $xor.i64($i4.shadow,$sub.i64(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 695, 12} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1));
  $p28.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 695, 12} true;
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 695, 9} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($p29,$mul.ref($i23,8));
  $p30.shadow := $add.ref($p29.shadow,$mul.ref($i23.shadow,8));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 695, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i32 := $and.i64($i31,$i27);
  $i32.shadow := $and.i64($i31.shadow,$i27.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 695, 17} true;
  assume {:verifier.code 0} true;
  assert ($p30 == $p30.shadow);
  $M.0 := $store.i64($M.0,$p30,$i32);
  $M.0.shadow := $store.i64($M.0.shadow,$p30.shadow,$i32.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 695, 9} true;
  assume {:verifier.code 0} true;
  goto $bb13;
$bb12:
  assume !($i26 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 695, 21} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb13:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 694, 38} true;
  assume {:verifier.code 0} true;
  $i33 := $add.i64($i23,1);
  $i33.shadow := $add.i64($i23.shadow,1);
  call {:cexpr "i"} boogie_si_record_i64($i33);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 694, 5} true;
  assume {:verifier.code 0} true;
  $i23 := $i33;
  $i23.shadow := $i33.shadow;
  goto $bb10;
}
...
const mbedtls_mpi_core_cond_assign: ref;
axiom (mbedtls_mpi_core_cond_assign == $sub.ref(0,12384));
procedure {:inline 1} mbedtls_mpi_core_cond_assign($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64, $i3: i8, $i3.shadow: i8)
modifies $exn;
modifies $M.0;
{
  var $i4: i1;
  var $i4.shadow: i1;
$bb0:
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 163, 11} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_mpi_core_cond_assign:arg:limbs"} boogie_si_record_i64($i2);
  call {:cexpr "mbedtls_mpi_core_cond_assign:arg:assign"} boogie_si_record_i8($i3);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 163, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.ref($p0,$p1);
  $i4.shadow := $eq.ref($p0.shadow,$p1.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 163, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 164, 9} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume !($i4 == 1);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 166, 5} true;
  assume {:verifier.code 0} true;
  call mbedtls_ct_mpi_uint_cond_assign($i2, $i2.shadow, $p0, $p0.shadow, $p1, $p1.shadow, $i3, $i3.shadow);
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 167, 1} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb3:
  assume {:sourceloc "../mbedtls/library/bignum_core.c", 167, 1} true;
...
const mbedtls_ct_mpi_uint_cond_assign: ref;
axiom (mbedtls_ct_mpi_uint_cond_assign == $sub.ref(0,13416));
procedure {:inline 1} mbedtls_ct_mpi_uint_cond_assign($i0: i64, $i0.shadow: i64, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $i3: i8, $i3.shadow: i8)
modifies $M.0, $exn;
{
  var $i4: i32;
  var $i4.shadow: i32;
  ...
  var $i18.shadow: i64;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 317, 36} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_mpi_uint_cond_assign:arg:n"} boogie_si_record_i64($i0);
  call {:cexpr "mbedtls_ct_mpi_uint_cond_assign:arg:condition"} boogie_si_record_i8($i3);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 317, 36} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i8.i32($i3);
  $i4.shadow := $zext.i8.i32($i3.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 317, 35} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32(0,$i4);
  $i5.shadow := $sub.i32(0,$i4.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 317, 35} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i5);
  $i6.shadow := $sext.i32.i64($i5.shadow);
  call {:cexpr "mask"} boogie_si_record_i64($i6);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 323, 10} true;
  assume {:verifier.code 0} true;
  $i7 := 0;
  $i7.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 323, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $ult.i64($i7,$i0);
  $i8.shadow := $ult.i64($i7.shadow,$i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 323, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i8} true;
  assert ($i8 == $i8.shadow);
  goto $bb2, $bb3;
$bb2:
  assume ($i8 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 21} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p2,$mul.ref($i7,8));
  $p9.shadow := $add.ref($p2.shadow,$mul.ref($i7.shadow,8));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 21} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $i10 := $load.i64($M.7,$p9);
  $i10.shadow := $load.i64($M.7.shadow,$p9.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 28} true;
  assume {:verifier.code 0} true;
  $i11 := $and.i64($i10,$i6);
  $i11.shadow := $and.i64($i10.shadow,$i6.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 41} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p1,$mul.ref($i7,8));
  $p12.shadow := $add.ref($p1.shadow,$mul.ref($i7.shadow,8));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 41} true;
  assume {:verifier.code 0} true;
  assert ($p12 == $p12.shadow);
  $i13 := $load.i64($M.0,$p12);
  $i13.shadow := $load.i64($M.0.shadow,$p12.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 51} true;
  assume {:verifier.code 0} true;
  $i14 := $xor.i64($i6,$sub.i64(0,1));
  $i14.shadow := $xor.i64($i6.shadow,$sub.i64(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 49} true;
  assume {:verifier.code 0} true;
  $i15 := $and.i64($i13,$i14);
  $i15.shadow := $and.i64($i13.shadow,$i14.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 37} true;
  assume {:verifier.code 0} true;
  $i16 := $or.i64($i11,$i15);
  $i16.shadow := $or.i64($i11.shadow,$i15.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 9} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($p1,$mul.ref($i7,8));
  $p17.shadow := $add.ref($p1.shadow,$mul.ref($i7.shadow,8));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 17} true;
  assume {:verifier.code 0} true;
  assert ($p17 == $p17.shadow);
  $M.0 := $store.i64($M.0,$p17,$i16);
  $M.0.shadow := $store.i64($M.0.shadow,$p17.shadow,$i16.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 9} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i8 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 325, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 323, 25} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i64($i7,1);
  $i18.shadow := $add.i64($i7.shadow,1);
  call {:cexpr "i"} boogie_si_record_i64($i18);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 323, 5} true;
  assume {:verifier.code 0} true;
  $i7 := $i18;
  $i7.shadow := $i18.shadow;
  goto $bb1;
}
const mbedtls_mpi_safe_cond_assign_wrapper: ref;
axiom (mbedtls_mpi_safe_cond_assign_wrapper == $sub.ref(0,14448));
procedure {:entrypoint} mbedtls_mpi_safe_cond_assign_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i8, $i2.shadow: i8)
...
requires {:public_in $load.i32, $M.5, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1)), 4} true;
requires {:public_in $load.i64, $M.3, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1)), 8} true;
requires {:public_in $load.i64, $M.6, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1)), 8} true;
requires {:public_in $load.i32, $M.4, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1)), 4} true;
modifies $exn;
modifies $M.5, $M.0, $M.1, $M.2;
modifies $CurrAddr;
...
requires ($load.i32($M.5,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1))) == $load.i32($M.5.shadow,$add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(0,1))));
requires ($load.i64($M.3,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1))) == $load.i64($M.3.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(8,1))));
requires ($load.i64($M.6,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1))) == $load.i64($M.6.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(16,1))));
requires ($load.i32($M.4,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1))) == $load.i32($M.4.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(0,1))));
{
  var $p3: ref;
  var $p3.shadow: ref;
  var $p4: ref;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 10, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_mpi_safe_cond_assign_wrapper"} boogie_si_record_ref(mbedtls_mpi_safe_cond_assign_wrapper);
  call {:cexpr "smack:arg:mbedtls_mpi_safe_cond_assign_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:mbedtls_mpi_safe_cond_assign_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:mbedtls_mpi_safe_cond_assign_wrapper:$i2"} boogie_si_record_i8($i2);
  call {:cexpr "mbedtls_mpi_safe_cond_assign_wrapper:arg:assign"} boogie_si_record_i8($i2);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 10, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 10, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p3, $p3.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 11, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p4 := __SMACK_value.ref($p1);
  $p4.shadow := $p4;
  assume $isExternal($p4);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p4);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 11, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 14, 29} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 14, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p7, $p7.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 15, 29} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 15, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p10, $p10.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 16, 29} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1));
  $p11.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(0,1));
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 16, 29} true;
  ...
  $i12 := $load.i32($M.5,$p11);
  $i12.shadow := $load.i32($M.5.shadow,$p11.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 16, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p0} {:field "$load.i32", $M.5, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1)), 4} $p13 := __SMACK_value.i32($i12);
  $p13.shadow := $p13;
  assume $isExternal($p13);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p13);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 16, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p13, $p13.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 18, 29} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 18, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.3, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1)), 8} $p16 := __SMACK_value.i64($i15);
  $p16.shadow := $p16;
  assume $isExternal($p16);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p16);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 18, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p16, $p16.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 19, 29} true;
  assume {:verifier.code 0} true;
  $p17 := $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1));
  $p17.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(16,1));
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 19, 29} true;
  ...
  $p18 := $load.ref($M.6,$p17);
  $p18.shadow := $load.ref($M.6.shadow,$p17.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 19, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.6, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1)), 8} $p19 := __SMACK_value.ref($p18);
  $p19.shadow := $p19;
  assume $isExternal($p19);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p19);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 19, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p19, $p19.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 20, 29} true;
  assume {:verifier.code 0} true;
  ...
  $i21.shadow := $load.i32($M.4.shadow,$p20.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 20, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i32", $M.4, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1)), 4} $p22 := __SMACK_value.i32($i21);
  $p22.shadow := $p22;
  assume $isExternal($p22);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p22);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 20, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p22, $p22.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 23, 2} true;
  assume {:verifier.code 0} true;
  call $i23, $i23.shadow := mbedtls_mpi_safe_cond_assign($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_assign.c", 25, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
