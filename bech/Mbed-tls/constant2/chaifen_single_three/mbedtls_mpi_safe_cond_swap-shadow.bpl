...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,39216));
...
$bb3:
  ...
  assert ($p0 == $p0.shadow);
  assert ($i1 == $i1.shadow);
  call $M.0, $M.0.shadow := $memset.i8($M.0, $M.0.shadow, $p0, $p0.shadow, 0, 0, $i1, $i1.shadow, false, false);
  assume {:sourceloc "../mbedtls/library/platform_util.c", 72, 9} true;
  assume {:verifier.code 0} true;
  goto $bb5;
$bb4:
...
axiom (llvm.memset.p0i8.i64 == $sub.ref(0,5160));
...
$bb4:
  ...
  assert ($p4 == $p4.shadow);
  $i5 := $load.i64($M.1,$p4);
  $i5.shadow := $load.i64($M.1.shadow,$p4.shadow);
...
$bb10:
  ...
  $p11.shadow := $load.ref($M.2.shadow,$p10.shadow);
...
$bb11:
  ...
  $p15.shadow := $load.ref($M.2.shadow,$p14.shadow);
  assume {:sourceloc "../mbedtls/library/bignum.c", 114, 13} true;
  assume {:verifier.code 0} true;
  ...
  call $M.0, $M.0.shadow := $memcpy.i8($M.0, $M.0.shadow, $M.0, $M.0.shadow, $p13, $p13.shadow, $p16, $p16.shadow, $i19, $i19.shadow, false, false);
  ...
  $p21.shadow := $load.ref($M.2.shadow,$p20.shadow);
  ...
  $p25.shadow := $load.ref($M.2.shadow,$p24.shadow);
...
$bb13:
  ...
  $M.1 := $store.i64($M.1,$p27,$i1);
  $M.1.shadow := $store.i64($M.1.shadow,$p27.shadow,$i1.shadow);
  ...
  $M.2 := $store.ref($M.2,$p28,$p7);
  $M.2.shadow := $store.ref($M.2.shadow,$p28.shadow,$p7.shadow);
...
axiom (mbedtls_ct_mpi_uint_mask == $sub.ref(0,9288));
...
axiom (mbedtls_ct_cond_select_sign == $sub.ref(0,10320));
...
axiom (mbedtls_mpi_core_cond_swap == $sub.ref(0,11352));
...
$bb5:
  ...
  $M.0.shadow := $store.i64($M.0.shadow,$p19.shadow,$i18.shadow);
...
axiom (mbedtls_mpi_safe_cond_swap == $sub.ref(0,12384));
...
$bb13:
  ...
  $i11.shadow := $load.i64($M.1.shadow,$p10.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 720, 5} true;
  assume {:verifier.code 0} true;
...
$bb16:
  ...
  $p27.shadow := $load.ref($M.2.shadow,$p26.shadow);
  ...
  $p29.shadow := $load.ref($M.2.shadow,$p28.shadow);
  ...
  $i31.shadow := $load.i64($M.1.shadow,$p30.shadow);
...
axiom (mbedtls_mpi_safe_cond_swap_wrapper == $sub.ref(0,13416));
...
requires {:public_in $load.i64, $M.1, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1)), 8} true;
requires {:public_in $load.i64, $M.2, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1)), 8} true;
requires {:public_in $load.i32, $M.3, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(0,1)), 4} true;
requires {:public_in $load.i64, $M.1, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1)), 8} true;
requires {:public_in $load.i64, $M.2, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1)), 8} true;
requires {:public_in $load.i32, $M.3, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(0,1)), 4} true;
modifies $exn;
modifies $M.3, $M.0, $M.1, $M.2;
modifies $CurrAddr;
requires ($p0 == $p0.shadow);
requires ($p1 == $p1.shadow);
requires ($load.i64($M.1,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1))) == $load.i64($M.1.shadow,$add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(8,1))));
requires ($load.i64($M.2,$add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1))) == $load.i64($M.2.shadow,$add.ref($add.ref($p0.shadow,$mul.ref(0,24)),$mul.ref(16,1))));
...
requires ($load.i64($M.1,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1))) == $load.i64($M.1.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(8,1))));
requires ($load.i64($M.2,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1))) == $load.i64($M.2.shadow,$add.ref($add.ref($p1.shadow,$mul.ref(0,24)),$mul.ref(16,1))));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:name $p0} {:field "$load.i64", $M.1, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(8,1)), 8} $p7 := __SMACK_value.i64($i6);
  $p7.shadow := $p7;
  ...
  assert ($p8 == $p8.shadow);
  $p9 := $load.ref($M.2,$p8);
  $p9.shadow := $load.ref($M.2.shadow,$p8.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 15, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p0} {:field "$load.i64", $M.2, $add.ref($add.ref($p0,$mul.ref(0,24)),$mul.ref(16,1)), 8} $p10 := __SMACK_value.ref($p9);
  $p10.shadow := $p10;
  ...
  $i15.shadow := $load.i64($M.1.shadow,$p14.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 18, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.1, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1)), 8} $p16 := __SMACK_value.i64($i15);
  $p16.shadow := $p16;
  ...
  $p18.shadow := $load.ref($M.2.shadow,$p17.shadow);
  assume {:sourceloc "mbedtls_mpi_safe_cond_swap.c", 19, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} {:field "$load.i64", $M.2, $add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1)), 8} $p19 := __SMACK_value.ref($p18);
  $p19.shadow := $p19;
...
axiom (__SMACK_value == $sub.ref(0,14448));
...
const public_in: ref;
axiom (public_in == $sub.ref(0,15480));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0,29928));
...
axiom (__SMACK_nondet_int == $sub.ref(0,30960));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0,35088));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0,36120));
...
$bb2:
  ...
  assert ($p6 == $p6.shadow);
  assert ($i7 == $i7.shadow);
  call $M.0, $M.0.shadow := $memset.i8($M.0, $M.0.shadow, $p6, $p6.shadow, 0, 0, $i7, $i7.shadow, false, false);
...
axiom (__SMACK_static_init == $sub.ref(0,39216));
