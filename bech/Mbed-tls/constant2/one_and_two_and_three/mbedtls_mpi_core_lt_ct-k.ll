; ModuleID = 'mbedtls_mpi_core_lt_ct.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_mpi_core_lt_ct_wrapper(i64* %0, i64* %1, i64 %2) #0 !dbg !919 {
  ...
  %4 = call %struct.smack_value* (i64*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64*, ...)*)(i64* %0), !dbg !926
  call void @public_in(%struct.smack_value* %4), !dbg !927
  %5 = call %struct.smack_value* (i64*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64*, ...)*)(i64* %1), !dbg !928
  call void @public_in(%struct.smack_value* %5), !dbg !929
  %6 = call %struct.smack_value* (i64, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64, ...)*)(i64 %2), !dbg !930
  call void @public_in(%struct.smack_value* %6), !dbg !931
  %7 = call i32 @mbedtls_mpi_core_lt_ct(i64* %0, i64* %1, i64 %2), !dbg !932
  ret void, !dbg !933
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_mpi_core_lt_ct_wrapper_t() #0 !dbg !934 {
  %1 = call i64* (...) @getA(), !dbg !937
  call void @llvm.dbg.value(metadata i64* %1, metadata !938, metadata !DIExpression()), !dbg !939
  %2 = call i64* (...) @getB(), !dbg !940
  call void @llvm.dbg.value(metadata i64* %2, metadata !941, metadata !DIExpression()), !dbg !939
  %3 = call i64 (...) @getz(), !dbg !942
  call void @llvm.dbg.value(metadata i64 %3, metadata !943, metadata !DIExpression()), !dbg !939
  %4 = call i32 @mbedtls_mpi_core_lt_ct(i64* %1, i64* %2, i64 %3), !dbg !944
  ret void, !dbg !945
}
...
!919 = distinct !DISubprogram(name: "mbedtls_mpi_core_lt_ct_wrapper", scope: !25, file: !25, line: 5, type: !920, scopeLine: 7, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!920 = !DISubroutineType(types: !921)
!921 = !{null, !180, !180, !21}
!922 = !DILocalVariable(name: "A", arg: 1, scope: !919, file: !25, line: 5, type: !180)
!923 = !DILocation(line: 0, scope: !919)
!924 = !DILocalVariable(name: "B", arg: 2, scope: !919, file: !25, line: 6, type: !180)
!925 = !DILocalVariable(name: "limbs", arg: 3, scope: !919, file: !25, line: 7, type: !21)
!926 = !DILocation(line: 11, column: 12, scope: !919)
!927 = !DILocation(line: 11, column: 2, scope: !919)
!928 = !DILocation(line: 12, column: 12, scope: !919)
!929 = !DILocation(line: 12, column: 2, scope: !919)
!930 = !DILocation(line: 13, column: 12, scope: !919)
!931 = !DILocation(line: 13, column: 2, scope: !919)
!932 = !DILocation(line: 18, column: 2, scope: !919)
!933 = !DILocation(line: 20, column: 1, scope: !919)
!934 = distinct !DISubprogram(name: "mbedtls_mpi_core_lt_ct_wrapper_t", scope: !25, file: !25, line: 26, type: !935, scopeLine: 26, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!935 = !DISubroutineType(types: !936)
!936 = !{null}
!937 = !DILocation(line: 28, column: 30, scope: !934)
!938 = !DILocalVariable(name: "A", scope: !934, file: !25, line: 28, type: !180)
!939 = !DILocation(line: 0, scope: !934)
!940 = !DILocation(line: 29, column: 62, scope: !934)
!941 = !DILocalVariable(name: "B", scope: !934, file: !25, line: 29, type: !180)
!942 = !DILocation(line: 30, column: 49, scope: !934)
!943 = !DILocalVariable(name: "limbs", scope: !934, file: !25, line: 30, type: !21)
!944 = !DILocation(line: 32, column: 2, scope: !934)
!945 = !DILocation(line: 33, column: 1, scope: !934)
