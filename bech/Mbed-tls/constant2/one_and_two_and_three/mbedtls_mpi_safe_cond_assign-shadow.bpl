...
modifies $exn, $exn.shadow, $M.0, $M.0.shadow, $M.1, $M.1.shadow, $M.2, $M.2.shadow;
modifies $CurrAddr;
{
  var $i2: i1;
  var $i2.shadow: i1;
...
modifies $exn, $exn.shadow, $M.5, $M.5.shadow, $M.0, $M.0.shadow;
...
modifies $M.5, $M.5.shadow, $M.0, $M.0.shadow, $M.1, $M.1.shadow, $M.2, $M.2.shadow;
modifies $CurrAddr;
{
  var $p3: ref;
  var $p3.shadow: ref;
