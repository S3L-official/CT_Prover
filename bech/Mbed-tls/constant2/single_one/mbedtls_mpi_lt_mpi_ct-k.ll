; ModuleID = 'mbedtls_mpi_lt_mpi_ct.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_mpi_lt_mpi_ct_wrapper(%struct.mbedtls_mpi* %0, %struct.mbedtls_mpi* %1, i32* %2) #0 !dbg !919 {
  call void @llvm.dbg.value(metadata %struct.mbedtls_mpi* %0, metadata !930, metadata !DIExpression()), !dbg !931
  call void @llvm.dbg.value(metadata %struct.mbedtls_mpi* %1, metadata !932, metadata !DIExpression()), !dbg !931
  call void @llvm.dbg.value(metadata i32* %2, metadata !933, metadata !DIExpression()), !dbg !931
  %4 = call %struct.smack_value* (%struct.mbedtls_mpi*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (%struct.mbedtls_mpi*, ...)*)(%struct.mbedtls_mpi* %0), !dbg !934
  call void @public_in(%struct.smack_value* %4), !dbg !935
  %5 = call %struct.smack_value* (%struct.mbedtls_mpi*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (%struct.mbedtls_mpi*, ...)*)(%struct.mbedtls_mpi* %1), !dbg !936
  call void @public_in(%struct.smack_value* %5), !dbg !937
  %6 = call %struct.smack_value* (i32*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i32*, ...)*)(i32* %2), !dbg !938
  call void @public_in(%struct.smack_value* %6), !dbg !939
  %7 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %0, i32 0, i32 1, !dbg !940
  %8 = load i64, i64* %7, align 8, !dbg !940
  %9 = call %struct.smack_value* (i64, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64, ...)*)(i64 %8), !dbg !941
  call void @public_in(%struct.smack_value* %9), !dbg !942
  %10 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %0, i32 0, i32 2, !dbg !943
  %11 = load i64*, i64** %10, align 8, !dbg !943
  %12 = call %struct.smack_value* (i64*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64*, ...)*)(i64* %11), !dbg !944
  call void @public_in(%struct.smack_value* %12), !dbg !945
  %13 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %0, i32 0, i32 0, !dbg !946
  %14 = load i32, i32* %13, align 8, !dbg !946
  %15 = call %struct.smack_value* (i32, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i32, ...)*)(i32 %14), !dbg !947
  call void @public_in(%struct.smack_value* %15), !dbg !948
  %16 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %1, i32 0, i32 1, !dbg !949
  %17 = load i64, i64* %16, align 8, !dbg !949
  %18 = call %struct.smack_value* (i64, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64, ...)*)(i64 %17), !dbg !950
  call void @public_in(%struct.smack_value* %18), !dbg !951
  %19 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %1, i32 0, i32 2, !dbg !952
  %20 = load i64*, i64** %19, align 8, !dbg !952
  %21 = call %struct.smack_value* (i64*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64*, ...)*)(i64* %20), !dbg !953
  call void @public_in(%struct.smack_value* %21), !dbg !954
  %22 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %1, i32 0, i32 0, !dbg !955
  %23 = load i32, i32* %22, align 8, !dbg !955
  %24 = call %struct.smack_value* (i32, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i32, ...)*)(i32 %23), !dbg !956
  call void @public_in(%struct.smack_value* %24), !dbg !957
  %25 = call i32 @mbedtls_mpi_lt_mpi_ct(%struct.mbedtls_mpi* %0, %struct.mbedtls_mpi* %1, i32* %2), !dbg !958
  ret void, !dbg !959
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @vfct_tmp(i64* %0, i64* %1, %struct.mbedtls_mpi* %2, %struct.mbedtls_mpi* %3, i32* %4) #0 !dbg !960 {
  call void @llvm.dbg.value(metadata i64* %0, metadata !963, metadata !DIExpression()), !dbg !964
  call void @llvm.dbg.value(metadata i64* %1, metadata !965, metadata !DIExpression()), !dbg !964
  call void @llvm.dbg.value(metadata %struct.mbedtls_mpi* %2, metadata !966, metadata !DIExpression()), !dbg !964
  call void @llvm.dbg.value(metadata %struct.mbedtls_mpi* %3, metadata !967, metadata !DIExpression()), !dbg !964
  call void @llvm.dbg.value(metadata i32* %4, metadata !968, metadata !DIExpression()), !dbg !964
  %6 = call i32 @mbedtls_mpi_lt_mpi_ct(%struct.mbedtls_mpi* %2, %struct.mbedtls_mpi* %3, i32* %4), !dbg !969
  ret void, !dbg !970
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_mpi_lt_mpi_ct_wrapper_t() #0 !dbg !971 {
  %1 = alloca %struct.mbedtls_mpi, align 8
  %2 = alloca %struct.mbedtls_mpi, align 8
  %3 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata %struct.mbedtls_mpi* %1, metadata !974, metadata !DIExpression()), !dbg !975
  call void (%struct.mbedtls_mpi*, ...) @getA(%struct.mbedtls_mpi* sret(%struct.mbedtls_mpi) align 8 %1), !dbg !976
  call void @llvm.dbg.value(metadata %struct.mbedtls_mpi* %1, metadata !977, metadata !DIExpression()), !dbg !978
  %4 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %1, i32 0, i32 2, !dbg !979
  %5 = load i64*, i64** %4, align 8, !dbg !979
  call void @llvm.dbg.value(metadata i64* %5, metadata !980, metadata !DIExpression()), !dbg !978
  call void @llvm.dbg.declare(metadata %struct.mbedtls_mpi* %2, metadata !981, metadata !DIExpression()), !dbg !982
  call void (%struct.mbedtls_mpi*, ...) @getB(%struct.mbedtls_mpi* sret(%struct.mbedtls_mpi) align 8 %2), !dbg !983
  call void @llvm.dbg.value(metadata %struct.mbedtls_mpi* %2, metadata !984, metadata !DIExpression()), !dbg !978
  %6 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %2, i32 0, i32 2, !dbg !985
  %7 = load i64*, i64** %6, align 8, !dbg !985
  call void @llvm.dbg.value(metadata i64* %7, metadata !986, metadata !DIExpression()), !dbg !978
  call void @llvm.dbg.declare(metadata i32* %3, metadata !987, metadata !DIExpression()), !dbg !988
  %8 = call i32 (...) @getz(), !dbg !989
  store i32 %8, i32* %3, align 4, !dbg !988
  call void @llvm.dbg.value(metadata i32* %3, metadata !990, metadata !DIExpression()), !dbg !978
  call void @vfct_tmp(i64* %5, i64* %7, %struct.mbedtls_mpi* %1, %struct.mbedtls_mpi* %2, i32* %3), !dbg !991
  ret void, !dbg !992
}
...
!919 = distinct !DISubprogram(name: "mbedtls_mpi_lt_mpi_ct_wrapper", scope: !25, file: !25, line: 4, type: !920, scopeLine: 6, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!920 = !DISubroutineType(types: !921)
!921 = !{null, !922, !922, !675}
!922 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !923, size: 64)
!923 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !924)
!924 = !DIDerivedType(tag: DW_TAG_typedef, name: "mbedtls_mpi", file: !94, line: 227, baseType: !925)
!925 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "mbedtls_mpi", file: !94, line: 203, size: 192, elements: !926)
!926 = !{!927, !928, !929}
!927 = !DIDerivedType(tag: DW_TAG_member, name: "private_s", scope: !925, file: !94, line: 216, baseType: !20, size: 32)
!928 = !DIDerivedType(tag: DW_TAG_member, name: "private_n", scope: !925, file: !94, line: 219, baseType: !21, size: 64, offset: 64)
!929 = !DIDerivedType(tag: DW_TAG_member, name: "private_p", scope: !925, file: !94, line: 225, baseType: !179, size: 64, offset: 128)
!930 = !DILocalVariable(name: "X", arg: 1, scope: !919, file: !25, line: 4, type: !922)
!931 = !DILocation(line: 0, scope: !919)
!932 = !DILocalVariable(name: "Y", arg: 2, scope: !919, file: !25, line: 5, type: !922)
!933 = !DILocalVariable(name: "ret", arg: 3, scope: !919, file: !25, line: 6, type: !675)
!934 = !DILocation(line: 10, column: 12, scope: !919)
!935 = !DILocation(line: 10, column: 2, scope: !919)
!936 = !DILocation(line: 11, column: 12, scope: !919)
!937 = !DILocation(line: 11, column: 2, scope: !919)
!938 = !DILocation(line: 12, column: 12, scope: !919)
!939 = !DILocation(line: 12, column: 2, scope: !919)
!940 = !DILocation(line: 14, column: 29, scope: !919)
!941 = !DILocation(line: 14, column: 12, scope: !919)
!942 = !DILocation(line: 14, column: 2, scope: !919)
!943 = !DILocation(line: 15, column: 29, scope: !919)
!944 = !DILocation(line: 15, column: 12, scope: !919)
!945 = !DILocation(line: 15, column: 2, scope: !919)
!946 = !DILocation(line: 16, column: 29, scope: !919)
!947 = !DILocation(line: 16, column: 12, scope: !919)
!948 = !DILocation(line: 16, column: 2, scope: !919)
!949 = !DILocation(line: 18, column: 29, scope: !919)
!950 = !DILocation(line: 18, column: 12, scope: !919)
!951 = !DILocation(line: 18, column: 2, scope: !919)
!952 = !DILocation(line: 19, column: 29, scope: !919)
!953 = !DILocation(line: 19, column: 12, scope: !919)
!954 = !DILocation(line: 19, column: 2, scope: !919)
!955 = !DILocation(line: 20, column: 29, scope: !919)
!956 = !DILocation(line: 20, column: 12, scope: !919)
!957 = !DILocation(line: 20, column: 2, scope: !919)
!958 = !DILocation(line: 23, column: 2, scope: !919)
!959 = !DILocation(line: 25, column: 1, scope: !919)
!960 = distinct !DISubprogram(name: "vfct_tmp", scope: !25, file: !25, line: 31, type: !961, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!961 = !DISubroutineType(types: !962)
!962 = !{null, !179, !179, !922, !922, !675}
!963 = !DILocalVariable(name: "xp", arg: 1, scope: !960, file: !25, line: 31, type: !179)
!964 = !DILocation(line: 0, scope: !960)
!965 = !DILocalVariable(name: "yp", arg: 2, scope: !960, file: !25, line: 32, type: !179)
!966 = !DILocalVariable(name: "X", arg: 3, scope: !960, file: !25, line: 32, type: !922)
!967 = !DILocalVariable(name: "Y", arg: 4, scope: !960, file: !25, line: 33, type: !922)
!968 = !DILocalVariable(name: "ret", arg: 5, scope: !960, file: !25, line: 34, type: !675)
!969 = !DILocation(line: 35, column: 2, scope: !960)
!970 = !DILocation(line: 36, column: 1, scope: !960)
!971 = distinct !DISubprogram(name: "mbedtls_mpi_lt_mpi_ct_wrapper_t", scope: !25, file: !25, line: 38, type: !972, scopeLine: 38, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!972 = !DISubroutineType(types: !973)
!973 = !{null}
!974 = !DILocalVariable(name: "XX", scope: !971, file: !25, line: 39, type: !923)
!975 = !DILocation(line: 39, column: 20, scope: !971)
!976 = !DILocation(line: 39, column: 25, scope: !971)
!977 = !DILocalVariable(name: "X", scope: !971, file: !25, line: 40, type: !922)
!978 = !DILocation(line: 0, scope: !971)
!979 = !DILocation(line: 41, column: 29, scope: !971)
!980 = !DILocalVariable(name: "xp", scope: !971, file: !25, line: 41, type: !179)
!981 = !DILocalVariable(name: "YY", scope: !971, file: !25, line: 42, type: !923)
!982 = !DILocation(line: 42, column: 40, scope: !971)
!983 = !DILocation(line: 42, column: 45, scope: !971)
!984 = !DILocalVariable(name: "Y", scope: !971, file: !25, line: 43, type: !922)
!985 = !DILocation(line: 44, column: 37, scope: !971)
!986 = !DILocalVariable(name: "yp", scope: !971, file: !25, line: 44, type: !179)
!987 = !DILocalVariable(name: "rret", scope: !971, file: !25, line: 45, type: !5)
!988 = !DILocation(line: 45, column: 19, scope: !971)
!989 = !DILocation(line: 45, column: 26, scope: !971)
!990 = !DILocalVariable(name: "ret", scope: !971, file: !25, line: 46, type: !675)
!991 = !DILocation(line: 48, column: 2, scope: !971)
!992 = !DILocation(line: 49, column: 1, scope: !971)
