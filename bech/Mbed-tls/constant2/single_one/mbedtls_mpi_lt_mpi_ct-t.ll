; ModuleID = 'mbedtls_mpi_lt_mpi_ct-k.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_mpi_lt_mpi_ct_wrapper(%struct.mbedtls_mpi* %0, %struct.mbedtls_mpi* %1, i32* %2) #0 !dbg !1833 {
  call void @llvm.dbg.value(metadata %struct.mbedtls_mpi* %0, metadata !1844, metadata !DIExpression()), !dbg !1845, !psr.id !1846
  call void @llvm.dbg.value(metadata %struct.mbedtls_mpi* %1, metadata !1847, metadata !DIExpression()), !dbg !1845, !psr.id !1848
  call void @llvm.dbg.value(metadata i32* %2, metadata !1849, metadata !DIExpression()), !dbg !1845, !psr.id !1850
  %4 = call %struct.smack_value* (%struct.mbedtls_mpi*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (%struct.mbedtls_mpi*, ...)*)(%struct.mbedtls_mpi* %0), !dbg !1851, !psr.id !1852
  call void @public_in(%struct.smack_value* %4), !dbg !1853, !psr.id !1854
  %5 = call %struct.smack_value* (%struct.mbedtls_mpi*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (%struct.mbedtls_mpi*, ...)*)(%struct.mbedtls_mpi* %1), !dbg !1855, !psr.id !1856
  call void @public_in(%struct.smack_value* %5), !dbg !1857, !psr.id !1858
  %6 = call %struct.smack_value* (i32*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i32*, ...)*)(i32* %2), !dbg !1859, !psr.id !1860
  call void @public_in(%struct.smack_value* %6), !dbg !1861, !psr.id !1862
  %7 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %0, i32 0, i32 1, !dbg !1863, !psr.id !1864
  %8 = load i64, i64* %7, align 8, !dbg !1863, !psr.id !1865
  %9 = call %struct.smack_value* (i64, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64, ...)*)(i64 %8), !dbg !1866, !psr.id !1867
  call void @public_in(%struct.smack_value* %9), !dbg !1868, !psr.id !1869
  %10 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %0, i32 0, i32 2, !dbg !1870, !psr.id !1871
  %11 = load i64*, i64** %10, align 8, !dbg !1870, !psr.id !1872
  %12 = call %struct.smack_value* (i64*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64*, ...)*)(i64* %11), !dbg !1873, !psr.id !1874
  call void @public_in(%struct.smack_value* %12), !dbg !1875, !psr.id !1876
  %13 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %0, i32 0, i32 0, !dbg !1877, !psr.id !1878
  %14 = load i32, i32* %13, align 8, !dbg !1877, !psr.id !1879
  %15 = call %struct.smack_value* (i32, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i32, ...)*)(i32 %14), !dbg !1880, !psr.id !1881
  call void @public_in(%struct.smack_value* %15), !dbg !1882, !psr.id !1883
  %16 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %1, i32 0, i32 1, !dbg !1884, !psr.id !1885
  %17 = load i64, i64* %16, align 8, !dbg !1884, !psr.id !1886
  %18 = call %struct.smack_value* (i64, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64, ...)*)(i64 %17), !dbg !1887, !psr.id !1888
  call void @public_in(%struct.smack_value* %18), !dbg !1889, !psr.id !1890
  %19 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %1, i32 0, i32 2, !dbg !1891, !psr.id !1892
  %20 = load i64*, i64** %19, align 8, !dbg !1891, !psr.id !1893
  %21 = call %struct.smack_value* (i64*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64*, ...)*)(i64* %20), !dbg !1894, !psr.id !1895
  call void @public_in(%struct.smack_value* %21), !dbg !1896, !psr.id !1897
  %22 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %1, i32 0, i32 0, !dbg !1898, !psr.id !1899
  %23 = load i32, i32* %22, align 8, !dbg !1898, !psr.id !1900
  %24 = call %struct.smack_value* (i32, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i32, ...)*)(i32 %23), !dbg !1901, !psr.id !1902
  call void @public_in(%struct.smack_value* %24), !dbg !1903, !psr.id !1904
  %25 = call i32 @mbedtls_mpi_lt_mpi_ct(%struct.mbedtls_mpi* %0, %struct.mbedtls_mpi* %1, i32* %2), !dbg !1905, !psr.id !1906
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @vfct_tmp(i64* %0, i64* %1, %struct.mbedtls_mpi* %2, %struct.mbedtls_mpi* %3, i32* %4) #0 !dbg !1909 {
  call void @llvm.dbg.value(metadata i64* %0, metadata !1912, metadata !DIExpression()), !dbg !1913, !psr.id !1914
  call void @llvm.dbg.value(metadata i64* %1, metadata !1915, metadata !DIExpression()), !dbg !1913, !psr.id !1916
  call void @llvm.dbg.value(metadata %struct.mbedtls_mpi* %2, metadata !1917, metadata !DIExpression()), !dbg !1913, !psr.id !1918
  call void @llvm.dbg.value(metadata %struct.mbedtls_mpi* %3, metadata !1919, metadata !DIExpression()), !dbg !1913, !psr.id !1920
  call void @llvm.dbg.value(metadata i32* %4, metadata !1921, metadata !DIExpression()), !dbg !1913, !psr.id !1922
  %6 = call i32 @mbedtls_mpi_lt_mpi_ct(%struct.mbedtls_mpi* %2, %struct.mbedtls_mpi* %3, i32* %4), !dbg !1923, !psr.id !1924
  ret void, !dbg !1925, !psr.id !1926
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_mpi_lt_mpi_ct_wrapper_t() #0 !dbg !1927 {
  %1 = alloca %struct.mbedtls_mpi, align 8, !psr.id !1930
  %2 = alloca %struct.mbedtls_mpi, align 8, !psr.id !1931
  %3 = alloca i32, align 4, !psr.id !1932
  call void @llvm.dbg.declare(metadata %struct.mbedtls_mpi* %1, metadata !1933, metadata !DIExpression()), !dbg !1934, !psr.id !1935
  call void (%struct.mbedtls_mpi*, ...) @getA(%struct.mbedtls_mpi* sret(%struct.mbedtls_mpi) align 8 %1), !dbg !1936, !psr.id !1937
  call void @llvm.dbg.value(metadata %struct.mbedtls_mpi* %1, metadata !1938, metadata !DIExpression()), !dbg !1939, !psr.id !1940
  %4 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %1, i32 0, i32 2, !dbg !1941, !psr.id !1942
  %5 = load i64*, i64** %4, align 8, !dbg !1941, !psr.id !1943
  call void @llvm.dbg.value(metadata i64* %5, metadata !1944, metadata !DIExpression()), !dbg !1939, !psr.id !1945
  call void @llvm.dbg.declare(metadata %struct.mbedtls_mpi* %2, metadata !1946, metadata !DIExpression()), !dbg !1947, !psr.id !1948
  call void (%struct.mbedtls_mpi*, ...) @getB(%struct.mbedtls_mpi* sret(%struct.mbedtls_mpi) align 8 %2), !dbg !1949, !psr.id !1950
  call void @llvm.dbg.value(metadata %struct.mbedtls_mpi* %2, metadata !1951, metadata !DIExpression()), !dbg !1939, !psr.id !1952
  %6 = getelementptr inbounds %struct.mbedtls_mpi, %struct.mbedtls_mpi* %2, i32 0, i32 2, !dbg !1953, !psr.id !1954
  %7 = load i64*, i64** %6, align 8, !dbg !1953, !psr.id !1955
  call void @llvm.dbg.value(metadata i64* %7, metadata !1956, metadata !DIExpression()), !dbg !1939, !psr.id !1957
  call void @llvm.dbg.declare(metadata i32* %3, metadata !1958, metadata !DIExpression()), !dbg !1959, !psr.id !1960
  %8 = call i32 (...) @getz(), !dbg !1961, !psr.id !1962
  store i32 %8, i32* %3, align 4, !dbg !1959, !psr.id !1963
  call void @llvm.dbg.value(metadata i32* %3, metadata !1964, metadata !DIExpression()), !dbg !1939, !psr.id !1965
  call void @vfct_tmp(i64* %5, i64* %7, %struct.mbedtls_mpi* %1, %struct.mbedtls_mpi* %2, i32* %3), !dbg !1966, !psr.id !1967
  ret void, !dbg !1968, !psr.id !1969
}

declare dso_local void @getA(%struct.mbedtls_mpi* sret(%struct.mbedtls_mpi) align 8, ...) #2

declare dso_local void @getB(%struct.mbedtls_mpi* sret(%struct.mbedtls_mpi) align 8, ...) #2

declare dso_local i32 @getz(...) #2
...
entry:
  call void @mbedtls_mpi_lt_mpi_ct_wrapper_t()
  ret void
}
...
!25 = !DIFile(filename: "mbedtls_mpi_lt_mpi_ct.c", directory: "/home/luwei/bech-back/Mbed-tls/constant2")
!26 = !{}
...
!1832 = !{!"913"}
!1833 = distinct !DISubprogram(name: "mbedtls_mpi_lt_mpi_ct_wrapper", scope: !25, file: !25, line: 4, type: !1834, scopeLine: 6, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1834 = !DISubroutineType(types: !1835)
!1835 = !{null, !1836, !1836, !1311}
!1836 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1837, size: 64)
!1837 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1838)
!1838 = !DIDerivedType(tag: DW_TAG_typedef, name: "mbedtls_mpi", file: !141, line: 227, baseType: !1839)
!1839 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "mbedtls_mpi", file: !141, line: 203, size: 192, elements: !1840)
!1840 = !{!1841, !1842, !1843}
!1841 = !DIDerivedType(tag: DW_TAG_member, name: "private_s", scope: !1839, file: !141, line: 216, baseType: !20, size: 32)
!1842 = !DIDerivedType(tag: DW_TAG_member, name: "private_n", scope: !1839, file: !141, line: 219, baseType: !21, size: 64, offset: 64)
!1843 = !DIDerivedType(tag: DW_TAG_member, name: "private_p", scope: !1839, file: !141, line: 225, baseType: !283, size: 64, offset: 128)
!1844 = !DILocalVariable(name: "X", arg: 1, scope: !1833, file: !25, line: 4, type: !1836)
!1845 = !DILocation(line: 0, scope: !1833)
!1846 = !{!"914"}
!1847 = !DILocalVariable(name: "Y", arg: 2, scope: !1833, file: !25, line: 5, type: !1836)
!1848 = !{!"915"}
!1849 = !DILocalVariable(name: "ret", arg: 3, scope: !1833, file: !25, line: 6, type: !1311)
!1850 = !{!"916"}
!1851 = !DILocation(line: 10, column: 12, scope: !1833)
!1852 = !{!"917"}
!1853 = !DILocation(line: 10, column: 2, scope: !1833)
!1854 = !{!"918"}
!1855 = !DILocation(line: 11, column: 12, scope: !1833)
!1856 = !{!"919"}
!1857 = !DILocation(line: 11, column: 2, scope: !1833)
!1858 = !{!"920"}
!1859 = !DILocation(line: 12, column: 12, scope: !1833)
!1860 = !{!"921"}
!1861 = !DILocation(line: 12, column: 2, scope: !1833)
!1862 = !{!"922"}
!1863 = !DILocation(line: 14, column: 29, scope: !1833)
!1864 = !{!"923"}
!1865 = !{!"924"}
!1866 = !DILocation(line: 14, column: 12, scope: !1833)
!1867 = !{!"925"}
!1868 = !DILocation(line: 14, column: 2, scope: !1833)
!1869 = !{!"926"}
!1870 = !DILocation(line: 15, column: 29, scope: !1833)
!1871 = !{!"927"}
!1872 = !{!"928"}
!1873 = !DILocation(line: 15, column: 12, scope: !1833)
!1874 = !{!"929"}
!1875 = !DILocation(line: 15, column: 2, scope: !1833)
!1876 = !{!"930"}
!1877 = !DILocation(line: 16, column: 29, scope: !1833)
!1878 = !{!"931"}
!1879 = !{!"932"}
!1880 = !DILocation(line: 16, column: 12, scope: !1833)
!1881 = !{!"933"}
!1882 = !DILocation(line: 16, column: 2, scope: !1833)
!1883 = !{!"934"}
!1884 = !DILocation(line: 18, column: 29, scope: !1833)
!1885 = !{!"935"}
!1886 = !{!"936"}
!1887 = !DILocation(line: 18, column: 12, scope: !1833)
!1888 = !{!"937"}
!1889 = !DILocation(line: 18, column: 2, scope: !1833)
!1890 = !{!"938"}
!1891 = !DILocation(line: 19, column: 29, scope: !1833)
!1892 = !{!"939"}
!1893 = !{!"940"}
!1894 = !DILocation(line: 19, column: 12, scope: !1833)
!1895 = !{!"941"}
!1896 = !DILocation(line: 19, column: 2, scope: !1833)
!1897 = !{!"942"}
!1898 = !DILocation(line: 20, column: 29, scope: !1833)
!1899 = !{!"943"}
!1900 = !{!"944"}
!1901 = !DILocation(line: 20, column: 12, scope: !1833)
!1902 = !{!"945"}
!1903 = !DILocation(line: 20, column: 2, scope: !1833)
!1904 = !{!"946"}
!1905 = !DILocation(line: 23, column: 2, scope: !1833)
!1906 = !{!"947"}
!1907 = !DILocation(line: 25, column: 1, scope: !1833)
!1908 = !{!"948"}
!1909 = distinct !DISubprogram(name: "vfct_tmp", scope: !25, file: !25, line: 31, type: !1910, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1910 = !DISubroutineType(types: !1911)
!1911 = !{null, !283, !283, !1836, !1836, !1311}
!1912 = !DILocalVariable(name: "xp", arg: 1, scope: !1909, file: !25, line: 31, type: !283)
!1913 = !DILocation(line: 0, scope: !1909)
!1914 = !{!"949"}
!1915 = !DILocalVariable(name: "yp", arg: 2, scope: !1909, file: !25, line: 32, type: !283)
!1916 = !{!"950"}
!1917 = !DILocalVariable(name: "X", arg: 3, scope: !1909, file: !25, line: 32, type: !1836)
!1918 = !{!"951"}
!1919 = !DILocalVariable(name: "Y", arg: 4, scope: !1909, file: !25, line: 33, type: !1836)
!1920 = !{!"952"}
!1921 = !DILocalVariable(name: "ret", arg: 5, scope: !1909, file: !25, line: 34, type: !1311)
!1922 = !{!"953"}
!1923 = !DILocation(line: 35, column: 2, scope: !1909)
!1924 = !{!"954"}
!1925 = !DILocation(line: 36, column: 1, scope: !1909)
!1926 = !{!"955"}
!1927 = distinct !DISubprogram(name: "mbedtls_mpi_lt_mpi_ct_wrapper_t", scope: !25, file: !25, line: 38, type: !1928, scopeLine: 38, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1928 = !DISubroutineType(types: !1929)
!1929 = !{null}
!1930 = !{!"956"}
!1931 = !{!"957"}
!1932 = !{!"958"}
!1933 = !DILocalVariable(name: "XX", scope: !1927, file: !25, line: 39, type: !1837)
!1934 = !DILocation(line: 39, column: 20, scope: !1927)
!1935 = !{!"959"}
!1936 = !DILocation(line: 39, column: 25, scope: !1927)
!1937 = !{!"960"}
!1938 = !DILocalVariable(name: "X", scope: !1927, file: !25, line: 40, type: !1836)
!1939 = !DILocation(line: 0, scope: !1927)
!1940 = !{!"961"}
!1941 = !DILocation(line: 41, column: 29, scope: !1927)
!1942 = !{!"962"}
!1943 = !{!"963"}
!1944 = !DILocalVariable(name: "xp", scope: !1927, file: !25, line: 41, type: !283)
!1945 = !{!"964"}
!1946 = !DILocalVariable(name: "YY", scope: !1927, file: !25, line: 42, type: !1837)
!1947 = !DILocation(line: 42, column: 40, scope: !1927)
!1948 = !{!"965"}
!1949 = !DILocation(line: 42, column: 45, scope: !1927)
!1950 = !{!"966"}
!1951 = !DILocalVariable(name: "Y", scope: !1927, file: !25, line: 43, type: !1836)
!1952 = !{!"967"}
!1953 = !DILocation(line: 44, column: 37, scope: !1927)
!1954 = !{!"968"}
!1955 = !{!"969"}
!1956 = !DILocalVariable(name: "yp", scope: !1927, file: !25, line: 44, type: !283)
!1957 = !{!"970"}
!1958 = !DILocalVariable(name: "rret", scope: !1927, file: !25, line: 45, type: !5)
!1959 = !DILocation(line: 45, column: 19, scope: !1927)
!1960 = !{!"971"}
!1961 = !DILocation(line: 45, column: 26, scope: !1927)
!1962 = !{!"972"}
!1963 = !{!"973"}
!1964 = !DILocalVariable(name: "ret", scope: !1927, file: !25, line: 46, type: !1311)
!1965 = !{!"974"}
!1966 = !DILocation(line: 48, column: 2, scope: !1927)
!1967 = !{!"975"}
!1968 = !DILocation(line: 49, column: 1, scope: !1927)
!1969 = !{!"976"}
