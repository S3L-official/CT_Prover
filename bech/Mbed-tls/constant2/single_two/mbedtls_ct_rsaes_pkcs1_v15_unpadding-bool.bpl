...
requires ($i3.dup == 0);
requires ($p4.dup == 0);
requires ($load.i64($M.2.dup,($p4 + 0)) == 0);
requires ($load.i64($M.2.dup,($p4 + 8)) == 0);
requires ($load.i64($M.2.dup,($p4 + 16)) == 0);
requires ($load.i64($M.2.dup,($p4 + 24)) == 0);
requires ($load.i64($M.2.dup,($p4 + 32)) == 0);
requires ($load.i64($M.2.dup,($p4 + 40)) == 0);
requires ($load.i64($M.2.dup,($p4 + 48)) == 0);
requires ($load.i64($M.2.dup,($p4 + 56)) == 0);
requires ($load.i64($M.2.dup,($p4 + 64)) == 0);
requires ($load.i64($M.2.dup,($p4 + 72)) == 0);
requires ($load.i64($M.2.dup,($p4 + 80)) == 0);
requires ($load.i64($M.2.dup,($p4 + 88)) == 0);
requires ($load.i64($M.2.dup,($p4 + 96)) == 0);
requires ($load.i64($M.2.dup,($p4 + 104)) == 0);
requires ($load.i64($M.2.dup,($p4 + 112)) == 0);
requires ($load.i64($M.2.dup,($p4 + 120)) == 0);
requires ($load.i64($M.2.dup,($p4 + 128)) == 0);
requires ($load.i64($M.2.dup,($p4 + 136)) == 0);
requires ($load.i64($M.2.dup,($p4 + 144)) == 0);
requires ($load.i64($M.2.dup,($p4 + 152)) == 0);
requires ($load.i64($M.2.dup,($p4 + 160)) == 0);
requires ($load.i64($M.2.dup,($p4 + 168)) == 0);
requires ($load.i64($M.2.dup,($p4 + 176)) == 0);
requires ($load.i64($M.2.dup,($p4 + 184)) == 0);
requires ($load.i64($M.2.dup,($p4 + 192)) == 0);
requires ($load.i64($M.2.dup,($p4 + 200)) == 0);
requires ($load.i64($M.2.dup,($p4 + 208)) == 0);
requires ($load.i64($M.2.dup,($p4 + 216)) == 0);
requires ($load.i64($M.2.dup,($p4 + 224)) == 0);
requires ($load.i64($M.2.dup,($p4 + 232)) == 0);
requires ($load.i64($M.2.dup,($p4 + 240)) == 0);
requires ($load.i64($M.2.dup,($p4 + 248)) == 0);
{
  var $p5: ref;
  var $p5.dup: i1;
  var $p6: ref;
