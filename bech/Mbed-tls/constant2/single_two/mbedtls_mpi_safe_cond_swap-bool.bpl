...
$bb5:
  ...
  $M.0.dup := $store.i1($M.0.dup,$p19,$i18.dup);
...
requires ($load.i64($M.1.dup,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(8,1))) == 0);
requires ($load.i64($M.2.dup,$add.ref($add.ref($p1,$mul.ref(0,24)),$mul.ref(16,1))) == 0);
