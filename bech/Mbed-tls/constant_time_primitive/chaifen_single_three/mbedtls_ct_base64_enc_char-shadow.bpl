...
const mbedtls_ct_base64_enc_char: ref;
axiom (mbedtls_ct_base64_enc_char == $sub.ref(0,2064));
procedure {:inline 1} mbedtls_ct_base64_enc_char($i0: i8, $i0.shadow: i8) returns ($r: i8, $r.shadow: i8)
modifies $exn;
{
  var $i1: i8;
  var $i1.shadow: i8;
  ...
  var $i38.shadow: i8;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 337, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_base64_enc_char:arg:value"} boogie_si_record_i8($i0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 337, 14} true;
  assume {:verifier.code 0} true;
  call $i1, $i1.shadow := mbedtls_ct_uchar_mask_of_range(0, 0, 25, 25, $i0, $i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 337, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i8.i32($i1);
  $i2.shadow := $zext.i8.i32($i1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 337, 72} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i8.i32($i0);
  $i3.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 337, 70} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32(65,$i3);
  $i4.shadow := $add.i32(65,$i3.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 337, 62} true;
  assume {:verifier.code 0} true;
  $i5 := $and.i32($i2,$i4);
  $i5.shadow := $and.i32($i2.shadow,$i4.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 337, 11} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i8.i32(0);
  $i6.shadow := $zext.i8.i32(0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 337, 11} true;
  assume {:verifier.code 0} true;
  $i7 := $or.i32($i6,$i5);
  $i7.shadow := $or.i32($i6.shadow,$i5.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 337, 11} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i32.i8($i7);
  $i8.shadow := $trunc.i32.i8($i7.shadow);
  call {:cexpr "digit"} boogie_si_record_i8($i8);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 338, 14} true;
  assume {:verifier.code 0} true;
  call $i9, $i9.shadow := mbedtls_ct_uchar_mask_of_range(26, 26, 51, 51, $i0, $i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 338, 14} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i8.i32($i9);
  $i10.shadow := $zext.i8.i32($i9.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 338, 72} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i8.i32($i0);
  $i11.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 338, 70} true;
  assume {:verifier.code 0} true;
  $i12 := $add.i32(97,$i11);
  $i12.shadow := $add.i32(97,$i11.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 338, 78} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i32($i12,26);
  $i13.shadow := $sub.i32($i12.shadow,26);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 338, 62} true;
  assume {:verifier.code 0} true;
  $i14 := $and.i32($i10,$i13);
  $i14.shadow := $and.i32($i10.shadow,$i13.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 338, 11} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i8.i32($i8);
  $i15.shadow := $zext.i8.i32($i8.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 338, 11} true;
  assume {:verifier.code 0} true;
  $i16 := $or.i32($i15,$i14);
  $i16.shadow := $or.i32($i15.shadow,$i14.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 338, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $trunc.i32.i8($i16);
  $i17.shadow := $trunc.i32.i8($i16.shadow);
  call {:cexpr "digit"} boogie_si_record_i8($i17);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 339, 14} true;
  assume {:verifier.code 0} true;
  call $i18, $i18.shadow := mbedtls_ct_uchar_mask_of_range(52, 52, 61, 61, $i0, $i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 339, 14} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i8.i32($i18);
  $i19.shadow := $zext.i8.i32($i18.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 339, 72} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i8.i32($i0);
  $i20.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 339, 70} true;
  assume {:verifier.code 0} true;
  $i21 := $add.i32(48,$i20);
  $i21.shadow := $add.i32(48,$i20.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 339, 78} true;
  assume {:verifier.code 0} true;
  $i22 := $sub.i32($i21,52);
  $i22.shadow := $sub.i32($i21.shadow,52);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 339, 62} true;
  assume {:verifier.code 0} true;
  $i23 := $and.i32($i19,$i22);
  $i23.shadow := $and.i32($i19.shadow,$i22.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 339, 11} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i8.i32($i17);
  $i24.shadow := $zext.i8.i32($i17.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 339, 11} true;
  assume {:verifier.code 0} true;
  $i25 := $or.i32($i24,$i23);
  $i25.shadow := $or.i32($i24.shadow,$i23.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 339, 11} true;
  assume {:verifier.code 0} true;
  $i26 := $trunc.i32.i8($i25);
  $i26.shadow := $trunc.i32.i8($i25.shadow);
  call {:cexpr "digit"} boogie_si_record_i8($i26);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 340, 14} true;
  assume {:verifier.code 0} true;
  call $i27, $i27.shadow := mbedtls_ct_uchar_mask_of_range(62, 62, 62, 62, $i0, $i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 340, 14} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i8.i32($i27);
  $i28.shadow := $zext.i8.i32($i27.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 340, 62} true;
  assume {:verifier.code 0} true;
  $i29 := $and.i32($i28,43);
  $i29.shadow := $and.i32($i28.shadow,43);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 340, 11} true;
  assume {:verifier.code 0} true;
  $i30 := $zext.i8.i32($i26);
  $i30.shadow := $zext.i8.i32($i26.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 340, 11} true;
  assume {:verifier.code 0} true;
  $i31 := $or.i32($i30,$i29);
  $i31.shadow := $or.i32($i30.shadow,$i29.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 340, 11} true;
  assume {:verifier.code 0} true;
  $i32 := $trunc.i32.i8($i31);
  $i32.shadow := $trunc.i32.i8($i31.shadow);
  call {:cexpr "digit"} boogie_si_record_i8($i32);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 341, 14} true;
  assume {:verifier.code 0} true;
  call $i33, $i33.shadow := mbedtls_ct_uchar_mask_of_range(63, 63, 63, 63, $i0, $i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 341, 14} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i8.i32($i33);
  $i34.shadow := $zext.i8.i32($i33.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 341, 62} true;
  assume {:verifier.code 0} true;
  $i35 := $and.i32($i34,47);
  $i35.shadow := $and.i32($i34.shadow,47);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 341, 11} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i8.i32($i32);
  $i36.shadow := $zext.i8.i32($i32.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 341, 11} true;
  assume {:verifier.code 0} true;
  $i37 := $or.i32($i36,$i35);
  $i37.shadow := $or.i32($i36.shadow,$i35.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 341, 11} true;
  assume {:verifier.code 0} true;
  $i38 := $trunc.i32.i8($i37);
  $i38.shadow := $trunc.i32.i8($i37.shadow);
  call {:cexpr "digit"} boogie_si_record_i8($i38);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 342, 5} true;
  assume {:verifier.code 0} true;
  $r := $i38;
  $r.shadow := $i38.shadow;
  $exn := false;
...
axiom (mbedtls_ct_uchar_mask_of_range == $sub.ref(0,3096));
...
const mbedtls_ct_base64_enc_char_wrapper: ref;
axiom (mbedtls_ct_base64_enc_char_wrapper == $sub.ref(0,4128));
procedure {:entrypoint} mbedtls_ct_base64_enc_char_wrapper($i0: i8, $i0.shadow: i8) returns ($r: i32, $r.shadow: i32)
modifies $exn;
modifies $CurrAddr;
{
  var $i1: i32;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_ct_base64_enc_char.c", 8, 30} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_ct_base64_enc_char_wrapper"} boogie_si_record_ref(mbedtls_ct_base64_enc_char_wrapper);
  call {:cexpr "smack:arg:mbedtls_ct_base64_enc_char_wrapper:$i0"} boogie_si_record_i8($i0);
  call {:cexpr "mbedtls_ct_base64_enc_char_wrapper:arg:value"} boogie_si_record_i8($i0);
  assume {:sourceloc "mbedtls_ct_base64_enc_char.c", 8, 30} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i8.i32($i0);
  $i1.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "mbedtls_ct_base64_enc_char.c", 8, 2} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.shadow := mbedtls_ct_base64_enc_char($i1, $i1.shadow);
  assume {:sourceloc "mbedtls_ct_base64_enc_char.c", 10, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $r.shadow := $u0;
  $exn := false;
