...
const mbedtls_ct_size_mask: ref;
axiom (mbedtls_ct_size_mask == $sub.ref(0,2064));
procedure {:inline 1} mbedtls_ct_size_mask($i0: i64, $i0.shadow: i64) returns ($r: i64, $r.shadow: i64)
modifies $exn;
{
  var $i1: i64;
  var $i1.shadow: i64;
  ...
  var $i4.shadow: i64;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 95, 27} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_size_mask:arg:value"} boogie_si_record_i64($i0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 95, 27} true;
  assume {:verifier.code 0} true;
  $i1 := $sub.i64(0,$i0);
  $i1.shadow := $sub.i64(0,$i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 95, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $or.i64($i0,$i1);
  $i2.shadow := $or.i64($i0.shadow,$i1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 95, 37} true;
  assume {:verifier.code 0} true;
  $i3 := $lshr.i64($i2,63);
  $i3.shadow := $lshr.i64($i2.shadow,63);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 95, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i64(0,$i3);
  $i4.shadow := $sub.i64(0,$i3.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 95, 5} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $r.shadow := $i4.shadow;
  $exn := false;
...
const mbedtls_ct_size_bool_eq: ref;
axiom (mbedtls_ct_size_bool_eq == $sub.ref(0,3096));
procedure {:inline 1} mbedtls_ct_size_bool_eq($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i64;
  var $i2.shadow: i64;
  ...
  var $i7.shadow: i32;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 182, 27} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_size_bool_eq:arg:x"} boogie_si_record_i64($i0);
  call {:cexpr "mbedtls_ct_size_bool_eq:arg:y"} boogie_si_record_i64($i1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 182, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i64($i0,$i1);
  $i2.shadow := $xor.i64($i0.shadow,$i1.shadow);
  call {:cexpr "diff"} boogie_si_record_i64($i2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 192, 47} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i64(0,$i2);
  $i3.shadow := $sub.i64(0,$i2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 192, 36} true;
  assume {:verifier.code 0} true;
  $i4 := $or.i64($i2,$i3);
  $i4.shadow := $or.i64($i2.shadow,$i3.shadow);
  call {:cexpr "diff_msb"} boogie_si_record_i64($i4);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 199, 37} true;
  assume {:verifier.code 0} true;
  $i5 := $lshr.i64($i4,63);
  $i5.shadow := $lshr.i64($i4.shadow,63);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 199, 28} true;
  assume {:verifier.code 0} true;
  $i6 := $trunc.i64.i32($i5);
  $i6.shadow := $trunc.i64.i32($i5.shadow);
  call {:cexpr "diff1"} boogie_si_record_i32($i6);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 201, 15} true;
  assume {:verifier.code 0} true;
  $i7 := $xor.i32(1,$i6);
  $i7.shadow := $xor.i32(1,$i6.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 201, 5} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $r.shadow := $i7.shadow;
  $exn := false;
...
const mbedtls_ct_memcpy_if_eq: ref;
axiom (mbedtls_ct_memcpy_if_eq == $sub.ref(0,4128));
procedure {:inline 1} mbedtls_ct_memcpy_if_eq($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64, $i3: i64, $i3.shadow: i64, $i4: i64, $i4.shadow: i64)
modifies $M.1, $exn;
{
  var $i5: i32;
  var $i5.shadow: i32;
  ...
  var $i25.shadow: i64;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 417, 26} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_memcpy_if_eq:arg:len"} boogie_si_record_i64($i2);
  call {:cexpr "mbedtls_ct_memcpy_if_eq:arg:c1"} boogie_si_record_i64($i3);
  call {:cexpr "mbedtls_ct_memcpy_if_eq:arg:c2"} boogie_si_record_i64($i4);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 417, 26} true;
  assume {:verifier.code 0} true;
  call $i5, $i5.shadow := mbedtls_ct_size_bool_eq($i3, $i3.shadow, $i4, $i4.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 417, 26} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i32.i64($i5);
  $i6.shadow := $zext.i32.i64($i5.shadow);
  call {:cexpr "equal"} boogie_si_record_i64($i6);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 418, 48} true;
  assume {:verifier.code 0} true;
  call $i7, $i7.shadow := mbedtls_ct_size_mask($i6, $i6.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 418, 32} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i64.i8($i7);
  $i8.shadow := $trunc.i64.i8($i7.shadow);
  call {:cexpr "mask"} boogie_si_record_i8($i8);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 421, 10} true;
  assume {:verifier.code 0} true;
  $i9 := 0;
  $i9.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 421, 26} true;
  assume {:verifier.code 0} true;
  $i10 := $ult.i64($i9,$i2);
  $i10.shadow := $ult.i64($i9.shadow,$i2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 421, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i10 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 30} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i8.i32($i8);
  $i14.shadow := $zext.i8.i32($i8.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 28} true;
  assume {:verifier.code 0} true;
  $i15 := $and.i32($i13,$i14);
  $i15.shadow := $and.i32($i13.shadow,$i14.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 41} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p0,$mul.ref($i9,1));
  $p16.shadow := $add.ref($p0.shadow,$mul.ref($i9.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 41} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 52} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i8.i32($i8);
  $i19.shadow := $zext.i8.i32($i8.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 51} true;
  assume {:verifier.code 0} true;
  $i20 := $xor.i32($i19,$sub.i32(0,1));
  $i20.shadow := $xor.i32($i19.shadow,$sub.i32(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 49} true;
  assume {:verifier.code 0} true;
  $i21 := $and.i32($i18,$i20);
  $i21.shadow := $and.i32($i18.shadow,$i20.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 37} true;
  assume {:verifier.code 0} true;
  $i22 := $or.i32($i15,$i21);
  $i22.shadow := $or.i32($i15.shadow,$i21.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 19} true;
  assume {:verifier.code 0} true;
  $i23 := $trunc.i32.i8($i22);
  $i23.shadow := $trunc.i32.i8($i22.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 9} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p0,$mul.ref($i9,1));
  $p24.shadow := $add.ref($p0.shadow,$mul.ref($i9.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 17} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume !($i10 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 423, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 421, 34} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i64($i9,1);
  $i25.shadow := $add.i64($i9.shadow,1);
  call {:cexpr "i"} boogie_si_record_i64($i25);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 421, 5} true;
  assume {:verifier.code 0} true;
  $i9 := $i25;
  $i9.shadow := $i25.shadow;
  goto $bb1;
}
const mbedtls_ct_memcpy_offset: ref;
axiom (mbedtls_ct_memcpy_offset == $sub.ref(0,5160));
procedure {:inline 1} mbedtls_ct_memcpy_offset($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64, $i3: i64, $i3.shadow: i64, $i4: i64, $i4.shadow: i64, $i5: i64, $i5.shadow: i64)
modifies $exn;
modifies $M.1;
{
  var $i6: i64;
  ...
  var $i9.shadow: i64;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 434, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_memcpy_offset:arg:offset"} boogie_si_record_i64($i2);
  call {:cexpr "mbedtls_ct_memcpy_offset:arg:offset_min"} boogie_si_record_i64($i3);
  call {:cexpr "mbedtls_ct_memcpy_offset:arg:offset_max"} boogie_si_record_i64($i4);
  call {:cexpr "mbedtls_ct_memcpy_offset:arg:len"} boogie_si_record_i64($i5);
  call {:cexpr "mbedtls_ct_memcpy_offset:arg:offsetval"} boogie_si_record_i64($i3);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 434, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $i3;
  $i6.shadow := $i3.shadow;
...
$bb1:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 434, 44} true;
  assume {:verifier.code 0} true;
  $i7 := $ule.i64($i6,$i4);
  $i7.shadow := $ule.i64($i6.shadow,$i4.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 434, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i7 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 436, 44} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p1,$mul.ref($i6,1));
  $p8.shadow := $add.ref($p1.shadow,$mul.ref($i6.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 436, 9} true;
  assume {:verifier.code 0} true;
  call mbedtls_ct_memcpy_if_eq($p0, $p0.shadow, $p8, $p8.shadow, $i5, $i5.shadow, $i6, $i6.shadow, $i2, $i2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 438, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i7 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 439, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 434, 68} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i64($i6,1);
  $i9.shadow := $add.i64($i6.shadow,1);
  call {:cexpr "offsetval"} boogie_si_record_i64($i9);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 434, 5} true;
  assume {:verifier.code 0} true;
  $i6 := $i9;
  $i6.shadow := $i9.shadow;
...
const mbedtls_ct_memcpy_offset_wrapper: ref;
axiom (mbedtls_ct_memcpy_offset_wrapper == $sub.ref(0,6192));
procedure {:entrypoint} mbedtls_ct_memcpy_offset_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64, $i3: i64, $i3.shadow: i64, $i4: i64, $i4.shadow: i64, $i5: i64, $i5.shadow: i64) returns ($r: i32, $r.shadow: i32)
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 12, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_ct_memcpy_offset_wrapper"} boogie_si_record_ref(mbedtls_ct_memcpy_offset_wrapper);
  call {:cexpr "smack:arg:mbedtls_ct_memcpy_offset_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:mbedtls_ct_memcpy_offset_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:mbedtls_ct_memcpy_offset_wrapper:$i2"} boogie_si_record_i64($i2);
  call {:cexpr "smack:arg:mbedtls_ct_memcpy_offset_wrapper:$i3"} boogie_si_record_i64($i3);
  call {:cexpr "smack:arg:mbedtls_ct_memcpy_offset_wrapper:$i4"} boogie_si_record_i64($i4);
  call {:cexpr "smack:arg:mbedtls_ct_memcpy_offset_wrapper:$i5"} boogie_si_record_i64($i5);
  call {:cexpr "mbedtls_ct_memcpy_offset_wrapper:arg:offset"} boogie_si_record_i64($i2);
  call {:cexpr "mbedtls_ct_memcpy_offset_wrapper:arg:offset_min"} boogie_si_record_i64($i3);
  call {:cexpr "mbedtls_ct_memcpy_offset_wrapper:arg:offset_max"} boogie_si_record_i64($i4);
  call {:cexpr "mbedtls_ct_memcpy_offset_wrapper:arg:len"} boogie_si_record_i64($i5);
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 12, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 12, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p6, $p6.shadow);
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 13, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p7 := __SMACK_value.ref($p1);
  $p7.shadow := $p7;
  assume $isExternal($p7);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p7);
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p7, $p7.shadow);
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 14, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i3} $p8 := __SMACK_value.i64($i3);
  $p8.shadow := $p8;
  assume $isExternal($p8);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p8);
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p8, $p8.shadow);
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 15, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i4} $p9 := __SMACK_value.i64($i4);
  $p9.shadow := $p9;
  assume $isExternal($p9);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p9);
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 15, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p9, $p9.shadow);
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 16, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i5} $p10 := __SMACK_value.i64($i5);
  $p10.shadow := $p10;
  assume $isExternal($p10);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p10);
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 16, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p10, $p10.shadow);
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 19, 2} true;
  assume {:verifier.code 0} true;
  call $i11, $i11.shadow := mbedtls_ct_memcpy_offset($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow, $i3, $i3.shadow, $i4, $i4.shadow, $i5, $i5.shadow);
  assume {:sourceloc "mbedtls_ct_memcpy_offset.c", 21, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $r.shadow := $u0;
  $exn := false;
