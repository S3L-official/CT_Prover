...
axiom (mbedtls_ct_mpi_uint_cond_assign == $sub.ref(0,2064));
...
$bb2:
  ...
  $M.1.shadow := $store.i64($M.1.shadow,$p17.shadow,$i16.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 324, 9} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
...
const mbedtls_ct_mpi_uint_cond_assign_wrapper: ref;
axiom (mbedtls_ct_mpi_uint_cond_assign_wrapper == $sub.ref(0,3096));
procedure {:entrypoint} mbedtls_ct_mpi_uint_cond_assign_wrapper($i0: i64, $i0.shadow: i64, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $i3: i8, $i3.shadow: i8) returns ($r: i32, $r.shadow: i32)
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_ct_mpi_uint_cond_assign.c", 10, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_ct_mpi_uint_cond_assign_wrapper"} boogie_si_record_ref(mbedtls_ct_mpi_uint_cond_assign_wrapper);
  call {:cexpr "smack:arg:mbedtls_ct_mpi_uint_cond_assign_wrapper:$i0"} boogie_si_record_i64($i0);
  call {:cexpr "smack:arg:mbedtls_ct_mpi_uint_cond_assign_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:mbedtls_ct_mpi_uint_cond_assign_wrapper:$p2"} boogie_si_record_ref($p2);
  call {:cexpr "smack:arg:mbedtls_ct_mpi_uint_cond_assign_wrapper:$i3"} boogie_si_record_i8($i3);
  call {:cexpr "mbedtls_ct_mpi_uint_cond_assign_wrapper:arg:n"} boogie_si_record_i64($i0);
  call {:cexpr "mbedtls_ct_mpi_uint_cond_assign_wrapper:arg:condition"} boogie_si_record_i8($i3);
  assume {:sourceloc "mbedtls_ct_mpi_uint_cond_assign.c", 10, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i0} $p4 := __SMACK_value.i64($i0);
  $p4.shadow := $p4;
  assume $isExternal($p4);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p4);
  assume {:sourceloc "mbedtls_ct_mpi_uint_cond_assign.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "mbedtls_ct_mpi_uint_cond_assign.c", 11, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p5 := __SMACK_value.ref($p1);
  $p5.shadow := $p5;
  assume $isExternal($p5);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p5);
  assume {:sourceloc "mbedtls_ct_mpi_uint_cond_assign.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "mbedtls_ct_mpi_uint_cond_assign.c", 12, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p2} $p6 := __SMACK_value.ref($p2);
  $p6.shadow := $p6;
  assume $isExternal($p6);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p6);
  assume {:sourceloc "mbedtls_ct_mpi_uint_cond_assign.c", 12, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p6, $p6.shadow);
  assume {:sourceloc "mbedtls_ct_mpi_uint_cond_assign.c", 14, 49} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i8.i32($i3);
  $i7.shadow := $zext.i8.i32($i3.shadow);
  assume {:sourceloc "mbedtls_ct_mpi_uint_cond_assign.c", 14, 2} true;
  assume {:verifier.code 0} true;
  call $i8, $i8.shadow := mbedtls_ct_mpi_uint_cond_assign($i0, $i0.shadow, $p1, $p1.shadow, $p2, $p2.shadow, $i7, $i7.shadow);
  assume {:sourceloc "mbedtls_ct_mpi_uint_cond_assign.c", 16, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $r.shadow := $u0;
  $exn := false;
...
axiom (__SMACK_dummy == $sub.ref(0,8256));
...
axiom (__SMACK_loop_exit == $sub.ref(0,18576));
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0,21672));
