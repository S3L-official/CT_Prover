...
procedure {:inline 1} mbedtls_ct_base64_enc_char($i0: i8, $i0.dup: i1) returns ($r: i8, $r.dup: i1)
modifies $exn;
{
  var $i1: i8;
  var $i1.dup: i1;
...
$bb0:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 337, 14} true;
  assume {:verifier.code 0} true;
  call $i1, $i1.dup := mbedtls_ct_uchar_mask_of_range(0, 0, 25, 0, $i0, $i0.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 337, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i8.i32($i1);
  $i2.dup := $i1.dup;
  ...
  assume {:verifier.code 0} true;
  call $i9, $i9.dup := mbedtls_ct_uchar_mask_of_range(26, 0, 51, 0, $i0, $i0.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 338, 14} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i8.i32($i9);
  $i10.dup := $i9.dup;
  ...
  assume {:verifier.code 0} true;
  call $i18, $i18.dup := mbedtls_ct_uchar_mask_of_range(52, 0, 61, 0, $i0, $i0.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 339, 14} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i8.i32($i18);
  $i19.dup := $i18.dup;
  ...
  assume {:verifier.code 0} true;
  call $i27, $i27.dup := mbedtls_ct_uchar_mask_of_range(62, 0, 62, 0, $i0, $i0.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 340, 14} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i8.i32($i27);
  $i28.dup := $i27.dup;
  ...
  assume {:verifier.code 0} true;
  call $i33, $i33.dup := mbedtls_ct_uchar_mask_of_range(63, 0, 63, 0, $i0, $i0.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 341, 14} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i8.i32($i33);
  $i34.dup := $i33.dup;
...
procedure {:entrypoint} mbedtls_ct_base64_enc_char_wrapper($i0: i8, $i0.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
modifies $CurrAddr;
{
  var $i1: i32;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i2, $i2.dup := mbedtls_ct_base64_enc_char($i1, $i1.dup);
