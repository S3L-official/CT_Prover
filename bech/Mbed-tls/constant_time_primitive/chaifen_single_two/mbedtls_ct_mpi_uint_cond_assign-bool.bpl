...
procedure {:entrypoint} mbedtls_ct_mpi_uint_cond_assign_wrapper($i0: i64, $i0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1, $i3: i8, $i3.dup: i1) returns ($r: i32, $r.dup: i1)
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i8, $i8.dup := mbedtls_ct_mpi_uint_cond_assign($i0, $i0.dup, $p1, $p1.dup, $p2, $p2.dup, $i7, $i7.dup);
