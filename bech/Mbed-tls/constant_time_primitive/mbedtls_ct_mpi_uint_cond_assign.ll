; ModuleID = 'mbedtls_ct_mpi_uint_cond_assign.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_mpi_uint_cond_assign_wrapper(i64 %0, i64* %1, i64* %2, i8 zeroext %3) #0 !dbg !919 {
  ...
  call void @llvm.dbg.value(metadata i8 %3, metadata !926, metadata !DIExpression()), !dbg !923
  %5 = call %struct.smack_value* (i64, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64, ...)*)(i64 %0), !dbg !927
  call void @public_in(%struct.smack_value* %5), !dbg !928
  %6 = call %struct.smack_value* (i64*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64*, ...)*)(i64* %1), !dbg !929
  call void @public_in(%struct.smack_value* %6), !dbg !930
  %7 = call %struct.smack_value* (i64*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64*, ...)*)(i64* %2), !dbg !931
  call void @public_in(%struct.smack_value* %7), !dbg !932
  %8 = zext i8 %3 to i32, !dbg !933
  %9 = call i32 (i64, i64*, i64*, i32, ...) bitcast (void (i64, i64*, i64*, i8)* @mbedtls_ct_mpi_uint_cond_assign to i32 (i64, i64*, i64*, i32, ...)*)(i64 %0, i64* %1, i64* %2, i32 %8), !dbg !934
  ret i32 undef, !dbg !935
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_mpi_uint_cond_assign_wrapper_t() #0 !dbg !936 {
  %1 = call i64 (...) @getsize_t(), !dbg !939
  call void @llvm.dbg.value(metadata i64 %1, metadata !940, metadata !DIExpression()), !dbg !941
  %2 = call i64* (...) @getpt1(), !dbg !942
  call void @llvm.dbg.value(metadata i64* %2, metadata !943, metadata !DIExpression()), !dbg !941
  %3 = call i64* (...) @getpt2(), !dbg !944
  call void @llvm.dbg.value(metadata i64* %3, metadata !945, metadata !DIExpression()), !dbg !941
  %4 = call zeroext i8 (...) @getcondition(), !dbg !946
  call void @llvm.dbg.value(metadata i8 %4, metadata !947, metadata !DIExpression()), !dbg !941
  %5 = zext i8 %4 to i32, !dbg !948
  %6 = call i32 (i64, i64*, i64*, i32, ...) bitcast (void (i64, i64*, i64*, i8)* @mbedtls_ct_mpi_uint_cond_assign to i32 (i64, i64*, i64*, i32, ...)*)(i64 %1, i64* %2, i64* %3, i32 %5), !dbg !949
  ret void, !dbg !950
}
...
!919 = distinct !DISubprogram(name: "mbedtls_ct_mpi_uint_cond_assign_wrapper", scope: !25, file: !25, line: 5, type: !920, scopeLine: 8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!920 = !DISubroutineType(types: !921)
!921 = !{!20, !21, !179, !180, !19}
!922 = !DILocalVariable(name: "n", arg: 1, scope: !919, file: !25, line: 5, type: !21)
!923 = !DILocation(line: 0, scope: !919)
!924 = !DILocalVariable(name: "dest", arg: 2, scope: !919, file: !25, line: 6, type: !179)
!925 = !DILocalVariable(name: "src", arg: 3, scope: !919, file: !25, line: 7, type: !180)
!926 = !DILocalVariable(name: "condition", arg: 4, scope: !919, file: !25, line: 8, type: !19)
!927 = !DILocation(line: 10, column: 13, scope: !919)
!928 = !DILocation(line: 10, column: 3, scope: !919)
!929 = !DILocation(line: 11, column: 13, scope: !919)
!930 = !DILocation(line: 11, column: 3, scope: !919)
!931 = !DILocation(line: 12, column: 13, scope: !919)
!932 = !DILocation(line: 12, column: 3, scope: !919)
!933 = !DILocation(line: 14, column: 49, scope: !919)
!934 = !DILocation(line: 14, column: 2, scope: !919)
!935 = !DILocation(line: 16, column: 1, scope: !919)
!936 = distinct !DISubprogram(name: "mbedtls_ct_mpi_uint_cond_assign_wrapper_t", scope: !25, file: !25, line: 25, type: !937, scopeLine: 25, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!937 = !DISubroutineType(types: !938)
!938 = !{null}
!939 = !DILocation(line: 26, column: 13, scope: !936)
!940 = !DILocalVariable(name: "n", scope: !936, file: !25, line: 26, type: !21)
!941 = !DILocation(line: 0, scope: !936)
!942 = !DILocation(line: 27, column: 30, scope: !936)
!943 = !DILocalVariable(name: "dest", scope: !936, file: !25, line: 27, type: !179)
!944 = !DILocation(line: 28, column: 35, scope: !936)
!945 = !DILocalVariable(name: "src", scope: !936, file: !25, line: 28, type: !180)
!946 = !DILocation(line: 29, column: 31, scope: !936)
!947 = !DILocalVariable(name: "condition", scope: !936, file: !25, line: 29, type: !19)
!948 = !DILocation(line: 32, column: 49, scope: !936)
!949 = !DILocation(line: 32, column: 2, scope: !936)
!950 = !DILocation(line: 33, column: 1, scope: !936)
