; ModuleID = 'mbedtls_ct_size_mask_ge.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_size_mask_ge_wrapper(i64 %0, i64 %1) #0 !dbg !919 {
  ...
  %3 = call i32 (i64, i64, ...) bitcast (i64 (i64, i64)* @mbedtls_ct_size_mask_ge to i32 (i64, i64, ...)*)(i64 %0, i64 %1), !dbg !925
  ret i32 undef, !dbg !926
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_size_mask_ge_wrapper_t() #0 !dbg !927 {
  ...
  %3 = call i32 (i64, i64, ...) bitcast (i64 (i64, i64)* @mbedtls_ct_size_mask_ge to i32 (i64, i64, ...)*)(i64 %1, i64 %2), !dbg !935
  ret void, !dbg !936
}
...
!919 = distinct !DISubprogram(name: "mbedtls_ct_size_mask_ge_wrapper", scope: !25, file: !25, line: 3, type: !920, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
...
!926 = !DILocation(line: 11, column: 1, scope: !919)
!927 = distinct !DISubprogram(name: "mbedtls_ct_size_mask_ge_wrapper_t", scope: !25, file: !25, line: 18, type: !928, scopeLine: 18, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!928 = !DISubroutineType(types: !929)
!929 = !{null}
!930 = !DILocation(line: 19, column: 13, scope: !927)
!931 = !DILocalVariable(name: "x", scope: !927, file: !25, line: 19, type: !21)
!932 = !DILocation(line: 0, scope: !927)
!933 = !DILocation(line: 20, column: 13, scope: !927)
!934 = !DILocalVariable(name: "y", scope: !927, file: !25, line: 20, type: !21)
!935 = !DILocation(line: 24, column: 2, scope: !927)
!936 = !DILocation(line: 25, column: 1, scope: !927)
