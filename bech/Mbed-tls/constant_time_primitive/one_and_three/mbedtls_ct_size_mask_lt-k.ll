; ModuleID = 'mbedtls_ct_size_mask_lt.ll'
...
define dso_local i64 @mbedtls_ct_size_mask_ge(i64 %0, i64 %1) #0 !dbg !106 {
  ...
  %3 = call i64 @mbedtls_ct_size_mask_lt.2(i64 %0, i64 %1), !dbg !112
  %4 = xor i64 %3, -1, !dbg !113
  ret i64 %4, !dbg !114
}

; Function Attrs: noinline nounwind uwtable
define internal i64 @mbedtls_ct_size_mask_lt.2(i64 %0, i64 %1) #0 !dbg !115 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_size_mask_lt_wrapper(i64 %0, i64 %1) #0 !dbg !919 {
  ...
  %3 = call i32 (i64, i64, ...) bitcast (i32 (...)* @mbedtls_ct_size_mask_lt to i32 (i64, i64, ...)*)(i64 %0, i64 %1), !dbg !925
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_size_mask_lt_wrapper_t() #0 !dbg !927 {
  ...
  %3 = call i32 (i64, i64, ...) bitcast (i32 (...)* @mbedtls_ct_size_mask_lt to i32 (i64, i64, ...)*)(i64 %1, i64 %2), !dbg !935
  ret void, !dbg !936
}
...
!919 = distinct !DISubprogram(name: "mbedtls_ct_size_mask_lt_wrapper", scope: !25, file: !25, line: 3, type: !920, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
...
!925 = !DILocation(line: 7, column: 2, scope: !919)
!926 = !DILocation(line: 9, column: 1, scope: !919)
!927 = distinct !DISubprogram(name: "mbedtls_ct_size_mask_lt_wrapper_t", scope: !25, file: !25, line: 16, type: !928, scopeLine: 16, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!928 = !DISubroutineType(types: !929)
!929 = !{null}
!930 = !DILocation(line: 17, column: 13, scope: !927)
!931 = !DILocalVariable(name: "x", scope: !927, file: !25, line: 17, type: !21)
!932 = !DILocation(line: 0, scope: !927)
!933 = !DILocation(line: 18, column: 13, scope: !927)
!934 = !DILocalVariable(name: "y", scope: !927, file: !25, line: 18, type: !21)
!935 = !DILocation(line: 20, column: 2, scope: !927)
!936 = !DILocation(line: 21, column: 1, scope: !927)
