; ModuleID = 'mbedtls_ct_mpi_uint_mask.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_mpi_uint_mask_wrapper(i64 %0) #0 !dbg !919 {
  call void @llvm.dbg.value(metadata i64 %0, metadata !922, metadata !DIExpression()), !dbg !923
  %2 = call i32 (i64, ...) bitcast (i64 (i64)* @mbedtls_ct_mpi_uint_mask to i32 (i64, ...)*)(i64 %0), !dbg !924
  ret i32 undef, !dbg !925
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_mpi_uint_mask_wrapper_t() #0 !dbg !926 {
  %1 = call i64 (...) @getv(), !dbg !929
  call void @llvm.dbg.value(metadata i64 %1, metadata !930, metadata !DIExpression()), !dbg !931
  %2 = call i32 (i64, ...) bitcast (i64 (i64)* @mbedtls_ct_mpi_uint_mask to i32 (i64, ...)*)(i64 %1), !dbg !932
  ret void, !dbg !933
}
...
!919 = distinct !DISubprogram(name: "mbedtls_ct_mpi_uint_mask_wrapper", scope: !25, file: !25, line: 5, type: !920, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!920 = !DISubroutineType(types: !921)
!921 = !{!20, !93}
!922 = !DILocalVariable(name: "value", arg: 1, scope: !919, file: !25, line: 5, type: !93)
!923 = !DILocation(line: 0, scope: !919)
!924 = !DILocation(line: 8, column: 2, scope: !919)
!925 = !DILocation(line: 10, column: 1, scope: !919)
!926 = distinct !DISubprogram(name: "mbedtls_ct_mpi_uint_mask_wrapper_t", scope: !25, file: !25, line: 17, type: !927, scopeLine: 17, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!927 = !DISubroutineType(types: !928)
!928 = !{null}
!929 = !DILocation(line: 18, column: 27, scope: !926)
!930 = !DILocalVariable(name: "value", scope: !926, file: !25, line: 18, type: !93)
!931 = !DILocation(line: 0, scope: !926)
!932 = !DILocation(line: 20, column: 2, scope: !926)
!933 = !DILocation(line: 21, column: 1, scope: !926)
