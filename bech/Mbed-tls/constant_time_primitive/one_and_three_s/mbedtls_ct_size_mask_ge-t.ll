; ModuleID = 'mbedtls_ct_size_mask_ge-k.ll'
...
define dso_local i64 @mbedtls_ct_size_mask_ge(i64 %0, i64 %1) #0 !dbg !160 {
  ...
  %3 = call i64 @mbedtls_ct_size_mask_lt(i64 %0, i64 %1), !dbg !168, !psr.id !169, !ValueTainted !129
  %4 = xor i64 %3, -1, !dbg !170, !psr.id !171, !ValueTainted !129
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_size_mask_ge_wrapper(i64 %0, i64 %1) #0 !dbg !1834 {
  call void @llvm.dbg.value(metadata i64 %0, metadata !1837, metadata !DIExpression()), !dbg !1838, !psr.id !1839
  call void @llvm.dbg.value(metadata i64 %1, metadata !1840, metadata !DIExpression()), !dbg !1838, !psr.id !1841
  %3 = call i32 (i64, i64, ...) bitcast (i64 (i64, i64)* @mbedtls_ct_size_mask_ge to i32 (i64, i64, ...)*)(i64 %0, i64 %1), !dbg !1842, !psr.id !1843
  ret i32 undef, !dbg !1844, !psr.id !1845
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_size_mask_ge_wrapper_t() #0 !dbg !1846 {
  %1 = call i64 (...) @getlen(), !dbg !1849, !psr.id !1850
  call void @llvm.dbg.value(metadata i64 %1, metadata !1851, metadata !DIExpression()), !dbg !1852, !psr.id !1853
  %2 = call i64 (...) @getlen2(), !dbg !1854, !psr.id !1855
  call void @llvm.dbg.value(metadata i64 %2, metadata !1856, metadata !DIExpression()), !dbg !1852, !psr.id !1857
  %3 = call i32 (i64, i64, ...) bitcast (i64 (i64, i64)* @mbedtls_ct_size_mask_ge to i32 (i64, i64, ...)*)(i64 %1, i64 %2), !dbg !1858, !psr.id !1859
  ret void, !dbg !1860, !psr.id !1861
}
...
entry:
  call void @mbedtls_ct_size_mask_ge_wrapper_t()
  ret void
}
...
!25 = !DIFile(filename: "mbedtls_ct_size_mask_ge.c", directory: "/home/luwei/bech-back/Mbed-tls/constant_time_primitive")
!26 = !{}
...
!1833 = !{!"913"}
!1834 = distinct !DISubprogram(name: "mbedtls_ct_size_mask_ge_wrapper", scope: !25, file: !25, line: 3, type: !1835, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1835 = !DISubroutineType(types: !1836)
!1836 = !{!20, !21, !21}
!1837 = !DILocalVariable(name: "x", arg: 1, scope: !1834, file: !25, line: 3, type: !21)
!1838 = !DILocation(line: 0, scope: !1834)
!1839 = !{!"914"}
!1840 = !DILocalVariable(name: "y", arg: 2, scope: !1834, file: !25, line: 4, type: !21)
!1841 = !{!"915"}
!1842 = !DILocation(line: 9, column: 2, scope: !1834)
!1843 = !{!"916"}
!1844 = !DILocation(line: 11, column: 1, scope: !1834)
!1845 = !{!"917"}
!1846 = distinct !DISubprogram(name: "mbedtls_ct_size_mask_ge_wrapper_t", scope: !25, file: !25, line: 18, type: !1847, scopeLine: 18, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1847 = !DISubroutineType(types: !1848)
!1848 = !{null}
!1849 = !DILocation(line: 19, column: 13, scope: !1846)
!1850 = !{!"918"}
!1851 = !DILocalVariable(name: "x", scope: !1846, file: !25, line: 19, type: !21)
!1852 = !DILocation(line: 0, scope: !1846)
!1853 = !{!"919"}
!1854 = !DILocation(line: 20, column: 13, scope: !1846)
!1855 = !{!"920"}
!1856 = !DILocalVariable(name: "y", scope: !1846, file: !25, line: 20, type: !21)
!1857 = !{!"921"}
!1858 = !DILocation(line: 24, column: 2, scope: !1846)
!1859 = !{!"922"}
!1860 = !DILocation(line: 25, column: 1, scope: !1846)
!1861 = !{!"923"}
