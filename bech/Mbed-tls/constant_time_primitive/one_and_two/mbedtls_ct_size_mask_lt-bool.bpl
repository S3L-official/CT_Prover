...
procedure {:entrypoint} mbedtls_ct_size_mask_lt_wrapper($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
modifies $CurrAddr;
{
  var $i2: i32;
...
$bb0:
  ...
  assume {:sourceloc "mbedtls_ct_size_mask_lt.c", 7, 2} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.dup := mbedtls_ct_size_mask_lt.i64.i64($i0, $i0.dup, $i1, $i1.dup);
...
procedure {:inline 1} mbedtls_ct_size_mask_lt.i64.i64(p.0: i64, p.0.dup: i1, p.1: i64, p.1.dup: i1) returns ($r: i32, $r.dup: i1);
