...
axiom (mbedtls_ct_size_bool_eq == $sub.ref(0,2064));
...
const mbedtls_ct_size_bool_eq_wrapper: ref;
axiom (mbedtls_ct_size_bool_eq_wrapper == $sub.ref(0,3096));
procedure {:entrypoint} mbedtls_ct_size_bool_eq_wrapper($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $exn;
modifies $CurrAddr;
{
  var $i2: i32;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_ct_size_bool_eq.c", 11, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_ct_size_bool_eq_wrapper"} boogie_si_record_ref(mbedtls_ct_size_bool_eq_wrapper);
  call {:cexpr "smack:arg:mbedtls_ct_size_bool_eq_wrapper:$i0"} boogie_si_record_i64($i0);
  call {:cexpr "smack:arg:mbedtls_ct_size_bool_eq_wrapper:$i1"} boogie_si_record_i64($i1);
  call {:cexpr "mbedtls_ct_size_bool_eq_wrapper:arg:x"} boogie_si_record_i64($i0);
  call {:cexpr "mbedtls_ct_size_bool_eq_wrapper:arg:y"} boogie_si_record_i64($i1);
  assume {:sourceloc "mbedtls_ct_size_bool_eq.c", 11, 2} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.shadow := mbedtls_ct_size_bool_eq($i0, $i0.shadow, $i1, $i1.shadow);
  assume {:sourceloc "mbedtls_ct_size_bool_eq.c", 13, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $r.shadow := $r;
  $exn := false;
