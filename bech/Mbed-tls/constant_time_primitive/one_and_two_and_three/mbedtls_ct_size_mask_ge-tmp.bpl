...
const mbedtls_ct_size_mask_ge: ref;
axiom (mbedtls_ct_size_mask_ge == $sub.ref(0,3096));
procedure {:inline 1} mbedtls_ct_size_mask_ge($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i64, $r.shadow: i64)
modifies $exn;
{
  var $i2: i64;
  var $i2.shadow: i64;
  ...
  var $i3.shadow: i64;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 153, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_size_mask_ge:arg:x"} boogie_si_record_i64($i0);
  call {:cexpr "mbedtls_ct_size_mask_ge:arg:y"} boogie_si_record_i64($i1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 153, 14} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.shadow := mbedtls_ct_size_mask_lt($i0, $i0.shadow, $i1, $i1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 153, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $xor.i64($i2,$sub.i64(0,1));
  $i3.shadow := $xor.i64($i2.shadow,$sub.i64(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 153, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $r.shadow := $r;
  $exn := false;
...
const mbedtls_ct_size_mask_lt: ref;
axiom (mbedtls_ct_size_mask_lt == $sub.ref(0,4128));
procedure {:inline 1} mbedtls_ct_size_mask_lt($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i64, $r.shadow: i64)
modifies $exn;
{
  var $i2: i64;
  var $i2.shadow: i64;
  ...
  var $i4.shadow: i64;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 139, 26} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_size_mask_lt:arg:x"} boogie_si_record_i64($i0);
  call {:cexpr "mbedtls_ct_size_mask_lt:arg:y"} boogie_si_record_i64($i1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 139, 26} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i64($i0,$i1);
  $i2.shadow := $sub.i64($i0.shadow,$i1.shadow);
  call {:cexpr "sub"} boogie_si_record_i64($i2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 142, 29} true;
  assume {:verifier.code 0} true;
  $i3 := $lshr.i64($i2,63);
  $i3.shadow := $lshr.i64($i2.shadow,63);
  call {:cexpr "sub1"} boogie_si_record_i64($i3);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 145, 25} true;
  assume {:verifier.code 0} true;
  call $i4, $i4.shadow := mbedtls_ct_size_mask($i3, $i3.shadow);
  call {:cexpr "mask"} boogie_si_record_i64($i4);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 147, 5} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $r.shadow := $i4.shadow;
  $exn := false;
...
const mbedtls_ct_size_mask_ge_wrapper: ref;
axiom (mbedtls_ct_size_mask_ge_wrapper == $sub.ref(0,5160));
procedure {:entrypoint} mbedtls_ct_size_mask_ge_wrapper($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $exn;
modifies $CurrAddr;
{
  var $i2: i32;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_ct_size_mask_ge.c", 9, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_ct_size_mask_ge_wrapper"} boogie_si_record_ref(mbedtls_ct_size_mask_ge_wrapper);
  call {:cexpr "smack:arg:mbedtls_ct_size_mask_ge_wrapper:$i0"} boogie_si_record_i64($i0);
  call {:cexpr "smack:arg:mbedtls_ct_size_mask_ge_wrapper:$i1"} boogie_si_record_i64($i1);
  call {:cexpr "mbedtls_ct_size_mask_ge_wrapper:arg:x"} boogie_si_record_i64($i0);
  call {:cexpr "mbedtls_ct_size_mask_ge_wrapper:arg:y"} boogie_si_record_i64($i1);
  assume {:sourceloc "mbedtls_ct_size_mask_ge.c", 9, 2} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.shadow := mbedtls_ct_size_mask_ge($i0, $i0.shadow, $i1, $i1.shadow);
  assume {:sourceloc "mbedtls_ct_size_mask_ge.c", 11, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $r.shadow := $r;
  $exn := false;
