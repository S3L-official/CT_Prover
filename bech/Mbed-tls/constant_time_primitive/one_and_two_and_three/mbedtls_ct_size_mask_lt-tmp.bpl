...
const mbedtls_ct_size_mask_lt_wrapper: ref;
axiom (mbedtls_ct_size_mask_lt_wrapper == $sub.ref(0,2064));
procedure {:entrypoint} mbedtls_ct_size_mask_lt_wrapper($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $exn;
modifies $CurrAddr;
{
  var $i2: i32;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_ct_size_mask_lt.c", 7, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_ct_size_mask_lt_wrapper"} boogie_si_record_ref(mbedtls_ct_size_mask_lt_wrapper);
  call {:cexpr "smack:arg:mbedtls_ct_size_mask_lt_wrapper:$i0"} boogie_si_record_i64($i0);
  call {:cexpr "smack:arg:mbedtls_ct_size_mask_lt_wrapper:$i1"} boogie_si_record_i64($i1);
  call {:cexpr "mbedtls_ct_size_mask_lt_wrapper:arg:x"} boogie_si_record_i64($i0);
  call {:cexpr "mbedtls_ct_size_mask_lt_wrapper:arg:y"} boogie_si_record_i64($i1);
  assume {:sourceloc "mbedtls_ct_size_mask_lt.c", 7, 2} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.shadow := mbedtls_ct_size_mask_lt.i64.i64($i0, $i0.shadow, $i1, $i1.shadow);
  assume {:sourceloc "mbedtls_ct_size_mask_lt.c", 9, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $r.shadow := $r;
  $exn := false;
...
axiom (mbedtls_ct_size_mask_lt == $sub.ref(0,3096));
procedure {:inline 1} mbedtls_ct_size_mask_lt.i64.i64(p.0: i64, p.0.shadow: i64, p.1: i64, p.1.shadow: i64) returns ($r: i32, $r.shadow: i32);
