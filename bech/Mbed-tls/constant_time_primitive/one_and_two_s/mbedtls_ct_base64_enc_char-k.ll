; ModuleID = 'mbedtls_ct_base64_enc_char.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_base64_enc_char_wrapper(i8 zeroext %0) #0 !dbg !919 {
  call void @llvm.dbg.value(metadata i8 %0, metadata !922, metadata !DIExpression()), !dbg !923
  %2 = zext i8 %0 to i32, !dbg !924
  %3 = call i32 (i32, ...) bitcast (i8 (i8)* @mbedtls_ct_base64_enc_char to i32 (i32, ...)*)(i32 %2), !dbg !925
  ret i32 undef, !dbg !926
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_base64_enc_char_wrapper_t() #0 !dbg !927 {
  %1 = call zeroext i8 (...) @getv(), !dbg !930
  call void @llvm.dbg.value(metadata i8 %1, metadata !931, metadata !DIExpression()), !dbg !932
  %2 = zext i8 %1 to i32, !dbg !933
  %3 = call i32 (i32, ...) bitcast (i8 (i8)* @mbedtls_ct_base64_enc_char to i32 (i32, ...)*)(i32 %2), !dbg !934
  ret void, !dbg !935
}
...
!919 = distinct !DISubprogram(name: "mbedtls_ct_base64_enc_char_wrapper", scope: !25, file: !25, line: 5, type: !920, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!920 = !DISubroutineType(types: !921)
!921 = !{!20, !19}
!922 = !DILocalVariable(name: "value", arg: 1, scope: !919, file: !25, line: 5, type: !19)
!923 = !DILocation(line: 0, scope: !919)
!924 = !DILocation(line: 8, column: 30, scope: !919)
!925 = !DILocation(line: 8, column: 2, scope: !919)
!926 = !DILocation(line: 10, column: 1, scope: !919)
!927 = distinct !DISubprogram(name: "mbedtls_ct_base64_enc_char_wrapper_t", scope: !25, file: !25, line: 17, type: !928, scopeLine: 17, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!928 = !DISubroutineType(types: !929)
!929 = !{null}
!930 = !DILocation(line: 18, column: 24, scope: !927)
!931 = !DILocalVariable(name: "value", scope: !927, file: !25, line: 18, type: !19)
!932 = !DILocation(line: 0, scope: !927)
!933 = !DILocation(line: 20, column: 30, scope: !927)
!934 = !DILocation(line: 20, column: 2, scope: !927)
!935 = !DILocation(line: 21, column: 1, scope: !927)
