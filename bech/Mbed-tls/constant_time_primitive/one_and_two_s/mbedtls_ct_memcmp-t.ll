; ModuleID = 'mbedtls_ct_memcmp-k.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_memcmp_wrapper(i8* %0, i8* %1, i64 %2) #0 !dbg !1835 {
  call void @llvm.dbg.value(metadata i8* %0, metadata !1836, metadata !DIExpression()), !dbg !1837, !psr.id !1838
  call void @llvm.dbg.value(metadata i8* %1, metadata !1839, metadata !DIExpression()), !dbg !1837, !psr.id !1840
  call void @llvm.dbg.value(metadata i64 %2, metadata !1841, metadata !DIExpression()), !dbg !1837, !psr.id !1842
  %4 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %0), !dbg !1843, !psr.id !1844
  call void @public_in(%struct.smack_value* %4), !dbg !1845, !psr.id !1846
  %5 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %1), !dbg !1847, !psr.id !1848
  call void @public_in(%struct.smack_value* %5), !dbg !1849, !psr.id !1850
  %6 = call %struct.smack_value* (i64, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64, ...)*)(i64 %2), !dbg !1851, !psr.id !1852
  call void @public_in(%struct.smack_value* %6), !dbg !1853, !psr.id !1854
  %7 = call i32 @mbedtls_ct_memcmp(i8* %0, i8* %1, i64 %2), !dbg !1855, !psr.id !1856
  ret i32 undef, !dbg !1857, !psr.id !1858
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_memcmp_wrapper_t() #0 !dbg !1859 {
  %1 = call i8* (...) @getpt1(), !dbg !1862, !psr.id !1863
  call void @llvm.dbg.value(metadata i8* %1, metadata !1864, metadata !DIExpression()), !dbg !1865, !psr.id !1866
  %2 = call i8* (...) @getpt2(), !dbg !1867, !psr.id !1868
  call void @llvm.dbg.value(metadata i8* %2, metadata !1869, metadata !DIExpression()), !dbg !1865, !psr.id !1870
  %3 = call i64 (...) @getlen(), !dbg !1871, !psr.id !1872
  call void @llvm.dbg.value(metadata i64 %3, metadata !1873, metadata !DIExpression()), !dbg !1865, !psr.id !1874
  %4 = call i32 @mbedtls_ct_memcmp(i8* %1, i8* %2, i64 %3), !dbg !1875, !psr.id !1876
...
entry:
  call void @mbedtls_ct_memcmp_wrapper_t()
  ret void
}
...
!25 = !DIFile(filename: "mbedtls_ct_memcmp.c", directory: "/home/luwei/bech-back/Mbed-tls/constant_time_primitive")
!26 = !{}
...
!1834 = !{!"913"}
!1835 = distinct !DISubprogram(name: "mbedtls_ct_memcmp_wrapper", scope: !25, file: !25, line: 3, type: !32, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1836 = !DILocalVariable(name: "a", arg: 1, scope: !1835, file: !25, line: 3, type: !34)
!1837 = !DILocation(line: 0, scope: !1835)
!1838 = !{!"914"}
!1839 = !DILocalVariable(name: "b", arg: 2, scope: !1835, file: !25, line: 4, type: !34)
!1840 = !{!"915"}
!1841 = !DILocalVariable(name: "n", arg: 3, scope: !1835, file: !25, line: 5, type: !21)
!1842 = !{!"916"}
!1843 = !DILocation(line: 9, column: 12, scope: !1835)
!1844 = !{!"917"}
!1845 = !DILocation(line: 9, column: 2, scope: !1835)
!1846 = !{!"918"}
!1847 = !DILocation(line: 10, column: 12, scope: !1835)
!1848 = !{!"919"}
!1849 = !DILocation(line: 10, column: 2, scope: !1835)
!1850 = !{!"920"}
!1851 = !DILocation(line: 11, column: 12, scope: !1835)
!1852 = !{!"921"}
!1853 = !DILocation(line: 11, column: 2, scope: !1835)
!1854 = !{!"922"}
!1855 = !DILocation(line: 15, column: 2, scope: !1835)
!1856 = !{!"923"}
!1857 = !DILocation(line: 17, column: 1, scope: !1835)
!1858 = !{!"924"}
!1859 = distinct !DISubprogram(name: "mbedtls_ct_memcmp_wrapper_t", scope: !25, file: !25, line: 24, type: !1860, scopeLine: 24, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1860 = !DISubroutineType(types: !1861)
!1861 = !{null}
!1862 = !DILocation(line: 25, column: 17, scope: !1859)
!1863 = !{!"925"}
!1864 = !DILocalVariable(name: "a", scope: !1859, file: !25, line: 25, type: !34)
!1865 = !DILocation(line: 0, scope: !1859)
!1866 = !{!"926"}
!1867 = !DILocation(line: 26, column: 39, scope: !1859)
!1868 = !{!"927"}
!1869 = !DILocalVariable(name: "b", scope: !1859, file: !25, line: 26, type: !34)
!1870 = !{!"928"}
!1871 = !DILocation(line: 27, column: 35, scope: !1859)
!1872 = !{!"929"}
!1873 = !DILocalVariable(name: "n", scope: !1859, file: !25, line: 27, type: !21)
!1874 = !{!"930"}
!1875 = !DILocation(line: 31, column: 2, scope: !1859)
!1876 = !{!"931"}
!1877 = !DILocation(line: 32, column: 1, scope: !1859)
!1878 = !{!"932"}
