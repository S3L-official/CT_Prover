; ModuleID = 'mbedtls_ct_memcpy_offset.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_memcpy_offset_wrapper(i8* %0, i8* %1, i64 %2, i64 %3, i64 %4, i64 %5) #0 !dbg !919 {
  ...
  call void @llvm.dbg.value(metadata i64 %5, metadata !928, metadata !DIExpression()), !dbg !923
  %7 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %0), !dbg !929
  call void @public_in(%struct.smack_value* %7), !dbg !930
  %8 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %1), !dbg !931
  call void @public_in(%struct.smack_value* %8), !dbg !932
  %9 = call %struct.smack_value* (i64, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64, ...)*)(i64 %3), !dbg !933
  call void @public_in(%struct.smack_value* %9), !dbg !934
  %10 = call %struct.smack_value* (i64, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64, ...)*)(i64 %4), !dbg !935
  call void @public_in(%struct.smack_value* %10), !dbg !936
  %11 = call %struct.smack_value* (i64, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64, ...)*)(i64 %5), !dbg !937
  call void @public_in(%struct.smack_value* %11), !dbg !938
  %12 = call i32 (i8*, i8*, i64, i64, i64, i64, ...) bitcast (void (i8*, i8*, i64, i64, i64, i64)* @mbedtls_ct_memcpy_offset to i32 (i8*, i8*, i64, i64, i64, i64, ...)*)(i8* %0, i8* %1, i64 %2, i64 %3, i64 %4, i64 %5), !dbg !939
  ret i32 undef, !dbg !940
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_memcpy_offset_wrapper_t() #0 !dbg !941 {
  %1 = call i8* (...) @getdest(), !dbg !944
  call void @llvm.dbg.value(metadata i8* %1, metadata !945, metadata !DIExpression()), !dbg !946
  %2 = call i8* (...) @getsrc(), !dbg !947
  call void @llvm.dbg.value(metadata i8* %2, metadata !948, metadata !DIExpression()), !dbg !946
  %3 = call i64 (...) @getoffset(), !dbg !949
  call void @llvm.dbg.value(metadata i64 %3, metadata !950, metadata !DIExpression()), !dbg !946
  %4 = call i64 (...) @getoffset_min(), !dbg !951
  call void @llvm.dbg.value(metadata i64 %4, metadata !952, metadata !DIExpression()), !dbg !946
  %5 = call i64 (...) @getoffset_max(), !dbg !953
  call void @llvm.dbg.value(metadata i64 %5, metadata !954, metadata !DIExpression()), !dbg !946
  %6 = call i64 (...) @getlen(), !dbg !955
  call void @llvm.dbg.value(metadata i64 %6, metadata !956, metadata !DIExpression()), !dbg !946
  %7 = call i32 (i8*, i8*, i64, i64, i64, i64, ...) bitcast (void (i8*, i8*, i64, i64, i64, i64)* @mbedtls_ct_memcpy_offset to i32 (i8*, i8*, i64, i64, i64, i64, ...)*)(i8* %1, i8* %2, i64 %3, i64 %4, i64 %5, i64 %6), !dbg !957
  ret void, !dbg !958
}
...
!94 = !DIFile(filename: "../mbedtls/include/mbedtls/bignum.h", directory: "/home/luwei/bech-back/Mbed-tls/constant_time_primitive")
...
!919 = distinct !DISubprogram(name: "mbedtls_ct_memcpy_offset_wrapper", scope: !25, file: !25, line: 5, type: !920, scopeLine: 10, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!920 = !DISubroutineType(types: !921)
!921 = !{!20, !310, !311, !21, !21, !21, !21}
!922 = !DILocalVariable(name: "dest", arg: 1, scope: !919, file: !25, line: 5, type: !310)
!923 = !DILocation(line: 0, scope: !919)
!924 = !DILocalVariable(name: "src", arg: 2, scope: !919, file: !25, line: 6, type: !311)
!925 = !DILocalVariable(name: "offset", arg: 3, scope: !919, file: !25, line: 7, type: !21)
!926 = !DILocalVariable(name: "offset_min", arg: 4, scope: !919, file: !25, line: 8, type: !21)
!927 = !DILocalVariable(name: "offset_max", arg: 5, scope: !919, file: !25, line: 9, type: !21)
!928 = !DILocalVariable(name: "len", arg: 6, scope: !919, file: !25, line: 10, type: !21)
!929 = !DILocation(line: 12, column: 12, scope: !919)
!930 = !DILocation(line: 12, column: 2, scope: !919)
!931 = !DILocation(line: 13, column: 13, scope: !919)
!932 = !DILocation(line: 13, column: 3, scope: !919)
!933 = !DILocation(line: 14, column: 13, scope: !919)
!934 = !DILocation(line: 14, column: 3, scope: !919)
!935 = !DILocation(line: 15, column: 13, scope: !919)
!936 = !DILocation(line: 15, column: 3, scope: !919)
!937 = !DILocation(line: 16, column: 13, scope: !919)
!938 = !DILocation(line: 16, column: 3, scope: !919)
!939 = !DILocation(line: 19, column: 2, scope: !919)
!940 = !DILocation(line: 21, column: 1, scope: !919)
!941 = distinct !DISubprogram(name: "mbedtls_ct_memcpy_offset_wrapper_t", scope: !25, file: !25, line: 31, type: !942, scopeLine: 31, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!942 = !DISubroutineType(types: !943)
!943 = !{null}
!944 = !DILocation(line: 32, column: 24, scope: !941)
!945 = !DILocalVariable(name: "dest", scope: !941, file: !25, line: 32, type: !310)
!946 = !DILocation(line: 0, scope: !941)
!947 = !DILocation(line: 33, column: 59, scope: !941)
!948 = !DILocalVariable(name: "src", scope: !941, file: !25, line: 33, type: !311)
!949 = !DILocation(line: 34, column: 48, scope: !941)
!950 = !DILocalVariable(name: "offset", scope: !941, file: !25, line: 34, type: !21)
!951 = !DILocation(line: 35, column: 52, scope: !941)
!952 = !DILocalVariable(name: "offset_min", scope: !941, file: !25, line: 35, type: !21)
!953 = !DILocation(line: 36, column: 52, scope: !941)
!954 = !DILocalVariable(name: "offset_max", scope: !941, file: !25, line: 36, type: !21)
!955 = !DILocation(line: 37, column: 45, scope: !941)
!956 = !DILocalVariable(name: "len", scope: !941, file: !25, line: 37, type: !21)
!957 = !DILocation(line: 39, column: 2, scope: !941)
!958 = !DILocation(line: 40, column: 1, scope: !941)
