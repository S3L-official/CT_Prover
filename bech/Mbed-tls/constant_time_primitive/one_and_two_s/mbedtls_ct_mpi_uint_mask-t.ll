; ModuleID = 'mbedtls_ct_mpi_uint_mask-k.ll'
...
define dso_local i32 @mbedtls_ct_uint_mask(i32 %0) #0 !dbg !105 {
  ...
  %2 = sub i32 0, %0, !dbg !111, !psr.id !112, !ValueTainted !113
  %3 = or i32 %0, %2, !dbg !114, !psr.id !115, !ValueTainted !113
  %4 = lshr i32 %3, 31, !dbg !116, !psr.id !117, !ValueTainted !113
  %5 = sub i32 0, %4, !dbg !118, !psr.id !119, !ValueTainted !113
  ret i32 %5, !dbg !120, !psr.id !121
}

; Function Attrs: noinline nounwind uwtable
define dso_local i64 @mbedtls_ct_size_mask(i64 %0) #0 !dbg !122 {
  call void @llvm.dbg.value(metadata i64 %0, metadata !125, metadata !DIExpression()), !dbg !126, !psr.id !127
  %2 = sub i64 0, %0, !dbg !128, !psr.id !129
  %3 = or i64 %0, %2, !dbg !130, !psr.id !131
  %4 = lshr i64 %3, 63, !dbg !132, !psr.id !133
  %5 = sub i64 0, %4, !dbg !134, !psr.id !135
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_mpi_uint_mask_wrapper(i64 %0) #0 !dbg !1834 {
  call void @llvm.dbg.value(metadata i64 %0, metadata !1837, metadata !DIExpression()), !dbg !1838, !psr.id !1839
  %2 = call i32 (i64, ...) bitcast (i64 (i64)* @mbedtls_ct_mpi_uint_mask to i32 (i64, ...)*)(i64 %0), !dbg !1840, !psr.id !1841
  ret i32 undef, !dbg !1842, !psr.id !1843
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_mpi_uint_mask_wrapper_t() #0 !dbg !1844 {
  %1 = call i64 (...) @getv(), !dbg !1847, !psr.id !1848
  call void @llvm.dbg.value(metadata i64 %1, metadata !1849, metadata !DIExpression()), !dbg !1850, !psr.id !1851
  %2 = call i32 (i64, ...) bitcast (i64 (i64)* @mbedtls_ct_mpi_uint_mask to i32 (i64, ...)*)(i64 %1), !dbg !1852, !psr.id !1853
  ret void, !dbg !1854, !psr.id !1855
}

declare dso_local i64 @getv(...) #2
...
entry:
  call void @mbedtls_ct_mpi_uint_mask_wrapper_t()
  ret void
}
...
!25 = !DIFile(filename: "mbedtls_ct_mpi_uint_mask.c", directory: "/home/luwei/bech-back/Mbed-tls/constant_time_primitive")
!26 = !{}
...
!112 = !{!"36"}
!113 = !{!"ValueTainted"}
!114 = !DILocation(line: 79, column: 25, scope: !105)
!115 = !{!"37"}
!116 = !DILocation(line: 79, column: 37, scope: !105)
!117 = !{!"38"}
!118 = !DILocation(line: 79, column: 13, scope: !105)
!119 = !{!"39"}
!120 = !DILocation(line: 79, column: 5, scope: !105)
!121 = !{!"40"}
!122 = distinct !DISubprogram(name: "mbedtls_ct_size_mask", scope: !1, file: !1, line: 87, type: !123, scopeLine: 88, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !26)
!123 = !DISubroutineType(types: !124)
!124 = !{!21, !21}
!125 = !DILocalVariable(name: "value", arg: 1, scope: !122, file: !1, line: 87, type: !21)
!126 = !DILocation(line: 0, scope: !122)
!127 = !{!"41"}
!128 = !DILocation(line: 95, column: 27, scope: !122)
!129 = !{!"42"}
!130 = !DILocation(line: 95, column: 25, scope: !122)
!131 = !{!"43"}
!132 = !DILocation(line: 95, column: 37, scope: !122)
!133 = !{!"44"}
!134 = !DILocation(line: 95, column: 13, scope: !122)
!135 = !{!"45"}
!136 = !DILocation(line: 95, column: 5, scope: !122)
!137 = !{!"46"}
...
!735 = !{!"330"}
!736 = !{!"331"}
!737 = !DILocalVariable(name: "block_size", scope: !688, file: !1, line: 593, type: !183)
!738 = !{!"332"}
...
!753 = !{!"340"}
!754 = !{!"341"}
!755 = !DILocalVariable(name: "hash_size", scope: !688, file: !1, line: 596, type: !183)
!756 = !{!"342"}
...
!968 = !DIDerivedType(tag: DW_TAG_typedef, name: "mbedtls_mpi", file: !142, line: 227, baseType: !969)
!969 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "mbedtls_mpi", file: !142, line: 203, size: 192, elements: !970)
!970 = !{!971, !972, !973}
!971 = !DIDerivedType(tag: DW_TAG_member, name: "s", scope: !969, file: !142, line: 216, baseType: !20, size: 32)
!972 = !DIDerivedType(tag: DW_TAG_member, name: "n", scope: !969, file: !142, line: 219, baseType: !21, size: 64, offset: 64)
!973 = !DIDerivedType(tag: DW_TAG_member, name: "p", scope: !969, file: !142, line: 225, baseType: !284, size: 64, offset: 128)
...
!998 = !{!"467"}
!999 = !DILocalVariable(name: "limb_mask", scope: !964, file: !1, line: 686, type: !141)
!1000 = !{!"468"}
...
!1103 = !{!"524"}
!1104 = !DILocalVariable(name: "mask", scope: !1082, file: !1, line: 293, type: !218)
!1105 = !{!"525"}
...
!1703 = !{!"853"}
!1704 = distinct !DISubprogram(name: "mbedtls_ct_size_gt", scope: !1, file: !1, line: 217, type: !196, scopeLine: 219, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0, retainedNodes: !26)
...
!1833 = !{!"913"}
!1834 = distinct !DISubprogram(name: "mbedtls_ct_mpi_uint_mask_wrapper", scope: !25, file: !25, line: 5, type: !1835, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1835 = !DISubroutineType(types: !1836)
!1836 = !{!20, !141}
!1837 = !DILocalVariable(name: "value", arg: 1, scope: !1834, file: !25, line: 5, type: !141)
!1838 = !DILocation(line: 0, scope: !1834)
!1839 = !{!"914"}
!1840 = !DILocation(line: 8, column: 2, scope: !1834)
!1841 = !{!"915"}
!1842 = !DILocation(line: 10, column: 1, scope: !1834)
!1843 = !{!"916"}
!1844 = distinct !DISubprogram(name: "mbedtls_ct_mpi_uint_mask_wrapper_t", scope: !25, file: !25, line: 17, type: !1845, scopeLine: 17, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1845 = !DISubroutineType(types: !1846)
!1846 = !{null}
!1847 = !DILocation(line: 18, column: 27, scope: !1844)
!1848 = !{!"917"}
!1849 = !DILocalVariable(name: "value", scope: !1844, file: !25, line: 18, type: !141)
!1850 = !DILocation(line: 0, scope: !1844)
!1851 = !{!"918"}
!1852 = !DILocation(line: 20, column: 2, scope: !1844)
!1853 = !{!"919"}
!1854 = !DILocation(line: 21, column: 1, scope: !1844)
!1855 = !{!"920"}
