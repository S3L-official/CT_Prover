; ModuleID = 'mbedtls_ct_size_bool_eq-k.ll'
...
define dso_local i32 @mbedtls_ct_size_bool_eq(i64 %0, i64 %1) #0 !dbg !194 {
  ...
  %3 = xor i64 %0, %1, !dbg !202, !psr.id !203, !ValueTainted !204
  call void @llvm.dbg.value(metadata i64 %3, metadata !205, metadata !DIExpression()), !dbg !198, !psr.id !206
  %4 = sub i64 0, %3, !dbg !207, !psr.id !208, !ValueTainted !204
  %5 = or i64 %3, %4, !dbg !209, !psr.id !210, !ValueTainted !204
  call void @llvm.dbg.value(metadata i64 %5, metadata !211, metadata !DIExpression()), !dbg !198, !psr.id !212
  %6 = lshr i64 %5, 63, !dbg !213, !psr.id !214, !ValueTainted !204
  %7 = trunc i64 %6 to i32, !dbg !215, !psr.id !216, !ValueTainted !204
  call void @llvm.dbg.value(metadata i32 %7, metadata !217, metadata !DIExpression()), !dbg !198, !psr.id !219
  %8 = xor i32 1, %7, !dbg !220, !psr.id !221, !ValueTainted !204
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_size_bool_eq_wrapper(i64 %0, i64 %1) #0 !dbg !1834 {
  ...
  %3 = call i32 (i64, i64, ...) bitcast (i32 (i64, i64)* @mbedtls_ct_size_bool_eq to i32 (i64, i64, ...)*)(i64 %0, i64 %1), !dbg !1842, !psr.id !1843
  ret i32 undef, !dbg !1844, !psr.id !1845
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_size_bool_eq_wrapper_t() #0 !dbg !1846 {
  ...
  %3 = call i32 (i64, i64, ...) bitcast (i32 (i64, i64)* @mbedtls_ct_size_bool_eq to i32 (i64, i64, ...)*)(i64 %1, i64 %2), !dbg !1858, !psr.id !1859
...
entry:
  call void @mbedtls_ct_size_bool_eq_wrapper_t()
  ret void
}
...
!25 = !DIFile(filename: "mbedtls_ct_size_bool_eq.c", directory: "/home/luwei/bech-back/Mbed-tls/constant_time_primitive")
!26 = !{}
...
!203 = !{!"69"}
!204 = !{!"ValueTainted"}
!205 = !DILocalVariable(name: "diff", scope: !194, file: !1, line: 182, type: !182)
!206 = !{!"70"}
!207 = !DILocation(line: 192, column: 47, scope: !194)
!208 = !{!"71"}
!209 = !DILocation(line: 192, column: 36, scope: !194)
!210 = !{!"72"}
!211 = !DILocalVariable(name: "diff_msb", scope: !194, file: !1, line: 192, type: !182)
!212 = !{!"73"}
!213 = !DILocation(line: 199, column: 37, scope: !194)
!214 = !{!"74"}
!215 = !DILocation(line: 199, column: 28, scope: !194)
!216 = !{!"75"}
!217 = !DILocalVariable(name: "diff1", scope: !194, file: !1, line: 199, type: !218)
!218 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !5)
!219 = !{!"76"}
!220 = !DILocation(line: 201, column: 15, scope: !194)
!221 = !{!"77"}
!222 = !DILocation(line: 201, column: 5, scope: !194)
!223 = !{!"78"}
...
!226 = !{!5, !227, !227}
!227 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !140)
...
!234 = !{!"81"}
!235 = !DILocalVariable(name: "cond", scope: !224, file: !1, line: 232, type: !140)
!236 = !{!"82"}
...
!242 = !{!"85"}
!243 = !DILocalVariable(name: "ret", scope: !224, file: !1, line: 231, type: !140)
!244 = !{!"86"}
...
!1833 = !{!"913"}
!1834 = distinct !DISubprogram(name: "mbedtls_ct_size_bool_eq_wrapper", scope: !25, file: !25, line: 3, type: !1835, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
...
!1841 = !{!"915"}
!1842 = !DILocation(line: 11, column: 2, scope: !1834)
!1843 = !{!"916"}
!1844 = !DILocation(line: 13, column: 1, scope: !1834)
!1845 = !{!"917"}
!1846 = distinct !DISubprogram(name: "mbedtls_ct_size_bool_eq_wrapper_t", scope: !25, file: !25, line: 20, type: !1847, scopeLine: 20, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1847 = !DISubroutineType(types: !1848)
!1848 = !{null}
!1849 = !DILocation(line: 21, column: 13, scope: !1846)
!1850 = !{!"918"}
!1851 = !DILocalVariable(name: "x", scope: !1846, file: !25, line: 21, type: !21)
!1852 = !DILocation(line: 0, scope: !1846)
!1853 = !{!"919"}
!1854 = !DILocation(line: 22, column: 13, scope: !1846)
!1855 = !{!"920"}
!1856 = !DILocalVariable(name: "y", scope: !1846, file: !25, line: 22, type: !21)
!1857 = !{!"921"}
!1858 = !DILocation(line: 26, column: 2, scope: !1846)
!1859 = !{!"922"}
!1860 = !DILocation(line: 27, column: 1, scope: !1846)
!1861 = !{!"923"}
