...
procedure {:inline 1} mbedtls_ct_size_mask_ge($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1) returns ($r: i64, $r.dup: i1)
modifies $exn;
{
  var $i2: i64;
  var $i2.dup: i1;
...
$bb0:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 153, 14} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.dup := mbedtls_ct_size_mask_lt($i0, $i0.dup, $i1, $i1.dup);
...
procedure {:inline 1} mbedtls_ct_size_mask_lt($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1) returns ($r: i64, $r.dup: i1)
modifies $exn;
{
  var $i2: i64;
  var $i2.dup: i1;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i4, $i4.dup := mbedtls_ct_size_mask($i3, $i3.dup);
...
procedure {:entrypoint} mbedtls_ct_size_mask_ge_wrapper($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
modifies $CurrAddr;
{
  var $i2: i32;
...
$bb0:
  ...
  assume {:sourceloc "mbedtls_ct_size_mask_ge.c", 9, 2} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.dup := mbedtls_ct_size_mask_ge($i0, $i0.dup, $i1, $i1.dup);
