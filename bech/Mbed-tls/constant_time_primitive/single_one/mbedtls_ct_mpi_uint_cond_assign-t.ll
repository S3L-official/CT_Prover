; ModuleID = 'mbedtls_ct_mpi_uint_cond_assign-k.ll'
...
define dso_local void @mbedtls_ct_mpi_uint_cond_assign(i64 %0, i64* %1, i64* %2, i8 zeroext %3) #0 !dbg !280 {
  ...
  %5 = zext i8 %3 to i32, !dbg !294, !psr.id !295, !ValueTainted !296
  %6 = sub nsw i32 0, %5, !dbg !297, !psr.id !298, !ValueTainted !296
  %7 = sext i32 %6 to i64, !dbg !297, !psr.id !299, !ValueTainted !296
  call void @llvm.dbg.value(metadata i64 %7, metadata !300, metadata !DIExpression()), !dbg !286, !psr.id !301
  call void @llvm.dbg.value(metadata i64 0, metadata !302, metadata !DIExpression()), !dbg !286, !psr.id !303
  br label %8, !dbg !304, !psr.id !306

8:                                                ; preds = %20, %4
  %.0 = phi i64 [ 0, %4 ], [ %21, %20 ], !dbg !307, !psr.id !308
  call void @llvm.dbg.value(metadata i64 %.0, metadata !302, metadata !DIExpression()), !dbg !286, !psr.id !309
  %9 = icmp ult i64 %.0, %0, !dbg !310, !psr.id !312
  br i1 %9, label %10, label %22, !dbg !313, !psr.id !314

10:                                               ; preds = %8
  %11 = getelementptr inbounds i64, i64* %2, i64 %.0, !dbg !315, !psr.id !316, !PointTainted !317
  %12 = load i64, i64* %11, align 8, !dbg !315, !psr.id !318, !ValueTainted !296
  %13 = and i64 %12, %7, !dbg !319, !psr.id !320, !ValueTainted !296
  %14 = getelementptr inbounds i64, i64* %1, i64 %.0, !dbg !321, !psr.id !322, !PointTainted !317
  %15 = load i64, i64* %14, align 8, !dbg !321, !psr.id !323, !ValueTainted !296
  %16 = xor i64 %7, -1, !dbg !324, !psr.id !325, !ValueTainted !296
  %17 = and i64 %15, %16, !dbg !326, !psr.id !327, !ValueTainted !296
  %18 = or i64 %13, %17, !dbg !328, !psr.id !329, !ValueTainted !296
  %19 = getelementptr inbounds i64, i64* %1, i64 %.0, !dbg !330, !psr.id !331, !PointTainted !317
  store i64 %18, i64* %19, align 8, !dbg !332, !psr.id !333
  br label %20, !dbg !330, !psr.id !334

20:                                               ; preds = %10
  %21 = add i64 %.0, 1, !dbg !335, !psr.id !336
  call void @llvm.dbg.value(metadata i64 %21, metadata !302, metadata !DIExpression()), !dbg !286, !psr.id !337
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_mpi_uint_cond_assign_wrapper(i64 %0, i64* %1, i64* %2, i8 zeroext %3) #0 !dbg !1835 {
  ...
  call void @llvm.dbg.value(metadata i8 %3, metadata !1845, metadata !DIExpression()), !dbg !1839, !psr.id !1846
  %5 = call %struct.smack_value* (i64, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64, ...)*)(i64 %0), !dbg !1847, !psr.id !1848
  call void @public_in(%struct.smack_value* %5), !dbg !1849, !psr.id !1850
  %6 = call %struct.smack_value* (i64*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64*, ...)*)(i64* %1), !dbg !1851, !psr.id !1852
  call void @public_in(%struct.smack_value* %6), !dbg !1853, !psr.id !1854
  %7 = call %struct.smack_value* (i64*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64*, ...)*)(i64* %2), !dbg !1855, !psr.id !1856
  call void @public_in(%struct.smack_value* %7), !dbg !1857, !psr.id !1858
  %8 = zext i8 %3 to i32, !dbg !1859, !psr.id !1860
  %9 = call i32 (i64, i64*, i64*, i32, ...) bitcast (void (i64, i64*, i64*, i8)* @mbedtls_ct_mpi_uint_cond_assign to i32 (i64, i64*, i64*, i32, ...)*)(i64 %0, i64* %1, i64* %2, i32 %8), !dbg !1861, !psr.id !1862
  ret i32 undef, !dbg !1863, !psr.id !1864
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_mpi_uint_cond_assign_wrapper_t() #0 !dbg !1865 {
  %1 = call i64 (...) @getsize_t(), !dbg !1868, !psr.id !1869
  call void @llvm.dbg.value(metadata i64 %1, metadata !1870, metadata !DIExpression()), !dbg !1871, !psr.id !1872
  %2 = call i64* (...) @getpt1(), !dbg !1873, !psr.id !1874
  call void @llvm.dbg.value(metadata i64* %2, metadata !1875, metadata !DIExpression()), !dbg !1871, !psr.id !1876
  %3 = call i64* (...) @getpt2(), !dbg !1877, !psr.id !1878
  call void @llvm.dbg.value(metadata i64* %3, metadata !1879, metadata !DIExpression()), !dbg !1871, !psr.id !1880
  %4 = call zeroext i8 (...) @getcondition(), !dbg !1881, !psr.id !1882
  call void @llvm.dbg.value(metadata i8 %4, metadata !1883, metadata !DIExpression()), !dbg !1871, !psr.id !1884
  %5 = zext i8 %4 to i32, !dbg !1885, !psr.id !1886
  %6 = call i32 (i64, i64*, i64*, i32, ...) bitcast (void (i64, i64*, i64*, i8)* @mbedtls_ct_mpi_uint_cond_assign to i32 (i64, i64*, i64*, i32, ...)*)(i64 %1, i64* %2, i64* %3, i32 %5), !dbg !1887, !psr.id !1888
  ret void, !dbg !1889, !psr.id !1890
}

declare dso_local i64 @getsize_t(...) #2

declare dso_local i64* @getpt1(...) #2

declare dso_local i64* @getpt2(...) #2

declare dso_local zeroext i8 @getcondition(...) #2
...
entry:
  call void @mbedtls_ct_mpi_uint_cond_assign_wrapper_t()
  ret void
}
...
!25 = !DIFile(filename: "mbedtls_ct_mpi_uint_cond_assign.c", directory: "/home/luwei/bech-back/Mbed-tls/constant_time_primitive")
!26 = !{}
...
!295 = !{!"108"}
!296 = !{!"ValueTainted"}
!297 = !DILocation(line: 317, column: 35, scope: !280)
!298 = !{!"109"}
!299 = !{!"110"}
!300 = !DILocalVariable(name: "mask", scope: !280, file: !1, line: 317, type: !226)
!301 = !{!"111"}
!302 = !DILocalVariable(name: "i", scope: !280, file: !1, line: 307, type: !21)
!303 = !{!"112"}
!304 = !DILocation(line: 323, column: 10, scope: !305)
!305 = distinct !DILexicalBlock(scope: !280, file: !1, line: 323, column: 5)
!306 = !{!"113"}
...
!317 = !{!"PointTainted"}
!318 = !{!"119"}
!319 = !DILocation(line: 324, column: 28, scope: !311)
!320 = !{!"120"}
!321 = !DILocation(line: 324, column: 41, scope: !311)
!322 = !{!"121"}
!323 = !{!"122"}
!324 = !DILocation(line: 324, column: 51, scope: !311)
!325 = !{!"123"}
!326 = !DILocation(line: 324, column: 49, scope: !311)
!327 = !{!"124"}
!328 = !DILocation(line: 324, column: 37, scope: !311)
!329 = !{!"125"}
!330 = !DILocation(line: 324, column: 9, scope: !311)
!331 = !{!"126"}
!332 = !DILocation(line: 324, column: 17, scope: !311)
!333 = !{!"127"}
!334 = !{!"128"}
!335 = !DILocation(line: 323, column: 25, scope: !311)
!336 = !{!"129"}
!337 = !{!"130"}
!338 = !DILocation(line: 323, column: 5, scope: !311)
!339 = distinct !{!339, !313, !340, !97}
!340 = !DILocation(line: 324, column: 57, scope: !305)
!341 = !{!"131"}
!342 = !DILocation(line: 325, column: 1, scope: !280)
!343 = !{!"132"}
...
!585 = !{!"263"}
!586 = !{!"264"}
!587 = !DILocalVariable(name: "equal", scope: !567, file: !1, line: 417, type: !182)
!588 = !{!"265"}
...
!736 = !{!"330"}
!737 = !{!"331"}
!738 = !DILocalVariable(name: "block_size", scope: !689, file: !1, line: 593, type: !182)
!739 = !{!"332"}
...
!754 = !{!"340"}
!755 = !{!"341"}
!756 = !DILocalVariable(name: "hash_size", scope: !689, file: !1, line: 596, type: !182)
!757 = !{!"342"}
...
!969 = !DIDerivedType(tag: DW_TAG_typedef, name: "mbedtls_mpi", file: !141, line: 227, baseType: !970)
!970 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "mbedtls_mpi", file: !141, line: 203, size: 192, elements: !971)
!971 = !{!972, !973, !974}
!972 = !DIDerivedType(tag: DW_TAG_member, name: "s", scope: !970, file: !141, line: 216, baseType: !20, size: 32)
!973 = !DIDerivedType(tag: DW_TAG_member, name: "n", scope: !970, file: !141, line: 219, baseType: !21, size: 64, offset: 64)
!974 = !DIDerivedType(tag: DW_TAG_member, name: "p", scope: !970, file: !141, line: 225, baseType: !283, size: 64, offset: 128)
...
!999 = !{!"467"}
!1000 = !DILocalVariable(name: "limb_mask", scope: !965, file: !1, line: 686, type: !140)
!1001 = !{!"468"}
...
!1074 = distinct !{!1074, !1056, !1075, !97}
...
!1104 = !{!"524"}
!1105 = !DILocalVariable(name: "mask", scope: !1083, file: !1, line: 293, type: !217)
!1106 = !{!"525"}
...
!1228 = !{!5, !284, !284, !21}
!1229 = !DILocalVariable(name: "A", arg: 1, scope: !1226, file: !1, line: 735, type: !284)
!1230 = !DILocation(line: 0, scope: !1226)
!1231 = !{!"591"}
!1232 = !DILocalVariable(name: "B", arg: 2, scope: !1226, file: !1, line: 736, type: !284)
!1233 = !{!"592"}
...
!1834 = !{!"913"}
!1835 = distinct !DISubprogram(name: "mbedtls_ct_mpi_uint_cond_assign_wrapper", scope: !25, file: !25, line: 5, type: !1836, scopeLine: 8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1836 = !DISubroutineType(types: !1837)
!1837 = !{!20, !21, !283, !284, !19}
!1838 = !DILocalVariable(name: "n", arg: 1, scope: !1835, file: !25, line: 5, type: !21)
!1839 = !DILocation(line: 0, scope: !1835)
!1840 = !{!"914"}
!1841 = !DILocalVariable(name: "dest", arg: 2, scope: !1835, file: !25, line: 6, type: !283)
!1842 = !{!"915"}
!1843 = !DILocalVariable(name: "src", arg: 3, scope: !1835, file: !25, line: 7, type: !284)
!1844 = !{!"916"}
!1845 = !DILocalVariable(name: "condition", arg: 4, scope: !1835, file: !25, line: 8, type: !19)
!1846 = !{!"917"}
!1847 = !DILocation(line: 10, column: 13, scope: !1835)
!1848 = !{!"918"}
!1849 = !DILocation(line: 10, column: 3, scope: !1835)
!1850 = !{!"919"}
!1851 = !DILocation(line: 11, column: 13, scope: !1835)
!1852 = !{!"920"}
!1853 = !DILocation(line: 11, column: 3, scope: !1835)
!1854 = !{!"921"}
!1855 = !DILocation(line: 12, column: 13, scope: !1835)
!1856 = !{!"922"}
!1857 = !DILocation(line: 12, column: 3, scope: !1835)
!1858 = !{!"923"}
!1859 = !DILocation(line: 14, column: 49, scope: !1835)
!1860 = !{!"924"}
!1861 = !DILocation(line: 14, column: 2, scope: !1835)
!1862 = !{!"925"}
!1863 = !DILocation(line: 16, column: 1, scope: !1835)
!1864 = !{!"926"}
!1865 = distinct !DISubprogram(name: "mbedtls_ct_mpi_uint_cond_assign_wrapper_t", scope: !25, file: !25, line: 25, type: !1866, scopeLine: 25, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1866 = !DISubroutineType(types: !1867)
!1867 = !{null}
!1868 = !DILocation(line: 26, column: 13, scope: !1865)
!1869 = !{!"927"}
!1870 = !DILocalVariable(name: "n", scope: !1865, file: !25, line: 26, type: !21)
!1871 = !DILocation(line: 0, scope: !1865)
!1872 = !{!"928"}
!1873 = !DILocation(line: 27, column: 30, scope: !1865)
!1874 = !{!"929"}
!1875 = !DILocalVariable(name: "dest", scope: !1865, file: !25, line: 27, type: !283)
!1876 = !{!"930"}
!1877 = !DILocation(line: 28, column: 35, scope: !1865)
!1878 = !{!"931"}
!1879 = !DILocalVariable(name: "src", scope: !1865, file: !25, line: 28, type: !284)
!1880 = !{!"932"}
!1881 = !DILocation(line: 29, column: 31, scope: !1865)
!1882 = !{!"933"}
!1883 = !DILocalVariable(name: "condition", scope: !1865, file: !25, line: 29, type: !19)
!1884 = !{!"934"}
!1885 = !DILocation(line: 32, column: 49, scope: !1865)
!1886 = !{!"935"}
!1887 = !DILocation(line: 32, column: 2, scope: !1865)
!1888 = !{!"936"}
!1889 = !DILocation(line: 33, column: 1, scope: !1865)
!1890 = !{!"937"}
