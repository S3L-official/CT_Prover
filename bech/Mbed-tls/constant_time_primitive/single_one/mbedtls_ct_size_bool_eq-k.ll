; ModuleID = 'mbedtls_ct_size_bool_eq.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_size_bool_eq_wrapper(i64 %0, i64 %1) #0 !dbg !919 {
  ...
  %3 = call i32 (i64, i64, ...) bitcast (i32 (i64, i64)* @mbedtls_ct_size_bool_eq to i32 (i64, i64, ...)*)(i64 %0, i64 %1), !dbg !925
  ret i32 undef, !dbg !926
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_size_bool_eq_wrapper_t() #0 !dbg !927 {
  %1 = call i64 (...) @getlen(), !dbg !930
  call void @llvm.dbg.value(metadata i64 %1, metadata !931, metadata !DIExpression()), !dbg !932
  %2 = call i64 (...) @getlen2(), !dbg !933
  call void @llvm.dbg.value(metadata i64 %2, metadata !934, metadata !DIExpression()), !dbg !932
  %3 = call i32 (i64, i64, ...) bitcast (i32 (i64, i64)* @mbedtls_ct_size_bool_eq to i32 (i64, i64, ...)*)(i64 %1, i64 %2), !dbg !935
  ret void, !dbg !936
}
...
!919 = distinct !DISubprogram(name: "mbedtls_ct_size_bool_eq_wrapper", scope: !25, file: !25, line: 3, type: !920, scopeLine: 4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!920 = !DISubroutineType(types: !921)
!921 = !{!20, !21, !21}
!922 = !DILocalVariable(name: "x", arg: 1, scope: !919, file: !25, line: 3, type: !21)
!923 = !DILocation(line: 0, scope: !919)
!924 = !DILocalVariable(name: "y", arg: 2, scope: !919, file: !25, line: 4, type: !21)
!925 = !DILocation(line: 11, column: 2, scope: !919)
!926 = !DILocation(line: 13, column: 1, scope: !919)
!927 = distinct !DISubprogram(name: "mbedtls_ct_size_bool_eq_wrapper_t", scope: !25, file: !25, line: 20, type: !928, scopeLine: 20, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!928 = !DISubroutineType(types: !929)
!929 = !{null}
!930 = !DILocation(line: 21, column: 13, scope: !927)
!931 = !DILocalVariable(name: "x", scope: !927, file: !25, line: 21, type: !21)
!932 = !DILocation(line: 0, scope: !927)
!933 = !DILocation(line: 22, column: 13, scope: !927)
!934 = !DILocalVariable(name: "y", scope: !927, file: !25, line: 22, type: !21)
!935 = !DILocation(line: 26, column: 2, scope: !927)
!936 = !DILocation(line: 27, column: 1, scope: !927)
