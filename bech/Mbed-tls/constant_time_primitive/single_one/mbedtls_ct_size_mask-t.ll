; ModuleID = 'mbedtls_ct_size_mask-k.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_size_mask_wrapper(i64 %0) #0 !dbg !1834 {
  call void @llvm.dbg.value(metadata i64 %0, metadata !1837, metadata !DIExpression()), !dbg !1838, !psr.id !1839
  %2 = call i32 (i64, ...) bitcast (i64 (i64)* @mbedtls_ct_size_mask to i32 (i64, ...)*)(i64 %0), !dbg !1840, !psr.id !1841
  ret i32 undef, !dbg !1842, !psr.id !1843
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_size_mask_wrapper_t() #0 !dbg !1844 {
  %1 = call i64 (...) @getlen2(), !dbg !1847, !psr.id !1848
  call void @llvm.dbg.value(metadata i64 %1, metadata !1849, metadata !DIExpression()), !dbg !1850, !psr.id !1851
  %2 = call i32 (i64, ...) bitcast (i64 (i64)* @mbedtls_ct_size_mask to i32 (i64, ...)*)(i64 %1), !dbg !1852, !psr.id !1853
...
entry:
  call void @mbedtls_ct_size_mask_wrapper_t()
  ret void
}
...
!25 = !DIFile(filename: "mbedtls_ct_size_mask.c", directory: "/home/luwei/bech-back/Mbed-tls/constant_time_primitive")
!26 = !{}
...
!1833 = !{!"913"}
!1834 = distinct !DISubprogram(name: "mbedtls_ct_size_mask_wrapper", scope: !25, file: !25, line: 3, type: !1835, scopeLine: 3, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1835 = !DISubroutineType(types: !1836)
!1836 = !{!20, !21}
!1837 = !DILocalVariable(name: "value", arg: 1, scope: !1834, file: !25, line: 3, type: !21)
!1838 = !DILocation(line: 0, scope: !1834)
!1839 = !{!"914"}
!1840 = !DILocation(line: 10, column: 2, scope: !1834)
!1841 = !{!"915"}
!1842 = !DILocation(line: 12, column: 1, scope: !1834)
!1843 = !{!"916"}
!1844 = distinct !DISubprogram(name: "mbedtls_ct_size_mask_wrapper_t", scope: !25, file: !25, line: 19, type: !1845, scopeLine: 19, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!1845 = !DISubroutineType(types: !1846)
!1846 = !{null}
!1847 = !DILocation(line: 20, column: 17, scope: !1844)
!1848 = !{!"917"}
!1849 = !DILocalVariable(name: "value", scope: !1844, file: !25, line: 20, type: !21)
!1850 = !DILocation(line: 0, scope: !1844)
!1851 = !{!"918"}
!1852 = !DILocation(line: 24, column: 2, scope: !1844)
!1853 = !{!"919"}
!1854 = !DILocation(line: 25, column: 1, scope: !1844)
!1855 = !{!"920"}
