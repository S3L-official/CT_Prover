...
const mbedtls_ct_uchar_mask_of_range: ref;
axiom (mbedtls_ct_uchar_mask_of_range == $sub.ref(0,2064));
procedure {:inline 1} mbedtls_ct_uchar_mask_of_range($i0: i8, $i0.shadow: i8, $i1: i8, $i1.shadow: i8, $i2: i8, $i2.shadow: i8) returns ($r: i8, $r.shadow: i8)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
  ...
  var $i14.shadow: i8;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 170, 27} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_uchar_mask_of_range:arg:low"} boogie_si_record_i8($i0);
  call {:cexpr "mbedtls_ct_uchar_mask_of_range:arg:high"} boogie_si_record_i8($i1);
  call {:cexpr "mbedtls_ct_uchar_mask_of_range:arg:c"} boogie_si_record_i8($i2);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 170, 27} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i8.i32($i2);
  $i3.shadow := $zext.i8.i32($i2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 170, 42} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i8.i32($i0);
  $i4.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 170, 40} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32($i3,$i4);
  $i5.shadow := $sub.i32($i3.shadow,$i4.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 170, 48} true;
  assume {:verifier.code 0} true;
  $i6 := $lshr.i32($i5,8);
  $i6.shadow := $lshr.i32($i5.shadow,8);
  call {:cexpr "low_mask"} boogie_si_record_i32($i6);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 172, 28} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i8.i32($i1);
  $i7.shadow := $zext.i8.i32($i1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 172, 46} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i8.i32($i2);
  $i8.shadow := $zext.i8.i32($i2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 172, 44} true;
  assume {:verifier.code 0} true;
  $i9 := $sub.i32($i7,$i8);
  $i9.shadow := $sub.i32($i7.shadow,$i8.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 172, 50} true;
  assume {:verifier.code 0} true;
  $i10 := $lshr.i32($i9,8);
  $i10.shadow := $lshr.i32($i9.shadow,8);
  call {:cexpr "high_mask"} boogie_si_record_i32($i10);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 173, 25} true;
  assume {:verifier.code 0} true;
  $i11 := $or.i32($i6,$i10);
  $i11.shadow := $or.i32($i6.shadow,$i10.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 173, 13} true;
  assume {:verifier.code 0} true;
  $i12 := $xor.i32($i11,$sub.i32(0,1));
  $i12.shadow := $xor.i32($i11.shadow,$sub.i32(0,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 173, 39} true;
  assume {:verifier.code 0} true;
  $i13 := $and.i32($i12,255);
  $i13.shadow := $and.i32($i12.shadow,255);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 173, 11} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.i32.i8($i13);
  $i14.shadow := $trunc.i32.i8($i13.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 173, 5} true;
  assume {:verifier.code 0} true;
  $r := $i14;
  $r.shadow := $i14.shadow;
  $exn := false;
...
const mbedtls_ct_base64_dec_value: ref;
axiom (mbedtls_ct_base64_dec_value == $sub.ref(0,3096));
procedure {:inline 1} mbedtls_ct_base64_dec_value($i0: i8, $i0.shadow: i8) returns ($r: i8, $r.shadow: i8)
modifies $exn;
{
  var $i1: i8;
  var $i1.shadow: i8;
  ...
  var $i53.shadow: i8;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mbedtls_ct_base64_dec_value:arg:c"} boogie_si_record_i8($i0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 12} true;
  assume {:verifier.code 0} true;
  call $i1, $i1.shadow := mbedtls_ct_uchar_mask_of_range(65, 65, 90, 90, $i0, $i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i8.i32($i1);
  $i2.shadow := $zext.i8.i32($i1.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 62} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i8.i32($i0);
  $i3.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 64} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32($i3,65);
  $i4.shadow := $sub.i32($i3.shadow,65);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 70} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i4,0);
  $i5.shadow := $add.i32($i4.shadow,0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 75} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i5,1);
  $i6.shadow := $add.i32($i5.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 58} true;
  assume {:verifier.code 0} true;
  $i7 := $and.i32($i2,$i6);
  $i7.shadow := $and.i32($i2.shadow,$i6.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i8.i32(0);
  $i8.shadow := $zext.i8.i32(0);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 9} true;
  assume {:verifier.code 0} true;
  $i9 := $or.i32($i8,$i7);
  $i9.shadow := $or.i32($i8.shadow,$i7.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 9} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i32.i8($i9);
  $i10.shadow := $trunc.i32.i8($i9.shadow);
  call {:cexpr "val"} boogie_si_record_i8($i10);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 353, 12} true;
  assume {:verifier.code 0} true;
  call $i11, $i11.shadow := mbedtls_ct_uchar_mask_of_range(97, 97, 122, 122, $i0, $i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 353, 12} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i8.i32($i11);
  $i12.shadow := $zext.i8.i32($i11.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 353, 62} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i8.i32($i0);
  $i13.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 353, 64} true;
  assume {:verifier.code 0} true;
  $i14 := $sub.i32($i13,97);
  $i14.shadow := $sub.i32($i13.shadow,97);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 353, 70} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i14,26);
  $i15.shadow := $add.i32($i14.shadow,26);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 353, 75} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i32($i15,1);
  $i16.shadow := $add.i32($i15.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 353, 58} true;
  assume {:verifier.code 0} true;
  $i17 := $and.i32($i12,$i16);
  $i17.shadow := $and.i32($i12.shadow,$i16.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 353, 9} true;
  assume {:verifier.code 0} true;
  $i18 := $zext.i8.i32($i10);
  $i18.shadow := $zext.i8.i32($i10.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 353, 9} true;
  assume {:verifier.code 0} true;
  $i19 := $or.i32($i18,$i17);
  $i19.shadow := $or.i32($i18.shadow,$i17.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 353, 9} true;
  assume {:verifier.code 0} true;
  $i20 := $trunc.i32.i8($i19);
  $i20.shadow := $trunc.i32.i8($i19.shadow);
  call {:cexpr "val"} boogie_si_record_i8($i20);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 354, 12} true;
  assume {:verifier.code 0} true;
  call $i21, $i21.shadow := mbedtls_ct_uchar_mask_of_range(48, 48, 57, 57, $i0, $i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 354, 12} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i8.i32($i21);
  $i22.shadow := $zext.i8.i32($i21.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 354, 62} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i8.i32($i0);
  $i23.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 354, 64} true;
  assume {:verifier.code 0} true;
  $i24 := $sub.i32($i23,48);
  $i24.shadow := $sub.i32($i23.shadow,48);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 354, 70} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i24,52);
  $i25.shadow := $add.i32($i24.shadow,52);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 354, 75} true;
  assume {:verifier.code 0} true;
  $i26 := $add.i32($i25,1);
  $i26.shadow := $add.i32($i25.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 354, 58} true;
  assume {:verifier.code 0} true;
  $i27 := $and.i32($i22,$i26);
  $i27.shadow := $and.i32($i22.shadow,$i26.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 354, 9} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i8.i32($i20);
  $i28.shadow := $zext.i8.i32($i20.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 354, 9} true;
  assume {:verifier.code 0} true;
  $i29 := $or.i32($i28,$i27);
  $i29.shadow := $or.i32($i28.shadow,$i27.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 354, 9} true;
  assume {:verifier.code 0} true;
  $i30 := $trunc.i32.i8($i29);
  $i30.shadow := $trunc.i32.i8($i29.shadow);
  call {:cexpr "val"} boogie_si_record_i8($i30);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 355, 12} true;
  assume {:verifier.code 0} true;
  call $i31, $i31.shadow := mbedtls_ct_uchar_mask_of_range(43, 43, 43, 43, $i0, $i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 355, 12} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i8.i32($i31);
  $i32.shadow := $zext.i8.i32($i31.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 355, 62} true;
  assume {:verifier.code 0} true;
  $i33 := $zext.i8.i32($i0);
  $i33.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 355, 64} true;
  assume {:verifier.code 0} true;
  $i34 := $sub.i32($i33,43);
  $i34.shadow := $sub.i32($i33.shadow,43);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 355, 70} true;
  assume {:verifier.code 0} true;
  $i35 := $add.i32($i34,62);
  $i35.shadow := $add.i32($i34.shadow,62);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 355, 75} true;
  assume {:verifier.code 0} true;
  $i36 := $add.i32($i35,1);
  $i36.shadow := $add.i32($i35.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 355, 58} true;
  assume {:verifier.code 0} true;
  $i37 := $and.i32($i32,$i36);
  $i37.shadow := $and.i32($i32.shadow,$i36.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 355, 9} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i8.i32($i30);
  ...
  call {:cexpr "val"} boogie_si_record_i8($i40);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 356, 12} true;
  assume {:verifier.code 0} true;
  call $i41, $i41.shadow := mbedtls_ct_uchar_mask_of_range(47, 47, 47, 47, $i0, $i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 356, 12} true;
  assume {:verifier.code 0} true;
  $i42 := $zext.i8.i32($i41);
  $i42.shadow := $zext.i8.i32($i41.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 356, 62} true;
  assume {:verifier.code 0} true;
  $i43 := $zext.i8.i32($i0);
  $i43.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 356, 64} true;
  assume {:verifier.code 0} true;
  $i44 := $sub.i32($i43,47);
  $i44.shadow := $sub.i32($i43.shadow,47);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 356, 70} true;
  assume {:verifier.code 0} true;
  $i45 := $add.i32($i44,63);
  $i45.shadow := $add.i32($i44.shadow,63);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 356, 75} true;
  assume {:verifier.code 0} true;
  $i46 := $add.i32($i45,1);
  $i46.shadow := $add.i32($i45.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 356, 58} true;
  assume {:verifier.code 0} true;
  $i47 := $and.i32($i42,$i46);
  $i47.shadow := $and.i32($i42.shadow,$i46.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 356, 9} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i8.i32($i40);
  $i48.shadow := $zext.i8.i32($i40.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 356, 9} true;
  assume {:verifier.code 0} true;
  $i49 := $or.i32($i48,$i47);
  $i49.shadow := $or.i32($i48.shadow,$i47.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 356, 9} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i32.i8($i49);
  $i50.shadow := $trunc.i32.i8($i49.shadow);
  call {:cexpr "val"} boogie_si_record_i8($i50);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 359, 13} true;
  assume {:verifier.code 0} true;
  $i51 := $zext.i8.i32($i50);
  $i51.shadow := $zext.i8.i32($i50.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 359, 17} true;
  assume {:verifier.code 0} true;
  $i52 := $sub.i32($i51,1);
  $i52.shadow := $sub.i32($i51.shadow,1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 359, 11} true;
  assume {:verifier.code 0} true;
  $i53 := $trunc.i32.i8($i52);
  $i53.shadow := $trunc.i32.i8($i52.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 359, 5} true;
  assume {:verifier.code 0} true;
  $r := $i53;
  $r.shadow := $i53.shadow;
  $exn := false;
...
const mbedtls_ct_base64_dec_value_wrapper: ref;
axiom (mbedtls_ct_base64_dec_value_wrapper == $sub.ref(0,4128));
procedure {:entrypoint} mbedtls_ct_base64_dec_value_wrapper($i0: i8, $i0.shadow: i8) returns ($r: i32, $r.shadow: i32)
modifies $exn;
modifies $CurrAddr;
{
  var $i1: i32;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_ct_base64_dec_value.c", 8, 31} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_ct_base64_dec_value_wrapper"} boogie_si_record_ref(mbedtls_ct_base64_dec_value_wrapper);
  call {:cexpr "smack:arg:mbedtls_ct_base64_dec_value_wrapper:$i0"} boogie_si_record_i8($i0);
  call {:cexpr "mbedtls_ct_base64_dec_value_wrapper:arg:value"} boogie_si_record_i8($i0);
  assume {:sourceloc "mbedtls_ct_base64_dec_value.c", 8, 31} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i8.i32($i0);
  $i1.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "mbedtls_ct_base64_dec_value.c", 8, 2} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.shadow := mbedtls_ct_base64_dec_value($i1, $i1.shadow);
  assume {:sourceloc "mbedtls_ct_base64_dec_value.c", 10, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $r.shadow := $u0;
  $exn := false;
...
axiom (__SMACK_and32 == $sub.ref(0,8256));
...
axiom (__SMACK_and64 == $sub.ref(0,9288));
...
axiom (__SMACK_and16 == $sub.ref(0,10320));
...
axiom (__SMACK_and8 == $sub.ref(0,11352));
...
axiom (__SMACK_or32 == $sub.ref(0,12384));
...
axiom (__SMACK_or64 == $sub.ref(0,13416));
...
axiom (__SMACK_or16 == $sub.ref(0,14448));
...
axiom (__SMACK_or8 == $sub.ref(0,15480));
...
axiom (__SMACK_loop_exit == $sub.ref(0,17544));
...
axiom (__SMACK_decls == $sub.ref(0,18576));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,19608));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,20640));
