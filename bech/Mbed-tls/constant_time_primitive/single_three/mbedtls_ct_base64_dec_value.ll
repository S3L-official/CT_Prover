; ModuleID = 'mbedtls_ct_base64_dec_value.ll'
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_base64_dec_value_wrapper(i8 zeroext %0) #0 !dbg !919 {
  call void @llvm.dbg.value(metadata i8 %0, metadata !922, metadata !DIExpression()), !dbg !923
  %2 = zext i8 %0 to i32, !dbg !924
  %3 = call i32 (i32, ...) bitcast (i8 (i8)* @mbedtls_ct_base64_dec_value to i32 (i32, ...)*)(i32 %2), !dbg !925
  ret i32 undef, !dbg !926
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_base64_dec_value_wrapper_t() #0 !dbg !927 {
  ...
  %3 = call i32 (i32, ...) bitcast (i8 (i8)* @mbedtls_ct_base64_dec_value to i32 (i32, ...)*)(i32 %2), !dbg !934
  ret void, !dbg !935
}
...
!919 = distinct !DISubprogram(name: "mbedtls_ct_base64_dec_value_wrapper", scope: !25, file: !25, line: 5, type: !920, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!920 = !DISubroutineType(types: !921)
!921 = !{!20, !19}
!922 = !DILocalVariable(name: "value", arg: 1, scope: !919, file: !25, line: 5, type: !19)
!923 = !DILocation(line: 0, scope: !919)
!924 = !DILocation(line: 8, column: 31, scope: !919)
!925 = !DILocation(line: 8, column: 2, scope: !919)
!926 = !DILocation(line: 10, column: 1, scope: !919)
!927 = distinct !DISubprogram(name: "mbedtls_ct_base64_dec_value_wrapper_t", scope: !25, file: !25, line: 17, type: !928, scopeLine: 17, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
...
!933 = !DILocation(line: 20, column: 31, scope: !927)
