...
const mbedtls_ct_memcmp: ref;
axiom (mbedtls_ct_memcmp == $sub.ref(0,1032));
procedure {:inline 1} mbedtls_ct_memcmp($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $M.0, $exn;
modifies $CurrAddr;
{
  var $p3: ref;
  ...
  var $i19.shadow: i32;
$bb0:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 57, 28} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p3 := $alloc($mul.ref(1,$zext.i32.i64(1)));
  $p3.shadow := $p3;
  call {:cexpr "mbedtls_ct_memcmp:arg:n"} boogie_si_record_i64($i2);
  assume true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 57, 28} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 59, 10} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  $i4.shadow := 0;
  goto $bb1;
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "../mbedtls/library/constant_time.c", 59, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i64($i4,$i2);
  $i5.shadow := $ult.i64($i4.shadow,$i2.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 59, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 64, 27} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p0,$mul.ref($i4,1));
  $p6.shadow := $add.ref($p0.shadow,$mul.ref($i4.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 64, 27} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p6 == $p6.shadow));
  $i7 := $load.i8($M.1,$p6);
  $i7.shadow := $load.i8($M.1.shadow,$p6.shadow);
  call {:cexpr "x"} boogie_si_record_i8($i7);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 64, 37} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p1,$mul.ref($i4,1));
  $p8.shadow := $add.ref($p1.shadow,$mul.ref($i4.shadow,1));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 64, 37} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p8 == $p8.shadow));
  $i9 := $load.i8($M.2,$p8);
  $i9.shadow := $load.i8($M.2.shadow,$p8.shadow);
  call {:cexpr "y"} boogie_si_record_i8($i9);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 65, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i8.i32($i7);
  $i10.shadow := $zext.i8.i32($i7.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 65, 21} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i8.i32($i9);
  $i11.shadow := $zext.i8.i32($i9.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 65, 19} true;
  assume {:verifier.code 0} true;
  $i12 := $xor.i32($i10,$i11);
  $i12.shadow := $xor.i32($i10.shadow,$i11.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 65, 14} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p3 == $p3.shadow));
  $i13 := $load.i8($M.0,$p3);
  $i13.shadow := $load.i8($M.0.shadow,$p3.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 65, 14} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i8.i32($i13);
  ...
  assume {:verifier.code 0} true;
  $i15 := $or.i32($i14,$i12);
  $i15.shadow := $or.i32($i14.shadow,$i12.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 65, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p3 == $p3.shadow));
  $M.0 := $store.i8($M.0,$p3,$i16);
  $M.0.shadow := $store.i8($M.0.shadow,$p3.shadow,$i16.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 66, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i5 == 1);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 68, 18} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p3 == $p3.shadow));
  $i18 := $load.i8($M.0,$p3);
  $i18.shadow := $load.i8($M.0.shadow,$p3.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 68, 13} true;
  assume {:verifier.code 0} true;
  $i19 := $zext.i8.i32($i18);
  $i19.shadow := $zext.i8.i32($i18.shadow);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 68, 5} true;
  assume {:verifier.code 0} true;
  $r := $i19;
  $r.shadow := $i19.shadow;
  $exn := false;
  ...
  return;
$bb4:
  assume {:sourceloc "../mbedtls/library/constant_time.c", 59, 25} true;
  assume {:verifier.code 0} true;
  $i17 := $add.i64($i4,1);
  $i17.shadow := $add.i64($i4.shadow,1);
  call {:cexpr "i"} boogie_si_record_i64($i17);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 59, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i17;
  $i4.shadow := $i17.shadow;
  goto $bb1;
}
...
const mbedtls_ct_memcmp_wrapper: ref;
axiom (mbedtls_ct_memcmp_wrapper == $sub.ref(0,4128));
procedure {:entrypoint} mbedtls_ct_memcmp_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64) returns ($r: i32, $r.shadow: i32)
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "mbedtls_ct_memcmp.c", 9, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:mbedtls_ct_memcmp_wrapper"} boogie_si_record_ref(mbedtls_ct_memcmp_wrapper);
  call {:cexpr "smack:arg:mbedtls_ct_memcmp_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:mbedtls_ct_memcmp_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:mbedtls_ct_memcmp_wrapper:$i2"} boogie_si_record_i64($i2);
  call {:cexpr "mbedtls_ct_memcmp_wrapper:arg:n"} boogie_si_record_i64($i2);
  assume {:sourceloc "mbedtls_ct_memcmp.c", 9, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "mbedtls_ct_memcmp.c", 9, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p3, $p3.shadow);
  assume {:sourceloc "mbedtls_ct_memcmp.c", 10, 12} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p4 := __SMACK_value.ref($p1);
  $p4.shadow := $p4;
  assume $isExternal($p4);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p4);
  assume {:sourceloc "mbedtls_ct_memcmp.c", 10, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "mbedtls_ct_memcmp.c", 11, 12} true;
  assume {:verifier.code 0} true;
  call {:name $i2} $p5 := __SMACK_value.i64($i2);
  $p5.shadow := $p5;
  assume $isExternal($p5);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p5);
  assume {:sourceloc "mbedtls_ct_memcmp.c", 11, 2} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "mbedtls_ct_memcmp.c", 15, 2} true;
  assume {:verifier.code 0} true;
  call $i6, $i6.shadow := mbedtls_ct_memcmp($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow);
  assume {:sourceloc "mbedtls_ct_memcmp.c", 17, 1} true;
  assume {:verifier.code 0} true;
  $r := $u0;
  $r.shadow := $u0;
  $exn := false;
