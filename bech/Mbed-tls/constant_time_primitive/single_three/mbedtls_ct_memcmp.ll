...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @mbedtls_ct_memcmp_wrapper(i8* %0, i8* %1, i64 %2) #0 !dbg !919 {
  call void @llvm.dbg.value(metadata i8* %0, metadata !920, metadata !DIExpression()), !dbg !921
  call void @llvm.dbg.value(metadata i8* %1, metadata !922, metadata !DIExpression()), !dbg !921
  call void @llvm.dbg.value(metadata i64 %2, metadata !923, metadata !DIExpression()), !dbg !921
  %4 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %0), !dbg !924
  call void @public_in(%struct.smack_value* %4), !dbg !925
  %5 = call %struct.smack_value* (i8*, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i8*, ...)*)(i8* %1), !dbg !926
  call void @public_in(%struct.smack_value* %5), !dbg !927
  %6 = call %struct.smack_value* (i64, ...) bitcast (%struct.smack_value* (...)* @__SMACK_value to %struct.smack_value* (i64, ...)*)(i64 %2), !dbg !928
  call void @public_in(%struct.smack_value* %6), !dbg !929
  %7 = call i32 @mbedtls_ct_memcmp(i8* %0, i8* %1, i64 %2), !dbg !930
  ret i32 undef, !dbg !931
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @mbedtls_ct_memcmp_wrapper_t() #0 !dbg !932 {
  %1 = call i8* (...) @getpt1(), !dbg !935
  call void @llvm.dbg.value(metadata i8* %1, metadata !936, metadata !DIExpression()), !dbg !937
  %2 = call i8* (...) @getpt2(), !dbg !938
  call void @llvm.dbg.value(metadata i8* %2, metadata !939, metadata !DIExpression()), !dbg !937
  %3 = call i64 (...) @getlen(), !dbg !940
  call void @llvm.dbg.value(metadata i64 %3, metadata !941, metadata !DIExpression()), !dbg !937
  %4 = call i32 @mbedtls_ct_memcmp(i8* %1, i8* %2, i64 %3), !dbg !942
  ret void, !dbg !943
}
...
!919 = distinct !DISubprogram(name: "mbedtls_ct_memcmp_wrapper", scope: !25, file: !25, line: 3, type: !32, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!920 = !DILocalVariable(name: "a", arg: 1, scope: !919, file: !25, line: 3, type: !34)
!921 = !DILocation(line: 0, scope: !919)
!922 = !DILocalVariable(name: "b", arg: 2, scope: !919, file: !25, line: 4, type: !34)
!923 = !DILocalVariable(name: "n", arg: 3, scope: !919, file: !25, line: 5, type: !21)
!924 = !DILocation(line: 9, column: 12, scope: !919)
!925 = !DILocation(line: 9, column: 2, scope: !919)
!926 = !DILocation(line: 10, column: 12, scope: !919)
!927 = !DILocation(line: 10, column: 2, scope: !919)
!928 = !DILocation(line: 11, column: 12, scope: !919)
!929 = !DILocation(line: 11, column: 2, scope: !919)
!930 = !DILocation(line: 15, column: 2, scope: !919)
!931 = !DILocation(line: 17, column: 1, scope: !919)
!932 = distinct !DISubprogram(name: "mbedtls_ct_memcmp_wrapper_t", scope: !25, file: !25, line: 24, type: !933, scopeLine: 24, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !26)
!933 = !DISubroutineType(types: !934)
!934 = !{null}
!935 = !DILocation(line: 25, column: 17, scope: !932)
!936 = !DILocalVariable(name: "a", scope: !932, file: !25, line: 25, type: !34)
!937 = !DILocation(line: 0, scope: !932)
!938 = !DILocation(line: 26, column: 39, scope: !932)
!939 = !DILocalVariable(name: "b", scope: !932, file: !25, line: 26, type: !34)
!940 = !DILocation(line: 27, column: 35, scope: !932)
!941 = !DILocalVariable(name: "n", scope: !932, file: !25, line: 27, type: !21)
!942 = !DILocation(line: 31, column: 2, scope: !932)
!943 = !DILocation(line: 32, column: 1, scope: !932)
