...
procedure {:inline 1} mbedtls_ct_uchar_mask_of_range($i0: i8, $i0.dup: i1, $i1: i8, $i1.dup: i1, $i2: i8, $i2.dup: i1) returns ($r: i8, $r.dup: i1)
modifies $exn;
{
  var $i3: i32;
  var $i3.dup: i1;
...
$bb0:
  ...
  $i12.dup := $or.i1($i11.dup,$or.i1(0,0));
...
procedure {:inline 1} mbedtls_ct_base64_dec_value($i0: i8, $i0.dup: i1) returns ($r: i8, $r.dup: i1)
modifies $exn;
{
  var $i1: i8;
  var $i1.dup: i1;
...
$bb0:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 12} true;
  assume {:verifier.code 0} true;
  call $i1, $i1.dup := mbedtls_ct_uchar_mask_of_range(65, 0, 90, 0, $i0, $i0.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 352, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i8.i32($i1);
  $i2.dup := $i1.dup;
  ...
  assume {:verifier.code 0} true;
  call $i11, $i11.dup := mbedtls_ct_uchar_mask_of_range(97, 0, 122, 0, $i0, $i0.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 353, 12} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i8.i32($i11);
  $i12.dup := $i11.dup;
  ...
  assume {:verifier.code 0} true;
  call $i21, $i21.dup := mbedtls_ct_uchar_mask_of_range(48, 0, 57, 0, $i0, $i0.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 354, 12} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i8.i32($i21);
  $i22.dup := $i21.dup;
  ...
  assume {:verifier.code 0} true;
  call $i31, $i31.dup := mbedtls_ct_uchar_mask_of_range(43, 0, 43, 0, $i0, $i0.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 355, 12} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i8.i32($i31);
  $i32.dup := $i31.dup;
  ...
  assume {:verifier.code 0} true;
  call $i41, $i41.dup := mbedtls_ct_uchar_mask_of_range(47, 0, 47, 0, $i0, $i0.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 356, 12} true;
  assume {:verifier.code 0} true;
  $i42 := $zext.i8.i32($i41);
  $i42.dup := $i41.dup;
...
procedure {:entrypoint} mbedtls_ct_base64_dec_value_wrapper($i0: i8, $i0.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
modifies $CurrAddr;
{
  var $i1: i32;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i2, $i2.dup := mbedtls_ct_base64_dec_value($i1, $i1.dup);
