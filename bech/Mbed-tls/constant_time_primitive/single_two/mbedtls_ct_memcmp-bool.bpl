...
procedure {:inline 1} mbedtls_ct_memcmp($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i64, $i2.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $M.0, $exn;
modifies $CurrAddr;
{
  var $p3: ref;
...
$bb2:
  ...
  $p6.dup := $or.i1($p0.dup,$or.i1($i4.dup,0));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 64, 27} true;
  assume {:verifier.code 0} true;
  ...
  $p8.dup := $or.i1($p1.dup,$or.i1($i4.dup,0));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 64, 37} true;
  assume {:verifier.code 0} true;
  ...
  $M.0.dup := $store.i1($M.0.dup,$p3,$i16.dup);
...
procedure {:entrypoint} mbedtls_ct_memcmp_wrapper($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i64, $i2.dup: i1) returns ($r: i32, $r.dup: i1)
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i6, $i6.dup := mbedtls_ct_memcmp($p0, $p0.dup, $p1, $p1.dup, $i2, $i2.dup);
