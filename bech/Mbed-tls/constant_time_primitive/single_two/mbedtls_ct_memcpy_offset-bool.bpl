...
procedure {:inline 1} mbedtls_ct_size_mask($i0: i64, $i0.dup: i1) returns ($r: i64, $r.dup: i1)
modifies $exn;
{
  var $i1: i64;
  var $i1.dup: i1;
...
procedure {:inline 1} mbedtls_ct_size_bool_eq($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i2: i64;
  var $i2.dup: i1;
...
procedure {:inline 1} mbedtls_ct_memcpy_if_eq($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i64, $i2.dup: i1, $i3: i64, $i3.dup: i1, $i4: i64, $i4.dup: i1)
modifies $M.1, $exn;
{
  var $i5: i32;
  var $i5.dup: i1;
...
$bb0:
  ...
  assume {:sourceloc "../mbedtls/library/constant_time.c", 417, 26} true;
  assume {:verifier.code 0} true;
  call $i5, $i5.dup := mbedtls_ct_size_bool_eq($i3, $i3.dup, $i4, $i4.dup);
  assume {:sourceloc "../mbedtls/library/constant_time.c", 417, 26} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i32.i64($i5);
  $i6.dup := $i5.dup;
  ...
  assume {:verifier.code 0} true;
  call $i7, $i7.dup := mbedtls_ct_size_mask($i6, $i6.dup);
...
$bb2:
  ...
  $p11.dup := $or.i1($p1.dup,$or.i1($i9.dup,0));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 21} true;
  assume {:verifier.code 0} true;
  ...
  $p16.dup := $or.i1($p0.dup,$or.i1($i9.dup,0));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 422, 41} true;
  assume {:verifier.code 0} true;
  ...
  $i20.dup := $or.i1($i19.dup,$or.i1(0,0));
  ...
  $p24.dup := $or.i1($p0.dup,$or.i1($i9.dup,0));
...
procedure {:inline 1} mbedtls_ct_memcpy_offset($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i64, $i2.dup: i1, $i3: i64, $i3.dup: i1, $i4: i64, $i4.dup: i1, $i5: i64, $i5.dup: i1)
modifies $exn;
modifies $M.1;
{
  var $i6: i64;
...
$bb2:
  ...
  $p8.dup := $or.i1($p1.dup,$or.i1($i6.dup,0));
  assume {:sourceloc "../mbedtls/library/constant_time.c", 436, 9} true;
  assume {:verifier.code 0} true;
  call mbedtls_ct_memcpy_if_eq($p0, $p0.dup, $p8, $p8.dup, $i5, $i5.dup, $i6, $i6.dup, $i2, $i2.dup);
...
procedure {:entrypoint} mbedtls_ct_memcpy_offset_wrapper($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i64, $i2.dup: i1, $i3: i64, $i3.dup: i1, $i4: i64, $i4.dup: i1, $i5: i64, $i5.dup: i1) returns ($r: i32, $r.dup: i1)
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i11, $i11.dup := mbedtls_ct_memcpy_offset($p0, $p0.dup, $p1, $p1.dup, $i2, $i2.dup, $i3, $i3.dup, $i4, $i4.dup, $i5, $i5.dup);
