...
procedure {:entrypoint} mbedtls_ct_size_bool_eq_wrapper($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
modifies $CurrAddr;
{
  var $i2: i32;
...
$bb0:
  ...
  assume {:sourceloc "mbedtls_ct_size_bool_eq.c", 11, 2} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.dup := mbedtls_ct_size_bool_eq($i0, $i0.dup, $i1, $i1.dup);
