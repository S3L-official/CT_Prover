...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,18576));
...
axiom (__SMACK_dummy == $sub.ref(0,3096));
...
axiom (__SMACK_and32 == $sub.ref(0,4128));
...
axiom (__SMACK_and64 == $sub.ref(0,5160));
...
axiom (__SMACK_and16 == $sub.ref(0,6192));
...
axiom (__SMACK_and8 == $sub.ref(0,7224));
...
axiom (__SMACK_or32 == $sub.ref(0,8256));
...
axiom (__SMACK_or64 == $sub.ref(0,9288));
...
axiom (__SMACK_or16 == $sub.ref(0,10320));
...
axiom (__SMACK_or8 == $sub.ref(0,11352));
...
axiom (__SMACK_check_overflow == $sub.ref(0,12384));
...
axiom (__SMACK_loop_exit == $sub.ref(0,13416));
...
axiom (__SMACK_decls == $sub.ref(0,14448));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,15480));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,16512));
...
axiom (llvm.dbg.value == $sub.ref(0,17544));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0,18576));
