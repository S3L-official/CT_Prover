...
modifies $exn, $exn.shadow, $shadow_ok, $M.1, $M.1.shadow, $M.2, $M.2.shadow;
modifies $M.12, $M.12.shadow, $M.13, $M.13.shadow;
modifies $CurrAddr;
{
  var $p6: ref;
...
modifies $shadow_ok, $M.12, $M.12.shadow;
...
modifies $M.13, $M.13.shadow, $shadow_ok, $M.1, $M.1.shadow, $exn, $exn.shadow;
modifies $CurrAddr;
{
  var $p2: ref;
  var $p2.shadow: ref;
