...
$bb6:
  ...
  assume {:VFCTMarked} true;
  assert {:likely_shadow_invariant} ($p13 == $p13.shadow);
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
...
$bb13:
  ...
  assert {:shadow_invariant} $shadow_ok;
  assume {:VFCTMarked} true;
  assert {:likely_shadow_invariant} ($p23 == $p23.shadow);
  assume {:VFCTMarked} true;
  assert {:likely_shadow_invariant} ($p21 == $p21.shadow);
  assume {:VFCTMarked} true;
...
$bb1:
  ...
  assert {:shadow_invariant} $shadow_ok;
  assume {:VFCTMarked} true;
  assert {:likely_shadow_invariant} ($i4 == $i4.shadow);
