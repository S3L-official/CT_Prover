...
requires {:public_in $load.i8, $M.1, $p3, 1, 16} true;
...
modifies $M.1, $M.1.shadow, $M.2, $M.2.shadow;
modifies $CurrAddr, $M.4, $M.4.shadow, $M.5, $M.5.shadow, $M.6, $M.6.shadow, $M.7, $M.7.shadow, $M.8, $M.8.shadow, $M.9, $M.9.shadow, $M.10, $M.10.shadow, $M.11, $M.11.shadow;
modifies $M.12, $M.12.shadow, $M.13, $M.13.shadow;
{
  var $p6: ref;
  var $p6.shadow: ref;
  var $p7: ref;
...
$bb0:
  ...
  call {:name $p3} {:array "$load.i8", $M.1, $p3, 1, 16} $p12 := __SMACK_values($p3, 16);
  $p12.shadow := $p12;
...
modifies $shadow_ok, $exn, $exn.shadow, $M.1, $M.1.shadow, $M.2, $M.2.shadow;
modifies $M.12, $M.12.shadow, $M.13, $M.13.shadow;
modifies $CurrAddr;
{
  var $p6: ref;
...
modifies $shadow_ok, $M.1, $M.1.shadow, $exn, $exn.shadow;
modifies $M.12, $M.12.shadow;
modifies $M.13, $M.13.shadow;
modifies $CurrAddr;
{
  var $i4: i64;
  var $i4.shadow: i64;
...
modifies $shadow_ok, $exn, $exn.shadow;
modifies $M.12, $M.12.shadow;
modifies $M.13, $M.13.shadow, $M.1, $M.1.shadow;
modifies $CurrAddr;
{
  var $p3: ref;
  var $p3.shadow: ref;
...
modifies $shadow_ok, $M.12, $M.12.shadow, $exn, $exn.shadow;
modifies $CurrAddr;
{
  var $p1: ref;
  var $p1.shadow: ref;
...
modifies $shadow_ok, $M.13, $M.13.shadow, $M.1, $M.1.shadow, $exn, $exn.shadow;
modifies $CurrAddr;
{
  var $p2: ref;
  var $p2.shadow: ref;
...
modifies $shadow_ok, $M.4, $M.4.shadow, $M.5, $M.5.shadow, $M.6, $M.6.shadow, $M.7, $M.7.shadow, $M.8, $M.8.shadow, $M.9, $M.9.shadow, $M.10, $M.10.shadow, $M.11, $M.11.shadow, $exn, $exn.shadow;
{
$bb0:
...
modifies $CurrAddr, $exn;
modifies $shadow_ok, $M.4, $M.4.shadow, $M.5, $M.5.shadow, $M.6, $M.6.shadow, $M.7, $M.7.shadow, $M.8, $M.8.shadow, $M.9, $M.9.shadow, $M.10, $M.10.shadow, $M.11, $M.11.shadow, $exn.shadow;
{
