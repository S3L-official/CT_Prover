...
axiom (ssl3_cbc_copy_mac == $sub.ref(0,1032));
procedure {:inline 1} ssl3_cbc_copy_mac($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32, $i3: i32, $i3.shadow: i32)
modifies $M.1, $M.4, $exn;
modifies $CurrAddr;
{
  var $p4: ref;
  var $p4.shadow: ref;
  ...
  var $i73.shadow: i32;
$bb0:
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 76, 29} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  call $p4 := $alloc($mul.ref(128,$zext.i32.i64(1)));
  $p4.shadow := $p4;
  call {:cexpr "ssl3_cbc_copy_mac:arg:md_size"} boogie_si_record_i32($i2);
  call {:cexpr "ssl3_cbc_copy_mac:arg:orig_len"} boogie_si_record_i32($i3);
  assume true;
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 76, 29} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p5.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 76, 29} true;
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $i6 := $load.i32($M.0,$p5);
  ...
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 77, 34} true;
  assume {:verifier.code 0} true;
  $i7 := $sub.i32($i6,$i2);
  $i7.shadow := $sub.i32($i6.shadow,$i2.shadow);
  call {:cexpr "mac_start"} boogie_si_record_i32($i7);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 91, 19} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref($p4,$mul.ref(0,128)),$mul.ref(0,1));
  $p8.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,128)),$mul.ref(0,1));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 91, 51} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p4,$mul.ref(0,128)),$mul.ref(0,1));
  $p9.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,128)),$mul.ref(0,1));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 91, 43} true;
  assume {:verifier.code 0} true;
  $i10 := $p2i.ref.i64($p9);
  $i10.shadow := $p2i.ref.i64($p9.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 91, 41} true;
  assume {:verifier.code 0} true;
  $i11 := $sub.i64(0,$i10);
  $i11.shadow := $sub.i64(0,$i10.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 91, 68} true;
  assume {:verifier.code 0} true;
  $i12 := $and.i64($i11,63);
  $i12.shadow := $and.i64($i11.shadow,63);
  $p13 := $add.ref($add.ref($p4,$mul.ref(0,128)),$mul.ref($i12,1));
  $p13.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,128)),$mul.ref($i12.shadow,1));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 95, 28} true;
  assume {:verifier.code 0} true;
  $i14 := $add.i32($i2,255);
  $i14.shadow := $add.i32($i2.shadow,255);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 95, 34} true;
  assume {:verifier.code 0} true;
  $i15 := $add.i32($i14,1);
  $i15.shadow := $add.i32($i14.shadow,1);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 95, 18} true;
  assume {:verifier.code 0} true;
  $i16 := $ugt.i32($i3,$i15);
  $i16.shadow := $ugt.i32($i3.shadow,$i15.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 95, 9} true;
  assume {:verifier.code 0} true;
  $i17 := 0;
  $i17.shadow := 0;
...
$bb1:
  assume ($i16 == 1);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 96, 42} true;
  assume {:verifier.code 0} true;
  $i18 := $add.i32($i2,255);
  $i18.shadow := $add.i32($i2.shadow,255);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 96, 48} true;
  assume {:verifier.code 0} true;
  $i19 := $add.i32($i18,1);
  $i19.shadow := $add.i32($i18.shadow,1);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 96, 31} true;
  assume {:verifier.code 0} true;
  $i20 := $sub.i32($i3,$i19);
  $i20.shadow := $sub.i32($i3.shadow,$i19.shadow);
  call {:cexpr "scan_start"} boogie_si_record_i32($i20);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 96, 9} true;
  assume {:verifier.code 0} true;
  $i17 := $i20;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 105, 27} true;
  assume {:verifier.code 0} true;
  $i21 := $lshr.i32($i2,1);
  $i21.shadow := $lshr.i32($i2.shadow,1);
  call {:cexpr "div_spoiler"} boogie_si_record_i32($i21);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 106, 17} true;
  assume {:verifier.code 0} true;
  $i22 := $shl.i32($i21,24);
  $i22.shadow := $shl.i32($i21.shadow,24);
  call {:cexpr "div_spoiler"} boogie_si_record_i32($i22);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 107, 34} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i32($i22,$i7);
  $i23.shadow := $add.i32($i22.shadow,$i7.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 107, 46} true;
  assume {:verifier.code 0} true;
  $i24 := $sub.i32($i23,$i17);
  $i24.shadow := $sub.i32($i23.shadow,$i17.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 107, 60} true;
  assume {:verifier.code 0} true;
  $i25 := $urem.i32($i24,$i2);
  $i25.shadow := $urem.i32($i24.shadow,$i2.shadow);
  call {:cexpr "rotate_offset"} boogie_si_record_i32($i25);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 109, 28} true;
  assume {:verifier.code 0} true;
  $i26 := $zext.i32.i64($i2);
  $i26.shadow := $zext.i32.i64($i2.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 109, 5} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  assert ($i26 == $i26.shadow);
  call $M.1, $M.1.shadow := $memset.i8($M.1, $M.1.shadow, $p13, $p13.shadow, 0, 0, $i26, $i26.shadow, false, false);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 110, 10} true;
  assume {:verifier.code 0} true;
  $i27 := $i17;
  $i27.shadow := $i17.shadow;
  $i28 := 0;
  $i28.shadow := 0;
  goto $bb4;
$bb4:
  ...
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 110, 35} true;
  assume {:verifier.code 0} true;
  $i29 := $ult.i32($i27,$i3);
  $i29.shadow := $ult.i32($i27.shadow,$i3.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 110, 5} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i29 == 1);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 113, 37} true;
  assume {:verifier.code 0} true;
  call $i30, $i30.shadow := constant_time_ge_8($i27, $i27.shadow, $i7, $i7.shadow);
  call {:cexpr "mac_started"} boogie_si_record_i8($i30);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 114, 35} true;
  assume {:verifier.code 0} true;
  call $i31, $i31.shadow := constant_time_ge_8($i27, $i27.shadow, $i6, $i6.shadow);
  call {:cexpr "mac_ended"} boogie_si_record_i8($i31);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 115, 32} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(8,1));
  $p32.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(8,1));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 115, 32} true;
  assume {:verifier.code 0} true;
  assert ($p32 == $p32.shadow);
  $p33 := $load.ref($M.2,$p32);
  $p33.shadow := $load.ref($M.2.shadow,$p32.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 115, 27} true;
  assume {:verifier.code 0} true;
  $i34 := $zext.i32.i64($i27);
  $i34.shadow := $zext.i32.i64($i27.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 115, 27} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($p33,$mul.ref($i34,1));
  $p35.shadow := $add.ref($p33.shadow,$mul.ref($i34.shadow,1));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 115, 27} true;
  assume {:verifier.code 0} true;
  assert ($p35 == $p35.shadow);
  $i36 := $load.i8($M.3,$p35);
  $i36.shadow := $load.i8($M.3.shadow,$p35.shadow);
  call {:cexpr "b"} boogie_si_record_i8($i36);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 116, 29} true;
  assume {:verifier.code 0} true;
  $i37 := $zext.i8.i32($i36);
  $i37.shadow := $zext.i8.i32($i36.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 116, 33} true;
  assume {:verifier.code 0} true;
  $i38 := $zext.i8.i32($i30);
  $i38.shadow := $zext.i8.i32($i30.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 116, 31} true;
  assume {:verifier.code 0} true;
  $i39 := $and.i32($i37,$i38);
  $i39.shadow := $and.i32($i37.shadow,$i38.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 116, 48} true;
  assume {:verifier.code 0} true;
  $i40 := $zext.i8.i32($i31);
  $i40.shadow := $zext.i8.i32($i31.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 116, 47} true;
  assume {:verifier.code 0} true;
  $i41 := $xor.i32($i40,$sub.i32(0,1));
  $i41.shadow := $xor.i32($i40.shadow,$sub.i32(0,1));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 116, 45} true;
  assume {:verifier.code 0} true;
  $i42 := $and.i32($i39,$i41);
  $i42.shadow := $and.i32($i39.shadow,$i41.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 116, 22} true;
  assume {:verifier.code 0} true;
  $i43 := $add.i32($i28,1);
  $i43.shadow := $add.i32($i28.shadow,1);
  call {:cexpr "j"} boogie_si_record_i32($i43);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 116, 9} true;
  assume {:verifier.code 0} true;
  $i44 := $zext.i32.i64($i28);
  $i44.shadow := $zext.i32.i64($i28.shadow);
  $i45 := $add.i64($i12,$i44);
  $i45.shadow := $add.i64($i12.shadow,$i44.shadow);
  $p46 := $add.ref($add.ref($p4,$mul.ref(0,128)),$mul.ref($i45,1));
  $p46.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,128)),$mul.ref($i45.shadow,1));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 116, 26} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i48 := $zext.i8.i32($i47);
  $i48.shadow := $zext.i8.i32($i47.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 116, 26} true;
  assume {:verifier.code 0} true;
  $i49 := $or.i32($i48,$i42);
  $i49.shadow := $or.i32($i48.shadow,$i42.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 116, 26} true;
  assume {:verifier.code 0} true;
  $i50 := $trunc.i32.i8($i49);
  $i50.shadow := $trunc.i32.i8($i49.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 116, 26} true;
  assume {:verifier.code 0} true;
  assert ($p46 == $p46.shadow);
  $M.1 := $store.i8($M.1,$p46,$i50);
  $M.1.shadow := $store.i8($M.1.shadow,$p46.shadow,$i50.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 117, 14} true;
  assume {:verifier.code 0} true;
  call $i51, $i51.shadow := constant_time_lt($i43, $i43.shadow, $i2, $i2.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 117, 11} true;
  assume {:verifier.code 0} true;
  $i52 := $and.i32($i43,$i51);
  $i52.shadow := $and.i32($i43.shadow,$i51.shadow);
  call {:cexpr "j"} boogie_si_record_i32($i52);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 118, 5} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !($i29 == 1);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 123, 10} true;
  assume {:verifier.code 0} true;
  $i54 := 0;
  $i54.shadow := 0;
  $i55 := 0;
  $i55.shadow := 0;
  $i56 := $i25;
  $i56.shadow := $i25.shadow;
  goto $bb8;
$bb7:
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 110, 48} true;
  assume {:verifier.code 0} true;
  $i53 := $add.i32($i27,1);
  $i53.shadow := $add.i32($i27.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i53);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 110, 5} true;
  assume {:verifier.code 0} true;
  $i27 := $i53;
  $i27.shadow := $i53.shadow;
  $i28 := $i52;
  $i28.shadow := $i52.shadow;
  goto $bb4;
$bb8:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i55 == $i55.shadow);
  assert {:shadow_invariant} ($i56 == $i56.shadow);
  assert {:shadow_invariant} ($i54 == $i54.shadow);
  assert {:shadow_invariant} ($i12 == $i12.shadow);
  assert {:shadow_invariant} ($p4 == $p4.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 0, 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 123, 19} true;
  assume {:verifier.code 0} true;
  $i57 := $ult.i32($i54,$i2);
  $i57.shadow := $ult.i32($i54.shadow,$i2.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 123, 5} true;
  assume {:verifier.code 0} true;
...
$bb9:
  assume ($i57 == 1);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 126, 63} true;
  assume {:verifier.code 0} true;
  $i58 := $xor.i32($i56,32);
  $i58.shadow := $xor.i32($i56.shadow,32);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 126, 9} true;
  assume {:verifier.code 0} true;
  $i59 := $zext.i32.i64($i58);
  $i59.shadow := $zext.i32.i64($i58.shadow);
  $i60 := $add.i64($i12,$i59);
  $i60.shadow := $add.i64($i12.shadow,$i59.shadow);
  $p61 := $add.ref($add.ref($p4,$mul.ref(0,128)),$mul.ref($i60,1));
  $p61.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,128)),$mul.ref($i60.shadow,1));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 126, 9} true;
  assume {:verifier.code 0} true;
  assert ($p61 == $p61.shadow);
  $i62 := $load.i8($M.1,$p61);
  $i62.shadow := $load.i8($M.1.shadow,$p61.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 127, 45} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i56,1);
  $i63.shadow := $add.i32($i56.shadow,1);
  call {:cexpr "rotate_offset"} boogie_si_record_i32($i63);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 127, 20} true;
  assume {:verifier.code 0} true;
  $i64 := $zext.i32.i64($i56);
  $i64.shadow := $zext.i32.i64($i56.shadow);
  $i65 := $add.i64($i12,$i64);
  $i65.shadow := $add.i64($i12.shadow,$i64.shadow);
  $p66 := $add.ref($add.ref($p4,$mul.ref(0,128)),$mul.ref($i65,1));
  $p66.shadow := $add.ref($add.ref($p4.shadow,$mul.ref(0,128)),$mul.ref($i65.shadow,1));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 127, 20} true;
  assume {:verifier.code 0} true;
  assert ($p66 == $p66.shadow);
  $i67 := $load.i8($M.1,$p66);
  $i67.shadow := $load.i8($M.1.shadow,$p66.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 127, 14} true;
  assume {:verifier.code 0} true;
  $i68 := $add.i32($i55,1);
  $i68.shadow := $add.i32($i55.shadow,1);
  call {:cexpr "j"} boogie_si_record_i32($i68);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 127, 9} true;
  assume {:verifier.code 0} true;
  $i69 := $zext.i32.i64($i55);
  $i69.shadow := $zext.i32.i64($i55.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 127, 9} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($p0,$mul.ref($i69,1));
  $p70.shadow := $add.ref($p0.shadow,$mul.ref($i69.shadow,1));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 127, 18} true;
  assume {:verifier.code 0} true;
  assert ($p70 == $p70.shadow);
  $M.4 := $store.i8($M.4,$p70,$i67);
  $M.4.shadow := $store.i8($M.4.shadow,$p70.shadow,$i67.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 128, 26} true;
  assume {:verifier.code 0} true;
  call $i71, $i71.shadow := constant_time_lt($i63, $i63.shadow, $i2, $i2.shadow);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 128, 23} true;
  assume {:verifier.code 0} true;
  $i72 := $and.i32($i63,$i71);
  $i72.shadow := $and.i32($i63.shadow,$i71.shadow);
  call {:cexpr "rotate_offset"} boogie_si_record_i32($i72);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 129, 5} true;
  assume {:verifier.code 0} true;
  goto $bb11;
$bb10:
  assume !($i57 == 1);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 141, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb11:
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 123, 31} true;
  assume {:verifier.code 0} true;
  $i73 := $add.i32($i54,1);
  $i73.shadow := $add.i32($i54.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i73);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 123, 5} true;
  assume {:verifier.code 0} true;
  $i54 := $i73;
  $i54.shadow := $i73.shadow;
  $i55 := $i68;
  $i55.shadow := $i68.shadow;
  $i56 := $i72;
  $i56.shadow := $i72.shadow;
  goto $bb8;
}
...
axiom (constant_time_ge_8 == $sub.ref(0,5160));
...
axiom (constant_time_lt == $sub.ref(0,6192));
...
axiom (constant_time_msb == $sub.ref(0,7224));
...
axiom (constant_time_ge == $sub.ref(0,8256));
...
const copy_mac_wrapper: ref;
axiom (copy_mac_wrapper == $sub.ref(0,9288));
procedure {:entrypoint} copy_mac_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32, $i3: i32, $i3.shadow: i32, $i4: i32, $i4.shadow: i32)
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "copy_mac.c", 13, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:copy_mac_wrapper"} boogie_si_record_ref(copy_mac_wrapper);
  call {:cexpr "smack:arg:copy_mac_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:copy_mac_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:copy_mac_wrapper:$i2"} boogie_si_record_i32($i2);
  call {:cexpr "smack:arg:copy_mac_wrapper:$i3"} boogie_si_record_i32($i3);
  call {:cexpr "smack:arg:copy_mac_wrapper:$i4"} boogie_si_record_i32($i4);
  assume {:verifier.code 0} true;
  call $p5 := $alloc($mul.ref(32,$zext.i32.i64(1)));
  $p5.shadow := $p5;
  call {:cexpr "copy_mac_wrapper:arg:length"} boogie_si_record_i32($i2);
  call {:cexpr "copy_mac_wrapper:arg:md_size"} boogie_si_record_i32($i3);
  call {:cexpr "copy_mac_wrapper:arg:orig_len"} boogie_si_record_i32($i4);
  assume {:sourceloc "copy_mac.c", 13, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p0} $p6 := __SMACK_value.ref($p0);
  $p6.shadow := $p6;
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p6);
  assume {:sourceloc "copy_mac.c", 13, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p6, $p6.shadow);
  assume {:sourceloc "copy_mac.c", 14, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p7 := __SMACK_value.ref($p1);
  $p7.shadow := $p7;
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p7);
  assume {:sourceloc "copy_mac.c", 14, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p7, $p7.shadow);
  assume {:sourceloc "copy_mac.c", 17, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i2} $p8 := __SMACK_value.i32($i2);
  $p8.shadow := $p8;
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p8);
  assume {:sourceloc "copy_mac.c", 17, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p8, $p8.shadow);
  assume {:sourceloc "copy_mac.c", 18, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i3} $p9 := __SMACK_value.i32($i3);
  $p9.shadow := $p9;
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p9);
  assume {:sourceloc "copy_mac.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p9, $p9.shadow);
  assume {:sourceloc "copy_mac.c", 19, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i4} $p10 := __SMACK_value.i32($i4);
  $p10.shadow := $p10;
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p10);
  assume {:sourceloc "copy_mac.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p10, $p10.shadow);
  assume true;
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p5,$mul.ref(0,32)),$mul.ref(0,1));
  $p11.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  assert ($p11 == $p11.shadow);
  $M.0 := $store.i32($M.0,$p11,$i2);
  $M.0.shadow := $store.i32($M.0.shadow,$p11.shadow,$i2.shadow);
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p5,$mul.ref(0,32)),$mul.ref(8,1));
  $p12.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,32)),$mul.ref(8,1));
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  assert ($p12 == $p12.shadow);
  $M.2 := $store.ref($M.2,$p12,$p1);
  $M.2.shadow := $store.ref($M.2.shadow,$p12.shadow,$p1.shadow);
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p5,$mul.ref(0,32)),$mul.ref(16,1));
  $p13.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,32)),$mul.ref(16,1));
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  assert ($p13 == $p13.shadow);
  $M.5 := $store.i32($M.5,$p13,0);
  $M.5.shadow := $store.i32($M.5.shadow,$p13.shadow,0);
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p5,$mul.ref(0,32)),$mul.ref(24,1));
  $p14.shadow := $add.ref($add.ref($p5.shadow,$mul.ref(0,32)),$mul.ref(24,1));
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  assert ($p14 == $p14.shadow);
  $M.6 := $store.ref($M.6,$p14,$0.ref);
  $M.6.shadow := $store.ref($M.6.shadow,$p14.shadow,$0.ref);
  assume {:sourceloc "copy_mac.c", 24, 10} true;
  assume {:verifier.code 0} true;
  call ssl3_cbc_copy_mac($p0, $p0.shadow, $p5, $p5.shadow, $i3, $i3.shadow, $i4, $i4.shadow);
  assume {:sourceloc "copy_mac.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
