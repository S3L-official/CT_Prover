...
modifies $M.1, $M.1.shadow, $M.4, $M.4.shadow, $exn, $exn.shadow;
modifies $CurrAddr;
{
  var $p4: ref;
  var $p4.shadow: ref;
...
$bb4:
  ...
  assert {:unlikely_shadow_invariant ($i28 == $i28.shadow)} true;
...
$bb8:
  ...
  $i12 := $i12.shadow;
  $p4 := $p4.shadow;
  assert {:unlikely_shadow_invariant ($i56 == $i56.shadow)} true;
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
modifies $shadow_ok, $M.0, $M.0.shadow, $M.2, $M.2.shadow, $M.5, $M.5.shadow, $M.6, $M.6.shadow, $exn, $exn.shadow;
modifies $M.1, $M.1.shadow, $M.4, $M.4.shadow;
modifies $CurrAddr;
{
  var $p5: ref;
  var $p5.shadow: ref;
