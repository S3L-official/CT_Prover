...
modifies $M.0, $M.0.shadow, $M.3, $M.3.shadow, $exn, $exn.shadow;
{
  var $i4: i32;
  var $i4.shadow: i32;
  var $p5: ref;
...
modifies $shadow_ok, $M.4, $M.4.shadow, $M.0, $M.0.shadow, $M.1, $M.1.shadow, $M.3, $M.3.shadow, $M.5, $M.5.shadow, $exn, $exn.shadow;
modifies $CurrAddr;
{
  var $p4: ref;
  var $p4.shadow: ref;
