...
define dso_local void @digest_record_wrapper_t() #0 !dbg !1063 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %5, i8* align 1 getelementptr inbounds (<{ i8, [12 x i8] }>, <{ i8, [12 x i8] }>* @__const.digest_record_wrapper_t.header, i32 0, i32 0), i64 13, i1 false), !dbg !1079
  %6 = call i8* (...) @get2(), !dbg !1080
  call void @llvm.dbg.value(metadata i8* %6, metadata !1081, metadata !DIExpression()), !dbg !1067
  ...
  %7 = call i8* (...) @get3(), !dbg !1084
  call void @llvm.dbg.value(metadata i8* %7, metadata !1085, metadata !DIExpression()), !dbg !1067
  ...
  %8 = getelementptr inbounds [13 x i8], [13 x i8]* %1, i64 0, i64 0, !dbg !1088
  call void @tmp(i32 1, i64 2, i8* %2, i8* %3, i64* %4, i8* %8, i8* %6, i64 64, i64 32, i8* %7, i32 2, i32 3), !dbg !1089
  ret void, !dbg !1090
}
