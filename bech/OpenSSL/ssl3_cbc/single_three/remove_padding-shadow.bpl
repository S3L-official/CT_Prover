...
const ssl3_cbc_remove_padding: ref;
axiom (ssl3_cbc_remove_padding == $sub.ref(0,1032));
procedure {:inline 1} ssl3_cbc_remove_padding($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32, $i3: i32, $i3.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $M.0, $M.3, $exn;
{
  var $i4: i32;
  var $i4.shadow: i32;
  var $p5: ref;
  ...
  var $i8.shadow: i32;
$bb0:
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 57, 60} true;
  assume {:verifier.code 0} true;
  call {:cexpr "ssl3_cbc_remove_padding:arg:block_size"} boogie_si_record_i32($i2);
  call {:cexpr "ssl3_cbc_remove_padding:arg:mac_size"} boogie_si_record_i32($i3);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 57, 60} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32(1,$i3);
  $i4.shadow := $add.i32(1,$i3.shadow);
  call {:cexpr "overhead"} boogie_si_record_i32($i4);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 62, 25} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 62, 18} true;
  assume {:verifier.code 0} true;
  $i7 := $ugt.i32($i4,$i6);
  $i7.shadow := $ugt.i32($i4.shadow,$i6.shadow);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 62, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i7 == 1);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 63, 9} true;
  assume {:verifier.code 0} true;
  $i8 := 0;
  $i8.shadow := 0;
  goto $bb3;
$bb2:
  assume !($i7 == 1);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 65, 27} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(8,1));
  $p9.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(8,1));
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 65, 27} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p9 == $p9.shadow));
  $p10 := $load.ref($M.1,$p9);
  $p10.shadow := $load.ref($M.1.shadow,$p9.shadow);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 65, 37} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p11.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 65, 37} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p11 == $p11.shadow));
  $i12 := $load.i32($M.0,$p11);
  $i12.shadow := $load.i32($M.0.shadow,$p11.shadow);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 65, 44} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i32($i12,1);
  $i13.shadow := $sub.i32($i12.shadow,1);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 65, 22} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i32.i64($i13);
  $i14.shadow := $zext.i32.i64($i13.shadow);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 65, 22} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p10,$mul.ref($i14,1));
  $p15.shadow := $add.ref($p10.shadow,$mul.ref($i14.shadow,1));
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 65, 22} true;
  assume {:verifier.code 0} true;
  ...
  call {:cexpr "padding_length"} boogie_si_record_i32($i17);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 66, 34} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p18.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 66, 34} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p18 == $p18.shadow));
  $i19 := $load.i32($M.0,$p18);
  $i19.shadow := $load.i32($M.0.shadow,$p18.shadow);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 66, 57} true;
  assume {:verifier.code 0} true;
  $i20 := $add.i32($i17,$i4);
  $i20.shadow := $add.i32($i17.shadow,$i4.shadow);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 66, 12} true;
  assume {:verifier.code 0} true;
  call $i21, $i21.shadow := constant_time_ge($i19, $i19.shadow, $i20, $i20.shadow);
  call {:cexpr "good"} boogie_si_record_i32($i21);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 68, 57} true;
  assume {:verifier.code 0} true;
  $i22 := $add.i32($i17,1);
  $i22.shadow := $add.i32($i17.shadow,1);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 68, 13} true;
  assume {:verifier.code 0} true;
  call $i23, $i23.shadow := constant_time_ge($i2, $i2.shadow, $i22, $i22.shadow);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 68, 10} true;
  assume {:verifier.code 0} true;
  $i24 := $and.i32($i21,$i23);
  $i24.shadow := $and.i32($i21.shadow,$i23.shadow);
  call {:cexpr "good"} boogie_si_record_i32($i24);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 69, 45} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i32($i17,1);
  $i25.shadow := $add.i32($i17.shadow,1);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 69, 27} true;
  assume {:verifier.code 0} true;
  $i26 := $and.i32($i24,$i25);
  $i26.shadow := $and.i32($i24.shadow,$i25.shadow);
  call {:cexpr "padding_length"} boogie_si_record_i32($i26);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 70, 10} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p27.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 70, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i29 := $sub.i32($i28,$i26);
  $i29.shadow := $sub.i32($i28.shadow,$i26.shadow);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 70, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p27 == $p27.shadow));
  $M.0 := $store.i32($M.0,$p27,$i29);
  $M.0.shadow := $store.i32($M.0.shadow,$p27.shadow,$i29.shadow);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 71, 33} true;
  assume {:verifier.code 0} true;
  $i30 := $shl.i32($i26,8);
  $i30.shadow := $shl.i32($i26.shadow,8);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 71, 10} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(16,1));
  $p31.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(16,1));
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 71, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i33 := $or.i32($i32,$i30);
  $i33.shadow := $or.i32($i32.shadow,$i30.shadow);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 71, 15} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p31 == $p31.shadow));
  $M.3 := $store.i32($M.3,$p31,$i33);
  $M.3.shadow := $store.i32($M.3.shadow,$p31.shadow,$i33.shadow);
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 72, 12} true;
  assume {:verifier.code 0} true;
  call $i34, $i34.shadow := constant_time_select_int($i24, $i24.shadow, 1, 1, $sub.i32(0,1), $sub.i32(0,1));
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 72, 5} true;
  assume {:verifier.code 0} true;
  $i8 := $i34;
  $i8.shadow := $i34.shadow;
  goto $bb3;
$bb3:
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 73, 1} true;
  assume {:verifier.code 0} true;
  $r := $i8;
  $r.shadow := $i8.shadow;
  $exn := false;
...
axiom (constant_time_ge == $sub.ref(0,3096));
...
axiom (constant_time_select_int == $sub.ref(0,4128));
...
axiom (constant_time_select == $sub.ref(0,5160));
...
axiom (remove_padding_wrapper == $sub.ref(0,8256));
procedure {:entrypoint} remove_padding_wrapper($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32, $i3: i32, $i3.shadow: i32) returns ($r: i32, $r.shadow: i32)
requires {:public_in $p0} true;
requires {:public_in $i1} true;
requires {:public_in $i2} true;
requires {:public_in $i3} true;
modifies $M.4, $M.0, $M.1, $M.3, $M.5, $exn;
modifies $CurrAddr;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "remove_padding.c", 13, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:remove_padding_wrapper"} boogie_si_record_ref(remove_padding_wrapper);
  call {:cexpr "smack:arg:remove_padding_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:remove_padding_wrapper:$i1"} boogie_si_record_i32($i1);
  call {:cexpr "smack:arg:remove_padding_wrapper:$i2"} boogie_si_record_i32($i2);
  call {:cexpr "smack:arg:remove_padding_wrapper:$i3"} boogie_si_record_i32($i3);
  assume {:verifier.code 0} true;
  ...
  $p5.shadow := $p5;
  call {:cexpr "remove_padding_wrapper:arg:length"} boogie_si_record_i32($i1);
  call {:cexpr "remove_padding_wrapper:arg:block_size"} boogie_si_record_i32($i2);
  call {:cexpr "remove_padding_wrapper:arg:mac_size"} boogie_si_record_i32($i3);
  assume {:sourceloc "remove_padding.c", 13, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume true;
  assume {:sourceloc "remove_padding.c", 21, 7} true;
  assume {:verifier.code 0} true;
  ...
  call $M.4, $M.4.shadow := $memset.i8($M.4, $M.4.shadow, $p10, $p10.shadow, 0, 0, 40, 40, false, false);
  assume true;
  assume {:sourceloc "remove_padding.c", 25, 25} true;
  assume {:verifier.code 0} true;
  ...
  $M.0.shadow := $store.i32($M.0.shadow,$p11.shadow,$i1.shadow);
  assume {:sourceloc "remove_padding.c", 25, 25} true;
  assume {:verifier.code 0} true;
  ...
  $M.1 := $store.ref($M.1,$p12,$p0);
  $M.1.shadow := $store.ref($M.1.shadow,$p12.shadow,$p0.shadow);
  assume {:sourceloc "remove_padding.c", 25, 25} true;
  assume {:verifier.code 0} true;
  ...
  $M.3.shadow := $store.i32($M.3.shadow,$p13.shadow,0);
  assume {:sourceloc "remove_padding.c", 25, 25} true;
  assume {:verifier.code 0} true;
  ...
  $M.5.shadow := $store.ref($M.5.shadow,$p14.shadow,$0.ref);
  assume {:sourceloc "remove_padding.c", 27, 10} true;
  assume {:verifier.code 0} true;
  call $i15, $i15.shadow := ssl3_cbc_remove_padding($p4, $p4.shadow, $p5, $p5.shadow, $i2, $i2.shadow, $i3, $i3.shadow);
...
axiom (llvm.dbg.declare == $sub.ref(0,11352));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const llvm.memset.p0i8.i64: ref;
axiom (llvm.memset.p0i8.i64 == $sub.ref(0,12384));
