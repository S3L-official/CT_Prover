...
procedure {:inline 1} ssl3_cbc_copy_mac($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i32, $i2.dup: i1, $i3: i32, $i3.dup: i1)
...
$bb3:
  ...
  call $M.1, $M.1.dup := $memset.i8($M.1, $M.1.dup, $p13, $p13.dup, 0, 0, $i26, $i26.dup, false, false);
...
$bb4:
  ...
  assert {:shadow_invariant} ($i27.dup == 0);
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  call $i30, $i30.dup := constant_time_ge_8($i27, $i27.dup, $i7, $i7.dup);
  call {:cexpr "mac_started"} boogie_si_record_i8($i30);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 114, 35} true;
  assume {:verifier.code 0} true;
  call $i31, $i31.dup := constant_time_ge_8($i27, $i27.dup, $i6, $i6.dup);
  ...
  $p35.dup := $or.i1($p33.dup,$or.i1($i34.dup,0));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 115, 27} true;
  assume {:verifier.code 0} true;
  ...
  $M.1.dup := $store.i1($M.1.dup,$p46,$i50.dup);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 117, 14} true;
  assume {:verifier.code 0} true;
  call $i51, $i51.dup := constant_time_lt($i43, $i43.dup, $i2, $i2.dup);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 117, 11} true;
  assume {:verifier.code 0} true;
  $i52 := $and.i32($i43,$i51);
  $i52.dup := $or.i1($i43.dup,$i51.dup);
...
$bb8:
  ...
  assert {:shadow_invariant} ($i54.dup == 0);
  assert {:shadow_invariant} ($i12.dup == 0);
  assert {:shadow_invariant} ($p4.dup == 0);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
$bb9:
  ...
  $i59.dup := $i58.dup;
  $i60 := $add.i64($i12,$i59);
  $i60.dup := $or.i1($i12.dup,$i59.dup);
  $p61 := $add.ref($add.ref($p4,$mul.ref(0,128)),$mul.ref($i60,1));
  $p61.dup := $or.i1($or.i1($p4.dup,$or.i1(0,0)),$or.i1($i60.dup,0));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 126, 9} true;
  assume {:verifier.code 0} true;
  ...
  $i64.dup := $i56.dup;
  $i65 := $add.i64($i12,$i64);
  $i65.dup := $or.i1($i12.dup,$i64.dup);
  $p66 := $add.ref($add.ref($p4,$mul.ref(0,128)),$mul.ref($i65,1));
  $p66.dup := $or.i1($or.i1($p4.dup,$or.i1(0,0)),$or.i1($i65.dup,0));
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 127, 20} true;
  assume {:verifier.code 0} true;
  ...
  $M.4.dup := $store.i1($M.4.dup,$p70,$i67.dup);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 128, 26} true;
  assume {:verifier.code 0} true;
  call $i71, $i71.dup := constant_time_lt($i63, $i63.dup, $i2, $i2.dup);
  assume {:sourceloc "./../ssl3_cbc_copy_mac.c", 128, 23} true;
  assume {:verifier.code 0} true;
  $i72 := $and.i32($i63,$i71);
  $i72.dup := $or.i1($i63.dup,$i71.dup);
...
procedure {:entrypoint} copy_mac_wrapper($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i32, $i2.dup: i1, $i3: i32, $i3.dup: i1, $i4: i32, $i4.dup: i1)
...
$bb0:
  ...
  $p11.dup := $or.i1($or.i1($p5.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p11.dup == 0));
  $M.0 := $store.i32($M.0,$p11,$i2);
  $M.0.dup := $store.i1($M.0.dup,$p11,$i2.dup);
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref($p5,$mul.ref(0,32)),$mul.ref(8,1));
  $p12.dup := $or.i1($or.i1($p5.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p12.dup == 0));
  $M.2 := $store.ref($M.2,$p12,$p1);
  $M.2.dup := $store.ref($M.2.dup,$p12,$p1.dup);
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref($p5,$mul.ref(0,32)),$mul.ref(16,1));
  $p13.dup := $or.i1($or.i1($p5.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p13.dup == 0));
  $M.5 := $store.i32($M.5,$p13,0);
  $M.5.dup := $store.i1($M.5.dup,$p13,0);
  assume {:sourceloc "copy_mac.c", 22, 25} true;
  assume {:verifier.code 0} true;
  ...
  $M.6.dup := $store.ref($M.6.dup,$p14,cons.dup);
  assume {:sourceloc "copy_mac.c", 24, 10} true;
  assume {:verifier.code 0} true;
  call ssl3_cbc_copy_mac($p0, $p0.dup, $p5, $p5.dup, $i3, $i3.dup, $i4, $i4.dup);
