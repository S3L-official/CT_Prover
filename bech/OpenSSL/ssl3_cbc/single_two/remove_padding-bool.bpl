...
procedure {:inline 1} ssl3_cbc_remove_padding($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $i2: i32, $i2.dup: i1, $i3: i32, $i3.dup: i1) returns ($r: i32, $r.dup: i1)
...
$bb2:
  ...
  $p15.dup := $or.i1($p10.dup,$or.i1($i14.dup,0));
  assume {:sourceloc "./../ssl3_cbc_remove_padding.c", 65, 22} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  call $i34, $i34.dup := constant_time_select_int($i24, $i24.dup, 1, 0, $sub.i32(0,1), $or.i1(0,0));
...
procedure {:entrypoint} remove_padding_wrapper($p0: ref, $p0.dup: i1, $i1: i32, $i1.dup: i1, $i2: i32, $i2.dup: i1, $i3: i32, $i3.dup: i1) returns ($r: i32, $r.dup: i1)
...
$bb0:
  ...
  call $M.4, $M.4.dup := $memset.i8($M.4, $M.4.dup, $p10, $p10.dup, 0, 0, 40, 0, false, false);
  assume true;
  ...
  $M.0.dup := $store.i1($M.0.dup,$p11,$i1.dup);
  assume {:sourceloc "remove_padding.c", 25, 25} true;
  assume {:verifier.code 0} true;
  ...
  $M.1.dup := $store.ref($M.1.dup,$p12,$p0.dup);
  assume {:sourceloc "remove_padding.c", 25, 25} true;
  assume {:verifier.code 0} true;
  ...
  $M.5.dup := $store.ref($M.5.dup,$p14,cons.dup);
  assume {:sourceloc "remove_padding.c", 27, 10} true;
  assume {:verifier.code 0} true;
  call $i15, $i15.dup := ssl3_cbc_remove_padding($p4, $p4.dup, $p5, $p5.dup, $i2, $i2.dup, $i3, $i3.dup);
