...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,35089));
...
axiom (.str == $sub.ref(0,1033));
const CRYPTO_memcmp: ref;
axiom (CRYPTO_memcmp == $sub.ref(0,2065));
procedure {:inline 1} CRYPTO_memcmp($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i64;
  var $i3.shadow: i64;
  ...
  var $i17.shadow: i32;
$bb0:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 49, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "CRYPTO_memcmp:arg:len"} boogie_si_record_i64($i2);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 49, 10} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  $i3.shadow := 0;
...
$bb1:
  ...
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 49, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i64($i3,$i2);
  $i5.shadow := $ult.i64($i3.shadow,$i2.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 49, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i5 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 50, 14} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p0,$mul.ref($i3,1));
  $p6.shadow := $add.ref($p0.shadow,$mul.ref($i3.shadow,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 50, 14} true;
  assume {:verifier.code 0} true;
  assert ($p6 == $p6.shadow);
  $i7 := $load.i8($M.0,$p6);
  ...
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 50, 21} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p1,$mul.ref($i3,1));
  $p9.shadow := $add.ref($p1.shadow,$mul.ref($i3.shadow,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 50, 21} true;
  assume {:verifier.code 0} true;
  assert ($p9 == $p9.shadow);
  $i10 := $load.i8($M.1,$p9);
  $i10.shadow := $load.i8($M.1.shadow,$p9.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 50, 21} true;
  assume {:verifier.code 0} true;
  $i11 := $sext.i8.i32($i10);
  $i11.shadow := $sext.i8.i32($i10.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 50, 19} true;
  assume {:verifier.code 0} true;
  $i12 := $xor.i32($i8,$i11);
  $i12.shadow := $xor.i32($i8.shadow,$i11.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 50, 11} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i8.i32($i4);
  $i13.shadow := $zext.i8.i32($i4.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 50, 11} true;
  assume {:verifier.code 0} true;
  $i14 := $or.i32($i13,$i12);
  $i14.shadow := $or.i32($i13.shadow,$i12.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 50, 11} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.i32.i8($i14);
  $i15.shadow := $trunc.i32.i8($i14.shadow);
  call {:cexpr "x"} boogie_si_record_i8($i15);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 50, 9} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i5 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 52, 12} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i8.i32($i4);
  $i17.shadow := $zext.i8.i32($i4.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 52, 5} true;
  assume {:verifier.code 0} true;
  $r := $i17;
  $r.shadow := $i17.shadow;
  $exn := false;
  ...
  return;
$bb4:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 49, 27} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i64($i3,1);
  $i16.shadow := $add.i64($i3.shadow,1);
...
axiom (llvm.dbg.value == $sub.ref(0,3097));
procedure {:inline 1} llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const tls1_cbc_remove_padding: ref;
axiom (tls1_cbc_remove_padding == $sub.ref(0,4129));
procedure {:inline 1} tls1_cbc_remove_padding($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i32, $i2.shadow: i32, $i3: i32, $i3.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $M.4, $M.5, $M.3, $exn, $M.0, $M.13;
{
  var $i4: i32;
  var $i4.shadow: i32;
  var $p5: ref;
  ...
  var $i13.shadow: i32;
$bb0:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 73, 60} true;
  assume {:verifier.code 0} true;
  call {:cexpr "tls1_cbc_remove_padding:arg:block_size"} boogie_si_record_i32($i2);
  call {:cexpr "tls1_cbc_remove_padding:arg:mac_size"} boogie_si_record_i32($i3);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 73, 60} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32(1,$i3);
  $i4.shadow := $add.i32(1,$i3.shadow);
  call {:cexpr "overhead"} boogie_si_record_i32($i4);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 75, 9} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref($p0,$mul.ref(0,40)),$mul.ref(32,1));
  $p5.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,40)),$mul.ref(32,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 75, 9} true;
  assume {:verifier.code 0} true;
  assert ($p5 == $p5.shadow);
  $i6 := $load.i32($M.2,$p5);
  $i6.shadow := $load.i32($M.2.shadow,$p5.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 75, 9} true;
  assume {:verifier.code 0} true;
  $i7 := $and.i32($i6,1);
  $i7.shadow := $and.i32($i6.shadow,1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 75, 9} true;
  assume {:verifier.code 0} true;
  $i8 := $ne.i32($i7,0);
...
$bb1:
  assume ($i8 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 80, 22} true;
  assume {:verifier.code 0} true;
  $i9 := $add.i32($i4,$i2);
  $i9.shadow := $add.i32($i4.shadow,$i2.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 80, 42} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p10.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 80, 42} true;
  assume {:verifier.code 0} true;
  assert ($p10 == $p10.shadow);
  $i11 := $load.i32($M.3,$p10);
  $i11.shadow := $load.i32($M.3.shadow,$p10.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 80, 35} true;
  assume {:verifier.code 0} true;
  $i12 := $ugt.i32($i9,$i11);
  $i12.shadow := $ugt.i32($i9.shadow,$i11.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 80, 13} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume !($i8 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 86, 32} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p25.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 86, 32} true;
  assume {:verifier.code 0} true;
  assert ($p25 == $p25.shadow);
  $i26 := $load.i32($M.3,$p25);
  $i26.shadow := $load.i32($M.3.shadow,$p25.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 86, 25} true;
  assume {:verifier.code 0} true;
  $i27 := $ugt.i32($i4,$i26);
  $i27.shadow := $ugt.i32($i4.shadow,$i26.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 86, 16} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume ($i12 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 81, 13} true;
  assume {:verifier.code 0} true;
  $i13 := 0;
  $i13.shadow := 0;
  goto $bb5;
$bb4:
  assume !($i12 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 83, 14} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(8,1));
  $p14.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(8,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 83, 19} true;
  assume {:verifier.code 0} true;
  assert ($p14 == $p14.shadow);
  $p15 := $load.ref($M.4,$p14);
  $p15.shadow := $load.ref($M.4.shadow,$p14.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 83, 19} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i32.i64($i2);
  $i16.shadow := $zext.i32.i64($i2.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 83, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  assert ($p14 == $p14.shadow);
  $M.4 := $store.ref($M.4,$p14,$p17);
  $M.4.shadow := $store.ref($M.4.shadow,$p14.shadow,$p17.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 84, 14} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(24,1));
  $p18.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(24,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 84, 20} true;
  assume {:verifier.code 0} true;
  assert ($p18 == $p18.shadow);
  $p19 := $load.ref($M.5,$p18);
  $p19.shadow := $load.ref($M.5.shadow,$p18.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 84, 20} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i32.i64($i2);
  ...
  $p21.shadow := $add.ref($p19.shadow,$mul.ref($i20.shadow,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 84, 20} true;
  assume {:verifier.code 0} true;
  assert ($p18 == $p18.shadow);
  $M.5 := $store.ref($M.5,$p18,$p21);
  $M.5.shadow := $store.ref($M.5.shadow,$p18.shadow,$p21.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 85, 14} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p22.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 85, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i24 := $sub.i32($i23,$i2);
  $i24.shadow := $sub.i32($i23.shadow,$i2.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 85, 21} true;
  assume {:verifier.code 0} true;
  assert ($p22 == $p22.shadow);
  $M.3 := $store.i32($M.3,$p22,$i24);
  $M.3.shadow := $store.i32($M.3.shadow,$p22.shadow,$i24.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 86, 5} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 149, 1} true;
  assume {:verifier.code 0} true;
  $r := $i13;
  $r.shadow := $i13.shadow;
  $exn := false;
  ...
  return;
$bb6:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 88, 27} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(8,1));
  $p28.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(8,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 88, 27} true;
  assume {:verifier.code 0} true;
  assert ($p28 == $p28.shadow);
  $p29 := $load.ref($M.4,$p28);
  $p29.shadow := $load.ref($M.4.shadow,$p28.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 88, 37} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p30.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 88, 37} true;
  assume {:verifier.code 0} true;
  assert ($p30 == $p30.shadow);
  $i31 := $load.i32($M.3,$p30);
  $i31.shadow := $load.i32($M.3.shadow,$p30.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 88, 44} true;
  assume {:verifier.code 0} true;
  $i32 := $sub.i32($i31,1);
  $i32.shadow := $sub.i32($i31.shadow,1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 88, 22} true;
  assume {:verifier.code 0} true;
  ...
  $p34.shadow := $add.ref($p29.shadow,$mul.ref($i33.shadow,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 88, 22} true;
  assume {:verifier.code 0} true;
  assert ($p34 == $p34.shadow);
  $i35 := $load.i8($M.6,$p34);
  $i35.shadow := $load.i8($M.6.shadow,$p34.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 88, 22} true;
  assume {:verifier.code 0} true;
  $i36 := $zext.i8.i32($i35);
  $i36.shadow := $zext.i8.i32($i35.shadow);
  call {:cexpr "padding_length"} boogie_si_record_i32($i36);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 97, 13} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($add.ref($p0,$mul.ref(0,40)),$mul.ref(8,1));
  $p37.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,40)),$mul.ref(8,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 97, 13} true;
  assume {:verifier.code 0} true;
  assert ($p37 == $p37.shadow);
  $i38 := $load.i64($M.7,$p37);
  $i38.shadow := $load.i64($M.7.shadow,$p37.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 97, 21} true;
  assume {:verifier.code 0} true;
  $i39 := $and.i64($i38,512);
  $i39.shadow := $and.i64($i38.shadow,512);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 97, 21} true;
  assume {:verifier.code 0} true;
  $i40 := $ne.i64($i39,0);
  $i40.shadow := $ne.i64($i39.shadow,0);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 97, 53} true;
  assume {:verifier.code 0} true;
  $i41 := $i36;
  $i41.shadow := $i36.shadow;
  assume {:branchcond $i40} true;
  assert ($i40 == $i40.shadow);
  goto $bb9, $bb10;
$bb7:
  assume ($i27 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 87, 9} true;
  assume {:verifier.code 0} true;
  $i13 := 0;
  $i13.shadow := 0;
  goto $bb5;
...
$bb9:
  assume ($i40 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 97, 60} true;
  assume {:verifier.code 0} true;
  $p42 := $add.ref($add.ref($p0,$mul.ref(0,40)),$mul.ref(0,1));
  $p42.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,40)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 97, 60} true;
  assume {:verifier.code 0} true;
  assert ($p42 == $p42.shadow);
  $p43 := $load.ref($M.8,$p42);
  $p43.shadow := $load.ref($M.8.shadow,$p42.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 97, 57} true;
  assume {:verifier.code 0} true;
  $i44 := $ne.ref($p43,$0.ref);
  $i44.shadow := $ne.ref($p43.shadow,$0.ref);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 97, 9} true;
  assume {:verifier.code 0} true;
  $i41 := $i36;
  $i41.shadow := $i36.shadow;
...
$bb11:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 9} true;
  assume {:verifier.code 0} true;
  $p68 := $add.ref($add.ref($p0,$mul.ref(0,40)),$mul.ref(24,1));
  $p68.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,40)),$mul.ref(24,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 9} true;
  assume {:verifier.code 0} true;
  assert ($p68 == $p68.shadow);
  $p69 := $load.ref($M.10,$p68);
  $p69.shadow := $load.ref($M.10.shadow,$p68.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 9} true;
  assume {:verifier.code 0} true;
  $p70 := $add.ref($add.ref($p69,$mul.ref(0,8)),$mul.ref(0,1));
  $p70.shadow := $add.ref($add.ref($p69.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 9} true;
  assume {:verifier.code 0} true;
  assert ($p70 == $p70.shadow);
  $p71 := $load.ref($M.11,$p70);
  $p71.shadow := $load.ref($M.11.shadow,$p70.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 9} true;
  assume {:verifier.code 0} true;
  $p72 := $add.ref($add.ref($p71,$mul.ref(0,8)),$mul.ref(0,1));
  $p72.shadow := $add.ref($add.ref($p71.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 9} true;
  assume {:verifier.code 0} true;
  assert ($p72 == $p72.shadow);
  $i73 := $load.i64($M.12,$p72);
  $i73.shadow := $load.i64($M.12.shadow,$p72.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 51} true;
  assume {:verifier.code 0} true;
  $i74 := $and.i64($i73,2097152);
  $i74.shadow := $and.i64($i73.shadow,2097152);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 51} true;
  assume {:verifier.code 0} true;
  $i75 := $ne.i64($i74,0);
  $i75.shadow := $ne.i64($i74.shadow,0);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i75} true;
  assert ($i75 == $i75.shadow);
  goto $bb27, $bb28;
$bb12:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 97, 9} true;
  assume {:verifier.code 0} true;
...
$bb13:
  assume !($i44 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 98, 12} true;
  assume {:verifier.code 0} true;
  $i45 := $ne.i32($i36,0);
  $i45.shadow := $ne.i32($i36.shadow,0);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 98, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i45} true;
  assert ($i45 == $i45.shadow);
  goto $bb14, $bb15;
$bb14:
  assume ($i45 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 99, 13} true;
  assume {:verifier.code 0} true;
  goto $bb16;
$bb15:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 98, 12} true;
  ...
  goto $bb16;
$bb16:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 101, 31} true;
  assume {:verifier.code 0} true;
  $p46 := $add.ref($add.ref($p0,$mul.ref(0,40)),$mul.ref(16,1));
  $p46.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,40)),$mul.ref(16,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 101, 31} true;
  assume {:verifier.code 0} true;
  assert ($p46 == $p46.shadow);
  $p47 := $load.ref($M.9,$p46);
  $p47.shadow := $load.ref($M.9.shadow,$p46.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 101, 35} true;
  assume {:verifier.code 0} true;
  $p48 := $add.ref($add.ref($p47,$mul.ref(0,16)),$mul.ref(8,1));
  $p48.shadow := $add.ref($add.ref($p47.shadow,$mul.ref(0,16)),$mul.ref(8,1));
  $p49 := $add.ref($add.ref($add.ref($p47,$mul.ref(0,16)),$mul.ref(8,1)),$mul.ref(0,1));
  $p49.shadow := $add.ref($add.ref($add.ref($p47.shadow,$mul.ref(0,16)),$mul.ref(8,1)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 101, 14} true;
  assume {:verifier.code 0} true;
  call $i50, $i50.shadow := CRYPTO_memcmp($p49, $p49.shadow, .str, .str, 8, 8);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 101, 73} true;
  assume {:verifier.code 0} true;
  $i51 := $eq.i32($i50,0);
  $i51.shadow := $eq.i32($i50.shadow,0);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 101, 79} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i51} true;
  assert ($i51 == $i51.shadow);
  goto $bb17, $bb18;
$bb17:
  assume ($i51 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 102, 30} true;
  assume {:verifier.code 0} true;
  $i52 := $and.i32($i36,1);
  $i52.shadow := $and.i32($i36.shadow,1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 102, 30} true;
  assume {:verifier.code 0} true;
  $i53 := $ne.i32($i52,0);
  $i53.shadow := $ne.i32($i52.shadow,0);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 101, 13} true;
  assume {:verifier.code 0} true;
...
$bb18:
  ...
  goto $bb19;
$bb19:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 17} true;
  assume {:verifier.code 0} true;
  $p59 := $add.ref($add.ref($p0,$mul.ref(0,40)),$mul.ref(16,1));
  $p59.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,40)),$mul.ref(16,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 17} true;
  assume {:verifier.code 0} true;
  assert ($p59 == $p59.shadow);
  $p60 := $load.ref($M.9,$p59);
  $p60.shadow := $load.ref($M.9.shadow,$p59.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 21} true;
  assume {:verifier.code 0} true;
  $p61 := $add.ref($add.ref($p60,$mul.ref(0,16)),$mul.ref(0,1));
  $p61.shadow := $add.ref($add.ref($p60.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 21} true;
  assume {:verifier.code 0} true;
  assert ($p61 == $p61.shadow);
  $i62 := $load.i64($M.0,$p61);
  $i62.shadow := $load.i64($M.0.shadow,$p61.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 27} true;
  assume {:verifier.code 0} true;
  $i63 := $and.i64($i62,8);
  $i63.shadow := $and.i64($i62.shadow,8);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 27} true;
  assume {:verifier.code 0} true;
  $i64 := $ne.i64($i63,0);
  $i64.shadow := $ne.i64($i63.shadow,0);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 57} true;
  assume {:verifier.code 0} true;
  $i65 := $i36;
  $i65.shadow := $i36.shadow;
  assume {:branchcond $i64} true;
  assert ($i64 == $i64.shadow);
  goto $bb22, $bb23;
$bb20:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 101, 13} true;
  assume {:verifier.code 0} true;
...
$bb21:
  assume !($i53 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 103, 16} true;
  assume {:verifier.code 0} true;
  $p54 := $add.ref($add.ref($p0,$mul.ref(0,40)),$mul.ref(16,1));
  $p54.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,40)),$mul.ref(16,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 103, 16} true;
  assume {:verifier.code 0} true;
  assert ($p54 == $p54.shadow);
  $p55 := $load.ref($M.9,$p54);
  $p55.shadow := $load.ref($M.9.shadow,$p54.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 103, 20} true;
  assume {:verifier.code 0} true;
  $p56 := $add.ref($add.ref($p55,$mul.ref(0,16)),$mul.ref(0,1));
  $p56.shadow := $add.ref($add.ref($p55.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 103, 26} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i58 := $or.i64($i57,8);
  $i58.shadow := $or.i64($i57.shadow,8);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 103, 26} true;
  assume {:verifier.code 0} true;
  assert ($p56 == $p56.shadow);
  $M.0 := $store.i64($M.0,$p56,$i58);
  $M.0.shadow := $store.i64($M.0.shadow,$p56.shadow,$i58.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 104, 9} true;
  assume {:verifier.code 0} true;
  goto $bb19;
$bb22:
  assume ($i64 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 75} true;
  assume {:verifier.code 0} true;
  $i66 := $ugt.i32($i36,0);
  $i66.shadow := $ugt.i32($i36.shadow,0);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 13} true;
  assume {:verifier.code 0} true;
  $i65 := $i36;
  $i65.shadow := $i36.shadow;
...
$bb24:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 108, 5} true;
  assume {:verifier.code 0} true;
  $i41 := $i65;
  $i41.shadow := $i65.shadow;
  goto $bb11;
$bb25:
  assume ($i66 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 106, 27} true;
  assume {:verifier.code 0} true;
  $i67 := $add.i32($i36,$sub.i32(0,1));
  $i67.shadow := $add.i32($i36.shadow,$sub.i32(0,1));
  call {:cexpr "padding_length"} boogie_si_record_i32($i67);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 107, 9} true;
  assume {:verifier.code 0} true;
  $i65 := $i67;
  $i65.shadow := $i67.shadow;
  goto $bb24;
$bb26:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 13} true;
  assume {:verifier.code 0} true;
...
$bb27:
  assume ($i75 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 111, 39} true;
  assume {:verifier.code 0} true;
  $i76 := $add.i32($i41,1);
  $i76.shadow := $add.i32($i41.shadow,1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 111, 14} true;
  assume {:verifier.code 0} true;
  $p77 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p77.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 111, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i79 := $sub.i32($i78,$i76);
  $i79.shadow := $sub.i32($i78.shadow,$i76.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 111, 21} true;
  assume {:verifier.code 0} true;
  assert ($p77 == $p77.shadow);
  $M.3 := $store.i32($M.3,$p77,$i79);
  $M.3.shadow := $store.i32($M.3.shadow,$p77.shadow,$i79.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 112, 9} true;
  assume {:verifier.code 0} true;
  $i13 := 1;
  $i13.shadow := 1;
  goto $bb5;
$bb28:
  assume !($i75 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 114, 34} true;
  assume {:verifier.code 0} true;
  $p80 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p80.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 114, 34} true;
  assume {:verifier.code 0} true;
  assert ($p80 == $p80.shadow);
  $i81 := $load.i32($M.3,$p80);
  $i81.shadow := $load.i32($M.3.shadow,$p80.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 114, 51} true;
  assume {:verifier.code 0} true;
  $i82 := $add.i32($i4,$i41);
  $i82.shadow := $add.i32($i4.shadow,$i41.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 114, 12} true;
  assume {:verifier.code 0} true;
  call $i83, $i83.shadow := constant_time_ge($i81, $i81.shadow, $i82, $i82.shadow);
  call {:cexpr "good"} boogie_si_record_i32($i83);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 125, 25} true;
  assume {:verifier.code 0} true;
  $p84 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p84.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 125, 25} true;
  assume {:verifier.code 0} true;
  assert ($p84 == $p84.shadow);
  $i85 := $load.i32($M.3,$p84);
  $i85.shadow := $load.i32($M.3.shadow,$p84.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 125, 32} true;
  assume {:verifier.code 0} true;
  $i86 := $sub.i32($i85,1);
  $i86.shadow := $sub.i32($i85.shadow,1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 125, 18} true;
  assume {:verifier.code 0} true;
  $i87 := $ugt.i32(255,$i86);
  $i87.shadow := $ugt.i32(255,$i86.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 125, 9} true;
  assume {:verifier.code 0} true;
  $i88 := 255;
  $i88.shadow := 255;
  assume {:branchcond $i87} true;
  assert ($i87 == $i87.shadow);
  goto $bb29, $bb30;
$bb29:
  assume ($i87 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 126, 25} true;
  assume {:verifier.code 0} true;
  $p89 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p89.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 126, 25} true;
  assume {:verifier.code 0} true;
  assert ($p89 == $p89.shadow);
  $i90 := $load.i32($M.3,$p89);
  $i90.shadow := $load.i32($M.3.shadow,$p89.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 126, 32} true;
  assume {:verifier.code 0} true;
  $i91 := $sub.i32($i90,1);
  $i91.shadow := $sub.i32($i90.shadow,1);
  call {:cexpr "to_check"} boogie_si_record_i32($i91);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 126, 9} true;
  assume {:verifier.code 0} true;
  $i88 := $i91;
  $i88.shadow := $i91.shadow;
  goto $bb31;
$bb30:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 125, 9} true;
  assume {:verifier.code 0} true;
...
$bb31:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 128, 10} true;
  assume {:verifier.code 0} true;
  $i92 := $i83;
  $i92.shadow := $i83.shadow;
  $i93 := 0;
  $i93.shadow := 0;
  goto $bb32;
$bb32:
  assert {:shadow_invariant} $shadow_ok;
  assert {:shadow_invariant} ($i88 == $i88.shadow);
  assert {:shadow_invariant} ($i93 == $i93.shadow);
  assert {:unlikely_shadow_invariant ($i92 == $i92.shadow)} true;
  assert {:unlikely_shadow_invariant ($i41 == $i41.shadow)} true;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 128, 19} true;
  assume {:verifier.code 0} true;
  $i94 := $ult.i32($i93,$i88);
  $i94.shadow := $ult.i32($i93.shadow,$i88.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 128, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i94} true;
  assert ($i94 == $i94.shadow);
  goto $bb33, $bb34;
$bb33:
  assume ($i94 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 130, 30} true;
  assume {:verifier.code 0} true;
  call $i95, $i95.shadow := constant_time_ge_8($i41, $i41.shadow, $i93, $i93.shadow);
  call {:cexpr "mask"} boogie_si_record_i8($i95);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 32} true;
  assume {:verifier.code 0} true;
  $p96 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(8,1));
  $p96.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(8,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 32} true;
  assume {:verifier.code 0} true;
  assert ($p96 == $p96.shadow);
  $p97 := $load.ref($M.4,$p96);
  $p97.shadow := $load.ref($M.4.shadow,$p96.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 42} true;
  assume {:verifier.code 0} true;
  $p98 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p98.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 42} true;
  assume {:verifier.code 0} true;
  assert ($p98 == $p98.shadow);
  $i99 := $load.i32($M.3,$p98);
  $i99.shadow := $load.i32($M.3.shadow,$p98.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 49} true;
  assume {:verifier.code 0} true;
  $i100 := $sub.i32($i99,1);
  $i100.shadow := $sub.i32($i99.shadow,1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 53} true;
  assume {:verifier.code 0} true;
  $i101 := $sub.i32($i100,$i93);
  $i101.shadow := $sub.i32($i100.shadow,$i93.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 27} true;
  assume {:verifier.code 0} true;
  $i102 := $zext.i32.i64($i101);
  $i102.shadow := $zext.i32.i64($i101.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 27} true;
  assume {:verifier.code 0} true;
  $p103 := $add.ref($p97,$mul.ref($i102,1));
  $p103.shadow := $add.ref($p97.shadow,$mul.ref($i102.shadow,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 27} true;
  assume {:verifier.code 0} true;
  assert ($p103 == $p103.shadow);
  $i104 := $load.i8($M.6,$p103);
  $i104.shadow := $load.i8($M.6.shadow,$p103.shadow);
  call {:cexpr "b"} boogie_si_record_i8($i104);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 136, 19} true;
  assume {:verifier.code 0} true;
  $i105 := $zext.i8.i32($i95);
  $i105.shadow := $zext.i8.i32($i95.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 136, 44} true;
  assume {:verifier.code 0} true;
  $i106 := $zext.i8.i32($i104);
  $i106.shadow := $zext.i8.i32($i104.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 136, 42} true;
  assume {:verifier.code 0} true;
  $i107 := $xor.i32($i41,$i106);
  $i107.shadow := $xor.i32($i41.shadow,$i106.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 136, 24} true;
  assume {:verifier.code 0} true;
  $i108 := $and.i32($i105,$i107);
  $i108.shadow := $and.i32($i105.shadow,$i107.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 136, 17} true;
  assume {:verifier.code 0} true;
  $i109 := $xor.i32($i108,$sub.i32(0,1));
  $i109.shadow := $xor.i32($i108.shadow,$sub.i32(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 136, 14} true;
  assume {:verifier.code 0} true;
  $i110 := $and.i32($i92,$i109);
  $i110.shadow := $and.i32($i92.shadow,$i109.shadow);
  call {:cexpr "good"} boogie_si_record_i32($i110);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 137, 5} true;
  assume {:verifier.code 0} true;
  goto $bb35;
$bb34:
  assume !($i94 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 143, 40} true;
  assume {:verifier.code 0} true;
  $i112 := $and.i32($i92,255);
  $i112.shadow := $and.i32($i92.shadow,255);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 143, 12} true;
  assume {:verifier.code 0} true;
  call $i113, $i113.shadow := constant_time_eq(255, 255, $i112, $i112.shadow);
  call {:cexpr "good"} boogie_si_record_i32($i113);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 144, 45} true;
  assume {:verifier.code 0} true;
  $i114 := $add.i32($i41,1);
  $i114.shadow := $add.i32($i41.shadow,1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 144, 27} true;
  assume {:verifier.code 0} true;
  $i115 := $and.i32($i113,$i114);
  $i115.shadow := $and.i32($i113.shadow,$i114.shadow);
  call {:cexpr "padding_length"} boogie_si_record_i32($i115);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 145, 10} true;
  assume {:verifier.code 0} true;
  $p116 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p116.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 145, 17} true;
  assume {:verifier.code 0} true;
  assert ($p116 == $p116.shadow);
  $i117 := $load.i32($M.3,$p116);
  $i117.shadow := $load.i32($M.3.shadow,$p116.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 145, 17} true;
  assume {:verifier.code 0} true;
  $i118 := $sub.i32($i117,$i115);
  $i118.shadow := $sub.i32($i117.shadow,$i115.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 145, 17} true;
  assume {:verifier.code 0} true;
  assert ($p116 == $p116.shadow);
  $M.3 := $store.i32($M.3,$p116,$i118);
  $M.3.shadow := $store.i32($M.3.shadow,$p116.shadow,$i118.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 146, 33} true;
  assume {:verifier.code 0} true;
  $i119 := $shl.i32($i115,8);
  $i119.shadow := $shl.i32($i115.shadow,8);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 146, 10} true;
  assume {:verifier.code 0} true;
  $p120 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(16,1));
  $p120.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(16,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 146, 15} true;
  assume {:verifier.code 0} true;
  assert ($p120 == $p120.shadow);
  $i121 := $load.i32($M.13,$p120);
  $i121.shadow := $load.i32($M.13.shadow,$p120.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 146, 15} true;
  assume {:verifier.code 0} true;
  $i122 := $or.i32($i121,$i119);
  $i122.shadow := $or.i32($i121.shadow,$i119.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 146, 15} true;
  assume {:verifier.code 0} true;
  assert ($p120 == $p120.shadow);
  $M.13 := $store.i32($M.13,$p120,$i122);
  $M.13.shadow := $store.i32($M.13.shadow,$p120.shadow,$i122.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 148, 12} true;
  assume {:verifier.code 0} true;
  call $i123, $i123.shadow := constant_time_select_int($i113, $i113.shadow, 1, 1, $sub.i32(0,1), $sub.i32(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 148, 5} true;
  assume {:verifier.code 0} true;
  $i13 := $i123;
  $i13.shadow := $i123.shadow;
  goto $bb5;
$bb35:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 128, 32} true;
  assume {:verifier.code 0} true;
  $i111 := $add.i32($i93,1);
  $i111.shadow := $add.i32($i93.shadow,1);
  call {:cexpr "i"} boogie_si_record_i32($i111);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 128, 5} true;
  assume {:verifier.code 0} true;
  $i92 := $i110;
  $i92.shadow := $i110.shadow;
  $i93 := $i111;
  $i93.shadow := $i111.shadow;
  goto $bb32;
}
const constant_time_ge: ref;
axiom (constant_time_ge == $sub.ref(0,5161));
procedure {:inline 1} constant_time_ge($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
  ...
  var $i3.shadow: i32;
$bb0:
  assume {:sourceloc "./../constant_time_locl.h", 150, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "constant_time_ge:arg:a"} boogie_si_record_i32($i0);
  call {:cexpr "constant_time_ge:arg:b"} boogie_si_record_i32($i1);
  assume {:sourceloc "./../constant_time_locl.h", 150, 13} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.shadow := constant_time_lt($i0, $i0.shadow, $i1, $i1.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 150, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $xor.i32($i2,$sub.i32(0,1));
  $i3.shadow := $xor.i32($i2.shadow,$sub.i32(0,1));
  assume {:sourceloc "./../constant_time_locl.h", 150, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $r.shadow := $i3.shadow;
  $exn := false;
...
axiom (constant_time_ge_8 == $sub.ref(0,6193));
procedure {:inline 1} constant_time_ge_8($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i8, $r.shadow: i8)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
  ...
  var $i3.shadow: i8;
$bb0:
  assume {:sourceloc "./../constant_time_locl.h", 155, 28} true;
  assume {:verifier.code 0} true;
  call {:cexpr "constant_time_ge_8:arg:a"} boogie_si_record_i32($i0);
  call {:cexpr "constant_time_ge_8:arg:b"} boogie_si_record_i32($i1);
  assume {:sourceloc "./../constant_time_locl.h", 155, 28} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.shadow := constant_time_ge($i0, $i0.shadow, $i1, $i1.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 155, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $trunc.i32.i8($i2);
  $i3.shadow := $trunc.i32.i8($i2.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 155, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $r.shadow := $i3.shadow;
  $exn := false;
...
axiom (constant_time_eq == $sub.ref(0,7225));
procedure {:inline 1} constant_time_eq($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
  ...
  var $i3.shadow: i32;
$bb0:
  assume {:sourceloc "./../constant_time_locl.h", 170, 36} true;
  assume {:verifier.code 0} true;
  call {:cexpr "constant_time_eq:arg:a"} boogie_si_record_i32($i0);
  call {:cexpr "constant_time_eq:arg:b"} boogie_si_record_i32($i1);
  assume {:sourceloc "./../constant_time_locl.h", 170, 36} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i32($i0,$i1);
  $i2.shadow := $xor.i32($i0.shadow,$i1.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 170, 12} true;
  assume {:verifier.code 0} true;
  call $i3, $i3.shadow := constant_time_is_zero($i2, $i2.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 170, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $r.shadow := $i3.shadow;
  $exn := false;
...
axiom (constant_time_select_int == $sub.ref(0,8257));
procedure {:inline 1} constant_time_select_int($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
$bb0:
  assume {:sourceloc "./../constant_time_locl.h", 204, 18} true;
  assume {:verifier.code 0} true;
  call {:cexpr "constant_time_select_int:arg:mask"} boogie_si_record_i32($i0);
  call {:cexpr "constant_time_select_int:arg:a"} boogie_si_record_i32($i1);
  call {:cexpr "constant_time_select_int:arg:b"} boogie_si_record_i32($i2);
  assume {:sourceloc "./../constant_time_locl.h", 204, 18} true;
  assume {:verifier.code 0} true;
  call $i3, $i3.shadow := constant_time_select($i0, $i0.shadow, $i1, $i1.shadow, $i2, $i2.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 204, 5} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $r.shadow := $i3.shadow;
  $exn := false;
...
axiom (constant_time_select == $sub.ref(0,9289));
procedure {:inline 1} constant_time_select($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32, $i2: i32, $i2.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
  ...
  var $i6.shadow: i32;
$bb0:
  assume {:sourceloc "./../constant_time_locl.h", 192, 18} true;
  assume {:verifier.code 0} true;
  call {:cexpr "constant_time_select:arg:mask"} boogie_si_record_i32($i0);
  call {:cexpr "constant_time_select:arg:a"} boogie_si_record_i32($i1);
  call {:cexpr "constant_time_select:arg:b"} boogie_si_record_i32($i2);
  assume {:sourceloc "./../constant_time_locl.h", 192, 18} true;
  assume {:verifier.code 0} true;
  $i3 := $and.i32($i0,$i1);
  $i3.shadow := $and.i32($i0.shadow,$i1.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 192, 26} true;
  assume {:verifier.code 0} true;
  $i4 := $xor.i32($i0,$sub.i32(0,1));
  $i4.shadow := $xor.i32($i0.shadow,$sub.i32(0,1));
  assume {:sourceloc "./../constant_time_locl.h", 192, 32} true;
  assume {:verifier.code 0} true;
  $i5 := $and.i32($i4,$i2);
  $i5.shadow := $and.i32($i4.shadow,$i2.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 192, 23} true;
  assume {:verifier.code 0} true;
  $i6 := $or.i32($i3,$i5);
  $i6.shadow := $or.i32($i3.shadow,$i5.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 192, 5} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $r.shadow := $i6.shadow;
  $exn := false;
...
axiom (constant_time_is_zero == $sub.ref(0,10321));
procedure {:inline 1} constant_time_is_zero($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i4.shadow: i32;
$bb0:
  assume {:sourceloc "./../constant_time_locl.h", 160, 30} true;
  assume {:verifier.code 0} true;
  call {:cexpr "constant_time_is_zero:arg:a"} boogie_si_record_i32($i0);
  assume {:sourceloc "./../constant_time_locl.h", 160, 30} true;
  assume {:verifier.code 0} true;
  $i1 := $xor.i32($i0,$sub.i32(0,1));
  $i1.shadow := $xor.i32($i0.shadow,$sub.i32(0,1));
  assume {:sourceloc "./../constant_time_locl.h", 160, 38} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32($i0,1);
  $i2.shadow := $sub.i32($i0.shadow,1);
  assume {:sourceloc "./../constant_time_locl.h", 160, 33} true;
  assume {:verifier.code 0} true;
  $i3 := $and.i32($i1,$i2);
  $i3.shadow := $and.i32($i1.shadow,$i2.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 160, 12} true;
  assume {:verifier.code 0} true;
  call $i4, $i4.shadow := constant_time_msb($i3, $i3.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 160, 5} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $r.shadow := $i4.shadow;
  $exn := false;
...
axiom (constant_time_msb == $sub.ref(0,11353));
procedure {:inline 1} constant_time_msb($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
  ...
  var $i2.shadow: i32;
$bb0:
  assume {:sourceloc "./../constant_time_locl.h", 135, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "constant_time_msb:arg:a"} boogie_si_record_i32($i0);
  assume {:sourceloc "./../constant_time_locl.h", 135, 19} true;
  assume {:verifier.code 0} true;
  $i1 := $lshr.i32($i0,31);
  $i1.shadow := $lshr.i32($i0.shadow,31);
  assume {:sourceloc "./../constant_time_locl.h", 135, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0,$i1);
  $i2.shadow := $sub.i32(0,$i1.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 135, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $r.shadow := $i2.shadow;
  $exn := false;
...
axiom (constant_time_lt == $sub.ref(0,12385));
procedure {:inline 1} constant_time_lt($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
  ...
  var $i7.shadow: i32;
$bb0:
  assume {:sourceloc "./../constant_time_locl.h", 140, 38} true;
  assume {:verifier.code 0} true;
  call {:cexpr "constant_time_lt:arg:a"} boogie_si_record_i32($i0);
  call {:cexpr "constant_time_lt:arg:b"} boogie_si_record_i32($i1);
  assume {:sourceloc "./../constant_time_locl.h", 140, 38} true;
  assume {:verifier.code 0} true;
  $i2 := $xor.i32($i0,$i1);
  $i2.shadow := $xor.i32($i0.shadow,$i1.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 140, 49} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32($i0,$i1);
  $i3.shadow := $sub.i32($i0.shadow,$i1.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 140, 54} true;
  assume {:verifier.code 0} true;
  $i4 := $xor.i32($i3,$i1);
  $i4.shadow := $xor.i32($i3.shadow,$i1.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 140, 43} true;
  assume {:verifier.code 0} true;
  $i5 := $or.i32($i2,$i4);
  $i5.shadow := $or.i32($i2.shadow,$i4.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 140, 32} true;
  assume {:verifier.code 0} true;
  $i6 := $xor.i32($i0,$i5);
  $i6.shadow := $xor.i32($i0.shadow,$i5.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 140, 12} true;
  assume {:verifier.code 0} true;
  call $i7, $i7.shadow := constant_time_msb($i6, $i6.shadow);
  assume {:sourceloc "./../constant_time_locl.h", 140, 5} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $r.shadow := $i7.shadow;
  $exn := false;
...
const remove_padding_wrapper: ref;
axiom (remove_padding_wrapper == $sub.ref(0,13417));
procedure {:entrypoint} remove_padding_wrapper($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64, $p2: ref, $p2.shadow: ref, $i3: i64, $i3.shadow: i64, $i4: i32, $i4.shadow: i32, $p5: ref, $p5.shadow: ref, $i6: i32, $i6.shadow: i32, $i7: i32, $i7.shadow: i32, $i8: i32, $i8.shadow: i32) returns ($r: i32, $r.shadow: i32)
...
requires {:public_in $i6} true;
requires {:public_in $i7} true;
requires {:public_in $i8} true;
modifies $M.0, $M.12, $M.11, $M.8, $M.7, $M.9, $M.10, $M.2, $M.3, $M.4, $M.13, $M.5, $exn;
...
requires ($i6 == $i6.shadow);
requires ($i7 == $i7.shadow);
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "remove_padding.c", 18, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:remove_padding_wrapper"} boogie_si_record_ref(remove_padding_wrapper);
  call {:cexpr "smack:arg:remove_padding_wrapper:$i0"} boogie_si_record_i64($i0);
  call {:cexpr "smack:arg:remove_padding_wrapper:$i1"} boogie_si_record_i64($i1);
  call {:cexpr "smack:arg:remove_padding_wrapper:$p2"} boogie_si_record_ref($p2);
  call {:cexpr "smack:arg:remove_padding_wrapper:$i3"} boogie_si_record_i64($i3);
  call {:cexpr "smack:arg:remove_padding_wrapper:$i4"} boogie_si_record_i32($i4);
  call {:cexpr "smack:arg:remove_padding_wrapper:$p5"} boogie_si_record_ref($p5);
  call {:cexpr "smack:arg:remove_padding_wrapper:$i6"} boogie_si_record_i32($i6);
  call {:cexpr "smack:arg:remove_padding_wrapper:$i7"} boogie_si_record_i32($i7);
  call {:cexpr "smack:arg:remove_padding_wrapper:$i8"} boogie_si_record_i32($i8);
  assume {:verifier.code 0} true;
  ...
  $p11.shadow := $p11;
  assume {:verifier.code 0} true;
  call $p12 := $alloc($mul.ref(1,$zext.i32.i64(1)));
  $p12.shadow := $p12;
  assume {:verifier.code 0} true;
  call $p13 := $alloc($mul.ref(40,$zext.i32.i64(1)));
  $p13.shadow := $p13;
  assume {:verifier.code 0} true;
  call $p14 := $alloc($mul.ref(32,$zext.i32.i64(1)));
  $p14.shadow := $p14;
  call {:cexpr "remove_padding_wrapper:arg:options"} boogie_si_record_i64($i0);
  call {:cexpr "remove_padding_wrapper:arg:s3_flags"} boogie_si_record_i64($i1);
  call {:cexpr "remove_padding_wrapper:arg:flags"} boogie_si_record_i64($i3);
  call {:cexpr "remove_padding_wrapper:arg:slicing_cheat"} boogie_si_record_i32($i4);
  call {:cexpr "remove_padding_wrapper:arg:length"} boogie_si_record_i32($i6);
  call {:cexpr "remove_padding_wrapper:arg:block_size"} boogie_si_record_i32($i7);
  call {:cexpr "remove_padding_wrapper:arg:mac_size"} boogie_si_record_i32($i8);
  assume {:sourceloc "remove_padding.c", 18, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p2} $p15 := __SMACK_value.ref($p2);
  $p15.shadow := $p15;
  assume $isExternal($p15);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p15);
  assume {:sourceloc "remove_padding.c", 18, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p15, $p15.shadow);
  assume {:sourceloc "remove_padding.c", 19, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p5} $p16 := __SMACK_value.ref($p5);
  $p16.shadow := $p16;
  assume $isExternal($p16);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p16);
  assume {:sourceloc "remove_padding.c", 19, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p16, $p16.shadow);
  assume {:sourceloc "remove_padding.c", 22, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i0} $p17 := __SMACK_value.i64($i0);
  $p17.shadow := $p17;
  assume $isExternal($p17);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p17);
  assume {:sourceloc "remove_padding.c", 22, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p17, $p17.shadow);
  assume {:sourceloc "remove_padding.c", 23, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i1} $p18 := __SMACK_value.i64($i1);
  $p18.shadow := $p18;
  assume $isExternal($p18);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p18);
  assume {:sourceloc "remove_padding.c", 23, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p18, $p18.shadow);
  assume {:sourceloc "remove_padding.c", 24, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i3} $p19 := __SMACK_value.i64($i3);
  $p19.shadow := $p19;
  assume $isExternal($p19);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p19);
  assume {:sourceloc "remove_padding.c", 24, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p19, $p19.shadow);
  assume {:sourceloc "remove_padding.c", 25, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i4} $p20 := __SMACK_value.i32($i4);
  $p20.shadow := $p20;
  assume $isExternal($p20);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p20);
  assume {:sourceloc "remove_padding.c", 25, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p20, $p20.shadow);
  assume {:sourceloc "remove_padding.c", 26, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i6} $p21 := __SMACK_value.i32($i6);
  $p21.shadow := $p21;
  assume $isExternal($p21);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p21);
  assume {:sourceloc "remove_padding.c", 26, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p21, $p21.shadow);
  assume {:sourceloc "remove_padding.c", 27, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i7} $p22 := __SMACK_value.i32($i7);
  $p22.shadow := $p22;
  assume $isExternal($p22);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p22);
  assume {:sourceloc "remove_padding.c", 27, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p22, $p22.shadow);
  assume {:sourceloc "remove_padding.c", 28, 13} true;
  assume {:verifier.code 0} true;
  call {:name $i8} $p23 := __SMACK_value.i32($i8);
  $p23.shadow := $p23;
  assume $isExternal($p23);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p23);
  assume {:sourceloc "remove_padding.c", 28, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p23, $p23.shadow);
  assume true;
  assume {:sourceloc "remove_padding.c", 30, 23} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($add.ref($p9,$mul.ref(0,16)),$mul.ref(0,1));
  $p24.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,16)),$mul.ref(0,1));
  assume {:sourceloc "remove_padding.c", 30, 23} true;
  assume {:verifier.code 0} true;
  assert ($p24 == $p24.shadow);
  $M.0 := $store.i64($M.0,$p24,$i1);
  $M.0.shadow := $store.i64($M.0.shadow,$p24.shadow,$i1.shadow);
  assume {:sourceloc "remove_padding.c", 30, 23} true;
  assume {:verifier.code 0} true;
  $p25 := $add.ref($add.ref($p9,$mul.ref(0,16)),$mul.ref(8,1));
  $p25.shadow := $add.ref($add.ref($p9.shadow,$mul.ref(0,16)),$mul.ref(8,1));
  assume {:sourceloc "remove_padding.c", 30, 23} true;
  assume {:verifier.code 0} true;
  ...
  call $M.0, $M.0.shadow := $memset.i8($M.0, $M.0.shadow, $p26, $p26.shadow, 0, 0, 8, 8, false, false);
  assume true;
  assume {:sourceloc "remove_padding.c", 32, 23} true;
  assume {:verifier.code 0} true;
  $p27 := $add.ref($add.ref($p10,$mul.ref(0,8)),$mul.ref(0,1));
  $p27.shadow := $add.ref($add.ref($p10.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "remove_padding.c", 32, 23} true;
  assume {:verifier.code 0} true;
  assert ($p27 == $p27.shadow);
  $M.12 := $store.i64($M.12,$p27,$i3);
  $M.12.shadow := $store.i64($M.12.shadow,$p27.shadow,$i3.shadow);
  assume true;
  assume {:sourceloc "remove_padding.c", 33, 31} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($add.ref($p11,$mul.ref(0,8)),$mul.ref(0,1));
  $p28.shadow := $add.ref($add.ref($p11.shadow,$mul.ref(0,8)),$mul.ref(0,1));
  assume {:sourceloc "remove_padding.c", 33, 31} true;
  assume {:verifier.code 0} true;
  assert ($p28 == $p28.shadow);
  $M.11 := $store.ref($M.11,$p28,$p10);
  $M.11.shadow := $store.ref($M.11.shadow,$p28.shadow,$p10.shadow);
  assume true;
  assume true;
  assume {:sourceloc "remove_padding.c", 36, 15} true;
  assume {:verifier.code 0} true;
  $p29 := $add.ref($add.ref($p13,$mul.ref(0,40)),$mul.ref(0,1));
  $p29.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,40)),$mul.ref(0,1));
  assume {:sourceloc "remove_padding.c", 36, 15} true;
  assume {:verifier.code 0} true;
  assert ($p29 == $p29.shadow);
  $M.8 := $store.ref($M.8,$p29,$p12);
  $M.8.shadow := $store.ref($M.8.shadow,$p29.shadow,$p12.shadow);
  assume {:sourceloc "remove_padding.c", 36, 15} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($add.ref($p13,$mul.ref(0,40)),$mul.ref(8,1));
  $p30.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,40)),$mul.ref(8,1));
  assume {:sourceloc "remove_padding.c", 36, 15} true;
  assume {:verifier.code 0} true;
  assert ($p30 == $p30.shadow);
  $M.7 := $store.i64($M.7,$p30,$i0);
  $M.7.shadow := $store.i64($M.7.shadow,$p30.shadow,$i0.shadow);
  assume {:sourceloc "remove_padding.c", 36, 15} true;
  assume {:verifier.code 0} true;
  $p31 := $add.ref($add.ref($p13,$mul.ref(0,40)),$mul.ref(16,1));
  $p31.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,40)),$mul.ref(16,1));
  assume {:sourceloc "remove_padding.c", 36, 15} true;
  assume {:verifier.code 0} true;
  assert ($p31 == $p31.shadow);
  $M.9 := $store.ref($M.9,$p31,$p9);
  $M.9.shadow := $store.ref($M.9.shadow,$p31.shadow,$p9.shadow);
  assume {:sourceloc "remove_padding.c", 36, 15} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($add.ref($p13,$mul.ref(0,40)),$mul.ref(24,1));
  $p32.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,40)),$mul.ref(24,1));
  assume {:sourceloc "remove_padding.c", 36, 15} true;
  assume {:verifier.code 0} true;
  assert ($p32 == $p32.shadow);
  $M.10 := $store.ref($M.10,$p32,$p11);
  $M.10.shadow := $store.ref($M.10.shadow,$p32.shadow,$p11.shadow);
  assume {:sourceloc "remove_padding.c", 36, 15} true;
  assume {:verifier.code 0} true;
  $p33 := $add.ref($add.ref($p13,$mul.ref(0,40)),$mul.ref(32,1));
  $p33.shadow := $add.ref($add.ref($p13.shadow,$mul.ref(0,40)),$mul.ref(32,1));
  assume {:sourceloc "remove_padding.c", 36, 15} true;
  assume {:verifier.code 0} true;
  assert ($p33 == $p33.shadow);
  $M.2 := $store.i32($M.2,$p33,$i4);
  $M.2.shadow := $store.i32($M.2.shadow,$p33.shadow,$i4.shadow);
  assume true;
  assume {:sourceloc "remove_padding.c", 40, 25} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($add.ref($p14,$mul.ref(0,32)),$mul.ref(0,1));
  $p34.shadow := $add.ref($add.ref($p14.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "remove_padding.c", 40, 25} true;
  assume {:verifier.code 0} true;
  assert ($p34 == $p34.shadow);
  $M.3 := $store.i32($M.3,$p34,$i6);
  $M.3.shadow := $store.i32($M.3.shadow,$p34.shadow,$i6.shadow);
  assume {:sourceloc "remove_padding.c", 40, 25} true;
  assume {:verifier.code 0} true;
  $p35 := $add.ref($add.ref($p14,$mul.ref(0,32)),$mul.ref(8,1));
  $p35.shadow := $add.ref($add.ref($p14.shadow,$mul.ref(0,32)),$mul.ref(8,1));
  assume {:sourceloc "remove_padding.c", 40, 25} true;
  assume {:verifier.code 0} true;
  assert ($p35 == $p35.shadow);
  $M.4 := $store.ref($M.4,$p35,$p5);
  $M.4.shadow := $store.ref($M.4.shadow,$p35.shadow,$p5.shadow);
  assume {:sourceloc "remove_padding.c", 40, 25} true;
  assume {:verifier.code 0} true;
  $p36 := $add.ref($add.ref($p14,$mul.ref(0,32)),$mul.ref(16,1));
  $p36.shadow := $add.ref($add.ref($p14.shadow,$mul.ref(0,32)),$mul.ref(16,1));
  assume {:sourceloc "remove_padding.c", 40, 25} true;
  assume {:verifier.code 0} true;
  assert ($p36 == $p36.shadow);
  $M.13 := $store.i32($M.13,$p36,0);
  $M.13.shadow := $store.i32($M.13.shadow,$p36.shadow,0);
  assume {:sourceloc "remove_padding.c", 40, 25} true;
  assume {:verifier.code 0} true;
  $p37 := $add.ref($add.ref($p14,$mul.ref(0,32)),$mul.ref(24,1));
  $p37.shadow := $add.ref($add.ref($p14.shadow,$mul.ref(0,32)),$mul.ref(24,1));
  assume {:sourceloc "remove_padding.c", 40, 25} true;
  assume {:verifier.code 0} true;
  assert ($p37 == $p37.shadow);
  $M.5 := $store.ref($M.5,$p37,$0.ref);
  $M.5.shadow := $store.ref($M.5.shadow,$p37.shadow,$0.ref);
  assume {:sourceloc "remove_padding.c", 43, 10} true;
  assume {:verifier.code 0} true;
  call $i38, $i38.shadow := tls1_cbc_remove_padding($p13, $p13.shadow, $p14, $p14.shadow, $i7, $i7.shadow, $i8, $i8.shadow);
  assume {:sourceloc "remove_padding.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $r := $i38;
  $r.shadow := $i38.shadow;
  $exn := false;
...
axiom (__SMACK_value == $sub.ref(0,14449));
...
axiom (__SMACK_dummy == $sub.ref(0,20641));
...
axiom (__SMACK_and32 == $sub.ref(0,21673));
...
axiom (__SMACK_and64 == $sub.ref(0,22705));
...
axiom (__SMACK_and16 == $sub.ref(0,23737));
...
axiom (__SMACK_and8 == $sub.ref(0,24769));
...
axiom (__SMACK_or32 == $sub.ref(0,25801));
...
axiom (__SMACK_or64 == $sub.ref(0,26833));
...
axiom (__SMACK_or16 == $sub.ref(0,27865));
...
axiom (__SMACK_or8 == $sub.ref(0,28897));
...
axiom (__SMACK_check_overflow == $sub.ref(0,29929));
...
axiom (__SMACK_loop_exit == $sub.ref(0,30961));
...
axiom (__SMACK_decls == $sub.ref(0,31993));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,33025));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,34057));
...
axiom (__SMACK_static_init == $sub.ref(0,35089));
...
$bb0:
  ...
  $M.1.shadow := $store.i8($M.1.shadow,.str,0);
  assert ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(1,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(1,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(1,1)),0);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(1,1)),0);
  assert ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(2,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(2,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(2,1)),0);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(2,1)),0);
  assert ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(3,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(3,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(3,1)),0);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(3,1)),0);
  assert ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(4,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(4,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(4,1)),0);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(4,1)),0);
  assert ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(5,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(5,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(5,1)),0);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(5,1)),0);
  assert ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(6,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(6,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(6,1)),0);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(6,1)),0);
  assert ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(7,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(7,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(7,1)),0);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(7,1)),0);
  assert ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(8,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(8,1)));
  $M.1 := $store.i8($M.1,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(8,1)),0);
  $M.1.shadow := $store.i8($M.1.shadow,$add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(8,1)),0);
  $exn := false;
  $exn.shadow := false;
  return;
}
