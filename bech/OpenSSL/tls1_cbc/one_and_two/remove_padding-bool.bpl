...
$bb11:
  ...
  $p71.dup := $or.i1($or.i1($p70.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 9} true;
  assume {:verifier.code 0} true;
  $p71.dup := 0;
  ...
  $p73.dup := $or.i1($or.i1($p72.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 9} true;
  assume {:verifier.code 0} true;
  $p73.dup := 0;
...
$bb16:
  ...
  assume {:verifier.code 0} true;
  call $i51, $i51.dup := CRYPTO_memcmp($p49, $p49.dup, $p50, $p50.dup, 8, 0);
...
$bb19:
  ...
  $p60.dup := $or.i1($or.i1($p0.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 17} true;
  assume {:verifier.code 0} true;
  $p60.dup := 0;
  ...
  $p62.dup := $or.i1($or.i1($p61.dup,$or.i1(0,0)),$or.i1(0,0));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 21} true;
  assume {:verifier.code 0} true;
  $p62.dup := 0;
...
$bb21:
  ...
  $p57.dup := $or.i1($or.i1($p56.dup,$or.i1(0,0)),$or.i1(0,0));
  ...
  $M.0.dup := $store.i1($M.0.dup,$p57,$i59.dup);
...
$bb25:
  ...
  $i68.dup := $or.i1($i36.dup,$or.i1(0,0));
...
$bb28:
  ...
  assume {:verifier.code 0} true;
  $i83 := $add.i32($i4,$i41);
  $i83.dup := $or.i1($i4.dup,$i41.dup);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 114, 12} true;
  assume {:verifier.code 0} true;
  call $i84, $i84.dup := constant_time_ge($i82, $i82.dup, $i83, $i83.dup);
...
$bb32:
  assert {:shadow_invariant} $shadow_ok;
  assert {:unlikely_shadow_invariant ($i93.dup == 0)} true;
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  call $i96, $i96.dup := constant_time_ge_8($i41, $i41.dup, $i94, $i94.dup);
  ...
  $p104.dup := $or.i1($p98.dup,$or.i1($i103.dup,0));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 27} true;
  assume {:verifier.code 0} true;
  $p104.dup := 0;
  $i105 := $load.i8($M.6,$p104);
  $i105.dup := $load.i1($M.6.dup,$p104);
  ...
  $i108.dup := $or.i1($i41.dup,$i107.dup);
  ...
  $i110.dup := $or.i1($i109.dup,$or.i1(0,0));
...
$bb34:
  ...
  $i123.dup := $or.i1($i122.dup,$i120.dup);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 146, 15} true;
  assume {:verifier.code 0} true;
  $p121.dup := 0;
  $M.13 := $store.i32($M.13,$p121,$i123);
  $M.13.dup := $store.i1($M.13.dup,$p121,$i123.dup);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 148, 12} true;
  assume {:verifier.code 0} true;
  call $i124, $i124.dup := constant_time_select_int($i114, $i114.dup, 1, 0, $sub.i32(0,1), $or.i1(0,0));
