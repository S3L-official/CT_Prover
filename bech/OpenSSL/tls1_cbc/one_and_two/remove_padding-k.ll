...
34:                                               ; preds = %33, %16
  ...
  br i1 %47, label %48, label %84, !dbg !130
...
48:                                               ; preds = %34
  ...
  br i1 %51, label %84, label %52, !dbg !133
...
55:                                               ; preds = %54, %52
  ...
  %60 = getelementptr inbounds [9 x i8], [9 x i8]* @.str, i64 0, i64 0
  %61 = call i32 @CRYPTO_memcmp(i8* %59, i8* %60, i64 8), !dbg !144
  %62 = icmp eq i32 %61, 0, !dbg !145
  br i1 %62, label %63, label %72, !dbg !146

63:                                               ; preds = %55
  %64 = and i32 %43, 1, !dbg !147
  %65 = icmp ne i32 %64, 0, !dbg !147
  br i1 %65, label %72, label %66, !dbg !148

66:                                               ; preds = %63
  %67 = getelementptr inbounds %struct.ssl_st, %struct.ssl_st* %0, i32 0, i32 2, !dbg !149
  %68 = load %struct.ssl3_state_st*, %struct.ssl3_state_st** %67, align 8, !dbg !149
  %69 = getelementptr inbounds %struct.ssl3_state_st, %struct.ssl3_state_st* %68, i32 0, i32 0, !dbg !151
  %70 = load i64, i64* %69, align 8, !dbg !152
  %71 = or i64 %70, 8, !dbg !152
  store i64 %71, i64* %69, align 8, !dbg !152
  br label %72, !dbg !153

72:                                               ; preds = %66, %63, %55
  %73 = getelementptr inbounds %struct.ssl_st, %struct.ssl_st* %0, i32 0, i32 2, !dbg !154
  %74 = load %struct.ssl3_state_st*, %struct.ssl3_state_st** %73, align 8, !dbg !154
  %75 = getelementptr inbounds %struct.ssl3_state_st, %struct.ssl3_state_st* %74, i32 0, i32 0, !dbg !156
  %76 = load i64, i64* %75, align 8, !dbg !156
  %77 = and i64 %76, 8, !dbg !157
  %78 = icmp ne i64 %77, 0, !dbg !157
  br i1 %78, label %79, label %83, !dbg !158

79:                                               ; preds = %72
  %80 = icmp ugt i32 %43, 0, !dbg !159
  br i1 %80, label %81, label %83, !dbg !160

81:                                               ; preds = %79
  %82 = add i32 %43, -1, !dbg !161
  call void @llvm.dbg.value(metadata i32 %82, metadata !126, metadata !DIExpression()), !dbg !93
  br label %83, !dbg !163

83:                                               ; preds = %81, %79, %72
  %.04 = phi i32 [ %82, %81 ], [ %43, %79 ], [ %43, %72 ], !dbg !93
  call void @llvm.dbg.value(metadata i32 %.04, metadata !126, metadata !DIExpression()), !dbg !93
  br label %84, !dbg !164

84:                                               ; preds = %83, %48, %34
  %.1 = phi i32 [ %43, %48 ], [ %.04, %83 ], [ %43, %34 ], !dbg !93
  call void @llvm.dbg.value(metadata i32 %.1, metadata !126, metadata !DIExpression()), !dbg !93
  %85 = getelementptr inbounds %struct.ssl_st, %struct.ssl_st* %0, i32 0, i32 3, !dbg !165
  %86 = load %struct.evp_cipher_ctx_st*, %struct.evp_cipher_ctx_st** %85, align 8, !dbg !165
  %87 = getelementptr inbounds %struct.evp_cipher_ctx_st, %struct.evp_cipher_ctx_st* %86, i32 0, i32 0, !dbg !165
  %88 = load %struct.evp_cipher_st*, %struct.evp_cipher_st** %87, align 8, !dbg !165
  %89 = getelementptr inbounds %struct.evp_cipher_st, %struct.evp_cipher_st* %88, i32 0, i32 0, !dbg !165
  %90 = load i64, i64* %89, align 8, !dbg !165
  %91 = and i64 %90, 2097152, !dbg !167
  %92 = icmp ne i64 %91, 0, !dbg !167
  br i1 %92, label %93, label %98, !dbg !168

93:                                               ; preds = %84
  %94 = add i32 %.1, 1, !dbg !169
  %95 = getelementptr inbounds %struct.ssl3_record_st, %struct.ssl3_record_st* %1, i32 0, i32 0, !dbg !171
  %96 = load i32, i32* %95, align 8, !dbg !172
  %97 = sub i32 %96, %94, !dbg !172
  store i32 %97, i32* %95, align 8, !dbg !172
  br label %146, !dbg !173

98:                                               ; preds = %84
  %99 = getelementptr inbounds %struct.ssl3_record_st, %struct.ssl3_record_st* %1, i32 0, i32 0, !dbg !174
  %100 = load i32, i32* %99, align 8, !dbg !174
  %101 = add i32 %5, %.1, !dbg !175
  %102 = call i32 @constant_time_ge(i32 %100, i32 %101), !dbg !176
  call void @llvm.dbg.value(metadata i32 %102, metadata !177, metadata !DIExpression()), !dbg !93
  call void @llvm.dbg.value(metadata i32 255, metadata !138, metadata !DIExpression()), !dbg !93
  %103 = getelementptr inbounds %struct.ssl3_record_st, %struct.ssl3_record_st* %1, i32 0, i32 0, !dbg !178
  %104 = load i32, i32* %103, align 8, !dbg !178
  %105 = sub i32 %104, 1, !dbg !180
  %106 = icmp ugt i32 255, %105, !dbg !181
  br i1 %106, label %107, label %111, !dbg !182

107:                                              ; preds = %98
  %108 = getelementptr inbounds %struct.ssl3_record_st, %struct.ssl3_record_st* %1, i32 0, i32 0, !dbg !183
  %109 = load i32, i32* %108, align 8, !dbg !183
  %110 = sub i32 %109, 1, !dbg !184
  call void @llvm.dbg.value(metadata i32 %110, metadata !138, metadata !DIExpression()), !dbg !93
  br label %111, !dbg !185

111:                                              ; preds = %107, %98
  %.02 = phi i32 [ %110, %107 ], [ 255, %98 ], !dbg !93
...
112:                                              ; preds = %131, %111
  %.03 = phi i32 [ %102, %111 ], [ %130, %131 ], !dbg !93
  %.01 = phi i32 [ 0, %111 ], [ %132, %131 ], !dbg !189
  ...
  %113 = icmp ult i32 %.01, %.02, !dbg !190
  br i1 %113, label %114, label %133, !dbg !192

114:                                              ; preds = %112
  %115 = call zeroext i8 @constant_time_ge_8(i32 %.1, i32 %.01), !dbg !193
  call void @llvm.dbg.value(metadata i8 %115, metadata !195, metadata !DIExpression()), !dbg !196
  %116 = getelementptr inbounds %struct.ssl3_record_st, %struct.ssl3_record_st* %1, i32 0, i32 1, !dbg !197
  %117 = load i8*, i8** %116, align 8, !dbg !197
  %118 = getelementptr inbounds %struct.ssl3_record_st, %struct.ssl3_record_st* %1, i32 0, i32 0, !dbg !198
  %119 = load i32, i32* %118, align 8, !dbg !198
  %120 = sub i32 %119, 1, !dbg !199
  %121 = sub i32 %120, %.01, !dbg !200
  %122 = zext i32 %121 to i64, !dbg !201
  %123 = getelementptr inbounds i8, i8* %117, i64 %122, !dbg !201
  %124 = load i8, i8* %123, align 1, !dbg !201
  call void @llvm.dbg.value(metadata i8 %124, metadata !202, metadata !DIExpression()), !dbg !196
  %125 = zext i8 %115 to i32, !dbg !203
  %126 = zext i8 %124 to i32, !dbg !204
  %127 = xor i32 %.1, %126, !dbg !205
  %128 = and i32 %125, %127, !dbg !206
  %129 = xor i32 %128, -1, !dbg !207
  %130 = and i32 %.03, %129, !dbg !208
  call void @llvm.dbg.value(metadata i32 %130, metadata !177, metadata !DIExpression()), !dbg !93
  br label %131, !dbg !209

131:                                              ; preds = %114
  %132 = add i32 %.01, 1, !dbg !210
  call void @llvm.dbg.value(metadata i32 %132, metadata !186, metadata !DIExpression()), !dbg !93
  br label %112, !dbg !211, !llvm.loop !212

133:                                              ; preds = %112
  %134 = and i32 %.03, 255, !dbg !214
  %135 = call i32 @constant_time_eq(i32 255, i32 %134), !dbg !215
  call void @llvm.dbg.value(metadata i32 %135, metadata !177, metadata !DIExpression()), !dbg !93
  %136 = add i32 %.1, 1, !dbg !216
  %137 = and i32 %135, %136, !dbg !217
  call void @llvm.dbg.value(metadata i32 %137, metadata !126, metadata !DIExpression()), !dbg !93
  %138 = getelementptr inbounds %struct.ssl3_record_st, %struct.ssl3_record_st* %1, i32 0, i32 0, !dbg !218
  %139 = load i32, i32* %138, align 8, !dbg !219
  %140 = sub i32 %139, %137, !dbg !219
  store i32 %140, i32* %138, align 8, !dbg !219
  %141 = shl i32 %137, 8, !dbg !220
  %142 = getelementptr inbounds %struct.ssl3_record_st, %struct.ssl3_record_st* %1, i32 0, i32 2, !dbg !221
  %143 = load i32, i32* %142, align 8, !dbg !222
  %144 = or i32 %143, %141, !dbg !222
  store i32 %144, i32* %142, align 8, !dbg !222
  %145 = call i32 @constant_time_select_int(i32 %135, i32 1, i32 -1), !dbg !223
  br label %146, !dbg !224

146:                                              ; preds = %133, %93, %32, %15
  %.0 = phi i32 [ 0, %15 ], [ 1, %93 ], [ %145, %133 ], [ 0, %32 ], !dbg !93
  ret i32 %.0, !dbg !225
}
