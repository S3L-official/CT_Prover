...
modifies $M.4, $M.4.shadow, $M.5, $M.5.shadow, $M.3, $M.3.shadow, $exn, $exn.shadow, $shadow_ok, $M.0, $M.0.shadow, $M.13, $M.13.shadow;
{
  var $i4: i32;
  var $i4.shadow: i32;
  var $p5: ref;
...
$bb11:
  ...
  assume {:verifier.code 0} true;
  $p69 := $add.ref($add.ref($p0,$mul.ref(0,40)),$mul.ref(24,1));
  $p69.shadow := $add.ref($add.ref($p0.shadow,$mul.ref(0,40)),$mul.ref(24,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 9} true;
  assume {:verifier.code 0} true;
  $p69 := $p69.shadow;
  ...
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 9} true;
  assume {:verifier.code 0} true;
  $p71 := $add.ref($add.ref($p70,$mul.ref(0,8)),$mul.ref(0,1));
  $p71.shadow := $p71;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 109, 9} true;
  assume {:verifier.code 0} true;
  $p71 := $p71.shadow;
...
$bb16:
  ...
  $p49.shadow := $p49;
  assume {:verifier.code 0} true;
  $p50 := $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(0,1));
  $p50.shadow := $p50;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 101, 14} true;
  assume {:verifier.code 0} true;
  call $i51, $i51.shadow := CRYPTO_memcmp($p49, $p49.shadow, $p50, $p50.shadow, 8, 8);
...
$bb17:
  ...
  assume {:verifier.code 0} true;
  $i53 := $and.i32($i36,1);
  $i53.shadow := $and.i32($i36.shadow,1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 102, 30} true;
  assume {:verifier.code 0} true;
  $i54 := $ne.i32($i53,0);
  $i54.shadow := $ne.i32($i53.shadow,0);
...
$bb19:
  ...
  assume {:verifier.code 0} true;
  $p60 := $add.ref($add.ref($p0,$mul.ref(0,40)),$mul.ref(16,1));
  $p60.shadow := $p60;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 105, 17} true;
  assume {:verifier.code 0} true;
  $p60 := $p60.shadow;
  $p61 := $load.ref($M.9,$p60);
  $p61.shadow := $p61;
...
$bb21:
  ...
  assume {:verifier.code 0} true;
  $p55 := $add.ref($add.ref($p0,$mul.ref(0,40)),$mul.ref(16,1));
  $p55.shadow := $p55;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 103, 16} true;
  assume {:verifier.code 0} true;
  $p55 := $p55.shadow;
  $p56 := $load.ref($M.9,$p55);
  $p56.shadow := $p56;
  ...
  assume {:verifier.code 0} true;
  $p57 := $p57.shadow;
  $M.0 := $store.i64($M.0,$p57,$i59);
  $M.0.shadow := $store.i64($M.0.shadow,$p57.shadow,$i59.shadow);
...
$bb22:
  ...
  assume {:verifier.code 0} true;
  $i67 := $ugt.i32($i36,0);
  $i67.shadow := $ugt.i32($i36.shadow,0);
...
$bb24:
  ...
  assume {:verifier.code 0} true;
  $i41 := $i66;
  $i41.shadow := $i66.shadow;
  goto $bb11;
$bb25:
  assume ($i67 == 1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 106, 27} true;
  assume {:verifier.code 0} true;
  $i68 := $add.i32($i36,$sub.i32(0,1));
  $i68.shadow := $add.i32($i36.shadow,$sub.i32(0,1));
  call {:cexpr "padding_length"} boogie_si_record_i32($i68);
...
$bb27:
  ...
  assume {:verifier.code 0} true;
  $i77 := $add.i32($i41,1);
  $i77.shadow := $add.i32($i41.shadow,1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 111, 14} true;
  assume {:verifier.code 0} true;
  $p78 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p78.shadow := $p78;
  ...
  assume {:verifier.code 0} true;
  $i80 := $sub.i32($i79,$i77);
  $i80.shadow := $sub.i32($i79.shadow,$i77.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 111, 21} true;
  assume {:verifier.code 0} true;
  $p78 := $p78.shadow;
...
$bb28:
  ...
  assume {:verifier.code 0} true;
  $p81 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p81.shadow := $p81;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 114, 34} true;
  assume {:verifier.code 0} true;
  $p81 := $p81.shadow;
  ...
  assume {:verifier.code 0} true;
  $i83 := $add.i32($i4,$i41);
  $i83.shadow := $add.i32($i4.shadow,$i41.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 114, 12} true;
  assume {:verifier.code 0} true;
  call $i84, $i84.shadow := constant_time_ge($i82, $i82.shadow, $i83, $i83.shadow);
  call {:cexpr "good"} boogie_si_record_i32($i84);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 125, 25} true;
  assume {:verifier.code 0} true;
  $p85 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p85.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 125, 25} true;
  assume {:verifier.code 0} true;
  $p85 := $p85.shadow;
...
$bb29:
  ...
  $i92 := $sub.i32($i91,1);
  $i92.shadow := $i92;
  call {:cexpr "to_check"} boogie_si_record_i32($i92);
...
$bb32:
  assert {:shadow_invariant} $shadow_ok;
  assert {:unlikely_shadow_invariant ($i93 == $i93.shadow)} true;
  ...
  assume {:verifier.code 0} true;
  $i95 := $ult.i32($i94,$i89);
  $i95.shadow := $ult.i32($i94.shadow,$i89.shadow);
...
$bb33:
  ...
  assume {:verifier.code 0} true;
  call $i96, $i96.shadow := constant_time_ge_8($i41, $i41.shadow, $i94, $i94.shadow);
  call {:cexpr "mask"} boogie_si_record_i8($i96);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 32} true;
  assume {:verifier.code 0} true;
  $p97 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(8,1));
  $p97.shadow := $add.ref($add.ref($p1.shadow,$mul.ref(0,32)),$mul.ref(8,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 32} true;
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p97 := $p97.shadow;
  $p98 := $load.ref($M.4,$p97);
  $p98.shadow := $p98;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 42} true;
  assume {:verifier.code 0} true;
  $p99 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(0,1));
  $p99.shadow := $p99;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 42} true;
  assume {:verifier.code 0} true;
  $p99 := $p99.shadow;
  ...
  assume {:verifier.code 0} true;
  assume {:PointTainted} true;
  $p104 := $add.ref($p98,$mul.ref($i103,1));
  $p104.shadow := $p104;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 131, 27} true;
  assume {:verifier.code 0} true;
  $p104 := $p104.shadow;
  $i105 := $load.i8($M.6,$p104);
  $i105.shadow := $load.i8($M.6.shadow,$p104.shadow);
  call {:cexpr "b"} boogie_si_record_i8($i105);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 136, 19} true;
  assume {:verifier.code 0} true;
  $i106 := $zext.i8.i32($i96);
  $i106.shadow := $zext.i8.i32($i96.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 136, 44} true;
  assume {:verifier.code 0} true;
  $i107 := $zext.i8.i32($i105);
  $i107.shadow := $zext.i8.i32($i105.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 136, 42} true;
  assume {:verifier.code 0} true;
  $i108 := $xor.i32($i41,$i107);
  $i108.shadow := $xor.i32($i41.shadow,$i107.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 136, 24} true;
  assume {:verifier.code 0} true;
  $i109 := $and.i32($i106,$i108);
  $i109.shadow := $and.i32($i106.shadow,$i108.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 136, 17} true;
  assume {:verifier.code 0} true;
  $i110 := $xor.i32($i109,$sub.i32(0,1));
  $i110.shadow := $xor.i32($i109.shadow,$sub.i32(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 136, 14} true;
  assume {:verifier.code 0} true;
  $i111 := $and.i32($i93,$i110);
  $i111.shadow := $and.i32($i93.shadow,$i110.shadow);
  call {:cexpr "good"} boogie_si_record_i32($i111);
...
$bb34:
  ...
  assume {:verifier.code 0} true;
  $i113 := $and.i32($i93,255);
  $i113.shadow := $and.i32($i93.shadow,255);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 143, 12} true;
  assume {:verifier.code 0} true;
  call $i114, $i114.shadow := constant_time_eq(255, 255, $i113, $i113.shadow);
  call {:cexpr "good"} boogie_si_record_i32($i114);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 144, 45} true;
  assume {:verifier.code 0} true;
  $i115 := $add.i32($i41,1);
  $i115.shadow := $add.i32($i41.shadow,1);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 144, 27} true;
  assume {:verifier.code 0} true;
  $i116 := $and.i32($i114,$i115);
  $i116.shadow := $and.i32($i114.shadow,$i115.shadow);
  call {:cexpr "padding_length"} boogie_si_record_i32($i116);
  ...
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 145, 17} true;
  assume {:verifier.code 0} true;
  $i119 := $sub.i32($i118,$i116);
  $i119.shadow := $sub.i32($i118.shadow,$i116.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 145, 17} true;
  assume {:verifier.code 0} true;
  $p117 := $p117.shadow;
  $M.3 := $store.i32($M.3,$p117,$i119);
  $M.3.shadow := $store.i32($M.3.shadow,$p117.shadow,$i119.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 146, 33} true;
  assume {:verifier.code 0} true;
  $i120 := $shl.i32($i116,8);
  $i120.shadow := $shl.i32($i116.shadow,8);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 146, 10} true;
  assume {:verifier.code 0} true;
  $p121 := $add.ref($add.ref($p1,$mul.ref(0,32)),$mul.ref(16,1));
  $p121.shadow := $p121;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 146, 15} true;
  assume {:verifier.code 0} true;
  $p121 := $p121.shadow;
  $i122 := $load.i32($M.13,$p121);
  $i122.shadow := $i122;
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 146, 15} true;
  assume {:verifier.code 0} true;
  $i123 := $or.i32($i122,$i120);
  $i123.shadow := $or.i32($i122.shadow,$i120.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 146, 15} true;
  assume {:verifier.code 0} true;
  $p121 := $p121.shadow;
  $M.13 := $store.i32($M.13,$p121,$i123);
  $M.13.shadow := $store.i32($M.13.shadow,$p121.shadow,$i123.shadow);
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 148, 12} true;
  assume {:verifier.code 0} true;
  call $i124, $i124.shadow := constant_time_select_int($i114, $i114.shadow, 1, 1, $sub.i32(0,1), $sub.i32(0,1));
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 148, 5} true;
  assume {:verifier.code 0} true;
  $i13 := $i124;
  $i13.shadow := $i124.shadow;
  goto $bb5;
$bb35:
...
modifies $shadow_ok, $M.0, $M.0.shadow, $M.12, $M.12.shadow, $M.11, $M.11.shadow, $M.8, $M.8.shadow, $M.7, $M.7.shadow, $M.9, $M.9.shadow, $M.10, $M.10.shadow, $M.2, $M.2.shadow, $M.3, $M.3.shadow, $M.4, $M.4.shadow, $M.13, $M.13.shadow, $M.5, $M.5.shadow, $exn, $exn.shadow;
...
requires (.str == .str);
requires ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(1,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(1,1)));
requires ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(2,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(2,1)));
requires ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(3,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(3,1)));
requires ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(4,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(4,1)));
requires ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(5,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(5,1)));
requires ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(6,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(6,1)));
requires ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(7,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(7,1)));
requires ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(8,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(8,1)));
