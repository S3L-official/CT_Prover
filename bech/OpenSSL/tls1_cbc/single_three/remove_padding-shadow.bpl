...
$bb16:
  ...
  $shadow_ok := ($shadow_ok && ($i51 == $i51.shadow));
  goto $bb17, $bb18;
$bb17:
  assume ($i51 == 1);
...
$bb19:
  ...
  $shadow_ok := ($shadow_ok && ($i64 == $i64.shadow));
  goto $bb22, $bb23;
$bb20:
  assume {:sourceloc "./../tls1_cbc_remove_padding.c", 101, 13} true;
  assume {:verifier.code 0} true;
...
$bb28:
  ...
  $shadow_ok := ($shadow_ok && ($i87 == $i87.shadow));
  goto $bb29, $bb30;
$bb29:
  assume ($i87 == 1);
...
$bb32:
  ...
  $shadow_ok := ($shadow_ok && ($i94 == $i94.shadow));
  goto $bb33, $bb34;
$bb33:
  assume ($i94 == 1);
...
{
$bb0:
  $shadow_ok := ($shadow_ok && (.str == .str));
  $M.1 := $store.i8($M.1,.str,0);
  $M.1.shadow := $store.i8($M.1.shadow,.str,0);
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(1,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(1,1))));
  ...
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(2,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(2,1))));
  ...
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(3,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(3,1))));
  ...
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(4,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(4,1))));
  ...
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(5,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(5,1))));
  ...
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(6,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(6,1))));
  ...
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(7,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(7,1))));
  ...
  $shadow_ok := ($shadow_ok && ($add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(8,1)) == $add.ref($add.ref(.str,$mul.ref(0,9)),$mul.ref(8,1))));
