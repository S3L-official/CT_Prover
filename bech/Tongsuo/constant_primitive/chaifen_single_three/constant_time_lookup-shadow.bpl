...
const constant_time_lookup_wrapper: ref;
axiom (constant_time_lookup_wrapper == $sub.ref(0,1032));
procedure {:entrypoint} constant_time_lookup_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64, $i3: i64, $i3.shadow: i64, $i4: i64, $i4.shadow: i64)
...
requires {:public_in $load.i8, $M.2, $p1, 1, 256} true;
modifies $exn;
modifies $M.1;
modifies $CurrAddr;
...
requires ($load.i8($M.2,($p1 + 0)) == $load.i8($M.2.shadow,($p1.shadow + 0)));
requires ($load.i8($M.2,($p1 + 1)) == $load.i8($M.2.shadow,($p1.shadow + 1)));
requires ($load.i8($M.2,($p1 + 2)) == $load.i8($M.2.shadow,($p1.shadow + 2)));
requires ($load.i8($M.2,($p1 + 3)) == $load.i8($M.2.shadow,($p1.shadow + 3)));
requires ($load.i8($M.2,($p1 + 4)) == $load.i8($M.2.shadow,($p1.shadow + 4)));
requires ($load.i8($M.2,($p1 + 5)) == $load.i8($M.2.shadow,($p1.shadow + 5)));
requires ($load.i8($M.2,($p1 + 6)) == $load.i8($M.2.shadow,($p1.shadow + 6)));
requires ($load.i8($M.2,($p1 + 7)) == $load.i8($M.2.shadow,($p1.shadow + 7)));
requires ($load.i8($M.2,($p1 + 8)) == $load.i8($M.2.shadow,($p1.shadow + 8)));
requires ($load.i8($M.2,($p1 + 9)) == $load.i8($M.2.shadow,($p1.shadow + 9)));
requires ($load.i8($M.2,($p1 + 10)) == $load.i8($M.2.shadow,($p1.shadow + 10)));
requires ($load.i8($M.2,($p1 + 11)) == $load.i8($M.2.shadow,($p1.shadow + 11)));
requires ($load.i8($M.2,($p1 + 12)) == $load.i8($M.2.shadow,($p1.shadow + 12)));
requires ($load.i8($M.2,($p1 + 13)) == $load.i8($M.2.shadow,($p1.shadow + 13)));
requires ($load.i8($M.2,($p1 + 14)) == $load.i8($M.2.shadow,($p1.shadow + 14)));
requires ($load.i8($M.2,($p1 + 15)) == $load.i8($M.2.shadow,($p1.shadow + 15)));
requires ($load.i8($M.2,($p1 + 16)) == $load.i8($M.2.shadow,($p1.shadow + 16)));
requires ($load.i8($M.2,($p1 + 17)) == $load.i8($M.2.shadow,($p1.shadow + 17)));
requires ($load.i8($M.2,($p1 + 18)) == $load.i8($M.2.shadow,($p1.shadow + 18)));
requires ($load.i8($M.2,($p1 + 19)) == $load.i8($M.2.shadow,($p1.shadow + 19)));
requires ($load.i8($M.2,($p1 + 20)) == $load.i8($M.2.shadow,($p1.shadow + 20)));
requires ($load.i8($M.2,($p1 + 21)) == $load.i8($M.2.shadow,($p1.shadow + 21)));
requires ($load.i8($M.2,($p1 + 22)) == $load.i8($M.2.shadow,($p1.shadow + 22)));
requires ($load.i8($M.2,($p1 + 23)) == $load.i8($M.2.shadow,($p1.shadow + 23)));
requires ($load.i8($M.2,($p1 + 24)) == $load.i8($M.2.shadow,($p1.shadow + 24)));
requires ($load.i8($M.2,($p1 + 25)) == $load.i8($M.2.shadow,($p1.shadow + 25)));
requires ($load.i8($M.2,($p1 + 26)) == $load.i8($M.2.shadow,($p1.shadow + 26)));
requires ($load.i8($M.2,($p1 + 27)) == $load.i8($M.2.shadow,($p1.shadow + 27)));
requires ($load.i8($M.2,($p1 + 28)) == $load.i8($M.2.shadow,($p1.shadow + 28)));
requires ($load.i8($M.2,($p1 + 29)) == $load.i8($M.2.shadow,($p1.shadow + 29)));
requires ($load.i8($M.2,($p1 + 30)) == $load.i8($M.2.shadow,($p1.shadow + 30)));
requires ($load.i8($M.2,($p1 + 31)) == $load.i8($M.2.shadow,($p1.shadow + 31)));
requires ($load.i8($M.2,($p1 + 32)) == $load.i8($M.2.shadow,($p1.shadow + 32)));
requires ($load.i8($M.2,($p1 + 33)) == $load.i8($M.2.shadow,($p1.shadow + 33)));
requires ($load.i8($M.2,($p1 + 34)) == $load.i8($M.2.shadow,($p1.shadow + 34)));
requires ($load.i8($M.2,($p1 + 35)) == $load.i8($M.2.shadow,($p1.shadow + 35)));
requires ($load.i8($M.2,($p1 + 36)) == $load.i8($M.2.shadow,($p1.shadow + 36)));
requires ($load.i8($M.2,($p1 + 37)) == $load.i8($M.2.shadow,($p1.shadow + 37)));
requires ($load.i8($M.2,($p1 + 38)) == $load.i8($M.2.shadow,($p1.shadow + 38)));
requires ($load.i8($M.2,($p1 + 39)) == $load.i8($M.2.shadow,($p1.shadow + 39)));
requires ($load.i8($M.2,($p1 + 40)) == $load.i8($M.2.shadow,($p1.shadow + 40)));
requires ($load.i8($M.2,($p1 + 41)) == $load.i8($M.2.shadow,($p1.shadow + 41)));
requires ($load.i8($M.2,($p1 + 42)) == $load.i8($M.2.shadow,($p1.shadow + 42)));
requires ($load.i8($M.2,($p1 + 43)) == $load.i8($M.2.shadow,($p1.shadow + 43)));
requires ($load.i8($M.2,($p1 + 44)) == $load.i8($M.2.shadow,($p1.shadow + 44)));
requires ($load.i8($M.2,($p1 + 45)) == $load.i8($M.2.shadow,($p1.shadow + 45)));
requires ($load.i8($M.2,($p1 + 46)) == $load.i8($M.2.shadow,($p1.shadow + 46)));
requires ($load.i8($M.2,($p1 + 47)) == $load.i8($M.2.shadow,($p1.shadow + 47)));
requires ($load.i8($M.2,($p1 + 48)) == $load.i8($M.2.shadow,($p1.shadow + 48)));
requires ($load.i8($M.2,($p1 + 49)) == $load.i8($M.2.shadow,($p1.shadow + 49)));
requires ($load.i8($M.2,($p1 + 50)) == $load.i8($M.2.shadow,($p1.shadow + 50)));
requires ($load.i8($M.2,($p1 + 51)) == $load.i8($M.2.shadow,($p1.shadow + 51)));
requires ($load.i8($M.2,($p1 + 52)) == $load.i8($M.2.shadow,($p1.shadow + 52)));
requires ($load.i8($M.2,($p1 + 53)) == $load.i8($M.2.shadow,($p1.shadow + 53)));
requires ($load.i8($M.2,($p1 + 54)) == $load.i8($M.2.shadow,($p1.shadow + 54)));
requires ($load.i8($M.2,($p1 + 55)) == $load.i8($M.2.shadow,($p1.shadow + 55)));
requires ($load.i8($M.2,($p1 + 56)) == $load.i8($M.2.shadow,($p1.shadow + 56)));
requires ($load.i8($M.2,($p1 + 57)) == $load.i8($M.2.shadow,($p1.shadow + 57)));
requires ($load.i8($M.2,($p1 + 58)) == $load.i8($M.2.shadow,($p1.shadow + 58)));
requires ($load.i8($M.2,($p1 + 59)) == $load.i8($M.2.shadow,($p1.shadow + 59)));
requires ($load.i8($M.2,($p1 + 60)) == $load.i8($M.2.shadow,($p1.shadow + 60)));
requires ($load.i8($M.2,($p1 + 61)) == $load.i8($M.2.shadow,($p1.shadow + 61)));
requires ($load.i8($M.2,($p1 + 62)) == $load.i8($M.2.shadow,($p1.shadow + 62)));
requires ($load.i8($M.2,($p1 + 63)) == $load.i8($M.2.shadow,($p1.shadow + 63)));
requires ($load.i8($M.2,($p1 + 64)) == $load.i8($M.2.shadow,($p1.shadow + 64)));
requires ($load.i8($M.2,($p1 + 65)) == $load.i8($M.2.shadow,($p1.shadow + 65)));
requires ($load.i8($M.2,($p1 + 66)) == $load.i8($M.2.shadow,($p1.shadow + 66)));
requires ($load.i8($M.2,($p1 + 67)) == $load.i8($M.2.shadow,($p1.shadow + 67)));
requires ($load.i8($M.2,($p1 + 68)) == $load.i8($M.2.shadow,($p1.shadow + 68)));
requires ($load.i8($M.2,($p1 + 69)) == $load.i8($M.2.shadow,($p1.shadow + 69)));
requires ($load.i8($M.2,($p1 + 70)) == $load.i8($M.2.shadow,($p1.shadow + 70)));
requires ($load.i8($M.2,($p1 + 71)) == $load.i8($M.2.shadow,($p1.shadow + 71)));
requires ($load.i8($M.2,($p1 + 72)) == $load.i8($M.2.shadow,($p1.shadow + 72)));
requires ($load.i8($M.2,($p1 + 73)) == $load.i8($M.2.shadow,($p1.shadow + 73)));
requires ($load.i8($M.2,($p1 + 74)) == $load.i8($M.2.shadow,($p1.shadow + 74)));
requires ($load.i8($M.2,($p1 + 75)) == $load.i8($M.2.shadow,($p1.shadow + 75)));
requires ($load.i8($M.2,($p1 + 76)) == $load.i8($M.2.shadow,($p1.shadow + 76)));
requires ($load.i8($M.2,($p1 + 77)) == $load.i8($M.2.shadow,($p1.shadow + 77)));
requires ($load.i8($M.2,($p1 + 78)) == $load.i8($M.2.shadow,($p1.shadow + 78)));
requires ($load.i8($M.2,($p1 + 79)) == $load.i8($M.2.shadow,($p1.shadow + 79)));
requires ($load.i8($M.2,($p1 + 80)) == $load.i8($M.2.shadow,($p1.shadow + 80)));
requires ($load.i8($M.2,($p1 + 81)) == $load.i8($M.2.shadow,($p1.shadow + 81)));
requires ($load.i8($M.2,($p1 + 82)) == $load.i8($M.2.shadow,($p1.shadow + 82)));
requires ($load.i8($M.2,($p1 + 83)) == $load.i8($M.2.shadow,($p1.shadow + 83)));
requires ($load.i8($M.2,($p1 + 84)) == $load.i8($M.2.shadow,($p1.shadow + 84)));
requires ($load.i8($M.2,($p1 + 85)) == $load.i8($M.2.shadow,($p1.shadow + 85)));
requires ($load.i8($M.2,($p1 + 86)) == $load.i8($M.2.shadow,($p1.shadow + 86)));
requires ($load.i8($M.2,($p1 + 87)) == $load.i8($M.2.shadow,($p1.shadow + 87)));
requires ($load.i8($M.2,($p1 + 88)) == $load.i8($M.2.shadow,($p1.shadow + 88)));
requires ($load.i8($M.2,($p1 + 89)) == $load.i8($M.2.shadow,($p1.shadow + 89)));
requires ($load.i8($M.2,($p1 + 90)) == $load.i8($M.2.shadow,($p1.shadow + 90)));
requires ($load.i8($M.2,($p1 + 91)) == $load.i8($M.2.shadow,($p1.shadow + 91)));
requires ($load.i8($M.2,($p1 + 92)) == $load.i8($M.2.shadow,($p1.shadow + 92)));
requires ($load.i8($M.2,($p1 + 93)) == $load.i8($M.2.shadow,($p1.shadow + 93)));
requires ($load.i8($M.2,($p1 + 94)) == $load.i8($M.2.shadow,($p1.shadow + 94)));
requires ($load.i8($M.2,($p1 + 95)) == $load.i8($M.2.shadow,($p1.shadow + 95)));
requires ($load.i8($M.2,($p1 + 96)) == $load.i8($M.2.shadow,($p1.shadow + 96)));
requires ($load.i8($M.2,($p1 + 97)) == $load.i8($M.2.shadow,($p1.shadow + 97)));
requires ($load.i8($M.2,($p1 + 98)) == $load.i8($M.2.shadow,($p1.shadow + 98)));
requires ($load.i8($M.2,($p1 + 99)) == $load.i8($M.2.shadow,($p1.shadow + 99)));
requires ($load.i8($M.2,($p1 + 100)) == $load.i8($M.2.shadow,($p1.shadow + 100)));
requires ($load.i8($M.2,($p1 + 101)) == $load.i8($M.2.shadow,($p1.shadow + 101)));
requires ($load.i8($M.2,($p1 + 102)) == $load.i8($M.2.shadow,($p1.shadow + 102)));
requires ($load.i8($M.2,($p1 + 103)) == $load.i8($M.2.shadow,($p1.shadow + 103)));
requires ($load.i8($M.2,($p1 + 104)) == $load.i8($M.2.shadow,($p1.shadow + 104)));
requires ($load.i8($M.2,($p1 + 105)) == $load.i8($M.2.shadow,($p1.shadow + 105)));
requires ($load.i8($M.2,($p1 + 106)) == $load.i8($M.2.shadow,($p1.shadow + 106)));
requires ($load.i8($M.2,($p1 + 107)) == $load.i8($M.2.shadow,($p1.shadow + 107)));
requires ($load.i8($M.2,($p1 + 108)) == $load.i8($M.2.shadow,($p1.shadow + 108)));
requires ($load.i8($M.2,($p1 + 109)) == $load.i8($M.2.shadow,($p1.shadow + 109)));
requires ($load.i8($M.2,($p1 + 110)) == $load.i8($M.2.shadow,($p1.shadow + 110)));
requires ($load.i8($M.2,($p1 + 111)) == $load.i8($M.2.shadow,($p1.shadow + 111)));
requires ($load.i8($M.2,($p1 + 112)) == $load.i8($M.2.shadow,($p1.shadow + 112)));
requires ($load.i8($M.2,($p1 + 113)) == $load.i8($M.2.shadow,($p1.shadow + 113)));
requires ($load.i8($M.2,($p1 + 114)) == $load.i8($M.2.shadow,($p1.shadow + 114)));
requires ($load.i8($M.2,($p1 + 115)) == $load.i8($M.2.shadow,($p1.shadow + 115)));
requires ($load.i8($M.2,($p1 + 116)) == $load.i8($M.2.shadow,($p1.shadow + 116)));
requires ($load.i8($M.2,($p1 + 117)) == $load.i8($M.2.shadow,($p1.shadow + 117)));
requires ($load.i8($M.2,($p1 + 118)) == $load.i8($M.2.shadow,($p1.shadow + 118)));
requires ($load.i8($M.2,($p1 + 119)) == $load.i8($M.2.shadow,($p1.shadow + 119)));
requires ($load.i8($M.2,($p1 + 120)) == $load.i8($M.2.shadow,($p1.shadow + 120)));
requires ($load.i8($M.2,($p1 + 121)) == $load.i8($M.2.shadow,($p1.shadow + 121)));
requires ($load.i8($M.2,($p1 + 122)) == $load.i8($M.2.shadow,($p1.shadow + 122)));
requires ($load.i8($M.2,($p1 + 123)) == $load.i8($M.2.shadow,($p1.shadow + 123)));
requires ($load.i8($M.2,($p1 + 124)) == $load.i8($M.2.shadow,($p1.shadow + 124)));
requires ($load.i8($M.2,($p1 + 125)) == $load.i8($M.2.shadow,($p1.shadow + 125)));
requires ($load.i8($M.2,($p1 + 126)) == $load.i8($M.2.shadow,($p1.shadow + 126)));
requires ($load.i8($M.2,($p1 + 127)) == $load.i8($M.2.shadow,($p1.shadow + 127)));
requires ($load.i8($M.2,($p1 + 128)) == $load.i8($M.2.shadow,($p1.shadow + 128)));
requires ($load.i8($M.2,($p1 + 129)) == $load.i8($M.2.shadow,($p1.shadow + 129)));
requires ($load.i8($M.2,($p1 + 130)) == $load.i8($M.2.shadow,($p1.shadow + 130)));
requires ($load.i8($M.2,($p1 + 131)) == $load.i8($M.2.shadow,($p1.shadow + 131)));
requires ($load.i8($M.2,($p1 + 132)) == $load.i8($M.2.shadow,($p1.shadow + 132)));
requires ($load.i8($M.2,($p1 + 133)) == $load.i8($M.2.shadow,($p1.shadow + 133)));
requires ($load.i8($M.2,($p1 + 134)) == $load.i8($M.2.shadow,($p1.shadow + 134)));
requires ($load.i8($M.2,($p1 + 135)) == $load.i8($M.2.shadow,($p1.shadow + 135)));
requires ($load.i8($M.2,($p1 + 136)) == $load.i8($M.2.shadow,($p1.shadow + 136)));
requires ($load.i8($M.2,($p1 + 137)) == $load.i8($M.2.shadow,($p1.shadow + 137)));
requires ($load.i8($M.2,($p1 + 138)) == $load.i8($M.2.shadow,($p1.shadow + 138)));
requires ($load.i8($M.2,($p1 + 139)) == $load.i8($M.2.shadow,($p1.shadow + 139)));
requires ($load.i8($M.2,($p1 + 140)) == $load.i8($M.2.shadow,($p1.shadow + 140)));
requires ($load.i8($M.2,($p1 + 141)) == $load.i8($M.2.shadow,($p1.shadow + 141)));
requires ($load.i8($M.2,($p1 + 142)) == $load.i8($M.2.shadow,($p1.shadow + 142)));
requires ($load.i8($M.2,($p1 + 143)) == $load.i8($M.2.shadow,($p1.shadow + 143)));
requires ($load.i8($M.2,($p1 + 144)) == $load.i8($M.2.shadow,($p1.shadow + 144)));
requires ($load.i8($M.2,($p1 + 145)) == $load.i8($M.2.shadow,($p1.shadow + 145)));
requires ($load.i8($M.2,($p1 + 146)) == $load.i8($M.2.shadow,($p1.shadow + 146)));
requires ($load.i8($M.2,($p1 + 147)) == $load.i8($M.2.shadow,($p1.shadow + 147)));
requires ($load.i8($M.2,($p1 + 148)) == $load.i8($M.2.shadow,($p1.shadow + 148)));
requires ($load.i8($M.2,($p1 + 149)) == $load.i8($M.2.shadow,($p1.shadow + 149)));
requires ($load.i8($M.2,($p1 + 150)) == $load.i8($M.2.shadow,($p1.shadow + 150)));
requires ($load.i8($M.2,($p1 + 151)) == $load.i8($M.2.shadow,($p1.shadow + 151)));
requires ($load.i8($M.2,($p1 + 152)) == $load.i8($M.2.shadow,($p1.shadow + 152)));
requires ($load.i8($M.2,($p1 + 153)) == $load.i8($M.2.shadow,($p1.shadow + 153)));
requires ($load.i8($M.2,($p1 + 154)) == $load.i8($M.2.shadow,($p1.shadow + 154)));
requires ($load.i8($M.2,($p1 + 155)) == $load.i8($M.2.shadow,($p1.shadow + 155)));
requires ($load.i8($M.2,($p1 + 156)) == $load.i8($M.2.shadow,($p1.shadow + 156)));
requires ($load.i8($M.2,($p1 + 157)) == $load.i8($M.2.shadow,($p1.shadow + 157)));
requires ($load.i8($M.2,($p1 + 158)) == $load.i8($M.2.shadow,($p1.shadow + 158)));
requires ($load.i8($M.2,($p1 + 159)) == $load.i8($M.2.shadow,($p1.shadow + 159)));
requires ($load.i8($M.2,($p1 + 160)) == $load.i8($M.2.shadow,($p1.shadow + 160)));
requires ($load.i8($M.2,($p1 + 161)) == $load.i8($M.2.shadow,($p1.shadow + 161)));
requires ($load.i8($M.2,($p1 + 162)) == $load.i8($M.2.shadow,($p1.shadow + 162)));
requires ($load.i8($M.2,($p1 + 163)) == $load.i8($M.2.shadow,($p1.shadow + 163)));
requires ($load.i8($M.2,($p1 + 164)) == $load.i8($M.2.shadow,($p1.shadow + 164)));
requires ($load.i8($M.2,($p1 + 165)) == $load.i8($M.2.shadow,($p1.shadow + 165)));
requires ($load.i8($M.2,($p1 + 166)) == $load.i8($M.2.shadow,($p1.shadow + 166)));
requires ($load.i8($M.2,($p1 + 167)) == $load.i8($M.2.shadow,($p1.shadow + 167)));
requires ($load.i8($M.2,($p1 + 168)) == $load.i8($M.2.shadow,($p1.shadow + 168)));
requires ($load.i8($M.2,($p1 + 169)) == $load.i8($M.2.shadow,($p1.shadow + 169)));
requires ($load.i8($M.2,($p1 + 170)) == $load.i8($M.2.shadow,($p1.shadow + 170)));
requires ($load.i8($M.2,($p1 + 171)) == $load.i8($M.2.shadow,($p1.shadow + 171)));
requires ($load.i8($M.2,($p1 + 172)) == $load.i8($M.2.shadow,($p1.shadow + 172)));
requires ($load.i8($M.2,($p1 + 173)) == $load.i8($M.2.shadow,($p1.shadow + 173)));
requires ($load.i8($M.2,($p1 + 174)) == $load.i8($M.2.shadow,($p1.shadow + 174)));
requires ($load.i8($M.2,($p1 + 175)) == $load.i8($M.2.shadow,($p1.shadow + 175)));
requires ($load.i8($M.2,($p1 + 176)) == $load.i8($M.2.shadow,($p1.shadow + 176)));
requires ($load.i8($M.2,($p1 + 177)) == $load.i8($M.2.shadow,($p1.shadow + 177)));
requires ($load.i8($M.2,($p1 + 178)) == $load.i8($M.2.shadow,($p1.shadow + 178)));
requires ($load.i8($M.2,($p1 + 179)) == $load.i8($M.2.shadow,($p1.shadow + 179)));
requires ($load.i8($M.2,($p1 + 180)) == $load.i8($M.2.shadow,($p1.shadow + 180)));
requires ($load.i8($M.2,($p1 + 181)) == $load.i8($M.2.shadow,($p1.shadow + 181)));
requires ($load.i8($M.2,($p1 + 182)) == $load.i8($M.2.shadow,($p1.shadow + 182)));
requires ($load.i8($M.2,($p1 + 183)) == $load.i8($M.2.shadow,($p1.shadow + 183)));
requires ($load.i8($M.2,($p1 + 184)) == $load.i8($M.2.shadow,($p1.shadow + 184)));
requires ($load.i8($M.2,($p1 + 185)) == $load.i8($M.2.shadow,($p1.shadow + 185)));
requires ($load.i8($M.2,($p1 + 186)) == $load.i8($M.2.shadow,($p1.shadow + 186)));
requires ($load.i8($M.2,($p1 + 187)) == $load.i8($M.2.shadow,($p1.shadow + 187)));
requires ($load.i8($M.2,($p1 + 188)) == $load.i8($M.2.shadow,($p1.shadow + 188)));
requires ($load.i8($M.2,($p1 + 189)) == $load.i8($M.2.shadow,($p1.shadow + 189)));
requires ($load.i8($M.2,($p1 + 190)) == $load.i8($M.2.shadow,($p1.shadow + 190)));
requires ($load.i8($M.2,($p1 + 191)) == $load.i8($M.2.shadow,($p1.shadow + 191)));
requires ($load.i8($M.2,($p1 + 192)) == $load.i8($M.2.shadow,($p1.shadow + 192)));
requires ($load.i8($M.2,($p1 + 193)) == $load.i8($M.2.shadow,($p1.shadow + 193)));
requires ($load.i8($M.2,($p1 + 194)) == $load.i8($M.2.shadow,($p1.shadow + 194)));
requires ($load.i8($M.2,($p1 + 195)) == $load.i8($M.2.shadow,($p1.shadow + 195)));
requires ($load.i8($M.2,($p1 + 196)) == $load.i8($M.2.shadow,($p1.shadow + 196)));
requires ($load.i8($M.2,($p1 + 197)) == $load.i8($M.2.shadow,($p1.shadow + 197)));
requires ($load.i8($M.2,($p1 + 198)) == $load.i8($M.2.shadow,($p1.shadow + 198)));
requires ($load.i8($M.2,($p1 + 199)) == $load.i8($M.2.shadow,($p1.shadow + 199)));
requires ($load.i8($M.2,($p1 + 200)) == $load.i8($M.2.shadow,($p1.shadow + 200)));
requires ($load.i8($M.2,($p1 + 201)) == $load.i8($M.2.shadow,($p1.shadow + 201)));
requires ($load.i8($M.2,($p1 + 202)) == $load.i8($M.2.shadow,($p1.shadow + 202)));
requires ($load.i8($M.2,($p1 + 203)) == $load.i8($M.2.shadow,($p1.shadow + 203)));
requires ($load.i8($M.2,($p1 + 204)) == $load.i8($M.2.shadow,($p1.shadow + 204)));
requires ($load.i8($M.2,($p1 + 205)) == $load.i8($M.2.shadow,($p1.shadow + 205)));
requires ($load.i8($M.2,($p1 + 206)) == $load.i8($M.2.shadow,($p1.shadow + 206)));
requires ($load.i8($M.2,($p1 + 207)) == $load.i8($M.2.shadow,($p1.shadow + 207)));
requires ($load.i8($M.2,($p1 + 208)) == $load.i8($M.2.shadow,($p1.shadow + 208)));
requires ($load.i8($M.2,($p1 + 209)) == $load.i8($M.2.shadow,($p1.shadow + 209)));
requires ($load.i8($M.2,($p1 + 210)) == $load.i8($M.2.shadow,($p1.shadow + 210)));
requires ($load.i8($M.2,($p1 + 211)) == $load.i8($M.2.shadow,($p1.shadow + 211)));
requires ($load.i8($M.2,($p1 + 212)) == $load.i8($M.2.shadow,($p1.shadow + 212)));
requires ($load.i8($M.2,($p1 + 213)) == $load.i8($M.2.shadow,($p1.shadow + 213)));
requires ($load.i8($M.2,($p1 + 214)) == $load.i8($M.2.shadow,($p1.shadow + 214)));
requires ($load.i8($M.2,($p1 + 215)) == $load.i8($M.2.shadow,($p1.shadow + 215)));
requires ($load.i8($M.2,($p1 + 216)) == $load.i8($M.2.shadow,($p1.shadow + 216)));
requires ($load.i8($M.2,($p1 + 217)) == $load.i8($M.2.shadow,($p1.shadow + 217)));
requires ($load.i8($M.2,($p1 + 218)) == $load.i8($M.2.shadow,($p1.shadow + 218)));
requires ($load.i8($M.2,($p1 + 219)) == $load.i8($M.2.shadow,($p1.shadow + 219)));
requires ($load.i8($M.2,($p1 + 220)) == $load.i8($M.2.shadow,($p1.shadow + 220)));
requires ($load.i8($M.2,($p1 + 221)) == $load.i8($M.2.shadow,($p1.shadow + 221)));
requires ($load.i8($M.2,($p1 + 222)) == $load.i8($M.2.shadow,($p1.shadow + 222)));
requires ($load.i8($M.2,($p1 + 223)) == $load.i8($M.2.shadow,($p1.shadow + 223)));
requires ($load.i8($M.2,($p1 + 224)) == $load.i8($M.2.shadow,($p1.shadow + 224)));
requires ($load.i8($M.2,($p1 + 225)) == $load.i8($M.2.shadow,($p1.shadow + 225)));
requires ($load.i8($M.2,($p1 + 226)) == $load.i8($M.2.shadow,($p1.shadow + 226)));
requires ($load.i8($M.2,($p1 + 227)) == $load.i8($M.2.shadow,($p1.shadow + 227)));
requires ($load.i8($M.2,($p1 + 228)) == $load.i8($M.2.shadow,($p1.shadow + 228)));
requires ($load.i8($M.2,($p1 + 229)) == $load.i8($M.2.shadow,($p1.shadow + 229)));
requires ($load.i8($M.2,($p1 + 230)) == $load.i8($M.2.shadow,($p1.shadow + 230)));
requires ($load.i8($M.2,($p1 + 231)) == $load.i8($M.2.shadow,($p1.shadow + 231)));
requires ($load.i8($M.2,($p1 + 232)) == $load.i8($M.2.shadow,($p1.shadow + 232)));
requires ($load.i8($M.2,($p1 + 233)) == $load.i8($M.2.shadow,($p1.shadow + 233)));
requires ($load.i8($M.2,($p1 + 234)) == $load.i8($M.2.shadow,($p1.shadow + 234)));
requires ($load.i8($M.2,($p1 + 235)) == $load.i8($M.2.shadow,($p1.shadow + 235)));
requires ($load.i8($M.2,($p1 + 236)) == $load.i8($M.2.shadow,($p1.shadow + 236)));
requires ($load.i8($M.2,($p1 + 237)) == $load.i8($M.2.shadow,($p1.shadow + 237)));
requires ($load.i8($M.2,($p1 + 238)) == $load.i8($M.2.shadow,($p1.shadow + 238)));
requires ($load.i8($M.2,($p1 + 239)) == $load.i8($M.2.shadow,($p1.shadow + 239)));
requires ($load.i8($M.2,($p1 + 240)) == $load.i8($M.2.shadow,($p1.shadow + 240)));
requires ($load.i8($M.2,($p1 + 241)) == $load.i8($M.2.shadow,($p1.shadow + 241)));
requires ($load.i8($M.2,($p1 + 242)) == $load.i8($M.2.shadow,($p1.shadow + 242)));
requires ($load.i8($M.2,($p1 + 243)) == $load.i8($M.2.shadow,($p1.shadow + 243)));
requires ($load.i8($M.2,($p1 + 244)) == $load.i8($M.2.shadow,($p1.shadow + 244)));
requires ($load.i8($M.2,($p1 + 245)) == $load.i8($M.2.shadow,($p1.shadow + 245)));
requires ($load.i8($M.2,($p1 + 246)) == $load.i8($M.2.shadow,($p1.shadow + 246)));
requires ($load.i8($M.2,($p1 + 247)) == $load.i8($M.2.shadow,($p1.shadow + 247)));
requires ($load.i8($M.2,($p1 + 248)) == $load.i8($M.2.shadow,($p1.shadow + 248)));
requires ($load.i8($M.2,($p1 + 249)) == $load.i8($M.2.shadow,($p1.shadow + 249)));
requires ($load.i8($M.2,($p1 + 250)) == $load.i8($M.2.shadow,($p1.shadow + 250)));
requires ($load.i8($M.2,($p1 + 251)) == $load.i8($M.2.shadow,($p1.shadow + 251)));
requires ($load.i8($M.2,($p1 + 252)) == $load.i8($M.2.shadow,($p1.shadow + 252)));
requires ($load.i8($M.2,($p1 + 253)) == $load.i8($M.2.shadow,($p1.shadow + 253)));
requires ($load.i8($M.2,($p1 + 254)) == $load.i8($M.2.shadow,($p1.shadow + 254)));
requires ($load.i8($M.2,($p1 + 255)) == $load.i8($M.2.shadow,($p1.shadow + 255)));
{
  var $p5: ref;
  var $p5.shadow: ref;
  var $p6: ref;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "constant_time_lookup.c", 8, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:constant_time_lookup_wrapper"} boogie_si_record_ref(constant_time_lookup_wrapper);
  call {:cexpr "smack:arg:constant_time_lookup_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:constant_time_lookup_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:constant_time_lookup_wrapper:$i2"} boogie_si_record_i64($i2);
  call {:cexpr "smack:arg:constant_time_lookup_wrapper:$i3"} boogie_si_record_i64($i3);
  call {:cexpr "smack:arg:constant_time_lookup_wrapper:$i4"} boogie_si_record_i64($i4);
  call {:cexpr "constant_time_lookup_wrapper:arg:rowsize"} boogie_si_record_i64($i2);
  call {:cexpr "constant_time_lookup_wrapper:arg:numrows"} boogie_si_record_i64($i3);
  call {:cexpr "constant_time_lookup_wrapper:arg:idx"} boogie_si_record_i64($i4);
  assume {:sourceloc "constant_time_lookup.c", 8, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "constant_time_lookup.c", 14, 5} true;
  assume {:verifier.code 0} true;
  call public_in($p9, $p9.shadow);
  assume {:sourceloc "constant_time_lookup.c", 15, 15} true;
  assume {:verifier.code 1} true;
  call {:name $p1} {:array "$load.i8", $M.2, $p1, 1, 256} $p10 := __SMACK_values($p1, 256);
  $p10.shadow := $p10;
  assume $isExternal($p10);
  call {:cexpr "smack:ext:__SMACK_values"} boogie_si_record_ref($p10);
  assume {:sourceloc "constant_time_lookup.c", 15, 5} true;
  assume {:verifier.code 0} true;
  call public_in($p10, $p10.shadow);
  assume {:sourceloc "constant_time_lookup.c", 19, 2} true;
  assume {:verifier.code 0} true;
  call constant_time_lookup($p0, $p0.shadow, $p1, $p1.shadow, $i2, $i2.shadow, $i3, $i3.shadow, $i4, $i4.shadow);
  assume {:sourceloc "constant_time_lookup.c", 20, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  assert $shadow_ok;
...
const constant_time_lookup: ref;
axiom (constant_time_lookup == $sub.ref(0,6192));
procedure {:inline 1} constant_time_lookup($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $i2: i64, $i2.shadow: i64, $i3: i64, $i3.shadow: i64, $i4: i64, $i4.shadow: i64)
modifies $M.1, $exn;
{
  var $i5: i64;
  var $i5.shadow: i64;
  ...
  var $i25.shadow: i64;
$bb0:
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 405, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "constant_time_lookup:arg:rowsize"} boogie_si_record_i64($i2);
  call {:cexpr "constant_time_lookup:arg:numrows"} boogie_si_record_i64($i3);
  call {:cexpr "constant_time_lookup:arg:idx"} boogie_si_record_i64($i4);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 405, 5} true;
  assume {:verifier.code 0} true;
  assert ($p0 == $p0.shadow);
  assert ($i2 == $i2.shadow);
  call $M.1, $M.1.shadow := $memset.i8($M.1, $M.1.shadow, $p0, $p0.shadow, 0, 0, $i2, $i2.shadow, false, false);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 408, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $i4;
  $i5.shadow := $i4.shadow;
  $i6 := 0;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 401, 26} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 408, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $ult.i64($i6,$i3);
  $i8.shadow := $ult.i64($i6.shadow,$i3.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 408, 5} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i8 == 1);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 409, 31} true;
  assume {:verifier.code 0} true;
  call $i9, $i9.shadow := constant_time_is_zero_s($i5, $i5.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 409, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i64.i8($i9);
  $i10.shadow := $trunc.i64.i8($i9.shadow);
  call {:cexpr "mask"} boogie_si_record_i8($i10);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 410, 14} true;
  assume {:verifier.code 0} true;
  $i11 := 0;
  $i11.shadow := 0;
  $p12 := $p7;
  $p12.shadow := $p7.shadow;
  goto $bb4;
$bb3:
  assume !($i8 == 1);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 413, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
$bb4:
  ...
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 410, 23} true;
  assume {:verifier.code 0} true;
  $i13 := $ult.i64($i11,$i2);
  $i13.shadow := $ult.i64($i11.shadow,$i2.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 410, 9} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i13 == 1);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 411, 65} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p12,$mul.ref(1,1));
  $p14.shadow := $add.ref($p12.shadow,$mul.ref(1,1));
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 411, 57} true;
  assume {:verifier.code 0} true;
  assert ($p12 == $p12.shadow);
  $i15 := $load.i8($M.2,$p12);
  $i15.shadow := $load.i8($M.2.shadow,$p12.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 411, 28} true;
  assume {:verifier.code 0} true;
  call $i16, $i16.shadow := constant_time_select_8($i10, $i10.shadow, $i15, $i15.shadow, 0, 0);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 411, 28} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i8.i32($i16);
  $i17.shadow := $zext.i8.i32($i16.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 411, 20} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p0,$mul.ref($i11,1));
  $p18.shadow := $add.ref($p0.shadow,$mul.ref($i11.shadow,1));
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 411, 25} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i21 := $or.i32($i20,$i17);
  $i21.shadow := $or.i32($i20.shadow,$i17.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 411, 25} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 411, 13} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !($i13 == 1);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 412, 5} true;
  assume {:verifier.code 0} true;
  goto $bb8;
$bb7:
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 410, 35} true;
  assume {:verifier.code 0} true;
  $i23 := $add.i64($i11,1);
  $i23.shadow := $add.i64($i11.shadow,1);
  call {:cexpr "j"} boogie_si_record_i64($i23);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 410, 9} true;
  assume {:verifier.code 0} true;
  $i11 := $i23;
  $i11.shadow := $i23.shadow;
  $p12 := $p14;
  $p12.shadow := $p14.shadow;
  goto $bb4;
$bb8:
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 408, 31} true;
  assume {:verifier.code 0} true;
  $i24 := $add.i64($i6,1);
  $i24.shadow := $add.i64($i6.shadow,1);
  call {:cexpr "i"} boogie_si_record_i64($i24);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 408, 38} true;
  assume {:verifier.code 0} true;
  $i25 := $add.i64($i5,$sub.i64(0,1));
  $i25.shadow := $add.i64($i5.shadow,$sub.i64(0,1));
  call {:cexpr "idx"} boogie_si_record_i64($i25);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 408, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $i25;
  $i5.shadow := $i25.shadow;
  $i6 := $i24;
  $i6.shadow := $i24.shadow;
  $p7 := $p12;
  $p7.shadow := $p12.shadow;
  goto $bb1;
}
...
const constant_time_is_zero_s: ref;
axiom (constant_time_is_zero_s == $sub.ref(0,8256));
procedure {:inline 1} constant_time_is_zero_s($i0: i64, $i0.shadow: i64) returns ($r: i64, $r.shadow: i64)
modifies $exn;
{
  var $i1: i64;
  var $i1.shadow: i64;
  ...
  var $i4.shadow: i64;
$bb0:
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 172, 32} true;
  assume {:verifier.code 0} true;
  call {:cexpr "constant_time_is_zero_s:arg:a"} boogie_si_record_i64($i0);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 172, 32} true;
  assume {:verifier.code 0} true;
  $i1 := $xor.i64($i0,$sub.i64(0,1));
  $i1.shadow := $xor.i64($i0.shadow,$sub.i64(0,1));
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 172, 40} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i64($i0,1);
  $i2.shadow := $sub.i64($i0.shadow,1);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 172, 35} true;
  assume {:verifier.code 0} true;
  $i3 := $and.i64($i1,$i2);
  $i3.shadow := $and.i64($i1.shadow,$i2.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 172, 12} true;
  assume {:verifier.code 0} true;
  call $i4, $i4.shadow := constant_time_msb_s($i3, $i3.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 172, 5} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $r.shadow := $i4.shadow;
  $exn := false;
...
axiom (constant_time_select_8 == $sub.ref(0,9288));
procedure {:inline 1} constant_time_select_8($i0: i8, $i0.shadow: i8, $i1: i8, $i1.shadow: i8, $i2: i8, $i2.shadow: i8) returns ($r: i8, $r.shadow: i8)
modifies $exn;
{
  var $i3: i32;
  var $i3.shadow: i32;
  ...
  var $i7.shadow: i8;
$bb0:
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 294, 48} true;
  assume {:verifier.code 0} true;
  call {:cexpr "constant_time_select_8:arg:mask"} boogie_si_record_i8($i0);
  call {:cexpr "constant_time_select_8:arg:a"} boogie_si_record_i8($i1);
  call {:cexpr "constant_time_select_8:arg:b"} boogie_si_record_i8($i2);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 294, 48} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i8.i32($i0);
  $i3.shadow := $zext.i8.i32($i0.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 294, 54} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i8.i32($i1);
  $i4.shadow := $zext.i8.i32($i1.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 294, 57} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.i8.i32($i2);
  $i5.shadow := $zext.i8.i32($i2.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 294, 27} true;
  assume {:verifier.code 0} true;
  call $i6, $i6.shadow := constant_time_select($i3, $i3.shadow, $i4, $i4.shadow, $i5, $i5.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 294, 12} true;
  assume {:verifier.code 0} true;
  $i7 := $trunc.i32.i8($i6);
  $i7.shadow := $trunc.i32.i8($i6.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 294, 5} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $r.shadow := $i7.shadow;
  $exn := false;
...
axiom (constant_time_select == $sub.ref(0,10320));
...
modifies $exn;
{
  ...
  var $i8.shadow: i32;
$bb0:
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 280, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 280, 13} true;
  assume {:verifier.code 0} true;
  call $i3, $i3.shadow := value_barrier($i0, $i0.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 280, 33} true;
  assume {:verifier.code 0} true;
  $i4 := $and.i32($i3,$i1);
  $i4.shadow := $and.i32($i3.shadow,$i1.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 280, 55} true;
  assume {:verifier.code 0} true;
  $i5 := $xor.i32($i0,$sub.i32(0,1));
  $i5.shadow := $xor.i32($i0.shadow,$sub.i32(0,1));
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 280, 41} true;
  assume {:verifier.code 0} true;
  call $i6, $i6.shadow := value_barrier($i5, $i5.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 280, 62} true;
  assume {:verifier.code 0} true;
  $i7 := $and.i32($i6,$i2);
  $i7.shadow := $and.i32($i6.shadow,$i2.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 280, 38} true;
  assume {:verifier.code 0} true;
  $i8 := $or.i32($i4,$i7);
  $i8.shadow := $or.i32($i4.shadow,$i7.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 280, 5} true;
  assume {:verifier.code 0} true;
  $r := $i8;
  $r.shadow := $i8.shadow;
  $exn := false;
...
const value_barrier: ref;
axiom (value_barrier == $sub.ref(0,11352));
procedure {:inline 1} value_barrier($i0: i32, $i0.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i1: i32;
  var $i1.shadow: i32;
$bb0:
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 233, 5} true;
  assume {:verifier.code 0} true;
  call {:cexpr "value_barrier:arg:a"} boogie_si_record_i32($i0);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 233, 5} true;
  assume {:verifier.code 0} true;
  assume true;
  call {:cexpr "r"} boogie_si_record_i32($i1);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 237, 5} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $r.shadow := $i1.shadow;
  $exn := false;
...
const constant_time_msb_s: ref;
axiom (constant_time_msb_s == $sub.ref(0,12384));
procedure {:inline 1} constant_time_msb_s($i0: i64, $i0.shadow: i64) returns ($r: i64, $r.shadow: i64)
modifies $exn;
{
  var $i1: i64;
  var $i1.shadow: i64;
  ...
  var $i2.shadow: i64;
$bb0:
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 118, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "constant_time_msb_s:arg:a"} boogie_si_record_i64($i0);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 118, 19} true;
  assume {:verifier.code 0} true;
  $i1 := $lshr.i64($i0,63);
  $i1.shadow := $lshr.i64($i0.shadow,63);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 118, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i64(0,$i1);
  $i2.shadow := $sub.i64(0,$i1.shadow);
  assume {:sourceloc "./../Tongsuo/include/internal/constant_time.h", 118, 5} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $r.shadow := $i2.shadow;
  $exn := false;
