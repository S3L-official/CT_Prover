...
# 四个需要指定的选项
deps=(../Tongsuo/crypto/ec/curve448/f_generic.c
      ../Tongsuo/crypto/ec/curve448/scalar.c
      ../Tongsuo/crypto/ec/curve448/curve448_tables.c
      ../Tongsuo/crypto/ec/curve448/arch_64/f_impl64.c)
