...
procedure {:entrypoint} fix_cmp_wrapper($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1)
modifies $exn;
modifies $CurrAddr;
{
  var $i2: i8;
...
$bb0:
  ...
  assume {:sourceloc "fix_cmp.c", 4, 2} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.dup := fix_cmp($i0, $i0.dup, $i1, $i1.dup);
...
procedure {:inline 1} fix_cmp($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1) returns ($r: i8, $r.dup: i1)
modifies $exn;
{
  var $i2: i64;
  var $i2.dup: i1;
...
$bb0:
  ...
  $i14.dup := $or.i1($i13.dup,$or.i1(0,0));
  ...
  assume {:verifier.code 0} true;
  $i53 := $and.i32($i48,$i52);
  $i53.dup := $or.i1($i48.dup,$i52.dup);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 37, 66} true;
  assume {:verifier.code 0} true;
  $i54 := $or.i32($i45,$i53);
  $i54.dup := $or.i1($i45.dup,$i53.dup);
  ...
  $i108.dup := $or.i1($i100.dup,$i107.dup);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i109 := $or.i32($i63,$i72);
  $i109.dup := $or.i1($i63.dup,$i72.dup);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i110 := $ne.i32($i109,0);
  ...
  assume {:verifier.code 0} true;
  $i117 := $sub.i64($i116,1);
  $i117.dup := $or.i1($i116.dup,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i118 := $ne.i32($i74,0);
  $i118.dup := $or.i1($i74.dup,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i119 := $xor.i1($i118,1);
  ...
  $i133.dup := $or.i1($i125.dup,$i132.dup);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i134 := $and.i64($i117,$i133);
  $i134.dup := $or.i1($i117.dup,$i133.dup);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i135 := $or.i64($i108,$i134);
  $i135.dup := $or.i1($i108.dup,$i134.dup);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i136 := $and.i64($i92,$i135);
  $i136.dup := $or.i1($i92.dup,$i135.dup);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 47, 28} true;
  assume {:verifier.code 0} true;
  $i137 := $or.i64($i84,$i136);
  $i137.dup := $or.i1($i84.dup,$i136.dup);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 47, 5} true;
  assume {:verifier.code 0} true;
