...
axiom ($GLOBALS_BOTTOM == $sub.ref(0,20640));
...
const fix_cmp_wrapper: ref;
axiom (fix_cmp_wrapper == $sub.ref(0,2064));
procedure {:entrypoint} fix_cmp_wrapper($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64)
modifies $exn;
modifies $CurrAddr;
{
  var $i2: i8;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "fix_cmp.c", 4, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:fix_cmp_wrapper"} boogie_si_record_ref(fix_cmp_wrapper);
  call {:cexpr "smack:arg:fix_cmp_wrapper:$i0"} boogie_si_record_i64($i0);
  call {:cexpr "smack:arg:fix_cmp_wrapper:$i1"} boogie_si_record_i64($i1);
  call {:cexpr "fix_cmp_wrapper:arg:op1"} boogie_si_record_i64($i0);
  call {:cexpr "fix_cmp_wrapper:arg:op2"} boogie_si_record_i64($i1);
  assume {:sourceloc "fix_cmp.c", 4, 2} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.shadow := fix_cmp($i0, $i0.shadow, $i1, $i1.shadow);
  assume {:sourceloc "fix_cmp.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := $exn;
...
const fix_cmp: ref;
axiom (fix_cmp == $sub.ref(0,3096));
procedure {:inline 1} fix_cmp($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i8, $r.shadow: i8)
modifies $exn;
{
  var $i2: i64;
  var $i2.shadow: i64;
  ...
  var $i138.shadow: i8;
$bb0:
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 30, 22} true;
  assume {:verifier.code 0} true;
  call {:cexpr "fix_cmp:arg:op1"} boogie_si_record_i64($i0);
  call {:cexpr "fix_cmp:arg:op2"} boogie_si_record_i64($i1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 30, 22} true;
  assume {:verifier.code 0} true;
  $i2 := $and.i64($i0,3);
  $i2.shadow := $and.i64($i0.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 30, 22} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i64($i2,1);
  $i3.shadow := $eq.i64($i2.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 30, 22} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i1.i32($i3);
  $i4.shadow := $zext.i1.i32($i3.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 30, 40} true;
  assume {:verifier.code 0} true;
  $i5 := $and.i64($i1,3);
  $i5.shadow := $and.i64($i1.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 30, 40} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i64($i5,1);
  $i6.shadow := $eq.i64($i5.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 30, 40} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i1.i32($i6);
  $i7.shadow := $zext.i1.i32($i6.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 30, 38} true;
  assume {:verifier.code 0} true;
  $i8 := $or.i32($i4,$i7);
  $i8.shadow := $or.i32($i4.shadow,$i7.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 30, 20} true;
  assume {:verifier.code 0} true;
  $i9 := $ne.i32($i8,0);
  ...
  assume {:verifier.code 0} true;
  $i10 := $xor.i1($i9,1);
  $i10.shadow := $xor.i1($i9.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 30, 19} true;
  assume {:verifier.code 0} true;
  $i11 := $xor.i1($i10,1);
  $i11.shadow := $xor.i1($i10.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 30, 19} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i1.i32($i11);
  $i12.shadow := $zext.i1.i32($i11.shadow);
  call {:cexpr "nans"} boogie_si_record_i32($i12);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 32, 20} true;
  assume {:verifier.code 0} true;
  $i13 := $and.i64($i0,9223372036854775808);
  $i13.shadow := $and.i64($i0.shadow,9223372036854775808);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 32, 20} true;
  assume {:verifier.code 0} true;
  $i14 := $eq.i64($i13,$sub.i64(0,9223372036854775808));
  $i14.shadow := $eq.i64($i13.shadow,$sub.i64(0,9223372036854775808));
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 32, 19} true;
  assume {:verifier.code 0} true;
  $i15 := $xor.i1($i14,1);
  $i15.shadow := $xor.i1($i14.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 32, 19} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i1.i32($i15);
  $i16.shadow := $zext.i1.i32($i15.shadow);
  call {:cexpr "pos1"} boogie_si_record_i32($i16);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 33, 20} true;
  assume {:verifier.code 0} true;
  $i17 := $and.i64($i1,9223372036854775808);
  $i17.shadow := $and.i64($i1.shadow,9223372036854775808);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 33, 20} true;
  assume {:verifier.code 0} true;
  $i18 := $eq.i64($i17,$sub.i64(0,9223372036854775808));
  $i18.shadow := $eq.i64($i17.shadow,$sub.i64(0,9223372036854775808));
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 33, 19} true;
  assume {:verifier.code 0} true;
  $i19 := $xor.i1($i18,1);
  $i19.shadow := $xor.i1($i18.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 33, 19} true;
  assume {:verifier.code 0} true;
  $i20 := $zext.i1.i32($i19);
  $i20.shadow := $zext.i1.i32($i19.shadow);
  call {:cexpr "pos2"} boogie_si_record_i32($i20);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 35, 20} true;
  assume {:verifier.code 0} true;
  $i21 := $and.i64($i0,3);
  $i21.shadow := $and.i64($i0.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 35, 20} true;
  assume {:verifier.code 0} true;
  $i22 := $eq.i64($i21,2);
  $i22.shadow := $eq.i64($i21.shadow,2);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 35, 20} true;
  assume {:verifier.code 0} true;
  $i23 := $zext.i1.i32($i22);
  $i23.shadow := $zext.i1.i32($i22.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 35, 45} true;
  assume {:verifier.code 0} true;
  $i24 := $and.i64($i1,3);
  $i24.shadow := $and.i64($i1.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 35, 45} true;
  assume {:verifier.code 0} true;
  $i25 := $eq.i64($i24,2);
  $i25.shadow := $eq.i64($i24.shadow,2);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 35, 44} true;
  assume {:verifier.code 0} true;
  $i26 := $xor.i1($i25,1);
  $i26.shadow := $xor.i1($i25.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 35, 44} true;
  assume {:verifier.code 0} true;
  $i27 := $zext.i1.i32($i26);
  $i27.shadow := $zext.i1.i32($i26.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 35, 41} true;
  assume {:verifier.code 0} true;
  $i28 := $and.i32($i23,$i27);
  $i28.shadow := $and.i32($i23.shadow,$i27.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 36, 20} true;
  assume {:verifier.code 0} true;
  $i29 := $and.i64($i0,3);
  $i29.shadow := $and.i64($i0.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 36, 20} true;
  assume {:verifier.code 0} true;
  $i30 := $eq.i64($i29,3);
  $i30.shadow := $eq.i64($i29.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 36, 19} true;
  assume {:verifier.code 0} true;
  $i31 := $xor.i1($i30,1);
  $i31.shadow := $xor.i1($i30.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 36, 19} true;
  assume {:verifier.code 0} true;
  $i32 := $zext.i1.i32($i31);
  $i32.shadow := $zext.i1.i32($i31.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 36, 45} true;
  assume {:verifier.code 0} true;
  $i33 := $and.i64($i1,3);
  $i33.shadow := $and.i64($i1.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 36, 45} true;
  assume {:verifier.code 0} true;
  $i34 := $eq.i64($i33,3);
  $i34.shadow := $eq.i64($i33.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 36, 45} true;
  assume {:verifier.code 0} true;
  $i35 := $zext.i1.i32($i34);
  $i35.shadow := $zext.i1.i32($i34.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 36, 41} true;
  assume {:verifier.code 0} true;
  $i36 := $and.i32($i32,$i35);
  $i36.shadow := $and.i32($i32.shadow,$i35.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 35, 67} true;
  assume {:verifier.code 0} true;
  $i37 := $or.i32($i28,$i36);
  $i37.shadow := $or.i32($i28.shadow,$i36.shadow);
  call {:cexpr "gt"} boogie_si_record_i32($i37);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 37, 20} true;
  assume {:verifier.code 0} true;
  $i38 := $and.i64($i0,3);
  $i38.shadow := $and.i64($i0.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 37, 20} true;
  assume {:verifier.code 0} true;
  $i39 := $eq.i64($i38,2);
  $i39.shadow := $eq.i64($i38.shadow,2);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 37, 19} true;
  assume {:verifier.code 0} true;
  $i40 := $xor.i1($i39,1);
  $i40.shadow := $xor.i1($i39.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 37, 19} true;
  assume {:verifier.code 0} true;
  $i41 := $zext.i1.i32($i40);
  $i41.shadow := $zext.i1.i32($i40.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 37, 45} true;
  assume {:verifier.code 0} true;
  $i42 := $and.i64($i1,3);
  $i42.shadow := $and.i64($i1.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 37, 45} true;
  assume {:verifier.code 0} true;
  $i43 := $eq.i64($i42,2);
  $i43.shadow := $eq.i64($i42.shadow,2);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 37, 45} true;
  assume {:verifier.code 0} true;
  $i44 := $zext.i1.i32($i43);
  $i44.shadow := $zext.i1.i32($i43.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 37, 41} true;
  assume {:verifier.code 0} true;
  $i45 := $and.i32($i41,$i44);
  $i45.shadow := $and.i32($i41.shadow,$i44.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 38, 20} true;
  assume {:verifier.code 0} true;
  $i46 := $and.i64($i0,3);
  $i46.shadow := $and.i64($i0.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 38, 20} true;
  assume {:verifier.code 0} true;
  $i47 := $eq.i64($i46,3);
  $i47.shadow := $eq.i64($i46.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 38, 20} true;
  assume {:verifier.code 0} true;
  $i48 := $zext.i1.i32($i47);
  $i48.shadow := $zext.i1.i32($i47.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 38, 45} true;
  assume {:verifier.code 0} true;
  $i49 := $and.i64($i1,3);
  $i49.shadow := $and.i64($i1.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 38, 45} true;
  assume {:verifier.code 0} true;
  $i50 := $eq.i64($i49,3);
  $i50.shadow := $eq.i64($i49.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 38, 44} true;
  assume {:verifier.code 0} true;
  $i51 := $xor.i1($i50,1);
  $i51.shadow := $xor.i1($i50.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 38, 44} true;
  assume {:verifier.code 0} true;
  $i52 := $zext.i1.i32($i51);
  $i52.shadow := $zext.i1.i32($i51.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 38, 41} true;
  assume {:verifier.code 0} true;
  $i53 := $and.i32($i48,$i52);
  $i53.shadow := $and.i32($i48.shadow,$i52.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 37, 66} true;
  assume {:verifier.code 0} true;
  $i54 := $or.i32($i45,$i53);
  $i54.shadow := $or.i32($i45.shadow,$i53.shadow);
  call {:cexpr "lt"} boogie_si_record_i32($i54);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 40, 10} true;
  assume {:verifier.code 0} true;
  $i55 := $ne.i32($i54,0);
  $i55.shadow := $ne.i32($i54.shadow,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 40, 10} true;
  assume {:verifier.code 0} true;
  $i56 := $xor.i1($i55,1);
  $i56.shadow := $xor.i1($i55.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 40, 10} true;
  assume {:verifier.code 0} true;
  $i57 := $zext.i1.i32($i56);
  $i57.shadow := $zext.i1.i32($i56.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 40, 26} true;
  assume {:verifier.code 0} true;
  $i58 := $ne.i32($i20,0);
  $i58.shadow := $ne.i32($i20.shadow,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 40, 26} true;
  assume {:verifier.code 0} true;
  $i59 := $xor.i1($i58,1);
  $i59.shadow := $xor.i1($i58.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 40, 26} true;
  assume {:verifier.code 0} true;
  $i60 := $zext.i1.i32($i59);
  $i60.shadow := $zext.i1.i32($i59.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 40, 23} true;
  assume {:verifier.code 0} true;
  $i61 := $and.i32($i16,$i60);
  $i61.shadow := $and.i32($i16.shadow,$i60.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 40, 15} true;
  assume {:verifier.code 0} true;
  $i62 := $and.i32($i57,$i61);
  $i62.shadow := $and.i32($i57.shadow,$i61.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 40, 6} true;
  assume {:verifier.code 0} true;
  $i63 := $or.i32($i37,$i62);
  $i63.shadow := $or.i32($i37.shadow,$i62.shadow);
  call {:cexpr "gt"} boogie_si_record_i32($i63);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 41, 10} true;
  assume {:verifier.code 0} true;
  $i64 := $ne.i32($i63,0);
  $i64.shadow := $ne.i32($i63.shadow,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 41, 10} true;
  assume {:verifier.code 0} true;
  $i65 := $xor.i1($i64,1);
  $i65.shadow := $xor.i1($i64.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 41, 10} true;
  assume {:verifier.code 0} true;
  $i66 := $zext.i1.i32($i65);
  $i66.shadow := $zext.i1.i32($i65.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 41, 19} true;
  assume {:verifier.code 0} true;
  $i67 := $ne.i32($i16,0);
  $i67.shadow := $ne.i32($i16.shadow,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 41, 19} true;
  assume {:verifier.code 0} true;
  $i68 := $xor.i1($i67,1);
  $i68.shadow := $xor.i1($i67.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 41, 19} true;
  assume {:verifier.code 0} true;
  $i69 := $zext.i1.i32($i68);
  $i69.shadow := $zext.i1.i32($i68.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 41, 26} true;
  assume {:verifier.code 0} true;
  $i70 := $and.i32($i69,$i20);
  $i70.shadow := $and.i32($i69.shadow,$i20.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 41, 15} true;
  assume {:verifier.code 0} true;
  $i71 := $and.i32($i66,$i70);
  $i71.shadow := $and.i32($i66.shadow,$i70.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 41, 6} true;
  assume {:verifier.code 0} true;
  $i72 := $or.i32($i54,$i71);
  $i72.shadow := $or.i32($i54.shadow,$i71.shadow);
  call {:cexpr "lt"} boogie_si_record_i32($i72);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 43, 36} true;
  assume {:verifier.code 0} true;
  $i73 := $ugt.i64($i0,$i1);
  $i73.shadow := $ugt.i64($i0.shadow,$i1.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 43, 36} true;
  assume {:verifier.code 0} true;
  $i74 := $zext.i1.i32($i73);
  $i74.shadow := $zext.i1.i32($i73.shadow);
  call {:cexpr "cmp_gt"} boogie_si_record_i32($i74);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 44, 36} true;
  assume {:verifier.code 0} true;
  $i75 := $ult.i64($i0,$i1);
  $i75.shadow := $ult.i64($i0.shadow,$i1.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 44, 36} true;
  assume {:verifier.code 0} true;
  $i76 := $zext.i1.i32($i75);
  $i76.shadow := $zext.i1.i32($i75.shadow);
  call {:cexpr "cmp_lt"} boogie_si_record_i32($i76);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $i77 := $ne.i32($i12,0);
  $i77.shadow := $ne.i32($i12.shadow,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $i78 := $xor.i1($i77,1);
  $i78.shadow := $xor.i1($i77.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $i79 := $xor.i1($i78,1);
  $i79.shadow := $xor.i1($i78.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $i80 := $zext.i1.i32($i79);
  $i80.shadow := $zext.i1.i32($i79.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $i81 := $sext.i32.i64($i80);
  $i81.shadow := $sext.i32.i64($i80.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $i82 := $xor.i64($i81,1);
  $i82.shadow := $xor.i64($i81.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $i83 := $sub.i64($i82,1);
  $i83.shadow := $sub.i64($i82.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $i84 := $and.i64($i83,1);
  $i84.shadow := $and.i64($i83.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i85 := $ne.i32($i12,0);
  $i85.shadow := $ne.i32($i12.shadow,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i86 := $xor.i1($i85,1);
  $i86.shadow := $xor.i1($i85.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i87 := $xor.i1($i86,1);
  $i87.shadow := $xor.i1($i86.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i88 := $xor.i1($i87,1);
  $i88.shadow := $xor.i1($i87.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i89 := $zext.i1.i32($i88);
  $i89.shadow := $zext.i1.i32($i88.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i90 := $sext.i32.i64($i89);
  $i90.shadow := $sext.i32.i64($i89.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i91 := $xor.i64($i90,1);
  $i91.shadow := $xor.i64($i90.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i92 := $sub.i64($i91,1);
  $i92.shadow := $sub.i64($i91.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i93 := $ne.i32($i63,0);
  $i93.shadow := $ne.i32($i63.shadow,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i94 := $xor.i1($i93,1);
  $i94.shadow := $xor.i1($i93.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i95 := $xor.i1($i94,1);
  $i95.shadow := $xor.i1($i94.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i96 := $zext.i1.i32($i95);
  $i96.shadow := $zext.i1.i32($i95.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i98 := $xor.i64($i97,1);
  $i98.shadow := $xor.i64($i97.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i99 := $sub.i64($i98,1);
  $i99.shadow := $sub.i64($i98.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i100 := $and.i64($i99,1);
  $i100.shadow := $and.i64($i99.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i101 := $ne.i32($i72,0);
  $i101.shadow := $ne.i32($i72.shadow,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i102 := $xor.i1($i101,1);
  $i102.shadow := $xor.i1($i101.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i103 := $xor.i1($i102,1);
  $i103.shadow := $xor.i1($i102.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i104 := $zext.i1.i32($i103);
  $i104.shadow := $zext.i1.i32($i103.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i106 := $xor.i64($i105,1);
  $i106.shadow := $xor.i64($i105.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i107 := $sub.i64($i106,1);
  $i107.shadow := $sub.i64($i106.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i108 := $or.i64($i100,$i107);
  $i108.shadow := $or.i64($i100.shadow,$i107.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i109 := $or.i32($i63,$i72);
  $i109.shadow := $or.i32($i63.shadow,$i72.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i110 := $ne.i32($i109,0);
  $i110.shadow := $ne.i32($i109.shadow,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i111 := $xor.i1($i110,1);
  $i111.shadow := $xor.i1($i110.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i112 := $xor.i1($i111,1);
  $i112.shadow := $xor.i1($i111.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i113 := $xor.i1($i112,1);
  $i113.shadow := $xor.i1($i112.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i114 := $zext.i1.i32($i113);
  $i114.shadow := $zext.i1.i32($i113.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i115 := $sext.i32.i64($i114);
  $i115.shadow := $sext.i32.i64($i114.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i116 := $xor.i64($i115,1);
  $i116.shadow := $xor.i64($i115.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i117 := $sub.i64($i116,1);
  $i117.shadow := $sub.i64($i116.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i118 := $ne.i32($i74,0);
  $i118.shadow := $ne.i32($i74.shadow,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i119 := $xor.i1($i118,1);
  $i119.shadow := $xor.i1($i118.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i120 := $xor.i1($i119,1);
  $i120.shadow := $xor.i1($i119.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i121 := $zext.i1.i32($i120);
  $i121.shadow := $zext.i1.i32($i120.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i123 := $xor.i64($i122,1);
  $i123.shadow := $xor.i64($i122.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i124 := $sub.i64($i123,1);
  $i124.shadow := $sub.i64($i123.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i125 := $and.i64($i124,1);
  $i125.shadow := $and.i64($i124.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i126 := $ne.i32($i76,0);
  $i126.shadow := $ne.i32($i76.shadow,0);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i127 := $xor.i1($i126,1);
  $i127.shadow := $xor.i1($i126.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i128 := $xor.i1($i127,1);
  $i128.shadow := $xor.i1($i127.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i129 := $zext.i1.i32($i128);
  $i129.shadow := $zext.i1.i32($i128.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i130 := $sext.i32.i64($i129);
  $i130.shadow := $sext.i32.i64($i129.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i131 := $xor.i64($i130,1);
  $i131.shadow := $xor.i64($i130.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i132 := $sub.i64($i131,1);
  $i132.shadow := $sub.i64($i131.shadow,1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i133 := $or.i64($i125,$i132);
  $i133.shadow := $or.i64($i125.shadow,$i132.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i134 := $and.i64($i117,$i133);
  $i134.shadow := $and.i64($i117.shadow,$i133.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i135 := $or.i64($i108,$i134);
  $i135.shadow := $or.i64($i108.shadow,$i134.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 48, 5} true;
  assume {:verifier.code 0} true;
  $i136 := $and.i64($i92,$i135);
  $i136.shadow := $and.i64($i92.shadow,$i135.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 47, 28} true;
  assume {:verifier.code 0} true;
  $i137 := $or.i64($i84,$i136);
  $i137.shadow := $or.i64($i84.shadow,$i136.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 47, 5} true;
  assume {:verifier.code 0} true;
  $i138 := $trunc.i64.i8($i137);
  $i138.shadow := $trunc.i64.i8($i137.shadow);
  call {:cexpr "result"} boogie_si_record_i8($i138);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 54, 3} true;
  assume {:verifier.code 0} true;
  $r := $i138;
  $r.shadow := $r;
  $exn := false;
...
axiom (__SMACK_dummy == $sub.ref(0,6192));
...
axiom (__SMACK_and32 == $sub.ref(0,7224));
...
axiom (__SMACK_and64 == $sub.ref(0,8256));
...
axiom (__SMACK_and16 == $sub.ref(0,9288));
...
axiom (__SMACK_and8 == $sub.ref(0,10320));
...
axiom (__SMACK_or32 == $sub.ref(0,11352));
...
axiom (__SMACK_or64 == $sub.ref(0,12384));
...
axiom (__SMACK_or16 == $sub.ref(0,13416));
...
axiom (__SMACK_or8 == $sub.ref(0,14448));
...
axiom (__SMACK_check_overflow == $sub.ref(0,15480));
...
axiom (__SMACK_loop_exit == $sub.ref(0,16512));
...
axiom (__SMACK_decls == $sub.ref(0,17544));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,18576));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,19608));
...
axiom (__SMACK_static_init == $sub.ref(0,20640));
