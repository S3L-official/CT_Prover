...
procedure {:entrypoint} fix_eq_wrapper($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1)
modifies $exn;
modifies $CurrAddr;
{
  var $i2: i8;
...
$bb0:
  ...
  assume {:sourceloc "fix_eq.c", 4, 2} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.dup := fix_eq($i0, $i0.dup, $i1, $i1.dup);
...
procedure {:inline 1} fix_eq($i0: i64, $i0.dup: i1, $i1: i64, $i1.dup: i1) returns ($r: i8, $r.dup: i1)
modifies $exn;
{
  var $i2: i64;
  var $i2.dup: i1;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i26 := $or.i32($i18,$i25);
  $i26.dup := $or.i1($i18.dup,$i25.dup);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i27 := $eq.i64($i0,$i1);
  $i27.dup := $or.i1($i0.dup,$i1.dup);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i1.i32($i27);
  $i28.dup := $i27.dup;
  ...
  assume {:verifier.code 0} true;
  $i29 := $or.i32($i26,$i28);
  $i29.dup := $or.i1($i26.dup,$i28.dup);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i30 := $and.i32($i11,$i29);
  $i30.dup := $or.i1($i11.dup,$i29.dup);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
