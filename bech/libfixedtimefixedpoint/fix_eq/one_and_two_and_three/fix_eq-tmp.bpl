...
const fix_eq_wrapper: ref;
axiom (fix_eq_wrapper == $sub.ref(0,2064));
procedure {:entrypoint} fix_eq_wrapper($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64)
modifies $exn;
modifies $CurrAddr;
{
  var $i2: i8;
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "fix_eq.c", 4, 2} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:fix_eq_wrapper"} boogie_si_record_ref(fix_eq_wrapper);
  call {:cexpr "smack:arg:fix_eq_wrapper:$i0"} boogie_si_record_i64($i0);
  call {:cexpr "smack:arg:fix_eq_wrapper:$i1"} boogie_si_record_i64($i1);
  call {:cexpr "fix_eq_wrapper:arg:op1"} boogie_si_record_i64($i0);
  call {:cexpr "fix_eq_wrapper:arg:op2"} boogie_si_record_i64($i1);
  assume {:sourceloc "fix_eq.c", 4, 2} true;
  assume {:verifier.code 0} true;
  call $i2, $i2.shadow := fix_eq($i0, $i0.shadow, $i1, $i1.shadow);
  assume {:sourceloc "fix_eq.c", 5, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := $exn;
...
const fix_eq: ref;
axiom (fix_eq == $sub.ref(0,3096));
procedure {:inline 1} fix_eq($i0: i64, $i0.shadow: i64, $i1: i64, $i1.shadow: i64) returns ($r: i8, $r.shadow: i8)
modifies $exn;
{
  var $i2: i64;
  var $i2.shadow: i64;
  ...
  var $i31.shadow: i8;
$bb0:
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "fix_eq:arg:op1"} boogie_si_record_i64($i0);
  call {:cexpr "fix_eq:arg:op2"} boogie_si_record_i64($i1);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $and.i64($i0,3);
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i1.i32($i10);
  $i11.shadow := $zext.i1.i32($i10.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i12 := $and.i64($i0,3);
  $i12.shadow := $and.i64($i0.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i13 := $eq.i64($i12,2);
  $i13.shadow := $eq.i64($i12.shadow,2);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i1.i32($i13);
  $i14.shadow := $zext.i1.i32($i13.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i15 := $and.i64($i1,3);
  $i15.shadow := $and.i64($i1.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i16 := $eq.i64($i15,2);
  $i16.shadow := $eq.i64($i15.shadow,2);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i17 := $zext.i1.i32($i16);
  $i17.shadow := $zext.i1.i32($i16.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i18 := $and.i32($i14,$i17);
  $i18.shadow := $and.i32($i14.shadow,$i17.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i19 := $and.i64($i0,3);
  $i19.shadow := $and.i64($i0.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i64($i19,3);
  $i20.shadow := $eq.i64($i19.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i21 := $zext.i1.i32($i20);
  $i21.shadow := $zext.i1.i32($i20.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i22 := $and.i64($i1,3);
  $i22.shadow := $and.i64($i1.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i23 := $eq.i64($i22,3);
  $i23.shadow := $eq.i64($i22.shadow,3);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i24 := $zext.i1.i32($i23);
  $i24.shadow := $zext.i1.i32($i23.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i25 := $and.i32($i21,$i24);
  $i25.shadow := $and.i32($i21.shadow,$i24.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i26 := $or.i32($i18,$i25);
  $i26.shadow := $or.i32($i18.shadow,$i25.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i27 := $eq.i64($i0,$i1);
  $i27.shadow := $eq.i64($i0.shadow,$i1.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i28 := $zext.i1.i32($i27);
  $i28.shadow := $zext.i1.i32($i27.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i29 := $or.i32($i26,$i28);
  $i29.shadow := $or.i32($i26.shadow,$i28.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i30 := $and.i32($i11,$i29);
  $i30.shadow := $and.i32($i11.shadow,$i29.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 10} true;
  assume {:verifier.code 0} true;
  $i31 := $trunc.i32.i8($i30);
  $i31.shadow := $trunc.i32.i8($i30.shadow);
  assume {:sourceloc "../libfixedtimefixedpoint/ftfp.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $r := $i31;
  $r.shadow := $r;
  $exn := false;
