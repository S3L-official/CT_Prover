...
define dso_local i8* @crypto_onetimeauth_poly1305_donna_implementation_name() #0 !dbg !170 {
  ret i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), !dbg !171
}
...
5:                                                ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.1.2, i64 0, i64 0), i32 142, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @__PRETTY_FUNCTION__.randombytes, i64 0, i64 0)) #8, !dbg !883
  unreachable, !dbg !883
...
define dso_local i8* @randombytes_sysrandom_implementation_name() #0 !dbg !889 {
  ret i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i64 0, i64 0), !dbg !890
}
...
define dso_local void @randombytes_sysrandom_stir() #0 !dbg !898 {
  %1 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !899
  %2 = icmp eq i32 %1, 0, !dbg !901
  br i1 %2, label %3, label %4, !dbg !902

3:                                                ; preds = %0
  call void @randombytes_sysrandom_init(), !dbg !903
  store i32 1, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !905
  br label %4, !dbg !906
...
define dso_local void @randombytes_sysrandom_buf(i8* %0, i64 %1) #0 !dbg !908 {
  ...
  %3 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !913
  %4 = icmp ne i32 %3, 0, !dbg !915
  br i1 %4, label %5, label %10, !dbg !916

5:                                                ; preds = %2
  %6 = call i32 @randombytes_linux_getrandom(i8* %0, i64 %1), !dbg !917
  %7 = icmp ne i32 %6, 0, !dbg !920
  br i1 %7, label %8, label %9, !dbg !921
...
10:                                               ; preds = %2
  %11 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !925
  %12 = icmp eq i32 %11, -1, !dbg !927
  br i1 %12, label %17, label %13, !dbg !928

13:                                               ; preds = %10
  %14 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !929
  %15 = call i64 @safe_read(i32 %14, i8* %0, i64 %1), !dbg !930
  %16 = icmp ne i64 %15, %1, !dbg !931
...
define dso_local i32 @randombytes_sysrandom_close() #0 !dbg !936 {
  ...
  %1 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !939
  %2 = icmp ne i32 %1, -1, !dbg !941
  br i1 %2, label %3, label %8, !dbg !942

3:                                                ; preds = %0
  %4 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !943
  %5 = call i32 @close(i32 %4), !dbg !944
  %6 = icmp eq i32 %5, 0, !dbg !945
  br i1 %6, label %7, label %8, !dbg !946

7:                                                ; preds = %3
  store i32 -1, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !947
  store i32 0, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !949
  call void @llvm.dbg.value(metadata i32 0, metadata !937, metadata !DIExpression()), !dbg !938
  br label %8, !dbg !950

8:                                                ; preds = %7, %3, %0
  %.0 = phi i32 [ 0, %7 ], [ -1, %3 ], [ -1, %0 ], !dbg !938
  call void @llvm.dbg.value(metadata i32 %.0, metadata !937, metadata !DIExpression()), !dbg !938
  %9 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !951
  %10 = icmp ne i32 %9, 0, !dbg !953
  br i1 %10, label %11, label %12, !dbg !954
...
define internal void @randombytes_sysrandom_stir_if_needed() #0 !dbg !958 {
  %1 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !959
  %2 = icmp eq i32 %1, 0, !dbg !961
  br i1 %2, label %3, label %4, !dbg !962
...
3:                                                ; preds = %17, %2
  %.03 = phi i8* [ %0, %2 ], [ %16, %17 ], !dbg !971
  %.02 = phi i64 [ %1, %2 ], [ %15, %17 ]
  %.01 = phi i64 [ 256, %2 ], [ %.1, %17 ], !dbg !971
...
8:                                                ; preds = %5
  call void @__assert_fail(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str.4, i64 0, i64 0), i32 159, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @__PRETTY_FUNCTION__.randombytes_linux_getrandom, i64 0, i64 0)) #8, !dbg !980
  unreachable, !dbg !980
...
10:                                               ; preds = %9, %3
  %.1 = phi i64 [ %.02, %9 ], [ %.01, %3 ], !dbg !971
  call void @llvm.dbg.value(metadata i64 %.1, metadata !974, metadata !DIExpression()), !dbg !971
  %11 = call i32 @_randombytes_linux_getrandom(i8* %.03, i64 %.1), !dbg !986
  %12 = icmp ne i32 %11, 0, !dbg !988
  br i1 %12, label %13, label %14, !dbg !989

13:                                               ; preds = %10
  br label %20, !dbg !990

14:                                               ; preds = %10
  %15 = sub i64 %.02, %.1, !dbg !992
  call void @llvm.dbg.value(metadata i64 %15, metadata !972, metadata !DIExpression()), !dbg !971
  %16 = getelementptr inbounds i8, i8* %.03, i64 %.1, !dbg !993
  call void @llvm.dbg.value(metadata i8* %16, metadata !973, metadata !DIExpression()), !dbg !971
  br label %17, !dbg !994

17:                                               ; preds = %14
  %18 = icmp ugt i64 %15, 0, !dbg !995
  br i1 %18, label %3, label %19, !dbg !994, !llvm.loop !996

19:                                               ; preds = %17
  br label %20, !dbg !998

20:                                               ; preds = %19, %13
  %.0 = phi i32 [ -1, %13 ], [ 0, %19 ], !dbg !971
  ret i32 %.0, !dbg !999
}
...
6:                                                ; preds = %3
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str.4, i64 0, i64 0), i32 82, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__PRETTY_FUNCTION__.safe_read, i64 0, i64 0)) #8, !dbg !1009
...
9:                                                ; preds = %24, %8
  %10 = call i64 @read(i32 %0, i8* %.01, i64 %.02), !dbg !1016
  call void @llvm.dbg.value(metadata i64 %10, metadata !1017, metadata !DIExpression()), !dbg !1005
  %11 = icmp slt i64 %10, 0, !dbg !1018
  br i1 %11, label %12, label %22, !dbg !1019

12:                                               ; preds = %9
  %13 = call i32* @__errno_location() #9, !dbg !1020
  %14 = load i32, i32* %13, align 4, !dbg !1020
  %15 = icmp eq i32 %14, 4, !dbg !1021
  br i1 %15, label %20, label %16, !dbg !1022

16:                                               ; preds = %12
  %17 = call i32* @__errno_location() #9, !dbg !1023
  %18 = load i32, i32* %17, align 4, !dbg !1023
  %19 = icmp eq i32 %18, 11, !dbg !1024
  br label %20, !dbg !1022
...
22:                                               ; preds = %20, %9
  %23 = phi i1 [ false, %9 ], [ %21, %20 ], !dbg !1025
  br i1 %23, label %24, label %25, !dbg !1014

24:                                               ; preds = %22
  br label %9, !dbg !1014, !llvm.loop !1026

25:                                               ; preds = %22
  %26 = icmp slt i64 %10, 0, !dbg !1028
  br i1 %26, label %27, label %28, !dbg !1030

27:                                               ; preds = %25
  br label %40, !dbg !1031

28:                                               ; preds = %25
  %29 = icmp eq i64 %10, 0, !dbg !1033
  br i1 %29, label %30, label %31, !dbg !1035

30:                                               ; preds = %28
  br label %36, !dbg !1036

31:                                               ; preds = %28
  %32 = sub i64 %.02, %10, !dbg !1038
  call void @llvm.dbg.value(metadata i64 %32, metadata !1007, metadata !DIExpression()), !dbg !1005
  %33 = getelementptr inbounds i8, i8* %.01, i64 %10, !dbg !1039
  call void @llvm.dbg.value(metadata i8* %33, metadata !1008, metadata !DIExpression()), !dbg !1005
  br label %34, !dbg !1040

34:                                               ; preds = %31
  %35 = icmp ugt i64 %32, 0, !dbg !1041
  br i1 %35, label %8, label %36, !dbg !1040, !llvm.loop !1042

36:                                               ; preds = %34, %30
  %.1 = phi i8* [ %.01, %30 ], [ %33, %34 ], !dbg !1005
  call void @llvm.dbg.value(metadata i8* %.1, metadata !1008, metadata !DIExpression()), !dbg !1005
  %37 = ptrtoint i8* %.1 to i64, !dbg !1044
  %38 = ptrtoint i8* %1 to i64, !dbg !1044
  %39 = sub i64 %37, %38, !dbg !1044
  br label %40, !dbg !1045

40:                                               ; preds = %36, %27
  %.0 = phi i64 [ %10, %27 ], [ %39, %36 ], !dbg !1005
  ret i64 %.0, !dbg !1046
}
...
5:                                                ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str.4, i64 0, i64 0), i32 142, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__PRETTY_FUNCTION__._randombytes_linux_getrandom, i64 0, i64 0)) #8, !dbg !1053
...
7:                                                ; preds = %23, %6
  %8 = trunc i64 %1 to i32, !dbg !1058
  %9 = call i64 (i64, ...) @syscall(i64 318, i8* %0, i32 %8, i32 0) #10, !dbg !1060
  %10 = trunc i64 %9 to i32, !dbg !1060
  call void @llvm.dbg.value(metadata i32 %10, metadata !1061, metadata !DIExpression()), !dbg !1051
  br label %11, !dbg !1062

11:                                               ; preds = %7
  %12 = icmp slt i32 %10, 0, !dbg !1063
  br i1 %12, label %13, label %23, !dbg !1064

13:                                               ; preds = %11
  %14 = call i32* @__errno_location() #9, !dbg !1065
  %15 = load i32, i32* %14, align 4, !dbg !1065
  %16 = icmp eq i32 %15, 4, !dbg !1066
  br i1 %16, label %21, label %17, !dbg !1067

17:                                               ; preds = %13
  %18 = call i32* @__errno_location() #9, !dbg !1068
  %19 = load i32, i32* %18, align 4, !dbg !1068
  %20 = icmp eq i32 %19, 11, !dbg !1069
...
23:                                               ; preds = %21, %11
  %24 = phi i1 [ false, %11 ], [ %22, %21 ], !dbg !1051
  br i1 %24, label %7, label %25, !dbg !1062, !llvm.loop !1070

25:                                               ; preds = %23
  %26 = trunc i64 %1 to i32, !dbg !1072
  %27 = icmp eq i32 %10, %26, !dbg !1073
  %28 = zext i1 %27 to i32, !dbg !1073
  %29 = sub nsw i32 %28, 1, !dbg !1074
  ret i32 %29, !dbg !1075
}
...
define internal void @randombytes_sysrandom_init() #0 !dbg !1076 {
  ...
  br i1 %6, label %7, label %9, !dbg !1087

7:                                                ; preds = %0
  store i32 1, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !1088
  %8 = call i32* @__errno_location() #9, !dbg !1090
  store i32 %3, i32* %8, align 4, !dbg !1091
  br label %15, !dbg !1092

9:                                                ; preds = %0
  store i32 0, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !1093
  %10 = call i32 @randombytes_sysrandom_random_dev_open(), !dbg !1094
  store i32 %10, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !1096
  %11 = icmp eq i32 %10, -1, !dbg !1097
  br i1 %11, label %12, label %13, !dbg !1098
...
13:                                               ; preds = %9
  %14 = call i32* @__errno_location() #9, !dbg !1101
  store i32 %3, i32* %14, align 4, !dbg !1102
...
2:                                                ; preds = %28, %0
  %.01 = phi i8** [ getelementptr inbounds ([3 x i8*], [3 x i8*]* @randombytes_sysrandom_random_dev_open.devices, i64 0, i64 0), %0 ], [ %.1, %28 ], !dbg !1143
  call void @llvm.dbg.value(metadata i8** %.01, metadata !1141, metadata !DIExpression()), !dbg !1143
  %3 = load i8*, i8** %.01, align 8, !dbg !1145
  %4 = call i32 (i8*, i32, ...) @open(i8* %3, i32 0), !dbg !1147
  call void @llvm.dbg.value(metadata i32 %4, metadata !1148, metadata !DIExpression()), !dbg !1143
  %5 = icmp ne i32 %4, -1, !dbg !1149
  br i1 %5, label %6, label %20, !dbg !1151

6:                                                ; preds = %2
  %7 = call i32 @fstat(i32 %4, %struct.stat* %1) #10, !dbg !1152
  %8 = icmp eq i32 %7, 0, !dbg !1155
  br i1 %8, label %9, label %18, !dbg !1156

9:                                                ; preds = %6
  %10 = getelementptr inbounds %struct.stat, %struct.stat* %1, i32 0, i32 3, !dbg !1157
  %11 = load i32, i32* %10, align 8, !dbg !1157
  %12 = and i32 %11, 61440, !dbg !1157
  %13 = icmp eq i32 %12, 8192, !dbg !1157
  br i1 %13, label %14, label %18, !dbg !1158

14:                                               ; preds = %9
  %15 = call i32 (i32, i32, ...) @fcntl(i32 %4, i32 1), !dbg !1159
  %16 = or i32 %15, 1, !dbg !1161
  %17 = call i32 (i32, i32, ...) @fcntl(i32 %4, i32 2, i32 %16), !dbg !1162
  br label %33, !dbg !1163

18:                                               ; preds = %9, %6
  %19 = call i32 @close(i32 %4), !dbg !1164
  br label %26, !dbg !1165

20:                                               ; preds = %2
  %21 = call i32* @__errno_location() #9, !dbg !1166
  %22 = load i32, i32* %21, align 4, !dbg !1166
  %23 = icmp eq i32 %22, 4, !dbg !1168
...
26:                                               ; preds = %25, %18
  %27 = getelementptr inbounds i8*, i8** %.01, i32 1, !dbg !1172
  call void @llvm.dbg.value(metadata i8** %27, metadata !1141, metadata !DIExpression()), !dbg !1143
  br label %28, !dbg !1173

28:                                               ; preds = %26, %24
  %.1 = phi i8** [ %27, %26 ], [ %.01, %24 ], !dbg !1143
  call void @llvm.dbg.value(metadata i8** %.1, metadata !1141, metadata !DIExpression()), !dbg !1143
  %29 = load i8*, i8** %.1, align 8, !dbg !1174
  %30 = icmp ne i8* %29, null, !dbg !1175
  br i1 %30, label %2, label %31, !dbg !1173, !llvm.loop !1176

31:                                               ; preds = %28
  %32 = call i32* @__errno_location() #9, !dbg !1178
  store i32 5, i32* %32, align 4, !dbg !1179
  br label %33, !dbg !1180

33:                                               ; preds = %31, %14
  %.0 = phi i32 [ %4, %14 ], [ -1, %31 ], !dbg !1143
  ret i32 %.0, !dbg !1181
}
...
define dso_local i32 @_sodium_alloc_init() #0 !dbg !1419 {
  call void @randombytes_buf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @canary, i64 0, i64 0), i64 16), !dbg !1420
  ret i32 0, !dbg !1421
}
