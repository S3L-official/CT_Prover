...
5:                                                ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.1, i64 0, i64 0), i32 142, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @__PRETTY_FUNCTION__.randombytes, i64 0, i64 0)) #8, !dbg !543
  unreachable, !dbg !543
...
define dso_local i8* @randombytes_sysrandom_implementation_name() #0 !dbg !549 {
  ret i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i64 0, i64 0), !dbg !550
}
...
define dso_local void @randombytes_sysrandom_stir() #0 !dbg !558 {
  %1 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !559
  %2 = icmp eq i32 %1, 0, !dbg !561
  br i1 %2, label %3, label %4, !dbg !562

3:                                                ; preds = %0
  call void @randombytes_sysrandom_init(), !dbg !563
  store i32 1, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !565
  br label %4, !dbg !566
...
define dso_local void @randombytes_sysrandom_buf(i8* %0, i64 %1) #0 !dbg !568 {
  ...
  %3 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !573
  %4 = icmp ne i32 %3, 0, !dbg !575
  br i1 %4, label %5, label %10, !dbg !576

5:                                                ; preds = %2
  %6 = call i32 @randombytes_linux_getrandom(i8* %0, i64 %1), !dbg !577
  %7 = icmp ne i32 %6, 0, !dbg !580
  br i1 %7, label %8, label %9, !dbg !581
...
10:                                               ; preds = %2
  %11 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !585
  %12 = icmp eq i32 %11, -1, !dbg !587
  br i1 %12, label %17, label %13, !dbg !588

13:                                               ; preds = %10
  %14 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !589
  %15 = call i64 @safe_read(i32 %14, i8* %0, i64 %1), !dbg !590
  %16 = icmp ne i64 %15, %1, !dbg !591
  br i1 %16, label %17, label %18, !dbg !592
...
define dso_local i32 @randombytes_sysrandom_close() #0 !dbg !596 {
  ...
  %1 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !599
  %2 = icmp ne i32 %1, -1, !dbg !601
  br i1 %2, label %3, label %8, !dbg !602

3:                                                ; preds = %0
  %4 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !603
  %5 = call i32 @close(i32 %4), !dbg !604
  %6 = icmp eq i32 %5, 0, !dbg !605
  br i1 %6, label %7, label %8, !dbg !606

7:                                                ; preds = %3
  store i32 -1, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !607
  store i32 0, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !609
  call void @llvm.dbg.value(metadata i32 0, metadata !597, metadata !DIExpression()), !dbg !598
  br label %8, !dbg !610

8:                                                ; preds = %7, %3, %0
  %.0 = phi i32 [ 0, %7 ], [ -1, %3 ], [ -1, %0 ], !dbg !598
  call void @llvm.dbg.value(metadata i32 %.0, metadata !597, metadata !DIExpression()), !dbg !598
  %9 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !611
  %10 = icmp ne i32 %9, 0, !dbg !613
  br i1 %10, label %11, label %12, !dbg !614
...
define internal void @randombytes_sysrandom_stir_if_needed() #0 !dbg !618 {
  %1 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !619
  %2 = icmp eq i32 %1, 0, !dbg !621
  br i1 %2, label %3, label %4, !dbg !622
...
3:                                                ; preds = %17, %2
  %.03 = phi i8* [ %0, %2 ], [ %16, %17 ], !dbg !631
  %.02 = phi i64 [ %1, %2 ], [ %15, %17 ]
  %.01 = phi i64 [ 256, %2 ], [ %.1, %17 ], !dbg !631
  ...
  br i1 %4, label %5, label %10, !dbg !639
...
8:                                                ; preds = %5
  call void @__assert_fail(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str.4, i64 0, i64 0), i32 159, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @__PRETTY_FUNCTION__.randombytes_linux_getrandom, i64 0, i64 0)) #8, !dbg !640
  unreachable, !dbg !640
...
10:                                               ; preds = %9, %3
  %.1 = phi i64 [ %.02, %9 ], [ %.01, %3 ], !dbg !631
  call void @llvm.dbg.value(metadata i64 %.1, metadata !634, metadata !DIExpression()), !dbg !631
  %11 = call i32 @_randombytes_linux_getrandom(i8* %.03, i64 %.1), !dbg !646
  %12 = icmp ne i32 %11, 0, !dbg !648
  br i1 %12, label %13, label %14, !dbg !649

13:                                               ; preds = %10
  br label %20, !dbg !650

14:                                               ; preds = %10
  %15 = sub i64 %.02, %.1, !dbg !652
  call void @llvm.dbg.value(metadata i64 %15, metadata !632, metadata !DIExpression()), !dbg !631
  %16 = getelementptr inbounds i8, i8* %.03, i64 %.1, !dbg !653
  call void @llvm.dbg.value(metadata i8* %16, metadata !633, metadata !DIExpression()), !dbg !631
  br label %17, !dbg !654

17:                                               ; preds = %14
  %18 = icmp ugt i64 %15, 0, !dbg !655
  br i1 %18, label %3, label %19, !dbg !654, !llvm.loop !656

19:                                               ; preds = %17
  br label %20, !dbg !658

20:                                               ; preds = %19, %13
  %.0 = phi i32 [ -1, %13 ], [ 0, %19 ], !dbg !631
  ret i32 %.0, !dbg !659
}
...
6:                                                ; preds = %3
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str.4, i64 0, i64 0), i32 82, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__PRETTY_FUNCTION__.safe_read, i64 0, i64 0)) #8, !dbg !669
  unreachable, !dbg !669
...
9:                                                ; preds = %24, %8
  %10 = call i64 @read(i32 %0, i8* %.01, i64 %.02), !dbg !676
  call void @llvm.dbg.value(metadata i64 %10, metadata !677, metadata !DIExpression()), !dbg !665
  %11 = icmp slt i64 %10, 0, !dbg !678
  br i1 %11, label %12, label %22, !dbg !679

12:                                               ; preds = %9
  %13 = call i32* @__errno_location() #9, !dbg !680
  %14 = load i32, i32* %13, align 4, !dbg !680
  %15 = icmp eq i32 %14, 4, !dbg !681
  br i1 %15, label %20, label %16, !dbg !682

16:                                               ; preds = %12
  %17 = call i32* @__errno_location() #9, !dbg !683
  %18 = load i32, i32* %17, align 4, !dbg !683
  %19 = icmp eq i32 %18, 11, !dbg !684
  br label %20, !dbg !682
...
22:                                               ; preds = %20, %9
  %23 = phi i1 [ false, %9 ], [ %21, %20 ], !dbg !685
  br i1 %23, label %24, label %25, !dbg !674

24:                                               ; preds = %22
  br label %9, !dbg !674, !llvm.loop !686

25:                                               ; preds = %22
  %26 = icmp slt i64 %10, 0, !dbg !688
  br i1 %26, label %27, label %28, !dbg !690

27:                                               ; preds = %25
  br label %40, !dbg !691

28:                                               ; preds = %25
  %29 = icmp eq i64 %10, 0, !dbg !693
  br i1 %29, label %30, label %31, !dbg !695

30:                                               ; preds = %28
  br label %36, !dbg !696

31:                                               ; preds = %28
  %32 = sub i64 %.02, %10, !dbg !698
  call void @llvm.dbg.value(metadata i64 %32, metadata !667, metadata !DIExpression()), !dbg !665
  %33 = getelementptr inbounds i8, i8* %.01, i64 %10, !dbg !699
  call void @llvm.dbg.value(metadata i8* %33, metadata !668, metadata !DIExpression()), !dbg !665
  br label %34, !dbg !700

34:                                               ; preds = %31
  %35 = icmp ugt i64 %32, 0, !dbg !701
  br i1 %35, label %8, label %36, !dbg !700, !llvm.loop !702

36:                                               ; preds = %34, %30
  %.1 = phi i8* [ %.01, %30 ], [ %33, %34 ], !dbg !665
  call void @llvm.dbg.value(metadata i8* %.1, metadata !668, metadata !DIExpression()), !dbg !665
  %37 = ptrtoint i8* %.1 to i64, !dbg !704
  %38 = ptrtoint i8* %1 to i64, !dbg !704
  %39 = sub i64 %37, %38, !dbg !704
  br label %40, !dbg !705

40:                                               ; preds = %36, %27
  %.0 = phi i64 [ %10, %27 ], [ %39, %36 ], !dbg !665
  ret i64 %.0, !dbg !706
}
...
5:                                                ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str.4, i64 0, i64 0), i32 142, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__PRETTY_FUNCTION__._randombytes_linux_getrandom, i64 0, i64 0)) #8, !dbg !713
  unreachable, !dbg !713
...
7:                                                ; preds = %23, %6
  %8 = trunc i64 %1 to i32, !dbg !718
  %9 = call i64 (i64, ...) @syscall(i64 318, i8* %0, i32 %8, i32 0) #10, !dbg !720
  %10 = trunc i64 %9 to i32, !dbg !720
  call void @llvm.dbg.value(metadata i32 %10, metadata !721, metadata !DIExpression()), !dbg !711
  br label %11, !dbg !722

11:                                               ; preds = %7
  %12 = icmp slt i32 %10, 0, !dbg !723
  br i1 %12, label %13, label %23, !dbg !724

13:                                               ; preds = %11
  %14 = call i32* @__errno_location() #9, !dbg !725
  %15 = load i32, i32* %14, align 4, !dbg !725
  %16 = icmp eq i32 %15, 4, !dbg !726
  br i1 %16, label %21, label %17, !dbg !727

17:                                               ; preds = %13
  %18 = call i32* @__errno_location() #9, !dbg !728
  %19 = load i32, i32* %18, align 4, !dbg !728
  %20 = icmp eq i32 %19, 11, !dbg !729
  br label %21, !dbg !727
...
23:                                               ; preds = %21, %11
  %24 = phi i1 [ false, %11 ], [ %22, %21 ], !dbg !711
  br i1 %24, label %7, label %25, !dbg !722, !llvm.loop !730

25:                                               ; preds = %23
  %26 = trunc i64 %1 to i32, !dbg !732
  %27 = icmp eq i32 %10, %26, !dbg !733
  %28 = zext i1 %27 to i32, !dbg !733
  %29 = sub nsw i32 %28, 1, !dbg !734
  ret i32 %29, !dbg !735
}
...
define internal void @randombytes_sysrandom_init() #0 !dbg !736 {
  ...
  br i1 %6, label %7, label %9, !dbg !747

7:                                                ; preds = %0
  store i32 1, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !748
  %8 = call i32* @__errno_location() #9, !dbg !750
  store i32 %3, i32* %8, align 4, !dbg !751
  br label %15, !dbg !752

9:                                                ; preds = %0
  store i32 0, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !753
  %10 = call i32 @randombytes_sysrandom_random_dev_open(), !dbg !754
  store i32 %10, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !756
  %11 = icmp eq i32 %10, -1, !dbg !757
  br i1 %11, label %12, label %13, !dbg !758
...
13:                                               ; preds = %9
  %14 = call i32* @__errno_location() #9, !dbg !761
  store i32 %3, i32* %14, align 4, !dbg !762
  br label %15, !dbg !763
...
2:                                                ; preds = %28, %0
  %.01 = phi i8** [ getelementptr inbounds ([3 x i8*], [3 x i8*]* @randombytes_sysrandom_random_dev_open.devices, i64 0, i64 0), %0 ], [ %.1, %28 ], !dbg !803
  call void @llvm.dbg.value(metadata i8** %.01, metadata !801, metadata !DIExpression()), !dbg !803
  %3 = load i8*, i8** %.01, align 8, !dbg !805
  %4 = call i32 (i8*, i32, ...) @open(i8* %3, i32 0), !dbg !807
  call void @llvm.dbg.value(metadata i32 %4, metadata !808, metadata !DIExpression()), !dbg !803
  %5 = icmp ne i32 %4, -1, !dbg !809
  br i1 %5, label %6, label %20, !dbg !811

6:                                                ; preds = %2
  %7 = call i32 @fstat(i32 %4, %struct.stat* %1) #10, !dbg !812
  %8 = icmp eq i32 %7, 0, !dbg !815
  br i1 %8, label %9, label %18, !dbg !816

9:                                                ; preds = %6
  %10 = getelementptr inbounds %struct.stat, %struct.stat* %1, i32 0, i32 3, !dbg !817
  %11 = load i32, i32* %10, align 8, !dbg !817
  %12 = and i32 %11, 61440, !dbg !817
  %13 = icmp eq i32 %12, 8192, !dbg !817
  br i1 %13, label %14, label %18, !dbg !818

14:                                               ; preds = %9
  %15 = call i32 (i32, i32, ...) @fcntl(i32 %4, i32 1), !dbg !819
  %16 = or i32 %15, 1, !dbg !821
  %17 = call i32 (i32, i32, ...) @fcntl(i32 %4, i32 2, i32 %16), !dbg !822
  br label %33, !dbg !823

18:                                               ; preds = %9, %6
  %19 = call i32 @close(i32 %4), !dbg !824
  br label %26, !dbg !825

20:                                               ; preds = %2
  %21 = call i32* @__errno_location() #9, !dbg !826
  %22 = load i32, i32* %21, align 4, !dbg !826
  %23 = icmp eq i32 %22, 4, !dbg !828
  br i1 %23, label %24, label %25, !dbg !829
...
26:                                               ; preds = %25, %18
  %27 = getelementptr inbounds i8*, i8** %.01, i32 1, !dbg !832
  call void @llvm.dbg.value(metadata i8** %27, metadata !801, metadata !DIExpression()), !dbg !803
  br label %28, !dbg !833

28:                                               ; preds = %26, %24
  %.1 = phi i8** [ %27, %26 ], [ %.01, %24 ], !dbg !803
  call void @llvm.dbg.value(metadata i8** %.1, metadata !801, metadata !DIExpression()), !dbg !803
  %29 = load i8*, i8** %.1, align 8, !dbg !834
  %30 = icmp ne i8* %29, null, !dbg !835
  br i1 %30, label %2, label %31, !dbg !833, !llvm.loop !836

31:                                               ; preds = %28
  %32 = call i32* @__errno_location() #9, !dbg !838
  store i32 5, i32* %32, align 4, !dbg !839
  br label %33, !dbg !840

33:                                               ; preds = %31, %14
  %.0 = phi i32 [ %4, %14 ], [ -1, %31 ], !dbg !803
  ret i32 %.0, !dbg !841
}
...
define dso_local i32 @_sodium_alloc_init() #0 !dbg !1079 {
  call void @randombytes_buf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @canary, i64 0, i64 0), i64 16), !dbg !1080
  ret i32 0, !dbg !1081
}
