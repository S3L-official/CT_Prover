...
axiom (crypto_core_salsa20 == $sub.ref(0,2064));
procedure {:inline 1} crypto_core_salsa20($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref) returns ($r: i32, $r.shadow: i32)
modifies $exn;
modifies $M.1;
{
  var $p4: ref;
  ...
  var $p182.shadow: ref;
$bb0:
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 47, 33} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 47, 33} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p3,$mul.ref(0,1));
  $p4.shadow := $add.ref($p3.shadow,$mul.ref(0,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 47, 13} true;
  assume {:verifier.code 0} true;
  call $i5, $i5.shadow := load_littleendian($p4, $p4.shadow);
  call {:cexpr "x0"} boogie_si_record_i32($i5);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 48, 33} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p2,$mul.ref(0,1));
  $p6.shadow := $add.ref($p2.shadow,$mul.ref(0,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 48, 13} true;
  assume {:verifier.code 0} true;
  call $i7, $i7.shadow := load_littleendian($p6, $p6.shadow);
  call {:cexpr "x1"} boogie_si_record_i32($i7);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 49, 33} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($p2,$mul.ref(4,1));
  $p8.shadow := $add.ref($p2.shadow,$mul.ref(4,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 49, 13} true;
  assume {:verifier.code 0} true;
  call $i9, $i9.shadow := load_littleendian($p8, $p8.shadow);
  call {:cexpr "x2"} boogie_si_record_i32($i9);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 50, 33} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($p2,$mul.ref(8,1));
  $p10.shadow := $add.ref($p2.shadow,$mul.ref(8,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 50, 13} true;
  assume {:verifier.code 0} true;
  call $i11, $i11.shadow := load_littleendian($p10, $p10.shadow);
  call {:cexpr "x3"} boogie_si_record_i32($i11);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 51, 33} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p2,$mul.ref(12,1));
  $p12.shadow := $add.ref($p2.shadow,$mul.ref(12,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 51, 13} true;
  assume {:verifier.code 0} true;
  call $i13, $i13.shadow := load_littleendian($p12, $p12.shadow);
  call {:cexpr "x4"} boogie_si_record_i32($i13);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 52, 33} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p3,$mul.ref(4,1));
  $p14.shadow := $add.ref($p3.shadow,$mul.ref(4,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 52, 13} true;
  assume {:verifier.code 0} true;
  call $i15, $i15.shadow := load_littleendian($p14, $p14.shadow);
  call {:cexpr "x5"} boogie_si_record_i32($i15);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 53, 34} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p1,$mul.ref(0,1));
  $p16.shadow := $add.ref($p1.shadow,$mul.ref(0,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 53, 13} true;
  assume {:verifier.code 0} true;
  call $i17, $i17.shadow := load_littleendian($p16, $p16.shadow);
  call {:cexpr "x6"} boogie_si_record_i32($i17);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 54, 34} true;
  assume {:verifier.code 0} true;
  $p18 := $add.ref($p1,$mul.ref(4,1));
  $p18.shadow := $add.ref($p1.shadow,$mul.ref(4,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 54, 13} true;
  assume {:verifier.code 0} true;
  call $i19, $i19.shadow := load_littleendian($p18, $p18.shadow);
  call {:cexpr "x7"} boogie_si_record_i32($i19);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 55, 34} true;
  assume {:verifier.code 0} true;
  $p20 := $add.ref($p1,$mul.ref(8,1));
  $p20.shadow := $add.ref($p1.shadow,$mul.ref(8,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 55, 13} true;
  assume {:verifier.code 0} true;
  call $i21, $i21.shadow := load_littleendian($p20, $p20.shadow);
  call {:cexpr "x8"} boogie_si_record_i32($i21);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 56, 34} true;
  assume {:verifier.code 0} true;
  $p22 := $add.ref($p1,$mul.ref(12,1));
  $p22.shadow := $add.ref($p1.shadow,$mul.ref(12,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 56, 13} true;
  assume {:verifier.code 0} true;
  call $i23, $i23.shadow := load_littleendian($p22, $p22.shadow);
  call {:cexpr "x9"} boogie_si_record_i32($i23);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 57, 35} true;
  assume {:verifier.code 0} true;
  $p24 := $add.ref($p3,$mul.ref(8,1));
  $p24.shadow := $add.ref($p3.shadow,$mul.ref(8,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 57, 15} true;
  assume {:verifier.code 0} true;
  call $i25, $i25.shadow := load_littleendian($p24, $p24.shadow);
  call {:cexpr "x10"} boogie_si_record_i32($i25);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 58, 35} true;
  assume {:verifier.code 0} true;
  $p26 := $add.ref($p2,$mul.ref(16,1));
  $p26.shadow := $add.ref($p2.shadow,$mul.ref(16,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 58, 15} true;
  assume {:verifier.code 0} true;
  call $i27, $i27.shadow := load_littleendian($p26, $p26.shadow);
  call {:cexpr "x11"} boogie_si_record_i32($i27);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 59, 35} true;
  assume {:verifier.code 0} true;
  $p28 := $add.ref($p2,$mul.ref(20,1));
  $p28.shadow := $add.ref($p2.shadow,$mul.ref(20,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 59, 15} true;
  assume {:verifier.code 0} true;
  call $i29, $i29.shadow := load_littleendian($p28, $p28.shadow);
  call {:cexpr "x12"} boogie_si_record_i32($i29);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 60, 35} true;
  assume {:verifier.code 0} true;
  $p30 := $add.ref($p2,$mul.ref(24,1));
  $p30.shadow := $add.ref($p2.shadow,$mul.ref(24,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 60, 15} true;
  assume {:verifier.code 0} true;
  call $i31, $i31.shadow := load_littleendian($p30, $p30.shadow);
  call {:cexpr "x13"} boogie_si_record_i32($i31);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 61, 35} true;
  assume {:verifier.code 0} true;
  $p32 := $add.ref($p2,$mul.ref(28,1));
  $p32.shadow := $add.ref($p2.shadow,$mul.ref(28,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 61, 15} true;
  assume {:verifier.code 0} true;
  call $i33, $i33.shadow := load_littleendian($p32, $p32.shadow);
  call {:cexpr "x14"} boogie_si_record_i32($i33);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 62, 35} true;
  assume {:verifier.code 0} true;
  $p34 := $add.ref($p3,$mul.ref(12,1));
  $p34.shadow := $add.ref($p3.shadow,$mul.ref(12,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 62, 15} true;
  assume {:verifier.code 0} true;
  call $i35, $i35.shadow := load_littleendian($p34, $p34.shadow);
  call {:cexpr "x15"} boogie_si_record_i32($i35);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 64, 8} true;
  assume {:verifier.code 0} true;
  $i36 := $i29;
  $i36.shadow := $i29.shadow;
  $i37 := $i27;
  $i37.shadow := $i27.shadow;
  $i38 := $i25;
  $i38.shadow := $i25.shadow;
  $i39 := $i23;
  $i39.shadow := $i23.shadow;
  $i40 := $i21;
  $i40.shadow := $i21.shadow;
  $i41 := $i19;
  $i41.shadow := $i19.shadow;
  $i42 := $i17;
  $i42.shadow := $i17.shadow;
  $i43 := $i15;
  $i43.shadow := $i15.shadow;
  $i44 := $i13;
  $i44.shadow := $i13.shadow;
  $i45 := $i11;
  $i45.shadow := $i11.shadow;
  $i46 := $i9;
  $i46.shadow := $i9.shadow;
  $i47 := $i7;
  $i47.shadow := $i7.shadow;
  $i48 := $i5;
  $i48.shadow := $i5.shadow;
  $i49 := $i31;
  $i49.shadow := $i31.shadow;
  $i50 := $i33;
  $i50.shadow := $i33.shadow;
  $i51 := $i35;
  $i51.shadow := $i35.shadow;
  $i52 := 20;
  $i52.shadow := 20;
  goto $bb1;
$bb1:
  ...
  assert {:unlikely_shadow_invariant ($i51 == $i51.shadow)} true;
  ...
  assert {:unlikely_shadow_invariant ($i48 == $i48.shadow)} true;
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 0, 0} true;
  ...
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 64, 21} true;
  assume {:verifier.code 0} true;
  $i53 := $sgt.i32($i52,0);
  $i53.shadow := $sgt.i32($i52.shadow,0);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 64, 3} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i53 == 1);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 65, 22} true;
  assume {:verifier.code 0} true;
  $i54 := $add.i32($i48,$i36);
  $i54.shadow := $add.i32($i48.shadow,$i36.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 65, 12} true;
  assume {:verifier.code 0} true;
  call $i55, $i55.shadow := rotate($i54, $i54.shadow, 7, 7);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 65, 9} true;
  assume {:verifier.code 0} true;
  $i56 := $xor.i32($i44,$i55);
  $i56.shadow := $xor.i32($i44.shadow,$i55.shadow);
  call {:cexpr "x4"} boogie_si_record_i32($i56);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 66, 22} true;
  assume {:verifier.code 0} true;
  $i57 := $add.i32($i56,$i48);
  $i57.shadow := $add.i32($i56.shadow,$i48.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 66, 12} true;
  assume {:verifier.code 0} true;
  call $i58, $i58.shadow := rotate($i57, $i57.shadow, 9, 9);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 66, 9} true;
  assume {:verifier.code 0} true;
  $i59 := $xor.i32($i40,$i58);
  $i59.shadow := $xor.i32($i40.shadow,$i58.shadow);
  call {:cexpr "x8"} boogie_si_record_i32($i59);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 67, 22} true;
  assume {:verifier.code 0} true;
  $i60 := $add.i32($i59,$i56);
  $i60.shadow := $add.i32($i59.shadow,$i56.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 67, 12} true;
  assume {:verifier.code 0} true;
  call $i61, $i61.shadow := rotate($i60, $i60.shadow, 13, 13);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 67, 9} true;
  assume {:verifier.code 0} true;
  $i62 := $xor.i32($i36,$i61);
  $i62.shadow := $xor.i32($i36.shadow,$i61.shadow);
  call {:cexpr "x12"} boogie_si_record_i32($i62);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 68, 22} true;
  assume {:verifier.code 0} true;
  $i63 := $add.i32($i62,$i59);
  $i63.shadow := $add.i32($i62.shadow,$i59.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 68, 12} true;
  assume {:verifier.code 0} true;
  call $i64, $i64.shadow := rotate($i63, $i63.shadow, 18, 18);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 68, 9} true;
  assume {:verifier.code 0} true;
  $i65 := $xor.i32($i48,$i64);
  $i65.shadow := $xor.i32($i48.shadow,$i64.shadow);
  call {:cexpr "x0"} boogie_si_record_i32($i65);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 69, 22} true;
  assume {:verifier.code 0} true;
  $i66 := $add.i32($i43,$i47);
  $i66.shadow := $add.i32($i43.shadow,$i47.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 69, 12} true;
  assume {:verifier.code 0} true;
  call $i67, $i67.shadow := rotate($i66, $i66.shadow, 7, 7);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 69, 9} true;
  assume {:verifier.code 0} true;
  $i68 := $xor.i32($i39,$i67);
  $i68.shadow := $xor.i32($i39.shadow,$i67.shadow);
  call {:cexpr "x9"} boogie_si_record_i32($i68);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 70, 22} true;
  assume {:verifier.code 0} true;
  $i69 := $add.i32($i68,$i43);
  $i69.shadow := $add.i32($i68.shadow,$i43.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 70, 12} true;
  assume {:verifier.code 0} true;
  call $i70, $i70.shadow := rotate($i69, $i69.shadow, 9, 9);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 70, 9} true;
  assume {:verifier.code 0} true;
  $i71 := $xor.i32($i49,$i70);
  $i71.shadow := $xor.i32($i49.shadow,$i70.shadow);
  call {:cexpr "x13"} boogie_si_record_i32($i71);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 71, 22} true;
  assume {:verifier.code 0} true;
  $i72 := $add.i32($i71,$i68);
  $i72.shadow := $add.i32($i71.shadow,$i68.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 71, 12} true;
  assume {:verifier.code 0} true;
  call $i73, $i73.shadow := rotate($i72, $i72.shadow, 13, 13);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 71, 9} true;
  assume {:verifier.code 0} true;
  $i74 := $xor.i32($i47,$i73);
  $i74.shadow := $xor.i32($i47.shadow,$i73.shadow);
  call {:cexpr "x1"} boogie_si_record_i32($i74);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 72, 22} true;
  assume {:verifier.code 0} true;
  $i75 := $add.i32($i74,$i71);
  $i75.shadow := $add.i32($i74.shadow,$i71.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 72, 12} true;
  assume {:verifier.code 0} true;
  call $i76, $i76.shadow := rotate($i75, $i75.shadow, 18, 18);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 72, 9} true;
  assume {:verifier.code 0} true;
  $i77 := $xor.i32($i43,$i76);
  $i77.shadow := $xor.i32($i43.shadow,$i76.shadow);
  call {:cexpr "x5"} boogie_si_record_i32($i77);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 73, 22} true;
  assume {:verifier.code 0} true;
  $i78 := $add.i32($i38,$i42);
  $i78.shadow := $add.i32($i38.shadow,$i42.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 73, 12} true;
  assume {:verifier.code 0} true;
  call $i79, $i79.shadow := rotate($i78, $i78.shadow, 7, 7);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 73, 9} true;
  assume {:verifier.code 0} true;
  $i80 := $xor.i32($i50,$i79);
  $i80.shadow := $xor.i32($i50.shadow,$i79.shadow);
  call {:cexpr "x14"} boogie_si_record_i32($i80);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 74, 22} true;
  assume {:verifier.code 0} true;
  $i81 := $add.i32($i80,$i38);
  $i81.shadow := $add.i32($i80.shadow,$i38.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 74, 12} true;
  assume {:verifier.code 0} true;
  call $i82, $i82.shadow := rotate($i81, $i81.shadow, 9, 9);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 74, 9} true;
  assume {:verifier.code 0} true;
  $i83 := $xor.i32($i46,$i82);
  $i83.shadow := $xor.i32($i46.shadow,$i82.shadow);
  call {:cexpr "x2"} boogie_si_record_i32($i83);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 75, 22} true;
  assume {:verifier.code 0} true;
  $i84 := $add.i32($i83,$i80);
  $i84.shadow := $add.i32($i83.shadow,$i80.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 75, 12} true;
  assume {:verifier.code 0} true;
  call $i85, $i85.shadow := rotate($i84, $i84.shadow, 13, 13);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 75, 9} true;
  assume {:verifier.code 0} true;
  $i86 := $xor.i32($i42,$i85);
  $i86.shadow := $xor.i32($i42.shadow,$i85.shadow);
  call {:cexpr "x6"} boogie_si_record_i32($i86);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 76, 22} true;
  assume {:verifier.code 0} true;
  $i87 := $add.i32($i86,$i83);
  $i87.shadow := $add.i32($i86.shadow,$i83.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 76, 12} true;
  assume {:verifier.code 0} true;
  call $i88, $i88.shadow := rotate($i87, $i87.shadow, 18, 18);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 76, 9} true;
  assume {:verifier.code 0} true;
  $i89 := $xor.i32($i38,$i88);
  $i89.shadow := $xor.i32($i38.shadow,$i88.shadow);
  call {:cexpr "x10"} boogie_si_record_i32($i89);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 77, 22} true;
  assume {:verifier.code 0} true;
  $i90 := $add.i32($i51,$i37);
  $i90.shadow := $add.i32($i51.shadow,$i37.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 77, 12} true;
  assume {:verifier.code 0} true;
  call $i91, $i91.shadow := rotate($i90, $i90.shadow, 7, 7);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 77, 9} true;
  assume {:verifier.code 0} true;
  $i92 := $xor.i32($i45,$i91);
  $i92.shadow := $xor.i32($i45.shadow,$i91.shadow);
  call {:cexpr "x3"} boogie_si_record_i32($i92);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 78, 22} true;
  assume {:verifier.code 0} true;
  $i93 := $add.i32($i92,$i51);
  $i93.shadow := $add.i32($i92.shadow,$i51.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 78, 12} true;
  assume {:verifier.code 0} true;
  call $i94, $i94.shadow := rotate($i93, $i93.shadow, 9, 9);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 78, 9} true;
  assume {:verifier.code 0} true;
  $i95 := $xor.i32($i41,$i94);
  $i95.shadow := $xor.i32($i41.shadow,$i94.shadow);
  call {:cexpr "x7"} boogie_si_record_i32($i95);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 79, 22} true;
  assume {:verifier.code 0} true;
  $i96 := $add.i32($i95,$i92);
  $i96.shadow := $add.i32($i95.shadow,$i92.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 79, 12} true;
  assume {:verifier.code 0} true;
  call $i97, $i97.shadow := rotate($i96, $i96.shadow, 13, 13);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 79, 9} true;
  assume {:verifier.code 0} true;
  $i98 := $xor.i32($i37,$i97);
  $i98.shadow := $xor.i32($i37.shadow,$i97.shadow);
  call {:cexpr "x11"} boogie_si_record_i32($i98);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 80, 22} true;
  assume {:verifier.code 0} true;
  $i99 := $add.i32($i98,$i95);
  $i99.shadow := $add.i32($i98.shadow,$i95.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 80, 12} true;
  assume {:verifier.code 0} true;
  call $i100, $i100.shadow := rotate($i99, $i99.shadow, 18, 18);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 80, 9} true;
  assume {:verifier.code 0} true;
  $i101 := $xor.i32($i51,$i100);
  $i101.shadow := $xor.i32($i51.shadow,$i100.shadow);
  call {:cexpr "x15"} boogie_si_record_i32($i101);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 81, 22} true;
  assume {:verifier.code 0} true;
  $i102 := $add.i32($i65,$i92);
  $i102.shadow := $add.i32($i65.shadow,$i92.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 81, 12} true;
  assume {:verifier.code 0} true;
  call $i103, $i103.shadow := rotate($i102, $i102.shadow, 7, 7);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 81, 9} true;
  assume {:verifier.code 0} true;
  $i104 := $xor.i32($i74,$i103);
  $i104.shadow := $xor.i32($i74.shadow,$i103.shadow);
  call {:cexpr "x1"} boogie_si_record_i32($i104);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 82, 22} true;
  assume {:verifier.code 0} true;
  $i105 := $add.i32($i104,$i65);
  $i105.shadow := $add.i32($i104.shadow,$i65.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 82, 12} true;
  assume {:verifier.code 0} true;
  call $i106, $i106.shadow := rotate($i105, $i105.shadow, 9, 9);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 82, 9} true;
  assume {:verifier.code 0} true;
  $i107 := $xor.i32($i83,$i106);
  $i107.shadow := $xor.i32($i83.shadow,$i106.shadow);
  call {:cexpr "x2"} boogie_si_record_i32($i107);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 83, 22} true;
  assume {:verifier.code 0} true;
  $i108 := $add.i32($i107,$i104);
  $i108.shadow := $add.i32($i107.shadow,$i104.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 83, 12} true;
  assume {:verifier.code 0} true;
  call $i109, $i109.shadow := rotate($i108, $i108.shadow, 13, 13);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 83, 9} true;
  assume {:verifier.code 0} true;
  $i110 := $xor.i32($i92,$i109);
  $i110.shadow := $xor.i32($i92.shadow,$i109.shadow);
  call {:cexpr "x3"} boogie_si_record_i32($i110);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 84, 22} true;
  assume {:verifier.code 0} true;
  $i111 := $add.i32($i110,$i107);
  $i111.shadow := $add.i32($i110.shadow,$i107.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 84, 12} true;
  assume {:verifier.code 0} true;
  call $i112, $i112.shadow := rotate($i111, $i111.shadow, 18, 18);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 84, 9} true;
  assume {:verifier.code 0} true;
  $i113 := $xor.i32($i65,$i112);
  $i113.shadow := $xor.i32($i65.shadow,$i112.shadow);
  call {:cexpr "x0"} boogie_si_record_i32($i113);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 85, 22} true;
  assume {:verifier.code 0} true;
  $i114 := $add.i32($i77,$i56);
  $i114.shadow := $add.i32($i77.shadow,$i56.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 85, 12} true;
  assume {:verifier.code 0} true;
  call $i115, $i115.shadow := rotate($i114, $i114.shadow, 7, 7);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 85, 9} true;
  assume {:verifier.code 0} true;
  $i116 := $xor.i32($i86,$i115);
  $i116.shadow := $xor.i32($i86.shadow,$i115.shadow);
  call {:cexpr "x6"} boogie_si_record_i32($i116);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 86, 22} true;
  assume {:verifier.code 0} true;
  $i117 := $add.i32($i116,$i77);
  $i117.shadow := $add.i32($i116.shadow,$i77.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 86, 12} true;
  assume {:verifier.code 0} true;
  call $i118, $i118.shadow := rotate($i117, $i117.shadow, 9, 9);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 86, 9} true;
  assume {:verifier.code 0} true;
  $i119 := $xor.i32($i95,$i118);
  $i119.shadow := $xor.i32($i95.shadow,$i118.shadow);
  call {:cexpr "x7"} boogie_si_record_i32($i119);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 87, 22} true;
  assume {:verifier.code 0} true;
  $i120 := $add.i32($i119,$i116);
  $i120.shadow := $add.i32($i119.shadow,$i116.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 87, 12} true;
  assume {:verifier.code 0} true;
  call $i121, $i121.shadow := rotate($i120, $i120.shadow, 13, 13);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 87, 9} true;
  assume {:verifier.code 0} true;
  $i122 := $xor.i32($i56,$i121);
  $i122.shadow := $xor.i32($i56.shadow,$i121.shadow);
  call {:cexpr "x4"} boogie_si_record_i32($i122);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 88, 22} true;
  assume {:verifier.code 0} true;
  $i123 := $add.i32($i122,$i119);
  $i123.shadow := $add.i32($i122.shadow,$i119.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 88, 12} true;
  assume {:verifier.code 0} true;
  call $i124, $i124.shadow := rotate($i123, $i123.shadow, 18, 18);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 88, 9} true;
  assume {:verifier.code 0} true;
  $i125 := $xor.i32($i77,$i124);
  $i125.shadow := $xor.i32($i77.shadow,$i124.shadow);
  call {:cexpr "x5"} boogie_si_record_i32($i125);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 89, 22} true;
  assume {:verifier.code 0} true;
  $i126 := $add.i32($i89,$i68);
  $i126.shadow := $add.i32($i89.shadow,$i68.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 89, 12} true;
  assume {:verifier.code 0} true;
  call $i127, $i127.shadow := rotate($i126, $i126.shadow, 7, 7);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 89, 9} true;
  assume {:verifier.code 0} true;
  $i128 := $xor.i32($i98,$i127);
  $i128.shadow := $xor.i32($i98.shadow,$i127.shadow);
  call {:cexpr "x11"} boogie_si_record_i32($i128);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 90, 22} true;
  assume {:verifier.code 0} true;
  $i129 := $add.i32($i128,$i89);
  $i129.shadow := $add.i32($i128.shadow,$i89.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 90, 12} true;
  assume {:verifier.code 0} true;
  call $i130, $i130.shadow := rotate($i129, $i129.shadow, 9, 9);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 90, 9} true;
  assume {:verifier.code 0} true;
  $i131 := $xor.i32($i59,$i130);
  $i131.shadow := $xor.i32($i59.shadow,$i130.shadow);
  call {:cexpr "x8"} boogie_si_record_i32($i131);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 91, 22} true;
  assume {:verifier.code 0} true;
  $i132 := $add.i32($i131,$i128);
  $i132.shadow := $add.i32($i131.shadow,$i128.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 91, 12} true;
  assume {:verifier.code 0} true;
  call $i133, $i133.shadow := rotate($i132, $i132.shadow, 13, 13);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 91, 9} true;
  assume {:verifier.code 0} true;
  $i134 := $xor.i32($i68,$i133);
  $i134.shadow := $xor.i32($i68.shadow,$i133.shadow);
  call {:cexpr "x9"} boogie_si_record_i32($i134);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 92, 22} true;
  assume {:verifier.code 0} true;
  $i135 := $add.i32($i134,$i131);
  $i135.shadow := $add.i32($i134.shadow,$i131.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 92, 12} true;
  assume {:verifier.code 0} true;
  call $i136, $i136.shadow := rotate($i135, $i135.shadow, 18, 18);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 92, 9} true;
  assume {:verifier.code 0} true;
  $i137 := $xor.i32($i89,$i136);
  $i137.shadow := $xor.i32($i89.shadow,$i136.shadow);
  call {:cexpr "x10"} boogie_si_record_i32($i137);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 93, 22} true;
  assume {:verifier.code 0} true;
  $i138 := $add.i32($i101,$i80);
  $i138.shadow := $add.i32($i101.shadow,$i80.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 93, 12} true;
  assume {:verifier.code 0} true;
  call $i139, $i139.shadow := rotate($i138, $i138.shadow, 7, 7);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 93, 9} true;
  assume {:verifier.code 0} true;
  $i140 := $xor.i32($i62,$i139);
  $i140.shadow := $xor.i32($i62.shadow,$i139.shadow);
  call {:cexpr "x12"} boogie_si_record_i32($i140);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 94, 22} true;
  assume {:verifier.code 0} true;
  $i141 := $add.i32($i140,$i101);
  $i141.shadow := $add.i32($i140.shadow,$i101.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 94, 12} true;
  assume {:verifier.code 0} true;
  call $i142, $i142.shadow := rotate($i141, $i141.shadow, 9, 9);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 94, 9} true;
  assume {:verifier.code 0} true;
  $i143 := $xor.i32($i71,$i142);
  $i143.shadow := $xor.i32($i71.shadow,$i142.shadow);
  call {:cexpr "x13"} boogie_si_record_i32($i143);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 95, 22} true;
  assume {:verifier.code 0} true;
  $i144 := $add.i32($i143,$i140);
  $i144.shadow := $add.i32($i143.shadow,$i140.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 95, 12} true;
  assume {:verifier.code 0} true;
  call $i145, $i145.shadow := rotate($i144, $i144.shadow, 13, 13);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 95, 9} true;
  assume {:verifier.code 0} true;
  $i146 := $xor.i32($i80,$i145);
  $i146.shadow := $xor.i32($i80.shadow,$i145.shadow);
  call {:cexpr "x14"} boogie_si_record_i32($i146);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 96, 22} true;
  assume {:verifier.code 0} true;
  $i147 := $add.i32($i146,$i143);
  $i147.shadow := $add.i32($i146.shadow,$i143.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 96, 12} true;
  assume {:verifier.code 0} true;
  call $i148, $i148.shadow := rotate($i147, $i147.shadow, 18, 18);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 96, 9} true;
  assume {:verifier.code 0} true;
  $i149 := $xor.i32($i101,$i148);
  $i149.shadow := $xor.i32($i101.shadow,$i148.shadow);
  call {:cexpr "x15"} boogie_si_record_i32($i149);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 97, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !($i53 == 1);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 99, 6} true;
  assume {:verifier.code 0} true;
  $i151 := $add.i32($i48,$i5);
  $i151.shadow := $add.i32($i48.shadow,$i5.shadow);
  call {:cexpr "x0"} boogie_si_record_i32($i151);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 100, 6} true;
  assume {:verifier.code 0} true;
  $i152 := $add.i32($i47,$i7);
  $i152.shadow := $add.i32($i47.shadow,$i7.shadow);
  call {:cexpr "x1"} boogie_si_record_i32($i152);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 101, 6} true;
  assume {:verifier.code 0} true;
  $i153 := $add.i32($i46,$i9);
  $i153.shadow := $add.i32($i46.shadow,$i9.shadow);
  call {:cexpr "x2"} boogie_si_record_i32($i153);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 102, 6} true;
  assume {:verifier.code 0} true;
  $i154 := $add.i32($i45,$i11);
  $i154.shadow := $add.i32($i45.shadow,$i11.shadow);
  call {:cexpr "x3"} boogie_si_record_i32($i154);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 103, 6} true;
  assume {:verifier.code 0} true;
  $i155 := $add.i32($i44,$i13);
  $i155.shadow := $add.i32($i44.shadow,$i13.shadow);
  call {:cexpr "x4"} boogie_si_record_i32($i155);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 104, 6} true;
  assume {:verifier.code 0} true;
  $i156 := $add.i32($i43,$i15);
  $i156.shadow := $add.i32($i43.shadow,$i15.shadow);
  call {:cexpr "x5"} boogie_si_record_i32($i156);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 105, 6} true;
  assume {:verifier.code 0} true;
  $i157 := $add.i32($i42,$i17);
  $i157.shadow := $add.i32($i42.shadow,$i17.shadow);
  call {:cexpr "x6"} boogie_si_record_i32($i157);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 106, 6} true;
  assume {:verifier.code 0} true;
  $i158 := $add.i32($i41,$i19);
  $i158.shadow := $add.i32($i41.shadow,$i19.shadow);
  call {:cexpr "x7"} boogie_si_record_i32($i158);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 107, 6} true;
  assume {:verifier.code 0} true;
  $i159 := $add.i32($i40,$i21);
  $i159.shadow := $add.i32($i40.shadow,$i21.shadow);
  call {:cexpr "x8"} boogie_si_record_i32($i159);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 108, 6} true;
  assume {:verifier.code 0} true;
  $i160 := $add.i32($i39,$i23);
  $i160.shadow := $add.i32($i39.shadow,$i23.shadow);
  call {:cexpr "x9"} boogie_si_record_i32($i160);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 109, 7} true;
  assume {:verifier.code 0} true;
  $i161 := $add.i32($i38,$i25);
  $i161.shadow := $add.i32($i38.shadow,$i25.shadow);
  call {:cexpr "x10"} boogie_si_record_i32($i161);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 110, 7} true;
  assume {:verifier.code 0} true;
  $i162 := $add.i32($i37,$i27);
  $i162.shadow := $add.i32($i37.shadow,$i27.shadow);
  call {:cexpr "x11"} boogie_si_record_i32($i162);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 111, 7} true;
  assume {:verifier.code 0} true;
  $i163 := $add.i32($i36,$i29);
  $i163.shadow := $add.i32($i36.shadow,$i29.shadow);
  call {:cexpr "x12"} boogie_si_record_i32($i163);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 112, 7} true;
  assume {:verifier.code 0} true;
  $i164 := $add.i32($i49,$i31);
  $i164.shadow := $add.i32($i49.shadow,$i31.shadow);
  call {:cexpr "x13"} boogie_si_record_i32($i164);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 113, 7} true;
  assume {:verifier.code 0} true;
  $i165 := $add.i32($i50,$i33);
  $i165.shadow := $add.i32($i50.shadow,$i33.shadow);
  call {:cexpr "x14"} boogie_si_record_i32($i165);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 114, 7} true;
  assume {:verifier.code 0} true;
  $i166 := $add.i32($i51,$i35);
  $i166.shadow := $add.i32($i51.shadow,$i35.shadow);
  call {:cexpr "x15"} boogie_si_record_i32($i166);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 116, 26} true;
  assume {:verifier.code 0} true;
  $p167 := $add.ref($p0,$mul.ref(0,1));
  $p167.shadow := $add.ref($p0.shadow,$mul.ref(0,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 116, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p167, $p167.shadow, $i151, $i151.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 117, 26} true;
  assume {:verifier.code 0} true;
  $p168 := $add.ref($p0,$mul.ref(4,1));
  $p168.shadow := $add.ref($p0.shadow,$mul.ref(4,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 117, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p168, $p168.shadow, $i152, $i152.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 118, 26} true;
  assume {:verifier.code 0} true;
  $p169 := $add.ref($p0,$mul.ref(8,1));
  $p169.shadow := $add.ref($p0.shadow,$mul.ref(8,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 118, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p169, $p169.shadow, $i153, $i153.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 119, 26} true;
  assume {:verifier.code 0} true;
  $p170 := $add.ref($p0,$mul.ref(12,1));
  $p170.shadow := $add.ref($p0.shadow,$mul.ref(12,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 119, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p170, $p170.shadow, $i154, $i154.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 120, 26} true;
  assume {:verifier.code 0} true;
  $p171 := $add.ref($p0,$mul.ref(16,1));
  $p171.shadow := $add.ref($p0.shadow,$mul.ref(16,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 120, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p171, $p171.shadow, $i155, $i155.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 121, 26} true;
  assume {:verifier.code 0} true;
  $p172 := $add.ref($p0,$mul.ref(20,1));
  $p172.shadow := $add.ref($p0.shadow,$mul.ref(20,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 121, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p172, $p172.shadow, $i156, $i156.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 122, 26} true;
  assume {:verifier.code 0} true;
  $p173 := $add.ref($p0,$mul.ref(24,1));
  $p173.shadow := $add.ref($p0.shadow,$mul.ref(24,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 122, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p173, $p173.shadow, $i157, $i157.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 123, 26} true;
  assume {:verifier.code 0} true;
  $p174 := $add.ref($p0,$mul.ref(28,1));
  $p174.shadow := $add.ref($p0.shadow,$mul.ref(28,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 123, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p174, $p174.shadow, $i158, $i158.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 124, 26} true;
  assume {:verifier.code 0} true;
  $p175 := $add.ref($p0,$mul.ref(32,1));
  $p175.shadow := $add.ref($p0.shadow,$mul.ref(32,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 124, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p175, $p175.shadow, $i159, $i159.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 125, 26} true;
  assume {:verifier.code 0} true;
  $p176 := $add.ref($p0,$mul.ref(36,1));
  $p176.shadow := $add.ref($p0.shadow,$mul.ref(36,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 125, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p176, $p176.shadow, $i160, $i160.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 126, 26} true;
  assume {:verifier.code 0} true;
  $p177 := $add.ref($p0,$mul.ref(40,1));
  $p177.shadow := $add.ref($p0.shadow,$mul.ref(40,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 126, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p177, $p177.shadow, $i161, $i161.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 127, 26} true;
  assume {:verifier.code 0} true;
  $p178 := $add.ref($p0,$mul.ref(44,1));
  $p178.shadow := $add.ref($p0.shadow,$mul.ref(44,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 127, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p178, $p178.shadow, $i162, $i162.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 128, 26} true;
  assume {:verifier.code 0} true;
  $p179 := $add.ref($p0,$mul.ref(48,1));
  $p179.shadow := $add.ref($p0.shadow,$mul.ref(48,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 128, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p179, $p179.shadow, $i163, $i163.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 129, 26} true;
  assume {:verifier.code 0} true;
  $p180 := $add.ref($p0,$mul.ref(52,1));
  $p180.shadow := $add.ref($p0.shadow,$mul.ref(52,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 129, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p180, $p180.shadow, $i164, $i164.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 130, 26} true;
  assume {:verifier.code 0} true;
  $p181 := $add.ref($p0,$mul.ref(56,1));
  $p181.shadow := $add.ref($p0.shadow,$mul.ref(56,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 130, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p181, $p181.shadow, $i165, $i165.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 131, 26} true;
  assume {:verifier.code 0} true;
  $p182 := $add.ref($p0,$mul.ref(60,1));
  $p182.shadow := $add.ref($p0.shadow,$mul.ref(60,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 131, 3} true;
  assume {:verifier.code 0} true;
  call store_littleendian($p182, $p182.shadow, $i166, $i166.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 133, 3} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $r.shadow := 0;
  $exn := false;
  ...
  return;
$bb4:
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 64, 27} true;
  assume {:verifier.code 0} true;
  $i150 := $sub.i32($i52,2);
  $i150.shadow := $sub.i32($i52.shadow,2);
  call {:cexpr "i"} boogie_si_record_i32($i150);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 64, 3} true;
  assume {:verifier.code 0} true;
  $i36 := $i140;
  $i36.shadow := $i140.shadow;
  $i37 := $i128;
  $i37.shadow := $i128.shadow;
  $i38 := $i137;
  $i38.shadow := $i137.shadow;
  $i39 := $i134;
  $i39.shadow := $i134.shadow;
  $i40 := $i131;
  $i40.shadow := $i131.shadow;
  $i41 := $i119;
  $i41.shadow := $i119.shadow;
  $i42 := $i116;
  $i42.shadow := $i116.shadow;
  $i43 := $i125;
  $i43.shadow := $i125.shadow;
  $i44 := $i122;
  $i44.shadow := $i122.shadow;
  $i45 := $i110;
  $i45.shadow := $i110.shadow;
  $i46 := $i107;
  $i46.shadow := $i107.shadow;
  $i47 := $i104;
  $i47.shadow := $i104.shadow;
  $i48 := $i113;
  $i48.shadow := $i113.shadow;
  $i49 := $i143;
  $i49.shadow := $i143.shadow;
  $i50 := $i146;
  $i50.shadow := $i146.shadow;
  $i51 := $i149;
  $i51.shadow := $i149.shadow;
  $i52 := $i150;
  $i52.shadow := $i150.shadow;
  goto $bb1;
}
const load_littleendian: ref;
axiom (load_littleendian == $sub.ref(0,3096));
procedure {:inline 1} load_littleendian($p0: ref, $p0.shadow: ref) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $p1: ref;
  var $p1.shadow: ref;
  ...
  var $i18.shadow: i32;
$bb0:
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 21, 17} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 21, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 21, 7} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i8.i32($i2);
  $i3.shadow := $zext.i8.i32($i2.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 22, 17} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($p0,$mul.ref(1,1));
  $p4.shadow := $add.ref($p0.shadow,$mul.ref(1,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 22, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p4 == $p4.shadow));
  $i5 := $load.i8($M.0,$p4);
  $i5.shadow := $load.i8($M.0.shadow,$p4.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 22, 7} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i8.i32($i5);
  $i6.shadow := $zext.i8.i32($i5.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 22, 24} true;
  assume {:verifier.code 0} true;
  $i7 := $shl.i32($i6,8);
  $i7.shadow := $shl.i32($i6.shadow,8);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 22, 3} true;
  assume {:verifier.code 0} true;
  $i8 := $or.i32($i3,$i7);
  $i8.shadow := $or.i32($i3.shadow,$i7.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 23, 17} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(2,1));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(2,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 23, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p9 == $p9.shadow));
  $i10 := $load.i8($M.0,$p9);
  $i10.shadow := $load.i8($M.0.shadow,$p9.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 23, 7} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i8.i32($i10);
  $i11.shadow := $zext.i8.i32($i10.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 23, 24} true;
  assume {:verifier.code 0} true;
  $i12 := $shl.i32($i11,16);
  $i12.shadow := $shl.i32($i11.shadow,16);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 23, 3} true;
  assume {:verifier.code 0} true;
  $i13 := $or.i32($i8,$i12);
  $i13.shadow := $or.i32($i8.shadow,$i12.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 24, 17} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($p0,$mul.ref(3,1));
  $p14.shadow := $add.ref($p0.shadow,$mul.ref(3,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 24, 17} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p14 == $p14.shadow));
  $i15 := $load.i8($M.0,$p14);
  $i15.shadow := $load.i8($M.0.shadow,$p14.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 24, 7} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i8.i32($i15);
  $i16.shadow := $zext.i8.i32($i15.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 24, 24} true;
  assume {:verifier.code 0} true;
  $i17 := $shl.i32($i16,24);
  $i17.shadow := $shl.i32($i16.shadow,24);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 24, 3} true;
  assume {:verifier.code 0} true;
  $i18 := $or.i32($i13,$i17);
  $i18.shadow := $or.i32($i13.shadow,$i17.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $r := $i18;
  $r.shadow := $i18.shadow;
  $exn := false;
...
const rotate: ref;
axiom (rotate == $sub.ref(0,4128));
procedure {:inline 1} rotate($i0: i32, $i0.shadow: i32, $i1: i32, $i1.shadow: i32) returns ($r: i32, $r.shadow: i32)
modifies $exn;
{
  var $i2: i32;
  var $i2.shadow: i32;
  ...
  var $i5.shadow: i32;
$bb0:
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 15, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "rotate:arg:u"} boogie_si_record_i32($i0);
  call {:cexpr "rotate:arg:c"} boogie_si_record_i32($i1);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 15, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $shl.i32($i0,$i1);
  $i2.shadow := $shl.i32($i0.shadow,$i1.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 15, 31} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32(32,$i1);
  $i3.shadow := $sub.i32(32,$i1.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 15, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $lshr.i32($i0,$i3);
  $i4.shadow := $lshr.i32($i0.shadow,$i3.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 15, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $or.i32($i2,$i4);
  $i5.shadow := $or.i32($i2.shadow,$i4.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $r.shadow := $i5.shadow;
  $exn := false;
...
axiom (store_littleendian == $sub.ref(0,5160));
procedure {:inline 1} store_littleendian($p0: ref, $p0.shadow: ref, $i1: i32, $i1.shadow: i32)
modifies $M.1, $exn;
{
  var $i2: i8;
  var $i2.shadow: i8;
  ...
  var $p12.shadow: ref;
$bb0:
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 30, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "store_littleendian:arg:u"} boogie_si_record_i32($i1);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 30, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $trunc.i32.i8($i1);
  $i2.shadow := $trunc.i32.i8($i1.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 30, 3} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($p0,$mul.ref(0,1));
  $p3.shadow := $add.ref($p0.shadow,$mul.ref(0,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 30, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p3 == $p3.shadow));
  $M.1 := $store.i8($M.1,$p3,$i2);
  $M.1.shadow := $store.i8($M.1.shadow,$p3.shadow,$i2.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 30, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $lshr.i32($i1,8);
  $i4.shadow := $lshr.i32($i1.shadow,8);
  call {:cexpr "u"} boogie_si_record_i32($i4);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 31, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $trunc.i32.i8($i4);
  $i5.shadow := $trunc.i32.i8($i4.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 31, 3} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p0,$mul.ref(1,1));
  $p6.shadow := $add.ref($p0.shadow,$mul.ref(1,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 31, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p6 == $p6.shadow));
  $M.1 := $store.i8($M.1,$p6,$i5);
  $M.1.shadow := $store.i8($M.1.shadow,$p6.shadow,$i5.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 31, 15} true;
  assume {:verifier.code 0} true;
  $i7 := $lshr.i32($i4,8);
  $i7.shadow := $lshr.i32($i4.shadow,8);
  call {:cexpr "u"} boogie_si_record_i32($i7);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 32, 10} true;
  assume {:verifier.code 0} true;
  $i8 := $trunc.i32.i8($i7);
  $i8.shadow := $trunc.i32.i8($i7.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 32, 3} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p0,$mul.ref(2,1));
  $p9.shadow := $add.ref($p0.shadow,$mul.ref(2,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 32, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p9 == $p9.shadow));
  $M.1 := $store.i8($M.1,$p9,$i8);
  $M.1.shadow := $store.i8($M.1.shadow,$p9.shadow,$i8.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 32, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $lshr.i32($i7,8);
  $i10.shadow := $lshr.i32($i7.shadow,8);
  call {:cexpr "u"} boogie_si_record_i32($i10);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 33, 10} true;
  assume {:verifier.code 0} true;
  $i11 := $trunc.i32.i8($i10);
  $i11.shadow := $trunc.i32.i8($i10.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 33, 3} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($p0,$mul.ref(3,1));
  $p12.shadow := $add.ref($p0.shadow,$mul.ref(3,1));
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 33, 8} true;
  assume {:verifier.code 0} true;
  $shadow_ok := ($shadow_ok && ($p12 == $p12.shadow));
  $M.1 := $store.i8($M.1,$p12,$i11);
  $M.1.shadow := $store.i8($M.1.shadow,$p12.shadow,$i11.shadow);
  assume {:sourceloc "../libsodium/src/libsodium/crypto_core/salsa20/ref/core_salsa20.c", 34, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  $exn.shadow := false;
  return;
...
axiom (crypto_core_salsa20_wrapper == $sub.ref(0,6192));
procedure {:entrypoint} crypto_core_salsa20_wrapper($p0: ref, $p0.shadow: ref, $p1: ref, $p1.shadow: ref, $p2: ref, $p2.shadow: ref, $p3: ref, $p3.shadow: ref) returns ($r: i32, $r.shadow: i32)
...
$bb0:
  $shadow_ok := true;
  call $initialize();
  assume {:sourceloc "crypto_core_salsa20.c", 8, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:crypto_core_salsa20_wrapper"} boogie_si_record_ref(crypto_core_salsa20_wrapper);
  call {:cexpr "smack:arg:crypto_core_salsa20_wrapper:$p0"} boogie_si_record_ref($p0);
  call {:cexpr "smack:arg:crypto_core_salsa20_wrapper:$p1"} boogie_si_record_ref($p1);
  call {:cexpr "smack:arg:crypto_core_salsa20_wrapper:$p2"} boogie_si_record_ref($p2);
  call {:cexpr "smack:arg:crypto_core_salsa20_wrapper:$p3"} boogie_si_record_ref($p3);
  assume {:sourceloc "crypto_core_salsa20.c", 8, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "crypto_core_salsa20.c", 8, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p4, $p4.shadow);
  assume {:sourceloc "crypto_core_salsa20.c", 9, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p1} $p5 := __SMACK_value.ref($p1);
  $p5.shadow := $p5;
  assume $isExternal($p5);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p5);
  assume {:sourceloc "crypto_core_salsa20.c", 9, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p5, $p5.shadow);
  assume {:sourceloc "crypto_core_salsa20.c", 10, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p2} $p6 := __SMACK_value.ref($p2);
  $p6.shadow := $p6;
  assume $isExternal($p6);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p6);
  assume {:sourceloc "crypto_core_salsa20.c", 10, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p6, $p6.shadow);
  assume {:sourceloc "crypto_core_salsa20.c", 11, 13} true;
  assume {:verifier.code 0} true;
  call {:name $p3} $p7 := __SMACK_value.ref($p3);
  $p7.shadow := $p7;
  assume $isExternal($p7);
  call {:cexpr "smack:ext:__SMACK_value"} boogie_si_record_ref($p7);
  assume {:sourceloc "crypto_core_salsa20.c", 11, 3} true;
  assume {:verifier.code 0} true;
  call public_in($p7, $p7.shadow);
  assume {:sourceloc "crypto_core_salsa20.c", 13, 10} true;
  assume {:verifier.code 0} true;
  call $i8, $i8.shadow := crypto_core_salsa20($p0, $p0.shadow, $p1, $p1.shadow, $p2, $p2.shadow, $p3, $p3.shadow);
  assume {:sourceloc "crypto_core_salsa20.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := $i8;
  $r.shadow := $i8.shadow;
  $exn := false;
...
axiom (__SMACK_dummy == $sub.ref(0,11352));
...
axiom (__SMACK_and32 == $sub.ref(0,12384));
...
axiom (__SMACK_and64 == $sub.ref(0,13416));
...
axiom (__SMACK_and16 == $sub.ref(0,14448));
...
axiom (__SMACK_and8 == $sub.ref(0,15480));
...
axiom (__SMACK_or32 == $sub.ref(0,16512));
...
axiom (__SMACK_or64 == $sub.ref(0,17544));
...
axiom (__SMACK_or16 == $sub.ref(0,18576));
...
axiom (__SMACK_or8 == $sub.ref(0,19608));
...
axiom (__SMACK_check_overflow == $sub.ref(0,20640));
...
axiom (__SMACK_loop_exit == $sub.ref(0,21672));
...
axiom (__SMACK_decls == $sub.ref(0,22704));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0,23736));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0,24768));
