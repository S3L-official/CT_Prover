...
procedure {:inline 1} crypto_core_salsa20($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1, $p3: ref, $p3.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
modifies $M.1;
{
  var $p4: ref;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i5, $i5.dup := load_littleendian($p4, $p4.dup);
  ...
  assume {:verifier.code 0} true;
  call $i7, $i7.dup := load_littleendian($p6, $p6.dup);
  ...
  assume {:verifier.code 0} true;
  call $i9, $i9.dup := load_littleendian($p8, $p8.dup);
  ...
  assume {:verifier.code 0} true;
  call $i11, $i11.dup := load_littleendian($p10, $p10.dup);
  ...
  assume {:verifier.code 0} true;
  call $i13, $i13.dup := load_littleendian($p12, $p12.dup);
  ...
  assume {:verifier.code 0} true;
  call $i17, $i17.dup := load_littleendian($p16, $p16.dup);
  ...
  assume {:verifier.code 0} true;
  call $i19, $i19.dup := load_littleendian($p18, $p18.dup);
  ...
  assume {:verifier.code 0} true;
  call $i21, $i21.dup := load_littleendian($p20, $p20.dup);
  ...
  assume {:verifier.code 0} true;
  call $i23, $i23.dup := load_littleendian($p22, $p22.dup);
  ...
  assume {:verifier.code 0} true;
  call $i27, $i27.dup := load_littleendian($p26, $p26.dup);
  ...
  assume {:verifier.code 0} true;
  call $i29, $i29.dup := load_littleendian($p28, $p28.dup);
  ...
  assume {:verifier.code 0} true;
  call $i31, $i31.dup := load_littleendian($p30, $p30.dup);
...
$bb1:
  ...
  assert {:unlikely_shadow_invariant ($i43.dup == 0)} true;
  ...
  assert {:unlikely_shadow_invariant ($i47.dup == 0)} true;
  ...
  assert {:unlikely_shadow_invariant ($i41.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i37.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i42.dup == 0)} true;
  ...
  assert {:unlikely_shadow_invariant ($i35.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i44.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i46.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i45.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i40.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i50.dup == 0)} true;
  assert {:unlikely_shadow_invariant ($i51.dup == 0)} true;
...
$bb3:
  ...
  $i154.dup := $or.i1($i45.dup,$i11.dup);
  ...
  $i155.dup := $or.i1($i44.dup,$i13.dup);
  ...
  $i156.dup := $or.i1($i43.dup,$i15.dup);
  ...
  $i157.dup := $or.i1($i42.dup,$i17.dup);
  ...
  $i158.dup := $or.i1($i41.dup,$i19.dup);
  ...
  $i159.dup := $or.i1($i40.dup,$i21.dup);
  ...
  $i160.dup := $or.i1($i39.dup,$i23.dup);
  ...
  $i161.dup := $or.i1($i38.dup,$i25.dup);
  ...
  $i162.dup := $or.i1($i37.dup,$i27.dup);
  ...
  $i163.dup := $or.i1($i36.dup,$i29.dup);
  ...
  $i164.dup := $or.i1($i49.dup,$i31.dup);
  ...
  $i165.dup := $or.i1($i50.dup,$i33.dup);
  ...
  $i166.dup := $or.i1($i51.dup,$i35.dup);
  ...
  assume {:verifier.code 0} true;
  call store_littleendian($p168, $p168.dup, $i152, $i152.dup);
  ...
  assume {:verifier.code 0} true;
  call store_littleendian($p169, $p169.dup, $i153, $i153.dup);
...
procedure {:inline 1} load_littleendian($p0: ref, $p0.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $p1: ref;
  var $p1.dup: i1;
...
procedure {:inline 1} rotate($i0: i32, $i0.dup: i1, $i1: i32, $i1.dup: i1) returns ($r: i32, $r.dup: i1)
modifies $exn;
{
  var $i2: i32;
  var $i2.dup: i1;
...
procedure {:inline 1} store_littleendian($p0: ref, $p0.dup: i1, $i1: i32, $i1.dup: i1)
modifies $M.1, $exn;
{
  var $i2: i8;
  var $i2.dup: i1;
...
$bb0:
  ...
  $M.1.dup := $store.i1($M.1.dup,$p3,$i2.dup);
  ...
  $M.1.dup := $store.i1($M.1.dup,$p6,$i5.dup);
  ...
  $M.1.dup := $store.i1($M.1.dup,$p9,$i8.dup);
...
procedure {:entrypoint} crypto_core_salsa20_wrapper($p0: ref, $p0.dup: i1, $p1: ref, $p1.dup: i1, $p2: ref, $p2.dup: i1, $p3: ref, $p3.dup: i1) returns ($r: i32, $r.dup: i1)
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call $i8, $i8.dup := crypto_core_salsa20($p0, $p0.dup, $p1, $p1.dup, $p2, $p2.dup, $p3, $p3.dup);
