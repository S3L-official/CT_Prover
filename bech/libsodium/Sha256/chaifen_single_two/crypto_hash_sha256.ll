...
16:                                               ; preds = %14, %12
  ...
  %19 = call i32 @crypto_hash_sha256_update(%struct.crypto_hash_sha256_state* %0, i8* getelementptr inbounds ([64 x i8], [64 x i8]* bitcast (<{ i8, [63 x i8] }>* @PAD to [64 x i8]*), i64 0, i64 0), i64 %18), !dbg !497
  %20 = getelementptr inbounds [8 x i8], [8 x i8]* %2, i64 0, i64 0, !dbg !498
  %21 = call i32 @crypto_hash_sha256_update(%struct.crypto_hash_sha256_state* %0, i8* %20, i64 8), !dbg !499
  ret void, !dbg !500
}
...
5:                                                ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.1, i64 0, i64 0), i32 142, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @__PRETTY_FUNCTION__.randombytes, i64 0, i64 0)) #9, !dbg !668
  unreachable, !dbg !668
...
define dso_local i8* @randombytes_sysrandom_implementation_name() #0 !dbg !674 {
  ret i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i64 0, i64 0), !dbg !675
}
...
define dso_local void @randombytes_sysrandom_stir() #0 !dbg !683 {
  %1 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !684
  %2 = icmp eq i32 %1, 0, !dbg !686
  br i1 %2, label %3, label %4, !dbg !687

3:                                                ; preds = %0
  call void @randombytes_sysrandom_init(), !dbg !688
  store i32 1, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !690
  br label %4, !dbg !691
...
define dso_local void @randombytes_sysrandom_buf(i8* %0, i64 %1) #0 !dbg !693 {
  ...
  %3 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !698
  %4 = icmp ne i32 %3, 0, !dbg !700
  br i1 %4, label %5, label %10, !dbg !701

5:                                                ; preds = %2
  %6 = call i32 @randombytes_linux_getrandom(i8* %0, i64 %1), !dbg !702
  %7 = icmp ne i32 %6, 0, !dbg !705
...
10:                                               ; preds = %2
  %11 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !710
  %12 = icmp eq i32 %11, -1, !dbg !712
  br i1 %12, label %17, label %13, !dbg !713

13:                                               ; preds = %10
  %14 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !714
  %15 = call i64 @safe_read(i32 %14, i8* %0, i64 %1), !dbg !715
  %16 = icmp ne i64 %15, %1, !dbg !716
  br i1 %16, label %17, label %18, !dbg !717
...
define dso_local i32 @randombytes_sysrandom_close() #0 !dbg !721 {
  ...
  %1 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !724
  %2 = icmp ne i32 %1, -1, !dbg !726
  br i1 %2, label %3, label %8, !dbg !727

3:                                                ; preds = %0
  %4 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !728
  %5 = call i32 @close(i32 %4), !dbg !729
  %6 = icmp eq i32 %5, 0, !dbg !730
  br i1 %6, label %7, label %8, !dbg !731

7:                                                ; preds = %3
  store i32 -1, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !732
  store i32 0, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !734
  call void @llvm.dbg.value(metadata i32 0, metadata !722, metadata !DIExpression()), !dbg !723
  br label %8, !dbg !735

8:                                                ; preds = %7, %3, %0
  %.0 = phi i32 [ 0, %7 ], [ -1, %3 ], [ -1, %0 ], !dbg !723
  call void @llvm.dbg.value(metadata i32 %.0, metadata !722, metadata !DIExpression()), !dbg !723
  %9 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !736
  %10 = icmp ne i32 %9, 0, !dbg !738
...
define internal void @randombytes_sysrandom_stir_if_needed() #0 !dbg !743 {
  %1 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !744
  %2 = icmp eq i32 %1, 0, !dbg !746
  br i1 %2, label %3, label %4, !dbg !747
...
3:                                                ; preds = %17, %2
  %.03 = phi i8* [ %0, %2 ], [ %16, %17 ], !dbg !756
  %.02 = phi i64 [ %1, %2 ], [ %15, %17 ]
  %.01 = phi i64 [ 256, %2 ], [ %.1, %17 ], !dbg !756
  ...
  br i1 %4, label %5, label %10, !dbg !764
...
8:                                                ; preds = %5
  call void @__assert_fail(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str.4, i64 0, i64 0), i32 159, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @__PRETTY_FUNCTION__.randombytes_linux_getrandom, i64 0, i64 0)) #9, !dbg !765
  unreachable, !dbg !765
...
10:                                               ; preds = %9, %3
  %.1 = phi i64 [ %.02, %9 ], [ %.01, %3 ], !dbg !756
  call void @llvm.dbg.value(metadata i64 %.1, metadata !759, metadata !DIExpression()), !dbg !756
  %11 = call i32 @_randombytes_linux_getrandom(i8* %.03, i64 %.1), !dbg !771
  %12 = icmp ne i32 %11, 0, !dbg !773
  br i1 %12, label %13, label %14, !dbg !774

13:                                               ; preds = %10
  br label %20, !dbg !775

14:                                               ; preds = %10
  %15 = sub i64 %.02, %.1, !dbg !777
  call void @llvm.dbg.value(metadata i64 %15, metadata !757, metadata !DIExpression()), !dbg !756
  %16 = getelementptr inbounds i8, i8* %.03, i64 %.1, !dbg !778
  call void @llvm.dbg.value(metadata i8* %16, metadata !758, metadata !DIExpression()), !dbg !756
  br label %17, !dbg !779

17:                                               ; preds = %14
  %18 = icmp ugt i64 %15, 0, !dbg !780
  br i1 %18, label %3, label %19, !dbg !779, !llvm.loop !781

19:                                               ; preds = %17
  br label %20, !dbg !783

20:                                               ; preds = %19, %13
  %.0 = phi i32 [ -1, %13 ], [ 0, %19 ], !dbg !756
  ret i32 %.0, !dbg !784
}
...
6:                                                ; preds = %3
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str.4, i64 0, i64 0), i32 82, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__PRETTY_FUNCTION__.safe_read, i64 0, i64 0)) #9, !dbg !794
  unreachable, !dbg !794
...
9:                                                ; preds = %24, %8
  %10 = call i64 @read(i32 %0, i8* %.01, i64 %.02), !dbg !801
  call void @llvm.dbg.value(metadata i64 %10, metadata !802, metadata !DIExpression()), !dbg !790
  %11 = icmp slt i64 %10, 0, !dbg !803
  br i1 %11, label %12, label %22, !dbg !804

12:                                               ; preds = %9
  %13 = call i32* @__errno_location() #10, !dbg !805
  %14 = load i32, i32* %13, align 4, !dbg !805
  %15 = icmp eq i32 %14, 4, !dbg !806
  br i1 %15, label %20, label %16, !dbg !807

16:                                               ; preds = %12
  %17 = call i32* @__errno_location() #10, !dbg !808
  %18 = load i32, i32* %17, align 4, !dbg !808
  %19 = icmp eq i32 %18, 11, !dbg !809
  br label %20, !dbg !807
...
22:                                               ; preds = %20, %9
  %23 = phi i1 [ false, %9 ], [ %21, %20 ], !dbg !810
  br i1 %23, label %24, label %25, !dbg !799

24:                                               ; preds = %22
  br label %9, !dbg !799, !llvm.loop !811

25:                                               ; preds = %22
  %26 = icmp slt i64 %10, 0, !dbg !813
  br i1 %26, label %27, label %28, !dbg !815

27:                                               ; preds = %25
  br label %40, !dbg !816

28:                                               ; preds = %25
  %29 = icmp eq i64 %10, 0, !dbg !818
  br i1 %29, label %30, label %31, !dbg !820

30:                                               ; preds = %28
  br label %36, !dbg !821

31:                                               ; preds = %28
  %32 = sub i64 %.02, %10, !dbg !823
  call void @llvm.dbg.value(metadata i64 %32, metadata !792, metadata !DIExpression()), !dbg !790
  %33 = getelementptr inbounds i8, i8* %.01, i64 %10, !dbg !824
  call void @llvm.dbg.value(metadata i8* %33, metadata !793, metadata !DIExpression()), !dbg !790
  br label %34, !dbg !825

34:                                               ; preds = %31
  %35 = icmp ugt i64 %32, 0, !dbg !826
  br i1 %35, label %8, label %36, !dbg !825, !llvm.loop !827

36:                                               ; preds = %34, %30
  %.1 = phi i8* [ %.01, %30 ], [ %33, %34 ], !dbg !790
  call void @llvm.dbg.value(metadata i8* %.1, metadata !793, metadata !DIExpression()), !dbg !790
  %37 = ptrtoint i8* %.1 to i64, !dbg !829
  %38 = ptrtoint i8* %1 to i64, !dbg !829
  %39 = sub i64 %37, %38, !dbg !829
  br label %40, !dbg !830

40:                                               ; preds = %36, %27
  %.0 = phi i64 [ %10, %27 ], [ %39, %36 ], !dbg !790
  ret i64 %.0, !dbg !831
}
...
5:                                                ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str.4, i64 0, i64 0), i32 142, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__PRETTY_FUNCTION__._randombytes_linux_getrandom, i64 0, i64 0)) #9, !dbg !838
  unreachable, !dbg !838
...
7:                                                ; preds = %23, %6
  %8 = trunc i64 %1 to i32, !dbg !843
  %9 = call i64 (i64, ...) @syscall(i64 318, i8* %0, i32 %8, i32 0) #11, !dbg !845
  %10 = trunc i64 %9 to i32, !dbg !845
  call void @llvm.dbg.value(metadata i32 %10, metadata !846, metadata !DIExpression()), !dbg !836
  br label %11, !dbg !847

11:                                               ; preds = %7
  %12 = icmp slt i32 %10, 0, !dbg !848
  br i1 %12, label %13, label %23, !dbg !849

13:                                               ; preds = %11
  %14 = call i32* @__errno_location() #10, !dbg !850
  %15 = load i32, i32* %14, align 4, !dbg !850
  %16 = icmp eq i32 %15, 4, !dbg !851
  br i1 %16, label %21, label %17, !dbg !852

17:                                               ; preds = %13
  %18 = call i32* @__errno_location() #10, !dbg !853
  %19 = load i32, i32* %18, align 4, !dbg !853
  %20 = icmp eq i32 %19, 11, !dbg !854
  br label %21, !dbg !852
...
23:                                               ; preds = %21, %11
  %24 = phi i1 [ false, %11 ], [ %22, %21 ], !dbg !836
  br i1 %24, label %7, label %25, !dbg !847, !llvm.loop !855

25:                                               ; preds = %23
  %26 = trunc i64 %1 to i32, !dbg !857
  %27 = icmp eq i32 %10, %26, !dbg !858
  %28 = zext i1 %27 to i32, !dbg !858
  %29 = sub nsw i32 %28, 1, !dbg !859
  ret i32 %29, !dbg !860
}
...
7:                                                ; preds = %0
  store i32 1, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !873
  %8 = call i32* @__errno_location() #10, !dbg !875
  store i32 %3, i32* %8, align 4, !dbg !876
  br label %15, !dbg !877

9:                                                ; preds = %0
  store i32 0, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !878
  %10 = call i32 @randombytes_sysrandom_random_dev_open(), !dbg !879
  store i32 %10, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !881
  %11 = icmp eq i32 %10, -1, !dbg !882
  br i1 %11, label %12, label %13, !dbg !883
...
13:                                               ; preds = %9
  %14 = call i32* @__errno_location() #10, !dbg !886
  store i32 %3, i32* %14, align 4, !dbg !887
  br label %15, !dbg !888
...
2:                                                ; preds = %28, %0
  %.01 = phi i8** [ getelementptr inbounds ([3 x i8*], [3 x i8*]* @randombytes_sysrandom_random_dev_open.devices, i64 0, i64 0), %0 ], [ %.1, %28 ], !dbg !928
  call void @llvm.dbg.value(metadata i8** %.01, metadata !926, metadata !DIExpression()), !dbg !928
  %3 = load i8*, i8** %.01, align 8, !dbg !930
  %4 = call i32 (i8*, i32, ...) @open(i8* %3, i32 0), !dbg !932
  call void @llvm.dbg.value(metadata i32 %4, metadata !933, metadata !DIExpression()), !dbg !928
  %5 = icmp ne i32 %4, -1, !dbg !934
  br i1 %5, label %6, label %20, !dbg !936

6:                                                ; preds = %2
  %7 = call i32 @fstat(i32 %4, %struct.stat* %1) #11, !dbg !937
  %8 = icmp eq i32 %7, 0, !dbg !940
  br i1 %8, label %9, label %18, !dbg !941

9:                                                ; preds = %6
  %10 = getelementptr inbounds %struct.stat, %struct.stat* %1, i32 0, i32 3, !dbg !942
  %11 = load i32, i32* %10, align 8, !dbg !942
  %12 = and i32 %11, 61440, !dbg !942
  %13 = icmp eq i32 %12, 8192, !dbg !942
  br i1 %13, label %14, label %18, !dbg !943

14:                                               ; preds = %9
  %15 = call i32 (i32, i32, ...) @fcntl(i32 %4, i32 1), !dbg !944
  %16 = or i32 %15, 1, !dbg !946
  %17 = call i32 (i32, i32, ...) @fcntl(i32 %4, i32 2, i32 %16), !dbg !947
  br label %33, !dbg !948

18:                                               ; preds = %9, %6
  %19 = call i32 @close(i32 %4), !dbg !949
  br label %26, !dbg !950

20:                                               ; preds = %2
  %21 = call i32* @__errno_location() #10, !dbg !951
  %22 = load i32, i32* %21, align 4, !dbg !951
  %23 = icmp eq i32 %22, 4, !dbg !953
  br i1 %23, label %24, label %25, !dbg !954
...
26:                                               ; preds = %25, %18
  %27 = getelementptr inbounds i8*, i8** %.01, i32 1, !dbg !957
  call void @llvm.dbg.value(metadata i8** %27, metadata !926, metadata !DIExpression()), !dbg !928
  br label %28, !dbg !958

28:                                               ; preds = %26, %24
  %.1 = phi i8** [ %27, %26 ], [ %.01, %24 ], !dbg !928
  call void @llvm.dbg.value(metadata i8** %.1, metadata !926, metadata !DIExpression()), !dbg !928
  %29 = load i8*, i8** %.1, align 8, !dbg !959
  %30 = icmp ne i8* %29, null, !dbg !960
  br i1 %30, label %2, label %31, !dbg !958, !llvm.loop !961

31:                                               ; preds = %28
  %32 = call i32* @__errno_location() #10, !dbg !963
  store i32 5, i32* %32, align 4, !dbg !964
  br label %33, !dbg !965

33:                                               ; preds = %31, %14
  %.0 = phi i32 [ %4, %14 ], [ -1, %31 ], !dbg !928
  ret i32 %.0, !dbg !966
}
...
define dso_local i32 @_sodium_alloc_init() #0 !dbg !1202 {
  call void @randombytes_buf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @canary, i64 0, i64 0), i64 16), !dbg !1203
  ret i32 0, !dbg !1204
}
