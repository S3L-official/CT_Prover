...
16:                                               ; preds = %14, %12
  ...
  %18 = call i32 @crypto_hash_sha512_update(%struct.crypto_hash_sha512_state* %0, i8* getelementptr inbounds ([128 x i8], [128 x i8]* bitcast (<{ i8, [127 x i8] }>* @PAD to [128 x i8]*), i64 0, i64 0), i64 %17), !dbg !527
  %19 = getelementptr inbounds [16 x i8], [16 x i8]* %2, i64 0, i64 0, !dbg !528
  %20 = call i32 @crypto_hash_sha512_update(%struct.crypto_hash_sha512_state* %0, i8* %19, i64 16), !dbg !529
  ret void, !dbg !530
}
...
5:                                                ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.1, i64 0, i64 0), i32 142, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @__PRETTY_FUNCTION__.randombytes, i64 0, i64 0)) #9, !dbg !719
  unreachable, !dbg !719
...
define dso_local i8* @randombytes_sysrandom_implementation_name() #0 !dbg !725 {
  ret i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i64 0, i64 0), !dbg !726
}
...
define dso_local void @randombytes_sysrandom_stir() #0 !dbg !734 {
  %1 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !735
  %2 = icmp eq i32 %1, 0, !dbg !737
  br i1 %2, label %3, label %4, !dbg !738

3:                                                ; preds = %0
  call void @randombytes_sysrandom_init(), !dbg !739
  store i32 1, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !741
  br label %4, !dbg !742
...
define dso_local void @randombytes_sysrandom_buf(i8* %0, i64 %1) #0 !dbg !744 {
  ...
  %3 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !749
  %4 = icmp ne i32 %3, 0, !dbg !751
  br i1 %4, label %5, label %10, !dbg !752

5:                                                ; preds = %2
  %6 = call i32 @randombytes_linux_getrandom(i8* %0, i64 %1), !dbg !753
  %7 = icmp ne i32 %6, 0, !dbg !756
  br i1 %7, label %8, label %9, !dbg !757
...
10:                                               ; preds = %2
  %11 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !761
  %12 = icmp eq i32 %11, -1, !dbg !763
  br i1 %12, label %17, label %13, !dbg !764

13:                                               ; preds = %10
  %14 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !765
  %15 = call i64 @safe_read(i32 %14, i8* %0, i64 %1), !dbg !766
  %16 = icmp ne i64 %15, %1, !dbg !767
...
define dso_local i32 @randombytes_sysrandom_close() #0 !dbg !772 {
  ...
  %1 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !775
  %2 = icmp ne i32 %1, -1, !dbg !777
  br i1 %2, label %3, label %8, !dbg !778

3:                                                ; preds = %0
  %4 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !779
  %5 = call i32 @close(i32 %4), !dbg !780
  %6 = icmp eq i32 %5, 0, !dbg !781
  br i1 %6, label %7, label %8, !dbg !782

7:                                                ; preds = %3
  store i32 -1, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !783
  store i32 0, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !785
  call void @llvm.dbg.value(metadata i32 0, metadata !773, metadata !DIExpression()), !dbg !774
  br label %8, !dbg !786

8:                                                ; preds = %7, %3, %0
  %.0 = phi i32 [ 0, %7 ], [ -1, %3 ], [ -1, %0 ], !dbg !774
  call void @llvm.dbg.value(metadata i32 %.0, metadata !773, metadata !DIExpression()), !dbg !774
  %9 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !787
  %10 = icmp ne i32 %9, 0, !dbg !789
  br i1 %10, label %11, label %12, !dbg !790
...
define internal void @randombytes_sysrandom_stir_if_needed() #0 !dbg !794 {
  %1 = load i32, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 1), align 4, !dbg !795
  %2 = icmp eq i32 %1, 0, !dbg !797
  br i1 %2, label %3, label %4, !dbg !798
...
3:                                                ; preds = %17, %2
  %.03 = phi i8* [ %0, %2 ], [ %16, %17 ], !dbg !807
  %.02 = phi i64 [ %1, %2 ], [ %15, %17 ]
  %.01 = phi i64 [ 256, %2 ], [ %.1, %17 ], !dbg !807
  ...
  br i1 %4, label %5, label %10, !dbg !815
...
8:                                                ; preds = %5
  call void @__assert_fail(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str.4, i64 0, i64 0), i32 159, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @__PRETTY_FUNCTION__.randombytes_linux_getrandom, i64 0, i64 0)) #9, !dbg !816
  unreachable, !dbg !816
...
10:                                               ; preds = %9, %3
  %.1 = phi i64 [ %.02, %9 ], [ %.01, %3 ], !dbg !807
  call void @llvm.dbg.value(metadata i64 %.1, metadata !810, metadata !DIExpression()), !dbg !807
  %11 = call i32 @_randombytes_linux_getrandom(i8* %.03, i64 %.1), !dbg !822
  %12 = icmp ne i32 %11, 0, !dbg !824
  br i1 %12, label %13, label %14, !dbg !825

13:                                               ; preds = %10
  br label %20, !dbg !826

14:                                               ; preds = %10
  %15 = sub i64 %.02, %.1, !dbg !828
  call void @llvm.dbg.value(metadata i64 %15, metadata !808, metadata !DIExpression()), !dbg !807
  %16 = getelementptr inbounds i8, i8* %.03, i64 %.1, !dbg !829
  call void @llvm.dbg.value(metadata i8* %16, metadata !809, metadata !DIExpression()), !dbg !807
  br label %17, !dbg !830

17:                                               ; preds = %14
  %18 = icmp ugt i64 %15, 0, !dbg !831
  br i1 %18, label %3, label %19, !dbg !830, !llvm.loop !832

19:                                               ; preds = %17
  br label %20, !dbg !834

20:                                               ; preds = %19, %13
  %.0 = phi i32 [ -1, %13 ], [ 0, %19 ], !dbg !807
  ret i32 %.0, !dbg !835
}
...
6:                                                ; preds = %3
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str.4, i64 0, i64 0), i32 82, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__PRETTY_FUNCTION__.safe_read, i64 0, i64 0)) #9, !dbg !845
  unreachable, !dbg !845
...
9:                                                ; preds = %24, %8
  %10 = call i64 @read(i32 %0, i8* %.01, i64 %.02), !dbg !852
  call void @llvm.dbg.value(metadata i64 %10, metadata !853, metadata !DIExpression()), !dbg !841
  %11 = icmp slt i64 %10, 0, !dbg !854
  br i1 %11, label %12, label %22, !dbg !855

12:                                               ; preds = %9
  %13 = call i32* @__errno_location() #10, !dbg !856
  %14 = load i32, i32* %13, align 4, !dbg !856
  %15 = icmp eq i32 %14, 4, !dbg !857
  br i1 %15, label %20, label %16, !dbg !858

16:                                               ; preds = %12
  %17 = call i32* @__errno_location() #10, !dbg !859
  %18 = load i32, i32* %17, align 4, !dbg !859
  %19 = icmp eq i32 %18, 11, !dbg !860
  br label %20, !dbg !858
...
22:                                               ; preds = %20, %9
  %23 = phi i1 [ false, %9 ], [ %21, %20 ], !dbg !861
  br i1 %23, label %24, label %25, !dbg !850

24:                                               ; preds = %22
  br label %9, !dbg !850, !llvm.loop !862

25:                                               ; preds = %22
  %26 = icmp slt i64 %10, 0, !dbg !864
  br i1 %26, label %27, label %28, !dbg !866

27:                                               ; preds = %25
  br label %40, !dbg !867

28:                                               ; preds = %25
  %29 = icmp eq i64 %10, 0, !dbg !869
  br i1 %29, label %30, label %31, !dbg !871

30:                                               ; preds = %28
  br label %36, !dbg !872

31:                                               ; preds = %28
  %32 = sub i64 %.02, %10, !dbg !874
  call void @llvm.dbg.value(metadata i64 %32, metadata !843, metadata !DIExpression()), !dbg !841
  %33 = getelementptr inbounds i8, i8* %.01, i64 %10, !dbg !875
  call void @llvm.dbg.value(metadata i8* %33, metadata !844, metadata !DIExpression()), !dbg !841
  br label %34, !dbg !876

34:                                               ; preds = %31
  %35 = icmp ugt i64 %32, 0, !dbg !877
  br i1 %35, label %8, label %36, !dbg !876, !llvm.loop !878

36:                                               ; preds = %34, %30
  %.1 = phi i8* [ %.01, %30 ], [ %33, %34 ], !dbg !841
  call void @llvm.dbg.value(metadata i8* %.1, metadata !844, metadata !DIExpression()), !dbg !841
  %37 = ptrtoint i8* %.1 to i64, !dbg !880
  %38 = ptrtoint i8* %1 to i64, !dbg !880
  %39 = sub i64 %37, %38, !dbg !880
  br label %40, !dbg !881

40:                                               ; preds = %36, %27
  %.0 = phi i64 [ %10, %27 ], [ %39, %36 ], !dbg !841
  ret i64 %.0, !dbg !882
}
...
5:                                                ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str.4, i64 0, i64 0), i32 142, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__PRETTY_FUNCTION__._randombytes_linux_getrandom, i64 0, i64 0)) #9, !dbg !889
  unreachable, !dbg !889
...
7:                                                ; preds = %23, %6
  %8 = trunc i64 %1 to i32, !dbg !894
  %9 = call i64 (i64, ...) @syscall(i64 318, i8* %0, i32 %8, i32 0) #11, !dbg !896
  %10 = trunc i64 %9 to i32, !dbg !896
  call void @llvm.dbg.value(metadata i32 %10, metadata !897, metadata !DIExpression()), !dbg !887
  br label %11, !dbg !898

11:                                               ; preds = %7
  %12 = icmp slt i32 %10, 0, !dbg !899
  br i1 %12, label %13, label %23, !dbg !900

13:                                               ; preds = %11
  %14 = call i32* @__errno_location() #10, !dbg !901
  %15 = load i32, i32* %14, align 4, !dbg !901
  %16 = icmp eq i32 %15, 4, !dbg !902
  br i1 %16, label %21, label %17, !dbg !903

17:                                               ; preds = %13
  %18 = call i32* @__errno_location() #10, !dbg !904
  %19 = load i32, i32* %18, align 4, !dbg !904
  %20 = icmp eq i32 %19, 11, !dbg !905
  br label %21, !dbg !903
...
23:                                               ; preds = %21, %11
  %24 = phi i1 [ false, %11 ], [ %22, %21 ], !dbg !887
  br i1 %24, label %7, label %25, !dbg !898, !llvm.loop !906

25:                                               ; preds = %23
  %26 = trunc i64 %1 to i32, !dbg !908
  %27 = icmp eq i32 %10, %26, !dbg !909
  %28 = zext i1 %27 to i32, !dbg !909
  %29 = sub nsw i32 %28, 1, !dbg !910
  ret i32 %29, !dbg !911
}
...
define internal void @randombytes_sysrandom_init() #0 !dbg !912 {
  ...
  br i1 %6, label %7, label %9, !dbg !923

7:                                                ; preds = %0
  store i32 1, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !924
  %8 = call i32* @__errno_location() #10, !dbg !926
  store i32 %3, i32* %8, align 4, !dbg !927
  br label %15, !dbg !928

9:                                                ; preds = %0
  store i32 0, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 2), align 4, !dbg !929
  %10 = call i32 @randombytes_sysrandom_random_dev_open(), !dbg !930
  store i32 %10, i32* getelementptr inbounds (%struct.SysRandom_, %struct.SysRandom_* @stream, i32 0, i32 0), align 4, !dbg !932
  %11 = icmp eq i32 %10, -1, !dbg !933
...
13:                                               ; preds = %9
  %14 = call i32* @__errno_location() #10, !dbg !937
  store i32 %3, i32* %14, align 4, !dbg !938
  br label %15, !dbg !939
...
2:                                                ; preds = %28, %0
  %.01 = phi i8** [ getelementptr inbounds ([3 x i8*], [3 x i8*]* @randombytes_sysrandom_random_dev_open.devices, i64 0, i64 0), %0 ], [ %.1, %28 ], !dbg !979
  call void @llvm.dbg.value(metadata i8** %.01, metadata !977, metadata !DIExpression()), !dbg !979
  %3 = load i8*, i8** %.01, align 8, !dbg !981
  %4 = call i32 (i8*, i32, ...) @open(i8* %3, i32 0), !dbg !983
  call void @llvm.dbg.value(metadata i32 %4, metadata !984, metadata !DIExpression()), !dbg !979
  %5 = icmp ne i32 %4, -1, !dbg !985
  br i1 %5, label %6, label %20, !dbg !987

6:                                                ; preds = %2
  %7 = call i32 @fstat(i32 %4, %struct.stat* %1) #11, !dbg !988
  %8 = icmp eq i32 %7, 0, !dbg !991
  br i1 %8, label %9, label %18, !dbg !992

9:                                                ; preds = %6
  %10 = getelementptr inbounds %struct.stat, %struct.stat* %1, i32 0, i32 3, !dbg !993
  %11 = load i32, i32* %10, align 8, !dbg !993
  %12 = and i32 %11, 61440, !dbg !993
  %13 = icmp eq i32 %12, 8192, !dbg !993
  br i1 %13, label %14, label %18, !dbg !994

14:                                               ; preds = %9
  %15 = call i32 (i32, i32, ...) @fcntl(i32 %4, i32 1), !dbg !995
  %16 = or i32 %15, 1, !dbg !997
  %17 = call i32 (i32, i32, ...) @fcntl(i32 %4, i32 2, i32 %16), !dbg !998
  br label %33, !dbg !999

18:                                               ; preds = %9, %6
  %19 = call i32 @close(i32 %4), !dbg !1000
  br label %26, !dbg !1001

20:                                               ; preds = %2
  %21 = call i32* @__errno_location() #10, !dbg !1002
  %22 = load i32, i32* %21, align 4, !dbg !1002
  %23 = icmp eq i32 %22, 4, !dbg !1004
  br i1 %23, label %24, label %25, !dbg !1005

24:                                               ; preds = %20
  br label %28, !dbg !1006

25:                                               ; preds = %20
  br label %26

26:                                               ; preds = %25, %18
  %27 = getelementptr inbounds i8*, i8** %.01, i32 1, !dbg !1008
  call void @llvm.dbg.value(metadata i8** %27, metadata !977, metadata !DIExpression()), !dbg !979
  br label %28, !dbg !1009

28:                                               ; preds = %26, %24
  %.1 = phi i8** [ %27, %26 ], [ %.01, %24 ], !dbg !979
  call void @llvm.dbg.value(metadata i8** %.1, metadata !977, metadata !DIExpression()), !dbg !979
  %29 = load i8*, i8** %.1, align 8, !dbg !1010
  %30 = icmp ne i8* %29, null, !dbg !1011
  br i1 %30, label %2, label %31, !dbg !1009, !llvm.loop !1012

31:                                               ; preds = %28
  %32 = call i32* @__errno_location() #10, !dbg !1014
  store i32 5, i32* %32, align 4, !dbg !1015
  br label %33, !dbg !1016

33:                                               ; preds = %31, %14
  %.0 = phi i32 [ %4, %14 ], [ -1, %31 ], !dbg !979
  ret i32 %.0, !dbg !1017
}
...
define dso_local i32 @_sodium_alloc_init() #0 !dbg !1253 {
  call void @randombytes_buf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @canary, i64 0, i64 0), i64 16), !dbg !1254
  ret i32 0, !dbg !1255
}
