...
namespace psr{
    template <typename AnalysisDomainTy>
    class LuweiIFDSSolver : public LuweiIDESolver<AnalysisDomainExtender<AnalysisDomainTy>> {
    public:
        using ProblemTy = IFDSTabulationProblem<AnalysisDomainTy>;
        using D = typename AnalysisDomainTy::d_t;
        using N = typename AnalysisDomainTy::n_t;

        LuweiIFDSSolver(IFDSTabulationProblem<AnalysisDomainTy> &IFDSProblem)
                : LuweiIDESolver<AnalysisDomainExtender<AnalysisDomainTy>>(IFDSProblem) {}

        ~LuweiIFDSSolver() override = default;
    ...
    template <typename Problem>
    LuweiIFDSSolver(Problem &) -> LuweiIFDSSolver<typename Problem::ProblemAnalysisDomain>;

    template <typename Problem>
    using LuweiIFDSSolver_P = LuweiIFDSSolver<typename Problem::ProblemAnalysisDomain>;
}
