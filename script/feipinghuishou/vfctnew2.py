...
def single_one():
    ...
    totaltime.append(("1", total))
    totaltime2.append(("1", total))
    detailtime.append(("add-key", lowtiant1))
    detailtime.append(("taint-analysis", lowtiant2))
    detailtime.append(("ept", []))
...
def single_two():
    ...
    totaltime.append(("2", total))
    totaltime2.append(("2", total))
    detailtime.append(("2-generatebpl", sigtwo1))
    detailtime.append(("2-product", sigtwo2))
    detailtime.append(("2-verify", sigtwo3))
    detailtime.append(("ept1", []))

    verifytime.append(("2", sigtwo3))
...
def single_three():
    ...
    totaltime.append(("3", total))
    totaltime2.append(("3", total))
    detailtime.append(("3-generatebpl", sigtwo1))
    detailtime.append(("3-product", sigtwo2))
    detailtime.append(("3-verify", sigtwo3))
    detailtime.append(("ept2", []))

    verifytime.append(("3", sigtwo3))
...
def chaifen_single_three():
    ...
    totaltime.append(("3-s", total))
    totaltime2.append(("3-s", total))
    detailtime.append(("3-s-generatebpl", sigtwo1))
    detailtime.append(("3-s-product", sigtwo2))
    detailtime.append(("3-s-verify", sigtwo3))
    detailtime.append(("ept22", []))

    verifytime.append(("3-s", sigtwo3))
...
def one_and_two():
    ...
    totaltime.append(("1+2", total))
    totaltime2.append(("1+2", total2))
    detailtime.append(("1+2-addkey", l1))
    detailtime.append(("1+2-taint-analysis", l2))
    detailtime.append(("1+2-generatebpl", l3))
    detailtime.append(("1+2-product", l4))
    detailtime.append(("1+2-verify", l5))
    detailtime.append(("ept3", []))

    verifytime.append(("1+2", l5))
...
def one_and_three():
    ...
    totaltime.append(("1+3", total))
    totaltime2.append(("1+3", total2))
    detailtime.append(("1+3-addkey", l1))
    detailtime.append(("1+3-taint-analysis", l2))
    detailtime.append(("1+3-generatebpl", l3))
    detailtime.append(("1+3-product", l4))
    detailtime.append(("1+3-verify", l5))
    detailtime.append(("ept4", []))

    verifytime.append(("1+3", l5))
...
def one_and_three_s():
    ...
    totaltime.append(("1+3_s", total))
    totaltime2.append(("1+3_s", total2))
    detailtime.append(("1+3_s-addkey", l1))
    detailtime.append(("1+3_s-taint-analysis", l2))
    detailtime.append(("1+3_s-generatebpl", l3))
    detailtime.append(("1+3_s-product", l4))
    detailtime.append(("1+3_s-verify", l5))
    detailtime.append(("ept44", []))

    verifytime.append(("1+3_s", l5))
...
def two_and_three():
    ...
    for item in entry:
        ...
        t3 = verifybpl(boolboogiefile, boolanalyres, "two_and_three")
    ...
    totaltime.append(("2+3", total))
    totaltime2.append(("2+3", total2))
    detailtime.append(("2+3-generate", l1))
    detailtime.append(("2+3-productbpl", l2))
    detailtime.append(("2+3-verifybpl", l3))
    detailtime.append(("2+3-productbpl-2", l4))
    detailtime.append(("2+3-transfer-1", l5))
    detailtime.append(("2+3-transfer-2", l6))
    detailtime.append(("2+3-verify-2", l7))
    detailtime.append(("ept5", []))
...
def one_and_two_and_three():
    ...
    for item in entry:
        ...
        restime5 = verifybpl(boolboogiefile, analyres,"one_and_two_and_three")
    ...
    totaltime.append(("1+2+3", total))
    totaltime2.append(("1+2+3", total2))
    detailtime.append(("1+2+3-addkey", l1))
    detailtime.append(("1+2+3-taint-analysis", l2))
    detailtime.append(("1+2+3-generatebpl", l3))
    detailtime.append(("1+2+3-product", l4))
    detailtime.append(("1+2+3-verify", l5))
    detailtime.append(("1+2+3-product2", l6))
    detailtime.append(("1+2+3-transfer1", l7))
    detailtime.append(("1+2+3-transfer2", l8))
    detailtime.append(("1+2+3-verify2", l9))
    detailtime.append(("ep23", []))

    verifytime.append(("1+2+3", l9))
...
def one_and_two_and_three_s():
    ...
    for item in entry:
        ...
        restime5 = verifybpl(boolboogiefile, analyres,"one_and_two_and_three-s")
    ...
    totaltime.append(("1+2+3-s", total))
    totaltime2.append(("1+2+3-s", total2))
    detailtime.append(("1+2+3-s-addkey", l1))
    detailtime.append(("1+2+3-s-taint-analysis", l2))
    detailtime.append(("1+2+3-s-generatebpl", l3))
    detailtime.append(("1+2+3-s-product", l4))
    detailtime.append(("1+2+3-s-verify", l5))
    detailtime.append(("1+2+3-s-product2", l6))
    detailtime.append(("1+2+3-s-transfer1", l7))
    detailtime.append(("1+2+3-s-transfer2", l8))
    detailtime.append(("1+2+3-s-verify2", l9))

    verifytime.append(("1+2+3-s", l9))
...
def runall():
    ...
    collcet_time(totaltime, "totaltime.csv")
    collcet_time(detailtime, "detailtime.csv")
    collcet_time(verifytime, "verifytime")
