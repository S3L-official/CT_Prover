...
all_sensitive_pos = []
# all, left
# 单独的高精度污点分析，pass与否是从single_two里得到的，剩余污点个数是从one_and_two里得到的
# one_and_two里是拆分的single_two. 因此结果不管是pass与否，还是left个数都不太一样。
high_taint_res_2_3 = []
...
def chaifen_single_three():
    ...
    totaltime2_3_s.append(("3-s", total))
...
def one_and_two():
    ...
    totaltime2_1_2.append(("1+2", total2))
...
def one_and_three():
    ...
    totaltime2_1_3.append(("1+3", total2))
...
def one_and_three_s():
    ...
    totaltime2_1_3_s.append(("1+3_s", total2))
...
def runall():
    ...
    for i in threads:
        ...
        #收集时间
    totaltime = totaltime_1+totaltime_2+totaltime_2_s+totaltime_3+totaltime_3_s+totaltime_1_2 \
    +totaltime_1_3+totaltime_1_3_s+totaltime_2_3+totaltime_1_2_3+totaltime_1_2_3_s
    
    totaltime2 = totaltime2_1+totaltime2_2+totaltime2_2_s+totaltime2_3+totaltime2_3_s+totaltime2_1_2 \
    +totaltime2_1_3+totaltime2_1_3_s+totaltime2_2_3+totaltime2_1_2_3+totaltime2_1_2_3_s
    
    detailtime = detailtime_1+detailtime_2+detailtime_2_s+detailtime_3+detailtime_3_s+detailtime_1_2+ detailtime_1_3+\
        detailtime_1_3_s+detailtime_2_3+detailtime_1_2_3+detailtime_1_2_3_s

    verifytime = verifytime_1+verifytime_2+verifytime_2_s+verifytime_3+verifytime_3_s+verifytime_1_2+\
        verifytime_1_3+verifytime_1_3_s+verifytime_2_3+verifytime_1_2_3+verifytime_1_2_3_s
    collcetinfo2(totaltime2)
    #收集时间
    collcet_time(totaltime, "totaltime.csv")
    collcet_time(totaltime2, "totaltime2.csv")
    collcet_time(detailtime, "detailtime.csv")
